 ...
 * {@link BigDecimal#ROUND_DOWN}, etc. ).
 *
 * @see BigDecimal
 * @see MathContext
 * @author Josh Bloch
...
public enum RoundingMode {
	 ...
	 * is thrown.
	 * <p>
	 * Example: <table border> <caption><b>Rounding mode UNNECESSARY
	 * Examples</b></caption>
	 * <tr valign=top>
	 * <th>Input Number</th>
	 * <th>Input rounded to one digit<br>
	...
	/**
	 * Returns the {@code RoundingMode} object corresponding to a legacy integer
