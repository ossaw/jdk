 ...
 * {@code BigInteger}) and arbitrary-precision decimal arithmetic (
 * {@code BigDecimal}). {@code BigInteger} is analogous to the primitive integer
 * types except that it provides arbitrary precision, hence operations on
 * {@code BigInteger}s do not overflow or lose precision. In addition to
