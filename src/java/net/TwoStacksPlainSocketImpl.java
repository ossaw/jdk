...
class TwoStacksPlainSocketImpl extends AbstractPlainSocketImpl {
    /*
     * second fd, used for ipv6 on windows only. fd1 is used for listeners and
     * for client sockets at initialization until the socket is connected. Up to
    ...
    /*
     * Needed for ipv6 on windows because we need to know if the socket is bound
     * to ::0 or 0.0.0.0, when a caller asks for it. Otherwise we don't know
     * which socket to ask.
     */
    private InetAddress anyLocalBoundAddr = null;

    /*
     * to prevent starvation when listening on two sockets, this is is used to
     * hold the id of the last socket we accepted on.
     */
