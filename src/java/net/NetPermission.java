 ...
 * sensitive cookie information for an Http session.</td>
 * <td>Malicious code can get a cookie handler to obtain access to highly
 * security sensitive cookie information. Some web servers use cookies to save
 ...
 * proxies to use when making network connections.</td>
 ...
 * sensitive cookie information for an Http session.</td>
 * <td>Malicious code can set a cookie handler to obtain access to highly
 * security sensitive cookie information. Some web servers use cookies to save
 * user private information such as access control information, or to track user
 * browsing habit.</td>
 * </tr>
 ...
 * proxy or HTTP server asks for authentication</td>
 ...
 * <td>Malicious code may create a URL with resources that it would normally not
 * have access to (like file:/foo/fum/), specifying a stream handler that gets
 * the actual bytes from someplace it does have access to. Thus it might be able
 * to trick the system into creating a ProtectionDomain/CodeSource for a class
 * even though that class really didn't come from that location.</td>
 * </tr>
 * </table>
 *
