 ...
 * implementation to perform the HTTP tunneling and authentication. The sockets
 * impl is swapped out and replaced with the socket from the HTTP handler after
 * the tunnel is successfully setup.
 *
 * @since 1.8
 */
...
/* package */ class HttpConnectSocketImpl extends PlainSocketImpl {
	...
	public void setOption(int opt, Object val) throws SocketException {
		...
		// store options so that they can be re-applied to the impl after
		// connect
