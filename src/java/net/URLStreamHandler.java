...
public abstract class URLStreamHandler {
	 ...
	 *                if the subclass that implements the protocol doesn't
	 *                support this method.
	 * @since 1.5
	 */
	 ...
	 * @param limit
	 *            the character position to stop parsing at. This is the end of
	...
	protected boolean sameFile(URL u1, URL u2) {
		...
		if (!((u1.getProtocol() == u2.getProtocol()) || (u1.getProtocol() != null
	 ...
	 *                if the protocol handler of the URL is different from this
	 *                one
