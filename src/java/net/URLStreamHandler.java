...
public abstract class URLStreamHandler {
    ...
    protected void parseURL(URL u, String spec, int start, int limit) {
        ...
        boolean isUNCName = (start <= limit - 4) && (spec.charAt(start) == '/') && (spec.charAt(start
                + 1) == '/') && (spec.charAt(start + 2) == '/') && (spec.charAt(start + 3) == '/');
        if (!isUNCName && (start <= limit - 2) && (spec.charAt(start) == '/') && (spec.charAt(start
                + 1) == '/')) {
            start += 2;
        ...
        if (isRelPath) {
            ...
            while ((i = path.indexOf("/../", i)) >= 0) {
                 ...
                 */
                if (i > 0 && (limit = path.lastIndexOf('/', i - 1)) >= 0 && (path.indexOf("/../",
                        limit) != 0)) {
