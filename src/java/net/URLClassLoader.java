...
public class URLClassLoader extends SecureClassLoader implements Closeable {
	 ...
	 *                if closing any file opened by this class loader resulted
	 *                in an IOException. Any such exceptions are caught
	 *                internally. If only one is caught, then it is re-thrown.
	 *                If more than one exception is caught, then the second and
	 *                following exceptions are added as suppressed exceptions of
	 ...
	 *                if the class could not be found, or if the loader is
	 *                closed.
	 * @exception NullPointerException
