...
/**
 * Represent channels for retrieving resources from the ResponseCache. Instances
 * of such a class provide an InputStream that returns the entity body, and also
 * a getHeaders() method which returns the associated response headers.
 *
