...
/**
 * The abstract class {@code SocketImpl} is a common superclass of all classes
 * that actually implement sockets. It is used to create both client and server
 * sockets.
 * <p>
...
public abstract class SocketImpl implements SocketOptions {
	 ...
	 * request to connect) to the {@code count} argument. If a connection
	 ...
	 *         blocking.
	 * @exception IOException
	 *                if an I/O error occurs when determining the number of
	 *                bytes available.
	 */
	...
	public String toString() {
		return "Socket[addr=" + getInetAddress() + ",port=" + getPort() + ",localport="
				+ getLocalPort() + "]";
	}
