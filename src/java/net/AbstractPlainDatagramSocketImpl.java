...
/**
 * Abstract datagram and multicast socket implementation base class. Note: This
 * is not a public class, so that applets cannot call into the implementation
 * directly and hence cannot bypass the security checks present in the
 * DatagramSocket and MulticastSocket classes.
 *
...
abstract class AbstractPlainDatagramSocketImpl extends DatagramSocketImpl {
	 ...
	 * to this destination and received from this destination.
	 * 
	 * @param address
	 ...
	 * 
	 * @param i
	 *          the address to populate with the sender address
	 */
	...
	public void setOption(int optID, Object o) throws SocketException {
		...
		switch (optID) {
			...
			case SO_RCVBUF:
			case SO_SNDBUF:
				if (o == null || !(o instanceof Integer) || ((Integer) o)
						.intValue() < 0) {
			...
			case IP_MULTICAST_LOOP:
				if (o == null || !(o instanceof Boolean))
					throw new SocketException(
							"bad argument for IP_MULTICAST_LOOP");
				break;
			default:
	...
	protected abstract void connect0(InetAddress address, int port)
			throws SocketException;
