 ...
 * <a href="http://www.ietf.org/rfc/rfc2965.txt"><i>RFC&nbsp;2965: HTTP State
...
public abstract class CookieHandler {
	 ...
	 *
	 * <P>
	 * The {@code URI} passed as an argument specifies the intended use for the
	 * cookies. In particular the scheme should reflect whether the cookies will
	 * be sent over http, https or used in another context like javascript. The
	 * host part should reflect either the destination of the cookies or their
	 * origin in the case of javascript.
	 * </P>
	 * <P>
	 * It is up to the implementation to take into account the {@code URI} and
