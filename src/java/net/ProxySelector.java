 ...
 * resource referenced by a URL. A proxy selector is a concrete sub-class of
 * this class and is registered by invoking the
...
public abstract class ProxySelector {
    /**
     * The system wide proxy selector that selects the proxy server to use, if
     * any, when connecting to a remote object referenced by an URL.
     *
     ...
     * resource with and a destination address to access the resource at. The
     * format of the URI is defined as follow:
     * <UL>
     ...
     * proxy/socks server. An implementation of this method can temporarily
     * remove the proxies or reorder the sequence of proxies returned by
     * {@link #select(URI)}, using the address and the IOException caught when
     * trying to connect.
     *
     * @param uri
