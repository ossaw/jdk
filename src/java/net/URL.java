 ...
 * types of URLs and their formats can be found at: <a href=
 ...
 * </blockquote>
 * <p>
 * The URL above indicates that the protocol to use is {@code http} (HyperText
 * Transfer Protocol) and that the information resides on a host machine named
 * {@code www.example.com}. The information on that host machine is named
 * {@code /docs/resource1.html}. The exact meaning of this name on the host
 ...
 * component of the URL is called the <i>path</i> component.
 * <p>
 ...
 * the default port for {@code http} is {@code 80}. An alternative port could be
 * specified as: <blockquote>
 * 
 * <pre>
 ...
 * interested in that part of the document that has the tag {@code chapter1}
...
public final class URL implements java.io.Serializable {
     ...
     * protocol handlers. The value of this property (if any) should be a
     * vertical bar delimited list of package names to search through for a
     * protocol handler to load. The policy of this class is that all protocol
     * handlers will be in a class called <protocolname>.Handler, and each
     * package in the list is examined in turn for a matching handler. If none
     * are found (or the property is not specified), the default package prefix,
    ...
    /**
     * The specified file name on that host. {@code file} is defined as
     * {@code path[?query]}
     * 
     * @serial
     */
     ...
     * An uninitialized or unknown hostAddress is null.
     */
    ...
    /**
     * Creates a {@code URL} object from the specified {@code protocol},
     * {@code host}, {@code port} number, and {@code file}.
     * <p>
     * {@code host} can be expressed as a host name or a literal IP address. If
     * IPv6 literal address is used, it should be enclosed in square brackets (
     * {@code '['} and {@code ']'}), as specified by
     * <a href="http://www.ietf.org/rfc/rfc2732.txt">RFC&nbsp;2732</a>; However,
     * the literal IPv6 address format defined in
     * <a href="http://www.ietf.org/rfc/rfc2373.txt"><i>RFC&nbsp;2373: IP
     * Version 6 Addressing Architecture</i></a> is also accepted.
     * <p>
     * Specifying a {@code port} number of {@code -1} indicates that the URL
     * should use the default port for the protocol.
     * <p>
     * If this is the first URL object being created with the specified
     * protocol, a <i>stream protocol handler</i> object, an instance of class
     * {@code URLStreamHandler}, is created for that protocol:
     * <ol>
     * <li>If the application has previously set up an instance of
     * {@code URLStreamHandlerFactory} as the stream handler factory, then the
     * {@code createURLStreamHandler} method of that instance is called with the
     * protocol string as an argument to create the stream protocol handler.
     * <li>If no {@code URLStreamHandlerFactory} has yet been set up, or if the
     * factory's {@code createURLStreamHandler} method returns {@code null},
     ...
     * </pre>
     * 
     * </blockquote> If the value of that system property is not {@code null},
     * it is interpreted as a list of packages separated by a vertical slash
     * character '{@code |}'. The constructor tries to load the class named:
     * <blockquote>
     * 
     * <pre>
     ...
     * not a subclass of {@code URLStreamHandler}, then the next package in the
     * list is tried.
     ...
     * is not a subclass of {@code URLStreamHandler}, then a
    ...
    /**
     * Creates a URL from the specified {@code protocol} name, {@code host}
     * name, and {@code file} name. The default port for the specified protocol
     * is used.
     * <p>
     * This method is equivalent to calling the four-argument constructor with
     * the arguments being {@code protocol}, {@code host}, {@code -1}, and
     * {@code file}.
     * No validation of the inputs is performed by this constructor.
     *
     * @param protocol
    ...
    /**
     * Creates a {@code URL} object from the specified {@code protocol},
     * {@code host}, {@code port} number, {@code file}, and {@code handler}.
     * Specifying a {@code port} number of {@code -1} indicates that the URL
     * should use the default port for the protocol. Specifying a
     * {@code handler} of {@code null} indicates that the URL should use a
     ...
     * manager's {@code checkPermission} method is called with a
     * {@code NetPermission("specifyStreamHandler")} permission. This may result
     ...
     *            {@code checkPermission} method doesn't
     *            allow specifying a
    ...
    public URL(String protocol, String host, int port, String file, URLStreamHandler handler)
        ...
        if (host != null) {
            ...
            /**
             * if host is a literal IPv6 address, we will make it conform to RFC
             * 2732
             */
     ...
     * with a {@code null} first argument.
     *
     * @param spec
     ...
     *            unknown protocol is
     *            found, or {@code spec} is {@code null}.
     ...
     * as described in RFC2396 &quot;Uniform Resource Identifiers : Generic *
     * Syntax&quot; : <blockquote>
     * 
     * <pre>
     ...
     * a specified context. If the handler is null, the parsing occurs as with
    ...
    public URL(URL context, String spec, URLStreamHandler handler) throws MalformedURLException {
        ...
        try {
            ...
            if ((context != null) && ((newProtocol == null) || newProtocol.equalsIgnoreCase(
                    context.protocol))) {
    ...
    void set(String protocol, String host, int port, String file, String ref) {
        synchronized (this) {
            ...
            this.ref = ref;
            /*
             * This is very important. We must recompute this after the URL has
             * been changed.
             */
            hashCode = -1;
            hostAddress = null;
     ...
     * @since 1.3
     */
    void set(String protocol, String host, int port, String authority, String userInfo, String path,
     ...
     *
     * @return the query part of this {@code URL}, or <CODE>null</CODE> if one
     *         does not exist
     * @since 1.3
     */
     ...
     *
     * @return the path part of this {@code URL}, or an empty string if one does
     *         not exist
     * @since 1.3
     */
     ...
     *
     * @return the userInfo part of this {@code URL}, or <CODE>null</CODE> if
     *         one does not exist
     * @since 1.3
     */
     ...
     * {@code URL}. If the URL scheme or the URLStreamHandler for the URL do not
    ...
    /**
     * Gets the host name of this {@code URL}, if applicable. The format of the
     * host conforms to RFC 2732, i.e. for a literal IPv6 address, this method
     * will return the IPv6 address enclosed in square brackets ({@code '['} and
     * {@code ']'}).
     *
    ...
    /**
     * Gets the file name of this {@code URL}. The returned file portion will be
     * the same as <CODE>getPath()</CODE>, plus the concatenation of the value
     * of <CODE>getQuery()</CODE>, if any. If there is no query portion, this
     * method and <CODE>getPath()</CODE> will return identical results.
     *
     * @return the file name of this {@code URL}, or an empty string if one does
     *         not exist
     */
     ...
     *
     * @return the anchor (also known as the "reference") of this {@code URL},
     ...
     * the host names must be equal without regard to case; or both host names
     * equal to null.
     * <p>
     ...
     * <p>
     * Returns {@code true} if this {@code URL} and the {@code other} argument
     * are equal without taking the fragment component into consideration.
     *
     * @param other
    ...
    /**
     * Constructs a string representation of this {@code URL}. The string is
     * created by calling the {@code toExternalForm} method of the stream
     ...
     * functions in the same way as {@code new URI (this.toString())}.
     * <p>
     ...
     *            or proxy has the wrong
     *            type
     * @exception UnsupportedOperationException
     *            if the subclass that implements
     ...
     * @return the content object of this URL that is the first match of the
     *         types specified in the classes array. null if none of the
    ...
    /**
     * Sets an application's {@code URLStreamHandlerFactory}. This method can be
     * called at most once in a given Java Virtual Machine.
     * <p>
     * The {@code URLStreamHandlerFactory} instance is used to construct a
     ...
     *        the desired factory.
     * @exception Error
     *            if the application has already set a
     *            factory.
     * @exception SecurityException
     *            if a security manager exists and its
    ...
    /**
     * @serialField protocol
     *              String
     * @serialField host
     *              String
     * @serialField port
     *              int
     * @serialField authority
     *              String
     * @serialField file
     *              String
     * @serialField ref
     ...
     *              int
     */
    private static final ObjectStreamField[] serialPersistentFields = { new ObjectStreamField("protocol",
            String.class), new ObjectStreamField("host", String.class), new ObjectStreamField("port",
                    int.class), new ObjectStreamField("authority", String.class), new ObjectStreamField(
                            "file", String.class), new ObjectStreamField("ref", String.class),
            new ObjectStreamField("hashCode", int.class), };

    /**
     * WriteObject is called to save the state of the URL to an
     * ObjectOutputStream. The handler is not saved since it is specific to this
     * system.
     *
     * @serialData the default write object value. When read back in, the reader
     *             must ensure that calling getURLStreamHandler with the
     *             protocol variable returns a valid URLStreamHandler and throw
    ...
    /**
     * readObject is called to restore the state of the URL from the stream. It
     * reads the components of the URL and finds the local stream handler.
     */
...
final class UrlDeserializedState {
    ...
    public UrlDeserializedState(String protocol, String host, int port, String authority, String file,
