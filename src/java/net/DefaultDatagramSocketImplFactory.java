...
/**
 * This class defines a factory for creating DatagramSocketImpls. It defaults to
 * creating plain DatagramSocketImpls, but may create other DatagramSocketImpls
 * by setting the impl.prefix system property.
 * For Windows versions lower than Windows Vista a
 * TwoStacksPlainDatagramSocketImpl is always created. This impl supports IPv6
 * on these platform where available.
 * On Windows platforms greater than Vista that support a dual layer TCP/IP
 * stack a DualStackPlainDatagramSocketImpl is created for DatagramSockets. For
 * MulticastSockets a TwoStacksPlainDatagramSocketImpl is always created. This
 * is to overcome the lack of behavior defined for multicasting over a dual
 * layer socket by the RFC.
 *
...
class DefaultDatagramSocketImplFactory {
    ...
    static {
        ...
        String prefix = null;
        try {
            prefix = AccessController.doPrivileged(new sun.security.action.GetPropertyAction("impl.prefix",
                    null));
            if (prefix != null)
