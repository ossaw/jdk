...
/**
 * This class represents an Internet Protocol version 4 (IPv4) address. Defined
 * by <a href="http://www.ietf.org/rfc/rfc790.txt"> <i>RFC&nbsp;790: Assigned
 * Numbers</i></a>,
 ...
 * scoping is preferred. Please refer to
 * <a href="http://www.ietf.org/rfc/rfc2365.txt"> <i>RFC&nbsp;2365:
 * Administratively Scoped IP Multicast</i></a>
 * 
 * @since 1.4
...
public final class Inet4Address extends InetAddress {
	...
	private Object writeReplace() throws ObjectStreamException {
		...
		/**
		 * Prior to 1.4 an InetAddress was created with a family based on the
		 * platform AF_INET value (usually 2). For compatibility reasons we must
		 * therefore write the the InetAddress with this family.
		 */
