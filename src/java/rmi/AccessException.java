 ...
 * <code>java.rmi.activation.ActivationSystem</code> interface to indicate that
 * the caller does not have permission to perform the action requested by the
 * method call. If the method was invoked from a non-local host, then an
 * <code>AccessException</code> is thrown.
 *
 * @author Ann Wollrath
 * @author Roger Riggs
 * @since JDK1.1
