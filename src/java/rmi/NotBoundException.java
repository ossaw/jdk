...
/**
 * A <code>NotBoundException</code> is thrown if an attempt is made to lookup or
...
public class NotBoundException extends java.lang.Exception {
	...
	/**
	 * Constructs a <code>NotBoundException</code> with no specified detail
	 * message.
	 * 
	 * @since JDK1.1
	 */
	...
	/**
	 * Constructs a <code>NotBoundException</code> with the specified detail
	 * message.
	 *
	 * @param s
	 *          the detail message
