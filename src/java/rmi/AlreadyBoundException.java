...
/**
 * An <code>AlreadyBoundException</code> is thrown if an attempt is made to bind
 * an object in the registry to a name that already has an associated binding.
 *
 * @since JDK1.1
 * @author Ann Wollrath
 * @author Roger Riggs
...
public class AlreadyBoundException extends java.lang.Exception {
    ...
    /**
     * Constructs an <code>AlreadyBoundException</code> with no specified detail
     * message.
     * 
     * @since JDK1.1
     */
