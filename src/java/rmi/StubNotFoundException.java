...
/**
 * A <code>StubNotFoundException</code> is thrown if a valid stub class could
 * not be found for a remote object when it is exported. A
 * <code>StubNotFoundException</code> may also be thrown when an activatable
 * object is registered via the
