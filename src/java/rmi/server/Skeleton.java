...
/**
 * The <code>Skeleton</code> interface is used solely by the RMI implementation.
 *
 * <p>
 * Every version 1.1 (and version 1.1 compatible skeletons generated in 1.2
 * using <code>rmic -vcompat</code>) skeleton class generated by the rmic stub
 * compiler implements this interface. A skeleton for a remote object is a
 * server-side entity that dispatches calls to the actual remote object
 * implementation.
 *
 * @author Ann Wollrath
 * @since JDK1.1
