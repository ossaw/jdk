...
/**
 * An <code>RMIClientSocketFactory</code> instance is used by the RMI runtime in
 ...
 * instance that represents the same (functionally equivalent) client socket
 * factory, and <code>false</code> otherwise (and it should also implement
 * {@link Object#hashCode} consistently with its <code>Object.equals</code>
 * implementation).
 *
 * @author Ann Wollrath
 * @author Peter Jones
