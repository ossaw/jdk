 ...
 * implementation of the following static methods of <code>RMIClassLoader</code>
 * :
 *
 * <ul>
 *
 ...
 * </ul>
 *
 * When one of those methods is invoked, its behavior is to delegate to a
 * corresponding method on an instance of this class. The details of how each
 * method delegates to the provider instance is described in the documentation
 * for each particular method. See the documentation for {@link RMIClassLoader}
 * for a description of how a provider instance is chosen.
 *
 * @author Peter Jones
 * @author Laird Dornin
 * @see RMIClassLoader
...
public abstract class RMIClassLoaderSpi {
     ...
     * implementation of this method may also perform further security checks to
     * verify that the calling context has permission to connect to all of the
