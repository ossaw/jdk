...
/**
 * An <code>ObjID</code> is used to identify a remote object exported to an RMI
 ...
 * a unique <code>ObjID</code>, the address space identifier is unique with
 ...
 * {@link #ObjID()} constructor will use a cryptographically strong random
 * number generator to choose the object number of the returned
 * <code>ObjID</code>.
 *
 * @author Ann Wollrath
 * @author Peter Jones
...
public final class ObjID implements Serializable {
    ...
    /**
     * Object number for well-known <code>ObjID</code> of the distributed
     * garbage collector.
     */
     ...
     * constructor will use a cryptographically strong random number generator
     * to choose the object number of the returned <code>ObjID</code>.
     */
    public ObjID() {
        /*
         * If generating random object numbers, create a new UID to ensure
         * uniqueness; otherwise, use a shared UID because sequential object
         * numbers already ensure uniqueness.
         */
        if (useRandomIDs()) {
            space = new UID();
     ...
     * object number, and then it writes its address space identifier by
     ...
     * invokes {@link UID#read(DataInput)} with the stream to read an address
     * space identifier, and then it creates and returns a new
     * <code>ObjID</code> instance that contains the object number and address
    ...
    /**
     * Returns the hash code value for this object identifier, the object
     * number.
     *
     ...
     * representation if it does not denote the local address space (or if the
     * randomIDs property was set).
     */
