 ...
 * <ul>
 * <li><code>unique</code>, an <code>int</code> that uniquely identifies the VM
 * that this <code>UID</code> was generated in, with respect to its host and at
 * the time represented by the <code>time</code> value (an example
 * implementation of the <code>unique</code> value would be a process
 * identifier), or zero for a well-known <code>UID</code>
 * <li><code>time</code>, a <code>long</code> equal to a time (as returned by
 * {@link System#currentTimeMillis()}) at which the VM that this
 * <code>UID</code> was generated in was alive, or zero for a well-known
 * <code>UID</code>
 ...
 * one millisecond to reboot and its system clock is never set backward. A
 * globally unique identifier can be constructed by pairing a <code>UID</code>
...
public final class UID implements Serializable {
	...
	/**
	 * number that uniquely identifies the VM that this <code>UID</code> was
	 * generated in with respect to its host and at the given time
	 * 
	 * @serial
	 */
	 ...
	 * VM that this <code>UID</code> was generated in was alive
	 * 
	 * @serial
	 */
	...
	/**
	 * 16-bit number to distinguish <code>UID</code> instances created in the
	 * same VM with the same time value
	 * 
	 * @serial
	 */
	...
	/**
	 * Generates a <code>UID</code> that is unique over time with respect to the
	 * host that it was generated on.
	 */
	public UID() {
	 ...
	 * then it invoke's the stream's {@link DataInput#readLong()} method to read
	 * a <code>time</code> value, then it invoke's the stream's
	 * {@link DataInput#readShort()} method to read a <code>count</code> value,
	 * and then it creates and returns a new <code>UID</code> instance that
	 * contains the <code>unique</code>, <code>time</code>, and
