...
/**
 * An <code>RMIServerSocketFactory</code> instance is used by the RMI runtime in
 ...
 * (functionally equivalent) server socket factory, and <code>false</code>
 * otherwise (and it should also implement {@link Object#hashCode} consistently
 * with its <code>Object.equals</code> implementation).
 *
 * @author Ann Wollrath
 * @author Peter Jones
 * @since 1.2
