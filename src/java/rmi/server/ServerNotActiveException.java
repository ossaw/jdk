...
/**
 * An <code>ServerNotActiveException</code> is an <code>Exception</code> thrown
 * during a call to <code>RemoteServer.getClientHost</code> if the getClientHost
 * method is called outside of servicing a remote method call.
 *
 * @author Roger Riggs
 * @since JDK1.1
