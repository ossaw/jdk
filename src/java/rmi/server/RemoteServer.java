 ...
 * implementations and provides the framework to support a wide range of remote
 * reference semantics. Specifically, the functions needed to create and export
 * remote objects (i.e. to make them remotely available) are provided abstractly
 * by <code>RemoteServer</code> and concretely by its subclass(es).
 *
 * @author Ann Wollrath
 * @since JDK1.1
 */
public abstract class RemoteServer extends RemoteObject {
	...
	/**
	 * Returns a string representation of the client host for the remote method
	 ...
	 * <code>java.util.logging.LoggingPermission("control")</code> permission;
