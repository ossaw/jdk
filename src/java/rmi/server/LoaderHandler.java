...
/**
 * <code>LoaderHandler</code> is an interface used internally by the RMI runtime
 * in previous implementation versions. It should never be accessed by
 * application code.
 *
 * @author Ann Wollrath
 * @since JDK1.1
...
public interface LoaderHandler {
	 ...
	 * @return the <code>Class</code> object representing the loaded class
	 * @exception MalformedURLException
	 *                if the <code>codebase</code> paramater contains an invalid
	 *                URL
	 * @exception ClassNotFoundException
	 *                if a definition for the class could not be found at the
	 *                specified URL
