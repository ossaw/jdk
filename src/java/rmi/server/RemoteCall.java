...
/**
 * <code>RemoteCall</code> is an abstraction used solely by the RMI runtime (in
 * conjunction with stubs and skeletons of remote objects) to carry out a call
 * to a remote object. The <code>RemoteCall</code> interface is deprecated
 * because it is only used by deprecated methods of
...
public interface RemoteCall {
	...
	/**
	 * Release the output stream; in some transports this would release the
	 * stream.
	 *
	 * @exception java.io.IOException
	 *            if an I/O error occurs.
	...
	/**
	 * Get the InputStream that the stub/skeleton should get results/arguments
	 * from.
	 *
