...
/**
 * <code>LogStream</code> provides a mechanism for logging errors that are of
 * possible interest to those monitoring a system.
 *
...
public class LogStream extends PrintStream {
    ...
    /**
     * Create a new LogStream object. Since this only constructor is private,
    ...
    /**
     * Return the LogStream identified by the given name. If a log corresponding
     ...
     * currently buffered line is sent to the log's output stream, prefixed with
