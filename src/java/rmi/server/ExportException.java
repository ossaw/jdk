...
/**
 * An <code>ExportException</code> is a <code>RemoteException</code> thrown if
 * an attempt to export a remote object fails. A remote object is exported via
 * the constructors and <code>exportObject</code> methods of
