 ...
 * invalid. An <code>ActivationID</code> is invalid if it is not currently known
 * by the <code>ActivationSystem</code>. An <code>ActivationID</code> is
 * obtained by the <code>ActivationSystem.registerObject</code> method. An
 * <code>ActivationID</code> is also obtained during the
