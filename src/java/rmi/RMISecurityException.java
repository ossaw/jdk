...
/**
 * An <code>RMISecurityException</code> signals that a security exception has
 * occurred during the execution of one of
 * <code>java.rmi.RMISecurityManager</code>'s methods.
 *
 * @author Roger Riggs
 * @since JDK1.1
 * @deprecated Use {@link java.lang.SecurityException} instead. Application code
 *             should never directly reference this class, and
