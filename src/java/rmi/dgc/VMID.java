...
public final class VMID implements java.io.Serializable {
    ...
    /**
     * Create a new VMID. Each new VMID returned from this constructor is unique
     * for all Java virtual machines under the following conditions: a) the
     * conditions for uniqueness for objects of the class
     * <code>java.rmi.server.UID</code> are satisfied, and b) an address can be
     * obtained for this host that is unique and constant for the lifetime of
     * this object.
     */
    public VMID() {
        addr = randomBytes;
    ...
    /**
     * Return true if an accurate address can be determined for this host. If
     * false, reliable VMID cannot be generated from this host
     * 
    ...
    /**
     * Compare this VMID to another, and return true if they are the same
     * identifier.
     */
