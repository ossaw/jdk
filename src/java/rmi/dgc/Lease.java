...
/**
 * A lease contains a unique VM identifier and a lease duration. A Lease object
 * is used to request and grant leases to remote object references.
 */
public final class Lease implements java.io.Serializable {
	...
	/**
	 * Constructs a lease with a specific VMID and lease duration. The vmid may
	 * be null.
	 * 
	 * @param id
