...
public interface Adjustable {
     ...
     * 
     * @return the orientation of the adjustable object; either
     *         <code>HORIZONTAL</code>, <code>VERTICAL</code>, or
     *         <code>NO_ORIENTATION</code>
     */
    int getOrientation();
    ...
    /**
     * Sets the current value of the adjustable object. If the value supplied is
     * less than <code>minimum</code> or greater than <code>maximum</code> -
     * <code>visibleAmount</code>, then one of those values is substituted, as
     * appropriate.
     * <p>
    ...
    /**
     * Adds a listener to receive adjustment events when the value of the
