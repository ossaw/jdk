 ...
 * Simple, Check, and More Examples." style="float:center; margin: 7px 10px;">
 * <p>
...
public class MenuBar extends MenuComponent implements MenuContainer,
    ...
    /**
     * This field represents a vector of the actual menus that will be part of
     * the MenuBar.
     *
     * @serial
     * @see #countMenus()
    ...
    /**
     * This menu is a special menu dedicated to help. The one thing to note
     * about this menu is that on some platforms it appears at the right edge of
     * the menubar.
     *
     * @serial
     * @see #getHelpMenu()
    ...
    /**
     * Creates the menu bar's peer. The peer allows us to change the appearance
     * of the menu bar without changing any of the menu bar's functionality.
     */
    ...
    /**
     * Removes the menu bar's peer. The peer allows us to change the appearance
     * of the menu bar without changing any of the menu bar's functionality.
     */
    ...
    /**
     * Sets the specified menu to be this menu bar's help menu. If this menu bar
     * has an existing help menu, the old help menu is removed from the menu
    ...
    /**
     * Adds the specified menu to the menu bar. If the menu has been part of
     ...
     * 
     * @return an enumeration of menu shortcuts that this menu bar is managing.
     * @see java.awt.MenuShortcut
     * @since JDK1.1
     */
    ...
    /**
     * Gets the instance of <code>MenuItem</code> associated with the specified
     * <code>MenuShortcut</code> object, or <code>null</code> if none of the
     * menu items being managed by this menu bar is associated with the
    ...
    /*
     * Post an ACTION_EVENT to the target of the MenuPeer associated with the
    ...
    /*
     * Serialization support. Restore the (transient) parent fields of Menubar
     * menus here.
     */
    ...
    /**
     * Gets the AccessibleContext associated with this MenuBar. For menu bars,
     * the AccessibleContext takes the form of an AccessibleAWTMenuBar. A new
     * AccessibleAWTMenuBar instance is created if necessary.
     *
     * @return an AccessibleAWTMenuBar that serves as the AccessibleContext of
     *         this MenuBar
     * @since 1.3
     */
     ...
     * <p>
     * This class implements accessibility support for the <code>MenuBar</code>
