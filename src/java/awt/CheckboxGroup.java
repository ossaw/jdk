 ...
 * <p>
 * Exactly one check box button in a <code>CheckboxGroup</code> can be in the
 * "on" state at any given time. Pushing any button sets its state to "on" and
 * forces any other button that is in the "on" state into the "off" state.
 * <p>
