 ...
 * <IMG SRC="doc-files/MenuBar-1.gif" alt=
 * "The following text describes this graphic." style=
 * "float:center; margin: 7px 10px;"> <br style="clear:left;">
...
public class MenuItem extends MenuComponent implements Accessible {
    ...
    /**
     * A value to indicate whether a menu item is enabled or not. If it is
     * enabled, <code>enabled</code> will be set to true. Else
     * <code>enabled</code> will be set to false.
     *
     * @serial
     * @see #isEnabled()
    ...
    /**
     * <code>label</code> is the label of a menu item. It can be any string.
     *
     * @serial
     * @see #getLabel()
     * @see #setLabel(String)
    ...
    /**
     * This field indicates the command tha has been issued by a particular menu
     * item. By default the <code>actionCommand</code> is the label of the menu
     * item, unless it has been set using setActionCommand.
     *
     * @serial
    ...
    /**
     * A sequence of key stokes that ia associated with a menu item. Note :in
     * 1.1.2 you must use setActionCommand() on a menu item in order for its
     * shortcut to work.
     *
     * @serial
     * @see #getShortcut()
     ...
     * shortcut. Note that use of "-" in a label is reserved to indicate a
     * separator between menu items. By default, all menu items except for
     ...
     * "-" in a label is reserved to indicate a separator between menu items. By
    ...
    /**
     * Creates the menu item's peer. The peer allows us to modify the appearance
     * of the menu item without changing its functionality.
     */
     ...
     * 
     * @return the label of this menu item, or <code>null</code> if this menu
     *         item has no label.
     ...
     * 
     * @return the menu shortcut associated with this menu item, or
     ...
     * If a menu shortcut is already associated with this menu item, it is
     * replaced.
     * 
     * @param s
    ...
    /**
     * Delete any <code>MenuShortcut</code> object associated with this menu
     * item.
     * 
     * @since JDK1.1
     */
    ...
    /*
     * Delete a matching MenuShortcut associated with this MenuItem. Used when
     * iterating Menus.
     */
    ...
    /*
     * The main goal of this method is to post an appropriate event to the event
     * queue when menu shortcut is pressed. However, in subclasses this method
    ...
    /*
     * Returns true if the item and all its ancestors are enabled, false
     * otherwise
     */
    ...
    /*
     * Post an ActionEvent to the target (on keydown) and the item is enabled.
    ...
    boolean handleShortcut(KeyEvent e) {
        ...
        MenuShortcut sE = new MenuShortcut(e.getExtendedKeyCode(), (e.getModifiers()
     ...
     * <p>
     * Since event types are automatically enabled when a listener for that type
     * is added to the menu item, this method only needs to be invoked by
     * subclasses of <code>MenuItem</code> which desire to have the specified
     * event types delivered to <code>processEvent</code> regardless of whether
    ...
    /**
     * Disables event delivery to this menu item for events defined by the
     * specified event mask parameter.
     *
    ...
    /**
     * Sets the command name of the action event that is fired by this menu
     * item.
     * <p>
    ...
    /**
     * Gets the command name of the action event that is fired by this menu
     * item.
     * 
     ...
     * menu item. If l is null, no exception is thrown and no action is
     * performed.
     * <p>
     ...
     * events from this menu item. If l is null, no exception is thrown and no
     * action is performed.
     * <p>
     * Refer to <a href="doc-files/AWTThreadIssues.html#ListenersThreads" >AWT
     * Threading Issues</a> for details on AWT's threading model.
    ...
    /**
     * Returns an array of all the action listeners registered on this menu
     * item.
     *
     * @return all of this menu item's <code>ActionListener</code>s or an empty
     ...
     * <code><em>Foo</em>Listener</code>s upon this <code>MenuItem</code>.
     ...
     * you can query a <code>MenuItem</code> <code>m</code> for its action
     ...
     * <code>ActionEvent</code>, it invokes <code>processActionEvent</code>,
     * another method defined by <code>MenuItem</code>.
     * <p>
    ...
    /**
     * Processes action events occurring on this menu item, by dispatching them
     * to any registered <code>ActionListener</code> objects. This method is not
     * called unless action events are enabled for this component. Action events
     ...
     * serializable <code>ActionListeners</code> as optional data. The
     ...
     * <code>null</code> adds a listener to receive action events fired by the
    ...
    /**
     * Gets the AccessibleContext associated with this MenuItem. For menu items,
     * the AccessibleContext takes the form of an AccessibleAWTMenuItem. A new
     * AccessibleAWTMenuItem instance is created if necessary.
     *
     * @return an AccessibleAWTMenuItem that serves as the AccessibleContext of
     *         this MenuItem
     * @since 1.3
     */
     ...
     * developers.
     * <p>
     * This class implements accessibility support for the <code>MenuItem</code>
     * class. It provides an implementation of the Java Accessibility API
     * appropriate to menu item user-interface elements.
     * 
     * @since 1.3
     */
    protected class AccessibleAWTMenuItem extends AccessibleAWTMenuComponent implements AccessibleAction,
            AccessibleValue {
        /*
         ...
         * behavior of a menu item is to have one action.
         *
        ...
        public boolean doAccessibleAction(int i) {
            if (i == 0) {
                ...
                Toolkit.getEventQueue().postEvent(new ActionEvent(MenuItem.this, ActionEvent.ACTION_PERFORMED,
                        MenuItem.this.getActionCommand(), EventQueue.getMostRecentEventTime(), 0));
                return true;
            } else {
                return false;
            }
