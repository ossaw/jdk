...
public class GridBagConstraints implements Cloneable, java.io.Serializable {
	 ...
	 * or row (<code>gridwidth</code>, <code>gridheight</code>), or that this
	 * component be placed next to the previously added component (
	 * <code>gridx</code>, <code>gridy</code>).
	 * 
	 ...
	 * {@code ComponentOrientation}. Equal to NORTH for horizontal orientations.
	 */
	 ...
	 * {@code ComponentOrientation}. Equal to SOUTH for horizontal orientations.
	 */
	 ...
	 * {@code ComponentOrientation}. Equal to WEST for horizontal, left-to-right
	 ...
	 * {@code ComponentOrientation}. Equal to EAST for horizontal, left-to-right
	...
	/**
	 * Possible value for the <code>anchor</code> field. Specifies that the
	 * component should be horizontally centered and vertically aligned along
	 * the baseline of the prevailing row. If the component does not have a
	 * baseline it will be vertically centered.
	 *
	 * @since 1.6
	 */
	...
	/**
	 * Possible value for the <code>anchor</code> field. Specifies that the
	 * component should be horizontally placed along the leading edge. For
	 * components with a left-to-right orientation, the leading edge is the left
	 * edge. Vertically the component is aligned along the baseline of the
	 * prevailing row. If the component does not have a baseline it will be
	 * vertically centered.
	 *
	 * @since 1.6
	 */
	...
	/**
	 * Possible value for the <code>anchor</code> field. Specifies that the
	 * component should be horizontally placed along the trailing edge. For
	 * components with a left-to-right orientation, the trailing edge is the
	 * right edge. Vertically the component is aligned along the baseline of the
	 * prevailing row. If the component does not have a baseline it will be
	 * vertically centered.
	 *
	 * @since 1.6
	...
	/**
	 * Possible value for the <code>anchor</code> field. Specifies that the
	 * component should be horizontally centered. Vertically the component is
	 * positioned so that its bottom edge touches the baseline of the starting
	 * row. If the starting row does not have a baseline it will be vertically
	 * centered.
	 *
	 * @since 1.6
	 */
	 ...
	 * component should be horizontally placed along the leading edge. For
	 * components with a left-to-right orientation, the leading edge is the left
	 * edge. Vertically the component is positioned so that its bottom edge
	 * touches the baseline of the starting row. If the starting row does not
	 ...
	 * component should be horizontally placed along the trailing edge. For
	 * components with a left-to-right orientation, the trailing edge is the
	 * right edge. Vertically the component is positioned so that its bottom
	 * edge touches the baseline of the starting row. If the starting row does
	 * not have a baseline it will be vertically centered.
	 *
	 * @since 1.6
	 */
	 ...
	 * Possible value for the <code>anchor</code> field. Specifies that the
	 * component should be horizontally centered. Vertically the component is
	 * positioned so that its top edge touches the baseline of the starting row.
	 * If the starting row does not have a baseline it will be vertically
	 * centered.
	 *
	 * @since 1.6
	 */
	 ...
	 * component should be horizontally placed along the leading edge. For
	 * components with a left-to-right orientation, the leading edge is the left
	 * edge. Vertically the component is positioned so that its top edge touches
	 * the baseline of the starting row. If the starting row does not have a
	 * baseline it will be vertically centered.
	 *
	 * @since 1.6
	 */
	 ...
	 * component should be horizontally placed along the trailing edge. For
	 * components with a left-to-right orientation, the trailing edge is the
	 * right edge. Vertically the component is positioned so that its top edge
	 * touches the baseline of the starting row. If the starting row does not
	 * have a baseline it will be vertically centered.
	 *
	 * @since 1.6
	 ...
	 * right-to-left container. The value <code>RELATIVE</code> specifies that
	 * the component be placed immediately following the component that was
	 * added to the container just before this component was added.
	 * <p>
	 * The default value is <code>RELATIVE</code>. <code>gridx</code> should be
	 ...
	 * added to the container just before this component was added.
	 * <p>
	 * The default value is <code>RELATIVE</code>. <code>gridy</code> should be
	 * a non-negative value.
	 * 
	 * @serial
	 * @see #clone()
	 ...
	 * <code>RELATIVE</code> to specify that the component's display area will
	 * be from <code>gridx</code> to the next to the last one in its row.
	 * <p>
	 ...
	 * <code>RELATIVE</code> to specify that the component's display area will
	 * be from <code>gridy</code> to the next to the last one in its column.
	 * <p>
	 ...
	 * weight. A column that has a weight of zero receives no extra space.
	 * <p>
	 ...
	 * resulting layout is smaller vertically than the area it needs to fill,
	 * the extra space is distributed to each row in proportion to its weight. A
	 * row that has a weight of zero receives no extra space.
	 * <p>
	 * If all the weights are zero, all the extra space appears between the
	 ...
	 * component is at least its minimum width plus <code>ipadx</code> pixels.
	 * <p>
	...
	/**
	 * Creates a <code>GridBagConstraint</code> object with all of its fields
