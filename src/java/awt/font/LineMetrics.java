...
public abstract class LineMetrics {
	...
	/**
	 * Returns the number of characters (<code>char</code> values) in the text
	 * whose metrics are encapsulated by this <code>LineMetrics</code> object.
	 * 
	 * @return the number of characters (<code>char</code> values) in the text
	 *         with which this <code>LineMetrics</code> was created.
	 */
	 ...
	 * from the bottom of the descender line to the top of the next line.
	 * 
	...
	/**
	 * Returns the baseline offsets of the text, relative to the baseline of the
	 * text. The offsets are indexed by baseline index. For example, if the
	 * baseline index is <code>CENTER_BASELINE</code> then
	 * <code>offsets[HANGING_BASELINE]</code> is usually negative,
	 * <code>offsets[CENTER_BASELINE]</code> is zero, and
	 * <code>offsets[ROMAN_BASELINE]</code> is usually positive.
	 * 
