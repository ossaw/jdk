...
/**
 * The <code>OpenType</code> interface represents OpenType and TrueType fonts.
 * This interface makes it possible to obtain <i>sfnt</i> tables from the font.
 * A particular <code>Font</code> object can implement this interface.
 * <p>
 * For more information on TrueType and OpenType fonts, see the OpenType
 * specification. (
 * <a href="http://www.microsoft.com/typography/otspec/">http://www.microsoft.
 * com/typography/otspec/</a> ).
 */
public interface OpenType {
    ...
    /**
     * Character to glyph mapping. Table tag "cmap" in the Open Type
     * Specification.
     */
    ...
    /**
     * Horizontal device metrics. Table tag "hdmx" in the Open Type
     * Specification.
     */
    ...
    /**
     * OS/2 and Windows specific metrics. Table tag "OS/2" in the Open Type
     * Specification.
     */
    ...
    /**
     * Grid-fitting and scan conversion procedure. Table tag "gasp" in the Open
     * Type Specification.
     */
    ...
    /**
     * Horizontal metrics header. Table tag "hhea" in the Open Type
     * Specification.
     */
    ...
    /**
     * Embedded bitmap location. Table tag "EBLC" in the Open Type
     * Specification.
     */
    ...
    /**
     * Returns the version of the <code>OpenType</code> font. 1.0 is represented
     * as 0x00010000.
     * 
    ...
    /**
     * Returns the table as an array of bytes for a specified tag. Tags for sfnt
     * tables include items like <i>cmap</i>, <i>name</i> and <i>head</i>. The
     ...
     * Tags for sfnt tables include items like <i>cmap</i>, <i>name</i> and
     * <i>head</i>. The byte array returned is a copy of the font data in
     * memory.
     * 
     * @param sfntTag
     *                a four-character code as a 32-bit integer
     ...
     * Returns a subset of the table as an array of bytes for a specified tag.
     * Tags for sfnt tables include items like <i>cmap</i>, <i>name</i> and
     * <i>head</i>. The <code>byte</code> array returned is a copy of the font
     * data in memory.
     * 
     * @param strSfntTag
     *                   a four-character code as a <code>String</code>
    ...
    /**
     * Returns the size of the table for a specified tag. Tags for sfnt tables
