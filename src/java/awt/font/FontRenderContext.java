...
public class FontRenderContext {
	...
	/**
	 * Constructs a new <code>FontRenderContext</code> object.
	 *
	 */
	...
	/**
	 * Constructs a <code>FontRenderContext</code> object from an optional
	 * {@link AffineTransform} and two <code>boolean</code> values that
	 * determine if the newly constructed object has anti-aliasing or fractional
	 * metrics. In each case the boolean values <CODE>true</CODE> and
	 * <CODE>false</CODE> correspond to the rendering hint values
	 * <CODE>ON</CODE> and <CODE>OFF</CODE> respectively.
	 * <p>
	 * To specify other hint values, use the constructor which specifies the
	 * rendering hint values as parameters :
	 * {@link #FontRenderContext(AffineTransform, Object, Object)}.
	 * 
	 * @param tx
	 *            the transform which is used to scale typographical points to
	 *            pixels in this <code>FontRenderContext</code>. If null, an
	 *            identity transform is used.
	 * @param isAntiAliased
	 *            determines if the newly constructed object has anti-aliasing.
	 * @param usesFractionalMetrics
	 *            determines if the newly constructed object has fractional
	 *            metrics.
	 */
	...
	/**
	 * Constructs a <code>FontRenderContext</code> object from an optional
	 * {@link AffineTransform} and two <code>Object</code> values that determine
	 ...
	 *            identity transform is used.
	 * @param aaHint
	 *            - one of the text antialiasing rendering hint values defined
	 *            in {@link java.awt.RenderingHints java.awt.RenderingHints}.
	 *            Any other value will throw
	 *            <code>IllegalArgumentException</code>.
	 *            {@link java.awt.RenderingHints#VALUE_TEXT_ANTIALIAS_DEFAULT
	 *            VALUE_TEXT_ANTIALIAS_DEFAULT} may be specified, in which case
	 *            the mode used is implementation dependent.
	 * @param fmHint
	 *            - one of the text fractional rendering hint values defined in
	 *            {@link java.awt.RenderingHints java.awt.RenderingHints}.
	 *            {@link java.awt.RenderingHints#VALUE_FRACTIONALMETRICS_DEFAULT
	 *            VALUE_FRACTIONALMETRICS_DEFAULT} may be specified, in which
	 *            case the mode used is implementation dependent. Any other
	 *            value will throw <code>IllegalArgumentException</code>
	 * @throws IllegalArgumentException
	 *             if the hints are not one of the legal values.
	 * @since 1.6
	 */
	 ...
	 * 
	 * @return <code>true</code> if this <code>FontRenderContext</code> object
	 *         has a non-identity AffineTransform attribute. <code>false</code>
	 *         otherwise.
	...
	/**
	 * Gets the transform that is used to scale typographical points to pixels
	 ...
	 * antialiasing is specified by this <code>FontRenderContext</code>. Call
	 * {@link #getAntiAliasingHint() getAntiAliasingHint()} for the specific
	...
	/**
	 * Returns a boolean which whether text fractional metrics mode is used in
	 * this <code>FontRenderContext</code>. Call
	 * {@link #getFractionalMetricsHint() getFractionalMetricsHint()} to obtain
	 * the corresponding rendering hint value.
	 * 
	 * @return <code>true</code>, if layout should be performed with fractional
	 *         metrics; <code>false</code> otherwise. in this
	 *         <code>FontRenderContext</code>.
	 * @see java.awt.RenderingHints#KEY_FRACTIONALMETRICS
	 * @see #FontRenderContext(AffineTransform,boolean,boolean)
	 * @see #FontRenderContext(AffineTransform,Object,Object)
	 ...
	 * <code>FontRenderContext</code>. This will be one of the text antialiasing
	 * rendering hint values defined in {@link java.awt.RenderingHints
	 ...
	 * <code>FontRenderContext</code>. This will be one of the text fractional
	 * metrics rendering hint values defined in {@link java.awt.RenderingHints
	 * java.awt.RenderingHints}.
	 * 
	 * @return the text fractional metrics rendering mode hint used in this
	 *         <code>FontRenderContext</code>.
	...
	/**
	 * Return true if rhs has the same transform, antialiasing, and fractional
	 * metrics values as this.
	 * 
	 * @param rhs
	 *            the <code>FontRenderContext</code> to test for equality
	 * @return <code>true</code> if <code>rhs</code> is equal to this
	 *         <code>FontRenderContext</code>; <code>false</code> otherwise.
	 * @since 1.4
	 */
	...
	public int hashCode() {
		...
		/*
		 * SunHints value objects have identity hashcode, so we can rely on this
		 * to ensure that two equal FRC's have the same hashcode.
		 */
		if (defaulting) {
