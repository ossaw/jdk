...
public final class TextMeasurer implements Cloneable {
    ...
    private void generateComponents(int startingAt, int endingAt) {
        ...
        try {
            fComponents = TextLine.getComponents(fParagraph, fChars, startingAt, endingAt, charsLtoV, fLevels,
                    factory);
    ...
    private TextLineComponent[] makeComponentsOnRange(int startPos, int limitPos) {
        ...
        while (linePos < limitPos) {
            ...
            components[newCompIndex++] = fComponents[tlcIndex].getSubset(start - tlcStart, limit - tlcStart,
                    subsetFlag);
            linePos += (limit - start);
            if (linePos == breakPt) {
                breakPt = limitPos;
    ...
    private TextLine makeTextLineOnRange(int startPos, int limitPos) {
        ...
        return new TextLine(fFrc, components, fBaselineOffsets, fChars, startPos, limitPos, charsLtoV,
                charLevels, fIsDirectionLTR);
    ...
    public void insertChar(AttributedCharacterIterator newParagraph, int insertPos) {
        ...
        if (fBidi != null || Bidi.requiresBidi(newChars, newCharIndex, newCharIndex + 1) || newParagraph
                .getAttribute(TextAttribute.BIDI_EMBEDDING) != null) {
