...
public final class GlyphJustificationInfo {
    ...
    public GlyphJustificationInfo(float weight, boolean growAbsorb, int growPriority, float growLeftLimit,
            float growRightLimit, boolean shrinkAbsorb, int shrinkPriority, float shrinkLeftLimit,
    ...
    /**
     * If <code>true</code>, this glyph absorbs all extra space at this and
    ...
    /**
     * If <code>true</code>,this glyph absorbs all remaining shrinkage at this
     * and lower priority levels as it shrinks.
     */
    public final boolean shrinkAbsorb;

    /**
     * The maximum amount by which the left side of this glyph can shrink (a
     * positive number).
     */
    public final float shrinkLeftLimit;

    /**
     * The maximum amount by which the right side of this glyph can shrink (a
     * positive number).
     */
