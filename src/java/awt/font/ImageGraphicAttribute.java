 ...
 * {@link GraphicAttribute} which draws images in a {@link TextLayout}.
 * 
...
public final class ImageGraphicAttribute extends GraphicAttribute {
	 ...
	 * <code>Image</code>. The point (<code>originX</code>,&nbsp;
	 * <code>originY</code>) in the <code>Image</code> appears at the origin of
	...
	/**
	 * Returns the ascent of this <code>ImageGraphicAttribute</code>. The ascent
	 * of an <code>ImageGraphicAttribute</code> is the distance from the top of
	 * the image to the origin.
	 * 
	...
	/**
	 * Returns the descent of this <code>ImageGraphicAttribute</code>. The
	 * descent of an <code>ImageGraphicAttribute</code> is the distance from the
	...
	/**
	 * Returns the advance of this <code>ImageGraphicAttribute</code>. The
	 * advance of an <code>ImageGraphicAttribute</code> is the distance from the
	 * origin to the right edge of the image.
	 * 
	...
	/**
	 * Returns a {@link Rectangle2D} that encloses all of the bits rendered by
	 * this <code>ImageGraphicAttribute</code>, relative to the rendering
	 * position. A graphic can be rendered beyond its origin, ascent, descent,
	 * or advance; but if it is, this method's implementation must indicate
	 * where the graphic is rendered.
	 * 
	 * @return a <code>Rectangle2D</code> that encloses all of the bits rendered
	 *         by this <code>ImageGraphicAttribute</code>.
	 */
