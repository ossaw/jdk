...
/**
 * This class stores Font, GraphicAttribute, and Decoration intervals on a
...
final class StyledParagraph {
    ...
    /**
     * Adjust indices in starts to reflect an insertion after pos. Any index in
     * starts greater than pos will be increased by 1.
     */
     ...
     * into the text. This method will attempt to reuse the given paragraph, but
    ...
    /**
     * Adjust indices in starts to reflect a deletion after deleteAt. Any index
     * in starts greater than deleteAt will be increased by 1. It is the
     * caller's responsibility to make sure that no 0-length runs result.
     */
    ...
    /**
     * Return the Font or GraphicAttribute in effect at the given index. The
    ...
    /**
     * Return i such that starts[i] &lt;= index &lt; starts[i+1]. starts must be
     * in increasing order, with at least one element greater than index.
     */
    ...
    /**
     * Append the given Object to the given Vector. Add the given index to the
     * given starts array. If the starts array does not have room for the index,
    ...
    /**
     * Add a new Font/GraphicAttribute run with the given object at the given
     * index.
     */
    ...
    /**
     * Extract a GraphicAttribute or Font from the given attributes. If
