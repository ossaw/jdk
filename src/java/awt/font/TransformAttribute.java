...
/**
 * The <code>TransformAttribute</code> class provides an immutable wrapper for a
 * transform so that it is safe to use as an attribute.
 */
public final class TransformAttribute implements Serializable {

	/**
	 * The <code>AffineTransform</code> for this <code>TransformAttribute</code>
	 * , or <code>null</code> if <code>AffineTransform</code> is the identity
	 * transform.
	 */
	private AffineTransform transform;

	/**
	 * Wraps the specified transform. The transform is cloned and a reference to
	 * the clone is kept. The original transform is unchanged. If null is passed
	 * as the argument, this constructor behaves as though it were the identity
	 * transform. (Note that it is preferable to use {@link #IDENTITY} in this
	 * case.)
	 * 
	 * @param transform
	 ...
	 * transform.
	 * 
	 * @return <code>true</code> if the wrapped transform is an identity
