...
public final class ShapeGraphicAttribute extends GraphicAttribute {
	...
	/**
	 * Returns the ascent of this <code>ShapeGraphicAttribute</code>. The ascent
	 * of a <code>ShapeGraphicAttribute</code> is the positive distance from the
	 * origin of its <code>Shape</code> to the top of bounds of its
	 * <code>Shape</code>.
	 * 
	...
	/**
	 * Returns the descent of this <code>ShapeGraphicAttribute</code>. The
	 * descent of a <code>ShapeGraphicAttribute</code> is the distance from the
	 * origin of its <code>Shape</code> to the bottom of the bounds of its
	 * <code>Shape</code>.
	 * 
	...
	/**
	 * Returns the advance of this <code>ShapeGraphicAttribute</code>. The
	 * advance of a <code>ShapeGraphicAttribute</code> is the distance from the
	 * origin of its <code>Shape</code> to the right side of the bounds of its
	 * <code>Shape</code>.
	 * 
	 ...
	 * <code>ShapeGraphicAttribute</code> relative to the rendering position. A
	 * graphic can be rendered beyond its origin, ascent, descent, or advance;
	 * but if it does, this method's implementation should indicate where the
	 * graphic is rendered.
	 * 
	 * @return a <code>Rectangle2D</code> that encloses all of the bits rendered
	 *         by this <code>ShapeGraphicAttribute</code>.
	 */
	 ...
	 * <code>ShapeGraphicAttribute</code> renders. This is used when a
	 ...
	 * 
	 * @return a hash code value for this <code>ShapeGraphicAttribute</code>.
	 */
	public int hashCode() {
