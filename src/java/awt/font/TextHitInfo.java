...
/**
 * The <code>TextHitInfo</code> class represents a character position in a text
 ...
 * <EM>trailing</EM> (the right edge, for a left-to-right character). Instances
 * of <code>TextHitInfo</code> are used to specify caret and insertion positions
 * within text.
 * <p>
 * For example, consider the text "abc". TextHitInfo.trailing(1) corresponds to
 * the right side of the 'b' in the text.
 * <p>
 * <code>TextHitInfo</code> is used primarily by {@link TextLayout} and clients
 * of <code>TextLayout</code>. Clients of <code>TextLayout</code> query
 * <code>TextHitInfo</code> instances for an insertion offset, where new text is
 * inserted into the text model. The insertion offset is equal to the character
 * position in the <code>TextHitInfo</code> if the bias is leading, and one
 * character after if the bias is trailing. The insertion offset for
 * TextHitInfo.trailing(1) is 2.
 * <p>
 * Sometimes it is convenient to construct a <code>TextHitInfo</code> with the
 * same insertion offset as an existing one, but on the opposite character. The
 * <code>getOtherHit</code> method constructs a new <code>TextHitInfo</code>
 * with the same insertion offset as an existing one, with a hit on the
 * character on the other side of the insertion offset. Calling
 * <code>getOtherHit</code> on trailing(1) would return leading(2). In general,
 * <code>getOtherHit</code> for trailing(n) returns leading(n+1) and
 * <code>getOtherHit</code> for leading(n) returns trailing(n-1).
 * <p>
...
public final class TextHitInfo {
     ...
     * 
     * @return <code>true</code> if the leading edge of the character was hit;
    ...
    /**
     * Returns the insertion index. This is the character index if the leading
     * edge of the character was hit, and one greater than the character index
     * if the trailing edge was hit.
     * 
     ...
     * 
     * @return the hash code of this <code>TextHitInfo</code>, which is also the
     *         <code>charIndex</code> of this <code>TextHitInfo</code>.
     */
    public int hashCode() {
        return charIndex;
    }
    ...
    /**
     * Returns <code>true</code> if the specified <code>TextHitInfo</code> has
     * the same <code>charIndex</code> and <code>isLeadingEdge</code> as this
     * <code>TextHitInfo</code>. This is not the same as having the same
     * insertion offset.
     * 
     * @param hitInfo
    ...
    /**
     * Returns a <code>String</code> representing the hit for debugging use
     * only.
     * 
     * @return a <code>String</code> representing this <code>TextHitInfo</code>.
     */
    ...
    /**
     * Creates a <code>TextHitInfo</code> on the leading edge of the character
    ...
    /**
     * Creates a <code>TextHitInfo</code> at the specified offset, associated
    ...
    /**
     * Creates a <code>TextHitInfo</code> on the other side of the insertion
     * point. This <code>TextHitInfo</code> remains unchanged.
     * 
     * @return a <code>TextHitInfo</code> on the other side of the insertion
     *         point.
     */
    ...
    /**
     * Creates a <code>TextHitInfo</code> whose character index is offset by
     * <code>delta</code> from the <code>charIndex</code> of this
