 ...
 * <p>
 * A dialog may have its native decorations (i.e. Frame &amp; Titlebar) turned
 * off with <code>setUndecorated</code>. This can only be done while the dialog
...
public class Dialog extends Window {
    ...
    /**
     * A dialog's resizable property. Will be true if the Dialog is to be
    ...
    /**
     * This field indicates whether the dialog is undecorated. This property can
     * only be changed while the dialog is not displayable.
     * <code>undecorated</code> will be true if the dialog is undecorated,
     ...
     * particular window is blocked depends on dialog's type of modality; this
     * is called the "scope of blocking". The <code>ModalityType</code> enum
     * specifies modal types and their associated scopes.
     *
    ...
    public static enum ModalityType {
        ...
        MODELESS,
        /**
         * A <code>DOCUMENT_MODAL</code> dialog blocks input to all top-level
         * windows from the same document except those from its own child
         * hierarchy. A document is a top-level window without an owner. It may
         * contain child windows that, together with the top-level window are
         * treated as a single solid document. Since every top-level window must
         * belong to some document, its root can be found as the top-nearest
         * window without an owner.
         */
        DOCUMENT_MODAL,
        /**
         * An <code>APPLICATION_MODAL</code> dialog blocks all top-level windows
         * from the same Java application except those from its own child
         * hierarchy. If there are several applets launched in a browser, they
         * can be treated either as separate applications or a single one. This
         * behavior is implementation-dependent.
         */
        APPLICATION_MODAL,
        /**
         * A <code>TOOLKIT_MODAL</code> dialog blocks all top-level windows run
         * from the same toolkit except those from its own child hierarchy. If
         * there are several applets launched in a browser, all of them run with
         * the same toolkit; thus, a toolkit-modal dialog displayed by an applet
         * may affect other applets and all windows of the browser instance
         * which embeds the Java runtime environment for this toolkit. Special
         * <code>AWTPermission</code> "toolkitModality" must be granted to use
         * toolkit-modal dialogs. If a <code>TOOLKIT_MODAL</code> dialog is
         * being created and this permission is not granted, a
         * <code>SecurityException</code> will be thrown, and no dialog will be
         * created. If a modality type is being changed to
         * <code>TOOLKIT_MODAL</code> and this permission is not granted, a
         * <code>SecurityException</code> will be thrown, and the modality type
     ...
     * <code>APPLICATION_MODAL</code>. Calling the oldstyle
     * <code>setModal(true)</code> is equal to
     * <code>setModalityType(DEFAULT_MODALITY_TYPE)</code>.
     *
    ...
    /**
     * True if this dialog is modal, false is the dialog is modeless. A modal
     * dialog blocks user input to some application top-level windows. This
     * field is kept only for backwards compatibility. Use the
     ...
     * This is called "modal exclusion". This enum specifies the possible modal
     * exclusion types.
     *
    ...
    public static enum ModalExclusionType {
         ...
         * blocked by document-modal dialogs from outside of its child
         * hierarchy.
         */
        APPLICATION_EXCLUDE,
        /**
         * <code>TOOLKIT_EXCLUDE</code> indicates that a top-level window won't
         * be blocked by application-modal or toolkit-modal dialogs. Also, it
         * isn't blocked by document-modal dialogs from outside of its child
         * hierarchy. The "toolkitModality" <code>AWTPermission</code> must be
         * granted for this exclusion. If an exclusion property is being changed
         * to <code>TOOLKIT_EXCLUDE</code> and this permission is not granted, a
     ...
     * specified owner <code>Frame</code> and an empty title.
     *
     * @param owner
     *              the owner of the dialog or <code>null</code> if this dialog
     *              has no owner
     * @exception                   java.lang.IllegalArgumentException
     *                              if the <code>owner</code>'s
     *                              <code>GraphicsConfiguration</code> is not
     *                              from a screen
     *                              device
     ...
     *              top-level
     *              windows when shown. If <code>false</code>, the dialog is
     *              <code>MODELESS</code>; if <code>true</code>, the modality
     *              type
    ...
    /**
     * Constructs an initially invisible, modeless <code>Dialog</code> with the
     * specified owner <code>Frame</code> and title.
     *
     * @param owner
     *              the owner of the dialog or <code>null</code> if this dialog
     *              has no owner
     * @param title
     *              the title of the dialog or <code>null</code> if this dialog
     *              has no title
     * @exception IllegalArgumentException
     *                                     if the <code>owner</code>'s
     *                                     <code>GraphicsConfiguration</code> is
     *                                     not from a screen
     *                                     device
     * @exception HeadlessException
     *                                     when
    ...
    /**
     * Constructs an initially invisible <code>Dialog</code> with the specified
     * owner <code>Frame</code>, title and modality.
     *
     * @param owner
     *              the owner of the dialog or <code>null</code> if this dialog
     *              has no owner
    ...
    /**
     * Constructs an initially invisible <code>Dialog</code> with the specified
     * owner <code>Frame</code>, title, modality, and
     ...
     *              device; if <code>null</code>, the default system
    ...
    /**
     * Constructs an initially invisible, modeless <code>Dialog</code> with the
     * specified owner <code>Dialog</code> and an empty title.
     *
     * @param owner
     *              the owner of the dialog or <code>null</code> if this dialog
     *              has no owner
    ...
    /**
     * Constructs an initially invisible, modeless <code>Dialog</code> with the
     * specified owner <code>Dialog</code> and title.
     *
     * @param owner
     *              the owner of the dialog or <code>null</code> if this has no
     *              owner
     * @param title
     *              the title of the dialog or <code>null</code> if this dialog
     *              has no title
    ...
    /**
     * Constructs an initially invisible <code>Dialog</code> with the specified
     * owner <code>Dialog</code>, title, and modality.
     *
     * @param owner
     *              the owner of the dialog or <code>null</code> if this dialog
     *              has no owner
    ...
    /**
     * Constructs an initially invisible <code>Dialog</code> with the specified
     * owner <code>Dialog</code>, title, modality and
     * <code>GraphicsConfiguration</code>.
     *
     * @param owner
     *              the owner of the dialog or <code>null</code> if this dialog
     ...
     *              {@link java.awt.Dialog Dialog}, {@link java.awt.Frame
     *              Frame},
     *              any of their descendents or <code>null</code>
     *
     * @exception                   java.lang.IllegalArgumentException
     *                              if the <code>owner</code> is not an instance
     *                              of
     *                              {@link java.awt.Dialog Dialog} or
     *                              {@link java.awt.Frame
     *                              Frame}
     * @exception                   java.lang.IllegalArgumentException
     *                              if the <code>owner</code>'s
    ...
    /**
     * Constructs an initially invisible, modeless <code>Dialog</code> with the
     * specified owner <code>Window</code> and title.
     *
     * @param owner
     *              the owner of the dialog. The owner must be an instance of
     *              {@link java.awt.Dialog Dialog}, {@link java.awt.Frame
    ...
    /**
     * Constructs an initially invisible <code>Dialog</code> with the specified
     * owner <code>Window</code> and modality and an empty title.
     *
     * @param owner
     *                     the owner of the dialog. The owner must be an
     *                     instance of
     *                     {@link java.awt.Dialog Dialog}, {@link java.awt.Frame
     *                     Frame},
     *                     any of their descendents or <code>null</code>
     ...
     *                     windows when
     *                     shown. <code>null</code> value and unsupported
     *                     modality types
     *                     are equivalent to <code>MODELESS</code>
     *
     * @exception                   java.lang.IllegalArgumentException
     *                              if the <code>owner</code> is not an instance
     *                              of
    ...
    /**
     * Constructs an initially invisible <code>Dialog</code> with the specified
     * owner <code>Window</code>, title and modality.
     *
     * @param owner
     *                     the owner of the dialog. The owner must be an
     *                     instance of
     ...
     *                     any of their descendents or <code>null</code>
     * @param title
     *                     the title of the dialog or <code>null</code> if this
     *                     dialog
     *                     has no title
     * @param modalityType
     *                     specifies whether dialog blocks input to other
    ...
    /**
     * Constructs an initially invisible <code>Dialog</code> with the specified
     * owner <code>Window</code>, title, modality and
     * <code>GraphicsConfiguration</code>.
     *
     * @param owner
     *                     the owner of the dialog. The owner must be an
     ...
     *                     are equivalent to <code>MODELESS</code>
     * @param gc
     *                     the <code>GraphicsConfiguration</code> of the target
     *                     screen
     *                     device; if <code>null</code>, the default system
     *                     <code>GraphicsConfiguration</code> is assumed
     *
     ...
     * resource. Making a dialog displayable will cause any of its children to
     * be made displayable. This method is called internally by the toolkit and
     ...
     * {@link #getModalityType getModalityType()} instead.
     *
     ...
     * <p>
     * This method is obsolete and is kept for backwards compatibility only. Use
     * {@link #setModalityType setModalityType()} instead.
     * <p>
     * Note: changing modality of the visible dialog may have no effect until it
     * is hidden and then shown again.
     *
     * @param modal
     *              specifies whether dialog blocks input to other windows when
     *              shown; calling to <code>setModal(true)</code> is equivalent
     *              to
     *              <code>setModalityType(Dialog.DEFAULT_MODALITY_TYPE)</code>,
     *              and calling to <code>setModal(false)</code> is equvivalent
     *              to
     ...
     * {@link java.awt.Dialog.ModalityType ModalityType} for possible modality
     * types.
     * <p>
     * If the given modality type is not supported, <code>MODELESS</code> is
     * used. You may want to call <code>getModalityType()</code> after calling
    ...
    private boolean conditionalShow(Component toFocus, AtomicLong time) {
        ...
        synchronized (getTreeLock()) {
            ...
            if (visible) {
                ...
                // peer.show(),
                // otherwise, a pair of FOCUS_GAINED and FOCUS_LOST may be
                // mistakenly
                ...
                if (toFocus != null && time != null && isFocusable()
                    ...
                    time.set(Toolkit.getEventQueue()
                            .getMostRecentKeyEventTime());
                    KeyboardFocusManager.getCurrentKeyboardFocusManager()
                            .enqueueKeyEvents(time.get(), toFocus);
                }

                // This call is required as the show() method of the Dialog
                // class
                ...
                createHierarchyEvents(HierarchyEvent.HIERARCHY_CHANGED, this,
                        parent, HierarchyEvent.SHOWING_CHANGED, Toolkit
                                .enabledOnToolkit(
     ...
     * 
     * @param b
     *          if {@code true}, makes the {@code Dialog} visible, otherwise
     *          hides the {@code Dialog}. If the dialog and/or its owner are
     *          not yet displayable, both are made displayable. The dialog
     *          will be validated prior to being made visible. If
     *          {@code false}, hides the {@code Dialog} and then causes
     ...
     *          visible, this call will not return until the dialog is hidden
     *          by calling {@code setVisible(false)} or {@code dispose}.
     *          <li>{@code setVisible(false)}: Hides the dialog and then
     *          returns on {@code setVisible(true)} if it is currently
     *          blocked.
     *          <li>It is OK to call this method from the event dispatching
     *          thread because the toolkit ensures that other events are not
    ...
    /**
     * Makes the {@code Dialog} visible. If the dialog and/or its owner are not
     * yet displayable, both are made displayable. The dialog will be validated
        ...
        if (!isModal()) {
            ...
            try {
                ...
                if (conditionalShow(predictedFocusOwner, time)) {
                    ...
                    // if this dialog is toolkit-modal, the filter should be
                    // added
                    // to all EDTs (for all AppContexts)
                    if (modalityType == ModalityType.TOOLKIT_MODAL) {
                        Iterator<AppContext> it = AppContext.getAppContexts()
                                .iterator();
                        while (it.hasNext()) {
                            ...
                            EventQueue eventQueue = (EventQueue) appContext.get(
                                    AppContext.EVENT_QUEUE_KEY);
                            // it may occur that EDT for appContext hasn't been
                            // started yet, so
                            // we post an empty invocation event to trigger EDT
                            // initialization
                            ...
                            eventQueue.postEvent(new InvocationEvent(this,
                                    createEDT));
                            EventDispatchThread edt = eventQueue
                                    .getDispatchThread();
                    ...
                    modalityPushed();
                    try {
                        final EventQueue eventQueue = AccessController
                                .doPrivileged(
                        ...
                        secondaryLoop = eventQueue.createSecondaryLoop(cond,
                                modalFilter, 0);
                    ...
                    // if this dialog is toolkit-modal, its filter must be
                    // removed
    ...
    /**
     * Hides the Dialog and then causes {@code show} to return if it is
     * currently blocked.
     * 
     * @see Window#show
     * @see Window#dispose
    ...
    public void hide() {
        ...
        // hideAndDisposeHandler() should not be called here as it will be
        // called
     ...
     * Refer to {@link Window#setShape}, {@link Window#setOpacity} and
     * {@link Window#setBackground} for details
     *
     * @param undecorated
     *                    {@code true} if no dialog decorations are to be
     *                    enabled;
     *                    {@code false} if dialog decorations are to be enabled
     *
     * @throws IllegalComponentStateException
     *                                        if the dialog is displayable
     * @throws IllegalComponentStateException
     *                                        if {@code undecorated} is
     *                                        {@code false}, and this dialog
     *                                        does
     *                                        not have the default shape
     * @throws IllegalComponentStateException
     *                                        if {@code undecorated} is
     *                                        {@code false}, and this dialog
     *                                        opacity is less than {@code 1.0f}
     * @throws IllegalComponentStateException
     *                                        if {@code undecorated} is
     *                                        {@code false}, and the alpha value
     *                                        of this dialog background color is
     *                                        less than {@code 1.0f}
     *
     * @see #isUndecorated
     * @see Component#isDisplayable
     ...
     * initially decorated.
     * 
     * @return <code>true</code> if dialog is undecorated; <code>false</code>
     *         otherwise.
    ...
    /**
     * Returns a string representing the state of this dialog. This method is
     ...
     * Goes through the list of all visible top-level windows and divide them
     * into three distinct groups: blockers of this dialog, blocked by this
     * dialog and all others. Then blocks this dialog by first met dialog from
     * the first group (if any) and blocks all the windows from the second
     * group.
     */
    void modalShow() {
        ...
        for (Dialog d : modalDialogs) {
            if (d.shouldBlock(this)) {
                ...
                if ((w == this) || !shouldBlock(d) || (modalityType.compareTo(d
                        .getModalityType()) < 0)) {
                    blockers.add(d);
                }
            }
        ...
        IdentityArrayList<Window> blockersHierarchies = new IdentityArrayList<Window>(
                blockers);
        int k = 0;
        ...
        // block all windows from scope of blocking except from blockers'
        // hierarchies
        IdentityArrayList<Window> unblockedWindows = Window
                .getAllUnblockedWindows();
        for (Window w : unblockedWindows) {
            if (shouldBlock(w) && !blockersHierarchies.contains(w)) {
                if ((w instanceof Dialog) && ((Dialog) w)
                        .isModal_NoClientCode()) {
                    Dialog wd = (Dialog) w;
                    if (wd.shouldBlock(this) && (modalDialogs.indexOf(
                            wd) > modalDialogs.indexOf(this))) {
                        continue;
                    }
                }
                toBlock.add(w);
    ...
    /*
     * This method is called only for modal dialogs.
     * Unblocks all the windows blocked by this modal dialog. After each of them
     * has been unblocked, it is checked to be blocked by any other modal
     * dialogs.
     */
    void modalHide() {
    ...
    /*
     * Returns whether the given top-level window should be blocked by this
     * dialog. Note, that the given window can be also a modal dialog and it
     * should block this dialog, but this method do not take such situations
     * into consideration (such checks are performed in the modalShow() and
     * modalHide() methods).
     * This method should be called on the getTreeLock() lock.
     */
    boolean shouldBlock(Window w) {
        if (!isVisible_NoClientCode() || (!w.isVisible_NoClientCode()
                && !w.isInShow) || isInHide || (w == this)
                || !isModal_NoClientCode()) {
            return false;
        }
        ...
        // fix for 6271546: we should also take into consideration child
        // hierarchies
    ...
    /*
     * Adds the given top-level window to the list of blocked windows for this
     * dialog and marks it as modal blocked. If the window is already blocked by
     * some modal dialog, does nothing.
     */
    ...
    /*
     * Removes the given top-level window from the list of blocked windows for
     * this dialog and marks it as unblocked. If the window is not modal
    ...
    /*
     * Checks if any other modal dialog D blocks the given window. If such D
     * exists, mark the window as blocked by D.
     */
    ...
    private void readObject(ObjectInputStream s) throws ClassNotFoundException,
        ...
        ModalityType localModalityType = (ModalityType) fields.get(
                "modalityType", null);
     ...
     *
     * @return an AccessibleAWTDialog that serves as the AccessibleContext of
     *         this Dialog
     * @since 1.3
     */
    ...
    /**
     * This class implements accessibility support for the <code>Dialog</code>
     * class. It provides an implementation of the Java Accessibility API
     * appropriate to dialog user-interface elements.
     * 
     * @since 1.3
     */
