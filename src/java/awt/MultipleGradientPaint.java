...
public abstract class MultipleGradientPaint implements Paint {
	...
	MultipleGradientPaint(float[] fractions, Color[] colors, CycleMethod cycleMethod,
		...
		for (float currentFraction : fractions) {
			...
			if (currentFraction <= previousFraction) {
				throw new IllegalArgumentException(
						"Keyframe fractions " + "must be increasing: " + currentFraction);
			}
	 ...
	 *
	 * @return {@code OPAQUE} if all colors used by this {@code Paint} object
	 *         are opaque, {@code TRANSLUCENT} if at least one of the colors
	 *         used by this {@code Paint} object is not opaque.
