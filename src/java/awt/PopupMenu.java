...
public class PopupMenu extends Menu {
	 ...
	 * component. The origin component must be contained within the component
	 * hierarchy of the popup menu's parent. Both the origin and the parent must
	 * be showing on the screen for this method to be valid.
	 * <p>
	 * If this <code>PopupMenu</code> is being used as a <code>Menu</code>
	 * (i.e., it has a non-<code>Component</code> parent), then you cannot call
	...
	public void show(Component origin, int x, int y) {
		...
		// Fixed 6278745: Incorrect exception throwing in PopupMenu.show()
		// method
	 ...
	 * <code>PopupMenu</code>.
	 *
	 * @return the <code>AccessibleContext</code> of this <code>PopupMenu</code>
	 * @since 1.3
	 */
	 ...
	 * developers, but is instead meant only to be subclassed by menu component
	 * developers.
	 * <p>
