 ...
 * <CODE>PIE</CODE>).
 * <p>
 * <a name="inscribes"> The arc is a partial section of a full ellipse which
 * inscribes the framing rectangle of its parent {@link RectangularShape}. </a>
 * <a name="angles"> The angles are specified relative to the non-square framing
 * rectangle such that 45 degrees always falls on the line from the center of
 * the ellipse to the upper right corner of the framing rectangle. As a result,
 * if the framing rectangle is noticeably longer along one axis than the other,
 * the angles to the start and end of the arc segment will be skewed farther
 * along the longer axis of the frame. </a>
 * <p>
...
public abstract class Arc2D extends RectangularShape {
    ...
    public static class Float extends Arc2D implements Serializable {
         ...
         *
         * @param type
         *        The closure type for the arc: {@link #OPEN},
         ...
         *
         * @param x
         *        The X coordinate of the upper-left corner of the arc's
         *        framing rectangle.
         * @param y
         *        The Y coordinate of the upper-left corner of the arc's
         *        framing rectangle.
         * @param w
         *        The overall width of the full ellipse of which this arc
         *        is
         *        a partial section.
         * @param h
         ...
         *
         * @param ellipseBounds
         *        The framing rectangle that defines the outer
         *        boundary of
         *        the full ellipse of which this arc is a partial
         *        section.
         * @param start
         *        The starting angle of the arc in degrees.
         * @param extent
         ...
         * <a href="Arc2D.html#inscribes">partially inscribes</a> the framing
         * rectangle of this {@code RectangularShape}.
         *
         * @since 1.2
         */
        public double getX() {
         ...
         *             <li>followed by a <code>byte</code> indicating the arc
         *             type {@link #OPEN}, {@link #CHORD}, or {@link #PIE}.
         *             </ol>
         */
         ...
         * <code>ObjectInputStream</code> followed by a byte indicating the arc
         * type of this <code>Arc2D</code> instance.
         *
         * @serialData
         *             <ol>
     ...
     *
     * @param type
     *        The closure type of this arc: {@link #OPEN}, {@link #CHORD},
     *        or {@link #PIE}.
     * @see java.awt.geom.Arc2D.Float
     * @see java.awt.geom.Arc2D.Double
     * @since 1.2
    ...
    /**
     * Returns the arc closure type of the arc: {@link #OPEN}, {@link #CHORD},
     * or {@link #PIE}.
     * 
     ...
     * @since 1.2
     */
    public abstract void setArc(double x, double y, double w, double h, double angSt, double angExt,
            int closure);
     ...
     *
     * @param loc
     *        The <CODE>Point2D</CODE> representing the coordinates of
     *        the
     *        upper-left corner of the arc.
     * @param size
     *        The <CODE>Dimension2D</CODE> representing the width and
     *        height
     ...
     *
     * @param rect
     *        The framing rectangle that defines the outer boundary of
     *        the
    ...
    public void setArc(Arc2D a) {
        setArc(a.getX(), a.getY(), a.getWidth(), a.getHeight(), a.getAngleStart(), a.getAngleExtent(),
                a.type);
    }
     ...
     *        the arc is tangent to the line specified by points (p1,
     *        p2).
     * @param p2
     *        The second point that defines the arc. The starting angle
     *        of
     *        the arc is tangent to the line specified by points (p1,
     *        p2).
     *        The ending angle of the arc is tangent to the line
     *        specified
     *        by points (p2, p3).
     * @param p3
     *        The third point that defines the arc. The ending angle of
     *        the
    ...
    /**
     * {@inheritDoc} Note that the arc <a href="Arc2D.html#inscribes">partially
     * inscribes</a> the framing rectangle of this {@code RectangularShape}.
     *
     * @since 1.2
     */
     ...
     * hold the parameters calculated to be the framing rectangle of this arc.
     *
     * @param x
     ...
     * @return a <code>Rectangle2D</code> that is the framing rectangle of this
     *         arc.
     * @since 1.2
     */
    ...
    public boolean contains(double x, double y) {
        ...
        boolean inside = (Line2D.relativeCCW(x1, y1, x2, y2, 2 * normx, 2 * normy) * Line2D.relativeCCW(x1,
                y1, x2, y2, 0, 0) >= 0);
    ...
    public boolean intersects(double x, double y, double w, double h) {
        ...
        if (ayc >= y && ayc <= yh) { // 0 and 180
            if ((sx < xw && ex < xw && axc < xw && axw > x && containsAngle(0)) || (sx > x && ex > x
                    && axc > x && ax < xw && containsAngle(180))) {
                return true;
            }
        }
        if (axc >= x && axc <= xw) { // 90 and 270
            if ((sy > y && ey > y && ayc > y && ay < yh && containsAngle(90)) || (sy < yh && ey < yh
                    && ayc < yh && ayh > y && containsAngle(270))) {
                return true;
            }
        }
     ...
     *         <code>Arc2D</code> and has the same values; <code>false</code>
     *         otherwise.
     * @since 1.6
     */
