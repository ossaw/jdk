...
public abstract class Arc2D extends RectangularShape {
	...
	public static class Double extends Arc2D implements Serializable {
		 ...
		 * @since 1.2
		 */
		public Double(double x, double y, double w, double h, double start, double extent,
				int type) {
			super(type);
			this.x = x;
			this.y = y;
	 ...
	 *            The angular extent of the arc in degrees.
	 * @param closure
	 *            The closure type for the arc: {@link #OPEN}, {@link #CHORD},
	 *            or {@link #PIE}.
	 * @since 1.2
	 */
	 ...
	 *
	 * @param rect
	 *            The framing rectangle that defines the outer boundary of the
