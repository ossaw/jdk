...
public class FlatteningPathIterator implements PathIterator {
     ...
     * a path as it iterates over it. The iterator does not subdivide any curve
     * read from the source iterator to more than 10 levels of subdivision which
    ...
    /*
     * Ensures that the hold array can hold up to (want) more values. It is
     * currently holding (hold.length - holdIndex) values.
     */
