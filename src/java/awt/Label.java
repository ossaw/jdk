...
/**
 * A <code>Label</code> object is a component for placing text in a container. A
 * label displays a single line of read-only text. The text can be changed by
 * the application, but a user cannot edit it directly.
 * <p>
 ...
 * <p>
 * <img src="doc-files/Label-1.gif" alt=
 * "Two labels: 'Hi There!' and 'Another label'" style=
...
public class Label extends Component implements Accessible {
	...
	/**
	 * The text of this label. This text can be modified by the program but
	 * never by the user.
	 *
	 * @serial
	 * @see #getText()
	 ...
	 * the specified alignment. Possible values for <code>alignment</code> are
	...
	/**
	 * Sets the alignment for this label to the specified alignment. Possible
	 * values are <code>Label.LEFT</code>, <code>Label.RIGHT</code>, and
	 * <code>Label.CENTER</code>.
	 * 
	 * @param alignment
	 ...
	 * 
	 * @return the text of this label, or <code>null</code> if the text has been
	...
	/**
	 * Returns a string representing the state of this <code>Label</code>. This
	 ...
	 *
	 * @return an AccessibleAWTLabel that serves as the AccessibleContext of
	 *         this Label
	 * @since 1.3
	 */
	...
	/**
	 * This class implements accessibility support for the <code>Label</code>
	 * class. It provides an implementation of the Java Accessibility API
	 * appropriate to label user-interface elements.
	 * 
	 * @since 1.3
	 */
