 ...
 * DataFlavor flavor2 = new DataFlavor(Object.class,
 * 		&quot;X-test/test; class=&lt;java.lang.Object&gt;; x=y&quot;);
 ...
 * to Use Drag and Drop and Data Transfer</a>, section in <em>Java Tutorial</em>
 * .
 *
...
public class DataFlavor implements Externalizable, Cloneable {
	...
	public static final DataFlavor stringFlavor = createConstant(
			java.lang.String.class, "Unicode String");
	 ...
	 * </pre>
	 * 
	 * This <code>DataFlavor</code> has been <b>deprecated</b> because (1) Its
	 * representation is an InputStream, an 8-bit based representation, while
	 * Unicode is a 16-bit character set; and (2) The charset "unicode" is not
	 * well-defined. "unicode" implies a particular platform's implementation of
	 * Unicode, not a cross-platform implementation.
	 *
	 * @deprecated as of 1.3. Use
	 *             <code>DataFlavor.getReaderForText(Transferable)</code>
	 *             instead of
	 *             <code>Transferable.getTransferData(DataFlavor.plainTextFlavor)</code>
	 *             .
	 */
	@Deprecated
	 ...
	 * invocation <code>java.awt.datatransfer.getTransferData</code>.
	 */
	public static final String javaSerializedObjectMimeType = "application/x-java-serialized-object";

	/**
	 * To transfer a list of files to/from Java (and the underlying platform) a
	 * <code>DataFlavor</code> of this type/subtype and representation class of
	 * <code>java.util.List</code> is used. Each element of the list is
	 * required/guaranteed to be of type <code>java.io.File</code>.
	 */
	 ...
	 * associated MIME Content-type, across a <code>Transferable</code>
	 * interface WITHIN THE SAME JVM, a <code>DataFlavor</code> with this
	 * type/subtype is used, with a <code>representationClass</code> equal to
	 * the type of the class/interface being passed across the
	 * <code>Transferable</code>.
	 * <p>
	 * The object reference returned from
	 * <code>Transferable.getTransferData</code> for a <code>DataFlavor</code>
	 * with this MIME Content-Type is required to be an instance of the
	 * representation Class of the <code>DataFlavor</code>.
	 */
	 ...
	 * class of the <code>DataFlavor</code> represents the type of the
	 * <code>Remote</code> interface to be transferred.
	 */
	 ...
	 * instances which content MIME type does not contain document parameter and
	 * representation class is the String class.
	 * 
	 * <pre>
	 ...
	 * </pre>
	 */
	public static DataFlavor fragmentHtmlFlavor = initHtmlDataFlavor(
			"fragment");
	...
	/**
	 * Constructs a new <code>DataFlavor</code>. This constructor is provided
	 * only for the purpose of supporting the <code>Externalizable</code>
	 ...
	 *                                 if either <code>primaryType</code>,
	 *                                 <code>subType</code>
	 *                                 or <code>representationClass</code> is
	 *                                 null
	 */
	private DataFlavor(String primaryType, String subType,
			MimeTypeParameterList params, Class<?> representationClass,
		...
		try {
			...
			throw new IllegalArgumentException("MimeType Parse Exception: "
					+ mtpe.getMessage());
		}
	 ...
	 *                             this flavor; if
	 *                             this parameter is <code>null</code> then the
	 *                             value of the the
	 *                             MIME Content Type is used
	 * @exception NullPointerException
	 *                                 if <code>representationClass</code> is
	 *                                 null
	 */
	public DataFlavor(Class<?> representationClass,
			String humanPresentableName) {
		this("application", "x-java-serialized-object", null,
				representationClass, humanPresentableName);
		if (representationClass == null) {
			throw new NullPointerException("representationClass");
		}
	}
	 ...
	 * "application/x-java-serialized-object; class=&lt;representation
	 * class&gt;"
	 ...
	 * 
	 * @param mimeType
	 *                             the string used to identify the MIME type for
	 *                             this flavor; if
	 *                             the the <code>mimeType</code> does not
	 *                             specify a "class="
	 *                             parameter, or if the class is not
	 ...
	 *                                     if <code>mimeType</code> is invalid
	 *                                     or if the class is not
	 *                                     successfully loaded
	 * @exception NullPointerException
	 *                                     if <code>mimeType</code> is null
	 */
	public DataFlavor(String mimeType, String humanPresentableName) {
		...
		try {
			initialize(mimeType, humanPresentableName, this.getClass()
					.getClassLoader());
		} catch (MimeTypeParseException mtpe) {
			throw new IllegalArgumentException("failed to parse:" + mimeType);
		} catch (ClassNotFoundException cnfe) {
			throw new IllegalArgumentException("can't find specified class: "
					+ cnfe.getMessage());
		}
	}
	 ...
	 *                 flavor; if
	 *                 the class specified by "class=" parameter is not
	 *                 successfully
	 *                 loaded, then an <code>ClassNotFoundException</code> is
	 *                 thrown
	 * @exception ClassNotFoundException
	 *                                     if the class is not loaded
	 * @exception IllegalArgumentException
	 ...
	 *
	 * @param mimeType
	 *                             the MIME Content Type (must have a class=
	 *                             param)
	 * @param humanPresentableName
	 *                             the human Presentable Name or
	 *                             <code>null</code>
	 * @param classLoader
	 *                             the fallback class loader to resolve against
	 *
	 ...
	 * @see #tryToLoadClass
	 */
	private void initialize(String mimeType, String humanPresentableName,
			ClassLoader classLoader) throws MimeTypeParseException,
		...
		if (rcn == null) {
			if ("application/x-java-serialized-object".equals(this.mimeType
				...
				throw new IllegalArgumentException(
						"no representation class specified for:" + mimeType);
			else
		...
		if (humanPresentableName == null) {
			humanPresentableName = this.mimeType.getParameter(
					"humanPresentableName");
			if (humanPresentableName == null)
				humanPresentableName = this.mimeType.getPrimaryType() + "/"
						+ this.mimeType.getSubType();
		}
	 ...
	 * The resulting <code>String</code> contains the name of the
	 * <code>DataFlavor</code> class, this flavor's MIME type, and its
	...
	private String paramString() {
		...
		if (DataTransferer.isFlavorCharsetTextType(this)
				&& (isRepresentationClassInputStream()
						|| isRepresentationClassByteBuffer() || byte[].class
								.equals(representationClass))) {
	 ...
	 * <code>utf-16le</code>. Sun's implementation for Solaris and Linux uses
	 * the encoding <code>iso-10646-ucs-2</code>.
	 *
	 * @return a <code>DataFlavor</code> representing plain text with Unicode
	 *         encoding
	 * @since 1.3
	 */
	public static final DataFlavor getTextPlainUnicodeFlavor() {
		...
		return new DataFlavor("text/plain;charset=" + encoding
	 ...
	 * <code>DataFlavor.stringFlavor</code> will be chosen over
	 ...
	 * <code>DataFlavor</code> which uses that MIME type. If so, the JRE will
	 * assume from that point on that the MIME type supports the charset
	 ...
	 * not support the charset parameter and will not check again. Because this
	 * check is performed on an arbitrarily chosen <code>DataFlavor</code>,
	 * developers must ensure that all <code>DataFlavor</code>s with a
	 * "text/&lt;other&gt;" MIME type specify the charset parameter if it is
	 * supported by that MIME type. Developers should never rely on the JRE to
	 * substitute the platform's default charset for a "text/&lt;other&gt;"
	 ...
	 *                         an array of available <code>DataFlavor</code>s
	 * @return the best (highest fidelity) flavor according to the rules
	 *         specified above, or <code>null</code>, if
	 *         <code>availableFlavors</code> is <code>null</code>, has zero
	 *         length, or contains no text flavors
	 * @since 1.3
	 */
	public static final DataFlavor selectBestTextFlavor(
		...
		DataFlavor bestFlavor = (DataFlavor) Collections.max(Arrays.asList(
				availableFlavors), textFlavorComparator);
	...
	static class TextFlavorComparator extends
		 ...
		 *
		 * @param obj1
		 *             the first <code>DataFlavor</code> to be compared
		 * @param obj2
		 *             the second <code>DataFlavor</code> to be compared
	 ...
	 * <code>java.io.InputStream</code>, <code>java.nio.ByteBuffer</code>, and
	 * <code>[B</code>.
	 * <p>
	 ...
	 * it accordingly. See <code>selectBestTextFlavor</code> for a list of text
	 * flavors which do not support the charset parameter.
	 *
	 * @param transferable
	 *                     the <code>Transferable</code> whose data will be
	 *                     requested in
	 *                     this flavor
	 *
	 ...
	 *                                         not one of the seven listed
	 *                                         above
	 * @exception IllegalArgumentException
	 *                                         if the <code>Transferable</code>
	 *                                         has <code>null</code>
	 *                                         data
	 * @exception NullPointerException
	 *                                         if the <code>Transferable</code>
	 ...
	 *                                         if this flavor's representation
	 *                                         is
	 *                                         <code>java.io.InputStream</code>,
	 *                                         <code>java.nio.ByteBuffer</code>,
	 *                                         or <code>[B</code> and
	 *                                         this flavor's encoding is not
	 *                                         supported by this
	...
	public Reader getReaderForText(Transferable transferable)
		...
		return (encoding == null) ? new InputStreamReader(stream)
	 ...
	 * <code>DataFlavor</code> will return when this <code>DataFlavor</code> is
	 * requested.
	 * 
	 ...
	 * <code>DataFlavor</code> represents. This name would be localized for
	 * different countries.
	 * 
	...
	/**
	 * Returns the human presentable name for this <code>DataFlavor</code> if
	 * <code>paramName</code> equals "humanPresentableName". Otherwise returns
	 * the MIME type value associated with <code>paramName</code>.
	 *
	 * @param paramName
	 *                  the parameter name requested
	 * @return the value of the name parameter, or <code>null</code> if there is
	 *         no associated value
	 */
	 ...
	 * follows: Two <code>DataFlavor</code>s are considered equal if and only if
	 ...
	 * is not <code>java.io.Reader</code>, <code>java.lang.String</code>,
	 * <code>java.nio.CharBuffer</code>, or <code>[C</code>, the
	 * <code>charset</code> parameter must also be equal. If a charset is not
	 * explicitly specified for one or both <code>DataFlavor</code>s, the
	 * platform default encoding is assumed. See
	 * <code>selectBestTextFlavor</code> for a list of text flavors which
	 * support the charset parameter.
	 *
	 * @param o
	 *          the <code>Object</code> to compare with <code>this</code>
	 ...
	 *
	 * @param that
	 *             the <code>DataFlavor</code> to compare with <code>this</code>
	 * @return <code>true</code> if <code>that</code> is equivalent to this
	 *         <code>DataFlavor</code>; <code>false</code> otherwise
	 * @see #selectBestTextFlavor
	 */
	public boolean equals(DataFlavor that) {
		...
		if (!Objects.equals(this.getRepresentationClass(), that
		...
		if (mimeType == null) {
			...
			if ("text".equals(getPrimaryType())) {
				if (DataTransferer.doesSubtypeSupportCharset(this)
					...
					String thisCharset = DataTransferer.canonicalName(this
							.getParameter("charset"));
					String thatCharset = DataTransferer.canonicalName(that
							.getParameter("charset"));
	 ...
	 * <code>String</code> and <code>representationClass</code> is not
	 * considered in the comparison.
	 *
	 * If <code>representationClass</code> needs to be compared, then
	 * <code>equals(new DataFlavor(s))</code> may be used.
	 * 
	 * @deprecated As inconsistent with <code>hashCode()</code> contract, use
	 *             <code>isMimeTypeEqual(String)</code> instead.
	 * @param s
	 *          the {@code mimeType} to compare.
	...
	/**
	 * Returns hash code for this <code>DataFlavor</code>. For two equal
	 * <code>DataFlavor</code>s, hash codes are equal. For the
	 * <code>String</code> that matches <code>DataFlavor.equals(String)</code>,
	 * it is not guaranteed that <code>DataFlavor</code>'s hash code is equal to
		...
		if (mimeType != null) {
			...
			if ("text".equals(primaryType)) {
				if (DataTransferer.doesSubtypeSupportCharset(this)
						&& representationClass != null
						&& !isStandardTextRepresentationClass()) {
					String charset = DataTransferer.canonicalName(getParameter(
							"charset"));
					if (charset != null) {
	 ...
	 * equivalent to the MIME type of this <code>DataFlavor</code>. Parameters
	 ...
	 *
	 * @param dataFlavor
	 *                   the <code>DataFlavor</code> to be compared
	 * @return true if the <code>MimeType</code>s are equal, otherwise false
	 */
	...
	private boolean isStandardTextRepresentationClass() {
		return isRepresentationClassReader() || String.class.equals(
				representationClass) || isRepresentationClassCharBuffer()
	...
	/**
	 * Returns whether the representation class for this <code>DataFlavor</code>
	 * is <code>java.io.Reader</code> or a subclass thereof.
	 *
	 * @since 1.4
	 */
	...
	/**
	 * Returns whether the representation class for this <code>DataFlavor</code>
	 * is <code>java.nio.CharBuffer</code> or a subclass thereof.
	 *
	 * @since 1.4
	 */
	...
	/**
	 * Returns whether the representation class for this <code>DataFlavor</code>
	 * is <code>java.nio.ByteBuffer</code> or a subclass thereof.
	 *
	 * @since 1.4
	 */
	...
	/**
	 * Returns true if the <code>DataFlavor</code> specified represents a
	 * serialized object.
	 * 
	 * @return true if the <code>DataFlavor</code> specified represents a
	 *         Serialized Object
	 */

	public boolean isFlavorSerializedObjectType() {
		return isRepresentationClassSerializable() && isMimeTypeEqual(
				javaSerializedObjectMimeType);
	}

	/**
	 * Returns true if the <code>DataFlavor</code> specified represents a remote
	 * object.
	 * 
	 * @return true if the <code>DataFlavor</code> specified represents a Remote
	 *         Object
	 */

	public boolean isFlavorRemoteObjectType() {
		return isRepresentationClassRemote()
				&& isRepresentationClassSerializable() && isMimeTypeEqual(
						javaRemoteObjectMimeType);
	}

	/**
	 * Returns true if the <code>DataFlavor</code> specified represents a list
	 * of file objects.
	 * 
	 * @return true if the <code>DataFlavor</code> specified represents a List
	 *         of File objects
	 */
	 ...
	 * <code>DataFlavor.stringFlavor</code> and <code>DataFlavor</code>s with a
	 ...
	 * be supported by this implementation of the Java platform. If a charset is
	 * not specified, then the platform default charset, which is always
	 * supported, is assumed.
	 * <p>
	 * If this flavor does not support the charset parameter, its representation
	 * must be <code>java.io.InputStream</code>,
	 * <code>java.nio.ByteBuffer</code>, or <code>[B</code>.
	 * <p>
	 * See <code>selectBestTextFlavor</code> for a list of text flavors which
	 * support the charset parameter.
	 *
	 * @return <code>true</code> if this <code>DataFlavor</code> is a valid text
	 *         flavor as described above; <code>false</code> otherwise
	 * @see #selectBestTextFlavor
	 * @since 1.4
	 */
	public boolean isFlavorTextType() {
		return (DataTransferer.isFlavorCharsetTextType(this) || DataTransferer
				.isFlavorNoncharsetTextType(this));
	}
	...
	public synchronized void readExternal(ObjectInput is) throws IOException,
		...
		if (mimeType != null) {
			humanPresentableName = mimeType.getParameter(
					"humanPresentableName");
			mimeType.removeParameter("humanPresentableName");
		...
		try {
			...
			if (rcn != null) {
				representationClass = DataFlavor.tryToLoadClass(rcn, getClass()
						.getClassLoader());
			}
		}
	}
	...
	/**
	 * Called on <code>DataFlavor</code> for every MIME Type parameter to allow
	 * <code>DataFlavor</code> subclasses to handle special parameters like the
	 * text/plain <code>charset</code> parameters, whose values are case
