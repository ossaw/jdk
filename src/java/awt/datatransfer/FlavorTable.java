...
public interface FlavorTable extends FlavorMap {
	 ...
	 * specified <code>DataFlavor</code> corresponds. The <code>List</code> will
	 * be sorted from best native to worst. That is, the first native will best
	 * reflect data in the specified flavor to the underlying native platform.
	 * The returned <code>List</code> is a modifiable copy of this
	 ...
	 * a Java application. The returned <code>List</code> is a modifiable copy
	 * of this <code>FlavorTable</code>'s internal data. Client code is free to
