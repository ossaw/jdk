...
public class HierarchyEvent extends AWTEvent {
	 ...
	 */
	public static final int HIERARCHY_FIRST = 1400; // 1300 used by
													// sun.awt.windows.ModalityEvent

	/**
	 * The event id indicating that modification was made to the entire
	 * hierarchy tree.
	 */
	...
	/**
	 * A change flag indicates that the <code>HIERARCHY_CHANGED</code> event was
	 * generated by a reparenting operation.
	 */
	public static final int PARENT_CHANGED = 0x1;

	/**
	 * A change flag indicates that the <code>HIERARCHY_CHANGED</code> event was
	 * generated due to the changing of the hierarchy displayability. To discern
	 * the current displayability of the hierarchy, call the
	 * <code>Component.isDisplayable</code> method. Displayability changes occur
	 * in response to explicit or implicit calls of the
	 * <code>Component.addNotify</code> and <code>Component.removeNotify</code>
	 * methods.
	 *
	...
	/**
	 * A change flag indicates that the <code>HIERARCHY_CHANGED</code> event was
	 * generated due to the changing of the hierarchy showing state. To discern
	 * the current showing state of the hierarchy, call the
	 * <code>Component.isShowing</code> method. Showing state changes occur when
	 * either the displayability or visibility of the hierarchy occurs.
	 * Visibility changes occur in response to explicit or implicit calls of the
	 * <code>Component.show</code> and <code>Component.hide</code> methods.
	 *
	...
	/**
	 * Constructs an <code>HierarchyEvent</code> object to identify a change in
	 * the <code>Component</code> hierarchy.
	 * <p>
	 ...
	 *            {@link HierarchyEvent}
	 * @param changed
	 *            The <code>Component</code> at the top of the hierarchy which
	 *            was changed
	 * @param changedParent
	 *            The parent of the <code>changed</code> component. This may be
	 *            the parent before or after the change, depending on the type
	 *            of change
	 ...
	 *            <code>HIERARCHY_CHANGED</code> events represented in this
	 *            event object. For information on allowable values, see the
	 ...
	 *
	 * @return the <code>Component</code> object that originated the event, or
	 *         <code>null</code> if the object is not a <code>Component</code>.
	 */
	 ...
	 * getChanged()</code>. For a HIERARCHY_CHANGED event where the change was
	 * of type PARENT_CHANGED via a call to <code>
	 * Container.add</code>, the parent returned is the parent after the add
	 * operation. For a HIERARCHY_CHANGED event where the change was of type
	 * PARENT_CHANGED via a call to <code>
	 * Container.remove</code>, the parent returned is the parent before the
	 * remove operation. For all other events and types, the parent returned is
	 * the parent during the operation.
	 *
	...
	/**
	 * Returns a bitmask which indicates the type(s) of HIERARCHY_CHANGED events
	 * represented in this event object. The bits have been bitwise-ored
	 * together.
	 *
	 * @return the bitmask, or 0 if this is not an HIERARCHY_CHANGED event
	 */
