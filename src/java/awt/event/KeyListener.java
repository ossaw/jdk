 ...
 * component using the component's <code>addKeyListener</code> method. A
 * keyboard event is generated when a key is pressed, released, or typed. The
 * relevant method in the listener object is then invoked, and the
 * <code>KeyEvent</code> is passed to it.
 *
 * @author Carl Quinn
 * @see KeyAdapter
 * @see KeyEvent
