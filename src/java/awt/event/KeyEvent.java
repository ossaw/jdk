 ...
 * accommodate a wider range of keyboards in the future.
 * <p>
...
public class KeyEvent extends InputEvent {
	...
	/**
	 * The unique value assigned to each of the keys on the keyboard. There is a
	 * common set of key codes that can be fired by most keyboards. The symbolic
	 * name for a key code should be used rather than the code value itself.
	 *
	 * @serial
	 * @see #getKeyCode()
	 * @see #setKeyCode(int)
	...
	/**
	 * <code>keyChar</code> is a valid unicode character that is fired by a key
	 * or a key combination on a keyboard.
	 *
	 * @serial
	 * @see #getKeyChar()
	 * @see #setKeyChar(char)
	 ...
	 *
	 * Some keys occur more than once on a keyboard, e.g. the left and right
	 * shift keys. Additionally, some keys occur on the numeric keypad. This
	 * variable is used to distinguish such keys.
	 *
	 ...
	 *
	 * Event source can be changed during processing, but in some cases we need
	 * to be able to obtain original source.
	 */
	 ...
	 *                    meta).
	 *                    Passing negative value is not recommended. Zero value
	 *                    means
	 *                    that no modifiers were passed. Use either an extended
	 *                    _DOWN_MASK or old _MASK modifiers, however do not mix
	 *                    models
	 *                    in the one event. The extended modifiers are preferred
	 *                    for
	 *                    using
	 * @param keyCode
	 ...
	 * @param keyLocation
	 *                    Identifies the key location. The only legal values are
	 *                    <code>KEY_LOCATION_UNKNOWN</code>,
	 *                    <code>KEY_LOCATION_STANDARD</code>,
	 *                    <code>KEY_LOCATION_LEFT</code>,
	 *                    <code>KEY_LOCATION_RIGHT</code>, and
	 *                    <code>KEY_LOCATION_NUMPAD</code>.
	 * @throws IllegalArgumentException
	 *                                  if <code>id</code> is
	 *                                  <code>KEY_TYPED</code> and
	 *                                  <code>keyChar</code> is
	 *                                  <code>CHAR_UNDEFINED</code>; or if
	 *                                  <code>id</code> is
	 *                                  <code>KEY_TYPED</code> and
	 *                                  <code>keyCode</code> is not
	 *                                  <code>VK_UNDEFINED</code>; or if
	 *                                  <code>id</code> is
	 *                                  <code>KEY_TYPED</code> and
	 *                                  <code>keyLocation</code> is not
	 *                                  <code>KEY_LOCATION_UNKNOWN</code>; or if
	 *                                  <code>keyLocation</code> is not one of
	 *                                  the legal values
	 *                                  enumerated above.
	 * @throws IllegalArgumentException
	 ...
	 *                  using
	 * @param keyCode
	 *                  The integer code for an actual key, or VK_UNDEFINED (for
	 *                  a
	 *                  key-typed event)
	 * @param keyChar
	 *                  The Unicode character generated by this event, or
	 *                  CHAR_UNDEFINED (for key-pressed and key-released events
	 *                  which
	 *                  do not map to a valid Unicode character)
	 * @throws IllegalArgumentException
	 *                                  if <code>id</code> is
	 ...
	 *
	 * @return the integer code for an actual key on the keyboard. (For
	 *         <code>KEY_TYPED</code> events, the keyCode is
	 *         <code>VK_UNDEFINED</code>.)
	 */
	 ...
	 * the <code>KEY_TYPED</code> event for shift + "a" returns the value for
	 * "A".
	 * <p>
	 * <code>KEY_PRESSED</code> and <code>KEY_RELEASED</code> events are not
	 * intended for reporting of character input. Therefore, the values returned
	 ...
	 *         Unicode character exists for this key event,
	 ...
	 * implementations do not recognize modifier changes. This is especially
	 * true for <code>KEY_TYPED</code> events where the shift modifier is
	 * changed.
	 *
	 * @param modifiers
	 ...
	 * Some keys occur more than once on a keyboard, e.g. the left and right
	 * shift keys. Additionally, some keys occur on the numeric keypad. This
	 * provides a way of distinguishing such keys.
	 *
	 * @return the location of the key that was pressed or released. Always
	 *         returns <code>KEY_LOCATION_UNKNOWN</code> for
	 *         <code>KEY_TYPED</code> events.
	 * @since 1.4
	 */
	...
	public static String getKeyText(int keyCode) {
		if (keyCode >= VK_0 && keyCode <= VK_9 || keyCode >= VK_A
				&& keyCode <= VK_Z) {
		...
		switch (keyCode) {
			...
			case VK_DEAD_CIRCUMFLEX:
				return Toolkit.getProperty("AWT.deadCircumflex",
						"Dead Circumflex");
			case VK_DEAD_TILDE:
			...
			case VK_DEAD_ABOVEDOT:
				return Toolkit.getProperty("AWT.deadAboveDot",
						"Dead Above Dot");
			case VK_DEAD_DIAERESIS:
				return Toolkit.getProperty("AWT.deadDiaeresis",
						"Dead Diaeresis");
			case VK_DEAD_ABOVERING:
				return Toolkit.getProperty("AWT.deadAboveRing",
						"Dead Above Ring");
			...
			case VK_DEAD_VOICED_SOUND:
				return Toolkit.getProperty("AWT.deadVoicedSound",
						"Dead Voiced Sound");
			case VK_DEAD_SEMIVOICED_SOUND:
				return Toolkit.getProperty("AWT.deadSemivoicedSound",
			...
			case VK_EXCLAMATION_MARK:
				return Toolkit.getProperty("AWT.exclamationMark",
						"Exclamation Mark");
			case VK_INVERTED_EXCLAMATION_MARK:
				return Toolkit.getProperty("AWT.invertedExclamationMark",
						"Inverted Exclamation Mark");
			case VK_LEFT_PARENTHESIS:
				return Toolkit.getProperty("AWT.leftParenthesis",
						"Left Parenthesis");
			case VK_NUMBER_SIGN:
			...
			case VK_RIGHT_PARENTHESIS:
				return Toolkit.getProperty("AWT.rightParenthesis",
						"Right Parenthesis");
			case VK_UNDERSCORE:
			...
			case VK_ROMAN_CHARACTERS:
				return Toolkit.getProperty("AWT.romanCharacters",
						"Roman Characters");
			case VK_ALL_CANDIDATES:
				return Toolkit.getProperty("AWT.allCandidates",
						"All Candidates");
			case VK_PREVIOUS_CANDIDATE:
				return Toolkit.getProperty("AWT.previousCandidate",
						"Previous Candidate");
			case VK_CODE_INPUT:
				return Toolkit.getProperty("AWT.codeInput", "Code Input");
			case VK_JAPANESE_KATAKANA:
				return Toolkit.getProperty("AWT.japaneseKatakana",
						"Japanese Katakana");
			case VK_JAPANESE_HIRAGANA:
				return Toolkit.getProperty("AWT.japaneseHiragana",
						"Japanese Hiragana");
			case VK_JAPANESE_ROMAN:
				return Toolkit.getProperty("AWT.japaneseRoman",
						"Japanese Roman");
			case VK_KANA_LOCK:
				return Toolkit.getProperty("AWT.kanaLock", "Kana Lock");
			case VK_INPUT_METHOD_ON_OFF:
				return Toolkit.getProperty("AWT.inputMethodOnOff",
						"Input Method On/Off");
	...
	/**
	 * Returns a <code>String</code> describing the modifier key(s), such as
	 * "Shift", or "Ctrl+Shift". These strings can be localized by changing the
	 * <code>awt.properties</code> file.
	 * <p>
	 * Note that <code>InputEvent.ALT_MASK</code> and
	 * <code>InputEvent.BUTTON2_MASK</code> have the same value, so the string
	 * "Alt" is returned for both modifiers. Likewise,
	 * <code>InputEvent.META_MASK</code> and
	 * <code>InputEvent.BUTTON3_MASK</code> have the same value, so the string
	 * "Meta" is returned for both modifiers.
	 *
	 * @return string a text description of the combination of modifier keys
	...
	public String paramString() {
		...
		str.append(",extendedKeyCode=0x").append(Long.toHexString(
				extendedKeyCode));
	...
	/**
	 * Returns an extended key code for the event. The extended key code is a
	 * unique id assigned to a key on the keyboard just like {@code keyCode}.
	 * However, unlike {@code keyCode}, this value depends on the current
	 * keyboard layout. For instance, pressing the left topmost letter key in a
	 * common English layout produces the same value as {@code keyCode},
	 * {@code VK_Q}. Pressing the same key in a regular Russian layout gives
	 * another code, unique for the letter "Cyrillic I short".
	 *
	 * @since 1.7
	 *
	 */
