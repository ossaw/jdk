...
public class KeyEvent extends InputEvent {
	 ...
	 *            Passing negative value is not recommended. Zero value means
	 *            that no modifiers were passed. Use either an extended
	 *            _DOWN_MASK or old _MASK modifiers, however do not mix models
	 *            in the one event. The extended modifiers are preferred for
	 *            using
	 * @param keyCode
	 *            The integer code for an actual key, or VK_UNDEFINED (for a
	 *            key-typed event)
	 * @param keyChar
	 *            The Unicode character generated by this event, or
	 *            CHAR_UNDEFINED (for key-pressed and key-released events which
	 ...
	 *             <code>keyCode</code> is not <code>VK_UNDEFINED</code>; or if
	 *             <code>id</code> is <code>KEY_TYPED</code> and
	 *             <code>keyLocation</code> is not
	 *             <code>KEY_LOCATION_UNKNOWN</code>; or if
	 *             <code>keyLocation</code> is not one of the legal values
	 *             enumerated above.
	 * @throws IllegalArgumentException
	 ...
	 *
	 * @param keyChar
	 *            a char corresponding to to the combination of keystrokes that
	 *            make up this event.
	 */
