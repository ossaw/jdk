...
public class ActionEvent extends AWTEvent {
	...
	/**
	 * The shift modifier. An indicator that the shift key was held down during
	 * the event.
	 */
	public static final int SHIFT_MASK = Event.SHIFT_MASK;

	/**
	 * The control modifier. An indicator that the control key was held down
	 * during the event.
	 */
	public static final int CTRL_MASK = Event.CTRL_MASK;

	/**
	 * The meta modifier. An indicator that the meta key was held down during
	 * the event.
	 */
	public static final int META_MASK = Event.META_MASK;

	/**
	 * The alt modifier. An indicator that the alt key was held down during the
	 * event.
	 */
	...
	/**
	 * This represents the key modifier that was selected, and is used to
	 * determine the state of the selected key. If no modifier has been selected
	 ...
	 * on its state. For example, a single button might toggle between
	 * "show details" and "hide details". The source object and the event would
	 * be the same in each case, but the command string would identify the
	 * intended action.
	 * <p>
