 ...
 * objects.
 * <P>
 * Extend this class to create a <code>KeyEvent</code> listener and override the
 * methods for the events of interest. (If you implement the
 * <code>KeyListener</code> interface, you have to define all of the methods in
 ...
 * component using the component's <code>addKeyListener</code> method. When a
 * key is pressed, released, or typed, the relevant method in the listener
