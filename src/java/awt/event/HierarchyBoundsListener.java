...
/**
 * The listener interface for receiving ancestor moved and resized events. The
 * class that is interested in processing these events either implements this
 ...
 * <code>addHierarchyBoundsListener</code> method. When the hierarchy to which
 * the Component belongs changes by the resizing or movement of an ancestor, the
 ...
 * works properly regardless of whether a program registers an
 * <code>HierarchyBoundsListener</code> or not.
 *
