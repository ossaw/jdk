 ...
 * interested in processing a component event either implements this interface
 * (and all the methods it contains) or extends the abstract
 * <code>ComponentAdapter</code> class (overriding only the methods of
 * interest). The listener object created from that class is then registered
 * with a component using the component's <code>addComponentListener</code>
 * method. When the component's size, location, or visibility changes, the
 * relevant method in the listener object is invoked, and the
 * <code>ComponentEvent</code> is passed to it.
 * <P>
 ...
 * layout works properly regardless of whether a program registers a
 * <code>ComponentListener</code> or not.
 *
