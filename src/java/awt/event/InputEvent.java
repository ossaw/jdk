...
public abstract class InputEvent extends ComponentEvent {
	...
	/**
	 * A method to obtain a mask for any existing mouse button. The returned
	 * mask may be used for different purposes. Following are some of them:
	 * <ul>
	 * <li>{@link java.awt.Robot#mousePress(int) mousePress(buttons)} and
	 * {@link java.awt.Robot#mouseRelease(int) mouseRelease(buttons)}
	 * <li>as a {@code modifiers} parameter when creating a new
	 * {@link MouseEvent} instance
	 * <li>to check {@link MouseEvent#getModifiersEx() modifiersEx} of existing
	 * {@code MouseEvent}
	 * </ul>
	 * 
	 * @param button
	 ...
	 *    {@link MouseEvent#BUTTON2 BUTTON2}  
	...
	/*
	 * A flag that indicates that this instance can be used to access the system
	 * clipboard.
	 */
	...
	/**
	 * Returns the difference in milliseconds between the timestamp of when this
	 * event occurred and midnight, January 1, 1970 UTC.
	 */
	public long getWhen() {
		return when;
	}
	 ...
	 * <P>
	 * Extended modifiers are the modifiers that ends with the _DOWN_MASK
	 * suffix, such as ALT_DOWN_MASK, BUTTON1_DOWN_MASK, and others.
	 * <P>
	 * Extended modifiers represent the state of all modal keys, such as ALT,
	 ...
	 * 2</b>, and then releases them in the same order, the following sequence
	 * of events is generated:
	 * 
	 * <PRE>
	 ...
	 * such as "Shift", "Button1", or "Ctrl+Shift". These strings can be
	 * localized by changing the <code>awt.properties</code> file.
	 * <p>
	 * Note that passing negative parameter is incorrect, and will cause the
	 * returning an unspecified string. Zero parameter means that no modifiers
