 ...
 * objects.
 * <P>
 * Extend this class to create a <code>FocusEvent</code> listener and override
 * the methods for the events of interest. (If you implement the
 * <code>FocusListener</code> interface, you have to define all of the methods
 ...
 * component using the component's <code>addFocusListener</code> method. When
 * the component gains or loses the keyboard focus, the relevant method in the
