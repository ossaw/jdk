...
public class AdjustmentEvent extends AWTEvent {
	...
	/**
	 * <code>value</code> will contain the new value of the adjustable object.
	...
	/**
	 * The <code>adjustmentType</code> describes how the adjustable object value
	 * has changed. This value can be increased/decreased by a block or unit
	 * amount where the block is associated with page increments/decrements, and
	 * a unit is associated with line increments/decrements.
	 *
	 * @serial
	...
	/**
	 * The <code>isAdjusting</code> is true if the event is one of the series of
	...
	/**
	 * Constructs an <code>AdjustmentEvent</code> object with the specified
	 * <code>Adjustable</code> source, event type, adjustment type, and value.
	 * <p>
	...
	/**
	 * Constructs an <code>AdjustmentEvent</code> object with the specified
	 * Adjustable source, event type, adjustment type, and value.
	 * <p>
	 * This method throws an <code>IllegalArgumentException</code> if
	 * <code>source</code> is <code>null</code>.
	 *
	...
	/**
	 * Returns the type of adjustment which caused the value changed event. It
	 ...
	 *
	 * @return <code>true</code> if this is one of multiple adjustment events,
