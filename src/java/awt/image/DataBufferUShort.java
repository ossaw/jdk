...
public final class DataBufferUShort extends DataBuffer {
	...
	/**
	 * Constructs an unsigned-short based <CODE>DataBuffer</CODE> with a single
	...
	/**
	 * Constructs an unsigned-short based <CODE>DataBuffer</CODE> with the
	...
	/**
	 * Constructs an unsigned-short based <CODE>DataBuffer</CODE> with a single
	 * bank using the specified array. Only the first <CODE>size</CODE> elements
	 * should be used by accessors of this <CODE>DataBuffer</CODE>.
	 * <CODE>dataArray</CODE> must be large enough to hold <CODE>size</CODE>
	 * elements.
	 * <p>
	 ...
	 *
	 * @param dataArray
	 *            The unsigned-short array for the <CODE>DataBuffer</CODE>.
	 * @param size
	...
	/**
	 * Constructs an unsigned-short based <CODE>DataBuffer</CODE> with a single
	 * bank using the specified array, size, and offset. <CODE>dataArray</CODE>
	 * must have at least <CODE>offset</CODE> + <CODE>size</CODE> elements. Only
	 * elements <CODE>offset</CODE> through <CODE>offset</CODE> +
	 * <CODE>size</CODE> - 1 should be used by accessors of this
	...
	public DataBufferUShort(short dataArray[], int size, int offset) {
		...
		if ((size + offset) > dataArray.length) {
			throw new IllegalArgumentException(
					"Length of dataArray is less " + " than size+offset.");
		}
		data = dataArray;
		bankdata = new short[1][];
		bankdata[0] = data;
	...
	/**
	 * Constructs an unsigned-short based <CODE>DataBuffer</CODE> with the
	 * specified arrays. The number of banks will be equal to
	 * <CODE>dataArray.length</CODE>. Only the first <CODE>size</CODE> elements
	 * of each array should be used by accessors of this <CODE>DataBuffer</CODE>
	 * .
	 * <p>
	 * Note that {@code DataBuffer} objects created by this constructor may be
	 * incompatible with <a href="#optimizations">performance optimizations</a>
	 ...
	 *
	 * @param dataArray
	 *            The unsigned-short arrays for the <CODE>DataBuffer</CODE>.
	 * @param size
	 *            The size of the banks in the <CODE>DataBuffer</CODE>.
	 */
	public DataBufferUShort(short dataArray[][], int size) {
	...
	/**
	 * Constructs an unsigned-short based <CODE>DataBuffer</CODE> with specified
	 ...
	 * <CODE>size</CODE> + the corresponding offset. There must be an entry in
	 * the offset array for each <CODE>dataArray</CODE> entry. For each bank,
	 * only elements <CODE>offset</CODE> through <CODE>offset</CODE> +
	 * <CODE>size</CODE> - 1 should be used by accessors of this
	 * <CODE>DataBuffer</CODE>.
	 * <p>
	 * Note that {@code DataBuffer} objects created by this constructor may be
