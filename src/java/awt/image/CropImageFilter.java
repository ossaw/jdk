...
public class CropImageFilter extends ImageFilter {
     ...
     * property indicating the cropped region. This method invokes
     ...
     * extracted and passes through only that subset of pixels that appear in
     * the output region.
     * <p>
     * Note: This method is intended to be called by the
     * <code>ImageProducer</code> of the <code>Image</code> whose pixels are
    ...
    public void setPixels(int x, int y, int w, int h, ColorModel model, byte pixels[], int off,
        ...
        consumer.setPixels(x1 - cropX, y1 - cropY, (x2 - x1), (y2 - y1), model, pixels, off + (y1 - y)
                * scansize + (x1 - x), scansize);
    }

    /**
     * Determine if the delivered int pixels intersect the region to be
     * extracted and pass through only that subset of pixels that appear in the
     * output region.
     * <p>
     * Note: This method is intended to be called by the
     * <code>ImageProducer</code> of the <code>Image</code> whose pixels are
