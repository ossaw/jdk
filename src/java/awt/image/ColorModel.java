 ...
 * 0.0 and 1.0. In such cases the integral value 0 maps to 0.0 and the value 2
 * <sup>n</sup> - 1 maps to 1.0. In other cases, such as when the normalized
...
public abstract class ColorModel implements Transparency {
	...
	/**
	 * Returns a <code>DirectColorModel</code> that describes the default format
	 * for integer RGB values used in many of the methods in the AWT image
	 * interfaces for the convenience of the programmer. The color space is the
	 * default {@link ColorSpace}, sRGB. The format for the RGB values is an
	 * integer with 8 bits each of alpha, red, green, and blue color components
	 * ordered correspondingly from the most significant byte to the least
	 * significant byte, as in: 0xAARRGGBB. Color components are not
	 * premultiplied by the alpha component. This format does not necessarily
	 * represent the native or the most efficient <code>ColorModel</code> for a
	 * particular device or for all images. It is merely used as a common color
	 * model format.
	 * 
	 * @return a <code>DirectColorModel</code>object describing default RGB
	 *         values.
	 */
	 ...
	 * specified number of bits to color/alpha components. The color space is
	 * the default RGB <code>ColorSpace</code>, which is sRGB. Pixel values are
	 * assumed to include alpha information. If color and alpha information are
	 * represented in the pixel value as separate spatial bands, the color bands
	 * are assumed not to be premultiplied with the alpha value. The
	 * transparency type is java.awt.Transparency.TRANSLUCENT. The transfer type
	 * will be the smallest of DataBuffer.TYPE_BYTE, DataBuffer.TYPE_USHORT, or
	 * DataBuffer.TYPE_INT that can hold a single pixel (or
	 * DataBuffer.TYPE_UNDEFINED if bits is greater than 32). Since this
	 * constructor has no information about the number of bits per color and
	 * alpha component, any subclass calling this constructor should override
	 * any method that requires this information.
	 * 
	 * @param bits
	 *             the number of bits of a pixel
	 * @throws IllegalArgumentException
	 *                                  if the number of bits in
	...
	/**
	 * Constructs a <code>ColorModel</code> that translates pixel values to
	 * color/alpha components. Color components will be in the specified
	 * <code>ColorSpace</code>. <code>pixel_bits</code> is the number of bits in
	 * the pixel values. The bits array specifies the number of significant bits
	 * per color and alpha component. Its length should be the number of
	 * components in the <code>ColorSpace</code> if there is no alpha
	 * information in the pixel values, or one more than this number if there is
	 * alpha information. <code>hasAlpha</code> indicates whether or not alpha
	 * information is present. The <code>boolean</code>
	 * <code>isAlphaPremultiplied</code> specifies how to interpret pixel values
	 * in which color and alpha information are represented as separate spatial
	 * bands. If the <code>boolean</code> is <code>true</code>, color samples
	 * are assumed to have been multiplied by the alpha sample. The
	 * <code>transparency</code> specifies what alpha values can be represented
	 * by this color model. The transfer type is the type of primitive array
	 * used to represent pixel values. Note that the bits array contains the
	 * number of significant bits per color/alpha component after the
	 * translation from pixel values. For example, for an
	 * <code>IndexColorModel</code> with <code>pixel_bits</code> equal to 16,
	 * the bits array might have four elements with each element set to 8.
	 * 
	 * @param pixel_bits
	 *                             the number of bits in the pixel values
	 * @param bits
	 *                             array that specifies the number of
	 *                             significant bits per color
	 *                             and alpha component
	 * @param cspace
	 *                             the specified <code>ColorSpace</code>
	 * @param hasAlpha
	 *                             <code>true</code> if alpha information is
	 *                             present;
	 *                             <code>false</code> otherwise
	 * @param isAlphaPremultiplied
	 *                             <code>true</code> if color samples are
	 *                             assumed to be
	 *                             premultiplied by the alpha samples;
	 *                             <code>false</code>
	 *                             otherwise
	 * @param transparency
	 ...
	 *                                  than the number of
	 *                                  color or alpha components in this
	 *                                  <code>ColorModel</code>, or
	 *                                  if the transparency is not a valid
	 *                                  value.
	 * @throws IllegalArgumentException
	 *                                  if the sum of the number of bits in
	 *                                  <code>bits</code> is less
	 *                                  than 1 or if any of the elements in
	 *                                  <code>bits</code> is less
	 *                                  than 0.
	...
	protected ColorModel(int pixel_bits, int[] bits, ColorSpace cspace,
		...
		if (bits.length < numComponents) {
			throw new IllegalArgumentException("Number of color/alpha "
					+ "components should be " + numComponents
					+ " but length of bits array is " + bits.length);
		}
		...
		if (maxBits == 0) {
			throw new IllegalArgumentException("There must be at least "
					+ "one component with > 0 " + "pixel bits.");
		}
	...
	/**
	 * Returns whether or not alpha is supported in this <code>ColorModel</code>
	 * .
	 * 
	...
	/**
	 * Returns whether or not the alpha has been premultiplied in the pixel
	 * values to be translated by this <code>ColorModel</code>. If the boolean
	 * is <code>true</code>, this <code>ColorModel</code> is to be used to
	 * interpret pixel values in which color and alpha information are
	 * represented as separate spatial bands, and color samples are assumed to
	 * have been multiplied by the alpha sample.
	 * 
	 * @return <code>true</code> if the alpha values are premultiplied in the
	...
	/**
	 * Returns the transfer type of this <code>ColorModel</code>. The transfer
	 * type is the type of primitive array used to represent pixel values as
	 * arrays.
	 * 
	...
	/**
	 * Returns the number of bits for the specified color/alpha component. Color
	 * components are indexed in the order specified by the
	 * <code>ColorSpace</code>. Typically, this order reflects the name of the
	 * color space type. For example, for TYPE_RGB, index 0 corresponds to red,
	 * index 1 to green, and index 2 to blue. If this <code>ColorModel</code>
	 * supports alpha, the alpha component corresponds to the index following
	 * the last color component.
	 * 
	 * @param componentIdx
	 *                     the index of the color/alpha component
	 * @return the number of bits for the color/alpha component at the specified
	 *         index.
	 * @throws ArrayIndexOutOfBoundsException
	 *                                        if <code>componentIdx</code> is
	 ...
	 * array contains the color components in the order specified by the
	 * <code>ColorSpace</code>, followed by the alpha component, if present.
	 * 
	 ...
	 * <code>ColorModel</code>. This is equal to the number of color components,
	 * optionally plus one, if there is an alpha component.
	 * 
	...
	/**
	 * Returns the number of color components in this <code>ColorModel</code>.
	 * This is the number of components returned by
	 * {@link ColorSpace#getNumComponents}.
	 * 
	 * @return the number of color components in this <code>ColorModel</code>.
	 ...
	 * necessary. The pixel value is specified as an int. An
	 * <code>IllegalArgumentException</code> is thrown if pixel values for this
	 * <code>ColorModel</code> are not conveniently representable as a single
	 * int. The returned value is not a pre-multiplied value. For example, if
	 * the alpha is premultiplied, this method divides it out before returning
	 ...
	 * <code>IllegalArgumentException</code> is thrown if pixel values for this
	 * <code>ColorModel</code> are not conveniently representable as a single
	 * int. The returned value is a non pre-multiplied value. For example, if
	 * the alpha is premultiplied, this method divides it out before returning
	 ...
	 * int. The returned value is a non pre-multiplied value, for example, if
	 * the alpha is premultiplied, this method divides it out before returning
	 * the value. If the alpha value is 0, the blue value is 0.
	 * 
	 * @param pixel
	 *              the specified pixel
	 ...
	 * 255. The pixel value is specified as an int. An
	 * <code>IllegalArgumentException</code> is thrown if pixel values for this
	 * <code>ColorModel</code> are not conveniently representable as a single
	 * int.
	 * 
	...
	/**
	 * Returns the color/alpha components of the pixel in the default RGB color
	 * model format. A color conversion is done if necessary. The pixel value is
	 * specified as an int. An <code>IllegalArgumentException</code> thrown if
	 * pixel values for this <code>ColorModel</code> are not conveniently
	 * representable as a single int. The returned value is in a non
	 * pre-multiplied format. For example, if the alpha is premultiplied, this
	 * method divides it out of the color components. If the alpha value is 0,
	 * the color values are 0.
	 * 
	 * @param pixel
	 *              the specified pixel
	 ...
	 * is done if necessary. The pixel value is specified by an array of data
	 * elements of type transferType passed in as an object reference. The
	 * returned value is a non pre-multiplied value. For example, if alpha is
	 * premultiplied, this method divides it out before returning the value. If
	 * the alpha value is 0, the red value is 0. If <code>inData</code> is not a
	 * primitive array of type transferType, a <code>ClassCastException</code>
	 * is thrown. An <code>ArrayIndexOutOfBoundsException</code> is thrown if
	 * <code>inData</code> is not large enough to hold a pixel value for this
	 * <code>ColorModel</code>. If this <code>transferType</code> is not
	 * supported, a <code>UnsupportedOperationException</code> will be thrown.
	 * Since <code>ColorModel</code> is an abstract class, any instance must be
	 * an instance of a subclass. Subclasses inherit the implementation of this
	 * method and if they don't override it, this method throws an exception if
	 * the subclass uses a <code>transferType</code> other than
	 ...
	 * conversion is done if necessary. The pixel value is specified by an array
	 * of data elements of type transferType passed in as an object reference.
	 * The returned value will be a non pre-multiplied value. For example, if
	 * the alpha is premultiplied, this method divides it out before returning
	 * the value. If the alpha value is 0, the green value is 0. If
	 * <code>inData</code> is not a primitive array of type transferType, a
	 ...
	 * conversion is done if necessary. The pixel value is specified by an array
	 * of data elements of type transferType passed in as an object reference.
	 * The returned value is a non pre-multiplied value. For example, if the
	 * alpha is premultiplied, this method divides it out before returning the
	 * value. If the alpha value is 0, the blue value will be 0. If
	 * <code>inData</code> is not a primitive array of type transferType, a
	 * <code>ClassCastException</code> is thrown. An
	 * <code>ArrayIndexOutOfBoundsException</code> is thrown if
	 * <code>inData</code> is not large enough to hold a pixel value for this
	 ...
	 * transferType passed in as an object reference. If inData is not a
	 * primitive array of type transferType, a <code>ClassCastException</code>
	 * is thrown. An <code>ArrayIndexOutOfBoundsException</code> is thrown if
	 * <code>inData</code> is not large enough to hold a pixel value for this
	 * <code>ColorModel</code>. If this <code>transferType</code> is not
	 ...
	 * is thrown. An <code>ArrayIndexOutOfBoundsException</code> is thrown if
	 * <code>inData</code> is not large enough to hold a pixel value for this
	 * <code>ColorModel</code>. The returned value will be in a non
	 * pre-multiplied format, i.e. if the alpha is premultiplied, this method
	 * will divide it out of the color components (if the alpha value is 0, the
	...
	public int getRGB(Object inData) {
		return (getAlpha(inData) << 24) | (getRed(inData) << 16) | (getGreen(
				inData) << 8) | (getBlue(inData) << 0);
	}
	 ...
	 * {@link WritableRaster#setDataElements} method of a {@link WritableRaster}
	 * object. If the pixel variable is <code>null</code>, a new array will be
	 * allocated. If <code>pixel</code> is not <code>null</code>, it must be a
	 * primitive array of type <code>transferType</code>; otherwise, a
	 * <code>ClassCastException</code> is thrown. An
	 * <code>ArrayIndexOutOfBoundsException</code> is thrown if
	 * <code>pixel</code> is not large enough to hold a pixel value for this
	 * <code>ColorModel</code>. The pixel array is returned. If this
	 * <code>transferType</code> is not supported, a
	 * <code>UnsupportedOperationException</code> will be thrown. Since
	 * <code>ColorModel</code> is an abstract class, any instance is an instance
	 * of a subclass. Subclasses must override this method since the
	...
	/**
	 * Returns an array of unnormalized color/alpha components given a pixel in
	 * this <code>ColorModel</code>. The pixel value is specified as an
	 * <code>int</code>. An <code>IllegalArgumentException</code> will be thrown
	 * if pixel values for this <code>ColorModel</code> are not conveniently
	 * representable as a single <code>int</code> or if color component values
	 * for this <code>ColorModel</code> are not conveniently representable in
	 * the unnormalized form. For example, this method can be used to retrieve
	 * the components for a specific pixel value in a
	 * <code>DirectColorModel</code>. If the components array is
	 * <code>null</code>, a new array will be allocated. The components array
	 * will be returned. Color/alpha components are stored in the components
	 * array starting at <code>offset</code> (even if the array is allocated by
	 * this method). An <code>ArrayIndexOutOfBoundsException</code> is thrown if
	 * the components array is not <code>null</code> and is not large enough to
	 * hold all the color and alpha components (starting at offset). Since
	 * <code>ColorModel</code> is an abstract class, any instance is an instance
	 * of a subclass. Subclasses must override this method since the
	 * implementation in this abstract class throws an
	 * <code>UnsupportedOperationException</code>.
	 ...
	 *                   the specified pixel
	 * @param components
	 *                   the array to receive the color and alpha components of
	 *                   the
	 *                   specified pixel
	 * @param offset
	 *                   the offset into the <code>components</code> array at
	 *                   which to
	 *                   start storing the color and alpha components
	...
	/**
	 * Returns an array of unnormalized color/alpha components given a pixel in
	 * this <code>ColorModel</code>. The pixel value is specified by an array of
	 * data elements of type transferType passed in as an object reference. If
	 * <code>pixel</code> is not a primitive array of type transferType, a
	 * <code>ClassCastException</code> is thrown. An
	 * <code>IllegalArgumentException</code> will be thrown if color component
	 * values for this <code>ColorModel</code> are not conveniently
	 * representable in the unnormalized form. An
	 * <code>ArrayIndexOutOfBoundsException</code> is thrown if
	 * <code>pixel</code> is not large enough to hold a pixel value for this
	 * <code>ColorModel</code>. This method can be used to retrieve the
	 * components for a specific pixel value in any <code>ColorModel</code>. If
	 * the components array is <code>null</code>, a new array will be allocated.
	 * The components array will be returned. Color/alpha components are stored
	 * in the <code>components</code> array starting at <code>offset</code>
	 * (even if the array is allocated by this method). An
	 * <code>ArrayIndexOutOfBoundsException</code> is thrown if the components
	 * array is not <code>null</code> and is not large enough to hold all the
	 * color and alpha components (starting at <code>offset</code>). Since
	 * <code>ColorModel</code> is an abstract class, any instance is an instance
	 * of a subclass. Subclasses must override this method since the
	 * implementation in this abstract class throws an
	 * <code>UnsupportedOperationException</code>.
	 ...
	 *                   the specified pixel
	 * @param components
	 *                   an array that receives the color and alpha components
	 *                   of the
	 *                   specified pixel
	 * @param offset
	 *                   the index into the <code>components</code> array at
	 *                   which to
	 *                   begin storing the color and alpha components of the
	 *                   specified
	 *                   pixel
	 * @return an array containing the color and alpha components of the
	 *         specified pixel starting at the specified offset.
	 ...
	 * form, given a normalized component array. Unnormalized components are
	 * unsigned integral values between 0 and 2<sup>n</sup> - 1, where n is the
	 * number of bits for a particular component. Normalized components are
	 * float values between a per component minimum and maximum specified by the
	 * <code>ColorSpace</code> object for this <code>ColorModel</code>. An
	 * <code>IllegalArgumentException</code> will be thrown if color component
	 * values for this <code>ColorModel</code> are not conveniently
	 * representable in the unnormalized form. If the <code>components</code>
	 * array is <code>null</code>, a new array will be allocated. The
	 * <code>components</code> array will be returned. Color/alpha components
	 * are stored in the <code>components</code> array starting at
	 * <code>offset</code> (even if the array is allocated by this method). An
	 ...
	 * <code>offset</code>). An <code>IllegalArgumentException</code> is thrown
	 * if the <code>normComponents</code> array is not large enough to hold all
	 ...
	 *                                       <CODE>ColorModel</CODE> are
	 *                                       not conveniently representable in
	 *                                       the unnormalized form.
	 * @throws IllegalArgumentException
	 *                                       if the length of
	 *                                       <code>normComponents</code> minus
	 *                                       <code>normOffset</code> is less
	 *                                       than
	 *                                       <code>numComponents</code>
	 * @throws UnsupportedOperationException
	 *                                       if the constructor of this
	 *                                       <code>ColorModel</code> called the
	 *                                       <code>super(bits)</code>
	 *                                       constructor, but did not override
		...
		if (supportsAlpha && isAlphaPremultiplied) {
			...
			for (int i = 0; i < numColorComponents; i++) {
				components[offset + i] = (int) (normComponents[normOffset + i]
						* ((1 << nBits[i]) - 1) * normAlpha + 0.5f);
			}
			components[offset + numColorComponents] = (int) (normAlpha
	...
	/**
	 * Returns an array of all of the color/alpha components in normalized form,
	 * given an unnormalized component array. Unnormalized components are
	 * unsigned integral values between 0 and 2<sup>n</sup> - 1, where n is the
	 * number of bits for a particular component. Normalized components are
	 * float values between a per component minimum and maximum specified by the
	 * <code>ColorSpace</code> object for this <code>ColorModel</code>. An
	 * <code>IllegalArgumentException</code> will be thrown if color component
	 * values for this <code>ColorModel</code> are not conveniently
	 * representable in the unnormalized form. If the
	 * <code>normComponents</code> array is <code>null</code>, a new array will
	 * be allocated. The <code>normComponents</code> array will be returned.
	 * Color/alpha components are stored in the <code>normComponents</code>
	 * array starting at <code>normOffset</code> (even if the array is allocated
	 * by this method). An <code>ArrayIndexOutOfBoundsException</code> is thrown
	 * if the <code>normComponents</code> array is not <code>null</code> and is
	 * not large enough to hold all the color and alpha components (starting at
	 * <code>normOffset</code>). An <code>IllegalArgumentException</code> is
	 * thrown if the <code>components</code> array is not large enough to hold
	 ...
	 * instance of a subclass. The default implementation of this method in this
	 * abstract class assumes that component values for this class are
	 * conveniently representable in the unnormalized form. Therefore,
	 * subclasses which may have instances which do not support the unnormalized
	 * form must override this method.
	 * 
	 * @param components
	 ...
	 *                                       {@link #ColorModel(int)}.
	 * @throws UnsupportedOperationException
	 *                                       if this method is unable to
	 *                                       determine the number of bits per
	 *                                       component
	 */
	public float[] getNormalizedComponents(int[] components, int offset,
		...
		if (supportsAlpha && isAlphaPremultiplied) {
			...
			if (normAlpha != 0.0f) {
				for (int i = 0; i < numColorComponents; i++) {
					normComponents[normOffset + i] = ((float) components[offset
							+ i]) / (normAlpha * ((float) ((1 << nBits[i])
									- 1)));
				}
			} else {
				for (int i = 0; i < numColorComponents; i++) {
	 ...
	 * <code>ColorModel</code> are not conveniently representable as a single
	 * <code>int</code> or if color component values for this
	 * <code>ColorModel</code> are not conveniently representable in the
	 * unnormalized form. An <code>ArrayIndexOutOfBoundsException</code> is
	 * thrown if the <code>components</code> array is not large enough to hold
	 * all the color and alpha components (starting at <code>offset</code>).
	 * Since <code>ColorModel</code> is an abstract class, any instance is an
	 ...
	 *                                        <code>ColorModel</code> are not
	 *                                        conveniently representable in the
	 *                                        unnormalized form
	 * @throws ArrayIndexOutOfBoundsException
	 *                                        if the <code>components</code>
	 *                                        array is not large enough to
	 *                                        hold all of the color and alpha
	 ...
	 * conveniently representable in the unnormalized form. An
	 * <code>ArrayIndexOutOfBoundsException</code> is thrown if the
	 * <code>components</code> array is not large enough to hold all the color
	 * and alpha components (starting at <code>offset</code>). If the
	 * <code>obj</code> variable is <code>null</code>, a new array will be
	 * allocated. If <code>obj</code> is not <code>null</code>, it must be a
	 * primitive array of type transferType; otherwise, a
	 * <code>ClassCastException</code> is thrown. An
	 * <code>ArrayIndexOutOfBoundsException</code> is thrown if <code>obj</code>
	 ...
	 * @param obj
	 *                   the <code>Object</code> representing an array of color
	 *                   and
	 *                   alpha components
	 * @return an <code>Object</code> representing an array of color and alpha
	 *         components.
	 * @throws ClassCastException
	 ...
	 *                                        or the
	 *                                        <code>components</code> array is
	 *                                        not large enough to hold all
	 *                                        of the color and alpha components
	 *                                        starting at
	 *                                        <code>offset</code>
	 * @throws IllegalArgumentException
	 *                                        if component values for this
	 ...
	 * <code>ColorModel</code> are not conveniently representable as a single
	 * <code>int</code>. An <code>ArrayIndexOutOfBoundsException</code> is
	 * thrown if the <code>normComponents</code> array is not large enough to
	 * hold all the color and alpha components (starting at
	 * <code>normOffset</code>). Since <code>ColorModel</code> is an abstract
	 * class, any instance is an instance of a subclass. The default
	 * implementation of this method in this abstract class first converts from
	 * the normalized form to the unnormalized form and then calls
	 * <code>getDataElement(int[], int)</code>. Subclasses which may have
	 * instances which do not support the unnormalized form must override this
	 * method.
	 * 
	 * @param normComponents
	 ...
	 * components. This array can then be passed to the
	 * <code>setDataElements</code> method of a <code>WritableRaster</code>
	 * object. An <code>ArrayIndexOutOfBoundsException</code> is thrown if the
	 * <code>normComponents</code> array is not large enough to hold all the
	 * color and alpha components (starting at <code>normOffset</code>). If the
	 * <code>obj</code> variable is <code>null</code>, a new array will be
	 * allocated. If <code>obj</code> is not <code>null</code>, it must be a
	 * primitive array of type transferType; otherwise, a
	 * <code>ClassCastException</code> is thrown. An
	...
	/**
	 * Returns an array of all of the color/alpha components in normalized form,
	 * given a pixel in this <code>ColorModel</code>. The pixel value is
	 * specified by an array of data elements of type transferType passed in as
	 * an object reference. If pixel is not a primitive array of type
	 * transferType, a <code>ClassCastException</code> is thrown. An
	 * <code>ArrayIndexOutOfBoundsException</code> is thrown if
	 * <code>pixel</code> is not large enough to hold a pixel value for this
	 * <code>ColorModel</code>. Normalized components are float values between a
	 * per component minimum and maximum specified by the
	 * <code>ColorSpace</code> object for this <code>ColorModel</code>. If the
	 * <code>normComponents</code> array is <code>null</code>, a new array will
	 * be allocated. The <code>normComponents</code> array will be returned.
	 * Color/alpha components are stored in the <code>normComponents</code>
	 * array starting at <code>normOffset</code> (even if the array is allocated
	 ...
	 * <code>normOffset</code>). Since <code>ColorModel</code> is an abstract
	 * class, any instance is an instance of a subclass. The default
	 * implementation of this method in this abstract class first retrieves
	 * color and alpha components in the unnormalized form using
	...
	public float[] getNormalizedComponents(Object pixel, float[] normComponents,
		...
		return getNormalizedComponents(components, 0, normComponents,
				normOffset);
	}

	/**
	 * Tests if the specified <code>Object</code> is an instance of
	 * <code>ColorModel</code> and if it equals this <code>ColorModel</code>.
	 * 
	 * @param obj
	 *            the <code>Object</code> to test for equality
	 * @return <code>true</code> if the specified <code>Object</code> is an
	 *         instance of <code>ColorModel</code> and equals this
	 *         <code>ColorModel</code>; <code>false</code> otherwise.
	 */
	public boolean equals(Object obj) {
		...
		if (supportsAlpha != cm.hasAlpha() || isAlphaPremultiplied != cm
				.isAlphaPremultiplied() || pixel_bits != cm.getPixelSize()
				|| transparency != cm.getTransparency() || numComponents != cm
						.getNumComponents()) {
			return false;
		}
	...
	public int hashCode() {
		...
		result = (supportsAlpha ? 2 : 3) + (isAlphaPremultiplied ? 4 : 5)
				+ pixel_bits * 6 + transparency * 7 + numComponents * 8;
	 ...
	 * <code>ColorModel</code>.
	 * 
	 * @return the <code>ColorSpace</code> of this <code>ColorModel</code>.
	 */
	 ...
	 * method will also return an instance of this <code>ColorModel</code> with
	 * the <code>isAlphaPremultiplied</code> flag set appropriately. This method
	 * will throw a <code>UnsupportedOperationException</code> if it is not
	 * supported by this <code>ColorModel</code>. Since <code>ColorModel</code>
	 * is an abstract class, any instance is an instance of a subclass.
	 * Subclasses must override this method since the implementation in this
	 * abstract class throws an <code>UnsupportedOperationException</code>.
	 * 
	 * @param raster
	 *                             the <code>WritableRaster</code> data
	 * @param isAlphaPremultiplied
	 *                             <code>true</code> if the alpha is
	 *                             premultiplied;
	 *                             <code>false</code> otherwise
	 * @return a <code>ColorModel</code> object that represents the coerced
	 *         data.
	 */
	 ...
	 * <code>ColorModel</code> and <code>false</code> if it is not. Since
	 * <code>ColorModel</code> is an abstract class, any instance is an instance
	 * of a subclass. Subclasses must override this method since the
	 * implementation in this abstract class throws an
	 * <code>UnsupportedOperationException</code>.
	 * 
	 * @param raster
	 *               the {@link Raster} object to test for compatibility
	 ...
	 * 
	 * @param w
	 *          the width to apply to the new <code>WritableRaster</code>
	 * @param h
	 *          the height to apply to the new <code>WritableRaster</code>
	 * @return a <code>WritableRaster</code> object with the specified width and
	 *         height.
	 * @throws UnsupportedOperationException
	 *                                       if this method is not supported by
	 *                                       this
	 ...
	 * 
	 * @param w
	 *          the width to apply to the new <code>SampleModel</code>
	 * @param h
	 *          the height to apply to the new <code>SampleModel</code>
	 ...
	 * 
	 * @param sm
	 *           the specified <code>SampleModel</code>
	...
	/**
	 * Disposes of system resources associated with this <code>ColorModel</code>
	 * once this <code>ColorModel</code> is no longer referenced.
	 */
	public void finalize() {}

	/**
	 * Returns a <code>Raster</code> representing the alpha channel of an image,
	 * extracted from the input <code>Raster</code>, provided that pixel values
	 * of this <code>ColorModel</code> represent color and alpha information as
	 * separate spatial bands (e.g. {@link ComponentColorModel} and
	 * <code>DirectColorModel</code>). This method assumes that
	 * <code>Raster</code> objects associated with such a
	 * <code>ColorModel</code> store the alpha band, if present, as the last
	 * band of image data. Returns <code>null</code> if there is no separate
	 * spatial alpha channel associated with this <code>ColorModel</code>. If
	 * this is an <code>IndexColorModel</code> which has alpha in the lookup
	 * table, this method will return <code>null</code> since there is no
	 * spatially discrete alpha channel. This method will create a new
	 * <code>Raster</code> (but will share the data array). Since
	 * <code>ColorModel</code> is an abstract class, any instance is an instance
	 * of a subclass. Subclasses must override this method to get any behavior
	 * other than returning <code>null</code> because the implementation in this
	 * abstract class returns <code>null</code>.
	 * 
	 * @param raster
	 *               the specified <code>Raster</code>
	 * @return a <code>Raster</code> representing the alpha channel of an image,
	 *         obtained from the specified <code>Raster</code>.
	 */
	...
	public String toString() {
		return new String("ColorModel: #pixelBits = " + pixel_bits
				+ " numComponents = " + numComponents + " color space = "
				+ colorSpace + " transparency = " + transparency
				+ " has alpha = " + supportsAlpha + " isAlphaPre = "
	...
	static Map<ICC_ColorSpace, byte[]> g8Tos8Map = null; // 8-bit gray values to
															// 8-bit sRGB values
	static Map<ICC_ColorSpace, byte[]> lg16Toog8Map = null; // 16-bit linear to
															// 8-bit "other"
															// gray
	static Map<ICC_ColorSpace, byte[]> g16Tos8Map = null; // 16-bit gray values
															// to 8-bit sRGB
															// values
	static Map<ICC_ColorSpace, short[]> lg16Toog16Map = null; // 16-bit linear
																// to 16-bit
																// "other" gray
	 ...
	 * ColorSpace to the appropriate 8-bit sRGB value. I.e., if lut is the byte
	 * array returned by this method and sval = lut[gval], then the sRGB triple
	 * (sval,sval,sval) is the best match to gval. Cache references to any
	 * computed LUT in a Map.
	 */
	static byte[] getGray8TosRGB8LUT(ICC_ColorSpace grayCS) {
		...
		ICC_ColorSpace srgbCS = (ICC_ColorSpace) ColorSpace.getInstance(
				ColorSpace.CS_sRGB);
		transformList[0] = mdl.createTransform(grayCS.getProfile(),
				ColorTransform.Any, ColorTransform.In);
		transformList[1] = mdl.createTransform(srgbCS.getProfile(),
		...
		if (g8Tos8Map == null) {
			g8Tos8Map = Collections.synchronizedMap(
					new WeakHashMap<ICC_ColorSpace, byte[]>(2));
		}
	...
	/*
	 * Return a byte LUT that converts 16-bit gray values in the CS_GRAY linear
	 * gray ColorSpace to the appropriate 8-bit value in the grayCS ColorSpace.
	...
	static byte[] getLinearGray16ToOtherGray8LUT(ICC_ColorSpace grayCS) {
		...
		ColorTransform[] transformList = new ColorTransform[2];
		PCMM mdl = CMSManager.getModule();
		ICC_ColorSpace lgCS = (ICC_ColorSpace) ColorSpace.getInstance(
				ColorSpace.CS_GRAY);
		transformList[0] = mdl.createTransform(lgCS.getProfile(),
				ColorTransform.Any, ColorTransform.In);
		transformList[1] = mdl.createTransform(grayCS.getProfile(),
				ColorTransform.Any, ColorTransform.Out);
		ColorTransform t = mdl.createTransform(transformList);
		...
		for (int i = 0; i <= 65535; i++) {
			...
			lg16Toog8LUT[i] = (byte) (((float) (tmp[i] & 0xffff)) * (1.0f
					/ 257.0f) + 0.5f);
		}
		if (lg16Toog8Map == null) {
			lg16Toog8Map = Collections.synchronizedMap(
					new WeakHashMap<ICC_ColorSpace, byte[]>(2));
		}
	...
	static byte[] getGray16TosRGB8LUT(ICC_ColorSpace grayCS) {
		...
		for (int i = 0, j = 2; i <= 65535; i++, j += 3) {
			...
			// scale unsigned short (0 - 65535) to unsigned byte (0 - 255)
			g16Tos8LUT[i] = (byte) (((float) (tmp[j] & 0xffff)) * (1.0f
					/ 257.0f) + 0.5f);
		}
		if (g16Tos8Map == null) {
			g16Tos8Map = Collections.synchronizedMap(
					new WeakHashMap<ICC_ColorSpace, byte[]>(2));
		}
	...
	/*
	 * Return a short LUT that converts 16-bit gray values in the CS_GRAY linear
	 * gray ColorSpace to the appropriate 16-bit value in the grayCS ColorSpace.
	 * Cache references to any computed LUT in a Map.
	 */
	static short[] getLinearGray16ToOtherGray16LUT(ICC_ColorSpace grayCS) {
		...
		if (lg16Toog16Map == null) {
			lg16Toog16Map = Collections.synchronizedMap(
					new WeakHashMap<ICC_ColorSpace, short[]>(2));
		}
