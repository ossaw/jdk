...
public class SinglePixelPackedSampleModel extends SampleModel {
	 ...
	 * @throws IllegalArgumentException
	 *             if any mask in <code>bitMask</code> is not contiguous
	 * @throws IllegalArgumentException
	 *             if <code>dataType</code> is not either
	 *             <code>DataBuffer.TYPE_BYTE</code>,
	 *             <code>DataBuffer.TYPE_USHORT</code>, or
			...
			if (mask != 0) {
				...
				if (mask != 0) {
					throw new IllegalArgumentException(
							"Mask " + bitMasks[i] + " must be contiguous");
				}
			}
	 ...
	 *                if the length of the bands argument is greater than the
	...
	public boolean equals(Object o) {
		...
		return this.width == that.width && this.height == that.height
				...
				&& Arrays.equals(this.bitSizes, that.bitSizes) && this.maxBitSize == that.maxBitSize
