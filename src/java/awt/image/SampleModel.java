...
public abstract class SampleModel {
     ...
     * 
     * @return the width in pixels of the region of image data that this
     ...
     * 
     * @return the height in pixels of the region of image data that this
     *         <code>SampleModel</code> describes.
     */
    ...
    /**
     * Returns the number of data elements needed to transfer a pixel via the
     ...
     * format, depending on the implementation of the SampleModel. Using these
     * methods, pixels are transferred as an array of getNumDataElements()
     * elements of a primitive type given by getTransferType(). The TransferType
     * may or may not be the same as the storage DataType.
     * 
     ...
     * depending on the implementation of the SampleModel. Using these methods,
     * pixels are transferred as an array of getNumDataElements() elements of a
     * primitive type given by getTransferType(). The TransferType may or may
     * not be the same as the storage DataType. The TransferType will be one of
     * the types defined in DataBuffer.
     * 
    ...
    /**
     * Returns the samples for a specified pixel in an int array, one sample per
     * array element. ArrayIndexOutOfBoundsException may be thrown if the
     ...
     * Data may be returned in a packed format, thus increasing efficiency for
     * data transfers. Generally, obj should be passed in as null, so that the
     * Object will be created automatically and will be of the right primitive
     * data type.
     * <p>
     * The following code illustrates transferring data for one pixel from
     * DataBuffer <code>db1</code>, whose storage layout is described by
     * SampleModel <code>sm1</code>, to DataBuffer <code>db2</code>, whose
     * storage layout is described by SampleModel <code>sm2</code>. The transfer
     * will generally be more efficient than using getPixel/setPixel.
     * 
     * <pre>
     * SampleModel sm1, sm2;
     * DataBuffer db1, db2;
     ...
     * a packed format, thus increasing efficiency for data transfers.
     ...
     * Java 2D API, this will be one of DataBuffer.TYPE_BYTE,
     * DataBuffer.TYPE_USHORT, DataBuffer.TYPE_INT, DataBuffer.TYPE_SHORT,
     * DataBuffer.TYPE_FLOAT, or DataBuffer.TYPE_DOUBLE. Data in the array may
     * be in a packed format, thus increasing efficiency for data transfers.
     * <p>
     * The following code illustrates transferring data for one pixel from
     * DataBuffer <code>db1</code>, whose storage layout is described by
     * SampleModel <code>sm1</code>, to DataBuffer <code>db2</code>, whose
    ...
    /**
     * Returns all samples for a rectangle of pixels in an int array, one sample
     * per array element. ArrayIndexOutOfBoundsException may be thrown if the
     * coordinates are not in bounds.
     * 
     * @param x
    ...
    /**
     * Returns all samples for a rectangle of pixels in a float array, one
     ...
     * an int. ArrayIndexOutOfBoundsException may be thrown if the coordinates
     * are not in bounds.
     * 
     * @param x
     *        The X coordinate of the pixel location.
    ...
    /**
     * Returns the samples for a specified band for the specified rectangle of
     * pixels in a float array, one sample per array element.
     * ArrayIndexOutOfBoundsException may be thrown if the coordinates are not
     * in bounds.
     * 
     * @param x
     ...
     * pixels in a double array, one sample per array element.
     * ArrayIndexOutOfBoundsException may be thrown if the coordinates are not
     * in bounds.
     * 
     * @param x
    ...
    /**
     * Sets a sample in the specified band for the pixel located at (x,y) in the
     * DataBuffer using a float for input. The default implementation of this
     * method casts the input float sample to an int and then calls the
     * <code>setSample(int, int, int, DataBuffer)</code> method using that int
     * value. ArrayIndexOutOfBoundsException may be thrown if the coordinates
     * are not in bounds.
     * 
     * @param x
     *        The X coordinate of the pixel location.
    ...
    /**
     * Sets a sample in the specified band for the pixel located at (x,y) in the
     * DataBuffer using a double for input. The default implementation of this
     * method casts the input double sample to an int and then calls the
     * <code>setSample(int, int, int, DataBuffer)</code> method using that int
     * value. ArrayIndexOutOfBoundsException may be thrown if the coordinates
     * are not in bounds.
     * 
    ...
    /**
     * Sets the samples in the specified band for the specified rectangle of
     * pixels from a float array containing one sample per array element.
     * ArrayIndexOutOfBoundsException may be thrown if the coordinates are not
     * in bounds.
     * 
     * @param x
    ...
    /**
     * Sets the samples in the specified band for the specified rectangle of
     * pixels from a double array containing one sample per array element.
     * ArrayIndexOutOfBoundsException may be thrown if the coordinates are not
     * in bounds.
     * 
     * @param x
    ...
    /**
     * Creates a SampleModel which describes data in this SampleModel's format,
    ...
    /**
     * Creates a DataBuffer that corresponds to this SampleModel. The
     * DataBuffer's width and height will match this SampleModel's.
     * 
