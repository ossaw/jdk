...
/**
 * The RenderedImageFactory interface (often abbreviated RIF) is intended to be
 * implemented by classes that wish to act as factories to produce different
 * renderings, for example by executing a series of BufferedImageOps on a set of
 * sources, depending on a specific set of parameters, properties, and rendering
 * hints.
 */
public interface RenderedImageFactory {

    /**
     * Creates a RenderedImage representing the results of an imaging operation
     ...
     * parameters. For example, if a RenderedImageFactory is only capable of
     ...
     * to indicate which RenderingHints were used to create the image. In
     * addition any RenderedImages that are obtained via the getSources() method
