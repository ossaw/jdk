...
public interface RenderableImage {
	...
	/**
	 * String constant that can be used to identify a property on a
	 * RenderedImage obtained via the createRendering or createScaledRendering
	 * methods. If such a property exists, the value of the property will be a
	 * RenderingHints object specifying which hints were observed in creating
	 * the rendering.
	 */
	 ...
	 * an existing rendering may be cached and reused. It is always safe to
	 * return true.
	 * 
	...
	/**
	 * Returnd a RenderedImage instance of this image with a default width and
	 ...
	 * The rendering hints are empty. createDefaultRendering may make use of a
	 * stored rendering for speed.
	 *
	 * @return a RenderedImage containing the rendered data.
	 */
