...
public class RenderContext implements Cloneable {
    ...
    /**
     * Constructs a RenderContext with a given transform. The area of interest
     * is supplied as a Shape, and the rendering hints are supplied as a
     ...
     * 
     * @return a <code>RenderingHints</code> object that represents the
     *         rendering hints of this <code>RenderContext</code>.
    ...
    /**
     * Sets the current user-to-device AffineTransform contained in the
     ...
     * </pre>
     * 
     * This method does the same thing as the preConcatenateTransform method. It
     * is here for backward compatibility with previous releases which
     ...
     * </pre>
     * 
     * This method does the same thing as the concatenateTransform method. It is
     * here for backward compatibility with previous releases which misspelled
     * the method name.
     *
     * @param modTransform
     *                     the AffineTransform to append to the current usr2dev
     ...
     *
     * @return a reference to the area of interest of the RenderContext, or null
    ...
    /**
     * Makes a copy of a RenderContext. The area of interest is copied by
     * reference. The usr2dev AffineTransform and hints are cloned, while the
     * area of interest is copied by reference.
     *
