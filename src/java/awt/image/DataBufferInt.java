...
public final class DataBufferInt extends DataBuffer {
    ...
    /**
     * Constructs an integer-based <CODE>DataBuffer</CODE> with a single bank
     * using the specified array. Only the first <CODE>size</CODE> elements
    ...
    /**
     * Constructs an integer-based <CODE>DataBuffer</CODE> with a single bank
     * using the specified array, size, and offset. <CODE>dataArray</CODE> must
     * have at least <CODE>offset</CODE> + <CODE>size</CODE> elements. Only
