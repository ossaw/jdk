...
public interface WritableRenderedImage extends RenderedImage {
    ...
    /**
     * Relinquishes the right to write to a tile. If the caller continues to
    ...
    /**
     * Returns an array of Point objects indicating which tiles are checked out
     * for writing. Returns null if none are checked out.
     * 
    ...
    /**
     * Returns whether any tile is checked out for writing. Semantically
     * equivalent to (getWritableTileIndices() != null).
     * 
     * @return <code>true</code> if any tiles are checked out for writing;
     *         <code>false</code> otherwise.
     */
