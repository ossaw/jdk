...
public interface BufferedImageOp {
     ...
     * <CODE>BufferedImage</CODE>. If the color models for the two images do not
     * match, a color conversion into the destination color model is performed.
     * If the destination image is null, a <CODE>BufferedImage</CODE> with an
     * appropriate <CODE>ColorModel</CODE> is created.
     * <p>
    ...
    /**
     * Returns the bounding box of the filtered destination image. An
     * <CODE>IllegalArgumentException</CODE> may be thrown if the source image
     ...
     * bands. An <CODE>IllegalArgumentException</CODE> may be thrown if the
     * source image is incompatible with the types of images allowed by the
     ...
     *         <CODE>BufferedImageOp</CODE>. Returns null if no hints have been
     *         set.
     */
