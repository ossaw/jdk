 ...
 * elements of the DataBuffer's banks exist with and without a bank specifier.
 * The methods without a bank specifier use the default 0th bank. The DataBuffer
 * can optionally take an offset per bank, so that data in an existing array can
 * be used even if the interesting data doesn't start at array location zero.
 * Getting or setting the 0th element of a bank, uses the (0+offset)th element
 * of the array. The size field specifies how much of the data array is
 * available for use. Size + offset for a given bank should never be greater
 * than the length of the associated data array. The data type of a data buffer
 * indicates the type of the data array(s) and may also indicate additional
 * semantics, e.g. storing unsigned 8-bit data in elements of a byte array. The
 * data type may be TYPE_UNDEFINED or one of the types defined below. Other
 * types may be added in the future. Generally, an object of class DataBuffer
 * will be cast down to one of its data type specific subclasses to access data
 * type specific methods for improved performance. Currently, the Java 2D(tm)
 * API image classes use TYPE_BYTE, TYPE_USHORT, TYPE_INT, TYPE_SHORT,
...
public abstract class DataBuffer {
	 ...
	 *             if <code>type</code> is less than zero or greater than
	 *             {@link #TYPE_DOUBLE}
	 */
	...
	/**
	 * Constructs a DataBuffer containing one bank of the specified data type
	 * and size.
	 *
	 * @param dataType
	...
	/**
	 * Constructs a DataBuffer containing the specified number of banks. Each
	...
	/**
	 * Constructs a DataBuffer containing the specified number of banks with the
	 * indicated initial {@link State State}. Each bank has the specified size
	 * and an offset of 0.
	 *
	 * @param initialState
	 *            the initial {@link State State} state of the data
	...
	/**
	 * Constructs a DataBuffer that contains the specified number of banks. Each
	...
	/**
	 * Constructs a DataBuffer that contains the specified number of banks with
	 * the indicated initial {@link State State}. Each bank has the specified
	 ...
	 * Each bank has the specified datatype and size. The offset for each bank
	 ...
	 *             if <code>numBanks</code> does not equal the length of
	 *             <code>offsets</code>
	 */
	...
	/**
	 * Constructs a DataBuffer which contains the specified number of banks with
	 * the indicated initial {@link State State}. Each bank has the specified
	 * datatype and size. The offset for each bank is specified by its
	...
	/**
	 * Sets the requested data array element in the first (default) bank from
	 * the given integer.
	 * 
	 * @param i
	...
	/**
	 * Returns the requested data array element from the first (default) bank as
	 * a float. The implementation in this class is to cast getElem(i) to a
	 * float. Subclasses may override this method if another implementation is
	 * needed.
	 * 
	 * @param i
	 *            the index of the requested data array element
	 ...
	 * float. The implementation in this class is to cast
	 * {@link #getElem(int, int)} to a float. Subclasses can override this
	...
	/**
	 * Sets the requested data array element in the first (default) bank from
	 * the given float. The implementation in this class is to cast val to an
	 * int and call {@link #setElem(int, int)}. Subclasses can override this
	 * method if another implementation is needed.
	 * 
	 * @param i
	 *            the specified index
	...
	/**
	 * Sets the requested data array element in the specified bank from the
	 * given float. The implementation in this class is to cast val to an int
	 * and call {@link #setElem(int, int)}. Subclasses can override this method
	...
	/**
	 * Returns the requested data array element from the first (default) bank as
	 * a double. The implementation in this class is to cast
	 * {@link #getElem(int)} to a double. Subclasses can override this method if
	...
	/**
	 * Returns the requested data array element from the specified bank as a
	 * double. The implementation in this class is to cast getElem(bank, i) to a
	 * double. Subclasses may override this method if another implementation is
	 * needed.
	 * 
	 * @param bank
	 *            the specified bank
	...
	/**
	 * Sets the requested data array element in the first (default) bank from
	 * the given double. The implementation in this class is to cast val to an
	 * int and call {@link #setElem(int, int)}. Subclasses can override this
	 * method if another implementation is needed.
	 * 
	 * @param i
	...
	/**
	 * Sets the requested data array element in the specified bank from the
	 * given double. The implementation in this class is to cast val to an int
	 * and call {@link #setElem(int, int)}. Subclasses can override this method
	 * if another implementation is needed.
	 * 
	 * @param bank
