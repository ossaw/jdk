...
/**
 * This class extends <code>DataBuffer</code> and stores data internally in
...
public final class DataBufferDouble extends DataBuffer {
     ...
     *
     * @param dataArray
     *                  An array of <code>double</code>s to be used as the first
     *                  and
     ...
     *
     * @param dataArray
     *                  An array of arrays of <code>double</code>s to be used as
     *                  the
     ...
     * <code>size</code> plus the corresponding offset. There must be an entry
     * in the <code>offsets</code> array for each data array.
     * <p>
     * Note that {@code DataBuffer} objects created by this constructor may be
     * incompatible with <a href="#optimizations">performance optimizations</a>
     * used by some implementations (such as caching an associated image in
