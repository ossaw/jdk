...
public class DirectColorModel extends PackedColorModel {
     ...
     * indicate which bits in an <code>int</code> pixel representation contain
     * the red, green and blue color samples. As pixel values do not contain
     * alpha information, all pixels are treated as opaque, which means that
     * alpha&nbsp;=&nbsp;1.0. All of the bits in each mask must be contiguous
     * and fit in the specified number of least significant bits of an
     * <code>int</code> pixel representation. The <code>ColorSpace</code> is the
     * default sRGB space. The transparency value is Transparency.OPAQUE. The
     * transfer type is the smallest of DataBuffer.TYPE_BYTE,
     * DataBuffer.TYPE_USHORT, or DataBuffer.TYPE_INT that can hold a single
     * pixel.
     * 
     * @param bits
     *        the number of bits in the pixel values; for example, the sum
     *        of the number of bits in the masks.
     * @param rmask
     *        specifies a mask indicating which bits in an integer pixel
     *        contain the red component
     * @param gmask
     *        specifies a mask indicating which bits in an integer pixel
     *        contain the green component
     * @param bmask
     *        specifies a mask indicating which bits in an integer pixel
     *        contain the blue component
     */
     ...
     * If <code>amask</code> is 0, pixel values do not contain alpha information
     * and all pixels are treated as opaque, which means that
     * alpha&nbsp;=&nbsp;1.0. All of the bits in each mask must be contiguous
     * and fit in the specified number of least significant bits of an
     * <code>int</code> pixel representation. Alpha, if present, is not
     * premultiplied. The <code>ColorSpace</code> is the default sRGB space. The
     * transparency value is Transparency.OPAQUE if no alpha is present, or
     * Transparency.TRANSLUCENT otherwise. The transfer type is the smallest of
     * DataBuffer.TYPE_BYTE, DataBuffer.TYPE_USHORT, or DataBuffer.TYPE_INT that
    ...
    public DirectColorModel(int bits, int rmask, int gmask, int bmask, int amask) {
        super(ColorSpace.getInstance(ColorSpace.CS_sRGB), bits, rmask, gmask, bmask, amask, false, amask == 0
                ? Transparency.OPAQUE : Transparency.TRANSLUCENT, ColorModel.getDefaultTransferType(bits));
        setFields();
    }

    /**
     * Constructs a <code>DirectColorModel</code> from the specified parameters.
     * Color components are in the specified <code>ColorSpace</code>, which must
     * be of type ColorSpace.TYPE_RGB and have minimum normalized component
     * values which are all 0.0 and maximum values which are all 1.0. The masks
     * specify which bits in an <code>int</code> pixel representation contain
     * the red, green and blue color samples and the alpha sample, if present.
     * If <code>amask</code> is 0, pixel values do not contain alpha information
     * and all pixels are treated as opaque, which means that
     * alpha&nbsp;=&nbsp;1.0. All of the bits in each mask must be contiguous
     * and fit in the specified number of least significant bits of an
     * <code>int</code> pixel representation. If there is alpha, the
     * <code>boolean</code> <code>isAlphaPremultiplied</code> specifies how to
     * interpret color and alpha samples in pixel values. If the
     * <code>boolean</code> is <code>true</code>, color samples are assumed to
     * have been multiplied by the alpha sample. The transparency value is
     * Transparency.OPAQUE, if no alpha is present, or Transparency.TRANSLUCENT
     * otherwise. The transfer type is the type of primitive array used to
     * represent pixel values and must be one of DataBuffer.TYPE_BYTE,
     * DataBuffer.TYPE_USHORT, or DataBuffer.TYPE_INT.
     * 
     * @param space
     *        the specified <code>ColorSpace</code>
     * @param bits
     *        the number of bits in the pixel values; for
     *        example, the sum
     *        of the number of bits in the masks.
     * @param rmask
     ...
     *         space or if the
     *         min/max normalized component values are
     *         not 0.0/1.0.
     */
    public DirectColorModel(ColorSpace space, int bits, int rmask, int gmask, int bmask, int amask,
        ...
        super(space, bits, rmask, gmask, bmask, amask, isAlphaPremultiplied, amask == 0 ? Transparency.OPAQUE
    ...
    /*
     * Given an int pixel in this ColorModel's ColorSpace, converts it to the
     * default sRGB ColorSpace and returns the R, G, and B components as float
     ...
     * is done if necessary. The pixel value is specified as an <code>int</code>
     * . The returned value is a non pre-multiplied value. Thus, if the alpha is
     * premultiplied, this method divides it out before returning the value. If
     * the alpha value is 0, for example, the red value is 0.
     * 
     * @param pixel
     *        the specified pixel
     * @return the red color component for the specified pixel, from 0 to 255 in
     *         the sRGB <code>ColorSpace</code>.
     */
     ...
     * conversion is done if necessary. The pixel value is specified as an
     * <code>int</code>. The returned value is a non pre-multiplied value. Thus,
     * if the alpha is premultiplied, this method divides it out before
     * returning the value. If the alpha value is 0, for example, the green
     * value is 0.
     * 
     * @param pixel
     *        the specified pixel
     * @return the green color component for the specified pixel, from 0 to 255
     *         in the sRGB <code>ColorSpace</code>.
     */
     ...
     * <code>int</code>. The returned value is a non pre-multiplied value. Thus,
     * if the alpha is premultiplied, this method divides it out before
     * returning the value. If the alpha value is 0, for example, the blue value
     * is 0.
     * 
     * @param pixel
     *        the specified pixel
     * @return the blue color component for the specified pixel, from 0 to 255
     *         in the sRGB <code>ColorSpace</code>.
     */
     ...
     * 255. The pixel value is specified as an <code>int</code>.
     * 
     * @param pixel
     *        the specified pixel
     * @return the value of the alpha component of <code>pixel</code> from 0 to
     *         255.
     */
     ...
     * specified as an <code>int</code>. The returned value is in a non
     * pre-multiplied format. Thus, if the alpha is premultiplied, this method
     * divides it out of the color components. If the alpha value is 0, for
     * example, the color values are each 0.
     * 
     * @param pixel
     *        the specified pixel
    ...
    final public int getRGB(int pixel) {
        ...
        float rgb[] = getDefaultRGBComponents(pixel);
        return (getAlpha(pixel) << 24) | (((int) (rgb[0] * 255.0f + 0.5f)) << 16) | (((int) (rgb[1] * 255.0f
     ...
     * reference. The returned value is a non pre-multiplied value. Thus, if the
     * alpha is premultiplied, this method divides it out before returning the
     * value. If the alpha value is 0, for example, the red value is 0. If
     ...
     * <code>ColorModel</code>. Since <code>DirectColorModel</code> can be
     ...
     * unsupported <code>transferType</code>. An
     * <code>UnsupportedOperationException</code> is thrown if this
     ...
     * reference. The returned value is a non pre-multiplied value. Thus, if the
     * alpha is premultiplied, this method divides it out before returning the
     * value. If the alpha value is 0, for example, the green value is 0. If
     * <code>inData</code> is not a primitive array of type
     * <code>transferType</code>, a <code>ClassCastException</code> is thrown.
     * An <code>ArrayIndexOutOfBoundsException</code> is thrown if
     * <code>inData</code> is not large enough to hold a pixel value for this
     ...
     * reference. The returned value is a non pre-multiplied value. Thus, if the
     * alpha is premultiplied, this method divides it out before returning the
     * value. If the alpha value is 0, for example, the blue value is 0. If
     * <code>inData</code> is not a primitive array of type
     * <code>transferType</code>, a <code>ClassCastException</code> is thrown.
     * An <code>ArrayIndexOutOfBoundsException</code> is thrown if
     * <code>inData</code> is not large enough to hold a pixel value for this
     ...
     * <code>transferType</code> passed in as an object reference. If
     * <code>inData</code> is not a primitive array of type
     * <code>transferType</code>, a <code>ClassCastException</code> is thrown.
     * An <code>ArrayIndexOutOfBoundsException</code> is thrown if
     * <code>inData</code> is not large enough to hold a pixel value for this
     ...
     * subclassed, subclasses inherit the implementation of this method and if
     * they don't override it then they throw an exception if they use an
     * unsupported <code>transferType</code>. If this <code>transferType</code>
     * is not supported, an <code>UnsupportedOperationException</code> is
     * thrown.
     * 
     * @param inData
     *        the specified pixel
     ...
     * An <code>ArrayIndexOutOfBoundsException</code> is thrown if
     * <code>inData</code> is not large enough to hold a pixel value for this
     * <code>ColorModel</code>. The returned value is in a non pre-multiplied
     * format. Thus, if the alpha is premultiplied, this method divides it out
     * of the color components. If the alpha value is 0, for example, the color
     * values is 0. Since <code>DirectColorModel</code> can be subclassed,
     ...
     * object. If the pixel variable is <code>null</code>, a new array is
     ...
     * <code>ColorModel</code>. The pixel array is returned. Since
     * <code>DirectColorModel</code> can be subclassed, subclasses inherit the
     ...
     *            <code>transferType</code>
     * @exception ArrayIndexOutOfBoundsException
     *            if <code>pixel</code> is not
     *            large enough to hold a pixel
     *            value for this
     *            <code>ColorModel</code>
     * @exception UnsupportedOperationException
     *            if this
     *            <code>transferType</code> is
    ...
    public Object getDataElements(int rgb, Object pixel) {
        ...
        throw new UnsupportedOperationException("This method has not been " + "implemented for transferType "
                + transferType);
     ...
     * <code>null</code>, a new array is allocated. The <code>components</code>
     * array is returned. Color/alpha components are stored in the
     * <code>components</code> array starting at <code>offset</code>, even if
     * the array is allocated by this method. An
     ...
     * reference. If <code>pixel</code> is not a primitive array of type
     * <code>transferType</code>, a <code>ClassCastException</code> is thrown.
     * An <code>ArrayIndexOutOfBoundsException</code> is thrown if
     * <code>pixel</code> is not large enough to hold a pixel value for this
     ...
     * <code>components</code> array is not <code>null</code> and is not large
     * enough to hold all the color and alpha components, starting at
     * <code>offset</code>. Since <code>DirectColorModel</code> can be
     * subclassed, subclasses inherit the implementation of this method and if
     * they don't override it then they throw an exception if they use an
     ...
     * the <code>components</code> array is not large enough to hold all the
     ...
     * and alpha components, starting at offset. If the <code>obj</code>
     * variable is <code>null</code>, a new array is allocated. If
     * <code>obj</code> is not <code>null</code>, it must be a primitive array
    ...
    public Object getDataElements(int[] components, int offset, Object obj) {
        ...
        switch (transferType) {
            ...
            default:
                throw new ClassCastException("This method has not been " + "implemented for transferType "
                        + transferType);
        }
    }
     ...
     * will throw a <code>UnsupportedOperationException</code> if this
     * transferType is not supported by this <code>ColorModel</code>. Since
    ...
    final public ColorModel coerceData(WritableRaster raster, boolean isAlphaPremultiplied) {
        ...
        return new DirectColorModel(colorSpace, pixel_bits, maskArray[0], maskArray[1], maskArray[2],
     ...
     * <code>ColorModel</code> and <code>false</code> if it is not.
     * 
     * @param raster
    ...
    public String toString() {
        return new String("DirectColorModel: rmask=" + Integer.toHexString(red_mask) + " gmask=" + Integer
                .toHexString(green_mask) + " bmask=" + Integer.toHexString(blue_mask) + " amask=" + Integer
                        .toHexString(alpha_mask));
    }
}
