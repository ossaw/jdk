...
public class DirectColorModel extends PackedColorModel {
	 ...
	 *             if <code>space</code> is not a TYPE_RGB space or if the
	...
	private int getsRGBComponentFromsRGB(int pixel, int idx) {
		...
		if (isAlphaPremultiplied) {
			...
			c = (a == 0) ? 0
					: (int) (((c * scaleFactors[idx]) * 255.0f / (a * scaleFactors[3])) + 0.5f);
	...
	private int getsRGBComponentFromLinearRGB(int pixel, int idx) {
		...
		if (isAlphaPremultiplied) {
			...
			int a = ((pixel & maskArray[3]) >>> maskOffsets[3]);
			c = (a == 0) ? 0
					: (int) (((c * scaleFactors[idx]) * factor / (a * scaleFactors[3])) + 0.5f);
	 ...
	 *             if this <code>transferType</code> is not supported by this
	 *             color model
	 */
	 ...
	 * @exception ArrayIndexOutOfBoundsException
	 *                if <code>pixel</code> is not large enough to hold a pixel
	 *                value for this <code>ColorModel</code>, or if
	 *                <code>components</code> is not <code>null</code> and is
	 *                not large enough to hold all the color and alpha
	 ...
	 * @exception ArrayIndexOutOfBoundsException
	 *                if the <code>components</code> array is not large enough
	 ...
	 *                <code>transferType</code>
	 * @exception ArrayIndexOutOfBoundsException
	 *                if <code>obj</code> is not large enough to hold a pixel
	 *                value for this <code>ColorModel</code> or the
	 *                <code>components</code> array is not large enough to hold
	...
	final public ColorModel coerceData(WritableRaster raster, boolean isAlphaPremultiplied) {
		...
		return new DirectColorModel(colorSpace, pixel_bits, maskArray[0], maskArray[1],
				maskArray[2], maskArray[3], isAlphaPremultiplied, transferType);
