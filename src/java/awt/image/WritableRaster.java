...
public class WritableRaster extends Raster {
	 ...
	 *
	 * @param parentX
	 *            X coordinate of the upper left corner in this WritableRaster's
	 *            coordinates.
	 * @param parentY
	 *            Y coordinate of the upper left corner in this WritableRaster's
	 *            coordinates.
	 * @param w
	 ...
	 *             zero, or computing any of <code>parentX + w</code>,
	 *             <code>parentY + h</code>, <code>childMinX + w</code>, or
	 ...
	 *             if the coordinates are not in bounds, or if inData is too
	 ...
	 *
	 * @param dx
	 *            The X translation factor from src space to dst space of the
	 *            copy.
	 * @param dy
	 *            The Y translation factor from src space to dst space of the
	 *            copy.
	 * @param srcRaster
	 *            The Raster from which to copy pixels.
	 *
