...
public interface ImageObserver {
	 ...
	 * <b>OR</b> of the following flags: <code>WIDTH</code>, <code>HEIGHT</code>
	 ...
	 * width of the base image is now available and can be taken from the width
	 * argument to the imageUpdate callback method.
	 * 
	 * @see Image#getWidth
	 * @see #imageUpdate
	 */
	...
	/**
	 * This flag in the infoflags argument to imageUpdate indicates that the
	 * height of the base image is now available and can be taken from the
	 * height argument to the imageUpdate callback method.
	 * 
	 * @see Image#getHeight
	 * @see #imageUpdate
	 */
	...
	/**
	 * This flag in the infoflags argument to imageUpdate indicates that the
	 * properties of the image are now available.
	 * 
	...
	/**
	 * This flag in the infoflags argument to imageUpdate indicates that another
	 * complete frame of a multi-frame image which was previously drawn is now
	 * available to be drawn again. The x, y, width, and height arguments to the
	 * imageUpdate callback method should be ignored.
	 * 
	 * @see java.awt.Graphics#drawImage
	 * @see #imageUpdate
	 */
	...
	/**
	 * This flag in the infoflags argument to imageUpdate indicates that a
	 * static image which was previously drawn is now complete and can be drawn
	 * again in its final form. The x, y, width, and height arguments to the
	 * imageUpdate callback method should be ignored.
	 * 
	 * @see java.awt.Graphics#drawImage
	 * @see #imageUpdate
	 ...
	 * image which was being tracked asynchronously has encountered an error. No
	 * further information will become available and drawing the image will
	 * fail. As a convenience, the ABORT flag will be indicated at the same time
	 * to indicate that the image production was aborted.
	 * 
	 * @see #imageUpdate
	 */
	...
	/**
	 * This flag in the infoflags argument to imageUpdate indicates that an
	 * image which was being tracked asynchronously was aborted before
	 * production was complete. No more information will become available
	 * without further action to trigger another image production sequence. If
	 * the ERROR flag was not also set in this image update, then accessing any
	 * of the data in the image will restart the production again, probably from
	 * the beginning.
	 * 
	 * @see #imageUpdate
	 */
