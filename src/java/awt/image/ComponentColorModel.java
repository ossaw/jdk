...
public class ComponentColorModel extends ColorModel {
	...
	private void setupLUTs() {
		...
		if (is_sRGB) {
			...
			if (ColorModel.isLinearGRAYspace(ics)) {
				...
				if (transferType == DataBuffer.TYPE_BYTE) {
					tosRGB8LUT = ColorModel.getGray8TosRGB8LUT(ics);
					fromLinearGray16ToOtherGray8LUT = ColorModel
							.getLinearGray16ToOtherGray8LUT(ics);
				} else {
					tosRGB8LUT = ColorModel.getGray16TosRGB8LUT(ics);
					fromLinearGray16ToOtherGray16LUT = ColorModel
							.getLinearGray16ToOtherGray16LUT(ics);
				}
			}
		...
		if (is_sRGB_stdScale || is_LinearRGB_stdScale) {
			...
			if (supportsAlpha) {
				...
				if (nBits[numColorComponents] == 8) {
					...
					intpixel[numColorComponents] = (int) (alp * factor
	...
	public Object getDataElements(float[] normComponents, int normOffset, Object obj) {
		...
		if (nonStdScale) {
			...
			if (supportsAlpha) {
				stdNormComponents[numColorComponents] = normComponents[numColorComponents
						+ normOffset];
			}
			normOffset = 0;
		} else {
