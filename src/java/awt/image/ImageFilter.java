 ...
 * which deal with the data that needs to be filtered and modify it as
 * necessary.
 *
...
public class ImageFilter implements ImageConsumer, Cloneable {
	/**
	 * The consumer of the particular image data stream for which this instance
	 * of the ImageFilter is filtering data. It is not initialized during the
	 * constructor, but rather during the getFilterInstance() method call when
	 * the FilteredImageSource is creating a unique instance of this object for
	 ...
	 * perform the filtering for the specified ImageConsumer. The default
	 * implementation just clones this object.
	 * <p>
	 * Note: This method is intended to be called by the ImageProducer of the
	 * Image whose pixels are being filtered. Developers using this class to
	 * filter pixels from an image should avoid calling this method directly
	...
	/**
	 * Responds to a request for a TopDownLeftRight (TDLR) ordered resend of the
	 * pixel data from an <code>ImageConsumer</code>. When an
	 * <code>ImageConsumer</code> being fed by an instance of this
	 ...
	 * <code>ImageProducer</code> using this filter as the requesting
