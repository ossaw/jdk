...
public abstract class MenuComponent implements java.io.Serializable {
    ...
    /**
     * The <code>AppContext</code> of the <code>MenuComponent</code>. This is
     * set in the constructor and never changes.
     */
    transient AppContext appContext;

    /**
     * The menu component's font. This value can be <code>null</code> at which
     * point a default will be used. This defaults to <code>null</code>.
     *
     * @serial
     * @see #setFont(Font)
     * @see #getFont()
    ...
    /**
     * A variable to indicate whether a name is explicitly set. If
     * <code>true</code> the name will be set explicitly. This defaults to
     * <code>false</code>.
     * 
     * @serial
     * @see #setName(String)
    ...
    /**
     * Constructs a name for this <code>MenuComponent</code>. Called by
     ...
     * 
     * @return the menu component containing this menu component, or
     *         <code>null</code> if this menu component is the outermost
     *         component, the menu bar itself
     */
     ...
     * This font is also used by all subcomponents of this menu component,
     * unless those subcomponents specify a different font.
     * <p>
     * Some platforms may not support setting of all font attributes of a menu
     * component; in such cases, calling <code>setFont</code> will have no
     * effect on the unsupported font attributes of this menu component. Unless
     * subcomponents of this menu component specify a different font, this font
     * will be used by those subcomponents if supported by the underlying
     * platform.
     *
     * @param f
     *        the font to be set
    ...
    public void setFont(Font f) {
        synchronized (getTreeLock()) {
            font = f;
            // Fixed 6312943: NullPointerException in method
    ...
    /**
     * Posts the specified event to the menu. This method is part of the
     * Java&nbsp;1.0 event system and it is maintained only for backwards
     * compatibility. Its use is discouraged, and it may not be supported in the
     * future.
     * 
     * @param evt
     *        the event which is to take place
     * @deprecated As of JDK version 1.1, replaced by
     *             {@link #dispatchEvent(AWTEvent) dispatchEvent}.
     */
    @Deprecated
    ...
    void dispatchEventImpl(AWTEvent e) {
        ...
        if (newEventsOnly || (parent != null && parent instanceof MenuComponent
     ...
     * <code>MenuComponent</code>. This method is intended to be used only for
     ...
     * though it won't actually implement the interface - that will be up to the
     * individual objects which extend MenuComponent.
     */
     ...
     * Classes that extend <code>MenuComponent</code> should implement this
    ...
    /**
     * Inner class of <code>MenuComponent</code> used to provide default support
     * for accessibility. This class is not meant to be used directly by
     * application developers, but is instead meant only to be subclassed by
    ...
    protected abstract class AccessibleAWTMenuComponent extends AccessibleContext implements
            java.io.Serializable, AccessibleComponent, AccessibleSelection {
        /*
        ...
        /**
         * Although the class is abstract, this should be called by all
         * sub-classes.
         */
         ...
         * which allows its <code>Accessible</code> children to be selected.
         *
         * @return <code>AccessibleSelection</code> if supported by object; else
         ...
         * return <code>java.awt.MenuComponent.getName</code>, as that generally
         ...
         *         corner of the object's bounds in the coordinate space of the
         *         screen; <code>null</code> if this object or its parent are
         *         not on the screen
         */
         ...
         * <code>Dimension</code> object contains this object's height, and the
         ...
         *
         * @param d
         *        - the <code>Dimension</code> specifying the new size of
         *        the object
         */
         ...
         * at the local coordinate <code>Point</code>. If there is no
         * <code>Accessible</code> child, <code>null</code> is returned.
         *
         * @param p
     ...
     * Gets the index of this object in its accessible parent.
     *
     * @return -1 if this object does not have an accessible parent; otherwise,
     *         the index of the child in its accessible parent.
     */
    int getAccessibleIndexInParent() {
        MenuContainer localParent = parent;
        if (!(localParent instanceof MenuComponent)) {
            // MenuComponents only have accessible index when inside
            // MenuComponents
            return -1;
        }
     ...
     * @return -1 if this object doesn't contain the child, otherwise, index of
     *         the child.
     */
