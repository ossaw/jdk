 ...
 * <code>true</code>) or "off" (<code>false</code>) state. Clicking on a check
 * box changes its state from "on" to "off," or from "off" to "on."
 * <p>
 ...
 * example:
 * <p>
 * <img src="doc-files/Checkbox-1.gif" alt=
 * "The following context describes the graphic." style=
 * "float:center; margin: 7px 10px;">
 * <p>
 * The button labeled <code>one</code> is in the "on" state, and the other two
 * are in the "off" state. In this example, which uses the
 * <code>GridLayout</code> class, the states of the three check boxes are set
 * independently.
 * <p>
 * Alternatively, several check boxes can be grouped together under the control
 * of a single object, using the <code>CheckboxGroup</code> class. In a check
 * box group, at most one button can be in the "on" state at any given time.
 * Clicking on a check box to turn it on forces any other check box in the same
 * group that is on into the "off" state.
 *
 * @author Sami Shaio
...
public class Checkbox extends Component implements ItemSelectable, Accessible {
    ...
    /**
     * The check box group. This field can be null indicating that the checkbox
    ...
    /**
     * Helper function for setState and CheckboxGroup.setSelectedCheckbox Should
    ...
    /**
     * Creates a check box with an empty string for its label. The state of this
    ...
    /**
     * Creates a check box with the specified label. The state of this check box
    ...
    /**
     * Creates the peer of the Checkbox. The peer allows you to change the look
     * of the Checkbox without changing its functionality.
     *
     ...
     *
     * @return the label of this check box, or <code>null</code> if this check
     *         box has no label.
     * @see #setLabel(String)
     */
    ...
    /**
     * Determines whether this check box is in the "on" or "off" state. The
     * boolean value <code>true</code> indicates the "on" state, and
     ...
     * value <code>true</code> indicates the "on" state, and <code>false</code>
     * indicates the "off" state.
     * <p>
     * Note that this method should be primarily used to initialize the state of
     * the checkbox. Programmatically setting the state of the checkbox will
     ...
     * 
     * @return this check box's group, or <code>null</code> if the check box is
    ...
    /**
     * Sets this check box's group to the specified check box group. If this
     * check box is already in a different check box group, it is first taken
     * out of that group.
     * <p>
     * If the state of this check box is <code>true</code> and the new group
     * already has a check box selected, this check box's state is changed to
     * <code>false</code>. If the state of this check box is <code>true</code>
     * and the new group has no check box selected, this check box becomes the
     ...
     * box. Item events are sent to listeners in response to user input, but not
     * in response to calls to setState(). If l is null, no exception is thrown
     ...
     * receives item events from this check box. If l is null, no exception is
     ...
     *
     * @return all of this checkbox's <code>ItemListener</code>s or an empty
     ...
     * <code><em>Foo</em>Listener</code>s upon this <code>Checkbox</code>.
     ...
     * you can query a <code>Checkbox</code> <code>c</code> for its item
    ...
    /**
     * Processes events on this check box. If the event is an instance of
     * <code>ItemEvent</code>, this method invokes the
    ...
    /**
     * Processes item events occurring on this check box by dispatching them to
     * any registered <code>ItemListener</code> objects.
     * <p>
    ...
    /**
     * Gets the AccessibleContext associated with this Checkbox. For checkboxes,
     * the AccessibleContext takes the form of an AccessibleAWTCheckbox. A new
     * AccessibleAWTCheckbox is created if necessary.
     *
     * @return an AccessibleAWTCheckbox that serves as the AccessibleContext of
     *         this Checkbox
     * @since 1.3
     */
    ...
    /**
     * This class implements accessibility support for the <code>Checkbox</code>
     * class. It provides an implementation of the Java Accessibility API
     * appropriate to checkbox user-interface elements.
     * 
     * @since 1.3
     */
    protected class AccessibleAWTCheckbox extends AccessibleAWTComponent implements ItemListener,
            ...
            if (Checkbox.this.accessibleContext != null) {
                if (cb.getState()) {
                    Checkbox.this.accessibleContext.firePropertyChange(
                            AccessibleContext.ACCESSIBLE_STATE_PROPERTY, null, AccessibleState.CHECKED);
                } else {
                    Checkbox.this.accessibleContext.firePropertyChange(
                            AccessibleContext.ACCESSIBLE_STATE_PROPERTY, AccessibleState.CHECKED, null);
                }
            }
        }
        ...
        /**
         * Returns the number of Actions available in this object. If there is
         * more than one, the first one is the "default" action.
         *
