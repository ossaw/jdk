...
public abstract class GraphicsConfigTemplate implements Serializable {
     ...
     * required for the <code>GraphicsConfiguration</code> object. If this
     * feature is not available, do not select the
     * <code>GraphicsConfiguration</code> object.
     */
    public static final int REQUIRED = 1;

    /**
     * Value used for "Enum" (Integer) type. States that this feature is desired
     * for the <code>GraphicsConfiguration</code> object. A selection with this
    ...
    /**
     * Value used for "Enum" (Integer) type. States that this feature is not
     * necessary for the selection of the <code>GraphicsConfiguration</code>
     * object. A selection without this feature is preferred over a selection
     * that includes this feature since it is not used.
     */
     ...
     * <code>GraphicsConfiguration</code> can be used to create a drawing
     ...
     *         <code>GraphicsConfiguration</code> can not be used to create a
