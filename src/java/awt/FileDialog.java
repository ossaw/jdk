...
/**
 * The <code>FileDialog</code> class displays a dialog window from which the
 * user can select a file.
 * <p>
 * Since it is a modal dialog, when the application calls its <code>show</code>
 * method to display the dialog, it blocks the rest of the application until the
...
public class FileDialog extends Dialog {
    ...
    /**
     * This constant value indicates that the purpose of the file dialog window
     * is to locate a file from which to read.
     */
    public static final int LOAD = 0;

    /**
     * This constant value indicates that the purpose of the file dialog window
     * is to locate a file to which to write.
     */
    ...
    /**
     * Creates a file dialog for loading a file. The title of the file dialog is
     * initially empty. This is a convenience method for
     ...
     * The files shown are those in the current directory. This is a convenience
     ...
     * saving a file.
     * <p>
     * If the value of <code>mode</code> is <code>LOAD</code>, then the file
     * dialog is finding a file to read, and the files shown are those in the
     * current directory. If the value of <code>mode</code> is <code>SAVE</code>
    ...
    /**
     * Sets the mode of the file dialog. If <code>mode</code> is not a legal
     ...
     * <code>CANCEL</code>, the returned file is <code>null</code>.
     *
     * @return the currently selected file of this file dialog window, or
     ...
     * <p>
     * If the user cancels the file dialog, then the method returns an empty
     * array.
     *
     * @return files that the user selects or an empty array if the user cancels
     *         the file dialog.
     * @see #setFile(String)
     * @see #getFile
     * @since 1.7
     ...
     *
     * Note that the method is private and it's intended to be used by the peers
    ...
    /**
     * Sets the selected file for this file dialog window to be the specified
     * file. This file becomes the default file if it is set before the file
     * dialog window is first shown.
     * <p>
     ...
     * platform. E.g., the file could be highlighted in the file list, or a file
     * name editbox could be populated with the file name.
     * <p>
     ...
     *
     * @return {@code true} if the file dialog allows the multiple file
    ...
    /**
     * Determines this file dialog's filename filter. A filename filter allows
     * the user to specify which files appear in the file dialog window.
     * Filename filters do not function in Sun's reference implementation for
     * Microsoft Windows.
     *
     ...
     * filter. Filename filters do not function in Sun's reference
