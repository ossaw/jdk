 ...
 * axis in the result as if the {@link #add(Point)} method were being
 * called. </a>
 * <p>
 ...
 * negative dimension, the result will have at least one negative
 * dimension. </a>
 * <p>
...
public class Rectangle extends Rectangle2D implements Shape, java.io.Serializable {
     ...
     * <a href=#NonExistant>non-existant</a> rectangles apply. In that case, the
     * new bounds of this {@code Rectangle} will have a location equal to the
     * coordinates of the specified {@code Point} and width and height equal to
     * zero.
     * <p>
