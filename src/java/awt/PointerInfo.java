 ...
 * {@code GraphicsDevice} where the pointer is and the {@code Point} that
 * represents the coordinates of the pointer.
 * <p>
 * Instances of this class should be obtained via
 * {@link MouseInfo#getPointerInfo}. The {@code PointerInfo} instance is not
 * updated dynamically as the mouse moves. To get the updated location, you must
 * call {@link MouseInfo#getPointerInfo} again.
 *
