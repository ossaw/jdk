...
public abstract class Graphics {
    ...
    /**
     * Constructs a new <code>Graphics</code> object. This constructor is the
     * default constructor for a graphics context.
     * <p>
     * Since <code>Graphics</code> is an abstract class, applications cannot
     * call this constructor directly. Graphics contexts are obtained from other
     * graphics contexts or are created by calling <code>getGraphics</code> on a
     * component.
     * 
     ...
     * <ul>
     * <li>The new graphics context is translated by (<i>x</i>,&nbsp;<i>y</i>).
     * That is to say, the point (<code>0</code>,&nbsp;<code>0</code>) in the
     * new graphics context is the same as (<i>x</i>,&nbsp;<i>y</i>) in the
     ...
     * the <code>width</code> and <code>height</code> arguments.
     * </ul>
     * <p>
     * 
     * @param x
     ...
     * 
     * @param x
     *        the <i>x</i> coordinate of the upper left corner of the
     *        oval
     *        to be drawn.
     * @param y
     *        the <i>y</i> coordinate of the upper left corner of the
     *        oval
     *        to be drawn.
     * @param width
     ...
     * <p>
     * The baseline of the leftmost character is at position (<i>x</i>,&nbsp;
     * <i>y</i>) in this graphics context's coordinate system.
     * 
     * @param iterator
     ...
     * @throws NullPointerException
     *         if <code>data</code> is
     *         <code>null</code>.
     * @throws IndexOutOfBoundsException
     *         if <code>offset</code> or
     *         <code>length</code>is less than
     *         zero, or <code>offset+length</code> is
     *         greater than the
     *         length of the <code>data</code> array.
     * @see java.awt.Graphics#drawBytes
     ...
     * 
     * @param img
     *        the specified image to be drawn. This method does nothing
     *        if
     ...
     * @since JDK1.1
     */
    public abstract boolean drawImage(Image img, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1,
