 ...
 * <p>
 * To use a method which takes an inner class type, pass a reference to one of
 * the constant fields of the inner class. Client code cannot create new
 * instances of the inner class types because none of those classes has a public
 * constructor. For example, to set the print dialog type to the cross-platform,
 * pure Java print dialog, use the following code:
 * 
 * <pre>
 ...
 * </pre>
 * <p>
 * Every IPP attribute which supports an <i>attributeName</i>-default value has
 * a corresponding <code>set<i>attributeName</i>ToDefault</code> method. Default
...
public final class JobAttributes implements Cloneable {
	...
	public static final class DefaultSelectionType extends AttributeValue {
		...
		/**
		 * The <code>DefaultSelectionType</code> instance to use for specifying
		 * that all pages of the job should be printed.
		 */
		public static final DefaultSelectionType ALL = new DefaultSelectionType(
				I_ALL);
		/**
		 * The <code>DefaultSelectionType</code> instance to use for specifying
		 * that a range of pages of the job should be printed.
		 */
		public static final DefaultSelectionType RANGE = new DefaultSelectionType(
				I_RANGE);
		/**
		 * The <code>DefaultSelectionType</code> instance to use for specifying
		 * that the current selection should be printed.
		 */
		public static final DefaultSelectionType SELECTION = new DefaultSelectionType(
				I_SELECTION);
	...
	public static final class DestinationType extends AttributeValue {
		...
		/**
		 * The <code>DestinationType</code> instance to use for specifying print
		 * to file.
		 */
		 ...
		 * to printer.
		 */
		public static final DestinationType PRINTER = new DestinationType(
				I_PRINTER);
	...
	public static final class DialogType extends AttributeValue {
		...
		/**
		 * The <code>DialogType</code> instance to use for specifying the
		 * cross-platform, pure Java print dialog.
		 */
		public static final DialogType COMMON = new DialogType(I_COMMON);
		/**
		 * The <code>DialogType</code> instance to use for specifying the
		 * platform's native print dialog.
		 */
		public static final DialogType NATIVE = new DialogType(I_NATIVE);
		/**
		 * The <code>DialogType</code> instance to use for specifying no print
		 * dialog.
		 */
	...
	/**
	 * A type-safe enumeration of possible multiple copy handling states. It is
	 * used to control how the sheets of multiple copies of a single document
	 * are collated.
	 * 
	 * @since 1.3
	 */
	public static final class MultipleDocumentHandlingType extends
		...
		/**
		 * The <code>MultipleDocumentHandlingType</code> instance to use for
		 * specifying that the job should be divided into separate, collated
		 * copies.
		 */
		...
		/**
		 * The <code>MultipleDocumentHandlingType</code> instance to use for
		 * specifying that the job should be divided into separate, uncollated
		 * copies.
		 */
	...
	public static final class SidesType extends AttributeValue {
		...
		private static final String NAMES[] = { "one-sided",
		...
		/**
		 * The <code>SidesType</code> instance to use for specifying that
		 * consecutive job pages should be printed upon front and back sides of
		 * consecutive media sheets, such that the orientation of each pair of
		 * pages on the medium would be correct for the reader as if for binding
		 * on the long edge.
		 */
		public static final SidesType TWO_SIDED_LONG_EDGE = new SidesType(
		 ...
		 * on the short edge.
		 */
		public static final SidesType TWO_SIDED_SHORT_EDGE = new SidesType(
	...
	/**
	 * Constructs a <code>JobAttributes</code> instance with default values for
	 * every attribute. The dialog defaults to <code>DialogType.NATIVE</code>.
	 * Min page defaults to <code>1</code>. Max page defaults to
	 * <code>Integer.MAX_VALUE</code>. Destination defaults to
	 * <code>DestinationType.PRINTER</code>. Selection defaults to
	 * <code>DefaultSelectionType.ALL</code>. Number of copies defaults to
	 * <code>1</code>. Multiple document handling defaults to
	...
	/**
	 * Constructs a <code>JobAttributes</code> instance which is a copy of the
	 * supplied <code>JobAttributes</code>.
	 *
	 * @param obj
	 *            the <code>JobAttributes</code> to copy
	 */
	...
	/**
	 * Constructs a <code>JobAttributes</code> instance with the specified
	 ...
	 *                                 <code>DefaultSelectionType.RANGE</code>,
	 *                                 or
	 *                                 <code>DefaultSelectionType.SELECTION</code>
	 * @param destination
	 *                                 <code>DesintationType.FILE</code> or
	 *                                 <code>DesintationType.PRINTER</code>
	 * @param dialog
	 *                                 <code>DialogType.COMMON</code>,
	 *                                 <code>DialogType.NATIVE</code>
	 *                                 , or <code>DialogType.NONE</code>
	 * @param fileName
	 ...
	 *                                 <i>minPage</i>
	 * @param minPage
	 *                                 an integer greater than zero and less
	 *                                 than or equal to
	 *                                 <i>maxPage</i>
	 * @param multipleDocumentHandling
	 *                                 <code>MultipleDocumentHandlingType.SEPARATE_DOCUMENTS_COLLATED_COPIES</code>
	 *                                 or
	 *                                 <code>MultipleDocumentHandlingType.SEPARATE_DOCUMENTS_UNCOLLATED_COPIES</code>
	 * @param pageRanges
	 *                                 an array of integer arrays of two
	 *                                 elements; an array is
	 *                                 interpreted as a range spanning all pages
	 *                                 including and
	 *                                 between the specified pages; ranges must
	 *                                 be in ascending order
	 *                                 and must not overlap; specified page
	 *                                 numbers cannot be less
	 *                                 than <i>minPage</i> nor greater than
	 *                                 <i>maxPage</i>; for
	 *                                 example:
	 * 
	 *                                 <pre>
	 ...
	 *                                 </pre>
	 * 
	 *                                 specifies pages 1, 2, 3, 5, 15, 16, 17,
	 *                                 18, and 19. Note that
	 *                                 (
	 *                                 <code>new int[][] { new int[] { 1, 1 }, new int[] { 1, 2 } }</code>
	 *                                 ), is an invalid set of page ranges
	 *                                 because the two ranges
	 *                                 overlap
	 * @param printer
	 *                                 the possibly <code>null</code> printer
	 *                                 name
	 * @param sides
	 *                                 <code>SidesType.ONE_SIDED</code>,
	 *                                 <code>SidesType.TWO_SIDED_LONG_EDGE</code>,
	 *                                 or
	...
	public JobAttributes(int copies, DefaultSelectionType defaultSelection,
			DestinationType destination, DialogType dialog, String fileName,
			int maxPage, int minPage,
	 ...
	 *
	 * @return the newly created copy; it is safe to cast this Object into a
	...
	/**
	 * Sets all of the attributes of this <code>JobAttributes</code> to the same
	 * values as the attributes of obj.
	 *
	 * @param obj
	 *            the <code>JobAttributes</code> to copy
	 */
	...
	/**
	 * Returns the number of copies the application should render for jobs using
	 ...
	 *               an integer greater than 0
	 * @throws IllegalArgumentException
	 *                                  if <code>copies</code> is less than or
	 *                                  equal to 0
	 */
	 ...
	 * <code>getPageRanges</code>, or the current selection. This attribute is
	 ...
	 * Specifies whether, for jobs using these attributes, the application
	 * should print all pages, the range specified by the return value of
	 * <code>getPageRanges</code>, or the current selection. Not specifying this
	 * attribute is equivalent to specifying DefaultSelectionType.ALL.
	 *
	 * @param defaultSelection
	 ...
	 *                         DefaultSelectionType.SELECTION.
	 * @throws IllegalArgumentException
	 *                                  if defaultSelection is <code>null</code>
	 */
	...
	/**
	 * Returns whether, for jobs using these attributes, the user should see a
	 * print dialog in which to modify the print settings, and which type of
	 ...
	 *
	 * @return <code>DialogType.COMMON</code>, <code>DialogType.NATIVE</code>,
	 *         or <code>DialogType.NONE</code>
	 */
	...
	/**
	 * Specifies whether, for jobs using these attributes, the user should see a
	 * print dialog in which to modify the print settings, and which type of
	 * print dialog should be displayed. DialogType.COMMON denotes a cross-
	 * platform, pure Java print dialog. DialogType.NATIVE denotes the
	 * platform's native print dialog. If a platform does not support a native
	...
	/**
	 * Returns, for jobs using these attributes, the first page to be printed,
	 * if a range of pages is to be printed. This attribute is updated to the
	 * value chosen by the user. An application should ignore this attribute on
	 * output, unless the return value of the <code>
	...
	/**
	 * Specifies, for jobs using these attributes, the first page to be printed,
	 * if a range of pages is to be printed. If this attribute is not specified,
	 * then the values from the pageRanges attribute are used. If pageRanges and
	 * either or both of fromPage and toPage are specified, pageRanges takes
	 * precedence. Specifying none of pageRanges, fromPage, or toPage is
	 * equivalent to calling setPageRanges(new int[][] { new int[] {
	 * <i>minPage</i> } });
	 *
	 * @param fromPage
	 *                 an integer greater than zero and less than or equal to
	 *                 <i>toPage</i> and greater than or equal to <i>minPage</i>
	 *                 and
	 *                 less than or equal to <i>maxPage</i>.
	 * @throws IllegalArgumentException
	 *                                  if one or more of the above conditions
	...
	public void setFromPage(int fromPage) {
		if (fromPage <= 0 || (toPage != 0 && fromPage > toPage)
				|| fromPage < minPage || fromPage > maxPage) {
			throw new IllegalArgumentException("Invalid value for attribute "
					+ "fromPage");
		}
	...
	/**
	 * Specifies the maximum value the user can specify as the last page to be
	 * printed for jobs using these attributes. This attribute cannot be
	 * modified by, and is not subject to any limitations of, the implementation
	 * or the target printer.
	 *
	 * @return an integer greater than zero and greater than or equal to
	 *         <i>minPage</i>.
	 */
	 ...
	 * equivalent to specifying <code>Integer.MAX_VALUE</code>.
	 *
	 * @param maxPage
	 ...
	 * Specifies the minimum value the user can specify as the first page to be
	 * printed for jobs using these attributes. Not specifying this attribute is
	 * equivalent to specifying <code>1</code>.
	 *
	 * @param minPage
	 *                an integer greater than zero and less than or equal to
	 *                <i>maxPage</i>.
	...
	/**
	 * Specifies the handling of multiple copies, including collation, for jobs
	 * using these attributes. This attribute is updated to the value chosen by
	 * the user.
	 *
	 * @return MultipleDocumentHandlingType.SEPARATE_DOCUMENTS_COLLATED_COPIES
	 *         or MultipleDocumentHandlingType.
	 ...
	 *                                 SEPARATE_DOCUMENTS_COLLATED_COPIES or
	 *                                 MultipleDocumentHandlingType.
	 *                                 SEPARATE_DOCUMENTS_UNCOLLATED_COPIES.
	 * @throws IllegalArgumentException
	...
	/**
	 * Sets the handling of multiple copies, including collation, for jobs using
	 * these attributes to the default. The default handling is
	 * MultipleDocumentHandlingType.SEPARATE_DOCUMENTS_UNCOLLATED_COPIES.
	 */
	 ...
	 * inclusive. This attribute is updated to the value chosen by the user. An
	 * application should ignore this attribute on output, unless the return
	 * value of the <code>getDefaultSelection</code> method is
	 * DefaultSelectionType.RANGE.
	 *
	 * @return an array of integer arrays of 2 elements. An array is interpreted
	 *         as a range spanning all pages including and between the specified
	 *         pages. Ranges must be in ascending order and must not overlap.
	 *         Specified page numbers cannot be less than <i>minPage</i> nor
	 *         greater than <i>maxPage</i>. For example: (new int[][] { new
	 *         int[] { 1, 3 }, new int[] { 5, 5 }, new int[] { 15, 19 } }),
	 ...
	 *                   interpreted as a range spanning all pages including and
	 *                   between the specified pages. Ranges must be in
	 *                   ascending order
	 *                   and must not overlap. Specified page numbers cannot be
	 *                   less
	 *                   than <i>minPage</i> nor greater than <i>maxPage</i>.
	 *                   For
	 *                   example: (new int[][] { new int[] { 1, 3 }, new int[] {
	 *                   5, 5
	 *                   }, new int[] { 15, 19 } }), specifies pages 1, 2, 3, 5,
	 *                   15,
	 *                   16, 17, 18, and 19. Note that (new int[][] { new int[]
	 *                   { 1, 1
	 *                   }, new int[] { 1, 2 } }), is an invalid set of page
	 *                   ranges
	 ...
	 * print medium for jobs using these attributes. SidesType.ONE_SIDED imposes
	 * each consecutive page upon the same side of consecutive media sheets.
	 * This imposition is sometimes called <i>simplex</i>.
	 * SidesType.TWO_SIDED_LONG_EDGE imposes each consecutive pair of pages upon
	 * front and back sides of consecutive media sheets, such that the
	 * orientation of each pair of pages on the medium would be correct for the
	 * reader as if for binding on the long edge. This imposition is sometimes
	 * called <i>duplex</i>. SidesType.TWO_SIDED_SHORT_EDGE imposes each
	 * consecutive pair of pages upon front and back sides of consecutive media
	 * sheets, such that the orientation of each pair of pages on the medium
	 * would be correct for the reader as if for binding on the short edge. This
	 * imposition is sometimes called <i>tumble</i>. This attribute is updated
	 ...
	 * sheets, such that the orientation of each pair of pages on the medium
	 * would be correct for the reader as if for binding on the short edge. This
	 * imposition is sometimes called <i>tumble</i>. Not specifying this
	 * attribute is equivalent to specifying SidesType.ONE_SIDED.
	 *
	 * @param sides
	...
	/**
	 * Sets how consecutive pages should be imposed upon the sides of the print
	 * medium for jobs using these attributes to the default. The default
	 * imposition is SidesType.ONE_SIDED.
	 */
	 ...
	 * printed, if a range of pages is to be printed. This attribute is updated
	 * to the value chosen by the user. An application should ignore this
	 * attribute on output, unless the return value of the <code>
	 * getDefaultSelection</code> method is DefaultSelectionType.RANGE. An
	 * application should honor the return value of <code>getPageRanges</code>
	 * over the return value of this method, if possible.
	 *
	...
	/**
	 * Specifies, for jobs using these attributes, the last page (inclusive) to
	 * be printed, if a range of pages is to be printed. If this attribute is
	 * not specified, then the values from the pageRanges attribute are used. If
	 * pageRanges and either or both of fromPage and toPage are specified,
	 * pageRanges takes precedence. Specifying none of pageRanges, fromPage, or
	 * toPage is equivalent to calling setPageRanges(new int[][] { new int[] {
	 * <i>minPage</i> } });
	 *
	 * @param toPage
	 *               an integer greater than zero and greater than or equal to
	 *               <i>fromPage</i> and greater than or equal to <i>minPage</i>
	...
	public void setToPage(int toPage) {
		if (toPage <= 0 || (fromPage != 0 && toPage < fromPage)
				|| toPage < minPage || toPage > maxPage) {
			throw new IllegalArgumentException("Invalid value for attribute "
					+ "toPage");
		}
		this.toPage = toPage;
	 ...
	 * equal. Attributes of enumeration type are equal if and only if the fields
	 * refer to the same unique enumeration object. A set of page ranges is
	 * equal if and only if the sets are of equal length, each range enumerates
	 * the same pages, and the ranges are in the same order.
	 *
	 * @param obj
	 *            the object whose equality will be checked.
	 * @return whether obj is equal to this JobAttribute according to the above
	 *         criteria.
	 */
	public boolean equals(Object obj) {
		...
		return (copies == rhs.copies && defaultSelection == rhs.defaultSelection
				&& destination == rhs.destination && dialog == rhs.dialog
				&& fromPage == rhs.fromPage && maxPage == rhs.maxPage
				&& minPage == rhs.minPage
				&& multipleDocumentHandling == rhs.multipleDocumentHandling
				&& prFirst == rhs.prFirst && prLast == rhs.prLast
				&& sides == rhs.sides && toPage == rhs.toPage);
	}
	...
	public int hashCode() {
		...
		return (defaultSelection.hashCode() << 6 ^ destination.hashCode() << 5
				^ dialog.hashCode() << 3 ^ multipleDocumentHandling
						.hashCode() << 2 ^ sides.hashCode() ^ rest);
	}
	...
	public String toString() {
		...
		return "copies=" + getCopies() + ",defaultSelection="
				...
				+ ",printer=" + getPrinter() + ",sides=" + getSides()
				+ ",toPage=" + getToPage();
	}
}
