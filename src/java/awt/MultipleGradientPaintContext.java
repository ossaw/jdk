...
abstract class MultipleGradientPaintContext implements PaintContext {
	...
	private static ColorModel xrgbmodel = new DirectColorModel(24, 0x00ff0000, 0x0000ff00,
			0x000000ff);
	 ...
	 */
	protected MultipleGradientPaintContext(MultipleGradientPaint mgp, ColorModel cm,
			Rectangle deviceBounds, Rectangle2D userBounds, AffineTransform t, RenderingHints hints,
	...
	public final Raster getRaster(int x, int y, int w, int h) {
		...
		int scanlineStride = ((SinglePixelPackedSampleModel) raster.getSampleModel())
				.getScanlineStride();
	...
	protected abstract void fillRaster(int pixels[], int off, int adjust, int x, int y, int w,
			int h);
