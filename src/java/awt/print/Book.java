...
/**
 * The <code>Book</code> class provides a representation of a document in which
 * pages may have different page formats and page painters. This class uses the
 * {@link Pageable} interface to interact with a {@link PrinterJob}.
 * 
 * @see Pageable
 * @see PrinterJob
 */
...
public class Book implements Pageable {
	...
	/**
	 * Returns the {@link Printable} instance responsible for rendering the page
	 ...
	 * 
	 * @param pageIndex
	 *            the zero based index of the page whose painter and format is
	 *            altered
	 * @param painter
	 ...
	 * @throws IndexOutOfBoundsException
	 *             if the specified page is not already in this
	 *             <code>Book</code>
	 * @throws NullPointerException
	 *             if the <code>painter</code> or <code>page</code> argument is
	 *             <code>null</code>
	 */
	 ...
	 *            the size and orientation of the page
	 * @param numPages
	 *            the number of pages to be added to the this <code>Book</code>.
	 * @throws NullPointerException
	 *             If the <code>painter</code> or <code>page</code> argument is
	 *             <code>null</code>
	 */
	...
	/**
	 * The BookPage inner class describes an individual page in a Book through a
	 * PageFormat-Printable pair.
	 */
	private class BookPage {
		...
		/**
		 * A new instance where 'format' describes the page's size and
		 * orientation and 'painter' is the instance that will draw the page's
		 * graphics.
		 * 
		 * @throws NullPointerException
