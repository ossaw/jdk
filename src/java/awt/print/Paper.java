...
/**
 * The <code>Paper</code> class describes the physical characteristics of a
 * piece of paper.
 * <p>
 * When creating a <code>Paper</code> object, it is the application's
 * responsibility to ensure that the paper size and the imageable area are
 * compatible. For example, if the paper size is changed from 11 x 17 to 8.5 x
 * 11, the application might need to reduce the imageable area so that whatever
 * is printed fits on the page.
 * <p>
 * 
...
public class Paper implements Cloneable {
	...
	/**
	 * Creates a copy of this <code>Paper</code> with the same contents as this
	 * <code>Paper</code>.
	 * 
	...
	public Object clone() {
		...
		try {
			/*
			 * It's okay to copy the reference to the imageable area into the
			 * clone since we always return a copy of the imageable area when
			 * asked for it.
			 */
	 ...
	 * 
	 * @return the height of the page described by this <code>Paper</code>.
	 */
	...
	/**
	 * Sets the width and height of this <code>Paper</code> object, which
	 * represents the properties of the page onto which printing occurs. The
	 ...
	 * 
	 * @return the width of the page described by this <code>Paper</code>.
	 */
	...
	/**
	 * Sets the imageable area of this <code>Paper</code>. The imageable area is
