...
/**
 * The <code>Pageable</code> implementation represents a set of pages to be
 * printed. The <code>Pageable</code> object returns the total number of pages
 * in the set as well as the {@link PageFormat} and {@link Printable} for a
 * specified page.
 * 
...
public interface Pageable {
    ...
    /**
     * This constant is returned from the {@link #getNumberOfPages()
     * getNumberOfPages} method if a <code>Pageable</code> implementation does
     * not know the number of pages in its set.
     */
    @Native
