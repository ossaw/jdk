 ...
 * "<code>IOException</code> that terminated the print job" that is provided at
 * construction time and accessed via the {@link #getIOException()} method is
 * now known as the <i>cause</i>, and may be accessed via the
...
public class PrinterIOException extends PrinterException {
    ...
    /**
     * Constructs a new <code>PrinterIOException</code> with the string
     ...
     *
     * @return the <code>IOException</code> that terminated the print job.
     * @see IOException
     */
