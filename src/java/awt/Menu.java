...
public class Menu extends MenuItem implements MenuContainer, Accessible {
	...
	/**
	 * This field indicates whether the menu has the tear of property or not. It
	 * will be set to <code>true</code> if the menu has the tear off property
	 * and it will be set to <code>false</code> if it does not. A torn off menu
	 * can be deleted by a user when it is no longer needed.
	 *
	 * @serial
	 * @see #isTearOff()
	 */
	...
	/**
	 * This field will be set to <code>true</code> if the Menu in question is
	 * actually a help menu. Otherwise it will be set to <code>
	 * false</code>.
	 *
	 * @serial
	 */
	...
	/**
	 * Constructs a new menu with an empty label. This menu is not a tear-off
	 * menu.
	 * 
	...
	/**
	 * Constructs a new menu with the specified label. This menu is not a
	 * tear-off menu.
	 * 
	 * @param label
	 *            the menu's label in the menu bar, or in another menu of which
	...
	/**
	 * Constructs a new menu with the specified label, indicating whether the
	 * menu can be torn off.
	 * <p>
	 * Tear-off functionality may not be supported by all implementations of
	 * AWT. If a particular implementation doesn't support tear-off menus, this
	...
	/**
	 * Creates the menu's peer. The peer allows us to modify the appearance of
	 * the menu without changing its functionality.
	 */
	...
	/**
	 * Removes the menu's peer. The peer allows us to modify the appearance of
	 * the menu without changing its functionality.
	 */
	 ...
	 * value is silently ignored.
	 * 
	 * @return <code>true</code> if this is a tear-off menu; <code>false</code>
	 *         otherwise.
	 */
	...
	/**
	 * Adds the specified menu item to this menu. If the menu item has been part
	 ...
	 *                if the value of <code>index</code> is less than zero
	 * @since JDK1.1
	 */
	 ...
	 * specified position. This is a convenience method for
	...
	/*
	 * Post an ActionEvent to the target of the MenuPeer associated with the
	 * specified keyboard event (on keydown). Returns true if there is an
	 * associated keyboard event.
	 */
	...
	/*
	 * Serialization support. A MenuContainer is responsible for restoring the
	 * parent fields of its children.
	 */
	...
	/**
	 * Returns a string representing the state of this <code>Menu</code>. This
	 ...
	 *
	 * @return an AccessibleAWTMenu that serves as the AccessibleContext of this
	 *         Menu
	 * @since 1.3
	 */
	 ...
	 * This class is not meant to be used directly by application developers,
	 * but is instead meant only to be subclassed by menu component developers.
	 * <p>
	 * This class implements accessibility support for the <code>Menu</code>
