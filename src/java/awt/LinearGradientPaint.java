...
public final class LinearGradientPaint extends MultipleGradientPaint {
	...
	public PaintContext createContext(ColorModel cm, Rectangle deviceBounds, Rectangle2D userBounds,
		...
		if ((fractions.length == 2) && (cycleMethod != CycleMethod.REPEAT)
			...
			return new GradientPaintContext(cm, start, end, transform, colors[0], colors[1],
					cyclic);
		} else {
			return new LinearGradientPaintContext(this, cm, deviceBounds, userBounds, transform,
					hints, start, end, fractions, colors, cycleMethod, colorSpace);
		}
	}
