 ...
 * supercede the original java.awt.Event class. Subclasses of this root AWTEvent
 * class defined outside of the java.awt.event package should define event ID
 * values greater than the value defined by RESERVED_ID_MAX.
 * <p>
 ...
 * selected by registered listeners. If a listener is registered on a component,
 * the appropriate event mask is already set internally by the component.
 * <p>
 * The masks are also used to specify to which types of events an
 * AWTEventListener should listen. The masks are bitwise-ORed together and
 * passed to Toolkit.addAWTEventListener.
 *
...
public abstract class AWTEvent extends EventObject {
	...
	/**
	 * Indicates whether this AWTEvent was generated by the system as opposed to
	 * by user code.
	 */
	...
	/**
	 * Copies all private data from this event into that. Space is allocated for
	 * the copied data that will be freed when the that is finalized. Upon
	 * completion, this event is not changed.
	 */
