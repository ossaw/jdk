...
/**
 * <code>MouseInfo</code> provides methods for getting information about the
 * mouse, such as mouse pointer location and the number of mouse buttons.
 *
...
public class MouseInfo {
     ...
     * location of the mouse pointer. The <code>GraphicsDevice</code> stored in
     * this <code>PointerInfo</code> contains the mouse pointer. The coordinate
     * system used for the mouse position depends on whether or not the
     * <code>GraphicsDevice</code> is part of a virtual screen device. For
     * virtual screen devices, the coordinates are given in the virtual
     ...
     * more information about the virtual screen devices. On systems without a
     * mouse, returns <code>null</code>.
     * <p>
