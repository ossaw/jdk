...
public class GridBagLayoutInfo implements java.io.Serializable {
	...
	boolean hasBaseline; /*
							 * Whether or not baseline layout has been requested
							 * and one of the components has a valid baseline.
							 */
	// These are only valid if hasBaseline is true and are indexed by
	// row.
	short baselineType[]; /*
							 * The type of baseline for a particular row. A mix
							 * of the BaselineResizeBehavior constants (1 <<
							 * ordinal())
							 */
	...
	/**
	 * Creates an instance of GridBagLayoutInfo representing
