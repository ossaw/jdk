...
/**
 *
 * The ICC_ProfileRGB class is a subclass of the ICC_Profile class that
 * represents profiles which meet the following criteria:
 * <ul>
 ...
 * <code>redTRCTag</code>, <code>greenTRCTag</code>, <code>blueTRCTag</code>,
 * and <code>mediaWhitePointTag</code> tags.</li>
 * </ul>
 * The <code>ICC_Profile</code> <code>getInstance</code> method will return an
 * <code>ICC_ProfileRGB</code> object when these conditions are met.
...
public class ICC_ProfileRGB extends ICC_Profile {
    ...
    /**
     * Constructs a new <code>ICC_ProfileRGB</code> from a ProfileDeferralInfo
     * object.
     *
     * @param pdi
     */
     ...
     *
     * @return A 3-element <CODE>float</CODE> array containing the x, y, and z
     *         components of the profile's <CODE>mediaWhitePointTag</CODE>.
     */
    ...
    /**
     * Returns a 3x3 <CODE>float</CODE> matrix constructed from the X, Y, and Z
     ...
     * <code>BLUECOMPONENT</code>. Otherwise the returned array represents a
     * lookup table where the input component value is conceptually in the range
     * [0.0, 1.0]. Value 0.0 maps to array index 0 and value 1.0 maps to array
     * index length-1. Interpolation might be used to generate output values for
     * input values that do not map exactly to an index in the array. Output
     * values also map linearly to the range [0.0, 1.0]. Value 0.0 is
     * represented by an array value of 0x0000 and value 1.0 by 0xFFFF. In other
     * words, the values are really unsigned <code>short</code> values even
     * though they are returned in a <code>short</code> array.
     *
