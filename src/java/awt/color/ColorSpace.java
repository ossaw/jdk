 ...
 * information, see
 * <A href="http://www.w3.org/pub/WWW/Graphics/Color/sRGB.html"> http://www.w3.
 * org/pub/WWW/Graphics/Color/sRGB.html </A>.
 * <p>
...
public abstract class ColorSpace implements java.io.Serializable {
	 ...
	 * <A href="http://www.w3.org/pub/WWW/Graphics/Color/sRGB.html"> http://www.
	 * w3.org/pub/WWW/Graphics/Color/sRGB.html </A>.
	 */
	@Native
	 ...
	 * 
	 * @param type
	 *            one of the <CODE>ColorSpace</CODE> type constants
	 * @param numcomponents
	...
	/**
	 * Returns a ColorSpace representing one of the specific predefined color
	 * spaces.
	 * 
	 * @param colorspace
	 *            a specific color space identified by one of the predefined
	 *            class constants (e.g. CS_sRGB, CS_LINEAR_RGB, CS_CIEXYZ,
	 *            CS_GRAY, or CS_PYCC)
	 ...
	 * 
	 * @return <CODE>true</CODE> if this is a <CODE>CS_sRGB</CODE> color space,
	 ...
	 * D50 white point of the CS_CIEXYZ color space. This representation is
	 * useful in a two-step color conversion process in which colors are
	 * transformed from an input color space to CS_CIEXYZ and then to an output
	 * color space. This representation is not the same as the XYZ values that
	 * would be measured from the given color value by a colorimeter. A further
	 * transformation is necessary to compute the XYZ values that would be
	 * measured using current CIE recommended practices. See the
	 ...
	 * the D50 white point of the CS_CIEXYZ color space. This representation is
	 * useful in a two-step color conversion process in which colors are
	 * transformed from an input color space to CS_CIEXYZ and then to an output
	 * color space. The color values returned by this method are not those that
	 * would produce the XYZ value passed to the method when measured by a
	 * colorimeter. If you have XYZ values corresponding to measurements made
	 * using current CIE recommended practices, they must be converted to D50
	 * relative values before being passed to this method. See the
	 * {@link ICC_ColorSpace#fromCIEXYZ(float[]) fromCIEXYZ} method of
	 * <code>ICC_ColorSpace</code> for further information.
	 * <p>
	 * 
	 * @param colorvalue
	 ...
	 * TYPE_XYZ, ...). The type defines the number of components of the color
	 * space and the interpretation, e.g. TYPE_RGB identifies a color space with
	 * three components - red, green, and blue. It does not define the
	 * particular color characteristics of the space, e.g. the chromaticities of
	 * the primaries.
	 *
	 ...
	 *             if <code>idx</code> is less than 0 or greater than
	 *             numComponents - 1
	 */
