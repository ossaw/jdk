 ...
 * kind of profile are monochrome input profiles, monochrome display profiles,
 * and monochrome output profiles. The getInstance methods in the ICC_Profile
 * class will return an ICC_ProfileGray object when the above conditions are
 * met. The advantage of this class is that it provides a lookup table that Java
 * or native methods may be able to use directly to optimize color conversion in
 * some cases.
 * <p>
