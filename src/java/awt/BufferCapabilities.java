...
public class BufferCapabilities implements Cloneable {
     ...
     *         buffers that uses page flipping can swap the contents internally
     *         between the front buffer and one or more back buffers by
     *         switching the video pointer (or by copying memory internally). A
     *         non-flipping set of buffers uses blitting to copy the contents
     *         from one buffer to another; when this is the case,
     *         <code>getFlipContents</code> returns <code>null</code>
     */
     ...
     *         This value is <code>null</code> when the
     *         <code>isPageFlipping</code> returns <code>false</code>, implying
     *         blitting. It can be one of <code>FlipContents.UNDEFINED</code>
    ...
    /**
     * @return whether page flipping is only available in full-screen mode. If
     *         this is <code>true</code>, full-screen exclusive mode is required
     *         for page-flipping.
     * @see #isPageFlipping
    ...
    /**
     * @return whether or not page flipping can be performed using more than two
     *         buffers (one or more intermediate buffers as well as the front
     *         and back buffer).
     * @see #isPageFlipping
     */
    ...
    public static final class FlipContents extends AttributeValue {
         ...
         * back buffer are undefined after flipping.
         * 
         * @see #isPageFlipping
         * @see #getFlipContents
         * @see #BACKGROUND
         ...
         * back buffer are cleared with the background color after flipping.
         * 
         * @see #isPageFlipping
         * @see #getFlipContents
         * @see #UNDEFINED
         ...
         * buffer are the prior contents of the front buffer (a true page flip).
         * 
         * @see #isPageFlipping
         * @see #getFlipContents
         * @see #UNDEFINED
        ...
        /**
         * When flip contents are <code>COPIED</code>, the contents of the back
         * buffer are copied to the front buffer when flipping.
         * 
         * @see #isPageFlipping
         * @see #getFlipContents
         * @see #UNDEFINED
