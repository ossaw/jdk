...
public interface InputMethodRequests {
	...
	/**
	 * Gets the location of a specified offset in the current composed text, or
	 * of the selection in committed text. This information is, for example,
	 ...
	 * drawn vertically. Other text orientations need to be mapped to horizontal
	...
	/**
	 * Gets the offset within the composed text for the specified absolute x and
	...
	/**
	 * Gets the offset of the insert position in the committed text contained in
	 * the text editing component. This is the offset at which characters
	 * entered through an input method are inserted. This information is used by
	 * an input method, for example, to examine the text surrounding the insert
	 * position.
	 *
	 ...
	 * may have need not be made accessible through the iterator. If the list is
	 ...
	 * removes it from the component's text body. This is used for the
	 ...
	 * may be used for a variety of purposes. One of them is the "Reconvert"
	 * feature in some input methods. In this case, the input method will
	 * typically send an input method event to replace the selected text with
	 * composed text. Depending on the input method's capabilities, this may be
