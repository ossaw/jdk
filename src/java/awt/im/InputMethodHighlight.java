 ...
 * being composed. The description can be at two levels: at the abstract level
 * it specifies the conversion state and whether the text is selected; at the
 * concrete level it specifies style attributes used to render the highlight. An
 * InputMethodHighlight must provide the description at the abstract level; it
 * may or may not provide the description at the concrete level. If no concrete
 * style is provided, a renderer should use
 ...
 * <code>state</code>, and <code>variation</code>. <code>selected</code>
 * indicates whether the text range is the one that the input method is
 * currently working on, for example, the segment for which conversion
 * candidates are currently shown in a menu. <code>state</code> represents the
 * conversion state. State values are defined by the input method framework and
 * should be distinguished in all mappings from abstract to concrete styles.
 * Currently defined state values are raw (unconverted) and converted. These
 * state values are recommended for use before and after the main conversion
 * step of text composition, say, before and after kana-&gt;kanji or
...
public class InputMethodHighlight {
	 ...
	 */
	public final static InputMethodHighlight UNSELECTED_CONVERTED_TEXT_HIGHLIGHT = new InputMethodHighlight(
			false, CONVERTED_TEXT);

	/**
	 * Constant for the default highlight for selected converted text.
	 */
	public final static InputMethodHighlight SELECTED_CONVERTED_TEXT_HIGHLIGHT = new InputMethodHighlight(
			true, CONVERTED_TEXT);
	...
	/**
	 * Constructs an input method highlight record. The style attributes map
	 ...
	 * 
	 * @return The conversion state for the text range - RAW_TEXT or
	 *         CONVERTED_TEXT.
	 * @see InputMethodHighlight#RAW_TEXT
	 * @see InputMethodHighlight#CONVERTED_TEXT
	 */
