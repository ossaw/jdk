 ...
 * </ul>
 * <p>
 * <img src="doc-files/FontMetrics-1.gif" alt=
 * "The letter 'p' showing its 'reference point'" style=
 * "border:15px; float:right; margin: 7px 10px;"> Note that the implementations
 * of these methods are inefficient, so they are usually overridden with more
 * efficient toolkit-specific implementations.
 * <p>
 * When an application asks to place a character at the position (<i>x</i>
 * ,&nbsp;<i>y</i>), the character is placed so that its reference point (shown
 * as the dot in the accompanying image) is put at that position. The reference
 * point specifies a horizontal line called the <i>baseline</i> of the
 * character. In normal printing, the baselines of characters should align.
 * <p>
 * In addition, every character in a font has an <i>ascent</i>, a <i>descent</i>
 * , and an <i>advance width</i>. The ascent is the amount by which the
 * character ascends above the baseline. The descent is the amount by which the
 * character descends below the baseline. The advance width indicates the
 * position at which AWT should place the next character.
 * <p>
...
public abstract class FontMetrics implements java.io.Serializable {
	...
	/**
	 * The actual {@link Font} from which the font metrics are created. This
	 * cannot be null.
	 *
	 * @serial
	 * @see #getFont()
	...
	/**
	 * Creates a new <code>FontMetrics</code> object for finding out height and
	 * width information about the specified <code>Font</code> and specific
	 * character glyphs in that <code>Font</code>.
	 * 
	 * @param font
	 *            the <code>Font</code>
	 * @see java.awt.Font
	...
	/**
	 * Gets the <code>Font</code> described by this <code>FontMetrics</code>
	 * object.
	 * 
	 * @return the <code>Font</code> described by this <code>FontMetrics</code>
	 *         object.
	 */
	public Font getFont() {
		return font;
	 ...
	 * parameter measure text using the <code>FontRenderContext</code> of that
	 * <code>Graphics</code> object, and not this <code>FontRenderContext</code>
	 * 
	...
	/**
	 * Determines the <em>standard leading</em> of the <code>Font</code>
	 * described by this <code>FontMetrics</code> object. The standard leading,
	 * or interline spacing, is the logical amount of space to be reserved
	 * between the descent of one line of text and the ascent of the next line.
	 ...
	 * this <code>FontMetrics</code> object. The font ascent is the distance
	 * from the font's baseline to the top of most alphanumeric characters. Some
	 * characters in the <code>Font</code> might extend above the font ascent
	 * line.
	 * 
	...
	/**
	 * Determines the <em>font descent</em> of the <code>Font</code> described
	 * by this <code>FontMetrics</code> object. The font descent is the distance
	 * from the font's baseline to the bottom of most alphanumeric characters
	 * with descenders. Some characters in the <code>Font</code> might extend
	 ...
	 * distance between the baseline of adjacent lines of text. It is the sum of
	 * the leading + ascent + descent. Due to rounding this may not be the same
	 * as getAscent() + getDescent() + getLeading(). There is no guarantee that
	 * lines of text spaced at this distance are disjoint; such lines may
	...
	/**
	 * Determines the maximum ascent of the <code>Font</code> described by this
	 * <code>FontMetrics</code> object. No character extends further above the
	 * font's baseline than this height.
	 * 
	 * @return the maximum ascent of any character in the <code>Font</code>.
	 * @see #getAscent()
	 */
	...
	/**
	 * Determines the maximum descent of the <code>Font</code> described by this
	 * <code>FontMetrics</code> object. No character extends further below the
	 * font's baseline than this height.
	 * 
	 * @return the maximum descent of any character in the <code>Font</code>.
	 * @see #getDescent()
	 */
	 ...
	 * @return the maximum descent of any character in the <code>Font</code>.
	 * @see #getMaxDescent()
	 * @deprecated As of JDK version 1.1.1, replaced by
	 ...
	 * point on the string's baseline. The advance of a <code>String</code> is
	 * not necessarily the sum of the advances of its characters.
	 * 
	 * @return the maximum advance width of any character in the
	 *         <code>Font</code>, or <code>-1</code> if the maximum advance
	 *         width is not known.
	 */
	 ...
	 * <code>Font</code>. The advance is the distance from the leftmost point to
	 * the rightmost point on the character's baseline. Note that the advance of
	 * a <code>String</code> is not necessarily the sum of the advances of its
	 * characters.
	 *
	 * <p>
	 ...
	 * {@link java.lang.Character#isValidCodePoint(int)
	 * Character.isValidCodePoint} if necessary.
	 *
	 * @param codePoint
	 *            the character (Unicode code point) to be measured
	 * @return the advance width of the specified character in the
	 ...
	 * <a href="../lang/Character.html#supplementary"> supplementary
	 ...
	 * <code>String</code> in this <code>Font</code>. The advance is the
	 * distance from the leftmost point to the rightmost point on the string's
	 * baseline.
	 * <p>
	 * Note that the advance of a <code>String</code> is not necessarily the sum
	 * of the advances of its characters.
	 * 
	 * @param str
	 *            the <code>String</code> to be measured
	 * @return the advance width of the specified <code>String</code> in the
	 *         <code>Font</code> described by this <code>FontMetrics</code>.
	 ...
	 * characters in this <code>Font</code>. The advance is the distance from
	 * the leftmost point to the rightmost point on the string's baseline. The
	 * advance of a <code>String</code> is not necessarily the sum of the
	 * advances of its characters. This is equivalent to measuring a
	 * <code>String</code> of the characters in the specified range.
	 * 
	 * @param data
	 ...
	 *             if the <code>off</code> and <code>len</code> arguments index
	 *             characters outside the bounds of the <code>data</code> array.
	 * @see #charWidth(int)
	 * @see #charWidth(char)
	 * @see #bytesWidth(byte[], int, int)
	 * @see #stringWidth(String)
	...
	/**
	 * Returns the total advance width for showing the specified array of bytes
	 * in this <code>Font</code>. The advance is the distance from the leftmost
	 * point to the rightmost point on the string's baseline. The advance of a
	 * <code>String</code> is not necessarily the sum of the advances of its
	 * characters. This is equivalent to measuring a <code>String</code> of the
	 ...
	 * @return the advance width of the subarray of the specified
	 *         <code>byte</code> array in the <code>Font</code> described by
	 *         this <code>FontMetrics</code> object.
	 * @throws NullPointerException
	 *             if <code>data</code> is null.
	 * @throws IndexOutOfBoundsException
	 *             if the <code>off</code> and <code>len</code> arguments index
	 *             bytes outside the bounds of the <code>data</code> array.
	 * @see #charsWidth(char[], int, int)
	 * @see #stringWidth(String)
	 */
	 ...
	 * characters.
	 * 
	 * @return an array storing the advance widths of the characters in the
	 *         <code>Font</code> described by this <code>FontMetrics</code>
	 *         object.
	 */
	 ...
	 * composite font may consist of several different fonts to cover various
	 * character sets. In such cases, the <code>FontLineMetrics</code> objects
	 * are not uniform. Different fonts may have a different ascent, descent,
	 * metrics and so on. This information is sometimes necessary for line
	...
	/**
	 * Returns the {@link LineMetrics} object for the specified character array
	...
	/**
	 * Returns the bounds of the specified <code>String</code> in the specified
	 * <code>Graphics</code> context. The bounds is used to layout the
	 * <code>String</code>.
	 * <p>
	 * Note: The returned bounds is in baseline-relative coordinates (see
	 * {@link java.awt.FontMetrics class notes}).
	 * 
	 * @param str
	 *            the specified <code>String</code>
	 * @param context
	 ...
	 *         <code>String</code> in the specified <code>Graphics</code>
	 *         context.
	 ...
	 *            the specified <code>String</code>
	 * @param beginIndex
	 *            the offset of the beginning of <code>str</code>
	 * @param limit
	 *            the end offset of <code>str</code>
	 * @param context
	 *            the specified <code>Graphics</code> context
	 ...
	 * <code>Graphics</code> context. The bounds is used to layout the
	 * <code>String</code> created with the specified array of characters,
	 ...
	 *            the specified <code>Graphics</code> context
	 * @return a <code>Rectangle2D</code> that is the bounding box of the
	 *         specified character array in the specified <code>Graphics</code>
	 *         context.
	 ...
	 * <code>CharacterIterator</code> in the specified <code>Graphics</code>
	 * context.
	 * <p>
	 * Note: The returned bounds is in baseline-relative coordinates (see
	 * {@link java.awt.FontMetrics class notes}).
	 ...
	 *         <code>Graphics</code> context.
	 * @see java.awt.Font#getStringBounds(CharacterIterator, int, int,
	 *      FontRenderContext)
	 */
	...
	/**
	 * Returns the bounds for the character with the maximum bounds in the
	...
	/**
	 * Returns a representation of this <code>FontMetrics</code> object's values
	...
	public String toString() {
		return getClass().getName() + "[font=" + getFont() + "ascent=" + getAscent() + ", descent="
