 ...
 * <p>
 * <img src="doc-files/Button-1.gif" alt=
...
public class Button extends Component implements Accessible {
	...
	/**
	 * The action to be performed once a button has been pressed. This value may
	 * be null.
	 * 
	 * @serial
	...
	/**
	 * Creates the peer of the button. The button's peer allows the application
	 * to change the look of the button without changing its functionality.
	 *
	 ...
	 *
	 * @return the button's label, or <code>null</code> if the button has no
	 *         label.
	...
	/**
	 * Sets the command name for the action event fired by this button. By
	 ...
	 *            string is <code>null</code> then the action command is set to
	 ...
	 * command name is <code>null</code> (default) then this method returns the
	 * label of the button.
	 */
	 ...
	 * action events from this button. Action events occur when a user presses
	 * or releases the mouse over this button. If l is null, no exception is
	 ...
	 * you can query a <code>Button</code> <code>b</code> for its action
	...
	/**
	 * Processes events on this button. If an event is an instance of
	 * <code>ActionEvent</code>, this method invokes the
	 * <code>processActionEvent</code> method. Otherwise, it invokes
	 * <code>processEvent</code> on the superclass.
	 * <p>
	...
	/**
	 * Processes action events occurring on this button by dispatching them to
	 * any registered <code>ActionListener</code> objects.
	 * <p>
	 * This method is not called unless action events are enabled for this
	 * button. Action events are enabled when one of the following occurs:
	 * <ul>
	...
	/**
	 * Returns a string representing the state of this <code>Button</code>. This
	 ...
	 * non-serializable <code>ActionListeners</code> are detected and no attempt
	 ...
	 * <code>Button</code>. For buttons, the <code>AccessibleContext</code>
	 * takes the form of an <code>AccessibleAWTButton</code>. A new
	 * <code>AccessibleAWTButton</code> instance is created if necessary.
	 *
	...
	/**
	 * This class implements accessibility support for the <code>Button</code>
