...
public final class RadialGradientPaint extends MultipleGradientPaint {
	 ...
	 *            circle defining the gradient. The last color of the gradient
	 ...
	 *            used at the focus point, the last color around the perimeter
	 *            of the circle.
	 *
	 ...
	 *
	 * @throws NullPointerException
	 *             if {@code center} point is null, or {@code fractions} array
	 ...
	 * @throws NullPointerException
	 *             if {@code center} point is null, or {@code fractions} array
	 *             is null, or {@code colors} array is null, or
	 ...
	 *            gradient
	 * @param fx
	 *            the X coordinate of the point in user space to which the first
	 *            color is mapped
	 * @param fy
	 *            the Y coordinate of the point in user space to which the first
	 *            color is mapped
	 * @param fractions
	 *            numbers ranging from 0.0 to 1.0 specifying the distribution of
	 *            colors along the gradient
	 ...
	 *
	 * @throws NullPointerException
	 *             if one of the points is null, or {@code fractions} array is
	 *             null, or {@code colors} array is null, or {@code cycleMethod}
	 *             is null
	 * @throws IllegalArgumentException
	 *             if {@code radius} is non-positive, or
	 *             {@code fractions.length != colors.length}, or {@code colors}
	 ...
	 *             if one of the points is null, or {@code fractions} array is
	 *             null, or {@code colors} array is null, or {@code cycleMethod}
	 *             is null, or {@code colorSpace} is null, or
	 ...
	 * gradientTransform.translate(-cx, -cy);
	 *
	 * RadialGradientPaint gp = new RadialGradientPaint(center, 1.0f, center, fractions, colors,
	 * 		cycleMethod, ColorSpaceType.SRGB, gradientTransform);
	 * </pre>
	 *
	 * @param gradientBounds
	 *            the bounding box, in user space, of the circle defining the
	 ...
	 *
	 * @throws NullPointerException
	 *             if {@code gradientBounds} is null, or {@code fractions} array
	 *             is null, or {@code colors} array is null, or
	 *             {@code cycleMethod} is null
	 * @throws IllegalArgumentException
	...
	public PaintContext createContext(ColorModel cm, Rectangle deviceBounds, Rectangle2D userBounds,
		...
		return new RadialGradientPaintContext(this, cm, deviceBounds, userBounds, transform, hints,
				(float) center.getX(), (float) center.getY(), radius, (float) focus.getX(),
				(float) focus.getY(), fractions, colors, cycleMethod, colorSpace);
	}
