...
/**
 * A <code>TextArea</code> object is a multi-line region that displays text. It
 * can be set to allow editing or to be read-only.
 * <p>
 * The following image shows the appearance of a text area:
 * <p>
 * <img src="doc-files/TextArea-1.gif" alt=
 * "A TextArea showing the word 'Hello!'" style=
...
public class TextArea extends TextComponent {
    ...
    /**
     * The number of rows in the <code>TextArea</code>. This parameter will
     * determine the text area's height. Guaranteed to be non-negative.
     *
     * @serial
     * @see #getRows()
     * @see #setRows(int)
    ...
    /**
     * The number of columns in the <code>TextArea</code>. A column is an
     * approximate average character width that is platform-dependent. This
     * parameter will determine the text area's width. Guaranteed to be
     * non-negative.
     *
     * @serial
     * @see #setColumns(int)
    ...
    /**
     * Determines which scrollbars are created for the text area. It can be one
     * of four values : <code>SCROLLBARS_BOTH</code> = both scrollbars.<BR>
    ...
    /**
     * Constructs a new text area with the empty string as text. This text area
     * is created with scrollbar visibility equal to {@link #SCROLLBARS_BOTH},
     * so both vertical and horizontal scrollbars will be visible for this text
     * area.
     * 
    ...
    /**
     * Constructs a new text area with the specified text. This text area is
     * created with scrollbar visibility equal to {@link #SCROLLBARS_BOTH}, so
     * both vertical and horizontal scrollbars will be visible for this text
     * area.
     * 
     * @param text
     ...
     * and the empty string as text. A column is an approximate average
     * character width that is platform-dependent. The text area is created with
     * scrollbar visibility equal to {@link #SCROLLBARS_BOTH}, so both vertical
     ...
     * specified number of rows and columns. A column is an approximate average
     * character width that is platform-dependent. The text area is created with
     * scrollbar visibility equal to {@link #SCROLLBARS_BOTH}, so both vertical
     * and horizontal scrollbars will be visible for this text area.
     * 
     ...
     * columns, and scroll bar visibility as specified. All
     * <code>TextArea</code> constructors defer to this one.
     * <p>
     * The <code>TextArea</code> class defines several constants that can be
     * supplied as values for the <code>scrollbars</code> argument:
     * <ul>
     ...
     * </ul>
     * Any other value for the <code>scrollbars</code> argument is invalid and
     * will result in this text area being created with scrollbar visibility
     ...
     * <p>
     * Note that passing <code>null</code> or inconsistent parameters is invalid
     ...
     *
     * @param str
     *        the non-<code>null</code> text to append
     ...
     * specified replacement text. The text at the end position will not be
     * replaced. The text at the start position will be replaced (unless the
     * start position is the same as the end position). The text position is
     * zero-based. The inserted substring may be of a different length than the
     * text it replaces.
     * <p>
     * Note that passing <code>null</code> or inconsistent parameters is invalid
     * and will result in unspecified behavior.
    ...
    /**
     * @deprecated As of JDK version 1.1, replaced by
     *             <code>replaceRange(String, int, int)</code>.
     */
    @Deprecated
     ...
     * area uses.
     * <p>
     * The <code>TextArea</code> class defines four integer constants that are
     * used to specify which scroll bars are available. <code>TextArea</code>
     * has one constructor that gives the application discretion over scroll
     * bars.
     *
    ...
    protected String paramString() {
        ...
        return super.paramString() + ",rows=" + rows + ",columns=" + columns + ",scrollbarVisibility="
                + sbVisStr;
    }
     ...
     * <code>TextArea</code>. For text areas, the <code>AccessibleContext</code>
     * takes the form of an <code>AccessibleAWTTextArea</code>. A new
     * <code>AccessibleAWTTextArea</code> instance is created if necessary.
     *
    ...
    /**
     * This class implements accessibility support for the <code>TextArea</code>
