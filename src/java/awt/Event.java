 ...
 * maintained only for backwards compatibility. The information in this class
...
public class Event implements java.io.Serializable {
	...
	/**
	 * The user has pressed a non-ASCII <em>action</em> key. The
	 * <code>key</code> field contains a value that indicates that the event
	 * occurred on one of the action keys, which comprise the 12 function keys,
	 * the arrow (cursor) keys, Page Up, Page Down, Home, End, Print Screen,
	 * Scroll Lock, Caps Lock, Num Lock, Pause, and Insert.
	 */
	public static final int KEY_ACTION = 3 + KEY_EVENT;

	/**
	 * The user has released a non-ASCII <em>action</em> key. The
	 * <code>key</code> field contains a value that indicates that the event
	 * occurred on one of the action keys, which comprise the 12 function keys,
	 * the arrow (cursor) keys, Page Up, Page Down, Home, End, Print Screen,
	 * Scroll Lock, Caps Lock, Num Lock, Pause, and Insert.
	...
	/**
	 * The user has pressed the mouse button. The <code>ALT_MASK</code> flag
	 * indicates that the middle button has been pressed. The
	 * <code>META_MASK</code>flag indicates that the right button has been
	 * pressed.
	 * 
	...
	/**
	 * The user has released the mouse button. The <code>ALT_MASK</code> flag
	 * indicates that the middle button has been released. The
	 * <code>META_MASK</code>flag indicates that the right button has been
	 * released.
	 * 
	 * @see java.awt.Event#ALT_MASK
	 ...
	 * <code>ALT_MASK</code> flag indicates that the middle button is being
	 * pressed. The <code>META_MASK</code> flag indicates that the right button
	 * is being pressed.
	 * 
	 * @see java.awt.Event#ALT_MASK
	 * @see java.awt.Event#META_MASK
	...
	/**
	 * The user has activated the <em>line up</em> area of a scroll bar.
	 */
	public static final int SCROLL_LINE_UP = 1 + SCROLL_EVENT;

	/**
	 * The user has activated the <em>line down</em> area of a scroll bar.
	 */
	public static final int SCROLL_LINE_DOWN = 2 + SCROLL_EVENT;

	/**
	 * The user has activated the <em>page up</em> area of a scroll bar.
	 */
	public static final int SCROLL_PAGE_UP = 3 + SCROLL_EVENT;

	/**
	 * The user has activated the <em>page down</em> area of a scroll bar.
	 */
	public static final int SCROLL_PAGE_DOWN = 4 + SCROLL_EVENT;

	/**
	 * The user has moved the bubble (thumb) in a scroll bar, moving to an
	 * "absolute" position, rather than to an offset from the last position.
	 */
	...
	/**
	 * The <i>x</i> coordinate of the event. Replaced by MouseEvent.getX()
	 *
	 * @serial
	...
	/**
	 * The <i>y</i> coordinate of the event. Replaced by MouseEvent.getY()
	 *
	 * @serial
	...
	/**
	 * The key code of the key that was pressed in a keyboard event. This has
	 * been replaced by KeyEvent.getKeyCode()
	 *
	 * @serial
	...
	/**
	 * For <code>MOUSE_DOWN</code> events, this field indicates the number of
	 * consecutive clicks. For other events, its value is <code>0</code>. This
	 * field has been replaced by MouseEvent.getClickCount().
	 *
	 * @serial
	...
	private static final int actionKeyCodes[][] = {
			...
			{ KeyEvent.VK_F1, Event.F1 }, { KeyEvent.VK_F2, Event.F2 },
			{ KeyEvent.VK_F3, Event.F3 }, { KeyEvent.VK_F4, Event.F4 },
			{ KeyEvent.VK_F5, Event.F5 }, { KeyEvent.VK_F6, Event.F6 },
			{ KeyEvent.VK_F7, Event.F7 }, { KeyEvent.VK_F8, Event.F8 },
			{ KeyEvent.VK_F9, Event.F9 }, { KeyEvent.VK_F10, Event.F10 },
			{ KeyEvent.VK_F11, Event.F11 }, { KeyEvent.VK_F12, Event.F12 },
	 ...
	 * peer once the target has processed it - false means it's sent to the
	 ...
	 * component, time stamp, event type, <i>x</i> and <i>y</i> coordinates,
	 ...
	 * Creates an instance of <code>Event</code>, with the specified target
	 * component, time stamp, event type, <i>x</i> and <i>y</i> coordinates,
	 * keyboard key, state of the modifier keys, and an argument set to
	 * <code>null</code>.
	 * 
	 * @param target
	 *            the target component.
	 ...
	 * <code>AWTEvent</code> class and its subclasses.
	 * <p>
	 * Translates this event so that its <i>x</i> and <i>y</i> coordinates are
	 * increased by <i>dx</i> and <i>dy</i>, respectively.
	 * <p>
	 * This method translates an event relative to the given component. This
	 * involves, at a minimum, translating the coordinates into the local
	 * coordinate system of the given component. It may also involve translating
	 ...
	 * 
	 * @return <code>true</code> if the key is down; <code>false</code>
	 *         otherwise.
	 ...
	 * <b>NOTE:</b> The <code>Event</code> class is obsolete and is available
	 * only for backwards compatibility. It has been replaced by the
	 * <code>AWTEvent</code> class and its subclasses. <p> Returns the integer
	 * key-code associated with the key in this event, as described in
	 * java.awt.Event.
	 */
	 ...
	 * <b>NOTE:</b> The <code>Event</code> class is obsolete and is available
	 * only for backwards compatibility. It has been replaced by the
	 * <code>AWTEvent</code> class and its subclasses. <p> Returns a new
	 * KeyEvent char which corresponds to the int key of this old event.
	 */
	 ...
	 * <code>AWTEvent</code> class and its subclasses.
	 * <p>
	 * Returns a string representing the state of this <code>Event</code>. This
	 ...
	 * 
	 * @return a string that represents the event and the values of its member
	 *         fields.
