...
/**
 * <code>Panel</code> is the simplest container class. A panel provides space in
 * which an application can attach any other component, including other panels.
 * <p>
 * The default layout manager for a panel is the <code>FlowLayout</code> layout
 * manager.
 *
 * @author Sami Shaio
...
public class Panel extends Container implements Accessible {
     ...
     * manager for all panels is the <code>FlowLayout</code> class.
     */
    public Panel() {
        this(new FlowLayout());
    }
     ...
     *
     * @return an AccessibleAWTPanel that serves as the AccessibleContext of
     *         this Panel
     * @since 1.3
     */
    ...
    /**
     * This class implements accessibility support for the <code>Panel</code>
