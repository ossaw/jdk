...
public final class DisplayMode {
     ...
     * <code>BIT_DEPTH_MULTI</code> if multiple bit depths are supported in this
     * display mode.
     *
    ...
    public boolean equals(DisplayMode dm) {
        ...
        return (getHeight() == dm.getHeight() && getWidth() == dm.getWidth() && getBitDepth() == dm
                .getBitDepth() && getRefreshRate() == dm.getRefreshRate());
    }
