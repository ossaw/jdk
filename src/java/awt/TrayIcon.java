...
public class TrayIcon {
     ...
     * Unlike the acc in Component, this field is made final because TrayIcon is
     * not serializable.
     */
     ...
     * image is discarded without calling the {@link java.awt.Image#flush}
    ...
    /**
     * Sets the popup menu for this <code>TrayIcon</code>. If <code>popup</code>
     * is <code>null</code>, no popup menu will be associated with this
     * <code>TrayIcon</code>.
     *
     * <p>
     * Note that this <code>popup</code> must not be added to any parent before
     * or after it is set on the tray icon. If you add it to some parent, the
     * <code>popup</code> may be removed from that parent.
     *
     * <p>
     * The {@code popup} can be set on one {@code TrayIcon} only. Setting the
     * same popup on multiple {@code TrayIcon}s will cause an
     ...
     *
     * @throws IllegalArgumentException
     *                                  if the {@code popup} is already set for
     *                                  another
     *                                  {@code TrayIcon}
     * @param popup
     *              a <code>PopupMenu</code> or <code>null</code> to remove any
     *              popup menu
     * @see #getPopupMenu
     */
     ...
     * tooltip to <code>null</code> removes any tooltip text.
     *
     ...
     *
     * <p>
     * If auto-size is <code>false</code>, and the image size doesn't match the
     * tray icon space, the image is painted as-is inside that space &#151; if
     ...
     *
     * @param autosize
     *                 <code>true</code> to auto-size the image,
     *                 <code>false</code>
     *                 otherwise
     * @see #isImageAutoSize
     */
     ...
     * <code>TrayIcon</code>. Calling this method with a <code>null</code> value
     * has no effect.
     *
     * <p>
     * <b>Note</b>: The {@code MouseEvent}'s coordinates (received from the
     * {@code TrayIcon}) are relative to the screen, not the {@code TrayIcon}.
     *
     * <p>
     * <b>Note: </b>The <code>MOUSE_ENTERED</code> and <code>MOUSE_EXITED</code>
     ...
     *         <code>TrayIcon</code> or an empty array if no mouse listeners are
    ...
    public synchronized MouseListener[] getMouseListeners() {
        return AWTEventMulticaster.getListeners(mouseListener,
                MouseListener.class);
    }

    /**
     * Adds the specified mouse listener to receive mouse-motion events from
     * this <code>TrayIcon</code>. Calling this method with a <code>null</code>
     * value has no effect.
     *
     * <p>
     * <b>Note</b>: The {@code MouseEvent}'s coordinates (received from the
    ...
    public synchronized MouseMotionListener[] getMouseMotionListeners() {
        return AWTEventMulticaster.getListeners(mouseMotionListener,
     ...
     * from this <code>TrayIcon</code>. Action events usually occur when a user
     * selects the tray icon, using either the mouse or keyboard. The conditions
     * in which action events are generated are platform-dependent.
     *
     * <p>
    ...
    public synchronized ActionListener[] getActionListeners() {
        return AWTEventMulticaster.getListeners(actionListener,
     ...
     * <code>NullPointerException</code> is thrown if both are <code>null</code>
     * .
     *
     * When displayed, the caption or text strings may be truncated on some
     * platforms; the number of characters that may be displayed is
     * platform-dependent.
     *
     * <p>
     ...
     *
     * @param caption
     *                    the caption displayed above the text, usually in bold;
     *                    may be
     *                    <code>null</code>
     * @param text
