...
/**
 * A <code>DragGestureEvent</code> is passed to <code>DragGestureListener</code>
 * 's dragGestureRecognized() method when a particular
 * <code>DragGestureRecognizer</code> detects that a platform dependent drag
 * initiating gesture has occurred on the <code>Component</code> that it is
 * tracking.
 *
...
public class DragGestureEvent extends EventObject {
	 ...
	 * <code>DragGestureRecognizer</code> instance firing this event, an
	 * {@code act} parameter representing the user's preferred action, an
	 * {@code ori} parameter indicating the origin of the drag, and a
	 * {@code List} of events that comprise the gesture({@code evs} parameter).
	 * <P>
	 * 
	 * @param dgr
	 *            The <code>DragGestureRecognizer</code> firing this event
	 * @param act
	 *            The user's preferred action. For information on allowable
	 *            values, see the class description for {@link DragGestureEvent}
	 * @param ori
	 *            The origin of the drag
	 * @param evs
	 *            The <code>List</code> of events that comprise the gesture
	 *            <P>
	 * @throws IllegalArgumentException
	 *             if any parameter equals {@code null}
	 * @throws IllegalArgumentException
	 *             if the act parameter does not comply with the values given in
	...
	/**
	 * Returns a <code>Point</code> in the coordinates of the
	 * <code>Component</code> over which the drag originated.
	 * <P>
	 * 
	...
	/**
	 * Returns an <code>Object</code> array of the events comprising the drag
	 * gesture.
	 * <P>
	 * 
	 ...
	 * 
	 * @param array
	 *            the array of <code>EventObject</code> sub(types)
	 *            <P>
	 * @return an array of the events comprising the gesture
	 */
	@SuppressWarnings("unchecked")
	 ...
	 * be thrown and default drag cursors will be used instead. <br>
	 ...
	 * @param transferable
	 *            The <code>Transferable</code> representing the source data for
	 *            this drag operation.
	 *
	 ...
	 *             if the {@code Transferable} is {@code null}
	 * @since 1.4
	 */
	...
	/**
	 * Starts the drag given the initial <code>Cursor</code> to display, the
	 * <code>Transferable</code> object, and the <code>DragSourceListener</code>
	 * to use.
	 * <P>
	 * 
	 * @param dragCursor
	...
	/**
	 * Start the drag given the initial <code>Cursor</code> to display, a drag
	 * <code>Image</code>, the offset of the <code>Image</code>, the
	 * <code>Transferable</code> object, and the <code>DragSourceListener</code>
	 * to use.
	 * <P>
	 * 
	 ...
	 * gesture events if and only if the <code>List</code> can be serialized. If
	 * not, <code>null</code> is written instead. In this case, a
	 ...
	 * <code>List</code> of gesture events as well. This is first attempted by
	 * deserializing the field <code>events</code>, because, in releases prior
	 * to 1.4, a non-<code>transient</code> field of this name stored the
	 ...
	 * <code>null</code>, this object's <code>List</code> of gesture events is
	 * set to an empty <code>List</code>.
	 *
	 * @since 1.4
	 */
	private void readObject(ObjectInputStream s) throws ClassNotFoundException, IOException {
		...
		if (newAction != DnDConstants.ACTION_COPY && newAction != DnDConstants.ACTION_MOVE
