...
public class DragSourceDropEvent extends DragSourceEvent {
     ...
     * <code>DragSourceContext</code>, the drop action, and a
     * <code>boolean</code> indicating if the drop was successful. The
     * coordinates for this <code>DragSourceDropEvent</code> are not specified,
     * so <code>getLocation</code> will return <code>null</code> for this event.
     * <p>
     * The argument <code>action</code> should be one of
     * <code>DnDConstants</code> that represents a single action. This
    ...
    /**
     * Construct a <code>DragSourceDropEvent</code> for a drag that does not
     * result in a drop. The coordinates for this
     * <code>DragSourceDropEvent</code> are not specified, so
    ...
    /**
     * This method returns a <code>boolean</code> indicating if the drop was
     * successful.
     *
     * @return <code>true</code> if the drop target accepted the drop and
     *         successfully performed a drop action; <code>false</code> if the
     *         drop target rejected the drop or if the drop target accepted the
     *         drop, but failed to perform a drop action.
     */
    ...
    /**
     * This method returns an <code>int</code> representing the action performed
     * by the target on the subject of the drop.
     *
