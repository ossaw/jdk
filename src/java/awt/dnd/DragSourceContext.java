 ...
 * the drag operation.
 * <p>
 * <a name="defaultCursor"></a> By default, {@code DragSourceContext} sets the
...
public class DragSourceContext implements DragSourceListener, DragSourceMotionListener, Serializable {
    ...
    /**
     * An <code>int</code> used by updateCurrentCursor() indicating that the
     * <code>Cursor</code> should change to the default (no drop)
     * <code>Cursor</code>.
     */
    ...
    /**
     * An <code>int</code> used by updateCurrentCursor() indicating that the
     * <code>Cursor</code> has entered a <code>DropTarget</code>.
     */
    protected static final int ENTER = 1;

    /**
     * An <code>int</code> used by updateCurrentCursor() indicating that the
     * <code>Cursor</code> is over a <code>DropTarget</code>.
     */
    protected static final int OVER = 2;

    /**
     * An <code>int</code> used by updateCurrentCursor() indicating that the
     * user operation has changed.
     */
     ...
     * <code>Cursor</code> to use for the Drag, an (optional) <code>Image</code>
     * to display while the Drag is taking place, the offset of the
     * <code>Image</code> origin from the hotspot at the instant of the
     ...
     * <code>NullPointerException</code> is thrown. <br>
     ...
     * <br>
     * If <code>Image</code> is <code>null</code> no exception is thrown. <br>
     * If <code>Image</code> is not <code>null</code> and the offset is
     * <code>null</code> <code>NullPointerException</code> is thrown. <br>
     * If <code>Transferable</code> is <code>null</code>
     * <code>NullPointerException</code> is thrown. <br>
     * If <code>DragSourceListener</code> is <code>null</code> no exception is
     * thrown.
     *
     * @param dscp
     ...
     *         and offset is null
     */
    public DragSourceContext(DragSourceContextPeer dscp, DragGestureEvent trigger, Cursor dragCursor,
            Image dragImage, Point offset, Transferable t, DragSourceListener dsl) {
        if (dscp == null) {
    ...
    /**
     * Returns the <code>DragSource</code> that instantiated this
     * <code>DragSourceContext</code>.
     *
     * @return the <code>DragSource</code> that instantiated this
     *         <code>DragSourceContext</code>
     */
    ...
    /**
     * Returns the <code>DragGestureEvent</code> that initially triggered the
     * drag.
     *
    ...
    /**
     * Returns a bitwise mask of <code>DnDConstants</code> that represent the
     * set of drop actions supported by the drag source for the drag operation
     ...
     * <code>Cursor</code>. If the specified <code>Cursor</code> is
     * <code>null</code>, the default drag cursor behavior is activated for this
     ...
     * <code>DragSourceContext</code> if one has not already been added. If a
     * <code>DragSourceListener</code> already exists, this method throws a
     * <code>TooManyListenersException</code>.
     * <P>
     * 
     * @param dsl
     *        the <code>DragSourceListener</code> to add. Note that while
     *        <code>null</code> is not prohibited, it is not acceptable as a
     *        parameter.
     *        <P>
     ...
     *
     * @param dsl
     *        the <code>DragSourceListener</code> to remove; note that while
     *        <code>null</code> is not prohibited, it is not acceptable as a
     *        parameter
     */
    ...
    /**
     * Calls <code>dragEnter</code> on the <code>DragSourceListener</code>s
     * registered with this <code>DragSourceContext</code> and with the
     * associated <code>DragSource</code>, and passes them the specified
    ...
    /**
     * Calls <code>dragOver</code> on the <code>DragSourceListener</code>s
     * registered with this <code>DragSourceContext</code> and with the
     * associated <code>DragSource</code>, and passes them the specified
     * <code>DragSourceDragEvent</code>.
     *
    ...
    /**
     * Calls <code>dragExit</code> on the <code>DragSourceListener</code>s
     * registered with this <code>DragSourceContext</code> and with the
     * associated <code>DragSource</code>, and passes them the specified
    ...
    /**
     * Calls <code>dragDropEnd</code> on the <code>DragSourceListener</code>s
     * registered with this <code>DragSourceContext</code> and with the
     * associated <code>DragSource</code>, and passes them the specified
    ...
    /**
     * Returns the <code>Transferable</code> associated with this
     * <code>DragSourceContext</code>.
     *
     ...
     * serialized. If not, <code>null</code> is written instead. In this case, a
     * <code>DragSourceContext</code> created from the resulting deserialized
    ...
    private void readObject(ObjectInputStream s) throws ClassNotFoundException, IOException {
        ...
        int newSourceActions = f.get("sourceActions", 0) & (DnDConstants.ACTION_COPY_OR_MOVE
