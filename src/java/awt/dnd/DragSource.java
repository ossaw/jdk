...
/**
 * The <code>DragSource</code> is the entity responsible for the initiation of
 ...
 * <LI>1 instance per class of potential Drag Initiator object (e.g TextField).
 * [implementation dependent]
 * <LI>1 per instance of a particular <code>Component</code>, or application
 * specific object associated with a <code>Component</code> instance in the GUI.
 * [implementation dependent]
 * <LI>Some other arbitrary association. [implementation dependent]
 * </UL>
 *
 * Once the <code>DragSource</code> is obtained, a
 * <code>DragGestureRecognizer</code> should also be obtained to associate the
 * <code>DragSource</code> with a particular <code>Component</code>.
 * <P>
 ...
 * <code>Component</code>, which is usually implemented by a
 * <code>DragGestureRecognizer</code>.
 * <P>
 * When a drag gesture occurs, the <code>DragSource</code>'s startDrag() method
 * shall be invoked in order to cause processing of the user's navigational
 * gestures and delivery of Drag and Drop protocol notifications. A
 * <code>DragSource</code> shall only permit a single Drag and Drop operation to
 * be current at any one time, and shall reject any further startDrag() requests
 * by throwing an <code>IllegalDnDOperationException</code> until such time as
 * the extant operation is complete.
 * <P>
 * The startDrag() method invokes the createDragSourceContext() method to
 * instantiate an appropriate <code>DragSourceContext</code> and associate the
 * <code>DragSourceContextPeer</code> with that.
 * <P>
 * If the Drag and Drop System is unable to initiate a drag operation for some
 * reason, the startDrag() method throws a
 * <code>java.awt.dnd.InvalidDnDOperationException</code> to signal such a
 * condition. Typically this exception is thrown when the underlying platform
 * system is either not in a state to initiate a drag, or the parameters
...
public class DragSource implements Serializable {
    ...
    private static Cursor load(String name) {
        ...
        try {
            return (Cursor) Toolkit.getDefaultToolkit().getDesktopProperty(
                    name);
        } catch (Exception e) {
            e.printStackTrace();

            throw new RuntimeException("failed to load system cursor: " + name
                    + " : " + e.getMessage());
        }
    }
     ...
     * @see java.awt.GraphicsEnvironment#isHeadless
     */
    public static final Cursor DefaultCopyNoDrop = load(
     ...
     * @see java.awt.GraphicsEnvironment#isHeadless
     */
    public static final Cursor DefaultMoveNoDrop = load(
     ...
     * @see java.awt.GraphicsEnvironment#isHeadless
     */
    public static final Cursor DefaultLinkNoDrop = load(
            "DnD.Cursor.LinkNoDrop");

    private static final DragSource dflt = (GraphicsEnvironment.isHeadless())
            ? null
            : new DragSource();
    ...
    /**
     * Gets the <code>DragSource</code> object associated with the underlying
     * platform.
     *
    ...
    /**
     * Reports whether or not drag <code>Image</code> support is available on
    ...
    /**
     * Start a drag, given the <code>DragGestureEvent</code> that initiated the
     * drag, the initial <code>Cursor</code> to use, the <code>Image</code> to
     * drag, the offset of the <code>Image</code> origin from the hotspot of the
     * <code>Cursor</code> at the instant of the trigger, the
     * <code>Transferable</code> subject data of the drag, the
     * <code>DragSourceListener</code>, and the <code>FlavorMap</code>.
     * <P>
     * 
     * @param trigger
     *                     the <code>DragGestureEvent</code> that initiated the
     *                     drag
     * @param dragCursor
     ...
     *                     DragSourceContext</a> for more details on the cursor
     *                     handling
     *                     mechanism during drag and drop
     * @param dragImage
     *                     the image to drag or {@code null}
     * @param imageOffset
     *                     the offset of the <code>Image</code> origin from the
     *                     hotspot
     *                     of the <code>Cursor</code> at the instant of the
     *                     trigger
     * @param transferable
     ...
     * @param flavorMap
     *                     the <code>FlavorMap</code> to use, or
     *                     <code>null</code>
     *                     <P>
     * @throws java.awt.dnd.InvalidDnDOperationException
     *         if the Drag and Drop system is unable to initiate a drag
     *         operation, or if the user attempts to start a drag while an
    ...
    public void startDrag(DragGestureEvent trigger, Cursor dragCursor,
        ...
        try {
            ...
            DragSourceContext dsc = createDragSourceContext(dscp, trigger,
                    dragCursor, dragImage, imageOffset, transferable, dsl);

            if (dsc == null) {
                throw new InvalidDnDOperationException();
            }

            dscp.startDrag(dsc, dsc.getCursor(), dragImage, imageOffset); // may
                                                                          // throw
    ...
    /**
     * Start a drag, given the <code>DragGestureEvent</code> that initiated the
     * drag, the initial <code>Cursor</code> to use, the
     * <code>Transferable</code> subject data of the drag, the
     * <code>DragSourceListener</code>, and the <code>FlavorMap</code>.
     * <P>
     * 
    ...
    public void startDrag(DragGestureEvent trigger, Cursor dragCursor,
        ...
        startDrag(trigger, dragCursor, null, null, transferable, dsl,
                flavorMap);
    }
     ...
     * drag, the initial <code>Cursor</code> to use, the <code>Image</code> to
     * drag, the offset of the <code>Image</code> origin from the hotspot of the
     * <code>Cursor</code> at the instant of the trigger, the subject data of
     * the drag, and the <code>DragSourceListener</code>.
     * <P>
     * 
     * @param trigger
     *                     the <code>DragGestureEvent</code> that initiated the
    ...
    public void startDrag(DragGestureEvent trigger, Cursor dragCursor,
            Image dragImage, Point dragOffset, Transferable transferable,
            DragSourceListener dsl) throws InvalidDnDOperationException {
        startDrag(trigger, dragCursor, dragImage, dragOffset, transferable, dsl,
                null);
    }
     ...
     * Start a drag, given the <code>DragGestureEvent</code> that initiated the
     * drag, the initial <code>Cursor</code> to use, the
     * <code>Transferable</code> subject data of the drag, and the
     ...
     *                     {@code null} for the default cursor handling; see
     *                     <a href="DragSourceContext.html#defaultCursor">
     *                     DragSourceContext</a> class for more details on the
     *                     cursor
     *                     handling mechanism during drag and drop
     * @param transferable
     *                     the subject data of the drag
     * @param dsl
     *                     the <code>DragSourceListener</code>
     ...
     * operation.
     * <p>
     * To incorporate a new <code>DragSourceContext</code> subclass, subclass
     * <code>DragSource</code> and override this method.
     * <p>
     * If <code>dragImage</code> is <code>null</code>, no image is used to
     * represent the drag over feedback for this drag operation, but
     * <code>NullPointerException</code> is not thrown.
     * <p>
     * If <code>dsl</code> is <code>null</code>, no drag source listener is
     * registered with the created <code>DragSourceContext</code>, but
     * <code>NullPointerException</code> is not thrown.
     *
     * @param dscp
     *                    The <code>DragSourceContextPeer</code> for this drag
     * @param dgl
     *                    The <code>DragGestureEvent</code> that triggered the
     *                    drag
     * @param dragCursor
     *                    The initial {@code Cursor} for this drag operation or
     *                    {@code null} for the default cursor handling; see
     ...
     *                                  if <code>dscp</code> is
     *                                  <code>null</code>
     * @throws NullPointerException
     *                                  if <code>dgl</code> is <code>null</code>
     * @throws NullPointerException
     *                                  if <code>dragImage</code> is not
     *                                  <code>null</code> and
    ...
    /**
     * This method returns the <code>FlavorMap</code> for this
    ...
    /**
     * Creates a new <code>DragGestureRecognizer</code> that implements the
     * specified abstract subclass of <code>DragGestureRecognizer</code>, and
     * sets the specified <code>Component</code> and
     * <code>DragGestureListener</code> on the newly created object.
     * <P>
     * 
     * @param recognizerAbstractClass
     *                                the requested abstract type
     * @param actions
     *                                the permitted source drag actions
     * @param c
     *                                the <code>Component</code> target
     * @param dgl
     ...
     *         has no implementation available for the requested
     *         <code>DragGestureRecognizer</code> subclass and returns
     *         <code>null</code>
     */

    public <T extends DragGestureRecognizer> T createDragGestureRecognizer(
            Class<T> recognizerAbstractClass, Component c, int actions,
            DragGestureListener dgl) {
        return Toolkit.getDefaultToolkit().createDragGestureRecognizer(
                recognizerAbstractClass, this, c, actions, dgl);
    }

    /**
     * Creates a new <code>DragGestureRecognizer</code> that implements the
     * default abstract subclass of <code>DragGestureRecognizer</code> for this
     * <code>DragSource</code>, and sets the specified <code>Component</code>
     * and <code>DragGestureListener</code> on the newly created object.
     *
     * For this <code>DragSource</code> the default is
     * <code>MouseDragGestureRecognizer</code>.
     * <P>
     * 
     * @param c
     *                the <code>Component</code> target for the recognizer
     * @param actions
     *                the permitted source actions
     * @param dgl
     *                the <code>DragGestureListener</code> to notify
     *                <P>
     * @return the new <code>DragGestureRecognizer</code> or <code>null</code>
     *         if the <code>Toolkit.createDragGestureRecognizer</code> method
     *         has no implementation available for the requested
     ...
     * operations intiated with this <code>DragSource</code>. If a
     * <code>null</code> listener is specified, no action is taken and no
     * exception is thrown.
     *
     * @param dsl
     *            the <code>DragSourceListener</code> to add
     *
     ...
     * <code>DragSource</code>. If a <code>null</code> listener is specified, no
     * action is taken and no exception is thrown. If the listener specified by
     * the argument was not previously added to this <code>DragSource</code>, no
     * action is taken and no exception is thrown.
     *
     * @param dsl
     *            the <code>DragSourceListener</code> to remove
     *
    ...
    /**
     * Gets all the <code>DragSourceListener</code>s registered with this
     * <code>DragSource</code>.
     *
     * @return all of this <code>DragSource</code>'s
     *         <code>DragSourceListener</code>s or an empty array if no such
     ...
     *
     * @param dsml
     *             the <code>DragSourceMotionListener</code> to add
     *
     ...
     *
     * @param dsml
     *             the <code>DragSourceMotionListener</code> to remove
     *
    ...
    public void removeDragSourceMotionListener(DragSourceMotionListener dsml) {
        if (dsml != null) {
            synchronized (this) {
                motionListener = DnDEventMulticaster.remove(motionListener,
                        dsml);
            }
        }
    }
    ...
    /**
     * Gets all of the <code>DragSourceMotionListener</code>s registered with
     * this <code>DragSource</code>.
     *
     * @return all of this <code>DragSource</code>'s
    ...
    /**
     * Gets all the objects currently registered as <code><em>Foo</em>
     * Listener</code>s upon this <code>DragSource</code>. <code><em>Foo</em>
     ...
     *         Listener</code>s on this <code>DragSource</code>, or an empty
     ...
     * <code>Serializable</code> listeners registered with this object.
     * Listeners are written in a <code>null</code>-terminated sequence of 0 or
     * more pairs. The pair consists of a <code>String</code> and an
     ...
     *             <code>String</code> indicates the type of the
     *             <code>Object</code> and is one of the following:
     *             <ul>
     *             <li><code>dragSourceListenerK</code> indicating a
     *             <code>DragSourceListener</code> object;
     ...
     * deserialized by using the next object in the stream. If the resulting
     * <code>FlavorMap</code> is <code>null</code>, this object's
     * <code>FlavorMap</code> is set to the default FlavorMap for this thread's
     * <code>ClassLoader</code>. Next, this object's listeners are deserialized
     * by reading a <code>null</code>-terminated sequence of 0 or more key/value
    ...
    private void readObject(ObjectInputStream s) throws ClassNotFoundException,
        ...
        while (null != (keyOrNull = s.readObject())) {
            ...
            if (dragSourceListenerK == key) {
                ...
                addDragSourceMotionListener((DragSourceMotionListener) (s
                        .readObject()));
            } else {
     ...
     * <p>
     * If the system property <code>awt.dnd.drag.threshold</code> is set to a
    ...
    public static int getDragThreshold() {
        int ts = AccessController.doPrivileged(new GetIntegerAction(
                "awt.dnd.drag.threshold", 0)).intValue();
        if (ts > 0) {
            return ts;
        } else {
    ...
    private transient FlavorMap flavorMap = SystemFlavorMap
            .getDefaultFlavorMap();
