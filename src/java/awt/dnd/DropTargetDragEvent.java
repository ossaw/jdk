...
public class DropTargetDragEvent extends DropTargetEvent {
	 ...
	 * coordinates, the user drop action, and the source drop actions.
	 * <P>
	 * 
	 * @param dtc
	 *            The DropTargetContext for this operation
	 * @param cursorLocn
	 *            The location of the "Drag" Cursor's hotspot in Component
	 *            coordinates
	 * @param dropAction
	 ...
	 * <code>Cursor</code>'s current location within the <code>Component'</code>
	 * s coordinates.
	 * <P>
	 * 
	 * @return the current cursor location in <code>Component</code>'s coords.
	 */
	...
	/**
	 * This method returns the current <code>DataFlavor</code>s as a
	 * <code>java.util.List</code>
	 * <P>
	 * 
	 * @return a <code>java.util.List</code> of the Current
	 ...
	 * <code>DataFlavor</code> is supported.
	 * <P>
	 * 
	 * @param df
	 ...
	 *             if the data associated with the drag operation is not
	 *             available
	 *
	 * @since 1.5
	 */
	 ...
	 * Accepts the drag.
	 *
	 * This method should be called from a <code>DropTargetListeners</code>
	 * <code>dragEnter</code>, <code>dragOver</code>, and
	 * <code>dropActionChanged</code> methods if the implementation wishes to
	 * accept an operation from the srcActions other than the one selected by
	 ...
	 * <code>dropAction</code> or the available <code>DataFlavor</code> types.
	 */
