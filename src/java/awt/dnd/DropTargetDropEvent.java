...
/**
 * The <code>DropTargetDropEvent</code> is delivered via the
...
public class DropTargetDropEvent extends DropTargetEvent {
	...
	/**
	 * Construct a <code>DropTargetDropEvent</code> given the
	 * <code>DropTargetContext</code> for this operation, the location of the
	 * drag <code>Cursor</code>'s hotspot in the <code>Component</code>'s
	 * coordinates, the currently selected user drop action, and the current set
	 * of actions supported by the source. By default, this constructor assumes
	 * that the target is not in the same virtual machine as the source; that
	 * is, {@link #isLocalTransfer()} will return <code>false</code>.
	 * <P>
	 * 
	 * @param dtc
	 *            The <code>DropTargetContext</code> for this operation
	 * @param cursorLocn
	 *            The location of the "Drag" Cursor's hotspot in
	 ...
	 * <code>DropTargetContext</code> for this operation, the location of the
	 * drag <code>Cursor</code>'s hotspot in the <code>Component</code>'s
	 * coordinates, the currently selected user drop action, the current set of
	 * actions supported by the source, and a <code>boolean</code> indicating if
	 ...
	 * @param cursorLocn
	 *            The location of the "Drag" Cursor's hotspot in Component's
	 *            coordinates
	 * @param dropAction
	 *            the user drop action.
	 * @param srcActions
	...
	/**
	 * This method returns a <code>Point</code> indicating the
	 * <code>Cursor</code>'s current location in the <code>Component</code>'s
	 * coordinates.
	 * <P>
	 * 
	...
	/**
	 * This method returns the currently available <code>DataFlavor</code>s as a
	...
	/**
	 * This method returns a <code>boolean</code> indicating if the specified
	 * <code>DataFlavor</code> is available from the source.
	 * <P>
	 * 
	 * @param df
	...
	/**
	 * This method returns the <code>Transferable</code> object associated with
	 * the drop.
	 * <P>
	 * 
	...
	/**
	 * This method notifies the <code>DragSource</code> that the drop
	 * transfer(s) are completed.
	 * <P>
	 * 
	 * @param success
	 *            a <code>boolean</code> indicating that the drop transfer(s)
	 *            are completed.
	 */
	...
	/**
	 * This method returns an <code>int</code> indicating if the source is in
	 * the same JVM as the target.
	 * <P>
	 * 
