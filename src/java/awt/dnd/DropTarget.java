...
public class DropTarget implements DropTargetListener, Serializable {
    ...
    /**
     * Creates a new DropTarget given the <code>Component</code> to associate
     * itself with, an <code>int</code> representing the default acceptable
     * action(s) to support, a <code>DropTargetListener</code> to handle event
     * processing, a <code>boolean</code> indicating if the
     * <code>DropTarget</code> is currently accepting drops, and a
     * <code>FlavorMap</code> to use (or null for the default
     * <CODE>FlavorMap</CODE>).
     * <P>
     * The Component will receive drops only if it is enabled.
     * 
     * @param c
     *            The <code>Component</code> with which this
     *            <code>DropTarget</code> is associated
     * @param ops
     *            The default acceptable actions for this
     *            <code>DropTarget</code>
     * @param dtl
     *            The <code>DropTargetListener</code> for this
     *            <code>DropTarget</code>
     * @param act
     *            Is the <code>DropTarget</code> accepting drops.
     * @param fm
     *            The <code>FlavorMap</code> to use, or null for the default
     *            <CODE>FlavorMap</CODE>
    ...
    /**
     * Creates a <code>DropTarget</code> given the <code>Component</code> to
     * associate itself with, an <code>int</code> representing the default
     * acceptable action(s) to support, a <code>DropTargetListener</code> to
     * handle event processing, and a <code>boolean</code> indicating if the
     * <code>DropTarget</code> is currently accepting drops.
     * <P>
     * The Component will receive drops only if it is enabled.
     * 
     * @param c
    ...
    /**
     * Creates a <code>DropTarget</code> given the <code>Component</code> to
     * associate itself with, and the <code>DropTargetListener</code> to handle
     * event processing.
     * <P>
     * The Component will receive drops only if it is enabled.
     * 
     ...
     * Creates a <code>DropTarget</code> given the <code>Component</code> to
     * associate itself with, an <code>int</code> representing the default
     * acceptable action(s) to support, and a <code>DropTargetListener</code> to
     ...
     * <code> component.setDropTarget(droptarget); </code> or
     * <code> droptarget.setComponent(component); </code>
     * <P>
     * The Component will receive drops only if it is enabled.
     * 
     * @param c
     *          The new <code>Component</code> this <code>DropTarget</code> is
    ...
    /**
     * Gets the <code>Component</code> associated with this
     * <code>DropTarget</code>.
     * <P>
     * 
    ...
    public void setDefaultActions(int ops) {
        getDropTargetContext().setTargetActions(ops
    ...
    /**
     * Gets an <code>int</code> representing the current action(s) supported by
    ...
    /**
     * Sets the DropTarget active if <code>true</code>, inactive if
     * <code>false</code>.
     * <P>
     * 
     * @param isActive
     *                 sets the <code>DropTarget</code> (in)active.
     */
    ...
    /**
     * Reports whether or not this <code>DropTarget</code> is currently active
     ...
     * 
     * @param dtl
     *            The new <code>DropTargetListener</code>
     *            <P>
     * @throws TooManyListenersException
     *                                   if a <code>DropTargetListener</code> is
    ...
    public synchronized void addDropTargetListener(DropTargetListener dtl)
        ...
        if (equals(dtl))
            throw new IllegalArgumentException(
                    "DropTarget may not be its own Listener");
     ...
     * <code>DropTargetListener</code> and passes it the specified
     * <code>DropTargetDragEvent</code>. Has no effect if this
     * <code>DropTarget</code> is not active.
     *
     * @param dtde
     ...
     *                              and
     *                              <code>dtde</code> is <code>null</code>
     *
     * @see #isActive
     */
    public synchronized void dragEnter(DropTargetDragEvent dtde) {
        ...
        if (dtListener != null) {
            ...
            dtde.getDropTargetContext().setTargetActions(
     ...
     * <code>DropTargetListener</code> and passes it the specified
     * <code>DropTargetEvent</code>. Has no effect if this
     * <code>DropTarget</code> is not active.
     * <p>
    ...
    /**
     * Calls <code>drop</code> on the registered <code>DropTargetListener</code>
     * and passes it the specified <code>DropTargetDropEvent</code> if this
     * <code>DropTarget</code> is active.
     *
     * @param dtde
     *             the <code>DropTargetDropEvent</code>
     *
     * @throws NullPointerException
     *                              if <code>dtde</code> is null and at least
     *                              one of the
     *                              following is true: this
     *                              <code>DropTarget</code> is not
     *                              active, or there is no a
    ...
    /**
     * Gets the <code>FlavorMap</code> associated with this
     * <code>DropTarget</code>. If no <code>FlavorMap</code> has been set for
     * this <code>DropTarget</code>, it is associated with the default
     * <code>FlavorMap</code>.
     * <P>
     * 
    ...
    /**
     * Sets the <code>FlavorMap</code> associated with this
     * <code>DropTarget</code>.
     * <P>
     * 
     * @param fm
     *           the new <code>FlavorMap</code>, or null to associate the
    ...
    public void addNotify(ComponentPeer peer) {
        ...
        for (Component c = component; c != null
                && peer instanceof LightweightPeer; c = c.getParent()) {
            peer = c.getPeer();
        }
    ...
    /**
     * Gets the <code>DropTargetContext</code> associated with this
     * <code>DropTarget</code>.
     * <P>
     * 
     * @return the <code>DropTargetContext</code> associated with this
     *         <code>DropTarget</code>.
     */
    ...
    private void readObject(ObjectInputStream s) throws ClassNotFoundException,
        ...
        try {
            dropTargetContext = (DropTargetContext) f.get("dropTargetContext",
                    null);
    ...
    protected static class DropTargetAutoScroller implements ActionListener {
        ...
        protected synchronized void updateLocation(Point newLocn) {
            ...
            if (Math.abs(locn.x - prev.x) > hysteresis || Math.abs(locn.y
                    - prev.y) > hysteresis) {
                if (timer.isRunning())
                    timer.stop();
            } else {
    ...
    /**
     * <code>true</code> if the DropTarget is accepting Drag &amp; Drop
     * operations.
     *
     * @serial
     */
