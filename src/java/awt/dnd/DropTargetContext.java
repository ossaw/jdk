...
public class DropTargetContext implements Serializable {
	...
	/**
	 * Construct a <code>DropTargetContext</code> given a specified
	 ...
	 * <P>
	 * 
	 * @return the <code>DropTarget</code> associated with this
	 *         <code>DropTargetContext</code>
	 */
	...
	/**
	 * This method returns an <code>int</code> representing the current actions
	 * this <code>DropTarget</code> will accept.
	 * <P>
	 * 
	...
	/**
	 * get the available DataFlavors of the <code>Transferable</code> operand of
	 * this operation.
	 * <P>
	 * 
	 * @return a <code>DataFlavor[]</code> containing the supported
	 *         <code>DataFlavor</code>s of the <code>Transferable</code>
	 *         operand.
	 */
	 ...
	 * <code>Transferable</code> operand as a <code>java.util.List</code>.
	 * <P>
	 * 
	 * @return the currently available DataFlavors as a
	...
	/**
	 * This method returns a <code>boolean</code> indicating if the given
	 * <code>DataFlavor</code> is supported by this
	 * <code>DropTargetContext</code>.
	 * <P>
	 * 
	 * @param df
	 ...
	 * <code>Transferable</code> object which represents data transfer for a
	...
	protected class TransferableProxy implements Transferable {
		...
		/**
		 * Constructs a <code>TransferableProxy</code> given a specified
		 * <code>Transferable</code> object representing data transfer for a
		 * particular drag-n-drop operation and a <code>boolean</code> which
		 ...
		 * @param local
		 *            <code>true</code>, if <code>t</code> represents the result
		 ...
		 * <code>Transferable</code> object represents the result of local
		 * drag-n-drop operation (within the same JVM).
		 */
