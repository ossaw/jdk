...
public class DragSourceDragEvent extends DragSourceEvent {
	...
	/**
	 * Constructs a <code>DragSourceDragEvent</code>. This class is typically
	 * instantiated by the <code>DragSourceContextPeer</code> rather than
	 * directly by client code. The coordinates for this
	 * <code>DragSourceDragEvent</code> are not specified, so
	 * <code>getLocation</code> will return <code>null</code> for this event.
	 * <p>
	 * The arguments <code>dropAction</code> and <code>action</code> should be
	 * one of <code>DnDConstants</code> that represents a single action. The
	 * argument <code>modifiers</code> should be either a bitwise mask of old
	 * <code>java.awt.event.InputEvent.*_MASK</code> constants or a bitwise mask
	 * of extended <code>java.awt.event.InputEvent.*_DOWN_MASK</code> constants.
	 ...
	 *
	 * @param dsc
	 *            the <code>DragSourceContext</code> associated with this event.
	 * @param dropAction
	 *            the user drop action.
	 * @param action
	 *            the target drop action.
	 ...
	 * the input device modifiers associated with the user's gesture. Typically
	 * these would be mouse buttons or keyboard modifiers.
	 * <P>
	 * If the <code>modifiers</code> passed to the constructor are invalid, this
	...
	/**
	 * This method returns an <code>int</code> representing the current state of
	 * the input device extended modifiers associated with the user's gesture.
