 ...
 * test automation, self-running demos, and other applications where control of
 * the mouse and keyboard is needed. The primary purpose of Robot is to
 ...
 * AWT event queue or AWT components in that the events are generated in the
 * platform's native input queue. For example, <code>Robot.mouseMove</code> will
 ...
 * input control, an <code>AWTException</code> will be thrown when trying to
 * construct Robot objects. For example, X-Window systems will throw the
...
public class Robot {
	 ...
	 * as being in the same coordinate system as the specified screen. Note that
	 * depending on the platform configuration, multiple screens may either:
	 * <ul>
	 * <li>share the same coordinate system to form a combined virtual screen
	 * </li>
	 ...
	 * <code>KeyEvent.VK_SHIFT</code> could mean either the left or right shift
	...
	public synchronized BufferedImage createScreenCapture(Rectangle screenRect) {
		...
		if (screenCapCM == null) {
			/*
			 * Fix for 4285201 Create a DirectColorModel equivalent to the
			 * default RGB ColorModel, except with no Alpha component.
			 */

			screenCapCM = new DirectColorModel(24, /* red mask */ 0x00FF0000,
					/* green mask */ 0x0000FF00, /* blue mask */ 0x000000FF);
		}
	...
	/**
	 * Sets the number of milliseconds this Robot sleeps after generating an
	 * event.
	 * 
	 * @throws IllegalArgumentException
