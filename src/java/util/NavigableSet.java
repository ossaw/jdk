 ...
 * {@code
 * descendingSet} method returns a view of the set with the senses of all
 ...
 * one exists, else returning {@code
 * null}. Methods {@code subSet}, {@code headSet}, and {@code tailSet} differ
 * from the like-named {@code
 ...
 * {@code NavigableSet} must implement the {@code
 ...
 * insertion of {@code null} elements. (Note that sorted sets of
 * {@link Comparable} elements intrinsically do not permit {@code null}.)
 * <p>
 * Methods {@link #subSet(Object, Object) subSet(E, E)}, {@link #headSet(Object)
 * headSet(E)}, and {@link #tailSet(Object) tailSet(E)} are specified to return
 * {@code SortedSet} to allow existing implementations of {@code SortedSet} to
 * be compatibly retrofitted to implement {@code NavigableSet}, but extensions
 * and implementations of this interface are encouraged to override these
 * methods to return {@code NavigableSet}.
 * <p>
...
public interface NavigableSet<E> extends SortedSet<E> {
     ...
     * @throws ClassCastException
     *         if {@code fromElement} and
     *         {@code toElement} cannot be
     ...
     *         exception if {@code fromElement} or
     *         {@code toElement} cannot
     *         be compared to elements currently in the
     *         set.
     * @throws NullPointerException
     ...
     *         if {@code fromElement} is greater than
     *         {@code toElement}; or
     ...
     * @throws ClassCastException
     *         if {@code toElement} is not compatible
     *         with this set's
     *         comparator (or, if the set has no
     *         comparator, if
     *         {@code toElement} does not implement
     *         {@link Comparable}).
     *         Implementations may, but are not
     *         required to, throw this
     *         exception if {@code toElement} cannot be
     ...
     *         if this set itself has a restricted
     *         range, and
     *         {@code toElement} lies outside the
     *         bounds of the range
     */
     ...
     * @throws ClassCastException
     *         if {@code fromElement} is not compatible
     *         with this set's
     *         comparator (or, if the set has no
     *         comparator, if
     *         {@code fromElement} does not implement
     *         {@link Comparable}).
     *         Implementations may, but are not
     *         required to, throw this
     *         exception if {@code fromElement} cannot
     *         be compared to
     ...
     *         if this set itself has a restricted
     *         range, and
     *         {@code fromElement} lies outside the
     *         bounds of the range
     */
