...
public interface Collection<E> extends Iterable<E> {
	 ...
	 *             if the <tt>add</tt> operation is not supported by this
	 *             collection
	 * @throws ClassCastException
	 ...
	 *
	 * @implSpec The default implementation traverses all elements of the
	 *           collection using its {@link #iterator}. Each matching element
	 *           is removed using {@link Iterator#remove()}. If the collection's
	 ...
	 *             element cannot be removed or if, in general, removal is not
	 *             supported.
	 * @since 1.8
	 */
	 ...
	 *
	 * @throws UnsupportedOperationException
	 *             if the <tt>clear</tt> operation is not supported by this
	 *             collection
	 */
	void clear();
	 ...
	 * laziness behavior for the {@link #stream()} and {@link #parallelStream()}
