...
public interface Map<K, V> {
	 ...
	 *             if the key is of an inappropriate type for this map (<a href=
	...
	interface Entry<K, V> {
		...
		public static <K extends Comparable<? super K>, V> Comparator<Map.Entry<K, V>> comparingByKey() {
			return (Comparator<Map.Entry<K, V>> & Serializable) (c1, c2) -> c1.getKey()
					.compareTo(c2.getKey());
		}
		...
		public static <K, V extends Comparable<? super V>> Comparator<Map.Entry<K, V>> comparingByValue() {
			return (Comparator<Map.Entry<K, V>> & Serializable) (c1, c2) -> c1.getValue()
		...
		public static <K, V> Comparator<Map.Entry<K, V>> comparingByKey(Comparator<? super K> cmp) {
			...
			return (Comparator<Map.Entry<K, V>> & Serializable) (c1, c2) -> cmp.compare(c1.getKey(),
					c2.getKey());
		}
	 ...
	 * @throws UnsupportedOperationException
	 *             if the {@code set} operation is not supported by this map's
	 *             entry set iterator.
	 * @throws ClassCastException
	 *             if the class of a replacement value prevents it from being
	 *             stored in this map
	 * @throws NullPointerException
	 *             if the specified function is null, or the specified
	 *             replacement value is null, and this map does not permit null
	 *             values
	 * @throws ClassCastException
	 *             if a replacement value is of an inappropriate type for this
	 *             map (<a href=
	 *             "{@docRoot}/java/util/Collection.html#optional-restrictions"
	 *             >optional</a>)
	 * @throws NullPointerException
	 *             if function or a replacement value is null, and this map does
	 *             not permit null keys or values (<a href=
	 *             "{@docRoot}/java/util/Collection.html#optional-restrictions"
	 *             >optional</a>)
	 * @throws IllegalArgumentException
	 *             if some property of a replacement value prevents it from
	 ...
	 * @throws IllegalArgumentException
	 *             if some property of the specified key or value prevents it
	 *             from being stored in this map (<a href=
	 *             "{@docRoot}/java/util/Collection.html#optional-restrictions"
	 *             >optional</a>)
	 * @since 1.8
	 */
	 ...
	 *             being stored in this map
	 * @throws NullPointerException
	 *             if a specified key or newValue is null, and this map does not
	 *             permit null keys or values
	 * @throws NullPointerException
	 *             if oldValue is null and this map does not permit null values
	 *             (<a href=
	 *             "{@docRoot}/java/util/Collection.html#optional-restrictions"
	 *             >optional</a>)
	 * @throws IllegalArgumentException
	 ...
	 * @throws NullPointerException
	 *             if the specified key is null and this map does not support
	 ...
	 * @throws NullPointerException
	 *             if the specified key is null and this map does not support
	 *             null keys, or the remappingFunction is null
	 * @throws UnsupportedOperationException
	 *             if the {@code put} operation is not supported by this map (
	 *             <a href=
	 *             "{@docRoot}/java/util/Collection.html#optional-restrictions"
	 ...
	 * @throws NullPointerException
	 *             if the specified key is null and this map does not support
	 *             null keys or the value or remappingFunction is null
	 * @since 1.8
	 */
