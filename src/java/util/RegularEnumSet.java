...
class RegularEnumSet<E extends Enum<E>> extends EnumSet<E> {
	...
	/**
	 * Bit vector representation of this set. The 2^k bit indicates the presence
	 * of universe[k] in this set.
	 */
	 ...
	 * "snapshot" iterator that will never throw
	 * {@link ConcurrentModificationException}; the elements are traversed as
	 * they existed when this call was invoked.
	 *
