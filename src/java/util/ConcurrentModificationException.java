 ...
 * <i>fail-fast</i> iterators, as they fail quickly and cleanly, rather that
 ...
 * concurrently modified by a <i>different</i> thread. If a single thread issues
 * a sequence of method invocations that violates the contract of an object, the
 ...
 * correctness: <i>{@code ConcurrentModificationException} should be used only
 * to detect bugs.</i>
 *
 * @author Josh Bloch
 * @see Collection
