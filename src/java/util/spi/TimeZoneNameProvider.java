...
/**
 * An abstract class for service providers that provide localized time zone
 * names for the {@link java.util.TimeZone TimeZone} class. The localized time
 * zone names available from the implementations of this class are also the
 * source for the {@link java.text.DateFormatSymbols#getZoneStrings()
...
public abstract class TimeZoneNameProvider extends LocaleServiceProvider {
	 ...
	 * presentation to the user in the specified locale. The given time zone ID
	 * is "GMT" or one of the names defined using "Zone" entries in the
	 * "tz database", a public domain time zone database at
	 ...
	 * appropriate for daylight saving time even if the specified time zone has
