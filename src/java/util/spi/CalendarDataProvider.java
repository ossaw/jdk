...
public abstract class CalendarDataProvider extends LocaleServiceProvider {
	 ...
	 * This information is required by {@link Calendar} to determine the first
	 * week of a year. Refer to the description of
	 * <a href="../Calendar.html#first_week"> how {@code Calendar} determines
	 * the first week</a>.
	 *
	 * @param locale
	 *            the desired locale
