...
/**
 * An abstract class for service providers that provide localized currency
 * symbols and display names for the {@link java.util.Currency Currency} class.
 * Note that currency symbols are considered names when determining behaviors
 * described in the {@link java.util.spi.LocaleServiceProvider
...
public abstract class CurrencyNameProvider extends LocaleServiceProvider {
	 ...
	 * example, for "USD" (US Dollar), the symbol is "$" if the specified locale
	 * is the US, while for other locales it may be "US$". If no symbol can be
