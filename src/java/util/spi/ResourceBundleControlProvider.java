 ...
 * {@link java.util.ResourceBundle.Control}. The
 * <a href="../ResourceBundle.html#default_behavior">default resource bundle
 * loading behavior</a> of the {@code ResourceBundle.getBundle} factory methods
 ...
 * Mechanism</a> as installed extensions. Refer to
 * {@link java.util.ServiceLoader} for the extension packaging. Any installed
 * {@code
 * ResourceBundleControlProvider} implementations are loaded using
 * {@link java.util.ServiceLoader} at the {@code ResourceBundle} class loading
 * time.
 *
 * @author Masayoshi Okutsu
 * @since 1.8
 * @see ResourceBundle#getBundle(String, java.util.Locale, ClassLoader,
 *      ResourceBundle.Control) ResourceBundle.getBundle
