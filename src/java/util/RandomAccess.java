...
/**
 * Marker interface used by <tt>List</tt> implementations to indicate that they
 * support fast (generally constant time) random access. The primary purpose of
 ...
 * access lists (such as <tt>LinkedList</tt>). Generic list algorithms are
 * encouraged to check whether the given list is an <tt>instanceof</tt> this
 ...
 * times in practice. Such a <tt>List</tt> implementation should generally
 * implement this interface. As a rule of thumb, a <tt>List</tt> implementation
 * should implement this interface if, for typical instances of the class, this
 * loop:
 * 
 * <pre>
