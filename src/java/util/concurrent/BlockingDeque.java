 ...
 *
 * <p>
 * {@code BlockingDeque} methods come in four forms, with different ways of
 ...
 *
 * <table BORDER CELLPADDING=3 CELLSPACING=1> <caption>Summary of BlockingDeque
 * methods</caption>
 * <tr>
 ...
 * <td>{@link #offerFirst(Object, long, TimeUnit) offerFirst(e, time, unit)}
 * </td>
 * </tr>
 * <tr>
 * <td><b>Remove</b></td>
 ...
 *
 * <p>
 * Like any {@link BlockingQueue}, a {@code BlockingDeque} is thread safe, does
 ...
 * {@code BlockingQueue}. The methods inherited from the {@code BlockingQueue}
 * interface are precisely equivalent to {@code BlockingDeque} methods as
 * indicated in the following table:
 *
 * <table BORDER CELLPADDING=3 CELLSPACING=1> <caption>Comparison of
 * BlockingQueue and BlockingDeque methods</caption>
 * <tr>
 ...
 * a thread prior to placing an object into a {@code BlockingDeque}
...
public interface BlockingDeque<E> extends BlockingQueue<E>, Deque<E> {
	 ...
	 * is generally preferable to the {@link #addFirst(Object) addFirst} method,
	 ...
	 * generally preferable to the {@link #addLast(Object) addLast} method,
	 * which can fail to insert an element only by throwing an exception.
	 *
	 * @param e
	 *          the element to add
