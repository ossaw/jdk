 ...
 * consumption of the results of completed tasks. Producers {@code submit} tasks
 * for execution. Consumers {@code take} completed tasks and process their
 * results in the order they complete. A {@code CompletionService} can for
 * example be used to manage asynchronous I/O, in which tasks that perform reads
...
public interface CompletionService<V> {
	 ...
	 * representing the pending results of the task. Upon completion, this task
	...
	/**
	 * Retrieves and removes the Future representing the next completed task,
	 * waiting if necessary up to the specified wait time if none are yet
	 * present.
	 *
	 * @param timeout
