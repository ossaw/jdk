...
/**
 * A {@link ScheduledFuture} that is {@link Runnable}. Successful execution of
 * the {@code run} method causes completion of the {@code Future} and allows
...
public interface RunnableScheduledFuture<V> extends RunnableFuture<V>,
	 ...
	 * according to some schedule. A non-periodic task can be run only once.
	 *
