 ...
 * a thread prior to placing an object into a {@code ConcurrentMap} as a key or
 * value
 * <a href="package-summary.html#MemoryVisibility"><i>happen-before</i></a>
 * actions subsequent to the access or removal of that object from the
 * {@code ConcurrentMap} in another thread.
 * <p>
...
public interface ConcurrentMap<K, V> extends Map<K, V> {
     ...
     *           contain null values and {@code get()} returning null
     *           unambiguously means the key is absent. Implementations which
     ...
     *           {@code getValue()} indicates that the entry has been removed
     *           and cannot be processed. Operation continues for subsequent
     *           entries.
     * @throws NullPointerException
     *         {@inheritDoc}
     * @since 1.8
     ...
     *           threads attempt updates including potentially calling the
     *           function repeatedly for a given key.
     *           <p>
     ...
     *           The default implementation may retry these steps when multiple
     *           threads attempt updates including potentially calling the
     *           mapping function multiple times.
     *           <p>
     *           This implementation assumes that the ConcurrentMap cannot
     *           contain null values and {@code get()} returning null
     *           unambiguously means the key is absent. Implementations which
    ...
    default V computeIfAbsent(K key, Function<? super K, ? extends V> mappingFunction) {
        ...
        V v, newValue;
        return ((v = get(key)) == null && (newValue = mappingFunction.apply(key)) != null && (v = putIfAbsent(
                key, newValue)) == null) ? newValue : v;
    }
     ...
     *           The default implementation may retry these steps when multiple
     *           threads attempt updates including potentially calling the
     *           remapping function multiple times.
     *           <p>
     *           This implementation assumes that the ConcurrentMap cannot
     *           contain null values and {@code get()} returning null
     *           unambiguously means the key is absent. Implementations which
