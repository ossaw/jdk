...
abstract class Striped64 extends Number {
	 ...
	 * to values that typically do not often conflict with others. Contention
	 * and/or table collisions are indicated by failed CASes when performing an
	 * update operation. Upon a collision, if the table size is less than the
	 * capacity, it is doubled in size unless some other thread holds the lock.
	 ...
	 * thread. Duplicated from ThreadLocalRandom because of packaging
	 * restrictions.
	 */
