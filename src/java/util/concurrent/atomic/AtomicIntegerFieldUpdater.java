 ...
 * {@code volatile int} fields of designated classes. This class is designed for
 * use in atomic data structures in which several fields of the same node are
...
public abstract class AtomicIntegerFieldUpdater<T> {
     ...
     * Class argument is needed to check that reflective types and generic types
     * match.
     *
     * @param tclass
     ...
     *                                  if the field is not a volatile integer
     *                                  type
     ...
     */
    private static final class AtomicIntegerFieldUpdaterImpl<T> extends
