...
/**
 * A {@code long} array in which elements may be updated atomically. See the
...
public class AtomicLongArray implements java.io.Serializable {
	...
	/**
	 * Creates a new AtomicLongArray of the given length, with all elements
	 * initially zero.
	 *
	 * @param length
	...
	/**
	 * Atomically updates the element at index {@code i} with the results of
	 * applying the given function, returning the previous value. The function
	...
	/**
	 * Atomically updates the element at index {@code i} with the results of
	 * applying the given function, returning the updated value. The function
	 * should be side-effect-free, since it may be re-applied when attempted
	 * updates fail due to contention among threads.
	 *
	 * @param i
	...
	/**
	 * Atomically updates the element at index {@code i} with the results of
	 * applying the given function to the current and given values, returning
	 * the previous value. The function should be side-effect-free, since it may
	 * be re-applied when attempted updates fail due to contention among
