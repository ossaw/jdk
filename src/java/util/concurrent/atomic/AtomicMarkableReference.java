...
/**
 * An {@code AtomicMarkableReference} maintains an object reference along with a
...
public class AtomicMarkableReference<V> {
    ...
    /**
     * Creates a new {@code AtomicMarkableReference} with the given initial
     * values.
     *
     * @param initialRef
     ...
     */
    public boolean weakCompareAndSet(V expectedReference, V newReference, boolean expectedMark,
            boolean newMark) {
    ...
    public boolean compareAndSet(V expectedReference, V newReference, boolean expectedMark, boolean newMark) {
        ...
        return expectedReference == current.reference && expectedMark == current.mark
                && ((newReference == current.reference && newMark == current.mark) || casPair(current, Pair
                        .of(newReference, newMark)));
    }
    ...
    public boolean attemptMark(V expectedReference, boolean newMark) {
        Pair<V> current = pair;
        return expectedReference == current.reference && (newMark == current.mark || casPair(current, Pair.of(
