 ...
 * {@code volatile long} fields of designated classes. This class is designed
 * for use in atomic data structures in which several fields of the same node
 * are independently subject to atomic updates.
 * <p>
...
public abstract class AtomicLongFieldUpdater<T> {
    ...
    private static boolean isSamePackage(Class<?> class1, Class<?> class2) {
        return class1.getClassLoader() == class2.getClassLoader() && Objects.equals(getPackageName(class1),
