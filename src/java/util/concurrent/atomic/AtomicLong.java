 ...
 * the properties of atomic variables. An {@code AtomicLong} is used in
 * applications such as atomically incremented sequence numbers, and cannot be
 * used as a replacement for a {@link java.lang.Long}. However, this class does
 * extend {@code Number} to allow uniform access by tools and utilities that
...
public class AtomicLong extends Number implements java.io.Serializable {
	...
	/**
	 * Returns the value of this {@code AtomicLong} as an {@code int} after a
	...
	/**
	 * Returns the value of this {@code AtomicLong} as a {@code float} after a
	...
	/**
	 * Returns the value of this {@code AtomicLong} as a {@code double} after a
	 * widening primitive conversion.
	 * 
	 * @jls 5.1.2 Widening Primitive Conversions
	 */
