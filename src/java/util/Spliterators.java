...
public final class Spliterators {
	 ...
	 *            Additional spliterator characteristics of this spliterator's
	 *            source or elements beyond {@code SIZED} and {@code SUBSIZED}
	 ...
	 *             if {@code fromIndex} is negative, {@code toIndex} is less
	 *             than {@code fromIndex}, or {@code toIndex} is greater than
	 *             the array size
	 ...
	 * @throws ArrayIndexOutOfBoundsException
	 *             if the start index is greater than the end index, if the
	 *             start index is negative, or the end index is greater than the
	 *             array length
	 */
	 ...
	 *            Characteristics of this spliterator's source or elements. The
	 *            characteristics {@code SIZED} and {@code SUBSIZED} are
	 *            additionally reported unless {@code CONCURRENT} is supplied.
	 ...
	 *            The iterator for the source
	 * @param characteristics
	 *            Characteristics of this spliterator's source or elements (
	 *            {@code SIZED} and {@code SUBSIZED}, if supplied, are ignored
	...
	private static abstract class EmptySpliterator<T, S extends Spliterator<T>, C> {
		...
		private static final class OfRef<T> extends
				EmptySpliterator<T, Spliterator<T>, Consumer<? super T>> implements Spliterator<T> {
			OfRef() {
			}
		}
	...
	static final class ArraySpliterator<T> implements Spliterator<T> {
		 ...
		 *            the array, assumed to be unmodified during use
		 * @param additionalCharacteristics
		 *            Additional spliterator characteristics of this
		 *            spliterator's source or elements beyond {@code SIZED} and
	...
	public static abstract class AbstractSpliterator<T> implements Spliterator<T> {
		 ...
		 *            {@code Long.MAX_VALUE}.
		 * @param additionalCharacteristics
		 *            properties of this spliterator's source or elements. If
		 *            {@code SIZED} is reported then this spliterator will
	...
	static final class IntIteratorSpliterator implements Spliterator.OfInt {
		 ...
		 *            properties of this spliterator's source or elements.
		 */
		public IntIteratorSpliterator(PrimitiveIterator.OfInt iterator, long size,
				int characteristics) {
			this.it = iterator;
			this.est = size;
			this.characteristics = (characteristics & Spliterator.CONCURRENT) == 0
	...
	static final class LongIteratorSpliterator implements Spliterator.OfLong {
		 ...
		 *            properties of this spliterator's source or elements.
		 */
		public LongIteratorSpliterator(PrimitiveIterator.OfLong iterator, long size,
				int characteristics) {
			this.it = iterator;
			this.est = size;
			this.characteristics = (characteristics & Spliterator.CONCURRENT) == 0
	...
	static final class DoubleIteratorSpliterator implements Spliterator.OfDouble {
		 ...
		 *            properties of this spliterator's source or elements.
		 */
		public DoubleIteratorSpliterator(PrimitiveIterator.OfDouble iterator, long size,
				int characteristics) {
			this.it = iterator;
			this.est = size;
			this.characteristics = (characteristics & Spliterator.CONCURRENT) == 0
