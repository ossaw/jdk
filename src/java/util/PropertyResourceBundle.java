 ...
 * containing the resource data. <code>ResourceBundle.getBundle</code> will
 * automatically look for the appropriate properties file and create a
 ...
 * content of the file "MyResources_de.properties" (a related
 * <a href="ListResourceBundle.html#sample">example</a> shows how you can add
 * bundles to this family that are implemented as subclasses of
 * <code>ListResourceBundle</code>). The keys in this example are of the form
 * "s1" etc. The actual keys are entirely up to your choice, so long as they are
 * the same as the keys you use in your program to retrieve the objects from the
 * bundle. Keys are case-sensitive. <blockquote>
 * 
 * <pre>
 ...
 * represented in ISO-8859-1 encoding must be represented by Unicode Escapes as
 * defined in section 3.3 of <cite>The Java&trade; Language Specification</cite>
...
public class PropertyResourceBundle extends ResourceBundle {
    ...
    /**
     * Creates a property resource bundle from a {@link java.io.Reader Reader}.
     * Unlike the constructor
     * {@link #PropertyResourceBundle(java.io.InputStream)
