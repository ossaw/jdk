 ...
 * variables typed as functional interfaces, it is common to refer directly to
 ...
 * {@code R}), {@link java.util.function.Consumer} (unary function from
 ...
 * as in {@link java.util.function.ToIntFunction}. Otherwise, type arguments are
 * specialized left-to-right, as in {@link java.util.function.DoubleConsumer} or
 * {@link java.util.function.ObjIntConsumer}. (The type prefix {@code Obj} is
 * used to indicate that we don't want to specialize this parameter, but want to
