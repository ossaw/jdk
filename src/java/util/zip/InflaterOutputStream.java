...
public class InflaterOutputStream extends FilterOutputStream {
	...
	/**
	 * Creates a new output stream with the specified decompressor and buffer
	 * size.
	 *
	 * @param out
	 *            output stream to write the uncompressed data to
	...
	/**
	 * Flushes this output stream, forcing any pending buffered output bytes to
	 * be written.
	 *
	 * @throws IOException
	 ...
	 *             if {@code off < 0}, or if {@code len < 0}, or if
