...
public class DeflaterOutputStream extends FilterOutputStream {
	...
	/**
	 * Creates a new output stream with the specified compressor, buffer size
	 * and flush mode.
	 * 
	 * @param out
	 *            the output stream
	 ...
	 * @param syncFlush
	 *            if {@code true} the {@link #flush()} method of this instance
	...
	/**
	 * Creates a new output stream with the specified compressor, flush mode and
	...
	/**
	 * Creates a new output stream with a default compressor, a default buffer
	 ...
	 * with the flush mode {@link Deflater#SYNC_FLUSH} to force all pending data
	 * to be flushed out to the output stream and then flushes the output
	 * stream. Otherwise this method only flushes the output stream without
