...
public class DeflaterInputStream extends FilterInputStream {
    ...
    /**
     * Creates a new input stream with the specified compressor and a default
     * buffer size.
     *
     * @param in
     *             input stream to read the uncompressed data to
    ...
    /**
     * Reads a single byte of compressed data from the input stream. This method
     * will block until some input can be read and compressed.
     *
     * @return a single byte of compressed data, or -1 if the end of the
     *         uncompressed input stream is reached
     * @throws IOException
     *                     if an I/O error occurs or if this stream is already
     *                     closed
     */
    ...
    /**
     * Reads compressed data into a byte array. This method will block until
     * some input can be read and compressed.
     *
     * @param b
     ...
     *                                   if {@code len > b.length - off}
     * @throws IOException
     *                                   if an I/O error occurs or if this input
     *                                   stream is already
     *                                   closed
     */
    ...
    /**
     * Skips over and discards data from the input stream. This method may block
     * until the specified number of bytes are read and skipped. <em>Note:</em>
     * While {@code n} is given as a {@code long}, the maximum number of bytes
     * which can be skipped is {@code Integer.MAX_VALUE}.
     *
     * @param n
     ...
     *
     * @param limit
     *              maximum bytes that can be read before invalidating the
     *              position marker
     */
