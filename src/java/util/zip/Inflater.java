 ...
 * popular ZLIB compression library. The ZLIB compression library was initially
...
public class Inflater {
    ...
    /**
     * Creates a new decompressor. If the parameter 'nowrap' is true then the
     * ZLIB header and checksum fields will not be used. This provides
     * compatibility with the compression format used by both GZIP and PKZIP.
     * <p>
     * Note: When using the 'nowrap' option it is also necessary to provide an
     * extra "dummy" byte as input. This is required by the ZLIB native library
     ...
     * should be called when the decompressor is no longer being used, but will
     * also be called automatically by the finalize() method. Once this method
     * is called, the behavior of the Inflater object is undefined.
     */
    public void end() {
        synchronized (zsRef) {
