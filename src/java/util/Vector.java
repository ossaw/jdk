...
/**
 * The {@code Vector} class implements a growable array of objects. Like an
 ...
 * accommodate adding and removing items after the {@code Vector} has been
 * created.
 *
 * <p>
 * Each vector tries to optimize storage management by maintaining a
 * {@code capacity} and a {@code capacityIncrement}. The {@code capacity} is
 * always at least as large as the vector size; it is usually larger because as
 * components are added to the vector, the vector's storage increases in chunks
 * the size of {@code capacityIncrement}. An application can increase the
 * capacity of a vector before inserting a large number of components; this
 ...
 * methods are <em>fail-fast</em></a>: if the vector is structurally modified at
 ...
 * The {@link Enumeration Enumerations} returned by the {@link #elements()
 * elements} method are <em>not</em> fail-fast.
 *
 * <p>
 ...
 * {@link List} interface, making it a member of the <a href=
 * "{@docRoot}/../technotes/guides/collections/index.html"> Java Collections
 * Framework</a>. Unlike the new collection implementations, {@code Vector} is
 * synchronized. If a thread-safe implementation is not needed, it is
 * recommended to use {@link ArrayList} in place of {@code Vector}.
 *
 * @author Lee Boynton
...
public class Vector<E> extends AbstractList<E>
	 ...
	 * at index {@code k} in this vector is copied into component {@code k} of
	 * {@code anArray}.
	 *
	 * @param anArray
	 ...
	 *         in the field {@code elementData} of this vector)
	 */
	 ...
	 *
	 * <p>
	 * This method is identical in functionality to the {@link #set(int, Object)
	 * set(int, E)} method (which is part of the {@link List} interface). Note
	 * that the {@code set} method reverses the order of the parameters, to more
	 * closely match array usage. Note also that the {@code set} method returns
	 ...
	 *
	 * <p>
	 * This method is identical in functionality to the {@link #add(int, Object)
	 * add(int, E)} method (which is part of the {@link List} interface). Note
	 * that the {@code add} method reverses the order of the parameters, to more
	 ...
	 * </pre>
	 * 
	 * Similar idioms may be constructed for indexOf and lastIndexOf, and all of
	 * the algorithms in the Collections class can be applied to a subList.
	 *
	 * <p>
