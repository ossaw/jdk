 ...
 * is greater than the maximum number of entries the <tt>Hashtable</tt> will
 ...
 * {@code Hashtable}. If a thread-safe highly-concurrent implementation is
 * desired, then it is recommended to use
 * {@link java.util.concurrent.ConcurrentHashMap} in place of {@code Hashtable}.
 *
