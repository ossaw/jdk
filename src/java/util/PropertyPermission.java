 ...
 * to signify a wildcard match. For example: "java.*" and "*" signify a wildcard
 ...
 * <DT>write
 * <DD>write permission. Allows <code>System.setProperty</code> to be called.
 * </DL>
 * <P>
 ...
 * system environment (the Java installation directory). Also, granting
 * permission to access the "user.name" and "user.home" system properties gives
 * potentially malevolent code sensitive information about the user environment
...
public final class PropertyPermission extends BasicPermission {
	...
	/**
	 * initialize a PropertyPermission object. Common to all constructors. Also
	 ...
	 * is the name of the system property, and <i>actions</i> contains a
	 * comma-separated list of the desired actions granted on the property.
	 ...
	 *             if <code>name</code> is empty or if <code>actions</code> is
	 *             invalid.
	 */
	 ...
	 * <i>obj</i> is a PropertyPermission, and has the same name and actions as
	 * this object.
	 * <P>
	 * 
	 * @param obj
	 ...
	 * <code>getName().hashCode()</code>, where <code>getName</code> is from the
	 ...
	 * present actions in the following order: read, write.
	 *
	 ...
	 * write. For example, if this PropertyPermission object allows both write
	 * and read actions, a call to <code>getActions</code> will return the
	 * string "read,write".
	 *
	 * @return the canonical string representation of the actions.
	 */
	...
	/**
	 * WriteObject is called to save the state of the PropertyPermission to a
...
final class PropertyPermissionCollection extends PermissionCollection implements Serializable {
	...
	/**
	 * Adds a permission to the PropertyPermissions. The key for the hash is the
	 * name.
	 *
	 * @param permission
	 ...
	 *                - if this PropertyPermissionCollection object has been
	 *                marked readonly
	 */
	...
	public Enumeration<Permission> elements() {
		...
		synchronized (this) {
			/**
			 * Casting to rawtype since Enumeration<PropertyPermission> cannot
			 * be directly cast to Enumeration<Permission>
			 */
	 ...
	 *                  java.util.Hashtable A table of the PropertyPermissions.
