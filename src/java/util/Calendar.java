 ...
 * for converting between a specific instant in time and a set of {@link #fields
 * calendar fields} such as <code>YEAR</code>, <code>MONTH</code>,
 * <code>DAY_OF_MONTH</code>, <code>HOUR</code>, and so on, and for manipulating
 * the calendar fields, such as getting the date of the next week. An instant in
 * time can be represented by a millisecond value that is an offset from the
 * <a name="Epoch"><em>Epoch</em></a>, January 1, 1970 00:00:00.000 GMT
 * (Gregorian).
 *
 * <p>
 ...
 * defined as <code>protected</code>.
 *
 * <p>
 * Like other locale-sensitive classes, <code>Calendar</code> provides a class
 * method, <code>getInstance</code>, for getting a generally useful object of
 * this type. <code>Calendar</code>'s <code>getInstance</code> method returns a
 * <code>Calendar</code> object whose calendar fields have been initialized with
 * the current date and time: <blockquote>
 * 
 * <pre>
 ...
 *
 * <p>
 * A <code>Calendar</code> object can produce all the calendar field values
 * needed to implement the date-time formatting for a particular language and
 * calendar style (for example, Japanese-Gregorian, Japanese-Traditional).
 * <code>Calendar</code> defines the range of values returned by certain
 * calendar fields, as well as their meaning. For example, the first month of
 * the calendar system has value <code>MONTH ==
 * JANUARY</code> for all calendars. Other values are defined by the concrete
 * subclass, such as <code>ERA</code>. See individual field documentation and
 * subclass documentation for details.
 *
 * <h3>Getting and Setting Calendar Field Values</h3>
 *
 * <p>
 * The calendar field values can be set by calling the <code>set</code> methods.
 * Any field values set in a <code>Calendar</code> will not be interpreted until
 * it needs to calculate its time value (milliseconds from the Epoch) or values
 * of the calendar fields. Calling the <code>get</code>,
 * <code>getTimeInMillis</code>, <code>getTime</code>, <code>add</code> and
 * <code>roll</code> involves such calculation.
 *
 * <h4>Leniency</h4>
 *
 * <p>
 * <code>Calendar</code> has two modes for interpreting the calendar fields,
 * <em>lenient</em> and <em>non-lenient</em>. When a <code>Calendar</code> is in
 * lenient mode, it accepts a wider range of calendar field values than it
 * produces. When a <code>Calendar</code> recomputes calendar field values for
 * return by <code>get()</code>, all of the calendar fields are normalized. For
 * example, a lenient <code>GregorianCalendar</code> interprets
 * <code>MONTH == JANUARY</code>, <code>DAY_OF_MONTH == 32</code> as February 1.
 * 
 * <p>
 * When a <code>Calendar</code> is in non-lenient mode, it throws an exception
 * if there is any inconsistency in its calendar fields. For example, a
 * <code>GregorianCalendar</code> always produces <code>DAY_OF_MONTH</code>
 * values between 1 and the length of the month. A non-lenient
 * <code>GregorianCalendar</code> throws an exception upon calculating its time
 * or calendar field values if any out-of-range field value has been set.
 *
 ...
 * insufficient information for the computation (such as only year and month
 * with no day of month), or there may be inconsistent information (such as
 * Tuesday, July 15, 1996 (Gregorian) -- July 15, 1996 is actually a Monday).
 * <code>Calendar</code> will resolve calendar field values to determine the
 * date and time in the following way.
 *
 * <p>
 * <a name="resolution">If there is any conflict in calendar field values,
 * <code>Calendar</code> gives priorities to calendar fields that have been set
 * more recently.</a> The following are the default combinations of the calendar
 * fields. The most recent combination, as determined by the most recently set
 * single field, will be used.
 *
 * <p>
 * <a name="date_resolution">For the date fields</a>: <blockquote>
 * 
 * <pre>
 ...
 * </blockquote>
 *
 * <a name="time_resolution">For the time of day fields</a>: <blockquote>
 * 
 * <pre>
 * HOUR_OF_DAY
 * AM_PM + HOUR
 ...
 * selected field combination, <code>Calendar</code> uses their default values.
 * The default value of each field may vary by concrete calendar systems. For
 * example, in <code>GregorianCalendar</code>, the default of a field is the
 * same as that of the start of the Epoch: i.e., <code>YEAR = 1970</code>,
 * <code>MONTH =
 ...
 * {@link DateFormat} to format dates.
 *
 * <h4>Field Manipulation</h4>
 *
 * The calendar fields can be changed using three methods: <code>set()</code>,
 * <code>add()</code>, and <code>roll()</code>.
 *
 * <p>
 * <strong><code>set(f, value)</code></strong> changes calendar field
 * <code>f</code> to <code>value</code>. In addition, it sets an internal member
 * variable to indicate that calendar field <code>f</code> has been changed.
 * Although calendar field <code>f</code> is changed immediately, the calendar's
 * time value in milliseconds is not recomputed until the next call to
 * <code>get()</code>, <code>getTime()</code>, <code>getTimeInMillis()</code>,
 * <code>add()</code>, or <code>roll()</code> is made. Thus, multiple calls to
 * <code>set()</code> do not trigger multiple, unnecessary computations. As a
 * result of changing a calendar field using <code>set()</code>, other calendar
 * fields may also change, depending on the calendar field, the calendar field
 * value, and the calendar system. In addition, <code>get(f)</code> will not
 * necessarily return <code>value</code> set by the call to the <code>set</code>
 * method after the calendar fields have been recomputed. The specifics are
 * determined by the concrete calendar class.
 * </p>
 *
 * <p>
 * <em>Example</em>: Consider a <code>GregorianCalendar</code> originally set to
 * August 31, 1999. Calling <code>set(Calendar.MONTH,
 * Calendar.SEPTEMBER)</code> sets the date to September 31, 1999. This is a
 * temporary internal representation that resolves to October 1, 1999 if
 * <code>getTime()</code>is then called. However, a call to
 * <code>set(Calendar.DAY_OF_MONTH, 30)</code> before the call to
 * <code>getTime()</code> sets the date to September 30, 1999, since no
 * recomputation occurs after <code>set()</code> itself.
 * </p>
 *
 * <p>
 * <strong><code>add(f, delta)</code></strong> adds <code>delta</code> to field
 * <code>f</code>. This is equivalent to calling <code>set(f,
 * get(f) + delta)</code> with two adjustments:
 * </p>
 *
 * <blockquote>
 * <p>
 * <strong>Add rule 1</strong>. The value of field <code>f</code> after the call
 * minus the value of field <code>f</code> before the call is <code>delta</code>
 * , modulo any overflow that has occurred in field <code>f</code>. Overflow
 ...
 * but it is impossible for it to be equal to its prior value because of changes
 * in its minimum or maximum after field <code>f</code> is changed or other
 * constraints, such as time zone offset changes, then its value is adjusted to
 * be as close as possible to its expected value. A smaller field represents a
 * smaller unit of time. <code>HOUR</code> is a smaller field than
 * <code>DAY_OF_MONTH</code>. No adjustment is made to smaller fields that are
 * not expected to be invariant. The calendar system determines what fields are
 ...
 * 1</strong> sets the <code>MONTH</code> field to September, since adding 13
 * months to August gives September of the next year. Since
 * <code>DAY_OF_MONTH</code> cannot be 31 in September in a
 * <code>GregorianCalendar</code>, <strong>add rule 2</strong> sets the
 * <code>DAY_OF_MONTH</code> to 30, the closest possible value. Although it is a
 * smaller field, <code>DAY_OF_WEEK</code> is not adjusted by rule 2, since it
 * is expected to change when the month changes in a
 * <code>GregorianCalendar</code>.
 * </p>
 *
 * <p>
 * <strong><code>roll(f, delta)</code></strong> adds <code>delta</code> to field
 * <code>f</code> without changing larger fields. This is equivalent to calling
 * <code>add(f, delta)</code> with the following adjustment:
 * </p>
 *
 * <blockquote>
 * <p>
 * <strong>Roll rule</strong>. Larger fields are unchanged after the call. A
 * larger field represents a larger unit of time. <code>DAY_OF_MONTH</code> is a
 * larger field than <code>HOUR</code>.
 * </p>
 * </blockquote>
 *
 * <p>
 * <em>Example</em>: See {@link java.util.GregorianCalendar#roll(int, int)}.
 *
 * <p>
 * <strong>Usage model</strong>. To motivate the behavior of <code>add()</code>
 * and <code>roll()</code>, consider a user interface component with increment
 * and decrement buttons for the month, day, and year, and an underlying
 * <code>GregorianCalendar</code>. If the interface reads January 31, 1999 and
 * the user presses the month increment button, what should it read? If the
 * underlying implementation uses <code>set()</code>, it might read March 3,
 ...
 * <code>add()</code> or <code>roll()</code>, depending on whether larger fields
...
public abstract class Calendar implements Serializable, Cloneable,
	 ...
	 * A style specifier for {@link #getDisplayName(int, int, Locale)
	 * getDisplayName} and {@link #getDisplayNames(int, int, Locale)
	 * getDisplayNames} indicating a narrow name independently. Narrow names are
	 * typically single character strings, such as "M" for Monday.
	 *
	 * @see #NARROW_FORMAT
	 * @see #SHORT_STANDALONE
	 * @see #LONG_STANDALONE
	 ...
	 * A style specifier for {@link #getDisplayName(int, int, Locale)
	 * getDisplayName} and {@link #getDisplayNames(int, int, Locale)
	 * getDisplayNames} indicating a short name used independently, such as a
	 * month abbreviation as calendar headers.
	 *
	 * @see #SHORT_FORMAT
	 * @see #LONG_FORMAT
	 * @see #LONG_STANDALONE
	 ...
	 * A style specifier for {@link #getDisplayName(int, int, Locale)
	 * getDisplayName} and {@link #getDisplayNames(int, int, Locale)
	 * getDisplayNames} indicating a long name used independently, such as a
	 * month name as calendar headers.
	 *
	 * @see #LONG_FORMAT
	 * @see #SHORT_FORMAT
	 * @see #SHORT_STANDALONE
	...
	// milliseconds, and a set of calendar "fields" representing the current
	// time.
	 ...
	 * set. A new object has no fields set. After the first call to a method
	 * which generates the fields, they all remain set after that. This is an
	 * array of <code>FIELD_COUNT</code> booleans, with index values
	 * <code>ERA</code> through <code>DST_OFFSET</code>.
	 * 
	 * @serial
	 */
	...
	/**
	 * Pseudo-time-stamps which specify when each field was set. There are two
	 * special values, UNSET and COMPUTED. Values from MINIMUM_USER_SET to
	 * Integer.MAX_VALUE are legal user set values.
	 */
	...
	/**
	 * True if then the value of <code>time</code> is valid. The time is made
	 * invalid by a change to an item of <code>field[]</code>.
	 * 
	 * @see #time
	 * @serial
	 */
	...
	/**
	 * True if <code>fields[]</code> are in sync with the currently set time. If
	 * false, then the next attempt to get the value of a field will force a
	 * recomputation of all fields from the current value of <code>time</code>.
	 * 
	 * @serial
	 */
	@SuppressWarnings("ProtectedField")
	...
	/**
	 * <code>True</code> if this calendar allows out-of-range field values
	 * during computation of <code>time</code> from <code>fields[]</code>.
	 * 
	 * @see #setLenient
	 * @see #isLenient
	 * @serial
	 ...
	 */
	private static final ConcurrentMap<Locale, int[]> cachedLocaleData = new ConcurrentHashMap<>(
			3);
	 ...
	 * be removed from the stream in the near future. In the meantime, a value
	 * of <code>MINIMUM_USER_STAMP</code> should be used.
	 * 
	 * @serial
	 */
	 ...
	 * <dd>JDK 1.1.5 or earlier.</dd>
	 * <dt><b>1</b></dt>
	 * <dd>JDK 1.1.6 or later. Writes a correct 'time' value as well as
	 * compatible values for other fields. This is a transitional format.</dd>
	 * </dl>
	 * When streaming out this class, the most recent format and the highest
	 * allowable <code>serialVersionOnStream</code> is written.
	 * 
	 * @serial
	 * @since JDK1.1.6
	 */
	 ...
	 *
	 * <p>
	 * There are two ways to set a {@code Calendar} to a date-time value. One is
	 * to set the instant parameter to a millisecond offset from the
	 * <a href="Calendar.html#Epoch">Epoch</a>. The other is to set individual
	 ...
	 * calendar specific default values are used when building a
	 ...
	 * <a href="Calendar.html#resolution"> resolution rules</a> are applied.
	 ...
	 * <a href="GregorianCalendar.html#iso8601_compatible_setting"> ISO 8601
	 * compatible week parameters</a>.
	 * 
	 * <pre>
	 * Calendar cal = new Calendar.Builder().setCalendarType("iso8601").setWeekDate(
	 * 		2013, 1, MONDAY).build();
	 * </pre>
	 * <p>
	 * The following code produces a Japanese {@code Calendar} with date
	 * 1989-01-08 (Gregorian), assuming that the default {@link Calendar#ERA
	 * ERA} is <em>Heisei</em> that started on that day.
	 * 
	 * <pre>
	...
	public static class Builder {
		...
		// Calendar.stamp[] (lower half) and Calendar.fields[] (upper half)
		// combined
		private int[] fields;
		 ...
		 * a millisecond offset from <a href="Calendar.html#Epoch">the Epoch</a>
		 * .
		 *
		 * @param instant
		 ...
		 *
		 * @param instant
		 *                a {@code Date} representing a millisecond offset from
		 *                the
		 *                Epoch
		 * @return this {@code Calendar.Builder}
		 ...
		 * @throws IllegalStateException
		 *                                  if the instant value has already
		 *                                  been set, or if fields
		 *                                  have been set too many
		 *                                  (approximately
		 ...
		 * 
		 * <pre>
		 * set(Calendar.YEAR, 2013).set(Calendar.MONTH, Calendar.DECEMBER).set(
		 * 		Calendar.DAY_OF_MONTH, 23);
		 * </pre>
		 *
		 ...
		 * @return this {@code Calendar.Builder}
		 * @throws NullPointerException
		 *                                  if {@code fieldValuePairs} is
		 *                                  {@code null}
		 * @throws IllegalArgumentException
		 *                                  if any of fields are invalid, or if
		 *                                  {@code fieldValuePairs.length} is an
		 *                                  odd number.
		 * @throws IllegalStateException
		 *                                  if the instant value has been set,
		 *                                  or if fields have been
		 *                                  set too many (approximately
		 ...
		 * @param dayOfMonth
		 *                   the {@link Calendar#DAY_OF_MONTH DAY_OF_MONTH}
		 *                   value
		 * @return this {@code Calendar.Builder}
		 */
		public Builder setDate(int year, int month, int dayOfMonth) {
			return setFields(YEAR, year, MONTH, month, DAY_OF_MONTH,
					dayOfMonth);
		}
		...
		/**
		 * Sets the time of day field parameters to the values given by
		 * {@code hourOfDay}, {@code minute}, {@code second}, and {@code millis}
		...
		public Builder setTimeOfDay(int hourOfDay, int minute, int second,
				int millis) {
			return setFields(HOUR_OF_DAY, hourOfDay, MINUTE, minute, SECOND,
					second, MILLISECOND, millis);
		}
		 ...
		 */
		public Builder setWeekDate(int weekYear, int weekOfYear,
				int dayOfWeek) {
			allocateFields();
		 ...
		 * @throws IllegalStateException
		 *                                  if another calendar type has already
		 *                                  been set
		...
		public Builder setCalendarType(String type) {
			...
			if (!Calendar.getAvailableCalendarTypes().contains(type) && !type
					.equals("iso8601")) {
		 ...
		 *                                  {@code minimalDaysInFirstWeek} is
		 *                                  invalid
		 * @see Calendar#getFirstDayOfWeek()
		 * @see Calendar#getMinimalDaysInFirstWeek()
		 */
		public Builder setWeekDefinition(int firstDayOfWeek,
				int minimalDaysInFirstWeek) {
			if (!isValidWeekParameter(firstDayOfWeek) || !isValidWeekParameter(
		 ...
		 * calendar. Its week definition parameters are also set to be
		 * <a href="GregorianCalendar.html#iso8601_compatible_setting">
		 * compatible with the ISO 8601 standard</a>. Note that the
		 ...
		 *                                  if any invalid field
		 *                                  values are given in non-lenient
		 *                                  mode, or if a week date
		 *                                  is given for the calendar type that
		...
		public Calendar build() {
			...
			if (type == null) {
				if (locale.getCountry() == "TH" && locale
						.getLanguage() == "th") {
					type = "buddhist";
				} else {
					type = "gregory";
			...
			if (fields != null) {
				...
				if (weekDate && !cal.isWeekDateSupported()) {
					throw new IllegalArgumentException(
							"week date is unsupported by " + type);
				}
				...
				if (weekDate) {
					int weekOfYear = isSet(WEEK_OF_YEAR) ? fields[NFIELDS
							+ WEEK_OF_YEAR] : 1;
					int dayOfWeek = isSet(DAY_OF_WEEK) ? fields[NFIELDS
							+ DAY_OF_WEEK] : cal.getFirstDayOfWeek();
					cal.setWeekDate(fields[NFIELDS + WEEK_YEAR], weekOfYear,
							dayOfWeek);
				}
				cal.complete();
			}
	 ...
	 * <code>Calendar</code> returned is based on the current time in the
	 * default time zone with the default {@link Locale.Category#FORMAT FORMAT}
	 * locale.
	 *
	 * @return a Calendar.
	 */
	 ...
	 * <code>Calendar</code> returned is based on the current time in the given
	 * time zone with the default {@link Locale.Category#FORMAT FORMAT} locale.
	 *
	 * @param zone
	 *             the time zone to use
	 * @return a Calendar.
	...
	private static Calendar createCalendar(TimeZone zone, Locale aLocale) {
		...
		if (cal == null) {
			...
			if (aLocale.getLanguage() == "th" && aLocale.getCountry() == "TH") {
				cal = new BuddhistCalendar(zone, aLocale);
			} else if (aLocale.getVariant() == "JP" && aLocale
					.getLanguage() == "ja" && aLocale.getCountry() == "JP") {
				cal = new JapaneseImperialCalendar(zone, aLocale);
			} else {
				cal = new GregorianCalendar(zone, aLocale);
			}
	 ...
	 * methods of this class can return localized instances. The array returned
	 * must contain at least a <code>Locale</code> instance equal to
	 * {@link java.util.Locale#US Locale.US}.
	 *
	 * @return An array of locales for which localized <code>Calendar</code>
	...
	/**
	 * Converts the current calendar field values in {@link #fields fields[]} to
	 * the millisecond time value {@link #time}.
	 *
	 * @see #complete()
	 * @see #computeFields()
	 */
	...
	/**
	 * Converts the current millisecond time value {@link #time} to calendar
	 * field values in {@link #fields fields[]}. This allows you to sync up the
	 * calendar field values with a new time that is set for the calendar. The
	 * time is <em>not</em> recomputed first; to recompute the time, then the
	 * fields, call the {@link #complete()} method.
	 *
	 * @see #computeTime()
	 */
	 ...
	 * <code>Calendar</code>'s time value (millisecond offset from the
	 ...
	 * the {@link #complete()} method, which process is calendar system
	 * dependent.
	 *
	 * @param field
	 ...
	 *                                        if the specified field is out of
	 *                                        range (
	...
	/**
	 * Returns the value of the given calendar field. This method does not
	 * involve normalization or validation of the field value.
	 *
	 * @param field
	 *              the given calendar field.
	 * @return the value for the given calendar field.
	...
	/**
	 * Sets the value of the given calendar field. This method does not affect
	 * any setting state of the field in this <code>Calendar</code> instance.
	 *
	...
	/**
	 * Sets the values for the calendar fields <code>YEAR</code>,
	 * <code>MONTH</code>, <code>DAY_OF_MONTH</code>, <code>HOUR_OF_DAY</code>,
	 * and <code>MINUTE</code>. Previous values of other fields are retained. If
	 * this is not desired, call {@link #clear()} first.
	 *
	 * @param year
	 *                  the value used to set the <code>YEAR</code> calendar
	 *                  field.
	 * @param month
	 *                  the value used to set the <code>MONTH</code> calendar
	 *                  field.
	 *                  Month value is 0-based. e.g., 0 for January.
	 * @param date
	 ...
	 *                  field.
	 * @param hourOfDay
	 *                  the value used to set the <code>HOUR_OF_DAY</code>
	 *                  calendar
	 *                  field.
	 * @param minute
	 *                  the value used to set the <code>MINUTE</code> calendar
	 *                  field.
	 * @see #set(int,int)
	 * @see #set(int,int,int)
	 * @see #set(int,int,int,int,int,int)
	 ...
	 * and <code>SECOND</code>. Previous values of other fields are retained. If
	 * this is not desired, call {@link #clear()} first.
	 *
	 * @param year
	 *                  the value used to set the <code>YEAR</code> calendar
	 ...
	 *                  field.
	 * @param second
	 *                  the value used to set the <code>SECOND</code> calendar
	 *                  field.
	 * @see #set(int,int)
	 * @see #set(int,int,int)
	 * @see #set(int,int,int,int,int)
	 ...
	 * from the <a href="#Epoch">Epoch</a>) of this <code>Calendar</code>
	 * undefined. This means that {@link #isSet(int) isSet()} will return
	 * <code>false</code> for all the calendar fields, and the date and time
	 * calculations will treat the fields as if they had never been set. A
	 * <code>Calendar</code> implementation class may use its specific default
	 * field values for date/time calculations. For example,
	 * <code>GregorianCalendar</code> uses 1970 if the <code>YEAR</code> field
	 * value is undefined.
	 *
	 * @see #clear(int)
	 */
	...
	/**
	 * Sets the given calendar field value and the time value (millisecond
	 * offset from the <a href="#Epoch">Epoch</a>) of this <code>Calendar</code>
	 * undefined. This means that {@link #isSet(int) isSet(field)} will return
	 * <code>false</code>, and the date and time calculations will treat the
	 * field as if it had never been set. A <code>Calendar</code> implementation
	 * class may use the field's specific default value for date and time
	 * calculations.
	 *
	 * <p>
	 * The {@link #HOUR_OF_DAY}, {@link #HOUR} and {@link #AM_PM} fields are
	 * handled independently and the <a href="#time_resolution">the resolution
	 * rule for the time of day</a> is applied. Clearing one of the fields
	 * doesn't reset the hour of day value of this <code>Calendar</code>. Use
	 * {@link #set(int,int) set(Calendar.HOUR_OF_DAY, 0)} to reset the hour
	 * value.
	 *
	 * @param field
	...
	/**
	 * Determines if the given calendar field has a value set, including cases
	 * that the value has been set by internal fields calculations triggered by
	 * a <code>get</code> method call.
	 *
	 * @param field
	...
	/**
	 * Returns the string representation of the calendar <code>field</code>
	 * value in the given <code>style</code> and <code>locale</code>. If no
	 * string representation is applicable, <code>null</code> is returned. This
	 * method calls {@link Calendar#get(int) get(field)} to get the calendar
	 * <code>field</code> value if the string representation is applicable to
	 * the given calendar <code>field</code>.
	 *
	 * <p>
	 * For example, if this <code>Calendar</code> is a
	 * <code>GregorianCalendar</code> and its date is 2005-01-01, then the
	 * string representation of the {@link #MONTH} field would be "January" in
	 * the long style in an English locale or "Jan" in the short style. However,
	 * no string representation would be available for the {@link #DAY_OF_MONTH}
	 * field, and this method would return <code>null</code>.
	 *
	 * <p>
	 * The default implementation supports the calendar fields for which a
	 * {@link DateFormatSymbols} has names in the given <code>locale</code>.
	 *
	 * @param field
	 *               the calendar field for which the string representation is
	 *               returned
	 * @param style
	 *               the style applied to the string representation; one of
	 *               {@link #SHORT_FORMAT} ({@link #SHORT}),
	 *               {@link #SHORT_STANDALONE}, {@link #LONG_FORMAT}
	 *               ({@link #LONG}
	 *               ), {@link #LONG_STANDALONE}, {@link #NARROW_FORMAT}, or
	 *               {@link #NARROW_STANDALONE}.
	 * @param locale
	 *               the locale for the string representation (any calendar
	 *               types
	 *               specified by {@code locale} are ignored)
	 * @return the string representation of the given {@code field} in the given
	 *         {@code style}, or {@code null} if no string representation is
	 *         applicable.
	 * @exception IllegalArgumentException
	 *                                     if {@code field} or {@code style} is
	 *                                     invalid, or if this
	 *                                     {@code Calendar} is non-lenient and
	 *                                     any of the calendar
	...
	public String getDisplayName(int field, int style, Locale locale) {
		...
		// the standalone and narrow styles are supported only through
		// CalendarDataProviders.
		if (isStandaloneStyle(style) || isNarrowFormatStyle(style)) {
			String val = CalendarDataUtility.retrieveFieldValueName(
					calendarType, field, fieldValue, style, locale);
			// Perform fallback here to follow the CLDR rules
			if (val == null) {
				if (isNarrowFormatStyle(style)) {
					val = CalendarDataUtility.retrieveFieldValueName(
							calendarType, field, fieldValue, toStandaloneStyle(
									style), locale);
				} else if (isStandaloneStyle(style)) {
					val = CalendarDataUtility.retrieveFieldValueName(
							calendarType, field, fieldValue, getBaseStyle(
									style), locale);
				}
			}
			return val;
	...
	/**
	 * Returns a {@code Map} containing all names of the calendar {@code field}
	 * in the given {@code style} and {@code locale} and their corresponding
	 * field values. For example, if this {@code Calendar} is a
	 * {@link GregorianCalendar}, the returned map would contain "Jan" to
	 * {@link #JANUARY}, "Feb" to {@link #FEBRUARY}, and so on, in the
	 * {@linkplain #SHORT short} style in an English locale.
	 *
	 * <p>
	 * Narrow names may not be unique due to use of single characters, such as
	 * "S" for Sunday and Saturday. In that case narrow names are not included
	 * in the returned {@code Map}.
	 *
	 * <p>
	 * The values of other calendar fields may be taken into account to
	 * determine a set of display names. For example, if this {@code Calendar}
	 * is a lunisolar calendar system and the year value given by the
	 * {@link #YEAR} field has a leap month, this method would return month
	 * names containing the leap month name, and month names are mapped to their
	 * values specific for the year.
	 *
	 * <p>
	 * The default implementation supports display names contained in a
	 * {@link DateFormatSymbols}. For example, if {@code field} is
	 * {@link #MONTH} and {@code style} is {@link #ALL_STYLES}, this method
	 * returns a {@code Map} containing all strings returned by
	 * {@link DateFormatSymbols#getShortMonths()} and
	 * {@link DateFormatSymbols#getMonths()}.
	 *
	 * @param field
	 ...
	 * @return a {@code Map} containing all display names in {@code style} and
	 *         {@code locale} and their field values, or {@code null} if no
	 *         display names are defined for {@code field}
	 * @exception IllegalArgumentException
	 *                                     if {@code field} or {@code style} is
	 *                                     invalid, or if this
	 *                                     {@code Calendar} is non-lenient and
	...
	public Map<String, Integer> getDisplayNames(int field, int style,
			Locale locale) {
		if (!checkDisplayNameParams(field, style, ALL_STYLES, NARROW_FORMAT,
		...
		if (style == ALL_STYLES || isStandaloneStyle(style)
				|| isNarrowFormatStyle(style)) {
			Map<String, Integer> map;
			map = CalendarDataUtility.retrieveFieldValueNames(calendarType,
					field, style, locale);

			// Perform fallback here to follow the CLDR rules
			if (map == null) {
				if (isNarrowFormatStyle(style)) {
					map = CalendarDataUtility.retrieveFieldValueNames(
							calendarType, field, toStandaloneStyle(style),
							locale);
				} else if (style != ALL_STYLES) {
					map = CalendarDataUtility.retrieveFieldValueNames(
							calendarType, field, getBaseStyle(style), locale);
				}
			}
			return map;
		}
	...
	private Map<String, Integer> getDisplayNamesImpl(int field, int style,
			Locale locale) {
		DateFormatSymbols symbols = DateFormatSymbols.getInstance(locale);
		String[] strings = getFieldStrings(field, style, symbols);
		if (strings != null) {
	...
	boolean checkDisplayNameParams(int field, int style, int minStyle,
			int maxStyle, Locale locale, int fieldMask) {
		int baseStyle = getBaseStyle(style); // Ignore the standalone mask
		if (field < 0 || field >= fields.length || baseStyle < minStyle
				|| baseStyle > maxStyle) {
			throw new IllegalArgumentException();
		}
		if (locale == null) {
	...
	private String[] getFieldStrings(int field, int style,
		...
		switch (field) {
			...
			case MONTH:
				strings = (baseStyle == LONG) ? symbols.getMonths()
	 ...
	 * {@link #computeTime()} method is called if the time value (millisecond
	 * offset from the <a href="#Epoch">Epoch</a>) has not been calculated from
	 ...
	 *                                      if the specified <code>field</code>
	 *                                      is out of range (
	 *                                      <code>field &lt; 0 || field &gt;= FIELD_COUNT</code>).
	 * @see #selectFields()
	...
	/**
	 * Returns a field mask (bit mask) indicating all calendar fields that have
	 * the state of externally or internally set.
	 *
	...
	/**
	 * Sets the state of the specified calendar fields to <em>computed</em>.
	 * This state means that the specified calendar fields have valid values
	 * that have been set by internal time calculation rather than by calling
	 * one of the setter methods.
	 *
	 * @param fieldMask
	 *                  the field to be marked as computed.
	 * @exception IndexOutOfBoundsException
	 *                                      if the specified <code>field</code>
	 *                                      is out of range (
	 *                                      <code>field &lt; 0 || field &gt;= FIELD_COUNT</code>).
	...
	/**
	 * Sets the state of the calendar fields that are <em>not</em> specified by
	 * <code>fieldMask</code> to <em>unset</em>. If <code>fieldMask</code>
	 ...
	 *
	 * @param fieldMask
	 *                  the field mask indicating which calendar fields are in
	 *                  sync
	 *                  with the time value.
	 * @exception IndexOutOfBoundsException
	 *                                      if the specified <code>field</code>
	...
	/**
	 * Returns a field mask indicating which calendar field values to be used to
	 * calculate the time value. The calendar fields are returned as a bit mask,
	 * each bit of which corresponds to a field, i.e., the mask value of
	 * <code>field</code> is <code>(1 &lt;&lt;
	 ...
	 *
	 * <p>
	 * This method supports the calendar fields resolution as described in the
	 * class description. If the bit mask for a given field is on and its field
	 * has not been set (i.e., <code>isSet(field)</code> is <code>false</code>),
	 * then the default value of the field has to be used, which case means that
	 * the field has been selected because the selected combination involves the
	 * field.
	 *
	...
	final int selectFields() {
		...
		if (bestStamp == domStamp || (bestStamp == womStamp
				&& stamp[WEEK_OF_MONTH] >= stamp[WEEK_OF_YEAR])
				|| (bestStamp == dowimStamp
						&& stamp[DAY_OF_WEEK_IN_MONTH] >= stamp[WEEK_OF_YEAR])) {
	...
	/**
	 * Returns the pseudo-time-stamp for two fields, given their individual
	 * pseudo-time-stamps. If either of the fields is unset, then the aggregate
	 * is unset. Otherwise, the aggregate is the later of the two stamps.
	 */
	 ...
	 * The result is <code>true</code> if and only if the argument is a
	 * <code>Calendar</code> object of the same calendar system that represents
	 * the same time value (millisecond offset from the
	 * <a href="#Epoch">Epoch</a>) under the same <code>Calendar</code>
	 * parameters as this object.
	 *
	 * <p>
	 * The <code>Calendar</code> parameters are the values represented by the
	 * <code>isLenient</code>, <code>getFirstDayOfWeek</code>,
	 * <code>getMinimalDaysInFirstWeek</code> and <code>getTimeZone</code>
	 * methods. If there is any difference in those parameters between the two
	 * <code>Calendar</code>s, this method returns <code>false</code>.
	 *
	 * <p>
	 * Use the {@link #compareTo(Calendar) compareTo} method to compare only the
	 * time values.
	 *
	 * @param obj
	...
	public int hashCode() {
		...
		int otheritems = (lenient ? 1 : 0) | (firstDayOfWeek << 1)
				| (minimalDaysInFirstWeek << 4) | (zone.hashCode() << 7);
		long t = getMillisOf(this);
		return (int) t ^ (int) (t >> 32) ^ otheritems;
	}

	/**
	 * Returns whether this <code>Calendar</code> represents a time before the
	 * time represented by the specified <code>Object</code>. This method is
	 * equivalent to:
	 * 
	 * <pre>
	 * {@code
	 ...
	 *         before the time represented by <code>when</code>;
	 *         <code>false</code> otherwise.
	...
	/**
	 * Returns whether this <code>Calendar</code> represents a time after the
	 * time represented by the specified <code>Object</code>. This method is
	 * equivalent to:
	 * 
	 * <pre>
	 ...
	 *             the <code>Object</code> to be compared
	 * @return <code>true</code> if the time of this <code>Calendar</code> is
	 *         after the time represented by <code>when</code>;
	 *         <code>false</code> otherwise.
	 * @see #compareTo(Calendar)
	 */
	 ...
	 * <a href="#Epoch">Epoch</a>) represented by two <code>Calendar</code>
	 * objects.
	 *
	 * @param anotherCalendar
	 *                        the <code>Calendar</code> to be compared.
	 * @return the value <code>0</code> if the time represented by the argument
	 *         is equal to the time represented by this <code>Calendar</code>; a
	 *         value less than <code>0</code> if the time of this
	 *         <code>Calendar</code> is before the time represented by the
	 *         argument; and a value greater than <code>0</code> if the time of
	 *         this <code>Calendar</code> is after the time represented by the
	 *         argument.
	 * @exception NullPointerException
	 *                                     if the specified
	 ...
	 *                                     <code>null</code>.
	 * @exception IllegalArgumentException
	 *                                     if the time value of the specified
	 *                                     <code>Calendar</code>
	 *                                     object can't be obtained due to any
	 *                                     invalid calendar
	 *                                     values.
	 * @since 1.5
	 */
	 ...
	 * without changing larger fields. For example, to roll the current date up
	 * by one day, you can achieve it by calling:
	 * <p>
	 * roll(Calendar.DATE, true). When rolling on the year or Calendar.YEAR
	 * field, it will roll the year value in the range between 1 and the value
	 * returned by calling <code>getMaximum(Calendar.YEAR)</code>. When rolling
	 * on the month or Calendar.MONTH field, other fields like date might
	 ...
	 *
	 * <p>
	 * NOTE: This default implementation on <code>Calendar</code> just
	 * repeatedly calls the version of {@link #roll(int,boolean) roll()} that
	 * rolls by one unit. This may not always do the right thing. For example,
	 * if the <code>DAY_OF_MONTH</code> field is 31, rolling through February
	 * will leave it set to 28. The <code>GregorianCalendar</code> version of
	 ...
	 *
	 * @param value
	 *              the given minimal days required in the first week of the
	 *              year.
	 * @see #getMinimalDaysInFirstWeek()
	 */
	 ...
	 * the first month of a year, this method returns 1. If the minimal days
	...
	/**
	 * Returns the week year represented by this {@code Calendar}. The week year
	 * is in sync with the week cycle. The {@linkplain #getFirstDayOfWeek()
	 * first day of the first week} is the first day of the week year.
	 *
	 * <p>
	 ...
	 *                                          if any week year numbering isn't
	 *                                          supported in this
	 *                                          {@code Calendar}.
	...
	/**
	 * Sets the date of this {@code Calendar} with the the given date specifiers
	 * - week year, week of year, and day of week.
	 *
	 * <p>
	 * Unlike the {@code set} method, all of the calendar fields and
	 * {@code time} values are calculated upon return.
	 *
	 * <p>
	 * If {@code weekOfYear} is out of the valid week-of-year range in
	 * {@code weekYear}, the {@code weekYear} and {@code
	 ...
	 * @param dayOfWeek
	 *                   the day of week value: one of the constants for the
	 *                   {@link #DAY_OF_WEEK} field: {@link #SUNDAY}, ...,
	 *                   {@link #SATURDAY}.
	 * @exception IllegalArgumentException
	 *                                          if any of the given date
	 *                                          specifiers is invalid or any of
	 *                                          the calendar fields are
	 *                                          inconsistent with the given date
	 *                                          specifiers in non-lenient mode
	 * @exception UnsupportedOperationException
	 *                                          if any week year numbering isn't
	 *                                          supported in this
	 *                                          {@code Calendar}.
	 ...
	 * <code>Calendar</code> instance. The minimum value is defined as the
	 * smallest value returned by the {@link #get(int) get} method for any
	 * possible time value. The minimum value depends on calendar system
	 ...
	 * <code>Calendar</code> instance. The maximum value is defined as the
	 * largest value returned by the {@link #get(int) get} method for any
	 * possible time value. The maximum value depends on calendar system
	 * specific parameters of the instance.
	 *
	 * @param field
	 *              the calendar field.
	 ...
	 * <code>Calendar</code> instance. The highest minimum value is defined as
	 * the largest value returned by {@link #getActualMinimum(int)} for any
	 * possible time value. The greatest minimum value depends on calendar
	 ...
	 * <code>Calendar</code> instance. The lowest maximum value is defined as
	 * the smallest value returned by {@link #getActualMaximum(int)} for any
	 * possible time value. The least maximum value depends on calendar system
	 * specific parameters of the instance. For example, a <code>Calendar</code>
	 * for the Gregorian calendar system returns 28 for the
	 * <code>DAY_OF_MONTH</code> field, because the 28th is the last day of the
	 * shortest month of this calendar, February in a common year.
	 *
	 * @param field
	 *              the calendar field.
	 ...
	 * given the time value of this <code>Calendar</code>.
	 *
	 * <p>
	 * The default implementation of this method uses an iterative algorithm to
	 * determine the actual minimum value for the calendar field. Subclasses
	 * should, if possible, override this with a more efficient implementation -
	 * in many cases, they can simply return <code>getMinimum()</code>.
	 *
	 * @param field
	 *              the calendar field
	 * @return the minimum of the given calendar field for the time value of
	 ...
	 * given the time value of this <code>Calendar</code>. For example, the
	 * actual maximum value of the <code>MONTH</code> field is 12 in some years,
	 * and 13 in other years in the Hebrew calendar system.
	 *
	 * <p>
	 * The default implementation of this method uses an iterative algorithm to
	 * determine the actual maximum value for the calendar field. Subclasses
	 * should, if possible, override this with a more efficient implementation.
	 *
	 * @param field
	 *              the calendar field
	 * @return the maximum of the given calendar field for the time value of
	 *         this <code>Calendar</code>
	 * @see #getMinimum(int)
	 * @see #getMaximum(int)
	 * @see #getGreatestMinimum(int)
	...
	public int getActualMaximum(int field) {
		...
		// if we're counting weeks, set the day of the week to Sunday. We know
		// the
	...
	private static final String[] FIELD_NAME = { "ERA", "YEAR", "MONTH",
	 ...
	 * @exception IndexOutOfBoundsException
	 *                                      if <code>field</code> is negative,
	 *                                      equal to or greater
	 *                                      then <code>FIELD_COUNT</code>.
	 */
	...
	private static void appendValue(StringBuilder sb, String item,
	...
	private void setWeekCountData(Locale desiredLocale) {
		...
		if (data == null) { /* cache miss */
			...
			data[1] = CalendarDataUtility.retrieveMinimalDaysInFirstWeek(
					desiredLocale);
	...
	/**
	 * Adjusts the stamp[] values before nextStamp overflow. nextStamp is set to
	 * the next stamp value upon the return.
	 */
	...
	/**
	 * Sets the WEEK_OF_MONTH and WEEK_OF_YEAR fields to new values with the new
	 * parameter value if they have been calculated internally.
	 */
	...
	private static class CalendarAccessControlContext {
		...
		static {
			RuntimePermission perm = new RuntimePermission(
