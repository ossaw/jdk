 ...
 * <p>
 * <b>Configuration:</b> By default each <tt>SocketHandler</tt> is initialized
 ...
 * <li>&lt;handler-name&gt;.host specifies the target host name to connect to
 * (no default).</li>
 * <li>&lt;handler-name&gt;.port specifies the target TCP port to use (no
 * default).</li>
 * </ul>
 * <p>
 ...
 * <li>java.util.logging.SocketHandler.formatter=java.util.logging.
 * SimpleFormatter</li>
 * </ul>
 * <p>
...
public class SocketHandler extends StreamHandler {
    ...
    /**
     * Create a <tt>SocketHandler</tt>, using only <tt>LogManager</tt>
     ...
     * and port arguments are used. If the host argument is empty, but not null
