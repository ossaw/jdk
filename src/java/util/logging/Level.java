...
public class Level implements java.io.Serializable {
    ...
    private String computeLocalizedLevelName(Locale newLocale) {
        ...
        final Locale locale = Locale.ROOT.equals(rbLocale) || name.equals(localizedName.toUpperCase(
                Locale.ROOT)) ? Locale.ROOT : rbLocale;
            ...
            if (list != null) {
                for (KnownLevel level : list) {
                    ...
                    if (l.value == other.value && (l.resourceBundleName == other.resourceBundleName
                            || (l.resourceBundleName != null && l.resourceBundleName.equals(
