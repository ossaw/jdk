 ...
 * exports them. It might for example, write them to a console or write them to
 * a file, or send them to a network logging service, or forward them to an OS
 * log, or whatever.
 * <p>
...
public abstract class Handler {
	...
	/**
	 * Default constructor. The resulting <tt>Handler</tt> has a log level of
	 * <tt>Level.ALL</tt>, no <tt>Formatter</tt>, and no <tt>Filter</tt>. A
	 ...
	 * <p>
	 * The intention is to allow developers to turn on voluminous logging, but
	 ...
	 * <tt>Level</tt> and whether it satisfies any <tt>Filter</tt>. It also may
	 * make other <tt>Handler</tt> specific checks that might prevent a handler
	 * from logging the <tt>LogRecord</tt>. It will return false if the
	 * <tt>LogRecord</tt> is null.
	 * <p>
	 * 
	 * @param record
	 *               a <tt>LogRecord</tt>
