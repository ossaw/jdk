...
public class Logger {
    ...
    public void log(LogRecord record) {
        ...
        Logger logger = this;
        while (logger != null) {
            final Handler[] loggerHandlers = isSystemLogger ? logger.accessCheckedHandlers()
                    : logger.getHandlers();
            ...
            final boolean useParentHdls = isSystemLogger ? logger.useParentHandlers
    ...
    private static ResourceBundle findSystemResourceBundle(final Locale locale) {
        ...
        return AccessController.doPrivileged(new PrivilegedAction<ResourceBundle>() {
            ...
            public ResourceBundle run() {
                try {
                    return ResourceBundle.getBundle(SYSTEM_LOGGER_RB_NAME, locale, ClassLoader
    ...
    public void setResourceBundle(ResourceBundle bundle) {
        ...
        synchronized (this) {
            ...
            final boolean canReplaceResourceBundle = lb.resourceBundleName == null || lb.resourceBundleName
                    .equals(baseName);
