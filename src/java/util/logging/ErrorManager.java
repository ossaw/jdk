 ...
 * occurs on a Handler during Logging.
 * <p>
 ...
 * unlikely to be interested) the Handler should call its associated
 * ErrorManager.
 */
...
public class ErrorManager {
	...
	/**
	 * GENERIC_FAILURE is used for failure that don't fit into one of the other
	 * categories.
	 */
	 ...
	 * <p>
	 * This method may be overridden in subclasses. The default behavior in this
	 * base class is that the first call is reported to System.err, and
