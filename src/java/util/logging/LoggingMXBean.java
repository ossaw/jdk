...
/**
 * The management interface for the logging facility. It is recommended to use
 * the {@link java.lang.management.PlatformLoggingMXBean} management interface
 * that implements all attributes defined in this {@code LoggingMXBean}. The
 ...
 * calling the {@link LogManager#getLoggingMXBean} method or from the
 ...
 * </pre>
 * <p>
 * The instance registered in the platform {@code MBeanServer} is also a
...
public interface LoggingMXBean {
     ...
     * {@link LogManager#getLoggerNames} and returns a list of the logger names.
     *
     * @return A list of <tt>String</tt> each of which is a currently registered
     *         <tt>Logger</tt> name.
     */
    public java.util.List<String> getLoggerNames();

    /**
     * Gets the name of the log level associated with the specified logger. If
     * the specified logger does not exist, <tt>null</tt> is returned. This
    ...
    /**
     * Sets the specified logger to the specified new level. If the
     * <tt>levelName</tt> is not <tt>null</tt>, the level of the specified
     * logger is set to the parsed <tt>Level</tt> matching the
     * <tt>levelName</tt>. If the <tt>levelName</tt> is <tt>null</tt>, the level
     * of the specified logger is set to <tt>null</tt> and the effective level
     * of the logger is inherited from its nearest ancestor with a specific
     ...
     * logger does not exist, <tt>null</tt> is returned. If the specified logger
     * is the root <tt>Logger</tt> in the namespace, the result will be an empty
     * string.
     *
     * @param loggerName
