 ...
 * implementing other logging <tt>Handlers</tt>.
 * <p>
 * <tt>LogRecords</tt> are published to a given <tt>java.io.OutputStream</tt>.
 * <p>
 * <b>Configuration:</b> By default each <tt>StreamHandler</tt> is initialized
 ...
 * <li>java.util.logging.StreamHandler.formatter=java.util.logging.
 * SimpleFormatter</li>
 * </ul>
 * <p>
...
public class StreamHandler extends Handler {
     ...
     * <p>
     * The <tt>StreamHandler</tt> first checks if there is an
     * <tt>OutputStream</tt> and if the given <tt>LogRecord</tt> has at least
     * the required log level. If not it silently returns. If so, it calls any
     * associated <tt>Filter</tt> to check if the record should be published. If
     * so, it calls its <tt>Formatter</tt> to format the record and then writes
     * the result to the current output stream.
     * <p>
     * If this is the first <tt>LogRecord</tt> to be written to a given
     * <tt>OutputStream</tt>, the <tt>Formatter</tt>'s "head" string is written
     ...
     * whether it satisfies any <tt>Filter</tt>. It will also return false if no
     * output stream has been assigned yet or the LogRecord is null.
     * <p>
     * 
     * @param record
     *               a <tt>LogRecord</tt>
     ...
     * yet been written to the stream, it will be written before the "tail"
     * string.
     *
     * @exception SecurityException
     *                              if a security manager exists and if the
