 ...
 * <em>weak keys</em>. An entry in a <tt>WeakHashMap</tt> will automatically be
 ...
 * refers to the key of the first value object. If the values in the map do not
 * rely on the map holding strong references to them, one way to deal with this
...
public class WeakHashMap<K, V> extends AbstractMap<K, V> implements Map<K, V> {
	...
	static class WeakHashMapSpliterator<K, V> {
		...
		WeakHashMapSpliterator(WeakHashMap<K, V> m, int origin, int fence, int est,
