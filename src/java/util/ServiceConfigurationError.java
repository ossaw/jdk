 ...
 * <ul>
 * <li>The format of a provider-configuration file violates the
 * <a href="ServiceLoader.html#format">specification</a>;</li>
 * <li>An {@link java.io.IOException IOException} occurs while reading a
 * provider-configuration file;</li>
 * <li>A concrete provider class named in a provider-configuration file cannot
 * be found;</li>
