 ...
 * {@link #add add}, {@link #remove remove}, and {@link #element element} are
 * based on {@link #offer offer}, {@link #poll poll}, and {@link #peek peek},
 * respectively, but throw exceptions instead of indicating failure via
 * <tt>false</tt> or <tt>null</tt> returns.
 *
 * <p>
 ...
 * {@link Collection#size}, and {@link Collection#iterator}. Typically,
...
public abstract class AbstractQueue<E> extends AbstractCollection<E> implements
	 ...
	 *
	 * <p>
	 * This implementation returns the result of <tt>peek</tt> unless the queue
	 * is empty.
	 *
	 * @return the head of this queue
	 * @throws NoSuchElementException
