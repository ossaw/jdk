 ...
 * member of the bundle family, and "MyResources_fr" is the French member. These
 * members are based on <code>ListResourceBundle</code> (a related
 * <a href="PropertyResourceBundle.html#sample">example</a> shows how you can
 * add a bundle to this family that's based on a properties file). The keys in
 * this example are of the form "s1" etc. The actual keys are entirely up to
 * your choice, so long as they are the same as the keys you use in your program
 * to retrieve the objects from the bundle. Keys are case-sensitive.
 * <blockquote>
 * 
 * <pre>
 *
 ...
 * implementations of the methods in this class are thread-safe.
 *
 * @see ResourceBundle
