...
/**
 * An abstract wrapper class for an {@code EventListener} class which associates
 * a set of additional parameters with the listener. Subclasses must provide the
 ...
 * method signature for adding a {@code PropertyChangeListener} for a property:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * then the array may contain inner {@code PropertyChangeListeners} which are
 * also {@code PropertyChangeListenerProxy} objects.
 * <p>
