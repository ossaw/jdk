...
public interface Formattable {
	 ...
	 *            {@link Formatter#locale() formatter.locale()} to obtain the
	 ...
	 *            {@link FormattableFlags#ALTERNATE}. If no flags are set, the
	 ...
	 *            will be truncated to <tt>precision</tt> characters even if the
