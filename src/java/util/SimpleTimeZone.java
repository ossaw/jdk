 ...
 * that represents a time zone for use with a Gregorian calendar. The class
 * holds an offset from GMT, called <em>raw offset</em>, and start and end rules
 * for a daylight saving time schedule. Since it only holds single values for
 * each, it cannot handle historical changes in the offset from GMT and the
 * daylight saving schedule, except that the {@link #setStartYear setStartYear}
 * method can specify the year when the daylight saving time schedule starts in
 * effect.
 * <p>
 ...
 * value is represented by a Calendar {@link Calendar#MONTH MONTH} field value,
 * such as {@link Calendar#MARCH}. The <em>day-of-week</em> value is represented
 * by a Calendar {@link Calendar#DAY_OF_WEEK DAY_OF_WEEK} value, such as
 * {@link Calendar#SUNDAY SUNDAY}. The meanings of value combinations are as
 * follows.
 * <ul>
 * <li><b>Exact day of month</b><br>
 * To specify an exact day of month, set the <em>month</em> and
 * <em>day-of-month</em> to an exact value, and <em>day-of-week</em> to zero.
 * For example, to specify March 1, set the <em>month</em> to
 * {@link Calendar#MARCH MARCH}, <em>day-of-month</em> to 1, and
 * <em>day-of-week</em> to 0.</li>
 ...
 * or after which the rule is applied, and <em>day-of-week</em> to a negative
 * {@link Calendar#DAY_OF_WEEK DAY_OF_WEEK} field value. For example, to specify
 * the second Sunday of April, set <em>month</em> to {@link Calendar#APRIL
 * APRIL}, <em>day-of-month</em> to 8, and <em>day-of-week</em> to
 * <code>-</code>{@link Calendar#SUNDAY SUNDAY}.</li>
 ...
 * and <em>day-of-week</em> is <code>-</code>{@link Calendar#WEDNESDAY
 * WEDNESDAY}.</li>
 ...
 * -1. For example, to specify the last Sunday of October, set <em>month</em> to
 * {@link Calendar#OCTOBER OCTOBER}, <em>day-of-week</em> to
 * {@link Calendar#SUNDAY SUNDAY} and <em>day-of-month</em> to -1.</li>
 * </ul>
 * The time of the day at which daylight saving time starts or ends is specified
 * by a millisecond value within the day. There are three kinds of <em>mode</em>
 * s to specify the time: {@link #WALL_TIME}, {@link #STANDARD_TIME} and
 * {@link #UTC_TIME}. For example, if daylight saving time ends at 2:00 am in
 * the wall clock time, it can be specified by 7200000 milliseconds in the
 * {@link #WALL_TIME} mode. In this case, the wall clock time for an
...
public class SimpleTimeZone extends TimeZone {
     ...
     * GMT, time zone ID, and rules for starting and ending the daylight time.
    ...
    public SimpleTimeZone(int rawOffset, String ID, int startMonth, int startDay, int startDayOfWeek,
        ...
        this(rawOffset, ID, startMonth, startDay, startDayOfWeek, startTime, WALL_TIME, endMonth, endDay,
                endDayOfWeek, endTime, WALL_TIME, millisPerHour);
    }
     ...
     */
    public SimpleTimeZone(int rawOffset, String ID, int startMonth, int startDay, int startDayOfWeek,
            int startTime, int endMonth, int endDay, int endDayOfWeek, int endTime, int dstSavings) {
        this(rawOffset, ID, startMonth, startDay, startDayOfWeek, startTime, WALL_TIME, endMonth, endDay,
                endDayOfWeek, endTime, WALL_TIME, dstSavings);
    }
     ...
     */
    public SimpleTimeZone(int rawOffset, String ID, int startMonth, int startDay, int startDayOfWeek,
            int startTime, int startTimeMode, int endMonth, int endDay, int endDayOfWeek, int endTime,
    ...
    /**
     * Sets the daylight saving time end rule. For example, if daylight saving
     * time ends on the last Sunday in October at 2 am in wall clock time, you
    ...
    /**
     * Returns the offset of this time zone from UTC at the given time. If
     * daylight saving time is in effect at the given time, the offset value is
     ...
     * into account both the raw offset and the effect of daylight saving, for
     * the specified date and time. This method assumes that the start and end
     * month are distinct. It also uses a default {@link GregorianCalendar}
     * object as its underlying calendar, such as for determining leap years. Do
     * not use the result of this method with a calendar other than a default
    ...
    public int getOffset(int era, int year, int month, int day, int dayOfWeek, int millis) {
        ...
        // compatibility.
                || (dayOfWeek < Calendar.SUNDAY || dayOfWeek > Calendar.SATURDAY) || (millis < 0
    ...
    private long getTransition(BaseCalendar cal, BaseCalendar.Date cdate, int mode, int year, int month,
            int dayOfMonth, int dayOfWeek, int timeOfDay) {
     ...
     *         standard time when the daylight saving rules are in effect, or 0
     ...
     * 
     * @return true if this time zone uses daylight saving time; false
     *         otherwise.
     */
    ...
    /**
     * Returns {@code true} if this {@code SimpleTimeZone} observes Daylight
     * Saving Time. This method is equivalent to {@link #useDaylightTime()}.
     *
     * @return {@code true} if this {@code SimpleTimeZone} observes Daylight
     *         Saving Time; {@code false} otherwise.
     * @since 1.7
     */
    @Override
     ...
     * 
     * @return true if daylight saving time is in effective at the given date;
     *         false otherwise.
     */
     ...
     *
     * @param obj
     *        The <code>SimpleTimeZone</code> object to be compared with.
    ...
    /**
     * Returns <code>true</code> if this zone has the same rules and offset as
     * another zone.
     * 
     * @param other
    ...
    public String toString() {
        return getClass().getName() + "[id=" + getID() + ",offset=" + rawOffset + ",dstSavings=" + dstSavings
                ...
                + ",startMonth=" + startMonth + ",startDay=" + startDay + ",startDayOfWeek=" + startDayOfWeek
                + ",startTime=" + startTime + ",startTimeMode=" + startTimeMode + ",endMode=" + endMode
                + ",endMonth=" + endMonth + ",endDay=" + endDay + ",endDayOfWeek=" + endDayOfWeek
     ...
     * between <code>Calendar.JANUARY</code> and <code>Calendar.DECEMBER</code>
     * inclusive. This value must not equal <code>endMonth</code>.
     * <p>
     * If <code>useDaylight</code> is false, this value is ignored.
     * 
     * @serial
     */
     ...
     * <dd><code>startDay</code> indicates the day of the month of
     * <code>startMonth</code> on which daylight saving time starts, from 1 to
     * 28, 30, or 31, depending on the <code>startMonth</code>.</dd>
     * <dt><code>startMode != DOW_IN_MONTH</code></dt>
     * <dd><code>startDay</code> indicates which <code>startDayOfWeek</code> in
     * the month <code>startMonth</code> daylight saving time starts on. For
     * example, a value of +1 and a <code>startDayOfWeek</code> of
     * <code>Calendar.SUNDAY</code> indicates the first Sunday of
     * <code>startMonth</code>. Likewise, +2 would indicate the second Sunday,
     * and -1 the last Sunday. A value of 0 is illegal.</dd>
     * </dl>
     * <p>
     * If <code>useDaylight</code> is false, this value is ignored.
     * 
    ...
    /**
     * The day of the week on which daylight saving time starts. This value must
     * be between <code>Calendar.SUNDAY</code> and
     * <code>Calendar.SATURDAY</code> inclusive.
     * <p>
     * If <code>useDaylight</code> is false or
    ...
    /**
     * The time in milliseconds after midnight at which daylight saving time
     * starts. This value is expressed as wall time, standard time, or UTC time,
     * depending on the setting of <code>startTimeMode</code>.
     * <p>
     * If <code>useDaylight</code> is false, this value is ignored.
     * 
     * @serial
    ...
    /**
     * The month in which daylight saving time ends. This value must be between
     * <code>Calendar.JANUARY</code> and <code>Calendar.UNDECIMBER</code>. This
     * value must not equal <code>startMonth</code>.
     * <p>
     * If <code>useDaylight</code> is false, this value is ignored.
     * 
     * @serial
     ...
     * <dd><code>endDay</code> indicates the day of the month of
     * <code>endMonth</code> on which daylight saving time ends, from 1 to 28,
     * 30, or 31, depending on the <code>endMonth</code>.</dd>
     * <dt><code>endMode != DOW_IN_MONTH</code></dt>
     * <dd><code>endDay</code> indicates which <code>endDayOfWeek</code> in th
     * month <code>endMonth</code> daylight saving time ends on. For example, a
     * value of +1 and a <code>endDayOfWeek</code> of
     * <code>Calendar.SUNDAY</code> indicates the first Sunday of
     * <code>endMonth</code>. Likewise, +2 would indicate the second Sunday, and
     * -1 the last Sunday. A value of 0 is illegal.</dd>
     * </dl>
     * <p>
     * If <code>useDaylight</code> is false, this value is ignored.
     * 
    ...
    /**
     * The day of the week on which daylight saving time ends. This value must
     * be between <code>Calendar.SUNDAY</code> and
     * <code>Calendar.SATURDAY</code> inclusive.
     * <p>
     * If <code>useDaylight</code> is false or
    ...
    /**
     * The time in milliseconds after midnight at which daylight saving time
     * ends. This value is expressed as wall time, standard time, or UTC time,
     * depending on the setting of <code>endTimeMode</code>.
     * <p>
     * If <code>useDaylight</code> is false, this value is ignored.
     * 
     * @serial
     ...
     * {@link GregorianCalendar#AD AD} value. If this value is less than 1 then
     * daylight saving time is observed for all <code>AD</code> years.
     * <p>
     * If <code>useDaylight</code> is false, this value is ignored.
     * 
     * @serial
     ...
     * are to the west of Greenwich. To obtain local <em>standard</em> time, add
     * the offset to GMT time. To obtain local wall time it may also be
    ...
    /**
     * This field was serialized in JDK 1.1, so we have to keep it that way to
     * maintain serialization compatibility. However, there's no need to
     * recreate the array each time we create a new time zone.
     * 
     * @serial An array of bytes containing the values {31, 28, 31, 30, 31, 30,
     *         31, 31, 30, 31, 30, 31}. This is ignored as of the Java 2
     *         platform v1.2, however, it must be streamed out for compatibility
     *         with JDK 1.1.
     */
     ...
     * <dd>Exact day of week; e.g., March 1.</dd>
     * <dt><code>DOW_IN_MONTH_MODE</code></dt>
     * <dd>Day of week in month; e.g., last Sunday in March.</dd>
     * <dt><code>DOW_GE_DOM_MODE</code></dt>
     * <dd>Day of week after day of month; e.g., Sunday on or after March 15.
     * </dd>
     * <dt><code>DOW_LE_DOM_MODE</code></dt>
     * <dd>Day of week before day of month; e.g., Sunday on or before March 15.
     * </dd>
     * </dl>
     ...
     * milliseconds. Typically one hour (3600000); sometimes 30 minutes
     * (1800000).
     * <p>
     * If <code>useDaylight</code> is false, this value is ignored.
     * 
    ...
    /**
     * Cache values representing a single period of daylight saving time. When
     * the cache values are valid, cacheStart is the start time (inclusive) of
     * daylight saving time and cacheEnd is the end time (exclusive).
     * cacheYear has a year value if both cacheStart and cacheEnd are in the
     * same year. cacheYear is set to startYear - 1 if cacheStart and cacheEnd
     * are in different years. cacheStart is 0 if the cache values are void.
     * cacheYear is a long to support Integer.MIN_VALUE - 1 (JCK requirement).
     */
    ...
    private static final int DOW_IN_MONTH_MODE = 2; // Day of week in month,
                                                    // "lastSun"
    private static final int DOW_GE_DOM_MODE = 3; // Day of week after day of
                                                  // month, "Sun>=15"
    private static final int DOW_LE_DOM_MODE = 4; // Day of week before day of
                                                  // month, "Sun<=21"

    /**
     * Constant for a mode of start or end time specified as wall clock time.
     * Wall clock time is standard time for the onset rule, and daylight time
     * for the end rule.
     * 
     * @since 1.4
     */
     ...
     * <dd>JDK 1.1.3 or earlier.</dd>
     * <dt><b>1</b></dt>
     * <dd>JDK 1.1.4 or later. Includes three new fields: <code>startMode</code>
     * , <code>endMode</code>, and <code>dstSavings</code>.</dd>
     * <dt><b>2</b></dt>
     * <dd>JDK 1.3 or later. Includes two new fields: <code>startTimeMode</code>
     * and <code>endTimeMode</code>.</dd>
     * </dl>
    ...
    /**
     * Given a set of encoded rules in startDay and startDayOfMonth, decode them
     * and set the startMode appropriately. Do the same for endDay and
     * endDayOfMonth. Upon entry, the day of week variables may be zero or
     * negative, in order to indicate special modes. The day of month variables
     * may also be negative. Upon exit, the mode variables will be set, and the
     * day of week and day of month variables will be positive. This method also
     * recognizes a startDay or endDay of zero as indicating no DST.
     */
    ...
    /**
     * Make rules compatible to 1.1 FCS code. Since 1.1 FCS code only
     * understands day-of-week-in-month rules, we must modify other modes of
     * rules to their approximate equivalent in 1.1 FCS terms. This method is
     * used when streaming out objects of this class. After it is called, the
     * rules will be modified, with a possible loss of information. startMode
     * and endMode will NOT be altered, even though semantically they should be
     * set to DOW_IN_MONTH_MODE, since the rule modification is only intended to
     * be temporary.
     */
    private void makeRulesCompatible() {
         ...
         * well unless it pushes into the next or previous day. If that happens,
         * we attempt to adjust the day rule somewhat crudely. The day rules
         * have been forced into DOW_IN_MONTH mode already, so we change the day
         * of week to move forward or back by a day. It's possible to make a
         * more refined adjustment of the original rules first, but in most
         * cases this extra effort will go to waste once we adjust the day rules
         * anyway.
         */
    ...
    /**
     * Pack the start and end rules into an array of bytes. Only pack data which
     * is not preserved by makeRulesCompatible.
     */
    ...
    /**
     * Given an array of bytes produced by packRules, interpret them as the
     * start and end rules.
     */
    ...
    /**
     * Pack the start and end times into an array of bytes. This is required as
     * of serial version 2.
     */
     ...
     *             <code>DOW_IN_MONTH_MODE</code> rules, in the required
     *             section, followed by the full rules, in packed format, in the
     *             optional section. The optional section will be ignored by JDK
     *             1.1 code upon stream in.
     *             <p>
     *             Contents of the optional section: The length of a byte array
     *             is emitted (int); this is 4 as of this release. The byte
     *             array of the given length is emitted. The contents of the
     *             byte array are the true values of the fields
     *             <code>startDay</code>, <code>startDayOfWeek</code>,
     *             <code>endDay</code>, and <code>endDayOfWeek</code>. The
     *             values of these fields in the required section are
     *             approximate values suited to the rule mode
     *             <code>DOW_IN_MONTH_MODE</code>, which is the only mode
     *             recognized by JDK 1.1.
     */
    ...
    private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
        ...
        if (serialVersionOnStream < 1) {
            ...
            // startDayOfWeek and endDayOfWeek were usually uninitialized. We
            // can't do
            // too much, so we assume SUNDAY, which actually works most of the
            // time.
            if (startDayOfWeek == 0) {
                startDayOfWeek = Calendar.SUNDAY;
            }
            ...
            // The variables dstSavings, startMode, and endMode are post-1.1, so
            // they
            ...
            // store the actual rules (which have not be made compatible with
            // 1.1)
