 ...
 * <code>Calendar</code> and provides the standard calendar system used by most
 * of the world.
 *
 * <p>
 * <code>GregorianCalendar</code> is a hybrid calendar that supports both the
 ...
 * Gregorian calendar was instituted (October 15, 1582 in some countries, later
 * in others). The cutover date may be changed by the caller by calling
 * {@link #setGregorianChange(Date) setGregorianChange()}.
 *
 * <p>
 ...
 * <code>GregorianCalendar</code> implements the Julian calendar. The only
 * difference between the Gregorian and the Julian calendar is the leap year
 * rule. The Julian calendar specifies leap years every four years, whereas the
 ...
 *
 * <p>
 * Values calculated for the {@link Calendar#WEEK_OF_YEAR WEEK_OF_YEAR} field
 * range from 1 to 53. The first week of a calendar year is the earliest seven
 * day period starting on {@link Calendar#getFirstDayOfWeek()
 * getFirstDayOfWeek()} that contains at least
 * {@link Calendar#getMinimalDaysInFirstWeek() getMinimalDaysInFirstWeek()} days
 * from that year. It thus depends on the values of
 * {@code getMinimalDaysInFirstWeek()}, {@code
 * getFirstDayOfWeek()}, and the day of the week of January 1. Weeks between
 * week 1 of one year and week 1 of the following year (exclusive) are numbered
 * sequentially from 2 to 52 or 53 (except for year(s) involved in the
 * Julian-Gregorian transition).
 *
 * <p>
 * The {@code getFirstDayOfWeek()} and {@code
 * getMinimalDaysInFirstWeek()} values are initialized using locale-dependent
 * resources when constructing a {@code
 ...
 * getMinimalDaysInFirstWeek()} is 4, which values are used in locales where the
 * standard is preferred. These values can explicitly be set by calling
 * {@link Calendar#setFirstDayOfWeek(int) setFirstDayOfWeek()} and
 * {@link Calendar#setMinimalDaysInFirstWeek(int) setMinimalDaysInFirstWeek()}.
 *
 * <p>
 * A <a name="week_year"><em>week year</em></a> is in sync with a
 * {@code WEEK_OF_YEAR} cycle. All weeks between the first and last weeks
 * (inclusive) have the same <em>week year</em> value. Therefore, the first and
 * last days of a week year may have different calendar year values.
 *
 * <p>
 * For example, January 1, 1998 is a Thursday. If {@code
 * getFirstDayOfWeek()} is {@code MONDAY} and {@code
 * getMinimalDaysInFirstWeek()} is 4 (ISO 8601 standard compatible setting),
 ...
 * however, {@code getFirstDayOfWeek()} is {@code SUNDAY}, then week 1 of 1998
 * starts on January 4, 1998, and ends on January 10, 1998; the first three days
 * of 1998 then are part of week 53 of 1997 and their week year is 1997.
 *
 * <h4>Week Of Month</h4>
 *
 * <p>
 * Values calculated for the <code>WEEK_OF_MONTH</code> field range from 0 to 6.
 * Week 1 of a month (the days with <code>WEEK_OF_MONTH =
 * 1</code>) is the earliest set of at least
 * <code>getMinimalDaysInFirstWeek()</code> contiguous days in that month,
 * ending on the day before <code>getFirstDayOfWeek()</code>. Unlike week 1 of a
 * year, week 1 of a month may be shorter than 7 days, need not start on
 * <code>getFirstDayOfWeek()</code>, and will not include days of the previous
 * month. Days of a month before week 1 have a <code>WEEK_OF_MONTH</code> of 0.
 *
 * <p>
 * For example, if <code>getFirstDayOfWeek()</code> is <code>SUNDAY</code> and
 * <code>getMinimalDaysInFirstWeek()</code> is 4, then the first week of January
 * 1998 is Sunday, January 4 through Saturday, January 10. These days have a
 * <code>WEEK_OF_MONTH</code> of 1. Thursday, January 1 through Saturday,
 * January 3 have a <code>WEEK_OF_MONTH</code> of 0. If
 ...
 *
 * <p>
 * The <code>clear</code> method sets calendar field(s) undefined.
 * <code>GregorianCalendar</code> uses the following default value for each
 * calendar field if its value is undefined.
 *
 * <table cellpadding="0" cellspacing="3" border="0" summary=
 * "GregorianCalendar default field values" style=
 ...
 * </tr>
 * <tr>
 * <td style="vertical-align: middle;"><code>ERA<br></code></td>
 * <td style="vertical-align: middle;"><code>AD<br></code></td>
 * </tr>
 * <tr>
 * <td style="vertical-align: middle; background-color: rgb(238, 238, 255);">
 * <code>YEAR<br></code></td>
 * <td style="vertical-align: middle; background-color: rgb(238, 238, 255);">
 * <code>1970<br></code></td>
 * </tr>
 * <tr>
 * <td style="vertical-align: middle;"><code>MONTH<br></code></td>
 * <td style="vertical-align: middle;"><code>JANUARY<br></code></td>
 * </tr>
 * <tr>
 * <td style="vertical-align: top; background-color: rgb(238, 238, 255);">
 * <code>DAY_OF_MONTH<br></code></td>
 * <td style="vertical-align: top; background-color: rgb(238, 238, 255);">
 * <code>1<br></code></td>
 * </tr>
 * <tr>
 * <td style="vertical-align: middle;"><code>DAY_OF_WEEK<br></code></td>
 * <td style="vertical-align: middle;"><code>the first day of week<br></code>
 * </td>
 * </tr>
 * <tr>
 * <td style="vertical-align: top; background-color: rgb(238, 238, 255);">
 * <code>WEEK_OF_MONTH<br></code></td>
 * <td style="vertical-align: top; background-color: rgb(238, 238, 255);">
 * <code>0<br></code></td>
 * </tr>
 * <tr>
 * <td style="vertical-align: top;"><code>DAY_OF_WEEK_IN_MONTH<br></code></td>
 * <td style="vertical-align: top;"><code>1<br></code></td>
 * </tr>
 * <tr>
 * <td style="vertical-align: middle; background-color: rgb(238, 238, 255);">
 * <code>AM_PM<br></code></td>
 * <td style="vertical-align: middle; background-color: rgb(238, 238, 255);">
 * <code>AM<br></code></td>
 * </tr>
 * <tr>
 * <td style="vertical-align: middle;">
 * <code>HOUR, HOUR_OF_DAY, MINUTE, SECOND, MILLISECOND<br></code></td>
 * <td style="vertical-align: middle;"><code>0<br></code></td>
 * </tr>
 * </tbody>
 * </table>
 * <br>
 ...
 * System.out.println("DAY_OF_WEEK_IN_MONTH: " + calendar.get(
 ...
 * 		/ (60 * 60 * 1000)));
 * System.out.println("DST_OFFSET: " + (calendar.get(Calendar.DST_OFFSET) / (60
 * 		* 60 * 1000)));
 * 
...
public class GregorianCalendar extends Calendar {
	 ...
	 * year rule, even though the historical pattern of leap years is irregular,
	 * being every 3 years from 45 BCE through 9 BCE, then every 4 years from 8
	 * CE onwards, with no leap years in-between. Thus date computations and
	...
	/**
	 * Value of the <code>ERA</code> field indicating the period before the
	 * common era (before Christ), also known as BCE. The sequence of years at
	 * the transition from <code>BC</code> to <code>AD</code> is ..., 2 BC, 1
	 * BC, 1 AD, 2 AD,...
	 *
	 * @see #ERA
	 */
	...
	/**
	 * Value of the {@link #ERA} field indicating the period before the common
	 * era, the same value as {@link #BC}.
	 *
	 * @see #CE
	 */
	 ...
	 * <code>BC</code> to <code>AD</code> is ..., 2 BC, 1 BC, 1 AD, 2 AD,...
	 *
	 * @see #ERA
	 */
	...
	/**
	 * Value of the {@link #ERA} field indicating the common era, the same value
	 * as {@link #AD}.
	 *
	 * @see #BCE
	 */
	...
	static final int MONTH_LENGTH[] = { 31, 28, 31, 30, 31, 30, 31, 31, 30, 31,
			30, 31 }; // 0-based
	static final int LEAP_MONTH_LENGTH[] = { 31, 29, 31, 30, 31, 30, 31, 31, 30,
			31, 30, 31 }; // 0-based
	 ...
	 * ---------- ------- ------- ------- ------- ERA 0 0 1 1 YEAR 1 1 292269054
	 * 292278994 MONTH 0 0 11 11 WEEK_OF_YEAR 1 1 52* 53 WEEK_OF_MONTH 0 0 4* 6
	 * DAY_OF_MONTH 1 1 28* 31 DAY_OF_YEAR 1 1 365* 366 DAY_OF_WEEK 1 1 7 7
	 * DAY_OF_WEEK_IN_MONTH -1 -1 4* 6 AM_PM 0 0 1 1 HOUR 0 0 11 11 HOUR_OF_DAY
	 * 0 0 23 23 MINUTE 0 0 59 59 SECOND 0 0 59 59 MILLISECOND 0 0 999 999
	 * ZONE_OFFSET -13:00 -13:00 14:00 14:00 DST_OFFSET 0:00 0:00 0:20 2:00
	 * </pre> *: depends on the Gregorian change date
	 */
	 ...
	 */
	private transient long gregorianCutoverDate = (((DEFAULT_GREGORIAN_CUTOVER
			+ 1) / ONE_DAY) - 1) + EPOCH_OFFSET; // == 577736
	...
	/**
	 * gdate always has a sun.util.calendar.Gregorian.Date instance to avoid
	 * overhead of creating it. The assumption is that most applications will
	 * need only Gregorian calendar calculations.
	 */
	private transient BaseCalendar.Date gdate;

	/**
	 * Reference to either gdate or a JulianCalendar.Date instance. After
	 * calling complete(), this value is guaranteed to be set.
	 */
	private transient BaseCalendar.Date cdate;

	/**
	 * The CalendarSystem used to calculate the date in cdate. After calling
	 * complete(), this value is guaranteed to be set and consistent with the
	 * cdate value.
	 */
	private transient BaseCalendar calsys;

	/**
	 * Temporary int[2] to get time zone offsets. zoneOffsets[0] gets the GMT
	 * offset value and zoneOffsets[1] gets the DST saving value.
	 */
	private transient int[] zoneOffsets;

	/**
	 * Temporary storage for saving original fields[] values in non-lenient
	 * mode.
	 */
	...
	/**
	 * Constructs a default <code>GregorianCalendar</code> using the current
	 * time in the default time zone with the default
	...
	/**
	 * Constructs a <code>GregorianCalendar</code> based on the current time in
	 * the given time zone with the default {@link Locale.Category#FORMAT
	 * FORMAT} locale.
	 *
	 * @param zone
	 *             the given time zone.
	...
	/**
	 * Constructs a <code>GregorianCalendar</code> with the given date set in
	 ...
	 *                   field in
	 *                   the calendar. Month value is 0-based. e.g., 0 for
	 *                   January.
	 * @param dayOfMonth
	...
	/**
	 * Constructs a <code>GregorianCalendar</code> with the given date and time
	 ...
	 *                   in the calendar.
	 * @param millis
	 *                   the value used to set the <code>MILLISECOND</code>
	 *                   calendar
	 *                   field
	 */
	...
	/**
	 * Sets the <code>GregorianCalendar</code> change date. This is the point
	 * when the switch from Julian dates to Gregorian dates occurred. Default is
	 * October 15, 1582 (Gregorian). Previous to this, dates will be in the
	 * Julian calendar.
	 * <p>
	 ...
	 * calendar.
	 *
	 * @return the Gregorian cutover date for this
	...
	public boolean isLeapYear(int year) {
		...
		// determine which calendar system to be applied to February in the
		// year.
	 ...
	 * <code>Object</code>. The result is <code>true</code> if and only if the
	 * argument is a <code>GregorianCalendar</code> object that represents the
	 * same time value (millisecond offset from the
	 * <a href="Calendar.html#Epoch">Epoch</a>) under the same
	 * <code>Calendar</code> parameters and Gregorian change date as this
	 * object.
	 *
	 * @param obj
	 ...
	 *
	 * <p>
	 * <em>Add rule 1</em>. The value of <code>field</code> after the call minus
	 * the value of <code>field</code> before the call is <code>amount</code>,
	 * modulo any overflow that has occurred in <code>field</code>. Overflow
	 * occurs when a field value exceeds its range and, as a result, the next
	 * larger field is incremented or decremented and the field value is
	 * adjusted back into its range.
	 * </p>
	 *
	 * <p>
	 * <em>Add rule 2</em>. If a smaller field is expected to be invariant, but
	 * it is impossible for it to be equal to its prior value because of changes
	 * in its minimum or maximum after <code>field</code> is changed, then its
	 * value is adjusted to be as close as possible to its expected value. A
	 * smaller field represents a smaller unit of time. <code>HOUR</code> is a
	 ...
	 *                                     if <code>field</code> is
	 *                                     <code>ZONE_OFFSET</code>,
	 *                                     <code>DST_OFFSET</code>, or unknown,
	 *                                     or if any calendar
	 *                                     fields have out-of-range values in
	 *                                     non-lenient mode.
	 */
	@Override
	public void add(int field, int amount) {
		...
		if (field == YEAR) {
			...
			setTimeInMillis((fd - EPOCH_OFFSET) * ONE_DAY + timeOfDay
					- zoneOffset);
	 ...
	 * set to December 31, 1999. Calling {@link #roll(int,boolean)
	 * roll(Calendar.MONTH, true)} sets the calendar to January 31, 1999. The
	 * <code>YEAR</code> field is unchanged because it is a larger field than
	 * <code>MONTH</code>.
	 * </p>
	 *
	 * @param up
	 *           indicates if the value of the specified calendar field is to
	 *           be rolled up or rolled down. Use <code>true</code> if rolling
	 ...
	 * larger fields. A negative roll amount means to subtract from field
	 * without changing larger fields. If the specified amount is 0, this method
	 * performs nothing.
	 *
	 * <p>
	 * This method calls {@link #complete()} before adding the amount so that
	 * all the calendar fields are normalized. If there is any calendar field
	 ...
	 * <code>GregorianCalendar</code>, the <code>DAY_OF_MONTH</code> field
	 * cannot be 31 in the month April. <code>DAY_OF_MONTH</code> is set to the
	 * closest possible value, 30. The <code>YEAR</code> field maintains the
	 * value of 1999 because it is a larger field than <code>MONTH</code>.
	 * <p>
	 * <em>Example</em>: Consider a <code>GregorianCalendar</code> originally
	 * set to Sunday June 6, 1999. Calling
	 * <code>roll(Calendar.WEEK_OF_MONTH, -1)</code> sets the calendar to
	 * Tuesday June 1, 1999, whereas calling
	 * <code>add(Calendar.WEEK_OF_MONTH, -1)</code> sets the calendar to Sunday
	 * May 30, 1999. This is because the roll rule imposes an additional
	 * constraint: The <code>MONTH</code> must not change when the
	 * <code>WEEK_OF_MONTH</code> is rolled. Taken together with add rule 1, the
	 * resultant date must be between Tuesday June 1 and Saturday June 5.
	 ...
	 *               the calendar field.
	 * @param amount
	 *               the signed amount to add to <code>field</code>.
	 * @exception IllegalArgumentException
	 *                                     if <code>field</code> is
	 *                                     <code>ZONE_OFFSET</code>,
	 *                                     <code>DST_OFFSET</code>, or unknown,
		...
		switch (field) {
			...
			case HOUR_OF_DAY: {
				...
				if (internalGet(DAY_OF_MONTH) != d.getDayOfMonth()) {
					d.setDate(internalGet(YEAR), internalGet(MONTH) + 1,
			...
			// E.g., <jan31>.roll(MONTH, 1) -> <feb28> or <feb29>.
			{
				if (!isCutoverYear(cdate.getNormalizedYear())) {
					...
					// Keep the day of month in the range. We don't want to spill
					// over
					// into the next month; e.g., we don't want jan31 + 1 mo ->
					// feb31 ->
					// mar3.
			...
			case WEEK_OF_YEAR: {
				...
				// Make sure the same thing for the max week
				fd += 7 * (max - woy);
				cal = (fd >= gregorianCutoverDate) ? gcal
						: getJulianCalendarSystem();
			...
			case WEEK_OF_MONTH: {
				boolean isCutoverYear = isCutoverYear(cdate
						.getNormalizedYear());
				...
				long monthDay1st = BaseCalendar.getDayOfWeekDateOnOrBefore(
						month1 + 6, getFirstDayOfWeek());
				// if the week has enough days to form a week, the
				// week starts from the previous month.
				if ((int) (monthDay1st
						- month1) >= getMinimalDaysInFirstWeek()) {
					monthDay1st -= 7;
				}
				max = getActualMaximum(field);

				// value: the new WEEK_OF_MONTH value
				int value = getRolledValue(internalGet(field), amount, 1, max)
						- 1;
			...
			case DAY_OF_MONTH: {
				...
				int value = getRolledValue((int) (fd - month1), amount, 0,
						actualMonthLength() - 1);
			...
			case DAY_OF_YEAR: {
				...
				int value = getRolledValue((int) (fd - jan1) + 1, amount, min,
						max);
			...
			case DAY_OF_WEEK: {
				...
				long fd = getCurrentFixedDate();
				long dowFirst = BaseCalendar.getDayOfWeekDateOnOrBefore(fd,
						getFirstDayOfWeek());
				fd += amount;
				if (fd < dowFirst) {
					fd += 7;
			...
			case DAY_OF_WEEK_IN_MONTH: {
				...
				int value = getRolledValue(internalGet(field), amount, min, max)
						- 1;
				fd = month1 + value * 7 + x;
				BaseCalendar cal = (fd >= gregorianCutoverDate) ? gcal
						: getJulianCalendarSystem();
				BaseCalendar.Date d = (BaseCalendar.Date) cal.newCalendarDate(
	 ...
	 * <code>GregorianCalendar</code> instance. The minimum value is defined as
	 * the smallest value returned by the {@link Calendar#get(int) get} method
	 * for any possible time value, taking into consideration the current values
	 * of the {@link Calendar#getFirstDayOfWeek() getFirstDayOfWeek},
	 ...
	 * <code>GregorianCalendar</code> instance. The maximum value is defined as
	 * the largest value returned by the {@link Calendar#get(int) get} method
	 * for any possible time value, taking into consideration the current values
	 * of the {@link Calendar#getFirstDayOfWeek() getFirstDayOfWeek},
	 * {@link Calendar#getMinimalDaysInFirstWeek() getMinimalDaysInFirstWeek},
	 * {@link #getGregorianChange() getGregorianChange} and
	 ...
	 * <code>GregorianCalendar</code> instance. The highest minimum value is
	 * defined as the largest value returned by {@link #getActualMinimum(int)}
	 * for any possible time value, taking into consideration the current values
	 * of the {@link Calendar#getFirstDayOfWeek() getFirstDayOfWeek},
	 * {@link Calendar#getMinimalDaysInFirstWeek() getMinimalDaysInFirstWeek},
	 * {@link #getGregorianChange() getGregorianChange} and
	 ...
	 * <code>GregorianCalendar</code> instance. The lowest maximum value is
	 * defined as the smallest value returned by {@link #getActualMaximum(int)}
	 * for any possible time value, taking into consideration the current values
	 * of the {@link Calendar#getFirstDayOfWeek() getFirstDayOfWeek},
	 * {@link Calendar#getMinimalDaysInFirstWeek() getMinimalDaysInFirstWeek},
	 * {@link #getGregorianChange() getGregorianChange} and
	...
	/**
	 * Returns the minimum value that this calendar field could have, taking
	 * into consideration the given time value and the current values of the
	 ...
	 *
	 * <p>
	 * For example, if the Gregorian change date is January 10, 1970 and the
	 * date of this <code>GregorianCalendar</code> is January 20, 1970, the
	 * actual minimum value of the <code>DAY_OF_MONTH</code> field is 10 because
	 * the previous date of January 10, 1970 is December 27, 1996 (in the Julian
	 * calendar). Therefore, December 28, 1969 to January 9, 1970 don't exist.
	 *
	 * @param field
	 *              the calendar field
	 * @return the minimum of the given field for the time value of this
	...
	public int getActualMinimum(int field) {
		if (field == DAY_OF_MONTH) {
			...
			if (year == gregorianCutoverYear
					|| year == gregorianCutoverYearJulian) {
				long month1 = getFixedDateMonth1(gc.cdate, gc.calsys
						.getFixedDate(gc.cdate));
	...
	/**
	 * Returns the maximum value that this calendar field could have, taking
	 * into consideration the given time value and the current values of the
	 * {@link Calendar#getFirstDayOfWeek() getFirstDayOfWeek},
	 * {@link Calendar#getMinimalDaysInFirstWeek() getMinimalDaysInFirstWeek},
	 * {@link #getGregorianChange() getGregorianChange} and
	 * {@link Calendar#getTimeZone() getTimeZone} methods. For example, if the
	 * date of this instance is February 1, 2004, the actual maximum value of
	 * the <code>DAY_OF_MONTH</code> field is 29 because 2004 is a leap year,
	 * and if the date of this instance is February 1, 2005, it's 28.
	 *
	 * <p>
	 * This method calculates the maximum value of {@link Calendar#WEEK_OF_YEAR
	 * WEEK_OF_YEAR} based on the {@link Calendar#YEAR YEAR} (calendar year)
	 * value, not the <a href="#week_year">week year</a>. Call
	 * {@link #getWeeksInWeekYear()} to get the maximum value of {@code
	 * WEEK_OF_YEAR} in the week year of this {@code GregorianCalendar}.
	 *
	 * @param field
	 *              the calendar field
	 * @return the maximum of the given field for the time value of this
	 *         <code>GregorianCalendar</code>
	 * @see #getMinimum(int)
	 * @see #getMaximum(int)
	 * @see #getGreatestMinimum(int)
	...
	public int getActualMaximum(int field) {
		final int fieldsForFixedMax = ERA_MASK | DAY_OF_WEEK_MASK | HOUR_MASK
				| AM_PM_MASK | HOUR_OF_DAY_MASK | MINUTE_MASK | SECOND_MASK
				| MILLISECOND_MASK | ZONE_OFFSET_MASK | DST_OFFSET_MASK;
		...
		switch (field) {
			case MONTH: {
				...
				long nextJan1;
				do {
					nextJan1 = gcal.getFixedDate(++normalizedYear,
			...
			case DAY_OF_MONTH: {
				...
				if (!gc.isCutoverYear(normalizedYear) || date
						.getDayOfMonth() == value) {
					break;
				}
				...
				long monthEnd = gc.getFixedDateMonth1(gc.cdate, fd)
						+ monthLength - 1;
			...
			case DAY_OF_YEAR: {
				...
				assert jan1 <= cal.getFixedDate(date.getNormalizedYear(), date
						.getMonth(), date.getDayOfMonth(), date);
			...
			case WEEK_OF_YEAR: {
				if (!gc.isCutoverYear(normalizedYear)) {
					...
					if ((magic == 6) || (date.isLeapYear() && (magic == 5
							|| magic == 12))) {
						value++;
					}
					break;
			...
			case WEEK_OF_MONTH: {
				if (!gc.isCutoverYear(normalizedYear)) {
					...
					int nDaysFirstWeek = 7 - dayOfWeek; // # of days in the first
														// week
					value = 3;
			...
			case DAY_OF_WEEK_IN_MONTH: {
				...
				if (!gc.isCutoverYear(normalizedYear)) {
					...
					// Let a cloned GregorianCalendar take care of the cutover
					// cases.
					if (gc == this) {
			 ...
			 * others,
			 * however, the range of possible maxima is large. In addition, the
			 * way
			 * we know we've exceeded the range is different. For these reasons,
			 * we
			 * use the special case code below to handle this field.
			 * The actual maxima for YEAR depend on the type of calendar:
			 * Gregorian = May 17, 292275056 BCE - Aug 17, 292278994 CE Julian =
			 * Dec
			 * 2, 292269055 BCE - Jan 3, 292272993 CE Hybrid = Dec 2, 292269055
			 * BCE
			 * - Aug 17, 292278994 CE
			 * We know we've exceeded the maximum when either the month, date,
			 * time,
			 * or era changes in response to setting the year. We don't check
			 * for
			 * month, date, and time here because the year and era are
			 * sufficient to
			 * detect an invalid year setting. NOTE: If code is added to check
			 * the
			 * month and date in the future for some reason, Feb 29 must be
			 * allowed
			 * to shift to Mar 1 when setting the year.
			 */
			{
				if (gc == this) {
					gc = (GregorianCalendar) clone();
				...
				if (gc.internalGetEra() == CE) {
					...
					CalendarSystem mincal = gc
							.getTimeInMillis() >= gregorianCutover ? gcal
									: getJulianCalendarSystem();
					CalendarDate d = mincal.getCalendarDate(Long.MIN_VALUE,
							getZone());
	...
	/**
	 * Returns the millisecond offset from the beginning of this year. This
	 * Calendar object must have been normalized.
	 */
	private long getYearOffsetInMillis() {
		...
		t *= 1000;
		return t + internalGet(MILLISECOND) - (internalGet(ZONE_OFFSET)
				+ internalGet(DST_OFFSET));
	}
	...
	/**
	 * Returns {@code true} indicating this {@code GregorianCalendar} supports
	 * week dates.
	 *
	 ...
	 * maximum week number of the week year have the same week year value that
	 * may be one year before or after the {@link Calendar#YEAR YEAR} (calendar
	 * year) value.
	 *
	 * <p>
	 * This method calls {@link Calendar#complete()} before calculating the week
	 * year.
	 *
	 * @return the week year represented by this {@code GregorianCalendar}. If
	 *         the {@link Calendar#ERA ERA} value is {@link #BC}, the year is
	 *         represented by 0 or a negative number: BC 1 is 0, BC 2 is -1, BC
	 *         3 is -2, and so on.
	 * @throws IllegalArgumentException
	 *                                  if any of the calendar fields is invalid
	 *                                  in non-lenient mode.
	...
	/**
	 * Sets this {@code GregorianCalendar} to the date given by the date
	 * specifiers - <a href="#week_year">{@code weekYear}</a>,
	 * {@code weekOfYear}, and {@code dayOfWeek}. {@code weekOfYear} follows the
	 * <a href="#week_and_year">{@code WEEK_OF_YEAR} numbering</a>. The
	 * {@code dayOfWeek} value must be one of the {@link Calendar#DAY_OF_WEEK
	 * DAY_OF_WEEK} values: {@link Calendar#SUNDAY SUNDAY} to
	 * {@link Calendar#SATURDAY SATURDAY}.
	 *
	 * <p>
	 * Note that the numeric day-of-week representation differs from the ISO
	 * 8601 standard, and that the {@code weekOfYear} numbering is compatible
	 * with the standard when {@code
	 * getFirstDayOfWeek()} is {@code MONDAY} and {@code
	 * getMinimalDaysInFirstWeek()} is 4.
	 *
	 * <p>
	 * Unlike the {@code set} method, all of the calendar fields and the instant
	 * of time value are calculated upon return.
	 *
	 * <p>
	 * If {@code weekOfYear} is out of the valid week-of-year range in
	 * {@code weekYear}, the {@code weekYear} and {@code weekOfYear} values are
	 * adjusted in lenient mode, or an {@code IllegalArgumentException} is
	 ...
	 *                   {@link #DAY_OF_WEEK DAY_OF_WEEK} field:
	 *                   {@link Calendar#SUNDAY
	 *                   SUNDAY}, ..., {@link Calendar#SATURDAY SATURDAY}.
	 * @exception IllegalArgumentException
	 *                                     if any of the given date specifiers
	 *                                     is invalid, or if any
	 *                                     of the calendar fields are
	 *                                     inconsistent with the given
	 *                                     date specifiers in non-lenient mode
	...
	public void setWeekDate(int weekYear, int weekOfYear, int dayOfWeek) {
		...
		if (!isLenient() && (gc.getWeekYear() != weekYear || gc.internalGet(
				WEEK_OF_YEAR) != weekOfYear || gc.internalGet(
	 ...
	 *
	 * <p>
	 * For example, if this {@code GregorianCalendar}'s date is December 31,
	 * 2008 with <a href="#iso8601_compatible_setting">the ISO 8601 compatible
	 * setting</a>, this method will return 53 for the period: December 29, 2008
	 * to January 3, 2010 while {@link #getActualMaximum(int)
	 * getActualMaximum(WEEK_OF_YEAR)} will return 52 for the period: December
	 * 31, 2007 to December 28, 2008.
	 *
	...
	/**
	 * The fixed date corresponding to gdate. If the value is Long.MIN_VALUE,
	 * the fixed date value is unknown. Currently, Julian calendar dates are not
	 * cached.
	 */
	 ...
	 * <a href="Calendar.html#Epoch">Epoch</a>) to calendar field values. The
	...
	protected void computeFields() {
		...
		if (isPartiallyNormalized()) {
			...
			if (fieldMask != 0 || calsys == null) {
				mask |= computeFields(fieldMask, mask & (ZONE_OFFSET_MASK
						| DST_OFFSET_MASK));
	...
	/**
	 * This computeFields implements the conversion from UTC (millisecond offset
	 * from the Epoch) to calendar field values. fieldMask specifies which
	 * fields to change the setting state to COMPUTED, although all fields are
	 * set to the correct values. This is required to fix 4685354.
	 *
	 * @param fieldMask
	 *                  a bit mask to specify which fields to change the setting
	 *                  state.
	 * @param tzMask
	 *                  a bit mask to specify which time zone offset fields to
	 *                  be used
	 *                  for time calculations
	 * @return a new field mask that indicates what field values have actually
	 *         been set.
	 */
	private int computeFields(int fieldMask, int tzMask) {
		...
		if (fixedDate >= gregorianCutoverDate) {
			...
			assert cachedFixedDate == Long.MIN_VALUE || gdate
					.isNormalized() : "cache control: not normalized";
			assert cachedFixedDate == Long.MIN_VALUE || gcal.getFixedDate(gdate
					.getNormalizedYear(), gdate.getMonth(), gdate
							.getDayOfMonth(),
					gdate) == cachedFixedDate : "cache control: inconsictency"
							+ ", cachedFixedDate=" + cachedFixedDate
							+ ", computed=" + gcal.getFixedDate(gdate
									.getNormalizedYear(), gdate.getMonth(),
									gdate.getDayOfMonth(), gdate) + ", date="
							+ gdate;
			...
			calsys = gcal;
			cdate = gdate;
			assert cdate.getDayOfWeek() > 0 : "dow=" + cdate.getDayOfWeek()
					+ ", date=" + cdate;
		} else {
		...
		if ((fieldMask & (MONTH_MASK | DAY_OF_MONTH_MASK
				| DAY_OF_WEEK_MASK)) != 0) {
		...
		if ((fieldMask & (HOUR_OF_DAY_MASK | AM_PM_MASK | HOUR_MASK
			...
			mask |= (HOUR_OF_DAY_MASK | AM_PM_MASK | HOUR_MASK | MINUTE_MASK
		...
		if ((fieldMask & (DAY_OF_YEAR_MASK | WEEK_OF_YEAR_MASK
			...
			long fixedDateJan1 = calsys.getFixedDate(normalizedYear, 1, 1,
					cdate);
			int dayOfYear = (int) (fixedDate - fixedDateJan1) + 1;
			long fixedDateMonth1 = fixedDate - dayOfMonth + 1;
			int cutoverGap = 0;
			int cutoverYear = (calsys == gcal) ? gregorianCutoverYear
			...
			if (weekOfYear == 0) {
				...
				if (normalizedYear > (cutoverYear + 1)) {
					...
					int prevYear = getCalendarDate(fixedDec31)
							.getNormalizedYear();
				...
				if (normalizedYear > gregorianCutoverYear
					...
					if (weekOfYear >= 52) {
						...
						long nextJan1st = BaseCalendar
								.getDayOfWeekDateOnOrBefore(nextJan1 + 6,
										getFirstDayOfWeek());
						int ndays = (int) (nextJan1st - nextJan1);
						if (ndays >= getMinimalDaysInFirstWeek()
								&& fixedDate >= (nextJan1st - 7)) {
							// The first days forms a week in which the date is
							// included.
							weekOfYear = 1;
						}
					}
			...
			internalSet(WEEK_OF_YEAR, weekOfYear);
			internalSet(WEEK_OF_MONTH, getWeekNumber(fixedDateMonth1,
					fixedDate));
	 ...
	 * The getFirstDayOfWeek-getMinimalDaysInFirstWeek rule is applied to
	 ...
	 * the <a href="Calendar.html#Epoch">Epoch</a>).
	 *
	 * @exception IllegalArgumentException
	...
	protected void computeTime() {
		...
		if (!isLenient()) {
			...
			for (int field = 0; field < FIELD_COUNT; field++) {
				...
				if (isExternallySet(field)) {
					...
					if (value < getMinimum(field) || value > getMaximum(
							field)) {
		...
		calculateFixedDate: {
			...
			if (year > gregorianCutoverYear
				...
				jfd = fixedDate + getFixedDate(getJulianCalendarSystem(), year,
						fieldMask);
			...
			if (isFieldSet(fieldMask, DAY_OF_YEAR) || isFieldSet(fieldMask,
					WEEK_OF_YEAR)) {
				if (gregorianCutoverYear == gregorianCutoverYearJulian) {
					fixedDate = jfd;
					break calculateFixedDate;
		...
		if (!isLenient()) {
			for (int field = 0; field < FIELD_COUNT; field++) {
				...
				if (originalFields[field] != internalGet(field)) {
					String s = originalFields[field] + " -> " + internalGet(
							field);
					// Restore the original field values
					System.arraycopy(originalFields, 0, fields, 0,
							fields.length);
					throw new IllegalArgumentException(getFieldName(field)
							+ ": " + s);
				}
	...
	/**
	 * Computes the fixed date under either the Gregorian or the Julian
	 * calendar, using the given year and the specified calendar fields.
	 *
	 * @param cal
	 *                  the CalendarSystem to be used for the date calculation
	 * @param year
	 *                  the normalized year number, with 0 indicating the year 1
	 *                  BCE,
	 *                  -1 indicating 2 BCE, etc.
	 * @param fieldMask
	...
	private long getFixedDate(BaseCalendar cal, int year, int fieldMask) {
		...
		long fixedDate = cal.getFixedDate(year, month + 1, 1, cal == gcal
				? gdate
				: null);
		if (isFieldSet(fieldMask, MONTH)) {
			...
			if (isFieldSet(fieldMask, DAY_OF_MONTH)) {
				...
				if (isFieldSet(fieldMask, WEEK_OF_MONTH)) {
					long firstDayOfWeek = BaseCalendar
							.getDayOfWeekDateOnOrBefore(fixedDate + 6,
									getFirstDayOfWeek());
					// If we have enough days in the first week, then
					// move to the previous week.
					if ((firstDayOfWeek
							- fixedDate) >= getMinimalDaysInFirstWeek()) {
						firstDayOfWeek -= 7;
					}
					if (isFieldSet(fieldMask, DAY_OF_WEEK)) {
						firstDayOfWeek = BaseCalendar
								.getDayOfWeekDateOnOrBefore(firstDayOfWeek + 6,
										internalGet(DAY_OF_WEEK));
					}
					// In lenient mode, we treat days of the previous
					// months as a part of the specified
					// WEEK_OF_MONTH. See 4633646.
					fixedDate = firstDayOfWeek + 7 * (internalGet(WEEK_OF_MONTH)
							- 1);
				} else {
					int dayOfWeek;
					if (isFieldSet(fieldMask, DAY_OF_WEEK)) {
					...
					if (dowim >= 0) {
						fixedDate = BaseCalendar.getDayOfWeekDateOnOrBefore(
								fixedDate + (7 * dowim) - 1, dayOfWeek);
					} else {
						// Go to the first day of the next week of
						// the specified week boundary.
						int lastDate = monthLength(month, year) + (7 * (dowim
								+ 1));
						// Then, get the day of week date on or before the last
						// date.
						fixedDate = BaseCalendar.getDayOfWeekDateOnOrBefore(
			...
			if (isFieldSet(fieldMask, DAY_OF_YEAR)) {
				...
				long firstDayOfWeek = BaseCalendar.getDayOfWeekDateOnOrBefore(
						fixedDate + 6, getFirstDayOfWeek());
				...
				fixedDate = firstDayOfWeek + 7 * ((long) internalGet(
						WEEK_OF_YEAR) - 1);
			}
		}
	 ...
	 * Otherwise, a cloned object is returned after calling complete() in
	 * lenient mode.
	 */
	...
	/**
	 * Returns the Julian calendar system instance (singleton). 'jcal' and
	 * 'jeras' are set upon the return.
	 */
	...
	/**
	 * Returns the calendar system for dates before the cutover date in the
	 * cutover year. If the cutover date is January 1, the method returns
	 * Gregorian. Otherwise, Julian.
	 */
	...
	/**
	 * Determines if the specified year (normalized) is the Gregorian cutover
	 * year. This object must have been normalized.
	 */
	...
	/**
	 * Returns the fixed date of the first day of the year (usually January 1)
	 * before the specified date.
	 *
	 * @param date
	 *                  the date for which the first day of the year is
	 *                  calculated.
	 *                  The date has to be in the cut-over year (Gregorian or
	 *                  Julian).
	 * @param fixedDate
	 *                  the fixed date representation of the date
	 */
	private long getFixedDateJan1(BaseCalendar.Date date, long fixedDate) {
		assert date.getNormalizedYear() == gregorianCutoverYear || date
				.getNormalizedYear() == gregorianCutoverYearJulian;
		if (gregorianCutoverYear != gregorianCutoverYearJulian) {
			if (fixedDate >= gregorianCutoverDate) {
		...
		BaseCalendar juliancal = getJulianCalendarSystem();
		return juliancal.getFixedDate(date.getNormalizedYear(),
				BaseCalendar.JANUARY, 1, null);
	}

	/**
	 * Returns the fixed date of the first date of the month (usually the 1st of
	 * the month) before the specified date.
	 *
	 * @param date
	...
	private long getFixedDateMonth1(BaseCalendar.Date date, long fixedDate) {
		...
		if (gCutover.getMonth() == BaseCalendar.JANUARY && gCutover
				.getDayOfMonth() == 1) {
	...
	/**
	 * Returns the Gregorian cutover date as a BaseCalendar.Date. The date is a
	 * Gregorian date.
	 */
	...
	/**
	 * Returns the length of the specified month in the year provided by
	 * internalGet(YEAR).
	 *
	 * @see #isLeapYear(int)
	 */
	...
	private int actualMonthLength() {
		...
		if (cdate != gdate) {
			date = (BaseCalendar.Date) gcal.newCalendarDate(
					TimeZone.NO_TIMEZONE);
		}
	...
	/**
	 * After adjustments such as add(MONTH), add(YEAR), we don't want the month
	 * to jump around. E.g., we don't want Jan 31 + 1 month to go to Mar 3, we
	 * want it to go to Feb 28. Adjustments which might run into this problem
	...
	/**
	 * Returns the fixed date value of this object. The time value and calendar
	 * fields must be in synch.
	 */
	...
	/**
	 * Returns the ERA. We need a special method for this because the default
	 * ERA is CE, but a zero (unset) ERA is BCE.
	 */
	...
	/**
	 * Converts this object to a {@code ZonedDateTime} that represents the same
	 * point on the time-line as this {@code GregorianCalendar}.
	 * <p>
	 ...
	 * correct date in the ISO calendar system, which will also be the same
	 * value for Modified Julian Days.
	 *
	 * @return a zoned date-time representing the same point on the time-line as
	 ...
	 * Gregorian calendar and uses ISO 8601 standard for week definitions, which
	 * has {@code MONDAY} as the {@link Calendar#getFirstDayOfWeek()
	 ...
	 *                                     if {@code zdt} is null
	 * @exception IllegalArgumentException
	 *                                     if the zoned date-time is too large
	 *                                     to represent as a
	 *                                     {@code GregorianCalendar}
	 * @since 1.8
	 */
	public static GregorianCalendar from(ZonedDateTime zdt) {
		GregorianCalendar cal = new GregorianCalendar(TimeZone.getTimeZone(zdt
				.getZone()));
		cal.setGregorianChange(new Date(Long.MIN_VALUE));
		cal.setFirstDayOfWeek(MONDAY);
		cal.setMinimalDaysInFirstWeek(4);
		try {
			cal.setTimeInMillis(Math.addExact(Math.multiplyExact(zdt
					.toEpochSecond(), 1000), zdt.get(
