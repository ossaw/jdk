...
/**
 * The <code>JarOutputStream</code> class is used to write the contents of a JAR
 * file to any output stream. It extends the class
 * <code>java.util.zip.ZipOutputStream</code> with support for writing an
...
public class JarOutputStream extends ZipOutputStream {
     ...
     * <code>Manifest</code>. The manifest is written as the first entry to the
     * output stream.
     *
     * @param out
    ...
    /**
     * Begins writing a new JAR file entry and positions the stream to the start
     * of the entry data. This method will also close any previous entry. The
     * default compression method will be used if no compression method was
     * specified for the entry. The current time will be used if the entry has
    ...
    /*
     * Returns true if specified byte array contains the jar magic extra field
     * id.
     */
    ...
    /*
     * Sets 16-bit value at specified offset. The bytes are assumed to be in
