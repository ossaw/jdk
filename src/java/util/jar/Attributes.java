 ...
 * ASCII characters in the set [0-9a-zA-Z_-], and cannot exceed 70 characters in
 * length. Attribute values can contain any characters and will be UTF8-encoded
 * when written to the output stream. See the
 * <a href="../../../../technotes/guides/jar/jar.html">JAR File
 * Specification</a> for more information about valid attribute names and
 * values.
 *
...
public class Attributes implements Map<Object, Object>, Cloneable {
     ...
     * or null if the attribute was not found. The attribute name is
     * case-insensitive.
     * <p>
     ...
     * this Map. If the Map previously contained a mapping for the attribute
     ...
     * specified as a String. The attributes name is case-insensitive. If the
     * Map previously contained a mapping for the attribute name, the old value
     * is replaced.
     * <p>
     * This method is defined as:
     * 
     ...
     * Returns true if the given object is also an instance of Attributes and
    ...
    /*
     * Writes the current attributes to the specified data output stream. XXX
    ...
    /*
     * Reads attributes from the specified input stream. XXX Need to handle UTF8
     * values.
     */
     ...
     * Map. Valid attribute names are case-insensitive, are restricted to the
    ...
    public static class Name {
        ...
        /**
         * <code>Name</code> object for <code>Manifest-Version</code> manifest
        ...
        /**
         * <code>Name</code> object for <code>Class-Path</code> manifest
         * attribute. Bundled extensions can use this attribute to find other
         * JAR files containing needed classes.
         * 
         ...
         * attribute used for launching applications packaged in JAR files. The
         * <code>Main-Class</code> attribute is used in conjunction with the
         * <code>-jar</code> command-line option of the <tt>java</tt>
