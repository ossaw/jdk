 ...
 * operations are provided, as well as a method to <tt>peek</tt> at the top item
 * on the stack, a method to test for whether the stack is <tt>empty</tt>, and a
 * method to <tt>search</tt> the stack for an item and discover how far it is
 * from the top.
 * <p>
