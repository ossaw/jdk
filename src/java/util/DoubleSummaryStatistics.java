 ...
 * statistics on a stream of doubles with:
 * 
 * <pre>
 * {
 *     &#64;code
 ...
 * a {@linkplain java.util.stream.Stream stream}. For example:
 *
 * <pre>
 * {
 *     &#64;code
 ...
 *           Collectors.toDoubleStatistics()} on a parallel stream, because the
