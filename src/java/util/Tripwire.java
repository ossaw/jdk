...
/**
 * Utility class for detecting inadvertent uses of boxing in {@code java.util}
 * classes. The detection is turned on or off based on whether the system
 * property {@code org.openjdk.java.util.stream.tripwire} is considered
 * {@code true} according to {@link Boolean#getBoolean(String)}. This should
 * normally be turned off for production use.
 *
