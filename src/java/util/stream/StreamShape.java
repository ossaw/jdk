 ...
 * Each will correspond to a specific subinterface of {@link BaseStream} (e.g.,
 * {@code REFERENCE} corresponds to {@code Stream}, {@code INT_VALUE}
 ...
 *          has both generic type parameters for its input types, and a getter
