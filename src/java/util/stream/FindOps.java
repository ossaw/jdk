...
final class FindOps {
	 ...
	 * @param mustFindFirst
	 *            whether the {@code TerminalOp} must produce the first element
	 ...
	 * @param <O>
	 *            the result type of the find operation, typically an optional
	 *            type
	 */
	private static final class FindOp<T, O> implements TerminalOp<T, O> {
		 ...
		 *
		 * @param mustFindFirst
		 *            if true, must find the first element in encounter order,
		 ...
		 *            {@code Predicate} on result value corresponding to
		 *            "found something"
		 * @param sinkSupplier
		 *            supplier for a {@code TerminalSink} implementing the
