...
/**
 * Factory for creating instances of {@code TerminalOp} that perform an action
 * for every element of a stream. Supported variants include unordered traversal
...
final class ForEachOps {
    ...
    /**
     * A {@code ForkJoinTask} for performing a parallel for-each operation which
     * visits the elements in encounter order
     */
    @SuppressWarnings("serial")
        ...
        private static <S, T> void doCompute(ForEachOrderedTask<S, T> task) {
            ...
            while (rightSplit.estimateSize() > sizeThreshold
                ...
                if (task.leftPredecessor != null) {
                     ...
                     * right subtree. The left child's pending count needs to be
                     * updated before it is associated in the completion map,
                     * otherwise the left child can complete prematurely and
                     * violate the "happens-before" constraint.
                     */
