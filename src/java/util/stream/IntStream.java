...
public interface IntStream extends BaseStream<Integer, IntStream> {
     ...
     *          source (such as {@link #generate(IntSupplier)}) or removing the
     ...
     *          {@link #generate(IntSupplier)}) or removing the ordering
     ...
     * <a href="package-summary.html#Associativity">associative</a> accumulation
     * function, and returns an {@code OptionalInt} describing the reduced
    ...
    /**
     * Returns an infinite sequential ordered {@code IntStream} produced by
    ...
    public static IntStream iterate(final int seed, final IntUnaryOperator f) {
        ...
        return StreamSupport.intStream(Spliterators.spliteratorUnknownSize(iterator, Spliterator.ORDERED
    ...
    public static IntStream generate(IntSupplier s) {
        ...
        return StreamSupport.intStream(new StreamSpliterators.InfiniteSupplyingSpliterator.OfInt(
                Long.MAX_VALUE, s), false);
    }

    /**
     * Returns a sequential ordered {@code IntStream} from
    ...
    public static IntStream range(int startInclusive, int endExclusive) {
        if (startInclusive >= endExclusive) {
            ...
            return StreamSupport.intStream(new Streams.RangeIntSpliterator(startInclusive, endExclusive,
                    false), false);
        }
    }
    ...
    public static IntStream rangeClosed(int startInclusive, int endInclusive) {
        if (startInclusive > endInclusive) {
            ...
            return StreamSupport.intStream(new Streams.RangeIntSpliterator(startInclusive, endInclusive,
                    true), false);
        }
    }
