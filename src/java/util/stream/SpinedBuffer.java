...
class SpinedBuffer<E> extends AbstractSpinedBuffer implements Consumer<E>, Iterable<E> {
            ...
            public Spliterator<E> trySplit() {
                if (splSpineIndex < lastSpineIndex) {
                    ...
                    if (t == 0)
                        ...
                        Spliterator<E> ret = Arrays.spliterator(splChunk, splElementIndex, splElementIndex
                                + t);
                        splElementIndex += t;
                        return ret;
                    }
     ...
     */
    static class OfDouble extends SpinedBuffer.OfPrimitive<Double, double[], DoubleConsumer> implements
            DoubleConsumer {
        OfDouble() {}
