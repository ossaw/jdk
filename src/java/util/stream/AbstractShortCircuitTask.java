...
/**
 * Abstract class for fork-join tasks used to implement short-circuiting stream
 * ops, which can produce a result without processing all elements of the
 * stream.
 *
 * @param <P_IN>
...
abstract class AbstractShortCircuitTask<P_IN, P_OUT, R, K extends AbstractShortCircuitTask<P_IN, P_OUT, R, K>>
	...
	/**
	 * Overrides AbstractTask version to include checks for early exits while
	 * splitting or computing.
	 */
	@Override
	public void compute() {
	...
	protected void cancelLaterNodes() {
		...
		K parent = getParent(), node = (K) this; parent != null; node = parent, parent = parent
				.getParent()) {
