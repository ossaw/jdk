...
public interface BaseStream<T, S extends BaseStream<T, S>> extends AutoCloseable {
     ...
     * handlers are run when the {@link #close()} method is called on the
     * stream, and are executed in the order they were added. All close handlers
     * are run, even if earlier close handlers throw exceptions. If any close
     * handler throws an exception, the first exception thrown will be relayed
     * to the caller of {@code close()}, with any remaining exceptions added to
