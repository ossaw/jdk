...
/**
 * The subclass of {@link SQLException} thrown for the SQLState class value '
 * <i>08</i>', or under vendor-specified conditions. This indicates that the
 * connection operation that failed will not succeed if the operation is retried
 * without the cause of the failure being corrected.
 * <p>
...
public class SQLNonTransientConnectionException extends java.sql.SQLNonTransientException {
    ...
    /**
     * Constructs a <code>SQLNonTransientConnectionException</code> object with
     * a given <code>cause</code>. The <code>SQLState</code> is initialized to
    ...
    /**
     * Constructs a <code>SQLTransientException</code> object with a given
    ...
    /**
     * Constructs a <code>SQLNonTransientConnectionException</code> object with
     * a given <code>reason</code>, <code>SQLState</code> and <code>cause</code>
