...
public class BatchUpdateException extends SQLException {
	 ...
	 * and <code>updateCounts</code>. The <code>cause</code> is not initialized,
	 * and may subsequently be initialized by a call to the
	 * {@link Throwable#initCause(java.lang.Throwable)} method.
	 * <p>
	 * <strong>Note:</strong> There is no validation of {@code updateCounts} for
	 * overflow and because of this it is recommended that you use the
	 * constructor {@code BatchUpdateException(String reason, String SQLState,
	 ...
	 * @param updateCounts
	 *            an array of <code>int</code>, with each element indicating the
	 *            update count, <code>Statement.SUCCESS_NO_INFO</code> or
	 ...
	 * <code>updateCounts</code>. The <code>cause</code> is not initialized, and
	 ...
	 * <code>cause</code> is not initialized, and may subsequently be
	 * initialized by a call to the
	 * {@link Throwable#initCause(java.lang.Throwable)} method. The
	 * <code>SQLState</code> is initialized to <code>null</code> and the vendor
	 ...
	 * {@link Throwable#initCause(java.lang.Throwable)} method. The
	 * <code>reason</code> and <code>SQLState</code> are initialized to null and
	 ...
	 * <code>reason</code>, <code>SQLState</code> and <code>updateCounts</code>
	 * are initialized to <code>null</code> and the vendor code is initialized
	 * to 0. The <code>cause</code> is not initialized, and may subsequently be
	 * initialized by a call to the
	 * {@link Throwable#initCause(java.lang.Throwable)} method.
	 * <p>
	 *
	 ...
	 * <code>updateCounts</code> are initialized to <code>null</code> and the
	 * vendor code is initialized to 0. The <code>reason</code> is initialized
	 * to <code>null</code> if <code>cause==null</code> or to
	 ...
	 * <code>updateCounts</code>. The <code>SQLState</code> is initialized to
	 ...
	 *            {@code updateCounts} for overflow and because of this it is
	...
	/*
	 * Utility method to copy long[] updateCount to int[] updateCount. No checks
	 * for overflow will be done as it is expected a user will call
