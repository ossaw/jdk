...
/**
 * <P>
 * The subclass of {@link SQLException} thrown when the timeout specified by
 * {@code Statement.setQueryTimeout}, {@code DriverManager.setLoginTimeout},
 * {@code DataSource.setLoginTimeout},{@code XADataSource.setLoginTimeout} has
 * expired.
 * <P>
...
public class SQLTimeoutException extends SQLTransientException {
    /**
     * Constructs a <code>SQLTimeoutException</code> object. The
    ...
    /**
     * Constructs a <code>SQLTimeoutException</code> object with a given
