...
public class Time extends java.util.Date {
	 ...
	 * for the hour, minute, and second. The driver sets the date components to
	 * January 1, 1970. Any method that attempts to access the date components
	 * of a <code>Time</code> object will throw a
	...
	/**
	 * Converts a string in JDBC time escape format to a <code>Time</code>
	 * value.
	 *
	 * @param s
