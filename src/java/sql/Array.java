...
public interface Array {
	...
	/**
	 * Retrieves the contents of the SQL <code>ARRAY</code> value designated by
	 * this <code>Array</code> object. This method uses the specified
	 * <code>map</code> for type map customizations unless the base type of the
	 * array does not match a user-defined type in <code>map</code>, in which
	 * case it uses the standard mapping. This version of the method
	 * <code>getArray</code> uses either the given type map or the standard
	 ...
	 * <code>Array</code> object, beginning with the specified
	 ...
	 * given type map or the standard mapping; it never uses the type map
	 ...
	 * appropriate, the elements of the array are mapped using the connection's
	 ...
	 * ascending order based on the indices. Each row has two columns: The
	 ...
	 * Retrieves a result set holding the elements of the subarray that starts
	 * at index <code>index</code> and contains up to <code>count</code>
	 * successive elements. This method uses the specified <code>map</code> for
	 * type map customizations unless the base type of the array does not match
	 * a user-defined type in <code>map</code>, in which case it uses the
