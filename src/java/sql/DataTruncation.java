...
public class DataTruncation extends SQLWarning {
     ...
     * initialized to 01004 when <code>read</code> is set to <code>true</code>
     * and 22001 when <code>read</code> is set to <code>false</code>, the reason
     * set to "Data truncation", the vendor code set to 0, and the other fields
     * set to the given values. The <code>cause</code> is not initialized, and
     ...
     *
     * <P>
     * This may be -1 if the column or parameter index is unknown, in which case
     * the <code>parameter</code> and <code>read</code> fields should be
     * ignored.
     *
