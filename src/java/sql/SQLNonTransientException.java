...
/**
 * The subclass of {@link SQLException} thrown when an instance where a retry of
 * the same operation would fail unless the cause of the
 * <code>SQLException</code> is corrected.
 * <p>
 *
 * @since 1.6
 */
public class SQLNonTransientException extends java.sql.SQLException {
	...
	/**
	 * Constructs a <code>SQLNonTransientException</code> object. The
	...
	/**
	 * Constructs a <code>SQLNonTransientException</code> object with a given
