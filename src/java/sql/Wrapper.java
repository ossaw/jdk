 ...
 * provide extensions beyond the traditional JDBC API that are specific to a
 * data source. Developers may wish to gain access to these resources that are
 * wrapped (the delegates) as proxy class instances representing the the actual
 * resources. This interface describes a standard mechanism to access these
 * wrapped resources represented by their proxy, to permit direct access to the
 * resource delegates.
 *
 * @since 1.6
 */
