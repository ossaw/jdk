 ...
 * for each parameter marker in a <code>PreparedStatement</code> object. For
 * some queries and driver implementations, the data that would be returned by a
 * <code>ParameterMetaData</code> object may not be available until the
 * <code>PreparedStatement</code> has been executed.
 * <p>
...
public interface ParameterMetaData extends Wrapper {
	...
	/**
	 * The constant indicating that a parameter will not allow <code>NULL</code>
	 * values.
	 */
	int parameterNoNulls = 0;

	/**
	 * The constant indicating that a parameter will allow <code>NULL</code>
	 * values.
	 */
	...
	/**
	 * Retrieves the designated parameter's number of digits to right of the
