 ...
 * values wrapped by a <code>java.sql.Date</code> instance must be 'normalized'
...
public class Date extends java.util.Date {
	...
	/**
	 * Constructs a <code>Date</code> object initialized with the given year,
	 * month, and day.
	 * <P>
	 ...
	 * value. If the given milliseconds value contains time information, the
	 * driver will set the time components to the time in the default time zone
	 * (the time zone of the Java virtual machine running the application) that
	...
	/**
	 * Sets an existing <code>Date</code> object using the given milliseconds
	 * time value. If the given milliseconds value contains time information,
	 * the driver will set the time components to the time in the default time
	 * zone (the time zone of the Java virtual machine running the application)
	 ...
	 *             if the date given is not in the JDBC date escape format
	 *             (yyyy-[m]m-[d]d)
	 */
	...
	/**
	 * This method is deprecated and should not be used because SQL Date values
	...
	/**
	 * Obtains an instance of {@code Date} from a {@link LocalDate} object with
	 * the same year, month and day of month value as the given
	 * {@code LocalDate}.
	 * <p>
	 * The provided {@code LocalDate} is interpreted as the local date in the
	 * local time zone.
	 *
	 * @param date
	 ...
	 * be used because SQL {@code Date} values do not have a time component.
	 *
