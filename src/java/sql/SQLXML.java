...
public interface SQLXML {
	 ...
	 * The SQL XML object becomes invalid and neither readable or writeable when
	 ...
	 * The bytes of the input stream are interpreted according to appendix F of
	 * the XML 1.0 specification. The behavior of this method is the same as
	 * ResultSet.getBinaryStream() when the designated column of the ResultSet
	 ...
	 * SQLXML instance. The format of this String is defined by
	 * org.xml.sax.InputSource, where the characters in the stream represent the
	 * unicode code points for XML according to section 2 and appendix B of the
	 * XML 1.0 specification. Although an encoding declaration other than
	 * unicode may be present, the encoding of the String is unicode. The
	 * behavior of this method is the same as ResultSet.getString() when the
