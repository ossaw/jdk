...
/**
 * The output stream for writing the attributes of a user-defined type back to
 * the database. This interface, used only for custom mapping, is used by the
 * driver, and its methods are never directly invoked by a programmer.
 * <p>
 * When an object of a class implementing the interface <code>SQLData</code> is
 * passed as an argument to an SQL statement, the JDBC driver calls the method
 * <code>SQLData.getSQLType</code> to determine the kind of SQL datum being
 * passed to the database. The driver then creates an instance of
 * <code>SQLOutput</code> and passes it to the method
 * <code>SQLData.writeSQL</code>. The method <code>writeSQL</code> in turn calls
 * the appropriate <code>SQLOutput</code> <i>writer</i> methods
 * <code>writeBoolean</code>, <code>writeCharacterStream</code>, and so on) to
 * write data from the <code>SQLData</code> object to the <code>SQLOutput</code>
...
public interface SQLOutput {
    ...
    /**
     * Writes the next attribute to the stream as a Java boolean. Writes the
     * next attribute to the stream as a <code>String</code> in the Java
    ...
    /**
     * Writes the next attribute to the stream as a Java byte. Writes the next
     * attribute to the stream as a <code>String</code> in the Java programming
     * language.
     *
     * @param x
     *        the value to pass to the database
    ...
    /**
     * Writes the next attribute to the stream as a Java short. Writes the next
     * attribute to the stream as a <code>String</code> in the Java programming
     * language.
     *
     * @param x
    ...
    /**
     * Writes the next attribute to the stream as a Java int. Writes the next
     * attribute to the stream as a <code>String</code> in the Java programming
     * language.
     *
     * @param x
    ...
    /**
     * Writes the next attribute to the stream as a Java long. Writes the next
     * attribute to the stream as a <code>String</code> in the Java programming
     * language.
     *
     * @param x
    ...
    /**
     * Writes the next attribute to the stream as a Java float. Writes the next
     * attribute to the stream as a <code>String</code> in the Java programming
     * language.
     *
     * @param x
    ...
    /**
     * Writes the next attribute to the stream as a Java double. Writes the next
     * attribute to the stream as a <code>String</code> in the Java programming
     * language.
     *
     * @param x
    ...
    /**
     * Writes the next attribute to the stream as an array of bytes. Writes the
     * next attribute to the stream as a <code>String</code> in the Java
     * programming language.
     *
     * @param x
    ...
    /**
     * Writes the next attribute to the stream as a java.sql.Date object. Writes
     * the next attribute to the stream as a <code>java.sql.Date</code> object
    ...
    /**
     * Writes the next attribute to the stream as a java.sql.Time object. Writes
     * the next attribute to the stream as a <code>java.sql.Date</code> object
     * in the Java programming language.
     *
     * @param x
     ...
     * Writes the next attribute to the stream as a <code>java.sql.Date</code>
    ...
    /**
     * Writes the next attribute to the stream as a stream of Unicode
     * characters.
     *
     * @param x
     *        the value to pass to the database
     ...
     * writes the object's attributes to the stream. The implementation of the
     * method <code>SQLData.writeSQL</code> calls the appropriate
     * <code>SQLOutput</code> writer method(s) for writing each of the object's
     * attributes in order. The attributes must be read from an
     * <code>SQLInput</code> input stream and written to an
     * <code>SQLOutput</code> output stream in the same order in which they were
