...
/**
 * The subclass of {@link SQLException} thrown in situations where a previously
 * failed operation might be able to succeed if the application performs some
 * recovery steps and retries the entire transaction or in the case of a
 * distributed transaction, the transaction branch. At a minimum, the recovery
 * operation must include closing the current connection and getting a new
 * connection.
 * <p>
 *
 * @since 1.6
...
public class SQLRecoverableException extends java.sql.SQLException {
    ...
    /**
     * Constructs a <code>SQLRecoverableException</code> object. The
    ...
    /**
     * Constructs a <code>SQLRecoverableException</code> object with a given
