...
/**
 * This class provides the method <code>normalize</code> which transforms
 * Unicode text into an equivalent composed or decomposed form, allowing for
 * easier sorting and searching of text. The <code>normalize</code> method
 ...
 * their equivalents. Finally, the <code>normalize</code> method rearranges
 * accents into the proper canonical order, so that you do not have to worry
