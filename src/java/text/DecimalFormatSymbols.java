...
public class DecimalFormatSymbols implements Cloneable, Serializable {
     ...
     * {@link java.util.Locale.Category#FORMAT FORMAT} locale. This constructor
     * can only construct instances for the locales supported by the Java
     ...
     * <p>
     * This is equivalent to calling {@link #DecimalFormatSymbols(Locale)
    ...
    /**
     * Create a DecimalFormatSymbols object for the given locale. This
     ...
     * {@link java.text.spi.DecimalFormatSymbolsProvider
     * DecimalFormatSymbolsProvider} implementations. For full locale coverage,
     * use the {@link #getInstance(Locale) getInstance} method. If the specified
     * locale contains the {@link java.util.Locale#UNICODE_LOCALE_EXTENSION} for
     * the numbering system, the instance is initialized with the specified
     * numbering system if the JRE implementation supports it. For example,
     * 
     * <pre>
     ...
     * system, instead of the Latin numbering system.
     *
     * @param locale
     *        the desired locale
     ...
     * installed {@link java.text.spi.DecimalFormatSymbolsProvider
     ...
     * those supported by installed
     * {@link java.text.spi.DecimalFormatSymbolsProvider
     * DecimalFormatSymbolsProvider} implementations. If the specified locale
     * contains the {@link java.util.Locale#UNICODE_LOCALE_EXTENSION} for the
     * numbering system, the instance is initialized with the specified
     * numbering system if the JRE implementation supports it. For example,
     * 
     * <pre>
     * NumberFormat.getNumberInstance(Locale.forLanguageTag("th-TH-u-nu-thai"))
     ...
     * currency's symbol in the DecimalFormatSymbols' locale. If the currency
     * code is not valid, then the currency attribute is set to null and the
    ...
    public boolean equals(Object obj) {
        ...
        return (zeroDigit == other.zeroDigit && groupingSeparator == other.groupingSeparator
                && decimalSeparator == other.decimalSeparator && percent == other.percent
                && perMill == other.perMill && digit == other.digit && minusSign == other.minusSign
                && patternSeparator == other.patternSeparator && infinity.equals(other.infinity) && NaN
                        .equals(other.NaN) && currencySymbol.equals(other.currencySymbol)
                && intlCurrencySymbol.equals(other.intlCurrencySymbol) && currency == other.currency
                && monetarySeparator == other.monetarySeparator && exponentialSeparator.equals(
                        other.exponentialSeparator) && locale.equals(other.locale));
    }
    ...
    private void initialize(Locale locale) {
        ...
        LocaleProviderAdapter adapter = LocaleProviderAdapter.getAdapter(DecimalFormatSymbolsProvider.class,
                locale);
        ...
        exponentialSeparator = numberElements[7]; // string representation new
                                                  // since 1.6
    ...
    /**
     * Reads the default serializable fields, provides default values for
     * objects in older serial versions, and initializes non-serializable
     * fields. If <code>serialVersionOnStream</code> is less than 1, initializes
