...
/**
 * Utility class for normalizing and merging patterns for collation. This is to
 * be used with MergeCollation for adding patterns to an existing rule table.
 * 
 * @see MergeCollation
...
class PatternEntry {
	...
	/**
	 * WARNING this is used for searching in a Vector. Because Vector.indexOf
	 * doesn't take a comparator, this method is ill-defined and ignores
	 * strength.
	 */
