...
public interface AttributedCharacterIterator extends CharacterIterator {
	 ...
	 * keys are used in {@code AttributedCharacterIterator} and
	...
	public static class Attribute implements Serializable {
		 ...
		 * {@code readResolve} to look up the corresponding predefined instance
		 * when deserializing an instance.
		 * 
		 * @serial
		 */
		private String name;
		 ...
		 * {@code x.equals(y)} if {@code x} and {@code y} refer to the same
		 * object, and guarantees this for all subclasses.
		 */
		...
		/**
		 * Returns a hash code value for the object. This version is identical
		 * to the one in {@code Object}, but is also final.
		 */
		...
		/**
		 * Returns a string representation of the object. This version returns
		 * the concatenation of class name, {@code "("}, a name identifying the
		 * attribute and {@code ")"}.
		 */
		 ...
		 * <p>
		 * Values are instances of {@link Annotation} holding a {@code null}
		 * reference.
		 * 
		 * @see Annotation
		 */
	 ...
	 * have been given to those text segments separately.
	 *
	...
	/**
	 * Returns the value of the named {@code attribute} for the current
