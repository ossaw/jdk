 ...
 * <code>SimpleDateFormat</code> uses <code>DateFormatSymbols</code> to
 ...
 * , <code>getDateInstance</code>, or <code>getDateTimeInstance</code>. These
 * methods automatically create a <code>DateFormatSymbols</code> for the
 * formatter so that you don't have to. After the formatter is created, you may
 * modify its format pattern using the <code>setPattern</code> method. For more
 * information about creating formatters using <code>DateFormat</code>'s factory
 ...
 * </blockquote>
 * <p>
 * <code>DateFormatSymbols</code> objects are cloneable. When you obtain a
 * <code>DateFormatSymbols</code> object, feel free to modify the date-time
...
public class DateFormatSymbols implements Serializable, Cloneable {
     ...
     * locale. This constructor can only construct instances for the locales
     * supported by the Java runtime environment, not for those supported by
     * installed {@link java.text.spi.DateFormatSymbolsProvider
     * DateFormatSymbolsProvider} implementations. For full locale coverage, use
     * the {@link #getInstance(Locale) getInstance} method.
     * <p>
     * This is equivalent to calling {@link #DateFormatSymbols(Locale)
    ...
    /**
     * Construct a DateFormatSymbols object by loading format data from
     * resources for the given locale. This constructor can only construct
     * instances for the locales supported by the Java runtime environment, not
     * for those supported by installed
     ...
     * by <code>Calendar.BC</code> and <code>Calendar.AD</code>.
     * 
     * @serial
     */
    String eras[] = null;
    ...
    /**
     * Month strings. For example: "January", "February", etc. An array of 13
     * strings (some calendars have 13 months), indexed by
    ...
    /**
     * Short month strings. For example: "Jan", "Feb", etc. An array of 13
     * strings (some calendars have 13 months), indexed by
     * <code>Calendar.JANUARY</code>, <code>Calendar.FEBRUARY</code>, etc.
     * 
     * @serial
    ...
    /**
     * Weekday strings. For example: "Sunday", "Monday", etc. An array of 8
     * strings, indexed by <code>Calendar.SUNDAY</code>,
     * <code>Calendar.MONDAY</code>, etc. The element <code>weekdays[0]</code>
     * is ignored.
     * 
     * @serial
     */
    ...
    /**
     * Short weekday strings. For example: "Sun", "Mon", etc. An array of 8
     * strings, indexed by <code>Calendar.SUNDAY</code>,
    ...
    /**
     * AM and PM strings. For example: "AM" and "PM". An array of 2 strings,
     * indexed by <code>Calendar.AM</code> and <code>Calendar.PM</code>.
     * 
     * @serial
     */
    String ampms[] = null;
    ...
    /**
     * Localized names of time zones in this locale. This is a two-dimensional
     * array of strings of size <em>n</em> by <em>m</em>, where <em>m</em> is at
     * least 5. Each of the <em>n</em> rows is an entry containing the localized
     * names for a single <code>TimeZone</code>. Each such row contains (with
     ...
     * </li>
     * <li><code>zoneStrings[i][3]</code> - long name of zone in daylight saving
     * time</li>
     ...
     * <a href="../java/util/TimeZone.html#CustomID">custom IDs</a>. All other
    ...
    /**
     * Indicates that zoneStrings is set externally with setZoneStrings()
     * method.
     */
     ...
     * of the characters described by <code>DateFormat.ERA_FIELD</code>,
     ...
     * installed {@link java.text.spi.DateFormatSymbolsProvider
     * DateFormatSymbolsProvider} implementations. It must contain at least a
     ...
     * This method provides access to <code>DateFormatSymbols</code> instances
     * for locales supported by the Java runtime itself as well as for those
     * supported by installed {@link java.text.spi.DateFormatSymbolsProvider
     * DateFormatSymbolsProvider} implementations.
     * <p>
    ...
    /**
     * Returns a DateFormatSymbols provided by a provider or found in the cache.
     * Note that this method returns a cached instance, not its clone.
     * Therefore, the instance should never be given to an application.
     */
    ...
    private static DateFormatSymbols getProviderInstance(Locale locale) {
        LocaleProviderAdapter adapter = LocaleProviderAdapter.getAdapter(DateFormatSymbolsProvider.class,
                locale);
     ...
     * <p>
     * If the language requires different forms for formatting and stand-alone
     * usages, this method returns month names in the formatting form. For
     * example, the preferred month name for January in the Czech language is
     * <em>ledna</em> in the formatting form, while it is <em>leden</em> in the
     * stand-alone form. This method returns {@code "ledna"} in this case. Refer
     * to the
     * <a href="http://unicode.org/reports/tr35/#Calendar_Elements"> Calendar
     * Elements in the Unicode Locale Data Markup Language (LDML)
     ...
     * <p>
     * If the language requires different forms for formatting and stand-alone
     * usages, This method returns short month names in the formatting form. For
     * example, the preferred abbreviation for January in the Catalan language
     * is <em>de gen.</em> in the formatting form, while it is <em>gen.</em> in
     * the stand-alone form. This method returns {@code "de gen."} in this case.
     * Refer to the
     * <a href="http://unicode.org/reports/tr35/#Calendar_Elements"> Calendar
     * Elements in the Unicode Locale Data Markup Language (LDML)
     * specification</a> for more details.
     ...
     * instead.
     * <p>
     * The value returned is a two-dimensional array of strings of size
     * <em>n</em> by <em>m</em>, where <em>m</em> is at least 5. Each of the
     * <em>n</em> rows is an entry containing the localized names for a single
     * <code>TimeZone</code>. Each such row contains (with <code>i</code>
     * ranging from 0..<em>n</em>-1):
     * <ul>
     * <li><code>zoneStrings[i][0]</code> - time zone ID</li>
     * <li><code>zoneStrings[i][1]</code> - long name of zone in standard time
     * </li>
     ...
     * The zone ID is <em>not</em> localized; it's one of the valid IDs of the
     * {@link java.util.TimeZone TimeZone} class that are not
     * <a href="../util/TimeZone.html#CustomID">custom IDs</a>. All other
     * entries are localized names. If a zone does not implement daylight saving
     * time, the daylight saving time names should not be used.
     * <p>
     * If {@link #setZoneStrings(String[][]) setZoneStrings} has been called on
     * this <code>DateFormatSymbols</code> instance, then the strings provided
     * by that call are returned. Otherwise, the returned array contains names
     * provided by the Java runtime and by installed
    ...
    /**
     * Sets time zone strings. The argument must be a two-dimensional array of
     * strings of size <em>n</em> by <em>m</em>, where <em>m</em> is at least 5.
     * Each of the <em>n</em> rows is an entry containing the localized names
     * for a single <code>TimeZone</code>. Each such row contains (with
     * <code>i</code> ranging from 0..<em>n</em>-1):
     * <ul>
     * <li><code>zoneStrings[i][0]</code> - time zone ID</li>
     * <li><code>zoneStrings[i][1]</code> - long name of zone in standard time
    ...
    public boolean equals(Object obj) {
        ...
        return (Arrays.equals(eras, that.eras) && Arrays.equals(months, that.months) && Arrays.equals(
                shortMonths, that.shortMonths) && Arrays.equals(weekdays, that.weekdays) && Arrays.equals(
                        shortWeekdays, that.shortWeekdays) && Arrays.equals(ampms, that.ampms) && Arrays
                                .deepEquals(getZoneStringsWrapper(), that.getZoneStringsWrapper())
     ...
     */
    private static final ConcurrentMap<Locale, SoftReference<DateFormatSymbols>> cachedInstances = new ConcurrentHashMap<>(
            3);
    ...
    /**
     * Package private: used by SimpleDateFormat Gets the index for the given
     * time zone ID to obtain the time zone strings for formatting. The time
    ...
    /**
     * Wrapper method to the getZoneStrings(), which is called from inside the
     * java.text package and not to mutate the returned arrays, so that it does
     * not need to create a defensive copy.
     */
    ...
    /**
     * Clones all the data members from the source DateFormatSymbols to the
     * target DateFormatSymbols.
     *
     * @param src
     ...
     * <code>zoneStrings</code> field is initialized in order to make sure the
