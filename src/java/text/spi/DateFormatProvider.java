 ...
 * of the {@link java.text.DateFormat DateFormat} class.
 *
 * @since 1.6
 */
public abstract class DateFormatProvider extends LocaleServiceProvider {
	...
	/**
	 * Returns a new <code>DateFormat</code> instance which formats time with
	 * the given formatting style for the specified locale.
	 * 
	 * @param style
	 ...
	 *                if <code>style</code> is invalid, or if
	...
	/**
	 * Returns a new <code>DateFormat</code> instance which formats date with
	 * the given formatting style for the specified locale.
	 * 
	 * @param style
	 *            the given formatting style. Either one of
	...
	/**
	 * Returns a new <code>DateFormat</code> instance which formats date and
	 * time with the given formatting style for the specified locale.
	 * 
	 * @param dateStyle
	 ...
	 *            the desired locale.
	 * @exception IllegalArgumentException
	 *                if <code>dateStyle</code> or <code>timeStyle</code> is
	 *                invalid, or if <code>locale</code> isn't one of the
