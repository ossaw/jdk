...
/**
 * Thrown when an application tries to access a type using a string representing
 * the type's name, but no definition for the type with the specified name can
 ...
 * types) are loaded. In particular, this exception can be thrown by the
