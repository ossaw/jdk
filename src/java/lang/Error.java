...
/**
 * An {@code Error} is a subclass of {@code Throwable} that indicates serious
 * problems that a reasonable application should not try to catch. Most such
 * errors are abnormal conditions. The {@code ThreadDeath} error, though a
 * "normal" condition, is also a subclass of {@code Error} because most
...
public class Error extends Throwable {
    ...
    /**
     * Constructs a new error with the specified detail message, cause,
