 ...
 * arguments of p are created recursively. See
 * {@link java.lang.reflect.TypeVariable TypeVariable} for details on the
 * creation process for type variables. Repeated creation of a parameterized
 * type has no effect.
 *
 * <p>
 * Instances of classes that implement this interface must implement an equals()
 * method that equates any two instances that share the same generic type
...
public interface ParameterizedType extends Type {
     ...
     * this type represents a non-parameterized type nested within a
     * parameterized type.
     *
