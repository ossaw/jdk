 ...
 * {@link #getTargetException()} method is now known as the <i>cause</i>, and
...
public class InvocationTargetException extends ReflectiveOperationException {
	...
	/**
	 * This field holds the target if the InvocationTargetException(Throwable
	...
	/**
	 * Constructs an {@code InvocationTargetException} with {@code null} as the
	 * target exception.
	 */
	...
	/**
	 * Constructs a InvocationTargetException with a target exception and a
	 * detail message.
	 *
	 * @param target
	 *               the target exception
	...
	/**
	 * Returns the cause of this exception (the thrown target exception, which
	 * may be {@code null}).
	 *
