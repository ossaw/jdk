 ...
 * on a class or interface. The reflected method may be a class method or an
 ...
 * but it throws an {@code IllegalArgumentException} if a narrowing conversion
 * would occur.
 *
 * @see Member
 * @see java.lang.Class
...
public final class Method extends Executable {
	...
	/**
	 * Package-private constructor used by ReflectAccess to enable instantiation
	 * of these objects in Java code from the java.lang package via
	 * sun.reflect.LangReflectAccess.
	 */
	Method(Class<?> declaringClass, String name, Class<?>[] parameterTypes,
			Class<?> returnType, Class<?>[] checkedExceptions, int modifiers,
			int slot, String signature, byte[] annotations,
	...
	/**
	 * Package-private routine (exposed to java.lang.Class via ReflectAccess)
	 * which returns a copy of this Method. The copy's "root" field points to
	 * this Method.
	 */
	Method copy() {
	...
	/**
	 * Returns the name of the method represented by this {@code Method} object,
	 * as a {@code String}.
	 */
	@Override
	...
	public TypeVariable<Method>[] getTypeParameters() {
		if (getGenericSignature() != null)
			return (TypeVariable<Method>[]) getGenericInfo()
					.getTypeParameters();
		else
	...
	/**
	 * Returns a {@code Class} object that represents the formal return type of
	...
	/**
	 * Returns a {@code Type} object that represents the formal return type of
	 * the method represented by this {@code Method} object.
	 *
	 * <p>
	 * If the return type is a parameterized type, the {@code Type} object
	 * returned must accurately reflect the actual type parameters used in the
	 * source code.
	 *
	 * <p>
	 * If the return type is a type variable or a parameterized type, it is
	 * created. Otherwise, it is resolved.
	 *
	 * @return a {@code Type} object that represents the formal return type of
	 ...
	 *                                             return type refers to a
	 *                                             non-existent type declaration
	 * @throws MalformedParameterizedTypeException
	 *                                             if the underlying method's
	 *                                             return typed refers to a
	...
	/**
	 * Compares this {@code Method} against the specified object. Returns true
	 * if the objects are the same. Two {@code Methods} are the same if they
	 * were declared by the same class and have the same name and formal
	...
	/**
	 * Returns a hashcode for this {@code Method}. The hashcode is computed as
	 * the exclusive-or of the hashcodes for the underlying method's declaring
	 * class name and the method's name.
	 */
	public int hashCode() {
	 ...
	 * {@code protected} or {@code private} first, and then other modifiers in
	 * the following order: {@code abstract}, {@code default}, {@code static},
	...
	public String toString() {
		return sharedToString(Modifier.methodModifiers(), isDefault(),
	 ...
	 * parameters. The string is formatted as the method access modifiers, if
	 * any, followed by an angle-bracketed comma-separated list of the method's
	 * type parameters, if any, followed by the method's generic return type,
	 * followed by a space, followed by the class declaring the method, followed
	 * by a period, followed by the method name, followed by a parenthesized,
	 * comma-separated list of the method's generic formal parameter types.
	 *
	 ...
	 * space separates the list from the class name. If the method is declared
	 * to throw exceptions, the parameter list is followed by a space, followed
	 * by the word throws followed by a comma-separated list of the generic
	...
	/**
	 * Invokes the underlying method represented by this {@code Method} object,
	 * on the specified object with the specified parameters. Individual
	 ...
	 * Second Edition, section 15.12.4.4; in particular, overriding based on the
	 ...
	 * appropriately wrapped in an object. However, if the value has the type of
	 * an array of a primitive type, the elements of the array are <i>not</i>
	 * wrapped in objects; in other words, an array of primitive type is
	 * returned. If the underlying method return type is void, the invocation
	 * returns null.
	 *
	 * @param obj
	 ...
	 *                                        if this {@code Method} object is
	 *                                        enforcing Java language
	 *                                        access control and the underlying
	 *                                        method is inaccessible.
	 * @exception IllegalArgumentException
	 *                                        if the method is an instance
	 *                                        method and the specified
	 *                                        object argument is not an instance
	 *                                        of the class or
	 *                                        interface declaring the underlying
	 *                                        method (or of a
	 *                                        subclass or implementor thereof);
	 *                                        if the number of actual
	 *                                        and formal parameters differ; if
	 *                                        an unwrapping conversion
	 *                                        for primitive arguments fails; or
	 *                                        if, after possible
	 *                                        unwrapping, a parameter value
	 *                                        cannot be converted to the
	 *                                        corresponding formal parameter
	 *                                        type by a method invocation
	 *                                        conversion.
	...
	/**
	 * Returns {@code true} if this method is a bridge method; returns
	 * {@code false} otherwise.
	 *
	 * @return true if and only if this method is a bridge method as defined by
	...
	public boolean isDefault() {
		...
		return ((getModifiers() & (Modifier.ABSTRACT | Modifier.PUBLIC
				| Modifier.STATIC)) == Modifier.PUBLIC) && getDeclaringClass()
						.isInterface();
	}
	 ...
	 * {@code Method} instance. If the member is of a primitive type, an
	 * instance of the corresponding wrapper type is returned. Returns null if
	 * no default is associated with the member, or if the method instance does
	 * not represent a declared member of an annotation type.
	 *
	 * @return the default value for the annotation member represented by this
	 *         {@code Method} instance.
	 * @throws TypeNotPresentException
	 *                                 if the annotation is of type
	 *                                 {@link Class} and no definition
	...
	public Object getDefaultValue() {
		...
		Class<?> memberType = AnnotationType.invocationHandlerReturnType(
				getReturnType());
		Object result = AnnotationParser.parseMemberValue(memberType, ByteBuffer
				.wrap(annotationDefault), sun.misc.SharedSecrets
