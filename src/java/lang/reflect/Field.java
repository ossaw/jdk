...
/**
 * A {@code Field} provides information about, and dynamic access to, a single
 * field of a class or an interface. The reflected field may be a class (static)
 * field or an instance field.
 *
 * <p>
 * A {@code Field} permits widening conversions to occur during a get or set
 * access operation, but throws an {@code IllegalArgumentException} if a
...
public final class Field extends AccessibleObject implements Member {
	 ...
	 * which returns a copy of this Field. The copy's "root" field points to
	 * this Field.
	 */
	Field copy() {
	 ...
	 *
	 * @return true if and only if this field is a synthetic field as defined by
	...
	/**
	 * Returns a {@code Class} object that identifies the declared type for the
	 * field represented by this {@code Field} object.
	 *
	...
	/**
	 * Returns a {@code Type} object that represents the declared type for the
	 * field represented by this {@code Field} object.
	 *
	 * <p>
	 * If the {@code Type} is a parameterized type, the {@code Type} object
	 * returned must accurately reflect the actual type parameters used in the
	 * source code.
	 *
	 * <p>
	 * If the type of the underlying field is a type variable or a parameterized
	 * type, it is created. Otherwise, it is resolved.
	 *
	 * @return a {@code Type} object that represents the declared type for the
	 *         field represented by this {@code Field} object
	 * @throws GenericSignatureFormatError
	 *                                             if the generic field
	 *                                             signature does not conform to
	 *                                             the format
	 *                                             specified in <cite>The
	 *                                             Java&trade; Virtual Machine
	 *                                             Specification</cite>
	 * @throws TypeNotPresentException
	 *                                             if the generic type signature
	 *                                             of the underlying field
	 *                                             refers
	 *                                             to a non-existent type
	 *                                             declaration
	 * @throws MalformedParameterizedTypeException
	 *                                             if the generic signature of
	 *                                             the underlying field refers
	 *                                             to a
	...
	/**
	 * Compares this {@code Field} against the specified object. Returns true if
	 * the objects are the same. Two {@code Field} objects are the same if they
	 * were declared by the same class and have the same name and type.
	 */
	public boolean equals(Object obj) {
		if (obj != null && obj instanceof Field) {
			Field other = (Field) obj;
			return (getDeclaringClass() == other.getDeclaringClass())
					&& (getName() == other.getName()) && (getType() == other
							.getType());
		}
		return false;
	}
	 ...
	 * exclusive-or of the hashcodes for the underlying field's declaring class
	 * name and its name.
	 */
	public int hashCode() {
	...
	/**
	 * Returns a string describing this {@code Field}. The format is the access
	 * modifiers for the field, if any, followed by the field type, followed by
	 * a space, followed by the fully-qualified name of the class declaring the
	 * field, followed by a period, followed by the name of the field. For
	 * example:
	 * 
	 * <pre>
	 ...
	 * the following order: {@code static}, {@code final}, {@code transient},
	 * {@code volatile}.
	 *
	...
	public String toString() {
		...
		return (((mod == 0) ? "" : (Modifier.toString(mod) + " ")) + getType()
				.getTypeName() + " " + getDeclaringClass().getTypeName() + "."
				+ getName());
	}

	/**
	 * Returns a string describing this {@code Field}, including its generic
	 * type. The format is the access modifiers for the field, if any, followed
	 * by the generic field type, followed by a space, followed by the
	 * fully-qualified name of the class declaring the field, followed by a
	 ...
	 * {@code volatile}.
	 *
	 * @return a string describing this {@code Field}, including its generic
	 *         type
	 *
	 * @since 1.5
	 * @jls 8.3.1 Field Modifiers
	...
	public String toGenericString() {
		...
		return (((mod == 0) ? "" : (Modifier.toString(mod) + " ")) + fieldType
				.getTypeName() + " " + getDeclaringClass().getTypeName() + "."
				+ getName());
	}
	 ...
	 *
	 * @param obj
	 *            the object to extract the {@code boolean} value from
	 ...
	 *                                        interface declaring the underlying
	 *                                        field (or a subclass or
	 *                                        implementor thereof), or if the
	 *                                        field value cannot be
	 *                                        converted to the type
	 *                                        {@code boolean} by a widening
	 *                                        conversion.
	 * @exception NullPointerException
	 *                                        if the specified object is null
	 *                                        and the field is an
	 ...
	 *
	 * @param obj
	 *            the object to extract the {@code byte} value from
	 ...
	 *
	 * @param obj
	 *            the object to extract the {@code char} value from
	 ...
	 *                                        implementor thereof), or if the
	 *                                        field value cannot be
	 *                                        converted to the type {@code char}
	 *                                        by a widening
	 *                                        conversion.
	 * @exception NullPointerException
	 *                                        if the specified object is null
	 ...
	 *
	 * @param obj
	 *            the object to extract the {@code short} value from
	 ...
	 *
	 * @param obj
	 *            the object to extract the {@code int} value from
	 ...
	 *                                        implementor thereof), or if the
	 *                                        field value cannot be
	 *                                        converted to the type {@code int}
	 *                                        by a widening
	 *                                        conversion.
	 * @exception NullPointerException
	 *                                        if the specified object is null
	 ...
	 *
	 * @param obj
	 *            the object to extract the {@code long} value from
	 ...
	 *                                        implementor thereof), or if the
	 *                                        field value cannot be
	 *                                        converted to the type {@code long}
	 *                                        by a widening
	 *                                        conversion.
	 * @exception NullPointerException
	 *                                        if the specified object is null
	 ...
	 *
	 * @param obj
	 *            the object to extract the {@code float} value from
	 ...
	 *
	 * @param obj
	 *            the object to extract the {@code double} value from
	 ...
	 * <p>
	 * Otherwise the underlying field is an instance field. If the specified
	 * object argument is null, the method throws a {@code NullPointerException}
	 * . If the specified object argument is not an instance of the class or
	 * interface declaring the underlying field, the method throws an
	 ...
	 * this attempt fails, the method throws an {@code IllegalArgumentException}
	 * .
	 *
	 * <p>
	 ...
	 * specify the declared type of the field represented by this Field.
	 * 
	 * @return an object representing the declared type of the field represented
	 *         by this Field
	 *
	 * @since 1.8
	 */
