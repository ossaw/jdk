...
public interface InvocationHandler {
     ...
     *        method invoked on the proxy instance. The declaring class
     *        of
     *        the {@code Method} object will be the interface that the
     *        method was declared in, which may be a superinterface of
     *        the
     ...
     *        {@code null} if interface method takes no arguments.
     *        Arguments
     *        of primitive types are wrapped in instances of the
     *        appropriate
     *        primitive wrapper class, such as {@code java.lang.Integer}
     *        or
     ...
     *         thrown
     *         by this method that is not assignable to any of the
     *         exception
     *         types declared in the {@code throws} clause of the
     *         interface
     *         method, then an {@link UndeclaredThrowableException}
     *         containing the exception that was thrown by this method
     *         will
     *         be thrown by the method invocation on the proxy
     *         instance.
