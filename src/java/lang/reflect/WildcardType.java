...
/**
 * WildcardType represents a wildcard type expression, such as {@code ?},
 * {@code ? extends Number}, or {@code ? super Integer}.
 *
 * @since 1.5
 */
public interface WildcardType extends Type {
	 ...
	 * <ul>
	 * <li>if B is a parameterized type or a type variable, it is created, (see
	...
	/**
	 * Returns an array of {@code Type} objects representing the lower bound(s)
	 * of this type variable. Note that if no lower bound is explicitly
	 * declared, the lower bound is the type of {@code null}. In this case, a
