 ...
 * other. As a consequence, users of type variables must not rely on the
...
public interface TypeVariable<D extends GenericDeclaration> extends Type, AnnotatedElement {
	...
	/**
	 * Returns the {@code GenericDeclaration} object representing the generic
	...
	/**
	 * Returns an array of AnnotatedType objects that represent the use of types
