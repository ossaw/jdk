...
public class Proxy implements java.io.Serializable {
    ...
    /*
     * Key1 and Key2 are optimized for the common use of dynamic proxies that
     * implement 1 or 2 interfaces.
     */
    ...
    private static final class Key1 extends WeakReference<Class<?>> {
        ...
        public boolean equals(Object obj) {
            Class<?> intf;
            return this == obj || obj != null && obj.getClass() == Key1.class && (intf = get()) != null
                    && intf == ((Key1) obj).get();
        }
    }
    ...
    private static final class Key2 extends WeakReference<Class<?>> {
        ...
        public boolean equals(Object obj) {
            Class<?> intf1, intf2;
            return this == obj || obj != null && obj.getClass() == Key2.class && (intf1 = get()) != null
                    && intf1 == ((Key2) obj).get() && (intf2 = ref2.get()) != null
    ...
    private static final class KeyX {
        ...
        @Override
        public boolean equals(Object obj) {
            return this == obj || obj != null && obj.getClass() == KeyX.class && equals(refs,
                    ((KeyX) obj).refs);
        }
    ...
    private static final class ProxyClassFactory implements BiFunction<ClassLoader, Class<?>[], Class<?>> {
        ...
        public Class<?> apply(ClassLoader loader, Class<?>[] interfaces) {
            ...
            try {
                 ...
                 * class generation code) there was some other invalid aspect of
                 * the arguments supplied to the proxy class creation (such as
