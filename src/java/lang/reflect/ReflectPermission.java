 ...
 * and methods in a class; allow access not only public members but also allow
 * access to default (package) access, protected, and private members.</td>
 * <td>This is dangerous in that information (possibly confidential) and methods
 * normally unavailable would be accessible to malicious code.</td>
 * </tr>
 * <tr>
 * <td>newProxyInPackage.{package name}</td>
 * <td>ability to create a proxy instance in the specified package of which the
 * non-public interface that the proxy class implements.</td>
 * <td>This gives code access to classes in packages to which it normally does
 * not have access and the dynamic proxy class is in the system protection
