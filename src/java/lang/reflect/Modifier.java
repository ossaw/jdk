...
/**
 * The Modifier class provides {@code static} methods and constants to decode
 * class and member access modifiers. The sets of modifiers are represented as
 * integers with distinct bit positions representing different modifiers. The
 * values for the constants representing the modifiers are taken from the tables
 * in sections 4.1, 4.4, 4.5, and 4.7 of <cite>The Java&trade; Virtual Machine
 * Specification</cite>.
 *
...
public class Modifier {
	...
	/**
	 * Return {@code true} if the integer argument includes the {@code public}
	...
	/**
	 * Return {@code true} if the integer argument includes the {@code private}
	 * modifier, {@code false} otherwise.
	 *
	 * @param mod
	 *            a set of modifiers
	...
	/**
	 * Return {@code true} if the integer argument includes the {@code static}
	 * modifier, {@code false} otherwise.
	 *
	 * @param mod
	 *            a set of modifiers
	...
	/**
	 * Return {@code true} if the integer argument includes the {@code final}
	 * modifier, {@code false} otherwise.
	 *
	 * @param mod
	 *            a set of modifiers
	...
	/**
	 * Return {@code true} if the integer argument includes the {@code volatile}
	 * modifier, {@code false} otherwise.
	 *
	 * @param mod
	 *            a set of modifiers
	...
	/**
	 * Return {@code true} if the integer argument includes the {@code native}
	 * modifier, {@code false} otherwise.
	 *
	 * @param mod
	 *            a set of modifiers
	...
	/**
	 * Return {@code true} if the integer argument includes the {@code abstract}
	 * modifier, {@code false} otherwise.
	 *
	 * @param mod
	 *            a set of modifiers
	...
	/**
	 * Return {@code true} if the integer argument includes the {@code strictfp}
	 * modifier, {@code false} otherwise.
	 *
	 * @param mod
	 *            a set of modifiers
	 ...
	 * the suggested modifier orderings given in sections 8.1.1, 8.3.1, 8.4.3,
	 * 8.8.3, and 9.1.1 of <cite>The Java&trade; Language Specification</cite>.
	 * The full modifier ordering used by this method is: <blockquote> {@code
	 * public protected private abstract static final transient
	 * volatile synchronized native strictfp
	 * interface } </blockquote> The {@code interface} modifier discussed in
	 * this class is not a true modifier in the Java language and it appears
	 * after all other modifiers listed by this method. This method may return a
	 ...
	 * that can be applied to a class.
	 * 
	...
	/**
	 * Return an {@code int} value OR-ing together the source language modifiers
	 * that can be applied to a method.
	 * 
	 * @return an {@code int} value OR-ing together the source language
	...
	/**
	 * Return an {@code int} value OR-ing together the source language modifiers
	 * that can be applied to a field.
	 * 
	 * @return an {@code int} value OR-ing together the source language
