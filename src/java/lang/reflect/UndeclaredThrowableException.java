 ...
 * {@link InvocationHandler#invoke invoke} method throws a checked exception (a
 * {@code Throwable} that is not assignable to {@code RuntimeException} or
 ...
 * exception that was thrown by the invocation handler" that may be provided at
 * construction time and accessed via the {@link #getUndeclaredThrowable()}
 * method is now known as the <i>cause</i>, and may be accessed via the
 * {@link Throwable#getCause()} method, as well as the aforementioned "legacy
 * method."
 *
 * @author Peter Jones
...
public class UndeclaredThrowableException extends RuntimeException {
    ...
    /**
     * Constructs an {@code UndeclaredThrowableException} with the specified
     * {@code Throwable}.
     *
    ...
    /**
     * Returns the cause of this exception (the {@code Throwable} instance
     * wrapped in this {@code UndeclaredThrowableException}, which may be
     * {@code null}).
     *
