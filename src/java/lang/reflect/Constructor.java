 ...
 * parameters, but throws an {@code IllegalArgumentException} if a narrowing
...
public final class Constructor<T> extends Executable {
     ...
     * which returns a copy of this Constructor. The copy's "root" field points
     * to this Constructor.
     */
    Constructor<T> copy() {
     ...
     * name of the constructor's declaring class.
     */
    @Override
    ...
    /**
     * Compares this {@code Constructor} against the specified object. Returns
     * true if the objects are the same. Two {@code Constructor} objects are the
     * same if they were declared by the same class and have the same formal
     * parameter types.
     */
    ...
    /**
     * Returns a hashcode for this {@code Constructor}. The hashcode is the same
     * as the hashcode for the underlying constructor's declaring class name.
     */
    public int hashCode() {
     ...
     * may appear, or none if the constructor has default (package) access.
     *
     ...
     * space separates the list from the class name. If the constructor is
