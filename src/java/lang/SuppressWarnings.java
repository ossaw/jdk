 ...
 * warning in a particular method, you should annotate that method rather than
 * its class.
 *
 * @author Josh Bloch
 * @since 1.5
...
public @interface SuppressWarnings {
	 ...
	 * support in conjunction with this annotation type. They are encouraged to
	 * cooperate to ensure that the same names work across multiple compilers.
	 * 
