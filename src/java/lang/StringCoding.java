...
class StringCoding {
    ...
    private static class StringDecoder {
        ...
        private StringDecoder(Charset cs, String rcn) {
            ...
            this.cs = cs;
            this.cd = cs.newDecoder().onMalformedInput(CodingErrorAction.REPLACE).onUnmappableCharacter(
    ...
    static char[] decode(Charset cs, byte[] ba, int off, int len) {
        ...
        // (4)There might be a timing gap in isTrusted setting.
        // getClassLoader0()
    ...
    private static class StringEncoder {
        ...
        private StringEncoder(Charset cs, String rcn) {
            this.requestedCharsetName = rcn;
            this.cs = cs;
            this.ce = cs.newEncoder().onMalformedInput(CodingErrorAction.REPLACE).onUnmappableCharacter(
                    CodingErrorAction.REPLACE);
            this.isTrusted = (cs.getClass().getClassLoader0() == null);
        }
