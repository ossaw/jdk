 ...
 * was raised while loading the class" that may be provided at construction time
 * and accessed via the {@link #getException()} method is now known as the
...
public class ClassNotFoundException extends ReflectiveOperationException {
    ...
    /**
     * This field holds the exception ex if the ClassNotFoundException(String s,
