...
abstract public class VirtualMachineError extends Error {
	...
	/**
	 * Constructs a <code>VirtualMachineError</code> with the specified detail
	 * message.
	 *
	 * @param message
	 *                the detail message.
	...
	/**
	 * Constructs a {@code VirtualMachineError} with the specified detail
	 * message and cause.
	 * <p>
	...
	/**
	 * Constructs an a {@code VirtualMachineError} with the specified cause and
	 * a detail message of {@code (cause==null ? null :
