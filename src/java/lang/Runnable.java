...
/**
 * The <code>Runnable</code> interface should be implemented by any class whose
 ...
 * to execute code while they are active. For example, <code>Runnable</code> is
 * implemented by class <code>Thread</code>. Being active simply means that a
