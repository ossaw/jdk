 ...
 * through {@link System#getProperty(String)} and
 * {@link System#getProperty(String, String)}. If so, it is assumed to be the
 * name of a library (with a platform-dependent exact location and type);
 * {@link System#loadLibrary} is called to load that library. If this loading
