...
class TypeConvertingMethodAdapter extends MethodVisitor {
    ...
    /**
     * Convert types by unboxing. The source type is known to be a primitive
     * wrapper.
     * 
     * @param sname
    ...
    /**
     * Convert an argument of type 'arg' to be passed to 'target' assuring that
     * it is 'functional'. Insert the needed conversion instructions in the
     * method code.
     * 
     * @param arg
     * @param target
     ...
     * and fast Java bytecode manipulation framework. Copyright (c) 2000-2005
