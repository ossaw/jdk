 ...
 * . Each element represents a single stack frame. All stack frames except for
 * the one at the top of the stack represent a method invocation. The frame at
 * the top of the stack represents the execution point at which the stack trace
 * was generated. Typically, this is the point at which the throwable
...
public final class StackTraceElement implements java.io.Serializable {
     ...
     * the {@code SourceFile} attribute of the relevant {@code class} file (as
     ...
     *         by this stack trace element, or {@code null} if this information
     *         is unavailable.
     */
     ...
     * the {@code LineNumberTable} attribute of the relevant {@code class} file
     * (as per <i>The Java Virtual Machine Specification</i>, Section 4.7.8).
     *
     ...
     *
     * @return the fully qualified name of the {@code Class} containing the
     ...
     * <i>special method name</i>, {@code <init>} or {@code <clinit>}, as per
     * Section 3.9 of <i>The Java Virtual Machine Specification</i>.
     *
     ...
     * <ul>
     * <li>{@code "MyClass.mash(MyClass.java:9)"} - Here, {@code "MyClass"} is
     * the <i>fully-qualified name</i> of the class containing the execution
     * point represented by this stack trace element, {@code "mash"} is the name
     * of the method containing the execution point, {@code "MyClass.java"} is
     * the source file containing the execution point, and {@code "9"} is the
     * line number of the source line containing the execution point.
     * <li>{@code "MyClass.mash(MyClass.java)"} - As above, but the line number
     * is unavailable.
     * <li>{@code "MyClass.mash(Unknown Source)"} - As above, but neither the
     * file name nor the line number are available.
     * <li>{@code "MyClass.mash(Native Method)"} - As above, but neither the
     * file name nor the line number are available, and the method containing
     * the execution point is known to be a native method.
     * </ul>
     * 
     ...
     * instance representing the same execution point as this instance. Two
     * stack trace elements {@code a} and {@code b} are equal if and only if:
     * 
     * <pre>
     * {@code
    ...
    public boolean equals(Object obj) {
        ...
        return e.declaringClass.equals(declaringClass) && e.lineNumber == lineNumber && Objects.equals(
                methodName, e.methodName) && Objects.equals(fileName, e.fileName);
    }
