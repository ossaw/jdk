...
public final class System {
	 ...
	 *
	 * VM will invoke the initializeSystemClass method to complete the
	 * initialization for this class separated from clinit. Note that to use
	 * properties set by the VM, see the constraints described in the
	 * initializeSystemClass method.
	 */
	 ...
	 * </pre>
	 *
	 * one should use {@code t1 - t0 < 0}, not {@code t1 < t0}, because of the
	 ...
	 * <td>Path of extension directory or directories <b>Deprecated.</b> <i>This
	 * property, and the mechanism which implements it, may be removed in a
	 * future release.</i></td>
	 * </tr>
	 * <tr>
	...
	private static void initializeSystemClass() {
		...
		// except
		// for Windows where the process-wide error mode is set before the
		// java.io
		// classes are used.
