 ...
 * that may be provided at construction time and accessed via the
 * {@link #getException()} method is now known as the <i>cause</i>, and may be
 * accessed via the {@link Throwable#getCause()} method, as well as the
...
public class ExceptionInInitializerError extends LinkageError {
     ...
     * ExceptionInInitializerError(Throwable thrown) constructor was used to
     ...
     * throwable object. A detail message is a String that describes this
    ...
    /**
     * Constructs a new <code>ExceptionInInitializerError</code> class by saving
     * a reference to the <code>Throwable</code> object thrown for later
     * retrieval by the {@link #getException()} method. The detail message
     ...
     *         <code>ExceptionInInitializerError</code>, or <code>null</code> if
    ...
    /**
     * Returns the cause of this error (the exception that occurred during a
     * static initialization that caused this error to be created).
     *
     * @return the cause of this error or <code>null</code> if the cause is
