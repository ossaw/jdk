...
public class ThreadLocal<T> {
     ...
     * invoked the {@link #set} method, in which case the {@code initialValue}
     ...
     * <p>
     * This implementation simply returns {@code null}; if the programmer
     * desires thread-local variables to have an initial value other than
     * {@code null}, {@code ThreadLocal} must be subclassed, and this method
     ...
     * by the current thread in the interim. This may result in multiple
     * invocations of the {@code initialValue} method in the current thread.
     *
     * @since 1.5
     */
    public void remove() {
     ...
     * but is internally defined here for the sake of providing
     * createInheritedMap factory method without needing to subclass the map
     * class in InheritableThreadLocal. This technique is preferable to the
    ...
    /**
     * An extension of ThreadLocal that obtains its initial value from the
