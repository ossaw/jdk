 ...
 * object. An object of type {@code Byte} contains a single field whose type is
 * {@code byte}.
 *
 * <p>
 * In addition, this class provides several methods for converting a
 * {@code byte} to a {@code String} and a {@code String} to a {@code
 * byte}, as well as other constants and methods useful when dealing with a
 * {@code byte}.
 *
...
public final class Byte extends Number implements Comparable<Byte> {
	...
	/**
	 * A constant holding the minimum value a {@code byte} can have, -2
	 * <sup>7</sup>.
	 */
	public static final byte MIN_VALUE = -128;

	/**
	 * A constant holding the maximum value a {@code byte} can have, 2
	 * <sup>7</sup>-1.
	 */
	...
	/**
	 * Returns a {@code Byte} instance representing the specified {@code byte}
	 * value. If a new {@code Byte} instance is not required, this method should
	 * generally be used in preference to the constructor {@link #Byte(byte)},
	...
	/**
	 * Parses the string argument as a signed {@code byte} in the radix
	 ...
	 * byte}. The characters in the string must all be decimal digits, except
	 * that the first character may be an ASCII minus sign {@code '-'} (
	 * {@code '\u005Cu002D'}) to indicate a negative value or an ASCII plus sign
	 * {@code '+'} ({@code '\u005Cu002B'}) to indicate a positive value. The
	 * resulting {@code byte} value is returned, exactly as if the argument and
	...
	/**
	 * Returns a {@code Byte} object holding the value extracted from the
	 ...
	 * {@code byte} in the radix specified by the second argument, exactly as if
	 * the argument were given to the {@link #parseByte(java.lang.String, int)}
	 * method. The result is a {@code Byte} object that represents the
	 * {@code byte} value specified by the string.
	 *
	 * <p>
	 * In other words, this method returns a {@code Byte} object equal to the
	 * value of:
	 *
	...
	/**
	 * Returns a {@code Byte} object holding the value given by the specified
	 * {@code String}. The argument is interpreted as representing a signed
	 * decimal {@code byte}, exactly as if the argument were given to the
	 * {@link #parseByte(java.lang.String)} method. The result is a {@code Byte}
	...
	/**
	 * Decodes a {@code String} into a {@code Byte}. Accepts decimal,
	...
	/**
	 * Constructs a newly allocated {@code Byte} object that represents the
	...
	/**
	 * Constructs a newly allocated {@code Byte} object that represents the
	 * {@code byte} value indicated by the {@code String} parameter. The string
	 * is converted to a {@code byte} value in exactly the manner used by the
	...
	/**
	 * Returns the value of this {@code Byte} as a {@code short} after a
	...
	/**
	 * Returns the value of this {@code Byte} as an {@code int} after a widening
	...
	/**
	 * Returns the value of this {@code Byte} as a {@code long} after a widening
	 * primitive conversion.
	 * 
	 * @jls 5.1.2 Widening Primitive Conversions
	 */
	...
	/**
	 * Returns the value of this {@code Byte} as a {@code float} after a
	 * widening primitive conversion.
	 * 
	 * @jls 5.1.2 Widening Primitive Conversions
	 */
	...
	/**
	 * Returns the value of this {@code Byte} as a {@code double} after a
	 * widening primitive conversion.
	 * 
	 * @jls 5.1.2 Widening Primitive Conversions
	 */
	...
	/**
	 * Returns a hash code for this {@code Byte}; equal to the result of
	 ...
	 * if and only if the argument is not {@code null} and is a {@code Byte}
	 ...
	 *         greater than {@code 0} if this {@code Byte} is numerically
	...
	/**
	 * Compares two {@code byte} values numerically. The value returned is
	 ...
	 * byte} values are mapped to an {@code int} value equal to the input plus 2
	 * <sup>8</sup>.
	 *
	 * @param x
	 ...
	 * unsigned conversion to a {@code long}, the high-order 56 bits of the
	 * {@code long} are zero and the low-order 8 bits are equal to the bits of
	 * the {@code byte} argument.
	 *
	 * Consequently, zero and positive {@code byte} values are mapped to a
	 * numerically equal {@code long} value and negative {@code
	 * byte} values are mapped to a {@code long} value equal to the input plus 2
	 * <sup>8</sup>.
	 *
	 * @param x
