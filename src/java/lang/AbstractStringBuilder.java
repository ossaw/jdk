...
abstract class AbstractStringBuilder implements Appendable, CharSequence {
     ...
     * {@code minimumCapacity} is non positive due to numeric overflow, this
     * method throws {@code OutOfMemoryError}.
     */
     ...
     * Returns the current capacity increased by the same amount + 2 if that
     * suffices. Will not return a capacity greater than {@code MAX_ARRAY_SIZE}
     * unless the given minimum capacity is greater than that.
     *
     * @param minCapacity
     *        the desired minimum capacity
     * @throws OutOfMemoryError
     *         if minCapacity is less than zero or greater than
     *         Integer.MAX_VALUE
     */
    private int newCapacity(int minCapacity) {
        ...
        return (newCapacity <= 0 || MAX_ARRAY_SIZE - newCapacity < 0) ? hugeCapacity(minCapacity)
                : newCapacity;
    }
     ...
     *         if the {@code newLength} argument is
     *         negative.
     */
     ...
     * @throws IndexOutOfBoundsException
     *         if {@code index} is negative or greater
     *         than or equal to
     *         {@code length()}.
     */
    @Override
     ...
     * this surrogate pair is returned. Otherwise, the {@code char} value at the
     ...
     * this sequence. The text range begins at the specified {@code beginIndex}
     * and extends to the {@code char} at index {@code endIndex - 1}. Thus the
     * length (in {@code char}s) of the text range is
     * {@code endIndex-beginIndex}. Unpaired surrogates within this sequence
     ...
     *            and the subsequence starting with
     *            {@code index} has fewer
     ...
     * @return a reference to this object.
     * @throws IndexOutOfBoundsException
     *         if {@code start} is negative, or
     *         {@code start} is greater
     *         than {@code end} or {@code end} is
     *         greater than
     *         {@code s.length()}
     */
    @Override
    public AbstractStringBuilder append(CharSequence s, int start, int end) {
        ...
        if ((start < 0) || (start > end) || (end > s.length()))
            throw new IndexOutOfBoundsException("start " + start + ", end " + end + ", s.length() " + s
                    .length());
        int len = end - start;
        ensureCapacityInternal(count + len);
     ...
     * @throws StringIndexOutOfBoundsException
     *         if {@code start} is less than
     *         zero, or greater than the
     ...
     * @throws IndexOutOfBoundsException
     *         if {@code start} or {@code end} are
     *         negative, if {@code end}
     *         is greater than {@code length()}, or if
     *         {@code start} is
     ...
     *         greater than {@code length()}
     *         , or {@code offset} or
     *         {@code len} are negative, or
     *         {@code (offset+len)} is greater
     ...
     * of this object's {@link #insert(int,CharSequence,int,int) insert}
     ...
     * position. The length of this sequence is increased by {@code end - start}
     * .
     * <p>
     ...
     * @return a reference to this object.
     * @throws IndexOutOfBoundsException
     *         if {@code dstOffset} is negative or
     *         greater than
     *         {@code this.length()}, or {@code start}
     *         or {@code end} are
     *         negative, or {@code start} is greater
     *         than {@code end} or
     *         {@code end} is greater than
     *         {@code s.length()}
     */
