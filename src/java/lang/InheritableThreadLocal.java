...
/**
 * This class extends <tt>ThreadLocal</tt> to provide inheritance of values from
 * parent thread to child thread: when a child thread is created, the child
 * receives initial values for all inheritable thread-local variables for which
 ...
 * any child threads that are created.
 *
...
public class InheritableThreadLocal<T> extends ThreadLocal<T> {
	 ...
	 * variable as a function of the parent's value at the time the child thread
	 * is created. This method is called from within the parent thread before
