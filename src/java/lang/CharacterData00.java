...
class CharacterData00 extends CharacterData {
    ...
    int findInCharMap(int ch) {
        ...
        top = charMap.length;
        current = top / 2;
        // invariant: top > current >= bottom && ch >=
        // CharacterData.charMap[bottom][0]
        while (top - bottom > 1) {
    ...
    // c:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8u144/9417/jdk/make/data/characterdata/CharacterData00.java.template
    // -spec
    // c:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8u144/9417/jdk/make/data/unicodedata/UnicodeData.txt
    // -specialcasing
    // c:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8u144/9417/jdk/make/data/unicodedata/SpecialCasing.txt
    // -proplist
    // c:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8u144/9417/jdk/make/data/unicodedata/PropList.txt
    // -o
    // c:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8u144/9417/build/windows-amd64/jdk/gensrc/java/lang/CharacterData00.java
    // -string -usecharforbyte 11 4 1
    static final char[][][] charMap;
    // The X table has 2048 entries for a total of 4096 bytes.

    static final char X[] = ("\000\020\040\060\100\120\140\160\200\220\240\260\300\320\340\360\200\u0100"
            + "\u0110\u0120\u0130\u0140\u0150\u0160\u0170\u0170\u0180\u0190\u01A0\u01B0\u01C0"
    ...
    static final char Y[] = ("\000\000\000\000\002\004\006\000\000\000\000\000\000\000\010\004\012\014\016"
    ...
    static final String A_DATA = "\u4800\u100F\u4800\u100F\u4800\u100F\u5800\u400F\u5000\u400F\u5800\u400F\u6000"
            + "\u400F\u5000\u400F\u5000\u400F\u5000\u400F\u6000\u400C\u6800\030\u6800\030"
