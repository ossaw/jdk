 ...
 * <code>Instrumentation.redefineClasses</code> method. Serves to bind the
 * <code>Class</code> that needs redefining together with the new class file
 * bytes.
 *
...
public final class ClassDefinition {
	 ...
	 * class and class file bytes. Does not copy the supplied buffer, just
