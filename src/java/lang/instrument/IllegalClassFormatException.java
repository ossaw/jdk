 ...
 * ClassFileTransformer.transform} when its input parameters are invalid. This
 * may occur either because the initial class file bytes were invalid or a
 * previously applied transform corrupted the bytes.
 *
