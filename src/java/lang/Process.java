 ...
 * {@link Runtime#exec(String[],String[],File) Runtime.exec} methods create a
 * native process and return an instance of a subclass of {@code Process} that
 * can be used to control the process and obtain information about it. The class
 * {@code Process} provides methods for performing input from the process,
 * performing output to the process, waiting for the process to complete,
 * checking the exit status of the process, and destroying (killing) the
 * process.
 *
 * <p>
 ...
 * All its standard I/O (i.e. stdin, stdout, stderr) operations will be
 * redirected to the parent process, where they can be accessed via the streams
 * obtained using the methods {@link #getOutputStream()},
 * {@link #getInputStream()}, and {@link #getErrorStream()}. The parent process
 ...
 *
 * <p>
 * Where desired, <a href="ProcessBuilder.html#redirect-input"> subprocess I/O
 * can also be redirected</a> using methods of the {@link ProcessBuilder} class.
 *
 * <p>
 * The subprocess is not killed when there are no more references to the
 * {@code Process} object, but rather the subprocess continues executing
 * asynchronously.
 *
 * <p>
 ...
 * Java process that owns the {@code Process} object.
 *
 * <p>
 * As of 1.5, {@link ProcessBuilder#start()} is the preferred way to create a
 * {@code Process}.
 *
 * @since JDK1.0
 */
public abstract class Process {
     ...
     * process represented by this {@code Process} object.
     *
     * <p>
     ...
     * ProcessBuilder.redirectOutput} then this method will return a
     * <a href="ProcessBuilder.html#redirect-output">null input stream</a>.
     *
     * <p>
     * Otherwise, if the standard error of the subprocess has been redirected
     * using {@link ProcessBuilder#redirectErrorStream(boolean)
     * ProcessBuilder.redirectErrorStream} then the input stream returned by
     * this method will receive the merged standard output and the standard
     ...
     * represented by this {@code Process} object.
     *
     * <p>
     ...
     * represented by this {@code Process} object has terminated. This method
     ...
     * represented by this {@code Process} object has terminated, or the
     ...
     *
     * <p>
     * The default implementation of this methods polls the {@code exitValue} to
     * check if the process has terminated. Concrete implementations of this
     ...
     * {@code Process} object is forcibly terminated or not is implementation
     * dependent.
     */
    public abstract void destroy();

    /**
     * Kills the subprocess. The subprocess represented by this {@code Process}
     * object is forcibly terminated.
     *
     * <p>
     * The default implementation of this method invokes {@link #destroy} and so
     * may not forcibly terminate the process. Concrete implementations of this
     * class are strongly encouraged to override this method with a compliant
     * implementation. Invoking this method on {@code Process} objects returned
     * by {@link ProcessBuilder#start} and {@link Runtime#exec} will forcibly
     * terminate the process.
     *
     * <p>
     * Note: The subprocess may not terminate immediately. i.e.
     * {@code isAlive()} may return true for a brief period after
     * {@code destroyForcibly()} is called. This method may be chained to
     * {@code waitFor()} if needed.
     *
     * @return the {@code Process} object representing the subprocess to be
     *         forcibly destroyed.
     * @since 1.8
     */
