 ...
 * {@code sb.append(x)} has the same effect as {@code sb.insert(sb.length(), x)}
 * .
 * <p>
...
public final class StringBuffer extends AbstractStringBuilder implements java.io.Serializable, CharSequence {
     ...
     * specified {@code CharSequence}. The initial capacity of the string buffer
     * is {@code 16} plus the length of the {@code CharSequence} argument.
     * <p>
     * If the length of the specified {@code CharSequence} is less than or equal
     * to zero, then an empty buffer of capacity {@code 16} is returned.
     *
     * @param seq
     ...
     * order, to the contents of this {@code StringBuffer}, increasing the
     * length of this {@code StringBuffer} by the length of the argument. If
     * {@code sb} is {@code null}, then the four characters {@code "null"} are
     * appended to this {@code StringBuffer}.
     * <p>
     * Let <i>n</i> be the length of the old character sequence, the one
     * contained in the {@code StringBuffer} just prior to execution of the
     * {@code append} method. Then the character at index <i>k</i> in the new
     * character sequence is equal to the character at index <i>k</i> in the old
     * character sequence, if <i>k</i> is less than <i>n</i>; otherwise, it is
     * equal to the character at index <i>k-n</i> in the argument {@code sb}.
     * <p>
     * This method synchronizes on {@code this}, the destination object, but
     ...
     * <p>
     * The characters of the {@code CharSequence} argument are appended, in
     * order, increasing the length of this sequence by the length of the
     * argument.
     * <p>
     * The result of this method is exactly the same as if it were an invocation
     * of this.append(s, 0, s.length());
     * <p>
     * This method synchronizes on {@code this}, the destination object, but
     * does not synchronize on the source ({@code s}).
     * <p>
    ...
    public StringBuffer insert(int dstOffset, CharSequence s) {
        // Note, synchronization achieved via invocations of other StringBuffer
        // methods
    ...
    public StringBuffer insert(int offset, boolean b) {
        // Note, synchronization achieved via invocation of StringBuffer
        // insert(int, String)
    ...
    private static final java.io.ObjectStreamField[] serialPersistentFields = { new java.io.ObjectStreamField(
            "value", char[].class), new java.io.ObjectStreamField("count", Integer.TYPE),
