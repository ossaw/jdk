...
public final class Class<T> implements java.io.Serializable, GenericDeclaration, Type, AnnotatedElement {
    ...
    private Class(ClassLoader loader) {
        // Initialize final field for classLoader. The initialization value of
        // non-null
     ...
     * an instance of {@code Shimmer}; the value of the expression:
     * <blockquote> {@code s.getClass().getInterfaces()[0]} </blockquote> is the
    ...
    private void checkMemberAccess(int which, Class<?> caller, boolean checkProxyInterfaces) {
        ...
        if (s != null) {
            /*
             * Default policy allows access to all {@link Member#PUBLIC}
             * members, as well as access to classes that have the same class
             * loader as the caller. In all other cases, it requires
    ...
    private static class Atomic {
        ...
        // instance method
        // and have to avoid calling it in the static initializer of the Class
        // class...
    ...
    // reflection data that might get invalidated when JVM TI RedefineClasses()
    // is called
    ...
    static class MethodArray {
        ...
        /*
         * Add Methods declared in an interface to this MethodArray. Static
         * methods declared in interfaces are not inherited.
         */
    ...
    // annotation data that might get invalidated when JVM TI RedefineClasses()
    // is called
    ...
    private AnnotationData createAnnotationData(int classRedefinedCount) {
        ...
        if (annotations == null) {
            // no inherited annotations -> share the Map with
            // declaredAnnotations
            annotations = declaredAnnotations;
        } else {
            // at least one inherited annotation -> declared may override
            // inherited
    ...
    /*
     * Backing store of user-defined values pertaining to this class. Maintained
     * by the ClassValue class.
     */
