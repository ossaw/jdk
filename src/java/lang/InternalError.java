...
public class InternalError extends VirtualMachineError {
    ...
    /**
     * Constructs an <code>InternalError</code> with the specified detail
     * message.
     *
     * @param message
     *                the detail message.
    ...
    /**
     * Constructs an {@code InternalError} with the specified detail message and
     * cause.
     * <p>
    ...
    /**
     * Constructs an {@code InternalError} with the specified cause and a detail
     * message of {@code (cause==null ? null :
