 ...
 * short} in an object. An object of type {@code Short} contains a single field
 * whose type is {@code short}.
 *
 * <p>
 * In addition, this class provides several methods for converting a
 * {@code short} to a {@code String} and a {@code String} to a {@code short}, as
 * well as other constants and methods useful when dealing with a {@code short}.
 *
...
public final class Short extends Number implements Comparable<Short> {
	...
	/**
	 * A constant holding the minimum value a {@code short} can have, -2
	 * <sup>15</sup>.
	 */
	public static final short MIN_VALUE = -32768;

	/**
	 * A constant holding the maximum value a {@code short} can have, 2
	 * <sup>15</sup>-1.
	 */
	...
	public static final Class<Short> TYPE = (Class<Short>) Class
			.getPrimitiveClass("short");

	/**
	 * Returns a new {@code String} object representing the specified
	 * {@code short}. The radix is assumed to be 10.
	 *
	 * @param s
	...
	/**
	 * Parses the string argument as a signed {@code short} in the radix
	 ...
	 *
	 * @param s
	 *              the {@code String} containing the {@code short}
	 *              representation
	 *              to be parsed
	 * @param radix
	 *              the radix to be used while parsing {@code s}
	 * @return the {@code short} represented by the string argument in the
	 *         specified radix.
	 ...
	 * short}. The characters in the string must all be decimal digits, except
	 * that the first character may be an ASCII minus sign {@code '-'} (
	 * {@code '\u005Cu002D'}) to indicate a negative value or an ASCII plus sign
	 * {@code '+'} ({@code '\u005Cu002B'}) to indicate a positive value. The
	 * resulting {@code short} value is returned, exactly as if the argument and
	 * the radix 10 were given as arguments to the
	 * {@link #parseShort(java.lang.String, int)} method.
	 *
	 * @param s
	 *          a {@code String} containing the {@code short} representation
	 *          to be parsed
	...
	/**
	 * Returns a {@code Short} object holding the value extracted from the
	 ...
	 * {@code short} in the radix specified by the second argument, exactly as
	 * if the argument were given to the
	 * {@link #parseShort(java.lang.String, int)} method. The result is a
	 * {@code Short} object that represents the {@code short} value specified by
	 * the string.
	 *
	 * <p>
	 * In other words, this method returns a {@code Short} object equal to the
	 * value of:
	 *
	 ...
	 * @return a {@code Short} object holding the value represented by the
	...
	/**
	 * Returns a {@code Short} object holding the value given by the specified
	 * {@code String}. The argument is interpreted as representing a signed
	 * decimal {@code short}, exactly as if the argument were given to the
	 * {@link #parseShort(java.lang.String)} method. The result is a
	 * {@code Short} object that represents the {@code short} value specified by
	 * the string.
	 *
	 * <p>
	...
	/**
	 * Returns a {@code Short} instance representing the specified {@code short}
	 * value. If a new {@code Short} instance is not required, this method
	 * should generally be used in preference to the constructor
	 * {@link #Short(short)}, as this method is likely to yield significantly
	...
	/**
	 * Decodes a {@code String} into a {@code Short}. Accepts decimal,
	 ...
	 * @return a {@code Short} object holding the {@code short} value
	...
	/**
	 * Constructs a newly allocated {@code Short} object that represents the
	 * {@code short} value indicated by the {@code String} parameter. The string
	 * is converted to a {@code short} value in exactly the manner used by the
	...
	/**
	 * Returns the value of this {@code Short} as a {@code byte} after a
	...
	/**
	 * Returns the value of this {@code Short} as an {@code int} after a
	...
	/**
	 * Returns the value of this {@code Short} as a {@code long} after a
	 * widening primitive conversion.
	 * 
	 * @jls 5.1.2 Widening Primitive Conversions
	 */
	...
	/**
	 * Returns the value of this {@code Short} as a {@code float} after a
	 * widening primitive conversion.
	 * 
	 * @jls 5.1.2 Widening Primitive Conversions
	 */
	...
	/**
	 * Returns the value of this {@code Short} as a {@code double} after a
	 * widening primitive conversion.
	 * 
	 * @jls 5.1.2 Widening Primitive Conversions
	 */
	 ...
	 * string, exactly as if the {@code short} value were given as an argument
	 * to the {@link java.lang.Short#toString(short)} method.
	 *
	...
	/**
	 * Returns a hash code for this {@code Short}; equal to the result of
	 * invoking {@code intValue()}.
	 *
	 ...
	 * if and only if the argument is not {@code null} and is a {@code Short}
	 ...
	 *         argument {@code Short}; a value less than {@code 0} if this
	 *         {@code Short} is numerically less than the argument {@code Short}
	 *         ; and a value greater than {@code 0} if this {@code Short} is
	 *         numerically greater than the argument {@code Short} (signed
	 *         comparison).
	 * @since 1.2
	 */
	...
	/**
	 * Compares two {@code short} values numerically. The value returned is
	 ...
	 *         bytes in the specified {@code short} value.
	 * @since 1.5
	 */
	 ...
	 * unsigned conversion to an {@code int}, the high-order 16 bits of the
	 * {@code int} are zero and the low-order 16 bits are equal to the bits of
	 * the {@code short} argument.
	 *
	 * Consequently, zero and positive {@code short} values are mapped to a
	 * numerically equal {@code int} value and negative {@code
	 * short} values are mapped to an {@code int} value equal to the input plus
	 * 2<sup>16</sup>.
	 *
	 * @param x
	 ...
	 * unsigned conversion to a {@code long}, the high-order 48 bits of the
	 * {@code long} are zero and the low-order 16 bits are equal to the bits of
	 * the {@code short} argument.
	 *
	 * Consequently, zero and positive {@code short} values are mapped to a
	 * numerically equal {@code long} value and negative {@code
	 * short} values are mapped to a {@code long} value equal to the input plus
	 * 2<sup>16</sup>.
	 *
	 * @param x
