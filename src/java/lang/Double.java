...
/**
 * The {@code Double} class wraps a value of the primitive type {@code double}
 * in an object. An object of type {@code Double} contains a single field whose
 * type is {@code double}.
 *
 * <p>
...
public final class Double extends Number implements Comparable<Double> {
	 ...
	 * and also equal to {@code Double.longBitsToDouble(0x7fefffffffffffffL)}.
	 */
	 ...
	 * to the value returned by {@code Math.getExponent(Double.MAX_VALUE)}.
	 *
	 * @since 1.6
	 */
	 ...
	 * type {@code double}. That is, suppose that <i>x</i> is the exact
	 ...
	 * the {@code double} value nearest to <i>x</i>; or if two {@code double}
	 * values are equally close to <i>x</i>, then <i>d</i> must be one of them
	 * and the least significant bit of the significand of <i>d</i> must be
	 * {@code 0}.
	 *
	 * <p>
	 ...
	 * of the result is '{@code -}' ({@code '\u005Cu002D'}); if the sign is
	...
	public static String toHexString(double d) {
		/*
		 * Modeled after the "a" conversion specifier in C99, section 7.19.6.1;
		 * however, the output of this method is more tightly specified.
		 */
		if (!isFinite(d))
