 ...
 * machine, for example, enabling and disabling the verbose output for the class
 * loading or memory system, setting the threshold of a memory pool, and
 * enabling and disabling the thread contention monitoring support. Some actions
 * controlled by this permission can disclose information about the running
 * application, like the -verbose:class flag.</td>
 * <td>This allows an attacker to control the runtime characteristics of the
 * Java virtual machine and cause the system to misbehave. An attacker can also
 * access some information related to the running application.</td>
 * </tr>
 * <tr>
 * <td>monitor</td>
 * <td>Ability to retrieve runtime information about the Java virtual machine
 * such as thread stack trace, a list of all loaded class names, and input
 * arguments to the Java virtual machine.</td>
 * <td>This allows malicious code to monitor runtime information and uncover
 * vulnerabilities.</td>
 * </tr>
 * </table>
 * <p>
