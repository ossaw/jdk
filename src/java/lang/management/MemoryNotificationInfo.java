 ...
 * threshold value. The notification emitted will contain the memory
 * notification information about the detected condition:
 * <ul>
 * <li>The name of the memory pool.</li>
 * <li>The memory usage of the memory pool when the notification was
 * constructed.</li>
 * <li>The number of times that the memory usage has crossed a threshold when
 * the notification was constructed. For usage threshold notifications, this
 * count will be the {@link MemoryPoolMXBean#getUsageThresholdCount usage
 * threshold count}. For collection threshold notifications, this count will be
 ...
 * {@link javax.management.Notification#setUserData user data} of a
 ...
 * <ul>
 * <li>A {@link #MEMORY_THRESHOLD_EXCEEDED usage threshold exceeded
 * notification}. <br>
 * This notification will be emitted when the memory usage of a memory pool is
 * increased and has reached or exceeded its
 * <a href="MemoryPoolMXBean.html#UsageThreshold"> usage threshold</a> value.
 * Subsequent crossing of the usage threshold value does not cause further
 * notification until the memory usage has returned to become less than the
 * usage threshold value.
 * <p>
 * </li>
 * <li>A {@link #MEMORY_COLLECTION_THRESHOLD_EXCEEDED collection usage threshold
 * exceeded notification}. <br>
 * This notification will be emitted when the memory usage of a memory pool is
 * greater than or equal to its
 * <a href="MemoryPoolMXBean.html#CollectionThreshold"> collection usage
...
public class MemoryNotificationInfo {
	 ...
	 * <a href="MemoryPoolMXBean.html#UsageThreshold"> usage threshold</a>
	 * value. This notification is emitted by {@link MemoryMXBean}. Subsequent
	 * crossing of the usage threshold value does not cause further notification
	 * until the memory usage has returned to become less than the usage
	 * threshold value. The value of this notification type is
	...
	/**
	 * Notification type denoting that the memory usage of a memory pool is
	 * greater than or equal to its
	 * <a href="MemoryPoolMXBean.html#CollectionThreshold"> collection usage
	 * threshold</a> after the Java virtual machine has expended effort in
	 * recycling unused objects in that memory pool. This notification is
	 * emitted by {@link MemoryMXBean}. The value of this notification type is
	...
	/**
	 * Returns the name of the memory pool that triggers this notification. The
	 * memory pool usage has crossed a threshold.
	 *
	...
	/**
	 * Returns the memory usage of the memory pool when this notification was
	 * constructed.
	 *
	 * @return the memory usage of the memory pool when this notification was
	 *         constructed.
	 */
	...
	/**
	 * Returns the number of times that the memory usage has crossed a threshold
	 * when the notification was constructed. For usage threshold notifications,
	 * this count will be the {@link MemoryPoolMXBean#getUsageThresholdCount
	 * threshold count}. For collection threshold notifications, this count will
	 * be the {@link MemoryPoolMXBean#getCollectionUsageThresholdCount
	 * collection usage threshold count}.
	 *
	 * @return the number of times that the memory usage has crossed a threshold
	...
	/**
	 * Returns a <tt>MemoryNotificationInfo</tt> object represented by the given
