...
public interface CompilationMXBean extends PlatformManagedObject {
     ...
     * time.
     *
     * @return <tt>true</tt> if the monitoring of compilation time is supported
     *         ; <tt>false</tt> otherwise.
     */
    public boolean isCompilationTimeMonitoringSupported();

    /**
     * Returns the approximate accumulated elapsed time (in milliseconds) spent
     ...
     * virtual machine implementations. The implementations may have different
     * definitions and different measurements of the compilation time.
     *
