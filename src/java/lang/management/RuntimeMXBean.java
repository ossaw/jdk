...
public interface RuntimeMXBean extends PlatformManagedObject {
    ...
    /**
     * Tests if the Java virtual machine supports the boot class path mechanism
     * used by the bootstrap class loader to search for class files.
     *
     * @return <tt>true</tt> if the Java virtual machine supports the class path
     ...
     * {@link #isBootClassPathSupported} method can be used to determine if the
     ...
     * not include the arguments to the <tt>main</tt> method. This method
     * returns an empty list if there is no input argument to the Java virtual
     * machine.
     * <p>
     ...
     * {@link javax.management.openmbean.TabularData TabularData} with two items
     * in each row as follows: <blockquote> <table border summary=
