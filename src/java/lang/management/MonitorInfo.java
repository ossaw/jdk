...
public class MonitorInfo extends LockInfo {
	 ...
	 *            lock object.
	 * @param stackDepth
	 *            the depth in the stack trace where the object monitor was
	 *            locked.
	 * @param stackFrame
	 *            the stack frame that locked the object monitor.
	 * @throws IllegalArgumentException
	 *             if <tt>stackDepth</tt> &ge; 0 but <tt>stackFrame</tt> is
	 *             <tt>null</tt>, or <tt>stackDepth</tt> &lt; 0 but
	 *             <tt>stackFrame</tt> is not <tt>null</tt>.
	 */
	public MonitorInfo(String className, int identityHashCode, int stackDepth,
		...
		if (stackDepth >= 0 && stackFrame == null) {
			throw new IllegalArgumentException(
					"Parameter stackDepth is " + stackDepth + " but stackFrame is null");
		}
		if (stackDepth < 0 && stackFrame != null) {
			throw new IllegalArgumentException(
					"Parameter stackDepth is " + stackDepth + " but stackFrame is not null");
		}
	 ...
	 *
	 * @throws IllegalArgumentException
	 *             if <tt>cd</tt> does not represent a <tt>MonitorInfo</tt> with
