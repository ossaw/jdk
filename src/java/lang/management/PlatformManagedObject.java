...
/**
 * A platform managed object is a {@linkplain javax.management.MXBean JMX
 * MXBean} for monitoring and managing a component in the Java platform. Each
 * platform managed object has a unique
 ...
 * methods may be added in these interfaces in future Java SE releases. In
 * addition, this {@code PlatformManagedObject} interface is only intended for
 * the management interfaces for the platform to extend but not for
 * applications.
 *
