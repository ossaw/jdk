 ...
 * MBeanServer}. The {@link javax.management.ObjectName ObjectName} for uniquely
...
public interface PlatformLoggingMXBean extends PlatformManagedObject {
	 ...
	 * {@linkplain java.util.logging.Logger logger} names. This method calls
	 * {@link java.util.logging.LogManager#getLoggerNames} and returns a list of
	 * the logger names.
	 *
	 * @return A list of {@code String} each of which is a currently registered
	 *         {@code Logger} name.
	 */
	 ...
	 * level} associated with the specified logger. If the specified logger does
	 * not exist, {@code null} is returned. This method first finds the logger
	 ...
	 * {@linkplain java.util.logging.Logger#setLevel level}. If the
	 * {@code levelName} is not {@code null}, the level of the specified logger
	 * is set to the parsed {@link java.util.logging.Level Level} matching the
	 * {@code levelName}. If the {@code levelName} is {@code null}, the level of
	 * the specified logger is set to {@code null} and the effective level of
	 * the logger is inherited from its nearest ancestor with a specific
	...
	/**
	 * Returns the name of the {@linkplain java.util.logging.Logger#getParent
	 * parent} for the specified logger. If the specified logger does not exist,
	 * {@code null} is returned. If the specified logger is the root
