 ...
 * an <em>ownable synchronizer</em>, or the {@link Condition Condition} object
 * associated with synchronizers.
 * <p>
 * <a name="OwnableSynchronizer">An ownable synchronizer</a> is a synchronizer
 * that may be exclusively owned by a thread and uses
 * {@link AbstractOwnableSynchronizer AbstractOwnableSynchronizer} (or its
