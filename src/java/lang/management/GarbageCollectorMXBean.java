...
/**
 * The management interface for the garbage collection of the Java virtual
 * machine. Garbage collection is the process that the Java virtual machine uses
 * to find and reclaim unreachable objects to free up memory space. A garbage
 * collector is one type of {@link MemoryManagerMXBean memory manager}.
 *
 * <p>
 * A Java virtual machine may have one or more instances of the implementation
 * class of this interface. An instance implementing this interface is an
 * <a href="ManagementFactory.html#MXBean">MXBean</a> that can be obtained by
 * calling the {@link ManagementFactory#getGarbageCollectorMXBeans} method or
 * from the {@link ManagementFactory#getPlatformMBeanServer platform
 * <tt>MBeanServer</tt>} method.
 *
 * <p>
 * The <tt>ObjectName</tt> for uniquely identifying the MXBean for a garbage
 * collector within an MBeanServer is:
 * <blockquote> {@link ManagementFactory#GARBAGE_COLLECTOR_MXBEAN_DOMAIN_TYPE
 * <tt>java.lang:type=GarbageCollector</tt>}<tt>,name=</tt><i>collector's
 * name</i> </blockquote>
 *
