...
public enum MemoryType {
	 ...
	 * Heap memory type.
	 * <p>
	 * The Java virtual machine has a <i>heap</i> that is the runtime data area
	 * from which memory for all class instances and arrays are allocated.
	 */
	HEAP("Heap memory"),
	 ...
	 * <i>non-heap memory</i>). The non-heap memory includes the <i>method
	 * area</i> and memory required for the internal processing or optimization
	 * for the Java virtual machine. It stores per-class structures such as a
