...
/**
 * The management interface for a memory manager. A memory manager manages one
 * or more memory pools of the Java virtual machine.
 *
 * <p>
 * A Java virtual machine has one or more memory managers. An instance
 * implementing this interface is an
 * <a href="ManagementFactory.html#MXBean">MXBean</a> that can be obtained by
 * calling the {@link ManagementFactory#getMemoryManagerMXBeans} method or from
 * the {@link ManagementFactory#getPlatformMBeanServer platform
 * <tt>MBeanServer</tt>} method.
 *
 * <p>
 * The <tt>ObjectName</tt> for uniquely identifying the MXBean for a memory
 * manager within an MBeanServer is:
 * <blockquote> {@link ManagementFactory#MEMORY_MANAGER_MXBEAN_DOMAIN_TYPE
 * <tt>java.lang:type=MemoryManager</tt>}<tt>,name=</tt><i>manager's
 * name</i> </blockquote>
 *
