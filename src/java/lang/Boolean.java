...
/**
 * The Boolean class wraps a value of the primitive type {@code boolean} in an
 * object. An object of type {@code Boolean} contains a single field whose type
 * is {@code boolean}.
 * <p>
 * In addition, this class provides many methods for converting a
 * {@code boolean} to a {@code String} and a {@code String} to a {@code boolean}
...
public final class Boolean implements java.io.Serializable,
    ...
    /**
     * Allocates a {@code Boolean} object representing the {@code value}
     * argument.
     *
     * <p>
    ...
    /**
     * Allocates a {@code Boolean} object representing the value {@code true} if
     * the string argument is not {@code null} and is equal, ignoring case, to
     * the string {@code "true"}. Otherwise, allocate a {@code Boolean} object
     * representing the value {@code false}. Examples:
     * <p>
     * {@code new Boolean("True")} produces a {@code Boolean} object that
     * represents {@code true}.<br>
     * {@code new Boolean("yes")} produces a {@code Boolean} object that
     ...
     * {@code boolean} value. If the specified {@code boolean} value is
     * {@code true}, this method returns {@code Boolean.TRUE}; if it is
     * {@code false}, this method returns {@code Boolean.FALSE}. If a new
     * {@code Boolean} instance is not required, this method should generally be
     * used in preference to the constructor {@link #Boolean(boolean)}, as this
     ...
     * string. The {@code Boolean} returned represents a true value if the
     * string argument is not {@code null} and is equal, ignoring case, to the
     * string {@code "true"}.
     *
     * @param s
     *          a string.
    ...
    /**
     * Returns a {@code String} object representing this Boolean's value. If
     * this object represents the value {@code true}, a string equal to
     ...
     *
     * @return the integer {@code 1231} if this object represents {@code true};
     *         returns the integer {@code 1237} if this object represents
     *         {@code false}.
     */
    @Override
    public int hashCode() {
    ...
    /**
     * Returns {@code true} if and only if the argument is not {@code null} and
     * is a {@code Boolean} object that represents the same {@code boolean}
     * value as this object.
     *
     * @param obj
     *            the object to compare with.
     * @return {@code true} if the Boolean objects represent the same value;
     ...
     * through {@code getProperty}, a method defined by the {@code System}
     * class.
     * <p>
    ...
    /**
     * Compares two {@code boolean} values. The value returned is identical to
