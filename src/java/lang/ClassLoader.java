...
public abstract class ClassLoader {
    ...
    private static class ParallelLoaders {
        ...
        private static final Set<Class<? extends ClassLoader>> loaderTypes = Collections.newSetFromMap(
    ...
    // created classes.
    private final ProtectionDomain defaultDomain = new ProtectionDomain(new CodeSource(null,
    ...
    private native Class<?> defineClass1(String name, byte[] b, int off, int len, ProtectionDomain pd,
            String source);

    private native Class<?> defineClass2(String name, java.nio.ByteBuffer b, int off, int len,
    ...
    protected Package definePackage(String name, String specTitle, String specVersion, String specVendor,
        ...
        synchronized (packages) {
            ...
            pkg = new Package(name, specTitle, specVersion, specVendor, implTitle, implVersion, implVendor,
                    sealBase, this);
...
class SystemClassLoaderAction implements PrivilegedExceptionAction<ClassLoader> {
    ...
    public ClassLoader run() throws Exception {
        ...
        Constructor<?> ctor = Class.forName(cls, true, parent).getDeclaredConstructor(new Class<?>[] {
                ClassLoader.class });
