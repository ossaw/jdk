...
/**
 * The BasicPermission class extends the Permission class, and can be used as
 ...
 * name, to signify a wildcard match. For example, "*" and "java.*" signify a
 * wildcard match, while "*java", "a*b", and "java*" do not.
 * <P>
 * The action string (inherited from Permission) is unused. Thus,
 ...
 * permission or you don't.) Subclasses may implement actions on top of
...
public abstract class BasicPermission extends Permission implements java.io.Serializable {
	...
	/**
	 * Creates a new BasicPermission with the specified name. Name is the
	 * symbolic name of the permission, such as "setFactory", "print.queueJob",
	...
	/**
	 * Creates a new BasicPermission object with the specified name. The name is
	 * the symbolic name of the BasicPermission, and the actions String is
	 * currently unused.
	 *
	 * @param name
	 *            the name of the BasicPermission.
	 ...
	 * <li><i>p</i>'s name equals or (in the case of wildcards) is implied by
	 * this object's name. For example, "a.b.*" implies "a.b.c".
	 * </ul>
	 *
	 * @param p
	...
	/**
	 * Checks two BasicPermission objects for equality. Checks that <i>obj</i>'s
	 * class is the same as this object's class and has the same name as this
	 * object.
	 * <P>
	 * 
	 * @param obj
	 ...
	 * hash code of the name, that is, {@code getName().hashCode()}, where
	 * {@code getName} is from the Permission superclass.
	 *
	 ...
	 * {@code implies} method to be implemented in an efficient (and consistent)
	 * manner.
	 *
	...
	/**
	 * Returns the canonical name of this BasicPermission. All internal
	 * invocations of getName should invoke this method, so that the pre-JDK 1.6
	 * "exitVM" and current "exitVM.*" permission are equivalent in
...
/**
 * A BasicPermissionCollection stores a collection of BasicPermission
...
final class BasicPermissionCollection extends PermissionCollection implements java.io.Serializable {
	...
	/**
	 * This is set to {@code true} if this BasicPermissionCollection contains a
	...
	/**
	 * The class to which all BasicPermissions in this BasicPermissionCollection
	 * belongs.
	 *
	 * @see #serialPersistentFields
	 */
	 ...
	 *                - if this BasicPermissionCollection object has been marked
	 *                readonly
	 */
	 ...
	 *                  java.util.Hashtable The BasicPermissions in this
	 *                  BasicPermissionCollection. All BasicPermissions in the
	 *                  collection must belong to the same class. The Hashtable
	 *                  is indexed by the BasicPermission name; the value of the
	 *                  Hashtable entry is the permission.
	 * @serialField all_allowed
	 *                  boolean This is set to {@code true} if this
	 *                  BasicPermissionCollection contains a BasicPermission
	 *                  with '*' as its permission name.
	 * @serialField permClass
