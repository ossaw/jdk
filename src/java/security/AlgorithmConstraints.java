 ...
 * sizes), and other algorithm parameters.
 * <p>
 * {@code AlgorithmConstraints} objects are immutable. An implementation of this
 * interface should not provide methods that can change the state of an instance
 * once it has been created.
 * <p>
 * Note that {@code AlgorithmConstraints} can be used to represent the
 * restrictions described by the security properties
 * {@code jdk.certpath.disabledAlgorithms} and
 * {@code jdk.tls.disabledAlgorithms}, or could be used by a concrete
 * {@code PKIXCertPathChecker} to check whether a specified certificate in the
 * certification path contains the required algorithm constraints.
 *
