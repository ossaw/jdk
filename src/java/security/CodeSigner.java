...
public final class CodeSigner implements Serializable {
    ...
    /**
     * Returns the hash code value for this code signer. The hash code is
     * generated using the signer's certificate path and the timestamp, if
     * present.
     *
    ...
    /**
     * Tests for equality between the specified object and this code signer. Two
     * code signers are considered equal if their signer certificate paths are
     ...
     *
     * @return A string comprising the signer's certificate and a timestamp, if
     *         present.
     */
