 ...
 * {@code  java.security.acl} package extends this Owner interface.) The initial
 * owner Principal should be specified as an argument to the constructor of the
...
public interface Owner {
	 ...
	 * an owner can add another owner. The initial owner is configured at ACL
	 * construction time.
	 *
	 * @param caller
	 *            the principal invoking this method. It must be an owner of the
	 *            ACL.
	 *
	 * @param owner
	 ...
	 * <p>
	 *
	 * The caller principal must be an owner of the ACL in order to invoke this
	 * method.
	 *
	 * @param caller
	 *            the principal invoking this method. It must be an owner of the
	 ...
	 *                if there is only one owner left, so that deleteOwner would
	 ...
	 *
	 * @param owner
	 *            the principal to be checked to determine whether or not it is
	 *            an owner.
	 *
	 * @return true if the passed principal is in the list of owners, false if
	 *         not.
	 */
