...
/**
 * This is the interface used for representing one entry in an Access Control
 * List (ACL).
 * <p>
 *
 ...
 * principal can have at most one positive ACL entry and one negative entry;
 ...
 * only if the {@link #setNegativePermissions() setNegativePermissions} method
 * is called on it.
 *
...
public interface AclEntry extends Cloneable {
	 ...
	 *
	 * Note: ACL entries are by default positive. An entry becomes a negative
	 * entry only if this {@code setNegativePermissions} method is called on it.
	 */
