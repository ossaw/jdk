...
/**
 * A UnresolvedPermissionCollection stores a collection of UnresolvedPermission
 * permissions.
 *
...
final class UnresolvedPermissionCollection extends PermissionCollection
	...
	/**
	 * Key is permission type, value is a list of the UnresolvedPermissions of
	 * the same type. Not serialized; see serialization section at end of class.
	 */
	...
	/**
	 * Adds a permission to this UnresolvedPermissionCollection. The key for the
	...
	/**
	 * get any unresolved permissions of the same type as p, and return the List
	 * containing them.
	 */
	...
	public Enumeration<Permission> elements() {
		List<Permission> results = new ArrayList<>(); // where results are
														// stored
	 ...
	 */
	/*
	 * Writes the contents of the perms field out as a Hashtable in which the
	 * values are Vectors for serialization compatibility with earlier releases.
	 */
	private void writeObject(ObjectOutputStream out) throws IOException {
		// Don't call out.defaultWriteObject()

		// Copy perms into a Hashtable
		Hashtable<String, Vector<UnresolvedPermission>> permissions = new Hashtable<>(
				perms.size() * 2);
	...
	private void readObject(ObjectInputStream in) throws IOException,
		...
		// for the permissions key, so this cast is safe, unless the data is
		// corrupt.
