 ...
 * <a href="../../../platform/serialization/spec/security.html"> Security
...
public class KeyRep implements Serializable {
     ...
     * <ul>
     * <li>Type.SECRET/"RAW" - returns a SecretKeySpec object constructed using
     * encoded key bytes and algorithm
     * <li>Type.PUBLIC/"X.509" - gets a KeyFactory instance for the key
     * algorithm, constructs an X509EncodedKeySpec with the encoded key bytes,
     * and generates a public key from the spec
     * <li>Type.PRIVATE/"PKCS#8" - gets a KeyFactory instance for the key
     * algorithm, constructs a PKCS8EncodedKeySpec with the encoded key bytes,
     * and generates a private key from the spec
     * </ul>
     * <p>
     *
    ...
    protected Object readResolve() throws ObjectStreamException {
        try {
            if (type == Type.SECRET && RAW.equals(format)) {
                ...
                throw new NotSerializableException("unrecognized type/format combination: " + type + "/"
                        + format);
            }
        } catch (NotSerializableException nse) {
            throw nse;
        } catch (Exception e) {
            NotSerializableException nse = new NotSerializableException("java.security.Key: " + "[" + type
                    + "] " + "[" + algorithm + "] " + "[" + format + "]");
            nse.initCause(e);
            throw nse;
        }
