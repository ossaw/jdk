 ...
 *
 * <p>
 * An {@code AlgorithmParameters} object for managing the parameters for a
 * particular algorithm can be obtained by calling one of the
 * {@code getInstance} factory methods (static methods that return instances of
 * a given class).
 *
 * <p>
 ...
 * {@code AlgorithmParameters} object via a call to {@code getParameterSpec},
 ...
 * > AlgorithmParameters section</a> of the Java Cryptography Architecture
...
public class AlgorithmParameters {
	 ...
	 * with the most preferred Provider. A new AlgorithmParameters object
	 * encapsulating the AlgorithmParametersSpi implementation from the first
	 ...
	 * {@code init}, using an appropriate parameter specification or parameter
	 * encoding.
	 *
	 * @param algorithm
	 *            the name of the algorithm requested. See the
	 *            AlgorithmParameters section in the <a href=
	 *            "{@docRoot}/../technotes/guides/security/StandardNames.html#AlgorithmParameters"
	 ...
	 *                if no Provider supports an AlgorithmParametersSpi
	...
	public static AlgorithmParameters getInstance(String algorithm)
		...
		try {
			...
			return new AlgorithmParameters((AlgorithmParametersSpi) objs[0], (Provider) objs[1],
					algorithm);
	 ...
	 *
	 * @exception NoSuchAlgorithmException
	 *                if an AlgorithmParametersSpi implementation for the
	...
	/**
	 * Imports the parameters from {@code params} and decodes them according to
	 * the specified decoding scheme. If {@code format} is null, the primary
	 * decoding format for parameters is used. The primary decoding format is
	 ...
	 * {@code paramSpec} identifies the specification class in which the
	 ...
	 *                for this parameter object, or if this parameter object has
	...
	/**
	 * Returns the parameters encoded in the specified scheme. If {@code format}
	 * is null, the primary encoding format for parameters is used. The primary
	 * encoding format is ASN.1, if an ASN.1 specification for these parameters
	 * exists.
	 *
	 * @param format
