...
/**
 * This class encapsulates information about a signed timestamp. It is
 * immutable. It includes the timestamp's date and time as well as information
 * about the Timestamping Authority (TSA) which generated and signed the
 * timestamp.
 *
 * @since 1.5
 * @author Vincent Ryan
...
public final class Timestamp implements Serializable {
	...
	/**
	 * Returns the hash code value for this timestamp. The hash code is
	 * generated using the date and time of the timestamp and the TSA's
	 * certificate path.
	 *
	...
	/**
	 * Tests for equality between the specified object and this timestamp. Two
	 * timestamps are considered equal if the date and time of their timestamp's
	 * and their signer's certificate paths are equal.
	 *
	 * @param obj
	 ...
	 *
	 * @return A string comprising the date and time of the timestamp and its
