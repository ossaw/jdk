...
public final class Permissions extends PermissionCollection implements
    ...
    private PermissionCollection getUnresolvedPermissions(Permission p) {
        ...
        UnresolvedPermissionCollection uc = (UnresolvedPermissionCollection) permsMap
...
final class PermissionsHash extends PermissionCollection implements
    ...
    private void readObject(ObjectInputStream in) throws IOException,
        ...
        // the perms key, so this cast is safe, unless the data is corrupt.
        @SuppressWarnings("unchecked")
        Hashtable<Permission, Permission> perms = (Hashtable<Permission, Permission>) gfields
                .get("perms", null);
