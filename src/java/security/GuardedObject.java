 ...
 * Once an object is encapsulated by a GuardedObject, access to that object is
 * controlled by the {@code getObject} method, which invokes the
 * {@code checkGuard} method on the Guard object that is guarding access. If
