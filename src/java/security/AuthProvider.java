 ...
 * performed prior to certain operations.
 *
 * @since 1.5
 */
public abstract class AuthProvider extends Provider {
     ...
     * {@code null} handler to this method, the provider uses the handler set in
     * the {@code setCallbackHandler} method. If no handler was set in that
     * method, the provider queries the <i>auth.login.defaultCallbackHandler</i>
     * security property for the fully qualified class name of a default handler
     * implementation. If the security property is not set, the provider is
     * assumed to have alternative means for obtaining authentication
     * information.
     *
     * @param subject
     ...
     * on behalf of callers. In either case if a handler is not set via this
     * method, the provider queries the <i>auth.login.defaultCallbackHandler</i>
     * security property for the fully qualified class name of a default handler
     * implementation. If the security property is not set, the provider is
     * assumed to have alternative means for obtaining authentication
