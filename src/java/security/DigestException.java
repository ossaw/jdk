...
public class DigestException extends GeneralSecurityException {
    ...
    /**
     * Constructs a DigestException with no detail message. (A detail message is
    ...
    /**
     * Creates a {@code DigestException} with the specified detail message and
     * cause.
     *
     * @param message
    ...
    /**
     * Creates a {@code DigestException} with the specified cause and a detail
