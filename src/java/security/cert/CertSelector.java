...
/**
 * A selector that defines a set of criteria for selecting {@code Certificate}s.
 * Classes that implement this interface are often used to specify which
 * {@code Certificate}s should be retrieved from a {@code CertStore}.
 * <p>
