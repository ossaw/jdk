 ...
 * check for and process a critical private extension of each certificate in a
 * certification path.
 *
 * @since 1.8
 */
public interface CertPathChecker {
	 ...
	 * the ability of the {@code CertPathChecker} to perform its checks when
	 * certificates are presented to the {@code check} method in the forward
	 * direction (from target to trust anchor).
	 *
