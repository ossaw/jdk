 ...
 * {@code TrustAnchor} describing the certification authority (CA) that served
...
public class PKIXCertPathValidatorResult implements CertPathValidatorResult {
    ...
    /**
     * Creates an instance of {@code PKIXCertPathValidatorResult} containing the
    ...
    /**
     * Returns the {@code TrustAnchor} describing the CA that served as a trust
     * anchor for the certification path.
     *
     ...
     * parameters in {@code PKIXParameters}. However, more sophisticated
     * applications, especially those that process policy qualifiers, may need
     * to traverse the valid policy tree using the {@link PolicyNode#getParent
     * PolicyNode.getParent} and {@link PolicyNode#getChildren
     * PolicyNode.getChildren} methods.
     *
     * @return the root node of the valid policy tree, or {@code null} if there
     *         are no valid policies
     */
