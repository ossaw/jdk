...
/**
 * Helper class that allows the Sun CertPath provider to access implementation
 * dependent APIs in CertPath framework.
 *
...
class CertPathHelperImpl extends CertPathHelper {
	...
	/**
	 * Initialize the helper framework. This method must be called from the
	 * static initializer of each class that is the target of one of the methods
	 * in this class. This ensures that the helper is initialized prior to a
	 * tunneled call from the Sun provider.
	 */
