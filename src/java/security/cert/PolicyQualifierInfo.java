 ...
 * certificate.
 * <p>
 * A {@code Set} of {@code PolicyQualifierInfo} objects are returned by the
 ...
 * qualifiers should explicitly set the {@code policyQualifiersRejected} flag to
 ...
 * class on a single {@code PolicyQualifierInfo} object (or more than one) with
 * no ill effects. Requiring {@code PolicyQualifierInfo} objects to be immutable
 * and thread-safe allows them to be passed around to various pieces of code
 * without worrying about coordinating access.
 *
 * @author seth proctor
 * @author Sean Mullan
 * @since 1.4
