 ...
 * {@code CertificateFactory} class. All the abstract methods in this class must
...
public abstract class CertificateFactorySpi {
	 ...
	 * service providers, this method cannot be {@code abstract} and by default
	 ...
	 * Documentation</a> for information about standard encoding names.
	 * <p>
	 ...
	 * formats described for
	 * {@link CertificateFactory#generateCertificate(java.io.InputStream)
	 * generateCertificate}. In addition, {@code inStream} may contain a PKCS#7
	 * certificate chain. This is a PKCS#7 <i>SignedData</i> object, with the
	 * only significant field being <i>certificates</i>. In particular, the
