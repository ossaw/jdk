 ...
 * <p>
 * All {@code PolicyNode} objects must be immutable and thread-safe. Multiple
 * threads may concurrently invoke the methods defined in this class on a single
 * {@code PolicyNode} object (or more than one) with no ill effects. This
