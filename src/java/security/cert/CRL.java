...
/**
 * This class is an abstraction of certificate revocation lists (CRLs) that have
 * different formats but important common uses. For example, all CRLs share the
 * functionality of listing revoked certificates, and can be queried on whether
 * or not they list a given certificate.
 * <p>
