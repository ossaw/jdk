...
public class PKIXParameters implements CertPathParameters {
	 ...
	 *             if the specified {@code Set} is empty
	 *             {@code (trustAnchors.isEmpty() == true)}
	 * @throws NullPointerException
	 *             if the specified {@code Set} is {@code null}
	 * @throws ClassCastException
	 *             if any of the elements in the {@code Set} are not of type
	...
	public void setTrustAnchors(Set<TrustAnchor> trustAnchors)
		...
		this.unmodTrustAnchors = Collections
				.unmodifiableSet(new HashSet<TrustAnchor>(trustAnchors));
	}
	 ...
	 *            a {@code Set} of initial policy OIDs in {@code String} format
	 *            (or {@code null})
	 * @throws ClassCastException
	 *             if any of the elements in the set are not of type
	 *             {@code String}
	...
	public void setInitialPolicies(Set<String> initialPolicies) {
		if (initialPolicies != null) {
			...
			this.unmodInitialPolicies = Collections
					.unmodifiableSet(new HashSet<String>(initialPolicies));
		} else
			this.unmodInitialPolicies = Collections.<String> emptySet();
	}
	 ...
	 *            {@code null}, in which case no additional checkers will be
	 *            used.
	 * @throws ClassCastException
	 *             if any of the elements in the list are not of type
	 ...
	 *
	 * @param checker
	 *            a {@code PKIXCertPathChecker} to add to the list of checks. If
