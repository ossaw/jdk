...
public abstract class X509CRLEntry implements X509Extension {
	...
	/**
	 * Compares this CRL entry for equality with the given object. If the
	 * {@code other} object is an {@code instanceof} {@code X509CRLEntry}, then
	 * its encoded form (the inner SEQUENCE) is retrieved and compared with the
	...
	/**
	 * Gets the revocation date from this X509CRLEntry, the
	...
	/**
	 * Returns the reason the certificate has been revoked, as specified in the
	 * Reason Code extension of this CRL entry.
	 *
	 * @return the reason the certificate has been revoked, or {@code null} if
	 *         this CRL entry does not have a Reason Code extension
	 * @since 1.7
	 */
