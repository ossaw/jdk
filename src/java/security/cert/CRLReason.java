...
/**
 * The CRLReason enumeration specifies the reason that a certificate is revoked,
 * as defined in <a href="http://www.ietf.org/rfc/rfc3280.txt"> RFC 3280:
...
public enum CRLReason {
     ...
     * subject's private key has been compromised. It applies to end-entity
     * certificates only.
     */
    KEY_COMPROMISE,
    ...
    /**
     * This reason indicates that it is known or suspected that the certificate
     * subject's private key has been compromised. It applies to certificate
     * authority (CA) certificates only.
     */
    CA_COMPROMISE,
     ...
     * should be removed from the CRL. It is for use with delta CRLs.
     */
    REMOVE_FROM_CRL,
    ...
    /**
     * This reason indicates that it is known or suspected that the certificate
     * subject's private key has been compromised. It applies to authority
     * attribute (AA) certificates only.
     */
    AA_COMPROMISE
}
