 ...
 * specified in the form of a trusted {@code X509Certificate} or as individual
 * parameters.
 * <p>
 * <b>Concurrent Access</b>
 * <p>
 * All {@code TrustAnchor} objects must be immutable and thread-safe. That is,
 * multiple threads may concurrently invoke the methods defined in this class on
 * a single {@code TrustAnchor} object (or more than one) with no ill effects.
 * Requiring {@code TrustAnchor} objects to be immutable and thread-safe allows
 * them to be passed around to various pieces of code without worrying about
 * coordinating access. This stipulation applies to all public fields and
...
public class TrustAnchor {
	 ...
	 * {@code X509Certificate} and optional name constraints, which are intended
	 * to be used as additional constraints when validating an X.509
	 * certification path.
	 * <p>
	 * The name constraints are specified as a byte array. This byte array
	 * should contain the DER encoded form of the name constraints, as they
	 * would appear in the NameConstraints structure defined in
	 * <a href="http://www.ietf.org/rfc/rfc3280">RFC 3280</a> and X.509. The
	 * ASN.1 definition of this structure appears below.
	 *
	 * <pre>
	 * {@code
	 ...
	 *            the OID or criticality flag. Specify {@code null} to omit the
	 *            parameter.
	 * @throws IllegalArgumentException
	 *             if the name constraints cannot be decoded
	 * @throws NullPointerException
	 *             if the specified {@code X509Certificate} is {@code null}
	 */
	...
	/**
	 * Creates an instance of {@code TrustAnchor} where the most-trusted CA is
	 * specified as an X500Principal and public key. Name constraints are an
	 * optional parameter, and are intended to be used as additional constraints
	 * when validating an X.509 certification path.
	 * <p>
	 * The name constraints are specified as a byte array. This byte array
	 ...
	 * for {@link #TrustAnchor(X509Certificate, byte[])
	 ...
	 *            parameter.
	 * @throws NullPointerException
	 *             if the specified {@code caPrincipal} or {@code pubKey}
	...
	/**
	 * Creates an instance of {@code TrustAnchor} where the most-trusted CA is
	 * specified as a distinguished name and public key. Name constraints are an
	 * optional parameter, and are intended to be used as additional constraints
	 * when validating an X.509 certification path.
	 * <p>
	 * The name constraints are specified as a byte array. This byte array
	 ...
	 *            parameter.
	 * @throws IllegalArgumentException
	 *             if the specified {@code caName} parameter is empty
	 *             {@code (caName.length() == 0)} or incorrectly formatted or
	 *             the name constraints cannot be decoded
	 * @throws NullPointerException
	 *             if the specified {@code caName} or {@code pubKey} parameter
	 *             is {@code null}
	 */
	public TrustAnchor(String caName, PublicKey pubKey, byte[] nameConstraints) {
		...
		if (caName.length() == 0)
			throw new IllegalArgumentException(
					"the caName " + "parameter must be a non-empty String");
	 ...
	 *
	 * @return a trusted {@code X509Certificate} or {@code null} if the trust
	 ...
	 *
	 * @return the public key of the most-trusted CA, or {@code null} if the
	 *         trust anchor was not specified as a trusted public key and name
