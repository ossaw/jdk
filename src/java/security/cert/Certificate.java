 ...
 * certificate is a binding of a principal to a public key which is vouched for
 * by another principal. (A principal represents an entity such as an individual
...
public abstract class Certificate implements java.io.Serializable {
     ...
     *
     * @param type
     *        the standard name of the certificate type. See the
    ...
    /**
     * Compares this certificate for equality with the specified object. If the
     * {@code other} object is an {@code instanceof} {@code Certificate}, then
     * its encoded form is retrieved and compared with the encoded form of this
     * certificate.
     *
     * @param other
     *        the object to test for equality with this certificate.
     * @return true iff the encoded forms of the two certificates match, false
     *         otherwise.
     */
    ...
    protected static class CertificateRep implements java.io.Serializable {
        ...
        protected Object readResolve() throws java.io.ObjectStreamException {
            try {
                ...
                throw new java.io.NotSerializableException("java.security.cert.Certificate: " + type + ": "
                        + e.getMessage());
            }
        }
    }
     ...
     * @throws java.io.ObjectStreamException
     *         if a new object representing this Certificate could not be
     *         created
     * @since 1.3
     */
    protected Object writeReplace() throws java.io.ObjectStreamException {
        try {
            ...
            throw new java.io.NotSerializableException("java.security.cert.Certificate: " + type + ": " + e
                    .getMessage());
        }
    }
}
