 ...
 * exceptions. The {@link #getCause getCause} method returns the throwable, if
 * any, that caused this exception to be thrown.
 * <p>
 * A {@code CertPathValidatorException} may also include the certification path
 * that was being validated when the exception was thrown, the index of the
 * certificate in the certification path that caused the exception to be thrown,
 * and the reason that caused the failure. Use the {@link #getCertPath
 * getCertPath}, {@link #getIndex getIndex}, and {@link #getReason getReason}
...
public class CertPathValidatorException extends GeneralSecurityException {
	...
	/**
	 * @serial the index of the certificate in the certification path that
	 *         caused the exception to be thrown
	 */
	private int index = -1;

	/**
	 * @serial the {@code CertPath} that was being validated when the exception
	 *         was thrown
	 */
	...
	/**
	 * Creates a {@code CertPathValidatorException} with the given detail
	...
	/**
	 * Creates a {@code CertPathValidatorException} that wraps the specified
	 * throwable. This allows any exception to be converted into a
	 * {@code CertPathValidatorException}, while retaining information about the
	 * wrapped exception, which may be useful for debugging. The detail message
	 * is set to ({@code cause==null ? null : cause.toString()}) (which
	...
	/**
	 * Creates a {@code CertPathValidatorException} with the specified detail
	 * message and cause.
	 *
	 * @param msg
	 *              the detail message
	...
	/**
	 * Creates a {@code CertPathValidatorException} with the specified detail
	 * message, cause, certification path, and index.
	 *
	 * @param msg
	 *                 the detail message (or {@code null} if none)
	 * @param cause
	 *                 the cause (or {@code null} if none)
	 * @param certPath
	 ...
	 *                 that
	 *                 caused the error (or -1 if not applicable). Note that the
	 *                 list
	 *                 of certificates in a {@code CertPath} is zero based.
	 * @throws IndexOutOfBoundsException
	 *                                   if the index is out of range
	 *                                   {@code (index < -1 || (certPath != null && index >=
	 * certPath.getCertificates().size()) }
	 * @throws IllegalArgumentException
	 *                                   if {@code certPath} is {@code null} and
	 *                                   {@code index} is not
	 *                                   -1
	 */
	public CertPathValidatorException(String msg, Throwable cause,
	...
	/**
	 * Creates a {@code CertPathValidatorException} with the specified detail
	 * message, cause, certification path, index, and reason.
	 *
	 * @param msg
	 *                 the detail message (or {@code null} if none)
	 * @param cause
	...
	public CertPathValidatorException(String msg, Throwable cause,
		...
		if (index < -1 || (certPath != null && index >= certPath
	 ...
	 *
	 * @return the {@code CertPath} that was being validated when the exception
	 *         was thrown (or {@code null} if not specified)
	 */
	 ...
	 * a {@code CertPath} is zero based. If no index has been set, -1 is
	 * returned.
	 *
	 ...
	 * with the index of the certificate returned by {@link #getIndex}.
	 *
