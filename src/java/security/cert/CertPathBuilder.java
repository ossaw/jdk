 ...
 * {@code CertPathBuilder}, call one of the static {@code getInstance} methods,
 * passing in the algorithm name of the {@code CertPathBuilder} desired and
 * optionally the name of the provider desired.
 *
 * <p>
 * Once a {@code CertPathBuilder} object has been created, certification paths
 * can be constructed by calling the {@link #build build} method and passing it
 * an algorithm-specific set of parameters. If successful, the result (including
 * the {@code CertPath} that was built) is returned in an object that implements
 * the {@code CertPathBuilderResult} interface.
 *
 * <p>
 ...
 * > CertPathBuilder section</a> of the Java Cryptography Architecture Standard
 ...
 * threads each manipulating a different {@code CertPathBuilder} instance need
 * not synchronize.
 *
 * @see CertPath
 *
...
public class CertPathBuilder {
	 ...
	 * default certpathbuilder type. In the Security properties file, the
	 * default certpathbuilder type is given as: <pre> certpathbuilder.type=PKIX
	 * </pre>
	 */
	...
	/**
	 * Creates a {@code CertPathBuilder} object of the given algorithm, and
	...
	/**
	 * Returns a {@code CertPathBuilder} object that implements the specified
	 * algorithm.
	 *
	 * <p>
	 * This method traverses the list of registered security Providers, starting
	 * with the most preferred Provider. A new CertPathBuilder object
	 * encapsulating the CertPathBuilderSpi implementation from the first
	 ...
	 *
	 * @param algorithm
	 *            the name of the requested {@code CertPathBuilder} algorithm.
	 *            See the CertPathBuilder section in the <a href=
	 *            "{@docRoot}/../technotes/guides/security/StandardNames.html#CertPathBuilder"
	 *            > Java Cryptography Architecture Standard Algorithm Name
	 *            Documentation</a> for information about standard algorithm
	 *            names.
	 *
	 * @return a {@code CertPathBuilder} object that implements the specified
	 *         algorithm.
	 *
	 * @throws NoSuchAlgorithmException
	 *             if no Provider supports a CertPathBuilderSpi implementation
	 *             for the specified algorithm.
	 *
	 * @see java.security.Provider
	 */
	public static CertPathBuilder getInstance(String algorithm) throws NoSuchAlgorithmException {
		Instance instance = GetInstance.getInstance("CertPathBuilder", CertPathBuilderSpi.class,
				algorithm);
		return new CertPathBuilder((CertPathBuilderSpi) instance.impl, instance.provider,
				algorithm);
	}
	 ...
	 *
	 * @throws NoSuchAlgorithmException
	 *             if a CertPathBuilderSpi implementation for the specified
	...
	/**
	 * Returns the default {@code CertPathBuilder} type as specified by the
	 * {@code certpathbuilder.type} security property, or the string
	 * {@literal "PKIX"} if no such property exists.
	 *
	 * <p>
	 * The default {@code CertPathBuilder} type can be used by applications that
	 * do not want to use a hard-coded type when calling one of the
	 * {@code getInstance} methods, and want to provide a default type in case a
	 * user does not specify its own.
	 *
	 * <p>
	 * The default {@code CertPathBuilder} type can be changed by setting the
	 * value of the {@code certpathbuilder.type} security property to the
	 * desired type.
	 *
	 * @see java.security.Security security properties
	 * @return the default {@code CertPathBuilder} type as specified by the
	 *         {@code certpathbuilder.type} security property, or the string
	 *         {@literal "PKIX"} if no such property exists.
	 */
