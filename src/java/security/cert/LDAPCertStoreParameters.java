 ...
 * <p>
 * This class is used to provide necessary configuration parameters (server name
 * and port number) to implementations of the LDAP {@code CertStore} algorithm.
 * <p>
...
public class LDAPCertStoreParameters implements CertStoreParameters {
    ...
    /**
     * Creates an instance of {@code LDAPCertStoreParameters} with the specified
     * parameter values.
     *
     * @param serverName
     *                   the DNS name of the LDAP server
    ...
    /**
     * Creates an instance of {@code LDAPCertStoreParameters} with the default
     * parameter values (server name "localhost", port 389).
     */
     ...
     * calls {@code Object.clone()}). This may be changed in a future revision
     * to perform a deep copy if new parameters are added that should not be
     * shared.
     *
     * @return the copy
     */
