 ...
 * {@code AlgorithmParameters} class, which is used to manage algorithm
 * parameters.
 *
 * <p>
 * All the abstract methods in this class must be implemented by each
 * cryptographic service provider who wishes to supply parameter management for
...
public abstract class AlgorithmParametersSpi {
     ...
     * the specified decoding format. If {@code format} is null, the primary
    ...
    /**
     * Returns the parameters encoded in the specified format. If {@code format}
