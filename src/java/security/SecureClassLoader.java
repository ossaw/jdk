...
public class SecureClassLoader extends ClassLoader {
	 ...
	 *                certificates than this class, or if the class name begins
	 *                with "java.".
	 */
	...
	/**
	 * Converts a {@link java.nio.ByteBuffer ByteBuffer} into an instance of
	 * class {@code Class}, with an optional CodeSource. Before the class can be
