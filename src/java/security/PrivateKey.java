 ...
 * example, the {@code DSAPrivateKey} interface in
 * {@link java.security.interfaces}.
 * <p>
 * Implementations should override the default {@code destroy} and
 * {@code isDestroyed} methods from the {@link javax.security.auth.Destroyable}
 * interface to enable sensitive key information to be destroyed, cleared, or in
 * the case where such information is immutable, unreferenced. Finally, since
 * {@code PrivateKey} is {@code Serializable}, implementations should also
 * override {@link java.io.ObjectOutputStream#writeObject(java.lang.Object)} to
 * prevent keys that have been destroyed from being serialized.
 *
 * @see Key
 * @see PublicKey
 * @see Certificate
