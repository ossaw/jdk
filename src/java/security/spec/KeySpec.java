 ...
 * private key may be specified by its components {@code x}, {@code p},
 * {@code q}, and {@code g} (see {@link DSAPrivateKeySpec}), or it may be
 * specified using its DER encoding (see {@link PKCS8EncodedKeySpec}).
 *
 * <P>
