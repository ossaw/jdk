...
/**
 * This immutable class holds the necessary values needed to represent an
 * elliptic curve.
 *
 * @see ECField
 * @see ECFieldFp
...
public class EllipticCurve {
	...
	/**
	 * Creates an elliptic curve with the specified elliptic field {@code field}
	...
	/**
	 * Creates an elliptic curve with the specified elliptic field {@code field}
	 * , the coefficients {@code a} and {@code b}, and the {@code seed} used for
	 * curve generation.
	 * 
	 * @param field
	 *              the finite field that this elliptic curve is over.
	 ...
	 * 
	 * @return the field {@code field} that this curve is over.
	 */
	...
	/**
	 * Returns the seeding bytes {@code seed} used during curve generation. May
	 * be null if not specified.
	 * 
	 * @return the seeding bytes {@code seed}. A new array is returned each time
