...
/**
 * This immutable class defines an elliptic curve (EC) characteristic 2 finite
 * field.
 *
 * @see ECField
 *
...
public class ECFieldF2m implements ECField {
    ...
    /**
     * Creates an elliptic curve characteristic 2 finite field which has 2^
     * {@code m} elements with polynomial basis. The reduction polynomial for
     * this field is based on {@code rp} whose i-th bit corresponds to the i-th
     * coefficient of the reduction polynomial.
     * <p>
     * Note: A valid reduction polynomial is either a trinomial (X^{@code m} +
     * X^{@code k} + 1 with {@code m} &gt; {@code k} &gt;= 1) or a pentanomial
     * (X^{@code m} + X^{@code k3} + X^{@code k2} + X^{@code k1} + 1 with
     ...
     * Creates an elliptic curve characteristic 2 finite field which has 2^
     * {@code m} elements with polynomial basis. The reduction polynomial for
     * this field is based on {@code ks} whose content contains the order of the
     * middle term(s) of the reduction polynomial. Note: A valid reduction
     * polynomial is either a trinomial (X^{@code m} + X^{@code k} + 1 with
     * {@code m} &gt; {@code k} &gt;= 1) or a pentanomial (X^{@code m} + X^
     * {@code k3} + X^{@code k2} + X^{@code k1} + 1 with {@code m} &gt;
     * {@code k3} &gt; {@code k2} &gt; {@code k1} &gt;= 1), so {@code ks} should
     * have length 1 or 3.
     * 
     * @param m
     *           with 2^{@code m} being the number of elements.
    ...
    /**
     * Returns the field size in bits which is {@code m} for this characteristic
     * 2 finite field.
     * 
     ...
     * 
     * @return {@code m} with 2^{@code m} being the number of elements.
     */
    public int getM() {
        return m;
    }
    ...
    /**
     * Returns a BigInteger whose i-th bit corresponds to the i-th coefficient
     * of the reduction polynomial for polynomial basis or null for normal
     * basis.
     * 
     * @return a BigInteger whose i-th bit corresponds to the i-th coefficient
     *         of the reduction polynomial for polynomial basis or null for
     *         normal basis.
     */
    ...
    /**
     * Returns an integer array which contains the order of the middle term(s)
     * of the reduction polynomial for polynomial basis or null for normal
     * basis.
     * 
     * @return an integer array which contains the order of the middle term(s)
     *         of the reduction polynomial for polynomial basis or null for
     *         normal basis. A new array is returned each time this method is
     *         called.
     */
     ...
     * @return true if {@code obj} is an instance of ECFieldF2m and both
     *         {@code m} and the reduction polynomial match, false otherwise.
     */
