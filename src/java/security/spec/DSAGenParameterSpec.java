 ...
 * <a href="http://csrc.nist.gov/publications/fips/fips186-3/fips_186-3.pdf">
...
public final class DSAGenParameterSpec implements AlgorithmParameterSpec {
	 ...
	 * using {@code primePLen} and {@code subprimeQLen}. The value of
	 * {@code subprimeQLen} is also used as the default length of the domain
	 ...
	 *                if {@code primePLen} or {@code subprimeQLen} is illegal
	 ...
	 *            the desired length of the sub-prime Q in bits.
	 * @param seedLen
	 *            the desired length of the domain parameter seed in bits, shall
	 *            be equal to or greater than {@code subprimeQLen}.
	 * @exception IllegalArgumentException
	 *                if {@code primePLenLen}, {@code subprimeQLen}, or
	 *                {@code seedLen} is illegal per the specification of FIPS
	 *                186-3.
	 */
	...
	/**
	 * Returns the desired length of the prime P of the to-be-generated DSA
	 * domain parameters in bits.
	 * 
	...
	/**
	 * Returns the desired length of the sub-prime Q of the to-be-generated DSA
	 * domain parameters in bits.
	 * 
