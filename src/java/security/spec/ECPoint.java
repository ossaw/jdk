...
/**
 * This immutable class represents a point on an elliptic curve (EC) in affine
 * coordinates. Other coordinate systems can extend this class to represent this
...
public class ECPoint {
	...
	/**
	 * Creates an ECPoint from the specified affine x-coordinate {@code x} and
	...
	/**
	 * Returns the affine x-coordinate {@code x}. Note: POINT_INFINITY has a
	 * null affine x-coordinate.
	 * 
	...
	/**
	 * Returns the affine y-coordinate {@code y}. Note: POINT_INFINITY has a
	 * null affine y-coordinate.
	 * 
	...
	/**
	 * Compares this elliptic curve point for equality with the specified
	 * object.
	 * 
	 * @param obj
