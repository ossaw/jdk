...
public class ECGenParameterSpec implements AlgorithmParameterSpec {
    ...
    /**
     * Creates a parameter specification for EC parameter generation using a
     * standard (or predefined) name {@code stdName} in order to generate the
     * corresponding (precomputed) elliptic curve domain parameters. For the
     * list of supported names, please consult the documentation of provider
