...
/**
 * This class specifies a parameter spec for RSA-PSS signature scheme, as
 * defined in the <a href="http://www.ietf.org/rfc/rfc3447.txt">PKCS#1 v2.1</a>
 * standard.
 * <p>
...
public class PSSParameterSpec implements AlgorithmParameterSpec {
     ...
     * using the specified message digest, mask generation function, parameters
    ...
    /**
     * Creates a new {@code PSSParameterSpec} using the specified salt length
