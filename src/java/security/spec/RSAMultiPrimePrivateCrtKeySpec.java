...
/**
 * This class specifies an RSA multi-prime private key, as defined in the PKCS#1
 * v2.1, using the Chinese Remainder Theorem (CRT) information values for
 * efficiency.
 *
 * @author Valerie Peng
 *
...
public class RSAMultiPrimePrivateCrtKeySpec extends RSAPrivateKeySpec {
	...
	/**
	 * Creates a new {@code RSAMultiPrimePrivateCrtKeySpec} given the modulus,
	 ...
	 *
	 * <p>
	 * Note that the contents of {@code otherPrimeInfo} are copied to protect
	 * against subsequent modification when constructing this object.
	 *
	 * @param modulus
	 *            the modulus n.
	 ...
	 *            triplets of the rest of primes, null can be specified if there
	 *            are only two prime factors (p and q).
	 * @exception NullPointerException
	 *                if any of the parameters, i.e. {@code modulus},
	 *                {@code publicExponent}, {@code privateExponent},
	 *                {@code primeP}, {@code primeQ}, {@code primeExponentP},
	 *                {@code primeExponentQ}, {@code crtCoefficient}, is null.
	 * @exception IllegalArgumentException
	 *                if an empty, i.e. 0-length, {@code otherPrimeInfo} is
	 *                specified.
	 */
	public RSAMultiPrimePrivateCrtKeySpec(BigInteger modulus, BigInteger publicExponent,
		...
		if (otherPrimeInfo == null) {
			...
			throw new IllegalArgumentException(
					"the otherPrimeInfo " + "parameter must not be empty");
		} else {
	...
	/**
	 * Returns a copy of the otherPrimeInfo or null if there are only two prime
	 * factors (p and q).
	 *
	 * @return the otherPrimeInfo. Returns a new array each time this method is
	 *         called.
	 */
