...
public abstract class KeyStoreSpi {
     ...
     *            is wrong).
     */
    public abstract Key engineGetKey(String alias, char[] password) throws NoSuchAlgorithmException,
     ...
     *            not identify an
     *            entry containing a trusted certificate, or
     *            this operation
     *            fails for some other reason.
     */
     ...
     *
     * @param param
     *        the {@code KeyStore.LoadStoreParameter} that specifies how
     *        to
    ...
    public void engineSetEntry(String alias, KeyStore.Entry entry, KeyStore.ProtectionParameter protParam)
        ...
        if (entry instanceof KeyStore.TrustedCertificateEntry) {
            ...
            if (pProtect == null || pProtect.getPassword() == null) {
                ...
                engineSetKeyEntry(alias, ((KeyStore.PrivateKeyEntry) entry).getPrivateKey(), pProtect
                        .getPassword(), ((KeyStore.PrivateKeyEntry) entry).getCertificateChain());
                return;
            }
            ...
            if (pProtect == null || pProtect.getPassword() == null) {
                ...
                engineSetKeyEntry(alias, ((KeyStore.SecretKeyEntry) entry).getSecretKey(), pProtect
                        .getPassword(), (Certificate[]) null);
                return;
            }
        }
