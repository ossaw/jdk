 ...
 * example, different types of certificates, such as X.509 certificates and PGP
 ...
 * is that of the specified principal. So an implementation of X.509
 ...
 * own. In particular, a Certificate object does not make any statement as to
 * the <i>validity</i> of the binding. It is the duty of the application
 * implementing this interface to verify the certificate and satisfy itself of
 * its validity.
 *
 * @author Benjamin Renaud
 * @deprecated A new certificate handling package is created in the Java
 *             platform. This Certificate interface is entirely deprecated and
 *             is here to allow for a smooth transition to the new package.
