...
public class KeyManagementException extends KeyException {
	...
	/**
	 * Constructs a KeyManagementException with no detail message. A detail
	...
	/**
	 * Constructs a KeyManagementException with the specified detail message. A
	...
	/**
	 * Creates a {@code KeyManagementException} with the specified detail
	 * message and cause.
	 *
	 * @param message
	...
	/**
	 * Creates a {@code KeyManagementException} with the specified cause and a
