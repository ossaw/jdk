 ...
 * that is not allowed according to the security policy. Such information should
 * be given whenever possible at the time the exception is thrown.
 *
 * @author Li Gong
...
public class AccessControlException extends SecurityException {
    ...
    /**
     * Constructs an {@code AccessControlException} with the specified, detailed
     * message.
     *
     * @param s
     *          the detail message.
    ...
    /**
     * Gets the Permission object associated with this exception, or null if
     * there was no corresponding Permission object.
     *
