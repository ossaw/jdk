...
/**
 * This exception is thrown by {@code doPrivileged(PrivilegedExceptionAction)}
 * and {@code doPrivileged(PrivilegedExceptionAction,
 * AccessControlContext context)} to indicate that the action being performed
 * threw a checked exception. The exception thrown by the action can be obtained
 ...
 * privileged computation" that is provided at construction time and accessed
 * via the {@link #getException()} method is now known as the <i>cause</i>, and
 * may be accessed via the {@link Throwable#getCause()} method, as well as the
...
public class PrivilegedActionException extends Exception {
	...
	/**
	 * Constructs a new PrivilegedActionException &quot;wrapping&quot; the
	 * specific Exception.
	 *
	 * @param exception
	...
	/**
	 * Returns the cause of this exception (the exception thrown by the
	 * privileged computation that resulted in this
