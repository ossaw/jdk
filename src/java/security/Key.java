 ...
 * standard format (such as X.509 {@code SubjectPublicKeyInfo} or PKCS#8), and
 * is returned using the {@link #getEncoded() getEncoded} method. Note: The
 * syntax of the ASN.1 type {@code SubjectPublicKeyInfo} is defined as follows:
 *
 * <pre>
 ...
 * in untrusted environments. See the
...
public interface Key extends java.io.Serializable {
     ...
     * standard; in this case, the returned format is {@code "X.509"}.
     ...
     * the returned format is {@code "PKCS#8"}.
     *
