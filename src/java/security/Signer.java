...
/**
 * This class is used to represent an Identity that can also digitally sign
 * data.
 *
 * <p>
...
public abstract class Signer extends Identity {
	 ...
	 * method is called with {@code "getSignerPrivateKey"} as its argument to
	 * see if it's ok to return the private key.
	 *
	 ...
	 * <p>
	 * First, if there is a security manager, its {@code checkSecurityAccess}
	 * method is called with {@code "setSignerKeyPair"} as its argument to see
	 * if it's ok to set the key pair.
	 *
	 * @param pair
	 *             an initialized key pair.
	 *
	 * @exception InvalidParameterException
	 *                                      if the key pair is not properly
	 *                                      initialized.
	 * @exception KeyException
	 *                                      if the key pair cannot be set for
	 *                                      any other reason.
	 * @exception SecurityException
	 *                                      if a security manager exists and its
