 ...
 * implementation classes. Charset providers may be installed in an instance of
 * the Java platform as extensions, that is, jar files placed into any of the
 * usual extension directories. Providers may also be made available by adding
 * them to the applet or application class path or by some other
 ...
 * <tt>META-INF/services</tt>. The file should contain a list of fully-qualified
 * concrete charset-provider class names, one per line. A line is terminated by
 * any one of a line feed (<tt>'\n'</tt>), a carriage return (<tt>'\r'</tt>), or
 * a carriage return followed immediately by a line feed. Space and tab
