...
class DirectByteBufferR
    ...
    public CharBuffer asCharBuffer() {
        ...
        if (!unaligned && ((address + off) % (1 << 1) != 0)) {
            ...
            return (nativeByteOrder ? (CharBuffer) (new DirectCharBufferRU(this, -1, 0, size, size, off))
    ...
    public ShortBuffer asShortBuffer() {
        ...
        if (!unaligned && ((address + off) % (1 << 1) != 0)) {
            ...
            return (nativeByteOrder ? (ShortBuffer) (new DirectShortBufferRU(this, -1, 0, size, size, off))
    ...
    public IntBuffer asIntBuffer() {
        ...
        if (!unaligned && ((address + off) % (1 << 2) != 0)) {
            ...
            return (nativeByteOrder ? (IntBuffer) (new DirectIntBufferRU(this, -1, 0, size, size, off))
    ...
    public LongBuffer asLongBuffer() {
        ...
        if (!unaligned && ((address + off) % (1 << 3) != 0)) {
            ...
            return (nativeByteOrder ? (LongBuffer) (new DirectLongBufferRU(this, -1, 0, size, size, off))
    ...
    public FloatBuffer asFloatBuffer() {
        ...
        if (!unaligned && ((address + off) % (1 << 2) != 0)) {
            ...
            return (nativeByteOrder ? (FloatBuffer) (new DirectFloatBufferRU(this, -1, 0, size, size, off))
    ...
    public DoubleBuffer asDoubleBuffer() {
        ...
        if (!unaligned && ((address + off) % (1 << 3) != 0)) {
            ...
            return (nativeByteOrder ? (DoubleBuffer) (new DirectDoubleBufferRU(this, -1, 0, size, size, off))
