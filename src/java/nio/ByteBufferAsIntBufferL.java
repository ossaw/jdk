...
class ByteBufferAsIntBufferL // package-private
	...
	ByteBufferAsIntBufferL(ByteBuffer bb, int mark, int pos, int lim, int cap,
			int off) {
	...
	public IntBuffer duplicate() {
		return new ByteBufferAsIntBufferL(bb, this.markValue(), this.position(),
				this.limit(), this.capacity(), offset);
	}

	public IntBuffer asReadOnlyBuffer() {

		return new ByteBufferAsIntBufferRL(bb, this.markValue(), this
