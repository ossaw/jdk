 ...
 * the registration. An object may be registered with more than one watch
 * service. Registration with a watch service is cancelled by invoking the key's
...
public interface Watchable {
	 ...
	 *             if an invalid of combination of events are modifiers are
	 *             specified
	 ...
	 *             unspecified permission required to monitor this object.
