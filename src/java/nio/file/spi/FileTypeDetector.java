 ...
 * implementation specific. A simple implementation might examine the
 * <em>file extension</em> (a convention used in some platforms) and map it to a
 * file type. In other cases, the file type may be stored as a file
 * <a href="../attribute/package-summary.html"> attribute</a> or the bytes in a
...
public abstract class FileTypeDetector {
     ...
     * a file <a href="../attribute/package-summary.html">attribute</a>, or it
     * may examines bytes in the file.
     *
     * <p>
     * The probe result is the string form of the value of a Multipurpose
     * Internet Mail Extension (MIME) content type as defined by
