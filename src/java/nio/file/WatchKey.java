 ...
 * {@link WatchService#poll() poll} or {@link WatchService#take() take} methods.
 * Once signalled, a key remains in this state until its {@link #reset reset}
 * method is invoked to return the key to the ready state. Events detected while
 * the key is in the signalled state are queued but do not cause the key to be
