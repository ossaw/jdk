...
public final class StandardWatchEventKinds {
     ...
     * specific and may be {@code null}. The event {@link WatchEvent#count
     * count} may be greater than {@code 1}.
     *
     * @see WatchService
     */
     ...
     */
    public static final WatchEvent.Kind<Path> ENTRY_CREATE = new StdWatchEventKind<Path>(
            "ENTRY_CREATE", Path.class);
     ...
     * the directory. The event {@link WatchEvent#count count} for this event is
     * always {@code 1}.
     */
    public static final WatchEvent.Kind<Path> ENTRY_DELETE = new StdWatchEventKind<Path>(
            "ENTRY_DELETE", Path.class);
     ...
     * {@code 1} or greater.
     */
    public static final WatchEvent.Kind<Path> ENTRY_MODIFY = new StdWatchEventKind<Path>(
            "ENTRY_MODIFY", Path.class);
