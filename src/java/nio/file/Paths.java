...
public final class Paths {
	 ...
	 * of the calling code. Hence it should not be used in library code intended
	 * for flexible reuse. A more flexible alternative is to use an existing
	 * {@code Path} instance as an anchor, such as:
	 * 
	 * <pre>
	 *     Path dir = ...
	 ...
	 * <i>p</i>
	 * <tt>.{@link Path#toAbsolutePath() toAbsolutePath}())</tt> </blockquote>
