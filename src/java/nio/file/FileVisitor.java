 ...
 * {@link Files#walkFileTree Files.walkFileTree} methods to visit each file in a
 * file tree.
 * <p>
 * <b>Usage Examples:</b> Suppose we want to delete a file tree. In that case,
 * each directory should be deleted after the entries in the directory are
 * deleted.
 * 
 * <pre>
 *     Path start = ...
 ...
 * </pre>
 * <p>
 * Furthermore, suppose we want to copy a file tree to a target location. In
 * that case, symbolic links should be followed and the target directory should
 * be created before the entries in the directory are copied.
 * 
 * <pre>
 *     final Path source = ...
 *     final Path target = ...
