 ...
 * operation</em> by invoking the {@link #readAttributes() readAttributes}
 * method. This class also defines the {@link #setTimes setTimes} method to
 * update the file's time attributes.
 *
 * <p>
 * Where dynamic access to file attributes is required, the attributes supported
 * by this attribute view have the following names and types: <blockquote>
 ...
 * to read any of these attributes as if by invoking the
 * {@link #readAttributes() readAttributes()} method.
 *
 * <p>
...
public interface BasicFileAttributeView extends FileAttributeView {
	 ...
	 *
	 * <p>
	 * If any of the {@code lastModifiedTime}, {@code lastAccessTime}, or
	 * {@code createTime} parameters has the value {@code null} then the
	 ...
	 *
	 * <p>
	 * <b>Usage Example:</b> Suppose we want to change a file's last access
	 * time.
	 * 
	 * <pre>
	 *    Path path = ...
