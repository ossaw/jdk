...
/**
 * A file attribute view that provides a view of the legacy "DOS" file
 * attributes. These attributes are supported by file systems such as the File
 * Allocation Table (FAT) format commonly used in <em>consumer devices</em>.
 *
 * <p>
 ...
 * by this attribute view are as defined by {@code
 ...
 *
 * <p>
 * The {@link java.nio.file.Files#getAttribute getAttribute} method may be used
 * to read any of these attributes, or any of the attributes defined by
 ...
 * to update the file's last modified time, last access time or create time
 * attributes as defined by {@link BasicFileAttributeView}. It may also be used
 * to update the DOS attributes as if by invoking the {@link #setReadOnly
...
public interface DosFileAttributeView extends BasicFileAttributeView {
	 ...
	 * @throws SecurityException
	 *             In the case of the default, and a security manager is
