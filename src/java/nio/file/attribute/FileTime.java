 ...
 * {@link BasicFileAttributes#lastAccessTime() accessed}, or
 * {@link BasicFileAttributes#creationTime() created}.
 * <p>
...
public final class FileTime implements Comparable<FileTime> {
    /**
     * The unit of granularity to interpret the value. Null if this
     * {@code FileTime} is converted from an {@code Instant}, the {@code value}
     * and {@code unit} pair will not be used in this scenario.
     */
    ...
    /**
     * Returns a {@code FileTime} representing the same point of time value on
     ...
     * on the time-line as this {@code FileTime}.
     * <p>
     * {@code FileTime} can store points on the time-line further in the future
     * and further in the past than {@code Instant}. Conversion from such
     * further time points saturates to {@link Instant#MIN} if earlier than
     * {@code Instant.MIN} or {@link Instant#MAX} if later than
     * {@code Instant.MAX}.
     *
     * @return an instant representing the same point on the time-line as this
     *         {@code FileTime} object
     * @since 1.8
     */
     ...
     * method satisfies the general contract of the {@code Object.equals}
     * method.
     *
     * @param obj
     ...
     *         is before {@code other}, and a value greater than 0 if this
    ...
    /**
     * Returns the string representation of this {@code FileTime}. The string is
     * returned in the
     * <a href="http://www.w3.org/TR/NOTE-datetime">ISO&nbsp;8601</a> format:
     * 
     * <pre>
     *     YYYY-MM-DDThh:mm:ss[.s+]Z
     * </pre>
     * 
     * where "{@code [.s+]}" represents a dot followed by one of more digits for
     * the decimal fraction of a second. It is only present when the decimal
     * fraction of a second is not zero. For example, {@code
     * FileTime.fromMillis(1234567890000L).toString()} yields {@code
     * "2009-02-13T23:31:30Z"}, and
     * {@code FileTime.fromMillis(1234567890123L).toString()} yields
     * {@code "2009-02-13T23:31:30.123Z"}.
     * <p>
