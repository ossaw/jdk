 ...
 * {@link java.nio.channels.FileChannel#map FileChannel.map} method. This class
 ...
 *
 * <p>
 * The content of a mapped byte buffer can change at any time, for example if
 * the content of the corresponding region of the mapped file is changed by this
 * program or another. Whether or not such changes occur, and when they occur,
 * is operating-system dependent and therefore unspecified.
 *
 * <a name="inaccess"></a>
 * <p>
 ...
 *
 * <p>
 * Mapped byte buffers otherwise behave no differently than ordinary direct byte
 * buffers.
 * </p>
 *
 *
...
public abstract class MappedByteBuffer extends ByteBuffer {
	...
	// Returns the distance (in bytes) of the buffer from the page aligned
	// address
	// of the mapping. Computed each time to avoid storing in every direct
	// buffer.
	 ...
	 *
	 * <p>
	 * A return value of <tt>true</tt> implies that it is highly likely that all
	 * of the data in this buffer is resident in physical memory and may
	 * therefore be accessed without incurring any virtual-memory page faults or
	 * I/O operations. A return value of <tt>false</tt> does not necessarily
	 * imply that the buffer's content is not resident in physical memory.
	 *
	 * <p>
	 ...
	 * </p>
	 *
	 * @return <tt>true</tt> if it is likely that this buffer's content is
	 ...
	 * then when this method returns it is guaranteed that all changes made to
	 * the buffer since it was created, or since this method was last invoked,
	 ...
	 * {@link java.nio.channels.FileChannel.MapMode#READ_WRITE}) then invoking
