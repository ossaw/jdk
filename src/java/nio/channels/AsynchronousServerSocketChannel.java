 ...
 * channel is open but not yet bound. It can be bound to a local address and
 * configured to listen for connections by invoking the
 * {@link #bind(SocketAddress,int) bind} method. Once bound, the
 * {@link #accept(Object,CompletionHandler) accept} method is used to initiate
 ...
 * type support the following options: <blockquote> <table border summary=
 * "Socket options">
 * <tr>
 * <th>Option Name</th>
 * <th>Description</th>
...
public abstract class AsynchronousServerSocketChannel implements AsynchronousChannel, NetworkChannel {
     ...
     * {@link java.nio.channels.spi.AsynchronousChannelProvider} object that
     * created the given group. If the group parameter is <tt>null</tt> then the
     ...
     * {@link AsynchronousChannelGroup} as this channel. If the group is
     * {@link AsynchronousChannelGroup#isShutdown shutdown} and a connection is
     ...
     * manner as the {@link #accept(Object, CompletionHandler)} method except
     * that instead of specifying a completion handler, this method returns a
     * {@code Future} representing the pending result. The {@code
     * Future}'s {@link Future#get() get} method returns the
     * {@link AsynchronousSocketChannel} to the new connection on successful
     * completion.
     *
