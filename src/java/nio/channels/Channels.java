...
public final class Channels {
     ...
     *         If the channel is selectable and
    ...
    public static OutputStream newOutputStream(final WritableByteChannel ch) {
        ...
        return new OutputStream() {
            ...
            public synchronized void write(byte[] bs, int off, int len) throws IOException {
                if ((off < 0) || (off > bs.length) || (len < 0) || ((off + len) > bs.length) || ((off
                        + len) < 0)) {
    ...
    private static class ReadableByteChannelImpl extends AbstractInterruptibleChannel // Not
            // really
            // interruptible
    ...
    private static class WritableByteChannelImpl extends AbstractInterruptibleChannel // Not
            // really
            // interruptible
     ...
     *        <tt>-1</tt> if an implementation-dependent default
     *        capacity is
     *        to be used
     * @return A new reader
     */
     ...
     * @return A new writer
     */
    public static Writer newWriter(final WritableByteChannel ch, final CharsetEncoder enc,
