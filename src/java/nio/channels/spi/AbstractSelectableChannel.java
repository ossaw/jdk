 ...
 * channel as well as its current set of selection keys. It performs all of the
 * synchronization required to implement the
 * {@link java.nio.channels.SelectableChannel} specification. Implementations of
...
public abstract class AbstractSelectableChannel extends SelectableChannel {
	 ...
	 * selector is invoked while holding the appropriate locks. The resulting
	 * key is added to this channel's key set before being returned.
	 * </p>
	 *
	 ...
	 * {@link java.nio.channels.Channel#close close} method, in turn invokes the
	 * {@link #implCloseSelectableChannel implCloseSelectableChannel} method in
	 * order to perform the actual work of closing this channel. It then cancels
	 * all of this channel's keys.
	 * </p>
	 */
	 ...
	 * the blocking mode. This method is only invoked if the new mode is
