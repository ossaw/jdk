 ...
 * {@link java.nio.channels.Pipe#open Pipe},
 * {@link java.nio.channels.Selector#open Selector},
 * {@link java.nio.channels.ServerSocketChannel#open ServerSocketChannel}, and
 * {@link java.nio.channels.SocketChannel#open SocketChannel} classes. It is
 * also used by the {@link java.lang.System#inheritedChannel
...
public abstract class SelectorProvider {
	 ...
	 * <tt>java.nio.channels.spi.SelectorProvider</tt> in the resource directory
	 * <tt>META-INF/services</tt>, then the first class name specified in that
	 * file is taken. The class is loaded and instantiated; if this process
	 * fails then an unspecified error is thrown.
	 * </p>
	 * </li>
	 *
	 ...
	 * the entity that created the process. The manner in which this is done is
	 * system dependent, as are the possible entities to which the channel may
	 * be connected. For example, on UNIX systems, the Internet services daemon
	 * (<i>inetd</i>) is used to start programs to service requests when a
	 ...
	 * then a {@link java.nio.channels.SocketChannel SocketChannel} is returned.
	 * The socket channel is, at least initially, in blocking mode, bound to a
	 ...
	 * then a {@link java.nio.channels.ServerSocketChannel ServerSocketChannel}
	 * is returned. The server-socket channel is, at least initially, in
	 ...
	 * {@link java.nio.channels.DatagramChannel DatagramChannel} is returned.
	 * The datagram channel is, at least initially, in blocking mode, and bound
	 * to a socket address.
	 * </p>
	 * </li>
	 *
