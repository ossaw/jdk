 ...
 * That this exception is thrown does not necessarily imply that the channel is
 * completely closed. A socket channel whose write half has been shut down, for
 * example, may still be open for reading.
 *
 * @since 1.4
 */
