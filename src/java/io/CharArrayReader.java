...
public class CharArrayReader extends Reader {
	 ...
	 *
	 * <p>
	 * The resulting reader will start reading at the given <tt>offset</tt>. The
	 * total number of <tt>char</tt> values that can be read from this reader
	 * will be either <tt>length</tt> or <tt>buf.length-offset</tt>, whichever
	 * is smaller.
	 *
	 ...
	 * exception in this case. If <code>n</code> is negative, then this method
