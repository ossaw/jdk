 ...
 * override the default serialization or deserialization, respectively, of
 * objects</td>
 * <td>Code can use this to serialize or deserialize classes in a purposefully
 * malfeasant manner. For example, during serialization, malicious code can use
 * this to purposefully store confidential private field data in a way easily
