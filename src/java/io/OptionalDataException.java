 ...
 *
 * <ul>
 * <li>An attempt was made to read an object when the next element in the stream
 * is primitive data. In this case, the OptionalDataException's length field is
 * set to the number of bytes of primitive data immediately readable from the
 * stream, and the eof field is set to false.
 *
...
public class OptionalDataException extends ObjectStreamException {
	...
	/*
	 * Create an <code>OptionalDataException</code> signifying no more primitive
	 * data is available.
	 */
