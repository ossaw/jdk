 ...
 * from write operations, within limits. A pipe is said to be
 * <a name="BROKEN"> <i>broken</i> </a> if a thread that was providing data
 * bytes to the connected piped output stream is no longer alive.
 *
