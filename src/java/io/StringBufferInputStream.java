 ...
 * read are supplied by the contents of a string. Applications can also read
 * bytes from a byte array by using a <code>ByteArrayInputStream</code>.
 * <p>
 * Only the low eight bits of each character in the string are used by this
 * class.
 *
 ...
 * @since JDK1.0
 * @deprecated This class does not properly convert characters into bytes. As of
 *             JDK&nbsp;1.1, the preferred way to create a stream from a string
 *             is via the <code>StringReader</code> class.
 */
@Deprecated
public class StringBufferInputStream extends InputStream {
     ...
     * <p>
     * The <code>read</code> method of <code>StringBufferInputStream</code>
     * cannot block. It returns the low eight bits of the next character in this
     ...
     * <p>
     * The <code>read</code> method of <code>StringBufferInputStream</code>
     * cannot block. It copies the low eight bits from the characters in this
