...
public interface DataOutput {
    ...
    /**
     * Writes a <code>boolean</code> value to this output stream. If the
     * argument <code>v</code> is <code>true</code>, the value
     ...
     * <code>DataInput</code>, which will then return a <code>boolean</code>
     ...
     * <code>readShort</code> method of interface <code>DataInput</code> , which
     * will then return a <code>short</code> equal to <code>(short)v</code>.
     *
     * @param v
     ...
     * </pre>
     * <p>
     * The bytes written by this method may be read by the <code>readChar</code>
     * method of interface <code>DataInput</code> , which will then return a
     ...
     * </pre>
     * <p>
     * The bytes written by this method may be read by the <code>readInt</code>
     * method of interface <code>DataInput</code> , which will then return an
     ...
     * </pre>
     * <p>
     * The bytes written by this method may be read by the <code>readLong</code>
     * method of interface <code>DataInput</code> , which will then return a
     ...
     * the <code>Float.floatToIntBits</code> method and then writes the
     * <code>int</code> value in exactly the manner of the <code>writeInt</code>
     * method. The bytes written by this method may be read by the
     * <code>readFloat</code> method of interface <code>DataInput</code>, which
     * will then return a <code>float</code> equal to <code>v</code>.
     *
     * @param v
     ...
     * the output stream. It does this as if it first converts this
     * <code>double</code> value to a <code>long</code> in exactly the manner of
     * the <code>Double.doubleToLongBits</code> method and then writes the
     * <code>long</code> value in exactly the manner of the
     * <code>writeLong</code> method. The bytes written by this method may be
     * read by the <code>readDouble</code> method of interface
     * <code>DataInput</code>, which will then return a <code>double</code>
     * equal to <code>v</code>.
     *
     * @param v
     ...
     * manner of the <code>writeByte</code> method . The high-order eight bits
     ...
     * stream, in order, two bytes per character. If <code>s</code> is
     * <code>null</code>, a <code>NullPointerException</code> is thrown. If
     * <code>s.length</code> is zero, then no characters are written. Otherwise,
     * the character <code>s[0]</code> is written first, then <code>s[1]</code>,
     * and so on; the last character written is <code>s[s.length-1]</code>. For
     * each character, two bytes are actually written, high-order byte first, in
     * exactly the manner of the <code>writeChar</code> method.
     *
     * @param s
     ...
     * the <a href="DataInput.html#modified-utf-8">modified UTF-8</a>
     * representation of every character in the string <code>s</code>. If
     * <code>s</code> is <code>null</code>, a <code>NullPointerException</code>
     * is thrown. Each character in the string <code>s</code> is converted to a
     * group of one, two, or three bytes, depending on the value of the
     * character.
     * <p>
     ...
     * <p>
     * The bytes written by this method may be read by the <code>readUTF</code>
     * method of interface <code>DataInput</code> , which will then return a
     * <code>String</code> equal to <code>s</code>.
     *
     * @param s
     *          the string value to be written.
     * @throws IOException
