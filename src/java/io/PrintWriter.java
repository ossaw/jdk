 ...
 * class implements all of the <tt>print</tt> methods found in
 * {@link PrintStream}. It does not contain methods for writing raw bytes, for
 * which a program should use unencoded byte streams.
 *
 * <p>
 * Unlike the {@link PrintStream} class, if automatic flushing is enabled it
 * will be done only when one of the <tt>println</tt>, <tt>printf</tt>, or
...
public class PrintWriter extends Writer {
	 ...
	 *                               If the given string does not denote an
	 *                               existing, writable
	 ...
	 *
	 * @param file
	 *             The file to use as the destination of this writer. If the
	 *             file
	 *             exists then it will be truncated to zero size; otherwise, a
	 *             new file will be created. The output will be written to the
