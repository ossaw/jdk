 ...
 * recommended as it may deadlock the thread. The pipe is said to be
 * <a name=BROKEN> <i>broken</i> </a> if a thread that was reading data bytes
...
public class PipedOutputStream extends OutputStream {
     ...
     *            {@link #connect(java.io.PipedInputStream)
     *            unconnected},
