...
/**
 * The {@code StreamTokenizer} class takes an input stream and parses it into
 ...
 * {@code '\u005Cu0000'} through {@code '\u005Cu00FF'}. The character value is
 * used to look up five possible attributes of the character: <i>white space</i>
 * , <i>alphabetic</i>, <i>numeric</i>, <i>string quote</i>, and <i>comment
 * character</i>. Each character can have zero or more of these attributes.
 * <p>
 ...
 * syntax tables, and then repeatedly loops calling the {@code nextToken} method
 * in each iteration of the loop until it returns the value {@code TT_EOF}.
 *
...
public class StreamTokenizer {
     ...
     * {@code '/'}) is treated as the beginning of a comment that extends to the
     * end of the line.
     * <p>
     * If the flag argument is {@code false}, then C++-style comments are not
     * treated specially.
    ...
    public String toString() {
        ...
        switch (ttype) {
            ...
            default: {
                /*
                 * ttype is the first character of either a quoted string or is
                 * an
