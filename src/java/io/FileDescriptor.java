...
public final class FileDescriptor {
     ...
     *
     * @return {@code true} if the file descriptor object represents a valid,
     *         open file, socket, or other active I/O connection; {@code false}
     *         otherwise.
     */
    ...
    /*
     * Package private methods to track referents. If multiple streams point to
     * the same FileDescriptor, we cycle through the list of all referents and
     * call close()
     */

    /**
     * Attach a Closeable to this FD for tracking. parent reference is added to
     * otherParents when needed to make closeAll simpler.
     */
    ...
    synchronized void closeAll(Closeable releaser) throws IOException {
        if (!closed) {
            ...
            try (Closeable c = releaser) {
                ...
                /*
                 * If releaser close() throws IOException add other exceptions
                 * as suppressed.
                 */
                if (ioe != null)
