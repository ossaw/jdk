...
/**
 * A <code>PushbackInputStream</code> adds functionality to another input
 * stream, namely the ability to "push back" or "unread" one byte. This is
 ...
 * was pushed back. For example, bytes representing the characters constituting
 * an identifier might be terminated by a byte representing an operator
 * character; a method whose job is to read just an identifier can read until it
...
public class PushbackInputStream extends FilterInputStream {
	 ...
	 *                        for the
	 *                        byte, or this input stream has been closed by
	 *                        invoking its
	 *                        {@link #close()} method.
	 */
	 ...
	 *                        If there is not enough room in the pushback buffer
	 *                        for the
	 *                        specified number of bytes, or this input stream
	 *                        has been
	 ...
	 * @return {@inheritDoc}
	 * @exception IOException
	 *                        if the stream does not support seek, or the stream
	 *                        has
