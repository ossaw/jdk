 ...
 * for writing by only one <tt>FileWriter</tt> (or other file-writing object) at
 * a time. In such situations the constructors in this class will fail if the
 * file involved is already open.
 *
 * <p>
 * <code>FileWriter</code> is meant for writing streams of characters. For
