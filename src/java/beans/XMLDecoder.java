...
/**
 * The <code>XMLDecoder</code> class is used to read XML documents created using
 * the <code>XMLEncoder</code> and is used just like the
 * <code>ObjectInputStream</code>. For example, one can use the following
 ...
 * <a href="http://java.sun.com/products/jfc/tsc/articles/persistence3">Long
 * Term Persistence of JavaBeans Components: XML Schema</a>, an article in
...
public class XMLDecoder implements AutoCloseable {
	 ...
	 * {@code XMLEncoder} class. If the input source {@code is} is {@code null},
	 * no exception is thrown and no parsing is performed. This behavior is
	 * similar to behavior of other constructors that use {@code InputStream} as
	 * a parameter.
	 *
	 * @param is
	...
	/**
	 * Creates a new handler for SAX parser that can be used to parse embedded
	 * XML archives created by the {@code XMLEncoder} class.
	 *
	 * The {@code owner} should be used if parsed XML document contains the
	 * method call within context of the &lt;java&gt; element. The {@code null}
	 * value may cause illegal parsing in such case. The same problem may occur,
	 * if the {@code owner} class does not contain expected method to call. See
	 * details
	 * <a href="http://java.sun.com/products/jfc/tsc/articles/persistence3/">
	 * here</a>.
	 *
	 * @param owner
