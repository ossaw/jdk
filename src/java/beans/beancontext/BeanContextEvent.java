...
/**
 * <p>
 * <code>BeanContextEvent</code> is the abstract root event class for all events
 * emitted from, and pertaining to the semantics of, a <code>BeanContext</code>.
 ...
 * <code>BeanContext</code>s. The <code>setPropagatedFrom()</code> and
 * <code>getPropagatedFrom()</code> methods allow a <code>BeanContext</code> to
 * identify itself as the source of a propagated event.
 * </p>
 *
...
public abstract class BeanContextEvent extends EventObject {
	 ...
	 * 
	 * @return the <code>BeanContext</code> from which this event was propagated
	 */
	 ...
	 * 
	 * @return <code>true</code> if propagated, <code>false</code> if not
	 */
