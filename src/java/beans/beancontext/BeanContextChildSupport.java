...
public class BeanContextChildSupport implements BeanContextChild,
    ...
    /**
     * construct a BeanContextChildSupport where this class has been subclassed
     * in order to implement the JavaBean component itself.
     */
     ...
     * implements BeanContextChild, and encapsulates this, delegating that
    ...
    /**
     * Sets the <code>BeanContext</code> for this
     * <code>BeanContextChildSupport</code>.
     * 
     * @param bc
     *           the new value to be assigned to the <code>BeanContext</code>
     *           property
        ...
        if (!rejectedSetBCOnce) {
            if (rejectedSetBCOnce = !validatePendingSetBeanContext(bc)) {
                throw new PropertyVetoException(
                        ...
                        new PropertyChangeEvent(beanContextChildPeer,
    ...
    /**
     * Gets the nesting <code>BeanContext</code> for this
     * <code>BeanContextChildSupport</code>.
     * 
     * @return the nesting <code>BeanContext</code> for this
     *         <code>BeanContextChildSupport</code>.
     */
    ...
    /**
     * Add a PropertyChangeListener for a specific property. The same listener
     ...
     * <code>name</code> or <code>pcl</code> is null, no exception is thrown and
     * no action is taken.
     *
     * @param name
     ...
     * <code>pcl</code> was added more than once to the same event source for
     * the specified property, it will be notified one less time after being
     * removed. If <code>name</code> is null, no exception is thrown and no
     * action is taken. If <code>pcl</code> is null, or was never added for the
    ...
    /**
     * Add a VetoableChangeListener for a specific property. The same listener
     * object may be added more than once. For each property, the listener will
     * be invoked the number of times it was added for that property. If
     * <code>name</code> or <code>vcl</code> is null, no exception is thrown and
     * no action is taken.
     *
     * @param name
     *             The name of the property to listen on
    ...
    /**
     * Removes a <code>VetoableChangeListener</code>. If <code>pcl</code> was
     * added more than once to the same event source for the specified property,
     * it will be notified one less time after being removed. If
     * <code>name</code> is null, no exception is thrown and no action is taken.
     ...
     * 
     * @param bcsre
     *              The <code>BeanContextServiceRevokedEvent</code> fired as a
     ...
     * 
     * @param bcsae
     *              The BeanContextServiceAvailableEvent fired as a result of a
    ...
    /**
     * Called from setBeanContext to validate (or otherwise) the pending change
     * in the nesting BeanContext property value. Returning false will cause
     * setBeanContext to throw PropertyVetoException.
     * 
     * @param newValue
     *                 the new value that has been requested for the BeanContext
     *                 property
     ...
     * behaviors. When invoked any resources held by this instance obtained from
     * its current BeanContext property should be released since the object is
     * no longer nested within that BeanContext.
     */
    ...
    private void writeObject(ObjectOutputStream oos) throws IOException {
        ...
        if (!equals(beanContextChildPeer)
                && !(beanContextChildPeer instanceof Serializable))
            throw new IOException(
                    "BeanContextChildSupport beanContextChildPeer not Serializable");
    ...
    /**
     * Restore a persistent object, must wait for subsequent setBeanContext() to
     * fully restore any resources obtained from the new nesting BeanContext
     */
    ...
    /**
     * The <code>BeanContext</code> in which this <code>BeanContextChild</code>
     * is nested.
     */
     ...
     * <code>PropertyChangeVetoException</code> thrown for the attempted
     * setBeanContext operation.
     */
