...
/**
 * <p>
 * This event type is used by the <code>BeanContextServiceRevokedListener</code>
...
public class BeanContextServiceRevokedEvent extends BeanContextEvent {
	 ...
	 * 
	 * @param bcs
	 *            the <code>BeanContextServices</code> from which this service
	 *            is being revoked
	 * @param sc
	 ...
	 * 
	 * @return the <code>BeanContextServices</code> from which this service is
	 *         being revoked
	 */
	 ...
	 * 
	 * @return A <code>Class</code> reference to the service that is being
	 *         revoked
	 */
	...
	/**
	 * Checks this event to determine whether or not the service being revoked
	...
	/**
	 * Reports if the current service is being forcibly revoked, in which case
	 * the references are now invalidated and unusable.
	 * 
