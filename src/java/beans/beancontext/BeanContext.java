...
public interface BeanContext extends BeanContextChild, Collection, DesignMode,
	 ...
	 * <code>BeanContext</code>. The implementation of the JavaBean is derived
	 * from the value of the beanName parameter, and is defined by the
	 ...
	 * this method allows a <code>BeanContext</code> implementation to interpose
	 * behavior between the child <code>Component</code> and underlying
	 ...
	 * <code>BeanContextMembershipEvents</code> from this
	 * <code>BeanContext</code> whenever it adds or removes a child
	...
	/**
	 * Removes the specified <code>BeanContextMembershipListener</code> so that
	 * it no longer receives <code>BeanContextMembershipEvent</code>s when the
	 ...
	 * <code>BeanContextServices</code> implementors to serialize changes in a
	 * <code>BeanContext</code> hierarchy and any service requests etc.
	 */
