...
public interface BeanContextServices extends BeanContext, BeanContextServicesListener {
	 ...
	 * <code>BeanContextServiceProvider</code>s call this method to register a
	 * particular service with this context. If the service has not previously
	 * been added, the <code>BeanContextServices</code> associates the service
	 * with the <code>BeanContextServiceProvider</code> and fires a
	 * <code>BeanContextServiceAvailableEvent</code> to all currently registered
	 * <code>BeanContextServicesListeners</code>. The method then returns
	 * <code>true</code>, indicating that the addition of the service was
	 * successful. If the given service has already been added, this method
	 ...
	 * service from this context may do so via invocation of this method. Upon
	 * revocation of the service, the <code>BeanContextServices</code> fires a
	 * <code>BeanContextServiceRevokedEvent</code> to its list of currently
	 * registered <code>BeanContextServiceRevokedListeners</code> and
	...
	/**
	 * Reports whether or not a given service is currently available from this
	 * context.
	 * 
	 * @param serviceClass
	...
	/**
	 * A <code>BeanContextChild</code>, or any arbitrary object associated with
	 * a <code>BeanContextChild</code>, may obtain a reference to a currently
	 * registered service from its nesting <code>BeanContextServices</code> via
	 * invocation of this method. When invoked, this method gets the service by
	 * calling the getService() method on the underlying
	...
	/**
	 * Releases a <code>BeanContextChild</code>'s (or any arbitrary object
	 * associated with a BeanContextChild) reference to the specified service by
	 * calling releaseService() on the underlying
	 * <code>BeanContextServiceProvider</code>.
	 * 
	 * @param child
	 ...
	 * 
	 * @return an <code>Iterator</code> consisting of the currently available
	 *         services
	 */
	Iterator getCurrentServiceClasses();

	/**
	 * Gets the list of service dependent service parameters (Service Selectors)
	 * for the specified service, by calling getCurrentServiceSelectors() on the
	...
	/**
	 * Removes a <code>BeanContextServicesListener</code> from this
