...
/**
 * A <code>BeanContextMembershipEvent</code> encapsulates the list of children
 * added to, or removed from, the membership of a particular
 * <code>BeanContext</code>. An instance of this event is fired whenever a
 * successful add(), remove(), retainAll(), removeAll(), or clear() is invoked
 * on a given <code>BeanContext</code> instance. Objects interested in receiving
 * events of this type must implement the
 * <code>BeanContextMembershipListener</code> interface, and must register their
 * intent via the <code>BeanContext</code>'s
