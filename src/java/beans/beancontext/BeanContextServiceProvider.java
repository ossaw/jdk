 ...
 * </p>
 * <p>
 * A JavaBean nested within a BeanContext, may ask that BeanContext to provide
 * an instance of a "service", based upon a reference to a Java Class object
 * that represents that service.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * The ServcieProvider may always return the same instance, or it may construct
...
public interface BeanContextServiceProvider {
	...
	/**
	 * Invoked by <code>BeanContextServices</code>, this method requests an
	 * instance of a service from this <code>BeanContextServiceProvider</code>.
	 *
	 * @param bcs
	 *            The <code>BeanContextServices</code> associated with this
	 ...
	 *            the service dependent parameter for a particular service, or
	 ...
	 * nested <code>BeanContextChild</code>'s (or any arbitrary object
	 * associated with a <code>BeanContextChild</code>) reference to the
	 * specified service.
	 *
	 * @param bcs
	 *            the <code>BeanContextServices</code> associated with this
	 ...
	 * service selectors for the specified service. A service selector is a
	 * service specific parameter, typical examples of which could include: a
	 * parameter to a constructor for the service implementation class, a value
	 * for a particular service's property, or a key into a map of existing
	 * implementations.
	 *
	 * @param bcs
