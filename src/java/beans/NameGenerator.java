...
/**
 * A utility class which generates unique names for object instances. The name
 * will be a concatenation of the unqualified class name and an instance number.
 * <p>
