...
public class FeatureDescriptor {
	...
	/**
	 * Copies all values from the specified attribute table. If some attribute
	...
	/**
	 * Sets the "transient" attribute according to the annotation. If the
	...
	static Class<?>[] getParameterTypes(Class<?> base, Method method) {
		...
		return TypeResolver
				.erase(TypeResolver.resolveInClass(base, method.getGenericParameterTypes()));
	}
