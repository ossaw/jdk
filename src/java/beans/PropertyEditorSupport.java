...
public class PropertyEditorSupport implements PropertyEditor {
	...
	/**
	 * Returns the bean that is used as the source of events. If the source has
	 * not been explicitly set then this instance of
	 ...
	 * This source should be used for information purposes only and should not
	 ...
	 * the property name. If the source property is set, it should be used as
	 * the source of the event.
	 * <p>
	 * The same listener object may be added more than once, and will be called
	 * as many times as it is added. If {@code listener} is {@code null}, no
	 ...
	 * <p>
	 * If the same listener was added more than once, it will be notified one
	 * less time after being removed. If {@code listener} is {@code null}, or
