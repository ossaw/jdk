...
/**
 * This is an abstract class that provides base functionality for the
 * {@link PropertyChangeSupport PropertyChangeSupport} class and the
 * {@link VetoableChangeSupport VetoableChangeSupport} class.
 *
...
abstract class ChangeListenerMap<L extends EventListener> {
    ...
    /**
     * Creates an array of listeners. This method can be optimized by using the
     * same instance of the empty array when {@code length} is equal to
     * {@code 0}.
     *
     * @param length
     *               the array length
    ...
    /**
     * Adds a listener to the list of listeners for the specified property. This
     ...
     * If the listener was added more than once to the same event source, this
