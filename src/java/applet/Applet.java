 ...
 * <p>
 * The <code>Applet</code> class must be the superclass of any applet that is to
 * be embedded in a Web page or viewed by the Java Applet Viewer. The
...
public class Applet extends Panel {
     ...
     * <p>
     * Note: Many methods in <code>java.applet.Applet</code> may be invoked by
     * the applet only after the applet is fully constructed; applet should
     * avoid calling methods in <code>java.applet.Applet</code> in the
     * constructor.
     *
     ...
     * is called with the <code>AWTPermission("setAppletStub")</code> permission
     ...
     * before its <code>start</code> method is called. It becomes inactive just
     * before its <code>stop</code> method is called.
     *
     ...
     * this applet is specified as <blockquote>
     * 
     * <pre>
    ...
    /**
     * Returns an <code>Image</code> object that can then be painted on the
     * screen. The <code>url</code> argument must specify an absolute URL. The
     * <code>name</code> argument is a specifier that is relative to the
     ...
     * <code>Strings</code> describing these parameters.
     * <p>
    ...
    /**
     * Plays the audio clip at the specified absolute URL. Nothing happens if
    ...
    /**
     * Plays the audio clip given the URL and a specifier that is relative to
    ...
    /**
     * This class implements accessibility support for the <code>Applet</code>
     * class. It provides an implementation of the Java Accessibility API
     * appropriate to applet user-interface elements.
     * 
     * @since 1.3
     */
