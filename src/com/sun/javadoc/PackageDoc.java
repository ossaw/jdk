...
/**
 * Represents a java package. Provides access to information about the package,
 * the package's comment and tags, and the classes in the package.
 * <p>
 * Each method whose return type is an array will return an empty array (never
 * null) when there are no objects in the result.
 *
 * @since 1.2
...
public interface PackageDoc extends Doc {
	...
	/**
	 * Get included <a href=
	 * "{@docRoot}/com/sun/javadoc/package-summary.html#class">ordinary</a>
	 * classes (that is, exclude exceptions, errors, enums, interfaces, and
	 * annotation types) in this package.
	 *
	...
	/**
	 * Get the annotations of this package. Return an empty array if there are
	 * none.
	 *
