...
/**
 * Represents a @throws or @exception documentation tag. Parses and holds the
 * exception name and exception comment. Note: @exception is a backwards
 * compatible synonymy for @throws.
 *
 * @author Robert Field
...
public interface ThrowsTag extends Tag {
    ...
    /**
     * Return the type of the exception associated with this
     * <code>ThrowsTag</code>. This may be a <code>ClassDoc</code> or a
