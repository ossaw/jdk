...
/**
 * The Doclet API (also called the Javadoc API) provides a mechanism for clients
 * to inspect the source-level structure of programs and libraries, including
 ...
 * </pre>
 * 
 * The {@link com.sun.javadoc.RootDoc} instance holds the root of the program
 ...
 * Javadoc options (<code>-public</code>, <code>-protected</code>,
 * <code>-package</code>, and <code>-private</code>) filter program elements,
 * producing a result set, called the <em>included</em> set, or "documented"
 ...
 * {@link com.sun.javadoc.PackageDoc#findClass(String) findClass(String)}. In
 * only a couple of other places, it means "class, as opposed to interface", as
 * in: {@link com.sun.javadoc.Doc#isClass()}. In the second sense, this API
 * calls out four kinds of classes:
 ...
 * {@linkplain com.sun.javadoc.Doc#isException() exceptions}. Throughout the
 ...
 * <font color=red title="Doclet API">red</font>. {@link com.sun.javadoc.Doclet
 * Doclet} is an abstract class that specifies the invocation interface for
 * doclets, {@link com.sun.javadoc.Doclet Doclet} holds class or interface
 * information, {@link com.sun.javadoc.ExecutableMemberDoc} is a superinterface
 * of {@link com.sun.javadoc.MethodDoc} and
 * {@link com.sun.javadoc.ConstructorDoc}, and {@link com.sun.javadoc.ParamTag}
 * holds information from "<code>@param</code>" tags.
 * <p>
