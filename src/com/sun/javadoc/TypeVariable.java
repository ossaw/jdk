...
/**
 * Represents a type variable. For example, the generic interface {@code List
 * <E>} has a single type variable {@code E}. A type variable may have explicit
 * bounds, as in {@code C<R extends Remote>}.
 *
