...
/**
 * Represents the root of the program structure information for one run of
 * javadoc. From this root all other program structure information can be
 * extracted. Also represents the command line information -- the packages,
 * classes and options specified by the user.
 *
 * @since 1.2
 * @author Robert Field
 */
public interface RootDoc extends Doc, DocErrorReporter {
    ...
    /**
     * Return the packages <a href="package-summary.html#included">specified</a>
     * on the command line. If <code>-subpackages</code> and
     * <code>-exclude</code> options are used, return all the non-excluded
     * packages.
     *
     ...
     * <a href="package-summary.html#included">specified</a> as source file
    ...
    /**
     * Return the <a href="package-summary.html#included">included</a> classes
     * and interfaces in all packages.
     *
