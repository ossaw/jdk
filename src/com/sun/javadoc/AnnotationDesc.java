...
public interface AnnotationDesc {
	...
	/**
	 * Returns this annotation's elements and their values. Only those
	 * explicitly present in the annotation are included, not those assuming
	 * their default values. Returns an empty array if there are none.
	 *
	...
	/**
	 * Represents an association between an annotation type element and one of
	 * its values.
	 *
	 * @author Scott Seligman
	 * @since 1.5
