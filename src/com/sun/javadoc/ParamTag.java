...
/**
 * Represents an @param documentation tag. Stores the name and comment parts of
 * the parameter tag. An @param tag may represent either a method or constructor
...
public interface ParamTag extends Tag {
     ...
     * <code>ParamTag</code>. The angle brackets delimiting a type parameter are
