...
public interface ExecutableMemberDoc extends MemberDoc {
     ...
     *
     * @return an array of ClassDoc[] representing the exceptions thrown by this
     *         method.
     ...
     *
     * @return an array representing the exceptions thrown by this method. Each
     *         array element is either a <code>ClassDoc</code> or a
    ...
    /**
     * Return true if this method was declared to take a variable number of
     * arguments.
     *
     * @since 1.5
     */
    ...
    /**
     * Get the signature. It is the parameter list, type is qualified. For
     * instance, for a method <code>mymethod(String x, int y)</code>, it will
     * return <code>(java.lang.String,int)</code>.
     */
    String signature();

    /**
     * get flat signature. all types are not qualified. return a String, which
     * is the flat signiture of this member. It is the parameter list, type is
     * not qualified. For instance, for a method
     * <code>mymethod(String x, int y)</code>, it will return
     * <code>(String, int)</code>.
     */
    String flatSignature();

    /**
     * Return the formal type parameters of this method or constructor. Return
     * an empty array if this method or constructor is not generic.
     *
