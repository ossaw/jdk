...
public interface MethodDoc extends ExecutableMemberDoc {
	 ...
	 * used instead.</i>
	 *
	 * @return a ClassDoc representing the superclass defining a method that
	 *         this method overrides, or null if this method does not override.
	 */
	ClassDoc overriddenClass();

	/**
	 * Return the type containing the method that this method overrides. It may
	 * be a <code>ClassDoc</code> or a <code>ParameterizedType</code>.
	 *
	 * @return the supertype whose method is overridden, or null if this method
	 *         does not override another in a superclass
	 * @since 1.5
	 */
	Type overriddenType();
	 ...
	 *
	 * @return a MethodDoc representing a method definition in a superclass this
	 *         method overrides, null if this method does not override.
	 */
