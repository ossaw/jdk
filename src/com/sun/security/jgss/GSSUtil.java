...
public class GSSUtil {
	 ...
	 * Typically this would be done by a server that wants to impersonate a
	 * client thread at the Java level by setting a client Subject in the
	 ...
	 * added to the subject will be instances of the standard Kerberos
