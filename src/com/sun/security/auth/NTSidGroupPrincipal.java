...
/**
 * <p>
 * This class extends <code>NTSid</code> and represents one of the groups to
 * which a Windows NT user belongs.
 *
 * <p>
 * Principals such as this <code>NTSidGroupPrincipal</code> may be associated
...
public class NTSidGroupPrincipal extends NTSid {
	...
	public String toString() {
		java.text.MessageFormat form = new java.text.MessageFormat(sun.security.util.ResourcesMgr
				.getString("NTSidGroupPrincipal.name", "sun.security.util.AuthResources"));
