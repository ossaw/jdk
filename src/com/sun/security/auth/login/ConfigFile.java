 ...
 * <ol>
 * <li>Loop through the security properties, <i>login.config.url.1</i>,
 * <i>login.config.url.2</i>, ..., <i>login.config.url.X</i>. Each property
 * value specifies a {@code URL} pointing to a login configuration file to be
 * loaded. Read in and load each configuration.
 * <li>The {@code java.lang.System} property
 * <i>java.security.auth.login.config</i> may also be set to a {@code URL}
 ...
 * login configuration.
 * <li>If the <i>java.security.auth.login.config</i> property is defined using
 * "==" (rather than "="), then ignore all other specified login configurations
 * and only load this configuration.
 * <li>If no system or security properties were set, try to read from the file,
 ...
 * syntax specified in the {@code javax.security.auth.login.Configuration}
 * class.
 *
