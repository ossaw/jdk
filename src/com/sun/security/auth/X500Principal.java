 ...
 * @deprecated A new X500Principal class is available in the Java platform. This
 *             X500Principal classs is entirely deprecated and is here to allow
 *             for a smooth transition to the new class.
