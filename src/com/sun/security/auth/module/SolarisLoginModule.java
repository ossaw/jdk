...
public class SolarisLoginModule implements LoginModule {
	 ...
	 *                if attempts to retrieve the underlying system information
	 *                fail.
	 *
	...
	public boolean login() throws LoginException {
		...
		if (ss == null) {
			...
			for (int i = 0; i < solarisGroups.length; i++) {
				SolarisNumericGroupPrincipal ngp = new SolarisNumericGroupPrincipal(
	...
	public boolean commit() throws LoginException {
		if (succeeded == false) {
			if (debug) {
				System.out.println(
						"\t\t[SolarisLoginModule]: " + "did not add any Principals to Subject "
