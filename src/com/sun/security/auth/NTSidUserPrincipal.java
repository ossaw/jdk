...
/**
 * <p>
 * This class extends <code>NTSid</code> and represents a Windows NT user's SID.
 *
 * <p>
 * Principals such as this <code>NTSidUserPrincipal</code> may be associated
 * with a particular <code>Subject</code> to augment that <code>Subject</code>
 * with an additional identity. Refer to the <code>Subject</code> class for more
...
public class NTSidUserPrincipal extends NTSid {
	...
	public String toString() {
		java.text.MessageFormat form = new java.text.MessageFormat(sun.security.util.ResourcesMgr
				.getString("NTSidUserPrincipal.name", "sun.security.util.AuthResources"));
	 ...
	 * <code>NTSidUserPrincipal</code> and the two NTSidUserPrincipals have the
	 * same SID.
	 *
	 * <p>
	 *
