...
public class JPEGImageMetadataFormatResources extends
			...
			{ "markerSequence",
					"A node grouping all non-jfif marker segments" }, {
							"app0jfif", "A JFIF APP0 marker segment" }, {
									"app14Adobe",
									"An Adobe APP14 marker segment" }, { "sof",
											"A Start Of Frame marker segment" },
			{ "sos", "A Start Of Scan marker segment" }, { "app0JFXX",
	...
	protected Object[][] getContents() {
		...
		// copy is sufficient
		Object[][] combinedContents = new Object[commonContents.length
