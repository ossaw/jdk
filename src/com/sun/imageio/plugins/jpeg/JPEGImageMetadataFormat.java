...
public class JPEGImageMetadataFormat extends JPEGMetadataFormat {
    ...
    private JPEGImageMetadataFormat() {
        ...
        addAttribute("JFIFthumbPalette", "thumbHeight", DATATYPE_INTEGER, false, null, "0", "255", true,
                true);
        ...
        addAttribute("componentSpec", "HsamplingFactor", DATATYPE_INTEGER, true, null, "1", "255", true,
                true);
        addAttribute("componentSpec", "VsamplingFactor", DATATYPE_INTEGER, true, null, "1", "255", true,
                true);
        ...
        addAttribute("scanComponentSpec", "componentSelector", DATATYPE_INTEGER, true, null, "0", "255", true,
                true);
    ...
    public boolean canNodeAppear(String elementName, ImageTypeSpecifier imageType) {
        ...
        if (elementName.equals(getRootName()) || elementName.equals("JPEGvariety") || isInSubtree(elementName,
                "markerSequence")) {
            return true;
        }
