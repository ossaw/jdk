...
abstract class JPEGMetadataFormatResources extends ListResourceBundle {
	...
	static final Object[][] commonContents = {
			...
			{ "com", "A Comment marker segment.  The user object contains " + "the actual bytes." },
			{ "unknown",
			...
			{ "dgtable/qtableId", "The table id" },
			{ "dhtable/class", "Indicates whether this is a DC (0) or an AC (1) table" },
			{ "dhtable/htableId", "The table id" },
			{ "dri/interval", "The restart interval in MCUs" },
			{ "com/comment", "The comment as a string (used only if user object is null)" },
			{ "unknown/MarkerTag", "The tag identifying this marker segment" } };
}
