...
abstract class JPEGMetadataFormat extends IIOMetadataFormatImpl {
	...
	/**
	 * Returns <code>true</code> if the named element occurs in the subtree of
	 * the format starting with the node named by <code>subtreeName</code>,
	 * including the node itself. <code>subtreeName</code> may be any node in
	 * the format. If it is not, an <code>IllegalArgumentException</code> is
	 * thrown.
	 */
