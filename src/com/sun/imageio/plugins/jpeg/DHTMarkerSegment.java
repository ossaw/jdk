...
class DHTMarkerSegment extends MarkerSegment {
    ...
    class Htable implements Cloneable {
        ...
        void print() {
            ...
            /*
             * System.out.print("Lengths:"); for (int i=0; i<16; i++) {
             * System.out.print(" " + Integer.toString(numCodes[i])); } int
             * count = 0; if (values.length > 16) { System.out.println(
             * "\nFirst 16 Values:"); count = 16; } else {
             * System.out.println("\nValues:"); count = values.length; } for
             * (int i=0; i<count; i++) {
