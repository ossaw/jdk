...
public class PNGMetadataFormatResources extends ListResourceBundle {
	...
	protected Object[][] getContents() {
		return new Object[][] {
				...
				{ "tEXt", "The tEXt chunk, containing text" }, { "tEXtEntry", "A text entry" },
				...
				{ "iTXtEntry/languageTag", "The ISO tag describing the language this iTXt entry" },
				...
				{ "sBIT_GrayAlpha/alpha", "The number of significant bits of the alpha samples" },
				{ "sBIT_RGB/red", "The number of significant bits of the red samples" },
				{ "sBIT_RGB/green", "The number of significant bits of the green samples" },
				{ "sBIT_RGB/blue", "The number of significant bits of the blue samples" },
				...
				{ "tRNS_RGB/blue", "The blure value to be considered transparent" },
