		...
		return new Object[][] {
				...
				{ "IHDR", "The IHDR chunk, containing the header" }, { "PLTE",
						"The PLTE chunk, containing the palette" }, {
								"PLTEEntry", "A palette entry" }, { "bKGD",
				...
				{ "hISTEntry", "A histogram entry" }, { "iCCP",
				...
				{ "sPLT", "The sPLT chunk, containing a suggested palette" }, {
						"sPLTEntry", "A suggested palette entry" }, { "sRGB",
								"The sRGB chunk, containing rendering intent information" },
				{ "tEXt", "The tEXt chunk, containing text" }, { "tEXtEntry",
						"A text entry" }, { "tIME",
				...
				{ "tEXtEntry/keyword", "The keyword" }, { "tEXtEntry/value",
						"The text" },
				...
				{ "zTXtEntry/keyword", "The keyword" }, {
						"zTXtEntry/compressionMethod",
						"The compression method" }, { "zTXtEntry/text",
								"The compressed text" },
