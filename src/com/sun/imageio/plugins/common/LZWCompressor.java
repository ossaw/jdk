...
public class LZWCompressor {
	/**
	 * base underlying code size of data being compressed 8 for TIFF, 1 to 8 for
	 * GIF
	 **/
	int codeSize;
	...
	/**
	 * the prefix code which represents the predecessor string to current input
	 * point
	 **/
	short prefix;
	...
	/**
	 * modify the limits of the code values in LZW encoding due to TIFF bug /
	 * feature
	 **/
	boolean tiffFudge;
