...
public class GIFImageMetadata extends GIFMetadata {
	...
	static final String[] disposalMethodNames = { "none", "doNotDispose",
			"restoreToBackgroundColor", "restoreToPrevious", "undefinedDisposalMethod4",
			"undefinedDisposalMethod5", "undefinedDisposalMethod6", "undefinedDisposalMethod7" };
	...
	public GIFImageMetadata() {
		this(true, nativeMetadataFormatName, "com.sun.imageio.plugins.gif.GIFImageMetadataFormat",
				null, null);
	}
	...
	public IIOMetadataNode getStandardTransparencyNode() {
		...
		node.setAttribute("value", Integer.toString(transparentColorIndex));
