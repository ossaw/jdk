...
/**
 * This class is the Java Image IO plugin reader for WBMP images. It may
 * subsample the image, clip the image, and shift the decoded image origin if
 * the proper decoding parameter are set in the provided
 * <code>WBMPImageReadParam</code>.
 */
public class WBMPImageReader extends ImageReader {
    ...
    public BufferedImage read(int imageIndex, ImageReadParam param) throws IOException {
        ...
        if (bi == null)
            bi = new BufferedImage(destinationRegion.x + destinationRegion.width, destinationRegion.y
                    + destinationRegion.height, BufferedImage.TYPE_BYTE_BINARY);
        ...
        if (noTransform) {
            ...
            for (int j = 0, y = sourceRegion.y, k = destinationRegion.y
                    * lineStride; j < destinationRegion.height; j++, y += scaleY) {
    ...
    /*
     * This method verifies that given byte is valid wbmp type marker. At the
     * moment only 0x0 marker is described by wbmp spec.
     */
