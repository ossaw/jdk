 ...
 * thrown ImageFormatExceptions and check the actual ColorModel associated with
 * the BufferedImage returned rather than make assumtions.
 * 
 * <pre>
    DECODING:
...
public interface JPEGDecodeParam extends Cloneable {
	 ...
	 * quantity, because fractional subsampling factors are not allowed, and it
	 * was felt
	 * 
	 * @param component
	 ...
	 * encoding this indicates wether tables should be written to the stream.
	 */
