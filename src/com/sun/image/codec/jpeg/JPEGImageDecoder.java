...
/**
 * This interface describes a JPEG data stream decoder. This decoder takes an
 * InputStream that contains JPEG encoded image data. The JPEGImageDecoder will
 * decode the JPEG image data according to the parameters set in a
 * JPEGDecodeParam object. The resulting image data is returned in either a
 * Raster or a BufferedImage.
 * <p>
