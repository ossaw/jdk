...
/**
 * Signals that a truncated file was detected. This object contains the
 * Raster/BufferedImage that has the partially decoded image data in it. There
 * is no indication of the portion of the Raster that may or may not be good.
 * <p>
