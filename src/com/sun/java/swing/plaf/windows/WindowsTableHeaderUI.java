...
public class WindowsTableHeaderUI extends BasicTableHeaderUI {
    ...
    private class XPDefaultRenderer extends DefaultTableCellHeaderRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
            ...
            /*
             * idk: Both on Vista and XP there is some offset to the
             * HP_HEADERITEM content. It does not seem to come from
             * Prop.CONTENTMARGINS. Do not know where it is defined. using some
             * hardcoded values.
             */
            contentLeft += 5;
            contentBottom += 4;
            ...
            /*
             * On Vista sortIcon is painted above the header's text. We use
             * border to paint it.
             */
            Icon sortIcon;
