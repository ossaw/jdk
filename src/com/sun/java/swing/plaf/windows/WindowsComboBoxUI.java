...
public class WindowsComboBoxUI extends BasicComboBoxUI {
    ...
    private static final PropertyChangeListener componentOrientationListener = new PropertyChangeListener() {
        public void propertyChange(PropertyChangeEvent e) {
            ...
            Object source = null;
            if ("componentOrientation" == propertyName && (source = e.getSource()) instanceof JComboBox
                    && ((JComboBox) source).getUI() instanceof WindowsComboBoxUI) {
                ...
                if (comboBoxUI.arrowButton instanceof XPComboBoxButton) {
                    ((XPComboBoxButton) comboBoxUI.arrowButton).setPart((comboBox
                            .getComponentOrientation() == ComponentOrientation.RIGHT_TO_LEFT)
                                    ? Part.CP_DROPDOWNBUTTONLEFT : Part.CP_DROPDOWNBUTTONRIGHT);
                }
            }
        }
    };
    ...
    protected void installListeners() {
        ...
        if (xp != null && xp.isSkinDefined(comboBox, Part.CP_DROPDOWNBUTTONRIGHT)) {
            comboBox.addPropertyChangeListener("componentOrientation", componentOrientationListener);
        }
    }
    ...
    protected void uninstallListeners() {
        ...
        comboBox.removePropertyChangeListener("componentOrientation", componentOrientationListener);
    }
        ...
        return new BasicComboBoxUI.ComboBoxLayoutManager() {
            public void layoutContainer(Container parent) {
                ...
                if (XPStyle.getXP() != null && arrowButton != null) {
                    ...
                    arrowButton.setBounds(WindowsGraphicsUtils.isLeftToRight((JComboBox) parent) ? (d.width
                            - insets.right - buttonWidth) : insets.left, insets.top, buttonWidth, d.height
    ...
    private class XPComboBoxButton extends XPStyle.GlyphButton {
        public XPComboBoxButton(XPStyle xp) {
            super(null, (!xp.isSkinDefined(comboBox, Part.CP_DROPDOWNBUTTONRIGHT)) ? Part.CP_DROPDOWNBUTTON
        ...
        protected State getState() {
            ...
            rv = super.getState();
            XPStyle xp = XPStyle.getXP();
            if (rv != State.DISABLED && comboBox != null && !comboBox.isEditable() && xp != null && xp
        ...
        public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected,
            ...
            if (rv instanceof JComponent) {
                ...
                if (index == -1 && isSelected) {
                    ...
                    if (component.getBorder() instanceof WindowsBorders.DashedBorder) {
