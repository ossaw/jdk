...
public class WindowsLabelUI extends BasicLabelUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        WindowsLabelUI windowsLabelUI = (WindowsLabelUI) appContext.get(
                WINDOWS_LABEL_UI_KEY);
    ...
    protected void paintEnabledText(JLabel l, Graphics g, String s, int textX,
        ...
        SwingUtilities2.drawStringUnderlineCharAt(l, g, s, mnemonicIndex, textX,
                textY);
    }
    ...
    protected void paintDisabledText(JLabel l, Graphics g, String s, int textX,
        ...
        if (UIManager.getColor("Label.disabledForeground") instanceof Color
                && UIManager.getColor(
                        "Label.disabledShadow") instanceof Color) {
