...
public class WindowsIconFactory implements Serializable {
    ...
    private static class FrameButtonIcon implements Icon, Serializable {
        ...
        public void paintIcon(Component c, Graphics g, int x0, int y0) {
            ...
            if (xp != null) {
                ...
                JInternalFrame jif = (JInternalFrame) SwingUtilities.getAncestorOfClass(JInternalFrame.class,
                        b);
    ...
    static class VistaMenuItemCheckIconFactory implements MenuItemCheckIconFactory {
        ...
        public boolean isCompatible(Object icon, String prefix) {
            return icon instanceof VistaMenuItemCheckIcon && ((VistaMenuItemCheckIcon) icon).type == getType(
                    prefix);
        }
        ...
        static int getIconWidth() {
            XPStyle xp = XPStyle.getXP();
            return ((xp != null) ? xp.getSkin(null, Part.MP_POPUPCHECK).getWidth() : 16) + 2 * OFFSET;
        }
        ...
        private static class VistaMenuItemCheckIcon implements Icon, UIResource, Serializable {
                ...
                if (type == JCheckBoxMenuItem.class || type == JRadioButtonMenuItem.class) {
                    ...
                    if (b.isSelected()) {
                        ...
                        if (isEnabled(c, null)) {
                            ...
                            state = (type == JRadioButtonMenuItem.class) ? State.BULLETNORMAL
                                    : State.CHECKMARKNORMAL;
                        } else {
                            backgroundState = State.DISABLEDPUSHED;
                            state = (type == JRadioButtonMenuItem.class) ? State.BULLETDISABLED
            ...
            private static boolean isEnabled(Component c, State state) {
                ...
                if (state == null) {
                    ...
                    return (state != State.DISABLED) && (state != State.DISABLEDHOT)
            ...
            private static String typeToString(Class<? extends JMenuItem> type) {
                assert type == JMenuItem.class || type == JMenu.class || type == JCheckBoxMenuItem.class
