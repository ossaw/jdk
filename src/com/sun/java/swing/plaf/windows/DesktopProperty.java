...
/**
 * Wrapper for a value from the desktop. The value is lazily looked up, and can
 * be accessed using the <code>UIManager.ActiveValue</code> method
...
public class DesktopProperty implements UIDefaults.ActiveValue {
    ...
    private static void updateAllUIs() {
        // Check if the current UI is WindowsLookAndfeel and flush the XP style
        // map.
        // Note: Change the package test if this class is moved to a different
        // package.
    ...
    /**
     * UIManager.LazyValue method, returns the value from the desktop or the
     * fallback value if the desktop value is null.
     */
    ...
    /**
     * Requests that all components in the GUI hierarchy be updated to reflect
     * dynamic changes in this look&feel. This update occurs by uninstalling and
     * re-installing the UI objects. Requests are batched and collapsed into a
     * single update pass because often many desktop properties will change at
     * once.
     */
    ...
    /**
     * Configures the value as appropriate for a defaults property in the
     * UIDefaults table.
     */
