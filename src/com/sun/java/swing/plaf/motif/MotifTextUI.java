...
/**
 * Provides the look and feel features that are common across the Motif/CDE text
 * LAF implementations.
 * <p>
...
public class MotifTextUI {
    ...
    /**
     * Creates the object to use for a caret for all of the Motif text
     * components. The caret is rendered as an I-beam on Motif.
     *
    ...
    public static class MotifCaret extends DefaultCaret implements UIResource {
         ...
         * implemented to repaint the component so the focus rectangle will be
         ...
         * If paint() is reimplemented, this method should also be
         * reimplemented.
         *
         * @param r
         ...
         * the caret is a vertical line. Does nothing if isVisible() is false.
         * The caret color is derived from getCaretColor() if the component has
     ...
     */
    static final JTextComponent.KeyBinding[] defaultBindings = { new JTextComponent.KeyBinding(KeyStroke
            .getKeyStroke(KeyEvent.VK_INSERT, InputEvent.CTRL_MASK), DefaultEditorKit.copyAction),
            new JTextComponent.KeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_INSERT, InputEvent.SHIFT_MASK),
                    DefaultEditorKit.pasteAction), new JTextComponent.KeyBinding(KeyStroke.getKeyStroke(
                            KeyEvent.VK_DELETE, InputEvent.SHIFT_MASK), DefaultEditorKit.cutAction),
            new JTextComponent.KeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_LEFT, InputEvent.SHIFT_MASK),
                    DefaultEditorKit.selectionBackwardAction), new JTextComponent.KeyBinding(KeyStroke
                            .getKeyStroke(KeyEvent.VK_RIGHT, InputEvent.SHIFT_MASK),
