...
public class MotifGraphicsUtils implements SwingConstants {
    ...
    /**
     * Draws <b>aString</b> in the rectangle defined by (<b>x</b>, <b>y</b>,
     * <b>width</b>, <b>height</b>). <b>justification</b> specifies the text's
     * justification, one of LEFT, CENTER, or RIGHT. <b>drawStringInRect()</b>
     * does not clip to the rectangle, but instead uses this rectangle and the
     * desired justification to compute the point at which to begin drawing the
     * text.
     * 
     * @see #drawString
     */
    public static void drawStringInRect(Graphics g, String aString, int x, int y, int width, int height,
            int justification) {
        drawStringInRect(null, g, aString, x, y, width, height, justification);
    }

    static void drawStringInRect(JComponent c, Graphics g, String aString, int x, int y, int width,
            int height, int justification) {
        ...
        if (fontMetrics == null) {
            // throw new InconsistencyException("No metrics for Font " +
            // font());
            return;
        }
    ...
    /**
     * This method is not being used to paint menu item since 6.0 This code left
     * for compatibility only. Do not use or override it, this will not cause
     * any visible effect.
     */
    public static void paintMenuItem(Graphics g, JComponent c, Icon checkIcon, Icon arrowIcon,
        ...
        FontMetrics fmAccel = SwingUtilities2.getFontMetrics(c, g, UIManager.getFont(
        ...
        String text = layoutMenuItem(c, fm, b.getText(), fmAccel, acceleratorText, b.getIcon(), checkIcon,
                arrowIcon, b.getVerticalAlignment(), b.getHorizontalAlignment(), b.getVerticalTextPosition(),
                b.getHorizontalTextPosition(), viewRect, iconRect, textRect, acceleratorRect, checkRect,
                arrowRect, b.getText() == null ? 0 : defaultTextIconGap, defaultTextIconGap);
        ...
        if (text != null && !text.equals("")) {
            ...
            if (v != null) {
                ...
                if (!model.isEnabled()) {
                    ...
                    SwingUtilities2.drawStringUnderlineCharAt(b, g, text, mnemIndex, textRect.x, textRect.y
                            + fmAccel.getAscent());
                    g.setColor(b.getBackground().darker());
                    SwingUtilities2.drawStringUnderlineCharAt(b, g, text, mnemIndex, textRect.x - 1,
                            textRect.y + fmAccel.getAscent() - 1);
        ...
        if (acceleratorText != null && !acceleratorText.equals("")) {
            ...
            if (parent != null && parent instanceof JComponent) {
                ...
                // Calculate the offset, with which the accelerator texts will
                // be drawn with.
            ...
            if (!model.isEnabled()) {
                ...
                g.setColor(b.getBackground().brighter());
                SwingUtilities2.drawString(c, g, acceleratorText, acceleratorRect.x - accOffset,
                        acceleratorRect.y + fm.getAscent());
                g.setColor(b.getBackground().darker());
                SwingUtilities2.drawString(c, g, acceleratorText, acceleratorRect.x - accOffset - 1,
    ...
    private static String layoutMenuItem(JComponent c, FontMetrics fm, String text, FontMetrics fmAccel,
            String acceleratorText, Icon icon, Icon checkIcon, Icon arrowIcon, int verticalAlignment,
        ...
        SwingUtilities.layoutCompoundLabel(c, fm, text, icon, verticalAlignment, horizontalAlignment,
                verticalTextPosition, horizontalTextPosition, viewR, iconR, textR, textIconGap);

        /*
         * Initialize the acceelratorText bounds rectangle textR. If a null or
         * and empty String was specified we substitute "" here and use 0,0,0,0
         * for acceleratorTextR.
         */
        if ((acceleratorText == null) || acceleratorText.equals("")) {
