...
public class JmxProperties {
	 ...
	 */
	public static final Logger MLET_LOGGER = Logger.getLogger(MLET_LOGGER_NAME);
	 ...
	 */
	public static final Logger MISC_LOGGER = Logger.getLogger(MISC_LOGGER_NAME);
	 ...
	 * Logger for SNMP.
	 */
	public static final Logger SNMP_LOGGER = Logger.getLogger(SNMP_LOGGER_NAME);
