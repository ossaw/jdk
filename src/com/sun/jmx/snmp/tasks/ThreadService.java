...
/**
 * This class implements a {@link com.sun.jmx.snmp.tasks.TaskServer} over a
 * thread pool.
 * <p>
...
public class ThreadService implements TaskServer {
     ...
     * called. This implementation of TaskServer uses a thread pool to execute
     * the submitted tasks.
     * 
     * @param task
    ...
    /**
     * Submit a task to be executed. This implementation of TaskServer uses a
