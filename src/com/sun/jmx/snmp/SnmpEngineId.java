...
/**
 * This class is handling an <CODE>SnmpEngineId</CODE> data. It copes with
 * binary as well as <CODE>String</CODE> representation of an engine Id. A
 * string format engine is an hex string starting with 0x.
 * <p>
...
public class SnmpEngineId implements Serializable {
    ...
    /**
     * New <CODE>SnmpEngineId</CODE> with an hex string value. Can handle engine
    ...
    /**
     * New <CODE>SnmpEngineId</CODE> with a binary value. You can use
     * <CODE> SnmpTools </CODE> to convert from hex string to binary format.
     * 
     * @param bin
     *        Binary value
     */
    ...
    /**
     * If a string of the format &lt;address&gt;:&lt;port&gt;:&lt;IANA
     * number&gt; has been provided at creation time, this string is returned.
     * 
    ...
    /**
     * Generates an engine Id that is unique to the host the agent is running
     * on. The engine Id unicity is system time based. The creation algorithm
     * uses the SUN Microsystems IANA number (42).
     * 
    ...
    /**
     * Translates an engine Id in an SnmpOid format. This is useful when dealing
     * with USM MIB indexes. The oid format is : <engine Id length>.<engine Id
     * binary octet1>....<engine Id binary octetn - 1>.<engine Id binary octetn>
     * Eg: "0x8000002a05819dcb6e00001f96" ==>
     * 13.128.0.0.42.5.129.157.203.110.0.0.31.150
     *
    ...
    /**
     * <P>
     * Generates a unique engine Id. Hexadecimal strings as well as a textual
     * description are supported. The textual format is as follow: <BR>
     ...
     * </P>
     * <ul>
     * <li>&lt;address&gt;:&lt;port&gt;:&lt;IANA number&gt <BR>
     * All these parameters are used to generate the Id. WARNING, this method is
     * not compliant with IPv6 address format. Use { @link
     * com.sun.jmx.snmp.SnmpEngineId#createEngineId(java.lang.String,java.lang.
     * String) } instead.</li>
     * <li>&lt;address&gt;:&lt;port&gt; <BR>
     * The IANA number will be the SUN Microsystems one (42).</li>
     * <li>address <BR>
     * The port 161 will be used to generate the Id. IANA number will be the SUN
     * Microsystems one (42).</li>
     * <li>:port <BR>
     * The host to use is localhost. IANA number will be the SUN Microsystems
     * one (42).</li>
     * <li>::&lt;IANA number&gt &nbsp;&nbsp;&nbsp; <BR>
     * The port 161 and localhost will be used to generate the Id.</li>
     * <li>:&lt;port&gt;:&lt;IANA number&gt; <BR>
     * The host to use is localhost.</li>
     * <li>&lt;address&gt;::&lt;IANA number&gt <BR>
     * The port 161 will be used to generate the Id.</li>
     * <li>:: &nbsp;&nbsp;&nbsp; <BR>
     * The port 161, localhost and the SUN Microsystems IANA number will be used
     * to generate the Id.</li>
     * </ul>
     * 
     ...
     */
    public static SnmpEngineId createEngineId(String str) throws IllegalArgumentException,
    ...
    /**
     * Idem { @link
     * com.sun.jmx.snmp.SnmpEngineId#createEngineId(java.lang.String) } with the
     * ability to provide your own separator. This allows IPv6 address format
     ...
     * @since 1.5
     */
    public static SnmpEngineId createEngineId(String str, String separator) throws IllegalArgumentException,
            UnknownHostException {
        if (str == null)
            return null;
        ...
        StringTokenizer token = new StringTokenizer(str, separator, true);
        ...
        try {
            ...
            throw new IllegalArgumentException("Passed string is invalid : [" + str
                    + "]. Check that the used separator [" + separator
    ...
    /**
     * Generates a unique engine Id. The engine Id unicity is based on the host
     * IP address and port. The IP address used is the localhost one. The
    ...
    /**
     * Generates a unique engine Id. The engine Id unicity is based on the host
     * IP address and port. The IP address used is the passed one. The creation
    ...
    /**
     * Generates a unique engine Id. The engine Id unicity is based on the host
     * IP address and port. The IP address is the localhost one. The creation
    ...
    /**
     * Generates a unique engine Id. The engine Id unicity is based on the host
     * IP address and port. The IP address is the passed one, it handles IPv4
    ...
    /**
     * Tests <CODE>SnmpEngineId</CODE> instance equality. Two
     * <CODE>SnmpEngineId</CODE> are equal if they have the same value.
     * 
     * @return <CODE>true</CODE> if the two <CODE>SnmpEngineId</CODE> are
     *         equals, <CODE>false</CODE> otherwise.
     */
    public boolean equals(Object a) {
        if (!(a instanceof SnmpEngineId))
            return false;
