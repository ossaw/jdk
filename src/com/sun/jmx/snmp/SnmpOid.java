...
public class SnmpOid extends SnmpValue {
    ...
    /**
     * Constructs a new <CODE>SnmpOid</CODE> containing four components with the
     * specified values.
     * 
     * @param id1
    ...
    /**
     * Constructs a new <CODE>SnmpOid</CODE> from a dot-formatted
     * <CODE>String</CODE> or a MIB variable name. It generates an exception if
     * the variable name cannot be resolved, or if the dot-formatted
     * <CODE>String</CODE> has an invalid subidentifier. This constructor helps
     * build an OID object with a <CODE>String</CODE> like .1.2.3.4 or 1.2.3.4
    ...
    /**
     * Returns the components array of this <CODE>SnmpOid</CODE>. If
     * <code>duplicate</code> is true, a copy is returned. Otherwise, a
     * reference to the internal array is returned, in which case the caller
     * <b>shall not</b> modify this array. This method is provided to optimize
     * processing in those cases where the caller needs only to read the
     * components array.
     *
     * @param duplicate
    ...
    /**
     * Returns the value of the OID arc found at the requested position in the
     * <CODE>components</CODE> array. The first element is at position
     * <code>0</code>.
     *
     * @param pos
    ...
    /**
     * Extracts the OID from an index OID and returns its value converted as an
     * <CODE>SnmpOid</CODE>.
     * 
     * @param index
     *        The index array.
    ...
    /**
     * Scans an index OID, skips the OID value and returns the position of the
     * next value.
     * 
     * @param index
     *        The index array.
    ...
    /**
     * Appends an <CODE>SnmpOid</CODE> representing an <CODE>SnmpOid</CODE> to
     * another OID.
     * 
     * @param source
    ...
    /**
     * Appends the specified <CODE>SnmpOid</CODE> to the end of this
     * <CODE>SnmpOid</CODE>.
     * 
     * @param oid
     *        The OID to append.
    ...
    /**
     * Adds the specified dot-formatted OID <CODE>String</CODE> to the end of
     * this <CODE>SnmpOid</CODE>. The subidentifiers can be expressed as a
     ...
     * 
     * @return <CODE>true</CODE> if the OID is valid, <CODE>false</CODE>
     *         otherwise.
     */
    ...
    /**
     * Checks whether the specified <CODE>Object</CODE> is equal to this
     * <CODE>SnmpOid</CODE>.
     * 
     * @param o
     ...
     *         <CODE>other</CODE>. A value larger than 0 if this
     *         <CODE>SnmpOid</CODE> is lexicographically larger than
     *         <CODE>other</CODE>.
     */
    ...
    /**
     * Sets the MIB table to use for resolving MIB variable names. If no mib
     * table is available, the class will not be able to resolve names contained
    ...
    /**
     * Checks if there is enough space in the components array to insert n new
     * subids. If not, it increases the size of the array. In fact it
    ...
    /**
     * Reference to a mib table. If no mib table is available, the class will
     * not be able to resolve names contained in the Object Identifier.
     */
