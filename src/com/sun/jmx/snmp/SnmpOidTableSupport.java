...
/**
 * Contains metadata definitions for MIB variables. A name can be resolved
 * against a table of MIB variables. Each entry in the table is an
 * <CODE>SnmpOidRecord</CODE> object that contains a name, a dot-separated OID
 * string, and the corresponding SMI type of the variable.
 * <P>
...
public class SnmpOidTableSupport implements SnmpOidTable {
    ...
    /**
     * Creates an <CODE>SnmpOidTableSupport</CODE> with the specified name. This
     * name identifies the MIB to which belong the MIB variables contained in
    ...
    /**
     * Returns a list that can be used to traverse all the entries in this
    ...
    /**
     * Checks if the specified <CODE>Object</CODE> is equal to this
    ...
    /**
     * Returns the name identifying this <CODE>SnmpOidTableSupport</CODE>
     * object.
     * 
