 ...
 * packets to and from an <CODE>SnmpPeer</CODE>. An <CODE>SnmpPeer</CODE> can be
 * configured explicitly to use a specific <CODE>SnmpParameter</CODE>. A number
 * of <CODE>SnmpPeer</CODE> objects can share a single parameter object.
 * <P>
 * <B>Note</B>: Changing values for an <CODE>SnmpParameter</CODE> object affects
...
public class SnmpParameters extends SnmpParams implements Cloneable,
	...
	/**
	 * Creates an <CODE>SnmpParameters</CODE> object with defaults set up. By
	 * default, <CODE>set</CODE> operations are not allowed, the read community
	 * and the inform community strings to use is "public" and the SNMP version
	 * is V1.
	 */
	...
	/**
	 * Creates an <CODE>SnmpParameters</CODE> object. This constructor allows
	 * the specification of the read/write community strings. The inform
	...
	/**
	 * Sets the community string to use when performing <CODE>get</CODE>
	 * operations.
	 * 
	 * @param read
	...
	/**
	 * Sets the community string to use when performing <CODE>inform</CODE>
	 * requests.
	 * 
	 * @param inform
	 *               The community string.
	...
	/**
	 * Compares two objects. Two <CODE>SnmpParameters</CODE> are equal if they
	 * correspond to the same protocol version, read community and write
	 * community.
	 * 
	 * @param obj
	...
	/**
	 * Specify the default community string to use for <CODE>get</CODE>
	 * operations. By default, the value is "public".
	 */
