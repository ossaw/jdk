...
public interface SnmpDefinitions {
     ...
     * <P>
     * Used if the request PDU exceeds the <CODE>maxTries</CODE> limit defined
     * in the {@link com.sun.jmx.snmp.SnmpPeer SnmpPeer} object.
     */
     ...
     * Error code specific to the API.
     * <P>
     * Used if the request PDU fails at encoding time or sending time for a
     * reason not covered by the previous error codes.
     */
     ...
     * <P>
     * Used if the authoritative engine Id is not associated to the current
     * user.
     *
     * @since 1.5
     */
