...
/**
 * Contains a list of <CODE>SnmpVarBind</CODE> objects. This class helps to
 * create an <CODE>SnmpVarBindList</CODE> from a list of MIB variable names. In
 * addition, it contains different forms of methods which can copy or clone the
 * list. This list is required by any SNMP entity which specifies a list of
 * variables to query.
 * <p>
...
public class SnmpVarBindList extends Vector<SnmpVarBind> {
	...
	/**
	 * Timestamp when this <CODE>SnmpVarBindList</CODE> was updated. Valid only
	 * for <CODE>SnmpGet</CODE> and <CODE>SnmpGetNext</CODE> operations.
	 * <CODE>SnmpTimestamp</CODE> is null by default. Also, when the list is
	 * cloned without value the timestamp is not copied.
	 */
	Timestamp timestamp;
	...
	/**
	 * Prepares an empty list. The initial capacity and the capacity increment
	 * are initialized to 5.
	 */
	 ...
	 *            The initial capacity of the <CODE>SnmpVarBindList</CODE>.
	 */
	...
	/**
	 * Prepares an empty list with a <CODE>String</CODE> to print while
	 * debugging.
	 * 
	 * @param name
	...
	/**
	 * Creates a new <CODE>SnmpVarBindList</CODE> object from a plain vector of
	 * <CODE>SnmpVarBind</CODE> objects. Objects in the specified vector can be
	...
	/**
	 * Gets the <CODE>timestamp</CODE> associated with this
	...
	/**
	 * Records the <CODE>sysUpTime</CODE> and the actual time when this
	 * <CODE>SnmpVarBindList</CODE> was changed or created. This needs to be set
	 * explicitly.
	 * 
	 * @param tstamp
	...
	/**
	 * This is a convenience function that returns an enumeration. This can be
	 * used to traverse the list. This is advantageous as it hides the
	 * implementation of the class of the list which keeps the variables.
	 * 
	...
	/**
	 * Replaces the current variable binding list of <CODE>SnmpVarBind</CODE>
	 * with the new specified variable binding list of <CODE>SnmpVarBind</CODE>
	 * objects. This method only clones the vector. It does not clone the
	...
	/**
	 * Replaces the current variable binding list of <CODE>SnmpVarBind</CODE>
	 * objects with the new variable binding list of <CODE>SnmpVarBind</CODE>
	 * objects. If <CODE>copy</CODE> is <CODE>true</CODE>, it will clone each
	...
	/**
	 * Appends an <CODE>SnmpVarBindList</CODE> at the end of the current
	...
	/**
	 * Removes all the <CODE>SnmpVarBind</CODE> objects of the given
	 * <CODE>SnmpVarBindList</CODE> from the existing
	 * <CODE>SnmpVarBindList</CODE>.
	 * 
	 * @param list
	...
	/**
	 * Prepares a vector of <CODE>SnmpVarBindList</CODE> from an array of SNMP
	 * MIB variables and instances.
	 * 
	 * @param list
	 *            An array of <CODE>String</CODE> containing MIB variable names.
	 * @param inst
	...
	/**
	 * Removes the array of SNMP MIB variables and instances from the existing
	 * <CODE>SnmpVarBindList</CODE>.
	 * 
	 * @param list
	 *            An array of <CODE>String</CODE> containing MIB variable names.
	...
	/**
	 * Creates an <CODE>SnmpVarBind</CODE> object from the given MIB variable
	 * and appends it to the existing <CODE>SnmpVarBindList</CODE>. It creates a
	...
	/**
	 * Removes the <CODE>SnmpVarBind</CODE> object corresponding to the given
	...
	/**
	 * Appends the given <CODE>SnmpVarBind</CODE> object to the existing
	 * <CODE>SnmpVarBindList</CODE>. It creates a new
	...
	/**
	 * Removes the given <CODE>SnmpVarBind</CODE> object from the existing
	 * <CODE>SnmpVarBindList</CODE>.
	 * 
	 * @param var
	...
	/**
	 * Returns <CODE>false</CODE> if any of the variables does not contain a
	 * valid value. Typically used for <CODE>SnmpSet</CODE> operations.
	 * 
	 * @return <CODE>false</CODE> if any of the variables does not contain a
	 *         valid value, <CODE>true</CODE> otherwise.
	 */
	 ...
	 * 
	 * @return <CODE>true</CODE> if there is a value that is not specified,
	 *         <CODE>false</CODE> otherwise.
	 */
	...
	/**
	 * Gives the index of an OID in the <CODE>SnmpVarBindList</CODE>. The index
	 * returned must be greater than or equal to the <CODE>start</CODE>
	 * parameter and smaller than the <CODE>end</CODE> parameter. Otherwise the
	 * method returns -1.
	 * 
	 * @param var
	...
	/**
	 * Clones the <CODE>SnmpVarBindList</CODE>. A new copy of the
	 * <CODE>SnmpVarBindList</CODE> is created. It is a real deep copy.
	 * 
	...
	/**
	 * Clones the <CODE>SnmpVarBindList</CODE>. It does not clone the value part
	...
	/**
	 * Copies the <CODE>SnmpVarBindList</CODE> into a plain vector of
	 * <CODE>SnmpVarBind</CODE> objects. If the <code>copy</code> flag is false,
	 * does a shallow copy of the list. Otherwise, individual elements will be
	 * cloned.
	 * 
	 * @param copy
	 *            The flag indicating whether each object in the list should be
	...
	/**
	 * Returns a <CODE>String</CODE> containing the ASCII representation of all
	 * OIDs in the list.
	 * 
	...
	/**
	 * Constructs a <CODE>String</CODE> containing details of each
	 * <CODE>SnmpVarBindList</CODE> (oid+value). This is typically used in
	 * debugging.
	 * 
	 * @return A detailed <CODE>String</CODE> of all in the
	 *         <CODE>SnmpVarBindList</CODE>.
	 */
	...
	/**
	 * Finalizer of the <CODE>SnmpVarBindList</CODE> objects. This method is
	 * called by the garbage collector on an object when garbage collection
	 * determines that there are no more references to the object.
	 * <P>
	 * Removes all the elements from this <CODE>SnmpVarBindList</CODE> object.
	 */
	@Override
