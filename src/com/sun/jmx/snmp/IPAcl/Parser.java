...
class Parser/* @bgen(jjtree) */ implements ParserTreeConstants,
	...
	final private boolean jj_3_2() {
		if (jj_scan_token(V6_ADDRESS))
			return true;
		if (jj_la == 0 && jj_scanpos == jj_lastpos)
			return false;
		if (jj_scan_token(MASK))
			return true;
		if (jj_la == 0 && jj_scanpos == jj_lastpos)
			return false;
		if (jj_scan_token(INTEGER_LITERAL))
	...
	final private int[] jj_la1_0 = { 0x100, 0x80000, 0x100000, 0x2000, 0x0, 0x60000, 0x0,
			0x80000000, 0x11000000, 0x0, 0x0, 0x0, 0x0, 0x2000, 0x2000, 0x0, 0x91000000, 0x0,
			0x8000, 0x2000, 0x0, 0x91000000, };
	final private int[] jj_la1_1 = { 0x0, 0x0, 0x0, 0x0, 0x10, 0x0, 0x10, 0x0, 0x0, 0x20, 0x20,
			0x40, 0x20, 0x0, 0x0, 0x10, 0x0, 0x10, 0x0, 0x0, 0x10, 0x0, };
	...
	private void jj_add_error_token(int kind, int pos) {
		...
		if (pos == jj_endpos + 1) {
			...
			for (java.util.Enumeration<int[]> enumv = jj_expentries.elements(); enumv
					.hasMoreElements();) {
