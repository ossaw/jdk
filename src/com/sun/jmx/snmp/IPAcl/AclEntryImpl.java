...
/**
 * Represent one entry in the Access Control List (ACL). This ACL entry object
 * contains a permission associated with a particular principal. (A principal
 * represents an entity such as an individual machine or a group).
 *
