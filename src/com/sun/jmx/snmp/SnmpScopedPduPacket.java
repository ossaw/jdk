...
public abstract class SnmpScopedPduPacket extends SnmpPdu implements
    ...
    /**
     * The security parameters. This is an opaque member that is interpreted by
     * the concerned security model.
     */
    public SnmpSecurityParameters securityParameters = null;

    /**
     * Constructor. Is only called by a son. Set the version to
     * <CODE>SnmpDefinitions.snmpVersionThree</CODE>.
     */
