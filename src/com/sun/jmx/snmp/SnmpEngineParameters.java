...
public class SnmpEngineParameters implements Serializable {
    ...
    /**
     * Sets the file to use for SNMP Runtime Lcd. If no file is provided, the
     * default location will be checked.
     */
    ...
    /**
     * Sets a customized user ACL. User Acl is used in order to check access for
     * SNMP V3 requests. If no ACL is provided,
    ...
    /**
     * Check if encryption is activated. By default the encryption is not
     * activated.
     * 
