...
/**
 * <P>
 * An <CODE>SnmpIncomingRequest</CODE> handles both sides of an incoming SNMP
 * request:
 * <ul>
...
public interface SnmpIncomingRequest {
    /**
     * Once the incoming request decoded, returns the decoded security
     * parameters.
     * 
     ...
     * order to allow or deny the access to OIDs.
     */
    public byte[] getAccessContext();

    /**
     * Encodes the response message to send and puts the result in the specified
     * byte array.
     *
     * @param outputBytes
    ...
    /**
     * Decodes the specified bytes and initializes the request with the incoming
     * message.
     *
     * @param inputBytes
