...
/**
 * Security model interface. Any security model implementation must implement
 * this interface in order to be integrated in the engine framework. Security
 * models are called when SNMP messages are received or sent. They deal with
...
public interface SnmpSecurityModel extends SnmpModel {
    ...
    public int generateRequestMsg(SnmpSecurityCache cache, int version, int msgID, int msgMaxSize,
            ...
            SnmpStatusException, SnmpSecurityException;
     ...
     *        The
     *        informations contained in this array are model
     *        dependant.
     * @param contextEngineID
    ...
    /**
     * Instantiate an <CODE>SnmpSecurityCache</CODE> that is dependant to the
