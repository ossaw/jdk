...
/**
 * <P>
 * An <CODE>SnmpOutgoingRequest</CODE> handles the marshalling of the message to
 * send.
 * </P>
 * <p>
...
public interface SnmpOutgoingRequest {
	/**
	 * Returns the cached security data used when marshalling the call as a
	 * secure one.
	 * 
	...
	/**
	 * Encodes the message to send and puts the result in the specified byte
	 * array.
	 *
	 * @param outputBytes
	 ...
	 *                If the specified PDU <CODE>p</CODE> is not valid.
