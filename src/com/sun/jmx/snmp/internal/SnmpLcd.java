 ...
 * retrieve data.
 * <P>
 * <CODE>SnmpLcd</CODE> manages the Lcds needed by every
 * {@link com.sun.jmx.snmp.internal.SnmpModel SnmpModel}. It is possible to add
 * and remove {@link com.sun.jmx.snmp.internal.SnmpModelLcd SnmpModelLcd}.
 * </P>
 * <p>
...
public abstract class SnmpLcd {
	...
	class SubSysLcdManager {
		private Hashtable<Integer, SnmpModelLcd> models = new Hashtable<Integer, SnmpModelLcd>();
	...
	private Hashtable<SnmpSubSystem, SubSysLcdManager> subs = new Hashtable<SnmpSubSystem, SubSysLcdManager>();

	/**
	 * Returns the number of time the engine rebooted.
	 * 
	 * @return The number of reboots or -1 if the information is not present in
	 *         the Lcd.
	 */
	 ...
	 * 
	 * @return The engine Id or null if the information is not present in the
	 *         Lcd.
	 */
