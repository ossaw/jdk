...
/**
 * SNMP sub system interface. To allow engine framework integration, a sub
 * system must implement this interface. A sub system is a model manager. Every
 * model is identified by an ID. A sub system can retrieve a previously
 * registered model using this ID.
 * <P>
...
public interface SnmpSubSystem {
    ...
    /**
     * Returns the set of model Ids that have been registered within the sub
     * system.
     */
    public int[] getModelIds();

    /**
     * Returns the set of model names that have been registered within the sub
     * system.
     */
