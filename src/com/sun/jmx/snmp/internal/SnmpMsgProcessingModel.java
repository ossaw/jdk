...
/**
 * The message processing model interface. Any message processing model must
 * implement this interface in order to be integrated in the engine framework.
 * The model is called by the dispatcher when a call is received or when a call
 * is sent.
 * <p>
...
public interface SnmpMsgProcessingModel extends SnmpModel {
	 ...
	 * <CODE>contextName</CODE>, <CODE>contextEngineID</CODE> and data are
	 * known. <BR>
	 * The specified parameters are defined in RFC 2572 (see also the
	 * {@link com.sun.jmx.snmp.SnmpV3Message} class).
	 * 
	...
	/**
	 * This method returns an encoded scoped pdu. This method encode only the
	 * <CODE>contextEngineID</CODE>, <CODE>contextName</CODE> and data. It is
