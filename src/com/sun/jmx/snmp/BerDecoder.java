...
/**
 * The <CODE>BerDecoder</CODE> class is used for decoding BER-encoded data.
 *
...
public class BerDecoder {
	 ...
	 *
	 * @exception BerException
	 *                Current position does not point to an integer or the tag
	 ...
	 *
	 * @exception BerException
	 *                Current position does not point to an octet string or the
	 *                tag is not the expected one.
	 */
	 ...
	 *
	 * @exception BerException
	 *                Current position does not point to an oid or the tag is
	 ...
	 *
	 * @exception BerException
	 *                Current position does not point to <CODE>NULL</CODE>
	 *                value.
	 */
	 ...
	 *
	 * @exception BerException
	 *                Current position does not point to <CODE>NULL</CODE> value
	...
	/**
	 * Fetch an <CODE>ANY</CODE> value. In fact, this method does not decode
	 * anything it simply returns the next TLV as an array of bytes.
	 *
	 * @return The TLV as a byte array.
	 *
	 * @exception BerException
	 *                The next TLV is really badly encoded...
	 */
	...
	/**
	 * Fetch a sequence header. The decoder computes the end position of the
	 * sequence and push it on its stack.
	 *
	 * @exception BerException
	 ...
	 *
	 * @exception BerException
	 *                Current position does not point to a sequence header or
	...
	/**
	 * Close a sequence. The decode pull the stack and verifies that the current
	 * position matches with the calculated end of the sequence. If not it
	 * throws an exception.
	 *
	 * @exception BerException
	 *                The sequence is not expected to finish here.
	 */
	...
	/**
	 * Return <CODE>true</CODE> if the end of the current sequence is not
	 * reached. When this method returns <CODE>false</CODE>,
	 * <CODE>closeSequence</CODE> can (and must) be invoked.
	 *
	...
	/**
	 * Get the tag of the data at the current position. Current position is
	 * unchanged.
	 *
	 * @return The next tag.
	 */
	...
	/**
	 * Fetch an integer value and return a long value. FIX ME: someday we could
	 * have only on fetchIntegerValue() which always returns a long value.
	 *
	 * @return The integer
	 */
