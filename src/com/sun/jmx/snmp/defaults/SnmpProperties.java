...
public class SnmpProperties {
    ...
    /**
     * Reads the Java DMK property list from a file and adds the read properties
    ...
    /**
     * References the property that specifies the directory where the native
     * libraries will be stored before the MLet Service loads them into memory.
     * <p>
    ...
    /**
     * References the property that specifies the ACL file used by the SNMP
     * protocol adaptor.
     * <p>
    ...
    /**
     * References the property that specifies the Security file used by the SNMP
     * protocol adaptor.
     * <p>
    ...
    /**
     * References the property that specifies the User ACL file used by the SNMP
     * protocol adaptor.
     * <p>
    ...
    /**
     * References the property that specifies the default mib_core file used by
     * the mibgen compiler.
     * <p>
    ...
    /**
     * References the property that specifies the SSL cipher suites to be
     * enabled by the HTTP/SSL connector.
     * <p>
     * Property Name: <B>jdmk.ssl.cipher.suite.</B>
     * <p>
     * The list of SSL cipher suites is specified in the format:
     * <p>
     * <DD><B>jdmk.ssl.cipher.suite.</B>&lt;n&gt;<B>=</B>&lt;cipher suite
     * name&gt;</DD>
     * <p>
     * For example:
     * <p>
