...
/**
 * Default implementation of the {@link com.sun.jmx.snmp.SnmpPduFactory
 * SnmpPduFactory} interface. <BR>
 * It uses the BER (basic encoding rules) standardized encoding scheme
 * associated with ASN.1.
 * <P>
 * This implementation of the <CODE>SnmpPduFactory</CODE> is very basic: it
 * simply calls encoding and decoding methods from
 * {@link com.sun.jmx.snmp.SnmpMsg}. <BLOCKQUOTE>
 * 
 * <PRE>
 ...
 * </PRE>
 * 
 * </BLOCKQUOTE> To implement your own object, you can implement
 * <CODE>SnmpPduFactory</CODE> or extend <CODE>SnmpPduFactoryBER</CODE>.
 * <p>
