...
public class SnmpString extends SnmpValue {
	...
	/**
	 * Constructs a new <CODE>SnmpString</CODE> from the specified
	 ...
	 *                If string value is not a legal address format.
	 *
	 * @since 1.5
	 */
	...
	/**
	 * Extracts the string from an index OID and returns its value converted as
	...
	/**
	 * Scans an index OID, skips the string value and returns the position of
	 * the next value.
	 * 
	 * @param index
	 *            The index array.
	...
	/**
	 * Appends an <CODE>SnmpOid</CODE> representing an <CODE>SnmpString</CODE>
	 * to another OID.
	 * 
	 * @param source
