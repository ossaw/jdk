 ...
 * {@link SnmpEngineId}. Engine instantiation is based on a factory
 * {@link com.sun.jmx.snmp.SnmpEngineFactory SnmpEngineFactory}. When an
 * <CODE> SnmpEngine </CODE> is created, a User based Security Model (USM) is
 * initialized. The security configuration is located in a text file. The text
 ...
 * </P>
 * <P>
 * Usm Mib userEntry supported storage type values are : volatile or nonVolatile
 * only. Other values are rejected and a wrongValue is returned)
 * </P>
 * <ul>
 ...
 * <li>If a nonVolatile row is set to be volatile, it will be not flushed in the
 * file</li>
 * <li>If a volatile row created from the UsmMib is set to nonVolatile, it will
 * be flushed in the file (if the file exist and is writable otherwise an
 * inconsistentValue is returned)</li>
 * </ul>
 * <p>
