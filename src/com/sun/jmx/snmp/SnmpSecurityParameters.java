...
/**
 * Security parameters are security model dependent. Every security parameters
 * class wishing to be passed to a security model must implement this marker
 * interface. This interface has to be implemented when developing customized
 * security models.
 * <p>
