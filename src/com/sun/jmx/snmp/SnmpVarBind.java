 ...
 * {@link com.sun.jmx.snmp.SnmpVarBindList}. An <CODE>SnmpVarBind</CODE>
 * consists of three parts:
 * <P>
 * <DL>
 * <DD>- The corresponding OID object for the MIB variable.
 * <DD>- The value part associated with that OID instance. If present, it
 * determines the MIB syntax for the object.
 * <DD>- The status of the <CODE>SnmpVarBind</CODE> which specifies whether the
 * agent responded with an exception condition for this variable such as
 * <CODE>noSuchInstance</CODE>, <CODE>endOfMibView</CODE>, or
...
public class SnmpVarBind implements SnmpDataTypeEnums, Cloneable, Serializable {
	 ...
	 */
	static final private String statusLegend[] = { "Status Mapper",
			"Value not initialized", "Valid Value", "No such object",
			"No such Instance", "End of Mib View" };

	/**
	 * Useful constant indicating that the status of the
	 * <CODE>SnmpVarBind</CODE> object is not initialized.
	 */
	static final public int stValueUnspecified = 1;

	/**
	 * Useful constant indicating that the status of the
	 * <CODE>SnmpVarBind</CODE> object is valid.
	 */
	static final public int stValueOk = 2;

	/**
	 * Useful constant indicating that the status of the
	 * <CODE>SnmpVarBind</CODE> object is <CODE>noSuchObject</CODE>. Status of
	 * <CODE>SnmpVarBind</CODE> as returned by the SNMPv2 agent.
	 */
	static final public int stValueNoSuchObject = 3;

	/**
	 * Useful constant indicating that the status of the
	 * <CODE>SnmpVarBind</CODE> object is <CODE>noSuchInstance</CODE>. Status of
	 * <CODE>SnmpVarBind</CODE> as returned by the SNMPv2 agent. In the SNMPv1
	 * context, this is appropriate when <CODE>noSuchName</CODE> is returned in
	 * response to the <CODE>SnmpGet</CODE> request.
	 */
	static final public int stValueNoSuchInstance = 4;

	/**
	 * Useful constant indicating that the status of the
	 * <CODE>SnmpVarBind</CODE> object is <CODE>endOfMibView</CODE>. Status of
	 * <CODE>SnmpVarBind</CODE> as returned by the SNMPv2 agent. In the SNMPv1
	 * context, this is appropriate when <CODE>noSuchName</CODE> is returned in
	 * response to the <CODE>SnmpGetNext</CODE> request.
	 */
	 ...
	 */
	public final static SnmpNull noSuchObject = new SnmpNull(
			errNoSuchObjectTag);

	/**
	 * Error code value as defined in RFC 1448 for: <CODE>noSuchInstance</CODE>.
	 */
	public final static SnmpNull noSuchInstance = new SnmpNull(
			errNoSuchInstanceTag);

	/**
	 * Error code value as defined in RFC 1448 for: <CODE>endOfMibView</CODE>.
	 */
	public final static SnmpNull endOfMibView = new SnmpNull(
			errEndOfMibViewTag);

	/**
	 * The OID of the <CODE>SnmpVarBind</CODE>. The default value is null.
	 * <p>
	 * <b>Reserved for internal use:</b><br>
	 * As of Java Dynamic Management Kit 5.0, use instead <CODE>getOid</CODE>
	 * and <CODE>setOid</CODE>
	 * </p>
	 */
	public SnmpOid oid = null;

	/**
	 * The value of the <CODE>SnmpVarBind</CODE>. The default value is null.
	 * <p>
	 * <b>Reserved for internal use:</b><br>
	 * As of Java Dynamic Management Kit 5.0, use instead
	 * <CODE>getSnmpValue</CODE> and <CODE>setSnmpValue</CODE>
	 * </p>
	 */
	public SnmpValue value = null;

	/**
	 * Indicates the status of the value in this <CODE>SnmpVarBind</CODE>. The
	 * default value is <CODE>stValueUnspecified</CODE>. This attribute is
	 * updated internally and should not be changed otherwise.
	 */
	...
	/**
	 * Constructs a new <CODE>SnmpVarBind</CODE> object from the specified
	 * <CODE>SnmpOid</CODE> value.
	 * 
	 * @param oid
	 *            The OID part of the <CODE>SnmpVarBind</CODE>.
	 */
	...
	/**
	 * Constructs a new <CODE>SnmpVarBind</CODE> object from the specified
	 * <CODE>SnmpOid</CODE> and <CODE>SnmpValue</CODE>.
	 * 
	 * @param oid
	 *            The OID part of the <CODE>SnmpVarBind</CODE>.
	 * @param val
	 *            The value part of the <CODE>SnmpVarBind</CODE>.
	 */
	...
	/**
	 * Constructs a new <CODE>SnmpVarBind</CODE> object from the specified
	 * <CODE>String</CODE> value. If the name is a MIB variable, it resolves the
	 * name with the MIB database.
	 * 
	 * @param name
	 *             The MIB variable name or a dot-formatted OID
	 *             <CODE>String</CODE>.
	 * @exception SnmpStatusException
	 *                                An error occurred while resolving the MIB
	 *                                variable name.
	 */
		...
		if (name.startsWith(".")) {
			...
			try {
				...
				if (index <= 0) {
					...
					this.oid = new SnmpOid(record.getName() + name.substring(
							index));
				}
			}
		}
	...
	/**
	 * Returns the complete OID part associated with this
	 * <CODE>SnmpVarBind</CODE>.
	 * 
	...
	/**
	 * Sets the <CODE>SnmpOid</CODE> part associated with this
	 * <CODE>SnmpVarBind</CODE> with the specified OID. The value part of this
	 * <CODE>SnmpVarBind</CODE> will automatically be nulled.
	 * 
	 * @param oid
	 *            The new OID.
	 */
	...
	/**
	 * Sets the <CODE>SnmpValue</CODE> part associated with this
	 * <CODE>SnmpVarBind</CODE> with the specified value. The status is updated
	 ...
	 *                               An attempt has been made to cast an object
	 *                               to a subclass
	 *                               of which it is not an instance.
	 */
	final public SnmpCounter64 getSnmpCounter64Value()
			throws ClassCastException {
		return (SnmpCounter64) this.value;
	}

	/**
	 * Sets the <CODE>SnmpCounter64</CODE> value part associated with this
	 * <CODE>SnmpVarBind</CODE> with the specified counter 64 value. The status
	 * is updated to indicate that the value is valid.
	 * 
	 * @param val
	 ...
	 * @see SnmpCounter64
	 */
	final public void setSnmpCounter64Value(long val)
	...
	/**
	 * Sets the <CODE>SnmpInt</CODE> value part associated with this
	 * <CODE>SnmpVarBind</CODE> with the specified integer value. The status is
	 * updated to indicate that the value is valid.
	 * 
	 * @param val
	 ...
	 * @see SnmpInt
	 */
	final public void setSnmpIntValue(long val)
			throws IllegalArgumentException {
		clearValue();
	...
	/**
	 * Sets the <CODE>SnmpCounter</CODE> value part associated with this
	 * <CODE>SnmpVarBind</CODE> with the specified counter value. The status is
	 * updated to indicate that the value is valid.
	 * 
	 * @param val
	 ...
	 * @see SnmpCounter
	 */
	final public void setSnmpCounterValue(long val)
			throws IllegalArgumentException {
		clearValue();
	...
	/**
	 * Sets the <CODE>SnmpGauge</CODE> value part associated with this
	 * <CODE>SnmpVarBind</CODE> with the specified gauge value. The status is
	 * updated to indicate that the value is valid.
	 * 
	 * @param val
	 *            The new gauge value.
	 ...
	 * @see SnmpGauge
	 */
	final public void setSnmpGaugeValue(long val)
			throws IllegalArgumentException {
		clearValue();
	 ...
	 *                               of which it is not an instance.
	 */
	final public SnmpTimeticks getSnmpTimeticksValue()
			throws ClassCastException {
		return (SnmpTimeticks) this.value;
	}

	/**
	 * Sets the <CODE>SnmpTimeticks</CODE> value part associated with this
	 * <CODE>SnmpVarBind</CODE> with the specified timeticks value. The status
	 * is updated to indicate that the value is valid.
	 * 
	 * @param val
	 ...
	 * @see SnmpTimeticks
	 */
	final public void setSnmpTimeticksValue(long val)
			throws IllegalArgumentException {
		clearValue();
	...
	/**
	 * Sets the <CODE>SnmpOid</CODE> value part associated with this
	 * <CODE>SnmpVarBind</CODE> with the specified OID value. The status is
	 * updated to indicate that the value is valid.
	 * 
	 * @param val
	 *            The new OID value.
	 * @exception IllegalArgumentException
	 *                                     The specified value is neither a
	 *                                     numeric
	 *                                     <CODE>String</CODE> nor a
	 *                                     <CODE>String</CODE> of the MIB
	 *                                     database.
	 * @see SnmpOid
	 */
	final public void setSnmpOidValue(String val)
			throws IllegalArgumentException {
		clearValue();
	 ...
	 *                               of which it is not an instance.
	 */
	final public SnmpIpAddress getSnmpIpAddressValue()
			throws ClassCastException {
		return (SnmpIpAddress) this.value;
	}

	/**
	 * Sets the <CODE>SnmpIpAddress</CODE> value part associated with this
	 * <CODE>SnmpVarBind</CODE> with the specified ipAddress value. The status
	 * is updated to indicate that the value is valid.
	 * 
	 * @param val
	 ...
	 * @see SnmpIpAddress
	 */
	final public void setSnmpIpAddressValue(String val)
			throws IllegalArgumentException {
		clearValue();
	...
	/**
	 * Sets the <CODE>SnmpString</CODE> value part associated with this
	 * <CODE>SnmpVarBind</CODE> with the specified string value. The status is
	 * updated to indicate that the value is valid.
	 * 
	 * @param val
	...
	/**
	 * Sets the <CODE>SnmpOpaque</CODE> value part associated with this
	 * <CODE>SnmpVarBind</CODE> with the specified bytes array values. The
	 * status is updated to indicate that the value is valid.
	 * 
	 * @param val
	 *            The new bytes array value.
	 * @see SnmpOpaque
	 */
	 ...
	 *                               of which it is not an instance.
	 */
	final public SnmpStringFixed getSnmpStringFixedValue()
			throws ClassCastException {
		return (SnmpStringFixed) this.value;
	}

	/**
	 * Sets the <CODE>SnmpStringFixed</CODE> value part associated with this
	 * <CODE>SnmpVarBind</CODE> with the specified string value. The status is
	 * updated to indicate that the value is valid.
	 * 
	 * @param val
	...
	/**
	 * Consults the MIB table storage to resolve the name to its OID type
	 * structure.
	 * 
	 * @param name
	 *             The MIB variable name or a dot-formatted OID
	 ...
	 * <CODE>SnmpVarBind</CODE> as an integer. This value is one of
	 * {@link #stValueUnspecified}, {@link #stValueOk},
	 * {@link #stValueNoSuchObject}, {@link #stValueNoSuchInstance},
	 * {@link #stValueEndOfMibView}.
	 * 
	...
	/**
	 * Returns the status of the value associated with this
	 * <CODE>SnmpVarBind</CODE> as a <CODE>String</CODE>. This value is a
	 * displayable representation of the status integer value. It is one of
	 * <CODE>Value not initialized</CODE>, <CODE>Valid Value</CODE>,
	 * <CODE>No such object</CODE>, <CODE>No such Instance</CODE>,
	 * <CODE>End of Mib View</CODE>.
	 * 
	 * @return The status of the associated value.
	 */
	 ...
	 * 
	 * @return <CODE>true</CODE> if the associated value is valid,
	...
	/**
	 * Checks whether the value associated with this <CODE>SnmpVarBind</CODE> is
	 * unspecified.
	 * 
	 * @return <CODE>true</CODE> if the status is unspecified,
	 *         <CODE>false</CODE> otherwise.
	 */
	...
	/**
	 * Clears the value associated with this <CODE>SnmpVarBind</CODE> and sets
	 * the status to <CODE>stValueUnspecified</CODE>.
	 */
	...
	/**
	 * Checks whether the OID for this variable completely matches the OID part
	 * of the specified <CODE>SnmpVarBind</CODE> object.
	 * 
	 * @param var
	 *            The object whose OID part is to be matched.
	 * @return <CODE>true</CODE> if the OID part matches exactly,
	 *         <CODE>false</CODE> otherwise.
	 */
	...
	/**
	 * Adds an instance part to the OID in the <CODE>SnmpOid</CODE> object. Note
	 * that there is no <CODE>getInstance</CODE> method. This method will
	 * directly add the instance to the <CODE>SnmpOid</CODE> object.
	 * 
	 * @param inst
	 *             The sub-identifier to be appended to the OID.
	 */
	 ...
	 * 
	 * @param inst
	 *             Dot-formatted sub-identifier <CODE>String</CODE> to be
	 *             appended to the OID.
	 * @exception SnmpStatusException
	 *                                An error occurred while accessing a MIB
	 *                                node.
	...
	/**
	 * Inserts a sub-id at the beginning of the OID of this
	 * <CODE>SnmpVarBind</CODE>.
	 * 
	 * @param oid
	 *            The sub-id to insert.
	 */
	...
	/**
	 * Appends the specified <CODE>SnmpOid</CODE> to the end of the OID of this
	 * <CODE>SnmpVarBind</CODE>.
	 * 
	 * @param oid
	 *            The OID to append.
	 ...
	 * 
	 * @return <CODE>true</CODE> if the <CODE>SnmpVarBind</CODE> has an SNMP
	 *         response exception, <CODE>false</CODE> otherwise.
	 */
	...
	/**
	 * Clones and copies the OID and value part from another
	 * <CODE>SnmpVarBind</CODE> object.
	 * 
	 * @param var
	 *            The <CODE>SnmpVarBind</CODE> clone.
	 */
	...
	/**
	 * Clones and copies only the value part from another
	 * <CODE>SnmpVarBind</CODE> object.
	 * 
	 * @param var
	 *            The <CODE>SnmpVarBind</CODE> clone.
	...
	public void copyValue(SnmpVarBind var) {
		if (var.isValidValue()) {
			...
			if (status == stValueEndOfMibView)
				value = endOfMibView;
			else if (status == stValueNoSuchObject)
				value = noSuchObject;
			else if (status == stValueNoSuchInstance)
	...
	/**
	 * Returns the printable ASCII representation for the corresponding variable
	 * value.
	 * 
	...
	/**
	 * Returns the printable ASCII representation of this
	 * <CODE>SnmpVarBind</CODE>.
	 * 
	 * @return The printable ASCII representation.
	 */
	 ...
	 * <CODE>SnmpVarBind</CODE> is valid.
	 */
	...
	private void handleLong(String oid, int index) throws NumberFormatException,
			SnmpStatusException {
