...
public abstract class SnmpUnsignedInt extends SnmpInt {
    ...
    // -------------
    /**
     * Constructs a new <CODE>SnmpUnsignedInt</CODE> from the specified integer
     * value.
     * 
     * @param v
    ...
    /**
     * Constructs a new <CODE>SnmpUnsignedInt</CODE> from the specified
    ...
    /**
     * Constructs a new <CODE>SnmpUnsignedInt</CODE> from the specified long
     * value.
     * 
     * @param v
     *        The initialization value.
