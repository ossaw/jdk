...
abstract public class Enumerated implements Serializable {
	...
	/**
	 * Construct an enumerated with a default value. The default value is the
	...
	/**
	 * This variable keeps the integer form of the enumerated. The string form
	 * is retrieved using getIntTable().
	 */
	protected int value;
