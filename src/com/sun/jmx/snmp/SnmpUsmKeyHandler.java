 ...
 * It is useful when adding user in USM MIB. An instance of
 * <CODE> SnmpUsmKeyHandler </CODE> is associated to each
 * <CODE> SnmpEngine </CODE> object. When computing key, an authentication
 * algorithm is needed. The supported ones are : usmHMACMD5AuthProtocol and
...
public interface SnmpUsmKeyHandler {
    ...
    /**
     * DES privacy algorithm delta size. To be used when calculing privacy key
     * delta.
     */
     ...
     * computation is done by the key change initiator. It MUST be compliant to
     ...
     * privacy algorithm. This computation is done by the key change initiator.
