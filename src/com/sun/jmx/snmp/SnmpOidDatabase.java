...
/**
 * Defines the minimal functionality that should be provided by a class
 * containing a set of <CODE>SnmpOidTable</CODE> objects containing metadata
 * definitions for MIB variables. Each <CODE>SnmpOidTable</CODE> should contain
 * information on variables of one MIB. The <CODE>SnmpOidDatabase</CODE> is a
 * "repository" of <CODE>SnmpOidTable</CODE>. It extends the
 * <CODE>SnmpOidTable</CODE> interface in order to provide resolution of the MIB
 * variables.
 * <P>
 * <p>
...
public interface SnmpOidDatabase extends SnmpOidTable {
    ...
    /**
     * Adds an <CODE>SnmpOidTable</CODE> object in this
    ...
    /**
     * Removes an <CODE>SnmpOidTable</CODE> object from this
     * <CODE>SnmpOidDatabase</CODE>.
     * 
     * @param table
    ...
    /**
     * Removes all the <CODE>SnmpOidTable</CODE> objects from this
     * <CODE>SnmpOidDatabase</CODE>.
     */
    ...
    /**
     * Returns a list that can be used to traverse all the entries of the
     * <CODE>SnmpOidTable</CODE> objects of this <CODE>SnmpOidDatabase</CODE>.
     * 
     * @return A vector of <CODE>SnmpOidTable</CODE> objects containing all the
     *         elements of this <CODE>SnmpOidDatabase</CODE>.
     */
    public Vector<?> getAllEntries();
    // We can't specify Vector<SnmpOidTable> because the subinterface
    // SnmpOidTable
