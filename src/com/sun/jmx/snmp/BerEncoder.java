...
public class BerEncoder {
	...
	/**
	 * Put an <CODE>ANY</CODE> value. In fact, this method does not encode
	...
	/**
	 * Put an <CODE>ANY</CODE> value. Only the first <CODE>byteCount</CODE> are
	 * considered.
	 *
	 * @param s
	 *                  The encoding of the <CODE>ANY</CODE> value.
	...
	/**
	 * Close a sequence. The decode pull the stack to know the end of the
	 * current sequence.
	 */
	...
	// A value is computed and pushed in it each time the
	// <CODE>openSequence</CODE> method
	// is invoked.
	// A value is pulled and checked each time the <CODE>closeSequence</CODE>
	// method is called.
	//
