...
/**
 * <p>
 * This interface defines the methods that must be implemented by an SNMP
 * metadata object that needs to interact with an
 * {@link com.sun.jmx.snmp.agent.SnmpGenericObjectServer} object.
 * </p>
 *
 * <p>
 * All these methods are usually generated by <code>mibgen</code> when run in
 * generic-metadata mode.
 * </p>
 *
 * <p>
 * <b><i> This interface is used internally between the generated Metadata and
 * the SNMP runtime and you shouldn't need to worry about it, because you will
 * never have to use it directly. </b></i>
 * </p>
 *
 * <p>
...
public interface SnmpGenericMetaServer {
	...
	/**
	 * Construct an attribute value (as returned by Attribute::getValue()) from
	 * an SnmpValue. The returned attribute value can be used to construct an
	 * Attribute object.
	 *
	 * @param id
	 *            The OID arc identifying the variable for which the value is
	 *            constructed.
	 * @param value
	 ...
	 *                if the attribute value cannot be built from the given
	 *                SnmpValue <code>value</code>.
	 *
	 */
	 ...
	 * @exception SnmpStatusException
	 *                if the SnmpValue cannot be built from the given
	 *                <code>value</code>.
	 **/
	 ...
	 *
	 * @return The name of the variable identified by the given <code>id</code>.
	 *
	 * @exception SnmpStatusException
	 *                if the given <code>id</code> does not correspond to a
	 *                known variable.
	 */
	 ...
	 *           {@link com.sun.jmx.snmp.agent.SnmpUserDataFactory}</code> for
	 *            each incoming SNMP request.
	 * @exception SnmpStatusException
	 *                if the SET operation must be rejected.
	 */
	void checkSetAccess(SnmpValue x, long id, Object data) throws SnmpStatusException;
	 ...
	 *                if the SET operation must be rejected.
	 */
	void checkGetAccess(long id, Object data) throws SnmpStatusException;
