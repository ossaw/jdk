...
/**
 * <p>
 * This class is a utility class that transforms SNMP GET / SET requests into
 * standard JMX getAttributes() setAttributes() requests.
 * </p>
 *
 * <p>
 * The transformation relies on the metadata information provided by the
 * {@link com.sun.jmx.snmp.agent.SnmpGenericMetaServer} object which is passed
 * as the first parameter to every method. This SnmpGenericMetaServer object is
 * usually a Metadata object generated by <code>mibgen</code>.
 * </p>
 *
 * <p>
 * <b><i> This class is used internally by mibgen generated metadata objects and
 * you should never need to use it directly. </b></i>
 * </p>
 * <p>
...
public class SnmpGenericObjectServer {
	 ...
	 *
	 * <p>
	 * This method first builds the list of attributes that need to be retrieved
	 * from the MBean and then calls getAttributes() on the MBean server. Then
	 * it updates the SnmpMibSubRequest with the values retrieved from the
	 * MBean.
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * <b><i> This method is called internally by <code>mibgen</code> generated
	 * objects and you should never need to call it directly. </i></b>
	 * </p>
	 *
	 * @param meta
	 ...
	 *
	 * <p>
	 * <b><i> You should never need to use this method directly. </i></b>
	 * </p>
	 *
	 * @param meta
	 ...
	 *
	 * <p>
	 * This method first builds the list of attributes that need to be set on
	 * the MBean and then calls setAttributes() on the MBean server. Then it
	 * updates the SnmpMibSubRequest with the new values retrieved from the
	 * MBean.
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * For each variable in the subrequest, this method calls checkSetAccess()
	 * on the meta object, and then tries to invoke the check
	 * <i>AttributeName</i>() method on the MBean. If this method is not defined
	 * then it is assumed that the SET won't fail.
	 * </p>
	 *
	 * <p>
	 * <b><i> This method is called internally by <code>mibgen</code> generated
