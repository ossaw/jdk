...
public interface SnmpMibAgentMBean {
    ...
    /**
     * Processes a <CODE>get</CODE> operation. This method must not be called
     * from remote.
     *
     * @param req
     *        The SnmpMibRequest object holding the list of variables to be
    ...
    /**
     * Processes a <CODE>getNext</CODE> operation. This method must not be
     * called from remote.
     *
     * @param req
     *        The SnmpMibRequest object holding the list of variables to be
    ...
    /**
     * Processes a <CODE>getBulk</CODE> operation. This method must not be
     * called from remote.
     *
     * @param req
    ...
    /**
     * Processes a <CODE>set</CODE> operation. This method must not be called
     * from remote.
     *
     * @param req
     *        The SnmpMibRequest object holding the list of variables to be
     ...
     * cannot be performed, the method should emit a
     ...
     * bound. <BR>
     * This method is used for accessing the SNMP MIB handler property of the
     * SNMP MIB agent in case of a standalone agent.
     *
     ...
     * <BR>
     * This method is used for setting the SNMP MIB handler property of the SNMP
     * MIB agent in case of a standalone agent.
     *
     * @param stack
     ...
     * implemented in more than one MIB. In this case, the OID nearer agent will
     * be used on SNMP operations.
     * 
     * @param stack
     *        The SNMP MIB handler.
     * @param oids
