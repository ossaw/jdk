...
public class SnmpMibOid extends SnmpMibNode implements Serializable {
        ...
        while (true) {
            ...
            try {
                ...
                if (child == null) {
                    ...
                    try {
                        result = child.findNextHandlingNode(varbind, oid, pos + 1, depth + 1, handlers,
                                checker);
                    } finally {
    ...
    /**
     * Export this node's children to a brother node that will replace this node
     * in the OID tree. This method is a patch that fixes the problem of
     * registering a subnode before its father node.
     **/
