...
public abstract class SnmpMibTable extends SnmpMibNode implements
        NotificationBroadcaster, Serializable {
     ...
     * @param depth
     *               The position of the columnar object arc in the OIDs from
     *               the
     *               varbind list.
     *
    ...
    public abstract void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
            int depth) throws SnmpStatusException;
     ...
     *                           Tells whether remote entry creation must be
     *                           enabled or
     *                           disabled.
     *                           <ul>
     *                           <li><CODE>setCreationEnabled(true)</CODE> will
     *                           enable remote
     *                           entry creation via SET operations.</li>
     *                           <li><CODE>setCreationEnabled(false)</CODE> will
     *                           disable remote
     *                           entry creation via SET operations.</li>
     *                           <p>
     *                           By default remote entry creation via SET
     *                           operation is
     *                           disabled.
     *                           </p>
     *                           </ul>
    ...
    public void get(SnmpMibSubRequest req, int depth)
        ...
        if (isnew) {
            SnmpVarBind var;
            for (Enumeration<SnmpVarBind> e = r.getElements(); e
                    .hasMoreElements();) {
                var = e.nextElement();
                r.registerGetException(var, new SnmpStatusException(
    ...
    public void check(SnmpMibSubRequest req, int depth)
        ...
        if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
            SNMP_ADAPTOR_LOGGER.logp(Level.FINEST, SnmpMibTable.class.getName(),
                    "check", "Calling check for " + req.getSize()
                            + " varbinds");
        }
     ...
     *
     * @exception SnmpStatusException
     *                                The entry couldn't be added at the
     *                                position identified by
     *                                the given <code>rowOid</code>, or this
     *                                version of the
     ...
     *                                The entry couldn't be added at the
     *                                position identified by
     *                                the given <code>rowOid</code>, or if this
     *                                version of the
     *                                metadata requires ObjectName's, and the
     *                                given name is
     *                                null.
     */
     ...
     * 
     * @param rowOid
     *               The <CODE>SnmpOid</CODE> identifying the table row to
     *               remove.
     *
     * @param entry
     ...
     *                                (if the given
     *                                <code>rowOid</code> is not valid for
     *                                instance).
     */
     ...
     *
     * @exception SnmpStatusException
     *                                if the specified entry couldn't be
     *                                removed.
     */
     ...
     * 
     * @param rowOid
     *               The <CODE>SnmpOid</CODE> identifying the row to be
     *               retrieved.
     *
     * @return The entry.
     *
     ...
     *                manager request the creation of a new entry via an SNMP
     *                SET
     *                request.
     */
     ...
     * 
     * @param rowOid
     *                 The <CODE>SnmpOid</CODE> identifying the table row
     *                 involved in
     *                 the operation.
     *
     * @param var
     ...
     *
     * @param rowOid
     *               The <CODE>SnmpOid</CODE> identifying the table row involved
     *               in
     *               the operation.
     *
     * @param depth
     ...
     *
     * @exception SnmpStatusException
     *                                if the value of the control variable could
     *                                not be mapped
     *                                to a RowStatus code.
     *
    ...
    protected int mapRowStatus(SnmpOid rowOid, SnmpVarBind vbstatus,
            Object userData) throws SnmpStatusException {
     ...
     *
     * @param newStatus
     *                  The new status for the row: one of the RowStatus code
     *                  defined
     ...
     *
     * @exception SnmpStatusException
     *                                If the given <code>newStatus</code> could
     *                                not be set on
     ...
     *
     **/
    protected void checkRowStatusChange(SnmpMibSubRequest req, SnmpOid rowOid,
            int depth, int newStatus) throws SnmpStatusException {
     ...
     *
     * @exception SnmpStatusException
     *                                if the actual row deletion fails. This
     *                                should not happen
     *                                since it would break the atomicity of the
     *                                SET request.
     *                                Specific checks should be implemented in
     *                                <code>checkRemoveTableRow()</code> if
     *                                needed. If the entry
     *                                does not exists, no exception is generated
     *                                and the method
     *                                simply returns.
     *
     **/
     ...
     *
     * @exception SnmpStatusException
     *                                if the specified <code>rowAction</code> is
     *                                not valid or
     *                                cannot be executed. This should not happen
     *                                since it would
     *                                break the atomicity of the SET request.
     *                                Specific checks
     *                                should be implemented in
     *                                <code>beginRowAction()</code> if
     *                                needed.
     *
     * @see com.sun.jmx.snmp.EnumRowStatus
     **/
    protected synchronized void beginRowAction(SnmpMibSubRequest req,
        ...
        switch (action) {
                ...
                if (isnew) {
                    if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
                        SNMP_ADAPTOR_LOGGER.logp(Level.FINEST,
                                SnmpMibTable.class.getName(), "beginRowAction",
                ...
                if (isnew) {
                    if (isCreationEnabled()) {
                        ...
                        if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
                            SNMP_ADAPTOR_LOGGER.logp(Level.FINEST,
                                    SnmpMibTable.class.getName(),
                                    "beginRowAction", "Can't create row["
                                            + rowOid
                                            + "] : RowStatus = createAndGo | createAndWait "
            ...
            default:
                if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
                    SNMP_ADAPTOR_LOGGER.logp(Level.FINEST, SnmpMibTable.class
                            .getName(), "beginRowAction",
                            "Invalid RowStatus value for row[" + rowOid
    ...
    protected void endRowAction(SnmpMibSubRequest req, SnmpOid rowOid,
            int depth, int rowAction) throws SnmpStatusException {
        final boolean isnew = req.isNewEntry();
        final SnmpOid oid = rowOid;
        final int action = rowAction;
        ...
        switch (action) {
            ...
            case EnumRowStatus.createAndGo:
                if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
                    SNMP_ADAPTOR_LOGGER.logp(Level.FINEST, SnmpMibTable.class
                            .getName(), "endRowAction",
                            "Setting RowStatus to 'active' " + "for row["
                                    + rowOid + "] : requested RowStatus = "
                                    + "createAndGo");
                }
            ...
            case EnumRowStatus.createAndWait:
                if (isRowReady(oid, data)) {
                    if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
                        SNMP_ADAPTOR_LOGGER.logp(Level.FINEST,
                                SnmpMibTable.class.getName(), "endRowAction",
                    ...
                    if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
                        SNMP_ADAPTOR_LOGGER.logp(Level.FINEST,
                                SnmpMibTable.class.getName(), "endRowAction",
                                "Setting RowStatus to 'notReady' " + "for row["
                                        + rowOid + "] : requested RowStatus = "
                                        + "createAndWait");
                    }
     ...
     *
     * @param userData
     *                   A contextual object containing user-data. This object
     *                   is
     *                   allocated through the <code>
     *        {@link com.sun.jmx.snmp.agent.SnmpUserDataFactory}</code> for each
     *                   incoming SNMP request.
     ...
     *
     **/
    protected long getNextVarEntryId(SnmpOid rowOid, long var, Object userData,
            int pduVersion) throws SnmpStatusException {
     ...
     */
    protected boolean skipEntryVariable(SnmpOid rowOid, long var,
            Object userData, int pduVersion) {
        return false;
    }
     ...
     *
     * @exception SnmpStatusException
     *                                There is no index following the specified
     *                                <CODE>oid</CODE>
     *                                in the table.
     */
     ...
     * <CODE>SnmpMibTable</CODE> subclasses generated by <CODE>mibgen</CODE>.
     */
    abstract protected void get(SnmpMibSubRequest req, SnmpOid rowOid,
            int depth) throws SnmpStatusException;
     ...
     * <CODE>SnmpMibTable</CODE> subclasses generated by <CODE>mibgen</CODE>.
     */
    abstract protected void check(SnmpMibSubRequest req, SnmpOid rowOid,
            int depth) throws SnmpStatusException;
     ...
     * <CODE>SnmpMibTable</CODE> subclasses generated by <CODE>mibgen</CODE>.
     */
    abstract protected void set(SnmpMibSubRequest req, SnmpOid rowOid,
            int depth) throws SnmpStatusException;
    ...
    // ---------------------------------------------------------------------
    @Override
    final synchronized void findHandlingNode(SnmpVarBind varbind, long[] oid,
            int depth, SnmpRequestTree handlers) throws SnmpStatusException {
    ...
    final synchronized long[] findNextHandlingNode(SnmpVarBind varbind,
            long[] oid, int pos, int depth, SnmpRequestTree handlers,
            AcmChecker checker) throws SnmpStatusException {
        ...
        return findNextAccessibleOid(entryoid, varbind, oid, depth, handlers,
                checker, data, var);
    }

    private long[] findNextAccessibleOid(SnmpOid entryoid, SnmpVarBind varbind,
            long[] oid, int depth, SnmpRequestTree handlers, AcmChecker checker,
            Object data, long var) throws SnmpStatusException {
        final int pduVersion = handlers.getRequestPduVersion();
        ...
        while (true) {
            ...
            try {
                ...
                //
                java.lang.System.arraycopy(etable, 0, result, depth + 2,
                        elength);
    ...
    private synchronized void sendNotification(Notification notification) {
        ...
        // loop on listener
        //
        for (java.util.Enumeration<NotificationListener> k = handbackTable
                .keys(); k.hasMoreElements();) {
            ...
            //
            java.util.Vector<?> handbackList = handbackTable.get(listener);
            java.util.Vector<NotificationFilter> filterList = filterTable.get(
                    listener);

            // loop on handback
            //
            java.util.Enumeration<NotificationFilter> f = filterList.elements();
            for (java.util.Enumeration<?> h = handbackList.elements(); h
                    .hasMoreElements();) {

                Object handback = h.nextElement();
                NotificationFilter filter = f.nextElement();

                if ((filter == null) || (filter.isNotificationEnabled(
                        notification))) {
     ...
     *                  The entry object.
     */
    private void sendNotification(String type, long timeStamp, Object entry,
            ObjectName name) {
        ...
        SnmpTableEntryNotification notif = new SnmpTableEntryNotification(type,
                this, sequenceNumber, timeStamp, entry, name);
     ...
     *
     * @exception SnmpStatusException
     *                                if the OID is already present in the table
     *                                and
    ...
    private void insertOid(int pos, SnmpOid oid) {
        if (pos >= tablesize || tablecount == tablesize) {
            ...
            java.lang.System.arraycopy(tableoids, pos, tableoids, pos + 1,
                    tablecount - pos);
        }
