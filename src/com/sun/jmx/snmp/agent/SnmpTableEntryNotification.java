...
/**
 * Represents a notification emitted when an entry is added or deleted from an
 * SNMP table.
 * <P>
 * The <CODE>SnmpTableEntryNotification</CODE> object contains the reference to
 * the entry added or removed from the table.
 * <P>
 * The list of notifications fired by the <CODE>SnmpMibTable</CODE> is the
 * following:
 * <UL>
...
public class SnmpTableEntryNotification extends Notification {
    ...
    /**
     * Gets the entry object. May be null if the entry is registered in the
     * MBeanServer, and the MIB is using the generic MetaData (see mibgen).
     *
     * @return The entry.
     */
    ...
    /**
     * Gets the ObjectName of the entry. May be null if the entry is not
     * registered in the MBeanServer.
     *
    ...
    /**
     * Notification type denoting that a new entry has been added to the SNMP
     * table. <BR>
    ...
    /**
     * Notification type denoting that an entry has been removed from the SNMP
     * table. <BR>
     * The value of this notification type is
