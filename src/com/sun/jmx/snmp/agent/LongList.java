...
/**
 * This list is used in order to construct the OID during the getnext. The
 * constructed oid is checked by the checker AcmChecker.
 */
final class LongList {
	...
	/**
	 * The list content. Any access to this variable must be protected by a
	 * synchronized block on the LongList object. Only read-only action should
	...
	/**
	 * Same behaviour than add(long o) in {@link java.util.List}. Any access to
	 * this method should be protected in a synchronized block on the LongList
	 * object.
	 **/
	...
	/**
	 * Same behaviour than add(int index, long o) in {@link java.util.List}. Any
	 * access to this method should be protected in a synchronized block on the
	 * LongList object.
	 **/
	 ...
	 *            inserted.
	 * @param count
	 *            number of elements to insert. Any access to this method should
	...
	/**
	 * Any access to this method should be protected in a synchronized block on
	 * the LongList object.
	 **/
	public final long remove(final int from, final int count) {
		...
		java.lang.System.arraycopy(list, from + count, list, from, size - from);
		return o;
	}

	/**
	 * Same behaviour than remove(int index) in {@link java.util.List}. Any
	 * access to this method should be protected in a synchronized block on the
	 * LongList object.
	 **/
	public final long remove(final int index) {
		...
		java.lang.System.arraycopy(list, index + 1, list, index, size - index);
		return o;
	}

	/**
	 * Same behaviour than the toArray(long[] a) method in
	 * {@link java.util.List}. Any access to this method should be protected in
	 * a synchronized block on the LongList object.
	 **/
	...
	/**
	 * Same behaviour than the toArray() method in {@link java.util.List}. Any
	 * access to this method should be protected in a synchronized block on the
	 * LongList object.
	 **/
	...
	/**
	 * Resize the list. Increase its capacity by DELTA elements. Any call to
	 * this method must be protected by a synchronized block on this LongList.
	 **/
	...
	/**
	 * Resize the list. Insure that the new length will be at least equal to
	 * <var>length</var>.
	 * 
	 * @param length
	 *            new minimal length requested. Any call to this method must be
