 ...
 * SnmpMibNode responsible for handling the requests concerning that varbind.
 * This class holds a hashtable of Handler nodes, whith the involved SnmpMibNode
 * as a key. When the involved SnmpMibNode is a group, the sublist of varbind is
 * directly stored in the Handler node. When the involved SnmpMibNode is a
 * table, the sublist is stored in a sorted array indexed by the OID of the
 * entry involved.
 */
final class SnmpRequestTree {
    ...
    public static int mapGetException(int errorStatus, int version) throws SnmpStatusException {
        ...
        //
        else if (errorCode == SnmpStatusException.noAccess)
    ...
    static final class Handler {
        ...
        /**
         * register an entry for the given oid at the given position with the
         * given sublist.
         */
        ...
        void add(int pos, SnmpOid oid, Vector<SnmpVarBind> v, boolean isnew, SnmpVarBind statusvb) {
            ...
            if (entryoids == null) {
                ...
                if (l1 > 0) {
                    java.lang.System.arraycopy(olde, 0, entryoids, 0, l1);
                    java.lang.System.arraycopy(oldl, 0, entrylists, 0, l1);
                    java.lang.System.arraycopy(oldn, 0, isentrynew, 0, l1);
                    java.lang.System.arraycopy(oldr, 0, rowstatus, 0, l1);
                }
                ...
                if (l2 > 0) {
                    final int l3 = l1 + 1;
                    java.lang.System.arraycopy(olde, l1, entryoids, l3, l2);
                ...
                java.lang.System.arraycopy(entryoids, pos, entryoids, l1, l2);
                java.lang.System.arraycopy(entrylists, pos, entrylists, l1, l2);
                java.lang.System.arraycopy(isentrynew, pos, isentrynew, l1, l2);
                java.lang.System.arraycopy(rowstatus, pos, rowstatus, l1, l2);
            }
        ...
        public void addVarbind(SnmpVarBind varbind, SnmpOid entryoid, boolean isnew, SnmpVarBind statusvb)
                throws SnmpStatusException {
            ...
            if (entryoids == null) {
                ...
                if (statusvb != null) {
                    if ((rs != null) && (rs != statusvb) && ((type == SnmpDefinitions.pduWalkRequest)
    ...
    public void add(SnmpMibNode meta, int depth, SnmpOid entryoid, SnmpVarBind varbind, boolean isnew)
            throws SnmpStatusException {
    ...
    SnmpMibSubRequest getSubRequest(Handler handler) {
        if (handler == null)
            return null;
        return new SnmpMibSubRequestImpl(request, handler.getSubList(), null, false, getnextflag, null);
    }
    ...
    SnmpMibSubRequest getSubRequest(Handler handler, SnmpOid oid) {
        ...
        if (pos == -1)
            return null;
        return new SnmpMibSubRequestImpl(request, handler.getEntrySubList(pos), handler.getEntryOid(pos),
                handler.isNewEntry(pos), getnextflag, handler.getRowStatusVarBind(pos));
    }
    ...
    SnmpMibSubRequest getSubRequest(Handler handler, int entry) {
        if (handler == null)
            return null;
        return new SnmpMibSubRequestImpl(request, handler.getEntrySubList(entry), handler.getEntryOid(entry),
                handler.isNewEntry(entry), getnextflag, handler.getRowStatusVarBind(entry));
    }
