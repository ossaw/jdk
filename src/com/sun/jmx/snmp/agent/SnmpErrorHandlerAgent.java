...
/**
 * A simple MIB agent that implements SNMP calls (get, set, getnext and getbulk)
 * in a way that only errors or exceptions are returned. Every call done on this
 * agent fails. Error handling is done according to the manager's SNMP protocol
 * version.
 * <P>
 * It is used by <CODE>SnmpAdaptorServer</CODE> for its default agent behavior.
 * When a received Oid doesn't match, this agent is called to fill the result
 * list with errors.
 * </P>
 * <p>
...
public class SnmpErrorHandlerAgent extends SnmpMibAgent implements Serializable {
	...
	/**
	 * Processes a <CODE>get</CODE> operation. It will throw an exception for V1
	 ...
	 * can not be performed, the method should emit a
	...
	/**
	 * Processes a <CODE>set</CODE> operation. Should never be called (check
	...
	/**
	 * Processes a <CODE>getNext</CODE> operation. It will throw an exception
	 * for V1 requests or it will set exceptions within the list for V2
	 * requests..
	 *
	 * @param inRequest
	 *            The SnmpMibRequest object holding the list of variables to be
	...
	/**
	 * Processes a <CODE>getBulk</CODE> operation. It will throw an exception if
	 * the request is a V1 one or it will set exceptions within the list for V2
	 * ones.
	 *
	 * @param inRequest
	 *            The SnmpMibRequest object holding the list of variable to be
