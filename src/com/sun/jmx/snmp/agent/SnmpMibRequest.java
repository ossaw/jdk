...
/**
 * This interface models the part of a SNMP request that involves a specific
...
public interface SnmpMibRequest {
    ...
    /**
     * Returns the vector of varbind to be handled by the SNMP mib node. The
     * caller shall not modify this vector.
     *
    ...
    /**
     * Returns the SNMP protocol version of the original request. If SNMP V1
     * request are received, the version is upgraded to SNMP V2.
     *
    ...
    /**
     * Returns the SNMP protocol version of the original request. No translation
     * is done on the version. The actual received request SNMP version is
     * returned.
     *
     * @return The SNMP protocol version of the original request.
     *
     ...
     * <CODE> SnmpV3AdaptorServer </CODE> is the adaptor receiving this request.
    ...
    /**
     * Gets the incoming request principal. This parameter is returned only if
     * <CODE> SnmpV3AdaptorServer </CODE> is the adaptor receiving this request.
     * Otherwise null is returned.
     * 
     ...
     * {@link com.sun.jmx.snmp.SnmpEngine SnmpEngine}. This parameter is
    ...
    /**
     * Gets the incoming request security model. This parameter is returned only
     * if <CODE> SnmpV3AdaptorServer </CODE> is the adaptor receiving this
    ...
    /**
     * Gets the incoming request context name. This parameter is returned only
     * if <CODE> SnmpV3AdaptorServer </CODE> is the adaptor receiving this
    ...
    /**
     * Gets the incoming request context name used by Access Control Model in
     * order to allow or deny the access to OIDs. This parameter is returned
     * only if <CODE> SnmpV3AdaptorServer </CODE> is the adaptor receiving this
     * request. Otherwise null is returned.
     * 
    ...
    /**
     * Returns a handle on a user allocated contextual object. This contextual
     * object is allocated through the SnmpUserDataFactory on a per SNMP request
     * basis, and is handed back to the user via SnmpMibRequest (and derivative)
     * objects. It is never accessed by the system, but might be handed back in
     * multiple threads. It is thus the user responsibility to make sure he
     * handles this object in a thread safe manner.
     */
    public Object getUserData();

    /**
     * Returns the varbind index that should be embedded in an
     * SnmpStatusException for this particular varbind. This does not
     * necessarily correspond to the "real" index value that will be returned in
     * the result PDU.
     *
     * @param varbind
    ...
    /**
     * Adds a varbind to this request sublist. This method is used for internal
