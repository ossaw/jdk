...
/**
 * <p>
 * This class is a utility class that transform SNMP GET / SET requests into
 * series of get<i>AttributeName</i>() set<i>AttributeName</i>() invoked on the
 * MBean.
 * </p>
 *
 * <p>
 * The transformation relies on the metadata information provided by the
 * {@link com.sun.jmx.snmp.agent.SnmpStandardMetaServer} object which is passed
 * as first parameter to every method. This SnmpStandardMetaServer object is
 * usually a Metadata object generated by <code>mibgen</code>.
 * </p>
 *
 * <p>
 * The MBean is not invoked directly by this class but through the metadata
 * object which holds a reference on it.
 * </p>
 *
 * <p>
...
public class SnmpStandardObjectServer implements Serializable {
	 ...
	 * <p>
	 * The default implementation of this method is to loop over the varbind
	 * list associated with the sub-request and to call
	 ...
	 *
	 * @param meta
	 *              A pointer to the generated meta-data object which implements
	 *              the <code>SnmpStandardMetaServer</code> interface.
	 *
	 * @param req
