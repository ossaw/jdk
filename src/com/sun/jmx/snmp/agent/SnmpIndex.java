...
/**
 * Represents a SNMP index. An <CODE>SnmpIndex</CODE> is represented as a
 * <CODE>Vector</CODE> of <CODE>SnmpOid</CODE>.
 * <P>
 * This class is used internally and by the classes generated by
...
public class SnmpIndex implements Serializable {
	...
	/**
	 * Initializes an <CODE>SnmpIndex</CODE> using a vector of object
	 * identifiers.
	 * <P>
	 * Following the RFC recommendations, every syntax that is used as a table
	 * index should have an object identifier representation. There are some
	 * guidelines on how to map the different syntaxes into an object
	 * identifier. In the different <CODE>SnmpValue</CODE> classes provided,
	 * there is a <CODE>toOid</CODE> method to get the object identifier of the
	 * value.
	 *
	 * @param oidList
	...
	/**
	 * Initializes an <CODE>SnmpIndex</CODE> using the specified Object
	 * Identifier.
	 *
	 * @param oid
	...
	/**
	 * Returns a <CODE>String</CODE> representation of the index. The different
