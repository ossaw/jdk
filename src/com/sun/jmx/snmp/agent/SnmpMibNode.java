 ...
 * <CODE>mibgen</CODE>. You should not need to use this class directly.
 * <p>
...
public abstract class SnmpMibNode implements Serializable {
    ...
    /**
     * Get the next OID arc corresponding to a readable scalar variable, a
     * branch leading to a subgroub, or a table.
     *
     * @param id
     *        Id we start from looking for the next.
     * @param userData
    ...
    /**
     * Get the next OID arc corresponding to a readable scalar variable, a
     * branch leading to a subgroub, or a table, possibly skipping over those
     * arcs that must not or cannot be returned.
     ...
     * @return The next id in this group which can be returned using the given
     ...
     * SnmpRequestTree. This method is a pure internal method. You should never
     * try to call it directly.
     *
     * @param varbind
     *        The varbind to be handled
     * @param oid
     *        The OID array extracted from the varbind
     * @param depth
     *        The depth reached in the OID at this step of the
     *        processing.
     * @param handlers
     *        The Hashtable in which the varbind will be registered
     *        with its
     *        handling node. This hashtable contains
     *        <CODE>SnmpRequestTree.Handler</CODE> items.
     * @exception SnmpStatusException
     *            No handling node was found.
     **/
    ...
    /**
     * Find the node which handles the leaf that immediately follows the given
     * varbind OID, and register the it in the SnmpRequestTree. This method is a
     * pure internal method. You should never try to call it directly.
     *
     * @param varbind
     *        The varbind to be handled
     * @param oid
     ...
     *            No handling node was found.
     **/
    long[] findNextHandlingNode(SnmpVarBind varbind, long[] oid, int pos, int depth, SnmpRequestTree handlers,
     ...
     *            node.
     */
    public abstract void set(SnmpMibSubRequest req, int depth) throws SnmpStatusException;
     ...
     *            node.
     */
    public abstract void check(SnmpMibSubRequest req, int depth) throws SnmpStatusException;
    ...
    /**
     * This will give the first element greater than <CODE>value</CODE> in a
     * sorted array. If there is no element of the array greater than
     * <CODE>value</CODE>, the method will throw a
     ...
     *            <CODE>value</CODE>.
     */
    final static protected int getNextIdentifier(int table[], long value) throws SnmpStatusException {
