...
public abstract class SnmpMib extends SnmpMibAgent implements Serializable {
    ...
    public void get(SnmpMibRequest req) throws SnmpStatusException {
        ...
        for (Enumeration<SnmpRequestTree.Handler> eh = handlers.getHandlers(); eh.hasMoreElements();) {
            ...
            for (Enumeration<SnmpMibSubRequest> rqs = handlers.getSubRequests(h); rqs.hasMoreElements();) {
     ...
     */
    private SnmpRequestTree getHandlers(SnmpMibRequest req, boolean createflag, boolean atomic, int type)
    ...
    private SnmpRequestTree getGetNextHandlers(SnmpMibRequest req) throws SnmpStatusException {
        ...
        for (Enumeration<SnmpVarBind> e = req.getElements(); e.hasMoreElements(); index++) {
            ...
            try {
                ...
                result = new SnmpOid(root.findNextHandlingNode(var, var.oid.longValue(false), 0, 0, handlers,
                        checker));
