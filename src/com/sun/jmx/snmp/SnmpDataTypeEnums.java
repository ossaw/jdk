...
/**
 * Contains SNMP data type constants. All members are static and can be used by
 * any application.
 * <p>
...
public interface SnmpDataTypeEnums {
    ...
    /**
     * ASN.1 tag for representing a <CODE>Counter32</CODE> as defined in RFC
     * 1155.
     */
    ...
    /**
     * ASN.1 tag for representing a <CODE>Timeticks</CODE> as defined in RFC
     * 1155.
     */
    static public final int TimeticksTag = ApplFlag | 3;

    /**
     * ASN.1 tag for representing an <CODE>Opaque</CODE> type as defined in RFC
     * 1155.
     */
    static public final int OpaqueTag = ApplFlag | 4;

    /**
     * ASN.1 tag for representing a <CODE>Counter64</CODE> as defined in RFC
     * 1155.
     */
    ...
    /**
     * ASN.1 tag for representing an <CODE>Unsigned32</CODE> integer as defined
     * in RFC 1902.
     */
    static final public int UintegerTag = ApplFlag | 7;

    /**
     * ASN.1 tag for representing a <CODE>NoSuchObject</CODE> as defined in RFC
     * 1902.
     */
    static final public int errNoSuchObjectTag = CtxtFlag | 0;

    /**
     * ASN.1 tag for representing a <CODE>NoSuchInstance</CODE> as defined in
     * RFC 1902.
     */
    static final public int errNoSuchInstanceTag = CtxtFlag | 1;

    /**
     * ASN.1 tag for representing an <CODE>EndOfMibView</CODE> as defined in RFC
     * 1902.
     */
