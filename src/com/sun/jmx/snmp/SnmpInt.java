...
public class SnmpInt extends SnmpValue {
	...
	/**
	 * Constructs a new <CODE>SnmpInt</CODE> from the specified
	...
	/**
	 * Extracts the integer from an index OID and returns its value converted as
	 ...
	 *                There is no integer value available at the start position.
	 */
	...
	/**
	 * Scans an index OID, skips the integer value and returns the position of
	 * the next value.
	 * 
	 * @param index
	 *            The index array.
	...
	/**
	 * Appends an <CODE>SnmpOid</CODE> representing an <CODE>SnmpInt</CODE> to
	 * another OID.
	 * 
	 * @param source
	...
	/**
	 * This method has been defined to allow the sub-classes of SnmpInt to
	 * perform their own control at intialization time.
	 */
