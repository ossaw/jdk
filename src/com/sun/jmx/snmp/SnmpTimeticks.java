...
public class SnmpTimeticks extends SnmpUnsignedInt {
    ...
    // -------------
    /**
     * Constructs a new <CODE>SnmpTimeticks</CODE> from the specified integer
     * value.
     * 
     * @param v
     ...
     * value.
     * <p>
     * If the specified value is greater than {@link SnmpUnsignedInt#MAX_VALUE
     * SnmpUnsignedInt.MAX_VALUE}, the SnmpTimeTicks will be initialized with
    ...
    // ---------------
    /**
     * Parses the specified long value with time units and returns a
    ...
    /**
     * Converts the timeticks value to its <CODE>String</CODE> form. The format
     * of the returned <CODE>String</CODE> is <CODE>d days hh:mm:ss</CODE>. <BR>
     * Note: this method simply calls the {@link #printTimeTicks printTimeTicks}
     * method.
     * 
     * @return The <CODE>String</CODE> representation of the value.
     */
