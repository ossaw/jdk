...
/**
 * Defines a set of <CODE>SnmpOidTable</CODE> objects containing metadata
 * definitions for MIB variables. Each <CODE>SnmpOidTable</CODE> should contain
 * information on variables of one MIB. It provides resolution of all MIB
 * variables contained in the <CODE>SnmpOidTable</CODE> objects.
 * <p>
...
public class SnmpOidDatabaseSupport implements SnmpOidDatabase {
    ...
    /**
     * Creates an <CODE>SnmpOidDatabaseSupport</CODE> containing the specified
    ...
    /**
     * Adds a <CODE>SnmpOidTable</CODE> object in this
    ...
    /**
     * Removes a <CODE>SnmpOidTable</CODE> object from this
     * <CODE>SnmpOidDatabase</CODE>.
     * 
     * @param table
    ...
    public void remove(SnmpOidTable table) throws SnmpStatusException {
        if (!tables.contains(table)) {
            throw new SnmpStatusException(
                    "The specified SnmpOidTable does not exist in this SnmpOidDatabase");
        }
    ...
    /**
     * Removes all <CODE>SnmpOidTable</CODE> objects from this
     * <CODE>SnmpOidDatabase</CODE>.
     */
