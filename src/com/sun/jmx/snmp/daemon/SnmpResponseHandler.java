...
/**
 * This class is used to handle received inform request responses. This classes
 * parses the SNMP inform response packet to obtain the corresponding inform
 * request.
 */
    ...
    public synchronized void processDatagram(DatagramPacket dgrm) {
        ...
        if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINER)) {
            SNMP_ADAPTOR_LOGGER.logp(Level.FINER, SnmpResponseHandler.class.getName(), "action",
                    "processDatagram", "Received from " + dgrm.getAddress().toString() + " Length = "
        ...
        try {
            ...
            // Retreive the PDU factory of the SNMP adaptor to decode the
            // received inform response.
            //
            ...
            if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
                SNMP_ADAPTOR_LOGGER.logp(Level.FINEST, SnmpResponseHandler.class.getName(), "processDatagram",
