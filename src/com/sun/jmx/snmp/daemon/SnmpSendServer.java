...
/**
 * This class starts a thread which picks up a session from the queue and
 * prepares the inform request protocol data unit (PDU) packet and sends it to
 * the manager. The request is then added to the wait queue and marked as one
...
final class SnmpSendServer extends Thread {
    ...
    // This boolean is used to stop handling requests while the corresponding
    // SnmpQManager
    // is being destroyed.
    //
