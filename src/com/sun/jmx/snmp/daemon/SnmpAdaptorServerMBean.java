...
/**
 * Exposes the remote management interface of the {@link SnmpAdaptorServer}
 * MBean.
 * <p>
...
public interface SnmpAdaptorServerMBean extends CommunicatorServerMBean {
	...
	/**
	 * Returns the buffer size of this SNMP protocol adaptor. By default, buffer
	 * size 1024 is used.
	 *
	 ...
	 * automatically by
	 * {@link com.sun.jmx.snmp.agent.SnmpMibAgent#setSnmpAdaptor(SnmpMibHandler)}
	 * and
	 * {@link com.sun.jmx.snmp.agent.SnmpMibAgent#setSnmpAdaptorName(ObjectName)}
	 ...
	 * The variable list included in the outgoing inform request is composed of
	 * the following items:
	 * <UL>
	 * <LI><CODE>sysUpTime.0</CODE> with its current value
	 * <LI><CODE>snmpTrapOid.0</CODE> with the value specified by
