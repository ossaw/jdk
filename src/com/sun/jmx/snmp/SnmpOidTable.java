...
/**
 * Defines the minimum functionality that should be provided by a class
 * containing metadata definitions for variables of a MIB. A name can be
 * resolved against a table of MIB variables. Each entry in the table is an
