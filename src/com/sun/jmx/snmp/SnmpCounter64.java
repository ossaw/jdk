...
public class SnmpCounter64 extends SnmpValue {
	...
	// -------------
	/**
	 * Constructs a new <CODE>SnmpCounter64</CODE> from the specified long
	 * value.
	 * 
	 * @param v
	...
	/**
	 * Constructs a new <CODE>SnmpCounter64</CODE> from the specified
	...
	/**
	 * Extracts the counter from an index OID and returns its value converted as
	...
	/**
	 * Scans an index OID, skips the counter value and returns the position of
	 * the next value.
	 * 
	 * @param index
	 *            The index array.
