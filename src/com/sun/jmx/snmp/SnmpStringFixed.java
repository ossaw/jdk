...
/**
 * Represents an SNMP String defined with a fixed length. The class is mainly
 * used when dealing with table indexes for which one of the keys is defined as
 * a <CODE>String</CODE>.
 *
 * <p>
...
public class SnmpStringFixed extends SnmpString {
    ...
    // -------------
    /**
     * Constructs a new <CODE>SnmpStringFixed</CODE> from the specified bytes
     * array.
     * 
     * @param v
    ...
    /**
     * Constructs a new <CODE>SnmpStringFixed</CODE> with the specified
    ...
    /**
     * Constructs a new <CODE>SnmpStringFixed</CODE> from the specified
    ...
    // ---------------
    /**
     * Extracts the fixed-string from an index OID and returns its value
    ...
    /**
     * Scans an index OID, skip the string value and returns the position of the
     * next value.
     * 
     * @param l
