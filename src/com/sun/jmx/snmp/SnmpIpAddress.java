...
public class SnmpIpAddress extends SnmpOid {
    ...
    // -------------
    /**
     * Constructs a new <CODE>SnmpIpAddress</CODE> from the specified bytes
     * array.
     * 
     * @param bytes
    ...
    /**
     * Constructs a new <CODE>SnmpIpAddress</CODE> from the specified long
     * value.
     * 
     * @param addr
    ...
    /**
     * Constructs a new <CODE>SnmpIpAddress</CODE> from a dot-formatted
     * <CODE>String</CODE>. The dot-formatted <CODE>String</CODE> is formulated
     * x.x.x.x .
     * 
     * @param dotAddress
     *        The initialization value.
    ...
    public SnmpIpAddress(String dotAddress) throws IllegalArgumentException {
        super(dotAddress);
        if ((componentCount > 4) || (components[0] > 255) || (components[1] > 255) || (components[2] > 255)
                || (components[3] > 255)) {
    ...
    /**
     * Converts the address to its <CODE>String</CODE> form. Same as
     * <CODE>toString()</CODE>. Exists only to follow a naming scheme.
     * 
    ...
    /**
     * Extracts the ip address from an index OID and returns its value converted
    ...
    /**
     * Scans an index OID, skips the address value and returns the position of
     * the next value.
     * 
     * @param index
     *        The index array.
    ...
    /**
     * Appends an <CODE>SnmpOid</CODE> representing an
