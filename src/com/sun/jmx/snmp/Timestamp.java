...
/**
 * This class is used by the {@link com.sun.jmx.snmp.SnmpVarBindList
 * SnmpVarBindList} object. An <CODE>SnmpVarBindList</CODE> time stamp object
 * represents the time stamp when the list was updated with the response
 * variables.
 * <p>
...
public class Timestamp implements java.io.Serializable {
	...
	/**
	 * The time (in hundreds of a second) since the network management portion
	...
	/**
	 * The <CODE>SnmpTimeticks</CODE> object corresponding to the
	...
	/**
	 * The default constructor. <CODE>Sysuptime</CODE> is 0. This simply
	...
	/**
	 * Gets the <CODE>SnmpTimeticks</CODE> object corresponding to the
	 * <CODE>TimeStamp</CODE> object.
	 * 
	...
	/**
	 * Gets the time (in hundredths of a second) since the network management
