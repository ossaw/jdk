...
public class SnmpNull extends SnmpValue {
	...
	/**
	 * Constructs a new <CODE>SnmpNull</CODE>. <BR>
	...
	/**
	 * Converts the <CODE>NULL</CODE> value to its ASN.1 <CODE>String</CODE>
	 * form. When the tag is not the universal one, it is preprended to the
	...
	/**
	 * Checks if this <CODE>SnmpNull</CODE> object corresponds to a
	 * <CODE>noSuchObject</CODE> value.
	 * 
	 * @return <CODE>true</CODE> if the tag equals
	 *         {@link com.sun.jmx.snmp.SnmpDataTypeEnums#errNoSuchObjectTag},
	...
	/**
	 * Checks if this <CODE>SnmpNull</CODE> object corresponds to a
	 * <CODE>noSuchInstance</CODE> value.
	 * 
	 * @return <CODE>true</CODE> if the tag equals
	 *         {@link com.sun.jmx.snmp.SnmpDataTypeEnums#errNoSuchInstanceTag},
	 *         <CODE>false</CODE> otherwise.
	 */
	...
	/**
	 * Checks if this <CODE>SnmpNull</CODE> object corresponds to an
	 * <CODE>endOfMibView</CODE> value.
	 * 
	 * @return <CODE>true</CODE> if the tag equals
	 *         {@link com.sun.jmx.snmp.SnmpDataTypeEnums#errEndOfMibViewTag},
	 *         <CODE>false</CODE> otherwise.
	 */
	...
	/**
	 * This is the tag of the NULL value. By default, it is the universal tag
	 * value.
	 */
	private int tag = 5;
}
