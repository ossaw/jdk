...
public class SubjectDelegator {
	/*
	 * Return the AccessControlContext appropriate to execute an operation on
	 * behalf of the delegatedSubject. If the authenticatedAccessControlContext
	 ...
	 * server creator codebase contains a subject delegation permission for each
	 * principal present in the authenticated subject.
	 *
