...
/**
 * An interface to a subset of the RMI-IIOP and CORBA APIs to avoid a static
 * dependencies on the types defined by these APIs.
 */
...
public interface IIOPProxy {
	...
	/**
	 * Converts a string, produced by the object_to_string method, back to a
