 ...
 * MXBean interface to a named MXBean in an MBean Server and handles translation
 * between the arbitrary Java types in the interface and the Open Types used by
 * the MXBean.
 * </p>
 * 
 * @since 1.6
...
public class MXBeanProxy {
    ...
    private static abstract class Handler {
        ...
        abstract Object invoke(MBeanServerConnection mbsc, ObjectName name, Object[] args) throws Exception;
