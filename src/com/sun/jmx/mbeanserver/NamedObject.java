...
/**
 * This class is used for storing a pair (name, object) where name is an object
 * name and object is a reference to the object.
 *
 * @since 1.5
 */
public class NamedObject {
	 ...
	 *
	 * @param objectName
	 *                   The string representation of the object name of the
	 *                   object.
	 * @param object
	 *                   A reference to the object.
	 *
	 * @exception MalformedObjectNameException
	 *                                         The string passed does not have
	 *                                         the format of a valid
	 *                                         ObjectName
	 */
