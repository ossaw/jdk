 ...
 * MXBean, it needs to be able to look up the name under which that MXBean has
...
public class MXBeanLookup {
    ...
    synchronized boolean removeReference(ObjectName name, Object mxbean) {
        if (name.equals(mxbeanToObjectName.get(mxbean))) {
            ...
            return false;
        /*
         * removeReference can be called when the above condition fails, notably
         * if you try to register the same MXBean twice.
         */
    }
