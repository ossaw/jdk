...
/**
 * Fix security hole in ClassLoaderRepository. This class wraps the actual
 * ClassLoaderRepository implementation so that only the methods from
 * {@link javax.management.loading.ClassLoaderRepository} can be accessed
 * (read-only).
 *
 * @since 1.5
 */
final class SecureClassLoaderRepository implements ClassLoaderRepository {
	...
	/**
	 * Creates a new secure ClassLoaderRepository wrapping an unsecure
	 * implementation.
	 * 
	 * @param clr
