...
/**
 * This is the base class for MBean manipulation on the agent side. It contains
 ...
 * {@link #addNotificationListener addNotificationListener} with the
 * <CODE>ObjectName</CODE> of the {@link javax.management.MBeanServerDelegate
 * MBeanServerDelegate}. This <CODE>ObjectName</CODE> is: <BR>
...
public final class JmxMBeanServer implements SunJmxMBeanServer {
	...
	/**
	 * Control the default locking policy of the repository. By default, we will
	 * be using a fair locking policy.
	 **/
	...
	/**
	 * <b>Package:</b> Creates an MBeanServer with the specified default domain
	 * name, outer interface, and delegate.
	 * <p>
	 * The default domain name is used as the domain part in the ObjectName of
	 * MBeans if no domain is specified by the user.
	 * <ul>
	 * <b>Note:</b>Using this constructor directly is strongly discouraged. You
	 * should use
	 ...
	 * {@link #JmxMBeanServer(java.lang.String,javax.management.MBeanServer,javax.management.MBeanServerDelegate,boolean)}
	 * to enable them.
	 * </ul>
	 * 
	 * @param domain
	 ...
	 *            its MBean repository.
	 * @param interceptors
	 *            If <code>true</code>, {@link MBeanServerInterceptor} will be
	 *            enabled (default is <code>false</code>) Note: this parameter
	 *            is not taken into account by this implementation - the default
	 *            value <code>false</code> is always used.
	 * @exception IllegalArgumentException
	 *                if the instantiator is null.
	 */
	JmxMBeanServer(String domain, MBeanServer outer, MBeanServerDelegate delegate,
	 ...
	 * @param metadata
	 *            The MetaData object that will be used by the MBean server in
	 *            order to invoke the MBean interface of the registered MBeans.
	 * @param interceptors
	 *            If <code>true</code>, {@link MBeanServerInterceptor} will be
	 *            enabled (default is <code>false</code>).
	 */
	JmxMBeanServer(String domain, MBeanServer outer, MBeanServerDelegate delegate,
			MBeanInstantiator instantiator, boolean interceptors) {
	 ...
	 *            enabled (default is <code>false</code>).
	 * @param fairLock
	 *            If {@code true}, the MBean repository will use a
	 *            {@link java.util.concurrent.locks.ReentrantReadWriteLock#ReentrantReadWriteLock(boolean)
	 *            fair locking} policy.
	 */
	JmxMBeanServer(String domain, MBeanServer outer, MBeanServerDelegate delegate,
			MBeanInstantiator instantiator, boolean interceptors, boolean fairLock) {
		...
		this.secureClr = new SecureClassLoaderRepository(
		...
		this.mbsInterceptor = new DefaultMBeanServerInterceptor(outer, delegate, instantiator,
				repository);
	 ...
	 * will use its {@link javax.management.loading.ClassLoaderRepository
	 ...
	 * The call returns an <CODE>ObjectInstance</CODE> object representing the
	 * newly created MBean.
	 *
	 * @param className
	 ...
	 *                Wraps an <CODE>
	 *                {@link java.lang.ClassNotFoundException}</CODE> or an
	 ...
	 *                Wraps an <CODE>
	 *                {@link java.lang.IllegalArgumentException}</CODE>: The
	...
	public ObjectInstance createMBean(String className, ObjectName name)
		...
		return mbsInterceptor.createMBean(className, cloneObjectName(name), (Object[]) null,
				(String[]) null);
	}
	 ...
	 * MBeanRegistration} interface. The call returns an
	...
	public ObjectInstance createMBean(String className, ObjectName name, ObjectName loaderName)
		...
		return mbsInterceptor.createMBean(className, cloneObjectName(name), loaderName,
	...
	public ObjectInstance createMBean(String className, ObjectName name, ObjectName loaderName,
		...
		return mbsInterceptor.createMBean(className, cloneObjectName(name), loaderName, params,
				signature);
	}
	 ...
	 * name by implementing the {@link javax.management.MBeanRegistration
	 * MBeanRegistration} interface. The call returns an
	 * <CODE>ObjectInstance</CODE> object representing the registered MBean.
	 *
	 * @param object
	 ...
	 *                Wraps an <CODE>
	 *                {@link java.lang.IllegalArgumentException}</CODE>: The
	 *                object passed in parameter is null or no object name is
	 *                specified.
	 *
	 */
	 ...
	 *            retrieved. If null or or no domain and key properties are
	 ...
	 * names of a set of MBeans specified by pattern matching on the
	 * <CODE>ObjectName</CODE> and/or a Query expression, a specific MBean name
	 * (equivalent to testing whether an MBean is registered). When the object
	 * name is null or or no domain and key properties are specified, all
	 * objects are selected (and filtered if a query is specified). It returns
	 * the set of ObjectNames for the MBeans selected.
	 *
	 * @param name
	 *            The object name pattern identifying the MBeans to be
	 ...
	 *                The MBean specified is not registered in the MBean server.
	 * @exception ReflectionException
	 *                Wraps an <CODE>{@link java.lang.Exception}</CODE> thrown
	 ...
	 *                The MBean specified is not registered in the MBean server.
	 * @exception ReflectionException
	 *                An exception occurred when trying to invoke the
	 *                getAttributes method of a Dynamic MBean.
	 * @exception RuntimeOperationsException
	 *                Wrap an <CODE>
	 *                {@link java.lang.IllegalArgumentException}</CODE>: The
	 *                object name in parameter is null or attributes in
	 *                parameter is null.
	 *
	 */
	 ...
	 *                notification broadcaster does not match any of the
	 *                registered MBeans.
	 */
	...
	public void removeNotificationListener(ObjectName name, NotificationListener listener,
		...
		mbsInterceptor.removeNotificationListener(cloneObjectName(name), listener, filter,
				handback);
	}
	 ...
	 * the MBean server (using its
	 * {@link javax.management.loading.ClassLoaderRepository Default Loader
	 * Repository}). The object's class should have a public constructor. It
	 * returns a reference to the newly created object. The newly created object
	 ...
	 * @exception ReflectionException
	 *                Wraps the <CODE>
	 *                {@link java.lang.ClassNotFoundException}</CODE> or the
	 *                <CODE>{@link java.lang.Exception}</CODE> that occurred
	 *                when trying to invoke the object's constructor.
	 * @exception MBeanException
	 ...
	 * <CODE>ObjectName</CODE>. If the loader name is null, the ClassLoader that
	 ...
	 * the MBean server (using its
	 * {@link javax.management.loading.ClassLoaderRepository Default Loader
	 * Repository}). The object's class should have a public constructor. The
	 * call returns a reference to the newly created object. The newly created
	 ...
	 *                Any of the usual Input/Output related exceptions.
	 * @exception ReflectionException
	 *                The specified class could not be loaded by the default
	 *                loader repository
	 *
	 */
	@Deprecated
	public ObjectInputStream deserialize(String className, byte[] data)
		...
		try {
			...
			throw new ReflectionException(e, "The given class could not be "
	...
	private void initialize() {
		...
		try {
			...
			if (MBEANSERVER_LOGGER.isLoggable(Level.FINEST)) {
				MBEANSERVER_LOGGER.logp(Level.FINEST, JmxMBeanServer.class.getName(), "initialize",
		...
		/*
		 * Add my class loader to the repository This can be null if my class
		 * loader is the bootstrap class loader. The ClassLoaderRepository knows
		 * how to handle that case.
		 */
		ClassLoader myLoader = outerShell.getClass().getClassLoader();
		final ModifiableClassLoaderRepository loaders = AccessController
		...
		if (loaders != null) {
			 ...
			 * loaded by the bootstrap class loader we can still load MBeans
			 * from the classpath using createMBean(className, objectName).
			 * 
			 * If this class (JmxMBeanServer) was not loaded by the system class
			 * loader or a parent of it, then the caller must have
			 * RuntimePermission("getClassLoader") for the
			 * getSystemClassLoader() call to succeed. If the caller does not
			 * have that permission, any call to Class.getClassLoader() will
			 * fail. Since there are lots of those in JMX, we better throw the
			 * exception now.
			 * 
			 * This permission question is irrelevant when JMX is part of J2SE
			 * (as of 1.5).
			 */
	 ...
	 * creating a new MBeanServer the
	 * {@link javax.management.MBeanServerBuilder} first calls this method in
	 * order to create a new MBeanServerDelegate. <br>
	 * Then it calls
	 ...
	 * implementation.
	 * <p>
	 * Note that the passed <var>delegate</var> might not be directly the
	 * MBeanServerDelegate that was returned by this method. It could be, for
	 * instance, a new object wrapping the previously returned object.
	 *
	...
	/**
	 * This method creates a new MBeanServer implementation object. When
	 * creating a new MBeanServer the
	 * {@link javax.management.MBeanServerBuilder} first calls
	 * <code>newMBeanServerDelegate()</code> in order to obtain a new
	 * {@link javax.management.MBeanServerDelegate} for the new MBeanServer.
	 * Then it calls <code>newMBeanServer(defaultDomain,outer,delegate)</code>
	 * passing the <var>delegate</var> that should be used by the MBeanServer
	 * implementation.
	 * <p>
	 * Note that the passed <var>delegate</var> might not be directly the
	 * MBeanServerDelegate that was returned by this implementation. It could
	 * be, for instance, a new object wrapping the previously returned delegate.
	 * <p>
	 * The <var>outer</var> parameter is a pointer to the MBeanServer that
	 * should be passed to the {@link javax.management.MBeanRegistration}
	 * interface when registering MBeans inside the MBeanServer. If
	 * <var>outer</var> is <code>null</code>, then the MBeanServer
	 ...
	 * <p>
	 * This makes it possible for a MBeanServer implementation to wrap another
	 * MBeanServer implementation, in order to implement, e.g, security checks,
	 * or to prevent access to the actual MBeanServer implementation by
	 ...
	 *            its MBean repository.
	 * @param interceptors
	 *            If <code>true</code>, {@link MBeanServerInterceptor}s will be
	 *            enabled (default is <code>false</code>). Note: this parameter
	 *            is not taken into account by this implementation - the default
	 *            value <code>false</code> is always used.
	...
	public static MBeanServer newMBeanServer(String defaultDomain, MBeanServer outer,
		...
		//
		return new JmxMBeanServer(defaultDomain, outer, delegate, null, interceptors, fairLock);
	}
