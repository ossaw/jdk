...
public final class JmxMBeanServer implements SunJmxMBeanServer {
    ...
    JmxMBeanServer(String domain, MBeanServer outer, MBeanServerDelegate delegate,
        ...
        this.secureClr = new SecureClassLoaderRepository(AccessController.doPrivileged(
    ...
    public ObjectInstance createMBean(String className, ObjectName name, ObjectName loaderName)
        ...
        return mbsInterceptor.createMBean(className, cloneObjectName(name), loaderName, (Object[]) null,
                (String[]) null);
    }
    ...
    public ObjectInputStream deserialize(String className, byte[] data) throws OperationsException,
        ...
        try {
            ...
            throw new ReflectionException(e, "The given class could not be " + "loaded by the default loader "
                    + "repository");
        }
    ...
    private void initialize() {
         ...
         */
        ClassLoader myLoader = outerShell.getClass().getClassLoader();
        final ModifiableClassLoaderRepository loaders = AccessController.doPrivileged(
