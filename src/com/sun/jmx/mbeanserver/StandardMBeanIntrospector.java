...
class StandardMBeanIntrospector extends MBeanIntrospector<Method> {
    ...
    @Override
    Object invokeM2(Method m, Object target, Object[] args, Object cookie) throws InvocationTargetException,
    ...
    Descriptor getBasicMBeanDescriptor() {
        /*
         * We don't bother saying mxbean=false, and we can't know whether the
         * info is immutable until we know whether the MBean class (not
         * interface) is a NotificationBroadcaster.
         */
    ...
    /*
     * Return true if and only if we can be sure that the given MBean
     * implementation class has immutable MBeanInfo. A Standard MBean that is a
     * NotificationBroadcaster is allowed to return different values at
     * different times from its getNotificationInfo() method, which is when we
     * might not know if it is immutable. But if it is a subclass of
    ...
    private static final WeakHashMap<Class<?>, Boolean> definitelyImmutable = new WeakHashMap<Class<?>, Boolean>();
