...
/**
 * <p>
 * Defines how types are mapped for a given MXBean or set of MXBeans. An
 * {@code MXBeanMappingFactory} can be specified either through the
 ...
 * add an {@link MXBeanMappingClass} annotation, we could achieve the same
 ...
 * {@code MyLinkedList[]} and {@code List<MyLinkedList>}; the default mapping
