 ...
 * instantiating objects, finding the class given its name and using different
 * class loaders, deserializing objects in the context of a given class loader.
 *
 * @since 1.5
 */
public class MBeanInstantiator {
    ...
    /**
     * This methods tests if the MBean class makes it possible to instantiate an
     * MBean of this class in the MBeanServer. e.g. it must have a public
     * constructor, be a concrete class...
     */
    ...
    /**
     * Loads the class with the specified name using this object's Default
     * Loader Repository.
     **/
    public Class<?> findClassWithDefaultLoaderRepository(String className) throws ReflectionException {
        ...
        if (className == null) {
            throw new RuntimeOperationsException(new IllegalArgumentException(
                    "The class name cannot be null"), "Exception occurred during object instantiation");
        }
    ...
    /**
     * Gets the class for the specified class name using the specified class
     * loader
     */
    public Class<?> findClass(String className, ObjectName aLoader) throws ReflectionException,
            InstanceNotFoundException {

        if (aLoader == null)
            throw new RuntimeOperationsException(new IllegalArgumentException(),
                    "Null loader passed in parameter");
    ...
    public ObjectInputStream deserialize(ClassLoader loader, byte[] data) throws OperationsException {
        ...
        if (data == null) {
            throw new RuntimeOperationsException(new IllegalArgumentException(),
                    "Null data passed in parameter");
        }
        if (data.length == 0) {
            throw new RuntimeOperationsException(new IllegalArgumentException(),
                    "Empty data passed in parameter");
        }
     ...
     * is specified. If null, a default one has to be provided (for a MBean
    ...
    public ObjectInputStream deserialize(String className, ObjectName loaderName, byte[] data,
            ClassLoader loader) throws InstanceNotFoundException, OperationsException, ReflectionException {
        ...
        if (loaderName == null) {
            ...
            try {
                ...
                throw new ReflectionException(e, "The MBean class could not be loaded by the " + loaderName
                        .toString() + " class loader");
            }
        }
     ...
     * the MBean Interceptor (using its
     ...
     * <P>
     * If the loader name is null, a default one has to be provided (for a MBean
     * Server, the ClassLoader that loaded it will be used).
     * <P>
     * The object's class should have a public constructor.
     * <P>
     * It returns a reference to the newly created object.
     ...
     * object name.
     * <P>
     * If the object name of the loader is null, a default has to be provided
     * (for example, for a MBean Server, the ClassLoader that loaded it will be
     * used).
     * <P>
     * The object's class should have a public constructor.
     * <P>
    ...
    public Object instantiate(String className, ObjectName loaderName, Object params[], String signature[],
            ClassLoader loader) throws ReflectionException, MBeanException, InstanceNotFoundException {
    ...
    static {
        for (Class<?> c : new Class<?>[] { byte.class, short.class, int.class, long.class, float.class,
