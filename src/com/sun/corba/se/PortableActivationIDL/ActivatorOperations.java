...
/**
 * com/sun/corba/se/PortableActivationIDL/ActivatorOperations.java . Generated
...
public interface ActivatorOperations {
	...
	/**
	 * A server is shutting down that was started by this activator. Complete
	 * termination of the server is detected by the death of the process
	 ...
	 * endpoints and the ORB proxy callback object. Note that we cannot detect
	...
	/**
	 * Construct or find an ORBD object template corresponding to the server's
	 ...
	 */
	void poaDestroyed(String serverId, String orbId,
			org.omg.PortableInterceptor.ObjectReferenceTemplate poaTemplate);
	...
	/**
	 * Invoke the server uninstall hook. If the server is not currently running,
