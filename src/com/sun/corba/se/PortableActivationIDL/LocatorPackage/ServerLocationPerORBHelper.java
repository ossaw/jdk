 ...
 * ServerLocationPerORBHelper.java . Generated by the IDL-to-Java compiler
...
abstract public class ServerLocationPerORBHelper {
	...
	public static void insert(org.omg.CORBA.Any a,
			com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB that) {
	...
	public static com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB extract(
			org.omg.CORBA.Any a) {
			...
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					_members0[0] = new org.omg.CORBA.StructMember("hostname",
							_tcOf_members0, null);
					_tcOf_members0 = com.sun.corba.se.PortableActivationIDL.EndPointInfoHelper
							.type();
					...
					_tcOf_members0 = org.omg.CORBA.ORB.init().create_alias_tc(
							com.sun.corba.se.PortableActivationIDL.EndpointInfoListHelper
									.id(), "EndpointInfoList", _tcOf_members0);
					...
					__typeCode = org.omg.CORBA.ORB.init().create_struct_tc(
							com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORBHelper
									.id(), "ServerLocationPerORB", _members0);
					__active = false;
				}
			}
		}
	...
	public static com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB read(
		...
		value.ports = com.sun.corba.se.PortableActivationIDL.EndpointInfoListHelper
				.read(istream);
		return value;
	}

	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB value) {
