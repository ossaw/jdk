...
abstract public class ServerDefHelper {
	...
	public static void insert(org.omg.CORBA.Any a,
			com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDef that) {
	...
	public static com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDef extract(
			org.omg.CORBA.Any a) {
		...
		if (__typeCode == null) {
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					_members0[0] = new org.omg.CORBA.StructMember("applicationName", _tcOf_members0,
							null);
					_tcOf_members0 = org.omg.CORBA.ORB.init().create_string_tc(0);
					_members0[1] = new org.omg.CORBA.StructMember("serverName", _tcOf_members0,
							null);
					_tcOf_members0 = org.omg.CORBA.ORB.init().create_string_tc(0);
					_members0[2] = new org.omg.CORBA.StructMember("serverClassPath", _tcOf_members0,
							null);
					_tcOf_members0 = org.omg.CORBA.ORB.init().create_string_tc(0);
					_members0[3] = new org.omg.CORBA.StructMember("serverArgs", _tcOf_members0,
							null);
					_tcOf_members0 = org.omg.CORBA.ORB.init().create_string_tc(0);
					_members0[4] = new org.omg.CORBA.StructMember("serverVmArgs", _tcOf_members0,
							null);
					_tcOf_members0 = org.omg.CORBA.ORB.init()
							.get_primitive_tc(org.omg.CORBA.TCKind.tk_boolean);
					_members0[5] = new org.omg.CORBA.StructMember("isInstalled", _tcOf_members0,
							null);
	...
	public static com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDef read(
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDef value) {
