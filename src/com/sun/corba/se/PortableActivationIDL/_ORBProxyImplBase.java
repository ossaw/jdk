 ...
 */
public abstract class _ORBProxyImplBase extends org.omg.CORBA.portable.ObjectImpl implements
        com.sun.corba.se.PortableActivationIDL.ORBProxy, org.omg.CORBA.portable.InvokeHandler {
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String $method, org.omg.CORBA.portable.InputStream in,
        ...
        switch (__method.intValue()) {
            ...
            /**
             * Method used to cause ORB to activate the named adapter, if
             * possible.
             * This will cause the named POA to register itself with the
             * activator
             * as a side effect. This should always happen before this call can
             * complete. This method returns true if adapter activation
             * succeeded,
