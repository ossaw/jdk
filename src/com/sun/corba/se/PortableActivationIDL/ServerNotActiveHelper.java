...
/**
 * com/sun/corba/se/PortableActivationIDL/ServerNotActiveHelper.java . Generated
...
abstract public class ServerNotActiveHelper {
    ...
    public static void insert(org.omg.CORBA.Any a,
            com.sun.corba.se.PortableActivationIDL.ServerNotActive that) {
    ...
    public static com.sun.corba.se.PortableActivationIDL.ServerNotActive extract(
            org.omg.CORBA.Any a) {
            ...
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    _tcOf_members0 = org.omg.CORBA.ORB.init().create_alias_tc(
                            ...
                            "ServerId", _tcOf_members0);
                    _members0[0] = new org.omg.CORBA.StructMember("serverId",
                            _tcOf_members0, null);
                    __typeCode = org.omg.CORBA.ORB.init().create_exception_tc(
                            com.sun.corba.se.PortableActivationIDL.ServerNotActiveHelper
                                    .id(), "ServerNotActive", _members0);
                    __active = false;
                }
            }
        }
    ...
    public static com.sun.corba.se.PortableActivationIDL.ServerNotActive read(
    ...
    public static void write(org.omg.CORBA.portable.OutputStream ostream,
            com.sun.corba.se.PortableActivationIDL.ServerNotActive value) {
