...
abstract public class ServerProxyHelper {
	...
	public static void insert(org.omg.CORBA.Any a,
			com.sun.corba.se.PortableActivationIDL.ServerProxy that) {
	...
	public static com.sun.corba.se.PortableActivationIDL.ServerProxy extract(
			org.omg.CORBA.Any a) {
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			__typeCode = org.omg.CORBA.ORB.init().create_interface_tc(
					com.sun.corba.se.PortableActivationIDL.ServerProxyHelper
							.id(), "ServerProxy");
		}
		return __typeCode;
	}
	...
	public static com.sun.corba.se.PortableActivationIDL.ServerProxy read(
			org.omg.CORBA.portable.InputStream istream) {
		return narrow(istream.read_Object(_ServerProxyStub.class));
	}

	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			com.sun.corba.se.PortableActivationIDL.ServerProxy value) {
		ostream.write_Object((org.omg.CORBA.Object) value);
	}

	public static com.sun.corba.se.PortableActivationIDL.ServerProxy narrow(
	...
	public static com.sun.corba.se.PortableActivationIDL.ServerProxy unchecked_narrow(
			org.omg.CORBA.Object obj) {
		if (obj == null)
			return null;
		else if (obj instanceof com.sun.corba.se.PortableActivationIDL.ServerProxy)
