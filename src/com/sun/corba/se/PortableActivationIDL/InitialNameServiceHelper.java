...
abstract public class InitialNameServiceHelper {
	...
	public static void insert(org.omg.CORBA.Any a,
			com.sun.corba.se.PortableActivationIDL.InitialNameService that) {
	...
	public static com.sun.corba.se.PortableActivationIDL.InitialNameService extract(
			org.omg.CORBA.Any a) {
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			__typeCode = org.omg.CORBA.ORB.init().create_interface_tc(
					com.sun.corba.se.PortableActivationIDL.InitialNameServiceHelper.id(),
					"InitialNameService");
		}
		return __typeCode;
	}
	...
	public static com.sun.corba.se.PortableActivationIDL.InitialNameService read(
			org.omg.CORBA.portable.InputStream istream) {
		return narrow(istream.read_Object(_InitialNameServiceStub.class));
	}

	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			com.sun.corba.se.PortableActivationIDL.InitialNameService value) {
		ostream.write_Object((org.omg.CORBA.Object) value);
	}

	public static com.sun.corba.se.PortableActivationIDL.InitialNameService narrow(
	...
	public static com.sun.corba.se.PortableActivationIDL.InitialNameService unchecked_narrow(
			org.omg.CORBA.Object obj) {
		if (obj == null)
			return null;
		else if (obj instanceof com.sun.corba.se.PortableActivationIDL.InitialNameService)
