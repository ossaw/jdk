...
/**
 * Type of TCP port number, used in structures that describe transport
 * endpoints. The valid range is actually 0-65535, but we use a long here to
 * avoid signed/unsigned conversion headaches in Java.
 */
