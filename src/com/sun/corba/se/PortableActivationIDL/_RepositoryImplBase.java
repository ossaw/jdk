...
/**
 * com/sun/corba/se/PortableActivationIDL/_RepositoryImplBase.java . Generated
...
public abstract class _RepositoryImplBase extends org.omg.CORBA.portable.ObjectImpl implements
		com.sun.corba.se.PortableActivationIDL.Repository, org.omg.CORBA.portable.InvokeHandler {
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String $method,
		...
		/**
		 * register server definition. This returns the serverId of the server.
		 * A newly created server is always uninstalled.
		 */
		case 0: // PortableActivationIDL/Repository/registerServer
		{
			try {
				com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDef serverDef = com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDefHelper
						.read(in);
				String $result = null;
				...
				com.sun.corba.se.PortableActivationIDL.ServerAlreadyRegisteredHelper.write(out,
						$ex);
		...
		case 2: // PortableActivationIDL/Repository/getServer
		{
			try {
				...
				out = $rh.createReply();
				com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDefHelper.write(out,
						$result);
			} catch (com.sun.corba.se.PortableActivationIDL.ServerNotRegistered $ex) {
				out = $rh.createExceptionReply();
				com.sun.corba.se.PortableActivationIDL.ServerNotRegisteredHelper.write(out, $ex);
		...
		/**
		 * Mark the server as being installed. Raises ServerAlreadyInstalled if
		 * the server is currently marked as installed.
		 */
		...
		case 5: // PortableActivationIDL/Repository/uninstall
		{
			try {
				...
				out = $rh.createExceptionReply();
				com.sun.corba.se.PortableActivationIDL.ServerAlreadyUninstalledHelper.write(out,
						$ex);
			}
			break;
		}
		...
		/**
		 * Returns list of ALL applicationNames defined in ServerDefs of
		 * registered servers.
		 */
		case 7: // PortableActivationIDL/Repository/getApplicationNames
		{
			...
			out = $rh.createReply();
			com.sun.corba.se.PortableActivationIDL.RepositoryPackage.AppNamesHelper.write(out,
					$result);
			break;
		}
