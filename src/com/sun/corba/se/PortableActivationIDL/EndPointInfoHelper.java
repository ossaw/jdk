...
/**
 * com/sun/corba/se/PortableActivationIDL/EndPointInfoHelper.java . Generated by
        ...
        if (__typeCode == null) {
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    _members0[0] = new org.omg.CORBA.StructMember("endpointType", _tcOf_members0, null);
                    ...
                    __typeCode = org.omg.CORBA.ORB.init().create_struct_tc(
                            com.sun.corba.se.PortableActivationIDL.EndPointInfoHelper.id(), "EndPointInfo",
                            _members0);
                    __active = false;
                }
            }
