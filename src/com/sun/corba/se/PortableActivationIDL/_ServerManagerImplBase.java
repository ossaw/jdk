 ...
 * implementation.
 */
public abstract class _ServerManagerImplBase extends
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String $method,
        ...
        switch (__method.intValue()) {
            ...
            case 0: // PortableActivationIDL/Activator/registerServer
            {
                try {
                    String serverId = org.omg.PortableInterceptor.ServerIdHelper
                            .read(in);
                    com.sun.corba.se.PortableActivationIDL.ServerProxy serverObj = com.sun.corba.se.PortableActivationIDL.ServerProxyHelper
                            .read(in);
             ...
             * Complete termination of the server is detected by the death of
             * the
            ...
            /**
             * Called whenever an ORB instance is created. This registers the
             * transport endpoints and the ORB proxy callback object. Note that
             * we
             * cannot detect when an ORB shuts down, although all of the POA
             * shutdowns should still be reported.
             */
            case 2: // PortableActivationIDL/Activator/registerORB
            {
                try {
                    ...
                    String orbId = org.omg.PortableInterceptor.ORBIdHelper.read(
                            in);
                    com.sun.corba.se.PortableActivationIDL.ORBProxy orb = com.sun.corba.se.PortableActivationIDL.ORBProxyHelper
                            .read(in);
                    com.sun.corba.se.PortableActivationIDL.EndPointInfo endPointInfo[] = com.sun.corba.se.PortableActivationIDL.EndpointInfoListHelper
                            .read(in);
            ...
            case 3: // PortableActivationIDL/Activator/registerPOA
            {
                ...
                org.omg.PortableInterceptor.ObjectReferenceTemplate poaTemplate = org.omg.PortableInterceptor.ObjectReferenceTemplateHelper
                        .read(in);
             ...
             * whether or
             * not the server has been installed.
             */
            ...
            /**
             * Invoke the server install hook. If the server is not currently
             * running, this method will activate it.
             */
            ...
            /**
             * Invoke the server uninstall hook. If the server is not currently
             * running, this method will activate it. After this hook completes,
             * the
            ...
            case 10: // PortableActivationIDL/Activator/getORBNames
            {
                try {
                    ...
                    out = $rh.createReply();
                    com.sun.corba.se.PortableActivationIDL.ORBidListHelper
                            .write(out, $result);
                } catch (com.sun.corba.se.PortableActivationIDL.ServerNotRegistered $ex) {
                    out = $rh.createExceptionReply();
                    com.sun.corba.se.PortableActivationIDL.ServerNotRegisteredHelper
            ...
            /**
             * Find the server template that corresponds to the ORBD's adapter
             * id.
             */
            case 11: // PortableActivationIDL/Activator/lookupPOATemplate
            {
                String serverId = org.omg.PortableInterceptor.ServerIdHelper
                        .read(in);
                String orbId = org.omg.PortableInterceptor.ORBIdHelper.read(in);
                String orbAdapterName[] = org.omg.PortableInterceptor.AdapterNameHelper
                        .read(in);
                org.omg.PortableInterceptor.ObjectReferenceTemplate $result = null;
                $result = this.lookupPOATemplate(serverId, orbId,
                        orbAdapterName);
                out = $rh.createReply();
                org.omg.PortableInterceptor.ObjectReferenceTemplateHelper.write(
                        out, $result);
            ...
            /**
             * locate server - returns the port with a specific type for all
             * registered ORBs of an active server. Starts the server if it is
             * not
             * already running.
             */
            ...
            /**
             * locate server - returns all ports registered with a specified ORB
             * for
             * an active server Starts the server if it is not already running.
             */
            ...
            /**
             * Useful from external BadServerIdHandlers which need to pick a
             * particular port type.
             */
            case 15: // PortableActivationIDL/Locator/getServerPortForType
            {
                try {
                    com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB location = com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORBHelper
                            .read(in);
                    String endPointType = in.read_string();
                    int $result = (int) 0;
