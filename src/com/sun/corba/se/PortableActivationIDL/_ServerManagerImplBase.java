 ...
 * implementation.
 */
public abstract class _ServerManagerImplBase extends org.omg.CORBA.portable.ObjectImpl implements
		com.sun.corba.se.PortableActivationIDL.ServerManager, org.omg.CORBA.portable.InvokeHandler {
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String $method,
		 ...
		 * transport endpoints and the ORB proxy callback object. Note that we
		 ...
		 * server's object template and return it. Called whenever a persistent
		 * POA is created.
		 */
		...
		/**
		 * If the server is not running, start it up. This is allowed whether or
		 ...
		 * running, this method will activate it. After this hook completes, the
		 ...
		 * registered ORBs of an active server. Starts the server if it is not
		 * already running.
		 */
