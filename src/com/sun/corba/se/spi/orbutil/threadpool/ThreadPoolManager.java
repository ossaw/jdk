...
public interface ThreadPoolManager extends Closeable {
     ...
     * threadpoolId. This method will be used by the ORB to support the
     ...
     * String threadpoolId. This is used by the POA interceptors to add the
     * numeric threadpool Id, as a tagged component in the IOR. This is used to
     * provide the functionality of dedicated threadpool for EJB beans
     */
    ...
    /**
     * Return an instance of ThreadPoolChooser based on the componentIndex that
     * was passed as argument. This is added for improved performance so that
     * the caller does not have to pay the cost of computing hashcode for the
     * componentId
     */
    public ThreadPoolChooser getThreadPoolChooser(int componentIndex);

    /**
     * Sets a ThreadPoolChooser for a particular componentId in the
