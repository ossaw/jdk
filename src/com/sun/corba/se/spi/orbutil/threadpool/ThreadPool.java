...
public interface ThreadPool extends Closeable {
	 ...
	 * instance only services one WorkQueue then that WorkQueue instance will be
	 * returned. If there are more than one WorkQueues serviced by this
	 ...
	 * would return a WorkQueue in a roundrobin fashion everytime this method is
	 * called. In the future we could allow pluggability of Policy objects for
	 * this.
	 */
	 ...
	 * queueId. This will be useful in situations where there are more than one
	 * WorkQueues managed by the ThreadPool and the user of the ThreadPool wants
	 * to always use the same WorkQueue for doing the Work. If the number of
	...
	/**
	 * This method will return the maximum number of threads in the threadpool
	 * at any point in time, for the life of the threadpool
	 */
	public int maximumNumberOfThreads();

	/**
	 * This method will return the time in milliseconds when idle threads in the
	 * threadpool are removed.
	 */
	 ...
	 * which are waiting for work. This method returns a value which is not
	 * synchronized.
	 */
	public int numberOfAvailableThreads();

	/**
	 * This method will return the number of busy threads in the threadpool This
