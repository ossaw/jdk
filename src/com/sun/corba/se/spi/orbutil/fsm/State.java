...
/**
 * This interface must be implemented by any class that is used as a state in a
 * FSM. The FSM only needs the identity of this object, so all that is really
 * needs is the default equals implementation. The toString() method should also
 * be overridden to give a concise description or name of the state. The
 * StateImpl class handles this.
 * <P>
...
public interface State {
	...
	/**
	 * Method that defines action that occurs whenever this state is exited. Any
	 * exceptions thrown by this method are ignored.
	 */
