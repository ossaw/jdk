 ...
 *         </p>
 *         <p>
 *         This is used for getting the default factories for MonitoredObject,
 *         MonitoredAttributeInfo and MonitoringManager. We do not expect users
 *         to use the MonitoredAttributeInfo factory most of the time because
 *         the Info is automatically built by StringMonitoredAttributeBase and
...
public class MonitoringFactories {
	...
	/**
	 * <p>
	 * Gets the MonitoredAttributeInfoFactory. The user is not expected to use
	 * this Factory, since the MonitoredAttributeInfo is internally created by
	 ...
	 * build a DoubleMonitoredAttributeBase like LongMonitoredAttributeBase and
	 * build a MonitoredAttributeInfo required by MonitoredAttributeBase
