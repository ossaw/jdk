 ...
 *         </p>
 *         <p>
 *         StatisticsMonitoredAttribute is provided as a convenience to collect
 *         the Statistics of any entity. The getValue() call will be delegated
 *         to the StatisticsAccumulator set by the user.
 *         </p>
 */
public class StatisticMonitoredAttribute extends MonitoredAttributeBase {
	 ...
	 * MonitoredAttributeInfo with Long as the class type and is always readonly
	 * attribute.
	 * </p>
	 * <p>
	 *
	 ...
	 *            will Provide the detailed stats based on the samples provided
	 ...
	 *            </p>
	 */
	public StatisticMonitoredAttribute(String name, String desc, StatisticsAccumulator s,
			Object mutex) {
		super(name);
		MonitoredAttributeInfoFactory f = MonitoringFactories.getMonitoredAttributeInfoFactory();
		MonitoredAttributeInfo maInfo = f.createMonitoredAttributeInfo(desc, String.class, false,
				true);
	...
	/**
	 * Gets the value from the StatisticsAccumulator, the value will be a
	 * formatted String with the computed statistics based on the samples
	 * accumulated in the Statistics Accumulator.
	 */
	...
	/**
	 * Clears the state on Statistics Accumulator, After this call all samples
	 * are treated fresh and the old sample computations are disregarded.
	 */
	...
	/**
	 * Gets the statistics accumulator associated with
	 * StatisticMonitoredAttribute. Usually, the user don't need to use this
	 * method as they can keep the handle to Accumulator to collect the samples.
	 */
