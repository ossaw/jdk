...
public class ServiceContexts {
    ...
    /**
     * Hopefully unused scid: This should be changed to a proper VMCID aligned
     * value. REVISIT!
     */
    ...
    /**
     * Write the service contexts in scMap in a desired order. Right now, the
     * only special case we have is UnknownExceptionInfo, so I'm merely writing
     * it last if present.
     */
    ...
    /**
     * Write the given entry from the scMap to the OutputStream. See note on
    ...
    /**
     * Add a service context to the stream, if there is not already a service
     * context in this object with the same id as sc.
     */
     ...
     * UnknownExceptionInfo service context after the SendingContextRunTime
     * service context so that we can get the CodeBase if necessary.
     */
    private Map scMap;
