...
public class ServiceContextData {
	...
	/**
	 * Factory method used to create a ServiceContext object by unmarshalling it
	...
	public ServiceContext makeServiceContext(InputStream is, GIOPVersion gv) {
		...
		try {
			...
			throwBadParam("InputStream constructor threw exception " + ite.getTargetException(),
					ite);
		}
	...
	public String toString() {
		return "ServiceContextData[ scClass=" + scClass + " scConstructor=" + scConstructor
				+ " scId=" + scId + " ]";
	}
