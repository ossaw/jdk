...
public class ServiceContextRegistry {
    ...
    /**
     * Register the ServiceContext class so that it will be recognized by the
     * read method. Class cls must have the following properties:
     * <ul>
     * <li>It must derive from
     * com.sun.corba.se.spi.servicecontext.ServiceContext.</li>
     * <li>It must have a public static final int SERVICE_CONTEXT_ID member.
     * </li>
