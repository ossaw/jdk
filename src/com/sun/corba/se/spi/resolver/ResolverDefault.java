...
/**
 * Utility class that provides factory methods for all of the standard resolvers
 * that we provide.
 */
public class ResolverDefault {
	...
	/**
	 * Return a resolver that uses the proprietary bootstrap protocol to
	...
	/**
	 * Return a resolver composed of the two given resolvers. result.list() is
	 * the union of first.list() and second.list(). result.resolve( name )
