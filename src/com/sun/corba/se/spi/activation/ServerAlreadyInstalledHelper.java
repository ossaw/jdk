...
/**
 * com/sun/corba/se/spi/activation/ServerAlreadyInstalledHelper.java . Generated
...
abstract public class ServerAlreadyInstalledHelper {
	...
	public static void insert(org.omg.CORBA.Any a,
			com.sun.corba.se.spi.activation.ServerAlreadyInstalled that) {
	...
	public static com.sun.corba.se.spi.activation.ServerAlreadyInstalled extract(
			org.omg.CORBA.Any a) {
			...
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					_tcOf_members0 = org.omg.CORBA.ORB.init().create_alias_tc(
							com.sun.corba.se.spi.activation.ServerIdHelper.id(), "ServerId",
							_tcOf_members0);
					...
					__typeCode = org.omg.CORBA.ORB.init().create_exception_tc(
							com.sun.corba.se.spi.activation.ServerAlreadyInstalledHelper.id(),
							"ServerAlreadyInstalled", _members0);
					__active = false;
				}
			}
		}
	...
	public static com.sun.corba.se.spi.activation.ServerAlreadyInstalled read(
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			com.sun.corba.se.spi.activation.ServerAlreadyInstalled value) {
