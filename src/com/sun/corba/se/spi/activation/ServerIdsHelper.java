...
/**
 * com/sun/corba/se/spi/activation/ServerIdsHelper.java . Generated by the
...
abstract public class ServerIdsHelper {
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			...
			__typeCode = org.omg.CORBA.ORB.init().create_sequence_tc(0,
					__typeCode);
			__typeCode = org.omg.CORBA.ORB.init().create_alias_tc(
					com.sun.corba.se.spi.activation.ServerIdsHelper.id(),
	...
	public static int[] read(org.omg.CORBA.portable.InputStream istream) {
		...
		for (int _o1 = 0; _o1 < value.length; ++_o1)
			value[_o1] = com.sun.corba.se.spi.activation.ServerIdHelper.read(
					istream);
		return value;
	}
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream,
		...
		for (int _i0 = 0; _i0 < value.length; ++_i0)
			com.sun.corba.se.spi.activation.ServerIdHelper.write(ostream,
					value[_i0]);
	}
