...
/**
 * com/sun/corba/se/spi/activation/ActivatorHelper.java . Generated by the
...
abstract public class ActivatorHelper {
	...
	public static void insert(org.omg.CORBA.Any a,
			com.sun.corba.se.spi.activation.Activator that) {
	...
	public static com.sun.corba.se.spi.activation.Activator extract(
			org.omg.CORBA.Any a) {
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			__typeCode = org.omg.CORBA.ORB.init().create_interface_tc(
					com.sun.corba.se.spi.activation.ActivatorHelper.id(),
					"Activator");
		}
		return __typeCode;
	}
	...
	public static com.sun.corba.se.spi.activation.Activator read(
			org.omg.CORBA.portable.InputStream istream) {
		return narrow(istream.read_Object(_ActivatorStub.class));
	}

	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			com.sun.corba.se.spi.activation.Activator value) {
		ostream.write_Object((org.omg.CORBA.Object) value);
	}

	public static com.sun.corba.se.spi.activation.Activator narrow(
	...
	public static com.sun.corba.se.spi.activation.Activator unchecked_narrow(
			org.omg.CORBA.Object obj) {
		if (obj == null)
			return null;
		else if (obj instanceof com.sun.corba.se.spi.activation.Activator)
