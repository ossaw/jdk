...
/**
 * com/sun/corba/se/spi/activation/ActivatorOperations.java . Generated by the
...
public interface ActivatorOperations {
    ...
    void active(int serverId, com.sun.corba.se.spi.activation.Server serverObj)
            throws com.sun.corba.se.spi.activation.ServerNotRegistered;

    // Install a particular kind of endpoint
    void registerEndpoints(int serverId, String orbId,
