 ...
 * java . Generated by the IDL-to-Java compiler (portable), version "3.2" from
...
abstract public class ServerLocationPerORBHelper {
	...
	public static void insert(org.omg.CORBA.Any a,
			com.sun.corba.se.spi.activation.LocatorPackage.ServerLocationPerORB that) {
	...
	public static com.sun.corba.se.spi.activation.LocatorPackage.ServerLocationPerORB extract(
			org.omg.CORBA.Any a) {
			...
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					_members0[0] = new org.omg.CORBA.StructMember("hostname",
							_tcOf_members0, null);
					_tcOf_members0 = com.sun.corba.se.spi.activation.EndPointInfoHelper
							.type();
	...
	public static com.sun.corba.se.spi.activation.LocatorPackage.ServerLocationPerORB read(
		...
		value.ports = com.sun.corba.se.spi.activation.EndpointInfoListHelper
				.read(istream);
		return value;
	}

	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			com.sun.corba.se.spi.activation.LocatorPackage.ServerLocationPerORB value) {
		ostream.write_string(value.hostname);
		com.sun.corba.se.spi.activation.EndpointInfoListHelper.write(ostream,
				value.ports);
	}
