...
/**
 * com/sun/corba/se/spi/activation/ServerManagerHelper.java . Generated by the
...
abstract public class ServerManagerHelper {
	...
	public static void insert(org.omg.CORBA.Any a,
			com.sun.corba.se.spi.activation.ServerManager that) {
	...
	public static com.sun.corba.se.spi.activation.ServerManager extract(
			org.omg.CORBA.Any a) {
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			__typeCode = org.omg.CORBA.ORB.init().create_interface_tc(
					com.sun.corba.se.spi.activation.ServerManagerHelper.id(),
					"ServerManager");
		}
		return __typeCode;
	}
	...
	public static com.sun.corba.se.spi.activation.ServerManager read(
			org.omg.CORBA.portable.InputStream istream) {
		return narrow(istream.read_Object(_ServerManagerStub.class));
	}

	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			com.sun.corba.se.spi.activation.ServerManager value) {
		ostream.write_Object((org.omg.CORBA.Object) value);
	}

	public static com.sun.corba.se.spi.activation.ServerManager narrow(
	...
	public static com.sun.corba.se.spi.activation.ServerManager unchecked_narrow(
			org.omg.CORBA.Object obj) {
		if (obj == null)
			return null;
		else if (obj instanceof com.sun.corba.se.spi.activation.ServerManager)
