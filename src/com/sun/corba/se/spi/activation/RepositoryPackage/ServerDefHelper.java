...
abstract public class ServerDefHelper {
	...
	public static void insert(org.omg.CORBA.Any a,
			com.sun.corba.se.spi.activation.RepositoryPackage.ServerDef that) {
	...
	public static com.sun.corba.se.spi.activation.RepositoryPackage.ServerDef extract(
			org.omg.CORBA.Any a) {
			...
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					__typeCode = org.omg.CORBA.ORB.init().create_struct_tc(
							com.sun.corba.se.spi.activation.RepositoryPackage.ServerDefHelper.id(),
							"ServerDef", _members0);
					__active = false;
				}
			}
	...
	public static com.sun.corba.se.spi.activation.RepositoryPackage.ServerDef read(
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			com.sun.corba.se.spi.activation.RepositoryPackage.ServerDef value) {
