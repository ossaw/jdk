...
/**
 * com/sun/corba/se/spi/activation/ORBAlreadyRegisteredHelper.java . Generated
...
abstract public class ORBAlreadyRegisteredHelper {
	...
	public static void insert(org.omg.CORBA.Any a,
			com.sun.corba.se.spi.activation.ORBAlreadyRegistered that) {
	...
	public static com.sun.corba.se.spi.activation.ORBAlreadyRegistered extract(
			org.omg.CORBA.Any a) {
			...
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					_tcOf_members0 = org.omg.CORBA.ORB.init().create_alias_tc(
							com.sun.corba.se.spi.activation.ORBidHelper.id(),
					...
					__typeCode = org.omg.CORBA.ORB.init().create_exception_tc(
							com.sun.corba.se.spi.activation.ORBAlreadyRegisteredHelper
	...
	public static com.sun.corba.se.spi.activation.ORBAlreadyRegistered read(
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			com.sun.corba.se.spi.activation.ORBAlreadyRegistered value) {
