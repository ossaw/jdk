...
/**
 * An ObjectKeyTemplate represents the part of an Object Key that corresponds to
 * the object adapter used to create an object reference. The template is shared
