...
/**
 * IIOPProfile represents an IIOP tagged profile. It is essentially composed of
 * an object identifier and a template. The template contains all of the IIOP
 * specific information in the profile. Templates are frequently shared between
 * many different profiles, while the object identifiy is unique to each
 * profile.
 */
