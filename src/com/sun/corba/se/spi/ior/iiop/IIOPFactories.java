 ...
 * components. This includes direct construction of profiles and templates, as
 * well as constructing factories that can be registered with an
    ...
    public static IdentifiableFactory makeAlternateIIOPAddressComponentFactory() {
        return new EncapsulationFactoryBase(TAG_ALTERNATE_IIOP_ADDRESS.value) {
            public Identifiable readContents(InputStream in) {
                ...
                Identifiable comp = new AlternateIIOPAddressComponentImpl(addr);
                return comp;
            }
        };
    }
