...
/**
 * TaggedProfile represents a tagged profile in an IOR. A profile contains all
 * of the information necessary for an invocation. It contains one or more
 * endpoints that may be used for an invocation. A TaggedProfile conceptually
 * has three parts: A TaggedProfileTemplate, an ObjectKeyTemplate, and an
 * ObjectId.
 */
