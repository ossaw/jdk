 ...
 * It is also used for the ServantObject that is returned by _servant_preinvoke
 * calls. This allows us to avoid allocating an extra object on each collocated
 * invocation.
 */
