...
public abstract class CopyobjectDefaults {
	 ...
	 * differently than the others: each ObjectCopier produced by the factory
	 * only preserves aliasing within a single call to copy. The others copiers
	 ...
	 * instances of a fallback copier that first tries an ObjectCopier created
