...
/**
 * Manager of ObjectCopier implementations used to support
 * javax.rmi.CORBA.Util.copyObject(s). This provides simple methods for
 * registering all supported ObjectCopier factories. A default copier is also
