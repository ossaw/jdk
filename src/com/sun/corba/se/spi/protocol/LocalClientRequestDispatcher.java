...
public interface LocalClientRequestDispatcher {
	 ...
	 * request. servant_preinvoke() is invoked by a local stub. If a
	 * ServantObject object is returned, then its servant field has been set to
	 * an object of the expected type (Note: the object may or may not be the
	 * actual servant instance). The local stub may cast the servant field to
	 ...
	 *
	 * @param operation
	 *            a string containing the operation name. The operation name
	 *            corresponds to the operation name as it would be encoded in a
	 *            GIOP request.
	 *
	 * @param expectedType
	 *            a Class object representing the expected type of the servant.
	 *            The expected type is the Class object associated with the
	 *            operations class of the stub's interface (e.g. A stub for an
