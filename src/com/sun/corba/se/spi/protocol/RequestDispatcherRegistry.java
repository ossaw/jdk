 ...
 * ServerRequestDispatcher, and ObjectAdapterFactory.
 */
public interface RequestDispatcherRegistry {

	/**
	 * Register a ClientRequestDispatcher for a particular subcontract ID. The
	 * subcontract ID appears in the ObjectKey of an object reference, and is
	 * used to control how a remote method invocation is processed by the ORB
	 * for a particular kind of object reference.
	 */
	 ...
	 * The subcontract ID appears in the ObjectKey of an object reference, and
	...
	/**
	 * Register a CorbaServerRequestDispatcher for handling an explicit object
	...
	/**
	 * Register an ObjectAdapterFactory for a particular subcontract ID. This
	 * controls how Object references are created and managed.
	 */
