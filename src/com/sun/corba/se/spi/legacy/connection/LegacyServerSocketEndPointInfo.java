...
public interface LegacyServerSocketEndPointInfo {
	...
	/**
	 * Get the host name of this end point. Subcontracts must use this instead
	 * of InetAddress.getHostName() because this would take into account the
	 * value of the ORBServerHost property.
	 */
	...
	/**
	 * The ORBD's proxy port of this end point. Note: Pre-ORT "port-exchange"
	 * model.
	 */
