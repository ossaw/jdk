 ...
 * implementation. The BootstrapServer makes all object references defined in a
 * configurable file available using the old naming bootstrap protocol.
 */
public class BootstrapServer {
    private ORB orb;

    /**
     * Main startup routine for the bootstrap server. It first determines the
     * port on which to listen, checks that the specified file is available, and
     * then creates the resolver that will be used to service the requests in
