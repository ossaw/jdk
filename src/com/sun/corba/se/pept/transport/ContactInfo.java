...
public interface ContactInfo {
    /**
     * The {@link com.sun.corba.se.pept.broker.Broker Broker} associated with an
     * invocation.
     *
    ...
    /**
     * The parent {@link com.sun.corba.se.pept.broker.ContactInfoList
     * ContactInfoList} for this <code>ContactInfo</code>.
     *
     * @return {@link com.sun.corba.se.pept.broker.ContactInfoList
     *         ContactInfoList}
     */
     ...
     * ClientRequestDispatcher} used to handle the specific <em>protocol</em>
     * represented by this <code>ContactInfo</code>.
     *
     * @return {@link com.sun.corba.se.pept.protocol.ClientRequestDispatcher
     ...
     * given by <code>getConnectionCacheType</code>.
     *
     ...
     * find that cache.
     *
     * @return {@link com.sun.corba.se.pept.transport.ConnectionCache
     *         ConnectionCache}
     */
    public OutboundConnectionCache getConnectionCache();

    /**
     * Used to get a {@link com.sun.corba.se.pept.transport.Connection
     * Connection} to send and receive messages on the specific
     * <em>transport</em> represented by this <code>ContactInfo</code>.
     *
     * @return {@link com.sun.corba.se.pept.transport.Connection Connection}
     */
    public Connection createConnection();

    /**
     * Used to get a {@link com.sun.corba.se.pept.protocol.MessageMeidator
     * MessageMediator} to hold internal data for a message to be sent using the
     * specific encoding, protocol, transport combination represented by this
    ...
    /**
     * Used to get a {@link com.sun.corba.se.pept.protocol.MessageMeidator
     * MessageMediator} to hold internal data for a message received using the
     * specific encoding, protocol, transport combination represented by this
     * <code>ContactInfo</code>.
     *
     ...
     * with internal data for a message received using the specific encoding,
     * protocol, transport combination represented by this
     * <code>ContactInfo</code>.
     *
     * @return {@link com.sun.corba.se.pept.protocol.MessageMediator
     *         MessageMediator}
     ...
     * InputObject} for the specific <em>encoding</em> represented by this
     * <code>ContactInfo</code>.
     *
     ...
     * OutputObject} for the specific <em>encoding</em> represented by this
     * <code>ContactInfo</code>.
     *
