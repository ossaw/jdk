...
/**
 * <p>
 * <code>Connection</code> represents a <em>transport</em> in the PEPt
 * architecture.
 * </p>
 *
 * @author Harold Carr
...
public interface Connection {
	/**
	 * Used to determine if the <code>Connection</code> should register with the
	...
	/**
	 * Get the {@link com.sun.corba.se.pept.transport.Acceptor Acceptor} that
	 * created this <code>Connection</code>.
	 *
	...
	/**
	 * Get the {@link com.sun.corba.se.pept.transport.ContactInfo ContactInfo}
	...
	/**
	 * Indicates whether a {@link com.sun.corba.se.pept.transport.ContactInfo
	 * ContactInfo} or a {@link com.sun.corba.se.pept.transport.Acceptor
	 * Acceptor} created the <code>Connection</code>.
	 *
	 * @return <code>true</code> if <code>Connection</code> an
	 *         {@link com.sun.corba.se.pept.transport.Acceptor Acceptor} created
	 *         the <code>Connection</code>.
	 */
	public boolean isServer();

	/**
	 * Indicates if the <code>Connection</code> is in the process of sending or
	 * receiving a message.
	 *
