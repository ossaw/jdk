...
public class ByteBufferPoolImpl implements ByteBufferPool {
    ...
    /*
     * Locations where ByteBuffers are gotten from the pool: 1.
     * ContactInfoBase.createMessageMediator() 2.
     * ByteBufferWithInfo.growBuffer() 3. ByteBufferWithInfo(ORB,
     * BufferManagerWrite) - constructor
     */
    ...
    /*
     * Locations where ByteBuffers are released to the pool: 1.
     * ByteBufferWithInfo.growBuffer() 2.
     * BufferManagerWriteCollect.sendMessage() 3. CDROutputStream_1_0.close() 4.
     * CDRInputStream_1_0.close() 5. BufferManagerReadStream.underflow() 6.
     * BufferManagerWrite.close() 7. BufferManagerRead.close() 8.
