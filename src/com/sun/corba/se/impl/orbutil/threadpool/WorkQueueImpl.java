...
public class WorkQueueImpl implements WorkQueue {
	...
	private void initializeMonitoring() {
		workqueueMonitoredObject = MonitoringFactories.getMonitoredObjectFactory()
				.createMonitoredObject(name, MonitoringConstants.WORKQUEUE_MONITORING_DESCRIPTION);
	...
	/**
	 * Returns the total number of Work items added to the Queue. This method is
	 * unsynchronized and only gives a snapshot of the state when it is called
	 */
	...
	/**
	 * Returns the total number of Work items in the Queue to be processed This
	 * method is unsynchronized and only gives a snapshot of the state when it
	 * is called
	 */
