...
public class ThreadPoolImpl implements ThreadPool {
	...
	// Minimum number of worker threads created at instantiation of the
	// threadpool
	...
	/**
	 * This constructor is used to create an unbounded threadpool in the
	 * ThreadGroup of the current thread
	 */
	...
	// Note that this method should not return until AFTER all threads have
	// died.
	...
	private void initializeMonitoring() {
		...
		MonitoredObject threadPoolMonitoringObjectRoot = root
				.getChild(MonitoringConstants.THREADPOOL_MONITORING_ROOT);
		...
		threadpoolMonitoredObject = MonitoringFactories.getMonitoredObjectFactory()
				.createMonitoredObject(name, MonitoringConstants.THREADPOOL_MONITORING_DESCRIPTION);
		...
		LongMonitoredAttributeBase b2 = new LongMonitoredAttributeBase(
		...
		LongMonitoredAttributeBase b3 = new LongMonitoredAttributeBase(
		...
		LongMonitoredAttributeBase b4 = new LongMonitoredAttributeBase(
		...
		LongMonitoredAttributeBase b5 = new LongMonitoredAttributeBase(
				MonitoringConstants.THREADPOOL_CURRENT_PROCESSED_COUNT,
	...
	/**
	 * To be called from the workqueue when work is added to the workQueue. This
	 * method would create new threads if required or notify waiting threads on
	 * the queue for available work
	 */
	...
	/**
	 * This method will decrement the number of available threads in the
	 * threadpool which are waiting for work. Called from
	...
	/**
	 * This method will increment the number of available threads in the
	 * threadpool which are waiting for work. Called from
	 * WorkQueueImpl.requestWork()
	 */
