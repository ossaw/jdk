...
public class BootstrapResolverImpl implements Resolver {
     ...
     * parameter. We do not want to extend BootStrap protocol any further, as
     * INS handles most of what BootStrap can handle in a portable way.
     *
    ...
    private InputStream invoke(String operationName, String parameter) {
        ...
        while (remarshal) {
            ...
            try {
                // The only reason a null objref is passed is to get the version
                // of
