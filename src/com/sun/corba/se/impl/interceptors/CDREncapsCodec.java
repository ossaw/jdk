...
public final class CDREncapsCodec extends org.omg.CORBA.LocalObject implements Codec {
	...
	/*
	 *******************************************************************
	 * NOTE: CDREncapsCodec must remain immutable! This is so that we can
	 * pre-create CDREncapsCodecs for each version of GIOP in CodecFactoryImpl.
	 *******************************************************************/
	...
	/**
	 * Decode the given octet sequence into an any based on a CDR encapsulated
	 * octet sequence.
	 */
	...
	/**
	 * Convert the given any into a CDR encapsulated octet sequence. Only the
	 * data is stored. The type code is not.
	 */
	...
	/**
	 * Convert the given any into a CDR encapsulated octet sequence. If
	 * sendTypeCode is true, the type code is sent with the message, as in a
	...
	private byte[] encodeImpl(Any data, boolean sendTypeCode) throws InvalidTypeForEncoding {
		...
		EncapsOutputStream cdrOut = sun.corba.OutputStreamFactory
				.newEncapsOutputStream((com.sun.corba.se.spi.orb.ORB) orb, giopVersion);
	...
	/**
	 * Decode the given octet sequence into an any based on a CDR encapsulated
	 * octet sequence. If the type code is null, it is expected to appear in the
	 * octet sequence. Otherwise, the given type code is used.
	 */
