 ...
 * Interceptors Spec orbos/99-12-02. IMPORTANT: PICurrent is implemented with
 * the assumption that get_slot() or set_slot() will not be called in
...
public class PICurrent extends org.omg.CORBA.LocalObject implements Current {
    ...
    PICurrent(ORB myORB) {
        this.myORB = myORB;
        wrapper = OMGSystemException.get(myORB, CORBALogDomains.RPC_PROTOCOL);
        this.orbInitializing = true;
        slotCounter = 0;
    }

    /**
     * This method will be called from ORBInitInfo.allocate_slot_id( ). simply
     * returns a slot id by incrementing slotCounter.
     */
    int allocateSlotId() {
    ...
    /**
     * This method pushes a SlotTable on the SlotTableStack. When there is a
     * resolve_initial_references("PICurrent") after this call. The new
    ...
    /**
     * This method sets the slot data at the given slot id (index) in the Slot
     * Table which is on the top of the SlotTableStack.
     */
    ...
    /**
     * This method gets the slot data at the given slot id (index) from the Slot
     * Table which is on the top of the SlotTableStack.
     */
    ...
    /**
     * This method resets all the slot data to null in the Slot Table which is
     * on the top of SlotTableStack.
     */
    void resetSlotTable() {
