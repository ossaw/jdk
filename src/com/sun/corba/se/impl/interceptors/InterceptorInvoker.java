...
/**
 * Handles invocation of interceptors. Has specific knowledge of how to invoke
 * IOR, ClientRequest, and ServerRequest interceptors. Makes use of the
 * InterceptorList to retrieve the list of interceptors to be invoked. Most
 * methods in this class are package scope so that they may only be called from
 * the PIHandlerImpl.
 */
public class InterceptorInvoker {
    ...
    /**
     * Creates a new Interceptor Invoker. Constructor is package scope so only
    ...
    /**
     * Invokes either send_request, or send_poll, depending on the value of
     * info.getStartingPointCall()
     */
    ...
    /**
     * Invokes either send_reply, send_exception, or send_other, depending on
     * the value of info.getEndingPointCall()
     */
    ...
    private void updateClientRequestDispatcherForward(
        ...
        // to the ClientRequestDispatcher rather than explicitly through
        // Portable
