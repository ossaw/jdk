...
/**
 * Provides a repository of registered Portable Interceptors, organized by type.
 * This list is designed to be accessed as efficiently as possible during
 * runtime, with the expense of added complexity during initialization and
 * interceptor registration. The class is designed to easily allow for the
 * addition of new interceptor types.
 */
public class InterceptorList {
	...
	/**
	 * Creates a new Interceptor List. Constructor is package scope so only the
	 * ORB can create it.
	 */
	...
	/**
	 * Registers an interceptor of the given type into the interceptor list. The
	 * type is one of:
	 * <ul>
	 ...
	 * registered. This method is called after all interceptors are registered
	...
	/**
	 * Retrieves an array of interceptors of the given type. For efficiency, the
	 * type parameter is assumed to be valid.
	 */
	...
	/**
	 * Returns true if there is at least one interceptor of the given type, or
	 * false if not.
	 */
	...
	/**
	 * Initializes all interceptors arrays to zero-length arrays of the correct
	 * type, based on the classTypes list.
	 */
