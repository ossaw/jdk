 ...
 */
public final class ORBInitInfoImpl extends org.omg.CORBA.LocalObject implements ORBInitInfo, ORBInitInfoExt {
    ...
    /**
     * Throws an exception if the current stage is STAGE_CLOSED. This is called
     * before any method is invoked to ensure that no method invocations are
     * attempted after all calls to post_init() are completed.
     */
     ...
     * This operation is identical to ORB::register_initial_reference described
     * there. This same functionality exists here because the ORB, not yet fully
     * initialized, is not yet available but initial references may need to be
     * registered as part of Interceptor registration.
     * <p>
    ...
    public void register_initial_reference(String id, org.omg.CORBA.Object obj) throws InvalidName {
        ...
        // throw BAD_PARAM with minor code
        // OMGSystemException.RIR_WITH_NULL_OBJECT.
     ...
     * because the ORB, not yet fully initialized, is not yet available, but
    ...
    /**
     * This operation is used to add a client-side request Interceptor to the
     * list of client-side request Interceptors.
     * <p>
    ...
    /**
     * This operation is used to add a server-side request Interceptor to the
     * list of server-side request Interceptors.
     * <p>
