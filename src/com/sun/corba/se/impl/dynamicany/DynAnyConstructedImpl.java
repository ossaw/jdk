...
import com.sun.corba.se.impl.corba.TypeCodeImpl; // needed for recursive type
                                                 // codes
...
abstract class DynAnyConstructedImpl extends DynAnyImpl {
    ...
    protected DynAnyConstructedImpl(ORB orb, TypeCode typeCode) {
        // assertion: typeCode has been checked to be valid for this particular
        // subclass.
    ...
    protected void checkInitAny() {
        if ((representations & REPRESENTATION_ANY) == 0) {
            // System.out.println(this + " checkInitAny: reps does not have
            // REPRESENTATION_ANY");
            if ((representations & REPRESENTATION_COMPONENTS) != 0) {
                // System.out.println(this + " checkInitAny: reps has
            ...
            // System.out.println(this + " checkInitAny: reps !=
            // REPRESENTATION_ANY");
        }
        return;
    }
    ...
    public org.omg.CORBA.Any to_any() {
        ...
        checkInitAny();
        // Anys value may still be uninitialized if DynAny was initialized by
        // TypeCode only
        ...
        try {
            ...
            for (int i = 0; i < components.length; i++) {
                if (dyn_any.seek(i) == false)
                    return false;
                // System.out.println(this + " comparing component " + i + "=" +
                // components[i] +
