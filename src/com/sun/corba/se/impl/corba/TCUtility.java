...
public final class TCUtility {
	...
	static void marshalIn(org.omg.CORBA.portable.OutputStream s, TypeCode typeCode, long l,
			Object o) {
		...
		case TCKind._tk_fixed:
			// _REVISIT_ As soon as the java-rtf adds digits and scale
			// parameters to
		...
		default:
			ORBUtilSystemException wrapper = ORBUtilSystemException
					.get((com.sun.corba.se.spi.orb.ORB) s.orb(), CORBALogDomains.RPC_PRESENTATION);
			throw wrapper.typecodeNotSupported();
		}
	}

	static void unmarshalIn(org.omg.CORBA.portable.InputStream s, TypeCode typeCode, long[] la,
			Object[] oa) {
