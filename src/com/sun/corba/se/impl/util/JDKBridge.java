...
/**
 * Utility methods for doing various method calls which are used by multiple
 * classes
 */
public class JDKBridge {

    /**
     * Get local codebase System property (java.rmi.server.codebase). May be
     * null or a space separated array of URLS.
     */
    ...
    /**
     * Return true if the system property "java.rmi.server.useCodebaseOnly" is
     * set, false otherwise.
     */
    ...
    public static final void main(String[] args) {
         ...
         * "Trying to load "+targetClass); try { Class clz =
         * loadClass(targetClass,null,localCodebase); System.out.println(
         * "Loaded: "+clz); } catch (ClassNotFoundException e) {
         * System.out.println("Caught "+e); }
         */
    }

    /**
     * Set the codebase and useCodebaseOnly properties. This is public only for
     * test code.
     */
