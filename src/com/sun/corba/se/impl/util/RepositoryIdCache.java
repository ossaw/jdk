...
class RepositoryIdPool extends Stack {
    ...
    final void increasePool(int size) {
        ...
        /*
         * // _REVISIT_ This will not work w/out either thread tracing or weak
         * references. I am // betting that thread tracing almost completely
         * negates benefit of reuse. Until either // 1.2 only inclusion or proof
         * to the contrary, I'll leave it this way... else { int numToReclaim =
         * cache.size() / 2; Enumeration keys = cache.keys(); Enumeration
