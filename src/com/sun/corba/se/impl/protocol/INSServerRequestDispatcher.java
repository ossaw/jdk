...
/**
 * INSServerRequestDispatcher handles all INS related discovery request. The INS
 * Service can be registered using ORB.register_initial_reference(). This
 * Singleton subcontract just finds the target IOR and does location forward.
