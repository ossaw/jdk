...
public abstract class SpecialMethod {
    ...
    public abstract CorbaMessageMediator invoke(java.lang.Object servant, CorbaMessageMediator request,
...
class IsA extends SpecialMethod { // _is_a
    ...
    public CorbaMessageMediator invoke(java.lang.Object servant, CorbaMessageMediator request,
        ...
        if ((servant == null) || (servant instanceof NullServant)) {
            ...
            ORBUtilSystemException wrapper = ORBUtilSystemException.get(orb, CORBALogDomains.OA_INVOCATION);

            return request.getProtocolHandler().createSystemExceptionResponse(request, wrapper.badSkeleton(),
                    null);
        }
...
class GetInterface extends SpecialMethod { // _get_interface
    ...
    public CorbaMessageMediator invoke(java.lang.Object servant, CorbaMessageMediator request,
        ...
        if ((servant == null) || (servant instanceof NullServant)) {
            ...
            return request.getProtocolHandler().createSystemExceptionResponse(request, wrapper
