...
public class Message_1_1 extends
	...
	public FragmentMessage createFragmentMessage() {
		...
		/*
		 * // A fragmented mesg can be created only if the current mesg'
		 * fragment // bit is set. Otherwise, raise error // too stringent check
	...
	public void read(org.omg.CORBA.portable.InputStream istream) {
		/*
		 * this.magic = istream.read_long(); this.GIOP_version = (new
		 * GIOPVersion()).read(istream); this.flags = istream.read_octet();
		 * this.message_type = istream.read_octet(); this.message_size =
		 * istream.read_ulong();
		 */
	}
