...
abstract public class IORAddressingInfoHelper {
    ...
    public static void insert(org.omg.CORBA.Any a,
            com.sun.corba.se.impl.protocol.giopmsgheaders.IORAddressingInfo that) {
    ...
    public static com.sun.corba.se.impl.protocol.giopmsgheaders.IORAddressingInfo extract(
            org.omg.CORBA.Any a) {
        ...
        if (__typeCode == null) {
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    _members0[0] = new org.omg.CORBA.StructMember("selected_profile_index", _tcOf_members0,
                            null);
                    ...
                    __typeCode = org.omg.CORBA.ORB.init().create_struct_tc(
                            com.sun.corba.se.impl.protocol.giopmsgheaders.IORAddressingInfoHelper.id(),
    ...
    public static com.sun.corba.se.impl.protocol.giopmsgheaders.IORAddressingInfo read(
