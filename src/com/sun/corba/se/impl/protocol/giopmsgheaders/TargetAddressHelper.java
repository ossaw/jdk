...
abstract public class TargetAddressHelper {
	...
	public static void insert(org.omg.CORBA.Any a,
			com.sun.corba.se.impl.protocol.giopmsgheaders.TargetAddress that) {
	...
	public static com.sun.corba.se.impl.protocol.giopmsgheaders.TargetAddress extract(
			org.omg.CORBA.Any a) {
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			...
			_disTypeCode0 = org.omg.CORBA.ORB.init()
					.get_primitive_tc(org.omg.CORBA.TCKind.tk_short);
			_disTypeCode0 = org.omg.CORBA.ORB.init().create_alias_tc(
			...
			_anyOf_members0.insert_short(
					(short) com.sun.corba.se.impl.protocol.giopmsgheaders.KeyAddr.value);
			_tcOf_members0 = org.omg.CORBA.ORB.init()
					.get_primitive_tc(org.omg.CORBA.TCKind.tk_octet);
			_tcOf_members0 = org.omg.CORBA.ORB.init().create_sequence_tc(0, _tcOf_members0);
			_members0[0] = new org.omg.CORBA.UnionMember("object_key", _anyOf_members0,
					_tcOf_members0, null);

			// Branch for profile
			_anyOf_members0 = org.omg.CORBA.ORB.init().create_any();
			_anyOf_members0.insert_short(
					(short) com.sun.corba.se.impl.protocol.giopmsgheaders.ProfileAddr.value);
			_tcOf_members0 = org.omg.IOP.TaggedProfileHelper.type();
			_members0[1] = new org.omg.CORBA.UnionMember("profile", _anyOf_members0, _tcOf_members0,
					null);

			// Branch for ior
			_anyOf_members0 = org.omg.CORBA.ORB.init().create_any();
			_anyOf_members0.insert_short(
					(short) com.sun.corba.se.impl.protocol.giopmsgheaders.ReferenceAddr.value);
			_tcOf_members0 = com.sun.corba.se.impl.protocol.giopmsgheaders.IORAddressingInfoHelper
					.type();
			_members0[2] = new org.omg.CORBA.UnionMember("ior", _anyOf_members0, _tcOf_members0,
					null);
			__typeCode = org.omg.CORBA.ORB.init().create_union_tc(
					com.sun.corba.se.impl.protocol.giopmsgheaders.TargetAddressHelper.id(),
					"TargetAddress", _disTypeCode0, _members0);
		}
		return __typeCode;
	}
	...
	public static com.sun.corba.se.impl.protocol.giopmsgheaders.TargetAddress read(
		...
		case com.sun.corba.se.impl.protocol.giopmsgheaders.ReferenceAddr.value:
			...
			_ior = com.sun.corba.se.impl.protocol.giopmsgheaders.IORAddressingInfoHelper
					.read(istream);
			value.ior(_ior);
			break;
		default:
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			com.sun.corba.se.impl.protocol.giopmsgheaders.TargetAddress value) {
		...
		case com.sun.corba.se.impl.protocol.giopmsgheaders.ProfileAddr.value:
			...
			break;
		case com.sun.corba.se.impl.protocol.giopmsgheaders.ReferenceAddr.value:
			com.sun.corba.se.impl.protocol.giopmsgheaders.IORAddressingInfoHelper.write(ostream,
					value.ior());
			break;
		default:
			throw new org.omg.CORBA.BAD_OPERATION();
