...
public class CorbaClientDelegateImpl extends CorbaClientDelegate {
	...
	public OutputStream request(org.omg.CORBA.Object self, String operation,
		...
		return (OutputStream) subcontract.beginRequest(self, operation, !responseExpected,
				contactInfo);
	}
	...
	public boolean equals(org.omg.CORBA.Object self, java.lang.Object other) {
		...
		if (delegate instanceof CorbaClientDelegateImpl) {
			CorbaClientDelegateImpl otherDel = (CorbaClientDelegateImpl) delegate;
	...
	public Request create_request(org.omg.CORBA.Object obj, Context ctx, String operation,
			NVList arg_list, NamedValue result) {
		return new RequestImpl(orb, obj, ctx, operation, arg_list, result, null, null);
	}

	public Request create_request(org.omg.CORBA.Object obj, Context ctx, String operation,
			NVList arg_list, NamedValue result, ExceptionList exclist, ContextList ctxlist) {
