...
public class PrefixParserAction extends ParserActionBase {
     ...
     * apply getOperation() to { suffix( s ), value } and add the result to an
     * Object[] which forms the result of apply. Returns null if there are no
     * matches.
     */
    public Object apply(Properties props) {
        ...
        if (size > 0) {
            ...
            try {
                ...
                throw wrapper.couldNotCreateArray(thr, getPropertyName(), componentType, new Integer(size));
            }
            ...
            while (iter2.hasNext()) {
                ...
                try {
                    ...
                    throw wrapper.couldNotSetArray(thr, getPropertyName(), new Integer(ctr), componentType,
                            new Integer(size), obj.toString());
                }
                ctr++;
            }
