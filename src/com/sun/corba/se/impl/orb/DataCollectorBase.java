...
public abstract class DataCollectorBase implements DataCollector {
    ...
    protected void checkPropertyDefaults() {
        ...
        if (serverHost == null || serverHost.equals("") || serverHost.equals("0.0.0.0") || serverHost.equals(
    ...
    protected void findPropertiesFromSystem() {
        ...
        findPropertiesByPrefix(prefixNames, getSystemPropertyNames(), callback);
    }
    ...
    private boolean hasCORBAPrefix(String prefix) {
        return prefix.startsWith(ORBConstants.ORG_OMG_PREFIX) || prefix.startsWith(ORBConstants.SUN_PREFIX)
                || prefix.startsWith(ORBConstants.SUN_LC_PREFIX) || prefix.startsWith(
