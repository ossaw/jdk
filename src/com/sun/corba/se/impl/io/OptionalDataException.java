 ...
 * This exception occurs when the stream contains primitive data instead of the
 * object expected by readObject. The eof flag in the exception is true to
 * indicate that no more primitive data is available. The count field contains
