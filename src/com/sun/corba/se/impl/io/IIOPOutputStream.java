...
public class IIOPOutputStream extends com.sun.corba.se.impl.io.OutputStreamHook {
    ...
    protected void beginOptionalCustomData() {
        ...
        if (streamFormatVersion == 2) {
            ...
            org.omg.CORBA.portable.ValueOutputStream vout = (org.omg.CORBA.portable.ValueOutputStream) orbStream;
    ...
    /**
     * Override the actions of the final method "writeObject()" in
     * ObjectOutputStream.
     * 
     * @since JDK1.1.6
     */
    ...
    /* throws IOException */
    {
        ...
        try {
            ...
            // !checkSubstitutableSpecialClasses(obj))
            outputObject(obj);
        ...
        /*
         * If the recursion depth is 0, test for and clear the pending
         * exception. If there is a pending exception throw it.
         */
    ...
    /**
     * Override the actions of the final method "defaultWriteObject()" in
     * ObjectOutputStream.
     * 
     * @since JDK1.1.6
     */
    ...
    /**
     * Override the actions of the final method "enableReplaceObject()" in
     * ObjectOutputStream.
     * 
     * @since JDK1.1.6
     */
    ...
    /*
     * Check for special cases of serializing objects. These objects are not
    ...
    private void outputObject(final Object obj) throws IOException {
        ...
        /*
         * Get the Class descriptor for this class, Throw a
         * NotSerializableException if there is none.
         */
        ...
        /*
         * If the object is externalizable, call writeExternal. else do
        ...
        if (currentClassDesc.isExternalizable()) {
            ...
            try {
                ...
                /*
                 * For currentClassDesc and all the pushed class descriptors If
                 * the class is writing its own data set blockData = true; call
                 * the class writeObject method If not invoke either the
    ...
    /*
     * Invoke writer. _REVISIT_ invokeObjectWriter and invokeObjectReader behave
