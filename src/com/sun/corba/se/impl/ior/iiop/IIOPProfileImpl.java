...
public class IIOPProfileImpl extends IdentifiableBase implements IIOPProfile {
     ...
     * invocation. XXX revisit: do we want this at all? If we do, it might move
     * to the ObjectKeyTemplate instead.
     */
    ...
    /**
     * Return GIOPVersion for this IOR. Requests created against this IOR will
     * be of the return Version.
     */
