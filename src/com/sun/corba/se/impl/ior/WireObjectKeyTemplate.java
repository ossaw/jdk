...
public class WireObjectKeyTemplate implements ObjectKeyTemplate {
     ...
     * problems since we need to check whether unusual object references are
     * local or not. It seems that the easiest way to handle this is to return
     * an invalid server id.
     */
    ...
    /**
     * Adapter ID is not available, since our ORB did not implement the object
     * carrying this key.
     */
