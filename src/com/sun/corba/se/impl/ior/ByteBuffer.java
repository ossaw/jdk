...
public class ByteBuffer {
     ...
     * ByteBuffer is doubled each time it needs to grow.
     *
     * @serial
     */
     ...
     * size. If the capacity of this cector is larger than its current size,
     * then the capacity is changed to equal the size by replacing its internal
     * data array, kept in the field <tt>elementData</tt>, with a smaller one.
     ...
     *
     * @return the current capacity (the length of its internal data arary, kept
     *         in the field <tt>elementData</tt> of this ByteBuffer.
     */
    public int capacity() {
     ...
     *
     * @return <code>true</code> if and only if this ByteBuffer has no
