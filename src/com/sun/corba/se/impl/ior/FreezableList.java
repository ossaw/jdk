...
/**
 * Simple class that delegates all List operations to another list. It also can
 * be frozen, which means that a number of operations can be performed on the
 * list, and then the list can be made immutable, so that no further changes are
