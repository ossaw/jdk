...
// c:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8u144/9417/corba/src/share/classes/com/sun/corba/se/spi/logging/data/Interceptors.mc
// on Fri Jul 21 21:58:44 PDT 2017
...
public class InterceptorsSystemException extends LogWrapperBase {
	...
	public BAD_INV_ORDER rirInvalidPreInit(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "INTERCEPTORS.rirInvalidPreInit", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public INTERNAL exceptionWasNull(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "INTERCEPTORS.exceptionWasNull", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public INTERNAL objectHasNoDelegate(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "INTERCEPTORS.objectHasNoDelegate", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public INTERNAL objectNotObjectimpl(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "INTERCEPTORS.objectNotObjectimpl", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public INTERNAL exceptionInvalid(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "INTERCEPTORS.exceptionInvalid", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public INTERNAL replyStatusNotInit(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "INTERCEPTORS.replyStatusNotInit", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public INTERNAL exceptionInContexts(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "INTERCEPTORS.exceptionInContexts", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public INTERNAL exceptionWasNull2(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "INTERCEPTORS.exceptionWasNull2", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public INTERNAL cantPopOnlyCurrent2(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "INTERCEPTORS.cantPopOnlyCurrent2", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public INTERNAL piDsiResultIsNull(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "INTERCEPTORS.piDsiResultIsNull", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public INTERNAL piDiiResultIsNull(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "INTERCEPTORS.piDiiResultIsNull", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public INTERNAL clientInfoStackNull(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "INTERCEPTORS.clientInfoStackNull", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public INTERNAL serverInfoStackNull(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "INTERCEPTORS.serverInfoStackNull", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public INTERNAL markAndResetFailed(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "INTERCEPTORS.markAndResetFailed", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public INTERNAL slotTableInvariant(CompletionStatus cs, Throwable t,
		...
		if (logger.isLoggable(Level.WARNING)) {
			...
			parameters[0] = arg0;
			parameters[1] = arg1;
			doLog(Level.WARNING, "INTERCEPTORS.slotTableInvariant", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public INTERNAL sortSizeMismatch(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "INTERCEPTORS.sortSizeMismatch", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public NO_IMPLEMENT piOrbNotPolicyBased(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "INTERCEPTORS.piOrbNotPolicyBased", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public OBJECT_NOT_EXIST orbinitinfoInvalid(CompletionStatus cs,
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = null;
			doLog(Level.FINE, "INTERCEPTORS.orbinitinfoInvalid", parameters,
					InterceptorsSystemException.class, exc);
		}
	...
	public UNKNOWN unknownRequestInvoke(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = null;
			doLog(Level.FINE, "INTERCEPTORS.unknownRequestInvoke", parameters,
					InterceptorsSystemException.class, exc);
		}
