...
public class UtilSystemException extends LogWrapperBase {
	...
	public static UtilSystemException get(ORB orb, String logDomain) {
		UtilSystemException wrapper = (UtilSystemException) orb.getLogWrapper(logDomain, "UTIL",
				factory);
		return wrapper;
	}

	public static UtilSystemException get(String logDomain) {
		UtilSystemException wrapper = (UtilSystemException) ORB.staticGetLogWrapper(logDomain,
				"UTIL", factory);
		return wrapper;
	}
	...
	public BAD_OPERATION errorInMakeStubFromRepositoryId(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = null;
			doLog(Level.FINE, "UTIL.errorInMakeStubFromRepositoryId", parameters,
					UtilSystemException.class, exc);
		}
	...
	public BAD_OPERATION exceptionInLoadStub(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = null;
			doLog(Level.FINE, "UTIL.exceptionInLoadStub", parameters, UtilSystemException.class,
					exc);
		}
	...
	public BAD_PARAM connectTieWrongOrb(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "UTIL.connectTieWrongOrb", parameters, UtilSystemException.class,
					exc);
		}
	...
	public BAD_PARAM connectTieNoServant(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "UTIL.connectTieNoServant", parameters, UtilSystemException.class,
					exc);
		}
	...
	public MARSHAL invalidIndirection(CompletionStatus cs, Throwable t, Object arg0) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = new Object[1];
			parameters[0] = arg0;
			doLog(Level.WARNING, "UTIL.invalidIndirection", parameters, UtilSystemException.class,
					exc);
		}
	...
	public INV_OBJREF objectNotConnected(CompletionStatus cs, Throwable t, Object arg0) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = new Object[1];
			parameters[0] = arg0;
			doLog(Level.WARNING, "UTIL.objectNotConnected", parameters, UtilSystemException.class,
					exc);
		}
	...
	public INV_OBJREF couldNotLoadStub(CompletionStatus cs, Throwable t, Object arg0) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = new Object[1];
			parameters[0] = arg0;
			doLog(Level.WARNING, "UTIL.couldNotLoadStub", parameters, UtilSystemException.class,
					exc);
		}
	...
	public INV_OBJREF objectNotExported(CompletionStatus cs, Throwable t, Object arg0) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = new Object[1];
			parameters[0] = arg0;
			doLog(Level.WARNING, "UTIL.objectNotExported", parameters, UtilSystemException.class,
					exc);
		}
	...
	public INTERNAL errorSetObjectField(CompletionStatus cs, Throwable t, Object arg0, Object arg1,
		...
		if (logger.isLoggable(Level.WARNING)) {
			...
			parameters[1] = arg1;
			parameters[2] = arg2;
			doLog(Level.WARNING, "UTIL.errorSetObjectField", parameters, UtilSystemException.class,
					exc);
		}
	...
	public INTERNAL errorSetObjectField(CompletionStatus cs, Object arg0, Object arg1,
			Object arg2) {
	...
	public INTERNAL errorSetBooleanField(CompletionStatus cs, Throwable t, Object arg0, Object arg1,
		...
		if (logger.isLoggable(Level.WARNING)) {
			...
			parameters[1] = arg1;
			parameters[2] = arg2;
			doLog(Level.WARNING, "UTIL.errorSetBooleanField", parameters, UtilSystemException.class,
					exc);
		}
	...
	public INTERNAL errorSetBooleanField(CompletionStatus cs, Object arg0, Object arg1,
			Object arg2) {
	...
	public INTERNAL errorSetByteField(CompletionStatus cs, Throwable t, Object arg0, Object arg1,
		...
		if (logger.isLoggable(Level.WARNING)) {
			...
			parameters[1] = arg1;
			parameters[2] = arg2;
			doLog(Level.WARNING, "UTIL.errorSetByteField", parameters, UtilSystemException.class,
					exc);
		}
	...
	public INTERNAL errorSetCharField(CompletionStatus cs, Throwable t, Object arg0, Object arg1,
		...
		if (logger.isLoggable(Level.WARNING)) {
			...
			parameters[1] = arg1;
			parameters[2] = arg2;
			doLog(Level.WARNING, "UTIL.errorSetCharField", parameters, UtilSystemException.class,
					exc);
		}
	...
	public INTERNAL errorSetShortField(CompletionStatus cs, Throwable t, Object arg0, Object arg1,
		...
		if (logger.isLoggable(Level.WARNING)) {
			...
			parameters[1] = arg1;
			parameters[2] = arg2;
			doLog(Level.WARNING, "UTIL.errorSetShortField", parameters, UtilSystemException.class,
					exc);
		}
	...
	public INTERNAL errorSetIntField(CompletionStatus cs, Throwable t, Object arg0, Object arg1,
		...
		if (logger.isLoggable(Level.WARNING)) {
			...
			parameters[1] = arg1;
			parameters[2] = arg2;
			doLog(Level.WARNING, "UTIL.errorSetIntField", parameters, UtilSystemException.class,
					exc);
		}
	...
	public INTERNAL errorSetLongField(CompletionStatus cs, Throwable t, Object arg0, Object arg1,
		...
		if (logger.isLoggable(Level.WARNING)) {
			...
			parameters[1] = arg1;
			parameters[2] = arg2;
			doLog(Level.WARNING, "UTIL.errorSetLongField", parameters, UtilSystemException.class,
					exc);
		}
	...
	public INTERNAL errorSetFloatField(CompletionStatus cs, Throwable t, Object arg0, Object arg1,
		...
		if (logger.isLoggable(Level.WARNING)) {
			...
			parameters[1] = arg1;
			parameters[2] = arg2;
			doLog(Level.WARNING, "UTIL.errorSetFloatField", parameters, UtilSystemException.class,
					exc);
		}
	...
	public INTERNAL errorSetDoubleField(CompletionStatus cs, Throwable t, Object arg0, Object arg1,
		...
		if (logger.isLoggable(Level.WARNING)) {
			...
			parameters[1] = arg1;
			parameters[2] = arg2;
			doLog(Level.WARNING, "UTIL.errorSetDoubleField", parameters, UtilSystemException.class,
					exc);
		}
	...
	public INTERNAL errorSetDoubleField(CompletionStatus cs, Object arg0, Object arg1,
			Object arg2) {
	...
	public INTERNAL illegalFieldAccess(CompletionStatus cs, Throwable t, Object arg0) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = new Object[1];
			parameters[0] = arg0;
			doLog(Level.WARNING, "UTIL.illegalFieldAccess", parameters, UtilSystemException.class,
					exc);
		}
	...
	public INTERNAL badBeginUnmarshalCustomValue(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "UTIL.badBeginUnmarshalCustomValue", parameters,
					UtilSystemException.class, exc);
		}
