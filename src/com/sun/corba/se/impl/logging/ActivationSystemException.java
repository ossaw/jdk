...
// c:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8u144/9417/corba/src/share/classes/com/sun/corba/se/spi/logging/data/Activation.mc
...
public class ActivationSystemException extends LogWrapperBase {
    ...
    public INTERNAL unableToStartProcess(CompletionStatus cs, Throwable t) {
        ...
        if (logger.isLoggable(Level.WARNING)) {
            Object[] parameters = null;
            doLog(Level.WARNING, "ACTIVATION.unableToStartProcess", parameters,
                    ActivationSystemException.class, exc);
        }
