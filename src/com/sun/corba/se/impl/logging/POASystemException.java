...
public class POASystemException extends LogWrapperBase {
	...
	public static POASystemException get(ORB orb, String logDomain) {
		POASystemException wrapper = (POASystemException) orb.getLogWrapper(logDomain, "POA",
				factory);
		return wrapper;
	}

	public static POASystemException get(String logDomain) {
		POASystemException wrapper = (POASystemException) ORB.staticGetLogWrapper(logDomain, "POA",
				factory);
		return wrapper;
	}
	...
	public BAD_OPERATION illegalForwardRequest(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.illegalForwardRequest", parameters, POASystemException.class,
					exc);
		}
	...
	public BAD_PARAM badTransactionContext(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.badTransactionContext", parameters, POASystemException.class,
					exc);
		}
	...
	public INTERNAL badLocalreplystatus(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.badLocalreplystatus", parameters, POASystemException.class,
					exc);
		}
	...
	public INTERNAL cantCloneTemplate(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.cantCloneTemplate", parameters, POASystemException.class,
					exc);
		}
	...
	public INTERNAL poacurrentNullField(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.poacurrentNullField", parameters, POASystemException.class,
					exc);
		}
	...
	public INTERNAL makeFactoryNotPoa(CompletionStatus cs, Throwable t, Object arg0) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			...
			parameters[0] = arg0;
			doLog(Level.WARNING, "POA.makeFactoryNotPoa", parameters, POASystemException.class,
					exc);
		}
	...
	public INTERNAL duplicateOrbVersionSc(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.duplicateOrbVersionSc", parameters, POASystemException.class,
					exc);
		}
	...
	public INTERNAL preinvokeCloneError(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.preinvokeCloneError", parameters, POASystemException.class,
					exc);
		}
	...
	public INTERNAL preinvokePoaDestroyed(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.preinvokePoaDestroyed", parameters, POASystemException.class,
					exc);
		}
	...
	public INTERNAL pmfCreateNonRetain(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.pmfCreateNonRetain", parameters, POASystemException.class,
					exc);
		}
	...
	public INTERNAL policyMediatorBadPolicyInFactory(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.policyMediatorBadPolicyInFactory", parameters,
					POASystemException.class, exc);
		}
	...
	public INTERNAL cantResolveRootPoa(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.cantResolveRootPoa", parameters, POASystemException.class,
					exc);
		}
	...
	public INTERNAL servantMustBeLocal(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.servantMustBeLocal", parameters, POASystemException.class,
					exc);
		}
	...
	public INTERNAL illegalPoaStateTrans(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.illegalPoaStateTrans", parameters, POASystemException.class,
					exc);
		}
	...
	public INTERNAL unexpectedException(CompletionStatus cs, Throwable t, Object arg0) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = new Object[1];
			parameters[0] = arg0;
			doLog(Level.WARNING, "POA.unexpectedException", parameters, POASystemException.class,
					exc);
		}
	...
	public NO_IMPLEMENT methodNotImplemented(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.methodNotImplemented", parameters, POASystemException.class,
					exc);
		}
	...
	public OBJ_ADAPTER poaNoServantManager(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.poaNoServantManager", parameters, POASystemException.class,
					exc);
		}
	...
	public OBJ_ADAPTER poaNoDefaultServant(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.poaNoDefaultServant", parameters, POASystemException.class,
					exc);
		}
	...
	public OBJ_ADAPTER poaServantNotUnique(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.poaServantNotUnique", parameters, POASystemException.class,
					exc);
		}
	...
	public OBJ_ADAPTER poaServantActivatorLookupFailed(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.poaServantActivatorLookupFailed", parameters,
					POASystemException.class, exc);
		}
	...
	public OBJ_ADAPTER poaBadServantManager(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.poaBadServantManager", parameters, POASystemException.class,
					exc);
		}
	...
	public OBJ_ADAPTER poaServantLocatorLookupFailed(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.poaServantLocatorLookupFailed", parameters,
					POASystemException.class, exc);
		}
	...
	public OBJ_ADAPTER localServantLookup(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.localServantLookup", parameters, POASystemException.class,
					exc);
		}
	...
	public OBJ_ADAPTER servantManagerBadType(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.servantManagerBadType", parameters, POASystemException.class,
					exc);
		}
	...
	public OBJ_ADAPTER defaultPoaNotPoaimpl(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.defaultPoaNotPoaimpl", parameters, POASystemException.class,
					exc);
		}
	...
	public OBJ_ADAPTER thisObjectWrongPolicy(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.thisObjectWrongPolicy", parameters, POASystemException.class,
					exc);
		}
	...
	public OBJ_ADAPTER incarnateReturnedNull(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.incarnateReturnedNull", parameters, POASystemException.class,
					exc);
		}
	...
	public UNKNOWN unknownServerException(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.unknownServerException", parameters, POASystemException.class,
					exc);
		}
	...
	public OBJECT_NOT_EXIST adapterActivatorFailed(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "POA.adapterActivatorFailed", parameters, POASystemException.class,
					exc);
		}
