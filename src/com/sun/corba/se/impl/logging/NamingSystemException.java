...
public class NamingSystemException extends LogWrapperBase {
	...
	public static NamingSystemException get(ORB orb, String logDomain) {
		NamingSystemException wrapper = (NamingSystemException) orb.getLogWrapper(logDomain,
				"NAMING", factory);
		return wrapper;
	}

	public static NamingSystemException get(String logDomain) {
		NamingSystemException wrapper = (NamingSystemException) ORB.staticGetLogWrapper(logDomain,
				"NAMING", factory);
		return wrapper;
	}
	...
	public BAD_PARAM transientNameServerBadPort(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			...
			doLog(Level.WARNING, "NAMING.transientNameServerBadPort", parameters,
	...
	public BAD_PARAM transientNameServerBadHost(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "NAMING.transientNameServerBadHost", parameters,
					NamingSystemException.class, exc);
		}
	...
	public BAD_PARAM objectIsNull(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "NAMING.objectIsNull", parameters, NamingSystemException.class,
					exc);
		}
	...
	public BAD_PARAM insBadAddress(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "NAMING.insBadAddress", parameters, NamingSystemException.class,
					exc);
		}
	...
	public UNKNOWN bindFailure(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "NAMING.bindFailure", parameters, NamingSystemException.class,
					exc);
		}
	...
	public UNKNOWN resolveFailure(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "NAMING.resolveFailure", parameters, NamingSystemException.class,
					exc);
		}
	...
	public UNKNOWN unbindFailure(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "NAMING.unbindFailure", parameters, NamingSystemException.class,
					exc);
		}
	...
	public INTERNAL insBadSchemeName(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "NAMING.insBadSchemeName", parameters, NamingSystemException.class,
					exc);
		}
