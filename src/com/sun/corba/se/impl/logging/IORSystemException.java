...
public class IORSystemException extends LogWrapperBase {
	...
	public static IORSystemException get(ORB orb, String logDomain) {
		IORSystemException wrapper = (IORSystemException) orb.getLogWrapper(logDomain, "IOR",
				factory);
		return wrapper;
	}

	public static IORSystemException get(String logDomain) {
		IORSystemException wrapper = (IORSystemException) ORB.staticGetLogWrapper(logDomain, "IOR",
				factory);
		return wrapper;
	}
	...
	public INTERNAL ortNotInitialized(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			...
			doLog(Level.WARNING, "IOR.ortNotInitialized", parameters, IORSystemException.class,
					exc);
		}
	...
	public INTERNAL stringifyWriteError(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "IOR.stringifyWriteError", parameters, IORSystemException.class,
					exc);
		}
	...
	public INTERNAL taggedProfileTemplateFactoryNotFound(CompletionStatus cs, Throwable t,
			Object arg0) {
	...
	public INTERNAL getLocalServantFailure(CompletionStatus cs, Throwable t, Object arg0) {
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = new Object[1];
			parameters[0] = arg0;
			doLog(Level.FINE, "IOR.getLocalServantFailure", parameters, IORSystemException.class,
					exc);
		}
	...
	public BAD_OPERATION adapterIdNotAvailable(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "IOR.adapterIdNotAvailable", parameters, IORSystemException.class,
					exc);
		}
	...
	public BAD_OPERATION serverIdNotAvailable(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "IOR.serverIdNotAvailable", parameters, IORSystemException.class,
					exc);
		}
	...
	public BAD_OPERATION orbIdNotAvailable(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "IOR.orbIdNotAvailable", parameters, IORSystemException.class,
					exc);
		}
	...
	public BAD_PARAM invalidTaggedProfile(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "IOR.invalidTaggedProfile", parameters, IORSystemException.class,
					exc);
		}
	...
	public BAD_PARAM badIiopAddressPort(CompletionStatus cs, Throwable t, Object arg0) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = new Object[1];
			parameters[0] = arg0;
			doLog(Level.WARNING, "IOR.badIiopAddressPort", parameters, IORSystemException.class,
					exc);
		}
	...
	public INV_OBJREF iorMustHaveIiopProfile(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "IOR.iorMustHaveIiopProfile", parameters, IORSystemException.class,
					exc);
		}
