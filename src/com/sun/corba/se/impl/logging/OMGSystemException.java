...
public class OMGSystemException extends LogWrapperBase {
	...
	public static OMGSystemException get(ORB orb, String logDomain) {
		OMGSystemException wrapper = (OMGSystemException) orb.getLogWrapper(logDomain, "OMG",
				factory);
		return wrapper;
	}

	public static OMGSystemException get(String logDomain) {
		OMGSystemException wrapper = (OMGSystemException) ORB.staticGetLogWrapper(logDomain, "OMG",
				factory);
		return wrapper;
	}
	...
	public BAD_CONTEXT idlContextNotFound(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			...
			doLog(Level.WARNING, "OMG.idlContextNotFound", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_CONTEXT noMatchingIdlContext(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.noMatchingIdlContext", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_INV_ORDER depPreventDestruction(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.depPreventDestruction", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_INV_ORDER destroyIndestructible(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.destroyIndestructible", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_INV_ORDER badSetServantManager(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.badSetServantManager", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_INV_ORDER serviceContextAddFailed(CompletionStatus cs, Throwable t, Object arg0) {
		...
		if (logger.isLoggable(Level.FINE)) {
			...
			parameters[0] = arg0;
			doLog(Level.FINE, "OMG.serviceContextAddFailed", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_INV_ORDER policyFactoryRegFailed(CompletionStatus cs, Throwable t, Object arg0) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = new Object[1];
			parameters[0] = arg0;
			doLog(Level.WARNING, "OMG.policyFactoryRegFailed", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_OPERATION badServantManagerType(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.badServantManagerType", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM ridAlreadyDefined(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.ridAlreadyDefined", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM targetNotContainer(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.targetNotContainer", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM soBadSchemaSpecific(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.soBadSchemaSpecific", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM irDeriveAbsIntBase(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.irDeriveAbsIntBase", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM incompleteTypecode(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.incompleteTypecode", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM typecodeInvMember(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.typecodeInvMember", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM tcUnionIncompatible(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.tcUnionIncompatible", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM setExceptionBadAny(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.setExceptionBadAny", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM setExceptionUnlisted(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.setExceptionUnlisted", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM illegalServiceContext(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.illegalServiceContext", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM invalidServiceContextId(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = null;
			doLog(Level.FINE, "OMG.invalidServiceContextId", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM rirWithNullObject(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.rirWithNullObject", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM policyTypeDuplicate(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.policyTypeDuplicate", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM badOnewayDefinition(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.badOnewayDefinition", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM unionBadDiscriminator(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.unionBadDiscriminator", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM ctxIllegalPropertyName(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.ctxIllegalPropertyName", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM ctxIllegalSearchString(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.ctxIllegalSearchString", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM notAValueoutputstream(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.notAValueoutputstream", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_PARAM notAValueinputstream(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.notAValueinputstream", parameters, OMGSystemException.class,
					exc);
		}
	...
	public BAD_TYPECODE badMemberTypecode(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.badMemberTypecode", parameters, OMGSystemException.class,
					exc);
		}
	...
	public DATA_CONVERSION priorityMapFailre(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.priorityMapFailre", parameters, OMGSystemException.class,
					exc);
		}
	...
	public INITIALIZE priorityRangeRestrict(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.priorityRangeRestrict", parameters, OMGSystemException.class,
					exc);
		}
	...
	public MARSHAL unableLocateValueFactory(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = null;
			doLog(Level.FINE, "OMG.unableLocateValueFactory", parameters, OMGSystemException.class,
					exc);
		}
	...
	public MARSHAL setResultBeforeCtx(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.setResultBeforeCtx", parameters, OMGSystemException.class,
					exc);
		}
	...
	public MARSHAL rmiiiopOptionalDataIncompatible1(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.rmiiiopOptionalDataIncompatible1", parameters,
					OMGSystemException.class, exc);
		}
	...
	public MARSHAL rmiiiopOptionalDataIncompatible2(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.rmiiiopOptionalDataIncompatible2", parameters,
					OMGSystemException.class, exc);
		}
	...
	public MARSHAL rmiiiopOptionalDataIncompatible3(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = null;
			doLog(Level.FINE, "OMG.rmiiiopOptionalDataIncompatible3", parameters,
					OMGSystemException.class, exc);
		}
	...
	public NO_IMPLEMENT missingLocalValueImpl(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.missingLocalValueImpl", parameters, OMGSystemException.class,
					exc);
		}
	...
	public NO_IMPLEMENT incompatibleValueImpl(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.incompatibleValueImpl", parameters, OMGSystemException.class,
					exc);
		}
	...
	public NO_IMPLEMENT bioMetaNotAvailable(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.bioMetaNotAvailable", parameters, OMGSystemException.class,
					exc);
		}
	...
	public NO_IMPLEMENT bioGenomicNoIterator(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.bioGenomicNoIterator", parameters, OMGSystemException.class,
					exc);
		}
	...
	public NO_RESOURCES piOperationNotSupported1(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = null;
			doLog(Level.FINE, "OMG.piOperationNotSupported1", parameters, OMGSystemException.class,
					exc);
		}
	...
	public NO_RESOURCES piOperationNotSupported2(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = null;
			doLog(Level.FINE, "OMG.piOperationNotSupported2", parameters, OMGSystemException.class,
					exc);
		}
	...
	public NO_RESOURCES piOperationNotSupported3(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = null;
			doLog(Level.FINE, "OMG.piOperationNotSupported3", parameters, OMGSystemException.class,
					exc);
		}
	...
	public NO_RESOURCES piOperationNotSupported4(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = null;
			doLog(Level.FINE, "OMG.piOperationNotSupported4", parameters, OMGSystemException.class,
					exc);
		}
	...
	public NO_RESOURCES piOperationNotSupported5(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = null;
			doLog(Level.FINE, "OMG.piOperationNotSupported5", parameters, OMGSystemException.class,
					exc);
		}
	...
	public NO_RESOURCES piOperationNotSupported6(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = null;
			doLog(Level.FINE, "OMG.piOperationNotSupported6", parameters, OMGSystemException.class,
					exc);
		}
	...
	public NO_RESOURCES piOperationNotSupported7(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = null;
			doLog(Level.FINE, "OMG.piOperationNotSupported7", parameters, OMGSystemException.class,
					exc);
		}
	...
	public NO_RESOURCES piOperationNotSupported8(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = null;
			doLog(Level.FINE, "OMG.piOperationNotSupported8", parameters, OMGSystemException.class,
					exc);
		}
	...
	public NO_RESOURCES noConnectionPriority(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.noConnectionPriority", parameters, OMGSystemException.class,
					exc);
		}
	...
	public TRANSIENT poaRequestDiscard(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.poaRequestDiscard", parameters, OMGSystemException.class,
					exc);
		}
	...
	public OBJECT_NOT_EXIST objectAdapterInactive(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.objectAdapterInactive", parameters, OMGSystemException.class,
					exc);
		}
	...
	public OBJ_ADAPTER adapterActivatorException(CompletionStatus cs, Throwable t, Object arg0,
			Object arg1) {
	...
	public OBJ_ADAPTER badPolicyIncarnate(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.badPolicyIncarnate", parameters, OMGSystemException.class,
					exc);
		}
	...
	public OBJ_ADAPTER piExcCompEstablished(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.piExcCompEstablished", parameters, OMGSystemException.class,
					exc);
		}
	...
	public UNKNOWN unknownUserException(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.FINE)) {
			Object[] parameters = null;
			doLog(Level.FINE, "OMG.unknownUserException", parameters, OMGSystemException.class,
					exc);
		}
	...
	public UNKNOWN piUnknownUserException(CompletionStatus cs, Throwable t) {
		...
		if (logger.isLoggable(Level.WARNING)) {
			Object[] parameters = null;
			doLog(Level.WARNING, "OMG.piUnknownUserException", parameters, OMGSystemException.class,
					exc);
		}
