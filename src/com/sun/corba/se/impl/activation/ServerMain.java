...
public class ServerMain {
	/*
	 * TODO: 1. Rewrite all uses of ORB properties to use constants from
	 * someplace. The strings are scattered between here, the ORB classes, and
	 * ServerTableEntry. 2. Consider a more general log facility. 3. Remove
	 * ServerCallback from POAORB. 4. Needs to be merged with Harold's changes
	 * to support SSL. 5. Logs need to be internationalized.
	 */
	...
	/**
	 * Write final message to log(s) and then terminate by calling System.exit(
	 * code ). If code == OK, write a normal termination message to standard
	 * out, otherwise write an abnormal termination message to standard out and
	 * standard error.
	 */
	...
	private void run(String[] args) {
		try {
			...
			try {
				// determine the main class, try loading with current class
				// loader
...
class ServerCallback extends com.sun.corba.se.spi.activation._ServerImplBase {
	private ORB orb;
