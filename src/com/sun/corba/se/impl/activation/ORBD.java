...
public class ORBD {
    ...
    protected ORB createORB(String[] args) {
        ...
        props.put(ORBConstants.PERSISTENT_SERVER_PORT_PROPERTY, props.getProperty(
    ...
    /**
     * Ensure that the Db directory exists. If not, create the Db and the log
     * directory and return true. Otherwise return false.
     */
    protected boolean createSystemDirs(String defaultDbDir) {
        ...
        dbDir = new File(props.getProperty(ORBConstants.DB_DIR_PROPERTY, props.getProperty("user.dir")
                + fileSep + defaultDbDir));
    ...
    protected void startActivationObjects(ORB orb) throws Exception {
        ...
        ServerManagerImpl serverMgr = new ServerManagerImpl(orb, orb.getCorbaTransportManager(), repository,
                getDbDirName(), orb.orbdDebugFlag);
