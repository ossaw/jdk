...
public final class OSFCodeSetRegistry {
     ...
     * equivalent Java character encoding name as well as some other facts from
     * the registry.
     */
    public final static class Entry {
        ...
        /**
         * Returns the Java equivalent name. If the encoding has an optional
         * byte order marker, this name will map to the Java encoding that
         * includes the marker.
         */
        ...
        /**
         * Is this a fixed or variable width code set? (In CORBA terms,
         * "non-byte-oriented" or a "byte-oriented" code set, respectively)
         */
        ...
        /**
         * First checks reference equality since it's expected people will use
         * the pre-defined constant Entries.
         */
     ...
     * marker. UTF-16BE and UTF-16LE are not in the OSF registry since it is no
     * longer being developed. When the OMG switches to the IANA registry, these
     * can be public. Right now, they're used internally by CodeSetConversion.
     */
     ...
     * encapsulations. However, since CORBA says chars are only one octet, it is
     * really the same as Latin-1.
     */
    ...
    /**
     * This is the encoding older JavaSoft ORBs advertised as their CORBA char
     ...
     * if an Entry for that value is unavailable.
     */
