...
/**
 * Describes CDRInputStream delegates and provides some implementation.
 * Non-default constructors are avoided in the delegation to separate
 * instantiation from initialization, so we use init methods.
 */
abstract class CDRInputStreamBase extends java.io.InputStream {
	...
	public abstract void init(org.omg.CORBA.ORB orb, ByteBuffer byteBuffer, int size,
	...
	public abstract void read_boolean_array(org.omg.CORBA.BooleanSeqHolder seq, int offset,
			int length);
	...
	public abstract void read_ushort_array(org.omg.CORBA.UShortSeqHolder seq, int offset,
			int length);
	...
	public abstract void read_ulonglong_array(org.omg.CORBA.ULongLongSeqHolder seq, int offset,
			int length);

	public abstract void read_longlong_array(org.omg.CORBA.LongLongSeqHolder seq, int offset,
			int length);

	public abstract void read_float_array(org.omg.CORBA.FloatSeqHolder seq, int offset, int length);

	public abstract void read_double_array(org.omg.CORBA.DoubleSeqHolder seq, int offset,
			int length);
