...
/**
 * EndpointInfo is used internally by CorbaLoc object to store the host
 * information used in creating the Service Object reference from the
 * -ORBInitDef and -ORBDefaultInitDef definitions.
 *
 * @Author Hemanth
 */
