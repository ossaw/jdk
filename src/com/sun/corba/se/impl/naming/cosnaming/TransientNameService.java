...
/**
 * Class TransientNameService implements a transient name service using
 * TransientNamingContexts and TransientBindingIterators, which implement the
 * org.omg.CosNaming::NamingContext and org.omg.CosNaming::BindingIterator
...
public class TransientNameService {
     ...
     * NamingContext, whose object reference can be obtained by the
     * initialNamingContext method.
     * 
     * @param orb
     *        The ORB object
     ...
     */
    public TransientNameService(com.sun.corba.se.spi.orb.ORB orb) throws org.omg.CORBA.INITIALIZE {
     ...
     * @param orb
     *        The ORB object
     * @param nameserviceName
     *        Stringified key used for INS Service registry
     * @exception org.omg.CORBA.INITIALIZE
     *            Thrown if the TransientNameService cannot initialize.
     */
    public TransientNameService(com.sun.corba.se.spi.orb.ORB orb, String serviceName)
     ...
     */
    private void initialize(com.sun.corba.se.spi.orb.ORB orb, String nameServiceName)
            throws org.omg.CORBA.INITIALIZE {
        NamingSystemException wrapper = NamingSystemException.get(orb, CORBALogDomains.NAMING);
        ...
        try {
            ...
            TransientNamingContext initialContext = new TransientNamingContext(orb, null, nsPOA);
            byte[] rootContextId = nsPOA.activate_object(initialContext);
            initialContext.localRoot = nsPOA.id_to_reference(rootContextId);
            theInitialNamingContext = initialContext.localRoot;
            orb.register_initial_reference(nameServiceName, theInitialNamingContext);
