...
/**
 * Class NameServer is a standalone application which implements a persistent
 * and a transient name service. It uses the PersistentNameService and
 * TransientNameService classes for the name service implementation.
 *
...
public class NameServer {
    ...
    protected NameServer(String args[]) {
        ...
        String dbDirName = props.getProperty(ORBConstants.DB_DIR_PROPERTY) + props.getProperty(
                "file.separator") + dbName + props.getProperty("file.separator");
    ...
    protected void run() {
        try {
            ...
            InitialNameService ins = InitialNameServiceHelper.narrow(orb.resolve_initial_references(
