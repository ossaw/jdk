 ...
 * There are two variants, to support whether or not multiple IDs per servant
 * are allowed. This class suppots bidirectional traversal of the key-servant
 * association. Access to an instance of this class is serialized by the POA
 * mutex.
 */
public abstract class ActiveObjectMap {
	...
	/**
	 * get Returbs the entry assigned to the key, or creates a new entry in
	 * state INVALID if none is present.
	 */
