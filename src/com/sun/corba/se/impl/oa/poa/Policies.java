...
public final class Policies {
    /*
     * Order of *POLICY_ID : THREAD_ LIFESPAN_ ID_UNIQUENESS_ ID_ASSIGNMENT_
     * IMPLICIT_ACTIVATION_ SERvANT_RETENTION_ REQUEST_PROCESSING_ The code in
     * this class depends on this order!
     */
    ...
    private HashMap policyMap = new HashMap(); // Maps Integer(policy type) to
                                               // Policy
    ...
    private Policies(int threadModel, int lifespan, int idUniqueness, int idAssignment,
        ...
        poaPolicyValues = new int[] { threadModel, lifespan, idUniqueness, idAssignment, implicitActivation,
                retention, requestProcessing };
    }
    ...
    private Policies() {
        this(ThreadPolicyValue._ORB_CTRL_MODEL, LifespanPolicyValue._TRANSIENT,
                ...
                ImplicitActivationPolicyValue._NO_IMPLICIT_ACTIVATION, ServantRetentionPolicyValue._RETAIN,
    ...
    /*
     * Returns the integer value of the POA policy, if this is a POA policy,
     * otherwise returns -1.
     */
    ...
    /**
     * If any errors were found, throw INVALID_POLICY with the smallest index of
     * any offending policy.
     */
    ...
    public final boolean useActiveMapOnly() {
        return getPolicyValue(
                REQUEST_PROCESSING_POLICY_ID.value) == RequestProcessingPolicyValue._USE_ACTIVE_OBJECT_MAP_ONLY;
    }

    public final boolean useDefaultServant() {
        return getPolicyValue(
                REQUEST_PROCESSING_POLICY_ID.value) == RequestProcessingPolicyValue._USE_DEFAULT_SERVANT;
    }

    public final boolean useServantManager() {
        return getPolicyValue(
                REQUEST_PROCESSING_POLICY_ID.value) == RequestProcessingPolicyValue._USE_SERVANT_MANAGER;
    }

    /* Implicit Activation */
    public final boolean isImplicitlyActivated() {
        return getPolicyValue(
                IMPLICIT_ACTIVATION_POLICY_ID.value) == ImplicitActivationPolicyValue._IMPLICIT_ACTIVATION;
    }
