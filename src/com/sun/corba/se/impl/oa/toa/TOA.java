 ...
 * (legacy JDK 1.2) object implementations. Its protocol for managing objects is
 * very simple: just connect and disconnect. There is only a single TOA instance
 * per ORB, and its lifetime is the same as the ORB. The TOA instance is always
