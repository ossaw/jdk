...
/**
 * Provides methods to convert between character positions and line numbers for
 * a compilation unit.
 *
 * @since 1.6
 */
...
public interface LineMap {
    ...
    /**
     * Find the line containing a position; a line termination character is on
    ...
    /**
     * Find the column for a character position. Tab characters preceding the
     * position on the same line will be expanded when calculating the column
     * number.
     *
     * @param pos
     *            character offset of the position
