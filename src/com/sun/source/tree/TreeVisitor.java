...
/**
 * A visitor of trees, in the style of the visitor design pattern. Classes
 * implementing this interface are used to operate on a tree when the kind of
 * tree is unknown at compile time. When a visitor is passed to an tree's
 * {@link Tree#accept accept} method, the <tt>visit<i>XYZ</i></tt> method most
 * applicable to that tree is invoked.
 *
 * <p>
