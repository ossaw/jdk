 ...
 *
 * <p>
 * <b>WARNING:</b> This interface and its sub-interfaces are subject to change
 * as the Java&trade; programming language evolves. These interfaces are
 * implemented by the JDK Java compiler (javac) and should not be implemented
 * either directly or indirectly by other applications.
 *
...
public interface Tree {
	...
	/**
	 * Used for instances of {@link AnnotationTree} representing declaration
	 * annotations.
	 */
	ANNOTATION(AnnotationTree.class),

	/**
	 * Used for instances of {@link AnnotationTree} representing type
	 * annotations.
	 */
	...
	/**
	 * Used for instances of {@link UnaryTree} representing prefix increment
	 * operator {@code ++}.
	 */
	PREFIX_INCREMENT(UnaryTree.class),

	/**
	 * Used for instances of {@link UnaryTree} representing prefix decrement
	 * operator {@code --}.
	 */
	...
	/**
	 * Used for instances of {@link BinaryTree} representing multiplication
	 * {@code *}.
	 */
	MULTIPLY(BinaryTree.class),

	/**
	 * Used for instances of {@link BinaryTree} representing division
	 * {@code /}.
	 */
	DIVIDE(BinaryTree.class),

	/**
	 * Used for instances of {@link BinaryTree} representing remainder
	 * {@code %}.
	 */
	REMAINDER(BinaryTree.class),

	/**
	 * Used for instances of {@link BinaryTree} representing addition or
	 * string concatenation {@code +}.
	 */
	PLUS(BinaryTree.class),

	/**
	 * Used for instances of {@link BinaryTree} representing subtraction
	 * {@code -}.
	 */
	MINUS(BinaryTree.class),

	/**
	 * Used for instances of {@link BinaryTree} representing left shift
	 * {@code <<}.
	 */
	LEFT_SHIFT(BinaryTree.class),

	/**
	 * Used for instances of {@link BinaryTree} representing right shift
	 * {@code >>}.
	 */
	RIGHT_SHIFT(BinaryTree.class),

	/**
	 * Used for instances of {@link BinaryTree} representing unsigned right
	 * shift {@code >>>}.
	 */
	UNSIGNED_RIGHT_SHIFT(BinaryTree.class),

	/**
	 * Used for instances of {@link BinaryTree} representing less-than
	 * {@code <}.
	 */
	LESS_THAN(BinaryTree.class),

	/**
	 * Used for instances of {@link BinaryTree} representing greater-than
	 * {@code >}.
	 */
	GREATER_THAN(BinaryTree.class),

	/**
	 * Used for instances of {@link BinaryTree} representing less-than-equal
	 * {@code <=}.
	 */
	...
	/**
	 * Used for instances of {@link BinaryTree} representing equal-to
	 * {@code ==}.
	 */
	EQUAL_TO(BinaryTree.class),

	/**
	 * Used for instances of {@link BinaryTree} representing not-equal-to
	 * {@code !=}.
	 */
	NOT_EQUAL_TO(BinaryTree.class),

	/**
	 * Used for instances of {@link BinaryTree} representing bitwise and
	 * logical "and" {@code &}.
	 */
	...
	/**
	 * Used for instances of {@link BinaryTree} representing conditional-and
	 * {@code &&}.
	 */
	CONDITIONAL_AND(BinaryTree.class),

	/**
	 * Used for instances of {@link BinaryTree} representing conditional-or
	 * {@code ||}.
	 */
	...
	/**
	 * Used for instances of {@link LiteralTree} representing an integral
	 * literal expression of type {@code int}.
	 */
	INT_LITERAL(LiteralTree.class),

	/**
	 * Used for instances of {@link LiteralTree} representing an integral
	 * literal expression of type {@code long}.
	 */
	LONG_LITERAL(LiteralTree.class),

	/**
	 * Used for instances of {@link LiteralTree} representing a
	 * floating-point literal expression of type {@code float}.
	 */
	FLOAT_LITERAL(LiteralTree.class),

	/**
	 * Used for instances of {@link LiteralTree} representing a
	 * floating-point literal expression of type {@code double}.
	 */
	DOUBLE_LITERAL(LiteralTree.class),

	/**
	 * Used for instances of {@link LiteralTree} representing a boolean
	 * literal expression of type {@code boolean}.
	 */
	BOOLEAN_LITERAL(LiteralTree.class),

	/**
	 * Used for instances of {@link LiteralTree} representing a character
	 * literal expression of type {@code char}.
	 */
	CHAR_LITERAL(LiteralTree.class),

	/**
	 * Used for instances of {@link LiteralTree} representing a string
	 * literal expression of type {@link String}.
	 */
	STRING_LITERAL(LiteralTree.class),

	/**
	 * Used for instances of {@link LiteralTree} representing the use of
	 * {@code null}.
	 */
	NULL_LITERAL(LiteralTree.class),

	/**
	 * Used for instances of {@link WildcardTree} representing an unbounded
	 * wildcard type argument.
	 */
	UNBOUNDED_WILDCARD(WildcardTree.class),

	/**
	 * Used for instances of {@link WildcardTree} representing an extends
	 * bounded wildcard type argument.
	 */
	EXTENDS_WILDCARD(WildcardTree.class),

	/**
	 * Used for instances of {@link WildcardTree} representing a super
	 * bounded wildcard type argument.
	 */
	...
	/**
	 * Used for instances of {@link ClassTree} representing annotation
	 * types.
	 */
	ANNOTATION_TYPE(ClassTree.class),

	/**
	 * An implementation-reserved node. This is the not the node you are
	 * looking for.
	 */
	OTHER(null);
	...
	/**
	 * Accept method used to implement the visitor pattern. The visitor pattern
