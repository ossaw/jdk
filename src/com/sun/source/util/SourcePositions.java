...
/**
 * Provides methods to obtain the position of a Tree within a CompilationUnit. A
 * position is defined as a simple character offset from the start of a
...
public interface SourcePositions {
    ...
    /**
     * Gets the starting position of tree within file. If tree is not found
     * within file, or if the starting position is not available, return
     ...
     * file, or if the ending position is not available, return
     * {@link javax.tools.Diagnostic#NOPOS}. The returned position must be at
