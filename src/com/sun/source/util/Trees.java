...
public abstract class Trees {
    ...
    public static Trees instance(CompilationTask task) {
        ...
        if (!taskClassName.equals("com.sun.tools.javac.api.JavacTaskImpl") && !taskClassName.equals(
    ...
    /**
     * Gets the Tree node for a given Element. Returns null if the node can not
     * be found.
     */
    public abstract Tree getTree(Element element);

    /**
     * Gets the ClassTree node for a given TypeElement. Returns null if the node
     * can not be found.
     */
    public abstract ClassTree getTree(TypeElement element);

    /**
     * Gets the MethodTree node for a given ExecutableElement. Returns null if
     * the node can not be found.
     */
    public abstract MethodTree getTree(ExecutableElement method);

    /**
     * Gets the Tree node for an AnnotationMirror on a given Element. Returns
     * null if the node can not be found.
     */
    ...
    /**
     * Gets the TreePath node for a given Element. Returns null if the node can
     * not be found.
     */
    ...
    /**
     * Gets the Scope for the Tree node identified by a given TreePath. Returns
     * null if the Scope is not available.
     */
    public abstract Scope getScope(TreePath path);

    /**
     * Gets the doc comment, if any, for the Tree node identified by a given
     * TreePath. Returns null if no doc comment was found.
     * 
    ...
    /**
     * Prints a message of the specified kind at the location of the tree within
     ...
     */
    public abstract void printMessage(Diagnostic.Kind kind, CharSequence msg, com.sun.source.tree.Tree t,
