...
public class XMLErrorResources extends ListResourceBundle {
    ...
    private static final Object[][] contents = {
            ...
            { ER_TYPED_ITERATOR_AXIS_NOT_IMPLEMENTED, "Error: typed iterator for axis  {0} not implemented" },
            ...
            { "BAD_CODE", "Parameter to createMessage was out of bounds" }, { "FORMAT_FAILED",
                    "Exception thrown during messageFormat call" }, { "line", "Line #" }, { "column",
                            "Column #" },
