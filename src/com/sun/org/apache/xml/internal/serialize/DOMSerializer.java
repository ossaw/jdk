...
public interface DOMSerializer {
    ...
    /**
     * Serialized the DOM element. Throws an exception only if an I/O exception
    ...
    /**
     * Serializes the DOM document. Throws an exception only if an I/O exception
     * occured while serializing.
     *
     * @param doc
    ...
    /**
     * Serializes the DOM document fragment. Throws an exception only if an I/O
