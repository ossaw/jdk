...
public final class HTMLdtd {
    ...
    /**
     * Table of reverse character reference mapping. Character codes are held as
     * single-character strings, mapped to their reference name.
     */
    ...
    /**
     * Locates the HTML entities file that is loaded upon initialization. This
     * file is a resource loaded with the default class loader.
     */
     ...
     * applies to PRE and TEXTAREA, all other HTML elements do not preserve
     * space.
     *
     * @param tagName
     *        The element tag name (upper case)
    ...
    /**
     * Returns true if the opening of one element (<tt>tagName</tt>) implies the
    ...
    public static boolean isClosing(String tagName, String openTag) {
        ...
        if (openTag.equalsIgnoreCase("THEAD") || openTag.equalsIgnoreCase("TFOOT") || openTag
                .equalsIgnoreCase("TBODY") || openTag.equalsIgnoreCase("TR") || openTag.equalsIgnoreCase(
                        "COLGROUP"))
     ...
     * appropriately. In HTML URIs are escaped differently than normal
     * attributes.
     *
     * @param tagName
     ...
     * printed without the value. This applies to attributes that are true if
     ...
     * optimized for character substitution. This method may be called any
     * number of times but will execute only once.
     */
        ...
        try {
            ...
            if (is == null) {
                throw new RuntimeException(DOMMessageFormatter.formatMessage(
                        DOMMessageFormatter.SERIALIZER_DOMAIN, "ResourceNotFound", new Object[] {
                                ENTITIES_RESOURCE }));
            }
            ...
            throw new RuntimeException(DOMMessageFormatter.formatMessage(
                    DOMMessageFormatter.SERIALIZER_DOMAIN, "ResourceNotLoaded", new Object[] {
