...
/**
 * Implements an HTML/XHTML serializer supporting both DOM and SAX pretty
 * serializing. HTML/XHTML mode is determined in the constructor. For usage
 ...
 * {@link #serialize} and SAX serializing is done by firing SAX events and using
 * the serializer as a document handler.
 * <p>
 ...
 * </ul>
 *
 * @deprecated This class was deprecated in Xerces 2.6.2. It is recommended that
 *             new applications use JAXP's Transformation API for XML (TrAX) for
 *             serializing HTML. See the Xerces documentation for more
 *             information.
...
public class HTMLSerializer extends BaseMarkupSerializer {
    ...
    public void startElement(String namespaceURI, String localName, String rawName, Attributes attrs)
        ...
        try {
            ...
            // As per SAX2, the namespace URI is an empty string if the element
            // has no
            // namespace URI, or namespaces is turned off. The check against
            // null protects
            ...
            if (!hasNamespaceURI)
                ...
                if (namespaceURI.equals(XHTMLNamespace) || (fUserXHTMLNamespace != null && fUserXHTMLNamespace
                        .equals(namespaceURI)))
                    htmlName = localName;
                else
                    htmlName = null;
            ...
            // unescaped (HTML).
            if (htmlName != null && (rawName.equalsIgnoreCase("SCRIPT") || rawName.equalsIgnoreCase(
                    "STYLE"))) {
                if (_xhtml) {
