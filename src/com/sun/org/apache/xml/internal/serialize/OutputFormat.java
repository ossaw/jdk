...
/**
 * Specifies an output format to control the serializer. Based on the XSLT
 * specification for output format, plus additional parameters. Used to select
 * the suitable serializer and determine how the document should be formatted on
 * output.
 * <p>
 * The two interesting constructors are:
 * <ul>
 * <li>{@link #OutputFormat(String,String,boolean)} creates a format for the
 * specified method (XML, HTML, Text, etc), encoding and indentation
...
public class OutputFormat {
	...
	/**
	 * Holds the output method specified for this document, or null if no method
	 * was specified.
	 */
	...
	/**
	 * The encoding to use, if an input stream is used. The default is always
	 * UTF-8.
	 */
	...
	/**
	 * List of element tag names whose text node children must be output as
	 * CDATA.
	 */
	private String[] _cdataElements;

	/**
	 * List of element tag names whose text node children must be output
	 * unescaped.
	 */
	...
	/**
	 * True if spaces should be preserved in elements that do not specify
	 * otherwise, or specify the default behavior.
	 */
	 ...
	 * method and encoding. If <tt>indent</tt> is true, the document will be
	 * pretty printed with the default indentation level and default line
	 * wrapping.
	 *
	 * @param method
	...
	/**
	 * Constructs a new output format with the proper method, document type
	...
	/**
	 * Constructs a new output format with the proper method, document type
	 * identifiers and media type for the specified document, and with the
	 * specified encoding. If <tt>indent</tt> is true, the document will be
	 * pretty printed with the default indentation level and default line
	 * wrapping.
	 *
	 * @param doc
	...
	/**
	 * Returns the method specified for this output format. Typically the method
	 * will be <tt>xml</tt>, <tt>html</tt> or <tt>text</tt>, but it might be
	 * other values. If no method was specified, null will be returned and the
	 * most suitable method will be determined for the document by calling
	 * {@link #whichMethod}.
	 *
	...
	/**
	 * Returns the version for this output method. If no version was specified,
	 * will return null and the default version number will be used. If the
	 * serializerr does not support that particular version, it should default
	...
	/**
	 * Sets the version for this output method. For XML the value would be
	 * "1.0", for HTML it would be "4.0".
	 *
	 * @see #getVersion
	 * @param version
	...
	/**
	 * Returns the indentation specified. If no indentation was specified, zero
	 * is returned and the document should not be indented.
	 *
	...
	/**
	 * Sets the indentation. The document will not be indented if the
	 * indentation is set to zero. Calling {@link #setIndenting} will reset this
	...
	/**
	 * Sets the indentation on and off. When set on, the default indentation
	 * level and default line wrapping is used (see {@link Defaults#Indent} and
	 * {@link Defaults#LineWidth}). To specify a different indentation level or
	...
	/**
	 * Returns the specified encoding. If no encoding was specified, the default
	 * is always "UTF-8".
	 *
	 * @return The encoding
	 */
	...
	/**
	 * Sets the encoding for this output method. If no encoding was specified,
	 * the default is always "UTF-8". Make sure the encoding is compatible with
	 * the one used by the {@link java.io.Writer}.
	 *
	 * @see #getEncoding
	 * @param encoding
	...
	/**
	 * Returns the specified media type, or null. To determine the media type
	 * based on the document type, use {@link #whichMediaType}.
	 *
	...
	/**
	 * Sets the document type public and system identifiers. Required only if
	 * the DOM Document or SAX events do not specify the document type, and one
	 * must be present in the serialized document. Any document type specified
	...
	/**
	 * Returns true if the DOCTYPE declaration should be ommited. The default is
	 * false.
	 */
	...
	/**
	 * Returns true if the XML document declaration should be ommited. The
	 * default is false.
	 */
	...
	/**
	 * Sets document DTD standalone. The public and system identifiers must be
	...
	/**
	 * Returns a list of all the elements whose text node children should be
	 * output as CDATA, or null if no such elements were specified.
	 */
	...
	/**
	 * Returns true if the text node children of the given elements should be
	 * output as CDATA.
	 *
	 * @param tagName
	...
	/**
	 * Sets the list of elements for which text node children should be output
	 * as CDATA.
	 *
	 * @param cdataElements
	...
	/**
	 * Returns a list of all the elements whose text node children should be
	 * output unescaped (no character references), or null if no such elements
	 * were specified.
	 */
	...
	/**
	 * Returns a specific line separator to use. The default is the Web line
	 ...
	 * <tt>\n</tt>). The machine's line separator can be obtained from the
	 * system property <tt>line.separator</tt>, but is only useful if the
	 * document is edited on machines of the same type. For general documents,
	...
	/**
	 * Returns true if the default behavior for this format is to preserve
	 * spaces. All elements that do not specify otherwise or specify the default
	 * behavior will be formatted based on this rule. All elements that specify
	 * space preserving will always preserve space.
	 */
	...
	/**
	 * Return the selected line width for breaking up long lines. When
	 * indenting, and only when indenting, long lines will be broken at space
	 * boundaries based on this line width. No line wrapping occurs if this
	 * value is zero.
	 */
	...
	/**
	 * Sets the line width. If zero then no line wrapping will occur. Calling
	 * {@link #setIndenting} will reset this value to zero (off) or the default
	 * (on).
	 *
	 * @param lineWidth
	 ...
	 * attributes with empty string values are output as the attribute name only
	 * (in HTML mode).
	 * 
	...
	/**
	 * Sets the preserveEmptyAttribute flag. If flag is false, then' attributes
	 * with empty string values are output as the attribute name only (in HTML
	 * mode).
	 * 
	 * @param preserve
	 *                 the preserve flag
	 ...
	 * Control characters and non-printable characters are always printed as
	...
	/**
	 * Determine the output method for the specified document. If the document
	 * is an instance of {@link org.w3c.dom.html.HTMLDocument} then the method
	 * is said to be <tt>html</tt>. If the root element is 'html' and all text
	 * nodes preceding the root element are all whitespace, then the method is
	...
	/**
	 * Returns the document type public identifier specified for this document,
	 * or null.
	 */
	...
	/**
	 * Returns the document type system identifier specified for this document,
	 * or null.
	 */
	...
	/**
	 * Returns the suitable media format for a document output with the
	 * specified method.
	 */
