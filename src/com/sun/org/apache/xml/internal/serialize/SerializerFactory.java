...
public abstract class SerializerFactory {
    ...
    /**
     * Returns the method supported by this factory and used to register the
     * factory. This call is required so factories can be added from a
     * properties file by knowing only the class name. This method is protected,
     * it is only required by this class but must be implemented in derived
     * classes.
     */
    protected abstract String getSupportedMethod();

    /**
     * Create a new serializer based on the {@link OutputFormat}. If this method
     * is used to create the serializer, the
     * {@link Serializer#setOutputByteStream} or
     * {@link Serializer#setOutputCharStream} methods must be called before
