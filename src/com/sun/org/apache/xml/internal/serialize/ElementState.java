...
public class ElementState {
	...
	/**
	 * True if element is empty. Turns false immediately after serializing the
	 * first contents of the element.
	 */
	...
	/**
	 * True if textual content of current element should be serialized as CDATA
	 * section.
	 */
	public boolean doCData;

	/**
	 * True if textual content of current element should be serialized as raw
