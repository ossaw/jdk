 ...
 * "PUBLIC" has two arguments, a public identifier and a system identifier. Each
...
public class CatalogEntry {
	...
	/**
	 * The entryTypes vector maps catalog entry names (e.g., 'BASE' or 'SYSTEM')
	 * to their type (1, 2, etc.). Names are case sensitive.
	 */
	protected static final Map<String, Integer> entryTypes = new ConcurrentHashMap<>();

	/**
	 * The entryTypes vector maps catalog entry types to the number of arguments
	 ...
	 * URI. But in general, this function should only be called shortly after
	 * object creation to do some sort of cleanup. Catalog entries should not
	 * mutate over time.
	 * </p>
	 *
	 * @param argNum
