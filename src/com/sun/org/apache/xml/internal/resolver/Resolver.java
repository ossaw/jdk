...
/**
 * An extension to OASIS Open Catalog files, this class supports suffix-based
...
public class Resolver extends Catalog {
	 ...
	 * Further, if a systemId is present, the external resolver(s) will be
	 * queried for that before the publicId.
	 * </p>
	 *
	 * @param publicId
	...
	protected Resolver queryResolver(String resolver, String command, String arg1, String arg2) {
		...
		String RFC2483 = resolver + "?command=" + command + "&format=tr9401&uri=" + arg1 + "&uri2="
				+ arg2;
		String line = null;
	 ...
	 * public, and system identifiers. In some contexts, these may be null.
	 * </p>
	 *
	 * @param entityType
