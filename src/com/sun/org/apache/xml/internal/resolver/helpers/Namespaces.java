...
public class Namespaces {
    /**
     * Returns the "prefix" part of a QName or the empty string (not null) if
    ...
    /**
     * Returns the "localname" part of a QName, which is the whole name if it
     * has no prefix.
     *
     * @param element
     *        The QName of an element.
    ...
    /**
     * Returns the namespace URI for the specified prefix at the specified
     * context node.
     *
     * @param node
     *        The context node.
