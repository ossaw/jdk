...
public class OASISXMLCatalogReader extends SAXCatalogReader implements SAXCatalogParser {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts)
        ...
        if (namespaceURI != null && namespaceName.equals(namespaceURI) && !inExtension) {
            ...
            if ((localName.equals("catalog") || localName.equals("group")) && atts.getValue(
                    "prefer") != null) {
            ...
            if (localName.equals("delegatePublic")) {
                if (checkAttributes(atts, "publicIdStartString", "catalog")) {
                    ...
                    debug.message(4, "delegatePublic", PublicId.normalize(atts.getValue(
                            "publicIdStartString")), atts.getValue("catalog"));
                }
                ...
                if (checkAttributes(atts, "systemIdStartString", "catalog")) {
                    ...
                    debug.message(4, "delegateSystem", atts.getValue("systemIdStartString"), atts.getValue(
                            "catalog"));
                }
                ...
                if (checkAttributes(atts, "uriStartString", "catalog")) {
                    ...
                    debug.message(4, "delegateURI", atts.getValue("uriStartString"), atts.getValue(
                            "catalog"));
                }
                ...
                if (checkAttributes(atts, "systemIdStartString", "rewritePrefix")) {
                    ...
                    debug.message(4, "rewriteSystem", atts.getValue("systemIdStartString"), atts.getValue(
                            "rewritePrefix"));
                }
                ...
                if (checkAttributes(atts, "uriStartString", "rewritePrefix")) {
                    ...
                    debug.message(4, "rewriteURI", atts.getValue("uriStartString"), atts.getValue(
                            "rewritePrefix"));
                }
                ...
                if (checkAttributes(atts, "publicId", "uri")) {
                    ...
                    debug.message(4, "public", PublicId.normalize(atts.getValue("publicId")), atts.getValue(
                            "uri"));
                }
    ...
    public void endElement(String namespaceURI, String localName, String qName) throws SAXException {
        ...
        if (namespaceURI != null && !inExtension && (namespaceName.equals(namespaceURI) || tr9401NamespaceName
                .equals(namespaceURI))) {
