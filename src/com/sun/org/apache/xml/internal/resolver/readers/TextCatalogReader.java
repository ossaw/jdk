...
public class TextCatalogReader implements CatalogReader {
	...
	/**
	 * Character lookahead stack. Reading a catalog sometimes requires up to two
	 * characters of lookahead.
	 */
	protected int[] stack = new int[3];

	/**
	 * Token stack. Recognizing an unexpected catalog entry requires the ability
	...
	/**
	 * Start parsing a text catalog file. The file is actually read and parsed
