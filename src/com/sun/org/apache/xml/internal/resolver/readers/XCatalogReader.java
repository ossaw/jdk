...
/**
 * Parse "xcatalog" XML Catalog files, this is the XML Catalog format developed
 * by John Cowan and supported by Apache.
 *
 * @see Catalog
 * @author Norman Walsh
...
public class XCatalogReader extends SAXCatalogReader implements SAXCatalogParser {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts)
        ...
        if (localName.equals("Base")) {
            ...
            catalog.getCatalogManager().debug.message(4, "Delegate", PublicId.normalize(atts.getValue(
                    "PublicId")), atts.getValue("HRef"));
            ...
            catalog.getCatalogManager().debug.message(4, "Map", PublicId.normalize(atts.getValue("PublicId")),
                    atts.getValue("HRef"));
            ...
            catalog.getCatalogManager().debug.message(4, "Remap", atts.getValue("SystemId"), atts.getValue(
                    "HRef"));
