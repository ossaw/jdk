 ...
 * make it so. Note that it makes more sense in many cases to set up fields to
 * hold this data rather than pointing at another object... but that decision
 * should be made on architectural grounds rather than serializability.
 * <p>
 * It isn't clear whether subclassing LocatorImpl and adding serialization
 * methods makes more sense than copying it and just adding Serializable to its
...

{
     ...
     * _is_ sometimes useful when you want to construct a new Locator pointing
     * to a specific location... which, after all, is why the setter methods are
     * provided.
     * </p>
     */
     ...
     * (and it can be used outside the scope of DocumentHandler methods).
     * </p>
     *
     * @param locator
     *        The locator to copy.
