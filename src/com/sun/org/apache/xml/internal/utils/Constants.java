...
public class Constants {
     ...
     * <ul>
     * <li>S_XMLNAMESPACEURI (http://www.w3.org/XML/1998/namespace) is the URI
     * permanantly assigned to the "xml:" prefix. This is used for some features
     * built into the XML specification itself, such as xml:space and xml:lang.
     * It was defined by the W3C's XML Namespaces spec.</li>
     * <li>S_XSLNAMESPACEURL (http://www.w3.org/1999/XSL/Transform) is the URI
     * which indicates that a name may be an XSLT directive. In most XSLT
     * stylesheets, this is bound to the "xsl:" prefix. It's defined by the
     * W3C's XSLT Recommendation.</li>
     * <li>S_OLDXSLNAMESPACEURL (http://www.w3.org/XSL/Transform/1.0) was used
     * in early prototypes of XSLT processors for much the same purpose as
     * S_XSLNAMESPACEURL. It is now considered obsolete, and the version of XSLT
     * which it signified is not fully compatable with the final XSLT
     * Recommendation, so what it really signifies is a badly obsolete
     * stylesheet.</li>
     * </ul>
     */
    ...
    /**
     * Authorship mnemonics, as Java Strings. Not standardized, as far as I
     * know.
     * <ul>
     * <li>S_VENDOR -- the name of the organization/individual who published
     * this XSLT processor.</li>
     * <li>S_VENDORURL -- URL where one can attempt to retrieve more information
