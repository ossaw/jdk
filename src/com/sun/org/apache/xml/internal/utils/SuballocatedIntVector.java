 ...
 *
 * Retrieval performance is critical, since this is used at the core of the DTM
 * model. (Append performance is almost as important.) That's pushing me toward
 * just letting reads from unset indices throw exceptions or return stale data;
 * safer behavior would have performance costs.
 */
public class SuballocatedIntVector {
	...
	/**
	 * "Shortcut" handle to most recently added row of m_map. Very helpful
	 * during construction.
	 * 
	 * @xsl.usage internal
	 */
	...
	/**
	 * Default constructor. Note that the default block size is currently 2K,
	 * which may be overkill for small lists and undershootng for large ones.
	 */
	...
	/**
	 * Construct a IntVector, using the given block size and the default number
	 * of blocks (32).
	 *
	 * @param blocksize
	 *                  Size of block to allocate
