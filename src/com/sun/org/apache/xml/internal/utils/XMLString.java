 ...
 * java Strings or
 * <code>com.sun.org.apache.xml.internal.utils.FastStringBuffer</code>s, or
 * other character data. By using XMLString, character copies can be reduced in
 * the XML pipeline.
 */
public interface XMLString {
     ...
     * and is an <code>XMLString</code> object that represents the same sequence
     ...
     * <p>
     * This method may be used to trim {@link Character#isSpace(char)
     * whitespace} from the beginning and end of a string; in fact, it trims all
