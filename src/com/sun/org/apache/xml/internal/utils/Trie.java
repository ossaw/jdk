 ...
 * java.util.Hashtable The key must be a 7-bit ASCII string The value may be any
 * Java Object
 * 
 * @xsl.usage internal
 */
public class Trie {
    ...
    public Object get(final String key) {
        ...
        /*
         * If the name is too long, we won't find it, this also keeps us from
         * overflowing m_charBuffer
         */
