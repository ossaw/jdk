...
/**
 * <meta name="usage" content="internal"/> To be subclassed by classes that wish
 * to fake being nodes.
 */
public class UnImplNode implements Node, Element, NodeList, Document {
    ...
    public void error(String msg, Object[] args) {
        ...
        throw new RuntimeException(XMLMessages.createXMLMessage(msg, args)); // "UnImplNode
                                                                             // error:
                                                                             // "+msg);
    }
    ...
    public NodeList getElementsByTagName(String name) {
        ...
        error(XMLErrorResources.ER_FUNCTION_NOT_SUPPORTED); // "getElementsByTagName
                                                            // not supported!");
     ...
     *
     * @param oldAttr
     *        Attribute to be removed from this node's list of
     *        attributes
     * @return null
     * @throws DOMException
     */
    public Attr removeAttributeNode(Attr oldAttr) throws DOMException {
        ...
        error(XMLErrorResources.ER_FUNCTION_NOT_SUPPORTED); // "removeAttributeNode
                                                            // not supported!");
     ...
     *
     * @param newAttr
     *        Attribute node to be added to this node's list of
     *        attributes
     * @return null
     * @throws DOMException
     */
    ...
    public NodeList getElementsByTagNameNS(String namespaceURI, String localName) {
        ...
        error(XMLErrorResources.ER_FUNCTION_NOT_SUPPORTED); // "getElementsByTagNameNS
                                                            // not supported!");
    ...
    public Attr setAttributeNodeNS(Attr newAttr) throws DOMException {
        ...
        error(XMLErrorResources.ER_FUNCTION_NOT_SUPPORTED); // "setAttributeNodeNS
                                                            // not supported!");
    ...
    public Attr getAttributeNodeNS(String namespaceURI, String localName) {
        ...
        error(XMLErrorResources.ER_FUNCTION_NOT_SUPPORTED); // "getAttributeNodeNS
                                                            // not supported!");
    ...
    public void removeAttributeNS(String namespaceURI, String localName) throws DOMException {
        error(XMLErrorResources.ER_FUNCTION_NOT_SUPPORTED); // "removeAttributeNS
                                                            // not supported!");
    }
    ...
    public Node getPreviousSibling() {
        ...
        error(XMLErrorResources.ER_FUNCTION_NOT_SUPPORTED); // "getPreviousSibling
                                                            // not supported!");
     ...
     *        specified, supporting any version of the feature will
     *        cause
    ...
    /**
     * DOM Level 3 WD - Experimental. An attribute specifying the actual
     * encoding of this document. This is <code>null</code> otherwise. <br>
    ...
    /**
     * DOM Level 3 WD - Experimental. Returns all text of <code>Text</code>
     * nodes logically-adjacent text nodes to this node, concatenated in
     * document order.
     * 
     * @since DOM Level 3
     */
    ...
    /**
     * DOM Level 3 WD - Experimental. Returns whether this text node contains
     * whitespace in element content, often abusively called
