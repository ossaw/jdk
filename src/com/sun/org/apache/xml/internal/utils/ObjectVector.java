 ...
 *
 * This version is based on a "realloc" strategy -- a simle array is used, and
 ...
 * fast but appending may be O(N**2) slow.
 * 
 * @xsl.usage internal
 */
public class ObjectVector implements Cloneable {
	...
	/**
	 * Inserts the specified object in this vector at the specified index. Each
