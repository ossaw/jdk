...
/**
 * THIS IS A COPY OF THE XERCES-2J CLASS
 * com.sun.org.apache.xerces.internal.utls.XMLChar
 *
...
public class XML11Char {
	...
	static {
		...
		Arrays.fill(XML11CHARS, 45, 47, (byte) -87); // Fill 2 of value (byte)
														// -87
		XML11CHARS[47] = 33;
		Arrays.fill(XML11CHARS, 48, 58, (byte) -87); // Fill 10 of value (byte)
														// -87
		XML11CHARS[58] = 45;
		XML11CHARS[59] = 33;
		XML11CHARS[60] = 1;
		Arrays.fill(XML11CHARS, 61, 65, (byte) 33); // Fill 4 of value (byte) 33
		Arrays.fill(XML11CHARS, 65, 91, (byte) -19); // Fill 26 of value (byte)
														// -19
		...
		XML11CHARS[95] = -19;
		XML11CHARS[96] = 33;
		Arrays.fill(XML11CHARS, 97, 123, (byte) -19); // Fill 26 of value (byte)
														// -19
		Arrays.fill(XML11CHARS, 123, 127, (byte) 33); // Fill 4 of value (byte)
														// 33
		Arrays.fill(XML11CHARS, 127, 133, (byte) 17); // Fill 6 of value (byte)
														// 17
		XML11CHARS[133] = 35;
		Arrays.fill(XML11CHARS, 134, 160, (byte) 17); // Fill 26 of value (byte)
														// 17
		Arrays.fill(XML11CHARS, 160, 183, (byte) 33); // Fill 23 of value (byte)
														// 33
		XML11CHARS[183] = -87;
		Arrays.fill(XML11CHARS, 184, 192, (byte) 33); // Fill 8 of value (byte)
														// 33
		...
		Arrays.fill(XML11CHARS, 8304, 8592, (byte) -19); // Fill 288 of value
															// (byte) -19
		Arrays.fill(XML11CHARS, 8592, 11264, (byte) 33); // Fill 2672 of value
															// (byte) 33
		Arrays.fill(XML11CHARS, 11264, 12272, (byte) -19); // Fill 1008 of value
															// (byte) -19
		Arrays.fill(XML11CHARS, 12272, 12289, (byte) 33); // Fill 17 of value
															// (byte) 33
		Arrays.fill(XML11CHARS, 12289, 55296, (byte) -19); // Fill 43007 of
															// value (byte) -19
		Arrays.fill(XML11CHARS, 57344, 63744, (byte) 33); // Fill 6400 of value
															// (byte) 33
		Arrays.fill(XML11CHARS, 63744, 64976, (byte) -19); // Fill 1232 of value
															// (byte) -19
	...
	/**
	 * Returns true if the specified character is a space character as amdended
	...
	/**
	 * Returns true if the specified character is valid and permitted outside of
	 * a character reference. That is, this method will return false for the
	 * same set as isXML11Valid, except it also reports false for
	 * "control characters".
	 *
	 * @param c
	 *            The character to check.
	...
	public static boolean isXML11ValidLiteral(int c) {
		return ((c < 0x10000 && ((XML11CHARS[c] & MASK_XML11_VALID) != 0
				&& (XML11CHARS[c] & MASK_XML11_CONTROL) == 0)) || (0x10000 <= c && c <= 0x10FFFF));
