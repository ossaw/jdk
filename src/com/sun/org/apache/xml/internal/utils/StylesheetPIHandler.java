...
public class StylesheetPIHandler extends DefaultHandler {
	 ...
	 *
	 * @param baseID
	 *            The base ID of the XML document, needed to resolve relative
	 *            IDs.
	 * @param media
	 *            The desired media criteria.
	 * @param title
	...
	public void processingInstruction(String target, String data) throws org.xml.sax.SAXException {
		...
		if (target.equals("xml-stylesheet")) {
			...
			if ((null != type) && (type.equals("text/xsl") || type.equals("text/xml")
					|| type.equals("application/xml+xslt")) && (null != href)) {
				if (null != m_media) {
					if (null != media) {
	...
	/**
	 * The spec notes that
	 * "The xml-stylesheet processing instruction is allowed only in the prolog of an XML document."
