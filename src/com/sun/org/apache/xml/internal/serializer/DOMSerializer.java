 ...
 * asDOMSerializer() method of the Serializer interface. A serializer may or may
 * not support a DOM serializer, if it does not then the return value from
 * asDOMSerializer() is null.
 * <p>
 * Example:
 * 
 * <pre>
