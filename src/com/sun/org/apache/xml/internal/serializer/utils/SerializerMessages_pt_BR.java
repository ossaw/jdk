...
/**
 * An instance of this class is a ListResourceBundle that has the required
 * getContents() method that returns an array of message-key/message
 * associations.
 * <p>
 * The message keys are defined in {@link MsgKey}. The messages that those keys
...
public class SerializerMessages_pt_BR extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        Object[][] contents = new Object[][] { { MsgKey.BAD_MSGKEY,
                 ...
                 */
                { MsgKey.ER_NAMESPACE_PREFIX, "O namespace do prefixo ''{0}'' n\u00E3o foi declarado." },
                ...
                { MsgKey.ER_HOST_ADDRESS_NOT_WELLFORMED, "O host n\u00E3o \u00E9 um endere\u00E7o correto" },
                ...
                { MsgKey.ER_PATH_INVALID_CHAR, "O caminho cont\u00E9m um caractere inv\u00E1lido: {0}" },

                { MsgKey.ER_FRAG_INVALID_CHAR, "O fragmento cont\u00E9m um caractere inv\u00E1lido" },
                 ...
                 * 'SerializerFactory' in this message are Java class names and
