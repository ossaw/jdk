...
/**
 * Administrative class to keep track of the version number of the Serializer
 * release.
 * <P>
...
public final class Version {
	...
	/**
	 * Get the basic version string for the current Serializer. Version String
	 * formatted like
	...
	public static String getVersion() {
		return getProduct() + " " + getImplementationLanguage() + " " + getMajorVersionNum() + "."
				+ getReleaseVersionNum() + "." + ((getDevelopmentVersionNum() > 0)
