...
final class URI {
	...
	public URI(String p_scheme, String p_userinfo, String p_host, int p_port, String p_path,
		...
		if (p_scheme == null || p_scheme.trim().length() == 0) {
			throw new MalformedURIException(
					Utils.messages.createMessage(MsgKey.ER_SCHEME_REQUIRED, null)); // "Scheme
																					// is
																					// required!");
		}
		...
		if (p_host == null) {
			if (p_userinfo != null) {
				throw new MalformedURIException(
						Utils.messages.createMessage(MsgKey.ER_NO_USERINFO_IF_NO_HOST, null)); // "Userinfo
																								// may
																								// not
																								// be
																								// specified
			...
			if (p_port != -1) {
				throw new MalformedURIException(
						Utils.messages.createMessage(MsgKey.ER_NO_PORT_IF_NO_HOST, null)); // "Port
																							// may
																							// not
																							// be
																							// specified
		...
		if (p_path != null) {
			if (p_path.indexOf('?') != -1 && p_queryString != null) {
				throw new MalformedURIException(
						Utils.messages.createMessage(MsgKey.ER_NO_QUERY_STRING_IN_PATH, null)); // "Query
																								// string
																								// cannot
																								// be
																								// specified
			...
			if (p_path.indexOf('#') != -1 && p_fragment != null) {
				throw new MalformedURIException(
						Utils.messages.createMessage(MsgKey.ER_NO_FRAGMENT_STRING_IN_PATH, null)); // "Fragment
																									// cannot
																									// be
																									// specified
																									// in
	...
	private void initialize(URI p_base, String p_uriSpec) throws MalformedURIException {
		...
		if (p_base == null && (p_uriSpec == null || p_uriSpec.trim().length() == 0)) {
			throw new MalformedURIException(
					Utils.messages.createMessage(MsgKey.ER_CANNOT_INIT_URI_EMPTY_PARMS, null)); // "Cannot
																								// initialize
																								// URI
																								// with
																								// empty
		...
		if (colonIndex < 0) {
			if (p_base == null) {
				throw new MalformedURIException(Utils.messages
						.createMessage(MsgKey.ER_NO_SCHEME_IN_URI, new Object[] { uriSpec })); // "No
																								// scheme
																								// found
																								// in
																								// URI:
	...
	private void initializeScheme(String p_uriSpec) throws MalformedURIException {
		...
		if (scheme.length() == 0) {
			throw new MalformedURIException(
					Utils.messages.createMessage(MsgKey.ER_NO_SCHEME_INURI, null)); // "No
																					// scheme
																					// found
																					// in
																					// URI.");
		...
		while (index < end) {
			...
			if (testChar == '%') {
				if (index + 2 >= end || !isHex(p_uriSpec.charAt(index + 1))
					...
					throw new MalformedURIException(Utils.messages
							.createMessage(MsgKey.ER_PATH_CONTAINS_INVALID_ESCAPE_SEQUENCE, null)); // "Path
																									// contains
																									// invalid
																									// escape
																									// sequence!");
				...
				if ('\\' != testChar)
					throw new MalformedURIException(
							Utils.messages.createMessage(MsgKey.ER_PATH_INVALID_CHAR,
	...
	public void setScheme(String p_scheme) throws MalformedURIException {
		...
		if (p_scheme == null) {
			throw new MalformedURIException(
					Utils.messages.createMessage(MsgKey.ER_SCHEME_FROM_NULL_STRING, null)); // "Cannot
																							// set
																							// scheme
																							// from
																							// null
		...
		if (!isConformantSchemeName(p_scheme)) {
			throw new MalformedURIException(
					Utils.messages.createMessage(MsgKey.ER_SCHEME_NOT_CONFORMANT, null)); // "The
																							// scheme
																							// is
																							// not
																							// conformant.");
	...
	public void setHost(String p_host) throws MalformedURIException {
		...
		if (p_host == null || p_host.trim().length() == 0) {
			...
			throw new MalformedURIException(
					Utils.messages.createMessage(MsgKey.ER_HOST_ADDRESS_NOT_WELLFORMED, null)); // "Host
																								// is
																								// not
																								// a
																								// well
	...
	public void setPort(int p_port) throws MalformedURIException {
		...
		if (p_port >= 0 && p_port <= 65535) {
			if (m_host == null) {
				throw new MalformedURIException(
						Utils.messages.createMessage(MsgKey.ER_PORT_WHEN_HOST_NULL, null)); // "Port
																							// cannot
																							// be
																							// set
																							// when
			...
			throw new MalformedURIException(
					Utils.messages.createMessage(MsgKey.ER_INVALID_PORT, null)); // "Invalid
																					// port
																					// number!");
		}
	...
	public void appendPath(String p_addToPath) throws MalformedURIException {
		...
		if (!isURIString(p_addToPath)) {
			throw new MalformedURIException(Utils.messages
					.createMessage(MsgKey.ER_PATH_INVALID_CHAR, new Object[] { p_addToPath })); // "Path
																								// contains
																								// invalid
																								// character!");
		}
	 ...
	 *
	 * @throws MalformedURIException
	 *             if p_queryString is not null and this URI does not conform to
	...
	public void setFragment(String p_fragment) throws MalformedURIException {
		...
		if (p_fragment == null) {
			...
			throw new MalformedURIException(
					Utils.messages.createMessage(MsgKey.ER_FRAG_FOR_GENERIC_URI, null)); // "Fragment
																							// can
																							// only
																							// be
																							// set
			...
			throw new MalformedURIException(
					Utils.messages.createMessage(MsgKey.ER_FRAG_WHEN_PATH_NULL, null)); // "Fragment
																						// cannot
																						// be
																						// set
																						// when
			...
			throw new MalformedURIException(
					Utils.messages.createMessage(MsgKey.ER_FRAG_INVALID_CHAR, null)); // "Fragment
																						// contains
																						// invalid
																						// character!");
		} else {
