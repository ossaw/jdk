 ...
 * xml.sax.Attributes. But for optimization this class adds a Map for faster
 * lookup of an index by qName, which is commonly done in the stream serializer.
 *
...
public final class AttributesImplSerializer extends AttributesImpl {
    /**
     * Hash table of qName/index values to quickly lookup the index of an
     ...
     * can be tuned, but 12 seems good for now - Brian M.
     */
    ...
    /**
     * We are switching over to having a hash table for quick look up of
     * attributes, but up until now we haven't kept any information in the Map,
     * so we now update the Map. Future additional attributes will update the
     * Map as they are added.
     * 
     * @param numAtts
     */
    ...
    /**
     * This method sets the attributes, previous attributes are cleared, it also
