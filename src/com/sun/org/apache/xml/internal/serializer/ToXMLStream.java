...
public final class ToXMLStream extends ToStream {
		...
		if (m_needToCallStartDocument) {
			...
			if (getOmitXMLDeclaration() == false) {
				...
				try {
					...
					writer.write("?>");
					if (m_doIndent) {
						if (m_standaloneWasSpecified || getDoctypePublic() != null
								|| getDoctypeSystem() != null || m_isStandalone) {
	 ...
	 * @param xslAttribute
	 *            true if this attribute is from an xsl:attribute, false if
	...
	public void addAttribute(String uri, String localName, String rawName, String type,
		...
		if (m_elemContext.m_startTagOpen) {
			...
			String msg = Utils.messages.createMessage(MsgKey.ER_ILLEGAL_ATTRIBUTE_POSITION,
	...
	private String getXMLVersion() {
		...
		if (xmlVersion == null || xmlVersion.equals(XMLVERSION10)) {
			...
			String msg = Utils.messages.createMessage(MsgKey.ER_XML_VERSION_NOT_SUPPORTED,
					new Object[] { xmlVersion });
			try {
				// Prepare to issue the warning message
				Transformer tran = super.getTransformer();
				ErrorListener errHandler = tran.getErrorListener();
