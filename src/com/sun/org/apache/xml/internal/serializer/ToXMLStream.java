...
public final class ToXMLStream extends ToStream {
    ...
    public void addAttribute(String uri, String localName, String rawName, String type, String value,
        ...
        if (m_elemContext.m_startTagOpen) {
            ...
            String msg = Utils.messages.createMessage(MsgKey.ER_ILLEGAL_ATTRIBUTE_POSITION, new Object[] {
                    localName });
    ...
    private String getXMLVersion() {
        ...
        if (xmlVersion == null || xmlVersion.equals(XMLVERSION10)) {
            ...
            String msg = Utils.messages.createMessage(MsgKey.ER_XML_VERSION_NOT_SUPPORTED, new Object[] {
                    xmlVersion });
            try {
                // Prepare to issue the warning message
                Transformer tran = super.getTransformer();
