...
public interface Serializer {
	 ...
	 * <p>
	 * The encoding specified in the output {@link Properties} is used, or if no
	 ...
	 * "encoding", "omit-xml-declaration", "standalone", doctype-public",
	 * "doctype-system", "cdata-section-elements", "indent", "media-type". These
	 * property keys and their values are described in the XSLT recommendation,
	 ...
	 * specified. One property value that can not be changed is that of the
	 * "method" property key.
	 * <p>
	 * The value of the "cdata-section-elements" property key is a whitespace
	 * separated list of elements. If the element is in a namespace then value
	 * is passed in this format: {uri}localName
	 * <p>
	 * If the "cdata-section-elements" key is specified on multiple calls to
	 * this method the set of elements specified in the value is not replaced
	 ...
	 * Through the returned object the document to be serailized, as a series of
	 * SAX events, can be provided to the serialzier. If the serializer does not
	 * support the {@link ContentHandler} interface, it will return null.
	 * <p>
	 * In principle only one of asDOMSerializer() or asContentHander() should be
	 * called.
	 *
	...
	/**
	 * Return a {@link DOMSerializer} interface into this serializer. Through
	 * the returned object the document to be serialized, a DOM, can be provided
	 * to the serializer. If the serializer does not support the
	 * {@link DOMSerializer} interface, it should return null.
	 * <p>
	 * In principle only one of asDOMSerializer() or asContentHander() should be
	 * called.
	 *
	 ...
	 * serializer may be used for subsequent serialization of new documents. It
	 * is possible to change the output format and output stream prior to
	 * serializing, or to reuse the existing output format and output stream or
	 * writer.
	 *
