...
public final class OutputPropertiesFactory {
     ...
     * of this package, it is the length of the old built-in extension
     * namespace.
     */
    public static final int S_BUILTIN_OLD_EXTENSIONS_UNIVERSAL_LEN = S_BUILTIN_OLD_EXTENSIONS_UNIVERSAL
            .length();

    /**
     * This non-standard, Oracle-impl only property key is used as if
     * OutputKeys.STANDALONE is specified but without writing it out in the
     * declaration; It can be used to reverse the change by Xalan patch 1495.
     ...
     * standalone</li>
     * <li><code>no</code> has no effect.</li>
     * </ul>
     */
    ...
    private static Class findAccessControllerClass() {
        try {
            ...
            // giving privileges to certain part of code using doPrivileged
            // block.
            ...
            // User may be using older JDK ( JDK <1.2 ). Allow him/her to use
            // it.
     ...
     * "org.apache.xslt.xxx", fix up the start of string to be a curly
     * namespace. If a key name starts with "xslt.output.xxx", clip off
     * "xslt.output.". If a key name *or* a key value is discovered, check for
     * \u003a in the text, and fix it up to be ":", since earlier versions of
