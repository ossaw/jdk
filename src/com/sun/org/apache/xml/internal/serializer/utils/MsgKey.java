...
/**
 * This class is not a public API, It is used internally by serializer and is
 * public, in the Java sense, only because its use crosses package boundaries.
 * <p>
...
public class MsgKey {
	...
	/**
	 * An internal error with the messages, this is the message to use if the
	 * message key can't be found
	 */
