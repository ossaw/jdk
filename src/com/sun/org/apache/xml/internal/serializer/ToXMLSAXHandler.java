...
public final class ToXMLSAXHandler extends ToSAXHandler {
    ...
    /**
     * This method is called when all the data needed for a call to the SAX
     * handler's startElement() method has been gathered.
     */
    ...
    /**
     * Closes ane open cdata tag, and unlike the this.endCDATA() method (from
     * the LexicalHandler) interface, this "internal" method will send the
     * endCDATA() call to the wrapped handler.
     */
    ...
    public boolean startPrefixMapping(String prefix, String uri, boolean shouldFlush)
        ...
        if (pushed) {
            ...
            if (getShouldOutputNSAttr()) {
                ...
                /*
                 * Brian M.: don't know if we really needto do this. The callers
                 * of this object should have injected both startPrefixMapping
                 * and the attributes. We are just covering our butt here.
                 */
                String name;
                if (EMPTYSTRING.equals(prefix)) {
                    ...
                    { // that maps ns1 prefix to "" URI
                        ...
                        /*
                         * for something like xmlns:abc="w3.pretend.org" the uri
    ...
    public void characters(char[] ch, int off, int len) throws SAXException {
        ...
        /*
         * If there are any occurances of "]]>" in the character data let
         * m_saxHandler worry about it, we've already warned them with the
         * previous call of m_lexHandler.startCDATA();
         */
    ...
    public void startCDATA() throws SAXException {
        /*
         * m_cdataTagOpen can only be true here if we have ignored the previous
         * call to this.endCDATA() and the previous call this.startCDATA()
         * before that is still "open". In this way we merge adjacent CDATA. If
         * anything else happened after the ignored call to this.endCDATA() and
         * this call then a call to flushPending() would have been made which
         * would have closed the CDATA and set m_cdataTagOpen to false.
         */
        if (!m_cdataTagOpen) {
            flushPending();
            if (m_lexHandler != null) {
