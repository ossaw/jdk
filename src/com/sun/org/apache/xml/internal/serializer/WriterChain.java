 ...
 * The serializer has a number of classes that extend java.io.Writer and which
 * send their ouput to a yet another wrapped Writer or OutputStream.
 ...
 * flush()
 * close()
 * </code> In this manner nothing will accidentally go directly to the base
 * class rather than to the wrapped Writer or OutputStream.
 * The purpose of this class is to have a uniform way of chaining the output of
 * one writer to the next writer in the chain. In addition there are methods to
