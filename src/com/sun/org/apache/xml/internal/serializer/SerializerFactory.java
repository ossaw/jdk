 ...
 * "cdata-section-elements", "indent", "media-type". These property keys and
...
public final class SerializerFactory {
	/**
	 * This constructor is private just to prevent the creation of such an
	 * object.
	 */
	 ...
	 * is specified by the value of the property associated with the "method"
	 * key. If no implementation exists that supports the specified output
	 * method an exception of some type will be thrown. For a list of the output
	...
	public static Serializer getSerializer(Properties format) {
		...
		try {
			...
			if (obj instanceof SerializationHandler) {
				...
				/*
				 * This must be a user defined Serializer. It had better
				 * implement ContentHandler.
				 */
				if (obj instanceof ContentHandler) {

					/*
					 * The user defined serializer defines ContentHandler, but
					 * we need to wrap it with ToXMLSAXHandler which will
					 * collect SAX-like events and emit true SAX ContentHandler
					 * events to the users handler.
					 */
