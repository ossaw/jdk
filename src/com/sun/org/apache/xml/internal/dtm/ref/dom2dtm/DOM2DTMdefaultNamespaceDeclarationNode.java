 ...
 */
/*
 * $Id: DOM2DTMdefaultNamespaceDeclarationNode.java,v 1.2.4.1 2005/09/15
 * 08:15:11 suresh_emailid Exp $
 */
...
/**
 * This is a kluge to let us shove a declaration for xml: into the DOM2DTM
 * model. Basically, it creates a proxy node in DOM space to carry the
...
public class DOM2DTMdefaultNamespaceDeclarationNode implements Attr, TypeInfo {
     ...
     * pruning problem, but since it will always be added to the root element
     * and we prune on elements, we shouldn't have to worry.
     */
    public int getHandleOfNode() {
        return handle;
    }

    // RAMESH: PENDING=> Add proper implementation for the below DOM L3
    // additions
