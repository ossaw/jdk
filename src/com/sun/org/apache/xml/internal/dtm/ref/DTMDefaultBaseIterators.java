...
public abstract class DTMDefaultBaseIterators extends DTMDefaultBaseTraversers {
     ...
     * extended type ID. Returns an iterator that must be initialized with a
    ...
    public DTMAxisIterator getTypedAxisIterator(int axis, int type) {
        ...
        /*
         * This causes an error when using patterns for elements that do not
         * exist in the DOM (translet types which do not correspond to a DOM
         * type are mapped to the DOM.ELEMENT type).
         */
            ...
            switch (axis) {
                ...
                default:
                    throw new DTMException(XMLMessages.createXMLMessage(
                            XMLErrorResources.ER_TYPED_ITERATOR_AXIS_NOT_IMPLEMENTED, new Object[] { Axis
                                    .getNames(axis) }));
     ...
     * Returns a bare-bones iterator that must be initialized with a start node
    ...
    public DTMAxisIterator getAxisIterator(final int axis) {
        ...
        switch (axis) {
            ...
            default:
                throw new DTMException(XMLMessages.createXMLMessage(
                        XMLErrorResources.ER_ITERATOR_AXIS_NOT_IMPLEMENTED, new Object[] { Axis.getNames(
                                axis) }));
     ...
     * internal implementations of DTMAxisIterator. Subclass this (and override,
     * if necessary) to implement the specifics of an individual axis iterator.
    ...
    public final class TypedFollowingIterator extends FollowingIterator {
        ...
        public int next() {
            ...
            } while (node != DTM.NULL && (getExpandedTypeID(node) != _nodeType && getNodeType(
                    node) != _nodeType));
    ...
    /**
     * Iterator that returns the descendants of a given node. I'm not exactly
     * clear about this one... -sb
     */
    ...
    public class SingletonIterator extends InternalAxisIteratorBase {
        ...
        /**
         * (not sure yet what this is. -sb) (sc & sb remove final to compile in
         * JDK 1.1.8)
         */
