...
public class DTMNodeIterator implements org.w3c.dom.traversal.NodeIterator {
     ...
     * querying whether a given node would be permitted if it appeared as our
     * next node, but in the current implementation that would be very complex
    ...
    /**
     * @return The root node of the NodeIterator, as specified when it was
     *         created.
     */
    public Node getRoot() {
