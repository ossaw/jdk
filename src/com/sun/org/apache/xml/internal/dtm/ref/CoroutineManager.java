...
public class CoroutineManager {
    ...
    public synchronized Object co_resume(Object arg_object, int thisCoroutine, int toCoroutine)
        ...
        if (!m_activeIDs.get(toCoroutine))
            throw new java.lang.NoSuchMethodException(XMLMessages.createXMLMessage(
                    XMLErrorResources.ER_COROUTINE_NOT_AVAIL, new Object[] { Integer.toString(
                            toCoroutine) })); // "Coroutine
                                                                                                                                                                                               // not
                                                                                                                                                                                               // available,
                                                                                                                                                                                               // id="+toCoroutine);
        ...
        if (m_nextCoroutine == NOBODY) {
            ...
            throw new java.lang.NoSuchMethodException(XMLMessages.createXMLMessage(
                    XMLErrorResources.ER_COROUTINE_CO_EXIT, null)); // "CoroutineManager
                                                                                                                                           // recieved
                                                                                                                                           // co_exit()
                                                                                                                                           // request");
        }
