...
public class DTMTreeWalker {
     ...
     * Visitor. startNode (preorder) and endNode (postorder) are invoked for
     * each node as we traverse over them, with the result that the node is
            ...
            while (DTM.NULL == nextNode) {
                ...
                if (DTM.NULL == nextNode) {
                    ...
                    if ((DTM.NULL == pos) || (top == pos)) {
                        // %REVIEW% This condition isn't tested in
                        // traverse(pos,top)
                        // -- bug?
                        if (DTM.NULL != pos)
                            endNode(pos);
