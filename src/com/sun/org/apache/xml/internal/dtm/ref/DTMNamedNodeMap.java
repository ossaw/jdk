 ...
 * DOM's NamedNodeMap interface, intended to support DTMProxy's getAttributes()
 * call.
 * <p>
 * ***** Note: this does _not_ current attempt to cache any of the data; if you
 * ask for attribute 27 and then 28, you'll have to rescan the first 27. It
 * should probably at least keep track of the last one retrieved, and possibly
...
public class DTMNamedNodeMap implements NamedNodeMap {
	 ...
	 * 
	 * @param newNode
	 *            node to store in this map. The node will later be accessible
	...
	/**
	 * Retrieves a node specified by local name and namespace URI. HTML-only DOM
	 ...
	 * name is already present in this map, it is replaced by the new one. <br>
