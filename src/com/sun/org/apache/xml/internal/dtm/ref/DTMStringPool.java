...
/**
 * <p>
 * DTMStringPool is an "interning" mechanism for strings. It will create a
 * stable 1:1 mapping between a set of string values and a set of integer index
 ...
 * <li>Threadsafety is not guaranteed at this level. Enforce that in the
 * application if needed.</li>
 ...
 * .equals() operations. The API enforces Strings because it's safer that way,
