 ...
 * </p>
 *
 * @deprecated Since the ability to start a parse via the coroutine protocol was
 *             not being used and was complicating design. See
 *             {@link IncrementalSAXSource}.
 */
public interface CoroutineParser {

    /**
     * @return the coroutine ID number for this CoroutineParser object. Note
     *         that this isn't useful unless you know which CoroutineManager
     *         you're talking to. Also note that the do...() methods encapsulate
     *         the common transactions with the CoroutineParser, so you
     *         shouldn't need this in most cases.
     */
    public int getParserCoroutineID();

    /**
     * @return the CoroutineManager for this CoroutineParser object. If you're
     *         using the do...() methods, applications should only need to talk
     *         to the CoroutineManager once, to obtain the application's
     *         Coroutine ID.
     */
     ...
     * course)... but it isn't part of our API, and shouldn't be declared here.
     */

    // ================================================================
    /**
     * doParse() is a simple API which tells the coroutine parser to begin
     * reading from a file. This is intended to be called from one of our
    ...
    /**
     * doMore() is a simple API which tells the coroutine parser that we need
     * more nodes. This is intended to be called from one of our partner
    ...
    /**
     * doTerminate() is a simple API which tells the coroutine parser to
     * terminate itself. This is intended to be called from one of our partner
     * coroutines, and serves both to encapsulate the communication protocol and
     * to avoid having to explicitly use the CoroutineParser's coroutine ID
     * number.
    ...
    /**
     * Initialize the coroutine parser. Same parameters could be passed in a
     * non-default constructor, or by using using context ClassLoader and
