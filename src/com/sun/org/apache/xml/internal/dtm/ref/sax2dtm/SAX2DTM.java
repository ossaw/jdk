...
public class SAX2DTM extends DTMDefaultBaseIterators implements EntityResolver, DTDHandler, ContentHandler,
        ...
        if (m_textPendingStart >= 0) // -1 indicates no-text-in-progress
        {
            ...
            if (doStrip) {
                ...
                if (length > 0) {
                    ...
                    m_previous = addNode(m_coalescedTextType, exName, m_parents.peek(), m_previous, dataIndex,
                            false);
    ...
    public void startDocument() throws SAXException {
        ...
        int doc = addNode(DTM.DOCUMENT_NODE, m_expandedNameTable.getExpandedTypeID(DTM.DOCUMENT_NODE),
    ...
    public void processingInstruction(String target, String data) throws SAXException {
        ...
        m_previous = addNode(DTM.PROCESSING_INSTRUCTION_NODE, exName, m_parents.peek(), m_previous, dataIndex,
                false);
    }
