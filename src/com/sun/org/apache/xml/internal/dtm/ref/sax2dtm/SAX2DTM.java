 ...
 */
public class SAX2DTM extends DTMDefaultBaseIterators implements EntityResolver,
        DTDHandler, ContentHandler, ErrorHandler, DeclHandler, LexicalHandler {
    ...
    /**
     * The parent stack, needed only for construction. Made protected rather
     * than private so SAX2RTFDTM can access it.
     */
     ...
     */
    private static final String[] m_fixednames = { null, null, // nothing,
            // Element
            null, "#text", // Attr, Text
    ...
    public SAX2DTM(DTMManager mgr, Source source, int dtmIdentity,
        ...
        // m_data = new SuballocatedIntVector(doIndexing ? (1024*2) : 512,
        // 1024);
        // m_data = new SuballocatedIntVector(blocksize);
    ...
    /**
     * Set whether information about document source location should be
     * maintained or not.
     */
     ...
     *                             The parser that we want to recieve events
     *                             from on demand.
     */
    public void setIncrementalSAXSource(
    ...
    public ContentHandler getContentHandler() {
        ...
        if (m_incrementalSAXSource.getClass().getName().equals(
    ...
    public void dispatchCharactersEvents(int nodeHandle, ContentHandler ch,
        ...
        if (isTextType(type)) {
            ...
            if (DTM.NULL != firstChild) {
                ...
                } while (DTM.NULL != identity && (_parent(
                        identity) >= startNode));
                ...
                if (normalize)
                    FastStringBuffer.sendNormalizedSAXcharacters(str
                            .toCharArray(), 0, str.length(), ch);
                else
        ...
        if (0 == namespaceID) {
            ...
            if (type == DTM.NAMESPACE_NODE) {
                if (null == m_expandedNameTable.getLocalName(expandedTypeID))
                    ...
                    return "xmlns:" + m_expandedNameTable.getLocalName(
                            expandedTypeID);
            } else if (0 == m_expandedNameTable.getLocalNameID(
                    expandedTypeID)) {
                return m_fixednames[type];
            } else
                return m_expandedNameTable.getLocalName(expandedTypeID);
        } else {
            int qnameIndex = m_dataOrQName.elementAt(makeNodeIdentity(
                    nodeHandle));
     ...
     */
    protected int addNode(int type, int expandedTypeID, int parentIndex,
    ...
    public String getLocalName(int nodeHandle) {
        return m_expandedNameTable.getLocalName(_exptype(makeNodeIdentity(
                nodeHandle)));
    }
        ...
        for (int i = 0; i < n; i += ENTITY_FIELDS_PER) {
            ...
            if (null != ename && ename.equals(name)) {
                ...
                if (null != nname) {
                    ...
                    url = (String) m_entities.elementAt(i
    ...
    public int getAttributeNode(int nodeHandle, String namespaceURI,
        ...
        for (int attrH = getFirstAttribute(
                nodeHandle); DTM.NULL != attrH; attrH = getNextAttribute(
                        attrH)) {
    ...
    public String getNamespaceURI(int nodeHandle) {
        ...
        return m_expandedNameTable.getNamespace(_exptype(makeNodeIdentity(
                nodeHandle)));
    }
    ...
    public XMLString getStringValue(int nodeHandle) {
        int identity = makeNodeIdentity(nodeHandle);
        int type;
        if (identity == DTM.NULL) // Separate lines because I wanted to
                                  // breakpoint it
            type = DTM.NULL;
        else
            type = _type(identity);
        ...
        if (isTextType(type)) {
            ...
            if (DTM.NULL != firstChild) {
                ...
                return m_xstrf.newstr(m_valuesOrPrefixes.indexToString(
                        dataIndex));
            }
        }
        ...
        if (null != uri && uri.length() > 0) {
            ...
            if (uriIndex >= 0) {
                ...
                if (qname.equals("xmlns"))
                    ...
                    prefix = (indexOfNSSep > 0) ? qname.substring(0,
                            indexOfNSSep) : null;
            } else {
                prefix = null;
            }
    ...
    protected void charactersFlush() {
        ...
        if (m_textPendingStart >= 0) // -1 indicates no-text-in-progress
        {
            ...
            if (doStrip) {
                m_chars.setLength(m_textPendingStart); // Discard accumulated
                                                       // text
            } else {
                ...
                if (length > 0) {
                    ...
                    m_previous = addNode(m_coalescedTextType, exName, m_parents
    ...
    public void startDocument() throws SAXException {
        ...
        int doc = addNode(DTM.DOCUMENT_NODE, m_expandedNameTable
                .getExpandedTypeID(DTM.DOCUMENT_NODE), DTM.NULL, DTM.NULL, 0,
                true);
    ...
    public void startElement(String uri, String localName, String qName,
        ...
        if (DEBUG) {
            ...
            if (DEBUG_ATTRS & attributes != null) {
                ...
                if (n == 0)
                    ...
                    for (int i = 0; i < n; i++)
                        System.out.println("\t attr: uri: " + attributes.getURI(
                                i) + ", localname: " + attributes.getLocalName(
                                        i) + ", qname: " + attributes.getQName(
                                                i) + ", type: " + attributes
                                                        .getType(i)
        ...
        int prefixIndex = (null != prefix) ? m_valuesOrPrefixes.stringToIndex(
                qName) : 0;
        ...
        if (!m_pastFirstElement) {
            ...
            prev = addNode(DTM.NAMESPACE_NODE, exName, elemNode, prev, val,
                    false);
    ...
    public void processingInstruction(String target, String data)
        ...
        m_previous = addNode(DTM.PROCESSING_INSTRUCTION_NODE, exName, m_parents
                .peek(), m_previous, dataIndex, false);
    }
     ...
     * otherwise indicated by a {@link #startEntity startEntity} event.
     * </p>
     *
     * <p>
    ...
    public void comment(char ch[], int start, int length) throws SAXException {
        ...
        m_previous = addNode(DTM.COMMENT_NODE, exName, m_parents.peek(),
    ...
    public SourceLocator getSourceLocatorFor(int node) {
        if (m_useSourceLocationProperty) {
            ...
            return new NodeLocator(null, m_sourceSystemId.elementAt(node),
                    m_sourceLine.elementAt(node), m_sourceColumn.elementAt(
                            node));
