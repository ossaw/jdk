...
public class XMLUtils {
	...
	private static boolean ignoreLineBreaks = AccessController
	...
	public static void outputDOM(Node contextNode, OutputStream os, boolean addPreamble) {
		try {
			...
			os.write(Canonicalizer.getInstance(Canonicalizer.ALGO_ID_C14N_WITH_COMMENTS)
	...
	public static Document getOwnerDocument(Set<Node> xpathNodeSet) {
		...
		throw new NullPointerException(I18n.translate("endorsed.jdk1.4.0")
				+ " Original message was \"" + (npe == null ? "" : npe.getMessage()) + "\"");
	}
	 ...
	 */
	public static boolean protectAgainstWrappingAttack(Node startNode, Element knownElement,
			String value) {
		Node startParent = startNode.getParentNode();
		Node processedNode = null;
