...
public class MessageDigestAlgorithm extends Algorithm {
	...
	/**
	 * Constructor for the brave who pass their own message digest algorithms
	 ...
	 * @param doc
	 * @param algorithmURI
	 * @return The MessageDigestAlgorithm element to attach in document and to
	 *         digest
	...
	/**
	 * Proxy method for {@link java.security.MessageDigest#isEqual} which is
	 * executed on the internal {@link java.security.MessageDigest} object.
	 *
	 * @param digesta
	 * @param digestb
	 * @return the result of the {@link java.security.MessageDigest#isEqual}
	 *         method
	 */
	...
	/**
	 * Proxy method for {@link java.security.MessageDigest#digest()} which is
	 * executed on the internal {@link java.security.MessageDigest} object.
	 *
	 * @return the result of the {@link java.security.MessageDigest#digest()}
	 *         method
	 */
	public byte[] digest() {
	...
	/**
	 * Proxy method for {@link java.security.MessageDigest#digest(byte[])} which
	 * is executed on the internal {@link java.security.MessageDigest} object.
	 *
	 * @param input
	 * @return the result of the
	 *         {@link java.security.MessageDigest#digest(byte[])} method
	 */
	...
	/**
	 * Proxy method for
	 * {@link java.security.MessageDigest#digest(byte[], int, int)} which is
	 * executed on the internal {@link java.security.MessageDigest} object.
	 *
	 * @param buf
	 * @param offset
	 * @param len
	 * @return the result of the
	 *         {@link java.security.MessageDigest#digest(byte[], int, int)}
	 *         method
	...
	/**
	 * Proxy method for {@link java.security.MessageDigest#getAlgorithm} which
	 * is executed on the internal {@link java.security.MessageDigest} object.
	 *
	 * @return the result of the
	 *         {@link java.security.MessageDigest#getAlgorithm} method
	 */
	...
	/**
	 * Proxy method for {@link java.security.MessageDigest#getProvider} which is
	 * executed on the internal {@link java.security.MessageDigest} object.
	 *
	 * @return the result of the {@link java.security.MessageDigest#getProvider}
	 *         method
	 */
	 ...
	 * which is executed on the internal {@link java.security.MessageDigest}
	 * object.
	 *
	 * @return the result of the
	 *         {@link java.security.MessageDigest#getDigestLength} method
	 */
	...
	/**
	 * Proxy method for {@link java.security.MessageDigest#update(byte[])} which
	 * is executed on the internal {@link java.security.MessageDigest} object.
	 *
	 * @param input
	 */
	...
	/**
	 * Proxy method for
	 * {@link java.security.MessageDigest#update(byte[], int, int)} which is
	 * executed on the internal {@link java.security.MessageDigest} object.
	 *
	 * @param buf
	 * @param offset
