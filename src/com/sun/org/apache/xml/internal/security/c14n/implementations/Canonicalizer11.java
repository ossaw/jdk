...
/**
 * Implements
 * <A HREF="http://www.w3.org/TR/2008/PR-xml-c14n11-20080129/"> Canonical XML
 * Version 1.1</A>, a W3C Proposed Recommendation from 29 January 2008.
 *
 * @author Sean Mullan
 * @author Raul Benito
 */
public abstract class Canonicalizer11 extends CanonicalizerBase {
    ...
    private static java.util.logging.Logger log = java.util.logging.Logger.getLogger(Canonicalizer11.class
            .getName());
    ...
    protected Iterator<Attr> handleAttributesSubtree(Element element, NameSpaceSymbTable ns)
        ...
        if (firstCall) {
            ...
            // Obtain all the namespaces defined in the parents, and added to
            // the output.
    ...
    /**
     * Returns the Attr[]s to be output for the given element. <br>
     * IMPORTANT: This method expects to work on a modified DOM tree, i.e. a DOM
     * which has been prepared using
     * {@link com.sun.org.apache.xml.internal.security.utils.XMLUtils#circumventBug2650( org.w3c.dom.Document)}
     * .
     *
     * @param element
     * @param ns
        ...
        if (element.hasAttributes()) {
            ...
            for (int i = 0; i < attrsLength; i++) {
                ...
                if (!XMLNS_URI.equals(NUri)) {
                    ...
                    /*
                     * except omit namespace node with local name xml, which
    ...
    private static String removeDotSegments(String path) {
        ...
        while (input.length() != 0) {
            ...
            if (input.startsWith("./")) {
                ...
                // buffer was removed and it was not the root slash then delete
                // a
                ...
                // character (if any) and any subsequent characters up to, but
                // not
