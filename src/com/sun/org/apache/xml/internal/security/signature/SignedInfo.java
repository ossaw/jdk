...
/**
 * Handles <code>&lt;ds:SignedInfo&gt;</code> elements This <code>SignedInfo
 * <code> element includes the canonicalization algorithm, a signature
 * algorithm, and one or more references.
 *
...
public class SignedInfo extends Manifest {
     ...
     *
     * @param doc
     *        the {@link Document} in which <code>XMLsignature</code> will
     *        be placed
     ...
     *
     * @param doc
     *        <code>SignedInfo</code> is placed in
     *        this document
     ...
     * @throws XMLSecurityException
     */
    public SignedInfo(Document doc, String signatureMethodURI, int hMACOutputLength,
            String canonicalizationMethodURI) throws XMLSecurityException {
        super(doc);

        c14nMethod = XMLUtils.createElementInSignatureSpace(this.doc, Constants._TAG_CANONICALIZATIONMETHOD);
        ...
        if (hMACOutputLength > 0) {
            this.signatureAlgorithm = new SignatureAlgorithm(this.doc, signatureMethodURI, hMACOutputLength);
        } else {
     ...
     * @throws XMLSecurityException
     * @see <A HREF=
     *      "http://lists.w3.org/Archives/Public/w3c-ietf-xmldsig/2001OctDec/0033.html">
     *      Question</A>
     * @see <A HREF=
    ...
    public SignedInfo(Element element, String baseURI, boolean secureValidation) throws XMLSecurityException {
        ...
        this.signatureAlgorithm = new SignatureAlgorithm(signatureMethod, this.getBaseURI(),
                secureValidation);
    }
    ...
    private static Element reparseSignedInfoElem(Element element) throws XMLSecurityException {
         ...
         * ds:SignedInfo, reparse it into a new document and replace the
         * original not-canonicalized ds:SignedInfo by the re-parsed
         * canonicalized one.
         */
        ...
        if (!(c14nMethodURI.equals(Canonicalizer.ALGO_ID_C14N_OMIT_COMMENTS) || c14nMethodURI.equals(
                Canonicalizer.ALGO_ID_C14N_WITH_COMMENTS) || c14nMethodURI.equals(
                        Canonicalizer.ALGO_ID_C14N_EXCL_OMIT_COMMENTS) || c14nMethodURI.equals(
                                Canonicalizer.ALGO_ID_C14N_EXCL_WITH_COMMENTS) || c14nMethodURI.equals(
                                        Canonicalizer.ALGO_ID_C14N11_OMIT_COMMENTS) || c14nMethodURI.equals(
     ...
     *        verify
     *        referenced <CODE>ds:Manifest</CODE>s, too
     * @return true if verification was successful
     * @throws MissingResourceFailureException
     * @throws XMLSecurityException
     */
    public boolean verify(boolean followManifests) throws MissingResourceFailureException,
     ...
     *
     * @return the canonicalization result octet stream of
     *         <code>SignedInfo</code> element
     * @throws CanonicalizationException
     * @throws InvalidCanonicalizerException
     * @throws XMLSecurityException
     */
    public byte[] getCanonicalizedOctetStream() throws CanonicalizationException,
            InvalidCanonicalizerException, XMLSecurityException {
     ...
     * @throws XMLSecurityException
     */
    public void signInOctetStream(OutputStream os) throws CanonicalizationException,
            InvalidCanonicalizerException, XMLSecurityException {
        if (this.c14nizedBytes == null) {
            Canonicalizer c14nizer = Canonicalizer.getInstance(this.getCanonicalizationMethodURI());
    ...
    /**
     * Creates a SecretKey for the appropriate Mac algorithm based on a byte[]
     * array password.
     *
    ...
    public String getInclusiveNamespaces() {
        String c14nMethodURI = c14nMethod.getAttributeNS(null, Constants._ATT_ALGORITHM);
        if (!(c14nMethodURI.equals("http://www.w3.org/2001/10/xml-exc-c14n#") || c14nMethodURI.equals(
