...
/**
 * Implements the parameters for a custom Transform which has a better
 * performance than the xfilter2.
 *
...
public class XPathFilterCHGPContainer extends ElementProxy implements TransformParam {
	...
	/**
	 * Creates a XPathFilterCHGPContainer from an existing Element; needed for
	 * verification.
	 *
	 * @param element
	 * @param BaseURI
