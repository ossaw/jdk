...
public abstract class AbstractSerializer implements Serializer {
	 ...
	 * <code>DocumentFragment</code>. A document fragment may be a non-valid XML
	 * document (refer to appropriate description of W3C) because it my start
	 * with a non-element node, e.g. a text node.
	 * <p/>
	 * The methods first converts the node list into a document fragment.
	 * Special care is taken to not destroy the current document, thus the
	 * method clones the nodes (deep cloning) before it appends them to the
	 * document fragment.
	 * <p/>
	 * Refer also to comments about setup of format.
	 *
