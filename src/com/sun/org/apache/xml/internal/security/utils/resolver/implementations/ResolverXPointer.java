...
/**
 * Handles barename XPointer Reference URIs. <BR />
 * To retain comments while selecting an element by an identifier ID, use the
 * following full XPointer: URI='#xpointer(id('ID'))'. <BR />
