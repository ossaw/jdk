...
/**
 * This resolver is used for resolving same-document URIs like URI="" of
 * URI="#id".
 *
 * @author $Author: coheigea $
 * @see <A HREF=
 *      "http://www.w3.org/TR/xmldsig-core/#sec-ReferenceProcessingModel">The
 *      Reference processing model in the XML Signature spec</A>
 * @see <A HREF="http://www.w3.org/TR/xmldsig-core/#sec-Same-Document">Same-
 *      Document URI-References in the XML Signature spec</A>
 * @see <A HREF="http://www.ietf.org/rfc/rfc2396.txt">Section 4.2 of RFC
 *      2396</A>
 */
public class ResolverFragment extends ResourceResolverSpi {
    ...
    public XMLSignatureInput engineResolveURI(ResourceResolverContext context)
        ...
        if (context.uriToResolve.equals("")) {
            ...
            /*
             * URI="#chapter1" Identifies a node-set containing the element with
             * ID attribute value 'chapter1' of the XML resource containing the
