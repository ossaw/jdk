...
public class SignatureAlgorithm extends Algorithm {
    ...
    private static java.util.logging.Logger log = java.util.logging.Logger.getLogger(SignatureAlgorithm.class
            .getName());
    ...
    public static void register(String algorithmURI, String implementingClass)
        ...
        if (log.isLoggable(java.util.logging.Level.FINE)) {
            log.log(java.util.logging.Level.FINE, "Try to register " + algorithmURI + " "
                    + implementingClass);
        }
    ...
    public static void registerDefaultAlgorithms() {
        ...
        algorithmHash.put(XMLSignature.ALGO_ID_SIGNATURE_RSA_SHA1, SignatureBaseRSA.SignatureRSASHA1.class);
