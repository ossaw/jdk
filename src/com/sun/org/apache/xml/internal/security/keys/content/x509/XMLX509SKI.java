...
public class XMLX509SKI extends SignatureElementProxy implements XMLX509DataContent {
    ...
    private static java.util.logging.Logger log = java.util.logging.Logger.getLogger(XMLX509SKI.class
            .getName());
     ...
     * distinct keys used by the same subject to be differentiated (e.g., as key
     * updating occurs). <BR />
     * A key identifier shall be unique with respect to all key identifiers for
     * the subject with which it is used. This extension is always non-critical.
     */
    ...
    public static byte[] getSKIBytesFromCert(X509Certificate cert) throws XMLSecurityException {
        ...
        /**
         * Strip away first four bytes from the extensionValue The first two
         * bytes are the tag and length of the extensionValue OCTET STRING, and
         * the next two bytes are the tag and length of the ski OCTET STRING.
         */
