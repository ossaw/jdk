 ...
 * the generation of the <code>EncryptedData</code> or <code>EncryptedKey</code>
 * . This information is wraped int an <code>EncryptionProperty</code> element.
 * Examples of additional information is e.g., a date/time stamp or the serial
 * number of cryptographic hardware used during encryption).
 * <p>
 * It is defined as follows: <xmp> <element name='EncryptionProperties' type=
 * 'xenc:EncryptionPropertiesType'/> <complexType name=
 * 'EncryptionPropertiesType'> <sequence> <element ref='xenc:EncryptionProperty'
 * maxOccurs='unbounded'/> </sequence>
 * <attribute name='Id' type='ID' use='optional'/> </complexType> </xmp>
 *
 * @author Axl Mattheus
 */
