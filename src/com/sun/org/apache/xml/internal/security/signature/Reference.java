...
public class Reference extends SignatureElementProxy {
    ...
    private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(Reference.class
            .getName());
    ...
    protected Reference(Document doc, String baseURI, String referenceURI, Manifest manifest,
        ...
        // important: The ds:Reference must be added to the associated
        // ds:Manifest
        ...
        MessageDigestAlgorithm mda = MessageDigestAlgorithm.getInstance(this.doc, messageDigestAlgorithm);

        digestMethodElem = mda.getElement();
        this.constructionElement.appendChild(digestMethodElem);
        XMLUtils.addReturnToElement(this.constructionElement);

        digestValueElement = XMLUtils.createElementInSignatureSpace(this.doc, Constants._TAG_DIGESTVALUE);
    ...
    protected Reference(Element element, String baseURI, Manifest manifest, boolean secureValidation)
        ...
        if (Constants._TAG_TRANSFORMS.equals(el.getLocalName()) && Constants.SignatureSpecNS.equals(el
                .getNamespaceURI())) {
     ...
     *
     * @param uri
     *        the <code>URI</code> of this <code>Reference</code> element
     */
    ...
    /**
     * Returns the <code>Id</code> attribute of this <code>Reference</code>
     * element
     *
     * @return Id the <code>Id</code> attribute of this <code>Reference</code>
     *         element
     */
    public String getId() {
     ...
     * <code>ds:Object</code>, <code>ds:SignatureProperty</code>, or
    ...
    /**
     * Return the <code>type</code> atttibute of the Reference indicate whether
     * an <code>ds:Object</code>, <code>ds:SignatureProperty</code>, or
     * <code>ds:Manifest</code> element
     *
     ...
     *
     * @return true if the Reference type indicates that this Reference points
     *         to an <code>Object</code>
     */
    ...
    /**
     * Returns the XMLSignatureInput which is created by de-referencing the URI
     * attribute.
     * 
    ...
    public XMLSignatureInput getContentsBeforeTransformation() throws ReferenceNotInitializedException {
        try {
            ...
            ResourceResolver resolver = ResourceResolver.getInstance(uriAttr, this.baseURI, this.manifest
                    .getPerManifestResolvers(), secureValidation);
    ...
    private XMLSignatureInput getContentsAfterTransformation(XMLSignatureInput input, OutputStream os)
        ...
        try {
            ...
            if (transforms != null) {
                ...
                this.transformsOutput = output;// new
                                               // XMLSignatureInput(output.getBytes());
    ...
    /**
     * This method returns the XMLSignatureInput which represents the node set
     * before some kind of canonicalization is applied for the first time.
     * 
        ...
        try {
            ...
            if (transforms != null) {
                ...
                for (int i = 0; i < transforms.getLength(); i++) {
                    ...
                    if (uri.equals(Transforms.TRANSFORM_C14N_EXCL_OMIT_COMMENTS) || uri.equals(
    ...
    public String getHTMLRepresentation() throws XMLSignatureException {
        try {
            ...
            if (c14nTransform != null && (c14nTransform.length(
                ...
                InclusiveNamespaces in = new InclusiveNamespaces(XMLUtils.selectNode(c14nTransform
                        .getElement().getFirstChild(), InclusiveNamespaces.ExclusiveCanonicalizationNamespace,
    ...
    /**
     * Get the ReferenceData that corresponds to the cached representation of
     * the dereferenced object before transformation.
     */
    ...
    /**
     * This method returns the {@link XMLSignatureInput} which is referenced by
    ...
    private void cacheDereferencedElement(XMLSignatureInput input) {
        if (input.isNodeSet()) {
            ...
            try {
                referenceData = new ReferenceOctetStreamData(input.getOctetStream(), input.getSourceURI(),
                        input.getMIMEType());
     ...
     * @throws XMLSignatureException
     */
    private byte[] calculateDigest(boolean validating) throws ReferenceNotInitializedException,
            XMLSignatureException {
        ...
        try {
            ...
            if (Reference.useC14N11 && !validating && !output.isOutputStreamSet() && !output
                    .isOctetStream()) {
                if (transforms == null) {
