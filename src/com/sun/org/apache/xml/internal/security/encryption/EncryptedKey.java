 ...
 * <xmp> <element name='EncryptedKey' type='xenc:EncryptedKeyType'/>
 * <complexType name='EncryptedKeyType'> <complexContent> <extension base=
 * 'xenc:EncryptedType'> <sequence> <element ref='xenc:ReferenceList' minOccurs=
 * '0'/> <element name='CarriedKeyName' type='string' minOccurs='0'/>
 * </sequence>
 * <attribute name='Recipient' type='string' use='optional'/> </extension>
 * </complexContent> </complexType> </xmp>
 *
 * @author Axl Mattheus
 */
