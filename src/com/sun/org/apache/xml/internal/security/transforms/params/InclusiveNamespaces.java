 ...
 * Canonicalization. <BR />
 * It implements the {@link Element} interface and can be used directly in a DOM
 * tree.
 *
...
public class InclusiveNamespaces extends ElementProxy implements
	...
	public String getInclusiveNamespaces() {
		return this.constructionElement.getAttributeNS(null,
				InclusiveNamespaces._ATT_EC_PREFIXLIST);
	}

	/**
	 * Decodes the <code>inclusiveNamespaces</code> String and returns all
	 * selected namespace prefixes as a Set. The <code>#default</code> namespace
	 * token is represented as an empty namespace prefix (<code>"xmlns"</code>).
	 * <BR/>
	 * The String <code>inclusiveNamespaces=" xenc    ds #default"</code> is
	 * returned as a Set containing the following Strings:
	 * <UL>
