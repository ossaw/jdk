...
public interface NodeFilter {
	...
	/**
	 * Tells if a node must be output in a c14n. The caller must assured that
	 * this method is always call in document order. The implementations can use
	 * this restriction to optimize the transformation.
	 * 
	 * @param n
	 * @param level
