...
public class JCEMapper {
    ...
    private static java.util.logging.Logger log = java.util.logging.Logger
            .getLogger(JCEMapper.class.getName());
    ...
    public static void registerDefaultAlgorithms() {
        ...
        algorithmsMap.put(MessageDigestAlgorithm.ALGO_ID_DIGEST_SHA1,
                new Algorithm("", "SHA-1", "MessageDigest"));
        algorithmsMap.put(MessageDigestAlgorithm.ALGO_ID_DIGEST_SHA256,
                new Algorithm("", "SHA-256", "MessageDigest"));
        algorithmsMap.put(MessageDigestAlgorithm.ALGO_ID_DIGEST_SHA384,
        ...
        algorithmsMap.put(XMLSignature.ALGO_ID_SIGNATURE_RSA_SHA1,
        ...
        algorithmsMap.put(XMLSignature.ALGO_ID_SIGNATURE_ECDSA_SHA1,
        ...
        algorithmsMap.put(XMLSignature.ALGO_ID_MAC_HMAC_NOT_RECOMMENDED_MD5,
