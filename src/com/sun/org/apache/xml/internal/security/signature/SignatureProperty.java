...
/**
 * Handles <code>&lt;ds:SignatureProperty&gt;</code> elements Additional
 * information item concerning the generation of the signature(s) can be placed
 * in this Element
 *
...
public class SignatureProperty extends SignatureElementProxy {
	...
	/**
	 * Constructs{@link SignatureProperty} using specified <code>target</code>
	 * attribute
	 *
	 * @param doc
	 ...
	 *               placed
	 * @param target
	 *               the <code>target</code> attribute references the
	 *               <code>Signature</code> element to which the property
	 *               applies
	 *               SignatureProperty
	 */
	...
	/**
	 * Constructs {@link SignatureProperty} using sepcified <code>target</code>
	 * attribute and <code>id</code> attribute
	 *
	 * @param doc
	 *               the {@link Document} in which <code>XMLsignature</code> is
	 *               placed
	 ...
	 *               applies
	 * @param id
	 *               the <code>id</code> will be specified by
	 *               {@link Reference#getURI} in validation
	 */
	 ...
	 * 
	 * @param element
	 *                <code>SignatureProperty</code> element
	 * @param BaseURI
	...
	public void setTarget(String target) {
		if (target != null) {
			this.constructionElement.setAttributeNS(null, Constants._ATT_TARGET,
					target);
		}
	}
