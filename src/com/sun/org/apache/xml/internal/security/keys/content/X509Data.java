...
public class X509Data extends SignatureElementProxy implements KeyInfoContent {
    ...
    private static java.util.logging.Logger log = java.util.logging.Logger.getLogger(X509Data.class
            .getName());
    ...
    public int lengthUnknownElement() {
        ...
        while (n != null) {
            if ((n.getNodeType() == Node.ELEMENT_NODE) && !n.getNamespaceURI().equals(
    ...
    public XMLX509SKI itemSKI(int i) throws XMLSecurityException {
        ...
        Element e = XMLUtils.selectDsNode(this.constructionElement.getFirstChild(), Constants._TAG_X509SKI,
                i);
    ...
    public XMLX509CRL itemCRL(int i) throws XMLSecurityException {
        ...
        Element e = XMLUtils.selectDsNode(this.constructionElement.getFirstChild(), Constants._TAG_X509CRL,
                i);
     ...
     *
     * @param i
     * @return the Unknown Element at i TODO implement
     **/
