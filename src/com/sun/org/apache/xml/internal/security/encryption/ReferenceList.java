 ...
 * <xmp> <element name='ReferenceList'> <complexType> <choice minOccurs='1'
 * maxOccurs='unbounded'> <element name='DataReference' type=
 * 'xenc:ReferenceType'/> <element name='KeyReference' type=
 * 'xenc:ReferenceType'/> </choice> </complexType> </element> </xmp>
 *
 * @author Axl Mattheus
 * @see Reference
 */
