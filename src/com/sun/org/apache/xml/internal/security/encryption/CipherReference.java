 ...
 * contains an identifier that is dereferenced. Should the Transforms, the data
 * resulting from dereferencing the <code>URI</code> is transformed as specified
 * so as to yield the intended cipher value. For example, if the value is base64
 * encoded within an XML document; the transforms could specify an XPath
 ...
 * <xmp> <element name='CipherReference' type='xenc:CipherReferenceType'/>
 * <complexType name='CipherReferenceType'> <sequence> <element name=
 * 'Transforms' type='xenc:TransformsType' minOccurs='0'/> </sequence>
 * <attribute name='URI' type='anyURI' use='required'/> </complexType> </xmp>
 *
 * @author Axl Mattheus
 */
