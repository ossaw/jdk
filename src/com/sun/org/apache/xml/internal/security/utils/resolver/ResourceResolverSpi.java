...
public abstract class ResourceResolverSpi {
    ...
    /**
     * Deprecated - used to carry state about whether resolution was being done
     * in a secure fashion, but was not thread safe, so the resolution
     * information is now passed as parameters to methods.
     *
    ...
    public XMLSignatureInput engineResolveURI(ResourceResolverContext context)
            throws ResourceResolverException {
        // The default implementation, to preserve backwards compatibility in
        // the
     ...
     * It normally means that the implementation does not have any member, or
     * there is member change between engineCanResolve & engineResolve
     * invocations. Or it maintains all member info in ThreadLocal methods.
     */
    ...
    public boolean engineCanResolveURI(ResourceResolverContext context) {
        // To preserve backward compatibility with existing resolvers that might
