...
/**
 * Raised when the computed hash value doesn't match the given
 * <i>DigestValue</i>. Additional human readable info is passed to the
 * constructor -- this being the benefit of raising an exception or returning a
 * value.
 *
