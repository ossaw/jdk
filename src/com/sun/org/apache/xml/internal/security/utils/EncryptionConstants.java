...
public class EncryptionConstants {
     ...
     * <A HREF="http://www.w3.org/TR/2001/WD-xmlenc-core-20010626/"> XML
    ...
    public static final String ALGO_ID_BLOCKCIPHER_TRIPLEDES = EncryptionConstants.EncryptionSpecNS
            + "tripledes-cbc";

    /** Block Encryption - REQUIRED AES-128 */
    public static final String ALGO_ID_BLOCKCIPHER_AES128 = EncryptionConstants.EncryptionSpecNS
            + "aes128-cbc";

    /** Block Encryption - REQUIRED AES-256 */
    public static final String ALGO_ID_BLOCKCIPHER_AES256 = EncryptionConstants.EncryptionSpecNS
            + "aes256-cbc";

    /** Block Encryption - OPTIONAL AES-192 */
    public static final String ALGO_ID_BLOCKCIPHER_AES192 = EncryptionConstants.EncryptionSpecNS
            + "aes192-cbc";
    ...
    public static final String ALGO_ID_KEYTRANSPORT_RSAOAEP_11 = EncryptionConstants.EncryptionSpec11NS
            + "rsa-oaep";
