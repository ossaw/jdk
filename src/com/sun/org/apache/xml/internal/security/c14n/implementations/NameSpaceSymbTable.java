...
/**
 * A stack based Symbol Table. <br>
 * For speed reasons all the symbols are introduced in the same map, and at the
 * same time in a list so it can be removed when the frame is pop back.
 * 
 * @author Raul Benito
 */
public class NameSpaceSymbTable {
    ...
    /**
     * Gets a definition without mark it as render. For render in exclusive c14n
    ...
    public boolean addMapping(String prefix, String uri, Attr n) {
        ...
        if (ob != null) {
            ...
            // Check if a previous definition(not the inmidiatly one) has been
            // rendered.
