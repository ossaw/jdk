...
/**
 * Implements the parameters for the
 * <A HREF="http://www.w3.org/TR/xmldsig-filter2/">XPath Filter v2.0</A>.
 *
...
public class XPath2FilterContainer extends ElementProxy implements TransformParam {
    ...
    /** Field INTERSECT */
    public static final String INTERSECT = XPath2FilterContainer._ATT_FILTER_VALUE_INTERSECT;

    /** Field SUBTRACT */
    public static final String SUBTRACT = XPath2FilterContainer._ATT_FILTER_VALUE_SUBTRACT;

    /** Field UNION */
    public static final String UNION = XPath2FilterContainer._ATT_FILTER_VALUE_UNION;
    ...
    private XPath2FilterContainer(Document doc, String xpath2filter, String filterType) {
        ...
        this.constructionElement.setAttributeNS(null, XPath2FilterContainer._ATT_FILTER, filterType);
    ...
    private XPath2FilterContainer(Element element, String BaseURI) throws XMLSecurityException {
        ...
        String filterStr = this.constructionElement.getAttributeNS(null, XPath2FilterContainer._ATT_FILTER);

        if (!filterStr.equals(XPath2FilterContainer._ATT_FILTER_VALUE_INTERSECT) && !filterStr.equals(
                XPath2FilterContainer._ATT_FILTER_VALUE_SUBTRACT) && !filterStr.equals(
    ...
    public static NodeList newInstances(Document doc, String[][] params) {
        ...
        for (int i = 0; i < params.length; i++) {
            ...
            if (!(type.equals(XPath2FilterContainer._ATT_FILTER_VALUE_INTERSECT) || type.equals(
                    XPath2FilterContainer._ATT_FILTER_VALUE_SUBTRACT) || type.equals(
                            XPath2FilterContainer._ATT_FILTER_VALUE_UNION))) {
    ...
    /**
     * Creates a XPath2FilterContainer from an existing Element; needed for
     * verification.
     *
     * @param element
     * @param BaseURI
    ...
    /**
     * Returns <code>true</code> if the <code>Filter</code> attribute has value
     * "intersect".
     *
     * @return <code>true</code> if the <code>Filter</code> attribute has value
     *         "intersect".
     */
    public boolean isIntersect() {
        return this.constructionElement.getAttributeNS(null, XPath2FilterContainer._ATT_FILTER).equals(
                XPath2FilterContainer._ATT_FILTER_VALUE_INTERSECT);
    }
     ...
     * to work.
     * $todo$ I dunno whether this crashes: <XPath> here()<!-- comment
     * -->/ds:Signature[1]</XPath>
     * 
     * @return the first Text node which contains information from the XPath 2
     *         Filter String
     */
