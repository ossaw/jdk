 ...
 * namespace to be included (i.e., <code>xml:space</code>, <code>xml:lang</code>
 * , and <code>xml:base</code>).
 * <p>
 * It is defined as follows:
 * <xmp> <element name='EncryptionProperty' type='xenc:EncryptionPropertyType'/>
 * <complexType name='EncryptionPropertyType' mixed='true'> <choice maxOccurs=
 * 'unbounded'> <any namespace='##other' processContents='lax'/> </choice>
 * <attribute name='Target' type='anyURI' use='optional'/> <attribute name='Id'
 * type='ID' use='optional'/> <anyAttribute namespace=
 * "http://www.w3.org/XML/1998/namespace"/> </complexType> </xmp>
 *
 * @author Axl Mattheus
 */
