...
public class AttrCompare implements Comparator<Attr>, Serializable {
     ...
     * name (the default namespace node, if one exists, has no local name and is
     * therefore lexicographically least).
     * <LI>An element's attribute nodes are sorted lexicographically with
     * namespace URI as the primary key and local name as the secondary key (an
     * empty namespace URI is lexicographically least).
     * </UL>
     *
     * @param attr0
     * @param attr1
