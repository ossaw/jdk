...
/**
 * An implementation of XPathAPI using Xalan. This supports the "here()"
 * function defined in the digital signature spec.
 */
public class XalanXPathAPI implements XPathAPI {

    private static java.util.logging.Logger log = java.util.logging.Logger.getLogger(XalanXPathAPI.class
            .getName());
    ...
    private XObject eval(Node contextNode, Node xpathnode, String str, Node namespaceNode)
        ...
        Node resolverNode = (namespaceNode.getNodeType() == Node.DOCUMENT_NODE) ? ((Document) namespaceNode)
    ...
    private XPath createXPath(String str, PrefixResolver prefixResolver) throws TransformerException {
        XPath xpath = null;
        Class<?>[] classes = new Class<?>[] { String.class, SourceLocator.class, PrefixResolver.class,
                int.class, ErrorListener.class, FunctionTable.class };
        Object[] objects = new Object[] { str, null, prefixResolver, Integer.valueOf(XPath.SELECT), null,
                funcTable };
        try {
