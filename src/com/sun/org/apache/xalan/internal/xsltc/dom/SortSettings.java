...
/**
 * Class for carrying settings that are to be used for a particular set of
 * <code>xsl:sort</code> elements.
 */
final class SortSettings {
	 ...
	 * @param types
	 *            an array specifying the type of comparison for each sort level
	 *            (text or number)
	 * @param locales
	 *            an array specifying the Locale for each sort level
	 * @param collators
	 *            an array specifying the Collation in effect for each sort
	 *            level
	 * @param caseOrders
	 *            an array specifying whether upper-case, lower-case or neither
	 *            is to take precedence for each sort level. The value of each
	...
	/**
	 * @return An array containing the sort order (ascending or descending) for
	 *         each level of <code>xsl:sort</code>
	 */
	int[] getSortOrders() {
		return _sortOrders;
	}
	...
	/**
	 * @return An array containing the type of comparison (text or number) to
	 *         perform for each level of <code>xsl:sort</code>
	 */
	int[] getTypes() {
		return _types;
	}
	...
	/**
	 * @return An array containing the Locale object in effect for each level of
	 *         <code>xsl:sort</code>
	 */
	Locale[] getLocales() {
		return _locales;
