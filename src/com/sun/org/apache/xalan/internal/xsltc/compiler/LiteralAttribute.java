...
final class LiteralAttribute extends Instruction {
    ...
    /**
     * Return true if at least one character in the String is considered to be a
     * "bad" character. A bad character is one whose code is: less than 32 (a
     * space), or greater than 126, or it is one of '<', '>', '&' or '\"'. This
     * helps the serializer to decide whether the String needs to be escaped.
     */
