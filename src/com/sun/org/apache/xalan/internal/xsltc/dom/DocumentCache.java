...
public final class DocumentCache implements DOMCache {
    ...
    public final class CachedDocument {
        ...
        public void loadDocument(String uri) {
            ...
            try {
                final long stamp = System.currentTimeMillis();
                _dom = (DOMEnhancedForDTM) _dtmManager.getDTM(new SAXSource(_reader, new InputSource(uri)),
    ...
    /**
     * Returns a document either by finding it in the cache or downloading it
