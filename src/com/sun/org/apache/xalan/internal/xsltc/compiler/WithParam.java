...
final class WithParam extends Instruction {
     ...
     * for a simple named template. If this is true, the parameters are passed
     * to the named template through method arguments rather than using the
     * expensive Translet.addParameter() call.
     */
