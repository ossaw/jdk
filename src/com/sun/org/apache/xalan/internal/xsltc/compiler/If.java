...
final class If extends Instruction {
    ...
    /**
     * Type-check the "test" expression and contents of this element. The
     * contents will be ignored if we know the test will always fail.
     */
    ...
    /**
     * Translate the "test" expression and contents of this element. The
     * contents will be ignored if we know the test will always fail.
     */
