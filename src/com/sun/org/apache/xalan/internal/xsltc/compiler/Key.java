...
final class Key extends TopLevelElement {
	 ...
	 */
	public void traverseNodeSet(ClassGenerator classGen, MethodGenerator methodGen,
			int buildKeyIndex) {
		final ConstantPoolGen cpg = classGen.getConstantPool();
		final InstructionList il = methodGen.getInstructionList();

		// DOM.getStringValueX(nodeIndex) => String
		final int getNodeValue = cpg.addInterfaceMethodref(DOM_INTF, GET_NODE_VALUE,
				"(I)" + STRING_SIG);

		final int getNodeIdent = cpg.addInterfaceMethodref(DOM_INTF, "getNodeIdent",
				"(I)" + NODE_SIG);

		// AbstractTranslet.SetKeyIndexDom(name, Dom) => void
		final int keyDom = cpg.addMethodref(TRANSLET_CLASS, "setKeyIndexDom",
		...
		final LocalVariableGen parentNode = methodGen.addLocalVariable("parentNode",
	...
	/**
	 * Gather all nodes that match the expression in the attribute "match" and
	 * add one (or more) entries in this key's index.
	 */
	public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
		...
		final int key = cpg.addMethodref(TRANSLET_CLASS, "buildKeyIndex",
		...
		final int git = cpg.addInterfaceMethodref(DOM_INTF, "getAxisIterator",
				"(I)" + NODE_ITERATOR_SIG);
