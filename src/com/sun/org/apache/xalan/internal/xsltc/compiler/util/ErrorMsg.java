...
public final class ErrorMsg {
	...
	/**
	 * This version of toString() uses the _params instance variable to format
	 * the message. If the <code>_code</code> is negative the use _message as
	 * the error string.
	 */
	...
	/**
	 * Return an ErrorMessages string corresponding to the _code This function
	 * is temporary until the three special-cased keys below are moved into
	 * ErrorMessages
	 *
