...
/**
 * This class is used for result trees implemented as methods. These methods
 * take a reference to the DOM and to the handler only.
 * 
...
public final class RtMethodGenerator extends MethodGenerator {
    ...
    public RtMethodGenerator(int access_flags, Type return_type, Type[] arg_types, String[] arg_names,
