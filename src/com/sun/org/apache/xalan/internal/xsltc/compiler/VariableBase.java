...
class VariableBase extends TopLevelElement {
    ...
    /**
     * When a variable is overriden by another, e.g. via xsl:import, its
     * references need to be copied or otherwise it may be compiled away as dead
     * code. This method can be used for that purpose.
     */
    ...
    /**
     * Returns an instruction for loading the value of this variable onto the
     * JVM stack.
     */
