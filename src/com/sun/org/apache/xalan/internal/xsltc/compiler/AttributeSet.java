...
final class AttributeSet extends TopLevelElement {
	 ...
	 * This is used in case several <xsl:attribute-set...> elements constitute a
	 * single set (with one name). The last element will merge itself with any
	 * previous set(s) with the same name and disable the other set(s).
	 */
	public void ignore() {
		_ignore = true;
	}
