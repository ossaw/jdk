...
final class XslAttribute extends Instruction {
    ...
    public void parseContents(Parser parser) {
        ...
        if (_namespace != null) {
            ...
            /*
             * TODO: The namespace URI must be passed to the parent element but
             * we don't yet know what the actual URI is (as we only know it as
    ...
    public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        if (!_isLiteral) {
            ...
            final int check = cpg.addMethodref(BASIS_LIBRARY_CLASS, "checkAttribQName", "(" + STRING_SIG
                    + ")V");
