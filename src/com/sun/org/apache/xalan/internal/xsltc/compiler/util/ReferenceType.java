...
public final class ReferenceType extends Type {
	...
	public void translateTo(ClassGenerator classGen, MethodGenerator methodGen, StringType type) {
		...
		final int stringF = cpg.addMethodref(BASIS_LIBRARY_CLASS, "stringF",
	...
	public void translateTo(ClassGenerator classGen, MethodGenerator methodGen, Class clazz) {
		...
		int referenceToLong = cpg.addMethodref(BASIS_LIBRARY_CLASS, "referenceToLong",
				"(" + OBJECT_SIG + ")J");
		int referenceToDouble = cpg.addMethodref(BASIS_LIBRARY_CLASS, "referenceToDouble",
				"(" + OBJECT_SIG + ")D");
		int referenceToBoolean = cpg.addMethodref(BASIS_LIBRARY_CLASS, "referenceToBoolean",
				"(" + OBJECT_SIG + ")Z");
