...
public class ClassGenerator extends ClassGen {
    ...
    /**
     * Pretend this is the stylesheet class. Useful when compiling references to
     * global variables inside a predicate.
     */
    ...
    /**
     * Returns <tt>true</tt> or <tt>false</tt> depending on whether this class
     * inherits from <tt>AbstractTranslet</tt> or not.
     */
