...
public class BitArray implements Externalizable {
    ...
    private final static int[] _masks = { 0x80000000, 0x40000000, 0x20000000, 0x10000000, 0x08000000,
            0x04000000, 0x02000000, 0x01000000, 0x00800000, 0x00400000, 0x00200000, 0x00100000, 0x00080000,
            0x00040000, 0x00020000, 0x00010000, 0x00008000, 0x00004000, 0x00002000, 0x00001000, 0x00000800,
    ...
    /**
     * Set the mask for this bit array. The upper 8 bits of this mask indicate
     * the DOM in which the nodes in this array belong.
     */
    ...
    /**
     * This method returns the Nth bit that is set in the bit array. The current
     * position is cached in the following 4 variables and will help speed up a
     * sequence of next() call in an index iterator. This method is a mess, but
     * it is fast and it works, so don't fuck with it.
     */
    ...
    /**
     * Merge two bit arrays. This currently only works for nodes from a single
     * DOM (because there is only one _mask per array).
     */
