...
final class FunctionAvailableCall extends FunctionCall {
    ...
    /**
     * Constructs a FunctionAvailableCall FunctionCall. Takes the function name
     * qname, for example, 'function-available', and a list of arguments where
     * the arguments must be instances of LiteralExpression.
     */
    ...
    /**
     * Argument of function-available call must be literal, typecheck returns
     * the type of function-available to be boolean.
     */
    ...
    /**
     * for external java functions only: reports on whether or not the specified
     * method is found in the specifed class.
     */
    ...
    /**
     * Reports on whether the function specified in the argument to xslt
     * function 'function-available' was found.
     */
