...
abstract class Expression extends SyntaxTreeNode {
     ...
     * operand stack for the next statement to succeed. Returns the handle of
     * the instruction to be backpatched.
     */
     ...
     * primop is overloaded then the "closest match" is returned. The first
