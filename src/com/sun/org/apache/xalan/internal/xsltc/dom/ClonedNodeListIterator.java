...
/**
 * A ClonedNodeListIterator is returned by the cloneIterator() method of a
 * CachedNodeListIterator. Its next() method retrieves the nodes from the cache
 * of the CachedNodeListIterator.
 */
