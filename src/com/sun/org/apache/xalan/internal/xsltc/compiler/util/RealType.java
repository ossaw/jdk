...
public final class RealType extends NumberType {
    ...
    /**
     * Translates a real into a non-synthesized boolean. It does not push a 0 or
     * a 1 but instead returns branchhandle list to be appended to the false
     * list. A NaN must be converted to "false".
     *
    ...
    public FlowList translateToDesynthesized(ClassGenerator classGen,
        ...
        local = methodGen.addLocalVariable("real_to_boolean_tmp",
                com.sun.org.apache.bcel.internal.generic.Type.DOUBLE, null,
                null);
    ...
    public void translateTo(ClassGenerator classGen, MethodGenerator methodGen,
        ...
        il.append(DUP_X2);
        il.append(POP);
        il.append(new INVOKESPECIAL(cpg.addMethodref(DOUBLE_CLASS, "<init>",
                "(D)V")));
    }
    ...
    public void translateUnBox(ClassGenerator classGen,
        ...
        il.append(new INVOKEVIRTUAL(cpg.addMethodref(DOUBLE_CLASS, DOUBLE_VALUE,
                DOUBLE_VALUE_SIG)));
    }
