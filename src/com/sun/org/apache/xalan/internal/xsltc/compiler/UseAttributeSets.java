...
final class UseAttributeSets extends Instruction {
	 ...
	 * itself with another AttributeSet (including any other AttributeSets the
	 * two may inherit from).
	 */
	...
	public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
		...
		for (int i = 0; i < _sets.size(); i++) {
			...
			if (attrs != null) {
				...
				final int method = cpg.addMethodref(classGen.getClassName(), methodName,
						ATTR_SET_SIG);
