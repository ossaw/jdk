...
final class CallTemplate extends Instruction {
    ...
    public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        StringBuffer methodSig = new StringBuffer("(" + DOM_INTF_SIG + NODE_ITERATOR_SIG + TRANSLET_OUTPUT_SIG
                + NODE_SIG);
    ...
    /**
     * Build the list of effective parameters in this CallTemplate. The
     * parameters of the called template are put into the array first. Then we
     * visit the WithParam children of this CallTemplate and replace the Param
     * with a corresponding WithParam having the same name.
     */
