...
public final class NodeType extends Type {
    ...
    /**
     * Translates a node into a synthesized boolean. If the expression is
     * "@attr", then "true" is pushed iff "attr" is an attribute of the current
     * node. If the expression is ".", the result is always "true".
     *
     * @see com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type#translateTo
     */
    ...
    /**
     * Expects a node on the stack and pushes a real. First the node is
    ...
    /**
     * Translates a node into a non-synthesized boolean. It does not push a 0 or
     * a 1 but instead returns branchhandle list to be appended to the false
     * list.
     *
     ...
     * <code>com.sun.org.apache.xalan.internal.xsltc.dom.Node</code>.
     *
     * @see com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type#translateTo
     */
