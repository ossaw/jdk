...
public final class ObjectType extends Type {
    ...
    /**
     * Must return the same value for all ObjectType instances. This is needed
     * in CastExpr to ensure the mapping table is used correctly.
     */
    public int hashCode() {
    ...
    public void translateTo(ClassGenerator classGen, MethodGenerator methodGen, Class clazz) {
        if (clazz.isAssignableFrom(_clazz))
            ...
            ErrorMsg err = new ErrorMsg(ErrorMsg.DATA_CONVERSION_ERR, toString(), clazz.getClass()
                    .toString());
            classGen.getParser().reportError(Constants.FATAL, err);
        }
    }
