...
public final class ResultTreeType extends Type {
     ...
     * The translation to int is undefined since result trees are always
    ...
    public void translateTo(ClassGenerator classGen, MethodGenerator methodGen, StringType type) {
        ...
        if (_methodName == null) {
            ...
            final LocalVariableGen handler = methodGen.addLocalVariable("rt_to_string_handler", Util
                    .getJCRefType(STRING_VALUE_HANDLER_SIG), null, null);
    ...
    /**
     * Expects an result tree on the stack and pushes a real. Translates a
    ...
    public void translateTo(ClassGenerator classGen, MethodGenerator methodGen, ReferenceType type) {
        ...
        if (_methodName == null) {
            ...
            newDom = methodGen.addLocalVariable("rt_to_reference_dom", Util.getJCRefType(DOM_INTF_SIG), null,
                    null);
            ...
            domBuilder = methodGen.addLocalVariable("rt_to_reference_handler", Util.getJCRefType(
                    TRANSLET_OUTPUT_SIG), null, null);
     ...
     * result tree, and not the DOM that is currently in use. This conversion
     * here will therefore not directly work with elements such as
     * <xsl:apply-templates> and <xsl:for-each> without the DOM
    ...
    public void translateTo(ClassGenerator classGen, MethodGenerator methodGen, NodeSetType type) {
        ...
        final int mapping = cpg.addInterfaceMethodref(DOM_INTF, "setupMapping", "([" + STRING_SIG + "["
    ...
    /**
     * Translates a result tree into a non-synthesized boolean. It does not push
     * a 0 or a 1 but instead returns branchhandle list to be appended to the
     * false list.
     *
     * @param classGen
     *        A BCEL class generator
     ...
     * Expects a result tree on the stack and pushes an object of the
     * appropriate type after coercion. Result trees are translated to W3C Node
