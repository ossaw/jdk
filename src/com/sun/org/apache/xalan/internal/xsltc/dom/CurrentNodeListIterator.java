...
public final class CurrentNodeListIterator extends DTMAxisIteratorBase {
	...
	public CurrentNodeListIterator(DTMAxisIterator source, CurrentNodeListFilter filter,
	...
	public CurrentNodeListIterator(DTMAxisIterator source, boolean docOrder,
			CurrentNodeListFilter filter, int currentNode, AbstractTranslet translet) {
		_source = source;
		_filter = filter;
		_translet = translet;
		_docOrder = docOrder;
