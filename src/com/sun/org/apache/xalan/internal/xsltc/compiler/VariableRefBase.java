...
class VariableRefBase extends Expression {
	...
	/**
	 * A reference to the enclosing expression/instruction for which a closure
	 * is needed (Predicate, Number or Sort).
	 */
	...
	/**
	 * Two variable references are deemed equal if they refer to the same
	 * variable.
	 */
	@Override
