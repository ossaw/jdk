...
final class KeyCall extends FunctionCall {
     ...
     * value(s) to look up. The vector has only one parameter for id() calls
     ...
     * (for key() call only) must be a string or convertable to a string, and
     ...
     * <p>
     * This method will generate byte code that produces an iterator for the
    ...
    public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        final int getKeyIterator = cpg.addMethodref(KEY_INDEX_CLASS, "getKeyIndexIterator", "(" + _valueType
                .toSignature() + "Z)" + KEY_INDEX_ITERATOR_SIG);
