...
final class When extends Instruction {
	 ...
	 * while we do not bother with the contents if we know the test fails. This
	 * is important in cases where the "test" expression tests for the support
	 * of a non-available element, and the <xsl:when> body contains this
