...
public final class NodeSetType extends Type {
	...
	public com.sun.org.apache.bcel.internal.generic.Type toJCType() {
		return new com.sun.org.apache.bcel.internal.generic.ObjectType(
				NODE_ITERATOR);
	}

	/**
	 * Translates a node-set into an object of internal type <code>type</code>.
	 * The translation to int is undefined since node-sets are always converted
	...
	public void translateFrom(ClassGenerator classGen,
		...
		if (clazz.getName().equals("org.w3c.dom.NodeList")) {
			// w3c NodeList is on the stack from the external Java function
			// call.
			...
			final int convert = cpg.addMethodref(BASIS_LIBRARY_CLASS,
					"nodeList2Iterator", "(" + "Lorg/w3c/dom/NodeList;"
							+ TRANSLET_INTF_SIG + DOM_INTF_SIG + ")"
							+ NODE_ITERATOR_SIG);
			...
			il.append(methodGen.loadDOM()); // push DOM onto stack
			final int convert = cpg.addMethodref(BASIS_LIBRARY_CLASS,
					"node2Iterator", "(" + "Lorg/w3c/dom/Node;"
							+ TRANSLET_INTF_SIG + DOM_INTF_SIG + ")"
							+ NODE_ITERATOR_SIG);
			il.append(new INVOKESTATIC(convert));
		} else {
	...
	/**
	 * Translates a node-set into a non-synthesized boolean. It does not push a
	...
	/**
	 * Expects a node-set on the stack and pushes a boxed node-set. Node sets
	 * are already boxed so the translation is just a NOP.
	 *
	 * @see com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type#translateTo
	 */
	public void translateTo(ClassGenerator classGen, MethodGenerator methodGen,
	...
	public void translateTo(ClassGenerator classGen, MethodGenerator methodGen,
		...
		if (className.equals("org.w3c.dom.Node")) {
		...
		} else if (className.equals("org.w3c.dom.NodeList") || className.equals(
				"java.lang.Object")) {
			...
			int index = cpg.addInterfaceMethodref(DOM_INTF, GET_NODE_VALUE,
					"(I)" + STRING_SIG);
	 ...
	 */
	private void getFirstNode(ClassGenerator classGen,
