...
public class TransformerHandlerImpl implements TransformerHandler, DeclHandler {
    ...
    /**
     * Implements javax.xml.transform.sax.TransformerHandler.getSystemId() Get
    ...
    /**
     * Implements javax.xml.transform.sax.TransformerHandler.setSystemId() Get
     * the base ID (URI or system ID) from where relative URLs will be resolved.
     * 
     * @param id
    ...
    public void setResult(Result result) throws IllegalArgumentException {
        ...
        if (null == result) {
            ...
            throw new IllegalArgumentException(err.toString()); // "result
                                                                // should not be
                                                                // null");
        }
        ...
        if (_isIdentity) {
            try {
                ...
                SerializationHandler outputHandler = _transformer
                        .getOutputHandler(result);
    ...
    /**
     * Implements org.xml.sax.ContentHandler.characters() Receive notification
     * of character data.
     */
    @Override
    ...
    /**
     * Implements org.xml.sax.ContentHandler.startDocument() Receive
    ...
    /**
     * Implements org.xml.sax.ContentHandler.endDocument() Receive notification
    ...
    public void endDocument() throws SAXException {
        ...
        if (_isIdentity && _result instanceof DOMResult) {
            ((DOMResult) _result).setNode(_transformer
                    .getTransletOutputHandlerFactory().getNode());
        }
    }
    ...
    /**
     * Implements org.xml.sax.ContentHandler.endElement() Receive notification
    ...
    /**
     * Implements org.xml.sax.ContentHandler.skippedEntity() Receive
    ...
    /**
     * Implements org.xml.sax.ContentHandler.startPrefixMapping() Begin the
    ...
    /**
     * Implements org.xml.sax.ContentHandler.endPrefixMapping() End the scope of
