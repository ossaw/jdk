...
public class ErrorMessages_it extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] { { ErrorMsg.MULTIPLE_STYLESHEET_ERR,
                 ...
                 * template. The same name was used on two different templates
                ...
                /*
                 * Note to translators: The substitution text is the name of a
                 * template. A reference to the template name was encountered,
                 * but the template is undefined.
                 */
                ...
                /*
                 * Note to translators: The substitution text is the name of a
                 * variable that was defined more than once.
                 */
                 ...
                 * class. Processing the stylesheet required a class to be
                 ...
                 * method. Processing the stylesheet required a reference to the
                 * method named by the substitution text, but it could not be
                 * found. "public" is the Java keyword.
                 */
                 ...
                 * Note to translators: The word "method" here refers to a Java
                 * method. Processing the stylesheet required a reference to the
                 * method named by the substitution text, but no method with the
                 * required types of arguments or return type could be found.
                 */
                 ...
                 * value.
                 */
                { ErrorMsg.NEED_LITERAL_ERR, "L''argomento per ''{0}'' deve essere una stringa di valori." },
                 ...
                 */
                { ErrorMsg.XPATH_PARSER_ERR, "Errore durante l''analisi dell''espressione XPath ''{0}''." },
                 ...
                 * item in an XML document that request some behaviour of an XML
                 ...
                 * stylesheet being processed attempted to construct an XML
                 * document with an attribute in a place other than on an
                 ...
                 * should not be translated. This messages indicates that the
                 * stylesheet named in the substitution text imported or
                 * included itself either directly or indirectly.
                 */
                 ...
                 * resulting XML document represented as a tree. "<xsl:sort>" is
                 * a keyword and should not be translated.
                 */
                ...
                /*
                 * Note to translators: A name can be given to a particular
                 * style to be used to format decimal values. The substitution
                 ...
                 * or parameters depend on one another.
                 */
                 ...
                 * must not be translated. A node-set is a set of the nodes in
                ...
                /*
                 * Note to translators: "<xsl:when>" and "<xsl:choose>" are
                 ...
                 * a syntax error in the stylesheet.
                 */
                { ErrorMsg.STRAY_WHEN_ERR, "<xsl:when> pu\u00F2 essere utilizzato sono in <xsl:choose>." },

                /*
                 * Note to translators: "<xsl:when>", "<xsl:otherwise>" and
                 * "<xsl:choose>" are keywords and should not be translated.
                 ...
                 * a stylesheet are referred to as top-level elements. No text
                 * should occur within that outermost element unless it is
                 * within a top-level element. This message indicates that that
                 * constraint was violated. "<xsl:stylesheet>" is a keyword that
                ...
                /*
                 * Note to translators: JAXP is an acronym for the Java API for
                 * XML Processing. This message indicates that the XML parser
                 ...
                 * to the XSL syntax and indicated that it was defined by XSLTC,
                 ...
                 * stylesheet was not, in fact, a stylesheet. XSLTC is able to
                 * detect that in this case because the outermost element in the
                 * stylesheet has to be declared with respect to the XSL
                 * namespace URI, but no declaration for that namespace was
                 * seen.
                 */
                ...
                /*
                 * Note to translators: This message represents an internal
                 ...
                 */
                { ErrorMsg.NOT_STYLESHEET_ERR, "Il documento di input non contiene un foglio di stile XSL." },
                 ...
                 * "string" and "number" are keywords in this context and should
                 * not be translated. This message indicates that the value of
                 * the "use" attribute was not one of the permitted values.
                 */
                { ErrorMsg.KEY_USE_ATTR_ERR,
                        "L'attributo di uso <key> deve essere un nodo, un set di nodi, una stringa o un numero." },

                /*
                 * Note to translators: An XML document can specify the version
                 * of the XML specification to which it adheres. This message
                 * indicates that the version specified for the output document
                 * was not valid.
                 */
                { ErrorMsg.OUTPUT_VERSION_ERR, "La versione del documento XML di output deve essere 1.0" },
                 ...
                 * attributes that can be added to an element in the output XML
                 * document as a group. This message is reported if the name
                 * specified was not used to declare an attribute set. The
                ...
                /*
                 * Note to translators: The term "attribute value template" is a
                 * term defined by XSLT which describes the value of an
                 * attribute that is determined by an XPath expression. The
                 * message indicates that the expression was syntactically
                 ...
                 * types. The message is displayed if a value in a particular
                 ...
                 * should not be translated.
                 */
                { ErrorMsg.NO_MAIN_TRANSLET_ERR, "Il modello non contiene una classe denominata ''{0}''." },
                ...
                /*
                 * Note to translators: "ErrorListener" is a Java interface name
                 * that should not be translated. The message indicates that the
                 * user tried to set an ErrorListener object on object of the
                 * class named in the substitution text with "null" Java value.
                 */
                { ErrorMsg.ERROR_LISTENER_NULL_ERR,
                        "Tentativo di impostare ErrorListener per ''{0}'' su null" },

                /*
                 * Note to translators: StreamSource, SAXSource and DOMSource
                 * are Java interface names that should not be translated.
                 */
                { ErrorMsg.JAXP_UNKNOWN_SOURCE_ERR,
                        "XSLTC supporta solo StreamSource, SAXSource e DOMSource." },

                /*
                 * Note to translators: "Source" is a Java class name that
                 * should not be translated. The substitution text is the name
                 * of Java method.
                 */
                { ErrorMsg.JAXP_NO_SOURCE_ERR, "L''oggetto di origine passato a ''{0}'' non ha contenuti." },
                 ...
                 * this context, an attribute is a property or setting of the
                 * TransformerFactory object. The substitution text is the name
                 * of the unrecognised attribute. The method used to retrieve
                 * the attribute is "getAttribute", so it's not clear whether it
                 * would be best to translate the term "attribute".
                 */
                { ErrorMsg.JAXP_INVALID_ATTR_ERR, "TransformerFactory non riconosce l''attributo ''{0}''." },
                 ...
                 * that should not be translated. A Transformer object should
                 * contained a reference to a translet object in order to be
                 * used for transformations; this message is produced if that
                 * requirement is not met.
                 */
                { ErrorMsg.JAXP_NO_TRANSLET_ERR, "Il trasformatore non contiene alcun oggetto incapsulato." },

                /*
                 * Note to translators: The XML document that results from a
                 * transformation needs to be sent to an output handler object;
                ...
                /*
                 * Note to translators: "Transformer" is a Java interface name.
                 * The user's program attempted to access an unrecognized
                 * property with the name specified in the substitution text.
                 * The method used to retrieve the property is
                 * "getOutputProperty", so it's not clear whether it would be
                 * best to translate the term "property".
                 */
                { ErrorMsg.JAXP_UNKNOWN_PROP_ERR,
                        "Tentativo di accedere a una propriet\u00E0 ''{0}'' del trasformatore non valida." },

                /*
                 * Note to translators: SAX2DOM is the name of a Java class that
                 * should not be translated. This is an adapter in the sense
                 ...
                 * name. "systemId" is an XML term that is short for
                 ...
                 * argument of setParameter must be a valid Java Object.
                 */
                 ...
                 * for a means of invoking XSLTC from the command-line. The
                 * message is formatted for presentation in English. The strings
                 * <output>, <directory>, etc. indicate user-specified argument
                 * values, and can be translated - the argument <package> refers
                 * to a Java package, so it should be handled in the same way
                 * the term is handled for JDK documentation.
                 */
                 ...
                 * for a means of invoking XSLTC from the command-line. The
                 * message is formatted for presentation in English. The strings
                 * <jarfile>, <document>, etc. indicate user-specified argument
                 * values, and can be translated - the argument <class> refers
                 * to a Java class, so it should be handled in the same way the
                 ...
                 * "<xsl:apply-templates>" are keywords that should not be
                 * translated. The message indicates that an xsl:sort element
                 * must be a child of one of the other kinds of elements
                 * mentioned.
                 */
                 ...
                 * requested for the output document was on that requires
                 * support that is not available from the Java Virtual Machine
                 * being used to execute the program.
                 */
                { ErrorMsg.UNSUPPORTED_ENCODING,
                        "La codifica di output ''{0}'' non \u00E8 supportata in questa JVM." },

                /*
                 * Note to translators: The message indicates that the XPath
                ...
                /*
                 * Note to translators: The substitution text is the name of a
                 * Java class. The term "constructor" here is the Java term. The
                 ...
                 * substitution text is the name of a function. The first
                 * argument of that function is not of the required type.
                 */
                ...
                /*
                 * Note to translators: An XPath expression was not of the type
                 * required in a particular context. However, the location of
                 * the problematic expression is unknown.
                 */
                ...
                /*
                 * Note to translators: The substitution text is the name of a
                 * command- line option that was not recognized.
                 */
                 ...
                 * severity of another message. The substitution text contains
                 * two error messages. The spacing before the second
                 ...
                 * class, while the second substitution is the name of a jar
                 * file.
                 */
                ...
                /*
                 * Note to translators: "TransformerFactory" is the name of a
                 * Java interface and must not be translated. The substitution
                 ...
                 * specified a name for the translet class that contains
                 * characters that are not permitted in a Java class name. The
                 * substitution text "{0}" specifies the name the user
                 * requested, while "{1}" specifies the name the processor used
                 * instead.
                 */
                ...
                /*
                 * Note to translators: The following message is used as a
                 * header. All the error messages that are produced when the
                 * stylesheet is applied to an input document are collected
                 * together and displayed beneath this message. A 'translet' is
                 * the compiled form of a stylesheet (see above).
                 */
                { ErrorMsg.RUNTIME_ERROR_KEY, "Errori del translet:" },

                /*
                 * Note to translators: An attribute whose value is constrained
                 * to be a "QName" or a list of "QNames" had a value that was
                 * incorrect. 'QName' is an XML syntactic term that must not be
                 * translated. The substitution text contains the actual value
                 * of the attribute.
                 */
                 ...
                 * be an "NCName". 'NCName' is an XML syntactic term that must
                 * not be translated. The substitution text contains the actual
                 ...
                 * "xml", "html" or "text"; it is also permitted to have the
                 * form of a QName that is not also an NCName. The terms
                 * "method", "xsl:output", "xml", "html" and "text" are keywords
                 * that must not be translated. The term "qname-but-not-ncname"
                 * is an XML syntactic term. The substitution text contains the
                 ...
                 * in the processor. The term "byte code" is a Java technical
                 * term for the executable code in a Java method, and
                 * "try-catch-finally block" refers to the Java keywords with
                 * those names. "Outlined" is a technical term internal to XSLTC
                ...
                /*
                 * Note to translators: This message describes an internal error
                 * in the processor. The terms "OutlineableChunkStart" and
                 * "OutlineableChunkEnd" are the names of classes internal to
                 * XSLTC and should not be translated. The message indicates
                 * that for every "start" there must be a corresponding "end",
                 * and vice versa, and that if one of a pair of "start" and
                 * "end" appears between another pair of corresponding "start"
                 * and "end", then the other half of the pair must also be
                 ...
                 * Note to translators: This message describes an internal error
                 * in the processor. The term "byte code" is a Java technical
                 * term for the executable code in a Java method. The "method"
                 * that is being referred to is a Java method in a translet that
                 * XSLTC is generating in processing a stylesheet. The
                 * "instruction" that is being referred to is one of the
                 * instrutions in the Java byte code in that method. "Outlined"
                 * is a technical term internal to XSLTC and should not be
                 * translated.
                 */
                ...
                { ErrorMsg.DESERIALIZE_TRANSLET_ERR,
                        "Quando la sicurezza Java \u00E8 abilitata, il supporto per la deserializzazione TemplatesImpl \u00E8 disabilitato. \u00C8 possibile ignorare questa condizione impostando su true la propriet\u00E0 di sistema jdk.xml.enableTemplatesImplDeserialization." }
