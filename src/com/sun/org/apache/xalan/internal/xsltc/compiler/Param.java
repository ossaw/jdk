...
final class Param extends VariableBase {
	...
	/**
	 * True if this Param is declared in a simple named template. This is used
	 * to optimize codegen for parameter passing in named templates.
	 */
	...
	public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
		 ...
		 * {namespaceuri}localName which will get mapped to an instance variable
		 * in the class.
		 */
		...
		if (isLocal()) {
			 ...
			 * param using its default value: if (param == null) param =
			 * <default-value>
			 */
