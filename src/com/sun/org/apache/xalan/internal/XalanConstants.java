...
public final class XalanConstants {
	 ...
	 * loader that will be used for extension functions class loading Value: a
	 * "null", the default value, means that the default EF class loading path
	 * will be used. Instance of ClassLoader: the specified instance of
	 * ClassLoader will be used for extension functions loading during
	 * translation process
	 */
	 ...
	 */
	public static final String ORACLE_ENABLE_EXTENSION_FUNCTION = ORACLE_JAXP_PROPERTY_PREFIX
