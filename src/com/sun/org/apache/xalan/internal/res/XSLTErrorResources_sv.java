...
public class XSLTErrorResources_sv extends ListResourceBundle {
	...
	public Object[][] getContents() {
		return new Object[][] {
				...
				{ "optionMEDIA",
						"   [-MEDIA mediaType (anv\u00E4nd medieattribut f\u00F6r att hitta formatmall som h\u00F6r ihop med dokument.)]" },
				{ "optionFLAVOR",
						"   [-FLAVOR flavorName (Anv\u00E4nd s2s=SAX eller d2d=DOM vid transformering.)] " }, // Added
																												// by
																												// sboag/scurcuru;
																												// experimental
				{ "optionDIAG",
