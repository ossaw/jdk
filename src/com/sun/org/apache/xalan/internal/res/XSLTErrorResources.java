...
public class XSLTErrorResources extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
                ...
                { ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML, "processing-instruction name can not be 'xml'" },
                ...
                { ER_XMLSPACE_ILLEGAL_VAL, "(StylesheetHandler) " + "xml:space has an illegal value: {0}" },
                ...
                { ER_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet requires a 'version' attribute!" },
                ...
                { ER_NO_NAMESPACE_DECL, "Prefix {0} does not have a corresponding namespace declaration" },
                ...
                { ER_CANNOT_CALL_PARSE, "parse can not be called if the ContentHandler has not been set" },
                ...
                { ER_NUMBER_TOO_BIG, "Attempting to format a number bigger than the largest Long integer" },
                ...
                { ER_NAMESPACE_CONTEXT_NULL_NAMESPACE, "Cannot get the prefix for a null namespace uri." },
                ...
                { WG_STYLESHEET_REQUIRES_VERSION_ATTRIB, "xsl:stylesheet requires a 'version' attribute!" },
                ...
                { "ui_language", "en" }, { "help_language", "en" }, { "language", "en" }, { "BAD_CODE",
                        "Parameter to createMessage was out of bounds" }, { "FORMAT_FAILED",
                                "Exception thrown during messageFormat call" }, { "version",
                                        ">>>>>>> Xalan Version " }, { "version2", "<<<<<<<" }, { "yes",
                                                "yes" }, { "line", "Line #" }, { "column", "Column #" }, {
                ...
                { "xslProc_option", "Xalan-J command line Process class options:" }, { "xslProc_option",
                ...
                { "xslProc_common_options", "-Common Options-" }, { "xslProc_xalan_options",
                        "-Options for Xalan-" }, { "xslProc_xsltc_options", "-Options for XSLTC-" }, {
                ...
                { "optionXSLTC", "   [-XSLTC (use XSLTC for transformation)]" }, { "optionIN",
                ...
                { "optionE", "   [-E (Do not expand entity refs)]" }, { "optionV",
                        "   [-E (Do not expand entity refs)]" }, { "optionQC",
                                "   [-QC (Quiet Pattern Conflicts Warnings)]" }, { "optionQ",
                                        "   [-Q  (Quiet Mode)]" }, { "optionLF",
                ...
                { "noParsermsg1", "XSL Process was not successful." }, { "noParsermsg2",
                        "** Could not find parser **" }, { "noParsermsg3", "Please check your classpath." }, {
                                "noParsermsg4",
                ...
                // it.
                { "optionXN", "   [-XN (enables template inlining)]" }, { "optionXX",
                        "   [-XX (turns on additional debugging message output)]" }, { "optionXT",
                                "   [-XT (use translet to transform if possible)]" }, { "diagTiming",
