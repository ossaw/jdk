...
/**
 * This class contains EXSLT common extension functions. It is accessed by
...
public class ExsltCommon {
	 ...
	 * utilities such as named templates or user-defined extension functions may
	 ...
	 * you get when you use the content of xsl:variable rather than its select
