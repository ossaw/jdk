...
/**
 * This class contains EXSLT set extension functions. It is accessed by
...
public class ExsltSets extends ExsltBase {
     ...
     * first argument that precede, in document order, the first node in the
     * node set passed as the second argument. If the first node in the second
     * node set is not contained in the first node set, then an empty node set
     * is returned. If the second node set is empty, then the first node set is
     * returned.
     *
     * @param nl1
     ...
     * - those nodes that are in the node set passed as the first argument that
