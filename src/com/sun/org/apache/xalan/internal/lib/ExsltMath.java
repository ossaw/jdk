...
public class ExsltMath extends ExsltBase {
     ...
     * the argument. The maximum value is defined as follows. The node set
     * passed as an argument is sorted in descending order as it would be by
     * xsl:sort with a data type of number. The maximum is the result of
     * converting the string value of the first node in this sorted list to a
     ...
     * the argument. The minimum value is defined as follows. The node set
     * passed as an argument is sorted in ascending order as it would be by
     * xsl:sort with a data type of number. The minimum is the result of
     * converting the string value of the first node in this sorted list to a
     * number using the number function.
     * <p>
     * If the node set is empty, or if the result of converting the string
    ...
    /**
     * The math:highest function returns the nodes in the node set whose value
     * is the maximum value for the node set. The maximum value for the node set
     * is the same as the value as calculated by math:max. A node has this
     * maximum value if the result of converting its string value to a number as
     * if by the number function is equal to the maximum value, where the
     * equality comparison is defined as a numerical comparison using the =
     * operator.
     * <p>
     ...
     * NaN != NaN. Therefore if any of the nodes in the node set has a
     ...
     * value if the result of converting its string value to a number as if by
     * the number function is equal to the minimum value, where the equality
