...
public class ExsltStrings extends ExsltBase {
	 ...
	 * string begins with the first character in the padding string. With right
	 * alignment, the range of characters replaced by the target string ends
	 * with the last character in the padding string. With center alignment, the
	 * range of characters replaced by the target string is in the middle of the
	 * padding string, such that either the number of unreplaced characters on
	 * either side of the range is the same or there is one less on the left
	...
	public static String align(String targetStr, String paddingStr, String type) {
		...
		if (type.equals("right")) {
			...
			return paddingStr.substring(0, startIndex) + targetStr
	 ...
	 * the string values of the nodes in that node set. If the node set is
	 ...
	 * string is repeated as many times as is necessary to create a string of
	 * the length specified by the first argument; if the string is more than a
	 * character long, it may have to be truncated to produce the required
	 * length. If no second argument is specified, it defaults to a space (' ').
	 * If the second argument is an empty string, str:padding returns an empty
	 * string.
	 *
	 * @param length
	 ...
	 * <p>
	 * The first argument is the string to be tokenized. The second argument is
	 * a string consisting of a number of characters. Each character in this
	 * string is taken as a delimiting character. The string given by the first
	 * argument is split at any occurrence of any of these characters. For
	 * example:
	 * 
	 * <pre>
