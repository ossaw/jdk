...
public class FactoryImpl {
    ...
    static public DocumentBuilderFactory getDOMFactory(boolean useServicesMechanism) {
        DocumentBuilderFactory dbf = useServicesMechanism ? DocumentBuilderFactory.newInstance()
    ...
    static public SAXParserFactory getSAXFactory(boolean useServicesMechanism) {
        SAXParserFactory factory = useServicesMechanism ? SAXParserFactory.newInstance()
