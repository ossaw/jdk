...
public class Field {
	...
	public static class XPath extends com.sun.org.apache.xerces.internal.impl.xpath.XPath {
		...
		public XPath(String xpath, SymbolTable symbolTable, NamespaceContext context)
			...
			// ... or a / or a . - NG
			super(((xpath.trim().startsWith("/") || xpath.trim().startsWith(".")) ? xpath
					: "./" + xpath), symbolTable, context);
	...
	protected class Matcher extends XPathMatcher {
		...
		protected void matched(Object actualValue, short valueType, ShortList itemValueType,
			...
			fStore.addValue(Field.this, actualValue, convertToPrimitiveKind(valueType),
		...
		protected void handleContent(XSTypeDefinition type, boolean nillable, Object actualValue,
			...
			if (type == null || type.getTypeCategory() == XSTypeDefinition.COMPLEX_TYPE
				...
				fStore.reportError("cvc-id.3", new Object[] { fIdentityConstraint.getName(),
