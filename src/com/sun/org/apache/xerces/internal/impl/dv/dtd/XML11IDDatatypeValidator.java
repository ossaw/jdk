...
/**
 * <P>
 * IDDatatypeValidator - ID represents the ID attribute type from XML 1.1
 * Recommendation. The value space of ID is the set of all strings that match
 * the NCName production and have been used in an XML document. The lexical
 * space of ID is the set of all strings that match the NCName production.
 * </P>
 * <P>
 * The value space of ID is scoped to a specific instance document.
 * </P>
 * <P>
 * The following constraint applies: An ID must not appear more than once in an
 * XML document as a value of this type; i.e., ID values must uniquely identify
