...
public class DoubleDV extends TypeValidator {
    ...
    /**
     * Returns true if it's possible that the given string represents a valid
    ...
    private static final class XDouble implements XSDouble {
        ...
        public int hashCode() {
            // This check is necessary because doubleToLongBits(+0) !=
            // doubleToLongBits(-0)
            if (value == 0d) {
                return 0;
            }
        ...
        public boolean isIdentical(XDouble val) {
            ...
            if (value == val.value) {
                return (value != 0.0d || (Double.doubleToLongBits(value) == Double.doubleToLongBits(
                        val.value)));
            }
