...
/**
 * <p>
 * SchemaContentHandler converts SAX events into XNI and passes them directly to
 * the SchemaDOMParser.
 * </p>
 *
 * @xerces.internal
...
final class SchemaContentHandler implements ContentHandler {
    ...
    /**
     * Flag used to track whether namespace declarations are reported as
     * attributes.
     */
    ...
    private void fillXMLAttributes(Attributes atts) {
        ...
        for (int i = 0; i < attrCount; ++i) {
            ...
            fAttributes.addAttributeNS(fAttributeQName, (type != null) ? type : XMLSymbols.fCDATASymbol, atts
                    .getValue(i));
    ...
    public void reset(SchemaDOMParser schemaDOMParser, SymbolTable symbolTable, boolean namespacePrefixes,
