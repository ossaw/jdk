...
public class XPathMatcher {
	...
	// matched some previous (ancestor) node on the descendant-or-self-axis, but
	// not this node
	...
	/**
	 * No match depth. The value of this field will be zero while matching is
	 * successful for the given xpath expression.
	 */
	 ...
	 */
	protected void matched(Object actualValue, short valueType, ShortList itemValueType,
			boolean isNil) {
		if (DEBUG_METHODS3) {
	...
	public void startElement(QName element, XMLAttributes attributes) {
		if (DEBUG_METHODS2) {
			System.out.println(toString() + "#startElement(" + "element={" + element + "},"
	 ...
	 *            name of the element.
	 * @param type
	 *            content type of this element. IOW, the XML schema type of the
	 *            <tt>value</tt>. Note that this may not be the type declared in
	 ...
	 * com.sun.org.apache.xerces.internal.parsers.SAXParser parser = new
	 * com.sun.org.apache.xerces.internal.parsers.SAXParser(symbols) { public
	 * void startDocument() throws XNIException {
	 * matcher.startDocumentFragment(symbols, null); } public void
	 * startElement(QName element, XMLAttrList attributes, int handle) throws
	 * XNIException { matcher.startElement(element, attributes, handle); }
	 * public void characters(char[] ch, int offset, int length) throws
	 * XNIException { matcher.characters(ch, offset, length); } public void
	 * endElement(QName element) throws XNIException {
	 * matcher.endElement(element); } public void endDocument() throws
	 * XNIException { matcher.endDocumentFragment(); } }; System.out.println(
