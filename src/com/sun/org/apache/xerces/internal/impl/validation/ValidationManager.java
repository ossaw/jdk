 ...
 * Each validator must know how to interact with this property. Validators are
 * not required to know what kind of other validators present in the pipeline,
 * but should understand that there are others and that some coordination is
 * required.
 *
 * @xerces.internal
