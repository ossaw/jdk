...
/**
 * Objects of this class hold all information pecular to a particular XML Schema
 * document. This is needed because namespace bindings and other settings on the
...
class XSDocumentInfo {
	...
	// represents whether this is a chameleon schema (i.e., whether its TNS is
	// natural or comes from without)
	...
	XSDocumentInfo(Element schemaRoot, XSAttributeChecker attrChecker,
		...
		if (schemaRoot != null) {
			...
			fAreLocalAttributesQualified = ((XInt) fSchemaAttrs[XSAttributeChecker.ATTIDX_AFORMDEFAULT])
