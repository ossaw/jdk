...
public class XSParticleDecl implements XSParticle {
    ...
    /**
     * 3.9.6 Schema Component Constraint: Particle Emptiable whether this
     * particle is emptible
     */
    ...
    /**
     * 3.8.6 Effective Total Range (all and sequence) and Effective Total Range
     * (choice) The following methods are used to return min/max range for a
     * particle. They are not exactly the same as it's described in the spec,
     * but all the values from the spec are retrievable by these methods.
     */
    ...
    /**
     * append the string description of this particle to the string buffer this
