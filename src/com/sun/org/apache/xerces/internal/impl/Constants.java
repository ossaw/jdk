...
public final class Constants {
    ...
    /**
     * If true, ignore DOCTYPE declaration as if it wasn't present at all. Note
     * that this is a violation of the XML recommendation. The full property
     * name is prefixed by {@link #ZEPHYR_PROPERTY_PREFIX}.
     */
    ...
    /**
     * Unicode normalization checking feature
    ...
    /**
     * Allow unparsed entity and notation declaration events to be sent after
     * the end DTD event ("allow-dtd-events-after-endDTD")
     */
     ...
     * <li>{@code false} instruct an object to skip service mechanism and use
     * the default implementation for that service.</li>
     * </ul>
     */
    ...
    /**
     * JAXP schemaSource property: when used internally may include DTD sources
     * (DOM)
     */
    ...
    public static final String XML_SECURITY_PROPERTY_MANAGER = ORACLE_JAXP_PROPERTY_PREFIX
     ...
     */
    public static final String JDK_ENTITY_EXPANSION_LIMIT = ORACLE_JAXP_PROPERTY_PREFIX
     ...
     */
    public static final String JDK_ELEMENT_ATTRIBUTE_LIMIT = ORACLE_JAXP_PROPERTY_PREFIX
     ...
     */
    public static final String JDK_TOTAL_ENTITY_SIZE_LIMIT = ORACLE_JAXP_PROPERTY_PREFIX
            + "totalEntitySizeLimit";

    /**
     * JDK maximum general entity size limit
     */
    public static final String JDK_GENERAL_ENTITY_SIZE_LIMIT = ORACLE_JAXP_PROPERTY_PREFIX
            + "maxGeneralEntitySizeLimit";

    /**
     * JDK node count limit in entities that limits the total number of nodes in
     * all of entity references.
     */
    public static final String JDK_ENTITY_REPLACEMENT_LIMIT = ORACLE_JAXP_PROPERTY_PREFIX
            + "entityReplacementLimit";

    /**
     * JDK maximum parameter entity size limit
     */
    public static final String JDK_PARAMETER_ENTITY_SIZE_LIMIT = ORACLE_JAXP_PROPERTY_PREFIX
    ...
    /**
     * Internal performance related feature: false - the parser settings
     * (features/properties) have not changed between 2 parses true - the parser
     * settings have changed between 2 parses NOTE: this feature should only be
     * set by the parser configuration.
     */
    ...
    /**
     * When true, the schema processor will change characters events to
     * ignorableWhitespaces events, when characters are expected to only contain
    ...
    public static final String SECURITY_MANAGER = Constants.XERCES_PROPERTY_PREFIX
     ...
     * this augmentation indicates that the attribute was not declared in the
     * DTD.
     */
    ...
    /**
     * Boolean indicating whether an entity referenced in the document has not
     * been read is stored in augmentations using the string "ENTITY_SKIPPED".
     ...
     * "CHAR_REF_PROBABLE_WS". The absence of this augmentation indicates that
     * the character is not probable white space and/or was not included from a
     * character reference.
     */
    ...
    public final static String ANONYMOUS_TYPE_NAMESPACE = "http://apache.org/xml/xmlschema/1.0/anonymousTypes";
