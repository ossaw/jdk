...
public final class XSLoaderImpl implements XSLoader, DOMConfiguration {
	...
	/**
	 * Grammar pool. Need this to prevent us from getting two grammars from the
	 * same namespace.
	 */
	 ...
	 * behavior of the load methods. The configuration may support the setting
	 * of and the retrieval of the following non-boolean parameters defined on
	 * the <code>DOMConfiguration</code> interface: <code>error-handler</code> (
	 * <code>DOMErrorHandler</code>) and <code>resource-resolver</code> (
	 * <code>LSResourceResolver</code>). <br>
	 ...
	 * <dd>[required] (default) Validate an XML Schema during loading. If
	 * validation errors are found, the error handler is notified.</dd>
	 * <dt><code>false</code></dt>
	 * <dd>[optional] Do not report errors during the loading of an XML Schema
	 * document.</dd>
	 * </dl>
	 * </dd>
	 * </dl>
	 ...
	 * references. If the URI contains a fragment identifier, the behavior is
	 ...
	 * reference. If the URI contains a fragment identifier, the behavior is not
	 ...
	 * 
	 * @see
	 * com.sun.org.apache.xerces.internal.dom3.DOMConfiguration#getParameter(
	 * java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * com.sun.org.apache.xerces.internal.dom3.DOMConfiguration#canSetParameter(
	 * java.lang.String, java.lang.Object)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sun.org.apache.xerces.internal.dom3.DOMConfiguration#
	 * getParameterNames()
	 */
	...
	/**
	 * Grammar pool which merges grammars from the same namespace into one. This
	 * eliminates duplicate named components. It doesn't ensure that the grammar
	 * is consistent, however this no worse than than the behaviour of
	 * XMLSchemaLoader alone when used as an XSLoader.
	 */
	private static final class XSGrammarMerger extends XSGrammarPool {
		...
		public void putGrammar(Grammar grammar) {
			SchemaGrammar cachedGrammar = toSchemaGrammar(
					super.getGrammar(grammar.getGrammarDescription()));
