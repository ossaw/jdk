...
public class SchemaParsingConfig extends BasicParserConfiguration
	...
	public SchemaParsingConfig(SymbolTable symbolTable, XMLGrammarPool grammarPool,
		...
		final String[] recognizedFeatures = { PARSER_SETTINGS, WARN_ON_DUPLICATE_ATTDEF,
		...
		final String[] recognizedProperties = { ERROR_REPORTER, ENTITY_MANAGER, DOCUMENT_SCANNER,
				DTD_SCANNER, DTD_VALIDATOR, NAMESPACE_BINDER, XMLGRAMMAR_POOL,
				DATATYPE_VALIDATOR_FACTORY, VALIDATION_MANAGER, GENERATE_SYNTHETIC_ANNOTATIONS,
				LOCALE };
