...
public class XML11DTDDVFactoryImpl extends DTDDVFactoryImpl {
    ...
    /**
     * return a dtd type of the given name This will call the super class if and
    ...
    /**
     * get all built-in DVs, which are stored in a Map keyed by the name New XML
     * 1.1 datatypes are inserted.
     *
