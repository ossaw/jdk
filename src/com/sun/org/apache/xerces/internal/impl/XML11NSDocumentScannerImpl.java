 ...
 * @version $Id: XML11NSDocumentScannerImpl.java,v 1.6 2010-11-01 04:39:40 joehw
 *          Exp $
 */
public class XML11NSDocumentScannerImpl extends XML11DocumentScannerImpl {
    ...
    protected boolean scanStartElement() throws IOException, XNIException {
        ...
        if (fBindNamespaces) {
            ...
            if (fElementQName.prefix == null && fElementQName.uri != null) {
                ...
                // making sure that the object in the element stack is updated
                // too.
        ...
        if (empty) {
            ...
            /*
             * if (fBindNamespaces) { fNamespaceContext.popContext(); }
             */
    ...
    protected void scanAttribute(XMLAttributesImpl attributes) throws IOException, XNIException {
        ...
        scanAttributeValue(this.fTempString, fTempString2, fAttributeQName.rawname, isVC,
            ...
            if (isNSDecl) {
                if (value.length() > fXMLNameLimit) {
                    fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "MaxXMLNameLimit",
                            new Object[] { value, value.length(), fXMLNameLimit, fSecurityManager
                                    .getStateLiteral(XMLSecurityManager.Limit.MAX_NAME_LIMIT) },
                            XMLErrorReporter.SEVERITY_FATAL_ERROR);
                }
                ...
                // Declare prefix in context. Removing the association between a
                // prefix and a
                // namespace name is permitted in XML 1.1, so if the uri value
                // is the empty string,
    ...
    protected final class NS11ContentDriver extends ContentDriver {
        ...
        protected boolean scanRootElementHook() throws IOException, XNIException {
            ...
            if (fExternalSubsetResolver != null && !fSeenDoctypeDecl && !fDisallowDoctype && (fValidation
                    || fLoadExternalDTD)) {
                scanStartElementName();
