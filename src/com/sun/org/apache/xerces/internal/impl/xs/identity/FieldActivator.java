...
/**
 * Interface for a field activator. The field activator is responsible for
 * activating fields within a specific scope; the caller merely requests the
...
public interface FieldActivator {
     ...
     * for the field. It's also important for the implementor to ensure that it
     * marks whether a Field is permitted to match a value--that is, to call the
