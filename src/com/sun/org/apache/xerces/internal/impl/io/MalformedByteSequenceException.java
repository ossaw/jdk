 ...
 * <code>java.io.Reader</code> that decodes bytes of a given encoding into
 * characters.
 * </p>
 *
 * @xerces.internal
...
public class MalformedByteSequenceException extends CharConversionException {
	 ...
	 * which may be passed to an error reporter to generate a localized string
	 * for this exception.
	 *
	 * @param formatter
	 *            The MessageFormatter used for building the message text for
	 *            this exception.
	 * @param locale
	 ...
	 * </p>
	 *
	 * @return the replacement arguments for the error message or
	 *         <code>null</code> if none exist
	 */
