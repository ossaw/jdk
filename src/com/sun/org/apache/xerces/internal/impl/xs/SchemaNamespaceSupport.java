...
/**
 * This class customizes the behaviour of the util.NamespaceSupport class in
 * order to easily implement some features that we need for efficient schema
...
public class SchemaNamespaceSupport extends NamespaceSupport {
    ...
    /**
     * This method takes a set of Strings, as stored in a NamespaceSupport
     * object, and "fools" the object into thinking that this is one unified
     * context. This is meant to be used in conjunction with things like local
     * elements, whose declarations may be deeply nested but which for all
     * practical purposes may be regarded as being one level below the global
     * <schema> element--at least with regard to namespace declarations. It's
     * worth noting that the context from which the strings are being imported
     * had better be using the same SymbolTable.
     */
    ...
    /**
     * This method returns an array of Strings, as would be stored in a
     * NamespaceSupport object. This array contains all declarations except
