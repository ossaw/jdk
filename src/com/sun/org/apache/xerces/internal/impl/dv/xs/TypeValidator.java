...
/**
 * All primitive types plus ID/IDREF/ENTITY/INTEGER are derived from this
 * abstract class. It provides extra information XSSimpleTypeDecl requires from
 * each type: allowed facets, converting String to actual value, check equality,
 * comparison, etc.
 *
 * @xerces.internal
 *
