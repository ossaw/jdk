...
public class XMLStreamReaderImpl implements javax.xml.stream.XMLStreamReader {
    ...
    // make Global NamespaceContextWrapper object,
    // fScanner.getNamespaceContext() is dynamic object and ita value changes
    // as per the state of the parser.
    protected NamespaceContextWrapper fNamespaceContextWrapper = new NamespaceContextWrapper(
            (NamespaceSupport) fScanner.getNamespaceContext());
    ...
    public XMLStreamReaderImpl(InputStream inputStream, String encoding, PropertyManager props)
        ...
        init(props);
        // publicId, systemid, baseSystemId, inputStream, enocding
        XMLInputSource inputSource = new XMLInputSource(null, null, null, new BufferedInputStream(
    ...
    public void setInputSource(XMLInputSource inputSource) throws XMLStreamException {
        // once setInputSource() is called this instance is busy parsing the
        // inputsource supplied
        // this instances is free for reuse if parser has reached END_DOCUMENT
        // state or application has
        // called close()
        fReuse = false;
        ...
        try {
            ...
            if (fReaderInDefinedState) {
                ...
                if (fEventType == XMLStreamConstants.START_DOCUMENT && versionStr != null && versionStr
                        .equals("1.1")) {
    ...
    void init(PropertyManager propertyManager) throws XMLStreamException {
        ...
        // set Stax internal properties -- Note that these instances are being
        // created in XMLReaderImpl.
        // 1.SymbolTable
    ...
    public void reset() {
        ...
        // REVISIT:this is too ugly -- we are getting XMLEntityManager and
        // XMLEntityReader from
        // property manager, it should be only XMLEntityManager
        fDTDDecl = null;
        fEntityScanner = (XMLEntityScanner) fEntityManager.getEntityScanner();
        // default value for this property is true. However, this should be
        // false when using XMLEventReader... Ugh..
        ...
        fReaderInDefinedState = ((Boolean) fPropertyManager.getProperty(READER_IN_DEFINED_STATE))
                .booleanValue();
        fBindNamespaces = ((Boolean) fPropertyManager.getProperty(XMLInputFactory.IS_NAMESPACE_AWARE))
                .booleanValue();
        versionStr = null;
    }
    ...
    public String getLocalName() {
        ...
        throw new IllegalStateException("Method getLocalName() cannot be called for " + getEventTypeString(
                fEventType) + " event.");
    }// getLocalName()
    ...
    public String getPIData() {
        if (fEventType == XMLEvent.PROCESSING_INSTRUCTION) {
            ...
            throw new java.lang.IllegalStateException("Current state of the parser is " + getEventTypeString(
                    fEventType) + " But Expected state is " + XMLEvent.PROCESSING_INSTRUCTION);
    }// getPIData
    ...
    public String getVersion() {
        // apply SAP's patch: the default version in the scanner was set to 1.0
        // because of DOM and SAX
        // so this patch is a workaround of the difference between StAX and DOM
        // SAPJVM: Return null if the XML version has not been declared (as
    ...
    public int next() throws XMLStreamException {
        ...
        try {
            ...
            if (fEventType == XMLStreamConstants.START_DOCUMENT && versionStr != null && versionStr.equals(
                    "1.1")) {
                switchToXML11Scanner();
            }
            ...
            if (fEventType == XMLStreamConstants.CHARACTERS
                    ...
                    || fEventType == XMLStreamConstants.COMMENT || fEventType == XMLStreamConstants.CDATA) {
            ...
            if (fScanner.fScannerState == fScanner.SCANNER_STATE_DTD_EXTERNAL) {
                Boolean isValidating = (Boolean) fPropertyManager.getProperty(XMLInputFactory.IS_VALIDATING);
                if (isValidating != null && !isValidating.booleanValue()) {
                    ...
                    if (fDTDDecl == null || fDTDDecl.length() == 0) {
                        fDTDDecl = "<!-- " + "Exception scanning External DTD Subset.  "
    ...
    public int getAttributeCount() {
        // xxx: recognize SAX properties namespace, namespace-prefix to get XML
        ...
        if (fEventType == XMLEvent.START_ELEMENT || fEventType == XMLEvent.ATTRIBUTE) {
            ...
            throw new java.lang.IllegalStateException("Current state is not among the states "
                    + getEventTypeString(XMLEvent.START_ELEMENT) + " , " + getEventTypeString(
                            XMLEvent.ATTRIBUTE) + "valid for getAttributeCount()");
        }
    }// getAttributeCount
    ...
    public QName getAttributeName(int index) {
        ...
        if (fEventType == XMLEvent.START_ELEMENT || fEventType == XMLEvent.ATTRIBUTE) {
            ...
            throw new java.lang.IllegalStateException("Current state is not among the states "
                    + getEventTypeString(XMLEvent.START_ELEMENT) + " , " + getEventTypeString(
                            XMLEvent.ATTRIBUTE) + "valid for getAttributeName()");
        }
    }// getAttributeName
    ...
    public String getAttributeNamespace(int index) {
        ...
        if (fEventType == XMLEvent.START_ELEMENT || fEventType == XMLEvent.ATTRIBUTE) {
            ...
            throw new java.lang.IllegalStateException("Current state is not among the states "
                    + getEventTypeString(XMLEvent.START_ELEMENT) + " , " + getEventTypeString(
                            XMLEvent.ATTRIBUTE) + "valid for getAttributeNamespace()");
        }
    ...
    public String getAttributePrefix(int index) {
        ...
        if (fEventType == XMLEvent.START_ELEMENT || fEventType == XMLEvent.ATTRIBUTE) {
            ...
            throw new java.lang.IllegalStateException("Current state is not among the states "
                    + getEventTypeString(XMLEvent.START_ELEMENT) + " , " + getEventTypeString(
                            XMLEvent.ATTRIBUTE) + "valid for getAttributePrefix()");
        }
    }// getAttributePrefix
    ...
    public javax.xml.namespace.QName getAttributeQName(int index) {
        ...
        if (fEventType == XMLEvent.START_ELEMENT || fEventType == XMLEvent.ATTRIBUTE) {
            ...
            throw new java.lang.IllegalStateException("Current state is not among the states "
                    + getEventTypeString(XMLEvent.START_ELEMENT) + " , " + getEventTypeString(
                            XMLEvent.ATTRIBUTE) + "valid for getAttributeQName()");
        }
    }// getAttributeQName
    ...
    public String getAttributeType(int index) {
        ...
        if (fEventType == XMLEvent.START_ELEMENT || fEventType == XMLEvent.ATTRIBUTE) {
            ...
            throw new java.lang.IllegalStateException("Current state is not among the states "
                    + getEventTypeString(XMLEvent.START_ELEMENT) + " , " + getEventTypeString(
                            XMLEvent.ATTRIBUTE) + "valid for getAttributeType()");
        }
    ...
    public String getAttributeValue(int index) {
        ...
        if (fEventType == XMLEvent.START_ELEMENT || fEventType == XMLEvent.ATTRIBUTE) {
            ...
            throw new java.lang.IllegalStateException("Current state is not among the states "
                    + getEventTypeString(XMLEvent.START_ELEMENT) + " , " + getEventTypeString(
                            XMLEvent.ATTRIBUTE) + "valid for getAttributeValue()");
        }
    ...
    public String getAttributeValue(String namespaceURI, String localName) {
        ...
        if (fEventType == XMLEvent.START_ELEMENT || fEventType == XMLEvent.ATTRIBUTE) {
            ...
            if (namespaceURI == null) { // sjsxp issue 70
                ...
                return fScanner.getAttributeIterator().getValue(namespaceURI.length() == 0 ? null
    ...
    public javax.xml.namespace.QName getName() {
        if (fEventType == XMLEvent.START_ELEMENT || fEventType == XMLEvent.END_ELEMENT)
            ...
            throw new java.lang.IllegalStateException("Illegal to call getName() " + "when event type is "
                    + getEventTypeString(fEventType) + "." + " Valid states are " + getEventTypeString(
                            XMLEvent.START_ELEMENT) + ", " + getEventTypeString(XMLEvent.END_ELEMENT));
    }
    ...
    public int getNamespaceCount() {
        ...
        // REVISIT: check if it specifies all conditions mentioned in the
        // javadoc
        if (fEventType == XMLEvent.START_ELEMENT || fEventType == XMLEvent.END_ELEMENT
            ...
            throw new IllegalStateException("Current event state is " + getEventTypeString(fEventType)
                    ...
                    + getEventTypeString(XMLEvent.END_ELEMENT) + ", " + getEventTypeString(XMLEvent.NAMESPACE)
    ...
    public String getNamespaceURI(int index) {
        if (fEventType == XMLEvent.START_ELEMENT || fEventType == XMLEvent.END_ELEMENT
                || fEventType == XMLEvent.NAMESPACE) {
            // namespaceContext is dynamic object.
            return fScanner.getNamespaceContext().getURI(fScanner.getNamespaceContext().getDeclaredPrefixAt(
                    index));
        } else {
            throw new IllegalStateException("Current state " + getEventTypeString(fEventType)
                    + " is not among the states " + getEventTypeString(XMLEvent.START_ELEMENT) + ", "
    ...
    public String getText() {
        if (fEventType == XMLEvent.CHARACTERS || fEventType == XMLEvent.COMMENT
            ...
            throw new IllegalStateException("Current state " + getEventTypeString(fEventType)
                    + " is not among the states" + getEventTypeString(XMLEvent.CHARACTERS) + ", "
                    + getEventTypeString(XMLEvent.COMMENT) + ", " + getEventTypeString(XMLEvent.CDATA) + ", "
                    + getEventTypeString(XMLEvent.SPACE) + ", " + getEventTypeString(
                            XMLEvent.ENTITY_REFERENCE) + ", " + getEventTypeString(XMLEvent.DTD)
                    + " valid for getText() ");
        }
    }// getText
     ...
     *
     * @param sourceStart
     *        the index of the first character in the source array
     *        to copy
     * @param target
     ...
     * @throws XMLStreamException
     *         if the underlying XML source
     *         is not well-formed
     * @throws IndexOutOfBoundsException
     *         if targetStart < 0 or > than
     *         the length of target
     * @throws IndexOutOfBoundwhile(isCharacters())
     *         ;sException if length < 0 or
     *         targetStart + length >
     *         length of
     *         target
    ...
    public int getTextCharacters(int sourceStart, char[] target, int targetStart, int length)
        ...
        if (targetStart < 0 || length < 0 || sourceStart < 0 || targetStart >= target.length || (targetStart
                + length) > target.length) {
            throw new IndexOutOfBoundsException();
        }

        // getTextStart() + sourceStart should not be greater than the lenght of
        ...
        System.arraycopy(getTextCharacters(), getTextStart() + sourceStart, target, targetStart,
                copiedLength);
        return copiedLength;
    }
    ...
    public boolean isAttributeSpecified(int index) {
        ...
        if ((fEventType == XMLEvent.START_ELEMENT) || (fEventType == XMLEvent.ATTRIBUTE)) {
            ...
            throw new IllegalStateException("Current state is not among the states " + getEventTypeString(
                    XMLEvent.START_ELEMENT) + " , " + getEventTypeString(XMLEvent.ATTRIBUTE)
    ...
    public int nextTag() throws XMLStreamException {
        ...
        if (eventType != XMLStreamConstants.START_ELEMENT && eventType != XMLStreamConstants.END_ELEMENT) {
            throw new XMLStreamException("found: " + getEventTypeString(eventType) + ", expected "
                    + getEventTypeString(XMLStreamConstants.START_ELEMENT) + " or " + getEventTypeString(
                            XMLStreamConstants.END_ELEMENT), getLocation());
        }
    ...
    public boolean standaloneSet() {
        // xxx: it requires if the standalone was set in the document ? This is
        // different that if the document
        // is standalone
    ...
    public String getNamespaceURI(String prefix) {
        ...
        // first add the string to symbol table.. since internally identity
