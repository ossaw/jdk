...
public class Selector {
	 ...
	 * @param initialDepth
	 *            The depth in the document at which this matcher began its
	...
	public static class XPath extends com.sun.org.apache.xerces.internal.impl.xpath.XPath {
		...
		public XPath(String xpath, SymbolTable symbolTable, NamespaceContext context)
			...
			for (int i = 0; i < fLocationPaths.length; i++) {
				com.sun.org.apache.xerces.internal.impl.xpath.XPath.Axis axis = fLocationPaths[i].steps[fLocationPaths[i].steps.length
						- 1].axis;
