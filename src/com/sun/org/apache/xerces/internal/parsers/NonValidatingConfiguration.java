 ...
 * configuration with the set of following parser components: Document scanner,
 * DTD scanner, namespace binder, document handler.
 * <p>
...
public class NonValidatingConfiguration extends BasicParserConfiguration
	...
	public NonValidatingConfiguration(SymbolTable symbolTable, XMLGrammarPool grammarPool,
		...
		final String[] recognizedFeatures = { PARSER_SETTINGS, NAMESPACES,
		...
		final String[] recognizedProperties = { ERROR_REPORTER, ENTITY_MANAGER, DOCUMENT_SCANNER,
				...
				DATATYPE_VALIDATOR_FACTORY, VALIDATION_MANAGER, LOCALE, SECURITY_MANAGER,
