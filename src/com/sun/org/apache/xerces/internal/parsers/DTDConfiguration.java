...
/**
 * This is the DTD-only parser configuration. It extends the basic configuration
 * with a standard set of parser components appropriate to DTD-centric
 * validation. Since the Xerces2 reference implementation document and DTD
 * scanner implementations are capable of acting as pull parsers, this
 * configuration implements the <code>XMLPullParserConfiguration</code>
 * interface.
 * <p>
...
public class DTDConfiguration extends BasicParserConfiguration implements XMLPullParserConfiguration {
    ...
    public DTDConfiguration(SymbolTable symbolTable, XMLGrammarPool grammarPool,
        ...
        // setFeature(WARN_ON_DUPLICATE_ATTDEF, false); // from
        // XMLDTDScannerImpl
        ...
        // XMLDocumentFragmentScannerImpl
        // setFeature(WARN_ON_DUPLICATE_ENTITYDEF, false); // from
        // XMLEntityManager

        // add default recognized properties
        final String[] recognizedProperties = { ERROR_REPORTER, ENTITY_MANAGER, DOCUMENT_SCANNER, DTD_SCANNER,
                DTD_PROCESSOR, DTD_VALIDATOR, NAMESPACE_BINDER, XMLGRAMMAR_POOL, DATATYPE_VALIDATOR_FACTORY,
                VALIDATION_MANAGER, JAXP_SCHEMA_SOURCE, JAXP_SCHEMA_LANGUAGE, LOCALE, SECURITY_MANAGER,
