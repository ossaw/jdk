...
/**
 * This is the "standard" parser configuration. It extends the DTD configuration
 * with the standard set of parser components. The standard set of parser
 * components include those needed to parse and validate with DTD's, and those
 * needed for XML Schema.
 * </p>
 * <p>
...
public class StandardParserConfiguration extends DTDConfiguration {
	...
	public StandardParserConfiguration(SymbolTable symbolTable, XMLGrammarPool grammarPool,
		...
		final String[] recognizedFeatures = { NORMALIZE_DATA, SCHEMA_ELEMENT_DEFAULT,
				SCHEMA_AUGMENT_PSVI, GENERATE_SYNTHETIC_ANNOTATIONS, VALIDATE_ANNOTATIONS,
