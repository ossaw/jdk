...
/**
 * This is a concrete vanilla XML parser class. It uses the abstract parser with
 * either a BasicConfiguration object or the one specified by the application.
 *
...
public class XMLDocumentParser extends AbstractXMLDocumentParser {
	...
	/**
	 * Constructs a document parser using the specified symbol table and grammar
	 * pool.
	 */
	public XMLDocumentParser(SymbolTable symbolTable,
