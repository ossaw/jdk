 ...
 * with a document scanner, a dtd scanner, and a validator, as well as a grammar
 * pool.
 *
...
public class DOMParser extends AbstractDOMParser {
	...
	protected static final String USE_ENTITY_RESOLVER2 = Constants.SAX_FEATURE_PREFIX
	...
	public void setProperty(String propertyId, Object value)
		...
		if (index > -1) {
			...
			if (!securityManager.setLimit(propertyId, XMLSecurityManager.State.APIPROPERTY,
					value)) {
