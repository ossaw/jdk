...
/**
 * <p>
 * This class provides an easy way for a user to preparse grammars of various
 * types. By default, it knows how to preparse external DTD's and schemas; it
 * provides an easy way for user applications to register classes that know how
 * to parse additional grammar types. By default, it does no grammar caching;
 * but it provides ways for user applications to do so.
 *
...
public class XMLGrammarPreparser {
    ...
    private final static String CONTINUE_AFTER_FATAL_ERROR = Constants.XERCES_FEATURE_PREFIX
    ...
    private static final String[] RECOGNIZED_PROPERTIES = { SYMBOL_TABLE, ERROR_REPORTER, ERROR_HANDLER,
            ENTITY_RESOLVER, GRAMMAR_POOL, };
    ...
    /*
     * Register a type of grammar to make it preparsable. If the second
    ...
    // in this class to set "standard" properties like error handler
    // etc.</strong>
