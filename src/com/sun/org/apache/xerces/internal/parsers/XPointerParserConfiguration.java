...
/**
 * This parser configuration includes an <code>XPointerHandler</code> in the
 * pipeline before the schema validator, or as the last component in the
 * pipeline if there is no schema validator. Using this pipeline will enable
 * processing according to the XML Inclusions specification with XPointers, to
 * the conformance level described in <code>XPointerHandler.</code>.
 *
...
public class XPointerParserConfiguration extends XML11Configuration {
	...
	protected static final String XPOINTER_HANDLER = Constants.XERCES_PROPERTY_PREFIX
			+ Constants.XPOINTER_HANDLER_PROPERTY;

	/** Property identifier: error reporter. */
	protected static final String XINCLUDE_HANDLER = Constants.XERCES_PROPERTY_PREFIX
	...
	public XPointerParserConfiguration(SymbolTable symbolTable, XMLGrammarPool grammarPool,
		...
		final String[] recognizedProperties = { XINCLUDE_HANDLER, XPOINTER_HANDLER,
				NAMESPACE_CONTEXT };
