...
/**
 * This class represents an input source for an XML resource retrievable over
 * HTTP. In addition to the properties provided by an
 * <code>XMLInputSource</code> an HTTP input source also has HTTP request
 * properties and a preference whether HTTP redirects will be followed. Note
 * that these properties will only be used if reading this input source will
...
public final class HTTPInputSource extends XMLInputSource {
    ...
    /**
     * Constructs an input source from a XMLResourceIdentifier object, leaving
     * resolution of the entity and opening of the input stream up to the
     * caller.
     *
    ...
    /**
     * Returns the preference whether HTTP redirects should be followed. By
     * default HTTP redirects will be followed.
     */
    ...
    /**
     * Sets the preference whether HTTP redirects should be followed. By default
    ...
    /**
     * Returns the value of the request property associated with the given
     * property name.
     *
     * @param key
    ...
    /**
     * Returns an iterator for the request properties this input source
     * contains. Each object returned by the iterator is an instance of
     * <code>java.util.Map.Entry</code> where each key and value are a pair of
     * strings corresponding to the name and value of a request property.
     *
    ...
    /**
     * Sets the value of the request property associated with the given property
     * name.
     *
     * @param key
     *        the name of the request property
