 ...
 * Augmentations interface defines a map of additional data that could be passed
 * along the document pipeline. The information can contain extra arguments or
 * infoset augmentations, for example PSVI. This additional information is
