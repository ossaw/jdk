...
/**
 * Its better to extend the functionality of existing XMLAttributesImpl and also
 * make it of type Iterator. We can directly give an object of type iterator
...
public class XMLAttributesIteratorImpl extends XMLAttributesImpl implements Iterator {
    ...
    public void remove() {
        ...
        if (fLastReturnedItem == fAttributes[fCurrent - 1]) {
            // remove the attribute at current index and lower the current
            // position by 1.
            removeAttributeAt(fCurrent--);
        } else {
            // either the next method has been called yet, or the remove method
