...
/**
 * This class is an unsynchronized hash table primary used for String to Object
 * mapping.
 * <p>
...
public class SymbolHash {
    ...
    /**
     * Remove all key/value association. This tries to save a bit of GC'ing by
     * at least keeping the fBuckets array around.
     */
    public void clear() {
        for (int i = 0; i < fTableSize; i++) {
            fBuckets[i] = null;
    ...
    /**
     * Increases the capacity of and internally reorganizes this SymbolHash, in
     * order to accommodate and access its entries more efficiently. This method
     * is called automatically when the number of keys in the SymbolHash exceeds
    ...
    /**
     * Randomly selects a new hash function and reorganizes this SymbolHash in
     * order to more evenly distribute its entries across the table. This method
     * is called automatically when the number keys in one of the SymbolHash's
     * buckets exceeds MAX_HASH_COLLISIONS.
     */
    ...
    /**
     * This class is a key table entry. Each entry acts as a node in a linked
     * list.
     */
