...
/**
 * <p>
 * The catalog resolver handles the resolution of external identifiers and URI
 * references through XML catalogs. This component supports XML catalogs defined
 * by the <a href="http://www.oasis-open.org/committees/entity/spec.html"> OASIS
 * XML Catalogs Specification</a>. It encapsulates the
 ...
 * </p>
 * <p>
 * It is intended that this class may be used standalone to perform catalog
 * resolution outside of a parsing context. It may be shared between several
 * parsers and the application.
 * </p>
 *
...
public class XMLCatalogResolver implements XMLEntityResolver, EntityResolver2, LSResourceResolver {
     ...
     * preference for whether system or public matches are preferred.
     * </p>
     *
     * @param catalogs
     *        an ordered array list of absolute URIs
     ...
     * mappings from the new list the next time the catalog is queried.
     * </p>
     *
     * @param catalogs
     *        an ordered array list of absolute URIs
     ...
     * preferred. This is used in the absence of any occurence of the
     ...
     * This is used in the absence of any occurence of the <code>prefer</code>
     * attribute on the <code>catalog</code> entry of a catalog.
     * </p>
     *
     * @param preferPublic
     *        the prefer public setting
     ...
     * explicitly set its value is <code>true</code>.
     * </p>
     *
     * @return the preference for using literal system identifers for catalog
     *         resolution
     ...
     * system identifier are available.
     * </p>
     * <p>
     ...
     * resolving the literal system identifier against a base URI.
     * </p>
     *
     ...
     * identifier. It should be overrided if other behaviour is required.
     * </p>
     *
     * @param publicId
     ...
     * was found in the catalog. It should be overrided if other behaviour is
     * required.
     * </p>
     *
    ...
    public XMLInputSource resolveEntity(XMLResourceIdentifier resourceIdentifier) throws XNIException,
        ...
        if (resolvedId != null) {
            return new XMLInputSource(resourceIdentifier.getPublicId(), resolvedId, resourceIdentifier
                    .getBaseSystemId());
        }
        return null;
    }
     ...
     * the semantics of external identifier resolution.
     * </p>
     *
     * @param uri
     ...
     * list. Only the first catalog will actually be parsed immediately. The
     * others will be queued and read if they are needed later.
     */
