...
public class SymbolTable {
    ...
    /**
     * A new hash function is selected and the table is rehashed when the number
     * of keys in the bucket exceeds this threshold.
     */
    ...
    /**
     * Increases the capacity of and internally reorganizes this SymbolTable, in
     * order to accommodate and access its entries more efficiently. This method
     * is called automatically when the number of keys in the SymbolTable
    ...
    /**
     * Randomly selects a new hash function and reorganizes this SymbolTable in
     * order to more evenly distribute its entries across the table. This method
     * is called automatically when the number keys in one of the SymbolTable's
     * buckets exceeds the given collision threshold.
     */
