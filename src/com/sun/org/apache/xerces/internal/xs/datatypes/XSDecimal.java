...
public interface XSDecimal {
	 ...
	 * @exception NumberFormatException
	 *                if the value cannot be represented as a <code>long</code>
	 */
	 ...
	 * @exception NumberFormatException
	 *                if the value cannot be represented as a <code>int</code>
	 */
	 ...
	 * @exception NumberFormatException
	 *                if the value cannot be represented as a <code>short</code>
	 */
	 ...
	 * @exception NumberFormatException
	 *                if the value cannot be represented as a <code>byte</code>
	 */
