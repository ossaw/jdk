...
public interface XSConstants {
	...
	// Scope
	/**
	 * The scope of a declaration within named model groups or attribute groups
	 * is <code>absent</code>. The scope of such a declaration is determined
	 * when it is used in the construction of complex type definitions.
	 */
	...
	/**
	 * The type represents a list type definition whose item type (itemType) is
