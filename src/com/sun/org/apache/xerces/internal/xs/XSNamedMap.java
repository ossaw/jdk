 ...
 * represent immutable collections of XML Schema components that can be accessed
 * by name. Note that <code>XSNamedMap</code> does not inherit from
...
public interface XSNamedMap extends Map {
     ...
     * URI. <br>
     * Per XML Namespaces, applications must use the value <code>null</code> as
     * the <code>namespace</code> parameter for methods if they wish to specify
     * no namespace.
     * 
     * @param namespace
