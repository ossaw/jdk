...
public interface XSDateTime {
    ...
    /**
     * @return months - can be negative only for duration types; For duration
     *         types, it returns years*12 + months
     */
    ...
    /**
     * @return seconds - can be negative only for durations; For duration types,
     *         it returns days*24*3600 + hours*3600 + minutes*60 + seconds
     */
    ...
    /**
     * @return a new date-time related object with normalized values (has no
     *         effect on objects already normalized)
     */
    public XSDateTime normalize();

    /**
     * @return whether a date-time related object is normalized or not (value is
     *         not useful for types where timezone is not specified)
     */
