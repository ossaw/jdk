 ...
 * interface provides several query operations for facet components. Users can
 * either retrieve the defined facets as XML Schema components, using the
 * <code>facets</code> and the <code>multiValueFacets</code> attributes; or
 * users can separately query a facet's properties using methods such as
