...
public interface XSModel {
	 ...
	 * schema. The value <code>null</code> is not a valid namespace name, but if
	 * there are components that do not have a target namespace ,
	 ...
	 * @param namespace
	 *            The namespace of the declaration, otherwise <code>null</code>.
	 ...
	 *            The name of the definition.
	 * @param namespace
	 *            The namespace of the definition, otherwise <code>null</code>.
