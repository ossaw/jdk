...
public interface XSWildcard extends XSTerm {
    ...
    /**
     * If the item, or any items among its [children] is an element information
     * item, has a uniquely determined declaration available, it must be valid
     * with respect to that definition, that is, validate where you can and do
     * not worry when you cannot.
     */
     ...
     * <code>NSCONSTRAINT_LIST</code>, the list contains allowed namespaces. For
     * <code>constraintType</code> <code>NSCONSTRAINT_NOT</code>, the list
     * contains disallowed namespaces. For <code>constraintType</code>
     ...
     * are: <code>PC_LAX</code>, <code>PC_SKIP</code> and <code>PC_STRICT</code>
     * .
     */
