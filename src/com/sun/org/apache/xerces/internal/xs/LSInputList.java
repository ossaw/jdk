...
/**
 * The <code>LSInputList</code> interface provides the abstraction of an ordered
 * collection of <code>LSInput</code>s, without defining or constraining how
 * this collection is implemented.
 */
public interface LSInputList extends List {
	/**
	 * The number of <code>LSInput</code>s in the list. The range of valid child
