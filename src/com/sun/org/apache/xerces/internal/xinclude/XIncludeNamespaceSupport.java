...
/**
 * This is an implementation of NamespaceContext which is intended to be used
 * for XInclude processing. It enables each context to be marked as invalid, if
 * necessary, to indicate that the namespaces recorded on those contexts won't
...
public class XIncludeNamespaceSupport extends MultipleScopeNamespaceSupport {
	...
	/**
	 * This method is used to set a context invalid for XInclude namespace
	 * processing. Any context defined by an &lt;include&gt; or &lt;fallback&gt;
	 * element is not valid for processing the include parent's [in-scope
	 * namespaces]. Thus, contexts defined by these elements are set to invalid
	 * by the XInclude processor using this method.
	 */
	...
	/**
	 * This returns the namespace URI which was associated with the given
	 * pretext, in the context that existed at the include parent of the current
	 * element. The include parent is the last element, before the current one,
