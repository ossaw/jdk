...
public class XIncludeHandler implements XMLComponent, XMLDocumentFilter,
    ...
    private static final Object[] PROPERTY_DEFAULTS = { null, null, null,
            new Integer(XMLEntityManager.DEFAULT_BUFFER_SIZE) };
    ...
    public void reset(XMLComponentManager componentManager)
        ...
        // Get error reporter.
        try {
            XMLErrorReporter value = (XMLErrorReporter) componentManager
        ...
        // Get entity resolver.
        try {
            XMLEntityResolver value = (XMLEntityResolver) componentManager
        ...
        try {
            XMLSecurityManager value = (XMLSecurityManager) componentManager
