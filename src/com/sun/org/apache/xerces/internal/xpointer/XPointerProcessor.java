...
/**
 * <p>
 * The XPointerProcessor is responsible for parsing an XPointer expression and
 * and providing scheme specific resolution of the document fragment pointed to
 * be the pointer.
 * </p>
 *
 * @xerces.internal
...
public interface XPointerProcessor {
	 ...
	 * depending on the pointer parts and sets up a Vector of XPointerParts in
	...
	/**
	 * Evaluates an XML resource with respect to an XPointer expressions by
	 * checking if it's element and attributes parameters match the criteria
	 ...
	 * fragment or Node which is part of the input resource being streamed else
	 * returns false.
	 *
