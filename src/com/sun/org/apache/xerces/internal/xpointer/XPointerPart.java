...
public interface XPointerPart {
    ...
    /**
     * Provides scheme specific parsing of a XPointer expression i.e. the
    ...
    /**
     * Returns a String containing the scheme name of the PointerPart or the
     * name of the ShortHand Pointer.
     *
