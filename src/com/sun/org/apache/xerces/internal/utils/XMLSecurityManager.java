...
public final class XMLSecurityManager {
	...
	/**
	 * Convert a value set through setProperty to XMLSecurityManager. If the
	 * value is an instance of XMLSecurityManager, use it to override the
	 * default; If the value is an old SecurityManager, convert to the new
	 * XMLSecurityManager.
	 *
	 * @param value
	...
	static public XMLSecurityManager convert(Object value, XMLSecurityManager securityManager) {
		...
		if (XMLSecurityManager.class.isAssignableFrom(value.getClass())) {
			...
			if (SecurityManager.class.isAssignableFrom(value.getClass())) {
				...
				securityManager.setLimit(Limit.MAX_OCCUR_NODE_LIMIT, State.APIPROPERTY,
						origSM.getMaxOccurNodeLimit());
				securityManager.setLimit(Limit.ENTITY_EXPANSION_LIMIT, State.APIPROPERTY,
						origSM.getEntityExpansionLimit());
				securityManager.setLimit(Limit.ELEMENT_ATTRIBUTE_LIMIT, State.APIPROPERTY,
