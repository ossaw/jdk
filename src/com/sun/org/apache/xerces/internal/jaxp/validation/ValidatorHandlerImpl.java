...
/**
 * <p>
 * Implementation of ValidatorHandler for W3C XML Schemas and also a validator
 * helper for <code>SAXSource</code>s.
 * </p>
 *
 ...
 *          $
 */
final class ValidatorHandlerImpl extends ValidatorHandler implements DTDHandler, EntityState, PSVIProvider,
        ValidatorHelper, XMLDocumentHandler {
    ...
    private static final String NAMESPACE_CONTEXT = Constants.XERCES_PROPERTY_PREFIX
    ...
    private static final String VALIDATION_MANAGER = Constants.XERCES_PROPERTY_PREFIX
    ...
    public boolean getFeature(String name) throws SAXNotRecognizedException, SAXNotSupportedException {
        ...
        try {
            ...
            throw new SAXNotRecognizedException(SAXMessageFormatter.formatMessage(fComponentManager
                    .getLocale(), key, new Object[] { identifier }));
        }
    }
    ...
    public void setFeature(String name, boolean value) throws SAXNotRecognizedException,
        ...
        try {
            ...
            if (e.getType() == Status.NOT_ALLOWED) {
                ...
                throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(fComponentManager
                        .getLocale(), "jaxp-secureprocessing-feature", null));
    ...
    public void startDocument() throws SAXException {
        ...
        if (fUnparsedEntities != null && !fUnparsedEntities.isEmpty()) {
            // should only clear this if the last document contained unparsed
            // entities
            ...
            try {
                ...
                if (reader == null) {
                    ...
                    SAXParserFactory spf = fComponentManager.getFeature(
                            Constants.ORACLE_FEATURE_SERVICE_MECHANISM) ? SAXParserFactory.newInstance()
                                    : new SAXParserFactoryImpl();
                    spf.setNamespaceAware(true);
                    try {
                        spf.setFeature(XMLConstants.FEATURE_SECURE_PROCESSING, fComponentManager.getFeature(
                                XMLConstants.FEATURE_SECURE_PROCESSING));
    ...
    private void fillXMLAttribute(Attributes att, int index) {
        ...
        fAttributes.addAttributeNS(fAttributeQName, (type != null) ? type : XMLSymbols.fCDATASymbol, att
                .getValue(index));
    }
    ...
    private class XMLSchemaTypeInfoProvider extends TypeInfoProvider {
        ...
        /**
         * Throws a {@link IllegalStateException} if we are not in the
         * startElement callback. the JAXP API requires this for most of the
         * public methods.
         */
        private void checkState(boolean forElementInfo) {
            if (!(fInStartElement || (fInEndElement && forElementInfo))) {
                throw new IllegalStateException(JAXPValidationMessageFormatter.formatMessage(fComponentManager
                        .getLocale(), "TypeInfoProviderIllegalState", null));
            }
        }
    ...
    static final class ResolutionForwarder implements EntityResolver2 {
        ...
        /**
         * Always returns <code>null</code>. An LSResourceResolver has no
        ...
        public InputSource resolveEntity(String name, String publicId, String baseURI, String systemId)
            ...
            if (fEntityResolver != null) {
                LSInput lsInput = fEntityResolver.resolveResource(XML_TYPE, null, publicId, systemId,
                        baseURI);
                if (lsInput != null) {
                    ...
                    /**
                     * An LSParser looks at inputs specified in LSInput in the
                     * following order: characterStream, byteStream, stringData,
                     * systemId, publicId. For consistency with the DOM Level 3
                     * Load and Save Recommendation use the same lookup order
                     * here.
                     */
                    InputSource inputSource = new InputSource();
                    inputSource.setPublicId(pubId);
                    inputSource.setSystemId((baseSystemId != null) ? resolveSystemId(systemId, baseSystemId)
                            : systemId);
        ...
        /**
         * Delegates to EntityResolver2.resolveEntity(String, String, String,
         * String).
         */
