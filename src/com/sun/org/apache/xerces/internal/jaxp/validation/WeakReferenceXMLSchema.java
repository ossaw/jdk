...
/**
 * <p>
 * An implementation of Schema for W3C XML Schemas that keeps a weak reference
 * to its grammar pool. If no validators currently have a reference to the
 * grammar pool, the garbage collector is free to reclaim its memory.
 * </p>
 *
