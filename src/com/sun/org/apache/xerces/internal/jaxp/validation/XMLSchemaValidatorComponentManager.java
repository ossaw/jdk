...
final class XMLSchemaValidatorComponentManager extends ParserConfigurationSettings
	...
	private static final String SCHEMA_VALIDATION = Constants.XERCES_FEATURE_PREFIX
	...
	/**
	 * Tracks whether the validator should use components from the grammar pool
	...
	public XMLSchemaValidatorComponentManager(XSGrammarPoolContainer grammarContainer) {
		...
		boolean secureProcessing = grammarContainer
	...
	public FeatureState getFeatureState(String featureId) throws XMLConfigurationException {
		if (PARSER_SETTINGS.equals(featureId)) {
			...
			return FeatureState.is(true); // pre-condition: VALIDATION and
											// SCHEMA_VALIDATION are always true
		}
	...
	public void setFeature(String featureId, boolean value) throws XMLConfigurationException {
		...
		if (XMLConstants.FEATURE_SECURE_PROCESSING.equals(featureId)) {
			if (_isSecureMode && !value) {
				throw new XMLConfigurationException(Status.NOT_ALLOWED,
