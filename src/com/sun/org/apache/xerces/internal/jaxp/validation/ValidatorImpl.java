...
final class ValidatorImpl extends Validator implements PSVIProvider {
    ...
    private static final String CURRENT_ELEMENT_NODE = Constants.XERCES_PROPERTY_PREFIX
    ...
    public void validate(Source source, Result result) throws SAXException, IOException {
        ...
        // Source parameter cannot be null.
            ...
            throw new NullPointerException(JAXPValidationMessageFormatter.formatMessage(fComponentManager
                    .getLocale(), "SourceParameterNull", null));
        }
        // Source parameter must be a SAXSource, DOMSource or StreamSource
            ...
            throw new IllegalArgumentException(JAXPValidationMessageFormatter.formatMessage(fComponentManager
                    .getLocale(), "SourceNotAccepted", new Object[] { source.getClass().getName() }));
        }
    }
    ...
    public AttributePSVI getAttributePSVIByName(String uri, String localname) {
        return (fSAXValidatorHelper != null) ? fSAXValidatorHelper.getAttributePSVIByName(uri, localname)
                : null;
    }
