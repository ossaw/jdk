...
final class DOMResultBuilder implements DOMDocumentHandler {
	...
	public void setDOMResult(DOMResult result) {
		...
		if (result != null) {
			...
			fDocumentImpl = (fDocument instanceof CoreDocumentImpl) ? (CoreDocumentImpl) fDocument
					: null;
	...
	public void doctypeDecl(DocumentType node) throws XNIException {
		...
		if (fDocumentImpl != null) {
			DocumentType docType = fDocumentImpl.createDocumentType(node.getName(),
			...
			for (int i = 0; i < length; ++i) {
				...
				EntityImpl newEntity = (EntityImpl) fDocumentImpl
						.createEntity(oldEntity.getNodeName());
	...
	public void startElement(QName element, XMLAttributes attributes, Augmentations augs)
		...
		if (fDocumentImpl == null) {
			...
			for (int i = 0; i < attrCount; ++i) {
				...
				elem.setAttributeNS(fAttributeQName.uri, fAttributeQName.rawname,
