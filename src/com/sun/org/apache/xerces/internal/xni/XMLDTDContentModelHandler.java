...
/**
 * The DTD content model handler interface defines callback methods to report
 * information items in DTD content models of an element declaration. Parser
 * components interested in DTD content model information implement this
 * interface and are registered as the DTD content model handler on the DTD
...
public interface XMLDTDContentModelHandler {
    ...
    /**
     * A choice separator for children and mixed content models. This separator
     * is used to specify that the allowed child is one of a collection.
     * <p>
     * For example:
     * 
     * <pre>
    ...
    /**
     * A sequence separator for children content models. This separator is used
     * to specify that the allowed children must follow in the specified
     * sequence.
     * <p>
     * 
     * <pre>
     ...
     * children content model to zero or one. In other words, the child is
     * optional.
     * <p>
     * For example:
     * 
    ...
    /**
     * This occurrence count limits the element, choice, or sequence in a
     * children content model to zero or more. In other words, the child may
     * appear an arbitrary number of times, or not at all. This occurrence count
     * is also used for mixed content models.
     * <p>
     * For example:
     * 
     * <pre>
    ...
    /**
     * This occurrence count limits the element, choice, or sequence in a
     * children content model to one or more. In other words, the child may
     * appear an arbitrary number of times, but must appear at least once.
     * <p>
     * For example:
     * 
     * <pre>
