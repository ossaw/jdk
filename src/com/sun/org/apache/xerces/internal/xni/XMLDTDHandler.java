...
/**
 * The DTD handler interface defines callback methods to report information
 * items in the DTD of an XML document. Parser components interested in DTD
 * information implement this interface and are registered as the DTD handler on
 * the DTD source.
 *
