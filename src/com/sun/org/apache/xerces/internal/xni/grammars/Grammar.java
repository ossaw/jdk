...
/**
 * A generic grammar for use in validating XML documents. The Grammar object
 * stores the validation information in a compiled form. Specific subclasses
 * extend this class and "populate" the grammar by compiling the specific syntax
 * (DTD, Schema, etc) into the data structures used by this object.
 * <p>
 * <strong>Note:</strong> The Grammar object is not useful as a generic grammar
 * access or query object. In other words, you cannot round-trip specific
