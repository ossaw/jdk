...
public interface XMLParserConfiguration extends XMLComponentManager {
     ...
     * an exception.
     * <p>
     * When this method returns, all characters streams and byte streams opened
     * by the parser are closed.
     *
     * @param inputSource
    ...
    /**
     * Allows a parser to add parser specific features to be recognized and
     * managed by the parser configuration.
     *
     * @param featureIds
     *                   An array of the additional feature identifiers to be
     *                   recognized.
     */
     ...
     *
     * @param propertyIds
     *                    An array of the additional property identifiers to be
     *                    recognized.
     */
    public void addRecognizedProperties(String[] propertyIds);

    /**
     * Sets the value of a property. This method is called by the parser and
     * gets propagated to components in this parser configuration.
     *
     * @param propertyId
