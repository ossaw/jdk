...
public interface NamespaceContext {
     ...
     * <p>
     * A new context should be pushed at the beginning of each XML element: the
     * new context will automatically inherit the declarations of its parent
     * context, but it will also keep track of which declarations were made
     * within this context.
     * <p>
     *
     * @see #popContext
     ...
     * <p>
     * The context should be popped at the end of each XML element. After
     * popping the context, all Namespace prefix mappings that were previously
     * in force are restored.
     * <p>
     * Users must not attempt to declare additional Namespace prefixes after
     ...
     * <p>
     * Note that to declare a default Namespace, use the empty string. The
     * prefixes "xml" and "xmlns" can't be rebound.
     * <p>
     ...
     * found, this methods will continue lookup in the parent context(s). Use
     ...
     * <p>
     * This method looks up the namespace URI in the current context. If more
     * than one prefix is currently mapped to the same URI, this method will
     * make an arbitrary selection If no mapping is found, this methods will
    ...
    /**
     * Return a count of locally declared prefixes, including the default prefix
     * if bound.
     */
