...
/**
 * This interface defines a generic DTD scanner. This interface allows a scanner
 * to be used interchangably in existing parser configurations.
 * <p>
 * If the parser configuration uses a DTD scanner that implements this
 * interface, components should be able to query the scanner instance from the
 * component manager using the following property identifier:
 * <blockquote> "http://apache.org/xml/properties/internal/dtd-scanner"
 * </blockquote>
 *
