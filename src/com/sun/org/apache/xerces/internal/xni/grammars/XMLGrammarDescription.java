...
/**
 * <p>
 * This interface describes basic attributes of XML grammars--their physical
...
public interface XMLGrammarDescription extends XMLResourceIdentifier {
	...
	// initial set of grammar constants that some configurations will
	// recognize;user
	 ...
	 * method returns this constant, the object should be an instance of the
	 * XMLSchemaDescription interface.
	 */
	public static final String XML_SCHEMA = "http://www.w3.org/2001/XMLSchema";

	/**
	 * The grammar type constant for DTD grammars. When getGrammarType() method
	 * returns this constant, the object should be an instance of the
	 * XMLDTDDescription interface.
	 */
