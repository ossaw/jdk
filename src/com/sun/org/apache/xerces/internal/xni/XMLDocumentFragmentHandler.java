...
/**
 * This handler interface contains methods necessary to receive information
 * about document elements and content.
 * <p>
 * <strong>Note:</strong> Some of these methods overlap methods found in the
...
public interface XMLDocumentFragmentHandler {
	 ...
	 *            be reported during the parsing of this fragment. However, it
	 ...
	 *            fragment. This object only represents the current context.
	 *            Implementors of this class are responsible for copying the
	 *            namespace bindings from the the current context (and its
