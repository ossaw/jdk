...
public class TextImpl extends CharacterDataImpl implements CharacterData, Text {
     ...
     * the document or if validation occurs while using
    ...
    /**
     * Concatenates the text of all logically-adjacent text nodes to the right
     * of this node
     * 
     * @param node
     * @param buffer
     * @param parent
     * @return true - if execution was stopped because the type of node other
    ...
    /**
     * NON-DOM (used by DOMParser: Sets data to empty string. Returns the value
     * the data was set to.
     */
