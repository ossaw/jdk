...
public class MutationEventImpl extends
	...
	/**
	 * @return the name of the Attr which changed, for DOMAttrModified events.
	...
	/**
	 * @return the previous string value of the Attr for DOMAttrModified events,
	 *         or of the CharacterData node for DOMCharDataModifed events.
	 *         Undefined for others.
	 */
	...
	/**
	 * @return a Node related to this event, other than the target that the node
	 *         was dispatched to. For DOMNodeRemoved, it is the node which was
	 *         removed. No other uses are currently defined.
	 */
