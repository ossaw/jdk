 ...
 *
 * @xerces.internal
 * @version $Id: CoreDOMImplementationImpl.java,v 1.6 2010-11-01 04:39:37 joehw
 *          Exp $
...
public class CoreDOMImplementationImpl implements DOMImplementation, DOMImplementationLS {
    ...
    public boolean hasFeature(String feature, String version) {
        ...
        return (feature.equalsIgnoreCase("Core") && (anyVersion || version.equals("1.0") || version.equals(
                "2.0") || version.equals("3.0"))) || (feature.equalsIgnoreCase("XML") && (anyVersion
                        || version.equals("1.0") || version.equals("2.0") || version.equals("3.0")))
    ...
    /**
     * DOM Level 3 LS CR - Experimental. Create a new <code>LSParser</code>. The
     ...
     *         <p >
     *         <b>Note:</b> By default, the newly created <code>LSParser</code>
     *         does not contain a <code>DOMErrorHandler</code>, i.e. the value
     *         of the "<a href=
     *         'http://www.w3.org/TR/2003/WD-DOM-Level-3-Core-20030609/core.html#parameter-error-handler'>
     *         error-handler</a>" configuration parameter is <code>null</code>.
     *         However, implementations may provide a default error handler at
     *         creation time. In that case, the initial value of the
     *         <code>"error-handler"</code> configuration parameter on the new
    ...
    public LSParser createLSParser(short mode, String schemaType) throws DOMException {
        if (mode != DOMImplementationLS.MODE_SYNCHRONOUS || (schemaType != null
                && !"http://www.w3.org/2001/XMLSchema".equals(schemaType) && !"http://www.w3.org/TR/REC-xml"
                        .equals(schemaType))) {
            String msg = DOMMessageFormatter.formatMessage(DOMMessageFormatter.DOM_DOMAIN,
    ...
    /**
     * DOM Level 3 LS CR - Experimental. Create a new <code>LSSerializer</code>
     * object.
     * 
     ...
     *         the initial value of the <code>"error-handler"</code>
     *         configuration parameter on the new created
     *         <code>LSSerializer</code> contains a reference to the default
     *         error handler.
     */
    ...
    synchronized RevalidationHandler getValidator(String schemaType) {
        ...
        if (schemaType == XMLGrammarDescription.XML_SCHEMA) {
            ...
            if (freeValidatorIndex < 0) {
                return (RevalidationHandler) (ObjectFactory.newInstance(
                        "com.sun.org.apache.xerces.internal.impl.xs.XMLSchemaValidator", ObjectFactory
            ...
            if (freeDTDValidatorIndex < 0) {
                return (RevalidationHandler) (ObjectFactory.newInstance(
                        "com.sun.org.apache.xerces.internal.impl.dtd.XMLDTDValidator", ObjectFactory
                                .findClassLoader(), true));
            }
            // return first available validator
