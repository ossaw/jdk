...
public class PSVIElementNSImpl extends ElementNSImpl implements ElementPSVI {
    ...
    /**
     * true if clause 3.2 of Element Locally Valid (Element) (3.3.4) is
     ...
     * [schema default]
     *
     * @return The canonical lexical representation of the declaration's {value
     *         constraint} value.
     ...
     *      XML Schema Part 1: Structures [schema normalized value]</a>
     ...
     * [schema specified]
     * 
     * @see <a href="http://www.w3.org/TR/xmlschema-1/#e-schema_specified">XML
     *      Schema Part 1: Structures [schema specified]</a>
     * @return false value was specified in schema, true value comes from the
     *         infoset
     */
     ...
     *
     * @return return the [validation attempted] property. The possible values
     *         are NO_VALIDATION, PARTIAL_VALIDATION and FULL_VALIDATION
     */
    ...
    /**
     * Determine the validity of the node with respect to the validation being
     * attempted
     *
    ...
    /**
     * A list of error codes generated from validation attempts. Need to find
     * all the possible subclause reports that need reporting
     *
     ...
     * [nil]
     * 
     * @see <a href="http://www.w3.org/TR/xmlschema-1/#e-nil>XML Schema Part 1:
     *      Structures [nil]</a>
     ...
     * simple thype definition with {variety} union, then an item isomorphic to
     * that member of the union's {member type definitions} which actually
    ...
    /**
     * An item isomorphic to the element declaration used to validate this
     * element.
     *
     ...
     * [schema information]
     * 
     * @see <a href="http://www.w3.org/TR/xmlschema-1/#e-schema_information">XML
     *      Schema Part 1: Structures [schema information]</a>
     * @return The schema information property if it's the validation root, null
     *         otherwise.
     */
