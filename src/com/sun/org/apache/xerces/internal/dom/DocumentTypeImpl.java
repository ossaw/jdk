...
public class DocumentTypeImpl extends ParentNode implements DocumentType {
	 ...
	 * @serialField entities
	 *                  NamedNodeMapImpl entities
	 * @serialField notations
	 *                  NamedNodeMapImpl notations
	 * @serialField elements
	 *                  NamedNodeMapImpl elements
	 * @serialField publicID
	 *                  String support public ID
	 * @serialField systemID
	 *                  String support system ID
	 * @serialField internalSubset
	 *                  String support internal subset
	 * @serialField doctypeNumber
	 *                  int Doctype number
	...
	/**
	 * DOM Level 3 WD- Experimental. Override inherited behavior from
	 * ParentNodeImpl to support deep equal.
	 */
	...
	/**
	 * Name of this document type. If we loaded from a DTD, this should be the
	 * name immediately following the DOCTYPE keyword.
	 */
	 ...
	 * <p>
	 * Note that "built in" entities such as &amp; and &lt; should be converted
	 * to their actual characters before being placed in the DOM's contained
	 * text, and should be converted back when the DOM is rendered as XML or
	 * HTML, and hence DO NOT appear here.
	 */
	...
	/**
	 * Access the collection of Notations defined in the DTD. A notation
	 * declares, by name, the format of an XML unparsed entity or is used to
	 * formally declare a Processing Instruction target.
	 */
