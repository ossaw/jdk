...
public class ProcessingInstructionImpl extends CharacterDataImpl implements ProcessingInstruction {
     ...
     * It is defined slightly differently in HTML and XML.
     * <p>
     * In XML, the data begins with the non-whitespace character immediately
     * after the target -- @see getTarget().
     * <p>
    ...
    /**
     * Change the data content of this PI. Note that setData is aliased to
     * setNodeValue.
     * 
     * @see #getData().
