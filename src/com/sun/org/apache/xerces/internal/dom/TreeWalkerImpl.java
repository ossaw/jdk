...
public class TreeWalkerImpl implements TreeWalker {
    ...
    /**
     * Internal function. Return the nextSibling Node, from the input node after
     * applying filter, whatToshow. NEVER TRAVERSES ABOVE THE SPECIFIED ROOT
     * NODE. The current node is not consulted or set.
     */
    ...
    /**
     * Internal function. Return the previousSibling Node, from the input node
     * after applying filter, whatToshow. NEVER TRAVERSES ABOVE THE SPECIFIED
     * ROOT NODE. The current node is not consulted or set.
     */
