...
/**
 * This class represents an XPath string object, and is capable of converting
 * the string to other types, such as a number.
 * 
 * @xsl.usage general
 */
public class XString extends XObject implements XMLString {
	...
	public double toDouble() {
		 ...
		 * following characters as white space characters. ht - horizontal tab,
		 * nl - newline , cr - carriage return and sp - space trim() methods by
		 * default also takes care of these white space characters So trim()
		 * method is used to remove leading and trailing white spaces.
		 */
		XMLString s = trim();
	 ...
	 * string-value. Multiple calls to the ContentHandler's characters methods
	...
	public boolean equals(XObject obj2) {
		...
		try {
			...
			// then each object
			// to be compared is converted to a number as if by applying the
			// number function.
	...
	/**
	 * Compares this string to the specified <code>String</code>. The result is
	 ...
	 * sequence represented by this <code>String</code> object and with every
	 * character equal to the result of applying the method
	 * <code>Character.toUpperCase</code> to the corresponding character of this
	 ...
	 * probably do it's own white space handling based on the semantics of the
	 * formatting object.
	 *
	 * @param trimHead
