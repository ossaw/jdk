...
public class XNumber extends XObject {
    ...
    // // significant digits = end - start + (0 or 1 depending on decimal
    // location)
    //
    // int decimalPos = -1;
     ...
     * Cast result object to a string.
     *
     * @return "NaN" if the number is NaN, Infinity or -Infinity if the number
     *         is infinite or the string value of the number.
     */
    public String str() {
