...
public interface XPathFactory {
	 ...
	 * @param locator
	 *                       The location of the expression string, mainly for
	 *                       diagnostic
	 *                       purposes.
	 * @param prefixResolver
	 *                       This will be called in order to resolve prefixes to
	 *                       namespace
	 *                       URIs.
	 * @param type
	 *                       One of
	 *                       {@link com.sun.org.apache.xpath.internal.XPath#SELECT}
	 *                       or
