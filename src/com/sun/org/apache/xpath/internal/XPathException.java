 ...
 * in case of an error. This class extends TransformerException, and may hold
 * other exceptions. In the case of nested exceptions, printStackTrace will dump
 * all the traces of the nested exceptions, not just the trace of this object.
 * 
 * @xsl.usage general
 */
public class XPathException extends TransformerException {
    ...
    /**
     * Create an XPathException object that holds an error message and the
    ...
    /**
     * Create an XPathException object that holds an error message, the
     * stylesheet node that the error originated from, and another exception
    ...
    /**
     * Create an XPathException object that holds an error message, and another
