...
public final class XPathEvaluatorImpl implements XPathEvaluator {
	...
	private class DummyPrefixResolver implements PrefixResolver {
		...
		public String getNamespaceForPrefix(String prefix, Node context) {
			String fmsg = XPATHMessages.createXPATHMessage(
					XPATHErrorResources.ER_NULL_RESOLVER, null);
	...
	public XPathExpression createExpression(String expression,
		...
		try {
			...
			XPath xpath = new XPath(expression, null, ((null == resolver)
					? new DummyPrefixResolver()
					: ((PrefixResolver) resolver)), XPath.SELECT);
			...
			if (e instanceof XPathStylesheetDOM3Exception)
				throw new DOMException(DOMException.NAMESPACE_ERR, e
	 ...
	 *                    result
	 *                    will be coerced to return the specified type relying
	 *                    on XPath
	 *                    type conversions and fail if the desired coercion is
	 *                    not
	...
	public Object evaluate(String expression, Node contextNode,
		...
		XPathExpression xpathExpression = createExpression(expression,
				resolver);
