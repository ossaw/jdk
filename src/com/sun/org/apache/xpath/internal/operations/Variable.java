...
public class Variable extends Expression implements PathComponent {
     ...
     * or, if higher than the globals area, must be adjusted by adding the
    ...
    public XObject execute(XPathContext xctxt, boolean destructiveOK)
        ...
        // extensions,
        // // pending some bright light going off in my head. Some sort of
        // callback?
        // synchronized(this)
        // {
        ...
        // new Object[]{m_qname.toString()})); //"Variable not resolvable:
        // "+m_qname);
        // }
    }

    /**
     * Get the XSLT ElemVariable that this sub-expression references. In order
     * for this to work, the SourceLocator must be the owning
     * ElemTemplateElement.
     * 
    ...
    public int getAnalysisBits() {
        ...
        /*
         * com.sun.org.apache.xalan.internal.templates.ElemVariable vvar =
         * getElemVariable(); if(null != vvar) { XPath xpath = vvar.getSelect();
         * if(null != xpath) { Expression expr = xpath.getExpression(); if(null
         * != expr && expr instanceof PathComponent) { return
         * ((PathComponent)expr).getAnalysisBits(); } } }
         */
    ...
    public boolean deepEquals(Expression expr) {
        ...
        // J2SE does not support Xalan interpretive
        /*
         * // We have to make sure that the qname really references // the same
         * variable element. if(getElemVariable() !=
         * ((Variable)expr).getElemVariable()) return false;
         */
