...
public class Arg {
	...
	/**
	 * Field m_qname: The name of this argument, expressed as a QName (Qualified
	 * Name) object.
	 * 
	 * @see getQName
	 * @see setQName
	...
	/**
	 * Have the object release it's resources. Call only when the variable or
	 * argument is going out of scope.
	 */
	public void detach() {
		if (null != m_val) {
	...
	/**
	 * True if this variable was added with an xsl:with-param or is added via
	 * setParameter.
	 */
	private boolean m_isFromWithParam;

	/**
	 * Tell if this variable is a parameter passed with a with-param or as a
	 * top-level parameter.
	 */
	...
	/**
	 * True if this variable is currently visible. To be visible, a variable
	 * needs to come either from xsl:variable or be a "received" parameter, ie
	 * one for which an xsl:param has been encountered. Set at the time the
	 * object is constructed and updated as needed.
	 */
	...
	/**
	 * Construct a dummy parameter argument, with no QName and no value (either
	 * expression string or value XObject). isVisible defaults to true.
	 */
	public Arg() {
	...
	/**
	 * Construct a parameter argument which has an XObject value. isVisible
	 * defaults to true.
	 *
	 * @param qname
	 *            Name of the argument, expressed as a QName object.
	...
	/**
	 * Equality function specialized for the variable name. If the argument is
