 ...
 * {@link com.sun.org.apache.xpath.internal.objects.XObject}, normally has a
 * location within a document or DOM, can send error and warning events, and
 * normally do not hold state and are meant to be immutable once construction
 * has completed. An exception to the immutibility rule is iterators and
...
public abstract class Expression implements java.io.Serializable,
    ...
    /**
     * Tell if the expression is a nodeset expression. In other words, tell if
     * you can execute {@link #asNode(XPathContext) asNode} without an
     * exception.
     * 
    ...
    /**
     * Compare this object with another object and see if they are equal,
     ...
     * here because I'm not totally confident that comparing the class objects
     * is the best way to do this.
     * 
     * @return true of the passed in class is the exact same class as this
     *         class.
     */
