 ...
 * javax.xml.xpath.XPath interface. This provide simple access to the results of
 * an XPath expression.
 *
...
public class XPathImpl implements javax.xml.xpath.XPath {
    ...
    private DocumentBuilder getParser() {
        try {
            // we'd really like to cache those DocumentBuilders, but we can't
            // because:
            ...
            // DocumentBuilderFactory.newInstance() depends on context class
            // loader
            // and system properties, which may change during the execution of
            // JVM.
            //
            // so we really have to create a fresh DocumentBuilder every time we
            // need one
            // - KK
    ...
    private XObject eval(String expression, Object contextItem)
        ...
        com.sun.org.apache.xpath.internal.XPath xpath = new com.sun.org.apache.xpath.internal.XPath(
                expression, null, prefixResolver, com.sun.org.apache.xpath.internal.XPath.SELECT);
     ...
     * </p>
     * <p>
     * See "Evaluation of XPath Expressions" of JAXP 1.3 spec for context item
     * evaluation, variable, function and QName resolution and return type
     * conversion.
     * </p>
     * <p>
     * If a <code>null</code> value is provided for <code>item</code>, an empty
    ...
    public XPathExpression compile(String expression) throws XPathExpressionException {
        ...
        try {
            com.sun.org.apache.xpath.internal.XPath xpath = new XPath(expression, null, prefixResolver,
                    com.sun.org.apache.xpath.internal.XPath.SELECT);
            // Can have errorListener
            XPathExpressionImpl ximpl = new XPathExpressionImpl(xpath, prefixResolver, functionResolver,
                    variableResolver, featureSecureProcessing, useServiceMechanism, featureManager);
            return ximpl;
        } catch (javax.xml.transform.TransformerException te) {
            throw new XPathExpressionException(te);
        }
