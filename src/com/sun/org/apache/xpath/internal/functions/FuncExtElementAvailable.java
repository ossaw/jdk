 ...
 */
/*
 * $Id: FuncExtElementAvailable.java,v 1.2.4.1 2005/09/14 19:58:32 jeffsuttor
 * Exp $
 */
...
public class FuncExtElementAvailable extends FunctionOneArg {
    ...
    public XObject execute(XPathContext xctxt)
        ...
        if (namespace.equals(Constants.S_XSLNAMESPACEURL) || namespace.equals(
                Constants.S_BUILTIN_EXTENSIONS_URL)) {

            // J2SE does not support Xalan interpretive
            /*
             * try { TransformerImpl transformer = (TransformerImpl)
             * xctxt.getOwnerObject(); return
             * transformer.getStylesheet().getAvailableElements().containsKey(
             * new QName(namespace, methName)) ? XBoolean.S_TRUE :
             * XBoolean.S_FALSE; } catch (Exception e) { return
             * XBoolean.S_FALSE; }
             */
            return XBoolean.S_FALSE;
        } else {
