...
public class FuncSystemProperty extends FunctionOneArg {
    ...
    public XObject execute(XPathContext xctxt) throws javax.xml.transform.TransformerException {
        ...
        if (indexOfNSSep > 0) {
            ...
            if (namespace.startsWith("http://www.w3.org/XSL/Transform") || namespace.equals(
                    "http://www.w3.org/1999/XSL/Transform")) {
                result = xsltInfo.getProperty(propName);

                if (null == result) {
                    warn(xctxt, XPATHErrorResources.WG_PROPERTY_NOT_SUPPORTED, new Object[] { fullName }); // "XSL Property not
                                                                                                           // supported:
                                                                                                           // "+fullName);
                ...
                warn(xctxt, XPATHErrorResources.WG_DONT_DO_ANYTHING_WITH_NS, new Object[] { namespace,
                        fullName }); // "Don't
                                                                                                                            // currently do
                                                                                                                            // anything with
                                                                                                                            // namespace
                ...
                try {
                    ...
                    warn(xctxt, XPATHErrorResources.WG_SECURITY_EXCEPTION, new Object[] { fullName }); // "SecurityException
     ...
     *
     * @param file
     *        The string name of the property file. The name should
     *        already
     *        be fully qualified as path/filename
     * @param target
     *        The target property bag the file will be placed into.
     */
    public void loadPropertyFile(String file, Properties target) {
        try {
            // Use SecuritySupport class to provide priveleged access to
            // property file
