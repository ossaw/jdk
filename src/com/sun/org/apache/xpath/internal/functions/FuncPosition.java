    ...
    public int getPositionInContextNodeList(XPathContext xctxt) {
        ...
        if (null != cnl) {
            ...
            if (n == DTM.NULL) {
                ...
                // Then I think we're in a sort. See sort21.xsl. So the iterator
                // has
                // already been spent, and is not on the node we're processing.
                // It's highly possible that this is an issue for other
                // context-list
                // functions. Shouldn't be a problem for last(), and it
                // shouldn't be
