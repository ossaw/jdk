...
public class XPATHErrorResources_de extends ListResourceBundle {
    ...
    private static final Object[][] _contents = new Object[][] {
            ...
            { ER_CANT_CONVERT_TO_MUTABLENODELIST, "{0} kann nicht in NodeSetDTM konvertiert werden." },
            ...
            { ER_DIDNOT_FIND_XPATH_SELECT_EXP, "Fehler. xpath-SELECT-Ausdruck (-select) nicht gefunden." },
            ...
            { ER_SETDOMFACTORY_NOT_SUPPORTED, "setDOMFactory wird nicht von XPathContext unterst\u00FCtzt." },
            ...
            { ER_XERCES_CANNOT_HANDLE_NODES, "DOM2Helper kann keine Knoten des Typs {0} verarbeiten" },

            { ER_XERCES_PARSE_ERROR_DETAILS, "DOM2Helper.parse-Fehler: SystemID - {0} Zeile - {1}" },
            ...
            { ER_PROG_ASSERT_UNKNOWN_OPCODE, "Programmierer-Assertion: Unbekannter Vorgangscode: {0}" },
            ...
            { ER_FSB_NOT_SUPPORTED_XSTRINGFORCHARS, "fsb() nicht unterst\u00FCtzt f\u00FCr XStringForChars" },
            ...
            { ER_FASTSTRINGBUFFER_CANNOT_BE_NULL, "FastStringBuffer-Argument darf nicht null sein" },

            { ER_TWO_OR_THREE, "2 oder 3" },

            { ER_VARIABLE_ACCESSED_BEFORE_BIND, "Auf Variable wurde zugegriffen, bevor sie gebunden wurde." },

            { ER_FSB_CANNOT_TAKE_STRING, "XStringForFSB kann keine Zeichenfolge als Argument akzeptieren." },

            { ER_SETTING_WALKER_ROOT_TO_NULL, "\n !!!! Fehler. Root eines Walkers wird auf null gesetzt." },

            { ER_NODESETDTM_CANNOT_ITERATE, "NodeSetDTM kann nicht zu einem vorherigen Knoten iterieren." },

            { ER_NODESET_CANNOT_ITERATE, "NodeSet kann nicht zu einem vorherigen Knoten iterieren." },
            ...
            { ER_UNKNOWN_STEP, "Programmierer-Assertion in getNextStepPos: Unbekannter stepType: {0}" },
            ...
            { ER_EXPECTED_STEP_PATTERN, "Ein Schrittmuster wurde erwartet, aber \"/\" wurde gefunden." },
            ...
            { WG_EXPAND_ENTITIES_NOT_SUPPORTED, "Option \"-E\" nicht unterst\u00FCtzt f\u00FCr DTM-Parser" },
            ...
            { "ui_language", "de" }, { "help_language", "de" }, { "language", "de" }, { "BAD_CODE",
                    "Parameter f\u00FCr createMessage war au\u00DFerhalb des g\u00FCltigen Bereichs" }, {
                            "FORMAT_FAILED", "Ausnahme bei messageFormat-Aufruf ausgel\u00F6st" }, {
                                    "version", ">>>>>>> Xalan-Version " }, { "version2", "<<<<<<<" }, { "yes",
                                            "Ja" }, { "line", "Zeilennummer" }, { "column", "Spaltennummer" },
            { "xsldone", "XSLProcessor: Fertig" }, { "xpath_option", "xpath-Optionen: " }, { "optionIN",
                    "   [-in inputXMLURL]" }, { "optionSelect", "   [-select xpath expression]" }, {
