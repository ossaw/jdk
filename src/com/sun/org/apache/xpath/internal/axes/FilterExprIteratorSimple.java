...
public class FilterExprIteratorSimple extends LocPathIterator {
    ...
    public static XNodeSet executeFilterExpr(int context, XPathContext xctxt, PrefixResolver prefixResolver,
            boolean isTopLevel, int stackFrame, Expression expr)
        ...
        try {
            ...
            // so we have to set up the variable context, execute the
            // expression,
            // and then restore the variable context.

            if (isTopLevel) {
                // System.out.println("calling
                // m_expr.execute(getXPathContext())");
                VariableStack vars = xctxt.getVarStack();

                // These three statements need to be combined into one
                // operation.
