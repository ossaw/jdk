...
public class NodeTest extends Expression {
	 ...
	 * 
	 * @see <a href="http://www.w3.org/TR/xpath#NT-NameTest">the XPath NameTest
	 *      production.</a>
	 */
	public static final String WILD = "*";

	/**
	 * The URL to pass to the Node#supports method, to see if the DOM has
	 * already been stripped of whitespace nodes.
	 */
	...
	/**
	 * Special bitmap for match patterns starting with a function. Make sure
	 * this does not conflict with {@link org.w3c.dom.traversal.NodeFilter}.
	 */
	public static final int SHOW_BYFUNCTION = 0x00010000;

	/**
	 * This attribute determines which node types are accepted. These constants
	 ...
	 *
	 * @return the local name to be tested, or {@link #WILD}, or an empty
	 *         string.
	 */
	...
	/**
	 * Statically calculated score for this test. One of {@link #SCORE_NODETEST}
	 * , {@link #SCORE_NONE}, {@link #SCORE_NSWILD}, {@link #SCORE_QNAME}, or
	 * {@link #SCORE_OTHER}.
	 * 
	 * @serial
	 */
	 ...
	 *         function they really want to call. If none of the known bits are
	...
	/**
	 * Two names are equal if they and either both are null or the name t is
	 ...
	 *         ,
	 *         {@link com.sun.org.apache.xpath.internal.patterns.NodeTest#SCORE_QNAME}
	 *         , or
