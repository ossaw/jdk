...
/**
 * Lazy load of functions into the function table as needed, so we don't have to
 * load all the functions allowed in XPath and XSLT on startup.
 * 
 * @xsl.usage advanced
 */
public class FuncLoader {
    ...
    /**
     * The function ID, which may correspond to one of the FUNC_XXX values found
     * in {@link com.sun.org.apache.xpath.internal.compiler.FunctionTable}, but
    ...
    /**
     * Get the local class name of the function class. If function name does not
     * have a '.' in it, it is assumed to be relative to
    ...
    Function getFunction() throws TransformerException {
        try {
            ...
            if (!(subString.equals("com.sun.org.apache.xalan.internal.templates") || subString.equals(
                    "com.sun.org.apache.xpath.internal.functions"))) {
