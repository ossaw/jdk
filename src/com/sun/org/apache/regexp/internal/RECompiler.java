...
/**
 * A regular expression compiler class. This class compiles a pattern string
 * into a regular expression program interpretable by the RE evaluator class.
 * The 'recompile' command line tool uses this compiler to pre-compile regular
 * expressions for use with RE. For a description of the syntax accepted by
 * RECompiler and what you can do with regular expressions, see the
 * documentation for the RE matcher class.
 *
 * @see RE
 * @see recompile
...
public class RECompiler {
    ...
    static final int ESC_COMPLEX = 0xffffe; // Escape isn't really a true
                                            // character
    static final int ESC_CLASS = 0xffffd; // Escape represents a whole class of
                                          // characters
    ...
    /**
     * Constructor. Creates (initially empty) storage for a regular expression
     * program.
     */
    public RECompiler() {
    ...
    /**
     * Ensures that n more characters can fit in the program buffer. If n more
     ...
     * it can un-include the last character of string if a closure operator
     * follows. This is correct because *+? have higher precedence than
     * concatentation (thus ABC* means AB(C*) and NOT (ABC)*).
     * 
    ...
    /**
     * Compile an expression with possible parens around it. Paren matching is
    ...
    /**
     * Local, nested class for maintaining character ranges for character
     * classes.
     */
    class RERange {
