 ...
 * expressions for use with the regular expression matcher class 'RE'. For
 * example, the command "java recompile a*b" produces output like this:
 *
 * <pre>
 *
 ...
 * </pre>
 *
 * By pasting this output into your code, you can construct a regular expression
 * matcher (RE) object directly from the pre-compiled data (the character array
 * re1), thus avoiding the overhead of compiling the expression at runtime. For
 * example:
 *
 * <pre>
 *
