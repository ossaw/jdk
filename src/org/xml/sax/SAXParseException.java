...
public class SAXParseException extends SAXException {
    ...
    public SAXParseException(String message, Locator locator) {
        super(message);
        if (locator != null) {
            init(locator.getPublicId(), locator.getSystemId(), locator.getLineNumber(), locator
                    .getColumnNumber());
        } else {
            init(null, null, -1, -1);
        }
     ...
     *        or warning.
     * @param lineNumber
     *        The line number of the end of the text that caused
     *        the error
     *        or warning.
     * @param columnNumber
     *        The column number of the end of the text that cause
     *        the error
     *        or warning.
     */
     ...
     *
     * @param message
     *        The error or warning message, or null to use the
     *        message from
     *        the embedded exception.
     * @param publicId
     *        The public identifier of the entity that generated
     ...
     *
     * @param publicId
     *        The public identifier of the entity which generated
     *        the
     *        exception, or null.
     * @param systemId
     *        The system identifier of the entity which generated
     *        the
     *        exception, or null.
     * @param lineNumber
    ...
    public String toString() {
        ...
        if (publicId != null)
            buf.append("publicId: ").append(publicId);
        if (systemId != null)
            buf.append("; systemId: ").append(systemId);
        if (lineNumber != -1)
            buf.append("; lineNumber: ").append(lineNumber);
        if (columnNumber != -1)
            buf.append("; columnNumber: ").append(columnNumber);
