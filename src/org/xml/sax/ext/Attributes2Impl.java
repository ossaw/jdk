 ...
 * Similarly, the <em>declared</em> flag for each attribute will always be
 * false, except for defaulted attributes (<em>specified</em> is false),
 * non-CDATA attributes, or when it is set to true using {@link #setDeclared}.
 * If you change an attribute's type by hand, you may need to modify its
...
public class Attributes2Impl extends AttributesImpl implements Attributes2 {
     ...
     * <em>declared</em> flags for each attribute are copied. Otherwise the flag
    ...
    /**
     * Copy an entire Attributes object. The "specified" flags are assigned as
     * true, and "declared" flags as false (except when an attribute's type is
     * not CDATA), unless the object is an Attributes2 object. In that case
     * those flag values are all copied.
     *
     ...
     * attributes, use {@link #setDeclared}.
     *
    ...
    /**
     * Assign a value to the "declared" flag of a specific attribute. This is
     * normally needed only for attributes of type CDATA, including attributes
    ...
    /**
     * Assign a value to the "specified" flag of a specific attribute. This is
     * the only way this flag can be cleared, except clearing by initialization
