 ...
 * already reported through the {@link org.xml.sax.DTDHandler DTDHandler}
 * interface.
 * </p>
 * <p>
 * If you are using the declaration handler together with a lexical handler, all
 * of the events will occur between the
 * {@link org.xml.sax.ext.LexicalHandler#startDTD startDTD} and the
 * {@link org.xml.sax.ext.LexicalHandler#endDTD endDTD} events.
 * </p>
 * <p>
 * To set the DeclHandler for an XML reader, use the
 * {@link org.xml.sax.XMLReader#setProperty setProperty} method with the
 * property name <code>http://xml.org/sax/properties/declaration-handler</code>
 * and an object implementing this interface (or null) as the value. If the
 * reader does not report declaration events, it will throw a
...
public interface DeclHandler {
     ...
     *            The application may raise an exception.
     */
    public abstract void attributeDecl(String eName, String aName, String type, String mode, String value)
            throws SAXException;
