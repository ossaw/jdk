 ...
 * {@link Locator}. If an implementation supports this extension, the Locator
...
public interface Locator2 extends Locator {
     ...
     * identifier from the current entity's
     * <em>&lt;?xml&nbsp;version='...'&nbsp;...?&gt;</em> declaration, or be
     * defaulted by the parser.
     *
     * @return Identifier for the XML version being used to interpret the
     *         entity's text, or null if that information is not yet available
     ...
     * <em>&lt;?xml&nbsp;...encoding='...'?&gt;</em> declaration at the start of
