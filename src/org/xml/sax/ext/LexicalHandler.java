 ...
 * the document element, and all lexical handler events must appear between the
 * content handler's startDocument and endDocument events.
 * </p>
 *
 * <p>
 * To set the LexicalHandler for an XML reader, use the
 * {@link org.xml.sax.XMLReader#setProperty setProperty} method with the
 * property name <code>http://xml.org/sax/properties/lexical-handler</code> and
 * an object implementing this interface (or null) as the value. If the reader
 * does not report lexical events, it will throw a
 * {@link org.xml.sax.SAXNotRecognizedException SAXNotRecognizedException} when
...
public interface LexicalHandler {
	 ...
	 *
	 * <p>
	 * All declarations reported through {@link org.xml.sax.DTDHandler
	 * DTDHandler} or {@link org.xml.sax.ext.DeclHandler DeclHandler} events
	 * must appear between the startDTD and {@link #endDTD endDTD} events.
	 * Declarations are assumed to belong to the internal DTD subset unless they
	 * appear between {@link #startEntity startEntity} and {@link #endEntity
	 * endEntity} events. Comments and processing instructions from the DTD
	 * should also be reported between the startDTD and endDTD events, in their
	 * original order of (logical) occurrence; they are not required to appear
	 * in their correct locations relative to DTDHandler or DeclHandler events,
	 * however.
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * This method is intended to report the end of the DOCTYPE declaration; if
	 ...
	 * is optional, and SAX2 drivers that report LexicalHandler events may not
	 * implement it; you can use the <code
	 ...
	 * requirement that events from {@link org.xml.sax.ext.DeclHandler
	 * DeclHandler} or {@link org.xml.sax.DTDHandler DTDHandler} be properly
	 * ordered.
	 * </p>
	 *
	 * <p>
