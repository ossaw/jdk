...
public class NamespaceSupport {
    ...
    /**
     * The namespace declaration URI as a constant. The value is
     * <code>http://www.w3.org/xmlns/2000/</code>, as defined in a
     ...
     * supported, that flag must also be set to a non-default value.
     * </p>
     *
     * @see #setNamespaceDeclUris
     */
     ...
     * don't include namespace declarations, the
     * <em>ContentHandler.startElement()</em> callback is the right place. For
     * elements with such a declaration, it'd done in the first
     * <em>ContentHandler.startPrefixMapping()</em> callback. A boolean flag can
     * be used to track whether a context has been started yet. When either of
     * those methods is called, it checks the flag to see if a new context needs
     ...
     * process all namespace declarations, making
     * <em>ContentHandler.startPrefixMapping()</em> callbacks. Then a second
     * pass is made, to determine the namespace-qualified names for all
     ...
     * default element namespace. To check for a default namespace, you have to
     * look it up explicitly using {@link #getURI getURI}. This asymmetry exists
     * to make it easier to look up prefixes for attribute names, where the
     * default prefix is not allowed.
     * </p>
     *
     * @param prefix
     ...
     * {@link #getURI getURI} with an argument of "".
     * </p>
     *
     ...
     * Namespace, use the {@link #getURI getURI} method with an argument of "".
     * </p>
     *
     * @param uri
     *            The Namespace URI.
     ...
     * {@link #NSDECL NSDECL} namespace by {@link #processName processName()}.
    ...
    /**
     * Returns true if namespace declaration attributes are placed into a
     * namespace. This behavior is not the default.
     *
     * @since SAX 2.1alpha
     */
     ...
     * number of elements (i.e. 5-10 rather than tens of thousands). Also, data
     * structures used to represent contexts are shared when possible (child
     * contexts without declarations) to further reduce the amount of memory
     * that's consumed.
     * </p>
     */
    final class Context {
        ...
        /**
         * (Re)set the parent of this Namespace context. The context must either
         ...
         * {@link #setParent} must be called before this context may be used
         * again.
         */
        void clear() {
            parent = null;
