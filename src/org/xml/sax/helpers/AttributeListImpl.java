 ...
 * implementation is useful both for SAX parser writers, who can use it to
 * provide attributes to the application, and for SAX application writers, who
 * can use it to create a persistent copy of an element's attribute
 * specifications:
 * </p>
 *
 * <pre>
 ...
 *             {@link org.xml.sax.AttributeList AttributeList}; that interface
 *             has been replaced by {@link org.xml.sax.Attributes Attributes},
 *             which is implemented in the
 *             {@link org.xml.sax.helpers.AttributesImpl AttributesImpl} helper
 *             class.
 * @since SAX 1.0
...
public class AttributeListImpl implements AttributeList {
     ...
     * to reuse the same AttributeListImpl object rather than allocating a new
     * one each time.
     * </p>
     *
     * @see org.xml.sax.DocumentHandler#startElement
