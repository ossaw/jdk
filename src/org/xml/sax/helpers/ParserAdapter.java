 ...
 * Namespace support. Note that it is not possible to report
...
public class ParserAdapter implements XMLReader, DocumentHandler {
	 ...
	 *                If the embedded driver cannot be instantiated or if the
	...
	public ParserAdapter() throws SAXException {
		...
		try {
			...
			throw new SAXException("SAX1 driver class " + driver + " found but cannot be loaded",
					e2);
	...
	/**
	 * Adapter implementation method; do not call. Adapt a SAX1 start document
	 * event.
	 *
	 * @exception SAXException
	...
	/**
	 * Adapter implementation method; do not call. Adapt a SAX1 end document
	 * event.
	 *
	 * @exception SAXException
	 *                The client may raise a processing exception.
				...
				if (prefix != null) {
					if (prefixes) {
						if (uris)
							...
							atts.addAttribute(nsSupport.XMLNS, prefix, attQName.intern(), type,
									value);
						else
	...
	/**
	 * Adapter implementation method; do not call. Adapt a SAX1 end element
	 * event.
	 *
	 * @param qName
	 *            The qualified (prefixed) name.
	...
	/**
	 * Adapter implementation method; do not call. Adapt a SAX1 characters
	 * event.
	 *
	 * @param ch
	...
	/**
	 * Adapter implementation method; do not call. Adapt a SAX1 ignorable
	 * whitespace event.
	 *
	 * @param ch
	 *            An array of characters.
	...
	/**
	 * Adapter implementation method; do not call. Adapt a SAX1 processing
	 * instruction event.
	 *
	 * @param target
	 ...
	 * @exception SAXException
	 *                The client may throw an exception if there is an error
	 *                callback.
	 */
	 ...
	 * @exception SAXNotSupportedException
	 *                If a document is currently being parsed.
	 */
	 ...
	 * names and types are interned whenever requested.
	 * </p>
	 */
