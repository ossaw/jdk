 ...
 * <p>
 * The expectation is that an instance of the <code>DOMImplementationLS</code>
 * interface can be obtained by using binding-specific casting methods on an
 * instance of the <code>DOMImplementation</code> interface or, if the
 * <code>Document</code> supports the feature <code>"Core"</code> version
 * <code>"3.0"</code> defined in [
 * <a href='http://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407'>DOM Level 3
 * Core</a>] , by using the method <code>DOMImplementation.getFeature</code>
 * with parameter values <code>"LS"</code> (or <code>"LS-Async"</code>) and
...
public interface DOMImplementationLS {
    ...
    /**
     * Create a new <code>LSParser</code>. The newly constructed parser may then
     * be configured by means of its <code>DOMConfiguration</code> object, and
     ...
     *         configuration parameter on the new <code>LSSerializer</code>
