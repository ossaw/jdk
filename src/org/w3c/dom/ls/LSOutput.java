 ...
 * method <code>DOMImplementationLS.createLSOutput()</code> to create objects
 * that implement this interface.
 * <p>
 * The <code>LSSerializer</code> will use the <code>LSOutput</code> object to
 * determine where to serialize the output to. The <code>LSSerializer</code>
 * will look at the different outputs specified in the <code>LSOutput</code> in
 * the following order to know which one to output to, the first one that is not
 * null and not an empty string will be used:
 * <ol>
...
public interface LSOutput {
	 ...
	 * <a href='http://www.ietf.org/rfc/rfc2396.txt'>IETF RFC 2396</a>], for
	 * this output destination. <br>
	 ...
	 * <a href='http://www.w3.org/TR/2004/REC-xml-20040204'>XML 1.0</a>] section
	 * 4.3.3 "Character Encoding in Entities"), it is recommended that character
	 ...
	 * -CHARSETS</a>] should be referred to using their registered names.
	 */
