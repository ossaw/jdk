...
public interface DocumentTraversal {
     ...
     *                                 with its children.
     *                                 The <code>NodeIterator</code> is
     *                                 initially positioned just
     *                                 before this node. The
     *                                 <code>whatToShow</code> flags and the
     *                                 filter, if any, are not considered when
     ...
     *                                 <code>NodeFilter</code> for the set of
     *                                 possible <code>SHOW_</code> values.These
     ...
     *                                 <code>whatToShow</code> flags and
     *                                 the <code>NodeFilter</code> are not
     *                                 considered when setting
     *                                 this value; any node type will be
     *                                 accepted as the
     *                                 <code>root</code>. The
     *                                 <code>currentNode</code> of the
     *                                 <code>TreeWalker</code> is initialized to
     *                                 this node, whether
     *                                 or not it is visible. The
     *                                 <code>root</code> functions as a
     *                                 stopping point for traversal methods that
     *                                 look upward in the
     *                                 document structure, such as
     *                                 <code>parentNode</code> and
     *                                 nextNode. The <code>root</code> must not
     *                                 be <code>null</code>.
     * @param whatToShow
     *                                 This flag specifies which node types may
     *                                 appear in the logical
     *                                 view of the tree presented by the
     *                                 <code>TreeWalker</code>. See
     *                                 the description of
     *                                 <code>NodeFilter</code> for the set of
     *                                 possible <code>SHOW_</code> values.These
     *                                 flags can be combined
     ...
     *                                 <code>EntityReference</code> nodes are
