...
public interface NodeFilter {
	 ...
	 * <code>NodeIterator</code> or <code>TreeWalker</code> with an attribute
	 * node as its <code>root</code>; in this case, it means that the attribute
	 * node will appear in the first position of the iteration or traversal.
	 ...
	 * <code>Entity</code> node as its <code>root</code>; in this case, it means
	 * that the <code>Entity</code> node will appear in the first position of
	 * the traversal. Since entities are not part of the document tree, they do
	 ...
	 * position of the traversal. Since notations are not part of the document
