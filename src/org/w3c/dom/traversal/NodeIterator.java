...
/**
 * <code>NodeIterators</code> are used to step through a set of nodes, e.g. the
 * set of nodes in a <code>NodeList</code>, the document subtree governed by a
 ...
 * document subtree. Instances of these <code>NodeIterators</code> are created
 * by calling <code>DocumentTraversal</code><code>.createNodeIterator()</code>.
 * <p>
 * See also the
...
public interface NodeIterator {
     ...
     * <code>NodeIterator</code>. The available set of constants is defined in
     ...
     * these children and their descendants will be rejected. Note that this
     ...
     * <code>NodeIterator</code> in the set. After a <code>NodeIterator</code>
     * is created, the first call to <code>nextNode()</code> returns the first
     * node in the set.
     * 
     ...
     * <code>NodeIterator</code> in the INVALID state. After <code>detach</code>
     * has been invoked, calls to <code>nextNode</code> or
