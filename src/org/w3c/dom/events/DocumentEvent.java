 ...
 * expected that the <code>DocumentEvent</code> interface will be implemented on
 * the same object which implements the <code>Document</code> interface in an
...
public interface DocumentEvent {
     ...
     *
     * @param eventType
     *                  The <code>eventType</code> parameter specifies the type
     *                  of
     *                  <code>Event</code> interface to be created. If the
     *                  <code>Event</code> interface specified is supported by
     *                  the
     *                  implementation this method will return a new
     *                  <code>Event</code> of the interface type requested. If
     *                  the
     *                  <code>Event</code> is to be dispatched via the
     *                  <code>dispatchEvent</code> method the appropriate event
     *                  init
     *                  method must be called after creation in order to
     *                  initialize
     *                  the <code>Event</code>'s values. As an example, a user
     *                  wishing
     *                  to synthesize some kind of <code>UIEvent</code> would
     *                  call
     *                  <code>createEvent</code> with the parameter "UIEvents".
     *                  The
     *                  <code>initUIEvent</code> method could then be called on
     *                  the
     *                  newly created <code>UIEvent</code> to set the specific
     *                  type of
     *                  UIEvent to be dispatched and set its context
     *                  information.The
     ...
     *                  <code>Event</code> is insufficient, users may supply
     *                  their own
     ...
     *                         does not
     *                         support the type of <code>Event</code> interface
     *                         requested
     */
