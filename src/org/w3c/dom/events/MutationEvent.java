...
public interface MutationEvent extends Event {
	 ...
	 * is the changed parent. If an event is instead dispatched to a subtree
	 * indicating a node was changed within it, the <code>relatedNode</code> is
	 * the changed node. In the case of the DOMAttrModified event it indicates
	 * the <code>Attr</code> node which was modified, added, or removed.
	 */
	...
	/**
	 * <code>attrName</code> indicates the name of the changed <code>Attr</code>
	 * node in a DOMAttrModified event.
	 */
	public String getAttrName();

	/**
	 * <code>attrChange</code> indicates the type of change which triggered the
	 * DOMAttrModified event. The values can be <code>MODIFICATION</code> ,
	 * <code>ADDITION</code>, or <code>REMOVAL</code>.
	 */
	public short getAttrChange();

	/**
	 * The <code>initMutationEvent</code> method is used to initialize the value
	 * of a <code>MutationEvent</code> created through the
