...
public interface Text extends CharacterData {
	 ...
	 * element content whitespace</a>, often abusively called
	 * "ignorable whitespace". The text node is determined to contain whitespace
	 * in element content during the load of the document or if validation
	 * occurs while using <code>Document.normalizeDocument()</code>.
	 * 
	 * @since DOM Level 3
	 */
