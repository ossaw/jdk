...
/**
 * The <code>CSSCharsetRule</code> interface represents a @charset rule in a CSS
 * style sheet. The value of the <code>encoding</code> attribute does not affect
 * the encoding of text data in the DOM objects; this encoding is always UTF-16.
 * After a stylesheet is loaded, the value of the <code>encoding</code>
 * attribute is the value found in the <code>@charset</code> rule. If there was
 * no <code>@charset</code> in the original document, then no
 ...
 * <code>CSSCharsetRule</code>) may not correspond to the encoding the document
