 ...
 * interface. Furthermore, implementations that support a specific level of CSS
...
public interface CSSStyleDeclaration {
	 ...
	 * parsing of the new value and resetting of all the properties in the
	 ...
	 * <code>"important"</code> qualifier) if the priority has been explicitly
	 ...
	 * <code>setProperty</code> permits to modify a property or add a new one in
	 ...
	 * declaration block. The range of valid indices is 0 to length-1 inclusive.
	 */
