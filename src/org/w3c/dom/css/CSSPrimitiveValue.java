 ...
 * explicitly within the block. An instance of this interface might be obtained
 * from the <code>getPropertyCSSValue</code> method of the
 * <code>CSSStyleDeclaration</code> interface. A <code>CSSPrimitiveValue</code>
...
public interface CSSPrimitiveValue extends CSSValue {
	...
	/**
	 * The value is a counter or counters function. The value can be obtained by
	 * using the <code>getCounterValue</code> method.
	 */
	 ...
	 * @exception DOMException
	 *                INVALID_ACCESS_ERR: Raised if the attached property can't
