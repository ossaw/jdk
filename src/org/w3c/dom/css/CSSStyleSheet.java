...
public interface CSSStyleSheet extends StyleSheet {
	...
	/**
	 * The list of all CSS rules contained within the style sheet. This includes
	 * both rule sets and at-rules.
	 */
	 ...
	 *                         <code>@import</code> rule is inserted after a
	 *                         standard
	 ...
	 *                         does not
	 *                         correspond to a rule in the style sheet's rule
	 *                         list. <br>
	 *                         NO_MODIFICATION_ALLOWED_ERR: Raised if this style
	 *                         sheet is
	 *                         readonly.
