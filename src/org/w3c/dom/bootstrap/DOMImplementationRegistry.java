...
public final class DOMImplementationRegistry {
	 ...
	 * <code>org.w3c.dom.DOMImplementationSourceList</code> and the service
	 * provider whose contents are at
	 ...
	 * availables classes implementing the <code>DOMImplementationSource</code>
	 * interface. Each class listed in the class name list is instantiated and
	 * any exceptions encountered are thrown to the application.
	 *
