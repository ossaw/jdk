...
public interface HTMLTableElement extends HTMLElement {
	 ...
	 * in the table. If <code>index</code> is equal to the number of rows, the
	 * new row is appended. In addition, when the table is empty the row is
	 * inserted into a <code>TBODY</code> which is created and inserted into the
	 * table. Note. A table row cannot be empty according to HTML 4.0
	 * Recommendation.
	 * 
	 * @param index
	 ...
	 *                than the number of rows or if the index is negative.
	 */
	 ...
	 * @exception DOMException
	 *                INDEX_SIZE_ERR: Raised if the specified index is greater
	 *                than or equal to the number of rows or if the index is
	 *                negative.
	 */
