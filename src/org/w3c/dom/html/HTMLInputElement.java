 ...
 * prevent unauthorized use. See the INPUT element definition in HTML 4.0.
 * <p>
 * See also the
...
public interface HTMLInputElement extends HTMLElement {
	 ...
	 * in an interactive user agent, changes. Changes to this attribute,
	 * however, resets the state of the form control. See the checked attribute
	 ...
	 * the form control, but do not change the value of the HTML value attribute
	 * of the element.
	 */
	 ...
	 * graphical submit button. See the src attribute definition in HTML 4.0.
	 */
