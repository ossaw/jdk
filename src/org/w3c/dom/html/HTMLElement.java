 ...
 * interface. These elements are as follows: HEAD special: SUB, SUP, SPAN, BDO
 * font: TT, I, B, U, S, STRIKE, BIG, SMALL phrase: EM, STRONG, DFN, CODE, SAMP,
 * KBD, VAR, CITE, ACRONYM, ABBR list: DD, DT NOFRAMES, NOSCRIPT ADDRESS, CENTER
 * The <code>style</code> attribute of an HTML element is accessible through the
