 ...
 * ones for the <code>BODY</code> element: alinkColor background bgColor fgColor
 * linkColor vlinkColor In DOM Level 2, the method <code>getElementById</code>
 * is inherited from the <code>Document</code> interface where it was moved.
 * <p>
 * See also the
