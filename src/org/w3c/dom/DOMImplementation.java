...
public interface DOMImplementation {
	 ...
	 * APIs of the specified feature and version, as specified in <a href=
	 * "http://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407/core.html#DOMFeatures">
	 * DOM Features</a>. The specialized object may also be obtained by using
	 * binding-specific casting methods but is not necessarily expected to, as
	 * discussed in . This method also allow the implementation to provide
	 * specialized objects which do not support the
