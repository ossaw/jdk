 ...
 * types, this object makes it possible to discover and manipulate the type and
 * value of the result.
 * <p>
 * See also the
 * <a href='http://www.w3.org/2002/08/WD-DOM-Level-3-XPath-20020820'>Document
...
public interface XPathResult {
     ...
     * the evaluation returns whatever type naturally results from evaluation of
     * the expression. <br>
     * If the natural result is a node set when <code>ANY_TYPE</code> was
     * requested, then <code>UNORDERED_NODE_ITERATOR_TYPE</code> is always the
     * resulting type. Any other representation of a node set must be explicitly
     * requested.
     */
    public static final short ANY_TYPE = 0;
    /**
     * The result is a number as defined by . Document modification does not
     * invalidate the number, but may mean that reevaluation would not yield the
     * same number.
     */
    public static final short NUMBER_TYPE = 1;
    /**
     * The result is a string as defined by . Document modification does not
     * invalidate the string, but may mean that the string no longer corresponds
     * to the current document.
     */
    public static final short STRING_TYPE = 2;
    /**
     * The result is a boolean as defined by . Document modification does not
     * invalidate the boolean, but may mean that reevaluation would not yield
     * the same boolean.
     */
    public static final short BOOLEAN_TYPE = 3;
    /**
     * The result is a node set as defined by that will be accessed iteratively,
     * which may not produce nodes in a particular order. Document modification
     * invalidates the iteration. <br>
    ...
    /**
     * The result is a node set as defined by that will be accessed iteratively,
     * which will produce document-ordered nodes. Document modification
     ...
     * modification does not invalidate the snapshot but may mean that
     * reevaluation would not yield the same snapshot and nodes in the snapshot
    ...
    /**
     * The result is a node set as defined by and will be accessed as a single
     ...
     * in the in the resulting set has been found. <br>
     ...
     * modification does not invalidate the node, but may mean that the result
     * node no longer corresponds to the current document. This is a convenience
     * that permits optimization since the implementation can stop once the
     * first node in document order of the resulting set has been found. <br>
     * If there are more than one node in the actual result, the single node
     ...
     * expression, then it is up to the definition of the binding binding to
     * specify how the XPath number is converted to the native binding number.
     * 
     * @exception XPathException
     *                           TYPE_ERR: raised if <code>resultType</code> is
     *                           not
     ...
     * <code>resultType</code> is <code>UNORDERED_NODE_ITERATOR_TYPE</code> or
     * <code>ORDERED_NODE_ITERATOR_TYPE</code> and the document has been
     ...
     *                           INVALID_STATE_ERR: The document has been
     *                           mutated since the
     *                           result was returned.
     */
