 ...
 * <code>XPathEvaluator</code>. In a DOM implementation which supports the XPath
 * 3.0 feature, as described above, the <code>XPathEvaluator</code> interface
 * will be implemented on the same object which implements the
...
public interface XPathEvaluator {
     ...
     * @param resolver
     *        The <code>resolver</code> permits translation of
     *        prefixes
     *        within the XPath expression into appropriate namespace
     *        URIs .
     *        If this is specified as <code>null</code>, any
     *        namespace
     ...
     *            INVALID_EXPRESSION_ERR: Raised if the
     *            expression is not
     *            legal according to the rules of the
     *            <code>XPathEvaluator</code>i
     * @exception DOMException
     *            NAMESPACE_ERR: Raised if the expression
     *            contains namespace
     *            prefixes which cannot be resolved by the
     *            specified
     ...
     *        evaluated.
     * @param contextNode
     *        The <code>context</code> is context node for the
     *        evaluation of
     *        this XPath expression. If the XPathEvaluator was
     *        obtained by
     *        casting the <code>Document</code> then this must be
     *        owned by
     ...
     *        <code>XPathNamespace</code> node. If the context node
     *        is a
     *        <code>Text</code> or a <code>CDATASection</code>, then
     *        the
     *        context is interpreted as the whole logical text node
     *        as seen
     *        by XPath, unless the node is empty in which case it
     *        may not
     ...
     *        result
     *        will be returned as the corresponding type.For XPath
     *        1.0
     *        results, this must be one of the codes of the
     *        <code>XPathResult</code> interface.
     * @param result
     *        The <code>result</code> specifies a specific result
     *        object
     *        which may be reused and returned by this method. If
     *        this is
     *        specified as <code>null</code>or the implementation
     *        does not
     *        reuse the specified result, a new result object will
     *        be
     *        constructed and returned.For XPath 1.0 results, this
     *        object
     ...
     *            TYPE_ERR: Raised if the result cannot be
     *            converted to
     ...
     *            WRONG_DOCUMENT_ERR: The Node is from a document
     *            that is
     *            not supported by this
     *            <code>XPathEvaluator</code>. <br>
     *            NOT_SUPPORTED_ERR: The Node is not a type
     *            permitted as an
     *            XPath context node or the request type is not
     *            permitted by
     *            this <code>XPathEvaluator</code>.
     */
    public Object evaluate(String expression, Node contextNode, XPathNSResolver resolver, short type,
