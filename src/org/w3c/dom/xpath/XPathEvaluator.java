...
public interface XPathEvaluator {
	 ...
	 *            will be returned as the corresponding type.For XPath 1.0
	 ...
	 *                not supported by this <code>XPathEvaluator</code>. <br>
	 *                NOT_SUPPORTED_ERR: The Node is not a type permitted as an
	 *                XPath context node or the request type is not permitted by
