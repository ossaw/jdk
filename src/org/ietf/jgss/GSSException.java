...
/**
 * This exception is thrown whenever a GSS-API error occurs, including any
 * mechanism specific error. It may contain both the major and the minor GSS-API
 * status codes. Major error codes are those defined at the GSS-API level in
 * this class. Minor error codes are mechanism specific error codes that can
 * provide additional information. The underlying mechanism implementation is
 * responsible for setting appropriate minor status codes when throwing this
 * exception. Aside from delivering the numeric error codes to the caller, this
 * class performs the mapping from their numeric values to textual
 * representations.
 * <p>
 *
...
public class GSSException extends Exception {
     ...
     */
    /*
     * This is meant to be thrown by display_status which displays major/minor
     * status when an incorrect status type is passed in to it!
     */
    ...
    /**
     * The token was a duplicate of an earlier token. This is a fatal error code
     * that may occur during context establishment. It is not used to indicate
     * supplementary status values. The MessageProp object is used for that
     * purpose.
     */
    public static final int DUPLICATE_TOKEN = 19;

    /**
     * The token's validity period has expired. This is a fatal error code that
     * may occur during context establishment. It is not used to indicate
     * supplementary status values. The MessageProp object is used for that
     * purpose.
     */
    ...
    /**
     * A later token has already been processed. This is a fatal error code that
     * may occur during context establishment. It is not used to indicate
     * supplementary status values. The MessageProp object is used for that
     * purpose.
     */
    ...
    /**
     * An expected per-message token was not received. This is a fatal error
     * code that may occur during context establishment. It is not used to
     * indicate supplementary status values. The MessageProp object is used for
     * that purpose.
     */
    public static final int GAP_TOKEN = 22;

    private static String[] messages = { "Channel binding mismatch", // BAD_BINDINGS
    ...
    /**
     * Creates a GSSException object with the specified major code, minor code,
     * and minor code textual explanation. This constructor is to be used when
     * the exception is originating from the underlying mechanism level. It
    ...
    /**
     * Returns the GSS-API level major error code for the problem causing this
     * exception to be thrown. Major error codes are defined at the mechanism
     * independent GSS-API level in this class. Mechanism specific error codes
     * that might provide more information are set as the minor error code.
     *
     ...
     * mechanism.
     *
     * @return int the mechanism error code; 0 indicates that it has not been
     *         set.
     * @see #getMinorString
     * @see #setMinor
     */
    ...
    /**
     * Returns a string explaining the GSS-API level major error code in this
     * exception.
     *
    ...
    /**
     * Returns a string explaining the mechanism specific error code. If the
     * minor status code is 0, then no mechanism level error details will be
     * available.
     *
    ...
    /**
     * Used by the exception thrower to set the mechanism level minor error code
     * and its string explanation. This is used by mechanism providers to
    ...
    /**
     * Returns a textual representation of both the major and the minor status
     * codes.
     *
