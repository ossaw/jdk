...
public class Oid {
    ...
    /**
     * Constructs an Oid object from a string representation of its integer
     * components.
     *
     * @param strOid
    ...
    /**
     * Creates an Oid object from its ASN.1 DER encoding. This refers to the
     * full encoding including tag and length. The structure and encoding of
     * Oids is defined in ISOIEC-8824 and ISOIEC-8825. This method is identical
    ...
    /**
     * Returns a string representation of the oid's integer components in dot
     * separated notation.
     *
    ...
    /**
     * Returns the full ASN.1 DER encoding for this oid object, which includes
     * the tag and length.
     *
