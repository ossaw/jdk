...
/**
 * org/omg/PortableServer/CurrentPackage/NoContextHelper.java . Generated by the
...
abstract public class NoContextHelper {
	...
	public static void insert(org.omg.CORBA.Any a,
			org.omg.PortableServer.CurrentPackage.NoContext that) {
			...
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					__typeCode = org.omg.CORBA.ORB.init().create_exception_tc(
							org.omg.PortableServer.CurrentPackage.NoContextHelper.id(), "NoContext",
							_members0);
					__active = false;
				}
			}
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			org.omg.PortableServer.CurrentPackage.NoContext value) {
