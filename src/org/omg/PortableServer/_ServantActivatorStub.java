 ...
 * ServantActivators.
 */
public class _ServantActivatorStub extends org.omg.CORBA.portable.ObjectImpl implements
     ...
     * 
     * @param oid
     *        object Id associated with the object on the request was
     *        made.
     * @param adapter
     ...
     * 
     * @param oid
     *        object Id associated with the object being
     *        deactivated.
     * @param adapter
     *        object reference for the POA in which the
     *        object was active.
     * @param serv
     *        contains reference to the servant associated
     *        with the object
     *        being deactivated.
     * @param cleanup_in_progress
     *        if TRUE indicates that destroy or deactivate
     *        is called with
     *        etherealize_objects param of TRUE. FALSE
     *        indicates that
     *        etherealize was called due to other reasons.
     * @param remaining_activations
     *        indicates whether the Servant Manager can
     *        destroy a servant.
     *        If set to TRUE, the Servant Manager should
     *        wait until all
     *        invocations in progress have completed.
     */
    public void etherealize(byte[] oid, org.omg.PortableServer.POA adapter,
            org.omg.PortableServer.Servant serv, boolean cleanup_in_progress, boolean remaining_activations) {
