...
public interface Delegate {
	/**
	 * Convenience method that returns the instance of the ORB currently
	...
	/**
	 * This allows the servant to obtain the object reference for the target
	...
	/**
	 * The method _poa() is equivalent to calling
	...
	/**
	 * The default behavior of this function is to return the root POA from the
	 ...
	 * returned by _all_interfaces() or is the repository id for the generic
	 * CORBA Object.
	 * 
	 * @param Self
	 *            the servant.
	 * @param Repository_Id
	 *            the repository_id to be checked in the repository list or
	...
	/**
	 * This operation returns an object in the Interface Repository which
