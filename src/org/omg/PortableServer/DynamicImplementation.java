 ...
 * from the standard <code>DynamicImplementation</code> class, this class
 * inherits from the <code>Servant</code> class. Based on IDL to Java spec.
 * CORBA V 2.3.1 ptc/00-01-08.pdf.
 */
abstract public class DynamicImplementation extends Servant {

    /**
     * Receives requests issued to any CORBA object incarnated by the DSI
