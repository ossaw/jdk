 ...
 * method was invoked. The Current interface is provided to support servants
 * that implement multiple objects, but can be used within the context of
 ...
 * CORBA::ORB::resolve_initial_references("POACurrent") operation. Thereafter,
 * it can be used within the context of a method dispatched by the POA to obtain
...
public interface CurrentOperations extends org.omg.CORBA.CurrentOperations {
	...
	/**
	 * Returns reference to the POA implementing the object in whose context it
	 * is called.
	 *
	 * @return The poa implementing the object
	 * 
	 * @exception NoContext
	 *                is raised when the operation is outside the context of a
	 ...
	 *
	 * @exception NoContext
	 *                is raised when the operation is called outside the context
