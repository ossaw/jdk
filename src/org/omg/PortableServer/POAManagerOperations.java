...
public interface POAManagerOperations {
	 ...
	 *                is raised if the operation is invoked on the POAManager in
	 *                inactive state.
	 */
	 ...
	 *            if FALSE, the operation returns immediately after changing
	 *            state. If TRUE, it waits for all active requests to complete.
	 * @exception AdapterInactive
	 *                is raised if the operation is invoked on the POAManager in
	 *                inactive state.
	 */
	...
	/**
	 * This operation changes the state of the POA manager to discarding. This
	 ...
	 * associated POAs to reject the requests that have not begun executing as
	 * well as as any new requests.
	 * 
	 * @param etherealize_objects
	 *            a flag to indicate whether to invoke the etherealize operation
	 *            of the associated servant manager for all active objects.
	 * @param wait_for_completion
	 *            if FALSE, the operation returns immediately after changing
	 *            state. If TRUE, it waits for all active requests to complete.
	 * @exception AdapterInactive
