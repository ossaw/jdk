...
public interface POAOperations {
	 ...
	 * 
	 * @param adapter_name
	 *            identifies the new POA with respect to other POAs with the
	 *            same parent POA.
	 * @param a_POAManager
	 *            specifies the POA Manager to be associated with the new POA.
	 * @param policies
	 *            specifies policy objects to be associated with the POA to
	 *            control its behavior.
	 * @exception AdapterAlreadyExists
	 *                specifies that the target POA already has a child POA with
	 *                the specified name.
	 * @exception InvalidPolicy
	 *                is raised if any of the policy objects are not valid for
	 *                the ORB, or are in conflict, or require an administrative
	 *                action that has not been performed.
	 */
	org.omg.PortableServer.POA create_POA(String adapter_name,
			org.omg.PortableServer.POAManager a_POAManager, org.omg.CORBA.Policy[] policies)
	 ...
	 * @param activate_it
	 *            if a POA with the specified name does not exist and the value
	 ...
	 *            flag to indicate whether etherealize operation on servant
	 *            manager needs to be called.
	 * @param wait_for_completion
	 *            flag to indicate whether POA and its children need to wait for
	 *            active requests and the etherealization to complete.
	 *
	 */
	 ...
	 * @exception NoServant
	 *                raised if no default servant is associated with the POA.
	 * @exception WrongPolicy
	 ...
	 *                is raised if the POA has UNIQUE_ID policy and servant is
	 *                is already in the Active Object Map.
	 * @exception WrongPolicy
	 *                raised if the SYSTEM_ID and RETAIN policies are not
	 *                specified.
	 */
	 ...
	 * @exception ServantAlreadyActive
	 *                raised if the POA has the UNIQUE_ID policy and the servant
	 *                is already in the Active Object Map.
	 * @exception ObjectAlreadyActive
	 *                raised if the object is already active in the POA.
	 * @exception WrongPolicy
	 ...
	 *                if the object with the specified oid is not in the Active
	 *                Object Map.
	 * @exception WrongPolicy
	 *                raised if the RETAIN policy is is not specified.
	 */
	 ...
	 *                detects that the Object Id value was not generated by the
	 ...
	 *                if the above rules and policy combination is not met.
	 * @exception WrongPolicy
	 *                if the USE_DEFAULT_SERVANT policy or a combination of the
	 ...
	 * @exception WrongPolicy
	 *                if the operation is not invoked in the context of
	 *                executing a request on the specified servant and the
	 *                required policies are not present.
	 * @exception ServantNotActive
	 *                if the above specified policies and rules are not met.
	 */
	 ...
	 * @exception WrongPolicy
	 *                if neither the RETAIN policy or the USE_DEFAULT_SERVANT
	 *                policy is present.
	 * @exception ObjectNotActive
	 *                if the servant is not present in the Active Object Map
	 *                (for RETAIN) or no default servant is registered (for
	 *                USE_DEFAULT_POLICY).
	 ...
	 *
	 * @param reference
	 *            the object reference from which the object id needs to be
	 *            returned.
	 * @return object id encapsulated in the reference.
	 * @exception WrongAdapter
	 *                if the reference was not created by the POA specified in
	 *                the reference.
	 * @exception WrongPolicy
	 ...
	 * @exception ObjectNotActive
	 *                is raised if ObjectId is is not in the Active Object Map
	 *                (for RETAIN policy), or no default servant is registered
	 *                (for USE_DEFAULT_SERVANT policy).
	 *
	 * @exception WrongPolicy
	 *                is raised if the RETAIN policy or the USE_DEFAULT_SERVANT
	 ...
	 *
	 * @exception ObjectNotActive
	 *                if the Object Id value is not active in the POA.
	 * @exception WrongPolicy
