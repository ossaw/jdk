...
/**
 * The LifespanPolicyValue can have the following values. TRANSIENT - The
 * objects implemented in the POA cannot outlive the POA instance in which they
 * are first created. PERSISTENT - The objects implemented in the POA can
...
public class LifespanPolicyValue implements org.omg.CORBA.portable.IDLEntity {
	...
	public static final org.omg.PortableServer.LifespanPolicyValue TRANSIENT = new org.omg.PortableServer.LifespanPolicyValue(
			_TRANSIENT);
	public static final int _PERSISTENT = 1;
	public static final org.omg.PortableServer.LifespanPolicyValue PERSISTENT = new org.omg.PortableServer.LifespanPolicyValue(
			_PERSISTENT);
	...
	public static org.omg.PortableServer.LifespanPolicyValue from_int(
			int value) {
