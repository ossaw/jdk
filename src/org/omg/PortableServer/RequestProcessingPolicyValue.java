 ...
 * USE_ACTIVE_OBJECT_MAP_ONLY - If the Object Id is not found in the Active
 * Object Map, an OBJECT_NOT_EXIST exception is returned to the client. The
 * RETAIN policy is also required. USE_DEFAULT_SERVANT - If the Object Id is not
 * found in the Active Object Map or the NON_RETAIN policy is present, and a
 * default servant has been registered with the POA using the set_servant
 * operation, the request is dispatched to the default servant.
 * USE_SERVANT_MANAGER - If the Object Id is not found in the Active Object Map
 * or the NON_RETAIN policy is present, and a servant manager has been
...
public class RequestProcessingPolicyValue implements org.omg.CORBA.portable.IDLEntity {
	...
	public static final org.omg.PortableServer.RequestProcessingPolicyValue USE_ACTIVE_OBJECT_MAP_ONLY = new org.omg.PortableServer.RequestProcessingPolicyValue(
			_USE_ACTIVE_OBJECT_MAP_ONLY);
	public static final int _USE_DEFAULT_SERVANT = 1;
	public static final org.omg.PortableServer.RequestProcessingPolicyValue USE_DEFAULT_SERVANT = new org.omg.PortableServer.RequestProcessingPolicyValue(
			_USE_DEFAULT_SERVANT);
	public static final int _USE_SERVANT_MANAGER = 2;
	public static final org.omg.PortableServer.RequestProcessingPolicyValue USE_SERVANT_MANAGER = new org.omg.PortableServer.RequestProcessingPolicyValue(
