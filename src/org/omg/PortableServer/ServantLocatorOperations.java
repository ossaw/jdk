 ...
 * information to the servant manager's operations and the servant manager's
 ...
 * after performing the operation invocation on the servant returned by
 * preinvoke, the POA will invoke postinvoke on the servant manager, passing the
 * ObjectId value and the Servant value as parameters (among others). This
...
public interface ServantLocatorOperations extends org.omg.PortableServer.ServantManagerOperations {
	 ...
	 * 
	 * @param oid
	 *            the object id associated with object on which the request was
	 *            made.
	 * @param adapter
	 ...
	 *            the operation name.
	 * @param the_cookie
	 *            an opaque value that can be set by the servant manager to be
	 ...
	 *                exception.
	 */
	org.omg.PortableServer.Servant preinvoke(byte[] oid, org.omg.PortableServer.POA adapter,
	 ...
	 * 
	 * @param oid
	 *            the object id ssociated with object on which the request was
	 *            made.
	 * @param adapter
