...
/**
 * org/omg/PortableServer/ForwardRequestHelper.java . Generated by the
...
abstract public class ForwardRequestHelper {
        ...
        if (__typeCode == null) {
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    _members0[0] = new org.omg.CORBA.StructMember("forward_reference", _tcOf_members0, null);
                    __typeCode = org.omg.CORBA.ORB.init().create_exception_tc(
                            org.omg.PortableServer.ForwardRequestHelper.id(), "ForwardRequest", _members0);
                    __active = false;
                }
            }
        }
    ...
    public static void write(org.omg.CORBA.portable.OutputStream ostream,
            org.omg.PortableServer.ForwardRequest value) {
