...
/**
 * org/omg/PortableServer/POAPackage/NoServantHelper.java . Generated by the
...
abstract public class NoServantHelper {
	...
	public static void insert(org.omg.CORBA.Any a,
			org.omg.PortableServer.POAPackage.NoServant that) {
			...
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					__typeCode = org.omg.CORBA.ORB.init().create_exception_tc(
							org.omg.PortableServer.POAPackage.NoServantHelper.id(), "NoServant",
							_members0);
					__active = false;
				}
			}
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			org.omg.PortableServer.POAPackage.NoServant value) {
