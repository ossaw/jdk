...
/**
 * org/omg/PortableServer/POAPackage/AdapterNonExistentHelper.java . Generated
...
abstract public class AdapterNonExistentHelper {
	...
	public static void insert(org.omg.CORBA.Any a,
			org.omg.PortableServer.POAPackage.AdapterNonExistent that) {
				...
				if (__typeCode == null) {
					...
					__typeCode = org.omg.CORBA.ORB.init().create_exception_tc(
							org.omg.PortableServer.POAPackage.AdapterNonExistentHelper
									.id(), "AdapterNonExistent", _members0);
					__active = false;
				}
			}
		}
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			org.omg.PortableServer.POAPackage.AdapterNonExistent value) {
