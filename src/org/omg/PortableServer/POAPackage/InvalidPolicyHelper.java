...
/**
 * org/omg/PortableServer/POAPackage/InvalidPolicyHelper.java . Generated by the
...
abstract public class InvalidPolicyHelper {
	...
	public static void insert(org.omg.CORBA.Any a,
			org.omg.PortableServer.POAPackage.InvalidPolicy that) {
			...
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					_tcOf_members0 = org.omg.CORBA.ORB.init()
							.get_primitive_tc(org.omg.CORBA.TCKind.tk_ushort);
					_members0[0] = new org.omg.CORBA.StructMember("index", _tcOf_members0, null);
					__typeCode = org.omg.CORBA.ORB.init().create_exception_tc(
							org.omg.PortableServer.POAPackage.InvalidPolicyHelper.id(),
							"InvalidPolicy", _members0);
					__active = false;
				}
			}
		}
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			org.omg.PortableServer.POAPackage.InvalidPolicy value) {
