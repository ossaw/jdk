...
public interface TAG_ALTERNATE_IIOP_ADDRESS {
    ...
    /**
     * In cases where the same object key is used for more than one internet
     * location, the following standard IOR Component is defined for support in
     * IIOP version 1.2.
     * <p>
     * The <code>TAG_ALTERNATE_IIOP_ADDRESS</code> component has an associated
     * value of type: <code>
     *   <pre>
     *     struct { 
     *         string HostID, 
     ...
     *     }; 
     *   </pre>
     * </code> encoded as a CDR encapsulation.
     * <p>
     ...
     * <code>TAG_ALTERNATE_IIOP_ADDRESS</code> components are present in a
     * <code>TAG_INTERNET_IOP</code> Profile, no order of use is prescribed by
     * Version 1.2 of IIOP.
     */
