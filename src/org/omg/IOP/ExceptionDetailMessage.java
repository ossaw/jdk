...
/**
 * org/omg/IOP/ExceptionDetailMessage.java . Generated by the IDL-to-Java
...
public interface ExceptionDetailMessage {
	...
	/**
	 * CORBA formal/02-06-01: 13.7.1: ExceptionDetailMessage identifies a CDR
	 * encapsulation of a wstring, encoded using GIOP 1.2 with a TCS-W of
	 * UTF-16. This service context may be sent on Reply messages with a
	 ...
	 * debugging information but may contain sensitive or unwanted information.
	 * The wstring within the service context will therefore contain additional
	 * information relating to the exception, for example the result of calling
	 * either printStackTrace(PrintWriter) or getMessage() on the exception.
	 * When unmarshaling a System Exception on the client side, the wstring from
