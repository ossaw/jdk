 ...
 * from
 * c:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8u144/9417/corba/src/share/classes/org/omg/PortableInterceptor/IOP.idl
 * Friday, July 21, 2017 9:58:52 PM PDT
 */

/**
 * The formats of IOR components and service context data used by ORB services
 * are often defined as CDR encapsulations encoding instances of IDL defined
 * data types. The <code>Codec</code> provides a mechanism to transfer these
 * components between their IDL data types and their CDR encapsulation
 * representations.
 * <p>
 * A <code>Codec</code> is obtained from the <code>CodecFactory</code>. The
...
public interface CodecOperations {
	...
	/**
	 * Converts the given any into a byte array based on the encoding format
	 * effective for this Codec. Only the data from the Any is encoded, not the
	 * <code>TypeCode</code>.
	 *
	 * @param data
	 *             The data, in the form of an Any, to be encoded into a byte
	 ...
	 * <code>TypeCode</code> and the encoding format effective for this
	 * <code>Codec</code>.
	 *
	 * @param data
	 *             The data, in the form of a byte array, to be decoded into an
