...
abstract public class TaggedComponentHelper {
			...
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					_tcOf_members0 = org.omg.CORBA.ORB.init().create_alias_tc(
							org.omg.IOP.ComponentIdHelper.id(), "ComponentId",
							_tcOf_members0);
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream,
		...
		ostream.write_octet_array(value.component_data, 0,
