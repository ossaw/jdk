...
abstract public class ObjectReferenceTemplateHelper {
			...
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					__typeCode = org.omg.CORBA.ORB.init().create_value_tc(_id,
							"ObjectReferenceTemplate", org.omg.CORBA.VM_ABSTRACT.value, null,
							_members0);
					__active = false;
				}
			}
	...
	public static org.omg.PortableInterceptor.ObjectReferenceTemplate read(
			org.omg.CORBA.portable.InputStream istream) {
		return (org.omg.PortableInterceptor.ObjectReferenceTemplate) ((org.omg.CORBA_2_3.portable.InputStream) istream)
				.read_value(id());
	}
