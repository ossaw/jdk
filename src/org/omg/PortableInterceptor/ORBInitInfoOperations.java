...
public interface ORBInitInfoOperations {
	 ...
	 *                thrown if a client-side request Interceptor has already
	 ...
	 * @exception DuplicateName
	 *                thrown if a server-side request Interceptor has already
	 *                been registered with this Interceptor's name
	 */
	 ...
	 * @exception DuplicateName
	 *                thrown if an IOR Interceptor has already been registered
	 ...
	 *                <code>set_slot</code> or <code>get_slot</code> is called
	 *                on the <code>PICurrent</code> within an ORB initializer.
	 * @see Current
	 */
	 ...
	 * 
	 * @param type
	 *            The policy type that the given <code>PolicyFactory</code>
	 *            serves.
