...
/**
 * The name of an object adapter. This is unique only within the scope of the
 * ORB that created the object adapter.
 */
abstract public class AdapterNameHelper {
    ...
    synchronized public static org.omg.CORBA.TypeCode type() {
        if (__typeCode == null) {
            ...
            __typeCode = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CORBA.StringSeqHelper.id(),
                    "StringSeq", __typeCode);
            __typeCode = org.omg.CORBA.ORB.init().create_alias_tc(
                    org.omg.PortableInterceptor.AdapterNameHelper.id(), "AdapterName", __typeCode);
        }
        return __typeCode;
    }
