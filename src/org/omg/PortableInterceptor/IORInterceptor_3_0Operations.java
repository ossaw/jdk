...
/**
 * org/omg/PortableInterceptor/IORInterceptor_3_0Operations.java . Generated by
...
public interface IORInterceptor_3_0Operations extends org.omg.PortableInterceptor.IORInterceptorOperations {
     ...
     * IORInterceptor_3_0 instances after establish_components has been invoked
     * on all registered IORInterceptor instances. The adapter_template is
     * available in info during this call. The current_factory may be get or set
     * in info during this call.
     * <p>
     * Any exception thrown from this method is handled by the Object Adapter
     * that called this interceptor. In the case of the POA, an exception
    ...
    /**
     * Called whenever the state of an adapter manager changes. For the POA,
     * that is the POAManager. If the state change is reported through
     * <code>adapter_manager_state_changed</code>, it is not reported through
    ...
    /**
     * Called whenever the state of an object adapter changes, and the state
     * change is not caused by an adapter manager. Such changes are reported to
