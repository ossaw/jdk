 ...
 * <p>
 * Some attributes and operations on <code>ClientRequestInfo</code> are not
 ...
 * whether in, inout, or out. But only the in and inout arguments will be
 * available.</li>
...
public interface ClientRequestInfoOperations
	 ...
	 *         identifier.
	 * @exception BAD_PARAM
	 *                thrown, with a standard minor code of 28, if no component
	 ...
	 *                thrown, with a standard minor code of 1, if the policy
	 *                type is not valid either because the specified type is not
	 *                supported by this ORB or because a policy object of that
	 ...
	 *            The <code>IOP.ServiceContext</code> to be added to the
	 *            request.
	 * @param replace
