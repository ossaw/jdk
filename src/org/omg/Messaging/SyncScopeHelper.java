...
* from c:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8u144/9417/corba/src/share/classes/org/omg/PortableInterceptor/Messaging.idl
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			...
			__typeCode = org.omg.CORBA.ORB.init().create_alias_tc(
					org.omg.Messaging.SyncScopeHelper.id(), "SyncScope", __typeCode);
		}
		return __typeCode;
	}
