 ...
 * which contains a set of name bindings in which each name is unique and is
 * part of Interoperable Naming Service. Different names can be bound to an
 ...
 */
public class _NamingContextExtStub extends org.omg.CORBA.portable.ObjectImpl
    ...
    public String to_string(org.omg.CosNaming.NameComponent[] n)
        ...
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("to_string",
                    true);
            org.omg.CosNaming.NameHelper.write($out, n);
            $in = _invoke($out);
            String $result = org.omg.CosNaming.NamingContextExtPackage.StringNameHelper
                    .read($in);
            return $result;
    ...
    public org.omg.CosNaming.NameComponent[] to_name(String sn)
        ...
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("to_name",
                    true);
            org.omg.CosNaming.NamingContextExtPackage.StringNameHelper.write(
                    $out, sn);
            $in = _invoke($out);
            org.omg.CosNaming.NameComponent $result[] = org.omg.CosNaming.NameHelper
                    .read($in);
            return $result;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            $in = $ex.getInputStream();
    ...
    public String to_url(String addr, String sn)
        ...
        try {
            ...
            org.omg.CosNaming.NamingContextExtPackage.AddressHelper.write($out,
                    addr);
            org.omg.CosNaming.NamingContextExtPackage.StringNameHelper.write(
                    $out, sn);
            $in = _invoke($out);
            String $result = org.omg.CosNaming.NamingContextExtPackage.URLStringHelper
                    .read($in);
            return $result;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            $in = $ex.getInputStream();
            ...
            if (_id.equals(
                ...
                throw org.omg.CosNaming.NamingContextExtPackage.InvalidAddressHelper
                        .read($in);
            else if (_id.equals(
                    "IDL:omg.org/CosNaming/NamingContext/InvalidName:1.0"))
                throw org.omg.CosNaming.NamingContextPackage.InvalidNameHelper
    ...
    public org.omg.CORBA.Object resolve_str(String sn)
        ...
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("resolve_str",
                    true);
            org.omg.CosNaming.NamingContextExtPackage.StringNameHelper.write(
                    $out, sn);
            $in = _invoke($out);
            ...
            if (_id.equals("IDL:omg.org/CosNaming/NamingContext/NotFound:1.0"))
                throw org.omg.CosNaming.NamingContextPackage.NotFoundHelper
                        .read($in);
            else if (_id.equals(
                    "IDL:omg.org/CosNaming/NamingContext/CannotProceed:1.0"))
                throw org.omg.CosNaming.NamingContextPackage.CannotProceedHelper
                        .read($in);
            else if (_id.equals(
                    "IDL:omg.org/CosNaming/NamingContext/InvalidName:1.0"))
                throw org.omg.CosNaming.NamingContextPackage.InvalidNameHelper
     ...
     * 
     * @exception org.omg.CosNaming.NamingContextPackage.CannotProceed
     *            Indicates that the implementation has given up for some
    ...
    public void bind(org.omg.CosNaming.NameComponent[] n,
        ...
        try {
            ...
            if (_id.equals("IDL:omg.org/CosNaming/NamingContext/NotFound:1.0"))
                ...
                throw org.omg.CosNaming.NamingContextPackage.AlreadyBoundHelper
                        .read($in);
            else
                throw new org.omg.CORBA.MARSHAL(_id);
        } catch (org.omg.CORBA.portable.RemarshalException $rm) {
    ...
    /**
     * Names an object that is a naming context. Naming contexts that are bound
     * using bind_context() participate in name resolution when compound names
     * are passed to be resolved.
     * 
     * @param n
     *           Name of the object
     *           <p>
    ...
    public void bind_context(org.omg.CosNaming.NameComponent[] n,
        ...
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("bind_context",
                    true);
            org.omg.CosNaming.NameHelper.write($out, n);
    ...
    /**
     * Creates a binding of a name and an object in the naming context even if
     * the name is already bound in the context. Naming contexts that are bound
     * using rebind do not participate in name resolution when compound names
     * are passed to be resolved.
     * 
     * @param n
     *            Name of the object
    ...
    /**
     * Creates a binding of a name and a naming context in the naming context
     * even if the name is already bound in the context. Naming contexts that
     * are bound using rebind_context() participate in name resolution when
    ...
    /**
     * The resolve operation is the process of retrieving an object bound to a
     * name in a given context. The given name must exactly match the bound
     * name. The naming service does not return the type of the object. Clients
     * are responsible for "narrowing" the object to the appropriate type. That
     * is, clients typically cast the returned object from Object to a more
    ...
    public org.omg.CORBA.Object resolve(org.omg.CosNaming.NameComponent[] n)
        ...
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("resolve",
                    true);
            org.omg.CosNaming.NameHelper.write($out, n);
            $in = _invoke($out);
            org.omg.CORBA.Object $result = org.omg.CORBA.ObjectHelper.read($in);
    ...
    /**
     * The list operation allows a client to iterate through a set of bindings
     * in a naming context.
     * <p>
     * 
    ...
    /**
     * This operation returns a naming context implemented by the same naming
     * server as the context on which the operation was invoked. The new context
     * is not bound to any name.
     */
    public org.omg.CosNaming.NamingContext new_context() {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("new_context",
                    true);
            $in = _invoke($out);
            org.omg.CosNaming.NamingContext $result = org.omg.CosNaming.NamingContextHelper
                    .read($in);
            return $result;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            $in = $ex.getInputStream();
    ...
    /**
     * This operation creates a new context and binds it to the name supplied as
     * an argument. The newly-created context is implemented by the same naming
     * server as the context in which it was bound (that is, the naming server
     * that implements the context denoted by the name argument excluding the
     * last component).
     * 
     * @param n
     *          Name of the object
    ...
    /**
     * The destroy operation deletes a naming context. If the naming context
     * contains bindings, the NotEmpty exception is raised.
     * 
    ...
    public void destroy()
        ...
        try {
            ...
            if (_id.equals("IDL:omg.org/CosNaming/NamingContext/NotEmpty:1.0"))
                throw org.omg.CosNaming.NamingContextPackage.NotEmptyHelper
                        .read($in);
            else
                throw new org.omg.CORBA.MARSHAL(_id);
        } catch (org.omg.CORBA.portable.RemarshalException $rm) {
