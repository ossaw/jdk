...
public abstract class NamingContextExtPOA extends org.omg.PortableServer.Servant implements
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String $method,
		 ...
		 * a name in a given context. The given name must exactly match the
		 ...
		 * appropriate type. That is, clients typically cast the returned object
		 ...
		 * <p>
		 * 
		 * The list operation returns at most the requested number of bindings
		 * in BindingList bl.
		 * <ul>
		 ...
		 * naming server as the context on which the operation was invoked. The
		 * new context is not bound to any name.
		 */
		 ...
		 * supplied as an argument. The newly-created context is implemented by
		 * the same naming server as the context in which it was bound (that is,
		 * the naming server that implements the context denoted by the name
