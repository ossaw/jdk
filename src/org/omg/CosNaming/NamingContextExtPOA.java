...
public abstract class NamingContextExtPOA extends org.omg.PortableServer.Servant
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String $method,
		...
		switch (__method.intValue()) {
			...
			/**
			 * This operation converts a Stringified Name into an equivalent
			 * array
			 * of Name Components.
			 * 
			 * @param sn
			...
			/**
			 * This operation creates a URL based "iiopname://" format name from
			 * the
			 * Stringified Name of the object.
			 * 
			 * @param addr
			 ...
			 * Creates a binding of a name and an object in the naming context
			 * even
			 * if the name is already bound in the context. Naming contexts that
			 * are
			 ...
			 * <li>If the naming context does not contain additional bindings,
			 * the
			 ...
			 * by
			 * the same naming server as the context in which it was bound (that
			 * is,
