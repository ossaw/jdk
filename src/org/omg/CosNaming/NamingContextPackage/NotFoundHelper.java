...
/**
 * org/omg/CosNaming/NamingContextPackage/NotFoundHelper.java . Generated by the
...
abstract public class NotFoundHelper {
    ...
    public static void insert(org.omg.CORBA.Any a,
            org.omg.CosNaming.NamingContextPackage.NotFound that) {
    ...
    public static org.omg.CosNaming.NamingContextPackage.NotFound extract(
            org.omg.CORBA.Any a) {
        ...
        if (__typeCode == null) {
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    _tcOf_members0 = org.omg.CosNaming.NamingContextPackage.NotFoundReasonHelper
                            .type();
                    _members0[0] = new org.omg.CORBA.StructMember("why",
                            _tcOf_members0, null);
    ...
    public static org.omg.CosNaming.NamingContextPackage.NotFound read(
            org.omg.CORBA.portable.InputStream istream) {
        org.omg.CosNaming.NamingContextPackage.NotFound value = new org.omg.CosNaming.NamingContextPackage.NotFound();
        // read and discard the repository ID
        istream.read_string();
        value.why = org.omg.CosNaming.NamingContextPackage.NotFoundReasonHelper
                .read(istream);
    ...
    public static void write(org.omg.CORBA.portable.OutputStream ostream,
            org.omg.CosNaming.NamingContextPackage.NotFound value) {
        // write the repository ID
        ostream.write_string(id());
        org.omg.CosNaming.NamingContextPackage.NotFoundReasonHelper.write(
                ostream, value.why);
