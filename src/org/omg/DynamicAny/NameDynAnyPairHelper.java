...
/**
 * org/omg/DynamicAny/NameDynAnyPairHelper.java . Generated by the IDL-to-Java
...
abstract public class NameDynAnyPairHelper {
			...
			synchronized (org.omg.CORBA.TypeCode.class) {
				if (__typeCode == null) {
					...
					__typeCode = org.omg.CORBA.ORB.init().create_struct_tc(
							org.omg.DynamicAny.NameDynAnyPairHelper.id(), "NameDynAnyPair",
							_members0);
					__active = false;
				}
			}
	...
	public static org.omg.DynamicAny.NameDynAnyPair read(
