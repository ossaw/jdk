...
/**
 * DynUnion objects support the manipulation of IDL unions. A union can have
 * only two valid current positions:
 * <UL>
 ...
 * otherwise.
 */
public class _DynUnionStub extends org.omg.CORBA.portable.ObjectImpl
	...
	public org.omg.DynamicAny.DynAny get_discriminator() {
		org.omg.CORBA.portable.ServantObject $so = _servant_preinvoke("get_discriminator",
				_opsClass);
	...
	/**
	 * Sets the discriminator of the DynUnion to the specified value. Setting
	 * the discriminator to a value that is consistent with the currently active
	 * union member does not affect the currently active member. Setting the
	 * discriminator to a value that is inconsistent with the currently active
	 * member deactivates the member and activates the member that is consistent
	 * with the new discriminator value (if there is a member for that value) by
	 * initializing the member to its default value. Setting the discriminator
	 * of a union sets the current position to 0 if the discriminator value
	 * indicates a non-existent union member (has_no_active_member returns true
	 * in this case). Otherwise, if the discriminator value indicates a named
	 * union member, the current position is set to 1 (has_no_active_member
	 * returns false and component_count returns 2 in this case).
	 *
	 * @exception TypeMismatch
	 *                if the TypeCode of the parameter is not equivalent to the
	 *                TypeCode of the union's discriminator
	 */
	public void set_discriminator(org.omg.DynamicAny.DynAny d)
			throws org.omg.DynamicAny.DynAnyPackage.TypeMismatch {
		org.omg.CORBA.portable.ServantObject $so = _servant_preinvoke("set_discriminator",
				_opsClass);
		DynUnionOperations $self = (DynUnionOperations) $so.servant;
	 ...
	 * the default case of a union. It sets the current position to zero and
	...
	public void set_to_default_member() throws org.omg.DynamicAny.DynAnyPackage.TypeMismatch {
		org.omg.CORBA.portable.ServantObject $so = _servant_preinvoke("set_to_default_member",
				_opsClass);
		DynUnionOperations $self = (DynUnionOperations) $so.servant;
	 ...
	 * unions case labels. It sets the current position to zero and causes
	 * component_count to return 1.
	 *
	 * @exception TypeMismatch
	 *                if the union has an explicit default case or if it uses
	 *                the entire range of discriminator values for explicit case
	 *                labels
	 */
	public void set_to_no_active_member() throws org.omg.DynamicAny.DynAnyPackage.TypeMismatch {
		org.omg.CORBA.portable.ServantObject $so = _servant_preinvoke("set_to_no_active_member",
				_opsClass);
		DynUnionOperations $self = (DynUnionOperations) $so.servant;
	 ...
	 * consists solely of its discriminator because the discriminator has a
	 * value that is not listed as an explicit case label. Calling this
	 * operation on a union that has a default case returns false. Calling this
	 * operation on a union that uses the entire range of discriminator values
	 * for explicit case labels returns false.
	 */
	public boolean has_no_active_member() {
		org.omg.CORBA.portable.ServantObject $so = _servant_preinvoke("has_no_active_member",
				_opsClass);
		DynUnionOperations $self = (DynUnionOperations) $so.servant;
	...
	public org.omg.CORBA.TCKind discriminator_kind() {
		org.omg.CORBA.portable.ServantObject $so = _servant_preinvoke("discriminator_kind",
				_opsClass);
		DynUnionOperations $self = (DynUnionOperations) $so.servant;
	 ...
	 * remains valid only for as long as the currently active member does not
	 * change. Using the returned reference beyond the life time of the
	 ...
	 * does not contain a member name for the currently active member, the
	...
	private static String[] __ids = { "IDL:omg.org/DynamicAny/DynUnion:1.0",
