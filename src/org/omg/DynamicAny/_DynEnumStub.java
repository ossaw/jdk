...
/**
 * DynEnum objects support the manipulation of IDL enumerated values. The
 * current position of a DynEnum is always -1.
 */
public class _DynEnumStub extends org.omg.CORBA.portable.ObjectImpl
	...
	/**
	 * Sets the value of the DynEnum to the enumerated value whose IDL
	 * identifier is passed in the value parameter.
	 *
	 * @exception InvalidValue
	 *                If value contains a string that is not a valid IDL
	 ...
	 * Enumerators have ordinal values 0 to n-1, as they appear from left to
	 * right in the corresponding IDL definition.
	 */
	 ...
	 *
	 * @exception InvalidValue
	 *                If value contains a value that is outside the range of
	 *                ordinal values for the corresponding enumerated type
	 */
	...
	private static String[] __ids = { "IDL:omg.org/DynamicAny/DynEnum:1.0",
