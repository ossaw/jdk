 ...
 * dimension of the array is contained in the TypeCode which is accessible
 * through the type attribute. It can also be obtained by calling the
 * component_count operation.
 */
public class _DynArrayStub extends org.omg.CORBA.portable.ObjectImpl
	 ...
	 *                if the sequence does not contain the same number of
	...
	private static String[] __ids = { "IDL:omg.org/DynamicAny/DynArray:1.0",
