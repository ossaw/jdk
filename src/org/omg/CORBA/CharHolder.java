...
/**
 * The Holder for <tt>Char</tt>. For more information on Holder files, see
 * <a href="doc-files/generatedfiles.html#holder">
 * "Generated Files: Holder Files"</a>.
 * <P>
 * A Holder class for a <code>char</code> that is used to store "out" and
 * "inout" parameters in IDL methods. If an IDL method signature has an IDL
 * <code>char</code> as an "out" or "inout" parameter, the programmer must pass
 * an instance of <code>CharHolder</code> as the corresponding parameter in the
 * method invocation; for "inout" parameters, the programmer must also fill the
 * "in" value to be sent to the server. Before the method invocation returns,
 * the ORB will fill in the value corresponding to the "out" value returned from
 * the server.
 * <P>
 * If <code>myCharHolder</code> is an instance of <code>CharHolder</code>, the
...
public final class CharHolder implements Streamable {
	 ...
	 *            <code>value</code> field of the new <code>CharHolder</code>
	 *            object
	 */
