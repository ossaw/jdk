...
/**
 * The Holder for <tt>Byte</tt>. For more information on Holder files, see
 * <a href="doc-files/generatedfiles.html#holder">
 * "Generated Files: Holder Files"</a>.
 * <P>
 * A Holder class for a <code>byte</code> that is used to store "out" and
 * "inout" parameters in IDL methods. If an IDL method signature has an IDL
 * <code>octet</code> as an "out" or "inout" parameter, the programmer must pass
 * an instance of <code>ByteHolder</code> as the corresponding parameter in the
 ...
 * the server.
 * <P>
 * If <code>myByteHolder</code> is an instance of <code>ByteHolder</code>, the
