 ...
 * exists. <tt>NO_IMPLEMENT</tt> can, for example, be raised by an ORB if a
 * client asks for an object's type definition from the interface repository,
 * but no interface repository is provided by the ORB.
 * <P>
...
public final class NO_IMPLEMENT extends SystemException {
    /**
     * Constructs a <code>NO_IMPLEMENT</code> exception with a default minor
    ...
    /**
     * Constructs a <code>NO_IMPLEMENT</code> exception with the specified minor
