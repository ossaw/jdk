...
public interface DataOutputStream extends org.omg.CORBA.portable.ValueBase {
	...
	/**
	 * Writes the IDL octet value (represented as a Java byte) to the output
	 * stream.
	 * 
	 * @param value
	 *            The value to be written.
	...
	/**
	 * Writes the IDL unsigned short value (represented as a Java short value)
	...
	/**
	 * Writes the IDL long value (represented as a Java int) to the output
	 * stream.
	 * 
	 * @param value
	 *            The value to be written.
	...
	/**
	 * Writes the IDL unsigned long value (represented as a Java int) to the
	 * output stream.
	 * 
	 * @param value
	 *            The value to be written.
	...
	/**
	 * Writes the IDL unsigned long long value (represented as a Java long) to
	 * the output stream.
	 * 
	 * @param value
	 *            The value to be written.
	...
	/**
	 * Writes the IDL wide string value (represented as a Java String) to the
	 * output stream.
	 * 
	 * @param value
	 *            The value to be written.
	 ...
	 * @param offset
	 *            The index into seq of the first element to write to the output
	 *            stream.
	 * @param length
	...
	/**
	 * Writes the array of IDL wide characters from offset for length elements
	 * to the output stream.
	 * 
	 * @param seq
	 *            The array to be written.
	...
	/**
	 * Writes the array of IDL unsigned longs (represented as Java ints) from
	 * offset for length elements to the output stream.
	 * 
	 * @param seq
	 *            The array to be written.
