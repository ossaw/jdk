...
public final class INVALID_TRANSACTION extends SystemException {
	/**
	 * Constructs an <code>INVALID_TRANSACTION</code> exception with a default
	...
	/**
	 * Constructs an <code>INVALID_TRANSACTION</code> exception with the
	...
	/**
	 * Constructs an <code>INVALID_TRANSACTION</code> exception with the
	 * specified detail message, minor code, and completion status. A detail
