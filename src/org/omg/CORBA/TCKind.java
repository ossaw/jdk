...
/**
 * The Java mapping of the IDL enum <code>TCKind</code>, which specifies the
 * kind of a <code>TypeCode</code> object. There is one kind for each primitive
 * and essential IDL data type.
 * <P>
 * The class <code>TCKind</code> consists of:
 * <UL>
 * <LI>a set of <code>int</code> constants, one for each kind of IDL data type.
 * These <code>int</code> constants make it possible to use a
 * <code>switch</code> statement.
 * <LI>a set of <code>TCKind</code> constants, one for each kind of IDL data
 * type. The <code>value</code> field for each <code>TCKind</code> instance is
 * initialized with the <code>int</code> constant that corresponds with the IDL
 * data type that the instance represents.
 * <LI>the method <code>from_int</code>for converting an <code>int</code> to its
 ...
 * the IDL type <code>string</code>, which is <code>tk_string</code>.
 * <P>
 * <LI>the method <code>value</code> for accessing the <code>_value</code> field
 * of a <code>TCKind</code> constant
 * <P>
 * Example:
 * 
 * <PRE>
 ...
 * </PRE>
 * 
 * The variable <code>i</code> represents 9, the value for the IDL data type
 * <code>char</code>.
 * </UL>
 * <P>
 * The <code>value</code> field of a <code>TCKind</code> instance is the CDR
 * encoding used for a <code>TypeCode</code> object in an IIOP message.
 */
...
public class TCKind {
	...
	/**
	 * The <code>int</code> constant for the IDL data type
	 * <code>Principal</code>.
	 */
	 ...
	 * <code>value_box</code>.
	 */
	public static final int _tk_value_box = 30; // orbos 98-01-18: Objects By
												// Value
	 ...
	 *
	 * @return the <code>int</code> that represents the kind of IDL data type
	 *         for this <code>TCKind</code> instance
	 */
	public int value() {
		return _value;
	}
