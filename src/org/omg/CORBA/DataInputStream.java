 ...
 * unmarshaling custom value types. This interface is used by user written
 * custom unmarshaling code for custom value types.
 * 
...
public interface DataInputStream extends org.omg.CORBA.portable.ValueBase {
	...
	/**
	 * Reads array of IDL Anys from offset for length elements from the input
	 * stream.
	 * 
	 * @param seq
	 *            The out parameter holder for the array to be read.
	 * @param offset
	 *            The index into seq of the first element to read from the input
	 *            stream.
	 * @param length
