...
public abstract class ServiceDetailHelper {
    ...
    synchronized public static org.omg.CORBA.TypeCode type() {
        ...
        if (_tc == null) {
            ...
            _members[0] = new org.omg.CORBA.StructMember("service_detail_type", org.omg.CORBA.ORB.init()
                    .get_primitive_tc(org.omg.CORBA.TCKind.tk_ulong), null);

            _members[1] = new org.omg.CORBA.StructMember("service_detail", org.omg.CORBA.ORB.init()
