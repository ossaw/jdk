...
public abstract class ServiceDetailHelper {
    ...
    public static void write(org.omg.CORBA.portable.OutputStream out,
            org.omg.CORBA.ServiceDetail that) {
        out.write_ulong(that.service_detail_type);
        {
            out.write_long(that.service_detail.length);
            out.write_octet_array(that.service_detail, 0,
                    that.service_detail.length);
        }
    }

    public static org.omg.CORBA.ServiceDetail read(
        ...
        that.service_detail_type = in.read_ulong();
        {
            ...
            in.read_octet_array(that.service_detail, 0,
                    that.service_detail.length);
        }
        return that;
    }
    ...
    synchronized public static org.omg.CORBA.TypeCode type() {
        ...
        if (_tc == null) {
            ...
            _members[0] = new org.omg.CORBA.StructMember("service_detail_type",
            ...
            _members[1] = new org.omg.CORBA.StructMember("service_detail",
                    org.omg.CORBA.ORB.init().create_sequence_tc(0,
                            org.omg.CORBA.ORB.init().get_primitive_tc(
                                    org.omg.CORBA.TCKind.tk_octet)), null);
            _tc = org.omg.CORBA.ORB.init().create_struct_tc(id(),
                    "ServiceDetail", _members);
        }
        return _tc;
    }
