...
/**
 * The Holder for <tt>Short</tt>. For more information on Holder files, see
 * <a href="doc-files/generatedfiles.html#holder">
 * "Generated Files: Holder Files"</a>.<P A Holder class for a
 * <code>short</code> that is used to store "out" and "inout" parameters in IDL
 * operations. If an IDL operation signature has an IDL <code>short</code> as an
 * "out" or "inout" parameter, the programmer must pass an instance of
 * <code>ShortHolder</code> as the corresponding parameter in the method
 ...
 * server.
 * <P>
 * If <code>myShortHolder</code> is an instance of <code>ShortHolder</code>, the
