...
abstract public class UnionMemberHelper {
    ...
    public static void insert(org.omg.CORBA.Any a,
            org.omg.CORBA.UnionMember that) {
        ...
        if (__typeCode == null) {
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    _members0[1] = new org.omg.CORBA.StructMember("label",
                            _tcOf_members0, null);
                    _tcOf_members0 = org.omg.CORBA.ORB.init().get_primitive_tc(
                    ...
                    _members0[3] = new org.omg.CORBA.StructMember("type_def",
                            _tcOf_members0, null);
                    __typeCode = org.omg.CORBA.ORB.init().create_struct_tc(
                            org.omg.CORBA.UnionMemberHelper.id(), "UnionMember",
                            _members0);
                    __active = false;
                }
            }
    ...
    public static org.omg.CORBA.UnionMember read(
