...
/**
 * The Helper for <tt>UnionMember</tt>. For more information on Helper files,
 * see <a href="doc-files/generatedfiles.html#helper">
 * "Generated Files: Helper Files"</a>.
 * <P>
 * org/omg/CORBA/UnionMemberHelper.java Generated by the IDL-to-Java compiler
 * (portable), version "3.0" from ir.idl 03 June 1999 11:33:43 o'clock GMT+00:00
 */
        ...
        if (__typeCode == null) {
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    _members0[1] = new org.omg.CORBA.StructMember("label", _tcOf_members0, null);
                    _tcOf_members0 = org.omg.CORBA.ORB.init().get_primitive_tc(
                            org.omg.CORBA.TCKind.tk_TypeCode);
                    _members0[2] = new org.omg.CORBA.StructMember("type", _tcOf_members0, null);
                    _tcOf_members0 = org.omg.CORBA.IDLTypeHelper.type();
                    _members0[3] = new org.omg.CORBA.StructMember("type_def", _tcOf_members0, null);
                    __typeCode = org.omg.CORBA.ORB.init().create_struct_tc(org.omg.CORBA.UnionMemberHelper
                            .id(), "UnionMember", _members0);
                    __active = false;
                }
            }
        }
