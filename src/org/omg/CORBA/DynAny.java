...
/**
 * Enables <tt>org.omg.CORBA.Any</tt> values to be dynamically interpreted
 * (traversed) and constructed. A <tt>DynAny</tt> object is associated with a
 * data value which may correspond to a copy of the value inserted into an
 * <tt>Any</tt>. The <tt>DynAny</tt> APIs enable traversal of the data value
 * associated with an Any at runtime and extraction of the primitive
 * constituents of the data value.
 * 
 * @deprecated Use the new <a href="../DynamicAny/DynAny.html">DynAny</a>
 *             instead
 */
@Deprecated
public interface DynAny extends org.omg.CORBA.Object {
	/**
	 * Returns the <code>TypeCode</code> of the object inserted into this
	 * <code>DynAny</code>.
	 *
	 ...
	 *
	 * @param dyn_any
	 *            the <code>DynAny</code> object whose contents are assigned to
	 ...
	 * @throws Invalid
	 *             if this <code>DynAny</code> is empty or bad. created or does
	 ...
	 * represent the data value associated with it. This method also destroys
	 * all <code>DynAny</code> objects obtained from it.
	 * <p>
	 * Destruction of <code>DynAny</code> objects should be handled with care,
	 * taking into account issues dealing with the representation of data values
	 * associated with <code>DynAny</code> objects. A programmer who wants to
	 * destroy a <code>DynAny</code> object but still be able to manipulate some
	 * component of the data value associated with it, should first create a
	 * <code>DynAny</code> object for the component and then make a copy of the
	 * created <code>DynAny</code> object.
	 */
	public void destroy();
	 ...
	 *
	 * @param value
	 *            the <code>byte</code> to insert into this <code>DynAny</code>
	 *            object
	 * @throws org.omg.CORBA.DynAnyPackage.InvalidValue
	 *             if the value inserted is not consistent with the type of the
	 *             accessed component in this <code>DynAny</code> object
	 ...
	 *
	 * @param value
	 *            the <code>char</code> to insert into this <code>DynAny</code>
	 *            object
	 * @throws org.omg.CORBA.DynAnyPackage.InvalidValue
	 *             if the value inserted is not consistent with the type of the
	 *             accessed component in this <code>DynAny</code> object
	 ...
	 *
	 * @param value
	 *            the <code>short</code> to insert into this <code>DynAny</code>
	 *            object
	 * @throws org.omg.CORBA.DynAnyPackage.InvalidValue
	 *             if the value inserted is not consistent with the type of the
	 *             accessed component in this <code>DynAny</code> object
	 ...
	 *
	 * @param value
	 *            the <code>float</code> to insert into this <code>DynAny</code>
	 *            object
	 * @throws org.omg.CORBA.DynAnyPackage.InvalidValue
	 *             if the value inserted is not consistent with the type of the
	 *             accessed component in this <code>DynAny</code> object
	 ...
	 *
	 * @param value
	 *            the <code>long</code> to insert into this <code>DynAny</code>
	 *            object
	 * @throws org.omg.CORBA.DynAnyPackage.InvalidValue
	 *             if the value inserted is not consistent with the type of the
	 *             accessed component in this <code>DynAny</code> object
	 ...
	 *
	 * @param value
	 *            the <code>org.omg.CORBA.Any</code> object to insert into this
	 *            <code>DynAny</code> object
	 * @throws org.omg.CORBA.DynAnyPackage.InvalidValue
	 *             if the value inserted is not consistent with the type of the
	 *             accessed component in this <code>DynAny</code> object
	 ...
	 * <code>DynAny</code> object.
	 *
	 * @return the <code>java.io.Serializable</code> object that is the value
	 *         for this <code>DynAny</code> object
	...
	/**
	 * Retrieves the <code>boolean</code> contained in this <code>DynAny</code>
	 * object.
	 *
	 * @return the <code>boolean</code> that is the value for this
	 *         <code>DynAny</code> object
	 * @throws org.omg.CORBA.DynAnyPackage.TypeMismatch
	 *             if the type code of the accessed component in this
	 *             <code>DynAny</code> object is not equivalent to the type code
	 ...
	 * object.
	 *
	 * @return the <code>byte</code> that is the value for this
	 *         <code>DynAny</code> object
	 * @throws org.omg.CORBA.DynAnyPackage.TypeMismatch
	 *             if the type code of the accessed component in this
	 *             <code>DynAny</code> object is not equivalent to the type code
	 *             for a <code>byte</code>
	 */
	public byte get_octet() throws org.omg.CORBA.DynAnyPackage.TypeMismatch;

	/**
	 * Retrieves the <code>char</code> contained in this <code>DynAny</code>
	 * object.
	 *
	 * @return the <code>char</code> that is the value for this
	 *         <code>DynAny</code> object
	 * @throws org.omg.CORBA.DynAnyPackage.TypeMismatch
	 *             if the type code of the accessed component in this
	 *             <code>DynAny</code> object is not equivalent to the type code
	 *             for a <code>char</code>
	 */
	public char get_char() throws org.omg.CORBA.DynAnyPackage.TypeMismatch;

	/**
	 * Retrieves the <code>short</code> contained in this <code>DynAny</code>
	 * object.
	 *
	 * @return the <code>short</code> that is the value for this
	 *         <code>DynAny</code> object
	 * @throws org.omg.CORBA.DynAnyPackage.TypeMismatch
	 *             if the type code of the accessed component in this
	 *             <code>DynAny</code> object is not equivalent to the type code
	 *             for a <code>short</code>
	 */
	public short get_short() throws org.omg.CORBA.DynAnyPackage.TypeMismatch;
	 ...
	 *             for a <code>short</code>
	 */
	public short get_ushort() throws org.omg.CORBA.DynAnyPackage.TypeMismatch;

	/**
	 * Retrieves the <code>int</code> contained in this <code>DynAny</code>
	 * object.
	 *
	 * @return the <code>int</code> that is the value for this
	 *         <code>DynAny</code> object
	 * @throws org.omg.CORBA.DynAnyPackage.TypeMismatch
	 *             if the type code of the accessed component in this
	 *             <code>DynAny</code> object is not equivalent to the type code
	 *             for a <code>int</code>
	 */
	public int get_long() throws org.omg.CORBA.DynAnyPackage.TypeMismatch;
	 ...
	 *             for a <code>int</code>
	 */
	public int get_ulong() throws org.omg.CORBA.DynAnyPackage.TypeMismatch;

	/**
	 * Retrieves the <code>float</code> contained in this <code>DynAny</code>
	 * object.
	 *
	 * @return the <code>float</code> that is the value for this
	 *         <code>DynAny</code> object
	 * @throws org.omg.CORBA.DynAnyPackage.TypeMismatch
	 *             if the type code of the accessed component in this
	 *             <code>DynAny</code> object is not equivalent to the type code
	 *             for a <code>float</code>
	 */
	public float get_float() throws org.omg.CORBA.DynAnyPackage.TypeMismatch;

	/**
	 * Retrieves the <code>double</code> contained in this <code>DynAny</code>
	 * object.
	 *
	 * @return the <code>double</code> that is the value for this
	 *         <code>DynAny</code> object
	 * @throws org.omg.CORBA.DynAnyPackage.TypeMismatch
	 *             if the type code of the accessed component in this
	 *             <code>DynAny</code> object is not equivalent to the type code
	 *             for a <code>double</code>
	 */
	public double get_double() throws org.omg.CORBA.DynAnyPackage.TypeMismatch;

	/**
	 * Retrieves the <code>String</code> contained in this <code>DynAny</code>
	 * object.
	 *
	 ...
	 *             if the type code of the accessed component in this
	 *             <code>DynAny</code> object is not equivalent to the type code
	 *             for a <code>String</code>
	 */
	public String get_string() throws org.omg.CORBA.DynAnyPackage.TypeMismatch;

	/**
	 * Retrieves the <code>org.omg.CORBA.Other</code> contained in this
	 * <code>DynAny</code> object.
	 *
	 * @return the <code>org.omg.CORBA.Other</code> that is the value for this
	 *         <code>DynAny</code> object
	 * @throws org.omg.CORBA.DynAnyPackage.TypeMismatch
	 *             if the type code of the accessed component in this
	 *             <code>DynAny</code> object is not equivalent to the type code
	 ...
	 * <code>DynAny</code> object.
	 *
	 * @return the <code>org.omg.CORBA.TypeCode</code> that is the value for
	 *         this <code>DynAny</code> object
	 * @throws org.omg.CORBA.DynAnyPackage.TypeMismatch
	 *             if the type code of the accessed component in this
	 *             <code>DynAny</code> object is not equivalent to the type code
	 ...
	 * object.
	 *
	 * @return the <code>long</code> that is the value for this
	 *         <code>DynAny</code> object
	 * @throws org.omg.CORBA.DynAnyPackage.TypeMismatch
	 *             if the type code of the accessed component in this
	 *             <code>DynAny</code> object is not equivalent to the type code
	 *             for a <code>long</code>
	 */
	public long get_longlong() throws org.omg.CORBA.DynAnyPackage.TypeMismatch;
	 ...
	 *             for a <code>long</code>
	 */
	public long get_ulonglong() throws org.omg.CORBA.DynAnyPackage.TypeMismatch;
	 ...
	 *             for a <code>char</code>
	 */
	public char get_wchar() throws org.omg.CORBA.DynAnyPackage.TypeMismatch;
	 ...
	 *             for a <code>String</code>
	 */
	public String get_wstring() throws org.omg.CORBA.DynAnyPackage.TypeMismatch;

	/**
	 * Retrieves the <code>org.omg.CORBA.Any</code> contained in this
	 * <code>DynAny</code> object.
	 *
	 * @return the <code>org.omg.CORBA.Any</code> that is the value for this
	 *         <code>DynAny</code> object
	 * @throws org.omg.CORBA.DynAnyPackage.TypeMismatch
	 *             if the type code of the accessed component in this
	 *             <code>DynAny</code> object is not equivalent to the type code
	 ...
	 * get/set the value of the component currently accessed. The appropriate
	 * <code>insert</code> method can be called on the resulting
	 * <code>DynAny</code> object to initialize the component. The appropriate
	 * <code>get</code> method can be called on the resulting
	 * <code>DynAny</code> object to extract the value of the component.
	 *
	 * @return a <code>DynAny</code> object reference that can be used to
	 *         retrieve or set the value of the component currently accessed
	 */
	public org.omg.CORBA.DynAny current_component();

	/**
	 * Moves to the next component of this <code>DynAny</code> object. This
	 * method is used for iterating through the components of a constructed
	 * type, effectively moving a pointer from one component to the next. The
	 * pointer starts out on the first component when a <code>DynAny</code>
	 * object is created.
	 *
	 * @return <code>true</code> if the pointer points to a component;
	 *         <code>false</code> if there are no more components or this
	 *         <code>DynAny</code> is associated with a basic type rather than a
	 *         constructed type
	 */
	public boolean next();
