...
/**
 * Exception thrown when a parameter passed to a call is out of range or
 * otherwise considered illegal. An ORB may raise this exception if null values
 * or null pointers are passed to an operation (for language mappings where the
 * concept of a null pointers or null values applies). BAD_PARAM can also be
 * raised as a result of a client generating requests with incorrect parameters
 * using the DII.
 * <P>
 ...
 * @see <A href=
 *      "../../../../technotes/guides/idl/jidlExceptions.html#minorcodemeanings">
 *      meaning of minor codes</A>
 * @since JDK1.2
 */
...
public final class BAD_PARAM extends SystemException {
	...
	/**
	 * Constructs a <code>BAD_PARAM</code> exception with a default minor code
	...
	/**
	 * Constructs a <code>BAD_PARAM</code> exception with the specified minor
	...
	/**
	 * Constructs a <code>BAD_PARAM</code> exception with the specified detail
	 * message, minor code, and completion status. A detail message is a
