...
/**
 * The Holder for <tt>Any</tt>. For more information on Holder files, see
 * <a href="doc-files/generatedfiles.html#holder">
 * "Generated Files: Holder Files"</a>.
 * <P>
 * A Holder class for <code>Any</code> objects that is used to store "out" and
 * "inout" parameters in IDL methods. If an IDL method signature has an IDL
 * <code>any</code> as an "out" or "inout" parameter, the programmer must pass
 * an instance of <code>AnyHolder</code> as the corresponding parameter in the
 ...
 * the server.
 * <P>
 * If <code>myAnyHolder</code> is an instance of <code>AnyHolder</code>, the
