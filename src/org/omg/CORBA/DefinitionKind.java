 ...
 * those that are an <code>int</code> and those that are an instance of the
 * class <code>DefinitionKind</code>. This class provides the method
 * <code>from_int</code>, which given one of the <code>int</code> constants,
 * creates the corresponding <code>DefinitionKind</code> instance. It also
 * provides the method <code>value</code>, which returns the <code>int</code>
 * constant that is the value for a <code>DefinitionKind</code> instance.
 *
 * @see IRObject
 */
...
public class DefinitionKind implements org.omg.CORBA.portable.IDLEntity {
    ...
    /**
     * The constant that indicates that an Interface Repository object does not
     * have a definition kind.
     */
    public static final int _dk_none = 0,

            /**
             * The constant that indicates that the type of an Interface
             * Repository object may be any type.
             */
            _dk_all = 1,
    ...
    /**
     * The wildcard <code>DefinitionKind</code> constant, useful in all
     * occasions where any <code>DefinitionKind</code> is appropriate. The
     * Container's <code>contents</code> method makes use of this constant to
     * return all contained definitions of any kind.
     */
    ...
    /**
     * Creates a <code>DefinitionKind</code> instance corresponding to the given
     * code .
     * 
     * @param i
     ...
     *         if the given parameter is not one of the <code>int</code>
     *         constants from the class <code>DefinitionKind</code>
     */
    ...
    /**
     * Constructs a <code>DefinitionKind</code> object with its
