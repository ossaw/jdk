...
/**
 * The Holder for <tt>TypeCode</tt>. For more information on Holder files, see
 * <a href="doc-files/generatedfiles.html#holder">
 * "Generated Files: Holder Files"</a>.
 * <P>
 * A Holder class for a <code>TypeCode</code> object that is used to store "out"
 * and "inout" parameters in IDL operations. If an IDL operation signature has
 * an IDL <code>TypeCode</code> as an "out" or "inout" parameter, the programmer
 * must pass an instance of <code>TypeCodeHolder</code> as the corresponding
 * parameter in the method invocation; for "inout" parameters, the programmer
 * must also fill the "in" value to be sent to the server. Before the method
 * invocation returns, the ORB will fill in the value corresponding to the "out"
 * value returned from the server.
 * <P>
 * If <code>myTypeCodeHolder</code> is an instance of
 * <code>TypeCodeHolder</code>, the value stored in its <code>value</code> field
 * can be accessed with <code>myTypeCodeHolder.value</code>.
 *
 * @since JDK1.2
 */
