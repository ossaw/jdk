...
/**
 * The CORBA <code>WrongTransaction</code> user-defined exception. This
 * exception is thrown only by the methods <code>Request.get_response</code> and
 * <code>ORB.get_next_response</code> when they are invoked from a transaction
 * scope that is different from the one in which the client originally sent the
 * request. See the OMG Transaction Service Specification for details.
 *
