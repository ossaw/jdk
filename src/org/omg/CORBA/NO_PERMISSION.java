...
/**
 * Exception thrown when an invocation failed because the caller has
...
public final class NO_PERMISSION extends SystemException {
	/**
	 * Constructs a <code>NO_PERMISSION</code> exception with a default minor
	 * code of 0 and a completion state of CompletionStatus.COMPLETED_NO, and a
	 * null description.
	 */
