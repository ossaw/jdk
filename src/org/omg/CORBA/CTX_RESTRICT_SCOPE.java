 ...
 * <code>Context.get_values</code> to restrict the search scope. When this flag
 * is used, it restricts the search for context values to this particular
 * <code>Context</code> object or to the scope specified in the first parameter
 * to <code>Context.get_values</code>.
 * <P>
 * Usage:
 * 
 * <PRE>
