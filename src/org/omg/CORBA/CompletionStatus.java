 ...
 * <P>
 * The class <code>CompletionStatus</code> contains three
 * <code>CompletionStatus</code> instances, which are constants representing
 * each possible completion status: <code>COMPLETED_MAYBE</code>,
 * <code>COMPLETED_NO</code>, and <code>COMPLETED_YES</code>. It also contains
 * three <code>int</code> members, each a constant corresponding to one of the
 * <code>CompletionStatus</code> instances. These <code>int</code> members make
 * it possible to use a <code>switch</code> statement.
 * <P>
 ...
 * <bold>from_int</bold>(int i)</code> -- for creating an instance from one of
 * the <code>int</code> members
 * </UL>
 * 
