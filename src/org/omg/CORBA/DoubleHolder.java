 ...
 * <P>
 * A Holder class for a <code>double</code> that is used to store "out" and
 * "inout" parameters in IDL methods. If an IDL method signature has an IDL
 * <code>double</code> as an "out" or "inout" parameter, the programmer must
 * pass an instance of <code>DoubleHolder</code> as the corresponding parameter
