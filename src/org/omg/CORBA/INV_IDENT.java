 ...
 * may be raised if, for example, an identifier passed to the interface
...
public final class INV_IDENT extends SystemException {
    /**
     * Constructs an <code>INV_IDENT</code> exception with a default minor code
    ...
    /**
     * Constructs an <code>INV_IDENT</code> exception with the specified minor
     * code and completion status.
     * 
     * @param minor
     *                  the minor code
     * @param completed
     *                  a <code>CompletionStatus</code> object indicating the
     *                  completion status
     */
