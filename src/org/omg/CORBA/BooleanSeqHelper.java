...
/**
 * The Helper for <tt>BooleanSeq</tt>. For more information on Helper files, see
 * <a href="doc-files/generatedfiles.html#helper">
 * "Generated Files: Helper Files"</a>.
 * <P>
 * org/omg/CORBA/BooleanSeqHelper.java Generated by the IDL-to-Java compiler
...
public abstract class BooleanSeqHelper {
    ...
    synchronized public static org.omg.CORBA.TypeCode type() {
        if (__typeCode == null) {
            ...
            __typeCode = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CORBA.BooleanSeqHelper.id(),
                    "BooleanSeq", __typeCode);
        }
        return __typeCode;
    }
