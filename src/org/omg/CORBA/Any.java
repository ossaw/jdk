...
/**
 * Serves as a container for any data that can be described in IDL or for any
 * IDL primitive type. An <code>Any</code> object is used as a component of a
 * <code>NamedValue</code> object, which provides information about arguments or
 ...
 * <OL>
 * <LI>a data value
 * <LI>a <code>TypeCode</code> object describing the type of the data value
 * contained in the <code>Any</code> object. For example, a
 * <code>TypeCode</code> object for an array contains a field for the length of
 * the array and a field for the type of elements in the array. (Note that in
 ...
 * <dd>This method allows the insertion of an instance <code>x</code> of
 * primitive type <code>X</code> into the <code>value</code> field of the
 * <code>Any</code> object. Note that the method <code>insert_X</code> also
 * resets the <code>Any</code> object's <code>type</code> field if necessary.
 * <dt><code><bold>X extract_X()</bold></code>
 * <dd>This method allows the extraction of an instance of type <code>X</code>
 * from the <code>Any</code> object. <BR>
 * <P>
 * This method throws the exception <code>BAD_OPERATION</code> under two
 * conditions:
 * <OL>
 * <LI>the type of the element contained in the <code>Any</code> object is not
 * <code>X</code>
 * <LI>the method <code>extract_X</code> is called before the <code>value</code>
 * field of the <code>Any</code> object has been set
 * </OL>
 * </dl>
 * <P>
 * There are distinct method pairs for each primitive IDL data type (
 * <code>insert_long</code> and <code>extract_long</code>,
 * <code>insert_string</code> and <code>extract_string</code>, and so on).<BR>
 * <P>
 * The class <code>Any</code> also has methods for getting and setting the type
 * code, for testing two <code>Any</code> objects for equality, and for reading
 * an <code>Any</code> object from a stream or writing it to a stream. <BR>
 * 
 * @since JDK1.2
 */
abstract public class Any implements IDLEntity {
	...
	/**
	 * Checks for equality between this <code>Any</code> object and the given
	 * <code>Any</code> object. Two <code>Any</code> objects are equal if both
	...
	/**
	 * Sets this <code>Any</code> object's <code>type</code> field to the given
	 * <code>TypeCode</code> object and clears its value.
	 * <P>
	 * Note that using this method to set the type code wipes out the value if
	 * there is one. The method is provided primarily so that the type may be
	 * set properly for IDL <code>out</code> parameters. Generally, setting the
	 * type is done by the <code>insert_X</code> methods, which will set the
	...
	/**
	 * Reads off (unmarshals) the value of an <code>Any</code> object from the
	 ...
	 *                consistent with the value that was contained in the input
	 *                stream
	 */
	abstract public void read_value(InputStream is, TypeCode t) throws MARSHAL;

	/**
	 * Writes out the value of this <code>Any</code> object to the given output
	 * stream. If both <code>typecode</code> and <code>value</code> need to be
	 * written, use <code>create_output_stream()</code> to create an
	 * <code>OutputStream</code>, then use <code>write_any</code> on the
	 * <code>OutputStream</code>.
	 * <P>
	 * If this method is called on an <code>Any</code> object that has not had a
	 * value inserted into its <code>value</code> field, it will throw the
	...
	/**
	 * Creates an output stream into which this <code>Any</code> object's value
	 * can be marshalled.
	 *
	...
	/**
	 * Extracts the <code>short</code> in this <code>Any</code> object's
	 * <code>value</code> field.
	 *
	 * @return the <code>short</code> stored in this <code>Any</code> object
	 * @exception BAD_OPERATION
	 *                if this <code>Any</code> object contains something other
	 *                than a <code>short</code> or the <code>value</code> field
	 *                has not yet been set
	 */
	abstract public short extract_short() throws BAD_OPERATION;

	/**
	 * Inserts the given <code>short</code> into this <code>Any</code> object's
	 * <code>value</code> field.
	 *
	 * @param s
	...
	/**
	 * Extracts the <code>int</code> in this <code>Any</code> object's
	 * <code>value</code> field.
	 *
	 * @return the <code>int</code> stored in this <code>Any</code> object
	 * @exception BAD_OPERATION
	 *                if this <code>Any</code> object contains something other
	 *                than an <code>int</code> or the <code>value</code> field
	 *                has not yet been set
	 */
	abstract public int extract_long() throws BAD_OPERATION;

	/**
	 * Inserts the given <code>int</code> into this <code>Any</code> object's
	 * <code>value</code> field.
	 *
	 * @param l
	...
	/**
	 * Extracts the <code>long</code> in this <code>Any</code> object's
	 * <code>value</code> field.
	 *
	 * @return the <code>long</code> stored in this <code>Any</code> object
	 * @exception BAD_OPERATION
	 *                if this <code>Any</code> object contains something other
	 *                than a <code>long</code> or the <code>value</code> field
	 *                has not yet been set
	 */
	abstract public long extract_longlong() throws BAD_OPERATION;

	/**
	 * Inserts the given <code>long</code> into this <code>Any</code> object's
	 * <code>value</code> field.
	 *
	 * @param l
	...
	/**
	 * Extracts the <code>float</code> in this <code>Any</code> object's
	 * <code>value</code> field.
	 *
	 * @return the <code>float</code> stored in this <code>Any</code> object
	 * @exception BAD_OPERATION
	 *                if this <code>Any</code> object contains something other
	 *                than a <code>float</code> or the <code>value</code> field
	 *                has not yet been set
	 */
	abstract public float extract_float() throws BAD_OPERATION;

	/**
	 * Inserts the given <code>float</code> into this <code>Any</code> object's
	 * <code>value</code> field.
	 *
	 * @param f
	...
	/**
	 * Extracts the <code>double</code> in this <code>Any</code> object's
	 * <code>value</code> field.
	 *
	 * @return the <code>double</code> stored in this <code>Any</code> object
	 * @exception BAD_OPERATION
	 *                if this <code>Any</code> object contains something other
	 *                than a <code>double</code> or the <code>value</code> field
	 *                has not yet been set
	 */
	abstract public double extract_double() throws BAD_OPERATION;

	/**
	 * Inserts the given <code>double</code> into this <code>Any</code> object's
	 * <code>value</code> field.
	 *
	 * @param d
	...
	/**
	 * Extracts the <code>boolean</code> in this <code>Any</code> object's
	 * <code>value</code> field.
	 *
	 * @return the <code>boolean</code> stored in this <code>Any</code> object
	 * @exception BAD_OPERATION
	 *                if this <code>Any</code> object contains something other
	 *                than a <code>boolean</code> or the <code>value</code>
	 *                field has not yet been set
	 */
	abstract public boolean extract_boolean() throws BAD_OPERATION;

	/**
	 * Inserts the given <code>boolean</code> into this <code>Any</code>
	...
	/**
	 * Extracts the <code>char</code> in this <code>Any</code> object's
	 * <code>value</code> field.
	 *
	 * @return the <code>char</code> stored in this <code>Any</code> object
	 * @exception BAD_OPERATION
	 *                if this <code>Any</code> object contains something other
	 *                than a <code>char</code> or the <code>value</code> field
	 *                has not yet been set
	 */
	abstract public char extract_char() throws BAD_OPERATION;

	/**
	 * Inserts the given <code>char</code> into this <code>Any</code> object's
	 * <code>value</code> field.
	 *
	 * @param c
	...
	/**
	 * Extracts the <code>byte</code> in this <code>Any</code> object's
	 * <code>value</code> field.
	 *
	 * @return the <code>byte</code> stored in this <code>Any</code> object
	 * @exception BAD_OPERATION
	 *                if this <code>Any</code> object contains something other
	 *                than a <code>byte</code> or the <code>value</code> field
	 *                has not yet been set
	 */
	abstract public byte extract_octet() throws BAD_OPERATION;

	/**
	 * Inserts the given <code>byte</code> into this <code>Any</code> object's
	 * <code>value</code> field.
	 *
	 * @param b
	...
	/**
	 * Extracts the <code>Any</code> object in this <code>Any</code> object's
	 * <code>value</code> field.
	 *
	 ...
	 * @exception BAD_OPERATION
	 *                if this <code>Any</code> object contains something other
	 *                than an <code>Any</code> object or the <code>value</code>
	 *                field has not yet been set
	 */
	abstract public Any extract_any() throws BAD_OPERATION;

	/**
	 * Inserts the given <code>Any</code> object into this <code>Any</code>
	 * object's <code>value</code> field.
	 *
	 * @param a
	...
	/**
	 * Extracts the <code>org.omg.CORBA.Object</code> in this <code>Any</code>
	 * object's <code>value</code> field.
	 *
	 ...
	 * @exception BAD_OPERATION
	 *                if this <code>Any</code> object contains something other
	 *                than a <code>java.io.Serializable</code> object or the
	 *                <code>value</code> field has not yet been set
	 */
	abstract public java.io.Serializable extract_Value() throws BAD_OPERATION;

	/**
	 * Inserts the given <code>java.io.Serializable</code> object into this
	 * <code>Any</code> object's <code>value</code> field.
	 *
	 * @param v
	 ...
	 * @exception BAD_OPERATION
	 *                if this method is invalid for this <code>Any</code> object
	 *
	 */
	...
	/**
	 * Inserts the given <code>String</code> object into this <code>Any</code>
	 * object's <code>value</code> field.
	 *
	 * @param s
	...
	/**
	 * Extracts the <code>TypeCode</code> object in this <code>Any</code>
	 * object's <code>value</code> field.
	 *
	...
	/**
	 * Inserts the given <code>TypeCode</code> object into this <code>Any</code>
	 * object's <code>value</code> field.
	 *
	 * @param t
	...
	/**
	 * Extracts the <code>Principal</code> object in this <code>Any</code>
	 * object's <code>value</code> field. Note that the class
	...
	/**
	 * Inserts the given <code>Principal</code> object into this
	 * <code>Any</code> object's <code>value</code> field. Note that the class
	 * <code>Principal</code> has been deprecated.
	 *
	 * @param p
	 ...
	 *             if the caller has invoked operations in the wrong order
	 * @see <a href="package-summary.html#unimpl"><code>CORBA</code> package
	 *      comments for unimplemented features</a>
	 */
	...
	/**
	 * Inserts the given <code>Streamable</code> object into this
	 * <code>Any</code> object's <code>value</code> field. This method allows
	 ...
	 * @exception BAD_OPERATION
	 *                if this <code>Any</code> object contains something other
	 *                than a <code>java.math.BigDecimal</code> object or the
	 *                <code>value</code> field has not yet been set
	 * @see <a href="package-summary.html#unimpl"><code>CORBA</code> package
	 *      comments for unimplemented features</a>
	 */
	 ...
	 * <P>
	 * Inserts the given <code>java.math.BigDecimal</code> object into this
	 * <code>Any</code> object's <code>value</code> field.
	 *
	 * @param value
