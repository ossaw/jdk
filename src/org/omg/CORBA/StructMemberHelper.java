...
/**
 * The Helper for <tt>StructMember</tt>. For more information on Helper files,
 * see <a href="doc-files/generatedfiles.html#helper">
 * "Generated Files: Helper Files"</a>.
 * <P>
 * org/omg/CORBA/StructMemberHelper.java Generated by the IDL-to-Java compiler
        ...
        if (__typeCode == null) {
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    __typeCode = org.omg.CORBA.ORB.init().create_struct_tc(org.omg.CORBA.StructMemberHelper
                            .id(), "StructMember", _members0);
                    __active = false;
                }
            }
        }
