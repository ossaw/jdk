 ...
 * run time. For example, an ORB may reach the maximum number of references it
 * can hold simultaneously in an address space, the size of a parameter may have
...
public final class IMP_LIMIT extends SystemException {
    /**
     * Constructs an <code>IMP_LIMIT</code> exception with a default minor code
    ...
    /**
     * Constructs an <code>IMP_LIMIT</code> exception with the specified minor
