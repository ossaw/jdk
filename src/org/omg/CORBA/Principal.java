...
/**
 * A class that contains information about the identity of the client, for
 * access control and other purposes. It contains a single attribute, the name
 * of the <code>Principal</code>, encoded as a sequence of bytes.
 * <P>
 * 
