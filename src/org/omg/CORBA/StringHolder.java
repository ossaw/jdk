...
/**
 * The Holder for <tt>String</tt>. For more information on Holder files, see
 * <a href="doc-files/generatedfiles.html#holder">
 * "Generated Files: Holder Files"</a>.
 * <P>
 * A Holder class for a <code>String</code> that is used to store "out" and
 * "inout" parameters in IDL operations. If an IDL operation signature has an
 * IDL <code>string</code> as an "out" or "inout" parameter, the programmer must
 * pass an instance of <code>StringHolder</code> as the corresponding parameter
 * in the method invocation; for "inout" parameters, the programmer must also
 * fill the "in" value to be sent to the server. Before the method invocation
