...
/**
 * The Stub for <tt>Policy</tt>. For more information on Stub files, see
 * <a href="doc-files/generatedfiles.html#stub"> "Generated Files: Stubs"</a>.
 * <P>
 * org/omg/CORBA/_PolicyStub.java Generated by the IDL-to-Java compiler
...
public class _PolicyStub extends org.omg.CORBA.portable.ObjectImpl implements org.omg.CORBA.Policy {
	...
	/**
	 * Constructs a <code>_PolicyStub</code> object initialized with the given
	 ...
	 * object. The values of the polivy objectys are allocated by the OMG. New
	...
	/**
	 * Copies the policy object. The copy does not retain any relationships that
	...
	/**
	 * Destroys the policy object. It is the responsibility of the policy object
	 * to determine whether it can be destroyed.
	 */
	public void destroy() {
		org.omg.CORBA.portable.InputStream _in = null;
		try {
