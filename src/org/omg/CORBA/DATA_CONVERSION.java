...
/**
 * This exception is raised if an ORB cannot convert the representation of data
 * as marshaled into its native representation or vice-versa. For example,
 * DATA_CONVERSION can be raised if wide character codeset conversion fails, or
 * if an ORB cannot convert floating point values between different
 * representations.
 * <P>
 ...
 * meaning of minor codes</A> to see the minor codes for this exception.
 *
...
public final class DATA_CONVERSION extends SystemException {
	...
	/**
	 * Constructs a <code>DATA_CONVERSION</code> exception with a default minor
