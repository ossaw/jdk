 ...
 * code, allowing more detailed specification, and a completion status. This
 * class is subclassed to generate each one of the set of standard ORB
 * exceptions. <code>SystemException</code> extends
 * <code>java.lang.RuntimeException</code>; thus none of the
 * <code>SystemException</code> exceptions need to be declared in signatures of
 * the Java methods mapped from operations in IDL interfaces.
 *
