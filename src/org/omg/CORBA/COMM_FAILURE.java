...
public final class COMM_FAILURE extends SystemException {
	...
	/**
	 * Constructs a <code>COMM_FAILURE</code> exception with a default minor
	 ...
	 * detail message, a minor code of 0, and a completion state of
	 * COMPLETED_NO.
	 *
	 * @param s
	...
	/**
	 * Constructs a <code>COMM_FAILURE</code> exception with the specified minor
