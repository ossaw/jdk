 ...
 * initialization, such as failure to acquire networking resources or detecting
...
public final class INITIALIZE extends SystemException {
	/**
	 * Constructs an <code>INITIALIZE</code> exception with a default minor code
	 * of 0 and a completion state of <code>CompletionStatus.COMPLETED_NO</code>
	 * .
	 */
	public INITIALIZE() {
		this("");
	...
	/**
	 * Constructs an <code>INITIALIZE</code> exception with the specified minor
	 ...
	 *            completion status of the method that threw this exception
	 */
