 ...
 * <P>
 * FixedHolder is a container class for values of IDL type "fixed", which is
 * mapped to the Java class java.math.BigDecimal. It is usually used to store
 * "out" and "inout" IDL method parameters. If an IDL method signature has a
 * fixed as an "out" or "inout" parameter, the programmer must pass an instance
 * of FixedHolder as the corresponding parameter in the method invocation; for
