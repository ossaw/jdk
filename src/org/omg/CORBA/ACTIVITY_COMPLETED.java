 ...
 * method for which Activity context is accessed. It indicates that the Activity
 * context in which the method call was made has been completed due to a timeout
 * of either the Activity itself or a transaction that encompasses the Activity,
 * or that the Activity completed in a manner other than that originally
 * requested.
 *
...
public final class ACTIVITY_COMPLETED extends SystemException {
	...
	/**
	 * Constructs an <code>ACTIVITY_COMPLETED</code> exception with minor code
