...
/**
 * Exception thrown when an object reference denotes an existing object, but
 * that the object does not support the operation that was invoked.
 * <P>
...
public final class BAD_OPERATION extends SystemException {
    ...
    /**
     * Constructs a <code>BAD_OPERATION</code> exception with a default minor
