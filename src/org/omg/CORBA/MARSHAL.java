 ...
 * ORB raises this exception. <tt>MARSHAL</tt> can also be caused by using the
 * DII or DSI incorrectly, for example, if the type of the actual parameters
...
public final class MARSHAL extends SystemException {
    /**
     * Constructs a <code>MARSHAL</code> exception with a default minor code of
    ...
    /**
     * Constructs a <code>MARSHAL</code> exception with the specified minor code
