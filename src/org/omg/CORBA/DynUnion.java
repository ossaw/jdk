 ...
 * that is associated with an IDL union. Union values can be traversed using the
 * operations defined in <code>DynAny</code>. The first component in the union
 * corresponds to the discriminator; the second corresponds to the actual value
 * of the union. Calling the method <code>next()</code> twice allows you to
 * access both components.
 * 
 * @deprecated Use the new <a href="../DynamicAny/DynUnion.html">DynUnion</a>
 *             instead
 */
@Deprecated
