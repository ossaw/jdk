...
/**
 * The Stub for <tt>IDLType</tt>. For more information on Stub files, see
 * <a href="doc-files/generatedfiles.html#stub"> "Generated Files: Stubs"</a>.
 * <P>
 * org/omg/CORBA/_IDLTypeStub.java Generated by the IDL-to-Java compiler
 * (portable), version "3.0" from ir.idl. 03 June 1999 11:33:44 o'clock
 * GMT+00:00
 */
...
public class _IDLTypeStub extends org.omg.CORBA.portable.ObjectImpl implements
     ...
     * <code>_set_delegate</code> has been called.
     */
    // NOTE: This constructor is not required according to the spec. Only JCK
    // expects it now.
    public _IDLTypeStub() {
        super();
    }
    ...
    /**
     * Constructs an <code>_IDLTypeStub</code> object initialized with the given
    ...
    private static String[] __ids = { "IDL:omg.org/CORBA/IDLType:1.0",
