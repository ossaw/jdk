...
/**
 * The Helper for <tt>CharSeq</tt>. For more information on Helper files, see
 * <a href="doc-files/generatedfiles.html#helper">
 * "Generated Files: Helper Files"</a>.
 * <P>
 * org/omg/CORBA/CharSeqHelper.java Generated by the IDL-to-Java compiler
...
public abstract class CharSeqHelper {
    ...
    synchronized public static org.omg.CORBA.TypeCode type() {
        if (__typeCode == null) {
            ...
            __typeCode = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CORBA.CharSeqHelper.id(), "CharSeq",
                    __typeCode);
        }
        return __typeCode;
    }
