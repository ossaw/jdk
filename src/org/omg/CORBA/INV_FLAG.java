...
/**
 * Exception thrown when an invalid flag was passed to an operation (for
 * example, when creating a DII request).
 * <P>
...
public final class INV_FLAG extends SystemException {
	/**
	 * Constructs an <code>INV_FLAG</code> exception with a default minor code
	...
	/**
	 * Constructs an <code>INV_FLAG</code> exception with the specified minor
