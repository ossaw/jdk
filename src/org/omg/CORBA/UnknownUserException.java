 ...
 * uses the DII to make an invocation, any user exception returned from the
 * server is enclosed in an <code>Any</code> object contained in the
 * <code>UnknownUserException</code> object. This is available from the
 * <code>Environment</code> object returned by the method
...
public final class UnknownUserException extends UserException {
    ...
    /**
     * The <code>Any</code> instance that contains the actual user exception
    ...
    /**
     * Constructs an <code>UnknownUserException</code> object that contains the
