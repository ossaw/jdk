...
/**
 * The Helper for <tt>DoubleSeq</tt>. For more information on Helper files, see
 * <a href="doc-files/generatedfiles.html#helper">
 * "Generated Files: Helper Files"</a>.
 * <P>
 * org/omg/CORBA/DoubleSeqHelper.java Generated by the IDL-to-Java compiler
...
public abstract class DoubleSeqHelper {
    ...
    synchronized public static org.omg.CORBA.TypeCode type() {
        if (__typeCode == null) {
            ...
            __typeCode = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CORBA.DoubleSeqHelper.id(),
                    "DoubleSeq", __typeCode);
        }
        return __typeCode;
    }
