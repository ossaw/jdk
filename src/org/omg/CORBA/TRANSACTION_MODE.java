...
/**
 * The CORBA <code>TRANSACTION_MODE</code> exception is thrown by the client ORB
 * if it detects a mismatch between the InvocationPolicy in the IOR and the
 * chosen invocation path (i.e, direct or routed invocation). It contains a
 * minor code, which gives information about what caused the exception, and a
 * completion status. It may also contain a string describing the exception. The
 * OMG CORBA core 2.4 specification has details.
 *
...
public final class TRANSACTION_MODE extends SystemException {
	/**
	 * Constructs a <code>TRANSACTION_MODE</code> exception with a default minor
	 * code of 0, a completion state of CompletionStatus.COMPLETED_NO, and a
	 * null description.
	 */
