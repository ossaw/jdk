...
/**
 * The representation of a <code>DynAny</code> object that is associated with an
 * IDL value type.
 * 
 * @deprecated Use the new <a href="../DynamicAny/DynValue.html">DynValue</a>
 *             instead
 */
@Deprecated
public interface DynValue extends org.omg.CORBA.Object, org.omg.CORBA.DynAny {
    ...
    /**
     * Returns an array containing all the members of the value object stored in
     * this <code>DynValue</code>.
     *
    ...
    /**
     * Sets the members of the value object this <code>DynValue</code> object
     * represents to the given array of <code>NameValuePair</code> objects.
     *
     * @param value
     *        the array of name-value pairs to be set
