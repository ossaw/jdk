 ...
 * the argument is being passed from the server to the client.
 * <code>ARG_OUT.value</code> is one of the possible values used to indicate the
 * direction in which a parameter is being passed during a dynamic invocation
