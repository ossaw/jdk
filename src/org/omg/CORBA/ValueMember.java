...
/**
 * A description in the Interface Repository of a member of a <code>value</code>
 * object.
 */
public final class ValueMember implements org.omg.CORBA.portable.IDLEntity {
	...
	/**
	 * The repository ID of the <code>value</code> member described by this
	 * <code>ValueMember</code> object;
	 * 
	 * @serial
	 */
	...
	/**
	 * The repository ID of the <code>value</code> in which this member is
	 * defined.
	 * 
	 * @serial
	 */
	...
	/**
	 * The typedef that represents the IDL type of the <code>value</code> member
	 * described by this <code>ValueMember</code> object.
	 * 
	 * @serial
	 */
	...
	/**
	 * The type of access (public, private) for the <code>value</code> member
	 * described by this <code>ValueMember</code> object.
	 * 
	 * @serial
	 */
	...
	/**
	 * Constructs a <code>ValueMember</code> object initialized with the given
	 * values.
	 *
	 * @param __name
	 *            The name of the <code>value</code> member described by this
	 *            <code>ValueMember</code> object.
	 * @param __id
	 *            The repository ID of the <code>value</code> member described
	 *            by this <code>ValueMember</code> object;
	 * @param __defined_in
	 *            The repository ID of the <code>value</code> in which this
	 *            member is defined.
	 * @param __version
	 *            The version of the <code>value</code> in which this member is
	 *            defined.
	 * @param __type
	 *            The type of of this <code>value</code> member.
	 * @param __type_def
