 ...
 * the operation's raises expression. UNKNOWN is also raised if the server
 * returns a system exception that is unknown to the client. (This can happen if
 * the server uses a later version of CORBA than the client and new system
 ...
 * <P>
 * See the section <A href=
 * "../../../../technotes/guides/idl/jidlExceptions.html#minorcodemeanings">
 * Minor Code Meanings</A> to see the minor codes for this exception.
 *
...
public final class UNKNOWN extends SystemException {
    /**
     * Constructs an <code>UNKNOWN</code> exception with a default minor code of
     * 0, a completion state of CompletionStatus.COMPLETED_NO, and a null
     * description.
     */
    public UNKNOWN() {
        this("");
    ...
    /**
     * Constructs an <code>UNKNOWN</code> exception with the specified minor
