...
/**
 * The Holder for <tt>Principal</tt>. For more information on Holder files, see
 * <a href="doc-files/generatedfiles.html#holder">
 * "Generated Files: Holder Files"</a>.
 * <P>
 * A container class for values of type <code>Principal</code> that is used to
 * store "out" and "inout" parameters in IDL methods. If an IDL method signature
 * has an IDL <code>Principal</code> as an "out" or "inout" parameter, the
 * programmer must pass an instance of <code>PrincipalHolder</code> as the
 ...
 * method invocation returns, the ORB will fill in the value corresponding to
 * the "out" value returned from the server.
 * <P>
 * If <code>myPrincipalHolder</code> is an instance of
 * <code>PrincipalHolder</code>, the value stored in its <code>value</code>
 * field can be accessed with <code>myPrincipalHolder.value</code>.
 *
 * @since JDK1.2
