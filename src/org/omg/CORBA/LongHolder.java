...
/**
 * The Holder for <tt>Long</tt>. For more information on Holder files, see
 * <a href="doc-files/generatedfiles.html#holder">
 * "Generated Files: Holder Files"</a>.
 * <P>
 * A Holder class for a <code>long</code> that is used to store "out" and
 * "inout" parameters in IDL methods. If an IDL method signature has an IDL
 * <code>long long</code> as an "out" or "inout" parameter, the programmer must
 * pass an instance of <code>LongHolder</code> as the corresponding parameter in
 * the method invocation; for "inout" parameters, the programmer must also fill
 * the "in" value to be sent to the server. Before the method invocation
 * returns, the ORB will fill in the value corresponding to the "out" value
 * returned from the server.
 * <P>
 * If <code>myLongHolder</code> is an instance of <code>LongHolder</code>, the
 * value stored in its <code>value</code> field can be accessed with
