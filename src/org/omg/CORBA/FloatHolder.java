...
/**
 * The Holder for <tt>Float</tt>. For more information on Holder files, see
 * <a href="doc-files/generatedfiles.html#holder">
 * "Generated Files: Holder Files"</a>.
 * <P>
 * A Holder class for a <code>float</code> that is used to store "out" and
 * "inout" parameters in IDL methods. If an IDL method signature has an IDL
 * <code>float</code> as an "out" or "inout" parameter, the programmer must pass
 * an instance of <code>FloatHolder</code> as the corresponding parameter in the
 ...
 * the server.
 * <P>
 * If <code>myFloatHolder</code> is an instance of <code>FloatHolder</code>, the
