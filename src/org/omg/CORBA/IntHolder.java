...
/**
 * The Holder for <tt>Int</tt>. For more information on Holder files, see
 * <a href="doc-files/generatedfiles.html#holder">
 * "Generated Files: Holder Files"</a>.
 * <P>
 * A Holder class for an <code>int</code> that is used to store "out" and
 * "inout" parameters in IDL methods. If an IDL method signature has an IDL
 * <code>long</code> as an "out" or "inout" parameter, the programmer must pass
 * an instance of <code>IntHolder</code> as the corresponding parameter in the
 ...
 * the server.
 * <P>
 * If <code>myIntHolder</code> is an instance of <code>IntHolder</code>, the
