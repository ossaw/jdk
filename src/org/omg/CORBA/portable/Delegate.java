...
public abstract class Delegate {
     ...
     * @param ctxlist
     *        A list of context strings that need to be resolved and
     *        sent
     *        with the Request.
     * @return The created Request object.
     */
     ...
     *        otheroverrides that already exist (ADD_OVERRIDE) in the
     *        object
     *        reference, or they should be added to a clean override
     *        free
     ...
     *        delegate.
     * @param operation
     *        a string containing the operation name. The
     *        operation name
     *        corresponds to the operation name as it would be
     *        encoded in a
     *        GIOP request.
     ...
     *         thrown when implementation throws (upon
     *         invocation) an
     *         exception defined as part of its remote
     *         method definition.
