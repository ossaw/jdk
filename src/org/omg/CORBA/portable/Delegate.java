 ...
 *
 * Each stub (proxy) contains a delegate object, to which all
 * org.omg.CORBA.Object methods are forwarded. This allows a stub generated by
...
public abstract class Delegate {
	 ...
	 *            The object reference which delegated to this delegate.
	 * @param max
	 *            specifies an upper bound on the hash value returned by the
	 *            ORB.
	 ...
	 *            The object reference which delegated to this delegate.
	 * @param operation
	 *            The name of the operation to be invoked using the Request
	 *            instance.
	 ...
	 * @param arg_list
	 *            The arguments to the operation in the form of an NVList.
	 * @param result
	 *            A container for the result as a NamedValue.
	 * @return The created Request object.
	 *
	 */
	public abstract Request create_request(org.omg.CORBA.Object obj, Context ctx, String operation,
	 ...
	 *            A container for the result as a NamedValue.
	 * @param exclist
	 *            A list of possible exceptions the operation can throw.
	 * @param ctxlist
	 *            A list of context strings that need to be resolved and sent
	 *            with the Request.
	 * @return The created Request object.
	 */
	public abstract Request create_request(org.omg.CORBA.Object obj, Context ctx, String operation,
	 ...
	 *                raised when the value of policy type is not valid either
	 *                because the specified type is not supported by this ORB or
	 *                because a policy object of that type is not associated
	 *                with this Object.
	 * @see <a href="package-summary.html#unimpl"><code>portable</code> package
	 *      comments for unimplemented features</a>
	 */
	...
	/**
	 * Associates the policies passed in with a newly created object reference
	 * that it returns. Only certain policies that pertain to the invocation of
	 * an operation at the client end can be overridden using this operation.
	 ...
	 *            The object reference which delegated to this delegate.
	 * @param policies
	 *            A sequence of references to Policy objects.
	 * @param set_add
	 *            Indicates whether these policies should be added onto any
	 *            otheroverrides that already exist (ADD_OVERRIDE) in the object
	 *            reference, or they should be added to a clean override free
	 *            object reference (SET_OVERRIDE).
	 ...
	 *         does not support local stubs for this particular servant. The
	 *         default behavior of is_local() is to return false.
	 */
	 ...
	 * the expected type, and then invoke the operation directly. The
	 * ServantRequest object is valid for only one invocation, and cannot be
	 * used for more than one invocation.
	 *
	 * @param self
	 *            The object reference which delegated to this delegate.
	 *
	...
	/**
	 * servant_postinvoke() is invoked by the local stub after the operation has
	 * been invoked on the local servant. This method must be called if
	 * servant_preinvoke() returned a non-null value, even if an exception was
	 * thrown by the servant's method. For this reason, the call to
	 * servant_postinvoke() should be placed in a Java finally clause.
	 *
	 * @param self
	 *            The object reference which delegated to this delegate.
	 *
	 * @param servant
	 *            the instance of the ServantObject returned from the
	 *            servant_preinvoke() method.
	 */
	public void servant_postinvoke(org.omg.CORBA.Object self, ServantObject servant) {
	}

	/**
	 * request is called by a stub to obtain an OutputStream for marshaling
	 * arguments. The stub must supply the operation name, and indicate if a
	 * response is expected (i.e is this a oneway call).
	 *
	 * @param self
	 *            The object reference which delegated to this delegate.
	 * @param operation
	 ...
	 *            false if the operation is a one way operation, and true
	 *            otherwise.
	 * @return OutputStream the OutputStream into which request arguments can be
	 *         marshaled.
	 * @see <a href="package-summary.html#unimpl"><code>portable</code> package
	 *      comments for unimplemented features</a>
	 */
	 ...
	 * OutputStream that was previously returned by a request() call. invoke
	 * returns an InputStream which contains the marshaled reply. If an
	 * exception occurs, invoke may throw an ApplicationException object which
	 * contains an InputStream from which the user exception state may be
	 * unmarshaled.
	 *
	 * @param self
	 *            The object reference which delegated to this delegate.
	 ...
	 *             thrown when implementation throws (upon invocation) an
	 *             exception defined as part of its remote method definition.
	...
	/**
	 * releaseReply may optionally be called by a stub to release a reply stream
	 * back to the ORB when the unmarshaling has completed. The stub passes the
	 * InputStream returned by invoke() or
	 * ApplicationException.getInputStream(). A null value may also be passed to
	 * releaseReply, in which case the method is a noop.
	 *
	 * @param self
	 *            The object reference which delegated to this delegate.
	 * @param input
	...
	/**
	 * Provides the implementation to override the toString() method of the
	 * delegating CORBA object.
	 *
	 * @param self
	 *            the object reference that delegated to this delegate
	 * @return a <code>String</code> object that represents the object reference
	 *         that delegated to this <code>Delegate</code> object
	 */
	...
	/**
	 * Provides the implementation to override the hashCode() method of the
	 * delegating CORBA object.
	 *
	 * @param self
	 *            the object reference that delegated to this delegate
	 * @return an <code>int</code> that represents the hashcode for the object
	 *         reference that delegated to this <code>Delegate</code> object
	 */
