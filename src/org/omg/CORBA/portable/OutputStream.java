 ...
 * These methods are used by the ORB to marshal IDL types as well as to insert
 * IDL types into Anys. The <code>_array</code> versions of the methods can be
 * directly used to write sequences and arrays of IDL types.
 *
 * @since JDK1.2
 */
...
public abstract class OutputStream extends java.io.OutputStream {
	...
	/**
	 * Writes an array of unsigned CORBA longs (i.e. Java ints) on this output
	 * stream.
	 * 
	 * @param value
	 *            the array to be written.
	...
	/**
	 * Writes an array of CORBA longlongs (i.e. Java longs) on this output
	 * stream.
	 * 
	 * @param value
	 *            the array to be written.
	...
	/**
	 * Writes a CORBA context on this stream. The Context is marshaled as a
	 * sequence of strings. Only those Context values specified in the contexts
