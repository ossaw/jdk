 ...
 * high performance calls for collocated clients and servers (i.e. clients and
 * servers residing in the same Java VM). The local stub API is supported via
 * three additional methods on <code>ObjectImpl</code> and <code>Delegate</code>
 * . ORB vendors may subclass this class to return additional request state that
