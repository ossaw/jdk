...
/**
 * This class is used for reporting application level exceptions between ORBs
 * and stubs.
 */
...
public class ApplicationException extends Exception {
	 ...
	 * exception and an input stream from which the exception data can be read
	 * as its parameters.
	 * 
	 * @param id
	...
	/**
	 * Returns the CORBA repository ID of the exception without removing it from
	 * the exceptions input stream.
	 * 
