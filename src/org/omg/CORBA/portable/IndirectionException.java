 ...
 * an indirection that is in the process of being demarshaled. This can occur
 * when the ORB input stream calls the ValueHandler to demarshal an RMI value
 * whose state contains a recursive reference to itself. Because the top-level
