 ...
 * These methods are used by the ORB to unmarshal IDL types as well as to
 * extract IDL types out of Anys. The <code>_array</code> versions of the
 * methods can be directly used to read sequences and arrays of IDL types.
 *
 * @since JDK1.2
 */
...
public abstract class InputStream extends java.io.InputStream {
	...
	/**
	 * Reads a CORBA unsigned longlong (that is, Java long) value from this
	 * input stream.
	 *
	 * @return the <code>long</code> value read from this input stream
	 */
	 ...
	 * 
	 * @param value
	 *            returned array of octets (that is, bytes).
	 * @param offset
	 *            offset on the stream.
	 * @param length
	 *            length of buffer to read.
	...
	/**
	 * Reads an array of CORBA longs (that is, Java ints) from this input
	 * stream.
	 * 
	 * @param value
	 *            returned array of CORBA longs (that is, Java ints).
	 * @param offset
	 *            offset on the stream.
	 * @param length
	 *            length of buffer to read.
	...
	/**
	 * Reads an array of unsigned CORBA longs (that is, Java ints) from this
	 * input stream.
	 * 
	 * @param value
	 *            returned array of CORBA longs (that is, Java ints).
	 ...
	 * 
	 * @param value
	 *            returned array of CORBA longs (that is, Java longs).
	 * @param offset
	 *            offset on the stream.
	 * @param length
	 *            length of buffer to read.
	...
	/**
	 * Reads an array of unsigned CORBA longlongs (that is, Java longs) from
	 * this input stream.
	 * 
	 * @param value
	 *            returned array of CORBA longs (that is, Java longs).
	...
	/**
	 * Unmarshals an object and returns a CORBA Object, which is an instance of
	 * the class passed as its argument. This class is the stub class of the
	 * expected type.
	 *
	 * @param clz
	 *            The Class object for the stub class which corresponds to the
	 *            type that is statistically expected, or the Class object for
	 *            the RMI/IDL interface type that is statistically expected.
