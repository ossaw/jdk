...
/**
 * An object used in <code>Request</code> operations to describe the exceptions
 * that can be thrown by a method. It maintains a modifiable list of
 * <code>TypeCode</code>s of the exceptions.
 * <P>
 * The following code fragment demonstrates creating an
 ...
 * <P>
 * To add items to the list, you first create a <code>TypeCode</code> object for
 * the exception you want to include, using the <code>ORB</code> method
 * <code>create_exception_tc</code>. Then you use the <code>ExceptionList</code>
 * method <code>add</code> to add it to the list. The class
 * <code>ExceptionList</code> has a method for getting the number of
 * <code>TypeCode</code> objects in the list, and after items have been added,
 * it is possible to call methods for accessing or deleting an item at a
 * designated index.
 *
 * @since JDK1.2
 */
...
public abstract class ExceptionList {
    ...
    /**
     * Adds a <code>TypeCode</code> object describing an exception to this
     * <code>ExceptionList</code> object.
     *
     * @param exc
    ...
    /**
     * Removes the <code>TypeCode</code> object at the given index. Note that
     * the indices of all the <code>TypeCoded</code> objects following the one
