 ...
 * not an indication that an object does not exist. Instead, it simply means
 * that no further determination of an object's status was possible because it
 * could not be reached. This exception is raised if an attempt to establish a
...
public final class TRANSIENT extends SystemException {
	 ...
	 * of 0, a completion state of CompletionStatus.COMPLETED_NO, and a null
	 * description.
	 */
	public TRANSIENT() {
		this("");
	...
	/**
	 * Constructs a <code>TRANSIENT</code> exception with the specified minor
