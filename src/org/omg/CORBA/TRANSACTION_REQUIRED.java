...
/**
 * Exception indicates that the request carried a null transaction context, but
 ...
 * the exception. The OMG Transaction Service specfication has details.
 *
...
public final class TRANSACTION_REQUIRED extends SystemException {
	/**
	 * Constructs a <code>TRANSACTION_REQUIRED</code> exception with a default
	 * minor code of 0, a completion state of CompletionStatus.COMPLETED_NO, and
	 * a null description.
	 */
	...
	/**
	 * Constructs a <code>TRANSACTION_REQUIRED</code> exception with the
	 * specified description message, a minor code of 0, and a completion state
	 * of COMPLETED_NO.
	 * 
	 * @param s
	 ...
	 *                  the completion status
	 */
	public TRANSACTION_REQUIRED(String s, int minor,
