 ...
 * Activity or Transaction services' resume methods if a transaction or Activity
 * is resumed in a context different to that from which it was suspended. It is
 * also raised when an attempted invocation is made that is incompatible with
