...
public final class UnionMember implements org.omg.CORBA.portable.IDLEntity {
	...
	/**
	 * The name of the union member described by this <code>UnionMember</code>
	 * object.
	 * 
	 * @serial
	 */
	...
	/**
	 * The label of the union member described by this <code>UnionMember</code>
	 * object.
	 * 
	 * @serial
	 */
	...
	/**
	 * The type of the union member described by this <code>UnionMember</code>
	 * object.
	 * 
	 * @serial
	 */
	...
	/**
	 * The typedef that represents the IDL type of the union member described by
	...
	/**
	 * Constructs a new <code>UnionMember</code> object with its fields
	 * initialized to null.
	 */
	public UnionMember() {
	}
	 ...
	 *            <code>UnionMember</code> object
	 * @param __type
	 *            a <code>TypeCode</code> object describing the type of this
	 *            <code>UnionMember</code> object
	 * @param __type_def
	 *            an <code>IDLType</code> object that represents the IDL type of
	 *            this <code>UnionMember</code> object
	 */
