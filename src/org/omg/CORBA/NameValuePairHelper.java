...
/**
 * The Helper for <tt>NameValuePair</tt>. For more information on Helper files,
 * see <a href="doc-files/generatedfiles.html#helper">
 * "Generated Files: Helper Files"</a>.
 * <P>
 * org/omg/CORBA/NameValuePairHelper.java Generated by the IDL-to-Java compiler
 * (portable), version "3.0" 03 June 1999 11:52:03 o'clock GMT+00:00
 */
        ...
        if (__typeCode == null) {
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    _tcOf_members0 = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CORBA.FieldNameHelper
                            .id(), "FieldName", _tcOf_members0);
                    ...
                    __typeCode = org.omg.CORBA.ORB.init().create_struct_tc(org.omg.CORBA.NameValuePairHelper
                            .id(), "NameValuePair", _members0);
                    __active = false;
                }
            }
        }
