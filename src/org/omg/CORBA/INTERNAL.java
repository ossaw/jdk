...
/**
 * This exception indicates an internal failure in an ORB, for example, if an
 * ORB has detected corruption of its internal data structures.
 * <P>
...
public final class INTERNAL extends SystemException {
    /**
     * Constructs an <code>INTERNAL</code> exception with a default minor code
    ...
    /**
     * Constructs an <code>INTERNAL</code> exception with the specified minor
