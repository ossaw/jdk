 ...
 * difference between a client invocation using a client stub and a request
 * using the DII.
 * <P>
 ...
 * <LI>the argument mode flag indicating whether the argument is for input,
 * output, or both
 * </OL>
 * </UL>
 * <P>
 * <code>Request</code> objects may also contain additional information,
 * depending on how an operation was defined in the original IDL interface
 * definition. For example, where appropriate, they may contain a
 * <code>NamedValue</code> object to hold the return value or exception, a
 * context, a list of possible exceptions, and a list of context strings that
 * need to be resolved.
 * <P>
 * New <code>Request</code> objects are created using one of the
 * <code>create_request</code> methods in the <code>Object</code> class. In
 * other words, a <code>create_request</code> method is performed on the object
...
public abstract class Request {
	 ...
	 *
	 * @return the object reference that points to the object implementation for
	...
	/**
	 * Retrieves the <code>NVList</code> object containing the arguments to the
	 * method being invoked. The elements in the list are
	 * <code>NamedValue</code> objects, with each one describing an argument to
	 * the method.
	 *
	...
	/**
	 * Retrieves the <code>NamedValue</code> object containing the return value
	 * for the method.
	 *
	 * @return the <code>NamedValue</code> object containing the result of the
	 *         method
	 */
	...
	/**
	 * Retrieves the <code>ExceptionList</code> object for this request. This
	 * list contains <code>TypeCode</code> objects describing the exceptions
	...
	/**
	 * Retrieves the <code>ContextList</code> object for this request. This list
	...
	/**
	 * Retrieves the <code>Context</code> object for this request. This is a
	 * list of properties giving information about the client, the environment,
	 * or the circumstances of this request.
	 *
	 * @return the <code>Context</code> object that is to be used to resolve any
	 *         context strings whose values need to be sent with the invocation
	 */
	...
	/**
	 * Adds an output argument with the given name to this <code>Request</code>
	 * object.
	 *
	 * @param name
	 *            the name of the argument being added
	 ...
	 *
	 * @return an <code>Any</code> object containing the value and typecode for
	 *         the return value
	 */
	 ...
	 * <code>Request</code> object. Exception information is placed into the
	 * <code>Request</code> object's environment object.
	 */

	public abstract void invoke();

	/**
	 * Makes a oneway invocation on the request. In other words, it does not
	 * expect or wait for a response. Note that this can be used even if the
	 * operation was not declared as oneway in the IDL declaration. No response
	 * or exception information is returned.
	 */

	public abstract void send_oneway();

	/**
	 * Makes an asynchronous invocation on the request. In other words, it does
	 * not wait for a response before it returns to the user. The user can then
	 * later use the methods <code>poll_response</code> and
	 * <code>get_response</code> to get the result or exception information for
	 * the invocation.
	 */
	 ...
	 * invocation triggered earlier with the <code>send_deferred</code> method.
	 *
	 * @return <code>true</code> if the method response has been received;
	...
	/**
	 * Allows the user to access the response for the invocation triggered
