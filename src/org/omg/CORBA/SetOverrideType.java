...
/**
 * The mapping of a CORBA <code>enum</code> tagging <code>SET_OVERRIDE</code>
 * and <code>ADD_OVERRIDE</code>, which indicate whether policies should replace
 * the existing policies of an <code>Object</code> or be added to them.
 * <P>
 * The method {@link org.omg.CORBA.Object#_set_policy_override} takes either
 * <code>SetOverrideType.SET_OVERRIDE</code> or
 * <code>SetOverrideType.ADD_OVERRIDE</code> as its second argument. The method
 * <code>_set_policy_override</code> creates a new <code>Object</code>
 * initialized with the <code>Policy</code> objects supplied as the first
 * argument. If the second argument is <code>ADD_OVERRIDE</code>, the new
 * policies are added to those of the <code>Object</code> instance that is
 * calling the <code>_set_policy_override</code> method. If
 * <code>SET_OVERRIDE</code> is given instead, the existing policies are
...
public class SetOverrideType implements org.omg.CORBA.portable.IDLEntity {
	 ...
	 *
	 * @return the <code>int</code> for this <code>SetOverrideType</code>
	 *         instance.
	 */
	public int value() {
		return _value;
