...
/**
 * The Holder for <tt>ServiceInformation</tt>. For more information on Holder
 * files, see <a href="doc-files/generatedfiles.html#holder">
 * "Generated Files: Holder Files"</a>.
 * <P>
 * A Holder class for a <code>ServiceInformation</code> object that is used to
 * store "out" and "inout" parameters in IDL methods. If an IDL method signature
 * has an IDL <code>xxx</code> as an "out" or "inout" parameter, the programmer
 * must pass an instance of <code>ServiceInformationHolder</code> as the
 ...
 * <P>
 * If <code>myServiceInformationHolder</code> is an instance of
 * <code>ServiceInformationHolder</code>, the value stored in its
