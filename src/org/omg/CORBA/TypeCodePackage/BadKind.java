...
/**
 * The exception <code>BadKind</code> is thrown when an inappropriate operation
 * is invoked on a <code>TypeCode</code> object. For example, invoking the
 * method <code>discriminator_type()</code> on an instance of
