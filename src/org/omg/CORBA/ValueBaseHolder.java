...
/**
 * The Holder for <tt>ValueBase</tt>. For more information on Holder files, see
 * <a href="doc-files/generatedfiles.html#holder">
 * "Generated Files: Holder Files"</a>.
 * <P>
 * A Holder class for a <code>java.io.Serializable</code> that is used to store
 * "out" and "inout" parameters in IDL methods. If an IDL method signature has
 * an IDL <code>ValueBase</code> as an "out" or "inout" parameter, the
 * programmer must pass an instance of <code>ValueBaseHolder</code> as the
