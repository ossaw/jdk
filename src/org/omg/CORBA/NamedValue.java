 ...
 * <code>NamedValue</code> objects are also used in the <code>Context</code>
 * object routines to pass lists of property names and values.
 * <P>
 * A <code>NamedValue</code> object contains:
 * <UL>
 * <LI>a name -- If the <code>NamedValue</code> object is used to describe
 * arguments to a request, the name will be an argument identifier specified in
 * the OMG IDL interface definition for the operation being described.
 ...
 * <LI>zero -- if this <code>NamedValue</code> object represents a property in a
 * <code>Context</code> object rather than a parameter or return value
 * </UL>
 * </UL>
 * <P>
 * The class <code>NamedValue</code> has three methods, which access its fields.
 * The following code fragment demonstrates creating a <code>NamedValue</code>
 ...
 * </PRE>
 * <P>
 * Note that the method <code>value</code> returns an <code>Any</code> object.
 * In order to access the <code>long</code> contained in the <code>Any</code>
 * object, we used the method <code>extract_long</code>.
 *
 * @see Any
 * @see ARG_IN
 * @see ARG_INOUT
