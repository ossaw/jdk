 ...
 * <UL>
 * <LI>to describe arguments for a <code>Request</code> object in the Dynamic
 * Invocation Interface and the Dynamic Skeleton Interface
 ...
 * </PRE>
 * 
 * The variable <code>nv</code> represents a newly-created <code>NVList</code>
 * object. The argument is a memory-management hint to the orb and does not
 * imply the actual length of the list. If, for example, you want to use an
 * <code>NVList</code> object in a request, and the method being invoked takes
 * three parameters, you might optimize by supplying 3 to the method
 * <code>create_list</code>. Note that the new <code>NVList</code> will not
 * necessarily have a length of 3; it could have a length of 2 or 4, for
 * instance. Note also that you can add any number of <code>NamedValue</code>
 ...
 * 
 * The variable <code>nv</code> represents a newly-created <code>NVList</code>
 * object that contains descriptions of the arguments to the method described in
 * the given <code>OperationDef</code> object.
 * </OL>
 * <P>
 * The methods in the class <code>NVList</code> all deal with the
 * <code>NamedValue</code> objects in the list. There are three methods for
 * adding a <code>NamedValue</code> object, a method for getting the count of
 * <code>NamedValue</code> objects in the list, a method for retrieving a
 * <code>NamedValue</code> object at a given index, and a method for removing a
 * <code>NamedValue</code> object at a given index.
 *
...
public abstract class NVList {
    ...
    /**
     * Returns the number of <code>NamedValue</code> objects that have been
     * added to this <code>NVList</code> object.
     *
    ...
    /**
     * Creates a new <code>NamedValue</code> object initialized with the given
     * flag and adds it to the end of this <code>NVList</code> object. The flag
     * can be any one of the argument passing modes: <code>ARG_IN.value</code>,
    ...
    /**
     * Creates a new <code>NamedValue</code> object initialized with the given
     * name and flag, and adds it to the end of this <code>NVList</code> object.
    ...
    /**
     * Creates a new <code>NamedValue</code> object initialized with the given
     * name, value, and flag, and adds it to the end of this <code>NVList</code>
     * object.
     *
     * @param item_name
     *                  the name for the new <code>NamedValue</code> object
    ...
    /**
     * Removes the <code>NamedValue</code> object at the given index. Note that
     * the indices of all <code>NamedValue</code> objects following the one
