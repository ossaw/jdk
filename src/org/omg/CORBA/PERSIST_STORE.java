...
/**
 * This exception indicates a persistent storage failure, for example, failure
 * to establish a database connection or corruption of a database.
 * <P>
...
public final class PERSIST_STORE extends SystemException {
	/**
	 * Constructs a <code>PERSIST_STORE</code> exception with a default minor
