...
public abstract class InputStream extends org.omg.CORBA.portable.InputStream {
	...
	private static final boolean allowSubclass = AccessController
	 ...
	 * enableSubclassImplementation SerializablePermission is not granted or
	 * jdk.corba.allowInputStreamSubclass system property is either not set or
	 * is set to 'false'
	 */
	public InputStream() {
	 ...
	 * 
	 * @param clz
	 *            is the declared type of the value to be unmarshalled
	 ...
	 * 
	 * @param factory
	 *            is the instance fo the helper to be used for unmarshalling the
	 *            value type
	 * @return the value unmarshalled from the input stream
	 */
	 ...
	 * 
	 * @param rep_id
	 *            identifies the type of the value to be unmarshalled
	...
	/**
	 * Unmarshal the class object or the stub class corresponding to the passed
	 * type.
	 * 
	 * @param clz
