...
/**
 * File manager for tools operating on Java&trade; programming language source
 * and class files. In this context, <em>file</em> means an abstraction of
 * regular files and other sources of data.
 *
 * <p>
 ...
 * internal form is defined in chapter four of <cite>The Java&trade; Virtual
 * Machine Specification</cite>.
 * 
 * <blockquote>
 * <p>
 * <i>Discussion:</i> this means that the names "java/lang.package-info",
 * "java/lang/package-info", "java.lang.package-info", are valid and equivalent.
 * Compare to binary name as defined in <cite>The Java&trade; Language
 * Specification</cite>, section 13.1 "The Form of a Binary".
 * </p>
 * </blockquote>
 *
 * <p>
 * The case of names is significant. All names should be treated as
 * case-sensitive. For example, some file systems have case-insensitive,
 * case-aware file names. File objects representing such files should take care
 * to preserve case by using {@link java.io.File#getCanonicalFile} or similar
 * means. If the system is not case-aware, file objects must use other means to
 * preserve case.
 *
 * <p>
 * <em><a name="relative_name">Relative names</a>:</em> some methods in this
 * interface use relative names. A relative name is a non-null, non-empty
 * sequence of path segments separated by '/'. '.' or '..' are invalid path
 * segments. A valid relative name must match the "path-rootless" rule of
 ...
 *
 * <p>
 * An object of this interface is not required to support multi-threaded access,
 * that is, be synchronized. However, it must support concurrent access to
 * different file objects created by this object.
 *
 * <p>
 * <em>Implementation note:</em> a consequence of this requirement is that a
 * trivial implementation of output to a
 * {@linkplain java.util.jar.JarOutputStream} is not a sufficient
 * implementation. That is, rather than creating a JavaFileObject that returns
 * the JarOutputStream directly, the contents must be cached until closed and
 * then written to the JarOutputStream.
 *
 * <p>
...
public interface JavaFileManager extends Closeable, Flushable, OptionChecker {
    ...
    /**
     * Interface for locations of file objects. Used by file managers to
     * determine where to place or search for file objects.
     */
    interface Location {
        /**
        ...
        /**
         * Determines if this is an output location. An output location is a
         * location that is conventionally used for output.
         *
    ...
    /**
     * Gets a class loader for loading plug-ins from the given location. For
     * example, to load annotation processors, a compiler will request a class
     * loader for the {@link StandardLocation#ANNOTATION_PROCESSOR_PATH
     ...
     *
     * <p>
     * Note: even if the given location is unknown to this file manager, it may
     * not return {@code null}. Also, an unknown location may not cause an
     * exception.
     *
     * @param location
     *                    a location
     ...
     * name returned might not be a valid binary name according to <cite>The
    ...
    /**
     * Compares two file objects and return true if they represent the same
     * underlying object.
     *
     * @param a
     *          a file object
    ...
    /**
     * Handles one option. If {@code current} is an option to this file manager
     * it will consume any arguments to that option from {@code remaining} and
    ...
    /**
     * Gets a {@linkplain JavaFileObject file object} for input representing the
     ...
     * the specified class of the specified kind in the given location.
     *
     * <p>
     ...
     * unspecified. The JDK compiler, javac, for example, will place class files
     * in the same directories as originating source files unless a class file
     * output directory is provided. To facilitate this behavior, javac might
     ...
     * specified <a href="JavaFileManager.html#relative_name">relative name</a>
     * in the specified package in the given location.
     *
     * <p>
     * If the returned object represents a
     * {@linkplain JavaFileObject.Kind#SOURCE source} or
     * {@linkplain JavaFileObject.Kind#CLASS class} file, it must be an instance
     * of {@link JavaFileObject}.
     *
     * <p>
     * Informally, the file object returned by this method is located in the
     * concatenation of the location, package name, and relative name. For
     * example, to locate the properties file "resources/compiler.properties" in
     * the package "com.sun.tools.javac" in the
     * {@linkplain StandardLocation#SOURCE_PATH SOURCE_PATH} location, this
     ...
     * <p>
     * Informally, the file object returned by this method is located in the
     * concatenation of the location, package name, and relative name or next to
     * the sibling argument. See {@link #getFileForInput getFileForInput} for an
     * example.
     *
     * @param location
     *                     a location
     ...
     * indirectly. This might render this file manager useless and the effect of
     * subsequent calls to methods on this object or any objects obtained
     * through this object is undefined unless explicitly allowed. However,
