...
/**
 * File abstraction for tools. In this context, <em>file</em> means an
...
public interface FileObject {
	...
	/**
	 * Gets a user-friendly name for this file object. The exact value returned
	 * is not specified but implementations should take care to preserve names
	 * as given by the user. For example, if the user writes the filename
	 * {@code "BobsApp\Test.java"} on the command line, this method should
	 * return {@code
	 * "BobsApp\Test.java"} whereas the {@linkplain #toUri toUri} method might
	 * return {@code
	...
	/**
	 * Gets a reader for this object. The returned reader will replace bytes
	 * that cannot be decoded with the default translation character. In
	 * addition, the reader may report a diagnostic unless
	...
	/**
	 * Gets the character content of this file object, if available. Any byte
	 * that cannot be decoded will be replaced by the default translation
	 * character. In addition, a diagnostic may be reported unless
	 * {@code ignoreEncodingErrors} is true.
	 *
	 * @param ignoreEncodingErrors
	 *            ignore encoding errors if true
	 ...
	 * 
	 * @return true if and only if this file object is successfully deleted;
	 *         false otherwise
	 */
	boolean delete();
