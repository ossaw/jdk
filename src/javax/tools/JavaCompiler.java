 ...
 * which is {@code
 * System.err} unless otherwise specified. Even if a diagnostic listener is
 * supplied, some diagnostics might not fit in a {@code
 ...
 *
 * <p>
 * An instance implementing this interface must conform to <cite>The Java&trade;
 * Language Specification</cite> and generate class files conforming to
 * <cite>The Java&trade; Virtual Machine Specification</cite>. The versions of
 * these specifications are defined in the {@linkplain Tool} interface.
 *
 ...
 * <dd>Used to collect diagnostics in a list, for example:
 * 
 * <pre>
 ...
 * </dd>
 *
 * <dt>{@link ForwardingJavaFileManager}, {@link ForwardingFileObject}, and
...
public interface JavaCompiler extends Tool, OptionChecker {
	 ...
	 * source code to be compiled, passed with the {@code compilationUnits}
	 * parameter, as well as class files, whose names are passed with the
	 ...
	 * producing any non-fatal diagnostics. Fatal errors will be signaled with
