...
public interface Diagnostic<S> {
     ...
     * or prefixed with the word "Warning". There is no requirement that the
     * Kind should imply any inherent semantic meaning to the message of the
     * diagnostic: for example, a tool might provide an option to report all
     * warnings as errors.
     */
    enum Kind {
    /**
     ...
     *
     * @return the source object associated with this diagnostic. {@code null}
     ...
     *         {@link #getSource()} would return {@code null} or if no location
     *         is suitable
     */
    long getPosition();
     ...
     * {@linkplain #getPosition()}.
     *
     * @return a column number or {@link #NOPOS} if and only if
     *         {@link #getPosition()} returns {@link #NOPOS}
     */
     ...
     * implementation-dependent. If the locale is {@code
