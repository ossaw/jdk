...
public interface DocumentationTool extends Tool, OptionChecker {
     ...
     * defined in {@link DocumentationTool.Location}, as well as
     * {@link StandardLocation#SOURCE_PATH}, {@link StandardLocation#CLASS_PATH}
     ...
     * not yet started. To start the task, call the {@linkplain #call call}
     * method.
     * <p>
     * Before calling the call method, additional aspects of the task can be
     * configured, for example, by calling the {@linkplain #setLocale setLocale}
     * method.
     */
    interface DocumentationTask extends Callable<Boolean> {
        ...
        /**
         * Performs this documentation task. The task may only be performed
