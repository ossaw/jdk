...
public class SimpleJavaFileObject implements JavaFileObject {
	...
	/**
	 * Construct a SimpleJavaFileObject of the given kind and with the given
	 * URI.
	 *
	 * @param uri
	...
	/**
	 * Wraps the result of openOutputStream in a Writer. Subclasses can change
	 * this behavior as long as the contract of {@link FileObject} is obeyed.
	 *
	...
	/**
	 * This implementation returns {@code 0L}. Subclasses can change this
	 * behavior as long as the contract of {@link FileObject} is obeyed.
	 *
	 * @return {@code 0L}
	 */
	...
	/**
	 * This implementation does nothing. Subclasses can change this behavior as
	 * long as the contract of {@link FileObject} is obeyed.
	 *
	 * @return {@code false}
	 */
	...
	/**
	 * This implementation compares the path of its URI to the given simple
	 * name. This method returns true if the given kind is equal to the kind of
	...
	/**
	 * This implementation returns {@code null}. Subclasses can change this
	 * behavior as long as the contract of {@link JavaFileObject} is obeyed.
	 */
