...
public class AuthorizeCallback implements Callback, java.io.Serializable {
	...
	/**
	 * The id of the authorized entity. If null, the id of the authorized entity
	 * is authorizationID.
	 * 
	 * @serial
	 */
	...
	/**
	 * A flag indicating whether the authentication id is allowed to act on
	 * behalf of the authorization id.
	 * 
	 * @serial
	 */
	...
	/**
	 * Determines whether the authentication id is allowed to act on behalf of
	 * the authorization id.
	 *
	 ...
	 * is different from getAuthorizationID(). For example, the id might need to
