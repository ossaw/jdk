...
public abstract interface SaslClientFactory {
     ...
     *        exchange of the
     *        selected mechanism. See the {@code Sasl} class for
     *        a list of
     *        standard properties. Other, possibly
     *        mechanism-specific,
     *        properties can be included. Properties not
     *        relevant to the
     ...
     *            an error.
     */
    public abstract SaslClient createSaslClient(String[] mechanisms, String authorizationId, String protocol,
