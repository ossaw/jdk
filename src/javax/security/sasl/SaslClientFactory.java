...
/**
 * An interface for creating instances of {@code SaslClient}. A class that
 ...
 * may provide and install a new or different {@code SaslClientFactory}.
 *
 * @since 1.5
 *
 * @see SaslClient
...
public abstract interface SaslClientFactory {
	 ...
	 *         {@code SaslClient} using the parameters supplied.
	 * @exception SaslException
	 *                If cannot create a {@code SaslClient} because of an error.
	 */
	public abstract SaslClient createSaslClient(String[] mechanisms, String authorizationId,
