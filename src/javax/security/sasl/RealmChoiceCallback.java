...
/**
 * This callback is used by {@code SaslClient} and {@code SaslServer} to obtain
...
public class RealmChoiceCallback extends ChoiceCallback {
	...
	/**
	 * Constructs a {@code RealmChoiceCallback} with a prompt, a list of choices
	 ...
	 * @param defaultChoice
	 *                      the choice to be used as the default choice when the
	 *                      list of
	 *                      choices is displayed. It is an index into the
	 *                      {@code choices}
	 *                      array.
	 * @param multiple
	 ...
	 *                                  string, if
	 *                                  {@code choices} has a length of 0, if
	 *                                  any element from
	 *                                  {@code choices} is null or empty, or if
	 *                                  {@code defaultChoice}
	 *                                  does not fall within the array boundary
	 *                                  of {@code choices}
	 */
