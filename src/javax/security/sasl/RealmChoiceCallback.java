...
public class RealmChoiceCallback extends ChoiceCallback {
	 ...
	 *            choices is displayed. It is an index into the {@code choices}
	 *            array.
	 * @param multiple
	 *            true if multiple choices allowed; false otherwise
	 * @throws IllegalArgumentException
	 *             If {@code prompt} is null or the empty string, if
	 *             {@code choices} has a length of 0, if any element from
