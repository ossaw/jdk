...
public abstract interface SaslServerFactory {
     ...
     *        authenticate
     *        to, or null if the server is not bound to any specific
     *        host
     *        name. If the mechanism does not allow an unbound
     *        server, a
     ...
     *        of the
     *        selected mechanism. See the {@code Sasl} class for a
     *        list of
     *        standard properties. Other, possibly
     *        mechanism-specific,
     *        properties can be included. Properties not relevant to
     *        the
     *        selected mechanism are ignored, including any map
     *        entries with
     *        non-String keys.
     * @param cbh
     ...
     *            an error.
     */
    public abstract SaslServer createSaslServer(String mechanism, String protocol, String serverName,
     ...
     *        property with the value {@code "true"}, then the factory
     *        must
     *        not return any SASL mechanisms that are susceptible to
     *        simple
