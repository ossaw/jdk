...
/**
 * <p>
 * Underlying security services instantiate and pass a {@code ChoiceCallback} to
 * the {@code handle} method of a {@code CallbackHandler} to display a list of
...
public class ChoiceCallback implements Callback, java.io.Serializable {
	...
	/**
	 * Construct a {@code ChoiceCallback} with a prompt, a list of choices, a
	 * default choice, and a boolean specifying whether or not multiple
	 ...
	 * <p>
	 *
	 * @return the defaultChoice, represented as an index into the
	 *         {@code choices} list.
	 */
