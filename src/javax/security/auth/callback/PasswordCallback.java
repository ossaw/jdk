...
/**
 * <p>
 * Underlying security services instantiate and pass a {@code PasswordCallback}
 * to the {@code handle} method of a {@code CallbackHandler} to retrieve
...
public class PasswordCallback implements Callback, java.io.Serializable {
    ...
    /**
     * Construct a {@code PasswordCallback} with a prompt and a boolean
     ...
     *
     * <p>
     * This method makes a copy of the input <i>password</i> before storing it.
     *
     * <p>
     *
     * @param password
