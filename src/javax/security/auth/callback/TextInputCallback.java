...
/**
 * <p>
 * Underlying security services instantiate and pass a {@code TextInputCallback}
 * to the {@code handle} method of a {@code CallbackHandler} to retrieve generic
 * text information.
 *
...
public class TextInputCallback implements Callback, java.io.Serializable {
    ...
    /**
     * Construct a {@code TextInputCallback} with a prompt and default input
     * value.
     *
     * <p>
     *
     ...
     * <p>
     *
     * @return the default text, or null if this {@code TextInputCallback} was
     *         not instantiated with {@code defaultText}.
     */
