 ...
 * {@code TextOutputCallback} to the {@code handle} method of a
 * {@code CallbackHandler} to display information messages, warning messages and
 * error messages.
 *
...
public class TextOutputCallback implements Callback, java.io.Serializable {
	 ...
	 *                if {@code messageType} is not either {@code INFORMATION},
	 *                {@code WARNING} or {@code ERROR}, if {@code message} is
	 *                null, or if {@code message} has a length of 0.
	 */
