...
/**
 * This class encapsulates a Kerberos encryption key. It is not associated with
 * a principal and may represent an ephemeral session key.
 *
...
class KeyImpl implements SecretKey, Destroyable, Serializable {
	...
	/**
	 * @serialData this {@code KeyImpl} is serialized by writing out the ASN1
	 *             Encoded bytes of the encryption key. The ASN1 encoding is
	 *             defined in RFC4120 and as follows: EncryptionKey ::= SEQUENCE
	 *             { keytype [0] Int32 -- actually encryption type --, keyvalue
	 *             [1] OCTET STRING }
	 */
