 ...
 * the login module will store an instance of this class in the private
 ...
 * the default JGSS Kerberos mechanism to access the KerberosKey. In that case,
 * however, the application will need an appropriate
...
public class KerberosKey implements SecretKey, Destroyable {
	 ...
	 * version number are known. This can be used when reading the secret key
	 ...
	 * @param algorithm
	 *            the name for the algorithm that this key will be used for.
	 *            This parameter may be null in which case the default algorithm
	 *            "DES" will be assumed.
	...
	/**
	 * Returns the standard algorithm name for this key. For example, "DES"
	 * would indicate that this key is a DES key. See Appendix A in the <a href=
	 * "../../../../../technotes/guides/security/crypto/CryptoSpec.html#AppA">
	 * Java Cryptography Architecture API Specification &amp; Reference </a> for
	...
	public String toString() {
		...
		return "Kerberos Principal " + principal.toString() + "Key Version " + versionNum + "key "
				+ key.toString();
	}
	...
	/**
	 * Compares the specified Object with this KerberosKey for equality. Returns
	 * true if the given object is also a {@code KerberosKey} and the two
