...
/**
 * This class is used to restrict the usage of the Kerberos delegation model,
 * ie: forwardable and proxiable tickets.
 * <p>
 * The target name of this {@code Permission} specifies a pair of kerberos
 * service principals. The first is the subordinate service principal being
 * entrusted to use the TGT. The second service principal designates the target
 * service the subordinate service principal is to interact with on behalf of
 * the initiating KerberosPrincipal. This latter service principal is specified
 * to restrict the use of a proxiable ticket.
 * <p>
...
public final class DelegationPermission extends BasicPermission implements
     ...
     * objects. <br>
     * DelegationPermission objects must be stored in a manner that allows them
     * to be inserted into the collection in any order, but that also enables
     * the PermissionCollection implies method to be implemented in an efficient
    ...
    /**
     * WriteObject is called to save the state of the DelegationPermission to a
     ...
     * DelegationPermission this_ = new DelegationPermission(args[0]);
     * DelegationPermission that_ = new DelegationPermission(args[1]);
...
final class KrbDelegationPermissionCollection extends PermissionCollection
    ...
    /**
     * Adds a permission to the DelegationPermissions. The key for the hash is
     * the name.
     *
     * @param permission
    ...
    /**
     * Returns an enumeration of all the DelegationPermission objects in the
     * container.
     *
    ...
    /*
     * Reads in a Vector of DelegationPermissions and saves them in the perms
     * field.
     */
