 ...
 * </pre>
 *
 * The {@code Policy} object consults the local policy and returns and
 ...
 * Principals triplet, as well as the Permissions granted to that triplet.
 *
 * <pre>
 ...
 * </pre>
 *
 * This <b><i>grant</i></b> entry specifies that code from "foo.com", signed by
 ...
 * code runs as all the Principals associated with the specified {@code Subject}
 ...
 * provided to {@code Subject.doAs} for that {@code Subject} to be granted the
 ...
 * name of the desired {@code Policy} implementation class.
 *
