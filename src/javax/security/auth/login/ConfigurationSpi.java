 ...
 * {@code Configuration} class. All the abstract methods in this class must be
 * implemented by each service provider who wishes to supply a Configuration
 * implementation.
 * <p>
 * Subclass implementations of this abstract class must provide a public
 * constructor that takes a {@code Configuration.Parameters} object as an input
 * parameter. This constructor also must throw an IllegalArgumentException if it
 * does not understand the {@code Configuration.Parameters} input.
 *
 * @since 1.6
 */
