...
/**
 * This class represents a single {@code LoginModule} entry configured for the
 * application specified in the {@code getAppConfigurationEntry(String appName)}
 * method in the {@code Configuration} class. Each respective
 * {@code AppConfigurationEntry} contains a {@code LoginModule} name, a control
 * flag (specifying whether this {@code LoginModule} is REQUIRED, REQUISITE,
 * SUFFICIENT, or OPTIONAL), and LoginModule-specific options. Please refer to
 * the {@code Configuration} class for more information on the different control
...
public class AppConfigurationEntry {
	 ...
	 * {@code getAppConfigurationEntry(String appName)} method from the
	 ...
	 *
	 * @return the class name of the configured {@code LoginModule} as a String.
	 */
	...
	/**
	 * Return the controlFlag (either REQUIRED, REQUISITE, SUFFICIENT, or
	 * OPTIONAL) for this {@code LoginModule}.
	 *
	 * @return the controlFlag (either REQUIRED, REQUISITE, SUFFICIENT, or
	 *         OPTIONAL) for this {@code LoginModule}.
	 */
	 ...
	 *
	 * @return the options configured for this {@code LoginModule} as an
	...
	/**
	 * This class represents whether or not a {@code LoginModule} is REQUIRED,
