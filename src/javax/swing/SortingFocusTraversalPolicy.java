...
public class SortingFocusTraversalPolicy extends InternalFrameFocusTraversalPolicy {
	...
	private PlatformLogger log = PlatformLogger
			.getLogger("javax.swing.SortingFocusTraversalPolicy");
	...
	static {
		legacySortingFTPEnabled = "true".equals(AccessController
				.doPrivileged(new GetPropertyAction("swing.legacySortingFTPEnabled", "true")));
		...
		for (Component comp : components) {
			if (comp instanceof Container) {
				...
				if (!cont.isFocusCycleRoot() && !cont.isFocusTraversalPolicyProvider()
						&& !((cont instanceof JComponent)
								&& ((JComponent) cont).isManagingFocus())) {
	 ...
	 *
	 * @param aContainer
	 *            a focus cycle root of aComponent or a focus traversal policy
	 *            provider
	 * @param aComponent
	 *            a (possibly indirect) child of aContainer, or aContainer
	 *            itself
	 * @return the Component that should receive the focus after aComponent, or
	 *         null if no suitable Component can be found
	 * @throws IllegalArgumentException
	 *             if aContainer is not a focus cycle root of aComponent or a
	 *             focus traversal policy provider, or if either aContainer or
	 *             aComponent is null
	 */
	 ...
	 *            whether this SortingFocusTraversalPolicy transfers focus
