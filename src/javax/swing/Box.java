...
public class Box extends JComponent implements Accessible {
	...
	/**
	 * Creates a <code>Box</code> that displays its components along the the
	 * specified axis.
	 *
	 * @param axis
	...
	/**
	 * Creates a <code>Box</code> that displays its components from left to
	 * right. If you want a <code>Box</code> that respects the component
	 * orientation you should create the <code>Box</code> using the constructor
	 * and pass in <code>BoxLayout.LINE_AXIS</code>, eg:
	 * 
	 * <pre>
	...
	/**
	 * Creates a <code>Box</code> that displays its components from top to
	 * bottom. If you want a <code>Box</code> that respects the component
	 * orientation you should create the <code>Box</code> using the constructor
	 * and pass in <code>BoxLayout.PAGE_AXIS</code>, eg:
	 * 
	 * <pre>
	 ...
	 * components. In a vertical box, you might use this method to force the box
	 * to be at least the specified width. The invisible component has no height
	 * unless excess space is available, in which case it takes its share of
	 * available space, just like any other component that has no maximum
	 * height.
	 *
	 * @param width
	 ...
	 * typically use this method to force a certain amount of space between two
	 * components. In a horizontal box, you might use this method to force the
	 * box to be at least the specified height. The invisible component has no
	 * width unless excess space is available, in which case it takes its share
	 * of available space, just like any other component that has no maximum
	 * width.
	 *
	 * @param height
	 ...
	 * visible components have a maximum width (for a horizontal box) or height
	 ...
	 * glue, the extra space goes to the right of the second component. If you
	 * put glue between the fixed-size components, then the extra space goes
	 * there. If you put glue before the first fixed-size component, the extra
	 * space goes there, and the fixed-size components are shoved against the
	 ...
	 * space is available, then the glue component takes its share of available
	 * horizontal or vertical space, just like any other component that has no
	 ...
	 * method invokes super's implementation, otherwise if this <code>Box</code>
	...
	/**
	 * An implementation of a lightweight component that participates in layout
	 * but has no view.
	 * <p>
	 * <strong>Warning:</strong> Serialized objects of this class will not be
	...
	public static class Filler extends JComponent implements Accessible {
		...
		/**
		 * Paints this <code>Filler</code>. If this <code>Filler</code> has a UI
		 * this method invokes super's implementation, otherwise if this
		 * <code>Filler</code> is opaque the <code>Graphics</code> is filled
		...
		/**
		 * Gets the AccessibleContext associated with this Box.Filler. For box
		 * fillers, the AccessibleContext takes the form of an
		 * AccessibleBoxFiller. A new AccessibleAWTBoxFiller instance is created
		 * if necessary.
		 *
		 * @return an AccessibleBoxFiller that serves as the AccessibleContext
		 *         of this Box.Filler.
		 */
	 ...
	 * AccessibleContext takes the form of an AccessibleBox. A new
	 * AccessibleAWTBox instance is created if necessary.
	 *
	 * @return an AccessibleBox that serves as the AccessibleContext of this Box
	 */
	public AccessibleContext getAccessibleContext() {
		if (accessibleContext == null) {
	...
	/**
	 * This class implements accessibility support for the <code>Box</code>
	 * class.
	 */
	@SuppressWarnings("serial")
