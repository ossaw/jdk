 ...
 * vertical arrangement of components will stay vertically arranged when the
 * frame is resized.
 * <TABLE STYLE="FLOAT:RIGHT" BORDER="0" SUMMARY="layout">
 * <TR>
 * <TD ALIGN="CENTER">
 * <P STYLE="TEXT-ALIGN:CENTER">
 * <IMG SRC="doc-files/BoxLayout-1.gif" alt=
 * "The following text describes this graphic." WIDTH="191" HEIGHT="201" STYLE=
 ...
 * orientations, if the container's <tt>ComponentOrientation</tt> is left to
 * right then components are laid out left to right, otherwise they are laid out
 * right to left.&nbsp; For vertical orientations components are always laid out
 ...
 * horizontally according to their X alignments. For <code>PAGE_AXIS</code>
 * layout, horizontal alignment is done based on the leading edge of the
 * component. In other words, an X alignment value of 0.0 means the left edge of
 * a component if the container's <code>ComponentOrientation</code> is left to
 ...
 * class is a lightweight container that uses a BoxLayout. It also provides
 * handy methods to help you use BoxLayout well. Adding components to multiple
 * nested boxes is a powerful way to get the arrangement you want.
 * <p>
