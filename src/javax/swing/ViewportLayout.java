 ...
 * <code>ViewportLayout</code> defines a policy for layout that should be useful
 * for most applications. The viewport makes its view the same size as the
 * viewport, however it will not make the view smaller than its minimum size. As
 * the viewport grows the view is kept bottom justified until the entire view is
 * visible, subsequently the view is kept top justified.
 * <p>
