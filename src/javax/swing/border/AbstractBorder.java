...
public abstract class AbstractBorder implements Border, Serializable {
	 ...
	 * initialized by the {@link #getBorderInsets(Component,Insets)} method. By
	 * default the {@code top}, {@code left}, {@code bottom}, and {@code right}
	 ...
	 * This is useful for determining the area that components should draw in
	...
	/**
	 * Returns an enum indicating how the baseline of a component changes as the
