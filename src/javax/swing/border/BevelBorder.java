...
public class BevelBorder extends AbstractBorder {
     ...
     * the specified component. If no highlight color was specified at
    ...
    /**
     * Returns the outer highlight color of the bevel border. Will return null
    ...
    /**
     * Returns the inner highlight color of the bevel border. Will return null
     * if no highlight color was specified at instantiation.
     * 
     * @since 1.3
     */
    ...
    /**
     * Returns the inner shadow color of the bevel border. Will return null if
     * no shadow color was specified at instantiation.
     * 
     * @since 1.3
     */
    ...
    /**
     * Returns the outer shadow color of the bevel border. Will return null if
     * no shadow color was specified at instantiation.
     * 
     * @since 1.3
     */
