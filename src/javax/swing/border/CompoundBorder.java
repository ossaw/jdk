...
public class CompoundBorder extends AbstractBorder {
	 ...
	 *
	 * @return {@code true} if the inside and outside borders are each either
	 *         {@code null} or opaque; or {@code false} otherwise
	 */
	@Override
	 ...
	 * specified position and size and then painting the inside border at the
