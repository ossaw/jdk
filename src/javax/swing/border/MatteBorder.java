...
public class MatteBorder extends EmptyBorder {
    ...
    /**
     * Creates a matte border with the specified tile icon. The insets will be
     * calculated dynamically based on the size of the tile icon, where the top
     * and bottom will be equal to the tile icon's height, and the left and
    ...
    public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
        ...
        if (color != null) {
            ...
            paintEdge(c, g, insets.left, height - insets.bottom, width - insets.left, insets.bottom, tileW,
                    tileH);
    ...
    /**
     * Returns the color used for tiling the border or null if a tile icon is
     * being used.
     * 
     * @since 1.3
     */
    ...
    /**
     * Returns the icon used for tiling the border or null if a solid color is
     * being used.
     * 
     * @since 1.3
     */
