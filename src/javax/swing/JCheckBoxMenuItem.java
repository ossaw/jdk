...
public class JCheckBoxMenuItem extends JMenuItem implements SwingConstants,
    ...
    /**
     * Sets the selected-state of the item. This method exists for AWT
    ...
    /**
     * Returns an array (length 1) containing the check box menu item label or
     * null if the check box is not selected.
     *
     * @return an array containing one Object -- the text of the menu item -- if
     *         the item is selected; otherwise null
     */
     ...
     * AccessibleJCheckBoxMenuItem. A new AccessibleJCheckBoxMenuItem instance
     ...
     * <code>JCheckBoxMenuItem</code> class. It provides an implementation of
     * the Java Accessibility API appropriate to checkbox menu item
