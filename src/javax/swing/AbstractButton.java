 ...
 * in
 * <a href="https://docs.oracle.com/javase/tutorial/uiswing/misc/action.html">
 * How to Use Actions</a>, a section in <em>The Java Tutorial</em>.
 * <p>
 * For further information see <a href=
 * "https://docs.oracle.com/javase/tutorial/uiswing/components/button.html">How
 * to Use Buttons, Check Boxes, and Radio Buttons</a>, a section in
...
public abstract class AbstractButton extends JComponent implements ItemSelectable, SwingConstants {
	...
	/**
	 * Sets the <code>hideActionText</code> property, which determines whether
	 * the button displays text from the <code>Action</code>. This is useful
	 * only if an <code>Action</code> has been installed on the button.
	 *
	 * @param hideActionText
	 *            <code>true</code> if the button's <code>text</code> property
	 *            should not reflect that of the <code>Action</code>; the
	 *            default is <code>false</code>
	 * @see <a href="Action.html#buttonActions">Swing Components Supporting
	 *      <code>Action</code></a>
	 * @since 1.6
	 * @beaninfo bound: true expert: true description: Whether the text of the
	 *           button should come from the <code>Action</code>.
	 */
	 ...
	 * determines whether the button displays text from the <code>Action</code>.
	 * This is useful only if an <code>Action</code> has been installed on the
	 * button.
	 *
	 * @return <code>true</code> if the button's <code>text</code> property
	 *         should not reflect that of the <code>Action</code>; the default
	 *         is <code>false</code>
	 * @since 1.6
	 */
	 ...
	 * <code>actionEvent</code>. Call <code>doClick</code> to perform a
	...
	/**
	 * Programmatically perform a "click". This does the same thing as if the
	 * user had pressed and released the button. The button stays visually
	...
	/**
	 * Sets space for margin between the button's border and the label. Setting
	 * to <code>null</code> will cause the button to use the default margin. The
	 * button's default <code>Border</code> object will use this value to create
	 * the proper margin. However, if a non-default border is set on the button,
	 * it is that <code>Border</code> object's responsibility to create the
	 * appropriate margin space (else this property will effectively be
	 * ignored).
	 *
	 * @param m
	...
	/**
	 * Sets the button's default icon. This icon is also used as the "pressed"
	...
	public void setIcon(Icon defaultIcon) {
		 ...
		 * disabled icon for this component, (i.e. setDisabledIcon() was never
		 * called) then clear the disabledIcon field.
		 */
	...
	public void setSelectedIcon(Icon selectedIcon) {
		...
		/*
		 * If the default selected icon has really changed and we had generated
		 * the disabled selected icon for this component, (i.e.
	...
	/**
	 * Returns the icon used by the button when it's disabled. If no disabled
	 * icon has been set this will forward the call to the look and feel to
	 * construct an appropriate disabled Icon.
	 * <p>
	...
	/**
	 * Returns the icon used by the button when it's disabled and selected. If
	 * no disabled selection icon has been set, this will forward the call to
	 * the LookAndFeel to construct an appropriate disabled Icon from the
	 * selection icon if it has been set and to <code>getDisabledIcon()</code>
	 * otherwise.
	 * <p>
	 * Some look and feels might not render the disabled selected Icon, in which
	 ...
	 *
	 * @return the <code>verticalAlignment</code> property, one of the following
	 *         values:
	 *         <ul>
	 ...
	 * {@code AbstractButton}'s default is {@code SwingConstants.CENTER}, but
	 * subclasses such as {@code JCheckBox} may use a different default.
	 *
	 * @return the <code>horizontalAlignment</code> property, one of the
	 *         following values:
	 *         <ul>
	 ...
	 *           attribute: visualUpdate true description: The horizontal
	 ...
	 * 
	 * @return the <code>verticalTextPosition</code> property, one of the
	 *         following values:
	 *         <ul>
	 *         <li>{@code SwingConstants.CENTER} (the default)
	 *         <li>{@code SwingConstants.TOP}
	 ...
	 * 
	 * @return the <code>horizontalTextPosition</code> property, one of the
	 *         following values:
	 *         <ul>
	 *         <li>{@code SwingConstants.RIGHT}
	 *         <li>{@code SwingConstants.LEFT}
	 ...
	 *                if <code>textPosition</code> is not one of the legal
	 *                values listed above
	 * @beaninfo bound: true enum: LEFT SwingConstants.LEFT CENTER
	 *           SwingConstants.CENTER RIGHT SwingConstants.RIGHT LEADING
	 *           SwingConstants.LEADING TRAILING SwingConstants.TRAILING
	 ...
	 * @since 1.4
	 * @see #getIconTextGap
	 * @beaninfo bound: true attribute: visualUpdate true description: If both
	 *           the icon and text properties are set, this property defines the
	 *           space between them.
	 */
	 ...
	 * @param exception
	 *            the message to use in the {@code IllegalArgumentException}
	...
	/**
	 * Verify that the {@code key} argument is a legal value for the vertical
	 * properties. Valid values are:
	 * <ul>
	 * <li>{@code SwingConstants.CENTER}
	 * <li>{@code SwingConstants.TOP}
	...
	/**
	 * Sets the <code>Action</code>. The new <code>Action</code> replaces any
	 * previously set <code>Action</code> but does not affect
	 * <code>ActionListeners</code> independently added with
	 * <code>addActionListener</code>. If the <code>Action</code> is already a
	 * registered <code>ActionListener</code> for the button, it is not
	 * re-registered.
	 * <p>
	 ...
	 * Components Supporting <code>Action</code></a>. Subsequently, the button's
	 * properties are automatically updated as the <code>Action</code>'s
	 * properties change.
	 * <p>
	 ...
	 * the button's properties. To track changes in the <code>Action</code>'s
	...
	/**
	 * Button subclasses that support mirroring the selected state from the
	 * action should override this to return true. AbstractButton's
	 ...
	 * class. If you do the lifetime of the button will be tied to that of the
	 * <code>Action</code>.
	 *
	 * @param a
	 *            the button's action
	...
	private static class ButtonActionPropertyChangeListener
		...
		protected void actionPropertyChanged(AbstractButton button, Action action,
	...
	/**
	 * Sets the <code>borderPainted</code> property. If <code>true</code> and
	 * the button has a border, the border is painted. The default value for the
	 * <code>borderPainted</code> property is <code>true</code>.
	 * <p>
	 * Some look and feels might not support the <code>borderPainted</code>
	...
	/**
	 * Paint the button's border if <code>BorderPainted</code> property is true
	...
	/**
	 * Sets the <code>paintFocus</code> property, which must be
	 * <code>true</code> for the focus state to be painted. The default value
	 * for the <code>paintFocus</code> property is <code>true</code>. Some look
	...
	/**
	 * Sets the <code>contentAreaFilled</code> property. If <code>true</code>
	 * the button will paint the content area. If you wish to have a transparent
	 * button, such as an icon only button, for example, then you should set
	 * this to <code>false</code>. Do not call <code>setOpaque(false)</code>.
	 * The default value for the the <code>contentAreaFilled</code> property is
	 * <code>true</code>.
	 * <p>
	 ...
	 * @see #setOpaque
	 * @beaninfo bound: true attribute: visualUpdate true description: Whether
	 *           the button should paint the content area or leave it
	 *           transparent.
	 */
	 ...
	 * <code>true</code> for rollover effects to occur. The default value for
	 * the <code>rolloverEnabled</code> property is <code>false</code>. Some
	 * look and feels might not implement rollover effects; they will ignore
	 * this property.
	 *
	 * @param b
	 ...
	 * <code>java.awt.event.KeyEvent</code>. These codes and the wider array of
	 * codes for international keyboards may be obtained through
	 ...
	 * @exception IllegalArgumentException
	 *                will be thrown if <code>index</code> is &gt;= length of
	 *                the text, or &lt; -1
	...
	/**
	 * Update the displayedMnemonicIndex property. This method is called when
	 * either text or mnemonic changes. The new value of the
	 * displayedMnemonicIndex property is the index of the first occurrence of
	 * mnemonic in text.
	 */
	...
	/**
	 * Brings the mnemonic property in accordance with model's mnemonic. This is
	 * called when model's mnemonic changes. Also updates the
	 ...
	 * events for the button to generate the corresponding action events. After
	 * the initial mouse press occurs (and action event generated) any
	 * subsequent mouse press events which occur on intervals less than the
	 * threshhold will be ignored and no corresponding action event generated.
	 * By default the threshhold is 0, which means that for each mouse press, an
	 * action event will be fired, no matter how quickly the mouse clicks occur.
	 * In buttons where this behavior is not desirable (for example, the "OK"
	 * button in a dialog), this threshhold should be set to an appropriate
	 * positive value.
	 *
	 * @see #getMultiClickThreshhold
	 * @param threshhold
	 *            the amount of time required between mouse press events to
	...
	/**
	 * Gets the amount of time (in milliseconds) required between mouse press
	 * events for the button to generate the corresponding action events.
	 *
	 * @see #setMultiClickThreshhold
	 * @return the amount of time required between mouse press events to
	 *         generate corresponding action events
	 * @since 1.4
	 */
	 ...
	 * Subtypes of <code>AbstractButton</code> should override this to update
	 ...
	 * refer to {@link java.awt.Container#addImpl(Component, Object, int)} for a
	 ...
	 * {@link java.awt.Container#setLayout(LayoutManager)} for a complete
			...
			if (listeners[i] == ItemListener.class) {
				...
				if (e == null) {
					e = new ItemEvent(AbstractButton.this, ItemEvent.ITEM_STATE_CHANGED,
							AbstractButton.this, event.getStateChange());
				}
	 ...
	 * @param infoflags
	 *            flags used to repaint the button when the image is updated and
	...
	/**
	 * Returns a string representation of this <code>AbstractButton</code>. This
	...
	protected String paramString() {
		...
		String disabledSelectedIconString = ((disabledSelectedIcon != null)
				&& (disabledSelectedIcon != this) ? disabledSelectedIcon.toString() : "");
		...
		String rolloverSelectedIconString = ((rolloverSelectedIcon != null)
				&& (rolloverSelectedIcon != this) ? rolloverSelectedIcon.toString() : "");
	 ...
	 * Java Accessibility API appropriate to button and menu item user-interface
	 * elements.
	 * <p>
	 * <strong>Warning:</strong> Serialized objects of this class will not be
	 * compatible with future Swing releases. The current serialization support
	...
	protected abstract class AccessibleAbstractButton extends AccessibleJComponent implements
		...
		/**
		 * Get the AccessibleIcons associated with this object if one or more
		 ...
		 * behavior of a button is to have one action - toggle the button.
		 *
		...
		private Rectangle getTextRectangle() {
			...
			String clippedText = SwingUtilities.layoutCompoundLabel(AbstractButton.this,
					getFontMetrics(getFont()), text, icon,
					...
					AbstractButton.this.getHorizontalTextPosition(), paintViewR, paintIconR,
					paintTextR, 0);
		...
		class ButtonKeyBinding implements AccessibleKeyBinding {
			 ...
			 * method should do the following: <nf><code>
