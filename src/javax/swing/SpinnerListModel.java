...
/**
 * A simple implementation of <code>SpinnerModel</code> whose values are defined
 * by an array or a <code>List</code>. For example to create a model defined by
 ...
 * </pre>
 * 
 * This class only stores a reference to the array or <code>List</code> so if an
 * element of the underlying sequence changes, it's up to the application to
 * notify the <code>ChangeListeners</code> by calling
 * <code>fireStateChanged</code>.
 * <p>
 * This model inherits a <code>ChangeListener</code>. The
 * <code>ChangeListener</code>s are notified whenever the model's
 * <code>value</code> or <code>list</code> properties changes.
 *
 * @see JSpinner
 * @see SpinnerModel
...
public class SpinnerListModel extends AbstractSpinnerModel implements
    ...
    /**
     * Constructs a <code>SpinnerModel</code> whose sequence of values is
     * defined by the specified <code>List</code>. The initial value (<i>current
     * element</i>) of the model will be <code>values.get(0)</code>. If
     * <code>values</code> is <code>null</code> or has zero size, an
    ...
    /**
     * Constructs a <code>SpinnerModel</code> whose sequence of values is
     * defined by the specified array. The initial value of the model will be
     * <code>values[0]</code>. If <code>values</code> is <code>null</code> or
    ...
    /**
     * Constructs an effectively empty <code>SpinnerListModel</code>. The
     * model's list will contain a single <code>"empty"</code> string element.
     */
    ...
    /**
     * Changes the list that defines this sequence and resets the index of the
     * models <code>value</code> to zero. Note that <code>list</code> is not
     * copied, the model just stores a reference to it.
     * <p>
     * This method fires a <code>ChangeEvent</code> if <code>list</code> is not
     ...
     * <code>ChangeListeners</code>. If the specified value is not equal to an
     * element of the underlying sequence then an
     * <code>IllegalArgumentException</code> is thrown. In the following example
     * the <code>setValue</code> call would cause an exception to be thrown:
     * 
     * <pre>
