...
public class JTextArea extends JTextComponent {
	 ...
	 * construction if one isn't explicitly given. A new instance of
	...
	/**
	 * Gets column width. The meaning of what a column is can be considered a
	 * fairly weak notion for some fonts. This method is used to define the
	 * width of a column. By default this is defined to be the width of the
	 * character <em>m</em> for the font used. This method can be redefined to
	...
	/**
	 * Returns a string representation of this JTextArea. This method is
	 ...
	 * <code>JTextArea</code> class. It provides an implementation of the Java
	 * Accessibility API appropriate to text area user-interface elements.
	 * <p>
	 * <strong>Warning:</strong> Serialized objects of this class will not be
