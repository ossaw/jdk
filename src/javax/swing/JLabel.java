 ...
 * <p>
 * See <a href=
 * "https://docs.oracle.com/javase/tutorial/uiswing/components/label.html">How
...
public class JLabel extends JComponent implements SwingConstants, Accessible {
	 ...
	 * component. This is generally not used by labels, but is instead used by
	 * components such as text areas that are being labeled by labels. When the
	 * labelFor property of a label is set, it will automatically set the
	 * LABELED_BY_PROPERTY of the component being labelled.
	 *
	 * @see #setLabelFor
	 */
	...
	public void setText(String text) {
		...
		setDisplayedMnemonicIndex(
				SwingUtilities.findDisplayedMnemonicIndex(text, getDisplayedMnemonic()));
	...
	public void setIcon(Icon icon) {
		 ...
		 * disabled icon for this component (in other words, setDisabledIcon()
		 * was never called), then clear the disabledIcon field.
		 */
		...
		/*
		 * If the default icon has changed and the new one is a different size,
	...
	/**
	 * Returns the icon used by the label when it's disabled. If no disabled
	 ...
	 *           to display if the label is disabled.
	 */
	 ...
	 * invoking <code>setDisplayedMnemonic(KeyEvent.VK_A)</code>.
	 *
	 * @since 1.4
	 * @param index
	 ...
	 *           visualUpdate true description: The alignment of the label's
	 *           contents along the Y axis.
	 */
	 ...
	 *           attribute: visualUpdate true description: The alignment of the
	 *           label's content along the X axis.
	 */
	 ...
	 * @beaninfo bound: true enum: TOP SwingConstants.TOP CENTER
	 *           SwingConstants.CENTER BOTTOM SwingConstants.BOTTOM expert: true
	 *           attribute: visualUpdate true description: The vertical position
	 *           of the text relative to it's image.
	 */
	...
	/**
	 * This is overridden to return false if the current Icon's Image is not
	 * equal to the passed in Image <code>img</code>.
	 *
	...
	/**
	 * Returns a string representation of this JLabel. This method is intended
	...
	protected String paramString() {
		...
		return super.paramString() + ",defaultIcon=" + defaultIconString + ",disabledIcon="
				...
				+ ",horizontalTextPosition=" + horizontalTextPositionString + ",iconTextGap="
				+ iconTextGap + ",labelFor=" + labelForString + ",text=" + textString
				+ ",verticalAlignment=" + verticalAlignmentString + ",verticalTextPosition="
				+ verticalTextPositionString;
	}
	...
	protected class AccessibleJLabel extends AccessibleJComponent
		...
		/**
		 * Returns the bounding box of the character at the given index in the
		...
		private Rectangle getTextRectangle() {
			...
			paintViewR.width = JLabel.this.getWidth()
					- (paintViewInsets.left + paintViewInsets.right);
			paintViewR.height = JLabel.this.getHeight()
					- (paintViewInsets.top + paintViewInsets.bottom);

			String clippedText = SwingUtilities.layoutCompoundLabel((JComponent) JLabel.this,
					getFontMetrics(getFont()), text, icon, JLabel.this.getVerticalAlignment(),
					JLabel.this.getHorizontalAlignment(), JLabel.this.getVerticalTextPosition(),
					JLabel.this.getHorizontalTextPosition(), paintViewR, paintIconR, paintTextR,
