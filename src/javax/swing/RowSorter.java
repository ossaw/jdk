...
public abstract class RowSorter<M> {
    ...
    /**
     * Reverses the sort order of the specified column. It is up to subclasses
     * to provide the exact behavior when invoked. Typically this will reverse
     * the sort order from ascending to descending (or descending to ascending)
     * if the specified column is already the primary sorted column; otherwise,
     * makes the specified column the primary sorted column, with an ascending
     * sort order. If the specified column is not sortable, this method has no
     * effect.
     * <p>
    ...
    /**
     * Returns the location of <code>index</code> in terms of the view. That is,
     * for the row <code>index</code> in the coordinates of the underlying model
     ...
     * non-null List} and may return an unmodifiable {@code List}. If you need
     * to change the sort keys, make a copy of the returned {@code List}, mutate
     * the copy and invoke {@code setSortKeys} with the new list.
     *
    ...
    /**
     * Returns the number of rows in the view. If the contents have been
     * filtered this might differ from the row count of the underlying model.
     *
     ...
     * example, if the number of columns in a <code>TableModel</code> changed,
    ...
    /**
     * Invoked when the contents of the underlying model have completely
     * changed. The structure of the table is the same, only the contents have
     * changed. This is typically sent when it is too expensive to characterize
     * the change in terms of the other methods.
     * <p>
     * You normally do not call this method. This method is public to allow view
     * classes to call it.
     */
     ...
     * <p>
     * The arguments give the indices of the effected range. The first argument
     * is in terms of the model before the change, and must be less than or
     * equal to the size of the model before the change. The second argument is
     * in terms of the model after the change and must be less than the size of
     * the model after the change. For example, if you have a 5-row model and
     * add 3 items to the end of the model the indices are 5, 7.
     * <p>
     * You normally do not call this method. This method is public to allow view
     * classes to call it.
     *
     ...
     * specified range (inclusive).
     * <p>
     * The arguments give the indices of the effected range and are in terms of
     * the model <b>before</b> the change. For example, if you have a 5-row
     * model and delete 3 items from the end of the model the indices are 2, 4.
     * <p>
     * You normally do not call this method. This method is public to allow view
     * classes to call it.
     *
    ...
    /**
     * Invoked when the column in the rows have been updated in the underlying
     * model between the specified range.
     * <p>
     * You normally do not call this method. This method is public to allow view
     * classes to call it.
     *
    ...
    /**
     * Adds a <code>RowSorterListener</code> to receive notification about this
     * <code>RowSorter</code>. If the same listener is added more than once it
     * will receive multiple notifications. If <code>l</code> is
    ...
    /**
     * Removes a <code>RowSorterListener</code>. If <code>l</code> is
     * <code>null</code> nothing is done.
     *
     * @param l
     *          the <code>RowSorterListener</code>
    ...
    /**
     * SortKey describes the sort order for a particular column. The column
     * index is in terms of the underlying model, which may differ from that of
     * the view.
     *
     * @since 1.6
     */
    public static class SortKey {
        ...
        /**
         * Returns true if this object equals the specified object. If the
         * specified object is a <code>SortKey</code> and references the same
