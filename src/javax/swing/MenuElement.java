...
public interface MenuElement {
	 ...
	 * with source being the receiving element's component. <code>path</code> is
	 * the path of the receiving element in the menu hierarchy including the
	 * receiving element itself. <code>manager</code> is the
	 * <code>MenuSelectionManager</code> for the menu hierarchy. This method
	 * should process the <code>MouseEvent</code> and change the menu selection
	 * if necessary by using <code>MenuSelectionManager</code>'s API Note: you
	 * do not have to forward the event to sub-components. This is done
