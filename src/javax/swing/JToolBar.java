 ...
 * "https://docs.oracle.com/javase/tutorial/uiswing/components/toolbar.html">How
...
public class JToolBar extends JComponent implements SwingConstants, Accessible {
    ...
    /**
     * Notification from the <code>UIFactory</code> that the L&amp;F has
     * changed. Called to replace the UI with the latest version from the
     * <code>UIFactory</code>.
     *
    ...
    /**
     * Returns the index of the specified component. (Note: Separators occupy
     * index positions.)
     *
     * @param c
    ...
    /**
     * Sets the margin between the tool bar's border and its buttons. Setting to
     * <code>null</code> causes the tool bar to use the default margins. The
     * tool bar's default <code>Border</code> object uses this value to create
     * the proper margin. However, if a non-default border is set on the tool
     * bar, it is that <code>Border</code> object's responsibility to create the
     * appropriate margin space (otherwise this property will effectively be
     * ignored).
     *
     * @param m
     ...
     * if the border should be painted. The default value for this property is
     * <code>true</code>. Some look and feels might not implement painted
    ...
    /**
     * Sets the <code>floatable</code> property, which must be <code>true</code>
     * for the user to move the tool bar. Typically, a floatable tool bar can be
     * dragged into a different position within the same container or out into
     * its own window. The default value of this property is <code>true</code>.
     * Some look and feels might not implement floatable tool bars; they will
    ...
    /**
     * Sets the orientation of the tool bar. The orientation must have either
    ...
    /**
     * Appends a separator of default size to the end of the tool bar. The
     * default size is determined by the current look and feel.
     */
     ...
     * <code>Action</code>s added to the <code>JToolBar</code>. The default name
     ...
     * updates the control as changes to the <code>Action</code> occur, or
     * <code>null</code> if the default property change listener for the control
     * is desired.
     *
    ...
    /**
     * If a <code>JButton</code> is being added, it is initially set to be
     * disabled.
     *
     * @param comp
    ...
    /**
     * Returns a string representation of this <code>JToolBar</code>. This
    ...
    private class DefaultToolBarLayout implements LayoutManager2, Serializable, PropertyChangeListener,
            UIResource {
    ...
    /**
     * Gets the AccessibleContext associated with this JToolBar. For tool bars,
     * the AccessibleContext takes the form of an AccessibleJToolBar. A new
     * AccessibleJToolBar instance is created if necessary.
     *
     * @return an AccessibleJToolBar that serves as the AccessibleContext of
     *         this JToolBar
     */
    ...
    /**
     * This class implements accessibility support for the <code>JToolBar</code>
     * class. It provides an implementation of the Java Accessibility API
     * appropriate to toolbar user-interface elements.
     */
    protected class AccessibleJToolBar extends AccessibleJComponent {
        ...
        public AccessibleStateSet getAccessibleStateSet() {
            ...
            // FIXME: [[[WDW - need to do SELECTABLE if SelectionModel is
            // added]]]
            return states;
        }
