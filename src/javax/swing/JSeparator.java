...
public class JSeparator extends JComponent implements SwingConstants, Accessible {
	 ...
	 *           SwingConstants.HORIZONTAL VERTICAL SwingConstants.VERTICAL
	 *           attribute: visualUpdate true description: The orientation of
	 *           the separator.
	 */
	...
	/**
	 * Returns a string representation of this <code>JSeparator</code>. This
	...
	/**
	 * Gets the AccessibleContext associated with this JSeparator. For
	 * separators, the AccessibleContext takes the form of an
	 * AccessibleJSeparator. A new AccessibleJSeparator instance is created if
	 * necessary.
	 *
	 * @return an AccessibleJSeparator that serves as the AccessibleContext of
	 *         this JSeparator
	 */
	 ...
	 * <code>JSeparator</code> class. It provides an implementation of the Java
	 * Accessibility API appropriate to separator user-interface elements.
	 * <p>
	 * <strong>Warning:</strong> Serialized objects of this class will not be
