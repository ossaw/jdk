...
public interface TableColumnModel {
	 ...
	 * array. This method posts a <code>columnAdded</code> event to its
	 * listeners.
	 *
	 * @param aColumn
	 ...
	 * <code>column</code> is not in the table's column list. This method posts
	 ...
	 * <code>newIndex</code>. This method posts a <code>columnMoved</code> event
	 * to its listeners.
	 *
	 * @param columnIndex
	 ...
	 *                if <code>columnIndex</code> or <code>newIndex</code> are
	 ...
	 * <code>newMargin</code>. This method posts a
	...
	/**
	 * Returns the index of the first column in the table whose identifier is
	 ...
	 * 
	 * @return an array of integers containing the indicies of all selected
	 *         columns; or an empty array if nothing is selected
	 */
