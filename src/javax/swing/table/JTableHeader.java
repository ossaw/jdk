...
public class JTableHeader extends JComponent implements TableColumnModelListener, Accessible {
    ...
    /**
     * If true, reordering of columns are allowed by the user; the default is
     * true.
     */
    protected boolean reorderingAllowed;

    /**
     * If true, resizing of columns are allowed by the user; the default is
     * true.
     */
     ...
     */
    /*
     * If this flag is true, then the header will repaint the table as a column
     * is dragged or resized; the default is true.
     */
    ...
    /**
     * The default renderer to be used when a <code>TableColumn</code> does not
     ...
     *        true if the table view should allow reordering;
     *        otherwise
     *        false
     * @see #getReorderingAllowed
     * @beaninfo bound: true description: Whether the user can drag column
     ...
     * @beaninfo bound: true description: Whether the user can resize columns by
     *           dragging between headers.
     */
     ...
     *
     * @return the dragged column, if a drag is in process, otherwise returns
     *         <code>null</code>
    ...
    /**
     * Returns the column's horizontal distance from its original position, if
     * and only if, a drag is in process. Otherwise, the the return value is
     * meaningless.
     *
     * @return the column's horizontal distance from its original position, if a
     *         drag is in process, otherwise the return value is meaningless
    ...
    /**
     * Returns the resizing column. If no column is being resized this method
     * returns <code>null</code>.
     *
     * @return the resizing column, if a resize is in process, otherwise returns
     *         <code>null</code>
     */
     ...
     */
    /*
     * Sets whether the body of the table updates in real time when a column is
     * resized or dragged.
     * @param flag true if tableView should update the body of the table in real
     * time
     ...
     */
    /*
     * Returns true if the body of the table view updates in real time when a
     * column is resized or dragged. User can set this flag to false to speed up
     * the table's response to user resize or drag actions. The default is true.
     ...
     * defined by a <code>TableColumn</code>.
     * 
     ...
     * When the <code>column</code> parameter is out of bounds this method uses
     ...
     * 
     * @param event
     *        the location of the event identifies the proper renderer
     *        and,
    ...
    public String getToolTipText(MouseEvent event) {
        ...
        if ((column = columnAtPoint(p)) != -1) {
            ...
            Component component = renderer.getTableCellRendererComponent(getTable(), aColumn.getHeaderValue(),
            ...
            if (component instanceof JComponent) {
                ...
                newEvent = new MouseEvent(component, event.getID(), event.getWhen(), event.getModifiers(),
                        p.x, p.y, event.getXOnScreen(), event.getYOnScreen(), event.getClickCount(), event
     ...
     * registers for listener notifications from the new column model.
     *
     * @param columnModel
     ...
     * changed. This method currently has no effect (the header is not redrawn).
     * <p>
     * Application code will not use these methods explicitly, they are used
     * internally by <code>JTable</code>.
     *
     ...
     *
     * @param aColumn
     *        the column being dragged, or <code>null</code> if no
     *        column is
     *        being dragged
     */
     ...
     * <p>
     * Application code will not use this method explicitly, it is used
     * internally by the column sizing mechanism.
     *
     * @param aColumn
     *        the column being resized, or <code>null</code> if no
     *        column is
     *        being resized
     */
    ...
    /**
     * Returns a string representation of this <code>JTableHeader</code>. This
    ...
    protected String paramString() {
        ...
        return super.paramString() + ",draggedDistance=" + draggedDistance + ",reorderingAllowed="
                + reorderingAllowedString + ",resizingAllowed=" + resizingAllowedString
    ...
    protected class AccessibleJTableHeader extends AccessibleJComponent {
        ...
        public Accessible getAccessibleAt(Point p) {
            ...
            if ((column = JTableHeader.this.columnAtPoint(p)) != -1) {
                ...
                Component component = renderer.getTableCellRendererComponent(JTableHeader.this.getTable(),
         ...
         * appropriate for JTableHeader entries.
         */
        protected class AccessibleJTableHeaderEntry extends AccessibleContext implements Accessible,
                AccessibleComponent {
            ...
            private AccessibleContext getCurrentAccessibleContext() {
                ...
                if (tcm != null) {
                    ...
                    Component c = renderer.getTableCellRendererComponent(JTableHeader.this.getTable(), aColumn
            ...
            private Component getCurrentComponent() {
                ...
                if (tcm != null) {
                    ...
                    return renderer.getTableCellRendererComponent(JTableHeader.this.getTable(), aColumn
                            .getHeaderValue(), false, false, -1, column);
                } else {
                    return null;
                }
