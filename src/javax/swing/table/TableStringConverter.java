 ...
 * This is useful in filtering and searching when the model returns objects that
 * do not have meaningful <code>toString</code> implementations.
 *
 * @since 1.6
 */
public abstract class TableStringConverter {
	 ...
	 *
	 * @param model
	 *            the <code>TableModel</code> to fetch the value from
	 * @param row
	 ...
	 *             if the arguments are outside the bounds of the model
	 */
