...
public class DefaultTableColumnModel implements TableColumnModel,
    ...
    /**
     * Appends <code>aColumn</code> to the end of the <code>tableColumns</code>
     * array. This method also posts the <code>columnAdded</code> event to its
     * listeners.
     *
     * @param aColumn
     *                the <code>TableColumn</code> to be added
     * @exception IllegalArgumentException
     *                                     if <code>aColumn</code> is
     *                                     <code>null</code>
     * @see #removeColumn
     */
    public void addColumn(TableColumn aColumn) {
        ...
        fireColumnAdded(new TableColumnModelEvent(this, 0, getColumnCount()
                - 1));
    }

    /**
     * Deletes the <code>column</code> from the <code>tableColumns</code> array.
     * This method will do nothing if <code>column</code> is not in the table's
     * columns list. <code>tile</code> is called to resize both the header and
     * table views. This method also posts a <code>columnRemoved</code> event to
     * its listeners.
     *
     * @param column
     ...
     * <code>newIndex</code>. The old column at <code>columnIndex</code> will
     * now be found at <code>newIndex</code>. The column that used to be at
     * <code>newIndex</code> is shifted left or right to make room. This will
     * not move any columns if <code>columnIndex</code> equals
     * <code>newIndex</code>. This method also posts a <code>columnMoved</code>
     ...
     * @exception IllegalArgumentException
     *                                     if <code>column</code> or
     *                                     <code>newIndex</code> are not in
     *                                     the valid range
     */
    ...
    /**
     * Sets the column margin to <code>newMargin</code>. This method also posts
     ...
     * array whose identifier is equal to <code>identifier</code>, when compared
     * using <code>equals</code>.
     *
     * @param identifier
     *                   the identifier object
     * @return the index of the first column in the <code>tableColumns</code>
    ...
    /**
     * Returns the width margin for <code>TableColumn</code>. The default
     * <code>columnMargin</code> is 1.
     *
    ...
    /**
     * Returns the index of the column that lies at position <code>x</code>, or
     * -1 if no column covers this point.
     *
     ...
     * object using this model (typically JTable). The view/controller need not
     * display the columns sequentially from left to right. For example, columns
     * could be displayed from right to left to accommodate a locale preference
     * or some columns might be hidden at the request of the user. Because the
     * model does not know how the columns are laid out on screen, the given
     * <code>xPosition</code> should not be considered to be a coordinate in 2D
     * graphics space. Instead, it should be considered to be a width from the
     * start of the first column in the model. If the column index for a given X
     * coordinate in 2D space is required, <code>JTable.columnAtPoint</code> can
     * be used instead.
     *
     * @param x
    ...
    // implements javax.swing.table.TableColumnModel
    /**
     * Returns true if column selection is allowed, otherwise false. The default
     * is false.
     * 
    ...
    // implements javax.swing.table.TableColumnModel
    /**
     * Returns an array of selected columns. If <code>selectionModel</code> is
     * <code>null</code>, returns an empty array.
     * 
     * @return an array of selected columns or an empty array if nothing is
     *         selected or the <code>selectionModel</code> is <code>null</code>
     */
     ...
     *         <code>ColumnModelListener</code>s or an empty array if no column
     ...
     * you can query a <code>DefaultTableColumnModel</code> <code>m</code> for
     * its column model listeners with the following code:
     *
     * <pre>
     * ColumnModelListener[] cmls = (ColumnModelListener[]) (m.getListeners(
     *         ColumnModelListener.class));
     * </pre>
     *
     ...
     * column width or preferred column width.
     *
     * @param evt
    ...
    protected void recalcWidthCache() {
        ...
        totalColumnWidth = 0;
        while (enumeration.hasMoreElements()) {
            totalColumnWidth += ((TableColumn) enumeration.nextElement())
                    .getWidth();
        }
    }
