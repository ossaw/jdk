...
/**
 * This class provides the ChangeListener part of the SpinnerModel interface
 * that should be suitable for most concrete SpinnerModel implementations.
 * Subclasses must provide an implementation of the <code>setValue</code>,
 * <code>getValue</code>, <code>getNextValue</code> and
...
public abstract class AbstractSpinnerModel implements SpinnerModel,
     ...
     * this model. For example to find all of the ChangeListeners added to this
     * model:
     * 
     * <pre>
