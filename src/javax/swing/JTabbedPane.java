 ...
 * How to Use Tabbed Panes</a>, a section in <em>The Java Tutorial</em>.
 * <p>
...
public class JTabbedPane extends JComponent implements Serializable, Accessible, SwingConstants {
    ...
    /**
     * Tab layout policy for providing a subset of available tabs when all the
     * tabs will not fit within a single run. If all the tabs do not fit within
     * a single run the look and feel will provide a way to navigate to hidden
     * tabs.
     */
    ...
    /**
     * The <code>changeListener</code> is the listener we add to the model.
     */
     ...
     *        the policy for laying out tabs when all tabs will
     *        not fit on
     *        one run
     * @exception IllegalArgumentException
     *            if tab placement or tab layout policy
     *            are not one of the
     ...
     *           description: The UI object that implements the tabbedpane's
     *           LookAndFeel
     */
    ...
    /**
     * We pass <code>ModelChanged</code> events along to the listeners with the
     ...
     * override this to return a subclass of <code>ModelListener</code> or
    ...
    protected void fireStateChanged() {
        ...
        /*
         * This code deals with changing the visibility of components to hide
         * and show the contents for the selected tab. It duplicates logic
         * already present in BasicTabbedPaneUI, logic that is processed during
         * the layout pass. This code exists to allow developers to do things
         * that are quite difficult to accomplish with the previous model of
         * waiting for the layout pass to process visibility changes; such as
         * requesting focus on the new visible component.
         * For the average code, using the typical JTabbedPane methods, all
         * visibility changes will now be processed here. However, the code in
         * BasicTabbedPaneUI still exists, for the purposes of backward
         * compatibility. Therefore, when making changes to this code, ensure
         * that the BasicTabbedPaneUI code is kept in synch.
         */
        ...
        if (selIndex < 0) {
            ...
            if (newComp != null && newComp != visComp) {
                 ...
                 * should continue to show the previously visible component if
                 * there is no component for the chosen tab.
                 */
     ...
     * @see #getModel
     * @beaninfo bound: true description: The tabbedpane's SingleSelectionModel.
     */
     ...
     *        the placement for the tabs relative to the content
     * @exception IllegalArgumentException
     *            if tab placement value isn't one of
     *            the above valid values
     * @beaninfo preferred: true bound: true attribute: visualUpdate true enum:
     *           TOP JTabbedPane.TOP LEFT JTabbedPane.LEFT BOTTOM
     *           JTabbedPane.BOTTOM RIGHT JTabbedPane.RIGHT description: The
     *           tabbedpane's tab placement.
     */
    ...
    /**
     * Sets the policy which the tabbedpane will use in laying out the tabs when
     * all the tabs will not fit within a single run. Possible values are:
     * <ul>
     ...
     * <code>JTabbedPane.WRAP_TAB_LAYOUT</code>.
     * <p>
     ...
     * @exception IllegalArgumentException
     *            if layoutPolicy value isn't one of
     *            the above valid values
     * @see #getTabLayoutPolicy
     * @since 1.4
     * @beaninfo preferred: true bound: true attribute: visualUpdate true enum:
     *           WRAP_TAB_LAYOUT JTabbedPane.WRAP_TAB_LAYOUT SCROLL_TAB_LAYOUT
     *           JTabbedPane.SCROLL_TAB_LAYOUT description: The tabbedpane's
     *           policy for laying out the tabs
     */
     ...
     * @beaninfo preferred: true description: The tabbedpane's selected tab
     *           index.
     */
    ...
    private void changeAccessibleSelection(Page oldPage, String oldName, Page newPage) {
        ...
        if (oldPage != null) {
            oldPage.firePropertyChange(AccessibleContext.ACCESSIBLE_STATE_PROPERTY, AccessibleState.SELECTED,
                    null);
        }

        if (newPage != null) {
            newPage.firePropertyChange(AccessibleContext.ACCESSIBLE_STATE_PROPERTY, null,
                    AccessibleState.SELECTED);
        }

        accessibleContext.firePropertyChange(AccessibleContext.ACCESSIBLE_NAME_PROPERTY, oldName,
                accessibleContext.getAccessibleName());
    }

    /**
     * Returns the currently selected component for this tabbedpane. Returns
     * <code>null</code> if there is no currently selected tab.
     *
    ...
    /**
     * Sets the selected component for this tabbedpane. This will automatically
     ...
     * @beaninfo preferred: true description: The tabbedpane's selected
     *           component.
     */
    ...
    public void insertTab(String title, Icon icon, Component component, String tip, int index) {
        ...
        pages.add(newIndex, new Page(this, title != null ? title : "", icon, null, component, tip));
        ...
        if (accessibleContext != null) {
            accessibleContext.firePropertyChange(AccessibleContext.ACCESSIBLE_VISIBLE_DATA_PROPERTY, null,
                    component);
        }
        revalidate();
        repaint();
    ...
    /**
     * Adds a <code>component</code> and <code>tip</code> represented by a
     * <code>title</code> and/or <code>icon</code>, either of which can be
     * <code>null</code>. Cover method for <code>insertTab</code>.
     *
     * @param title
     ...
     * <code>icon</code>, either of which can be <code>null</code>. Cover method
     * for <code>insertTab</code>.
     *
     * @param title
     *        the title to be displayed in this tab
     * @param icon
    ...
    /**
     * Adds a <code>component</code> represented by a <code>title</code> and no
     * icon. Cover method for <code>insertTab</code>.
     *
     * @param title
     *        the title to be displayed in this tab
     * @param component
    ...
    /**
     * Adds a <code>component</code> with a tab title defaulting to the name of
     * the component which is the result of calling
     * <code>component.getName</code>. Cover method for <code>insertTab</code>.
     *
     * @param component
     *        the component to be displayed when this tab is clicked
    ...
    /**
     * Adds a <code>component</code> with the specified tab title. Cover method
     * for <code>insertTab</code>.
     *
     * @param title
     *        the title to be displayed in this tab
    ...
    /**
     * Adds a <code>component</code> at the specified tab index with a tab title
     * defaulting to the name of the component. Cover method for
     * <code>insertTab</code>.
     *
     * @param component
     *        the component to be displayed when this tab is clicked
    ...
    /**
     * Adds a <code>component</code> to the tabbed pane. If
     * <code>constraints</code> is a <code>String</code> or an <code>Icon</code>
     * , it will be used for the tab title, otherwise the component's name will
     * be used as the tab title. Cover method for <code>insertTab</code>.
     *
     * @param component
     *        the component to be displayed when this tab is clicked
     * @param constraints
    ...
    /**
     * Adds a <code>component</code> at the specified tab index. If
     * <code>constraints</code> is a <code>String</code> or an <code>Icon</code>
     * , it will be used for the tab title, otherwise the component's name will
     * be used as the tab title. Cover method for <code>insertTab</code>.
     *
    ...
    /**
     * Removes the tab at <code>index</code>. After the component associated
     * with <code>index</code> is removed, its visibility is reset to true to
     * ensure it will be visible if added to other containers.
     * 
     * @param index
    ...
    public void removeTabAt(int index) {
        ...
        if (accessibleContext != null) {
            ...
            if (index == selected) {
                ...
                pages.get(index).firePropertyChange(AccessibleContext.ACCESSIBLE_STATE_PROPERTY,
        ...
        if (selected > index) {
            ...
            setSelectedIndexImpl(selected - 1, false);
            Page newSelected = (selected != 0) ? pages.get(selected - 1) : null;
     ...
     * <code>JTabbedPane</code>. The method does nothing if the
     ...
     *         <code>tabPlacement</code> is <code>TOP</code> or
     *         <code>BOTTOM</code> and the number of columns if
     *         <code>tabPlacement</code> is <code>LEFT</code> or
    ...
    /**
     * Returns the tab disabled icon at <code>index</code>. If the tab disabled
     * icon doesn't exist at <code>index</code> this will forward the call to
     * the look and feel to construct an appropriate disabled Icon from the
     * corresponding enabled Icon. Some look and feels might not render the
     * disabled Icon, in which case it won't be created.
     *
     * @param index
     *        the index of the item being queried
     * @return the icon at <code>index</code>
    ...
    /**
     * Returns the keyboard mnemonic for accessing the specified tab. The
     * mnemonic is the key which when combined with the look and feel's
     * mouseless modifier (usually Alt) will activate the specified tab.
     *
     * @since 1.4
     * @param tabIndex
     *        the index of the tab that the mnemonic refers to
     * @return the key code which represents the mnemonic; -1 if a mnemonic is
     *         not specified for the tab
     * @exception IndexOutOfBoundsException
     *            if index is out of range
     ...
     * @param tabIndex
     *        the index of the tab that the mnemonic refers to
     * @return index representing mnemonic character if one exists; otherwise
     *         returns -1
     * @exception IndexOutOfBoundsException
     *            if index is out of range
     *            (<code>tabIndex</code> &lt; 0 ||
    ...
    /**
     * Returns the tab bounds at <code>index</code>. If the tab at this index is
     * not currently visible in the UI, then returns <code>null</code>. If there
     * is no UI set on this <code>tabbedpane</code>, then returns
     * <code>null</code>.
     *
     * @param index
     ...
     *         <code>index</code> is not currently visible in the UI, or if
     *         there is no UI set on this <code>tabbedpane</code>
     * @exception IndexOutOfBoundsException
     *            if index is out of range
     *            {@code (index < 0 || index >= tab count)}
     */
    ...
    /**
     * Sets the title at <code>index</code> to <code>title</code> which can be
     * <code>null</code>. The title is not shown if a tab component for this tab
     * was specified. An internal exception is raised if there is no tab at that
     * index.
     *
     * @param index
     ...
     * @beaninfo preferred: true attribute: visualUpdate true description: The
     *           title at the specified tab index.
     */
    public void setTitleAt(int index, String title) {
        ...
        if ((oldTitle != title) && (accessibleContext != null)) {
            accessibleContext.firePropertyChange(AccessibleContext.ACCESSIBLE_VISIBLE_DATA_PROPERTY, oldTitle,
                    title);
        }
     ...
     * If the new Icon is different than the current Icon and disabled icon is
     * not explicitly set, the LookAndFeel will be asked to generate a disabled
     * Icon. To explicitly set disabled icon, use
     * <code>setDisableIconAt()</code>. The icon is not shown if a tab component
     * for this tab was specified. An internal exception is raised if there is
     ...
     * @see #setTabComponentAt
     * @beaninfo preferred: true attribute: visualUpdate true description: The
     *           icon at the specified tab index.
     */
    public void setIconAt(int index, Icon icon) {
        ...
        if (icon != oldIcon) {
            ...
            /*
             * If the default icon has really changed and we had generated the
             * disabled icon for this page, then clear the disabledIcon field of
             * the page.
             */
     ...
     * @see #getDisabledIconAt
     * @beaninfo preferred: true attribute: visualUpdate true description: The
     *           disabled icon at the specified tab index.
     */
     ...
     * @beaninfo preferred: true description: The tooltip text at the specified
     *           tab index.
     * @since 1.3
     */
     ...
     * <code>background</code> which can be <code>null</code>, in which case the
     * tab's background color will default to the background color of the
     * <code>tabbedpane</code>. An internal exception is raised if there is no
     * tab at that index.
     * <p>
     ...
     * @see #getBackgroundAt
     * @beaninfo preferred: true attribute: visualUpdate true description: The
     *           background color at the specified tab index.
     */
     ...
     * <code>foreground</code> which can be <code>null</code>, in which case the
     * tab's foreground color will default to the foreground color of this
     * <code>tabbedpane</code>. An internal exception is raised if there is no
     * tab at that index.
     * <p>
     * It is up to the look and feel to honor this property, some may choose to
     ...
     * @see #getForegroundAt
     * @beaninfo preferred: true attribute: visualUpdate true description: The
     *           foreground color at the specified tab index.
     */
    ...
    /**
     * Sets the component at <code>index</code> to <code>component</code>. An
     ...
     *            {@code (index < 0 || index >= tab count)}
     * @see #getComponentAt
     * @beaninfo attribute: visualUpdate true description: The component at the
     *           specified tab index.
     */
    public void setComponentAt(int index, Component component) {
        ...
        if (component != page.component) {
            ...
            if (page.component != null) {
                ...
                // why not if (page.component.getParent() == this)
                // remove(component)
     ...
     *        the index of the tab that the mnemonic refers to
     * @param mnemonicIndex
     *        index into the <code>String</code> to underline
     * @exception IndexOutOfBoundsException
     *            if <code>tabIndex</code> is out of
     *            range (
     *            {@code tabIndex < 0 || tabIndex >= tab
     *            count} )
     * @exception IllegalArgumentException
     *            will be thrown if
     *            <code>mnemonicIndex</code> is &gt;=
     ...
     * <code>java.awt.event.KeyEvent</code> or one of the extended keycodes
     * obtained through
     * <code>java.awt.event.KeyEvent.getExtendedKeyCodeForChar</code>. Mnemonics
     * are case-insensitive, therefore a key event with the corresponding
     ...
     *            if <code>tabIndex</code> is out of
     *            range (
     *            {@code tabIndex < 0 || tabIndex >= tab count})
     * @see #getMnemonicAt(int)
     * @see #setDisplayedMnemonicIndexAt(int,int)
     * @beaninfo bound: true attribute: visualUpdate true description: The
     *           keyboard mnenmonic, as a KeyEvent VK constant, for the
     *           specified tab
     */
    ...
    /**
     * Returns the first tab index with a given <code>title</code>, or -1 if no
     * tab has this title.
     *
     * @param title
     *        the title for the tab
     * @return the first tab index which matches <code>title</code>, or -1 if no
     *         tab has this title
     */
    ...
    /**
     * Returns the first tab index with a given <code>icon</code>, or -1 if no
     * tab has this icon.
     *
     * @param icon
     *        the icon for the tab
     * @return the first tab index which matches <code>icon</code>, or -1 if no
     *         tab has this icon
     */
     ...
     * @param component
     *        the component for the tab
     * @return the first tab which matches this component, or -1 if there is no
     ...
     * @return the tab index which intersects the location, or -1 if no tab
     ...
     *
     * @param event
     *        the <code>MouseEvent</code> that tells where the cursor is
     *        lingering
     ...
     * <code>EnableSerializationFocusListener</code> to do any Swing-specific
    ...
    /**
     * Returns a string representation of this <code>JTabbedPane</code>. This
    ...
    protected String paramString() {
        ...
        return super.paramString() + ",haveRegistered=" + haveRegisteredString + ",tabPlacement="
                + tabPlacementString;
    }
    ...
    /**
     * Gets the AccessibleContext associated with this JTabbedPane. For tabbed
     * panes, the AccessibleContext takes the form of an AccessibleJTabbedPane.
     * A new AccessibleJTabbedPane instance is created if necessary.
     *
     * @return an AccessibleJTabbedPane that serves as the AccessibleContext of
     *         this JTabbedPane
     */
     ...
     * <code>JTabbedPane</code> class. It provides an implementation of the Java
     * Accessibility API appropriate to tabbed pane user-interface elements.
     * <p>
     * <strong>Warning:</strong> Serialized objects of this class will not be
     ...
     */
    protected class AccessibleJTabbedPane extends AccessibleJComponent implements AccessibleSelection,
            ChangeListener {

        /**
         * Returns the accessible name of this object, or {@code null} if there
         ...
         * object. In the implementation of the Java Accessibility API for this
         * class, returns this object, which is responsible for implementing the
         ...
         * coordinate <code>Point</code>, if one exists. Otherwise returns the
        ...
        public Accessible getAccessibleAt(Point p) {
            int tab = ((TabbedPaneUI) ui).tabForCoordinate(JTabbedPane.this, p.x, p.y);
            if (tab == -1) {
    ...
    private class Page extends AccessibleContext implements Serializable, Accessible, AccessibleComponent {
        ...
        Page(JTabbedPane parent, String title, Icon icon, Icon disabledIcon, Component component,
                String tip) {
            this.title = title;
            this.icon = icon;
        ...
        void initAccessibleContext() {
            if (JTabbedPane.this.accessibleContext != null && component instanceof Accessible) {
                /*
                 * Do initialization if the AccessibleJTabbedPane has been
                 * instantiated. We do not want to load Accessibility classes
                 * unnecessarily.
                 */
        ...
        void setDisplayedMnemonicIndex(int mnemonicIndex) {
            if (this.mnemonicIndex != mnemonicIndex) {
                if (mnemonicIndex != -1 && (title == null || mnemonicIndex < 0 || mnemonicIndex >= title
                        .length())) {
         ...
         *
         * @return the enabled icon if one exists and the page is enabled.
         *         Otherwise, returns the disabled icon if one exists and the
         *         page is disabled. Otherwise, null is returned.
         */
        public AccessibleIcon[] getAccessibleIcon() {
            AccessibleIcon accessibleIcon = null;
            if (enabled && icon instanceof ImageIcon) {
                AccessibleContext ac = ((ImageIcon) icon).getAccessibleContext();
                accessibleIcon = (AccessibleIcon) ac;
            } else if (!enabled && disabledIcon instanceof ImageIcon) {
                AccessibleContext ac = ((ImageIcon) disabledIcon).getAccessibleContext();
                accessibleIcon = (AccessibleIcon) ac;
            }
     ...
     * specified tab. A null value means <code>JTabbedPane</code> will render
     * the title and/or icon for the specified tab. A non-null value means the
     * component will render the title and <code>JTabbedPane</code> will not
     * render the title and/or icon.
     * <p>
     * Note: The component must not be one that the developer has already added
     * to the tabbed pane.
     *
     * @param index
     *        the tab index where the component should be set
     * @param component
     *        the component to render the title for the specified tab
     * @exception IndexOutOfBoundsException
     *            if index is out of range
     *            {@code (index < 0 || index >= tab count)}
     * @exception IllegalArgumentException
     *            if component has already been added
     *            to this
     *            <code>JTabbedPane</code>
     * @see #getTabComponentAt
     * @beaninfo preferred: true attribute: visualUpdate true description: The
     *           tab component at the specified tab index.
     * @since 1.6
     */
    ...
    /**
     * Returns the index of the tab for the specified tab component. Returns -1
     * if there is no tab for this tab component.
     *
     * @param tabComponent
     *        the tab component for the tab
     * @return the first tab which matches this tab component, or -1 if there is
     *         no tab for this tab component
     * @see #setTabComponentAt
     * @see #getTabComponentAt
     * @since 1.6
     */
