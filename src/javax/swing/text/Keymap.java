...
public interface Keymap {
    ...
    /**
     * Fetches the default action to fire if a key is typed (i.e. a KEY_TYPED
     * KeyEvent is received) and there is no binding for it. Typically this
     * would be some action that inserts text so that the keymap doesn't require
     * an action for each possible key.
     *
     ...
     * This is used by JTextController to determine how to interpret key
     * sequences. If the binding is not resolved locally, an attempt is made to
     ...
     * behavior is unspecified if a {@code Keymap} has itself as one of its
     * resolve parents.
     *
     * @param parent
     *        the parent keymap
