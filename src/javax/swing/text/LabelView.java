...
/**
 * A <code>LabelView</code> is a styled chunk of text that represents a view
 * mapped over an element in the text model. It caches the character level
...
public class LabelView extends GlyphView implements TabableView {
    ...
    /**
     * Synchronize the view's cached values with the model. This causes the
     * font, metrics, color, etc to be re-cached if the cache has been
     * invalidated.
     */
    final void sync() {
        if (font == null) {
    ...
    /**
     * Sets whether or not the view is underlined. Note that this setter is
     * protected and is really only meant if you need to update some additional
     * state when set.
     *
     * @param u
    ...
    /**
     * Sets whether or not the view represents a superscript. Note that this
     * setter is protected and is really only meant if you need to update some
     * additional state when set.
     *
     * @param s
    ...
    /**
     * Sets whether or not the view represents a subscript. Note that this
     * setter is protected and is really only meant if you need to update some
     * additional state when set.
     *
     * @param s
    ...
    /**
     * Sets the background color for the view. This method is typically invoked
     * as part of configuring this <code>View</code>. If you need to customize
     * the background color you should override
     * <code>setPropertiesFromAttributes</code> and invoke this method. A value
     * of null indicates no background should be rendered, so that the
     ...
     * 
     * @deprecated FontMetrics are not used for glyph rendering when running in
     *             the JDK.
     */
    @Deprecated
    ...
    /**
     * Fetches the background color to use to render the glyphs. This is
     * implemented to return a cached background color, which defaults to
     * <code>null</code>.
     *
    ...
    /**
     * Fetches the foreground color to use to render the glyphs. This is
     * implemented to return a cached foreground color, which defaults to
     * <code>null</code>.
     *
    ...
    /**
     * Fetches the font that the glyphs should be based upon. This is
     * implemented to return a cached font.
     *
     ...
     * <code>AttributeSet</code> does not have this property set, it will revert
     * to false.
     *
