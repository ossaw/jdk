...
/**
 * FormSubmitEvent is used to notify interested parties that a form was
 * submitted.
 *
 * @since 1.5
...
public class FormSubmitEvent extends HTMLFrameHyperlinkEvent {
     ...
     */
    FormSubmitEvent(Object source, EventType type, URL targetURL, Element sourceElement, String targetFrame,
     ...
     *
     * @return the form method type, either <code>Method.GET</code> or
