...
/* public */ class TableView extends BoxView implements ViewFactory {
    ...
    protected void setPropertiesFromAttributes() {
        ...
        if (attr != null) {
            ...
            CSS.LengthValue lv = (CSS.LengthValue) attr.getAttribute(
            ...
            lv = (CSS.LengthValue) attr.getAttribute(
        ...
        if (!gridValid) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                if (v instanceof RowView) {
                    ...
                    Object o = v.getElement().getAttributes().getAttribute(
                            StyleConstants.NameAttribute);
            ...
            for (int row = 0; row < nrows; row++) {
                ...
                for (int cell = 0; cell < rv.getViewCount(); cell++, col++) {
                    ...
                    if (!relativeCells) {
                        ...
                        CSS.LengthValue lv = (CSS.LengthValue) a.getAttribute(
                                CSS.Attribute.WIDTH);
     ...
     * <a href="#layoutColumns">layoutColumns</a> method, and then forward to
     * the superclass to actually carry out the layout of the tables rows.
     *
     * @param targetSpan
    ...
    class ColumnIterator implements CSS.LayoutIterator {
         ...
         */
        public void setLayoutArrays(int offsets[], int spans[],
                int targetSpan) {
    ...
    class RowIterator implements CSS.LayoutIterator {
        ...
        /**
         * Fixup preferences to accommodate a multi-row table cell if not
         * already covered by existing preferences. This is a no-op if not all
        ...
        protected void layoutMinorAxis(int targetSpan, int axis, int[] offsets,
            ...
            for (int cell = 0; cell < ncells; cell++, col++) {
                ...
                if (rowSpan > 1) {
                    ...
                    int row0 = rowIndex;
                    int row1 = Math.min(rowIndex + rowSpan - 1, getRowCount()
                            - 1);
    ...
    class CellView extends BlockView {
            ...
            if (used < targetSpan) {
                ...
                if (valign == null) {
                    AttributeSet rowAttr = getElement().getParentElement()
                            .getAttributes();
                    valign = (String) rowAttr.getAttribute(
        ...
        protected SizeRequirements calculateMajorAxisRequirements(int axis,
                SizeRequirements r) {
            SizeRequirements req = super.calculateMajorAxisRequirements(axis,
                    r);
            req.maximum = Integer.MAX_VALUE;
            return req;
        }
