...
class HRuleView extends View {
	...
	public void paint(Graphics g, Shape a) {
		...
		int height = alloc.height
				- (SPACE_ABOVE + SPACE_BELOW + (int) topMargin + (int) bottomMargin);
		if (size > 0)
			height = size;
	...
	/**
	 * Calculates the desired shape of the rule... this is basically the
	...
	/**
	 * Gets the resize weight for the axis. The rule is: rigid vertically and
	...
	/**
	 * Determines how attractive a break opportunity in this view is. This is
