...
public class ParagraphView extends javax.swing.text.ParagraphView {
     ...
     * {@link #setPropertiesFromAttributes setPropertiesFromAttributes} method
     * to set the paragraph properties from the css attributes. The call is made
     * at this time to ensure the ability to resolve upward through the parents
     * view attributes.
     *
     * @param parent
     ...
     * <p>
     * If size requirements are explicitly specified for the paragraph, use that
     * requirements. Otherwise, use the requirements of the superclass
     * {@link javax.swing.text.ParagraphView}.
     * </p>
     * <p>
     ...
     * object is created, otherwise the supplied {@code SizeRequirements} object
     * is returned.
     * </p>
     *
     * @param axis
     ...
     * is implemented to delegate to the superclass after stashing the base
