...
class AccessibleHTML implements Accessible {
    ...
    /**
     * If possible acquires a lock on the Document. If a lock has been obtained
     * a key will be retured that should be passed to <code>unlock</code>.
     */
    private Object lock() {
    ...
    private class RootHTMLAccessibleContext extends HTMLAccessibleContext {
         ...
         * that act like a push button) as well as distinguish between
         * subclasses that behave differently (e.g., AccessibleRole.CHECK_BOX
         * for check boxes and AccessibleRole.RADIO_BUTTON for radio buttons).
         * <p>
     ...
     */
    protected abstract class HTMLAccessibleContext extends AccessibleContext implements Accessible,
            AccessibleComponent {
        ...
        /**
         * Determines if the object is enabled. Objects that are enabled will
         ...
         * because one of the objects that this object is contained by is
         * currently not visible. To determine if an object is showing on the
         * screen, use isShowing().
         * <p>
         ...
         * the visibility of the object and its ancestors. Note: this will
         * return true even if the object is obscured by another (for example,
         ...
         *
         * @return the location of the object on screen; null if this object is
         *         not on the screen
         * @see #getBounds
         * @see #getLocation
         */
         ...
         *         object's bounds in the coordinate space of the screen; null
         ...
         * its parent.
         *
         * @return A rectangle indicating this component's bounds; null if this
        ...
        /**
         * Sets the bounds of this object in the form of a Rectangle object. The
         * bounds specify this object's width, height, and location relative to
         * its parent.
         *
         * @param r
         ...
         * accept focus will also have the AccessibleState.FOCUSABLE state set
         * in their AccessibleStateSets.
         *
    ...
    class TextElementInfo extends ElementInfo implements Accessible {
        ...
        public class TextAccessibleContext extends HTMLAccessibleContext implements AccessibleText {
             ...
             * Gets the accessibleDescription property of this object. If this
             * property isn't set, returns the content type of this
             * <code>JEditorPane</code> instead (e.g. "plain/text",
             * "html/text").
             *
             ...
             * of the character under that Point. If the point is invalid, this
             * method returns -1.
             *
             * @param p
             ...
             * into the string. The bounds are returned in local coordinates. If
            ...
            /**
             * IndexedSegment extends Segment adding the offset into the the
             * model the <code>Segment</code> was asked for.
             */
             ...
             * <code>direction</code> is non-null this will find the
             ...
             * paragraph or sentence as identified by <code>part</code>, or null
             * if a valid paragraph/sentence can't be found. The offset will
             * point to the start of the word/sentence in the array, and the
    ...
    private class IconElementInfo extends ElementInfo implements Accessible {
        ...
        protected class IconAccessibleContext extends HTMLAccessibleContext implements AccessibleIcon {
             ...
             * presented to a blind user to give an indication of the purpose of
             * the icon.
             *
    ...
    /**
     * TableElementInfo encapsulates information about a HTML.Tag.TABLE. To make
     * access fast it crates a grid containing the children to allow for access
     * by row, column. TableElementInfo will contain TableRowElementInfos, which
     * will contain TableCellElementInfos. Any time one of the rows or columns
     * becomes invalid the table is invalidated. This is because any time one of
     * the child attributes changes the size of the grid may have changed.
     */
    private class TableElementInfo extends ElementInfo implements Accessible {
        ...
        public class TableAccessibleContext extends HTMLAccessibleContext implements AccessibleTable {
             ...
             */
            public int getAccessibleChildrenCount() {
                return ((TableElementInfo) elementInfo).getRowCount() * ((TableElementInfo) elementInfo)
                        .getColumnCount();
            }
                ...
                if (validateIfNecessary()) {
                    ...
                    if (cellInfo.isHeaderCell()) {
                        ...
                        if (v != null && model != null) {
                            try {
                                return model.getText(v.getStartOffset(), v.getEndOffset() - v
                                        .getStartOffset());
                            } catch (BadLocationException e) {
                                return null;
                            }
            ...
            protected class AccessibleHeadersTable implements AccessibleTable {
                ...
                private Hashtable<Integer, ArrayList<TableCellElementInfo>> headers = new Hashtable<Integer, ArrayList<TableCellElementInfo>>();
        ...
        private class TableRowElementInfo extends ElementInfo {
            ...
            protected void loadChildren(Element e) {
                for (int x = 0; x < e.getElementCount(); x++) {
                    ...
                    if (attrs.getAttribute(StyleConstants.NameAttribute) == HTML.Tag.TH) {
                        TableCellElementInfo headerElementInfo = new TableCellElementInfo(e.getElement(x),
                                this, true);
            ...
            /**
             * Returns the sum of the column spans of the individual cells in
             * this row.
             */
            public int getColumnCount() {
                int colCount = 0;
            ...
            private void updateGrid(int row) {
                if (validateIfNecessary()) {
                    ...
                    while (!emptyRow) {
                        for (int counter = 0; counter < grid[row].length; counter++) {
            ...
            /**
             * Returns the column count of the number of columns that have a
             * rowcount >= rowspan.
             */
        ...
        private class TableCellElementInfo extends ElementInfo {
            ...
            /**
             * Overriden to invalidate the TableRowElementInfo as well as the
    ...
    /**
     * ElementInfo provides a slim down view of an Element. Each ElementInfo can
     * have any number of child ElementInfos that are not necessarily direct
     * children of the Element. As the Document changes various ElementInfos
     * become invalidated. Before accessing a particular portion of an
     * ElementInfo you should make sure it is valid by invoking
     * <code>validateIfNecessary</code>, this will return true if successful, on
     * the other hand a false return value indicates the ElementInfo is not
     * valid and can never become valid again (usually the result of the Element
     * the ElementInfo encapsulates being removed).
     */
    private class ElementInfo {
        ...
        /**
         * Creates an ElementInfo representing <code>element</code> with the
         * specified parent.
         */
        ...
        protected void loadChildren(Element parent) {
            if (!parent.isLeaf()) {
                for (int counter = 0, maxCounter = parent
        ...
        /**
         * Returns the index of the child in the parent, or -1 for the root or
         * if the parent isn't valid.
         */
        ...
        /**
         * Returns the index of the specified child, or -1 if <code>child</code>
         * isn't a valid child.
         */
        ...
        /**
         * Returns the child ElementInfo at <code>index</code>, or null if
         * <code>index</code> isn't a valid index.
         */
        ...
        /**
         * Returns the View corresponding to this ElementInfo, or null if the
         * ElementInfo can't be validated.
         */
        ...
        /**
         * Returns the Bounds for this ElementInfo, or null if the ElementInfo
         * can't be validated.
         */
        public Rectangle getBounds() {
            if (!validateIfNecessary()) {
            ...
            try {
                ...
                if (bounds != null && rootView != null) {
                    try {
                        return rootView.modelToView(e.getStartOffset(), Position.Bias.Forward, e
                                .getEndOffset(), Position.Bias.Backward, bounds).getBounds();
         ...
         * representing this Element, this will return null if the ElementInfo
         * can't be validated.
         */
        ...
        /**
         * Validates the ElementInfo if necessary. Some ElementInfos may never
         * be valid again. You should check <code>isValid</code> before using
         * one. This will reload the children and invoke <code>validate</code>
         * if the ElementInfo is invalid and can become valid again. This will
         * return true if the receiver is valid.
         */
        ...
        /**
         * Invalidates the ElementInfo. Subclasses should override this if they
         * need to reset state once invalid.
         */
        protected void invalidate(boolean first) {
            if (!isValid()) {
                if (canBeValid && !first) {
        ...
        private void update(DocumentEvent e) {
            ...
            if (getChildCount() > 0) {
                ...
                if (index0 == -1 && e.getType() == DocumentEvent.EventType.REMOVE && pos >= elem
                        .getEndOffset()) {
     ...
     * <code>update</code> on the <code>RootInfo</code> in response to any
     * event.
     */
