...
/**
 * TextAreaDocument extends the capabilities of the PlainDocument to store the
 * data that is initially set in the Document. This is stored in order to enable
 * an accurate reset of the state when a reset is requested.
 *
 * @author Sunita Mani
 */
