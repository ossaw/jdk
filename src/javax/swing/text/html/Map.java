...
class Map implements Serializable {
     ...
     * gives the size of the region the map is defined over. If a matching area
     ...
     * <code>stringCoords</code>. If one of the values represents a % the
     * returned value with be negative. If a parse error results from trying to
     * parse one of the numbers null is returned.
     */
    ...
    interface RegionContainment {
        /**
         * Returns true if the location <code>x</code>, <code>y</code> falls
         * inside the region defined in the receiver. <code>width</code>,
         * <code>height</code> is the size of the enclosing region.
         */
    ...
    static class RectangleRegionContainment implements RegionContainment {
         ...
         * that is non null indicates it is a percent (order is x, y, width,
         * height).
         */
        float[] percents;
