...
public class MinimalHTMLWriter extends AbstractWriter {
    ...
    /**
     * These static finals are used to tweak and query the fontMask about which
     * of these tags need to be generated or terminated.
     */
    ...
    /**
     * Stores the attributes of the previous run. Used to compare with the
     * current run's attributeset. If identical, then a &lt;span&gt; tag is not
     * emitted.
     */
     ...
     * StyleConstants.FontConstants, StyleConstants.ColorConstants. The
     * attribute name and value are separated by a colon. Each pair is separated
     * by a semicolon.
     *
     * @exception IOException
     *            on any I/O error
    ...
    protected void writeAttributes(AttributeSet attr) throws IOException {
        ...
        while (attributeNames.hasMoreElements()) {
            ...
            if ((name instanceof StyleConstants.ParagraphConstants)
                ...
                write(name.toString());
                write(':');
                write(css.styleConstantsValueToCSSValue((StyleConstants) name, attr.getAttribute(name))
                        .toString());
                write(';');
                write(NEWLINE);
            }
    ...
    /**
     * Writes out an end tag appropriately indented. Also decrements the indent
     * level.
     *
     * @exception IOException
     *            on any I/O error
     ...
     * &lt;style&gt; tag. The content is surrounded by valid HTML comment
     * markers to ensure that the document is viewable in applications/browsers
    ...
    /**
     * Iterates over the elements in the document and processes elements based
     * on whether they are branch elements or leaf elements. This method
    ...
    protected void writeBody() throws IOException, BadLocationException {
        ...
        /*
         * This will be a section element for a styled document. We represent
         * this element in HTML as the body tags. Therefore we ignore it.
         */
        it.current();
    ...
    /**
     * Emits an end tag for a &lt;p&gt; tag. Before writing out the tag, this
     * method ensures that all other tags that have been opened are
    ...
    /**
     * Responsible for handling Icon Elements; deliberately unimplemented. How
     * to implement this method is an issue of policy. For example, if you're
     * generating an &lt;img&gt; tag, how should you represent the src attribute
     * (the location of the image)? In certain cases it could be a URL, in
    ...
    /**
     * Generates bold &lt;b&gt;, italic &lt;i&gt;, and &lt;u&gt; tags for the
    ...
    /**
     * Tweaks the appropriate bits of fontMask to reflect whether the text is to
     * be displayed in bold, italic, and/or with an underline.
     */
    ...
    /**
     * Writes out start tags &lt;u&gt;, &lt;i&gt;, and &lt;b&gt; based on the
     * mask settings.
     *
     * @exception IOException
     *            on any I/O error
    ...
    /**
     * Writes out end tags for &lt;u&gt;, &lt;i&gt;, and &lt;b&gt; based on the
     * mask settings.
     *
     * @exception IOException
     *            on any I/O error
    ...
    /**
     * Writes out the remaining character-level attributes (attributes other
     * than bold, italic, and underline) in an HTML-compliant way. Given that
     * attributes such as font family and font size have no direct mapping to
     * HTML tags, a &lt;span&gt; tag is generated and its style attribute is set
    ...
    protected void writeNonHTMLAttributes(AttributeSet attr) throws IOException {
        ...
        if (color != null) {
            style += "color: " + css.styleConstantsValueToCSSValue((StyleConstants) StyleConstants.Foreground,
                    color);
            first = false;
        }
     ...
     * This is no longer used, instead &lt;span&gt; will be written out.
     * <p>
     * Writes out a start tag for the &lt;font&gt; tag. Because font tags cannot
     * be nested, this method closes out any enclosing font tag before writing
     * out a new start tag.
     *
     * @exception IOException
     *            on any I/O error
     ...
     * returns the name that should be used when outputting. CSS does not allow
     * the full Unicode set to be used as a style name.
     */
