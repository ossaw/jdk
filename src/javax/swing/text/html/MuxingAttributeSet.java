...
class MuxingAttributeSet implements AttributeSet, Serializable {
     ...
     * use by subclasses only, and it is also intended that subclasses will set
    ...
    /**
     * Removes the AttributeSet at <code>index</code>. This assumes the value of
     * <code>index</code> is greater than or equal to 0, and less than
     * attrs.length.
     */
    ...
    /**
     * Checks whether a given attribute is defined. This will convert the key
    ...
    /**
     * Returns null, subclasses may wish to do something more intelligent with
     * this.
     */
    ...
    /**
     * An Enumeration of the Attribute names in a MuxingAttributeSet. This may
