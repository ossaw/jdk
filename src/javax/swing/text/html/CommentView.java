...
/**
 * CommentView subclasses HiddenTagView to contain a JTextArea showing a
 * comment. When the textarea is edited the comment is reset. As this inherits
 * from EditableView if the JTextComponent is not editable, the textarea will
 * not be visible.
 *
 * @author Scott Violet
 */
