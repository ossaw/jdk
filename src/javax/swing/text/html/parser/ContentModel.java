...
/**
 * A representation of a content model. A content model is basically a
 * restricted BNF expression. It is restricted in the sense that it must be
 * deterministic. This means that you don't have to represent it as a finite
 * state automaton.
 * <p>
...
public final class ContentModel implements Serializable {
    ...
    /**
     * Return true if the token could potentially be the first token in the
     * input stream.
     */
