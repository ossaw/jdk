...
/**
 * An element as described in a DTD using the ELEMENT construct. This is
 * essential the description of a tag. It describes the type, content model,
 * attributes, attribute types etc. It is used to correctly parse a document by
 * the Parser.
 *
 * @see DTD
 * @see AttributeList
