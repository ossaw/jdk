...
/**
 * Implements a View suitable for use in JPasswordField UI implementations. This
 * is basically a field ui that renders its contents as the echo character
 * specified in the associated component (if it can narrow the component to a
 * JPasswordField).
 *
...
public class PasswordView extends FieldView {
    ...
    /**
     * Renders the given range in the model as normal unselected text. This sets
     * the foreground color and echos the characters using the value returned by
     * getEchoChar().
     *
     * @param g
    ...
    /**
     * Renders the echo character, or whatever graphic should be used to display
     * the password characters. The color in the Graphics object is set to the
