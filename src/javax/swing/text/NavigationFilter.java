...
public class NavigationFilter {
     ...
     * calls directly into the <code>FilterBypass</code> with the passed in
     * arguments. Subclasses may wish to conditionally call super with a
     * different location, or invoke the necessary method on the
     * <code>FilterBypass</code>
     *
     * @param fb
     ...
     * calls directly into the <code>FilterBypass</code> with the passed in
     * arguments. Subclasses may wish to conditionally call super with a
     * different location, or invoke the necessary methods on the
     * <code>FilterBypass</code>.
     *
     * @param fb
     *        FilterBypass that can be used to mutate caret position
     ...
     * position. The default implementation simply forwards the method to the
     * root View. Subclasses may wish to further restrict the location based on
     * additional criteria.
     *
     * @param text
    ...
    /**
     * Used as a way to circumvent calling back into the caret to position the
     * cursor. Caret implementations that wish to support a NavigationFilter
     * must provide an implementation that will not callback into the
     * NavigationFilter.
     * 
     * @since 1.4
     */
