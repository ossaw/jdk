...
public class TabSet implements Serializable {
	...
	/**
	 * Since this class is immutable the hash code could be calculated once.
	 * MAX_VALUE means that it was not initialized yet. Hash code shouldn't has
	 * MAX_VALUE value.
	 */
	private int hashCode = Integer.MAX_VALUE;

	/**
	 * Creates and returns an instance of TabSet. The array of Tabs passed in
	 ...
	 * IllegalArgumentException if <code>index</code> is outside the range of
	 * tabs.
	 */
	...
	/**
	 * Returns the Tab instance after <code>location</code>. This will return
	 * null if there are no tabs after <code>location</code>.
	 */
	...
	/**
	 * Returns the index of the Tab to be used after <code>location</code>. This
	 * will return -1 if there are no tabs after <code>location</code>.
	 */
