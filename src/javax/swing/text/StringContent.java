 ...
 * debugging. It manages the character content as a simple character array. It
 * is also quite inefficient.
 * <p>
 * It is generally recommended that the gap buffer or piece table
 * implementations be used instead. This buffer does not scale up to large
 * sizes.
 * <p>
...
public final class StringContent implements AbstractDocument.Content,
    ...
    /**
     * Creates a new StringContent object, with the initial size specified. If
     ...
     * real mark can be collected if there are no more references to it.... the
     * update table holds only a reference to this grungy thing.
     */
    final class PosRec {
    ...
    /**
     * This really wants to be a weak reference but in 1.1 we don't have a 100%
     * pure solution for this... so this class trys to hack a solution to
     * causing the marks to be collected.
     */
    ...
    /**
     * Used to hold a reference to a Position that is being reset as the result
     * of removing from the content.
     */
