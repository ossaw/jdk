...
/**
 * <p>
 * Implements View interface for a table, that is composed of an element
 ...
 * box, the rows are horizontal boxes, and the cells are vertical boxes. The
 * cells are allowed to span multiple columns and rows. By default, the table
 * can be thought of as being formed over a grid (i.e. somewhat like one would
 * find in gridbag layout), where table cells can request to span more than one
 * grid cell. The default horizontal span of table cells will be based upon this
 * grid, but can be changed by reimplementing the requested span of the cell
 * (i.e. table cells can have independant spans if desired).
 *
...
public abstract class TableView extends BoxView {
    ...
    /**
     * Determines the number of columns occupied by the table cell
     * represented by given element.
     */
    ...
    /**
     * Determines the number of rows occupied by the table cell
     * represented by given element.
     */
    ...
    /**
     * Perform layout for the minor axis of the box (i.e. the axis orthogonal to
     ...
     * <p>
     * This is implemented to call the {@link #layoutColumns layoutColumns}
     * method, and then forward to the superclass to actually carry out the
    ...
    public class TableRow extends BoxView {
         ...
         * orthogonal to the axis that it represents). The results of the layout
