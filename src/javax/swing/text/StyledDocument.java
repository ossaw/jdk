...
public interface StyledDocument extends Document {
     ...
     * existing content in the document. All of the attributes defined in the
     * given Attributes argument are applied to the given range. This method can
     * be used to completely remove all content level attributes for the given
     * range by giving an Attributes argument that has no attributes defined and
    ...
    /**
     * Gets the element that represents the paragraph that encloses the given
    ...
    /**
     * Gets the element that represents the character that is at the given
     * offset within the document.
     *
     * @param pos
     *        the offset &gt;= 0
    ...
    /**
     * Takes a set of attributes and turn it into a font specification. This can
