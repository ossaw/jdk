...
public class IconView extends View {
    ...
    /**
     * Paints the icon. The real paint behavior occurs naturally from the
     * association that the icon has with its parent container (the same
     * container hosting this view), so this simply allows us to position the
     * icon properly relative to the view. Since the coordinate system for the
