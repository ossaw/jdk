...
public class TabStop implements Serializable {
	...
	/**
	 * Characters following tab are positioned such that all following
	 * characters up to next tab/newline are centered around the tabs location.
	 */
	public static final int ALIGN_CENTER = 2;
	/**
	 * Characters following tab are aligned such that next decimal/tab/newline
	 * is at the tab location, very similar to RIGHT_TAB, just includes decimal
	 * as additional character to look for.
	 */
	public static final int ALIGN_DECIMAL = 4;
	public static final int ALIGN_BAR = 5;

	/*
	 * Bar tabs (whatever they are) are actually a separate kind of tab in the
	 * RTF spec. However, being a bar tab and having alignment properties are
	 * mutually exclusive, so the reader treats barness as being a kind of
	 * alignment.
	 */
	...
	/**
	 * Creates a tab at position <code>pos</code> with a default alignment and
	 * default leader.
	 */
	...
	/**
	 * Creates a tab with the specified position <code>pos</code>, alignment
	 * <code>align</code> and leader <code>leader</code>.
	 */
	...
	/**
	 * Returns the hashCode for the object. This must be defined here to ensure
	 * 100% pure.
	 *
