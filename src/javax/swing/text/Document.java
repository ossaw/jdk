 ...
 * <img src="doc-files/Document-coord.gif" alt=
 * "The following text describes this graphic.">
 * <p>
 * In the example, if the content of a document is the sequence
 * "The quick brown fox," as shown in the preceding diagram, the location just
 * before the word "The" is 0, and the location after the word "The" and before
 * the whitespace that follows it is 3. The entire sequence of characters in the
 * sequence "The" is called a <em>range</em>.
 * <p>
 ...
 * <p style="text-align:center">
 * <img src="doc-files/Document-structure.gif" alt=
 ...
 * <p style="text-align:center">
 * <img src="doc-files/Document-notification.gif" alt=
 ...
 * <ul>
 * <li><a href="#addDocumentListener(javax.swing.event.DocumentListener)">
 * addDocumentListener(DocumentListener)</a>
 * <li><a href="#removeDocumentListener(javax.swing.event.DocumentListener)">
 * removeDocumentListener(DocumentListener)</a>
 * <li><a href=
 * "#addUndoableEditListener(javax.swing.event.UndoableEditListener)">
 * addUndoableEditListener(UndoableEditListener)</a>
 * <li><a href=
...
public interface Document {
     ...
     * <code>StreamDescriptionProperty</code></a> and <a href="#TitleProperty">
     * <code>TitleProperty</code></a>. Other properties, such as author, may
     * also be defined.
     *
     * @param key
     ...
     * updated and any marks created by <code>createPosition</code> have already
     * changed. For a removal, the end of the removal range is collapsed down to
     * the start of the range, and any marks in the removal range are collapsed
     * down to the start of the range.
     * <p style="text-align:center">
     * <img src="doc-files/Document-remove.gif" alt=
     ...
     * <p style="text-align:center">
     * <img src="doc-files/Document-insert.gif" alt=
     ...
     * the model supports being updated asynchronously. The given runnable will
     * be executed in a way that allows it to safely read the model with no
    ...
    /**
     * The property name for the description of the stream used to initialize
     * the document. This should be used if the document was initialized from a
     * stream and anything is known about the stream.
     */
