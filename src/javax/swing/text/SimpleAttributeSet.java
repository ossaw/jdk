...
public class SimpleAttributeSet implements MutableAttributeSet, Serializable,
    ...
    /**
     * Checks whether the attribute list contains a specified attribute
     * name/value pair.
     *
     * @param name
     *              the name
    ...
    /**
     * Checks whether the attribute list contains all the specified name/value
     * pairs.
     *
     * @param attributes
     *                   the attribute list
    ...
    /**
     * Gets the resolving parent. This is the set of attributes to resolve
     * through if an attribute isn't defined locally. This is null if there are
     * no other sets of attributes to resolve through.
     *
     * @return the parent
     */
