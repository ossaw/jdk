...
public interface Caret {
    ...
    /**
     * Set the current caret visual location. This can be used when moving
     * between lines that have uneven end positions (such as when caret up or
     * down actions occur). If text flows left-to-right or right-to-left the
     * x-coordinate will indicate the desired navigation location for vertical
     * movement. If the text flow is top-to-bottom, the y-coordinate will
    ...
    /**
     * Sets the blink rate of the caret. This determines if and how fast the
    ...
    /**
     * Gets the blink rate of the caret. This determines if and how fast the
     * caret blinks, commonly used as one way to attract attention to the caret.
     *
     * @return the delay in milliseconds &gt;=0. If this is zero the caret will
     *         not blink.
     */
     ...
     * mark will not be the same as the dot.
     *
     * @return the position &gt;=0
     */
    public int getMark();
    ...
    /**
     * Sets the caret position to some position. This causes the mark to become
     * the same as the dot, effectively setting the selection range to zero.
     * <p>
     * If the parameter is negative or beyond the length of the document, the
