...
public class DateFormatter extends InternationalFormatter {
	...
	/**
	 * Returns a DateFormatter configured with the specified <code>Format</code>
	 * instance.
	 *
	 * @param format
	...
	/**
	 * Returns the Calendar that <code>DateFormat</code> is associated with, or
	 * if the <code>Format</code> is not a <code>DateFormat</code>
