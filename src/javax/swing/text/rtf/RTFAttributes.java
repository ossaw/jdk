...
class RTFAttributes {
    ...
    static {
        ...
        a.addElement(new AssertiveAttribute(PGF, StyleConstants.Alignment, "qc",
    ...
    static class BooleanAttribute extends GenericAttribute implements RTFAttribute {
        ...
        public boolean set(MutableAttributeSet target) {
            /*
             * TODO: There's some ambiguity about whether this should set* or
    ...
    static class NumericAttribute extends GenericAttribute implements RTFAttribute {
        ...
        public boolean setDefault(MutableAttributeSet target) {
            ...
            if (old == null)
                old = swingDefault;
            if (old != null && ((scale == 1f && old.intValue() == rtfDefault) || (Math.round(old.floatValue()
                    * scale) == rtfDefault)))
                return true;
        ...
        public boolean writeValue(Object o_value, RTFGenerator target, boolean force) throws IOException {
            ...
            if (value == null) {
                 ...
                 * Currently we pretend that the RTF default value is equivalent
