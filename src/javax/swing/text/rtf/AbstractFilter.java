 ...
 * override <code>write(String)</code> as well. The subclass' initializer may
 * also install appropriate translation and specials tables.
 *
 * @see OutputStream
 */
abstract class AbstractFilter extends OutputStream {
    ...
    /**
     * A table indicating which byte values should be interpreted as characters
     * and which should be treated as formatting codes
     */
    ...
    /**
     * A convenience method that reads text from a FileInputStream and writes it
     * to the receiver. The format in which the file is read is determined by
     * the concrete subclass of AbstractFilter to which this method is sent.
     * <p>
     * This method does not close the receiver after reaching EOF on the input
     * stream. The user must call <code>close()</code> to ensure that all data
     * are processed.
     *
     * @param in
    ...
    /**
     * Implements the abstract method of OutputStream, of which this class is a
     * subclass.
     */
    ...
    /**
     * Hopefully, all subclasses will override this method to accept strings of
     * text, but if they don't, AbstractFilter's implementation will spoon-feed
    ...
    /**
     * Subclasses must provide an implementation of this method which accepts a
