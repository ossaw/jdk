 ...
 * editor view. If the view is allocated extra space, the field must adjust for
 * it. If the hosting component is a JTextField, this view will manage the
 * ranges of the associated BoundedRangeModel and will adjust the horizontal
 * allocation to match the current visibility settings of the JTextField.
 *
...
public class FieldView extends PlainView {
    ...
    /**
     * Adjusts the allocation given to the view to be a suitable allocation for
     * a text field. If the view has been allocated more than the preferred span
     * vertically, the allocation is changed to be centered vertically.
     * Horizontally the view is adjusted according to the horizontal alignment
     * property set on the associated JTextField (if that is the type of the
     * hosting component).
     *
     * @param a
    ...
    /**
     * Update the visibility model with the associated JTextField (if there is
     * one) to reflect the current visibility as a result of changes to the
     * document model. The bounded range properties are updated. If the view
     * hasn't yet been shown the extent will be zero and we just set it to be
