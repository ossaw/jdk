 ...
 * <li>A static convenience method for creating a color-chooser dialog where
 ...
 * added to detect when the current "color" property changes.
 * </ol>
 * <p>
...
public class JColorChooser extends JComponent implements Accessible {
	 ...
	 * pressed, the color-chooser's color will be reset to the color which was
	 ...
	 *
	 * @return the <code>ColorChooserUI</code> object that renders this
	 *         component
	 */
	 ...
	 * Note that the values of red, green, and blue should be between the
	 ...
	 * drop; they will ignore this property. You can work around such look and
	 * feels by modifying the component to directly call the
	...
	/**
	 * Sets the current preview panel. This will fire a
	 * <code>PropertyChangeEvent</code> for the property named "previewPanel".
	 *
	 * @param preview
	 *            the <code>JComponent</code> which displays the current color
	 * @see JComponent#addPropertyChangeListener
	 *
	 ...
	 * @exception IllegalArgumentException
	 *                if panel is not in list of known chooser panels
	 */
	public AbstractColorChooserPanel removeChooserPanel(AbstractColorChooserPanel panel) {
		...
		if (containedAt == chooserPanels.length - 1) { // at end
			...
			System.arraycopy(chooserPanels, containedAt + 1, newArray, containedAt,
					(chooserPanels.length - containedAt - 1));
		}
	...
	/**
	 * Returns a string representation of this <code>JColorChooser</code>. This
	...
	protected String paramString() {
		...
		return super.paramString() + ",chooserPanels=" + chooserPanelsString.toString()
	 ...
	 * AccessibleJColorChooser. A new AccessibleJColorChooser instance is
	 * created if necessary.
	 *
	 * @return an AccessibleJColorChooser that serves as the AccessibleContext
	 *         of this JColorChooser
	 */
...
/*
 * Class which builds a color chooser dialog consisting of a JColorChooser with
