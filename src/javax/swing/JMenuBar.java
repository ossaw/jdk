 ...
 * <p>
 * <strong>Warning:</strong> By default, pressing the Tab key does not transfer
 * focus from a <code>
 * JMenuBar</code> which is added to a container together with other Swing
 * components, because the <code>focusTraversalKeysEnabled</code> property of
 * <code>JMenuBar</code> is set to <code>false</code>. To resolve this, you
 * should call the <code>JMenuBar.setFocusTraversalKeysEnabled(true)</code>
 * method.
 * 
...
public class JMenuBar extends JComponent implements Accessible, MenuElement {
	 ...
	 *
	 * @param index
	 *              an integer giving the position in the menu bar, where 0 is
	 *              the
	 *              first position
	 * @return the <code>JMenu</code> at that position, or <code>null</code> if
	 *         if there is no <code>JMenu</code> at that position (ie. if it is
	...
	/**
	 * Sets the help menu that appears when the user selects the "help" option
	 * in the menu bar. This method is not yet implemented and will throw an
	 * exception.
	 *
	 * @param menu
	...
	/**
	 * Gets the help menu for the menu bar. This method is not yet implemented
	 ...
	 * @return the <code>Component</code> at the position, or <code>null</code>
	 ...
	 * @return an integer giving the component's position, where 0 is first; or
	...
	/**
	 * Sets the currently selected component, producing a a change to the
	 * selection model.
	 *
	 * @param sel
	...
	/**
	 * Paints the menubar's border if <code>BorderPainted</code> property is
	 * true.
	 *
	 * @param g
	 *          the <code>Graphics</code> context to use for painting
	...
	/**
	 * Returns the margin between the menubar's border and its menus. If there
	 * is no previous margin, it will create a default margin with zero size.
	 *
	...
	/**
	 * Implemented to be a <code>MenuElement</code> -- returns the menus in this
	 * menu bar. This is the reason for implementing the
	 * <code>MenuElement</code> interface -- so that the menu bar can be treated
	 * the same as other menu elements.
	 * 
	...
	/**
	 * Returns a string representation of this <code>JMenuBar</code>. This
	...
	protected String paramString() {
		...
		return super.paramString() + ",margin=" + marginString + ",paintBorder="
				+ paintBorderString;
	}
	...
	/**
	 * Gets the AccessibleContext associated with this JMenuBar. For JMenuBars,
	 * the AccessibleContext takes the form of an AccessibleJMenuBar. A new
	 * AccessibleJMenuBar instance is created if necessary.
	 *
	 * @return an AccessibleJMenuBar that serves as the AccessibleContext of
	 *         this JMenuBar
	 */
	...
	/**
	 * This class implements accessibility support for the <code>JMenuBar</code>
	 * class. It provides an implementation of the Java Accessibility API
	 * appropriate to menu bar user-interface elements.
	 * <p>
	 * <strong>Warning:</strong> Serialized objects of this class will not be
	...
	protected class AccessibleJMenuBar extends AccessibleJComponent implements
		...
		/**
		 * Returns the currently selected menu if one is selected, otherwise
		 * null.
		 */
		...
		/**
		 * Selects the nth menu in the menu bar, forcing it to pop up. If
		 * another menu is popped up, this will force it to close. If the nth
		 * menu is already selected, this method has no effect.
		 *
		 * @param i
		 ...
		 * selection. If the nth item isn't currently selected, this method has
		 * no effect. Otherwise, it closes the popup menu.
		 *
		 * @param i
		 *          the zero-based index of selectable items
		 */
		 ...
		 * selected. This will close any open menu.
		 */
	...
	protected boolean processKeyBinding(KeyStroke ks, KeyEvent e, int condition,
		...
		if (!retValue) {
			...
			for (MenuElement subElement : subElements) {
				if (processBindingForKeyStrokeRecursive(subElement, ks, e,
						condition, pressed)) {
					return true;
				}
			}
	...
	static boolean processBindingForKeyStrokeRecursive(MenuElement elem,
		...
		if (c != null && c instanceof JComponent && ((JComponent) c)
	...
	/**
	 * Overrides <code>JComponent.addNotify</code> to register this menu bar
	 * with the current keyboard manager.
	 */
	...
	/**
	 * Overrides <code>JComponent.removeNotify</code> to unregister this menu
	 * bar with the current keyboard manager.
	 */
