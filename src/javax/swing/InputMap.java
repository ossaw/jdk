...
public class InputMap implements Serializable {
     ...
     *
     * @return map the <code>InputMap</code> that is the parent of this one, or
     *         null if this <code>InputMap</code> has no parent
     */
    ...
    /**
     * Returns the binding for <code>keyStroke</code>, messaging the parent
     * <code>InputMap</code> if the binding is not locally defined.
     */
    ...
    /**
     * Returns the <code>KeyStroke</code>s that are bound in this
     * <code>InputMap</code>.
     */
     ...
     * <code>keys()</code> in that this method includes the keys defined in the
     * parent.
     */
