 ...
 * How to Use Text Fields</a> in <em>The Java Tutorial.</em>
 * <p>
...
public class JTextField extends JTextComponent implements SwingConstants {
     ...
     *        whatever naturally results from the component
     *        implementation
     */
     ...
     *        the number of columns to use to calculate the preferred
     *        width
     *        &gt;= 0; if <code>columns</code> is set to zero, the
     *        preferred
     *        width will be whatever naturally results from the
     *        component
     *        implementation
     ...
     * itself will be handled by validating the textfield, unless the textfield
     * is contained within a <code>JViewport</code>, in which case this returns
     * false.
     *
     ...
     *        the alignment
     * @exception IllegalArgumentException
     *            if <code>alignment</code> is not a
     *            valid key
     * @beaninfo preferred: true bound: true description: Set the field
     *           alignment to LEFT, CENTER, RIGHT, LEADING (the default) or
     *           TRAILING enum: LEFT JTextField.LEFT CENTER JTextField.CENTER
     *           RIGHT JTextField.RIGHT LEADING JTextField.LEADING TRAILING
     *           JTextField.TRAILING
     */
     ...
     * construction if one isn't explicitly given. An instance of
     * <code>PlainDocument</code> is returned.
     *
     ...
     * @exception IllegalArgumentException
     *            if <code>columns</code> is less than
     *            0
    ...
    protected void fireActionPerformed() {
        ...
        ActionEvent e = new ActionEvent(this, ActionEvent.ACTION_PERFORMED, (command != null) ? command
                : getText(), EventQueue.getMostRecentEventTime(), modifiers);
     ...
     * textfield's properties are automatically updated as the
     ...
     * the textfield's properties. To track changes in the <code>Action</code>'s
     ...
     *
     * @param a
     *        the <code>Action</code> for the <code>JTextField</code>, or
     *        <code>null</code>
     * @since 1.3
     * @see Action
     * @see #getAction
     ...
     *
     * @param action
     *        the <code>Action</code> associated with this
     *        textfield
     * @param propertyName
     ...
     * class. If you do the lifetime of the textfield will be tied to that of
    ...
    protected String paramString() {
        ...
        return super.paramString() + ",columns=" + columns + ",columnWidth=" + columnWidth + ",command="
                + commandString + ",horizontalAlignment=" + horizontalAlignmentString;
    }
     ...
     * <code>JTextField</code>. For <code>JTextFields</code>, the
     * <code>AccessibleContext</code> takes the form of an
     * <code>AccessibleJTextField</code>. A new
     * <code>AccessibleJTextField</code> instance is created if necessary.
     *
     ...
     * <code>JTextField</code> class. It provides an implementation of the Java
     * Accessibility API appropriate to text field user-interface elements.
     * <p>
     * <strong>Warning:</strong> Serialized objects of this class will not be
