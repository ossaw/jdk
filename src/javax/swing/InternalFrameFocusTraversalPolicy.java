...
public abstract class InternalFrameFocusTraversalPolicy extends
	 ...
	 * is selected for the first time. Once the JInternalFrame has been selected
	 * by a call to <code>setSelected(true)</code>, the initial Component will
	 * not be used again. Instead, if the JInternalFrame loses and subsequently
	 * regains selection, or is made invisible or undisplayable and subsequently
	 * made visible and displayable, the JInternalFrame's most recently focused
	 * Component will become the focus owner. The default implementation of this
