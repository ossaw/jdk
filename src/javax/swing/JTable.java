...
public class JTable extends JComponent implements TableModelListener, Scrollable, TableColumnModelListener,
     ...
     * drop location for a <code>JTable</code>.
     *
     * @see #getDropLocation
     * @since 1.6
     */
    public static final class DropLocation extends TransferHandler.DropLocation {
         ...
         * <code>isInsertRow()</code>. If that method returns <code>true</code>
         * this value indicates the index where a new row should be inserted.
         * Otherwise, it represents the value of an existing row on which the
         ...
         * <code>true</code> this value indicates the index where a new column
         * should be inserted. Otherwise, it represents the value of an existing
         * column on which the data was dropped. This index is in terms of the
         * view.
         * <p>
         * <code>-1</code> indicates that the drop occurred over empty space,
        ...
        /**
         * Returns whether or not this location represents an insert of a
         * column.
         *
     ...
     * spacing is look and feel dependent.
     *
     ...
     * it doesn't. The default value is look and feel dependent.
     *
     ...
     * TableRowSorter} is created and set as the table's row sorter. The default
     ...
     * <P>
     * <b>Note:</b> <code>JTable</code> provides all the methods for handling
     * column and row selection. When setting states, such as
     ...
     * columns can be resized to accommodate a change in the size of a
     * containing parent. Resizes one or more of the columns in the table so
     * that the total width of all of this <code>JTable</code>'s columns is
     ...
     * all. Use a horizontal scrollbar to accommodate the columns when their sum
     ...
     * </ul>
     * <p>
     * <b>Note:</b> When a <code>JTable</code> makes adjustments to the widths
     * of the columns it respects their minimum and maximum values absolutely.
     * It is therefore possible that, even after this method is called, the
     * total width of the columns is still not equal to the width of the table.
     * When this happens the <code>JTable</code> does not put itself in
     * AUTO_RESIZE_OFF mode to bring up a scroll bar, or break other commitments
     * of its current auto-resize mode -- instead it allows its bounds to be set
     * larger (or smaller) than the total of the column minimum or maximum,
     * meaning, either that there will not be enough room to display all of the
     * columns, or that the columns will not fill the <code>JTable</code>'s
     * bounds. These respectively, result in the clipping of some columns or an
     * area being painted in the <code>JTable</code>'s background color during
     * painting.
     * <p>
     ...
     * <p>
     * <b>Note:</b> For <code>JTable</code> to properly display tooltips of its
     * renderers <code>JTable</code> must be a registered component with the
     * <code>ToolTipManager</code>. This is done automatically in
    ...
    /**
     * Returns the suffix used to construct the name of the L&amp;F class used
     ...
     * (Java 2 v 1.2.2) the value returned will ensure that the viewport is
     * cleanly aligned on a row boundary.
     *
    ...
    /*
     * Called from the JComponent's EnableSerializationFocusListener to do any
     * Swing-specific pre-serialization configuration.
     */
    ...
    /**
     * Returns a string representation of this table. This method is intended to
     ...
     * this <code>JTable</code> in mode <code>PrintMode.FIT_WIDTH</code>, with
     * no header or footer text. A modal progress dialog, with an abort option,
     * will be shown for the duration of printing.
     * <p>
     * Note: In headless mode, no dialogs are shown and printing occurs on the
     * default printer.
     *
    ...
    /**
     * A convenience method that displays a printing dialog, and then prints
     * this <code>JTable</code> in the given printing mode, with no header or
     * footer text. A modal progress dialog, with an abort option, will be shown
    ...
    /**
     * A convenience method that displays a printing dialog, and then prints
     * this <code>JTable</code> in the given printing mode, with the specified
     * header and footer text. A modal progress dialog, with an abort option,
     * will be shown for the duration of printing.
     * <p>
     * Note: In headless mode, no dialogs are shown and printing occurs on the
     * default printer.
     ...
     * {@link #print(JTable.PrintMode, MessageFormat, MessageFormat, boolean, PrintRequestAttributeSet, boolean, PrintService)
     ...
     * developers would take in order to print a <code>JTable</code>. In short,
     * it prepares the table, calls <code>getPrintable</code> to fetch an
     * appropriate <code>Printable</code>, and then sends it to the printer.
     * <p>
     * A <code>boolean</code> parameter allows you to specify whether or not a
     * printing dialog is displayed to the user. When it is, the user may use
     * the dialog to change the destination printer or printing attributes, or
     * even to cancel the print. Another two parameters allow for a
     * <code>PrintService</code> and printing attributes to be specified. These
     * parameters can be used either to provide initial values for the print
     * dialog, or to specify values when the dialog is not shown.
     * <p>
     * A second <code>boolean</code> parameter allows you to specify whether or
     * not to perform printing in an interactive mode. If <code>true</code>, a
     * modal progress dialog, with an abort option, is displayed for the
     ...
     * responsibility of the developer to ensure that no other code modifies the
     * table in any way during printing (invalid modifications include changes
     * in: size, renderers, or underlying data). Printing behavior is undefined
     * when the table is changed during printing.
     * <p>
     * If <code>false</code> is specified for this parameter, no dialog will be
     * displayed and printing will begin immediately on the event-dispatch
     ...
     * during printing such that selection and focus are not indicated. As far
     * as customizing further how the table looks in the printout, developers
     * can provide custom renderers or paint code that conditionalize on the
     * value of {@link javax.swing.JComponent#isPaintingForPrint()}.
     * <p>
     ...
     * <code>PrintMode.NORMAL</code> specifies that the table be printed at its
     * current size. In this mode, there may be a need to spread columns across
     * pages in a similar manner to that of the rows. When the need arises,
     * columns are distributed in an order consistent with the table's
     * <code>ComponentOrientation</code>. <code>PrintMode.FIT_WIDTH</code>
     * specifies that the output be scaled smaller, if necessary, to fit the
     * table's entire width (and thereby all columns) on each page. Width and
     * height are scaled equally, maintaining the aspect ratio of the output.
     * <p>
     * The <code>Printable</code> heads the portion of table on each page with
     * the appropriate section from the table's <code>JTableHeader</code>, if it
     * has one.
     * <p>
     * Header and footer text can be added to the output by providing
     * <code>MessageFormat</code> arguments. The printing code requests Strings
     * from the formats, providing a single item which may be included in the
     * formatted string: an <code>Integer</code> representing the current page
     * number.
     * <p>
     * You are encouraged to read the documentation for
     * <code>MessageFormat</code> as some characters, such as single-quote, are
     ...
     * </pre>
     * <p>
     * The <code>Printable</code> constrains what it draws to the printable area
     * of each page that it prints. Under certain circumstances, it may find it
     * impossible to fit all of a page's content into that area. In these cases
     * the output may be clipped, but the implementation makes an effort to do
     * something reasonable. Here are a few situations where this is known to
     ...
     * completely in the printable area -- print as much of the text as possible
     * starting from the beginning, as determined by the table's
     * <code>ComponentOrientation</code>.
     * <li>In any mode, when a row is too tall to fit in the printable area --
     * print the upper-most portion of the row and paint no lower border on the
     * table.
     * <li>In <code>PrintMode.NORMAL</code> when a column is too wide to fit in
     * the printable area -- print the center portion of the column and leave
     * the left and right borders off the table.
     * </ul>
     * <p>
     * It is entirely valid for this <code>Printable</code> to be wrapped inside
     * another in order to create complex reports and documents. You may even
     * request that different pages be rendered into different sized printable
     * areas. The implementation must be prepared to handle this (possibly by
     * doing its layout calculations on the fly). However, providing different
     * heights to each page will likely not work well with
     * <code>PrintMode.NORMAL</code> when it has to spread columns across pages.
     * <p>
     * As far as customizing how the table looks in the printed result,
     * <code>JTable</code> itself will take care of hiding the selection and
     * focus during printing. For additional customizations, your renderers or
     * painting code can customize the look based on the value of
     * {@link javax.swing.JComponent#isPaintingForPrint()}
     * <p>
     * Also, <i>before</i> calling this method you may wish to <i>first</i>
     * modify the state of the table, such as to cancel cell editing or have the
     * user size the table appropriately. However, you must not modify the state
     * of the table <i>after</i> this <code>Printable</code> has been fetched
     * (invalid modifications include changes in size or underlying data). The
     * behavior of the returned <code>Printable</code> is undefined once the
    ...
    /**
     * Gets the AccessibleContext associated with this JTable. For tables, the
     * AccessibleContext takes the form of an AccessibleJTable. A new
     * AccessibleJTable instance is created if necessary.
     *
     * @return an AccessibleJTable that serves as the AccessibleContext of this
     *         JTable
     */
    ...
    //
    /**
     * This class implements accessibility support for the <code>JTable</code>
    ...
    protected class AccessibleJTable extends AccessibleJComponent implements AccessibleSelection,
        ...
        /**
         * Track changes to selection model, column model, etc. so as to be able
         * to re-place listeners on those in order to pass on information to the
        ...
        public void propertyChange(PropertyChangeEvent e) {
            ...
            if (name.compareTo("model") == 0) {
                ...
                if (source == JTable.this) { // row selection model
                    ...
                    // System.out.println("!!! Bug in source of selectionModel
                    // propertyChangeEvent");
                }
        ...
        /**
         * Invoked when editing is canceled. The editor object is discarded and
         * the cell is rendered once again.
         *
         * @see CellEditorListener
         */
        public void editingCanceled(ChangeEvent e) {
        ...
        /**
         * Returns the number of <code>Accessible</code> children currently
         * selected. If no children are selected, the return value will be 0.
         *
         ...
         * selected child in the object. If there isn't a selection, or there
         * are fewer children selected than the integer passed in, the return
            ...
            if (JTable.this.cellSelectionEnabled) { // a contiguous block
                ...
                if (JTable.this.getRowSelectionAllowed() && JTable.this.getColumnSelectionAllowed()) {
                    ...
                    if (curIndex < (colsSel * (ttlRows - (prevRow == -1 ? 0 : (prevRow + 1))))) { // it's
                        ...
                        // System.out.println("Bug in
                        // AccessibleJTable.getAccessibleSelection()");
                    }
        ...
        /**
         * Adds the specified <code>Accessible</code> child of the object to the
         * object's selection. If the object supports multiple selections, the
         * specified child is added to any existing selection, otherwise it
         * replaces any existing selection in the object. If the specified child
         * is already selected, this method has no effect.
         * <p>
         * This method only works on <code>JTable</code>s which have individual
         ...
         * <p>
         * This method only works on <code>JTables</code> which have individual
         * cell selection enabled.
         *
         * @param i
         *        the zero-based index of the child
         ...
         * <code>JTable</code> supports multiple selections, and if individual
        ...
        /**
         * Gets the <code>AccessibleTable</code> associated with this object. In
         * the implementation of the Java Accessibility API for this class,
         * return this object, which is responsible for implementing the
         * <code>AccessibleTables</code> interface on behalf of itself.
         *
         * @return this object
         * @since 1.3
         */
        ...
        /**
         * Returns the number of rows occupied by the <code>Accessible</code> at
         * a specified row and column in the table.
         *
         * @return the number of rows occupied by the <code>Accessible</code> at
         *         a specified row and column in the table
         * @since 1.3
         */
         ...
         * Returns the selected rows in a table.
         *
         * @return an array of selected rows where each element is a zero-based
         *         row of the table
         * @since 1.3
         */
        public int[] getSelectedAccessibleRows() {
        ...
        protected class AccessibleJTableCell extends AccessibleContext implements Accessible,
             ...
             * component. In the implementation of the Java Accessibility API
             * for this class, return this object, which is its own
             ...
             *
             * @return the <code>AccessibleContext</code> for the table cell
             *         renderer if one exists; otherwise, returns
             *         <code>null</code>.
             * @since 1.6
             */
             ...
             *
             * @return the localized name of the object; <code>null</code> if
             *         this object does not have a name
             */
             ...
             *         <code>null</code> if this object does not have a
             *         description
             */
             ...
             *
             * @return an instance of <code>AccessibleStateSet</code> containing
             ...
             *
             * @return the Accessible parent of this object; <code>null</code>
             *         if this object does not have an <code>Accessible</code>
             *         parent
             */
             ...
             * list. This removes a <code>PropertyChangeListener</code> that was
            ...
            /**
             * Gets the <code>AccessibleComponent</code> associated with this
             * object if one exists. Otherwise returns <code>null</code>.
             *
            ...
            /**
             * Gets the <code>AccessibleText</code> associated with this object
             ...
             * obscured by another (for example, it happens to be underneath a
             * menu that was pulled down).
             *
             ...
             *         space of the screen; <code>null</code> if this object or
        ...
        private class AccessibleJTableHeaderCell extends AccessibleContext implements Accessible,
            ...
            /*
             * Returns the AccessibleContext for the header cell renderer.
             */
             ...
             * can accept focus will also have the AccessibleState.FOCUSABLE
             ...
             * focus, nothing will happen. Otherwise, the object will attempt to
             * take focus.
             * 
