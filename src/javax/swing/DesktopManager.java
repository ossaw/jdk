...
public interface DesktopManager {
	/**
	 * If possible, display this frame in an appropriate location. Normally,
	 * this is not called, as the creator of the JInternalFrame will add the
	 * frame to the appropriate parent.
	 */
	...
	/**
	 * Generally, indicate that this frame has focus. This is usually called
	 * after the JInternalFrame's IS_SELECTED_PROPERTY has been set to true.
	 */
	void activateFrame(JInternalFrame f);

	/**
	 * Generally, indicate that this frame has lost focus. This is usually
	 * called after the JInternalFrame's IS_SELECTED_PROPERTY has been set to
	 * false.
	 */
	 ...
	 * begin dragging a component around. This method should be called prior to
	 * any dragFrame() calls to allow the DesktopManager to prepare any
	 * necessary state. Normally <b>f</b> will be a JInternalFrame.
	 */
	void beginDraggingFrame(JComponent f);

	/**
	 * The user has moved the frame. Calls to this method will be preceded by
	 * calls to beginDraggingFrame(). Normally <b>f</b> will be a
	 * JInternalFrame.
	 */
	void dragFrame(JComponent f, int newX, int newY);

	/**
	 * This method signals the end of the dragging session. Any state maintained
	 * by the DesktopManager can be removed here. Normally <b>f</b> will be a
	 * JInternalFrame.
	 */
	 ...
	 * will begin resizing the frame. This method should be called prior to any
	 * resizeFrame() calls to allow the DesktopManager to prepare any necessary
	 * state. Normally <b>f</b> will be a JInternalFrame.
	 */
	void beginResizingFrame(JComponent f, int direction);

	/**
	 * The user has resized the component. Calls to this method will be preceded
