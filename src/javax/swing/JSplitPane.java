...
public class JSplitPane extends JComponent implements Accessible {
	 ...
	 *            a boolean, true for the components to redraw continuously as
	 *            the divider changes position, false to wait until the divider
	 ...
	 * @exception IllegalArgumentException
	 *                if <code>orientation</code> is not one of:
	 ...
	 *            an integer specifying the last divider location in pixels,
	 *            from the left (or upper) edge of the pane to the left (or
	 ...
	 * @exception IllegalArgumentException
	 *                if orientation is not one of: HORIZONTAL_SPLIT or
	 *                VERTICAL_SPLIT.
	 ...
	 *
	 * @param newContinuousLayout
	 *            <code>true</code> if the components should continuously be
	...
	protected void addImpl(Component comp, Object constraints, int index) {
		...
		if (constraints != null
				&& (constraints.equals(JSplitPane.LEFT) || constraints.equals(JSplitPane.TOP))) {
	...
	protected String paramString() {
		String orientationString = (orientation == HORIZONTAL_SPLIT ? "HORIZONTAL_SPLIT"
				: "VERTICAL_SPLIT");
		...
		return super.paramString() + ",continuousLayout=" + continuousLayoutString + ",dividerSize="
				+ dividerSize + ",lastDividerLocation=" + lastDividerLocation
				+ ",oneTouchExpandable=" + oneTouchExpandableString + ",orientation="
				+ orientationString;
	}
