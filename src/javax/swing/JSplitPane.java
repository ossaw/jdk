 ...
 * How to Use Split Panes</a> in <em>The Java Tutorial</em>.
 * <p>
...
public class JSplitPane extends JComponent implements Accessible {
    ...
    /**
     * Vertical split indicates the <code>Component</code>s are split along the
     * y axis. For example the two <code>Component</code>s will be split one on
     * top of the other.
     */
    public final static int VERTICAL_SPLIT = 0;

    /**
     * Horizontal split indicates the <code>Component</code>s are split along
     * the x axis. For example the two <code>Component</code>s will be split one
    ...
    /**
     * Location of the divider, at least the value that was set, the UI may have
     * a different value.
     */
     ...
     */
    public JSplitPane() {
        this(JSplitPane.HORIZONTAL_SPLIT, UIManager.getBoolean("SplitPane.continuousLayout"), new JButton(
                UIManager.getString("SplitPane.leftButtonText")), new JButton(UIManager.getString(
     ...
     *            if <code>orientation</code> is not
     *            one of HORIZONTAL_SPLIT
     *            or VERTICAL_SPLIT.
     */
     ...
     *        continuously as
     *        the divider changes position, false to wait
     *        until the divider
     *        position stops changing to redraw
     * @exception IllegalArgumentException
     *            if <code>orientation</code> is not
     *            one of HORIZONTAL_SPLIT
     *            or VERTICAL_SPLIT
     ...
     *        the <code>Component</code> that will appear on
     *        the left of a
     *        horizontally-split pane, or at the top of a
     *        vertically-split
     *        pane
    ...
    /**
     * Returns the <code>SplitPaneUI</code> that is providing the current look
     * and feel.
     *
     * @return the <code>SplitPaneUI</code> object that renders this component
     * @beaninfo expert: true description: The L&amp;F object that renders this
     *           component.
     */
     ...
     *
     * @param comp
     *        the <code>Component</code> to display in that position
     */
     ...
     * @beaninfo preferred: true description: The component to the left (or
     *           above) the divider.
     */
     ...
     * @param comp
     *        the <code>Component</code> to display in that position
     * @beaninfo description: The component above, or to the left of the
     *           divider.
     */
     ...
     * @param comp
     *        the <code>Component</code> to display in that position
     * @beaninfo preferred: true description: The component to the right (or
     *           below) the divider.
     */
     ...
     * @param comp
     *        the <code>Component</code> to display in that position
     * @beaninfo description: The component below, or to the right of the
     *           divider.
     */
    ...
    /**
     * Sets the value of the <code>oneTouchExpandable</code> property, which
     * must be <code>true</code> for the <code>JSplitPane</code> to provide a UI
     * widget on the divider to quickly expand/collapse the divider. The default
     * value of this property is <code>false</code>. Some look and feels might
     * not support one-touch expanding; they will ignore this property.
     *
     * @param newValue
     *        <code>true</code> to specify that the split pane should
     *        provide a collapse/expand widget
     * @beaninfo bound: true description: UI widget on the divider to quickly
     ...
     * .
     *
     * @param newLastLocation
     *        an integer specifying the last divider location in
     *        pixels,
     *        from the left (or upper) edge of the pane to the
     *        left (or
     *        upper) edge of the divider
     * @beaninfo bound: true description: The last location the divider was at.
     */
     ...
     *
     * @return an integer specifying the last divider location as a count of
     *         pixels from the left (or upper) edge of the pane to the left (or
     *         upper) edge of the divider
     */
     ...
     *            HORIZONTAL_SPLIT or
     *            VERTICAL_SPLIT.
     * @beaninfo bound: true description: The orientation, or how the splitter
     *           is divided. enum: HORIZONTAL_SPLIT JSplitPane.HORIZONTAL_SPLIT
    ...
    /**
     * Sets the value of the <code>continuousLayout</code> property, which must
     * be <code>true</code> for the child components to be continuously
     * redisplayed and laid out during user intervention. The default value of
     * this property is look and feel dependent. Some look and feels might not
     * support continuous layout; they will ignore this property.
     *
     * @param newContinuousLayout
     *        <code>true</code> if the components should
     *        continuously be
     *        redrawn as the divider changes position
     * @beaninfo bound: true description: Whether the child components are
     *           continuously redisplayed and laid out during user intervention.
     ...
     * changes. A value of 0, the default, indicates the right/bottom component
     * gets all the extra space (the left/top component acts fixed), where as a
     * value of 1 specifies the left/top component gets all the extra space (the
     * right/bottom component acts fixed). Specifically, the left/top component
     * gets (weight * diff) extra space and the right/bottom component gets (1 -
     * weight) * diff extra space.
     *
     * @param value
     *        as described above
     * @exception IllegalArgumentException
     *            if <code>value</code> is &lt; 0 or
     *            &gt; 1
     * @since 1.3
     * @beaninfo bound: true description: Specifies how to distribute extra
     *           space when the split pane resizes.
     */
     ...
     * 
     * @return how extra space is to be distributed on a resize of the split
     *         pane
     * @since 1.3
     */
     ...
     * of the children components. This will likely result in changing the
     * divider location.
     */
    ...
    /**
     * Sets the divider location as a percentage of the <code>JSplitPane</code>
     * 's size.
     * <p>
     * This method is implemented in terms of
     * <code>setDividerLocation(int)</code>. This method immediately changes the
     * size of the split pane based on its current size. If the split pane is
     * not correctly realized and on screen, this method will have no effect
     * (new divider location will become (current size * proportionalLocation)
     * which is 0).
     *
     * @param proportionalLocation
     *        a double-precision floating point value that
     *        specifies a
     *        percentage, from zero (top/left) to 1.0
     *        (bottom/right)
     * @exception IllegalArgumentException
     ...
     * implementation, and then listeners are notified. A value less than 0
     * implies the divider should be reset to a value that attempts to honor the
     * preferred size of the left/top component. After notifying the listeners,
     * the last divider location is updated, via
     * <code>setLastDividerLocation</code>.
     *
     * @param location
     ...
     * location (if <code>setDividerLocation</code> was passed a value bigger
     ...
     *         <code>null</code>
     * @beaninfo description: The minimum location of the divider from the
     *           L&amp;F.
     */
    ...
    /**
     * Removes the child component, <code>component</code> from the pane. Resets
     * the <code>leftComponent</code> or <code>rightComponent</code> instance
    ...
    /**
     * Removes the <code>Component</code> at the specified index. Updates the
     * <code>leftComponent</code> and <code>rightComponent</code> instance
     * variables as necessary, and then messages super.
     *
     * @param index
     *        an integer specifying the component to remove, where 1
     *        specifies the left/top component and 2 specifies the
     ...
     * <code>leftComonent</code> and <code>rightComponent</code> instance
     * variables.
     */
    ...
    /**
     * Returns true, so that calls to <code>revalidate</code> on any descendant
     * of this <code>JSplitPane</code> will cause a request to be queued that
     ...
     * <li>JSplitPane.RIGHT
     * </ul>
     * If the <code>constraints</code> object is <code>null</code>, the
     * component is added in the first available position (left/top if open,
     * else right/bottom).
     *
     * @param comp
     *        the component to add
     * @param constraints
     *        an <code>Object</code> specifying the layout
     *        constraints
    ...
    protected void addImpl(Component comp, Object constraints, int index) {
        ...
        /*
         * If the constraints are null and the left/right component is invalid,
         * add it at the left/right component.
         */
        if (constraints == null) {
        ...
        if (constraints != null && (constraints.equals(JSplitPane.LEFT) || constraints.equals(
                JSplitPane.TOP))) {
            ...
            leftComponent = comp;
            index = -1;
        } else if (constraints != null && (constraints.equals(JSplitPane.RIGHT) || constraints.equals(
                JSplitPane.BOTTOM))) {
    ...
    /**
     * Returns a string representation of this <code>JSplitPane</code>. This
    ...
    protected String paramString() {
        ...
        return super.paramString() + ",continuousLayout=" + continuousLayoutString + ",dividerSize="
                + dividerSize + ",lastDividerLocation=" + lastDividerLocation + ",oneTouchExpandable="
    ...
    /**
     * Gets the AccessibleContext associated with this JSplitPane. For split
     * panes, the AccessibleContext takes the form of an AccessibleJSplitPane. A
     * new AccessibleJSplitPane instance is created if necessary.
     *
     * @return an AccessibleJSplitPane that serves as the AccessibleContext of
     *         this JSplitPane
     ...
     * <code>JSplitPane</code> class. It provides an implementation of the Java
     * Accessibility API appropriate to split pane user-interface elements.
     * <p>
     * <strong>Warning:</strong> Serialized objects of this class will not be
