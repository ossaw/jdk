...
public class JTree extends JComponent implements Scrollable, Accessible {
    ...
    public void setEditable(boolean flag) {
        ...
        if (accessibleContext != null) {
            accessibleContext.firePropertyChange(AccessibleContext.ACCESSIBLE_STATE_PROPERTY, (oldValue
                    ? AccessibleState.EDITABLE : null), (flag ? AccessibleState.EDITABLE : null));
        }
    }
    ...
    DropLocation dropLocationForPoint(Point p) {
        ...
        switch (dropMode) {
            ...
            case ON_OR_INSERT:
                ...
                boolean checkOn = dropMode == DropMode.ON_OR_INSERT || !model.isLeaf(getPathForRow(row)
                ...
                if (parent != null) {
                    location = new DropLocation(p, parent, model.getIndexOfChild(parent
                            .getLastPathComponent(), child.getLastPathComponent()));
        ...
        if (dropMode == DropMode.USE_SELECTION) {
            if (treeLocation == null) {
                ...
                if (dropLocation == null) {
                    ...
                    retVal = new TreePath[][] { paths, { getAnchorSelectionPath(), getLeadSelectionPath() } };
                } else {
                    retVal = state;
                }
    ...
    public String getToolTipText(MouseEvent event) {
        ...
        if (event != null) {
            ...
            if (selRow != -1 && r != null) {
                ...
                Component rComponent = r.getTreeCellRendererComponent(this, lastPath, isRowSelected(selRow),
                        isExpanded(selRow), getModel().isLeaf(lastPath), selRow, true);
    ...
    public void setLeadSelectionPath(TreePath newPath) {
        ...
        if (accessibleContext != null) {
            ((AccessibleJTree) accessibleContext).fireActiveDescendantPropertyChange(oldValue, newPath);
        }
    }
    ...
    public Enumeration<TreePath> getExpandedDescendants(TreePath parent) {
        ...
        if (toggledPaths != null) {
            while (toggledPaths.hasMoreElements()) {
                ...
                // expensive!
                if (path != parent && value != null && ((Boolean) value).booleanValue() && parent
                        .isDescendant(path) && isVisible(path)) {
                    if (elements == null) {
    ...
    public void setSelectionModel(TreeSelectionModel selectionModel) {
        ...
        if (accessibleContext != null) {
            accessibleContext.firePropertyChange(AccessibleContext.ACCESSIBLE_SELECTION_PROPERTY, Boolean
    ...
    public TreePath getNextMatch(String prefix, int startingRow, Position.Bias bias) {
        ...
        do {
            ...
            String text = convertValueToText(path.getLastPathComponent(), isRowSelected(row), isExpanded(row),
                    true, row, false);
    ...
    private TreePath[] getDescendantSelectedPaths(TreePath path, boolean includePath) {
        ...
        if (selPaths != null) {
            ...
            for (int counter = selPaths.length - 1; counter >= 0; counter--) {
                if (selPaths[counter] != null && path.isDescendant(selPaths[counter]) && (!path.equals(
                        selPaths[counter]) || includePath))
                    shouldRemove = true;
                else
        ...
        public static void createChildren(DefaultMutableTreeNode parent, Object children) {
            if (children instanceof Vector) {
                ...
                for (int counter = 0, maxCounter = childVector.size(); counter < maxCounter; counter++)
                    parent.add(new DynamicUtilTreeNode(childVector.elementAt(counter), childVector.elementAt(
                            counter)));
    ...
    protected String paramString() {
        ...
        return super.paramString() + ",editable=" + editableString + ",invokesStopCellEditing="
                + invokesStopCellEditingString + ",largeModel=" + largeModelString + ",rootVisible="
                + rootVisibleString + ",rowHeight=" + rowHeight + ",scrollsOnExpand=" + scrollsOnExpandString
                + ",showsRootHandles=" + showsRootHandlesString + ",toggleClickCount=" + toggleClickCount
     ...
     */
    @SuppressWarnings("serial")
    protected class AccessibleJTree extends AccessibleJComponent implements AccessibleSelection,
        ...
        public AccessibleJTree() {
            ...
            leadSelectionAccessible = (leadSelectionPath != null) ? new AccessibleJTreeNode(JTree.this,
                    leadSelectionPath, JTree.this) : null;
        }
        ...
        public void fireVisibleDataPropertyChange() {
            firePropertyChange(AccessibleContext.ACCESSIBLE_VISIBLE_DATA_PROPERTY, Boolean.valueOf(false),
                    Boolean.valueOf(true));
        }
        ...
        public void treeCollapsed(TreeExpansionEvent e) {
            ...
            if (path != null) {
                ...
                PropertyChangeEvent pce = new PropertyChangeEvent(node,
                        AccessibleContext.ACCESSIBLE_STATE_PROPERTY, AccessibleState.EXPANDED,
        ...
        public void treeExpanded(TreeExpansionEvent e) {
            ...
            if (path != null) {
                ...
                AccessibleJTreeNode node = new AccessibleJTreeNode(JTree.this, path, null);
                PropertyChangeEvent pce = new PropertyChangeEvent(node,
                        AccessibleContext.ACCESSIBLE_STATE_PROPERTY, AccessibleState.COLLAPSED,
        ...
        void fireActiveDescendantPropertyChange(TreePath oldPath, TreePath newPath) {
            if (oldPath != newPath) {
                Accessible oldLSA = (oldPath != null) ? new AccessibleJTreeNode(JTree.this, oldPath, null)
                        : null;

                Accessible newLSA = (newPath != null) ? new AccessibleJTreeNode(JTree.this, newPath, null)
                        : null;
        ...
        private Component getCurrentComponent() {
            ...
            if (JTree.this.isVisible(path)) {
                ...
                if (ui != null) {
                    ...
                    return r.getTreeCellRendererComponent(JTree.this, treeRoot, selected, expanded, model
                            .isLeaf(treeRoot), row, hasFocus);
                }
            }
            return null;
        }
            ...
            private Component getCurrentComponent() {
                ...
                if (tree.isVisible(path)) {
                    ...
                    if (ui != null) {
                        ...
                        return r.getTreeCellRendererComponent(tree, obj, selected, expanded, isLeaf, row,
                                hasFocus);
                    }
                }
                return null;
            ...
            public Accessible getAccessibleParent() {
                ...
                if (accessibleParent == null) {
                    ...
                    if (objPath.length > 1) {
                        ...
                        accessibleParent = new AccessibleJTreeNode(tree, parentPath, null);
