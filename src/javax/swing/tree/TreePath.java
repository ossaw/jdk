 ...
 * with {@code DefaultTreeModel}, the elements of the path are {@code TreeNode}
 * s. The following example illustrates extracting the user object from the
 * selection of a {@code JTree}:
 * 
 * <pre>
...
public class TreePath extends Object implements Serializable {
	...
	/**
	 * Creates a {@code TreePath} from an array. The array uniquely identifies
	 * the path to a node.
	 *
	 * @param path
	 *            an array of objects representing the path to a node
	 * @throws IllegalArgumentException
	 *             if {@code path} is {@code null}, empty, or contains a
	 *             {@code null} value
	 */
	...
	/**
	 * Creates a {@code TreePath} containing a single element. This is used to
	 ...
	 * @see #TreePath(Object[])
	 * @throws IllegalArgumentException
	 *             if {@code lastPathComponent} is {@code null}
	 */
	 ...
	 *
	 * @param parent
	 *            the path to the parent, or {@code null} to indicate the root
	 * @param lastPathComponent
	...
	/**
	 * Creates a {@code TreePath} from an array. The returned {@code TreePath}
	 * represents the elements of the array from {@code 0} to {@code length - 1}
	 * .
	 * <p>
	 ...
	 *             if {@code length - 1} is outside the range of the array
	 * @throws IllegalArgumentException
	 *             if any of the elements from {@code 0} to {@code length - 1}
	 *             are {@code null}
	 */
	...
	/**
	 * Creates an empty {@code TreePath}. This is provided for subclasses that
	 * represent paths in a different manner. Subclasses that use this
	 * constructor must override {@code getLastPathComponent}, and
	 * {@code getParentPath}.
	 */
	protected TreePath() {
	}
	...
	/**
	 * Returns an ordered array of the elements of this {@code TreePath}. The
	 ...
	 * {@code true} if {@code o} is a {@code TreePath} with the exact same
	 * elements (as determined by using {@code equals} on each element of the
	 * path).
	 *
	 * @param o
	 ...
	 * {@code TreePath} {@code P2} if {@code P1} contains all of the elements
	 * that make up {@code P2's} path. For example, if this object has the path
	 * {@code [a, b]}, and <code>aTreePath</code> has the path {@code [a, b, c]}
	 * , then <code>aTreePath</code> is a descendant of this object. However, if
	 * <code>aTreePath</code> has the path {@code [a]}, then it is not a
	 * descendant of this object. By this definition a {@code TreePath} is
	 * always considered a descendant of itself. That is,
	 ...
	 * <code>child</code>. <code>child</code> is the last element of the newly
