...
public class DefaultTreeCellEditor implements ActionListener, TreeCellEditor, TreeSelectionListener {
    ...
    public Component getTreeCellEditorComponent(JTree tree, Object value, boolean isSelected,
        ...
        editingComponent = realEditor.getTreeCellEditorComponent(tree, value, isSelected, expanded, leaf,
                row);
        ...
        if (event != null) {
            if (event.getSource() instanceof JTree) {
                ...
                if (event instanceof MouseEvent) {
                    TreePath path = tree.getPathForLocation(((MouseEvent) event).getX(), ((MouseEvent) event)
                            .getY());
