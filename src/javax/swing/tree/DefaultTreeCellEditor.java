 ...
 * <code>DefaultTreeCellRenderer</code> so that the icons can be obtained. You
 * can optionally supply a <code>TreeCellEditor</code> that will be layed out
 * according to the icon in the <code>DefaultTreeCellRenderer</code>. If you do
 * not supply a <code>TreeCellEditor</code>, a <code>TextField</code> will be
 * used. Editing is started on a triple mouse click, or after a click, pause,
...
public class DefaultTreeCellEditor implements ActionListener, TreeCellEditor,
    ...
    /**
     * As of Java 2 platform v1.4 this field should no longer be used. If you
     * wish to provide similar behavior you should directly override
    ...
    /**
     * Font to paint with, <code>null</code> indicates font of renderer is to be
     * used.
     */
    protected Font font;

    /**
     * Constructs a <code>DefaultTreeCellEditor</code> object for a JTree using
     * the specified renderer and a default editor. (Use this constructor for
     * normal editing.)
     *
     * @param tree
     ...
     * editor the receiver was instantiated with. If <code>null</code> for an
     * editor was passed in a default editor will be created that will pick up
     * this font.
     *
     * @param font
    ...
    public Component getTreeCellEditorComponent(JTree tree, Object value,
        ...
        canEdit = (lastPath != null && newPath != null && lastPath.equals(
                newPath));
        ...
        if (event != null) {
            if (event.getSource() instanceof JTree) {
                ...
                if (event instanceof MouseEvent) {
                    TreePath path = tree.getPathForLocation(((MouseEvent) event)
                            .getX(), ((MouseEvent) event).getY());
                    editable = (lastPath != null && path != null && lastPath
                            .equals(path));
                    if (path != null) {
                        ...
                        determineOffset(tree, value, isSelected, expanded, leaf,
                                lastRow);
                    }
                }
            }
     ...
     * <code>realEditor</code> is removed and true is returned, otherwise false
     * is returned.
     */
    ...
    /**
     * Messages <code>cancelCellEditing</code> to the <code>realEditor</code>
     ...
     * this DefaultTreeCellEditor with addCellEditorListener().
     *
    ...
    protected boolean shouldStartEditingTimer(EventObject event) {
        if ((event instanceof MouseEvent) && SwingUtilities.isLeftMouseButton(
                (MouseEvent) event)) {
            MouseEvent me = (MouseEvent) event;

            return (me.getClickCount() == 1 && inHitRegion(me.getX(), me
                    .getY()));
        }
        return false;
    }
     ...
     * <code>MouseEvent</code> with a click count &gt; 2 and
     * <code>inHitRegion</code> returns true.
     * 
     * @param event
     *              the event being studied
     */
     ...
     * &lt;= the width of the icon and icon gap displayed by the renderer. In
    ...
    protected boolean inHitRegion(int x, int y) {
        if (lastRow != -1 && tree != null) {
            ...
            ComponentOrientation treeOrientation = tree
            ...
            } else if (bounds != null && (x >= (bounds.x + bounds.width - offset
                    + 5) || x <= (bounds.x + 5)) && offset < (bounds.width
                            - 5)) {
                return false;
            }
        }
    ...
    protected TreeCellEditor createTreeCellEditor() {
        ...
        DefaultCellEditor editor = new DefaultCellEditor(new DefaultTextField(
                aBorder)) {
            public boolean shouldSelectCell(EventObject event) {
    ...
    public class DefaultTextField extends JTextField {
        ...
        /**
         * Constructs a <code>DefaultTreeCellEditor.DefaultTextField</code>
         * object.
         *
         * @param border
        ...
        public Dimension getPreferredSize() {
            ...
            if (renderer != null && DefaultTreeCellEditor.this
                    .getFont() == null) {
    ...
    public class EditorContainer extends Container {
        ...
        public void paint(Graphics g) {
            ...
            if (editingIcon != null) {
                ...
                if (getComponentOrientation().isLeftToRight()) {
                    ...
                    editingIcon.paintIcon(this, g, width - editingIcon
                            .getIconWidth(), yLoc);
                }
            }
        ...
        public void doLayout() {
            if (editingComponent != null) {
                ...
                int height = getHeight();
                if (getComponentOrientation().isLeftToRight()) {
                    editingComponent.setBounds(offset, 0, width - offset,
                            height);
                } else {
        ...
        private int calculateIconY(Icon icon) {
            ...
            int textHeight = editingComponent.getFontMetrics(editingComponent
                    .getFont()).getHeight();
        ...
        /**
         * Returns the preferred size for the <code>Container</code>. This will
         * be at least preferred size of the editor plus <code>offset</code>.
         * 
         * @return a <code>Dimension</code> containing the preferred size for
         *         the <code>Container</code>; if <code>editingComponent</code>
         *         is <code>null</code> the <code>Dimension</code> returned is
         *         0, 0
         */
        public Dimension getPreferredSize() {
            if (editingComponent != null) {
                ...
                Dimension rSize = (renderer != null) ? renderer
                        .getPreferredSize() : null;

                if (rSize != null)
                    pSize.height = Math.max(pSize.height, rSize.height);
                if (editingIcon != null)
                    pSize.height = Math.max(pSize.height, editingIcon
                            .getIconHeight());
