 ...
 * <code>ComponentOrientation</code> for more information. All columns in a row
...
public class LayoutFocusTraversalPolicy extends SortingFocusTraversalPolicy
	...
	public Component getComponentAfter(Container aContainer, Component aComponent) {
		...
		if (comparator instanceof LayoutComparator) {
			((LayoutComparator) comparator)
					.setComponentOrientation(aContainer.getComponentOrientation());
		}
	...
	/**
	 * Determines whether the specified <code>Component</code> is an acceptable
	 * choice as the new focus owner. This method performs the following
	 * sequence of operations:
	 * <ol>
	 * <li>Checks whether <code>aComponent</code> is visible, displayable,
	 * enabled, and focusable. If any of these properties is <code>false</code>,
	 ...
	 * <li>If <code>aComponent</code> is a <code>JComponent</code> with a
	 * <code>JComponent.WHEN_FOCUSED</code> <code>InputMap</code> that is
	 * neither <code>null</code> nor empty, returns <code>true</code>.
	 * <li>Returns the value of
	 * <code>DefaultFocusTraversalPolicy.accept(aComponent)</code>.
	 * </ol>
	 *
	 * @param aComponent
	 *            the <code>Component</code> whose fitness as a focus owner is
	 *            to be tested
	 ...
	 *         for a focus owner; otherwise <code>false</code>
	 */
