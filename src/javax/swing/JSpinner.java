 ...
 * the <code>model</code>'s value to differ from that of the <code>editor</code>
 * . To make sure the <code>model</code> has the same value as the editor use
 * the <code>commitEdit</code> method, eg:
 * 
 * <pre>
 * try {
 *     spinner.commitEdit();
 ...
 * "https://docs.oracle.com/javase/tutorial/uiswing/components/spinner.html">How
...
public class JSpinner extends JComponent implements Accessible {
     ...
     * @since 1.4
     */
    public static class DefaultEditor extends JPanel implements ChangeListener, PropertyChangeListener,
            LayoutManager {
        /**
     ...
     * <code>SpinnerDateModel</code>. The value of the editor is displayed with
     * a <code>JFormattedTextField</code> whose format is defined by a
     * <code>DateFormatter</code> instance whose <code>minimum</code> and
    ...
    public static class DateEditor extends DefaultEditor {
         ...
         * editing the value of a <code>SpinnerDateModel</code> with a
         * <code>JFormattedTextField</code>. <code>This</code>
         * <code>DateEditor</code> becomes both a <code>ChangeListener</code> on
         * the spinners model and a <code>PropertyChangeListener</code> on the
         ...
         * <code>JFormattedTextField</code>. <code>This</code>
         * <code>DateEditor</code> becomes both a <code>ChangeListener</code> on
         * the spinner and a <code>PropertyChangeListener</code> on the new
         * <code>JFormattedTextField</code>.
         *
         * @param spinner
    ...
    public static class ListEditor extends DefaultEditor {
         ...
         * <code>JFormattedTextField</code>. <code>This</code>
         * <code>ListEditor</code> becomes both a <code>ChangeListener</code> on
         * the spinner and a <code>PropertyChangeListener</code> on the new
         * <code>JFormattedTextField</code>.
         *
         * @param spinner
            ...
            private class Filter extends DocumentFilter {
                public void replace(FilterBypass fb, int offset, int length, String string,
                    ...
                    if (string != null && (offset + length) == fb.getDocument().getLength()) {
                        Object next = getModel().findNextMatch(fb.getDocument().getText(0, offset) + string);
    ...
    /**
     * <code>AccessibleJSpinner</code> implements accessibility support for the
     * <code>JSpinner</code> class.
     * 
     * @since 1.5
     */
    protected class AccessibleJSpinner extends AccessibleJComponent implements AccessibleValue,
         ...
         * increments the spinner value and AccessibleAction.DECREMENT which
