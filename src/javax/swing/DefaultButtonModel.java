...
public class DefaultButtonModel implements ButtonModel, Serializable {
    ...
    /**
     * Only one <code>ChangeEvent</code> is needed per button model instance
     * since the event's only state is the source property. The source of events
    ...
    /**
     * Identifies the "selected" bit in the bitmask, which indicates that the
     * button has been selected. Only needed for certain types of buttons - such
     * as radio button or check box.
     */
     ...
     * you can query a <code>DefaultButtonModel</code> instance <code>m</code>
