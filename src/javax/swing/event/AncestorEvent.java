...
public class AncestorEvent extends AWTEvent {
	...
	/**
	 * An ancestor-component was removed from the hierarchy of visible objects
	 * (hidden) and is no longer being displayed.
	 */
	...
	/**
	 * Returns the parent of the ancestor the event actually occurred on. This
	 * is most interesting in an ANCESTOR_REMOVED event, as the ancestor may no
	 * longer be in the component hierarchy.
	 */
