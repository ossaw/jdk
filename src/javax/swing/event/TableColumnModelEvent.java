...
/**
 * <B>TableColumnModelEvent</B> is used to notify listeners that a table column
...
public class TableColumnModelEvent extends java.util.EventObject {
	 ...
	 * @param from
	 *            an int specifying the index from where the column was moved or
	 *            removed
	 * @param to
	 *            an int specifying the index to where the column was moved or
	 *            added
	 * @see #getFromIndex
	 * @see #getToIndex
	 */
