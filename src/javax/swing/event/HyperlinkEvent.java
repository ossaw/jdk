...
public class HyperlinkEvent extends EventObject {
	...
	/**
	 * Creates a new object representing a hypertext link event. The other
	 * constructor is preferred, as it provides more information if a URL could
	 ...
	 *            the event type
	 * @param u
	 *            the affected URL. This may be null if a valid URL could not be
	 *            created.
	 * @param desc
	 *            the description of the link. This may be useful when
	 *            attempting to form a URL resulted in a MalformedURLException.
	 *            The description provides the text used when attempting to form
	 *            the URL.
	 */
	...
	/**
	 * Get the description of the link as a string. This may be useful if a URL
	 * can't be formed from the description, in which case the associated URL
	 * would be null.
	 */
	 ...
	 * event. This will typically be an <code>Element</code> representing an
	 * anchor. If a constructor that is used that does not specify a source
	...
	/**
	 * Returns the {@code InputEvent} that triggered the hyperlink event. This
	 * will typically be a {@code MouseEvent}. If a constructor is used that
	 * does not specify an {@code InputEvent}, or @{code null} was specified as
	 * the {@code InputEvent}, this returns {@code null}.
	 *
	...
	/**
	 * Defines the ENTERED, EXITED, and ACTIVATED event types, along with their
