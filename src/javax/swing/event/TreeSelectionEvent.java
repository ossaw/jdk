...
public class TreeSelectionEvent extends EventObject {
    ...
    /**
     * Represents a change in the selection of a TreeSelectionModel. paths
     * identifies the paths that have been either added or removed from the
     * selection.
     *
     * @param source
     *               source of event
    ...
    /**
     * Represents a change in the selection of a TreeSelectionModel. path
     * identifies the path that have been either added or removed from the
     * selection.
     *
     * @param source
     *               source of event
    ...
    /**
     * Returns whether the path identified by {@code getPath} was added to the
     * selection. A return value of {@code true} indicates the path identified
     * by {@code getPath} was added to the selection. A return value of
     * {@code false} indicates {@code
    ...
    /**
     * Returns whether the specified path was added to the selection. A return
     * value of {@code true} indicates the path identified by {@code path} was
     * added to the selection. A return value of {@code false} indicates
     * {@code path} is no longer selected. This method is only valid for the
     * paths returned from {@code getPaths()}; invoking with a path not included
    ...
    /**
     * Returns whether the path at {@code getPaths()[index]} was added to the
     * selection. A return value of {@code true} indicates the path was added to
     * the selection. A return value of {@code false} indicates the path is no
     * longer selected.
     *
     * @param index
