...
public class InternalFrameEvent extends AWTEvent {
	 ...
	 * the internal frame is made visible.
	 *
	 ...
	 * attempts to close the internal frame, such as by clicking the internal
	 * frame's close button, or when a program attempts to close the internal
	...
	/**
	 * The "window closed" event. This event is delivered after the internal
	...
	/**
	 * The "window iconified" event. This event indicates that the internal
	 * frame was shrunk down to a small icon.
	 *
