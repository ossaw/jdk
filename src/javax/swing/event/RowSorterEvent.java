...
public class RowSorterEvent extends java.util.EventObject {
	...
	public enum Type {
		...
		/**
		 * Indicates the contents have been newly sorted or transformed in some
		 * way.
		 */
		SORTED
	}
	 ...
	 * @throws IllegalArgumentException
	 *             if source or <code>type</code> is <code>null</code>
	 */
	...
	/**
	 * Returns the location of <code>index</code> in terms of the model prior to
	 * the sort. This method is only useful for events of type
	 * <code>SORTED</code>. This method will return -1 if the index is not
	...
	/**
	 * Returns the number of rows before the sort. This method is only useful
	 * for events of type <code>SORTED</code> and if the last locations have not
	 * been provided will return 0.
	 *
