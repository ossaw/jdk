...
public class MenuDragMouseEvent extends MouseEvent {
	 ...
	 * @param modifiers
	 *            an int specifying any modifier keys held down, as specified in
	 *            {@link java.awt.event.InputEvent}
	 * @param x
	 *            an int specifying the horizontal position at which the event
	 *            occurred, in pixels
	 * @param y
	 *            an int specifying the vertical position at which the event
	 *            occurred, in pixels
	 * @param clickCount
	 *            an int specifying the number of mouse-clicks
	 * @param popupTrigger
	 *            a boolean -- true if the event {should?/did?} trigger a popup
	 * @param p
	 *            an array of MenuElement objects specifying a path to a menu
	 ...
	 * @param yAbs
	 *            an int specifying the vertical absolute position at which the
