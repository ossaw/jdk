...
public class MenuDragMouseEvent extends MouseEvent {
     ...
     *        occurred, in pixels
     * @param y
     *        an int specifying the vertical position at which the
     *        event
     *        occurred, in pixels
     * @param clickCount
     *        an int specifying the number of mouse-clicks
     * @param popupTrigger
     *        a boolean -- true if the event {should?/did?} trigger
     *        a popup
     * @param p
     *        an array of MenuElement objects specifying a path to
     *        a menu
     ...
     *        occurred, in pixels
     * @param xAbs
     *        an int specifying the horizontal absolute position at
     *        which
     *        the event occurred, in pixels
     * @param yAbs
     *        an int specifying the vertical absolute position at
     *        which the
     *        event occurred, in pixels
     * @param clickCount
     *        an int specifying the number of mouse-clicks
     * @param popupTrigger
     *        a boolean -- true if the event {should?/did?} trigger
     ...
     * @since 1.6
     */
    public MenuDragMouseEvent(Component source, int id, long when, int modifiers, int x, int y, int xAbs,
            int yAbs, int clickCount, boolean popupTrigger, MenuElement p[], MenuSelectionManager m) {
