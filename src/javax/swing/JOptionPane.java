...
public class JOptionPane extends JComponent implements Accessible {
	...
	public static int showInternalOptionDialog(Component parentComponent, Object message,
		...
		try {
			Method method = AccessController
					.doPrivileged(new ModalPrivilegedAction(Container.class, "startLWModal"));
			if (method != null) {
	 ...
	 *
	 * @param parentComponent
	 *            the parent <code>Component</code> for the internal frame
	 * @param title
	 *            the <code>String</code> to display in the frame's title bar
	 * @return a <code>JInternalFrame</code> containing a
	 *         <code>JOptionPane</code>
	 * @exception RuntimeException
	 *                if <code>parentComponent</code> does not have a valid
	 *                parent
	 */
	public JInternalFrame createInternalFrame(Component parentComponent, String title) {
		...
		iFrame.setBounds((rootSize.width - iFrameSize.width) / 2,
				(rootSize.height - iFrameSize.height) / 2, iFrameSize.width, iFrameSize.height);
	 ...
	 *
	 * @param newOptions
	 *            an array of <code>Objects</code> that create the buttons the
	 *            user can click on, or arbitrary <code>Components</code> to add
	 *            to the pane
	 *
	 * @see #getOptions
	 ...
	 * 
	 * @param newValues
	 *            an array of <code>Objects</code> the user to be displayed
	 *            (usually in a list or combo-box) from which the user can make
	 *            a selection
	 * @see #setWantsInput
	 ...
	 *
	 * @param newValue
	 *            the <code>Object</code> used to set the value that the user
	...
	private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
		...
		if (indexCounter < maxCounter
				&& values.elementAt(indexCounter).equals("initialSelectionValue")) {
