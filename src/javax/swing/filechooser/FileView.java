 ...
 * provide the filechooser with UI information for a <code>File</code>. Each
 * L&amp;F <code>JFileChooserUI</code> object implements this class to pass back
 * the correct icons and type descriptions specific to that L&amp;F. For
 * example, the Microsoft Windows L&amp;F returns the generic Windows icons for
...
public abstract class FileView {
    ...
    /**
     * A human readable description of the file. For example, a file named
     * <i>jag.jpg</i> might have a description that read:
     ...
     * <code>jpg</code> file might have a type description of:
     ...
     * example, if you want a directory to represent a compound document and
     * don't want the user to descend into it.
     */
