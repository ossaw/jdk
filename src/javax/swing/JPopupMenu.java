...
public class JPopupMenu extends JComponent implements Accessible, MenuElement {
    ...
    static {
        popupPostionFixDisabled = java.security.AccessController.doPrivileged(
                new sun.security.action.GetPropertyAction("javax.swing.adjustPopupLocationToFit", "")).equals(
                        "false");
    ...
    /**
     * Gets the <code>defaultLightWeightPopupEnabled</code> property, which by
     ...
     * which by default is <code>true</code>. By default, when a look and feel
     * displays a popup, it can choose to use a lightweight (all-Java) popup.
     * Lightweight popup windows are more efficient than heavyweight (native
     * peer) windows, but lightweight and heavyweight components do not mix well
     * in a GUI. If your application mixes lightweight and heavyweight
     * components, you should disable lightweight popups. Some look and feels
     * might always use heavyweight popups, no matter what the value of this
     * property.
     *
     * @param aFlag
    ...
    /**
     * Always returns true since popups, by definition, should always be on top
    ...
    /**
     * Lays out the container so that it uses the minimum space needed to
    ...
    public void setVisible(boolean b) {
        ...
        if (b == false) {
            ...
            // 4234793: This is a workaround because
            // JPopupMenu.firePopupMenuCanceled is
            // a protected method and cannot be called from BasicPopupMenuUI
            // directly
    ...
    /**
     * Returns the popup menu which is at the root of the menu system for this
     * popup menu.
     *
    ...
    JPopupMenu getRootPopupMenu() {
        JPopupMenu mp = this;
        while ((mp != null) && (mp.isPopupMenu() != true) && (mp.getInvoker() != null) && (mp.getInvoker()
                .getParent() != null) && (mp.getInvoker().getParent() instanceof JPopupMenu)) {
    ...
    /**
     * Sets the size of the Popup window to the specified width and height. This
     * is equivalent to
    ...
    /**
     * Paints the popup menu's border if the <code>borderPainted</code> property
     * is <code>true</code>.
     * 
     * @param g
    ...
    /**
     * Gets the AccessibleContext associated with this JPopupMenu. For
     * JPopupMenus, the AccessibleContext takes the form of an
     * AccessibleJPopupMenu. A new AccessibleJPopupMenu instance is created if
     * necessary.
     *
     * @return an AccessibleJPopupMenu that serves as the AccessibleContext of
     *         this JPopupMenu
     */
     ...
     * <code>JPopupMenu</code> class. It provides an implementation of the Java
    ...
    protected class AccessibleJPopupMenu extends AccessibleJComponent implements PropertyChangeListener {
        ...
        /*
         * Fires AccessibleActiveDescendant PropertyChangeEvent to notify
         * listeners on the popup menu invoker that a popup list item has been
         * selected
         */
            ...
            if (JPopupMenu.this instanceof BasicComboPopup) {
                ...
                if (selectedItem != null && invoker != null) {
                    ...
                    if (invokerContext != null) {
                        ...
                        invokerContext.firePropertyChange(ACCESSIBLE_ACTIVE_DESCENDANT_PROPERTY, null,
                                selectedItem);
                    }
                }
            }
