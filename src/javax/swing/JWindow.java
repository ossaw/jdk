 ...
 * of the <code>JWindow</code>. As a convenience, the {@code add},
 * {@code remove}, and {@code setLayout} methods of this class are overridden,
 * so that they delegate calls to the corresponding methods of the
 * {@code ContentPane}. For example, you can add a child component to a window
 * as follows:
 * 
 * <pre>
 * window.add(child);
...
public class JWindow extends Window implements Accessible, RootPaneContainer,
     ...
     * is set to true when the <code>JWindow</code> is constructed.
     *
    ...
    /**
     * Creates a window with the specified <code>GraphicsConfiguration</code> of
     * a screen device. This window will not be focusable.
     * <p>
     * This constructor sets the component's locale property to the value
     * returned by <code>JComponent.getDefaultLocale</code>.
     *
    ...
    /**
     * Creates a window with the specified owner frame. If <code>owner</code> is
     * <code>null</code>, the shared owner will be used and this window will not
    ...
    /**
     * Sets the new <code>rootPane</code> object for this window. This method is
    ...
    /**
     * Sets the <code>contentPane</code> property for this window. This method
     ...
     * @beaninfo hidden: true description: The client area of the window where
    ...
    /**
     * Returns a string representation of this <code>JWindow</code>. This method
    ...
    /**
     * Gets the AccessibleContext associated with this JWindow. For JWindows,
     * the AccessibleContext takes the form of an AccessibleJWindow. A new
     * AccessibleJWindow instance is created if necessary.
     *
     * @return an AccessibleJWindow that serves as the AccessibleContext of this
     *         JWindow
     */
    ...
    /**
     * This class implements accessibility support for the <code>JWindow</code>
     * class. It provides an implementation of the Java Accessibility API
     * appropriate to window user-interface elements.
     */
    @SuppressWarnings("serial")
