 ...
 * {@code JDialog}. As a convenience, the {@code add}, {@code remove}, and
 ...
 * you can add a child component to a dialog as follows:
 * 
 * <pre>
 * dialog.add(child);
 * </pre>
 ...
 * JavaBeans&trade; has been added to the {@code java.beans} package. Please see
...
public class JDialog extends Dialog implements WindowConstants, Accessible, RootPaneContainer,
	...
	/**
	 * If true then calls to {@code add} and {@code setLayout} will be forwarded
	 * to the {@code contentPane}. This is initially false, but is set to true
	 * when the {@code JDialog} is constructed.
	 *
	 ...
	 *            windows when shown. If {@code true}, the modality type
	 *            property is set to {@code DEFAULT_MODALITY_TYPE}, otherwise
	 ...
	 *            specifies whether dialog blocks user input to other top-level
	 *            windows when shown. If {@code true}, the modality type
	 *            property is set to {@code DEFAULT_MODALITY_TYPE} otherwise the
	 *            dialog is modeless
	 * @throws HeadlessException
	 *             if {@code GraphicsEnvironment.isHeadless()} returns
	 *             {@code true}.
	 ...
	 *            if {@code null}, the default system
	 ...
	 *
	 * @param owner
	 *            the owner {@code Dialog} from which the dialog is displayed or
	 *            {@code null} if this dialog has no owner
	 * @throws HeadlessException
	 *             {@code if GraphicsEnvironment.isHeadless()} returns
	 *             {@code true}.
	 * @see java.awt.GraphicsEnvironment#isHeadless
	 * @see JComponent#getDefaultLocale
	 */
	 ...
	 *             if the {@code owner} is not an instance of
	 *             {@link java.awt.Dialog Dialog} or {@link java.awt.Frame
	 *             Frame}
	 * @throws IllegalArgumentException
	 *             if the {@code owner}'s {@code GraphicsConfiguration} is not
	 ...
	 *            shown. {@code null} value and unsupported modality types are
	 ...
	 *             modal dialogs with the given {@code modalityType}
	 *
	 * @see java.awt.Dialog.ModalityType
	 * @see java.awt.Dialog#setModal
	 * @see java.awt.Dialog#setModalityType
	 ...
	 *            {@code null} if this dialog has no owner
	 * @param title
	 *            the {@code String} to display in the dialog's title bar or
	 ...
	 * </ul>
	 * <p>
	 * The value is set to {@code HIDE_ON_CLOSE} by default. Changes to the
	 ...
	 * <a href="../../java/awt/doc-files/AWTThreadIssues.html"> AWT Threading
	 ...
	 *           WindowConstants.DISPOSE_ON_CLOSE description: The dialog's
	...
	/**
	 * Returns the operation which occurs when the user initiates a "close" on
	 * this dialog.
	 *
	 ...
	 * support transfer of data into this component. Use {@code null} if the
	 * component does not support data transfer operations.
	 * <p>
	 ...
	 * provides data import capability, as the data export related methods are
	 * currently typed to {@code JComponent}.
	 * <p>
	 * Please see
	...
	/**
	 * Calls {@code paint(g)}. This method was overridden to prevent an
	...
	/**
	 * Returns whether calls to {@code add} and {@code setLayout} are forwarded
	 * to the {@code contentPane}.
	 *
	 * @return true if {@code add} and {@code setLayout} are forwarded; false
	 *         otherwise
	 *
	 * @see #addImpl
	 * @see #setLayout
	...
	/**
	 * Sets whether calls to {@code add} and {@code setLayout} are forwarded to
	 * the {@code contentPane}.
	 *
	 * @param enabled
	 *            true if {@code add} and {@code setLayout} are forwarded, false
	 *            if they should operate directly on the {@code JDialog}.
	 *
	 * @see #addImpl
	 * @see #setLayout
	 * @see #isRootPaneCheckingEnabled
	...
	/**
	 * Adds the specified child {@code Component}. This method is overridden to
	 * conditionally forward calls to the {@code contentPane}. By default,
	 * children are added to the {@code contentPane} instead of the frame, refer
	 * to {@link javax.swing.RootPaneContainer} for details.
	 *
	 * @param comp
	...
	/**
	 * Removes the specified component from the container. If {@code comp} is
	 * not the {@code rootPane}, this will forward the call to the
	 * {@code contentPane}. This will do nothing if {@code comp} is not a child
	 * of the {@code JDialog} or {@code contentPane}.
	 *
	 * @param comp
	 *            the component to be removed
	 * @throws NullPointerException
	 *             if {@code comp} is null
	 * @see #add
	 * @see javax.swing.RootPaneContainer
	 */
	...
	/**
	 * Sets the {@code LayoutManager}. Overridden to conditionally forward the
	 * call to the {@code contentPane}. Refer to
	 * {@link javax.swing.RootPaneContainer} for more information.
	 *
	 * @param manager
	 *            the {@code LayoutManager}
	 * @see #setRootPaneCheckingEnabled
	 * @see javax.swing.RootPaneContainer
	 */
	...
	/**
	 * Sets the {@code rootPane} property. This method is called by the
	 * constructor.
	 *
	 * @param root
	 *            the {@code rootPane} object for this dialog
	 *
	 * @see #getRootPane
	 *
	...
	/**
	 * Sets the {@code contentPane} property. This method is called by the
	 * constructor.
	 * <p>
	 * Swing's painting architecture requires an opaque {@code JComponent} in
	 * the containment hierarchy. This is typically provided by the content
	 * pane. If you replace the content pane it is recommended you replace it
	 * with an opaque {@code JComponent}.
	 * 
	 * @see JRootPane
	 *
	 * @param contentPane
	 *            the {@code contentPane} object for this dialog
	 *
	...
	/**
	 * Sets the {@code layeredPane} property. This method is called by the
	 * constructor.
	 *
	 * @param layeredPane
	 *            the new {@code layeredPane} property
	 *
	 * @throws java.awt.IllegalComponentStateException
	...
	/**
	 * Sets the {@code glassPane} property. This method is called by the
	 * constructor.
	 *
	 * @param glassPane
	 *            the {@code glassPane} object for this dialog
	 * @see #getGlassPane
	...
	/**
	 * Repaints the specified rectangle of this component within {@code time}
	 * milliseconds. Refer to {@code RepaintManager} for details on how the
	 * repaint is handled.
	 *
	 * @param time
	 ...
	 * should have their Window decorations (such as borders, widgets to close
	 * the window, title...) provided by the current look and feel. If
	 * {@code defaultLookAndFeelDecorated} is true, the current
	 * {@code LookAndFeel} supports providing window decorations, and the
	 * current window manager supports undecorated windows, then newly created
	 * {@code JDialog}s will have their Window decorations provided by the
	 * current {@code LookAndFeel}. Otherwise, newly created {@code JDialog}s
	 * will have their Window decorations provided by the current window
	 * manager.
	 * <p>
	 ...
	 *            A hint as to whether or not current look and feel should
	...
	/**
	 * Returns true if newly created {@code JDialog}s should have their Window
	 * decorations provided by the current look and feel. This is only a hint,
	...
	/**
	 * Returns a string representation of this {@code JDialog}. This method is
	...
	protected String paramString() {
		...
		return super.paramString() + ",defaultCloseOperation=" + defaultCloseOperationString
				+ ",rootPane=" + rootPaneString + ",rootPaneCheckingEnabled="
	...
	/**
	 * Gets the AccessibleContext associated with this JDialog. For JDialogs,
	 * the AccessibleContext takes the form of an AccessibleJDialog. A new
	 * AccessibleJDialog instance is created if necessary.
	 *
	 * @return an AccessibleJDialog that serves as the AccessibleContext of this
	 *         JDialog
	 */
