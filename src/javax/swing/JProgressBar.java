 ...
 * target="_top">How to Monitor Progress</a>, a section in
...
public class JProgressBar extends JComponent implements SwingConstants, Accessible {
    ...
    /**
     * Whether the progress bar is horizontal or vertical. The default is
    ...
    /**
     * Whether to display a border around the progress bar. The default is
     * <code>true</code>.
     *
     ...
     * is <code>null</code>. Setting this to a non-<code>null</code> value does
     * not imply that the string will be displayed. To display the string,
    ...
    /**
     * Whether to display a string of text on the progress bar. The default is
     * <code>false</code>. Setting this to <code>true</code> causes a textual
     * display of the progress to be rendered on the progress bar. If the
     * <code>progressString</code> is <code>null</code>, the percentage of
     * completion is displayed on the progress bar. Otherwise, the
     * <code>progressString</code> is rendered on the progress bar.
     *
     * @see #setStringPainted
     * @see #setString
     */
     ...
     * event's only interesting property is the immutable source, which is the
     * progress bar. The event is lazily created the first time that an event
    ...
    /**
     * Listens for change events sent by the progress bar's model, redispatching
     * them to change-event listeners registered upon this progress bar.
     *
    ...
    /**
     * Whether the progress bar is indeterminate (<code>true</code>) or normal (
     ...
     * Sets the initial value of the progress bar to the specified minimum. By
     * default, a border is painted but a progress string is not.
     * <p>
     ...
     * maximum. By default, a border is painted but a progress string is not.
    ...
    /**
     * Creates a horizontal progress bar that uses the specified model to hold
     * the progress bar's data. By default, a border is painted but a progress
     * string is not.
     *
     * @param newModel
     ...
     * {@code SwingConstants.HORIZONTAL}, depending on the orientation of the
     * progress bar. The default orientation is
    ...
    /**
     * Sets the progress bar's orientation to <code>newOrientation</code>, which
     * must be {@code SwingConstants.VERTICAL} or
     * {@code SwingConstants.HORIZONTAL}. The default orientation is
     * {@code SwingConstants.HORIZONTAL}.
     *
     * @param newOrientation
     *        <code>HORIZONTAL</code> or <code>VERTICAL</code>
     * @exception IllegalArgumentException
     *            if <code>newOrientation</code> is an
     *            illegal value
     * @see #getOrientation
                ...
                case HORIZONTAL:
                    ...
                    if (accessibleContext != null) {
                        accessibleContext.firePropertyChange(AccessibleContext.ACCESSIBLE_STATE_PROPERTY,
                                ((oldOrientation == VERTICAL) ? AccessibleState.VERTICAL
                                        : AccessibleState.HORIZONTAL), ((orientation == VERTICAL)
    ...
    /**
     * Sets the value of the <code>stringPainted</code> property, which
     * determines whether the progress bar should render a progress string. The
     * default is <code>false</code>, meaning no string is painted. Some look
     * and feels might not support progress strings or might support them only
     * when the progress bar is in determinate mode.
     *
     * @param b
     ...
     *           the progress bar should render a string.
     */
    ...
    /**
     * Returns a {@code String} representation of the current progress. By
     * default, this returns a simple percentage {@code String} based on the
     * value returned from {@code getPercentComplete}. An example would be the
     * "42%". You can change this by calling {@code setString}.
     *
     ...
     * <code>null</code>, implying the built-in behavior of using a simple
     * percent string. If you have provided a custom progress string and want to
     * revert to the built-in behavior, set the string back to <code>null</code>
     * .
     * <p>
     * The progress string is painted only if the <code>isStringPainted</code>
     ...
     * @see #setStringPainted
     * @see #isStringPainted
     * @beaninfo bound: true attribute: visualUpdate true description: Specifies
     *           the progress string to paint
     */
    ...
    /**
     * Sets the <code>borderPainted</code> property, which is <code>true</code>
     * if the progress bar should paint its border. The default value for this
     * property is <code>true</code>. Some look and feels might not implement
     ...
     * @see #isBorderPainted
     * @beaninfo bound: true attribute: visualUpdate true description: Whether
     *           the progress bar should paint its border.
     */
     ...
     *
     * @param g
     *        the <code>Graphics</code> context within which to paint the
     *        border
     * @see #paint
     * @see #setBorder
     * @see #isBorderPainted
     ...
     *
     * @param ui
     *        a <code>ProgressBarUI</code> object
     ...
     * the event source. <p> <strong>Warning:</strong> Serialized objects of
     * this class will not be compatible with future Swing releases. The current
     ...
     * support for long term storage of all JavaBeans&trade; has been added to
     * the <code>java.beans</code> package. Please see {@link
    ...
    /**
     * Subclasses that want to handle change events from the model differently
     * can override this to return an instance of a custom
     * <code>ChangeListener</code> implementation. The default
     * {@code ChangeListener} simply calls the {@code fireStateChanged} method
     * to forward {@code ChangeEvent}s to the {@code ChangeListener}s that have
     * been added directly to the progress bar.
     *
     * @see #changeListener
     * @see #fireStateChanged
     ...
     * progress bar with <code>addChangeListener</code>.
     *
     ...
     * {@code ChangeEvent}s. This method is called each time a
     * {@code ChangeEvent} is received from the model.
     * <p>
    ...
    /**
     * Sets the data model used by the <code>JProgressBar</code>. Note that the
     * {@code BoundedRangeModel}'s {@code extent} is not used, and is set to
     * {@code 0}.
     *
     * @param newModel
     *        the <code>BoundedRangeModel</code> to use
     * @beaninfo expert: true description: The data model used by the
     *           JProgressBar.
     */
    public void setModel(BoundedRangeModel newModel) {
        // PENDING(???) setting the same model to multiple bars is broken;
        // listeners
        ...
        if (newModel != oldModel) {
            ...
            if (accessibleContext != null) {
                accessibleContext.firePropertyChange(AccessibleContext.ACCESSIBLE_VALUE_PROPERTY,
                        (oldModel == null ? null : Integer.valueOf(oldModel.getValue())), (newModel == null
    ...
    /**
     * Returns the progress bar's current {@code value} from the
     * <code>BoundedRangeModel</code>. The value is always between the minimum
    ...
    /**
     * Returns the progress bar's {@code minimum} value from the
    ...
    /**
     * Returns the progress bar's {@code maximum} value from the
     * <code>BoundedRangeModel</code>.
     *
    ...
    /**
     * Sets the progress bar's current value to {@code n}. This method forwards
     * the new value to the model.
     * <p>
    ...
    public void setValue(int n) {
        ...
        if (accessibleContext != null) {
            accessibleContext.firePropertyChange(AccessibleContext.ACCESSIBLE_VALUE_PROPERTY, Integer.valueOf(
                    oldValue), Integer.valueOf(brm.getValue()));
        }
    }

    /**
     * Sets the progress bar's minimum value (stored in the progress bar's data
     * model) to <code>n</code>.
     * <p>
     * The data model (a <code>BoundedRangeModel</code> instance) handles any
     * mathematical issues arising from assigning faulty values. See the
     * {@code BoundedRangeModel} documentation for details.
     * <p>
    ...
    /**
     * Sets the <code>indeterminate</code> property of the progress bar, which
     * determines whether the progress bar is in determinate or indeterminate
     * mode. An indeterminate progress bar continuously displays animation
     * indicating that an operation of unknown length is occurring. By default,
     * this property is <code>false</code>. Some look and feels might not
     * support indeterminate progress bars; they will ignore this property.
     * <p>
     * See <a href=
     * "https://docs.oracle.com/javase/tutorial/uiswing/components/progress.html"
     * target="_top">How to Monitor Progress</a> for examples of using
     ...
     * @see javax.swing.plaf.basic.BasicProgressBarUI
     * @since 1.4
     * @beaninfo bound: true attribute: visualUpdate true description: Set
     *           whether the progress bar is indeterminate (true) or normal
     *           (false).
     */
     ...
     * @see #setIndeterminate
     * @since 1.4
     * @beaninfo description: Is the progress bar indeterminate (true) or normal
     *           (false)?
     */
    ...
    /**
     * Returns a string representation of this <code>JProgressBar</code>. This
     * method is intended to be used only for debugging purposes. The content
     * and format of the returned string may vary between implementations. The
    ...
    protected String paramString() {
        ...
        String progressStringString = (progressString != null ? progressString : "");
        String paintStringString = (paintString ? "true" : "false");
        String indeterminateString = (indeterminate ? "true" : "false");

        return super.paramString() + ",orientation=" + orientationString + ",paintBorder=" + paintBorderString
                + ",paintString=" + paintStringString + ",progressString=" + progressStringString
     ...
     * <code>AccessibleJProgressBar</code>. A new
     * <code>AccessibleJProgressBar</code> instance is created if necessary.
     *
    ...
    protected class AccessibleJProgressBar extends AccessibleJComponent implements AccessibleValue {
        ...
        /**
         * Gets the <code>AccessibleValue</code> associated with this object. In
