 ...
 * to Use Buttons, Check Boxes, and Radio Buttons</a> in
...
public class JCheckBox extends JToggleButton implements Accessible {
	...
	/**
	 * Sets the <code>borderPaintedFlat</code> property, which gives a hint to
	 * the look and feel as to the appearance of the check box border. This is
	 * usually set to <code>true</code> when a <code>JCheckBox</code> instance
	 * is used as a renderer in a component such as a <code>JTable</code> or
	 * <code>JTree</code>. The default value for the
	 * <code>borderPaintedFlat</code> property is <code>false</code>. This
	 * method fires a property changed event. Some look and feels might not
	...
	/**
	 * The icon for checkboxs comes from the look and feel, not the Action; this
	 * is overriden to do nothing.
	 */
	...
	/**
	 * Returns a string representation of this JCheckBox. This method is
	 * intended to be used only for debugging purposes, and the content and
	 * format of the returned string may vary between implementations. The
	 * returned string may be empty but may not be <code>null</code>. specific
	 * new aspects of the JFC components.
	 *
	...
	/**
	 * Gets the AccessibleContext associated with this JCheckBox. For
	 * JCheckBoxes, the AccessibleContext takes the form of an
	 * AccessibleJCheckBox. A new AccessibleJCheckBox instance is created if
	 * necessary.
	 *
	 * @return an AccessibleJCheckBox that serves as the AccessibleContext of
	 *         this JCheckBox
	 ...
	 * <code>JCheckBox</code> class. It provides an implementation of the Java
	 * Accessibility API appropriate to check box user-interface elements.
	 * <p>
	 * <strong>Warning:</strong> Serialized objects of this class will not be
