 ...
 * and feel (L&amp;F). Note that <code>JDesktopPane</code> does not support
 * borders.
 * <p>
 ...
 * <code>JInternalFrames</code>. The <code>installUI</code> of the L&amp;F
 * specific implementation is responsible for setting the
 * <code>desktopManager</code> variable appropriately. When the parent of a
 * <code>JInternalFrame</code> is a <code>JDesktopPane</code>, it should
 * delegate most of its behavior to the <code>desktopManager</code> (closing,
 * resizing, etc).
 * <p>
 ...
 * How to Use Internal Frames</a>, a section in <em>The Java Tutorial</em>.
 * <p>
...
public class JDesktopPane extends JLayeredPane implements Accessible {
	...
	/**
	 * Sets the "dragging style" used by the desktop pane. You may want to
	 ...
	 * @see #OUTLINE_DRAG_MODE
	 *
	 * @beaninfo bound: true description: Dragging style for internal frame
	 *           children. enum: LIVE_DRAG_MODE JDesktopPane.LIVE_DRAG_MODE
	...
	/**
	 * Returns the <code>DesktopManger</code> that handles desktop-specific UI
	 * actions.
	 */
	...
	/**
	 * Sets the <code>DesktopManger</code> that will handle desktop-specific UI
	...
	/**
	 * Returns the currently active <code>JInternalFrame</code> in this
	 * <code>JDesktopPane</code>, or <code>null</code> if no
	 * <code>JInternalFrame</code> is currently active.
	 *
	...
	/**
	 * Sets the currently active <code>JInternalFrame</code> in this
	 * <code>JDesktopPane</code>. This method is used to bridge the package gap
	 * between JDesktopPane and the platform implementation code and should not
	 * be called directly. To visually select the frame the client must call
	 * JInternalFrame.setSelected(true) to activate the frame.
	 * 
	...
	/**
	 * Returns all <code>JInternalFrames</code> currently displayed in the
	 * specified layer of the desktop. Returns iconified frames as well expanded
	 * frames.
	 *
	 * @param layer
	...
	/**
	 * Returns a string representation of this <code>JDesktopPane</code>. This
	 ...
	 * <code>AccessibleJDesktopPane</code>. A new
	 * <code>AccessibleJDesktopPane</code> instance is created if necessary.
	 *
