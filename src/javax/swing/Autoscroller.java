...
/**
 * Autoscroller is responsible for generating synthetic mouse dragged events. It
 * is the responsibility of the Component (or its MouseListeners) that receive
 * the events to do the actual scrolling in response to the mouse dragged
 * events.
 *
 * @author Dave Moore
 * @author Scott Violet
...
class Autoscroller implements ActionListener {
    ...
    /**
     * Invoked when a mouse dragged event occurs, will start the autoscroller if
     * necessary.
     */
    ...
    //
    /**
     * ActionListener method. Invoked when the Timer fires. This will scroll if
     * necessary.
     */
