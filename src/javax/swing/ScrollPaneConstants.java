...
public interface ScrollPaneConstants {
	/**
	 * Identifies a "viewport" or display area, within which scrolled contents
	 * are visible.
	 */
	...
	/**
	 * Identifies the area at the top the viewport between the upper left corner
	...
	/**
	 * Identifies the lower leading edge corner of the viewport. The leading
	 * edge is determined relative to the Scroll Pane's ComponentOrientation
	 * property.
	 */
	String LOWER_LEADING_CORNER = "LOWER_LEADING_CORNER";
	/**
	 * Identifies the lower trailing edge corner of the viewport. The trailing
	 * edge is determined relative to the Scroll Pane's ComponentOrientation
	 * property.
	 */
	String LOWER_TRAILING_CORNER = "LOWER_TRAILING_CORNER";
	/**
	 * Identifies the upper leading edge corner of the viewport. The leading
	 * edge is determined relative to the Scroll Pane's ComponentOrientation
	 * property.
	 */
	String UPPER_LEADING_CORNER = "UPPER_LEADING_CORNER";
	/**
	 * Identifies the upper trailing edge corner of the viewport. The trailing
	 * edge is determined relative to the Scroll Pane's ComponentOrientation
	 * property.
	 */
