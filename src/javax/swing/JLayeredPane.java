 ...
 * How to Use a Layered Pane</a>, a section in <em>The Java Tutorial</em>.
 * <TABLE STYLE="FLOAT:RIGHT" BORDER="0" SUMMARY="layout">
 * <TR>
 * <TD ALIGN="CENTER">
 * <P STYLE="TEXT-ALIGN:CENTER">
 * <IMG SRC="doc-files/JLayeredPane-1.gif" alt=
 * "The following text describes this image." WIDTH="269" HEIGHT="264" STYLE=
 * "FLOAT:BOTTOM; BORDER=0"></TD>
 * </TR>
 * </TABLE>
...
public class JLayeredPane extends JComponent implements Accessible {
    ...
    /**
     * Convenience object defining the Default layer. Equivalent to new
     * Integer(0).
     */
    public final static Integer DEFAULT_LAYER = new Integer(0);
    /**
     * Convenience object defining the Palette layer. Equivalent to new
     * Integer(100).
     */
    public final static Integer PALETTE_LAYER = new Integer(100);
    /**
     * Convenience object defining the Modal layer. Equivalent to new
     * Integer(200).
     */
    public final static Integer MODAL_LAYER = new Integer(200);
    /**
     * Convenience object defining the Popup layer. Equivalent to new
     * Integer(300).
     */
    public final static Integer POPUP_LAYER = new Integer(300);
    /**
     * Convenience object defining the Drag layer. Equivalent to new
     * Integer(400).
     */
    public final static Integer DRAG_LAYER = new Integer(400);
    /**
     * Convenience object defining the Frame Content layer. This layer is
     * normally only use to position the contentPane and menuBar components of
     * JFrame. Equivalent to new Integer(-30000).
     * 
     * @see JFrame
     */
    ...
    private void validateOptimizedDrawing() {
        ...
        synchronized (getTreeLock()) {
            ...
            for (Component c : getComponents()) {
                ...
                if (SunToolkit.isInstanceOf(c, "javax.swing.JInternalFrame") || (c instanceof JComponent
                        && (layer = (Integer) ((JComponent) c).getClientProperty(LAYER_PROPERTY)) != null)) {
    ...
    //////////////////////////////////////////////////////////////////////////////
    /**
     * Sets the layer property on a JComponent. This method does not cause any
     * side effects like setLayer() (painting, add/remove, etc). Normally you
     * should use the instance method setLayer(), in order to get the desired
    ...
    public static void putLayer(JComponent c, int layer) {
        /// MAKE SURE THIS AND setLayer(Component c, int layer, int position)
        /// are SYNCED
        Integer layerObj;
    ...
    /**
     * Gets the layer property for a JComponent, it does not cause any side
     * effects like setLayer(). (painting, add/remove, etc) Normally you should
     ...
     * specified component. Note that all JFrames have a JLayeredPane at their
    ...
    /**
     * Sets the layer attribute on the specified component, making it the
     * bottommost component in that layer. Should be called before adding to
     * parent.
     *
     * @param c
    ...
    /**
     * Sets the layer attribute for the specified component and also sets its
     ...
     * position.
     * <p>
     * <b>Note:</b> Position numbering is defined by java.awt.Container, and is
     * the opposite of layer numbering. Lower position numbers are closer to the
    ...
    /**
     * Returns the highest layer value from all current children. Returns 0 if
     * there are no children.
     *
     * @return an int indicating the layer of the topmost component in the pane,
    ...
    /**
     * Returns the lowest layer value from all current children. Returns 0 if
     * there are no children.
     *
    ...
    /**
     * Primitive method that determines the proper location to insert a new
    ...
    /**
     * This method is an extended version of insertIndexForLayer() to support
     * setLayer which uses Container.setZOrder which does not remove the
     * component from the containment hierarchy though we need to ignore it when
    ...
    /**
     * Returns a string representation of this JLayeredPane. This method is
     ...
     * panes, the AccessibleContext takes the form of an AccessibleJLayeredPane.
     * A new AccessibleJLayeredPane instance is created if necessary.
     *
     * @return an AccessibleJLayeredPane that serves as the AccessibleContext of
     *         this JLayeredPane
     */
