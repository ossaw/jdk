...
public class UIDefaults extends Hashtable<Object, Object> {
	...
	/**
	 * Maps from a Locale to a cached Map of the ResourceBundle. This is done so
	 * as to avoid an exception being thrown when a value is asked for. Access
	 * to this should be done while holding a lock on the UIDefaults, eg
	 * synchronized(this).
	 */
	 ...
	 * <code>UIDefaults.LazyValue</code> then the real value is computed with
	 * <code>LazyValue.createValue()</code>, the table entry is replaced, and
	 * the real value is returned. If the value is an
	 * <code>UIDefaults.ActiveValue</code> the table entry is not replaced - the
	 * value is computed with <code>ActiveValue.createValue()</code> for each
	 * <code>get()</code> call.
	 *
	...
	private Object getFromHashtable(final Object key) {
		...
		/*
		 * If the LazyValue for key is being constructed by another thread then
		 * wait and then return the new value, otherwise drop the lock and
		 * construct the ActiveValue or the LazyValue. We use the special value
		 * PENDING to mark LazyValues that are being constructed.
		 */
		synchronized (this) {
			value = super.get(key);
			if (value == PENDING) {
		...
		if (value instanceof LazyValue) {
			try {
				/*
				 * If an exception is thrown we'll just put the LazyValue back
				 * in the table.
				 */
	...
	/**
	 * Returns the value for key associated with the given locale. If the value
	 * is a <code>UIDefaults.LazyValue</code> then the real value is computed
	 * with <code>LazyValue.createValue()</code>, the table entry is replaced,
	 * and the real value is returned. If the value is an
	 * <code>UIDefaults.ActiveValue</code> the table entry is not replaced - the
	 * value is computed with <code>ActiveValue.createValue()</code> for each
	 * <code>get()</code> call.
	 *
	 ...
	 * If <code>key</code> is a string and the new value isn't equal to the old
	 * one, fire a <code>PropertyChangeEvent</code>. If value is
	...
	/**
	 * Puts all of the key/value pairs in the database and unconditionally
	 * generates one <code>PropertyChangeEvent</code>. The events oldValue and
	 * newValue will be <code>null</code> and its <code>propertyName</code> will
	 ...
	 * @param key
	 *            the desired key
	 * @return if the value for <code>key</code> is a <code>Font</code>, return
	 *         the <code>Font</code> object; otherwise return <code>null</code>
	 */
	...
	/**
	 * If the value of <code>key</code> for the given <code>Locale</code> is a
	 ...
	 * @param l
	 *            the desired locale
	 * @return if the value for <code>key</code> and <code>Locale</code> is a
	 *         <code>Font</code>, return the <code>Font</code> object; otherwise
	 ...
	 * @param key
	 *            the desired key
	 * @return if the value for <code>key</code> is a <code>Color</code>, return
	 *         the <code>Color</code> object; otherwise return <code>null</code>
	 */
	...
	/**
	 * If the value of <code>key</code> for the given <code>Locale</code> is a
	 * <code>Color</code> return it, otherwise return <code>null</code>.
	 * 
	 * @param key
	 *            the desired key
	 * @param l
	 *            the desired locale
	 * @return if the value for <code>key</code> and <code>Locale</code> is a
	 *         <code>Color</code>, return the <code>Color</code> object;
	 *         otherwise return <code>null</code>
	 * @since 1.4
	 */
	 ...
	 * @param key
	 *            the desired key
	 * @return if the value for <code>key</code> is an <code>Icon</code>, return
	 *         the <code>Icon</code> object; otherwise return <code>null</code>
	 */
	...
	/**
	 * If the value of <code>key</code> for the given <code>Locale</code> is an
	 * <code>Icon</code> return it, otherwise return <code>null</code>.
	 * 
	 * @param key
	 *            the desired key
	 * @param l
	 *            the desired locale
	 * @return if the value for <code>key</code> and <code>Locale</code> is an
	 *         <code>Icon</code>, return the <code>Icon</code> object; otherwise
	 *         return <code>null</code>
	 * @since 1.4
	 */
	...
	/**
	 * If the value of <code>key</code> for the given <code>Locale</code> is a
	 * <code>Border</code> return it, otherwise return <code>null</code>.
	 * 
	 * @param key
	 *            the desired key
	 * @param l
	 *            the desired locale
	 * @return if the value for <code>key</code> and <code>Locale</code> is a
	 *         <code>Border</code>, return the <code>Border</code> object;
	 *         otherwise return <code>null</code>
	 * @since 1.4
	 */
	...
	/**
	 * If the value of <code>key</code> for the given <code>Locale</code> is a
	 * <code>String</code> return it, otherwise return <code>null</code>.
	 * 
	 * @param key
	 *            the desired key
	 * @param l
	 ...
	 *         <code>Locale</code> is a <code>String</code>, return the
	...
	/**
	 * If the value of <code>key</code> for the given <code>Locale</code> is an
	 * <code>Integer</code> return its integer value, otherwise return 0.
	 * 
	 * @param key
	 *            the desired key
	 * @param l
	...
	/**
	 * If the value of <code>key</code> is boolean, return the boolean value,
	 * otherwise return false.
	 *
	 * @param key
	 *            an <code>Object</code> specifying the key for the desired
	 *            boolean value
	 * @return if the value of <code>key</code> is boolean, return the boolean
	...
	/**
	 * If the value of <code>key</code> for the given <code>Locale</code> is
	 * boolean, return the boolean value, otherwise return false.
	 *
	 * @param key
	 *            an <code>Object</code> specifying the key for the desired
	 *            boolean value
	 * @param l
	 *            the desired locale
	 * @return if the value for <code>key</code> and <code>Locale</code> is
	 *         boolean, return the boolean value, otherwise return false.
	 * @since 1.4
	 */
	...
	/**
	 * If the value of <code>key</code> for the given <code>Locale</code> is an
	 * <code>Insets</code> return it, otherwise return <code>null</code>.
	 * 
	 * @param key
	 *            the desired key
	 * @param l
	 *            the desired locale
	 * @return if the value for <code>key</code> and <code>Locale</code> is an
	 *         <code>Insets</code>, return the <code>Insets</code> object;
	 *         otherwise return <code>null</code>
	 * @since 1.4
	 */
	...
	/**
	 * If the value of <code>key</code> for the given <code>Locale</code> is a
	 * <code>Dimension</code> return it, otherwise return <code>null</code>.
	 * 
	 * @param key
	 *            the desired key
	 * @param l
	 *            the desired locale
	 * @return if the value for <code>key</code> and <code>Locale</code> is a
	 *         <code>Dimension</code>, return the <code>Dimension</code> object;
	 *         otherwise return <code>null</code>
	 * @since 1.4
	 */
	...
	/**
	 * The value of <code>get(uidClassID)</code> must be the <code>String</code>
	 * name of a class that implements the corresponding
	 * <code>ComponentUI</code> class. If the class hasn't been loaded before,
	 * this method looks up the class with
	 * <code>uiClassLoader.loadClass()</code> if a non <code>null</code> class
	 * loader is provided, <code>classForName()</code> otherwise.
	 * <p>
	 * If a mapping for <code>uiClassID</code> exists or if the specified class
	 * can't be found, return <code>null</code>.
	 * <p>
	 * This method is used by <code>getUI</code>, it's usually not necessary to
	 * call it directly.
	 *
	 * @param uiClassID
	...
	/**
	 * If <code>getUI()</code> fails for any reason, it calls this method before
	 * returning <code>null</code>. Subclasses may choose to do more or less
	 * here.
	 *
	 * @param msg
	...
	/**
	 * Creates an <code>ComponentUI</code> implementation for the specified
	 * component. In other words create the look and feel specific delegate
	 * object for <code>target</code>. This is done in two steps:
	 * <ul>
	 * <li>Look up the name of the <code>ComponentUI</code> implementation class
	 * under the value returned by <code>target.getUIClassID()</code>.
	 * <li>Use the implementation classes static <code>createUI()</code> method
	 * to construct a look and feel delegate.
	 * </ul>
	 * 
	 * @param target
	 ...
	 * <p>
	 * A <code>PropertyChangeEvent</code> will get fired whenever a default is
	 * changed.
	 *
	 * @param listener
	 ...
	 * this UIDefaults with addPropertyChangeListener().
	 *
	...
	/**
	 * Support for reporting bound property changes. If oldValue and newValue
	 * are not equal and the <code>PropertyChangeEvent</code>x listener list
	 * isn't empty, then fire a <code>PropertyChange</code> event to each
	 * listener.
	 *
	 * @param propertyName
	 ...
	 * localized values via <code>get</code> methods that do not take a locale
	 * argument. As of release 1.4, Swing UI objects should retrieve localized
	 * values using the locale of their component rather than the default
	 * locale. The default locale exists to provide compatibility with pre 1.4
	 * behaviour.
	 *
	 * @param l
	 ...
	 * constructed until the first time it's looked up with one of the
	 * <code>getXXX(key)</code> methods. Lazy values are useful for defaults
	 * that are expensive to construct or are seldom retrieved. The first time a
	 * <code>LazyValue</code> is retrieved its "real value" is computed by
	 * calling <code>LazyValue.createValue()</code> and the real value is used
	 * to replace the <code>LazyValue</code> in the <code>UIDefaults</code>
	 * table. Subsequent lookups for the same key return the real value. Here's
	 * an example of a <code>LazyValue</code> that constructs a
	 * <code>Border</code>:
	 * 
	 * <pre>
	...
	public interface LazyValue {
		 ...
		 * table. When an object that implements this interface is retrieved
		 * from the table, this method is used to create the real value, which
	 ...
	 * constructed each time it's looked up with one of the
	 * <code>getXXX(key)</code> methods. Here's an example of an
	 * <code>ActiveValue</code> that constructs a
	...
	/**
	 * This class provides an implementation of <code>LazyValue</code> which can
	 * be used to delay loading of the Class for the instance to be created. It
	 * also avoids creation of an anonymous inner class for the
	 * <code>LazyValue</code> subclass. Both of these improve performance at the
	 * time that a a Look and Feel is loaded, at the cost of a slight
	 * performance reduction the first time <code>createValue</code> is called
	...
	public static class ProxyLazyValue implements LazyValue {
		...
		/*
		 * Coerce the array of class types provided into one which looks the way
		 * the Reflection APIs expect. This is done by substituting primitive
		 * types for their Object counterparts, and superclasses for subclasses
		 * used to add the <code>UIResource</code> tag.
		 */
		private Class[] getClassArray(Object[] args) {
			...
			if (args != null) {
				...
				for (int i = 0; i < args.length; i++) {
					/*
					 * PENDING(ges): At present only the primitive types used
					 * are handled correctly; this should eventually handle all
					 * primitive types
					 */
					if (args[i] instanceof java.lang.Integer) {
						 ...
						 * constructor/method lookup. Since we only have one
						 * case where this is needed, we substitute directly
						 * instead of adding a massive amount of mechanism for
						 * this. Eventually this will probably need to handle
	...
	/**
	 * <code>LazyInputMap</code> will create a <code>InputMap</code> in its
	 * <code>createValue</code> method. The bindings are passed in in the
	 * constructor. The bindings are an array with the even number entries being
	 * string <code>KeyStrokes</code> (eg "alt SPACE") and the odd number
	 * entries being the value to use in the <code>InputMap</code> (and the key
	 * in the <code>ActionMap</code>).
	 * 
	 * @since 1.3
	 */
	public static class LazyInputMap implements LazyValue {
		...
		/**
		 * Creates an <code>InputMap</code> with the bindings that are passed
		 * in.
		 *
		 * @param table
		 *              a <code>UIDefaults</code> table
	...
	/**
	 * <code>TextAndMnemonicHashMap</code> stores swing resource strings. Many
	 * of strings can have a mnemonic. For example:
	 * FileChooser.saveButton.textAndMnemonic=&Save For this case method get
	 * returns "Save" for the key "FileChooser.saveButtonText" and mnemonic "S"
	 * for the key "FileChooser.saveButtonMnemonic"
	 *
	 * There are several patterns for the text and mnemonic suffixes which are
	 * checked by the <code>TextAndMnemonicHashMap</code> class. Patterns which
	 * are converted to the xxx.textAndMnemonic key: (xxxNameText,
	 * xxxNameMnemonic) (xxxNameText, xxxMnemonic) (xxx.nameText, xxx.mnemonic)
	 * (xxxText, xxxMnemonic)
	 *
	 * These patterns can have a mnemonic index in format
	 * (xxxDisplayedMnemonicIndex)
	 *
	 * Pattern which is converted to the xxx.titleAndMnemonic key: (xxxTitle,
	 * xxxMnemonic)
	 *
	 */
