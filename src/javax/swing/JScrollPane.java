 ...
 * How to Use Scroll Panes</a>, a section in <em>The Java Tutorial</em>. Note
 * that <code>JScrollPane</code> does not support heavyweight components.
 * <TABLE STYLE="FLOAT:RIGHT" BORDER="0" SUMMARY="layout">
 * <TR>
 * <TD ALIGN="CENTER">
 * <P STYLE="TEXT-ALIGN:CENTER">
 * <IMG SRC="doc-files/JScrollPane-1.gif" alt=
 * "The following text describes this image." WIDTH="256" HEIGHT="248" STYLE=
 * "FLOAT:BOTTOM; BORDER:0px"></TD>
 * </TR>
 * </TABLE>
 ...
 * diagram, the top right space is present and identified by the label
 * "corner component".
 * <p>
...
public class JScrollPane extends JComponent implements ScrollPaneConstants, Accessible {
     ...
     * @param hsbPolicy
     *        an integer that specifies the horizontal scrollbar
     *        policy
     */
    ...
    /**
     * Sets the <code>ScrollPaneUI</code> object that provides the look and feel
     * (L&amp;F) for this component.
     *
     * @param ui
     *        the <code>ScrollPaneUI</code> L&amp;F object
     * @see #getUI
     */
     ...
     * overrides <code>setLayout</code> in <code>java.awt.Container</code> to
     * ensure that only <code>LayoutManager</code>s which are subclasses of
     * <code>ScrollPaneLayout</code> can be used in a <code>JScrollPane</code>.
     * If <code>layout</code> is non-null, this will invoke
     * <code>syncWithScrollPane</code> on it.
     *
     * @param layout
    ...
    /**
     * Overridden to return true so that any calls to <code>revalidate</code> on
     * any descendants of this <code>JScrollPane</code> will cause the entire
     * tree beginning with this <code>JScrollPane</code> to be validated.
     *
     * @return true
     ...
     *            if <code>policy</code> is not one of
     *            the legal values
     *            shown above
     * @see #getVerticalScrollBarPolicy
     * @beaninfo preferred: true bound: true description: The scrollpane
     *           vertical scrollbar policy enum: VERTICAL_SCROLLBAR_AS_NEEDED
     ...
     * viewport directly, <code>JViewport</code> doesn't support the
     * <code>JComponent</code> border property. Similarly setting the
     * <code>JScrollPane</code>s viewport doesn't affect the
     ...
     * @see #setViewport
     * @beaninfo preferred: true bound: true description: The border around the
     *           viewport.
     */
    ...
    /**
     * By default <code>JScrollPane</code> creates scrollbars that are instances
     * of this class. <code>Scrollbar</code> overrides the
     * <code>getUnitIncrement</code> and <code>getBlockIncrement</code> methods
     * so that, if the viewport's view is a <code>Scrollable</code>, the view is
     * asked to compute these values. Unless the unit/block increment have been
     * explicitly set.
     * <p>
     * <strong>Warning:</strong> Serialized objects of this class will not be
    ...
    protected class ScrollBar extends JScrollBar implements UIResource {
         ...
         *
         * @param orientation
         *        an integer specifying one of the legal orientation
         *        values
         *        shown above
         * @since 1.4
         */
     ...
     *        <code>null</code>,
     *        the old viewport is still removed and the new viewport is
     *        set
     *        to <code>null</code>
     * @see #createViewport
     * @see #getViewport
    ...
    /**
     * Creates a viewport if necessary and then sets its view. Applications that
     * don't provide the view directly to the <code>JScrollPane</code>
     * constructor should use this method to specify the scrollable child that's
     * going to be displayed in the scrollpane. For example:
     * 
     * <pre>
     ...
     *
     * @param rowHeader
     *        the new row header to be used; if <code>null</code> the
     *        old
     *        row header is still removed and the new rowHeader is set
     *        to
     *        <code>null</code>
     * @see #getRowHeader
     * @see #setRowHeaderView
     * @beaninfo bound: true expert: true description: The row header child for
     *           this scrollpane
     */
     ...
     * the row-header viewport to the scrollpane. For example:
     * 
     * <pre>
     * JScrollPane scrollpane = new JScrollPane();
     * scrollpane.setViewportView(myBigComponentToScroll);
     ...
     * @return the corner component (which may be <code>null</code>) identified
     *         by the given key, or <code>null</code> if the key is invalid
     * @see #setCorner
     */
    ...
    /**
     * Sets the orientation for the vertical and horizontal scrollbars as
     ...
     * @since 1.4
     * @beaninfo bound: true description: Flag for enabling/disabling mouse
     *           wheel scrolling
     */
    ...
    /**
     * Returns a string representation of this <code>JScrollPane</code>. This
    ...
    protected String paramString() {
        ...
        return super.paramString() + ",columnHeader=" + columnHeaderString + ",horizontalScrollBar="
                ...
                + ",lowerLeft=" + lowerLeftString + ",lowerRight=" + lowerRightString + ",rowHeader="
                + rowHeaderString + ",upperLeft=" + upperLeftString + ",upperRight=" + upperRightString
                + ",verticalScrollBar=" + verticalScrollBarString + ",verticalScrollBarPolicy="
                + verticalScrollBarPolicyString + ",viewport=" + viewportString + ",viewportBorder="
                + viewportBorderString;
    }
    ...
    /**
     * Gets the AccessibleContext associated with this JScrollPane. For scroll
     * panes, the AccessibleContext takes the form of an AccessibleJScrollPane.
     * A new AccessibleJScrollPane instance is created if necessary.
     *
     * @return an AccessibleJScrollPane that serves as the AccessibleContext of
     *         this JScrollPane
     */
     ...
     * <code>JScrollPane</code> class. It provides an implementation of the Java
    ...
    protected class AccessibleJScrollPane extends AccessibleJComponent implements ChangeListener,
        ...
        public void stateChanged(ChangeEvent e) {
            ...
            firePropertyChange(ACCESSIBLE_VISIBLE_DATA_PROPERTY, Boolean.valueOf(false), Boolean.valueOf(
                    true));
        }
        ...
        void setScrollBarRelations(JScrollBar scrollBar) {
             ...
             */
            AccessibleRelation controlledBy = new AccessibleRelation(AccessibleRelation.CONTROLLED_BY,
                    scrollBar);
            AccessibleRelation controllerFor = new AccessibleRelation(AccessibleRelation.CONTROLLER_FOR,
                    JScrollPane.this);
