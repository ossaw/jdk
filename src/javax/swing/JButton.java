 ...
 * <em>The Java Tutorial</em> for information and examples of using buttons.
 * <p>
...
public class JButton extends AbstractButton implements Accessible {
	...
	/**
	 * Overrides <code>JComponent.removeNotify</code> to check if this button is
	 * currently set as the default button on the <code>RootPane</code>, and if
	 * so, sets the <code>RootPane</code>'s default button to <code>null</code>
	 * to ensure the <code>RootPane</code> doesn't hold onto an invalid button
	 * reference.
	 */
	...
	/**
	 * Returns a string representation of this <code>JButton</code>. This method
	 ...
	 * <code>JButton</code>. For <code>JButton</code>s, the
	 * <code>AccessibleContext</code> takes the form of an
	 * <code>AccessibleJButton</code>. A new <code>AccessibleJButton</code>
	...
	/**
	 * This class implements accessibility support for the <code>JButton</code>
