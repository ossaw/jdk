...
public class JToolTip extends JComponent implements Accessible {
    ...
    /**
     * Sets the text to show when the tool tip is displayed. The string
    ...
    /**
     * Returns the text that is shown when the tool tip is displayed. The
    ...
    /**
     * Specifies the component that the tooltip describes. The component
     * <code>c</code> may be <code>null</code> and will have no effect.
     * <p>
    ...
    /**
     * Returns the component the tooltip applies to. The returned value may be
     * <code>null</code>.
     *
    ...
    /**
     * Always returns true since tooltips, by definition, should always be on
    ...
    /**
     * Returns a string representation of this <code>JToolTip</code>. This
    ...
    /**
     * Gets the AccessibleContext associated with this JToolTip. For tool tips,
     * the AccessibleContext takes the form of an AccessibleJToolTip. A new
     * AccessibleJToolTip instance is created if necessary.
     *
     * @return an AccessibleJToolTip that serves as the AccessibleContext of
     *         this JToolTip
     */
    ...
    /**
     * This class implements accessibility support for the <code>JToolTip</code>
     * class. It provides an implementation of the Java Accessibility API
     * appropriate to tool tip user-interface elements.
     * <p>
     * <strong>Warning:</strong> Serialized objects of this class will not be
