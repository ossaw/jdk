 ...
 * to Use Borders</a>, a section in <em>The Java Tutorial</em>.
 *
 * @author David Kloba
 */
public class BorderFactory {
	 ...
	 *
	 * @param color
	 *              a <code>Color</code> to use for the line
	...
	/**
	 * Creates a line border with the specified color and width. The width
	 * applies to all four sides of the border. To specify widths individually
	 * for the top, bottom, left, and right, use
	 ...
	 * for shadows. (In a raised border, highlights are on top and shadows are
	 * underneath.)
	 *
	 * @return the <code>Border</code> object
	 */
	...
	/**
	 * Creates a border with a lowered beveled edge, using brighter shades of
	...
	/**
	 * Creates a beveled border of the specified type, using brighter shades of
	 * the component's current background color for highlighting, and darker
	 * shading for shadows. (In a lowered border, shadows are on top and
	 * highlights are underneath.)
	 *
	 * @param type
	 *             an integer specifying either <code>BevelBorder.LOWERED</code>
	 *             or <code>BevelBorder.RAISED</code>
	 * @return the <code>Border</code> object
	 */
	 ...
	 * brighter shade of the highlight color. The inner edge of the shadow area
	 ...
	 *                  or <code>BevelBorder.RAISED</code>
	 * @param highlight
	 *                  a <code>Color</code> object for highlights
	 * @param shadow
	 *                  a <code>Color</code> object for shadows
	 * @return the <code>Border</code> object
	 */
	...
	/**
	 * Creates a beveled border of the specified type, using the specified
	 * colors for the inner and outer highlight and shadow areas.
	 *
	 * @param type
	 *                       an integer specifying either
	 *                       <code>BevelBorder.LOWERED</code>
	 ...
	 *                       a <code>Color</code> object for the outer edge of
	 *                       the
	 *                       highlight area
	 * @param highlightInner
	 *                       a <code>Color</code> object for the inner edge of
	 *                       the
	 *                       highlight area
	 * @param shadowOuter
	 *                       a <code>Color</code> object for the outer edge of
	 ...
	 * brighter shades of the component's current background color for
	 * highlighting, and darker shading for shadows. In a raised border,
	 * highlights are on top and shadows are underneath.
	 *
	 * @return the {@code Border} object
	 *
	 * @since 1.7
	 ...
	 * brighter shades of the component's current background color for
	 * highlighting, and darker shading for shadows. In a lowered border,
	 * shadows are on top and highlights are underneath.
	 *
	 * @return the {@code Border} object
	 *
	 * @since 1.7
	 ...
	 * using brighter shades of the component's current background color for
	 * highlighting, and darker shading for shadows. The type is either
	 * {@link BevelBorder#RAISED} or {@link BevelBorder#LOWERED}.
	 *
	 * @param type
	 *             a type of a bevel
	 * @return the {@code Border} object or {@code null} if the specified type
	 *         is not valid
	 *
	...
	/**
	 * Creates a beveled border of the specified type with softened corners,
	 * using the specified highlighting and shadowing. The type is either
	 * {@link BevelBorder#RAISED} or {@link BevelBorder#LOWERED}. The outer edge
	 * of the highlight area uses a brighter shade of the {@code highlight}
	 * color. The inner edge of the shadow area uses a brighter shade of the
	 * {@code shadow} color.
	 *
	 * @param type
	 *                  a type of a bevel
	...
	/**
	 * Creates a beveled border of the specified type with softened corners,
	 * using the specified colors for the inner and outer edges of the highlight
	 * and the shadow areas. The type is either {@link BevelBorder#RAISED} or
	 * {@link BevelBorder#LOWERED}. Note: The shadow inner and outer colors are
	...
	/**
	 * Creates a border with an "etched" look using the component's current
	...
	/**
	 * Creates a border with an "etched" look using the specified highlighting
	 * and shading colors.
	 *
	 * @param highlight
	 *                  a <code>Color</code> object for the border highlights
	 * @param shadow
	 *                  a <code>Color</code> object for the border shadows
	 * @return the <code>Border</code> object
	 */
	 ...
	 *
	 * @param type
	 *             one of <code>EtchedBorder.RAISED</code>, or
	...
	//// ////////////////////////////////////////////////////////////
	/**
	 * Creates a new titled border with the specified title, the default border
	 * type (determined by the current look and feel), the default text position
	 * (determined by the current look and feel), the default justification
	 * (leading), and the default font and text color (determined by the current
	 * look and feel).
	 *
	 * @param title
	 *              a <code>String</code> containing the text of the title
	...
	/**
	 * Creates a new titled border with an empty title, the specified border
	 * object, the default text position (determined by the current look and
	 * feel), the default justification (leading), and the default font and text
	 * color (determined by the current look and feel).
	 *
	 * @param border
	 *               the <code>Border</code> object to add the title to; if
	 *               <code>null</code> the <code>Border</code> is determined by
	 *               the
	...
	/**
	 * Adds a title to an existing border, with default positioning (determined
	 * by the current look and feel), default justification (leading) and the
	 * default font and text color (determined by the current look and feel).
	 *
	 * @param border
	 *               the <code>Border</code> object to add the title to
	 * @param title
	 *               a <code>String</code> containing the text of the title
	 * @return the <code>TitledBorder</code> object
	 */
	...
	/**
	 * Adds a title to an existing border, with the specified positioning and
	 * using the default font and text color (determined by the current look and
	 * feel).
	 *
	 * @param border
	 *                           the <code>Border</code> object to add the title
	 *                           to
	 * @param title
	 *                           a <code>String</code> containing the text of
	 *                           the title
	 * @param titleJustification
	 *                           an integer specifying the justification of the
	 *                           title -- one of
	 *                           the following:
	 *                           <ul>
	 ...
	 *                           <li><code>TitledBorder.DEFAULT_JUSTIFICATION</code>
	 *                           (leading)
	 *                           </ul>
	 * @param titlePosition
	 *                           an integer specifying the vertical position of
	 *                           the text in
	 *                           relation to the border -- one of the following:
	 *                           <ul>
	 *                           <li><code> TitledBorder.ABOVE_TOP</code>
	 *                           <li><code>TitledBorder.TOP</code> (sitting on
	 *                           the top line)
	 ...
	 *                           <li><code>TitledBorder.DEFAULT_POSITION</code>
	 *                           (the title
	 *                           position is determined by the current look and
	 *                           feel)
	 *                           </ul>
	 * @return the <code>TitledBorder</code> object
	 */
	...
	/**
	 * Adds a title to an existing border, with the specified positioning and
	 * font, and using the default text color (determined by the current look
	 * and feel).
	 *
	 * @param border
	 *                           the <code>Border</code> object to add the title
	...
	/**
	 * Adds a title to an existing border, with the specified positioning, font
	 * and color.
	 *
	 * @param border
	 *                           the <code>Border</code> object to add the title
	 ...
	 *                           </ul>
	 * @param titleFont
	 *                           a <code>Font</code> object specifying the title
	 *                           font
	 * @param titleColor
	 *                           a <code>Color</code> object specifying the
	 *                           title color
	 * @return the <code>TitledBorder</code> object
	 */
	public static TitledBorder createTitledBorder(Border border, String title,
	 ...
	 * @param right
	 *               an integer specifying the width of the right side, in
	 *               pixels
	 * @return the <code>Border</code> object
	 */
	...
	/**
	 * Creates a compound border specifying the border objects to use for the
	 * outside and inside edges.
	 *
	 * @param outsideBorder
	 *                      a <code>Border</code> object for the outer edge of
	 *                      the
	 *                      compound border
	 * @param insideBorder
	 *                      a <code>Border</code> object for the inner edge of
	 *                      the
	 *                      compound border
	 * @return the <code>CompoundBorder</code> object
	 */
	 ...
	 *               an integer specifying the width of the bottom, in pixels
	 * @param color
	 *               a <code>Color</code> to use for the border
	 ...
	 * specified icon. Multiple copies of the icon are placed side-by-side to
	 * fill up the border area.
	 * <p>
	 * Note:<br>
	 ...
	 *                 an integer specifying the width of the top, in pixels
	 * @param left
	 *                 an integer specifying the width of the left side, in
	 *                 pixels
	 * @param bottom
	 *                 an integer specifying the width of the right side, in
	 *                 pixels
	 ...
	 *                 an integer specifying the width of the bottom, in pixels
	 * @param tileIcon
	 *                 the <code>Icon</code> object used for the border tiles
	 * @return the <code>MatteBorder</code> object
	 */
	public static MatteBorder createMatteBorder(int top, int left, int bottom,
	...
	/**
	 * Creates a border of the specified {@code stroke}. The component's
	...
	/**
	 * Creates a dashed border of the specified {@code paint}. If the specified
	 * {@code paint} is {@code null}, the component's foreground color will be
	 * used to render the border. The width of a dash line is equal to {@code 1}
	 * . The relative length of a dash line and the relative spacing between
	 * dash lines are equal to {@code 1}. A dash line is not rounded.
	 *
	 * @param paint
	 *              the {@link Paint} object used to generate a color
	 * @return the {@code Border} object
	...
	/**
	 * Creates a dashed border of the specified {@code paint}, relative
	 * {@code length}, and relative {@code spacing}. If the specified
	 * {@code paint} is {@code null}, the component's foreground color will be
	 * used to render the border. The width of a dash line is equal to {@code 1}
	 ...
	 *                                  if the specified {@code length} is less
	 *                                  than {@code 1}, or if
	 *                                  the specified {@code spacing} is less
	 *                                  than {@code 0}
	 * @since 1.7
	 */
	 ...
	 * , line shape, relative {@code length}, and relative {@code spacing}. If
	 * the specified {@code paint} is {@code null}, the component's foreground
	 * color will be used to render the border.
	 *
	 * @param paint
	 ...
	 *
	 * @throws IllegalArgumentException
	 *                                  if the specified {@code thickness} is
	 *                                  less than {@code 1}, or
	 *                                  if the specified {@code length} is less
	 *                                  than {@code 1}, or if
	 *                                  the specified {@code spacing} is less
	...
	public static Border createDashedBorder(Paint paint, float thickness,
		...
		boolean shared = !rounded && (paint == null) && (thickness == 1.0f)
				&& (length == 1.0f) && (spacing == 1.0f);
		...
		float[] array = { thickness * (length - 1.0f), thickness * (spacing
				+ 1.0f) };
		Border border = createStrokeBorder(new BasicStroke(thickness, cap, join,
				thickness * 2.0f, array, 0.0f), paint);
		if (shared) {
