 ...
 * {@code JFrame}, {@code JDialog}, {@code JWindow}, {@code JApplet}, and
 * {@code JInternalFrame}) have their {@code add}, {@code remove}, and
 * {@code setLayout} methods overridden, so that they delegate calls to the
 * corresponding methods of the {@code ContentPane}. For example, you can add a
...
public interface RootPaneContainer {
     ...
     * implementation of this interface will have all of the other methods
     * indirect through this one. The rootPane has two children: the glassPane
     * and the layeredPane.
     *
    ...
    /**
     * The "contentPane" is the primary container for application specific
     * components. Applications should add children to the contentPane, set its
     ...
     * The layeredPane can be used by descendants that want to add a child to
     * the RootPaneContainer that isn't layout managed. For example an internal
     * dialog or a drag and drop effect component.
     * <p>
     ...
     * layout manager ensures that it's always as big as the rootPane. By
     * default it's transparent and not visible. It can be used to temporarily
     * grab all keyboard and mouse input by adding listeners and then making it
     * visible. by default it's not visible.
     * <p>
