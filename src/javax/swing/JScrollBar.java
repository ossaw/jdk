...
public class JScrollBar extends JComponent implements Adjustable, Accessible {
    ...
    /**
     * All changes from the model are treated as though the user moved the
     * scrollbar knob.
     */
     ...
     * minimum, and maximum. The "extent" is the size of the viewable area. It
     * is also known as the "visible amount".
     * <p>
     * Note: Use <code>setBlockIncrement</code> to set the block increment to a
     * size slightly smaller than the view's extent. That way, when the user
     * jumps the knob to an adjacent position, one or two lines of the original
     ...
     *
     * @param ui
     *        the <code>ScrollBarUI</code> {@literal L&F} object
    ...
    /**
     * Returns the delegate that implements the look and feel for this
     * component.
     *
     ...
     *           description: The scrollbar's orientation. enum: VERTICAL
     *           JScrollBar.VERTICAL HORIZONTAL JScrollBar.HORIZONTAL
     */
    ...
    /**
     * Returns data model that handles the scrollbar's four fundamental
     ...
     *
     * @see #getModel
     * @beaninfo bound: true expert: true description: The scrollbar's
     *           BoundedRangeModel.
     */
    public void setModel(BoundedRangeModel newModel) {
        ...
        if (accessibleContext != null) {
            accessibleContext.firePropertyChange(AccessibleContext.ACCESSIBLE_VALUE_PROPERTY, oldValue,
                    new Integer(model.getValue()));
        }
    }

    /**
     * Returns the amount to change the scrollbar's value by, given a unit
     * up/down request. A ScrollBarUI implementation typically calls this method
     * when the user clicks on a scrollbar up/down arrow and uses the result to
     * update the scrollbar's value. Subclasses my override this method to
     * compute a value, e.g. the change required to scroll up or down one
     * (variable height) line text or one row in a table.
     * <p>
     * The JScrollPane component creates scrollbars (by default) that override
     * this method and delegate to the viewports Scrollable view, if it has one.
     * The Scrollable interface provides a more specialized version of this
     * method.
     * <p>
    ...
    /**
     * Returns the amount to change the scrollbar's value by, given a block
     * (usually "page") up/down request. A ScrollBarUI implementation typically
     * calls this method when the user clicks above or below the scrollbar
     * "knob" to change the value up or down by large amount. Subclasses my
     * override this method to compute a value, e.g. the change required to
     * scroll up or down one paragraph in a text document.
     * <p>
     * The JScrollPane component creates scrollbars (by default) that override
     * this method and delegate to the viewports Scrollable view, if it has one.
     * The Scrollable interface provides a more specialized version of this
    ...
    /**
     * Sets the scrollbar's value. This method just forwards the value to the
     * model.
     *
     * @see #getValue
     ...
     * scrollbar look and feel implementations the size of the scrollbar "knob"
    ...
    /**
     * Sets the model's maximum property. Note that the scrollbar's value can
     * only be set to maximum - extent.
     *
     * @see #getMaximum
     ...
     * @beaninfo expert: true description: True if the scrollbar thumb is being
     *           dragged.
     */
    ...
    /**
     * Adds an AdjustmentListener. Adjustment listeners are notified each time
     * the scrollbar's model changes. Adjustment events are provided for
     * backwards compatibility with java.awt.Scrollbar.
     * <p>
     * Note that the AdjustmentEvents type property will always have a
     * placeholder value of AdjustmentEvent.TRACK because all changes to a
     * BoundedRangeModels value are considered equivalent. To change the value
     * of a BoundedRangeModel one just sets its value property, i.e.
     * model.setValue(123). No information about the origin of the change, e.g.
     * it's a block decrement, is provided. We don't try fabricate the origin of
     * the change here.
     *
     * @param l
    ...
    /**
     * Returns an array of all the <code>AdjustmentListener</code>s added to
     * this JScrollBar with addAdjustmentListener().
     *
     ...
     * AdjustmentEvents for the sake of backwards compatibility. Unfortunately
     * there's no way to determine the proper type of the AdjustmentEvent as all
     * updates to the model's value are considered equivalent.
     */
    ...
    /**
     * The scrollbar is flexible along it's scrolling axis and rigid along the
     * other axis.
     */
    ...
    /**
     * Returns a string representation of this JScrollBar. This method is
    ...
    protected String paramString() {
        ...
        return super.paramString() + ",blockIncrement=" + blockIncrement + ",orientation=" + orientationString
    ...
    /**
     * Gets the AccessibleContext associated with this JScrollBar. For
     * JScrollBar, the AccessibleContext takes the form of an
     * AccessibleJScrollBar. A new AccessibleJScrollBar instance is created if
     * necessary.
     *
     * @return an AccessibleJScrollBar that serves as the AccessibleContext of
     *         this JScrollBar
     */
     ...
     * <code>JScrollBar</code> class. It provides an implementation of the Java
     * Accessibility API appropriate to scroll bar user-interface elements.
     * <p>
     * <strong>Warning:</strong> Serialized objects of this class will not be
