 ...
 * <a href=
 * "https://docs.oracle.com/javase/tutorial/uiswing/components/frame.html">How
 * to Make Frames</a>.
 * <p>
 ...
 * different from the AWT <code>Frame</code> case. As a convenience, the
 * {@code add}, {@code remove}, and {@code setLayout} methods of this class are
 * overridden, so that they delegate calls to the corresponding methods of the
 * {@code ContentPane}. For example, you can add a child component to a frame as
 * follows:
 * 
 * <pre>
 * frame.add(child);
...
public class JFrame extends Frame implements WindowConstants, Accessible, RootPaneContainer,
    ...
    private static final Object defaultLookAndFeelDecoratedKey = new StringBuffer(
            "JFrame.defaultLookAndFeelDecorated");
     ...
     * frame, as well as the <code>glassPane</code>.
     *
     * @see JRootPane
     ...
     * is set to true when the <code>JFrame</code> is constructed.
     *
     ...
     * @param gc
     *        the <code>GraphicsConfiguration</code> that is used to
     *        construct the new <code>JFrame</code> with; if
     *        <code>gc</code>
     ...
     * <code>WindowConstants</code>): Automatically hide and dispose the frame
     * after invoking any registered <code>WindowListener</code> objects.
     ...
     *        the frame
     * @exception IllegalArgumentException
     *            if defaultCloseOperation value isn't
     *            one of the above
     *            valid values
     ...
     *         if <code>EXIT_ON_CLOSE</code> has been
     *         specified and the
     *         <code>SecurityManager</code> will not allow the
     *         caller to
     ...
     * <code>time</code> milliseconds. Refer to <code>RepaintManager</code> for
    ...
    /**
     * Returns a string representation of this <code>JFrame</code>. This method
     ...
     * AccessibleContext takes the form of an AccessibleJFrame. A new
     * AccessibleJFrame instance is created if necessary.
     *
     * @return an AccessibleJFrame that serves as the AccessibleContext of this
     *         JFrame
     */
    ...
    /**
     * This class implements accessibility support for the <code>JFrame</code>
