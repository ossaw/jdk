...
public class DebugGraphics extends Graphics {
    ...
    public void clipRect(int x, int y, int width, int height) {
        ...
        if (debugLog()) {
            info().log(toShortString() + " Setting clipRect: " + (new Rectangle(x, y, width, height))
    ...
    public void drawRoundRect(int x, int y, int width, int height, int arcWidth, int arcHeight) {
        ...
        if (debugLog()) {
            info().log(toShortString() + " Drawing round rect: " + new Rectangle(x, y, width, height)
    ...
    public void fillRoundRect(int x, int y, int width, int height, int arcWidth, int arcHeight) {
        ...
        if (debugLog()) {
            info().log(toShortString() + " Filling round rect: " + new Rectangle(x, y, width, height)
                    + " arcWidth: " + arcWidth + " archHeight: " + arcHeight);
        }
        if (isDrawingBuffer()) {
            if (debugBuffered()) {
    ...
    public void drawLine(int x1, int y1, int x2, int y2) {
        ...
        if (debugLog()) {
            info().log(toShortString() + " Drawing line: from " + pointToString(x1, y1) + " to "
                    + pointToString(x2, y2));
        }
    ...
    public void draw3DRect(int x, int y, int width, int height, boolean raised) {
        ...
        if (debugLog()) {
            info().log(toShortString() + " Drawing 3D rect: " + new Rectangle(x, y, width, height)
                    + " Raised bezel: " + raised);
        }
        if (isDrawingBuffer()) {
            if (debugBuffered()) {
    ...
    public void fill3DRect(int x, int y, int width, int height, boolean raised) {
        ...
        if (debugLog()) {
            info().log(toShortString() + " Filling 3D rect: " + new Rectangle(x, y, width, height)
                    + " Raised bezel: " + raised);
        }
        if (isDrawingBuffer()) {
            if (debugBuffered()) {
    ...
    public void drawArc(int x, int y, int width, int height, int startAngle, int arcAngle) {
        ...
        if (debugLog()) {
            info().log(toShortString() + " Drawing arc: " + new Rectangle(x, y, width, height)
    ...
    public void fillArc(int x, int y, int width, int height, int startAngle, int arcAngle) {
        ...
        if (debugLog()) {
            info().log(toShortString() + " Filling arc: " + new Rectangle(x, y, width, height)
                    + " startAngle: " + startAngle + " arcAngle: " + arcAngle);
        }
        if (isDrawingBuffer()) {
            if (debugBuffered()) {
    ...
    public void drawPolyline(int xPoints[], int yPoints[], int nPoints) {
        ...
        if (debugLog()) {
            info().log(toShortString() + " Drawing polyline: " + " nPoints: " + nPoints + " X's: " + xPoints
                    + " Y's: " + yPoints);
        }
        if (isDrawingBuffer()) {
            if (debugBuffered()) {
    ...
    public void drawPolygon(int xPoints[], int yPoints[], int nPoints) {
        ...
        if (debugLog()) {
            info().log(toShortString() + " Drawing polygon: " + " nPoints: " + nPoints + " X's: " + xPoints
                    + " Y's: " + yPoints);
        }
        if (isDrawingBuffer()) {
            if (debugBuffered()) {
    ...
    public void fillPolygon(int xPoints[], int yPoints[], int nPoints) {
        ...
        if (debugLog()) {
            info().log(toShortString() + " Filling polygon: " + " nPoints: " + nPoints + " X's: " + xPoints
                    + " Y's: " + yPoints);
        }
        if (isDrawingBuffer()) {
            if (debugBuffered()) {
    ...
    public boolean drawImage(Image img, int x, int y, ImageObserver observer) {
        ...
        if (isDrawingBuffer()) {
            ...
            ImageProducer newProducer = new FilteredImageSource(oldProducer, new DebugGraphicsFilter(
                    info.flashColor));
    ...
    public boolean drawImage(Image img, int x, int y, int width, int height, ImageObserver observer) {
        ...
        if (debugLog()) {
            info.log(toShortString() + " Drawing image: " + img + " at: " + new Rectangle(x, y, width,
                    height));
        }
    ...
    public boolean drawImage(Image img, int x, int y, Color bgcolor, ImageObserver observer) {
        ...
        if (debugLog()) {
            info.log(toShortString() + " Drawing image: " + img + " at: " + new Point(x, y) + ", bgcolor: "
                    + bgcolor);
        }
    ...
    public boolean drawImage(Image img, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1, int sx2,
        ...
        if (debugLog()) {
            info.log(toShortString() + " Drawing image: " + img + " destination: " + new Rectangle(dx1, dy1,
                    dx2, dy2) + " source: " + new Rectangle(sx1, sy1, sx2, sy2));
        }
    ...
    public boolean drawImage(Image img, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1, int sx2,
        ...
        if (debugLog()) {
            info.log(toShortString() + " Drawing image: " + img + " destination: " + new Rectangle(dx1, dy1,
                    dx2, dy2) + " source: " + new Rectangle(sx1, sy1, sx2, sy2) + ", bgcolor: " + bgcolor);
        }
        ...
        if (isDrawingBuffer()) {
            ...
            for (i = 0; i < count; i++) {
                imageToDraw = (i % 2) == 0 ? newImage : img;
                loadImage(imageToDraw);
                graphics.drawImage(imageToDraw, dx1, dy1, dx2, dy2, sx1, sy1, sx2, sy2, bgcolor,
                        imageObserver);
                Toolkit.getDefaultToolkit().sync();
                sleep(info.flashTime);
            }
    ...
    public void copyArea(int x, int y, int width, int height, int destX, int destY) {
        if (debugLog()) {
            info().log(toShortString() + " Copying area from: " + new Rectangle(x, y, width, height) + " to: "
    ...
    static DebugGraphicsInfo info() {
        DebugGraphicsInfo debugGraphicsInfo = (DebugGraphicsInfo) SwingUtilities.appContextGet(
