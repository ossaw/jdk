 ...
 * painting of the {@code JLayer} and {@link #eventDispatched(AWTEvent, JLayer)}
 * method is notified about any {@code AWTEvent}s which have been generated by a
 * {@code JLayer} or any of its subcomponents.
 * <p>
 * The {@code LayerUI} differs from the UI delegates of the other components,
 * because it is LookAndFeel independent and is not updated by default when the
 * system LookAndFeel is changed.
 * <p>
 * The subclasses of {@code LayerUI} can either be stateless and shareable by
...
public class LayerUI<V extends Component> extends ComponentUI implements
	 ...
	 * and use the specified {@code Graphics} object to render the content of
	 * the component.
	 * <p>
	...
	/**
	 * Processes {@code AWTEvent}s for {@code JLayer} and <b>all its
	 * descendants</b> to this {@code LayerUI} instance.
	 * <p>
	 * To enable the {@code AWTEvent}s of a particular type, you call
	 * {@link JLayer#setLayerEventMask} in
	 * {@link #installUI(javax.swing.JComponent)} and set the layer event mask
	 * to {@code 0} in {@link #uninstallUI(javax.swing.JComponent)} after that.
	 * By default this method calls the appropriate
	 * {@code process&lt;event&nbsp;type&gt;Event} method for the given class of
	 * event.
	 * <p>
	...
	/**
	 * Processes component events occurring on the {@link JLayer} or any of its
	 * subcomponents.
	 * <p>
	 * This method is not called unless component events are enabled for the
	 * {@code JLayer} objects, this {@code LayerUI} is set to. Component events
	 * are enabled in the overridden {@link #installUI} method and should be
	 * disabled in the {@link #uninstallUI} method after that.
	 * 
	 * <pre>
	 ...
	 * subcomponents.
	 * <p>
	 * This method is not called unless focus events are enabled for the
	 * {@code JLayer} objects, this {@code LayerUI} is set to. Focus events are
	 * enabled in the overridden {@link #installUI} method and should be
	 * disabled in the {@link #uninstallUI} method after that.
	 * 
	 * <pre>
	 * public void installUI(JComponent c) {
	 ...
	 * subcomponents.
	 * <p>
	 * This method is not called unless key events are enabled for the
	 * {@code JLayer} objects, this {@code LayerUI} is set to. Key events are
	 * enabled in the overridden {@link #installUI} method and should be
	 * disabled in the {@link #uninstallUI} method after that.
	 * 
	 * <pre>
	 ...
	 * subcomponents.
	 * <p>
	 * This method is not called unless mouse events are enabled for the
	 * {@code JLayer} objects, this {@code LayerUI} is set to. Mouse events are
	 * enabled in the overridden {@link #installUI} method and should be
	 * disabled in the {@link #uninstallUI} method after that.
	 * 
	 * <pre>
	 ...
	 * its subcomponents.
	 * <p>
	 * This method is not called unless mouse motion events are enabled for the
	 * {@code JLayer} objects, this {@code LayerUI} is set to. Mouse motion
	 * events are enabled in the overridden {@link #installUI} method and should
	 * be disabled in the {@link #uninstallUI} method after that.
	 * 
	 * <pre>
	 * public void installUI(JComponent c) {
	 * 	super.installUI(c);
	 ...
	 * subcomponents.
	 * <p>
	 * This method is not called unless mouse wheel events are enabled for the
	 * {@code JLayer} objects, this {@code LayerUI} is set to. Mouse wheel
	 * events are enabled in the overridden {@link #installUI} method and should
	 * be disabled in the {@link #uninstallUI} method after that.
	 * 
	 * <pre>
	 ...
	 * subcomponents.
	 * <p>
	 * This method is not called unless input events are enabled for the
	 * {@code JLayer} objects, this {@code LayerUI} is set to. Input events are
	 * enabled in the overridden {@link #installUI} method and should be
	 * disabled in the {@link #uninstallUI} method after that.
	 * 
	 * <pre>
	 ...
	 * subcomponents.
	 * <p>
	 * This method is not called unless hierarchy events are enabled for the
	 * {@code JLayer} objects, this {@code LayerUI} is set to. Hierarchy events
	 * are enabled in the overridden {@link #installUI} method and should be
	 * disabled in the {@link #uninstallUI} method after that.
	 * 
	 * <pre>
	 ...
	 * the {@code JLayer} objects, this {@code LayerUI} is set to. Hierarchy
	 * bounds events are enabled in the overridden {@link #installUI} method and
	 * should be disabled in the {@link #uninstallUI} method after that.
	 * 
	 * <pre>
	 * public void installUI(JComponent c) {
	 * 	super.installUI(c);
	 ...
	 * implementation registers the passed {@code JLayer} component as a
	 * {@code PropertyChangeListener} for the property changes of this
	 * {@code LayerUI}.
	 *
	 * @param c
	 ...
	 * {@link #installUI(JComponent)} method. The default implementation
	 * unregisters the passed {@code JLayer} component as a
	 * {@code PropertyChangeListener} for the property changes of this
	 * {@code LayerUI}.
	 *
	 * @param c
	 ...
	 * component.
	 *
	 * @return all of this ui's {@code PropertyChangeListener}s or an empty
	 ...
	 * property.
	 * <p>
	 * If {@code propertyName} or {@code listener} is {@code null}, no exception
	 ...
	 * {@code PropertyChangeListener}s that were registered for a specific bound
	 * property.
	 * <p>
	 * If {@code propertyName} or {@code listener} is {@code null}, no exception
	 * is thrown and no action is taken.
	...
	/**
	 * Notifies the {@code LayerUI} when any of its property are changed and
	 * enables updating every {@code JLayer} this {@code LayerUI} instance is
	 * set to.
	 *
	 * @param evt
	 ...
	 * the view's {@code getBaseline()} method. Otherwise, the default
	...
	/**
	 * If the {@code JLayer}'s view component is not {@code null}, this returns
	 * the result of the view's {@code getBaselineResizeBehavior()} method.
	...
	/**
	 * If the {@code JLayer}'s view component is not {@code null}, this returns
	 * the result of the view's {@code getPreferredSize()} method. Otherwise,
	...
	/**
	 * If the {@code JLayer}'s view component is not {@code null}, this returns
	 * the result of the view's {@code getMinimalSize()} method. Otherwise, the
	...
	/**
	 * If the {@code JLayer}'s view component is not {@code null}, this returns
	 * the result of the view's {@code getMaximumSize()} method. Otherwise, the
	 * default implementation is used.
	 *
	 * @param c
	 *          {@code JLayer} to return preferred size for
	...
	/**
	 * Paints the specified region in the {@code JLayer} this {@code LayerUI} is
	 * set to, immediately.
	 * <p>
	 * This method is to be overridden when the dirty region needs to be
	 * changed. The default implementation delegates its functionality to
