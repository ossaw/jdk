...
final class SplitPaneDividerPainter extends AbstractRegionPainter {
	...
	private Color color2 = decodeColor("nimbusBlueGrey", 0.055555582f, -0.102396235f, 0.21960783f,
			0);
	...
	private Color color7 = decodeColor("nimbusBlueGrey", 0.0055555105f, -0.06970999f, 0.21568626f,
			0);
	...
	private Color color10 = decodeColor("nimbusBlueGrey", 0.004273474f, -0.03790062f, -0.043137252f,
			0);
	private Color color11 = decodeColor("nimbusBlueGrey", -0.111111104f, -0.106573746f, 0.24705881f,
			0);
	private Color color12 = decodeColor("nimbusBlueGrey", 0.0f, -0.049301825f, 0.02352941f, 0);
	private Color color13 = decodeColor("nimbusBlueGrey", -0.006944418f, -0.07399663f, 0.11372548f,
			0);
	private Color color14 = decodeColor("nimbusBlueGrey", -0.018518567f, -0.06998578f, 0.12549019f,
			0);
	...
	private Paint decodeGradient1(Shape s) {
		...
		return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y,
				new float[] { 0.058064517f, 0.08064516f, 0.103225805f, 0.116129026f, 0.12903225f,
						0.43387097f, 0.7387097f, 0.77903223f, 0.81935483f, 0.85806453f,
						0.8967742f },
	...
	private Paint decodeGradient2(Shape s) {
		...
		float h = (float) bounds.getHeight();
		return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y,
				new float[] { 0.058064517f, 0.08064516f, 0.103225805f, 0.1166129f, 0.13f, 0.43f,
						0.73f, 0.7746774f, 0.81935483f, 0.85806453f, 0.8967742f },
				new Color[] { color1, decodeColor(color1, color4, 0.5f), color4,
						decodeColor(color4, color3, 0.5f), color3,
						decodeColor(color3, color3, 0.5f), color3,
	...
	private Paint decodeGradient3(Shape s) {
		...
		return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y,
				...
				new Color[] { color1, decodeColor(color1, color5, 0.5f), color5 });
	}
	...
	private Paint decodeGradient6(Shape s) {
		...
		float h = (float) bounds.getHeight();
		return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y,
				new float[] { 0.0f, 0.08064516f, 0.16129032f, 0.5129032f, 0.86451614f, 0.88548386f,
						0.90645164f },
