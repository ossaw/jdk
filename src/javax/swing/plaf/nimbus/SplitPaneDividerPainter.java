...
final class SplitPaneDividerPainter extends AbstractRegionPainter {
	...
	// of SplitPaneDividerPainter to determine which region/state is being
	// painted
	// by that instance.
	...
	// being used
	// by a particular instance of SplitPaneDividerPainter would be created. For
	// the moment at least,
	// however, all are created for each instance.
	private Color color1 = decodeColor("nimbusBlueGrey", 0.0f, -0.017358616f,
			-0.11372548f, 0);
	private Color color2 = decodeColor("nimbusBlueGrey", 0.055555582f,
			-0.102396235f, 0.21960783f, 0);
	private Color color3 = decodeColor("nimbusBlueGrey", 0.0f, -0.07016757f,
			0.12941176f, 0);
	...
	private Color color5 = decodeColor("nimbusBlueGrey", 0.0f, -0.110526316f,
			0.25490195f, 0);
	private Color color6 = decodeColor("nimbusBlueGrey", 0.0f, -0.048026316f,
			0.007843137f, 0);
	private Color color7 = decodeColor("nimbusBlueGrey", 0.0055555105f,
			-0.06970999f, 0.21568626f, 0);
	private Color color8 = decodeColor("nimbusBlueGrey", 0.0f, -0.06704806f,
			0.06666666f, 0);
	private Color color9 = decodeColor("nimbusBlueGrey", 0.0f, -0.019617222f,
			-0.09803921f, 0);
	private Color color10 = decodeColor("nimbusBlueGrey", 0.004273474f,
			-0.03790062f, -0.043137252f, 0);
	private Color color11 = decodeColor("nimbusBlueGrey", -0.111111104f,
			-0.106573746f, 0.24705881f, 0);
	private Color color12 = decodeColor("nimbusBlueGrey", 0.0f, -0.049301825f,
			0.02352941f, 0);
	private Color color13 = decodeColor("nimbusBlueGrey", -0.006944418f,
			-0.07399663f, 0.11372548f, 0);
	private Color color14 = decodeColor("nimbusBlueGrey", -0.018518567f,
			-0.06998578f, 0.12549019f, 0);
	private Color color15 = decodeColor("nimbusBlueGrey", 0.0f, -0.050526317f,
			0.039215684f, 0);
	...
	private Paint decodeGradient1(Shape s) {
		...
		return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x,
				(1.0f * h) + y, new float[] { 0.058064517f, 0.08064516f,
						0.103225805f, 0.116129026f, 0.12903225f, 0.43387097f,
						0.7387097f, 0.77903223f, 0.81935483f, 0.85806453f,
						0.8967742f }, new Color[] { color1, decodeColor(color1,
								...
								decodeColor(color2, color1, 0.5f), color1 });
	}
	...
	private Paint decodeGradient2(Shape s) {
		...
		return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x,
				(1.0f * h) + y, new float[] { 0.058064517f, 0.08064516f,
						0.103225805f, 0.1166129f, 0.13f, 0.43f, 0.73f,
						0.7746774f, 0.81935483f, 0.85806453f, 0.8967742f },
				new Color[] { color1, decodeColor(color1, color4, 0.5f), color4,
						decodeColor(color4, color3, 0.5f), color3, decodeColor(
								color3, color3, 0.5f), color3, decodeColor(
										color3, color4, 0.5f), color4,
						decodeColor(color4, color1, 0.5f), color1 });
	}
	...
	private Paint decodeGradient3(Shape s) {
		...
		float h = (float) bounds.getHeight();
		return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x,
				(1.0f * h) + y, new float[] { 0.20645161f, 0.5f, 0.7935484f },
				new Color[] { color1, decodeColor(color1, color5, 0.5f),
						color5 });
	}
	...
	private Paint decodeGradient4(Shape s) {
		...
		float h = (float) bounds.getHeight();
		return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x,
				(1.0f * h) + y, new float[] { 0.090322584f, 0.2951613f, 0.5f,
						0.5822581f, 0.66451615f }, new Color[] { color6,
	...
	private Paint decodeGradient5(Shape s) {
		...
		return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.75f * w) + x,
				(1.0f * h) + y, new float[] { 0.0f, 0.42096773f, 0.84193546f,
						0.8951613f, 0.9483871f }, new Color[] { color9,
	...
	private Paint decodeGradient6(Shape s) {
		...
		float h = (float) bounds.getHeight();
		return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x,
				(1.0f * h) + y, new float[] { 0.0f, 0.08064516f, 0.16129032f,
						0.5129032f, 0.86451614f, 0.88548386f, 0.90645164f },
