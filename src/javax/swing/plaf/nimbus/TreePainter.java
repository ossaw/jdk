...
final class TreePainter extends AbstractRegionPainter {
	...
	private Color color1 = decodeColor("nimbusBlueGrey", 0.007936537f, -0.065654516f, -0.13333333f,
			0);
	private Color color2 = new Color(97, 98, 102, 255);
	private Color color3 = decodeColor("nimbusBlueGrey", -0.032679737f, -0.043332636f, 0.24705881f,
			0);
	...
	private Color color26 = decodeColor("nimbusBlueGrey", -0.6111111f, -0.110526316f, -0.34509805f,
			0);
	...
	private Paint decodeGradient4(Shape s) {
		...
		return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y,
				new float[] { 0.0f, 0.5f, 1.0f },
				new Color[] { color5, decodeColor(color5, color14, 0.5f), color14 });
	}
