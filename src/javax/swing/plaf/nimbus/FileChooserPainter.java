...
final class FileChooserPainter extends AbstractRegionPainter {
    ...
    // being used
    // by a particular instance of FileChooserPainter would be created. For the
    // moment at least,
    ...
    private Path2D decodePath24() {
        ...
        path.curveTo(decodeAnchorX(1.0f, 1.0f), decodeAnchorY(0.4000000059604645f, -1.0f), decodeAnchorX(2.0f,
                -1.0f), decodeAnchorY(0.4000000059604645f, -1.0f), decodeX(2.0f), decodeY(0.4f));
        path.curveTo(decodeAnchorX(2.0f, 1.0f), decodeAnchorY(0.4000000059604645f, 1.0f), decodeAnchorX(
                2.200000047683716f, 0.0f), decodeAnchorY(1.0f, -1.0f), decodeX(2.2f), decodeY(1.0f));
        path.curveTo(decodeAnchorX(2.200000047683716f, 0.0f), decodeAnchorY(1.0f, 1.0f), decodeAnchorX(
                2.200000047683716f, 0.0f), decodeAnchorY(1.5f, -2.0f), decodeX(2.2f), decodeY(1.5f));
        path.curveTo(decodeAnchorX(2.200000047683716f, 0.0f), decodeAnchorY(1.5f, 2.0f), decodeAnchorX(
                1.6666667461395264f, 1.0f), decodeAnchorY(1.8333332538604736f, 0.0f), decodeX(1.6666667f),
                decodeY(1.8333333f));
        path.curveTo(decodeAnchorX(1.6666667461395264f, -1.0f), decodeAnchorY(1.8333332538604736f, 0.0f),
                decodeAnchorX(1.3333333730697632f, 1.0f), decodeAnchorY(1.8333332538604736f, 0.0f), decodeX(
                        1.3333334f), decodeY(1.8333333f));
        path.curveTo(decodeAnchorX(1.3333333730697632f, -1.0f), decodeAnchorY(1.8333332538604736f, 0.0f),
                decodeAnchorX(0.800000011920929f, 0.0f), decodeAnchorY(1.5f, 2.0f), decodeX(0.8f), decodeY(
                        1.5f));
        path.curveTo(decodeAnchorX(0.800000011920929f, 0.0f), decodeAnchorY(1.5f, -2.0f), decodeAnchorX(
                0.800000011920929f, 0.0f), decodeAnchorY(1.0f, 1.0f), decodeX(0.8f), decodeY(1.0f));
        path.curveTo(decodeAnchorX(0.800000011920929f, 0.0f), decodeAnchorY(1.0f, -1.0f), decodeAnchorX(1.0f,
                -1.0f), decodeAnchorY(0.4000000059604645f, 1.0f), decodeX(1.0f), decodeY(0.4f));
        path.closePath();
        return path;
    }
    ...
    private Paint decodeGradient1(Shape s) {
        ...
        return decodeGradient((0.046296295f * w) + x, (0.9675926f * h) + y, (0.4861111f * w) + x, (0.5324074f
                * h) + y, new float[] { 0.0f, 0.5f, 1.0f }, new Color[] { color4, decodeColor(color4, color5,
                        0.5f), color5 });
    }
    ...
    private Paint decodeGradient2(Shape s) {
        ...
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.5f, 1.0f }, new Color[] { color6, decodeColor(color6, color7, 0.5f), color7 });
    }
    ...
    private Paint decodeGradient3(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.04191617f, 0.10329342f, 0.16467066f, 0.24550897f, 0.3263473f, 0.6631737f, 1.0f },
    ...
    private Paint decodeGradient4(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.5f, 1.0f }, new Color[] { color6, decodeColor(color6, color15, 0.5f), color15 });
    }
    ...
    private Paint decodeGradient6(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.12724552f, 0.25449103f, 0.62724555f, 1.0f }, new Color[] { color21, decodeColor(
                        color21, color22, 0.5f), color22, decodeColor(color22, color23, 0.5f), color23 });
    }
    ...
    private Paint decodeGradient7(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.06392045f, 0.1278409f, 0.5213069f, 0.91477275f }, new Color[] { color25, decodeColor(
                        color25, color26, 0.5f), color26, decodeColor(color26, color27, 0.5f), color27 });
    }
    ...
    private Paint decodeGradient8(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.048295453f, 0.09659091f, 0.5482955f, 1.0f }, new Color[] { color28, decodeColor(
                        color28, color6, 0.5f), color6, decodeColor(color6, color15, 0.5f), color15 });
    }
    ...
    private Paint decodeGradient9(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.5f, 1.0f }, new Color[] { color29, decodeColor(color29, color30, 0.5f), color30 });
    }
    ...
    private Paint decodeGradient10(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.06534091f, 0.13068181f, 0.3096591f, 0.48863637f, 0.7443182f, 1.0f }, new Color[] {
                        color11, decodeColor(color11, color12, 0.5f), color12, decodeColor(color12, color31,
                                0.5f), color31, decodeColor(color31, color14, 0.5f), color14 });
    }
    ...
    private Paint decodeGradient11(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.5f, 1.0f }, new Color[] { color33, decodeColor(color33, color34, 0.5f), color34 });
    }
    ...
    private Paint decodeGradient12(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.5f, 1.0f }, new Color[] { color36, decodeColor(color36, color37, 0.5f), color37 });
    }
    ...
    private Paint decodeRadial1(Shape s) {
        ...
        float w = (float) bounds.getWidth();
        float h = (float) bounds.getHeight();
        return decodeRadialGradient((0.5f * w) + x, (1.0f * h) + y, 0.53913116f, new float[] { 0.11290322f,
                0.17419355f, 0.23548387f, 0.31129032f, 0.38709676f, 0.47903225f, 0.57096773f }, new Color[] {
                        color40, decodeColor(color40, color41, 0.5f), color41, decodeColor(color41, color41,
                                0.5f), color41, decodeColor(color41, color42, 0.5f), color42 });
    }
    ...
    private Paint decodeGradient13(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.5f, 1.0f }, new Color[] { color45, decodeColor(color45, color46, 0.5f), color46 });
    }
    ...
    private Paint decodeGradient14(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.5f, 1.0f }, new Color[] { color47, decodeColor(color47, color48, 0.5f), color48 });
    }
    ...
    private Paint decodeGradient15(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.3983871f, 0.7967742f, 0.8983871f, 1.0f }, new Color[] { color51, decodeColor(color51,
                        color52, 0.5f), color52, decodeColor(color52, color51, 0.5f), color51 });
    }
    ...
    private Paint decodeGradient16(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.061290324f, 0.12258065f, 0.5016129f, 0.88064516f, 0.9403226f, 1.0f }, new Color[] {
                        color57, decodeColor(color57, color58, 0.5f), color58, decodeColor(color58, color59,
                                0.5f), color59, decodeColor(color59, color44, 0.5f), color44 });
    }
    ...
    private Paint decodeGradient17(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.05f, 0.1f, 0.19193548f, 0.28387097f, 0.5209677f, 0.7580645f, 0.87903225f, 1.0f },
                new Color[] { color60, decodeColor(color60, color61, 0.5f), color61, decodeColor(color61,
                        color62, 0.5f), color62, decodeColor(color62, color63, 0.5f), color63, decodeColor(
                                color63, color64, 0.5f), color64 });
    }
    ...
    private Paint decodeGradient18(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.058064517f, 0.090322584f, 0.12258065f, 0.15645161f, 0.19032258f, 0.22741935f, 0.26451612f,
                0.31290323f, 0.36129034f, 0.38225806f, 0.4032258f, 0.4596774f, 0.516129f, 0.54193544f,
                0.56774193f, 0.61451614f, 0.66129035f, 0.70645165f, 0.7516129f }, new Color[] { color65,
                        decodeColor(color65, color40, 0.5f), color40, decodeColor(color40, color40, 0.5f),
                        color40, decodeColor(color40, color65, 0.5f), color65, decodeColor(color65, color65,
                                0.5f), color65, decodeColor(color65, color40, 0.5f), color40, decodeColor(
                                        color40, color40, 0.5f), color40, decodeColor(color40, color66, 0.5f),
                        color66, decodeColor(color66, color66, 0.5f), color66, decodeColor(color66, color40,
                                0.5f), color40 });
    }
    ...
    private Paint decodeGradient19(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.5f, 1.0f }, new Color[] { color67, decodeColor(color67, color67, 0.5f), color67 });
    }
    ...
    private Paint decodeGradient20(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.5f, 1.0f }, new Color[] { color74, decodeColor(color74, color75, 0.5f), color75 });
    }
    ...
    private Paint decodeGradient21(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.5f, 1.0f }, new Color[] { color77, decodeColor(color77, color78, 0.5f), color78 });
    }
    ...
    private Paint decodeGradient22(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.5f, 1.0f }, new Color[] { color79, decodeColor(color79, color80, 0.5f), color80 });
    }
    ...
    private Paint decodeGradient23(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.5f, 1.0f }, new Color[] { color81, decodeColor(color81, color82, 0.5f), color82 });
    }
    ...
    private Paint decodeGradient24(Shape s) {
        ...
        float w = (float) bounds.getWidth();
        float h = (float) bounds.getHeight();
        return decodeGradient((0.43076923f * w) + x, (0.37820512f * h) + y, (0.7076923f * w) + x, (0.6730769f
                * h) + y, new float[] { 0.0f, 0.5f, 1.0f }, new Color[] { color84, decodeColor(color84,
                        color85, 0.5f), color85 });
    }
    ...
    private Paint decodeGradient25(Shape s) {
        ...
        float w = (float) bounds.getWidth();
        float h = (float) bounds.getHeight();
        return decodeGradient((0.63076925f * w) + x, (0.3621795f * h) + y, (0.28846154f * w) + x, (0.73397434f
                * h) + y, new float[] { 0.0f, 0.5f, 1.0f }, new Color[] { color84, decodeColor(color84,
                        color86, 0.5f), color86 });
    }
    ...
    private Paint decodeGradient26(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.5f, 1.0f }, new Color[] { color87, decodeColor(color87, color88, 0.5f), color88 });
    }
    ...
    private Paint decodeGradient27(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.056818184f, 0.11363637f, 0.34232956f, 0.57102275f, 0.7855114f, 1.0f }, new Color[] {
                        color89, decodeColor(color89, color90, 0.5f), color90, decodeColor(color90, color91,
                                0.5f), color91, decodeColor(color91, color92, 0.5f), color92 });
    }
    ...
    private Paint decodeGradient28(Shape s) {
        ...
        return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.75f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.5f, 1.0f }, new Color[] { color95, decodeColor(color95, color96, 0.5f), color96 });
    }
    ...
    private Paint decodeRadial2(Shape s) {
        ...
        float w = (float) bounds.getWidth();
        float h = (float) bounds.getHeight();
        return decodeRadialGradient((0.49223602f * w) + x, (0.9751553f * h) + y, 0.73615754f, new float[] {
                0.0f, 0.40625f, 1.0f }, new Color[] { color97, decodeColor(color97, color98, 0.5f),
                        color98 });
    }
    ...
    private Paint decodeGradient29(Shape s) {
        ...
        float w = (float) bounds.getWidth();
        float h = (float) bounds.getHeight();
        return decodeGradient((0.0f * w) + x, (0.0f * h) + y, (1.0f * w) + x, (1.0f * h) + y, new float[] {
                0.38352272f, 0.4190341f, 0.45454547f, 0.484375f, 0.51420456f }, new Color[] { color99,
                        decodeColor(color99, color100, 0.5f), color100, decodeColor(color100, color101, 0.5f),
                        color101 });
    }
    ...
    private Paint decodeGradient30(Shape s) {
        ...
        float w = (float) bounds.getWidth();
        float h = (float) bounds.getHeight();
        return decodeGradient((1.0f * w) + x, (0.0f * h) + y, (0.0f * w) + x, (1.0f * h) + y, new float[] {
                0.12215909f, 0.16051137f, 0.19886364f, 0.2627841f, 0.32670453f, 0.43039775f, 0.53409094f },
                new Color[] { color102, decodeColor(color102, color35, 0.5f), color35, decodeColor(color35,
                        color35, 0.5f), color35, decodeColor(color35, color103, 0.5f), color103 });
    }
    ...
    private Paint decodeGradient31(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.038352273f, 0.07670455f, 0.24289773f, 0.4090909f, 0.7045455f, 1.0f }, new Color[] {
                        color89, decodeColor(color89, color90, 0.5f), color90, decodeColor(color90, color108,
                                0.5f), color108, decodeColor(color108, color92, 0.5f), color92 });
    }
    ...
    private Paint decodeGradient32(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.0f * w) + x, (0.0f * h) + y, (1.0f * w) + x, (1.0f * h) + y, new float[] {
                0.25f, 0.33522725f, 0.42045453f, 0.50142044f, 0.5823864f }, new Color[] { color109,
                        decodeColor(color109, color110, 0.5f), color110, decodeColor(color110, color109,
                                0.5f), color109 });
    }
    ...
    private Paint decodeGradient33(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.75f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.24147727f, 0.48295453f, 0.74147725f, 1.0f }, new Color[] { color114, decodeColor(
                        color114, color115, 0.5f), color115, decodeColor(color115, color114, 0.5f),
                        color114 });
    }
    ...
    private Paint decodeGradient34(Shape s) {
        ...
        float w = (float) bounds.getWidth();
        float h = (float) bounds.getHeight();
        return decodeGradient((0.0f * w) + x, (0.0f * h) + y, (1.0f * w) + x, (0.0f * h) + y, new float[] {
                0.0f, 0.21732955f, 0.4346591f }, new Color[] { color117, decodeColor(color117, color118,
                        0.5f), color118 });
    }
    ...
    private Paint decodeGradient35(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.0f * w) + x, (0.0f * h) + y, (1.0f * w) + x, (0.0f * h) + y, new float[] {
                0.0f, 0.21448864f, 0.42897728f, 0.7144886f, 1.0f }, new Color[] { color119, decodeColor(
                        color119, color120, 0.5f), color120, decodeColor(color120, color119, 0.5f),
                        color119 });
    }
