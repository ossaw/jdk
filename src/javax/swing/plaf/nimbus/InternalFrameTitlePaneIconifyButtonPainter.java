...
final class InternalFrameTitlePaneIconifyButtonPainter extends AbstractRegionPainter {
	...
	private Color color4 = decodeColor("nimbusOrange", -4.4563413E-4f, -0.48364475f, 0.10588235f,
			0);
	...
	private Color color7 = decodeColor("nimbusOrange", -0.08377897f, 0.02094239f, -0.40392157f,
			-106);
	...
	private Color color14 = decodeColor("nimbusBlueGrey", -0.0808081f, 0.015910469f, -0.40392157f,
			-216);
	private Color color15 = decodeColor("nimbusBlueGrey", -0.003968239f, -0.03760965f, 0.007843137f,
			0);
	...
	private Color color18 = decodeColor("nimbusOrange", -0.02758849f, 0.02094239f, -0.062745094f,
			0);
	...
	private Color color25 = decodeColor("nimbusOrange", -0.053104125f, 0.02094239f, -0.109803915f,
			0);
	private Color color26 = decodeColor("nimbusOrange", -0.017887495f, -0.33726656f, 0.039215684f,
			0);
	private Color color27 = decodeColor("nimbusOrange", -0.018038228f, 0.02094239f, -0.043137252f,
			0);
	private Color color28 = decodeColor("nimbusOrange", -0.015844189f, 0.02094239f, -0.027450979f,
			0);
	private Color color29 = decodeColor("nimbusOrange", -0.010274701f, 0.02094239f, 0.015686274f,
			0);
	private Color color30 = decodeColor("nimbusOrange", -0.08377897f, 0.02094239f, -0.14509803f,
			-91);
	...
	private Color color37 = decodeColor("nimbusBlueGrey", -0.01111114f, -0.017933726f, -0.32156864f,
			0);
	...
	private Paint decodeGradient2(Shape s) {
		...
		return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x,
				...
				new Color[] { color4, decodeColor(color4, color3, 0.5f), color3,
						decodeColor(color3, color5, 0.5f), color5,
	...
	private Paint decodeGradient10(Shape s) {
		...
		return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x,
				(1.0016667f * h) + y,
				new float[] { 0.0f, 0.26988637f, 0.53977275f, 0.5951705f, 0.6505682f, 0.78336793f,
						0.9161677f },
