...
final class InternalFrameTitlePaneIconifyButtonPainter extends
        AbstractRegionPainter {
    // package private integers representing the available states that
    // this painter will paint. These are used when creating a new instance
    // of InternalFrameTitlePaneIconifyButtonPainter to determine which
    ...
    // being used
    // by a particular instance of InternalFrameTitlePaneIconifyButtonPainter
    ...
    private Color color2 = decodeColor("nimbusOrange", -0.08377897f,
            0.02094239f, -0.40392157f, 0);
    private Color color3 = decodeColor("nimbusOrange", 0.0f, 0.0f, 0.0f, 0);
    private Color color4 = decodeColor("nimbusOrange", -4.4563413E-4f,
            -0.48364475f, 0.10588235f, 0);
    private Color color5 = decodeColor("nimbusOrange", 0.0f, -0.0050992966f,
            0.0039215684f, 0);
    private Color color6 = decodeColor("nimbusOrange", 0.0f, -0.12125945f,
            0.10588235f, 0);
    private Color color7 = decodeColor("nimbusOrange", -0.08377897f,
            0.02094239f, -0.40392157f, -106);
    private Color color8 = decodeColor("nimbusBlueGrey", 0.0f, -0.110526316f,
            0.25490195f, 0);
    private Color color9 = decodeColor("nimbusOrange", 0.5203877f, -0.9376068f,
            0.007843137f, 0);
    private Color color10 = decodeColor("nimbusOrange", 0.5273321f, -0.8903002f,
            -0.086274505f, 0);
    private Color color11 = decodeColor("nimbusOrange", 0.5273321f,
            -0.93313926f, 0.019607842f, 0);
    private Color color12 = decodeColor("nimbusOrange", 0.53526866f,
            -0.8995122f, -0.058823526f, 0);
    private Color color13 = decodeColor("nimbusOrange", 0.5233639f, -0.8971863f,
            -0.07843137f, 0);
    private Color color14 = decodeColor("nimbusBlueGrey", -0.0808081f,
            0.015910469f, -0.40392157f, -216);
    private Color color15 = decodeColor("nimbusBlueGrey", -0.003968239f,
            -0.03760965f, 0.007843137f, 0);
    private Color color16 = new Color(255, 200, 0, 255);
    private Color color17 = decodeColor("nimbusOrange", -0.08377897f,
            0.02094239f, -0.31764707f, 0);
    private Color color18 = decodeColor("nimbusOrange", -0.02758849f,
            0.02094239f, -0.062745094f, 0);
    private Color color19 = decodeColor("nimbusOrange", -4.4563413E-4f,
            -0.5074419f, 0.1490196f, 0);
    private Color color20 = decodeColor("nimbusOrange", 9.745359E-6f,
            -0.11175901f, 0.07843137f, 0);
    private Color color21 = decodeColor("nimbusOrange", 0.0f, -0.09280169f,
            0.07843137f, 0);
    private Color color22 = decodeColor("nimbusOrange", 0.0f, -0.19002807f,
            0.18039215f, 0);
    private Color color23 = decodeColor("nimbusOrange", -0.025772434f,
            0.02094239f, 0.05098039f, 0);
    private Color color24 = decodeColor("nimbusOrange", -0.08377897f,
            0.02094239f, -0.4f, 0);
    private Color color25 = decodeColor("nimbusOrange", -0.053104125f,
            0.02094239f, -0.109803915f, 0);
    private Color color26 = decodeColor("nimbusOrange", -0.017887495f,
            -0.33726656f, 0.039215684f, 0);
    private Color color27 = decodeColor("nimbusOrange", -0.018038228f,
            0.02094239f, -0.043137252f, 0);
    private Color color28 = decodeColor("nimbusOrange", -0.015844189f,
            0.02094239f, -0.027450979f, 0);
    private Color color29 = decodeColor("nimbusOrange", -0.010274701f,
            0.02094239f, 0.015686274f, 0);
    private Color color30 = decodeColor("nimbusOrange", -0.08377897f,
            0.02094239f, -0.14509803f, -91);
    private Color color31 = decodeColor("nimbusOrange", 0.5273321f,
            -0.87971985f, -0.15686274f, 0);
    private Color color32 = decodeColor("nimbusOrange", 0.5273321f, -0.842694f,
            -0.31764707f, 0);
    private Color color33 = decodeColor("nimbusOrange", 0.516221f, -0.9567362f,
            0.12941176f, 0);
    private Color color34 = decodeColor("nimbusOrange", 0.5222816f, -0.9229352f,
            0.019607842f, 0);
    private Color color35 = decodeColor("nimbusOrange", 0.5273321f,
            -0.91751915f, 0.015686274f, 0);
    private Color color36 = decodeColor("nimbusOrange", 0.5273321f, -0.9193561f,
            0.039215684f, 0);
    private Color color37 = decodeColor("nimbusBlueGrey", -0.01111114f,
            -0.017933726f, -0.32156864f, 0);

    // Array of current component colors, updated in each paint call
    private Object[] componentColors;

    public InternalFrameTitlePaneIconifyButtonPainter(PaintContext ctx,
            int state) {
        super();
        this.state = state;
        this.ctx = ctx;
    ...
    private Paint decodeGradient2(Shape s) {
        ...
        return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w)
                ...
                new Color[] { color4, decodeColor(color4, color3, 0.5f), color3,
                        decodeColor(color3, color5, 0.5f), color5, decodeColor(
    ...
    private Paint decodeGradient4(Shape s) {
        ...
        return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w)
                ...
                new Color[] { color11, decodeColor(color11, color12, 0.5f),
                        ...
                        decodeColor(color13, color10, 0.5f), color10 });
    }
    ...
    private Paint decodeGradient5(Shape s) {
        ...
        return decodeGradient((0.24868421f * w) + x, (0.0014705883f * h) + y,
                (0.24868421f * w) + x, (1.0f * h) + y, new float[] { 0.0f, 0.5f,
                        1.0f }, new Color[] { color17, decodeColor(color17,
                                color18, 0.5f), color18 });
    }
    ...
    private Paint decodeGradient10(Shape s) {
        ...
        return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w)
                + x, (1.0016667f * h) + y, new float[] { 0.0f, 0.26988637f,
                        0.53977275f, 0.5951705f, 0.6505682f, 0.78336793f,
                        0.9161677f }, new Color[] { color33, decodeColor(
                                color33, color34, 0.5f), color34, decodeColor(
                                        color34, color35, 0.5f), color35,
