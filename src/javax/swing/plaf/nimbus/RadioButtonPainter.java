...
final class RadioButtonPainter extends AbstractRegionPainter {
	...
	private Color color10 = decodeColor("nimbusBlueGrey", 0.055555582f, -0.10654225f, 0.23921567f,
			0);
	...
	private Color color13 = decodeColor("nimbusBlueGrey", -0.00505054f, -0.027819552f, -0.2235294f,
			0);
	private Color color14 = decodeColor("nimbusBlueGrey", 0.0f, 0.24241486f, -0.6117647f, 0);
	private Color color15 = decodeColor("nimbusBlueGrey", -0.111111104f, -0.10655806f, 0.24313724f,
			0);
	private Color color16 = decodeColor("nimbusBlueGrey", 0.0f, -0.07333623f, 0.20392156f, 0);
	private Color color17 = decodeColor("nimbusBlueGrey", 0.08585858f, -0.067389056f, 0.25490195f,
			0);
	private Color color18 = decodeColor("nimbusBlueGrey", -0.111111104f, -0.10628903f, 0.18039215f,
			0);
	private Color color19 = decodeColor("nimbusBlueGrey", 0.0f, -0.110526316f, 0.25490195f, 0);
	private Color color20 = decodeColor("nimbusBlueGrey", 0.055555582f, 0.23947367f, -0.6666667f,
			0);
	private Color color21 = decodeColor("nimbusBlueGrey", -0.0777778f, -0.06815343f, -0.28235295f,
			0);
	private Color color22 = decodeColor("nimbusBlueGrey", 0.0f, -0.06866585f, 0.09803921f, 0);
	private Color color23 = decodeColor("nimbusBlueGrey", -0.0027777553f, -0.0018306673f,
			-0.02352941f, 0);
	private Color color24 = decodeColor("nimbusBlueGrey", 0.002924025f, -0.02047892f, 0.082352936f,
			0);
	private Color color25 = decodeColor("nimbusBase", 2.9569864E-4f, -0.36035198f, -0.007843137f,
			0);
	...
	private Color color31 = decodeColor("nimbusBlueGrey", -0.027777791f, -0.07243107f, -0.33333334f,
			0);
	private Color color32 = decodeColor("nimbusBlueGrey", -0.6111111f, -0.110526316f, -0.74509805f,
			0);
	private Color color33 = decodeColor("nimbusBlueGrey", -0.027777791f, 0.07129187f, -0.6156863f,
			0);
	...
	private Color color40 = decodeColor("nimbusBlueGrey", -0.027777791f, -0.080223285f, -0.4862745f,
			0);
	...
	private Color color53 = decodeColor("nimbusBlueGrey", -0.01111114f, -0.058170296f,
			0.0039215684f, 0);
	private Color color54 = decodeColor("nimbusBlueGrey", -0.013888836f, -0.04195489f,
			-0.058823526f, 0);
	private Color color55 = decodeColor("nimbusBlueGrey", 0.009259284f, -0.0147816315f,
			-0.007843137f, 0);
	...
	private Paint decodeGradient1(Shape s) {
		...
		return decodeGradient((0.49789914f * w) + x, (-0.004201681f * h) + y, (0.5f * w) + x,
				(0.9978992f * h) + y, new float[] { 0.0f, 0.5f, 1.0f },
	...
	private Paint decodeGradient2(Shape s) {
		...
		float w = (float) bounds.getWidth();
		float h = (float) bounds.getHeight();
		return decodeGradient((0.49754903f * w) + x, (0.004901961f * h) + y, (0.50735295f * w) + x,
				(1.0f * h) + y,
				new float[] { 0.06344411f, 0.21601209f, 0.36858007f, 0.54833835f, 0.72809666f,
						0.77492446f, 0.82175225f, 0.91087615f, 1.0f },
				new Color[] { color3, decodeColor(color3, color4, 0.5f), color4,
						decodeColor(color4, color4, 0.5f), color4,
	...
	private Paint decodeGradient4(Shape s) {
		...
		return decodeGradient((0.49754903f * w) + x, (0.004901961f * h) + y, (0.50735295f * w) + x,
				(1.0f * h) + y,
				new float[] { 0.06344411f, 0.25009555f, 0.43674698f, 0.48042166f, 0.52409637f,
						0.70481926f, 0.88554215f },
				new Color[] { color10, decodeColor(color10, color4, 0.5f), color4,
						decodeColor(color4, color4, 0.5f), color4,
						decodeColor(color4, color11, 0.5f), color11 });
	}
	...
	private Paint decodeGradient6(Shape s) {
		...
		return decodeGradient((0.49754903f * w) + x, (0.004901961f * h) + y, (0.50735295f * w) + x,
				...
				new Color[] { color15, decodeColor(color15, color16, 0.5f), color16,
						decodeColor(color16, color16, 0.5f), color16,
	...
	private Paint decodeGradient8(Shape s) {
		...
		return decodeGradient((0.49754903f * w) + x, (0.004901961f * h) + y, (0.50735295f * w) + x,
				(1.0f * h) + y,
				new float[] { 0.06344411f, 0.20792687f, 0.35240963f, 0.45030123f, 0.5481928f,
						0.748494f, 0.9487952f },
				new Color[] { color22, decodeColor(color22, color23, 0.5f), color23,
						decodeColor(color23, color23, 0.5f), color23,
	...
	private Paint decodeGradient10(Shape s) {
		...
		return decodeGradient((0.49754903f * w) + x, (0.004901961f * h) + y, (0.50735295f * w) + x,
				(1.0f * h) + y,
				new float[] { 0.0813253f, 0.100903615f, 0.12048193f, 0.28915662f, 0.45783132f,
	...
	private Paint decodeGradient11(Shape s) {
		...
		float w = (float) bounds.getWidth();
		float h = (float) bounds.getHeight();
		return decodeGradient((0.50490195f * w) + x, (0.0f * h) + y, (0.49509802f * w) + x,
				(1.0f * h) + y, new float[] { 0.0f, 0.23192771f, 0.46385542f, 0.73192775f, 1.0f },
				new Color[] { color31, decodeColor(color31, color32, 0.5f), color32,
	...
	private Paint decodeGradient12(Shape s) {
		...
		return decodeGradient((0.49789914f * w) + x, (-0.004201681f * h) + y, (0.5f * w) + x,
				(0.9978992f * h) + y, new float[] { 0.0f, 0.5f, 1.0f },
				new Color[] { color34, decodeColor(color34, color26, 0.5f), color26 });
	}
	...
	private Paint decodeGradient13(Shape s) {
		...
		return decodeGradient((0.49754903f * w) + x, (0.004901961f * h) + y, (0.50735295f * w) + x,
				(1.0f * h) + y,
				new float[] { 0.039156627f, 0.07831325f, 0.11746988f, 0.2876506f, 0.45783132f,
						0.56174695f, 0.66566265f, 0.7756024f, 0.88554215f },
	...
	private Paint decodeGradient14(Shape s) {
		...
		return decodeGradient((0.50490195f * w) + x, (0.0f * h) + y, (0.49509802f * w) + x,
				(1.0f * h) + y, new float[] { 0.0f, 0.23192771f, 0.46385542f, 0.73192775f, 1.0f },
				new Color[] { color40, decodeColor(color40, color32, 0.5f), color32,
						decodeColor(color32, color33, 0.5f), color33 });
	}
	...
	private Paint decodeGradient15(Shape s) {
		...
		return decodeGradient((0.49789914f * w) + x, (-0.004201681f * h) + y, (0.5f * w) + x,
				(0.9978992f * h) + y, new float[] { 0.0f, 0.5f, 1.0f },
				new Color[] { color41, decodeColor(color41, color42, 0.5f), color42 });
	}
	...
	private Paint decodeGradient16(Shape s) {
		...
		return decodeGradient((0.49754903f * w) + x, (0.004901961f * h) + y, (0.50735295f * w) + x,
				(1.0f * h) + y,
				new float[] { 0.0813253f, 0.100903615f, 0.12048193f, 0.20180723f, 0.28313252f,
						0.49246985f, 0.7018072f, 0.7560241f, 0.810241f, 0.84789157f, 0.88554215f },
				new Color[] { color43, decodeColor(color43, color44, 0.5f), color44,
	...
	private Paint decodeGradient18(Shape s) {
		...
		return decodeGradient((0.49754903f * w) + x, (0.004901961f * h) + y, (0.50735295f * w) + x,
				...
				new Color[] { color50, decodeColor(color50, color51, 0.5f), color51,
						decodeColor(color51, color52, 0.5f), color52 });
	}
	...
	private Paint decodeGradient19(Shape s) {
		...
		return decodeGradient((0.50490195f * w) + x, (0.0f * h) + y, (0.49509802f * w) + x,
				(1.0f * h) + y, new float[] { 0.0f, 0.23192771f, 0.46385542f, 0.73192775f, 1.0f },
				new Color[] { color53, decodeColor(color53, color54, 0.5f), color54,
						decodeColor(color54, color55, 0.5f), color55 });
	}
