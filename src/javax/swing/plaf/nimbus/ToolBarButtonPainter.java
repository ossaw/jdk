...
final class ToolBarButtonPainter extends AbstractRegionPainter {
	...
	private Color color9 = decodeColor("nimbusBlueGrey", -0.00505054f, -0.05960039f, 0.10196078f,
			0);
	private Color color10 = decodeColor("nimbusBlueGrey", -0.008547008f, -0.04772438f, 0.06666666f,
			0);
	private Color color11 = decodeColor("nimbusBlueGrey", -0.0027777553f, -0.0018306673f,
			-0.02352941f, 0);
	private Color color12 = decodeColor("nimbusBlueGrey", -0.0027777553f, -0.0212406f, 0.13333333f,
			0);
	private Color color13 = decodeColor("nimbusBlueGrey", 0.0055555105f, -0.030845039f, 0.23921567f,
			0);
	...
	private Path2D decodePath1() {
		...
		path.curveTo(decodeAnchorX(1.9893617630004883f, 3.0f),
				...
				decodeAnchorY(1.04347825050354f, -3.0f), decodeX(2.8857148f), decodeY(1.0434783f));
		path.lineTo(decodeX(2.9f), decodeY(1.9565217f));
		path.curveTo(decodeAnchorX(2.9000000953674316f, 0.0f),
				decodeAnchorY(1.95652174949646f, 3.0f), decodeAnchorX(1.9893617630004883f, 3.0f),
				decodeAnchorY(2.8714287281036377f, 0.0f), decodeX(1.9893618f), decodeY(2.8714287f));
		path.lineTo(decodeX(1.0106384f), decodeY(2.8714287f));
		path.curveTo(decodeAnchorX(1.0106383562088013f, -3.0f),
				decodeAnchorY(2.8714287281036377f, 0.0f), decodeAnchorX(0.12000000476837158f, 0.0f),
				decodeAnchorY(1.95652174949646f, 3.0f), decodeX(0.120000005f), decodeY(1.9565217f));
		path.lineTo(decodeX(0.120000005f), decodeY(1.0465839f));
		path.curveTo(decodeAnchorX(0.12000000476837158f, 0.0f),
				decodeAnchorY(1.046583890914917f, -3.000000000000001f),
		...
		path.curveTo(decodeAnchorX(1.0106383562088013f, -1.928571428571427f),
				...
				decodeAnchorY(1.040372610092163f, -2.429218094741624f), decodeX(0.47142857f),
				decodeY(1.0403726f));
		path.lineTo(decodeX(0.47142857f), decodeY(1.9565217f));
		path.curveTo(decodeAnchorX(0.4714285731315613f, 0.0f),
				decodeAnchorY(1.95652174949646f, 2.2142857142856975f),
				decodeAnchorX(1.0106383562088013f, -1.7857142857142847f),
				decodeAnchorY(2.5142855644226074f, 0.0f), decodeX(1.0106384f), decodeY(2.5142856f));
		path.lineTo(decodeX(1.9893618f), decodeY(2.5142856f));
		path.curveTo(decodeAnchorX(1.9893617630004883f, 2.071428571428598f),
				decodeAnchorY(2.5142855644226074f, 0.0f), decodeAnchorX(2.5f, 0.0f),
				decodeAnchorY(1.95652174949646f, 2.2142857142857046f), decodeX(2.5f),
				decodeY(1.9565217f));
		path.lineTo(decodeX(2.5142853f), decodeY(1.0434783f));
		path.curveTo(decodeAnchorX(2.5142853260040283f, 0.0f),
				decodeAnchorY(1.04347825050354f, -2.1428571428571406f),
	...
	private Paint decodeGradient3(Shape s) {
		...
		return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y,
				...
				new Color[] { color9, decodeColor(color9, color10, 0.5f), color10,
						...
						decodeColor(color11, color11, 0.5f), color11,
