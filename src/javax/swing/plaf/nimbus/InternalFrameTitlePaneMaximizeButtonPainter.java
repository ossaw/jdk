...
final class InternalFrameTitlePaneMaximizeButtonPainter extends AbstractRegionPainter {
    ...
    private Paint decodeGradient1(Shape s) {
        ...
        return decodeGradient((0.24868421f * w) + x, (0.0014705883f * h) + y, (0.24868421f * w) + x, (1.0f
                * h) + y, new float[] { 0.0f, 0.5f, 1.0f }, new Color[] { color1, decodeColor(color1, color2,
                        0.5f), color2 });
    }
    ...
    private Paint decodeGradient2(Shape s) {
        ...
        return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x, (1.0016667f * h) + y,
                new float[] { 0.0f, 0.5f, 1.0f }, new Color[] { color3, decodeColor(color3, color2, 0.5f),
                        color2 });
    }
    ...
    private Paint decodeGradient4(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.24868421f * w) + x, (0.0014705883f * h) + y, (0.24868421f * w) + x, (1.0f
                * h) + y, new float[] { 0.0f, 0.5f, 1.0f }, new Color[] { color14, decodeColor(color14,
    ...
    private Paint decodeGradient5(Shape s) {
        ...
        return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x, (1.0016667f * h) + y,
                ...
                new Color[] { color16, decodeColor(color16, color15, 0.5f), color15, decodeColor(color15,
                        color17, 0.5f), color17, decodeColor(color17, color18, 0.5f), color18 });
    }
    ...
    private Paint decodeGradient6(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.24868421f * w) + x, (0.0014705883f * h) + y, (0.24868421f * w) + x, (1.0f
                * h) + y, new float[] { 0.0f, 0.5f, 1.0f }, new Color[] { color22, decodeColor(color22,
    ...
    private Paint decodeGradient7(Shape s) {
        ...
        return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x, (1.0016667f * h) + y,
                new float[] { 0.0f, 0.26988637f, 0.53977275f, 0.5951705f, 0.6505682f, 0.8252841f, 1.0f },
                new Color[] { color24, decodeColor(color24, color25, 0.5f), color25, decodeColor(color25,
                        color26, 0.5f), color26, decodeColor(color26, color27, 0.5f), color27 });
    }
    ...
    private Paint decodeGradient8(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.24868421f * w) + x, (0.0014705883f * h) + y, (0.24868421f * w) + x, (1.0f
                * h) + y, new float[] { 0.0f, 0.5f, 1.0f }, new Color[] { color35, decodeColor(color35,
    ...
    private Paint decodeGradient9(Shape s) {
        ...
        return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x, (1.0016667f * h) + y,
                new float[] { 0.0f, 0.26988637f, 0.53977275f, 0.5951705f, 0.6505682f, 0.8252841f, 1.0f },
                new Color[] { color37, decodeColor(color37, color38, 0.5f), color38, decodeColor(color38,
                        color39, 0.5f), color39, decodeColor(color39, color18, 0.5f), color18 });
    }
    ...
    private Paint decodeGradient10(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.24868421f * w) + x, (0.0014705883f * h) + y, (0.24868421f * w) + x, (1.0f
                * h) + y, new float[] { 0.0f, 0.5f, 1.0f }, new Color[] { color48, decodeColor(color48,
    ...
    private Paint decodeGradient11(Shape s) {
        ...
        return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x, (1.0016667f * h) + y,
                ...
                new Color[] { color50, decodeColor(color50, color51, 0.5f), color51, decodeColor(color51,
                        color52, 0.5f), color52, decodeColor(color52, color53, 0.5f), color53 });
    }
    ...
    private Paint decodeGradient12(Shape s) {
        ...
        return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x, (1.0016667f * h) + y,
                ...
                new Color[] { color3, decodeColor(color3, color59, 0.5f), color59, decodeColor(color59,
                        color60, 0.5f), color60, decodeColor(color60, color2, 0.5f), color2 });
    }
    ...
    private Paint decodeGradient13(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.26047903f, 0.6302395f, 1.0f }, new Color[] { color62, decodeColor(color62, color63, 0.5f),
                        color63 });
    }
    ...
    private Paint decodeGradient14(Shape s) {
        ...
        return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x, (1.0016667f * h) + y,
                new float[] { 0.0f, 0.26988637f, 0.53977275f, 0.5951705f, 0.6505682f, 0.8252841f, 1.0f },
                new Color[] { color24, decodeColor(color24, color67, 0.5f), color67, decodeColor(color67,
                        color25, 0.5f), color25, decodeColor(color25, color27, 0.5f), color27 });
    }
    ...
    private Paint decodeGradient15(Shape s) {
        ...
        return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x, (1.0016667f * h) + y,
                ...
                new Color[] { color37, decodeColor(color37, color38, 0.5f), color38, decodeColor(color38,
                        color39, 0.5f), color39, decodeColor(color39, color70, 0.5f), color70 });
    }
    ...
    private Paint decodeGradient16(Shape s) {
        ...
        return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x, (1.0016667f * h) + y,
                ...
                new Color[] { color50, decodeColor(color50, color52, 0.5f), color52, decodeColor(color52,
                        color52, 0.5f), color52, decodeColor(color52, color53, 0.5f), color53 });
    }
