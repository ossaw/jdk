...
final class InternalFrameTitlePaneMaximizeButtonPainter extends AbstractRegionPainter {
	...
	private Color color10 = decodeColor("nimbusBlueGrey", 0.0055555105f, -0.062449392f, 0.07058823f,
			0);
	private Color color11 = decodeColor("nimbusBlueGrey", -0.008547008f, -0.04174325f,
			-0.0039215684f, -13);
	private Color color12 = decodeColor("nimbusBlueGrey", 0.0f, -0.049920253f, 0.031372547f, 0);
	private Color color13 = decodeColor("nimbusBlueGrey", 0.0055555105f, -0.0029994324f,
			-0.38039216f, -185);
	...
	private Color color19 = decodeColor("nimbusGreen", -0.0087068975f, -0.009330213f, -0.32156864f,
			0);
	...
	private Color color27 = decodeColor("nimbusGreen", 0.010559708f, 9.2053413E-4f, -0.011764705f,
			0);
	...
	private Color color62 = decodeColor("nimbusBlueGrey", -0.00505054f, -0.057128258f, 0.062745094f,
			0);
	private Color color63 = decodeColor("nimbusBlueGrey", -0.003968239f, -0.035257496f,
			-0.015686274f, 0);
	...
	private Color color66 = decodeColor("nimbusBlueGrey", 0.004830897f, -0.00920473f, 0.14509803f,
			-101);
	private Color color67 = decodeColor("nimbusGreen", 0.009564877f, 0.100521624f, -0.109803915f,
			0);
	private Color color68 = new Color(113, 125, 0, 255);
	private Color color69 = decodeColor("nimbusBlueGrey", 0.0025252104f, -0.0067527294f,
			0.086274505f, -65);
	...
	private Paint decodeGradient2(Shape s) {
		...
		return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x,
				(1.0016667f * h) + y, new float[] { 0.0f, 0.5f, 1.0f },
	...
	private Paint decodeGradient5(Shape s) {
		...
		return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x,
				...
				new float[] { 0.0f, 0.26988637f, 0.53977275f, 0.5951705f, 0.6505682f, 0.8252841f,
						1.0f },
				new Color[] { color16, decodeColor(color16, color15, 0.5f), color15,
						decodeColor(color15, color17, 0.5f), color17,
	...
	private Paint decodeGradient12(Shape s) {
		...
		return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x,
				(1.0016667f * h) + y,
				new float[] { 0.0f, 0.26988637f, 0.53977275f, 0.6082097f, 0.6766467f, 0.83832335f,
						1.0f },
				new Color[] { color3, decodeColor(color3, color59, 0.5f), color59,
						decodeColor(color59, color60, 0.5f), color60,
						decodeColor(color60, color2, 0.5f), color2 });
	}
	...
	private Paint decodeGradient14(Shape s) {
		...
		return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x,
				...
				new float[] { 0.0f, 0.26988637f, 0.53977275f, 0.5951705f, 0.6505682f, 0.8252841f,
						1.0f },
				new Color[] { color24, decodeColor(color24, color67, 0.5f), color67,
						decodeColor(color67, color25, 0.5f), color25,
	...
	private Paint decodeGradient15(Shape s) {
		...
		return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x,
				(1.0016667f * h) + y,
				new float[] { 0.0f, 0.26988637f, 0.53977275f, 0.66659296f, 0.79341316f, 0.8967066f,
						1.0f },
				new Color[] { color37, decodeColor(color37, color38, 0.5f), color38,
						decodeColor(color38, color39, 0.5f), color39,
						decodeColor(color39, color70, 0.5f), color70 });
	}
	...
	private Paint decodeGradient16(Shape s) {
		...
		return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x,
				(1.0016667f * h) + y,
				new float[] { 0.0f, 0.26988637f, 0.53977275f, 0.6291678f, 0.7185629f, 0.8592814f,
						1.0f },
				new Color[] { color50, decodeColor(color50, color52, 0.5f), color52,
						decodeColor(color52, color52, 0.5f), color52,
						decodeColor(color52, color53, 0.5f), color53 });
	}
