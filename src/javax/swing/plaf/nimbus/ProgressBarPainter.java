...
final class ProgressBarPainter extends AbstractRegionPainter {
    ...
    private Path2D decodePath1() {
        ...
        path.curveTo(decodeAnchorX(1.0f, -2.0f), decodeAnchorY(0.21111111342906952f, 0.0f), decodeAnchorX(
                0.21111111342906952f, 0.0f), decodeAnchorY(1.0f, -2.0f), decodeX(0.21111111f), decodeY(1.0f));
        path.curveTo(decodeAnchorX(0.21111111342906952f, 0.0f), decodeAnchorY(1.0f, 2.0f), decodeAnchorX(
                0.21111111342906952f, 0.0f), decodeAnchorY(2.0f, -2.0f), decodeX(0.21111111f), decodeY(2.0f));
        path.curveTo(decodeAnchorX(0.21111111342906952f, 0.0f), decodeAnchorY(2.0f, 2.0f), decodeAnchorX(1.0f,
                -2.0f), decodeAnchorY(2.8222224712371826f, 0.0f), decodeX(1.0f), decodeY(2.8222225f));
        path.curveTo(decodeAnchorX(1.0f, 2.0f), decodeAnchorY(2.8222224712371826f, 0.0f), decodeAnchorX(3.0f,
                0.0f), decodeAnchorY(2.8222224712371826f, 0.0f), decodeX(3.0f), decodeY(2.8222225f));
        ...
        path.curveTo(decodeAnchorX(3.0f, 0.0f), decodeAnchorY(0.20000000298023224f, 0.0f), decodeAnchorX(1.0f,
                2.0f), decodeAnchorY(0.21111111342906952f, 0.0f), decodeX(1.0f), decodeY(0.21111111f));
        path.closePath();
        return path;
    }
    ...
    private Path2D decodePath2() {
        ...
        path.curveTo(decodeAnchorX(0.9111111164093018f, -2.000000000000001f), decodeAnchorY(
                0.21111111342906952f, 0.0f), decodeAnchorX(0.20000000298023224f, 0.0f), decodeAnchorY(
                        1.0025640726089478f, -1.9999999999999998f), decodeX(0.2f), decodeY(1.0025641f));
        path.lineTo(decodeX(0.2f), decodeY(2.0444443f));
        path.curveTo(decodeAnchorX(0.20000000298023224f, 0.0f), decodeAnchorY(2.0444443225860596f, 2.0f),
                decodeAnchorX(0.9666666984558105f, -2.0f), decodeAnchorY(2.799999952316284f, 0.0f), decodeX(
                        0.9666667f), decodeY(2.8f));
        path.lineTo(decodeX(2.0f), decodeY(2.788889f));
        path.curveTo(decodeAnchorX(2.0f, 1.9709292441265305f), decodeAnchorY(2.788888931274414f,
                0.019857039365145823f), decodeAnchorX(2.777777910232544f, -0.03333333333333499f),
                decodeAnchorY(2.0555553436279297f, 1.9333333333333869f), decodeX(2.777778f), decodeY(
                        2.0555553f));
        ...
        path.curveTo(decodeAnchorX(2.777777910232544f, 0.0042173304174148996f), decodeAnchorY(
                1.0025640726089478f, -1.9503377583381705f), decodeAnchorX(2.0999996662139893f,
                        1.9659460194139413f), decodeAnchorY(0.2222222238779068f, 0.017122267221350018f),
    ...
    private Path2D decodePath3() {
        ...
        path.curveTo(decodeAnchorX(0.0f, 2.678571428571433f), decodeAnchorY(1.4285714626312256f,
                8.881784197001252E-16f), decodeAnchorX(1.389880895614624f, -6.214285714285715f),
                decodeAnchorY(0.3452380895614624f, -0.03571428571428292f), decodeX(1.3898809f), decodeY(
                        0.3452381f));
        path.lineTo(decodeX(1.5535715f), decodeY(0.3452381f));
        path.curveTo(decodeAnchorX(1.5535714626312256f, 8.329670329670357f), decodeAnchorY(
                0.3452380895614624f, 0.002747252747249629f), decodeAnchorX(2.3333332538604736f,
                        -5.2857142857142705f), decodeAnchorY(1.4285714626312256f, 0.03571428571428559f),
        ...
        path.curveTo(decodeAnchorX(2.3333332538604736f, -5.321428571428569f), decodeAnchorY(
                1.5714285373687744f, 0.0357142857142847f), decodeAnchorX(1.5535714626312256f,
                        8.983516483516496f), decodeAnchorY(2.6666667461395264f, 0.03846153846153122f),
                decodeX(1.5535715f), decodeY(2.6666667f));
        path.lineTo(decodeX(1.4077381f), decodeY(2.6666667f));
        path.curveTo(decodeAnchorX(1.4077380895614624f, -6.714285714285704f), decodeAnchorY(
                2.6666667461395264f, 0.0f), decodeAnchorX(0.0f, 2.6071428571428568f), decodeAnchorY(
                        1.5714285373687744f, 0.03571428571428559f), decodeX(0.0f), decodeY(1.5714285f));
    ...
    private Path2D decodePath4() {
        ...
        path.curveTo(decodeAnchorX(0.9888889193534851f, -1.9999999999999993f), decodeAnchorY(
                0.20000000298023224f, 0.0f), decodeAnchorX(0.20000000298023224f, 0.0f), decodeAnchorY(
                        0.9888889193534851f, -2.000000000000001f), decodeX(0.2f), decodeY(0.9888889f));
        path.curveTo(decodeAnchorX(0.20000000298023224f, 0.0f), decodeAnchorY(0.9888889193534851f,
                1.9999999999999991f), decodeAnchorX(0.20000000298023224f, 0.0f), decodeAnchorY(
                        1.9974358081817627f, -2.0000000000000053f), decodeX(0.2f), decodeY(1.9974358f));
        path.curveTo(decodeAnchorX(0.20000000298023224f, 0.0f), decodeAnchorY(1.9974358081817627f,
                2.000000000000007f), decodeAnchorX(0.9888889193534851f, -1.9999999999999993f), decodeAnchorY(
                        2.811110734939575f, 0.0f), decodeX(0.9888889f), decodeY(2.8111107f));
        path.curveTo(decodeAnchorX(0.9888889193534851f, 2.000000000000003f), decodeAnchorY(2.811110734939575f,
                0.0f), decodeAnchorX(2.5f, 0.0f), decodeAnchorY(2.799999952316284f, 0.0f), decodeX(2.5f),
                decodeY(2.8f));
        ...
        path.curveTo(decodeAnchorX(2.5999996662139893f, 0.0f), decodeAnchorY(0.2222222238779068f, 0.0f),
                decodeAnchorX(0.9888889193534851f, 2.000000000000003f), decodeAnchorY(0.20000000298023224f,
    ...
    private Path2D decodePath5() {
        ...
        path.moveTo(decodeX(0.0f), decodeY(1.4285715f));
        path.curveTo(decodeAnchorX(0.0f, 2.678571428571433f), decodeAnchorY(1.4285714626312256f,
                8.881784197001252E-16f), decodeAnchorX(1.389880895614624f, -6.357142857142872f),
                decodeAnchorY(0.3452380895614624f, -0.03571428571428337f), decodeX(1.3898809f), decodeY(
                        0.3452381f));
        path.lineTo(decodeX(1.5535715f), decodeY(0.3452381f));
        path.curveTo(decodeAnchorX(1.5535714626312256f, 3.9999999999999964f), decodeAnchorY(
                0.3452380895614624f, 0.0f), decodeAnchorX(2.3333332538604736f, -5.2857142857142705f),
                decodeAnchorY(1.4285714626312256f, 0.03571428571428559f), decodeX(2.3333333f), decodeY(
                        1.4285715f));
        path.lineTo(decodeX(3.0f), decodeY(1.4285715f));
        path.lineTo(decodeX(3.0f), decodeY(1.5714285f));
        path.lineTo(decodeX(2.3333333f), decodeY(1.5714285f));
        path.curveTo(decodeAnchorX(2.3333332538604736f, -5.321428571428569f), decodeAnchorY(
                1.5714285373687744f, 0.0357142857142847f), decodeAnchorX(1.5535714626312256f,
                        3.999999999999986f), decodeAnchorY(2.6666667461395264f, 0.0f), decodeX(1.5535715f),
                decodeY(2.6666667f));
        path.lineTo(decodeX(1.4077381f), decodeY(2.6666667f));
        path.curveTo(decodeAnchorX(1.4077380895614624f, -6.571428571428584f), decodeAnchorY(
                2.6666667461395264f, -0.035714285714286476f), decodeAnchorX(0.0f, 2.6071428571428568f),
                decodeAnchorY(1.5714285373687744f, 0.03571428571428559f), decodeX(0.0f), decodeY(1.5714285f));
        path.lineTo(decodeX(0.0f), decodeY(1.4285715f));
        path.closePath();
        return path;
    }
    ...
    private Paint decodeGradient2(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.038709678f, 0.05967742f, 0.08064516f, 0.23709677f, 0.3935484f, 0.41612905f, 0.43870968f,
                0.67419356f, 0.90967745f, 0.91451615f, 0.91935486f }, new Color[] { color3, decodeColor(
                        color3, color4, 0.5f), color4, decodeColor(color4, color5, 0.5f), color5, decodeColor(
                                color5, color6, 0.5f), color6, decodeColor(color6, color7, 0.5f), color7,
    ...
    private Paint decodeGradient3(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.05483871f, 0.5032258f, 0.9516129f }, new Color[] { color9, decodeColor(color9, color10,
                        0.5f), color10 });
    }
    ...
    private Paint decodeGradient4(Shape s) {
        ...
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.038709678f, 0.05967742f, 0.08064516f, 0.23709677f, 0.3935484f, 0.41612905f, 0.43870968f,
                0.67419356f, 0.90967745f, 0.91612905f, 0.92258066f }, new Color[] { color11, decodeColor(
                        color11, color12, 0.5f), color12, decodeColor(color12, color13, 0.5f), color13,
                        decodeColor(color13, color14, 0.5f), color14, decodeColor(color14, color15, 0.5f),
                        color15, decodeColor(color15, color16, 0.5f), color16 });
    }
    ...
    private Paint decodeGradient5(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.038709678f, 0.05483871f, 0.07096774f, 0.28064516f, 0.4903226f, 0.6967742f, 0.9032258f,
                0.9241935f, 0.9451613f }, new Color[] { color18, decodeColor(color18, color19, 0.5f), color19,
                        decodeColor(color19, color20, 0.5f), color20, decodeColor(color20, color21, 0.5f),
                        color21, decodeColor(color21, color22, 0.5f), color22 });
    }
    ...
    private Paint decodeGradient6(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.038709678f, 0.061290324f, 0.08387097f, 0.27258065f, 0.46129033f, 0.4903226f, 0.5193548f,
                0.71774197f, 0.91612905f, 0.92419356f, 0.93225807f }, new Color[] { color23, decodeColor(
                        color23, color24, 0.5f), color24, decodeColor(color24, color25, 0.5f), color25,
                        decodeColor(color25, color26, 0.5f), color26, decodeColor(color26, color27, 0.5f),
                        color27, decodeColor(color27, color28, 0.5f), color28 });
    }
    ...
    private Paint decodeGradient7(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.051612902f, 0.06612903f, 0.08064516f, 0.2935484f, 0.5064516f, 0.6903226f, 0.87419355f,
                0.88870966f, 0.9032258f }, new Color[] { color3, decodeColor(color3, color4, 0.5f), color4,
                        decodeColor(color4, color29, 0.5f), color29, decodeColor(color29, color7, 0.5f),
    ...
    private Paint decodeGradient8(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.20645161f, 0.41290322f, 0.44193548f, 0.47096774f, 0.7354839f, 1.0f }, new Color[] {
                        color24, decodeColor(color24, color25, 0.5f), color25, decodeColor(color25, color26,
                                0.5f), color26, decodeColor(color26, color30, 0.5f), color30 });
    }
    ...
    private Paint decodeGradient9(Shape s) {
        ...
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.038709678f, 0.05483871f, 0.07096774f, 0.28064516f, 0.4903226f, 0.6967742f, 0.9032258f,
                0.9241935f, 0.9451613f }, new Color[] { color34, decodeColor(color34, color35, 0.5f), color35,
                        decodeColor(color35, color36, 0.5f), color36, decodeColor(color36, color37, 0.5f),
                        color37, decodeColor(color37, color38, 0.5f), color38 });
    }
    ...
    private Paint decodeGradient10(Shape s) {
        ...
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.038709678f, 0.061290324f, 0.08387097f, 0.27258065f, 0.46129033f, 0.4903226f, 0.5193548f,
                0.71774197f, 0.91612905f, 0.92419356f, 0.93225807f }, new Color[] { color39, decodeColor(
                        color39, color40, 0.5f), color40, decodeColor(color40, color41, 0.5f), color41,
                        decodeColor(color41, color42, 0.5f), color42, decodeColor(color42, color43, 0.5f),
                        color43, decodeColor(color43, color44, 0.5f), color44 });
    }
    ...
    private Paint decodeGradient11(Shape s) {
        ...
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.051612902f, 0.06612903f, 0.08064516f, 0.2935484f, 0.5064516f, 0.6903226f, 0.87419355f,
                0.88870966f, 0.9032258f }, new Color[] { color45, decodeColor(color45, color46, 0.5f),
                        color46, decodeColor(color46, color47, 0.5f), color47, decodeColor(color47, color48,
                                0.5f), color48, decodeColor(color48, color49, 0.5f), color49 });
    }
    ...
    private Paint decodeGradient12(Shape s) {
        ...
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.20645161f, 0.41290322f, 0.44193548f, 0.47096774f, 0.7354839f, 1.0f }, new Color[] {
                        color40, decodeColor(color40, color41, 0.5f), color41, decodeColor(color41, color42,
                                0.5f), color42, decodeColor(color42, color50, 0.5f), color50 });
    }
