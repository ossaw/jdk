...
final class CheckBoxPainter extends AbstractRegionPainter {
	...
	private Color color23 = decodeColor("nimbusBase", 5.1498413E-4f, -0.34585923f, -0.007843137f,
			0);
	...
	private Color color33 = decodeColor("nimbusBase", -0.006362498f, -0.016311288f, -0.02352941f,
			0);
	...
	private Color color40 = decodeColor("nimbusBlueGrey", -0.01111114f, -0.03771078f, 0.062745094f,
			0);
	private Color color41 = decodeColor("nimbusBlueGrey", -0.02222222f, -0.032806106f, 0.011764705f,
			0);
	...
	private Paint decodeGradient1(Shape s) {
		...
		return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25210086f * w) + x,
				(0.9957983f * h) + y, new float[] { 0.0f, 0.5f, 1.0f },
	...
	private Paint decodeGradient11(Shape s) {
		...
		return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25210086f * w) + x,
				(0.9957983f * h) + y, new float[] { 0.0f, 0.5f, 1.0f },
				new Color[] { color28, decodeColor(color28, color30, 0.5f), color30 });
	}
	...
	private Paint decodeGradient12(Shape s) {
		...
		float h = (float) bounds.getHeight();
		return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25f * w) + x, (0.997549f * h) + y,
				new float[] { 0.0f, 0.05775076f, 0.11550152f, 0.38003993f, 0.64457834f, 0.82228917f,
						1.0f },
	...
	private Paint decodeGradient16(Shape s) {
		...
		return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25f * w) + x, (0.997549f * h) + y,
				new float[] { 0.0f, 0.32228917f, 0.64457834f, 0.82228917f, 1.0f },
				new Color[] { color42, decodeColor(color42, color43, 0.5f), color43,
