...
final class InternalFrameTitlePaneCloseButtonPainter extends AbstractRegionPainter {
	...
	private Color color4 = decodeColor("nimbusBlueGrey", 0.0055555105f, -0.062449392f, 0.07058823f,
			0);
	private Color color5 = decodeColor("nimbusBlueGrey", 0.0055555105f, -0.0029994324f,
			-0.38039216f, -185);
	...
	private Color color12 = decodeColor("nimbusRed", 0.0056530247f, 0.0040003657f, -0.38431373f,
			-122);
	...
	private Color color20 = decodeColor("nimbusRed", -0.014814814f, 0.20118344f, 0.0039215684f,
			-122);
	...
	private Color color28 = decodeColor("nimbusRed", -0.014814814f, 0.20118344f, -0.31764707f,
			-122);
	...
	private Paint decodeGradient9(Shape s) {
		...
		return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.25441176f * w) + x,
				(1.0016667f * h) + y,
				new float[] { 0.0f, 0.24101797f, 0.48203593f, 0.5838324f, 0.6856288f, 0.8428144f,
						1.0f },
				new Color[] { color31, decodeColor(color31, color32, 0.5f), color32,
						decodeColor(color32, color32, 0.5f), color32,
