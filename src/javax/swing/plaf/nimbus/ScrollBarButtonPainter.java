...
final class ScrollBarButtonPainter extends AbstractRegionPainter {
    ...
    private Path2D decodePath2() {
        ...
        path.curveTo(decodeAnchorX(1.6956522464752197f, 0.0f), decodeAnchorY(0.0f, 0.0f), decodeAnchorX(
                1.6956522464752197f, -0.7058823529411633f), decodeAnchorY(1.307692289352417f,
                        -3.0294117647058822f), decodeX(1.6956522f), decodeY(1.3076923f));
        path.curveTo(decodeAnchorX(1.6956522464752197f, 0.7058823529411633f), decodeAnchorY(
                1.307692289352417f, 3.0294117647058822f), decodeAnchorX(1.8260869979858398f, -2.0f),
                decodeAnchorY(1.769230842590332f, -1.9411764705882355f), decodeX(1.826087f), decodeY(
                        1.7692308f));
        path.curveTo(decodeAnchorX(1.8260869979858398f, 2.0f), decodeAnchorY(1.769230842590332f,
                1.9411764705882355f), decodeAnchorX(3.0f, 0.0f), decodeAnchorY(2.0f, 0.0f), decodeX(3.0f),
                decodeY(2.0f));
        path.lineTo(decodeX(3.0f), decodeY(3.0f));
    ...
    private Path2D decodePath5() {
        ...
        path.curveTo(decodeAnchorX(1.6713554859161377f, 0.7352941176470615f), decodeAnchorY(
                1.076923131942749f, 0.0f), decodeAnchorX(1.718670129776001f, -0.911764705882355f),
                decodeAnchorY(1.4095022678375244f, -2.2058823529411784f), decodeX(1.7186701f), decodeY(
                        1.4095023f));
        path.curveTo(decodeAnchorX(1.718670129776001f, 0.911764705882355f), decodeAnchorY(1.4095022678375244f,
                2.2058823529411784f), decodeAnchorX(1.8439897298812866f, -2.3529411764705905f), decodeAnchorY(
                        1.7941176891326904f, -1.852941176470587f), decodeX(1.8439897f), decodeY(1.7941177f));
        path.curveTo(decodeAnchorX(1.8439897298812866f, 2.3529411764705905f), decodeAnchorY(
                1.7941176891326904f, 1.852941176470587f), decodeAnchorX(2.5f, 0.0f), decodeAnchorY(
                        2.2352943420410156f, 0.0f), decodeX(2.5f), decodeY(2.2352943f));
        path.lineTo(decodeX(2.3529415f), decodeY(2.8235292f));
        path.curveTo(decodeAnchorX(2.3529415130615234f, 0.0f), decodeAnchorY(2.8235292434692383f, 0.0f),
                decodeAnchorX(1.818414330482483f, 1.5588235294117645f), decodeAnchorY(1.8438913822174072f,
                        1.3823529411764675f), decodeX(1.8184143f), decodeY(1.8438914f));
        path.curveTo(decodeAnchorX(1.818414330482483f, -1.5588235294117645f), decodeAnchorY(
                1.8438913822174072f, -1.3823529411764675f), decodeAnchorX(1.694373369216919f,
                        0.7941176470588225f), decodeAnchorY(1.4841628074645996f, 1.9999999999999991f),
                decodeX(1.6943734f), decodeY(1.4841628f));
        path.curveTo(decodeAnchorX(1.694373369216919f, -0.7941176470588225f), decodeAnchorY(
                1.4841628074645996f, -1.9999999999999991f), decodeAnchorX(1.6713554859161377f,
                        -0.7352941176470598f), decodeAnchorY(1.076923131942749f, 0.0f), decodeX(1.6713555f),
                decodeY(1.0769231f));
        path.closePath();
        return path;
    }
    ...
    private Paint decodeGradient1(Shape s) {
        ...
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.032934133f, 0.065868266f, 0.089820355f, 0.11377245f, 0.23053892f, 0.3473054f,
                0.494012f, 0.6407186f, 0.78443116f, 0.92814374f }, new Color[] { color2, decodeColor(color2,
                        color3, 0.5f), color3, decodeColor(color3, color4, 0.5f), color4, decodeColor(color4,
                                color5, 0.5f), color5, decodeColor(color5, color6, 0.5f), color6, decodeColor(
    ...
    private Paint decodeGradient2(Shape s) {
        ...
        return decodeGradient((0.0f * w) + x, (0.5f * h) + y, (0.5735294f * w) + x, (0.5f * h) + y,
                new float[] { 0.0f, 0.5f, 1.0f }, new Color[] { color8, decodeColor(color8, color9, 0.5f),
                        color9 });
    }
    ...
    private Paint decodeGradient3(Shape s) {
        ...
        float w = (float) bounds.getWidth();
        float h = (float) bounds.getHeight();
        return decodeGradient((0.925f * w) + x, (0.9285714f * h) + y, (0.925f * w) + x, (0.004201681f * h)
                + y, new float[] { 0.0f, 0.2964072f, 0.5928144f, 0.79341316f, 0.994012f }, new Color[] {
                        color10, decodeColor(color10, color11, 0.5f), color11, decodeColor(color11, color12,
                                0.5f), color12 });
    }
    ...
    private Paint decodeGradient4(Shape s) {
        ...
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.032934133f, 0.065868266f, 0.089820355f, 0.11377245f, 0.23053892f, 0.3473054f,
                0.494012f, 0.6407186f, 0.78443116f, 0.92814374f }, new Color[] { color14, decodeColor(color14,
                        color15, 0.5f), color15, decodeColor(color15, color16, 0.5f), color16, decodeColor(
                                color16, color17, 0.5f), color17, decodeColor(color17, color18, 0.5f),
                        color18, decodeColor(color18, color16, 0.5f), color16 });
    }
    ...
    private Paint decodeGradient5(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.0f * w) + x, (0.5f * h) + y, (0.5735294f * w) + x, (0.5f * h) + y,
                new float[] { 0.19518717f, 0.5975936f, 1.0f }, new Color[] { color19, decodeColor(color19,
    ...
    private Paint decodeGradient6(Shape s) {
        ...
        return decodeGradient((0.925f * w) + x, (0.9285714f * h) + y, (0.925f * w) + x, (0.004201681f * h)
                + y, new float[] { 0.0f, 0.2964072f, 0.5928144f, 0.79341316f, 0.994012f }, new Color[] {
                        color21, decodeColor(color21, color22, 0.5f), color22, decodeColor(color22, color23,
                                0.5f), color23 });
    }
    ...
    private Paint decodeGradient7(Shape s) {
        ...
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] {
                0.0f, 0.032934133f, 0.065868266f, 0.089820355f, 0.11377245f, 0.23053892f, 0.3473054f,
                0.494012f, 0.6407186f, 0.78443116f, 0.92814374f }, new Color[] { color24, decodeColor(color24,
                        color25, 0.5f), color25, decodeColor(color25, color26, 0.5f), color26, decodeColor(
                                color26, color27, 0.5f), color27, decodeColor(color27, color28, 0.5f),
    ...
    private Paint decodeGradient8(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return decodeGradient((0.0f * w) + x, (0.5f * h) + y, (0.5735294f * w) + x, (0.5f * h) + y,
                new float[] { 0.0f, 0.5f, 1.0f }, new Color[] { color30, decodeColor(color30, color9, 0.5f),
                        color9 });
    }
