...
public abstract class ListUI extends ComponentUI {
	 ...
	 * given location in the list's coordinate system. To determine if the cell
	 * actually contains the specified location, compare the point against the
	 * cell's bounds, as provided by {@code getCellBounds}. This method returns
	...
	/**
	 * Returns the origin in the given {@code JList}, of the specified item, in
	 * the list's coordinate system. Returns {@code null} if the index isn't
	 * valid.
	 *
	 * @param list
	 *              the list
	 ...
	 * for the range of cells specified by the two indices. The indices can be
