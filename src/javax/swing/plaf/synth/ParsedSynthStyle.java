...
class ParsedSynthStyle extends DefaultSynthStyle {
	...
	private SynthPainter getBestPainter(SynthContext context, String method, int direction) {
		...
		if (info != null) {
			if ((painter = getBestPainter(info.getPainters(), method, direction)) != null) {
				return painter;
			}
		}
	...
	static class PainterInfo {
		...
		public String toString() {
			return "PainterInfo {method=" + _method + ",direction=" + _direction + ",painter="
					+ _painter + "}";
		}
	}
	...
	private static class AggregatePainter extends SynthPainter {
		...
		public void paintArrowButtonBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
		...
		public void paintArrowButtonBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintArrowButtonForeground(SynthContext context, Graphics g, int x, int y,
		...
		public void paintButtonBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintButtonBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintCheckBoxMenuItemBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintCheckBoxMenuItemBorder(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintCheckBoxBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintCheckBoxBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintColorChooserBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintColorChooserBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintComboBoxBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintComboBoxBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintDesktopIconBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintDesktopIconBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintDesktopPaneBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintDesktopPaneBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintEditorPaneBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintEditorPaneBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintFileChooserBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintFileChooserBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintFormattedTextFieldBackground(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintFormattedTextFieldBorder(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintInternalFrameTitlePaneBackground(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintInternalFrameTitlePaneBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintInternalFrameBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintInternalFrameBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintLabelBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintListBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintMenuBarBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintMenuBarBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintMenuItemBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintMenuItemBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintMenuBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintOptionPaneBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintOptionPaneBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintPanelBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintPasswordFieldBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintPasswordFieldBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintPopupMenuBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintPopupMenuBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintProgressBarBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintProgressBarBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintProgressBarForeground(SynthContext context, Graphics g, int x, int y,
				int w, int h, int orientation) {
			for (SynthPainter painter : painters) {
		...
		public void paintRadioButtonMenuItemBackground(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintRadioButtonMenuItemBorder(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintRadioButtonBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintRadioButtonBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintRootPaneBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintRootPaneBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintScrollBarBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintScrollBarBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintScrollBarThumbBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h, int orientation) {
			for (SynthPainter painter : painters) {
		...
		public void paintScrollBarThumbBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h, int orientation) {
			for (SynthPainter painter : painters) {
		...
		public void paintScrollBarTrackBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintScrollBarTrackBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintScrollPaneBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintScrollPaneBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintSeparatorBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintSeparatorBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintSeparatorForeground(SynthContext context, Graphics g, int x, int y, int w,
				int h, int orientation) {
			for (SynthPainter painter : painters) {
		...
		public void paintSliderBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintSliderBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintSliderThumbBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h, int orientation) {
			for (SynthPainter painter : painters) {
		...
		public void paintSliderThumbBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h, int orientation) {
			for (SynthPainter painter : painters) {
		...
		public void paintSliderTrackBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintSliderTrackBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintSpinnerBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintSpinnerBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintSplitPaneDividerBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintSplitPaneDividerForeground(SynthContext context, Graphics g, int x, int y,
				int w, int h, int orientation) {
			for (SynthPainter painter : painters) {
		...
		public void paintSplitPaneDragDivider(SynthContext context, Graphics g, int x, int y, int w,
				int h, int orientation) {
			for (SynthPainter painter : painters) {
		...
		public void paintSplitPaneBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintSplitPaneBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTabbedPaneBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTabbedPaneBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTabbedPaneTabAreaBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTabbedPaneTabAreaBorder(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTabbedPaneTabBackground(SynthContext context, Graphics g, int x, int y,
		...
		public void paintTabbedPaneTabBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h, int tabIndex, int orientation) {
			for (SynthPainter painter : painters) {
				painter.paintTabbedPaneTabBackground(context, g, x, y, w, h, tabIndex, orientation);
			}
		}

		public void paintTabbedPaneTabBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h, int tabIndex) {
			for (SynthPainter painter : painters) {
		...
		public void paintTabbedPaneTabBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h, int tabIndex, int orientation) {
			for (SynthPainter painter : painters) {
				painter.paintTabbedPaneTabBorder(context, g, x, y, w, h, tabIndex, orientation);
			}
		}

		public void paintTabbedPaneContentBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTabbedPaneContentBorder(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTableHeaderBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTableHeaderBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTableBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTextAreaBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTextAreaBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTextPaneBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTextPaneBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTextFieldBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTextFieldBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintToggleButtonBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintToggleButtonBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintToolBarBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintToolBarBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintToolBarContentBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintToolBarContentBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintToolBarDragWindowBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintToolBarDragWindowBorder(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintToolTipBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintToolTipBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTreeBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTreeCellBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTreeCellBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintTreeCellFocus(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintViewportBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintViewportBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			for (SynthPainter painter : painters) {
	...
	private static class DelegatingPainter extends SynthPainter {
		private static SynthPainter getPainter(SynthContext context, String method, int direction) {
			return ((ParsedSynthStyle) context.getStyle()).getBestPainter(context, method,
					direction);
		}

		public void paintArrowButtonBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			getPainter(context, "arrowbuttonbackground", -1).paintArrowButtonBackground(context, g,
					x, y, w, h);
		}

		public void paintArrowButtonBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "arrowbuttonborder", -1).paintArrowButtonBorder(context, g, x, y, w,
					h);
		}
		...
		public void paintButtonBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "buttonbackground", -1).paintButtonBackground(context, g, x, y, w,
					h);
		}
		...
		public void paintCheckBoxMenuItemBorder(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			getPainter(context, "checkboxmenuitemborder", -1).paintCheckBoxMenuItemBorder(context,
					g, x, y, w, h);
		}

		public void paintCheckBoxBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "checkboxbackground", -1).paintCheckBoxBackground(context, g, x, y,
					w, h);
		}
		...
		public void paintColorChooserBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			getPainter(context, "colorchooserbackground", -1).paintColorChooserBackground(context,
					g, x, y, w, h);
		}

		public void paintColorChooserBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "colorchooserborder", -1).paintColorChooserBorder(context, g, x, y,
					w, h);
		}

		public void paintComboBoxBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "comboboxbackground", -1).paintComboBoxBackground(context, g, x, y,
					w, h);
		}
		...
		public void paintDesktopIconBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			getPainter(context, "desktopiconbackground", -1).paintDesktopIconBackground(context, g,
					x, y, w, h);
		}

		public void paintDesktopIconBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "desktopiconborder", -1).paintDesktopIconBorder(context, g, x, y, w,
					h);
		}

		public void paintDesktopPaneBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			getPainter(context, "desktoppanebackground", -1).paintDesktopPaneBackground(context, g,
					x, y, w, h);
		}

		public void paintDesktopPaneBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "desktoppaneborder", -1).paintDesktopPaneBorder(context, g, x, y, w,
					h);
		}

		public void paintEditorPaneBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "editorpanebackground", -1).paintEditorPaneBackground(context, g, x,
					y, w, h);
		}

		public void paintEditorPaneBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "editorpaneborder", -1).paintEditorPaneBorder(context, g, x, y, w,
					h);
		}

		public void paintFileChooserBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			getPainter(context, "filechooserbackground", -1).paintFileChooserBackground(context, g,
					x, y, w, h);
		}

		public void paintFileChooserBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "filechooserborder", -1).paintFileChooserBorder(context, g, x, y, w,
					h);
		}
		...
		public void paintInternalFrameBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			getPainter(context, "internalframebackground", -1).paintInternalFrameBackground(context,
					g, x, y, w, h);
		}

		public void paintInternalFrameBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "internalframeborder", -1).paintInternalFrameBorder(context, g, x,
					y, w, h);
		}
		...
		public void paintMenuBarBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "menubarbackground", -1).paintMenuBarBackground(context, g, x, y, w,
					h);
		}
		...
		public void paintMenuItemBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "menuitembackground", -1).paintMenuItemBackground(context, g, x, y,
					w, h);
		}
		...
		public void paintOptionPaneBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "optionpanebackground", -1).paintOptionPaneBackground(context, g, x,
					y, w, h);
		}

		public void paintOptionPaneBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "optionpaneborder", -1).paintOptionPaneBorder(context, g, x, y, w,
					h);
		}
		...
		public void paintPasswordFieldBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			getPainter(context, "passwordfieldbackground", -1).paintPasswordFieldBackground(context,
					g, x, y, w, h);
		}

		public void paintPasswordFieldBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "passwordfieldborder", -1).paintPasswordFieldBorder(context, g, x,
					y, w, h);
		}

		public void paintPopupMenuBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "popupmenubackground", -1).paintPopupMenuBackground(context, g, x,
					y, w, h);
		}
		...
		public void paintProgressBarBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			getPainter(context, "progressbarbackground", -1).paintProgressBarBackground(context, g,
					x, y, w, h);
		}
		...
		public void paintProgressBarBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "progressbarborder", -1).paintProgressBarBorder(context, g, x, y, w,
					h);
		}

		public void paintProgressBarBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h, int direction) {
			getPainter(context, "progressbarborder", direction).paintProgressBarBorder(context, g,
					x, y, w, h, direction);
		}
		...
		public void paintRadioButtonBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			getPainter(context, "radiobuttonbackground", -1).paintRadioButtonBackground(context, g,
					x, y, w, h);
		}

		public void paintRadioButtonBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "radiobuttonborder", -1).paintRadioButtonBorder(context, g, x, y, w,
					h);
		}

		public void paintRootPaneBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "rootpanebackground", -1).paintRootPaneBackground(context, g, x, y,
					w, h);
		}
		...
		public void paintScrollBarBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "scrollbarbackground", -1).paintScrollBarBackground(context, g, x,
					y, w, h);
		}

		public void paintScrollBarBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h, int direction) {
			getPainter(context, "scrollbarbackground", direction).paintScrollBarBackground(context,
					g, x, y, w, h, direction);
		}
		...
		public void paintScrollBarBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h, int orientation) {
			getPainter(context, "scrollbarborder", orientation).paintScrollBarBorder(context, g, x,
					y, w, h, orientation);
		}
		...
		public void paintScrollBarTrackBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "scrollbartrackborder", -1).paintScrollBarTrackBorder(context, g, x,
					y, w, h);
		}
		...
		public void paintScrollPaneBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "scrollpanebackground", -1).paintScrollPaneBackground(context, g, x,
					y, w, h);
		}

		public void paintScrollPaneBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "scrollpaneborder", -1).paintScrollPaneBorder(context, g, x, y, w,
					h);
		}

		public void paintSeparatorBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "separatorbackground", -1).paintSeparatorBackground(context, g, x,
					y, w, h);
		}
		...
		public void paintSeparatorBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h, int orientation) {
			getPainter(context, "separatorborder", orientation).paintSeparatorBorder(context, g, x,
					y, w, h, orientation);
		}

		public void paintSeparatorForeground(SynthContext context, Graphics g, int x, int y, int w,
				int h, int direction) {
			getPainter(context, "separatorforeground", direction).paintSeparatorForeground(context,
					g, x, y, w, h, direction);
		}

		public void paintSliderBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "sliderbackground", -1).paintSliderBackground(context, g, x, y, w,
					h);
		}

		public void paintSliderBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h, int direction) {
			getPainter(context, "sliderbackground", direction).paintSliderBackground(context, g, x,
					y, w, h, direction);
		}
		...
		public void paintSliderBorder(SynthContext context, Graphics g, int x, int y, int w, int h,
				int direction) {
			getPainter(context, "sliderborder", direction).paintSliderBorder(context, g, x, y, w, h,
					direction);
		}
		...
		public void paintSliderThumbBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h, int direction) {
			getPainter(context, "sliderthumbborder", direction).paintSliderThumbBorder(context, g,
					x, y, w, h, direction);
		}

		public void paintSliderTrackBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			getPainter(context, "slidertrackbackground", -1).paintSliderTrackBackground(context, g,
					x, y, w, h);
		}
		...
		public void paintSliderTrackBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "slidertrackborder", -1).paintSliderTrackBorder(context, g, x, y, w,
					h);
		}

		public void paintSliderTrackBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h, int direction) {
			getPainter(context, "slidertrackborder", direction).paintSliderTrackBorder(context, g,
					x, y, w, h, direction);
		}

		public void paintSpinnerBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "spinnerbackground", -1).paintSpinnerBackground(context, g, x, y, w,
					h);
		}
		...
		public void paintSplitPaneBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "splitpanebackground", -1).paintSplitPaneBackground(context, g, x,
					y, w, h);
		}
		...
		public void paintTabbedPaneBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "tabbedpanebackground", -1).paintTabbedPaneBackground(context, g, x,
					y, w, h);
		}

		public void paintTabbedPaneBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "tabbedpaneborder", -1).paintTabbedPaneBorder(context, g, x, y, w,
					h);
		}
		...
		public void paintTabbedPaneTabAreaBackground(SynthContext context, Graphics g, int x, int y,
			...
			getPainter(context, "tabbedpanetabareabackground", orientation)
					.paintTabbedPaneTabAreaBackground(context, g, x, y, w, h, orientation);
		}

		public void paintTabbedPaneTabAreaBorder(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			getPainter(context, "tabbedpanetabareaborder", -1).paintTabbedPaneTabAreaBorder(context,
					g, x, y, w, h);
		}
		...
		public void paintTabbedPaneTabAreaBorder(SynthContext context, Graphics g, int x, int y,
			...
			getPainter(context, "tabbedpanetabareaborder", orientation)
					.paintTabbedPaneTabAreaBorder(context, g, x, y, w, h, orientation);
		}

		public void paintTabbedPaneTabBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h, int direction) {
			getPainter(context, "tabbedpanetabbackground", -1).paintTabbedPaneTabBackground(context,
					g, x, y, w, h, direction);
		}

		public void paintTabbedPaneTabBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h, int tabIndex, int direction) {
			getPainter(context, "tabbedpanetabbackground", direction)
					.paintTabbedPaneTabBackground(context, g, x, y, w, h, tabIndex, direction);
		}

		public void paintTabbedPaneTabBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h, int direction) {
			getPainter(context, "tabbedpanetabborder", -1).paintTabbedPaneTabBorder(context, g, x,
					y, w, h, direction);
		}

		public void paintTabbedPaneTabBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h, int tabIndex, int direction) {
			getPainter(context, "tabbedpanetabborder", direction).paintTabbedPaneTabBorder(context,
					g, x, y, w, h, tabIndex, direction);
		}
		...
		public void paintTabbedPaneContentBorder(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			getPainter(context, "tabbedpanecontentborder", -1).paintTabbedPaneContentBorder(context,
					g, x, y, w, h);
		}

		public void paintTableHeaderBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			getPainter(context, "tableheaderbackground", -1).paintTableHeaderBackground(context, g,
					x, y, w, h);
		}

		public void paintTableHeaderBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "tableheaderborder", -1).paintTableHeaderBorder(context, g, x, y, w,
					h);
		}
		...
		public void paintTextAreaBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "textareabackground", -1).paintTextAreaBackground(context, g, x, y,
					w, h);
		}
		...
		public void paintTextPaneBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "textpanebackground", -1).paintTextPaneBackground(context, g, x, y,
					w, h);
		}
		...
		public void paintTextFieldBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "textfieldbackground", -1).paintTextFieldBackground(context, g, x,
					y, w, h);
		}
		...
		public void paintToggleButtonBackground(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			getPainter(context, "togglebuttonbackground", -1).paintToggleButtonBackground(context,
					g, x, y, w, h);
		}

		public void paintToggleButtonBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "togglebuttonborder", -1).paintToggleButtonBorder(context, g, x, y,
					w, h);
		}

		public void paintToolBarBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "toolbarbackground", -1).paintToolBarBackground(context, g, x, y, w,
					h);
		}

		public void paintToolBarBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h, int orientation) {
			getPainter(context, "toolbarbackground", orientation).paintToolBarBackground(context, g,
					x, y, w, h, orientation);
		}
		...
		public void paintToolBarBorder(SynthContext context, Graphics g, int x, int y, int w, int h,
				int orientation) {
			getPainter(context, "toolbarborder", orientation).paintToolBarBorder(context, g, x, y,
					w, h, orientation);
		}
		...
		public void paintToolBarContentBorder(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "toolbarcontentborder", -1).paintToolBarContentBorder(context, g, x,
					y, w, h);
		}
		...
		public void paintToolBarDragWindowBorder(SynthContext context, Graphics g, int x, int y,
				int w, int h) {
			getPainter(context, "toolbardragwindowborder", -1).paintToolBarDragWindowBorder(context,
					g, x, y, w, h);
		}
		...
		public void paintToolTipBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "tooltipbackground", -1).paintToolTipBackground(context, g, x, y, w,
					h);
		}
		...
		public void paintTreeCellBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "treecellbackground", -1).paintTreeCellBackground(context, g, x, y,
					w, h);
		}
		...
		public void paintViewportBackground(SynthContext context, Graphics g, int x, int y, int w,
				int h) {
			getPainter(context, "viewportbackground", -1).paintViewportBackground(context, g, x, y,
					w, h);
		}
