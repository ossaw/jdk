...
class ParsedSynthStyle extends DefaultSynthStyle {
	...
	private static PainterInfo[] mergePainterInfo(PainterInfo[] old,
		...
		for (int newCounter = 0; newCounter < newLength; newCounter++) {
			boolean found = false;
			for (int oldCounter = 0; oldCounter < oldLength
					- dups; oldCounter++) {
	...
	static class PainterInfo {
		...
		public String toString() {
			return "PainterInfo {method=" + _method + ",direction=" + _direction
					+ ",painter=" + _painter + "}";
		}
	}
	...
	private static class AggregatePainter extends SynthPainter {
		...
		public void paintArrowButtonForeground(SynthContext context, Graphics g,
			...
			for (SynthPainter painter : painters) {
				painter.paintArrowButtonForeground(context, g, x, y, w, h,
						direction);
			}
		}
		...
		public void paintFormattedTextFieldBackground(SynthContext context,
				Graphics g, int x, int y, int w, int h) {
			for (SynthPainter painter : painters) {
				painter.paintFormattedTextFieldBackground(context, g, x, y, w,
						h);
			}
		}
		...
		public void paintInternalFrameTitlePaneBackground(SynthContext context,
				Graphics g, int x, int y, int w, int h) {
			for (SynthPainter painter : painters) {
				painter.paintInternalFrameTitlePaneBackground(context, g, x, y,
						w, h);
			}
		}
		...
		public void paintInternalFrameTitlePaneBorder(SynthContext context,
				Graphics g, int x, int y, int w, int h) {
			for (SynthPainter painter : painters) {
				painter.paintInternalFrameTitlePaneBorder(context, g, x, y, w,
						h);
			}
		}
		...
		public void paintListBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintMenuBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			for (SynthPainter painter : painters) {
		...
		public void paintProgressBarForeground(SynthContext context, Graphics g,
				int x, int y, int w, int h, int orientation) {
			for (SynthPainter painter : painters) {
				painter.paintProgressBarForeground(context, g, x, y, w, h,
						orientation);
			}
		}
		...
		public void paintRadioButtonMenuItemBackground(SynthContext context,
				Graphics g, int x, int y, int w, int h) {
			for (SynthPainter painter : painters) {
				painter.paintRadioButtonMenuItemBackground(context, g, x, y, w,
						h);
			}
		}
		...
		public void paintSeparatorForeground(SynthContext context, Graphics g,
				int x, int y, int w, int h, int orientation) {
			for (SynthPainter painter : painters) {
				painter.paintSeparatorForeground(context, g, x, y, w, h,
						orientation);
			}
		}
		...
		public void paintSliderThumbBackground(SynthContext context, Graphics g,
				int x, int y, int w, int h, int orientation) {
			for (SynthPainter painter : painters) {
				painter.paintSliderThumbBackground(context, g, x, y, w, h,
						orientation);
			}
		}
		...
		public void paintSliderThumbBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h, int orientation) {
			for (SynthPainter painter : painters) {
				painter.paintSliderThumbBorder(context, g, x, y, w, h,
						orientation);
			}
		}
		...
		public void paintSplitPaneDividerForeground(SynthContext context,
				Graphics g, int x, int y, int w, int h, int orientation) {
			for (SynthPainter painter : painters) {
				painter.paintSplitPaneDividerForeground(context, g, x, y, w, h,
						orientation);
			}
		}
		...
		public void paintSplitPaneDragDivider(SynthContext context, Graphics g,
				int x, int y, int w, int h, int orientation) {
			for (SynthPainter painter : painters) {
				painter.paintSplitPaneDragDivider(context, g, x, y, w, h,
						orientation);
			}
		}
		...
		public void paintTabbedPaneTabAreaBackground(SynthContext context,
				Graphics g, int x, int y, int w, int h) {
			for (SynthPainter painter : painters) {
				painter.paintTabbedPaneTabAreaBackground(context, g, x, y, w,
						h);
			}
		}
		...
		public void paintTabbedPaneTabBackground(SynthContext context,
			...
			for (SynthPainter painter : painters) {
				painter.paintTabbedPaneTabBackground(context, g, x, y, w, h,
						tabIndex);
			}
		}
		...
		public void paintTabbedPaneTabBorder(SynthContext context, Graphics g,
			...
			for (SynthPainter painter : painters) {
				painter.paintTabbedPaneTabBorder(context, g, x, y, w, h,
						tabIndex);
			}
		}
		...
		public void paintTabbedPaneContentBackground(SynthContext context,
				Graphics g, int x, int y, int w, int h) {
			for (SynthPainter painter : painters) {
				painter.paintTabbedPaneContentBackground(context, g, x, y, w,
						h);
			}
		}
		...
		public void paintToolBarDragWindowBackground(SynthContext context,
				Graphics g, int x, int y, int w, int h) {
			for (SynthPainter painter : painters) {
				painter.paintToolBarDragWindowBackground(context, g, x, y, w,
						h);
			}
		}
		...
		public void paintTreeBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			for (SynthPainter painter : painters) {
	...
	private static class DelegatingPainter extends SynthPainter {
		...
		public void paintArrowButtonBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "arrowbuttonborder", -1).paintArrowButtonBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintArrowButtonForeground(SynthContext context, Graphics g,
			...
			getPainter(context, "arrowbuttonforeground", direction)
					.paintArrowButtonForeground(context, g, x, y, w, h,
							direction);
		}

		public void paintButtonBackground(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "buttonbackground", -1).paintButtonBackground(
					context, g, x, y, w, h);
		}

		public void paintButtonBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "buttonborder", -1).paintButtonBorder(context,
					g, x, y, w, h);
		}
		...
		public void paintCheckBoxBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "checkboxborder", -1).paintCheckBoxBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintComboBoxBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "comboboxborder", -1).paintComboBoxBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintDesktopIconBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "desktopiconborder", -1).paintDesktopIconBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintDesktopPaneBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "desktoppaneborder", -1).paintDesktopPaneBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintEditorPaneBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "editorpaneborder", -1).paintEditorPaneBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintFileChooserBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "filechooserborder", -1).paintFileChooserBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintInternalFrameTitlePaneBackground(SynthContext context,
			...
			getPainter(context, "internalframetitlepanebackground", -1)
					.paintInternalFrameTitlePaneBackground(context, g, x, y, w,
							h);
		}
		...
		public void paintLabelBackground(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "labelbackground", -1).paintLabelBackground(
					context, g, x, y, w, h);
		}

		public void paintLabelBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "labelborder", -1).paintLabelBorder(context, g,
					x, y, w, h);
		}

		public void paintListBackground(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "listbackground", -1).paintListBackground(
					context, g, x, y, w, h);
		}

		public void paintListBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "listborder", -1).paintListBorder(context, g, x,
					y, w, h);
		}

		public void paintMenuBarBackground(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "menubarbackground", -1).paintMenuBarBackground(
					context, g, x, y, w, h);
		}

		public void paintMenuBarBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "menubarborder", -1).paintMenuBarBorder(context,
					g, x, y, w, h);
		}
		...
		public void paintMenuItemBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "menuitemborder", -1).paintMenuItemBorder(
					context, g, x, y, w, h);
		}

		public void paintMenuBackground(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "menubackground", -1).paintMenuBackground(
					context, g, x, y, w, h);
		}

		public void paintMenuBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "menuborder", -1).paintMenuBorder(context, g, x,
					y, w, h);
		}
		...
		public void paintOptionPaneBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "optionpaneborder", -1).paintOptionPaneBorder(
					context, g, x, y, w, h);
		}

		public void paintPanelBackground(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "panelbackground", -1).paintPanelBackground(
					context, g, x, y, w, h);
		}

		public void paintPanelBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "panelborder", -1).paintPanelBorder(context, g,
					x, y, w, h);
		}
		...
		public void paintPopupMenuBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "popupmenuborder", -1).paintPopupMenuBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintProgressBarBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "progressbarborder", -1).paintProgressBarBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintProgressBarForeground(SynthContext context, Graphics g,
			...
			getPainter(context, "progressbarforeground", direction)
					.paintProgressBarForeground(context, g, x, y, w, h,
							direction);
		}
		...
		public void paintRadioButtonBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "radiobuttonborder", -1).paintRadioButtonBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintRootPaneBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "rootpaneborder", -1).paintRootPaneBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintScrollBarBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "scrollbarborder", -1).paintScrollBarBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintScrollBarThumbBorder(SynthContext context, Graphics g,
			...
			getPainter(context, "scrollbarthumbborder", direction)
					.paintScrollBarThumbBorder(context, g, x, y, w, h,
							direction);
		}
		...
		public void paintScrollPaneBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "scrollpaneborder", -1).paintScrollPaneBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintSeparatorBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "separatorborder", -1).paintSeparatorBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintSeparatorForeground(SynthContext context, Graphics g,
			...
			getPainter(context, "separatorforeground", direction)
					.paintSeparatorForeground(context, g, x, y, w, h,
							direction);
		}

		public void paintSliderBackground(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "sliderbackground", -1).paintSliderBackground(
					context, g, x, y, w, h);
		}
		...
		public void paintSliderBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "sliderborder", -1).paintSliderBorder(context,
					g, x, y, w, h);
		}

		public void paintSliderBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h, int direction) {
			getPainter(context, "sliderborder", direction).paintSliderBorder(
		...
		public void paintSliderThumbBackground(SynthContext context, Graphics g,
			...
			getPainter(context, "sliderthumbbackground", direction)
					.paintSliderThumbBackground(context, g, x, y, w, h,
							direction);
		}
		...
		public void paintSliderTrackBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "slidertrackborder", -1).paintSliderTrackBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintSpinnerBackground(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "spinnerbackground", -1).paintSpinnerBackground(
					context, g, x, y, w, h);
		}

		public void paintSpinnerBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "spinnerborder", -1).paintSpinnerBorder(context,
					g, x, y, w, h);
		}
		...
		public void paintSplitPaneDragDivider(SynthContext context, Graphics g,
			...
			getPainter(context, "splitpanedragdivider", direction)
					.paintSplitPaneDragDivider(context, g, x, y, w, h,
							direction);
		}
		...
		public void paintSplitPaneBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "splitpaneborder", -1).paintSplitPaneBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintTabbedPaneBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "tabbedpaneborder", -1).paintTabbedPaneBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintTabbedPaneTabBackground(SynthContext context,
			...
			getPainter(context, "tabbedpanetabbackground", -1)
					.paintTabbedPaneTabBackground(context, g, x, y, w, h,
							direction);
		}
		...
		public void paintTabbedPaneTabBorder(SynthContext context, Graphics g,
			...
			getPainter(context, "tabbedpanetabborder", -1)
					.paintTabbedPaneTabBorder(context, g, x, y, w, h,
							direction);
		}

		public void paintTabbedPaneTabBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h, int tabIndex, int direction) {
		...
		public void paintTableHeaderBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "tableheaderborder", -1).paintTableHeaderBorder(
					context, g, x, y, w, h);
		}

		public void paintTableBackground(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "tablebackground", -1).paintTableBackground(
					context, g, x, y, w, h);
		}

		public void paintTableBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "tableborder", -1).paintTableBorder(context, g,
					x, y, w, h);
		}
		...
		public void paintTextAreaBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "textareaborder", -1).paintTextAreaBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintTextPaneBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "textpaneborder", -1).paintTextPaneBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintTextFieldBorder(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "textfieldborder", -1).paintTextFieldBorder(
					context, g, x, y, w, h);
		}
		...
		public void paintToolBarBackground(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "toolbarbackground", -1).paintToolBarBackground(
					context, g, x, y, w, h);
		}
		...
		public void paintToolBarBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "toolbarborder", -1).paintToolBarBorder(context,
					g, x, y, w, h);
		}
		...
		public void paintToolTipBackground(SynthContext context, Graphics g,
				int x, int y, int w, int h) {
			getPainter(context, "tooltipbackground", -1).paintToolTipBackground(
					context, g, x, y, w, h);
		}

		public void paintToolTipBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "tooltipborder", -1).paintToolTipBorder(context,
					g, x, y, w, h);
		}

		public void paintTreeBackground(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "treebackground", -1).paintTreeBackground(
					context, g, x, y, w, h);
		}

		public void paintTreeBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "treeborder", -1).paintTreeBorder(context, g, x,
					y, w, h);
		}
		...
		public void paintTreeCellBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "treecellborder", -1).paintTreeCellBorder(
					context, g, x, y, w, h);
		}

		public void paintTreeCellFocus(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "treecellfocus", -1).paintTreeCellFocus(context,
					g, x, y, w, h);
		}
		...
		public void paintViewportBorder(SynthContext context, Graphics g, int x,
				int y, int w, int h) {
			getPainter(context, "viewportborder", -1).paintViewportBorder(
					context, g, x, y, w, h);
		}
	}
}
