...
/**
 * Provides the Synth L&amp;F UI delegate for {@link javax.swing.JSeparator}.
 *
...
public class SynthSeparatorUI extends SeparatorUI implements
	...
	/**
	 * Installs listeners. This method is called when a {@code LookAndFeel} is
	 * installed.
	 */
	...
	/**
	 * Uninstalls listeners. This method is called when a {@code LookAndFeel} is
	 * uninstalled.
	 */
