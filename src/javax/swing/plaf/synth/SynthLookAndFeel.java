 ...
 * SynthLookAndFeel does not directly provide a look, all painting is delegated.
 * You need to either provide a configuration file, by way of the {@link #load}
 * method, or provide your own {@link SynthStyleFactory} to
 * {@link #setStyleFactory}. Refer to the <a href="package-summary.html">package
 * summary</a> for an example of loading a file, and
 * {@link javax.swing.plaf.synth.SynthStyleFactory} for an example of providing
 * your own <code>SynthStyleFactory</code> to <code>setStyleFactory</code>.
 * <p>
 * <strong>Warning:</strong> This class implements {@link Serializable} as a
 * side effect of it extending {@link BasicLookAndFeel}. It is not intended to
 * be serialized. An attempt to serialize it will result in
...
public class SynthLookAndFeel extends BasicLookAndFeel {
     ...
     */
    private static final Object STYLE_FACTORY_KEY = new StringBuffer(
     ...
     * accommodate this SynthLabelUI checks if the current UI matches that of
    ...
    /**
     * Sets the SynthStyleFactory that the UI classes provided by synth will use
    ...
    /**
     * Creates the Synth look and feel <code>ComponentUI</code> for the passed
     ...
     * invoke <code>load</code> to specify the set of <code>SynthStyle</code>s,
     * or invoke <code>setStyleFactory</code>.
     *
     * @see #load
     * @see #setStyleFactory
     */
    ...
    /**
     * Loads the set of <code>SynthStyle</code>s that will be used by this
     * <code>SynthLookAndFeel</code>. <code>resourceBase</code> is used to
     * resolve any path based resources, for example an <code>Image</code> would
     * be resolved by <code>resourceBase.getResource(path)</code>. Refer to
    ...
    public void load(InputStream input, Class<?> resourceBase) throws ParseException {
        ...
        new SynthParser().parse(input, (DefaultSynthStyleFactory) factory, null, resourceBase, defaultsMap);
    }

    /**
     * Loads the set of <code>SynthStyle</code>s that will be used by this
     * <code>SynthLookAndFeel</code>. Path based resources are resolved
     * relatively to the specified <code>URL</code> of the style. For example an
    ...
    public UIDefaults getDefaults() {
        ...
        table.put("PopupMenu.selectedWindowInputMapBindings", new Object[] { "ESCAPE", "cancel", "DOWN",
                "selectNext", "KP_DOWN", "selectNext", "UP", "selectPrevious", "KP_UP", "selectPrevious",
                "LEFT", "selectParent", "KP_LEFT", "selectParent", "RIGHT", "selectChild", "KP_RIGHT",
                "selectChild", "ENTER", "return", "SPACE", "return" });
        table.put("PopupMenu.selectedWindowInputMapBindings.RightToLeft", new Object[] { "LEFT",
                "selectChild", "KP_LEFT", "selectChild", "RIGHT", "selectParent", "KP_RIGHT",
                "selectParent", });
     ...
     * ancestor of the <code>JComponent</code> changes. A subclass that provided
     * a <code>SynthStyleFactory</code> that based the return value from
     * <code>getStyle</code> off the containment hierarchy would override this
     ...
     * Antialiasing might be forced off if the desktop is GNOME and the user has
     * set his locale to Chinese, Japanese or Korean. This is consistent with
     * what GTK does. See com.sun.java.swing.plaf.gtk.GtkLookAndFeel for more
     * information about CJK and antialiased fonts.
     *
    ...
    private static Object getAATextInfo() {
        ...
        boolean isCjkLocale = (Locale.CHINESE.getLanguage().equals(language) || Locale.JAPANESE.getLanguage()
                .equals(language) || Locale.KOREAN.getLanguage().equals(language));
