 ...
 * <code>Region</code>. A <code>SynthContext</code> should only be considered
 * valid for the duration of the method it is passed to. In other words you
 * should not cache a <code>SynthContext</code> that is passed to you and expect
 * it to remain valid.
 *
 * @since 1.5
 * @author Scott Violet
...
public class SynthContext {
    ...
    static SynthContext getContext(JComponent component, Region region, SynthStyle style, int state) {
