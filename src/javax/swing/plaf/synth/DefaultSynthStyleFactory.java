...
/**
 * Factory used for obtaining styles. Supports associating a style based on the
 * name of the component as returned by <code>Component.getName()</code>, and
 * the <code>Region</code> associated with the <code>JComponent</code>. Lookup
...
class DefaultSynthStyleFactory extends SynthStyleFactory {
	...
	/**
	 * Creates a single Style from the passed in styles. The passed in List is
	 * reverse sorted, that is the most recently added style found to match will
	 * be first.
	 */
