...
public class Region {
    ...
    /**
     * ArrowButton's are special types of buttons that also render a directional
     * indicator, typically an arrow. ArrowButtons are used by composite
     * components, for example ScrollBar's contain ArrowButtons. To bind a style
     * to this <code>Region</code> use the name <code>ArrowButton</code>.
     */
    ...
    /**
     * DesktopPane region. To bind a style to this <code>Region</code> use the
     * name <code>DesktopPane</code>.
     */
    public static final Region DESKTOP_PANE = new Region("DesktopPane", false);

    /**
     * DesktopIcon region. To bind a style to this <code>Region</code> use the
     * name <code>DesktopIcon</code>.
     */
    public static final Region DESKTOP_ICON = new Region("DesktopIcon", false);

    /**
     * EditorPane region. To bind a style to this <code>Region</code> use the
     * name <code>EditorPane</code>.
     */
    public static final Region EDITOR_PANE = new Region("EditorPane", false);

    /**
     * FileChooser region. To bind a style to this <code>Region</code> use the
     * name <code>FileChooser</code>.
     */
     ...
     * name <code>ProgressBar</code>.
     */
    public static final Region PROGRESS_BAR = new Region("ProgressBar", false);

    /**
     * RadioButton region. To bind a style to this <code>Region</code> use the
     * name <code>RadioButton</code>.
     */
    ...
    /**
     * ScrollBar region. To bind a style to this <code>Region</code> use the
     * name <code>ScrollBar</code>.
     */
     ...
     * gives a graphical depiction of what percentage of the View is currently
     ...
     * name <code>ScrollPane</code>.
     */
    public static final Region SCROLL_PANE = new Region("ScrollPane", false);

    /**
     * Separator region. To bind a style to this <code>Region</code> use the
     * name <code>Separator</code>.
     */
    public static final Region SEPARATOR = new Region("Separator", false);

    /**
     * Slider region. To bind a style to this <code>Region</code> use the name
     * <code>Slider</code>.
     */
    public static final Region SLIDER = new Region("Slider", false);

    /**
     * Track of the Slider. To bind a style to this <code>Region</code> use the
     * name <code>SliderTrack</code>.
     */
    ...
    /**
     * SplitPane region. To bind a style to this <code>Region</code> use the
     * name <code>SplitPane</code>.
     */
    ...
    /**
     * TableHeader region. To bind a style to this <code>Region</code> use the
     * name <code>TableHeader</code>.
     */
    public static final Region TABLE_HEADER = new Region("TableHeader", false);

    /**
     * TextArea region. To bind a style to this <code>Region</code> use the name
     * <code>TextArea</code>.
     */
    public static final Region TEXT_AREA = new Region("TextArea", false);

    /**
     * TextField region. To bind a style to this <code>Region</code> use the
     * name <code>TextField</code>.
     */
    public static final Region TEXT_FIELD = new Region("TextField", false);

    /**
     * TextPane region. To bind a style to this <code>Region</code> use the name
     * <code>TextPane</code>.
     */
    ...
    /**
     * Viewport region. To bind a style to this <code>Region</code> use the name
     * <code>Viewport</code>.
     */
