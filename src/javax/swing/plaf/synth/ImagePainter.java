...
class ImagePainter extends SynthPainter {
    ...
    ImagePainter(boolean tiles, boolean paintCenter, Insets sourceInsets, Insets destinationInsets, URL path,
            boolean center) {
    ...
    private void paint(SynthContext context, Graphics g, int x, int y, int w, int h) {
        ...
        if (Paint9Painter.validImage(image)) {
            ...
            imageCache.paint(context.getComponent(), g, x, y, w, h, image, sInsets, dInsets, type, mask);
        }
    }
