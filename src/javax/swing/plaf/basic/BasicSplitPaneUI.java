...
public class BasicSplitPaneUI extends SplitPaneUI {
    ...
    /**
     * Instance for the shadow of the divider when non continuous layout is
     * being used.
     */
    ...
    public class PropertyHandler implements PropertyChangeListener {
         ...
         * in. May potentially reset the layout manager and cause a
    ...
    /**
     * Returns the default non continuous layout divider, which is an instance
     * of {@code Canvas} that fills in the background with dark gray.
     */
     ...
     * session. It is recommended that the passed in component be a heavy
     * weight.
     */
    ...
    private void addHeavyweightDivider() {
        if (nonContinuousLayoutDivider != null && splitPane != null) {
            ...
            splitPane.remove(divider);
            splitPane.add(nonContinuousLayoutDivider, BasicSplitPaneUI.NON_CONTINUOUS_DIVIDER, splitPane
                    .getComponentCount());
    ...
    /**
     * Returns the preferred size for the passed in component, This is passed
     * off to the current layout manager.
     */
    ...
    /**
     * Returns the minimum size for the passed in component, This is passed off
    ...
    /**
     * Returns the maximum size for the passed in component, This is passed off
     * to the current layout manager.
     */
    ...
    protected void startDragging() {
        ...
        if (orientation == JSplitPane.HORIZONTAL_SPLIT) {
            ...
            if (!isContinuousLayout() && draggingHW) {
                nonContinuousLayoutDivider.setBounds(getLastDragLocation(), 0, dividerSize, splitPane
                        .getHeight());
            ...
            if (!isContinuousLayout() && draggingHW) {
                nonContinuousLayoutDivider.setBounds(0, getLastDragLocation(), splitPane.getWidth(),
                        dividerSize);
                addHeavyweightDivider();
            }
        }
    ...
    public class BasicHorizontalLayoutManager implements LayoutManager2 {
        ...
        public void layoutContainer(Container container) {
            ...
            } else if (lastSplitPaneSize <= 0 || availableSize == lastSplitPaneSize || !painted
            ...
            while (counter < 3) {
                if (components[counter] != null && components[counter].isVisible()) {
                    setComponentToSize(components[counter], sizes[counter], nextLocation, insets,
                            containerSize);
        ...
        /**
         * Adds the component at place. Place must be one of JSplitPane.LEFT,
         * RIGHT, TOP, BOTTOM, or null (for the divider).
         */
        ...
        /**
         * Returns the minimum size needed to contain the children. The width is
         * the sum of all the children's min widths and the height is the
         * largest of the children's minimum heights.
         */
        public Dimension minimumLayoutSize(Container container) {
            ...
            if (insets != null) {
                ...
                minSecondary += getSizeForSecondaryAxis(insets, true) + getSizeForSecondaryAxis(insets,
                        false);
            }
            if (axis == 0) {
        ...
        /**
         * Returns the preferred size needed to contain the children. The width
         * is the sum of all the preferred widths of the children and the height
         * is the largest preferred height of the children.
         */
        public Dimension preferredLayoutSize(Container container) {
            ...
            if (insets != null) {
                ...
                preSecondary += getSizeForSecondaryAxis(insets, true) + getSizeForSecondaryAxis(insets,
                        false);
            }
            if (axis == 0) {
        ...
        public void addLayoutComponent(Component comp, Object constraints) {
            if ((constraints == null) || (constraints instanceof String)) {
                ...
                throw new IllegalArgumentException("cannot add to layout: " + "constraint must be a "
                        + "string (or null)");
            }
        }
        ...
        /**
         * Does nothing. If the developer really wants to change the size of one
         * of the views JSplitPane.resetToPreferredSizes should be messaged.
         */
        ...
        /**
         * Marks the receiver so that the next time this instance is laid out
         * it'll ask for the preferred sizes.
         */
        ...
        protected int getAvailableSize(Dimension containerSize, Insets insets) {
            ...
            return (getSizeForPrimaryAxis(containerSize) - (getSizeForPrimaryAxis(insets, true)
        ...
        /**
         * Sets the width of the component c to be size, placing its x location
         * at location, y to the insets.top and height to the
         * containersize.height less the top and bottom insets.
         */
        protected void setComponentToSize(Component c, int size, int location, Insets insets,
                Dimension containerSize) {
            if (insets != null) {
                if (axis == 0) {
                    c.setBounds(location, insets.top, size, containerSize.height - (insets.top
                            + insets.bottom));
                } else {
                    c.setBounds(insets.left, location, containerSize.width - (insets.left + insets.right),
                            size);
                }
            } else {
                if (axis == 0) {
         ...
         * <code>isTop</code>
         * <p>
         * axis isTop 0 true - left 0 false - right 1 true - top 1 false -
         * bottom
         */
        ...
        /**
         * Determines the components. This should be called whenever a new
         * instance of this is installed into an existing SplitPane.
         */
        protected void updateComponents() {
            ...
            for (int counter = children.length - 1; counter >= 0; counter--) {
                if (children[counter] != components[0] && children[counter] != components[1]
        ...
        /**
         * Resets the size of the first component to <code>leftSize</code>, and
         * the right component to the remainder of the space.
         */
        ...
        /**
         * Distributes <code>space</code> between the two components (divider
         * won't get any extra space) based on the weighting. This attempts to
         * honor the min size of the components.
         *
         * @param keepHidden
         *        if true and one of the components is 0x0 it gets
         *        none of
         *        the extra space
         */
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed(ActionEvent ev) {
            ...
            BasicSplitPaneUI ui = (BasicSplitPaneUI) BasicLookAndFeel.getUIOfType(splitPane.getUI(),
                    BasicSplitPaneUI.class);
        ...
        private void moveFocus(JSplitPane splitPane, int direction) {
            ...
            Component focusOn = (direction > 0) ? policy.getComponentAfter(rootAncestor, splitPane)
            ...
            if (splitPane.isAncestorOf(focusOn)) {
                do {
                    ...
                    focusOn = (direction > 0) ? policy.getComponentAfter(rootAncestor, focusOn)
        ...
        private void toggleFocus(JSplitPane splitPane) {
            ...
            if (focusOn != null) {
                ...
                if (focus != null && ((SwingUtilities.isDescendingFrom(focus, left) && SwingUtilities
                        .isDescendingFrom(focusOn, left)) || (SwingUtilities.isDescendingFrom(focus, right)
        ...
        private Component getNextSide(JSplitPane splitPane, Component focus) {
            ...
            JSplitPane parentSplitPane = (JSplitPane) SwingUtilities.getAncestorOfClass(JSplitPane.class,
                    splitPane);
            if (parentSplitPane != null) {
