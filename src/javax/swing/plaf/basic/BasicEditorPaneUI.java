...
public class BasicEditorPaneUI extends BasicTextUI {
	...
	/**
	 * Fetches the EditorKit for the UI. This is whatever is currently set in
	 * the associated JEditorPane.
	 *
	...
	/**
	 * Fetch an action map to use. The map for a JEditorPane is not shared
	 * because it changes with the EditorKit.
	 */
	...
	/**
	 * Attribute key to reference the default font. used in
	 * javax.swing.text.StyleContext.getFont to resolve the default font.
	 */
