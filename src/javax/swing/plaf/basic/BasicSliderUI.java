...
public class BasicSliderUI extends SliderUI {
    ...
    InputMap getInputMap(int condition, JSlider slider) {
        if (condition == JComponent.WHEN_FOCUSED) {
            ...
            if (slider.getComponentOrientation().isLeftToRight() || ((rtlKeyMap = (InputMap) DefaultLookup
                    .get(slider, this, "Slider.focusInputMap.RightToLeft")) == null)) {
                return keyMap;
            } else {
    ...
    public int getBaseline(JComponent c, int width, int height) {
        ...
        if (slider.getPaintLabels() && labelsHaveSameBaselines()) {
            ...
            if (slider.getOrientation() == JSlider.HORIZONTAL) {
                ...
                int contentHeight = height - insets.top - insets.bottom - focusInsets.top
                        - focusInsets.bottom;
                ...
                if (value != null) {
                    ...
                    int trackHeight = height - focusInsets.top - focusInsets.bottom - insets.top
                            - insets.bottom - trackBuffer - trackBuffer;
                    int yPosition = yPositionForValue(value, trackY, trackHeight);
    ...
    public Dimension getPreferredHorizontalSize() {
        Dimension horizDim = (Dimension) DefaultLookup.get(slider, this, "Slider.horizontalSize");
        if (horizDim == null) {
    ...
    public Dimension getPreferredVerticalSize() {
        Dimension vertDim = (Dimension) DefaultLookup.get(slider, this, "Slider.verticalSize");
        if (vertDim == null) {
    ...
    public Dimension getMinimumHorizontalSize() {
        Dimension minHorizDim = (Dimension) DefaultLookup.get(slider, this, "Slider.minimumHorizontalSize");
        if (minHorizDim == null) {
    ...
    public Dimension getMinimumVerticalSize() {
        Dimension minVertDim = (Dimension) DefaultLookup.get(slider, this, "Slider.minimumVerticalSize");
        if (minVertDim == null) {
            ...
            while (keys.hasMoreElements()) {
                ...
                if (value >= minValue && value <= maxValue) {
                    ...
                    if (label instanceof JLabel) {
                        Icon icon = label.isEnabled() ? ((JLabel) label).getIcon()
                                : ((JLabel) label).getDisabledIcon();

                        if (icon instanceof ImageIcon) {
                            // Register Slider as an image observer. It allows
                            // to catch notifications about
                            // image changes (e.g. gif animation)
                            Toolkit.getDefaultToolkit().checkImage(((ImageIcon) icon).getImage(), -1, -1,
                                    slider);
                        }
                    }
    ...
    private class Handler implements ChangeListener, ComponentListener, FocusListener,
        ...
        public void propertyChange(PropertyChangeEvent e) {
            ...
            if (propertyName == "orientation" || propertyName == "inverted" || propertyName == "labelTable"
                    || propertyName == "majorTickSpacing" || propertyName == "minorTickSpacing"
                    || propertyName == "paintTicks" || propertyName == "paintTrack" || propertyName == "font"
                    || propertyName == "paintLabels" || propertyName == "Slider.paintThumbArrowShape") {
                checkedLabelBaselines = false;
                calculateGeometry();
                slider.repaint();
    ...
    public class TrackListener extends MouseInputAdapter {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            if (thumbRect.contains(currentMouseX, currentMouseY)) {
                if (UIManager.getBoolean("Slider.onlyLeftMouseButtonDrag") && !SwingUtilities
                        .isLeftMouseButton(e)) {
                    return;
                }
    ...
    static class SharedActionScroller extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            BasicSliderUI ui = (BasicSliderUI) BasicLookAndFeel.getUIOfType(slider.getUI(),
                    BasicSliderUI.class);
            if (ui == null) {
                return;
            }
    ...
    private static class Actions extends UIAction {
        ...
        private void scroll(JSlider slider, BasicSliderUI ui, int direction, boolean isBlock) {
            ...
            if (direction == NEGATIVE_SCROLL || direction == POSITIVE_SCROLL) {
                if (invert) {
                    direction = (direction == POSITIVE_SCROLL) ? NEGATIVE_SCROLL : POSITIVE_SCROLL;
                }
                ...
                if (invert) {
                    direction = (direction == MIN_SCROLL) ? MAX_SCROLL : MIN_SCROLL;
                }

                slider.setValue((direction == MIN_SCROLL) ? slider.getMinimum() : slider.getMaximum());
            }
        }
    }
}
