...
public class BasicTextAreaUI extends BasicTextUI {
     ...
     * subclasses. This is implemented to rebuild the View when the
    ...
    protected void propertyChange(PropertyChangeEvent evt) {
        ...
        if (evt.getPropertyName().equals("lineWrap") || evt.getPropertyName().equals("wrapStyleWord") || evt
                .getPropertyName().equals("tabSize")) {
            // rebuild the view
            modelChanged();
    ...
    public int getBaseline(JComponent c, int width, int height) {
        ...
        if (Boolean.TRUE.equals(i18nFlag)) {
            ...
            if (rootView.getViewCount() > 0) {
                ...
                int fieldBaseline = BasicHTML.getBaseline(rootView.getView(0), width - insets.left
                        - insets.right, height);
                if (fieldBaseline < 0) {
                    return -1;
                }
    ...
    /**
     * Paragraph for representing plain-text lines that support bidirectional
     * text.
     */
    static class PlainParagraph extends ParagraphView {
        ...
        /**
         * Sets the size of the view. If the size has changed, layout is redone.
         ...
         * keeps the children updated to reflect the state of the model, gives
         * the logical child views access to the view hierarchy, and calculates
         * a preferred span. It doesn't do any rendering, layout, or model/view
         * translation.
         */
        static class LogicalView extends CompositeView {
             ...
             * children may have been parented by a row in the flow if they fit
