...
class DragRecognitionSupport {
	...
	private static DragRecognitionSupport getDragRecognitionSupport() {
		DragRecognitionSupport support = (DragRecognitionSupport) AppContext.getAppContext()
	...
	private int mapDragOperationFromModifiers(MouseEvent me, TransferHandler th) {
		...
		return SunDragSourceContextPeer.convertModifiersToDropAction(me.getModifiersEx(),
	...
	private boolean mousePressedImpl(MouseEvent me) {
		...
		if (mapDragOperationFromModifiers(me,
				component.getTransferHandler()) != TransferHandler.NONE) {
