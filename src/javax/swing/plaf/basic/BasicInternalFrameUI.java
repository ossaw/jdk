...
public class BasicInternalFrameUI extends InternalFrameUI {
	...
	/**
	 * Installs necessary mouse handlers on <code>newPane</code> and adds it to
	 * the frame. Reverse process for the <code>currentPane</code>.
	 */
	 ...
	 * JDesktop component and returns the desktopManager from it. If this fails,
	 * it will return a default DesktopManager that should work in arbitrary
	 * parents.
	 */
	 ...
	 * <code>playCloseSound</code> Action is fired. This action is delegated to
	 * the desktopManager.
	 */
	...
	/**
	 * This method is called when the user wants to maximize the frame. The
	 * <code>playMaximizeSound</code> Action is fired. This action is delegated
	 * to the desktopManager.
	 */
	...
	/**
	 * This method is called when the user wants to minimize the frame. The
	 * <code>playRestoreDownSound</code> Action is fired. This action is
	...
	/**
	 * This method is called when the user wants to iconify the frame. The
	 * <code>playMinimizeSound</code> Action is fired. This action is delegated
	 * to the desktopManager.
	 */
	...
	/**
	 * This method is called when the user wants to deiconify the frame. The
	 * <code>playRestoreUpSound</code> Action is fired. This action is delegated
	 * to the desktopManager.
	 */
	...
	private class Handler implements ComponentListener, InternalFrameListener, LayoutManager,
		...
		public void layoutContainer(Container c) {
			...
			if (getSouthPane() != null) {
				...
				getSouthPane().setBounds(cx, frame.getHeight() - i.bottom - size.height, cw,
						size.height);
				ch -= size.height;
			}
		...
		public void propertyChange(PropertyChangeEvent evt) {
			...
			} else if (JInternalFrame.TITLE_PROPERTY == prop || prop == "closable"
					|| prop == "iconable" || prop == "maximizable") {
