...
public class BasicRootPaneUI extends RootPaneUI implements PropertyChangeListener {
    ...
    /**
     * Invoked when the default button property has changed. This reloads the
     * bindings from the defaults table with name
    ...
    /**
     * Invoked when a property changes on the root pane. If the event indicates
     * the <code>defaultButton</code> has changed, this will reinstall the
     * keyboard actions.
     */
