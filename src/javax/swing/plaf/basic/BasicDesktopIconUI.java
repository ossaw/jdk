...
public class BasicDesktopIconUI extends DesktopIconUI {
    ...
    /**
     * Desktop icons can not be resized. Therefore, we should always return the
     * minimum size of the desktop icon.
     *
     * @see #getMinimumSize
     */
    ...
    public class MouseInputHandler extends MouseInputAdapter {
        ...
        public void mouseDragged(MouseEvent e) {
            ...
            if ((d = desktopIcon.getDesktopPane()) != null) {
                ...
                moveAndRepaint(desktopIcon, newX, newY, desktopIcon.getWidth(), desktopIcon.getHeight());
            }
            return;
        }
