 ...
 * the popup portion of a combo box.
 * <p>
...
public interface ComboPopup {
	...
	/**
	 * Returns a mouse listener that will be added to the combo box or null. If
	...
	/**
	 * Returns a mouse motion listener that will be added to the combo box or
	 * null. If this method returns null then it will not be added to the combo
	 * box.
	 *
	...
	/**
	 * Returns a key listener that will be added to the combo box or null. If
	 * this method returns null then it will not be added to the combo box.
	 */
	public KeyListener getKeyListener();

	/**
	 * Called to inform the ComboPopup that the UI is uninstalling. If the
	 * ComboPopup added any listeners in the component, it should remove them
	 * here.
	 */
