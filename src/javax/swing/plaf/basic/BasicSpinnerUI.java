...
public class BasicSpinnerUI extends SpinnerUI {
    ...
    /**
     * Returns a new instance of BasicSpinnerUI. SpinnerListUI delegates are
     ...
     * , <code>nextButton</code>, and <code>previousButton</code> children of
     * the JSpinner. These three children must be added with a constraint that
     ...
     * JSpinner itself. Typically, this listener will call replaceEditor when
     * the "editor" property changes, since it's the <code>SpinnerUI's</code>
     * responsibility to add the editor to the JSpinner (and remove the old
     ...
     * value with the object returned by <code>spinner.getNextValue</code>. By
     * default the <code>nextButton</code> is a {@code JButton}. If the
     * increment button is not needed this method should return {@code null}.
     *
     * @return a component that will replace the spinner's value with the next
     ...
     * the <code>JSpinner</code> in an <code>installUI</code> override.
     * <p>
     ...
     * is changed with <code>JSpinner.setEditor</code>. If you've overriden this
     * method, then you'll probably want to override <code>replaceEditor</code>
     * as well.
     *
    ...
    private static class ArrowButtonHandler extends AbstractAction implements FocusListener, MouseListener,
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (!(e.getSource() instanceof javax.swing.Timer)) {
                ...
                if (arrowButton != null && !arrowButton.getModel().isPressed() && autoRepeatTimer
                        .isRunning()) {
        ...
        private void focusSpinnerIfNecessary() {
            ...
            if (spinner.isRequestFocusEnabled() && (fo == null || !SwingUtilities.isDescendingFrom(fo,
                    spinner))) {
    ...
    private static class Handler implements LayoutManager, PropertyChangeListener, ChangeListener {
        ...
        public void layoutContainer(Container parent) {
            ...
            if (nextButton == null && previousButton == null) {
                setBounds(editor, insets.left, insets.top, width - insets.left - insets.right, height
        ...
        public void stateChanged(ChangeEvent e) {
            if (e.getSource() instanceof JSpinner) {
                JSpinner spinner = (JSpinner) e.getSource();
                SpinnerUI spinnerUI = spinner.getUI();
                if (DefaultLookup.getBoolean(spinner, spinnerUI, "Spinner.disableOnBoundaryValues", false)
