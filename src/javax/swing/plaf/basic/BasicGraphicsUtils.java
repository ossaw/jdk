...
public class BasicGraphicsUtils {
    ...
    public static void drawEtchedRect(Graphics g, int x, int y, int w, int h, Color shadow, Color darkShadow,
    ...
    /**
     * Draw a string with the graphics <code>g</code> at location (x,y) just
     * like <code>g.drawString</code> would. The first occurrence of
     ...
     * <code>x</code>, <code>y</code>) just like <code>g.drawString</code>
     * would. The character at index <code>underlinedIndex</code> in text will
     * be underlined. If <code>index</code> is beyond the bounds of
    ...
    public static Dimension getPreferredButtonSize(AbstractButton b, int textIconGap) {
        ...
        SwingUtilities.layoutCompoundLabel(b, fm, text, icon, b.getVerticalAlignment(), b
                .getHorizontalAlignment(), b.getVerticalTextPosition(), b.getHorizontalTextPosition(), viewR,
