...
public class BasicHTML {
	...
	/**
	 * Check the given string to see if it should trigger the html rendering
	 * logic in a non-text component that supports html rendering.
	 */
	...
	/**
	 * Stash the HTML render for the given text into the client properties of
	 * the given JComponent. If the given text is <em>NOT HTML</em> the property
	 * will be cleared of any renderer.
	 * <p>
	 * This method is useful for ComponentUI implementations that are static
	 * (i.e. shared) and get their state entirely from the JComponent.
	 */
	 ...
	 * references are resolved against. For example, lets say you keep your
	 * images in the directory resources relative to the code path, you would
	 ...
	 * edited and don't need full html support. This kit alters the
	 * HTMLEditorKit to try and trim things down a bit. It does the following:
	 * <ul>
	 * <li>It doesn't produce Views for things like comments, head, title,
	 * unknown tags, etc.
