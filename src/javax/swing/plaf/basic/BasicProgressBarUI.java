...
public class BasicProgressBarUI extends ProgressBarUI {
	...
	public int getBaseline(JComponent c, int width, int height) {
		...
		if (progressBar.isStringPainted()
			...
			return y + (height + metrics.getAscent() - metrics.getLeading() - metrics.getDescent())
					/ 2;
		}
		return -1;
	}
	...
	protected void paintIndeterminate(Graphics g, JComponent c) {
		...
		if (progressBar.isStringPainted()) {
			if (progressBar.getOrientation() == JProgressBar.HORIZONTAL) {
				paintString(g2, b.left, b.top, barRectWidth, barRectHeight, boxRect.x,
						boxRect.width, b);
			} else {
				paintString(g2, b.left, b.top, barRectWidth, barRectHeight, boxRect.y,
						boxRect.height, b);
			}
		}
	}
	...
	protected void paintDeterminate(Graphics g, JComponent c) {
		...
		if (progressBar.getOrientation() == JProgressBar.HORIZONTAL) {
			...
			g2.drawLine(barRectWidth / 2 + b.left, b.top + barRectHeight, barRectWidth / 2 + b.left,
	...
	private void paintString(Graphics g, int x, int y, int width, int height, int fillStart,
		...
		if (progressBar.getOrientation() == JProgressBar.HORIZONTAL) {
			...
			SwingUtilities2.drawString(progressBar, g2, progressString, renderLocation.x,
					renderLocation.y);
	...
	protected Point getStringPlacement(Graphics g, String progressString, int x, int y, int width,
		...
		if (progressBar.getOrientation() == JProgressBar.HORIZONTAL) {
			...
			return new Point(
					x + ((width - fontSizer.getAscent() + fontSizer.getLeading()
							+ fontSizer.getDescent()) / 2),
	...
	private int initRepaintInterval() {
		repaintInterval = DefaultLookup.getInt(progressBar, this, "ProgressBar.repaintInterval",
				50);
		return repaintInterval;
	}
