...
/**
 * A default L&amp;F implementation of MenuUI. This implementation is a
...
public class BasicMenuUI extends BasicMenuItemUI {
	...
	void updateMnemonicBinding() {
		...
		if (mnemonic != 0) {
			...
			for (int shortcutKey : shortcutKeys) {
				windowInputMap.put(KeyStroke.getKeyStroke(mnemonic, shortcutKey, false),
						"selectMenu");
			}
		}
	...
	/*
	 * Set the background color depending on whether this is a toplevel menu in
	 * a menubar or a submenu of another menu.
	 */
