...
public class MultiTreeUI extends TreeUI {
	...
	/**
	 * Invokes the <code>getPathBounds</code> method on each UI handled by this
	 * object.
	 *
	...
	public Rectangle getPathBounds(JTree a, TreePath b) {
		Rectangle returnValue = ((TreeUI) (uis.elementAt(0))).getPathBounds(a, b);
	...
	/**
	 * Invokes the <code>getPathForRow</code> method on each UI handled by this
	 * object.
	 *
	 * @return the value obtained from the first UI, which is the UI obtained
	 *         from the default <code>LookAndFeel</code>
	...
	public TreePath getPathForRow(JTree a, int b) {
		TreePath returnValue = ((TreeUI) (uis.elementAt(0))).getPathForRow(a, b);
		for (int i = 1; i < uis.size(); i++) {
	...
	/**
	 * Invokes the <code>getRowForPath</code> method on each UI handled by this
	 * object.
	 *
	 * @return the value obtained from the first UI, which is the UI obtained
	 *         from the default <code>LookAndFeel</code>
	...
	public int getRowForPath(JTree a, TreePath b) {
		int returnValue = ((TreeUI) (uis.elementAt(0))).getRowForPath(a, b);
		for (int i = 1; i < uis.size(); i++) {
	...
	/**
	 * Invokes the <code>getRowCount</code> method on each UI handled by this
	 * object.
	 *
	 * @return the value obtained from the first UI, which is the UI obtained
	 *         from the default <code>LookAndFeel</code>
	...
	public int getRowCount(JTree a) {
		int returnValue = ((TreeUI) (uis.elementAt(0))).getRowCount(a);
		for (int i = 1; i < uis.size(); i++) {
	...
	/**
	 * Invokes the <code>getClosestPathForLocation</code> method on each UI
	...
	public TreePath getClosestPathForLocation(JTree a, int b, int c) {
		TreePath returnValue = ((TreeUI) (uis.elementAt(0))).getClosestPathForLocation(a, b, c);
		for (int i = 1; i < uis.size(); i++) {
	...
	/**
	 * Invokes the <code>isEditing</code> method on each UI handled by this
	 * object.
	 *
	 * @return the value obtained from the first UI, which is the UI obtained
	 *         from the default <code>LookAndFeel</code>
	...
	/**
	 * Invokes the <code>stopEditing</code> method on each UI handled by this
	 * object.
	 *
	 * @return the value obtained from the first UI, which is the UI obtained
	 *         from the default <code>LookAndFeel</code>
	...
	public boolean stopEditing(JTree a) {
		boolean returnValue = ((TreeUI) (uis.elementAt(0))).stopEditing(a);
		for (int i = 1; i < uis.size(); i++) {
	...
	/**
	 * Invokes the <code>cancelEditing</code> method on each UI handled by this
	 * object.
	 */
	...
	/**
	 * Invokes the <code>startEditingAtPath</code> method on each UI handled by
	 * this object.
	 */
	...
	/**
	 * Invokes the <code>getEditingPath</code> method on each UI handled by this
	 * object.
	 *
	 * @return the value obtained from the first UI, which is the UI obtained
	 *         from the default <code>LookAndFeel</code>
	...
	public TreePath getEditingPath(JTree a) {
		TreePath returnValue = ((TreeUI) (uis.elementAt(0))).getEditingPath(a);
		for (int i = 1; i < uis.size(); i++) {
	...
	public static ComponentUI createUI(JComponent a) {
		...
		return MultiLookAndFeel.createUIs(mui, ((MultiTreeUI) mui).uis, a);
	}
