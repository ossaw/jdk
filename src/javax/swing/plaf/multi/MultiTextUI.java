...
public class MultiTextUI extends TextUI {
    ...
    /**
     * Invokes the <code>getToolTipText</code> method on each UI handled by this
     * object.
     *
    ...
    public String getToolTipText(JTextComponent a, Point b) {
        String returnValue = ((TextUI) (uis.elementAt(0))).getToolTipText(a, b);
    ...
    /**
     * Invokes the <code>modelToView</code> method on each UI handled by this
     * object.
     *
     * @return the value obtained from the first UI, which is the UI obtained
     *         from the default <code>LookAndFeel</code>
    ...
    /**
     * Invokes the <code>viewToModel</code> method on each UI handled by this
     * object.
     *
     * @return the value obtained from the first UI, which is the UI obtained
     *         from the default <code>LookAndFeel</code>
    ...
    public int viewToModel(JTextComponent a, Point b) {
        int returnValue = ((TextUI) (uis.elementAt(0))).viewToModel(a, b);
        for (int i = 1; i < uis.size(); i++) {
    ...
    public int viewToModel(JTextComponent a, Point b, Position.Bias[] c) {
        int returnValue = ((TextUI) (uis.elementAt(0))).viewToModel(a, b, c);
        for (int i = 1; i < uis.size(); i++) {
    ...
    /**
     * Invokes the <code>getNextVisualPositionFrom</code> method on each UI
    ...
    /**
     * Invokes the <code>getEditorKit</code> method on each UI handled by this
     * object.
     *
     * @return the value obtained from the first UI, which is the UI obtained
     *         from the default <code>LookAndFeel</code>
    ...
    public EditorKit getEditorKit(JTextComponent a) {
        EditorKit returnValue = ((TextUI) (uis.elementAt(0))).getEditorKit(a);
        for (int i = 1; i < uis.size(); i++) {
    ...
    /**
     * Invokes the <code>getRootView</code> method on each UI handled by this
     * object.
     *
     * @return the value obtained from the first UI, which is the UI obtained
     *         from the default <code>LookAndFeel</code>
    ...
    public View getRootView(JTextComponent a) {
        View returnValue = ((TextUI) (uis.elementAt(0))).getRootView(a);
        for (int i = 1; i < uis.size(); i++) {
    ...
    public static ComponentUI createUI(JComponent a) {
        ...
        return MultiLookAndFeel.createUIs(mui, ((MultiTextUI) mui).uis, a);
    }
