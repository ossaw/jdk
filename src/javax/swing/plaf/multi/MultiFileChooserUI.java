...
public class MultiFileChooserUI extends FileChooserUI {
    ...
    /**
     * Invokes the <code>getAcceptAllFileFilter</code> method on each UI handled
     * by this object.
     *
    ...
    /**
     * Invokes the <code>getFileView</code> method on each UI handled by this
     * object.
     *
     * @return the value obtained from the first UI, which is the UI obtained
     *         from the default <code>LookAndFeel</code>
    ...
    /**
     * Invokes the <code>getApproveButtonText</code> method on each UI handled
     * by this object.
     *
     * @return the value obtained from the first UI, which is the UI obtained
     *         from the default <code>LookAndFeel</code>
    ...
    /**
     * Invokes the <code>getDialogTitle</code> method on each UI handled by this
     * object.
     *
     * @return the value obtained from the first UI, which is the UI obtained
     *         from the default <code>LookAndFeel</code>
    ...
    /**
     * Invokes the <code>rescanCurrentDirectory</code> method on each UI handled
     * by this object.
     */
    ...
    /**
     * Invokes the <code>ensureFileIsVisible</code> method on each UI handled by
     * this object.
     */
