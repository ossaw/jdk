...
public class MultiTabbedPaneUI extends TabbedPaneUI {
	...
	/**
	 * Invokes the <code>tabForCoordinate</code> method on each UI handled by
	 * this object.
	 *
	...
	/**
	 * Invokes the <code>getTabBounds</code> method on each UI handled by this
	 * object.
	 *
	 * @return the value obtained from the first UI, which is the UI obtained
	 *         from the default <code>LookAndFeel</code>
	...
	/**
	 * Invokes the <code>getTabRunCount</code> method on each UI handled by this
	 * object.
	 *
	 * @return the value obtained from the first UI, which is the UI obtained
	 *         from the default <code>LookAndFeel</code>
	...
	public int getTabRunCount(JTabbedPane a) {
		int returnValue = ((TabbedPaneUI) (uis.elementAt(0))).getTabRunCount(a);
		for (int i = 1; i < uis.size(); i++) {
