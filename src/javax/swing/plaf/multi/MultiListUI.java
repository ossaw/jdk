...
public class MultiListUI extends ListUI {
	...
	/**
	 * Invokes the <code>locationToIndex</code> method on each UI handled by
	 * this object.
	 *
	...
	public int locationToIndex(JList a, Point b) {
		int returnValue = ((ListUI) (uis.elementAt(0))).locationToIndex(a, b);
	...
	/**
	 * Invokes the <code>indexToLocation</code> method on each UI handled by
	 * this object.
	 *
	 * @return the value obtained from the first UI, which is the UI obtained
	 *         from the default <code>LookAndFeel</code>
	...
	public Point indexToLocation(JList a, int b) {
		Point returnValue = ((ListUI) (uis.elementAt(0))).indexToLocation(a, b);
		for (int i = 1; i < uis.size(); i++) {
	...
	/**
	 * Invokes the <code>getCellBounds</code> method on each UI handled by this
	 * object.
	 *
	 * @return the value obtained from the first UI, which is the UI obtained
	 *         from the default <code>LookAndFeel</code>
	...
	public Rectangle getCellBounds(JList a, int b, int c) {
		Rectangle returnValue = ((ListUI) (uis.elementAt(0))).getCellBounds(a, b, c);
		for (int i = 1; i < uis.size(); i++) {
	...
	public static ComponentUI createUI(JComponent a) {
		...
		return MultiLookAndFeel.createUIs(mui, ((MultiListUI) mui).uis, a);
	}
