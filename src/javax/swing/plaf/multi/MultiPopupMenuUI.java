...
public class MultiPopupMenuUI extends PopupMenuUI {
    ...
    /**
     * Invokes the <code>isPopupTrigger</code> method on each UI handled by this
     * object.
     *
    ...
    /**
     * Invokes the <code>getPopup</code> method on each UI handled by this
     * object.
     *
     * @return the value obtained from the first UI, which is the UI obtained
     *         from the default <code>LookAndFeel</code>
    ...
    public static ComponentUI createUI(JComponent a) {
        ...
        return MultiLookAndFeel.createUIs(mui, ((MultiPopupMenuUI) mui).uis, a);
    }
