...
public abstract class ComponentUI {
	 ...
	 * This method is invoked when the <code>ComponentUI</code> instance is
	 * being installed as the UI delegate on the specified component. This
	 * method should completely configure the component for the look and feel,
	 * including the following:
	 * <ol>
	 * <li>Install default property values for color, fonts, borders, icons,
	 ...
	 * immediately calls {@code paint}. In general this method need not be
	 * overridden by subclasses; all look-and-feel rendering code should reside
	 ...
	 * and feel. If <code>null</code> is returned, the preferred size will be
	...
	/**
	 * Returns the specified component's minimum size appropriate for the look
	 * and feel. If <code>null</code> is returned, the minimum size will be
	 * calculated by the component's layout manager instead (this is the
	 * preferred approach for any component with a specific layout manager
	 * installed). The default implementation of this method invokes
	...
	/**
	 * Returns the specified component's maximum size appropriate for the look
	 * and feel. If <code>null</code> is returned, the maximum size will be
	 * calculated by the component's layout manager instead (this is the
	 * preferred approach for any component with a specific layout manager
	 * installed). The default implementation of this method invokes
	 * <code>getPreferredSize</code> and returns that value.
	 ...
	 * children of this object implement <code>Accessible</code>, this method
	 * should return the number of children of this object. UIs might wish to
