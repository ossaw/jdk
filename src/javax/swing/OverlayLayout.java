...
public class OverlayLayout implements LayoutManager2, Serializable {
	...
	/**
	 * Constructs a layout manager that performs overlay arrangement of the
	...
	/**
	 * Indicates a child has changed its layout related information, which
	...
	/**
	 * Adds the specified component to the layout. Used by this class to know
	...
	/**
	 * Removes the specified component from the layout. Used by this class to
	 ...
	 * invalidated. Factors in the current inset setting returned by
	 * getInsets().
	 *
	 * @param target
	 ...
	 * in the specified target container. Recomputes the layout if it has been
	 ...
	 * in the specified target container. Recomputes the layout if it has been
	 * invalidated, and factors in the inset setting returned by
	 * <code>getInset</code>.
	 *
	 * @param target
