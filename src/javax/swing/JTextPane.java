...
public class JTextPane extends JEditorPane {
    ...
    public JTextPane() {
        ...
        if (contentType != null && getEditorKitClassNameForContentType(contentType) == defaultEditorKitMap
                .get(contentType)) {
     ...
     * of the current selection. The replacement text will have the attributes
     * currently defined for input at the point of insertion. If the document is
     ...
     * current position of the caret, or <code>null</code>.
     *
     * @return the <code>Style</code>
     */
    ...
    /**
     * Fetches the character attributes in effect at the current location of the
     * caret, or <code>null</code>.
     *
    ...
    /**
     * Fetches the current paragraph attributes in effect at the location of the
     * caret, or <code>null</code> if none.
     *
    ...
    /**
     * Creates the <code>EditorKit</code> to use by default. This is implemented
     * to return <code>javax.swing.text.StyledEditorKit</code>.
     *
     * @return the editor kit
     */
     ...
     * property that establishes the content type of the editor.
     *
     * @param kit
    ...
    /**
     * Returns a string representation of this <code>JTextPane</code>. This
