 ...
 * How to Use Root Panes</a>, a section in <em>The Java Tutorial</em>.
 * <p>
 * The following image shows the relationships between the classes that use root
 * panes.
 * <p style="text-align:center">
 * <img src="doc-files/JRootPane-1.gif" alt=
 * "The following text describes this graphic." HEIGHT=484 WIDTH=629>
 * </p>
 ...
 * <tr>
 * <td align="center"><img src="doc-files/JRootPane-2.gif" alt=
 * "The following text describes this graphic." HEIGHT=386 WIDTH=349></td>
 * </tr>
 * </table>
...
public class JRootPane extends JComponent implements Accessible {
    ...
    /**
     * Whether or not we should dump the stack when true double buffering is
    ...
    /**
     * As of Java 2 platform v1.3 this unusable field is no longer used. To
     * override the default button you should replace the <code>Action</code> in
     * the <code>JRootPane</code>'s <code>ActionMap</code>. Please refer to the
     ...
     * true, but may be set to false in special situations. For example, heavy
     * weight popups (backed by a window) set this to false.
     */
    boolean useTrueDoubleBuffering = true;

    static {
        LOG_DISABLE_TRUE_DOUBLE_BUFFERING = AccessController.doPrivileged(new GetBooleanAction(
                "swing.logDoubleBufferingDisable"));
        IGNORE_DISABLE_TRUE_DOUBLE_BUFFERING = AccessController.doPrivileged(new GetBooleanAction(
    ...
    /**
     * Sets the type of Window decorations (such as borders, widgets for closing
     * a Window, title ...) the <code>JRootPane</code> should provide. The
     * default is to provide no Window decorations (<code>NONE</code>).
     * <p>
     * This is only a hint, and some look and feels may not support this. This
     * is a bound property.
     *
     ...
     *           JRootPane.INFORMATION_DIALOG ERROR_DIALOG
     *           JRootPane.ERROR_DIALOG COLOR_CHOOSER_DIALOG
     *           JRootPane.COLOR_CHOOSER_DIALOG FILE_CHOOSER_DIALOG
     *           JRootPane.FILE_CHOOSER_DIALOG QUESTION_DIALOG
     *           JRootPane.QUESTION_DIALOG WARNING_DIALOG
     *           JRootPane.WARNING_DIALOG expert: true attribute: visualUpdate
     *           true description: Identifies the type of Window decorations to
     *           provide
     */
    ...
    /**
     * Called by the constructor methods to create the default
     * <code>glassPane</code>. By default this method creates a new
     * <code>JComponent</code> with visibility set to false.
     * 
    ...
    /**
     * Sets the layered pane for the root pane. The layered pane typically holds
    ...
    /**
     * Gets the layered pane used by the root pane. The layered pane typically
     * holds a content pane and an optional <code>JMenuBar</code>.
     *
     ...
     * root pane. The glass pane should normally be a lightweight, transparent
     * component, because it will be made visible when ever the root pane needs
     * to grab input events.
     * <p>
     * The new glass pane's visibility is changed to match that of the current
     * glass pane. An implication of this is that care must be taken when you
     * want to replace the glass pane and make it visible. Either of the
     * following will work:
     * 
     * <pre>
     ...
     * <p>
     * Deferred requests to layout a component and its descendents again. For
     * example, calls to <code>revalidate</code>, are pushed upwards to either a
     * <code>JRootPane</code> or a <code>JScrollPane</code> because both classes
     * override <code>isValidateRoot</code> to return true.
     *
    ...
    /**
     * The <code>glassPane</code> and <code>contentPane</code> have the same
     * bounds, which means <code>JRootPane</code> does not tiles its children
     * and this should return false. On the other hand, the
     * <code>glassPane</code> is normally not visible, and so this can return
     * true if the <code>glassPane</code> isn't visible. Therefore, the return
     * value here depends upon the visibility of the <code>glassPane</code>.
     *
    ...
    protected class RootLayout implements LayoutManager2, Serializable {
        ...
        public Dimension preferredLayoutSize(Container parent) {
            ...
            return new Dimension(Math.max(rd.width, mbd.width) + i.left + i.right, rd.height + mbd.height
                    + i.top + i.bottom);
        }
        ...
        public Dimension maximumLayoutSize(Container target) {
            ...
            return new Dimension(Math.min(rd.width, mbd.width) + i.left + i.right, rd.height + mbd.height
                    + i.top + i.bottom);
        }
    ...
    /**
     * Returns a string representation of this <code>JRootPane</code>. This
     ...
     * <code>AccessibleJRootPane</code>. A new <code>AccessibleJRootPane</code>
     ...
     * <code>JRootPane</code> class. It provides an implementation of the Java
     * Accessibility API appropriate to root pane user-interface elements.
     * <p>
     * <strong>Warning:</strong> Serialized objects of this class will not be
     * compatible with future Swing releases. The current serialization support
     * is appropriate for short term storage or RMI between applications running
