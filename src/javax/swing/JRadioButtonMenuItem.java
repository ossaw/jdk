...
public class JRadioButtonMenuItem extends JMenuItem implements Accessible {
    ...
    /**
     * Creates a radio button menu item with the specified text and selection
     * state.
     *
     * @param text
    ...
    /**
     * Creates a radio button menu item with the specified image and selection
     * state, but no text.
     *
     * @param icon
     ...
     * <code>null</code>.
     *
     * @return a string representation of this <code>JRadioButtonMenuItem</code>
     */
    ...
    /**
     * Overriden to return true, JRadioButtonMenuItem supports the selected
     * state.
     */
     ...
     * AccessibleJRadioButtonMenuItem. A new AccessibleJRadioButtonMenuItem
     ...
     * <code>JRadioButtonMenuItem</code> class. It provides an implementation of
     * the Java Accessibility API appropriate to
