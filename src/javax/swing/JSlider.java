 ...
 * "https://docs.oracle.com/javase/tutorial/uiswing/components/slider.html">How
...
public class JSlider extends JComponent implements SwingConstants, Accessible {
    ...
    /**
     * The number of values between the major tick marks -- the larger marks
     * that break up the minor tick marks.
     */
    protected int majorTickSpacing;

    /**
     * The number of values between the minor tick marks -- the smaller marks
     * that occur between the major tick marks.
     * 
    ...
    /**
     * If true, the knob (and the data value it represents) resolve to the
     * closest tick mark next to where the user positioned the knob. The default
     * is false.
     * 
     * @see #setSnapToTicks
     */
    ...
    /**
     * If true, the knob (and the data value it represents) resolve to the
     * closest slider value next to where the user positioned the knob.
     */
    ...
    /**
     * The changeListener (no suffix) is the listener we add to the slider's
     * model. This listener is initialized to the {@code ChangeListener}
     * returned from {@code createChangeListener}, which by default just
     * forwards events to {@code ChangeListener}s (if any) added directly to the
     * slider.
     *
    ...
    /**
     * Creates a slider using the specified orientation with the range {@code 0}
     * to {@code 100} and an initial value of {@code 50}. The orientation can be
     ...
     * initial value equal to the average of the min plus max.
     * <p>
    ...
    /**
     * We pass Change events along to the listeners with the the slider (instead
    ...
    /**
     * Subclasses that want to handle {@code ChangeEvent}s from the model
     * differently can override this to return an instance of a custom
     ...
     * been added directly to the slider.
     * 
     * @see #changeListener
     * @see #fireStateChanged
    ...
    /**
     * Send a {@code ChangeEvent}, whose source is this {@code JSlider}, to all
     * {@code ChangeListener}s that have registered interest in
     ...
     * fundamental properties: minimum, maximum, value.
     * <p>
     * Attempts to pass a {@code null} model to this method result in undefined
    ...
    public void setModel(BoundedRangeModel newModel) {
        ...
        if (accessibleContext != null) {
            accessibleContext.firePropertyChange(AccessibleContext.ACCESSIBLE_VALUE_PROPERTY,
                    (oldModel == null ? null : Integer.valueOf(oldModel.getValue())), (newModel == null ? null
    ...
    /**
     * Sets the slider's current value to {@code n}. This method forwards the
     * new value to the model.
     * <p>
    ...
    public void setValue(int n) {
        ...
        if (accessibleContext != null) {
            accessibleContext.firePropertyChange(AccessibleContext.ACCESSIBLE_VALUE_PROPERTY, Integer.valueOf(
                    oldValue), Integer.valueOf(m.getValue()));
        }
    }
    ...
    /**
     * Sets the slider's minimum value to {@code minimum}. This method forwards
     * the new minimum value to the model.
     * <p>
     * The data model (an instance of {@code BoundedRangeModel}) handles any
     * mathematical issues arising from assigning faulty values. See the
     * {@code BoundedRangeModel} documentation for details.
    ...
    /**
     * Sets the slider's maximum value to {@code maximum}. This method forwards
     * the new maximum value to the model.
     * <p>
     * The data model (an instance of {@code BoundedRangeModel}) handles any
     * mathematical issues arising from assigning faulty values. See the
     * {@code BoundedRangeModel} documentation for details.
    ...
    /**
     * Returns the {@code valueIsAdjusting} property from the model. For details
     * on how this is used, see the {@code setValueIsAdjusting} documentation.
     *
    ...
    /**
     * Sets the model's {@code valueIsAdjusting} property. Slider look and feel
     * implementations should set this property to {@code true} when a knob drag
    ...
    /**
     * Returns the "extent" from the <code>BoundedRangeModel</code>. This
     * represents the range of values "covered" by the knob.
     *
     ...
     * on either side of the knob. This method just forwards the new extent
     * value to the model.
     * <p>
     * The data model (an instance of {@code BoundedRangeModel}) handles any
     * mathematical issues arising from assigning faulty values. See the
     * {@code BoundedRangeModel} documentation for details.
     * <p>
     * If the new extent value is different from the previous extent value, all
     ...
     *           or HORIZONTAL. enum: VERTICAL JSlider.VERTICAL HORIZONTAL
     *           JSlider.HORIZONTAL
     */
    public void setOrientation(int orientation) {
        ...
        if ((oldValue != orientation) && (accessibleContext != null)) {
            accessibleContext.firePropertyChange(AccessibleContext.ACCESSIBLE_STATE_PROPERTY,
                    ((oldValue == VERTICAL) ? AccessibleState.VERTICAL : AccessibleState.HORIZONTAL),
    ...
    public boolean imageUpdate(Image img, int infoflags, int x, int y, int w, int h) {
        ...
        while (elements.hasMoreElements()) {
            ...
            if (component instanceof JLabel) {
                ...
                if (SwingUtilities.doesIconReferenceImage(label.getIcon(), img) || SwingUtilities
                        .doesIconReferenceImage(label.getDisabledIcon(), img)) {
     ...
     *
     * @return the <code>Dictionary</code> containing labels and where to draw
     *         them
     */
     ...
     * key-value pairs are of this format:
     ...
     * Note that the labels are only painted if the {@code paintLabels} property
     * is {@code true}.
     *
     * @param labels
     ...
     * @see #getLabelTable
     * @see #setPaintLabels
     * @beaninfo hidden: true bound: true attribute: visualUpdate true
     ...
     * {@code updateUI} on each label. The UIs are updated from the current look
     ...
     * slider minimum, and using the increment specified. For example, if you
     * call <code>createStandardLabels( 10 )</code> and the slider minimum is
     * zero, then labels will be created for the values 0, 10, 20, 30, and so
     * on.
     * <p>
    ...
    /**
     * Creates a {@code Hashtable} of numerical text labels, starting at the
     * starting point specified, and using the increment specified. For example,
     * if you call <code>createStandardLabels( 10, 2 )</code>, then labels will
     * be created for the values 2, 12, 22, 32, and so on.
     * <p>
     * For the labels to be drawn on the slider, the returned {@code Hashtable}
     * must be passed into {@code setLabelTable}, and {@code setPaintLabels}
     * must be set to {@code true}.
     ...
     * slider's <code>ComponentOrientation</code> property. Normal
     * (non-inverted) horizontal sliders with a
     * <code>ComponentOrientation</code> value of <code>LEFT_TO_RIGHT</code>
     * have their maximum on the right. Normal horizontal sliders with a
     * <code>ComponentOrientation</code> value of <code>RIGHT_TO_LEFT</code>
     * have their maximum on the left. Normal vertical sliders have their
     * maximum on the top. These labels are reversed when the slider is
     * inverted.
     * <p>
     ...
     * values: 0, 10, 20, 30, 40, 50.
     * <p>
     * In order for major ticks to be painted, {@code setPaintTicks} must be set
     * to {@code true}.
     * <p>
     * This method will also set up a label table for you. If there is not
     * already a label table, and the major tick spacing is {@code > 0}, and
     * {@code getPaintLabels} returns {@code true}, a standard label table will
     * be generated (by calling {@code createStandardLabels}) with labels at the
     * major tick marks. For the example above, you would get text labels: "0",
     * "10", "20", "30", "40", "50". The label table is then set on the slider
     ...
     * represents the distance, measured in values, between each minor tick
     * mark. If you have a slider with a range from 0 to 50 and the minor tick
     * spacing is set to 10, you will get minor ticks next to the following
     * values: 0, 10, 20, 30, 40, 50.
     *
     ...
     * values: 0, 10, 20, 30, 40, 50.
     * <p>
     * In order for minor ticks to be painted, {@code setPaintTicks} must be set
     * to {@code true}.
     *
     * @param n
    ...
    /**
     * Returns true if the knob (and the data value it represents) resolve to
    ...
    /**
     * Returns true if the knob (and the data value it represents) resolve to
     * the closest slider value next to where the user positioned the knob.
     *
     ...
     * to the closest tick mark next to where the user positioned the knob. By
    ...
    /**
     * Specifying true makes the knob (and the data value it represents) resolve
     * to the closest slider value next to where the user positioned the knob.
     * If the {@code snapToTicks} property has also been set to {@code true},
     * the snap-to-ticks behavior will prevail. By default, the snapToValue
     ...
     * <p>
     * This method will also set up a label table for you. If there is not
     * already a label table, and the major tick spacing is {@code > 0}, a
     * standard label table will be generated (by calling
     * {@code createStandardLabels}) with labels at the major tick marks. The
     * label table is then set on the slider by calling {@code setLabelTable}.
     * <p>
     ...
     * @see #createStandardLabels(int)
     * @beaninfo bound: true attribute: visualUpdate true description: If true
     *           labels are painted on the slider.
     */
    ...
    protected String paramString() {
        ...
        return super.paramString() + ",isInverted=" + isInvertedString + ",majorTickSpacing="
                ...
                + orientationString + ",paintLabels=" + paintLabelsString + ",paintTicks=" + paintTicksString
                + ",paintTrack=" + paintTrackString + ",snapToTicks=" + snapToTicksString + ",snapToValue="
                + snapToValueString;
    }
     ...
     *
     * @return an AccessibleJSlider that serves as the AccessibleContext of this
     *         JSlider
     */
    ...
    /**
     * This class implements accessibility support for the <code>JSlider</code>
     * class. It provides an implementation of the Java Accessibility API
     * appropriate to slider user-interface elements.
     * <p>
     * <strong>Warning:</strong> Serialized objects of this class will not be
