 ...
 *     System.out.println("You chose to open this file: " + chooser
...
public class JFileChooser extends JComponent implements Accessible {
    ...
    /**
     * Constructs a <code>JFileChooser</code> pointing to the user's default
    ...
    /**
     * Constructs a <code>JFileChooser</code> using the given path. Passing in a
     ...
     *                             a <code>String</code> giving the path to a
     *                             file or directory
     */
     ...
     *                         a <code>File</code> object specifying the path to
     *                         a file or
     *                         directory
     */
    ...
    private void installHierarchyListener() {
        addHierarchyListener(new HierarchyListener() {
            ...
            public void hierarchyChanged(HierarchyEvent e) {
                if ((e.getChangeFlags()
                        & HierarchyEvent.PARENT_CHANGED) == HierarchyEvent.PARENT_CHANGED) {
                    JFileChooser fc = JFileChooser.this;
                    JRootPane rootPane = SwingUtilities.getRootPane(fc);
                    if (rootPane != null) {
                        rootPane.setDefaultButton(fc.getUI().getDefaultButton(
                                fc));
                    }
                }
            }
     ...
     * <code>setSelectedFile</code> or by a user action, such as either typing
     * the filename into the UI or selecting the file from a list in the UI.
     *
     * @see #setSelectedFile
    ...
    public void setSelectedFile(File file) {
        ...
        if (selectedFile != null) {
            if (file.isAbsolute() && !getFileSystemView().isParent(
                    getCurrentDirectory(), selectedFile)) {
     ...
     *           JFileChooser is showing files of.
     *
     * @param dir
     ...
     * example, the following code pops up a file chooser with a
     * "Run Application" button (instead of the normal "Save" or "Open" button):
     * 
     * <pre>
    ...
    public void setControlButtonsAreShown(boolean b) {
        ...
        controlsShown = b;
        firePropertyChange(CONTROL_BUTTONS_ARE_SHOWN_CHANGED_PROPERTY, oldValue,
                controlsShown);
    }
    ...
    /**
     * Sets the type of this dialog. Use <code>OPEN_DIALOG</code> when you want
     * to bring up a file chooser that the user can use to open a file.
     * Likewise, use <code>SAVE_DIALOG</code> for letting the user choose a file
     * for saving. Use <code>CUSTOM_DIALOG</code> when you want to use the file
     * chooser in a context other than "Open" or "Save". For instance, you might
     * want to bring up a file chooser that allows the user to choose a file to
     * execute. Note that you normally would not need to set the
     * <code>JFileChooser</code> to use <code>CUSTOM_DIALOG</code> since a call
     * to <code>setApproveButtonText</code> does this for you. The default
     * dialog type is <code>JFileChooser.OPEN_DIALOG</code>.
     *
     * @param dialogType
     ...
     *                                     if <code>dialogType</code> is not
     *                                     legal
     * @beaninfo preferred: true bound: true description: The type (open, save,
     *           custom) of the JFileChooser. enum: OPEN_DIALOG
     *           JFileChooser.OPEN_DIALOG SAVE_DIALOG JFileChooser.SAVE_DIALOG
    ...
    /**
     * Sets the string that goes in the <code>JFileChooser</code> window's title
     * bar.
     *
     * @param dialogTitle
     ...
     * <code>FileChooserUI</code>. If <code>null</code>, the UI object will
     ...
     *
     * @return a <code>FileFilter</code> array containing all the choosable file
     *         filters
     *
     ...
     * on setting the file selection mode, see {@link #setFileSelectionMode
     * setFileSelectionMode}.
     *
     * @param filter
     *               the <code>FileFilter</code> to add to the choosable file
     *               filter list
     *
        ...
        if (index >= 0) {
            if (getFileFilter() == f) {
                ...
                if (isAcceptAllFileFilterUsed() && (aaff != f)) {
                    ...
                    // choose the second filter, because the first one is
                    // removed
    ...
    /**
     * Returns the <code>AcceptAll</code> file filter. For example, on Microsoft
     * Windows this would be All Files (*.*).
     */
     ...
     *
     * @beaninfo preferred: true bound: true description: Sets whether the
     *           AcceptAll FileFilter is used as an available choice in the
    ...
    /**
     * Sets the <code>JFileChooser</code> to allow the user to just select
    ...
    public void setFileHidingEnabled(boolean b) {
        ...
        if (showFilesListener != null) {
            Toolkit.getDefaultToolkit().removePropertyChangeListener(
                    SHOW_HIDDEN_PROP, showFilesListener);
            showFilesListener = null;
        }
        boolean oldValue = useFileHiding;
        useFileHiding = b;
        firePropertyChange(FILE_HIDING_CHANGED_PROPERTY, oldValue,
                useFileHiding);
    }
     ...
     *
     * @beaninfo preferred: true bound: true description: Sets the File View
     ...
     * 
     * @param fsv
     *            the new <code>FileSystemView</code>
     *
     ...
     *
     * @return the FileChooserUI object that implements the FileChooserUI
     *         L&amp;F
     */
    ...
    /**
     * Returns a string representation of this <code>JFileChooser</code>. This
    ...
    protected String paramString() {
        ...
        String currentDirectoryString = (currentDirectory != null
                ...
                : "");
        String selectedFileString = (selectedFile != null ? selectedFile
                .toString() : "");

        return super.paramString() + ",approveButtonText="
                + approveButtonTextString + ",currentDirectory="
                + currentDirectoryString + ",dialogTitle=" + dialogTitleString
                + ",dialogType=" + dialogTypeString + ",fileSelectionMode="
                + fileSelectionModeString + ",returnValue=" + returnValueString
                + ",selectedFile=" + selectedFileString + ",useFileHiding="
                + useFileHidingString;
    }
    ...
    /**
     * Gets the AccessibleContext associated with this JFileChooser. For file
