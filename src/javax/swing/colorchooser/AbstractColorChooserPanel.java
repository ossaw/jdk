 ...
 * color chooser panel into a <code>JColorChooser</code>, subclass this class.
 * <p>
...
public abstract class AbstractColorChooserPanel extends JPanel {
	...
	/**
	 * Invoked automatically when the model's state changes. It is also called
	 * by <code>installChooserPanel</code> to allow you to set up the initial
	 * state of your chooser. Override this method to update your
	...
	/**
	 * Invoked when the panel is added to the chooser. If you override this, be
	...
	/**
	 * Invoked when the panel is removed from the chooser. If override this, be
	 * sure to call <code>super</code>.
	 */
	 ...
	 * 
	 * @return the <code>ColorSelectionModel</code> model this panel is editing
	 */
	...
	/**
	 * Returns an integer from the defaults table. If <code>key</code> does not
	 * map to a valid <code>Integer</code>, <code>default</code> is returned.
	 *
	 * @param key
	 *            an <code>Object</code> specifying the int
	 * @param defaultValue
	 *            Returned value if <code>key</code> is not available, or is not
	 *            an Integer
	 * @return the int
	 */
