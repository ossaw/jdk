...
final class ColorChooserPanel extends AbstractColorChooserPanel implements
	...
	protected void buildChooser() {
		if (0 == getComponentCount()) {
			...
			this.text.addPropertyChangeListener("value", this); // NON-NLS: the
																// property name
		...
		if (visible) {
			...
			int mnemonic = this.model.getInteger(this, "HexCodeMnemonic"); // NON-NLS:
																			// suffix
			if (mnemonic > 0) {
				this.label.setDisplayedMnemonic(mnemonic);
				mnemonic = this.model.getInteger(this, "HexCodeMnemonicIndex"); // NON-NLS:
																				// suffix
				if (mnemonic >= 0) {
	...
	public int getDisplayedMnemonicIndex() {
		return this.model.getInteger(this, "DisplayedMnemonicIndex"); // NON-NLS:
																		// suffix
	}
