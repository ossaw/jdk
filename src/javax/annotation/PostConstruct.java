 ...
 * request any resources to be injected. Only one method can be annotated with
 * this annotation. The method on which the PostConstruct annotation is applied
