 ...
 * This annotation may be applied to an application component class, or to
 * fields or methods of the component class. When the annotation is applied to a
 * field or method, the container will inject an instance of the requested
 * resource into the application component when the component is initialized. If
 ...
 * specify resources that are needed by the application component. Note that
 * this annotation may appear on private fields and methods of superclasses; the
...
public @interface Resource {
	...
	/**
	 * The Java type of the resource. For field annotations, the default is the
	 * type of the field. For method annotations, the default is the type of the
	 * JavaBeans property. For class annotations, there is no default and this
	 * must be specified.
	 */
	...
	/**
	 * The authentication type to use for this resource. This may be specified
	 * for resources representing a connection factory of any supported type,
	 * and must not be specified for resources of other types.
	 */
	...
	/**
	 * A product specific name that this resource should be mapped to. The name
	 * of this resource, as defined by the <code>name</code> element or
	 * defaulted, is a name that is local to the application component using the
	 * resource. (It's a name in the JNDI <code>java:comp/env</code> namespace.)
	 ...
	 * description can be presented to the Deployer to help in choosing the
	 * correct resource.
	 */
