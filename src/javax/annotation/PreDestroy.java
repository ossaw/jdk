 ...
 * that it has been holding. This annotation MUST be supported by all container
 * managed objects that support PostConstruct except the application client
 * container in Java EE 5. The method on which the PreDestroy annotation is
 * applied MUST fulfill all of the following criteria:
 * <p>
 * <ul>
 * <li>The method MUST NOT have any parameters except in the case of
 * interceptors in which case it takes an InvocationContext object as defined by
 * the Interceptors specification.</li>
 * <li>The method defined on an interceptor class MUST HAVE one of the following
 * signatures:
 * <p>
