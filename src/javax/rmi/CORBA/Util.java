...
public class Util {
     ...
     * <UL>
     * <LI>Find the first non-null <tt>ClassLoader</tt> on the call stack and
     * attempt to load the class using this <tt>ClassLoader</tt>.
     * <LI>If the first step fails, and if <tt>remoteCodebase</tt> is non-null
     * and <tt>useCodebaseOnly</tt> is false, then call
     * <tt>java.rmi.server.RMIClassLoader.loadClass(remoteCodebase, className)</tt>
     * .
     * <LI>If <tt>remoteCodebase</tt> is null or <tt>useCodebaseOnly</tt> is
     * true, then call
     * <tt>java.rmi.server.RMIClassLoader.loadClass(className)</tt>.
     * <LI>If a class was not successfully loaded by step 1, 2, or 3, and
     * <tt>loader</tt> is non-null, then call
     * <tt>loader.loadClass(className)</tt>.
     * <LI>If a class was successfully loaded by step 1, 2, 3, or 4, then return
