...
/**
 * Defines methods which allow serialization of Java objects to and from GIOP
 * streams.
 **/
public interface ValueHandler {
	 ...
	 **/
	java.io.Serializable readValue(org.omg.CORBA.portable.InputStream in, int offset,
			java.lang.Class clz, String repositoryID, org.omg.SendingContext.RunTime sender);
	 ...
	 * CodeBase on the first GIOP reply. The client does the same on the first
	 * GIOP request.
	 * 
