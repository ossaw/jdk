 ...
 * {@link javax.rmi.PortableRemoteObject}. The delegate is a singleton instance
 * of a class that implements this interface and provides a replacement
 * implementation for all the methods of
 * <code>javax.rmi.PortableRemoteObject</code>.
 *
 * Delegates are enabled by providing the delegate's class name as the value of
 * the <code>javax.rmi.CORBA.PortableRemoteObjectClass</code> system property.
 *
