...
public abstract class ServiceUIFactory {
	 ...
	 * 
	 * @param role
	 *            requested. Must be one of the standard roles or a private role
	 ...
	 *             if the role or ui is neither one of the standard ones, nor a
	 ...
	 * from this factory which implement this role. The returned Strings should
	 * refer to the static variables defined in this class so that applications
	 ...
	 * @throws IllegalArgumentException
	 *             is the role is a non-standard role not supported by this
	 *             factory.
	 */
