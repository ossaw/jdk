 ...
 * <code>StreamPrintService</code> always requires an output stream, whereas a
 * <code>PrintService</code> optionally accepts a <code>Destination</code>. A
 * <code>StreamPrintService</code> has no default destination for its formatted
 * output. Additionally a <code>StreamPrintService</code> is expected to
 * generate output in a format useful in other contexts. StreamPrintService's
 * are not expected to support the Destination attribute.
 */
