...
public interface URIException {
	...
	/**
	 * Indicates that the printer cannot access the URI address. For example,
	 * the printer might report this error if it goes to get the print data and
	 * cannot even establish a connection to the URI address.
	 */
	public static final int URIInaccessible = 1;

	/**
	 * Indicates that the printer does not support the URI scheme ("http",
	 * "ftp", etc.) in the URI address.
	 */
