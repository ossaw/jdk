...
/**
 * Class URISyntax is an abstract base class providing the common implementation
 * of all attributes whose value is a Uniform Resource Identifier (URI). Once
 * constructed, a URI attribute's value is immutable.
 * <P>
 *
...
public abstract class URISyntax implements Serializable, Cloneable {
	 ...
	 * <LI><CODE>object</CODE> is an instance of class URISyntax.
	 * <LI>This URI attribute's underlying URI and <CODE>object</CODE>'s
	...
	/**
	 * Returns a String identifying this URI attribute. The String is the string
	 * representation of the attribute's underlying URI.
	 *
