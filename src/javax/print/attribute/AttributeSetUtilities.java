 ...
 * <I>U</I>. However, any attempt to modify <I>U</I>, results in an
 * UnmodifiableSetException. The unmodifiable view object <I>U</I> will be
 * serializable if the attribute set object <I>S</I> is serializable.
 * <P>
 ...
 * later time. IllegalArgumentException and NullPointerException are examples of
...
public final class AttributeSetUtilities {
	 ...
	 *                Thrown if <CODE>attributeSet</CODE> is null. Null is never
	 *                a
	 */
	 ...
	 *
	 * @exception NullPointerException
	 *                (unchecked exception) Thrown if <CODE>object</CODE> is
	 *                null.
	 * @exception ClassCastException
	 *                (unchecked exception) Thrown if <CODE>object</CODE> is not
	 *                a {@link java.lang.Class Class} that implements
	 ...
	 * @exception ClassCastException
	 *                (unchecked exception) Thrown if <CODE>object</CODE> is not
	 *                an instance of <CODE>interfaceName</CODE>.
	 */
	 ...
	 *
	 * @exception NullPointerException
	 *                (unchecked exception) Thrown if the <CODE>category</CODE>
	 *                is null or if the <CODE>attribute</CODE> is null.
	 * @exception IllegalArgumentException
	 *                (unchecked exception) Thrown if the <CODE>category</CODE>
	 *                is not equal to the category of the <CODE>attribute</CODE>
	 *                .
	 */
