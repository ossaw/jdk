 ...
 * also report a JobOriginatingUserName in the job's attribute set. Note that
 * many print services may have a way to independently authenticate the user
 * name, and so may state support for a requesting user name, but in practice
 * will then report the user name authenticated by the service rather than that
 * specified via this attribute.
 * <P>
