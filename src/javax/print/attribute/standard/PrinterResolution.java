...
/**
 * Class PrinterResolution is a printing attribute class that specifies an exact
 * resolution supported by a printer or to be used for a print job. This
 ...
 * instance of class PrinterResolution indicating the exact resolution the
 * client wants. Only printers supporting that exact resolution will match the
 * search.
 * <P>
 * <LI>When a client needs to print a job using the client's desired resolution
 ...
 * Print Job doesn't support that exact resolution, and Fidelity is set to true.
 * </OL>
 ...
 * some cases this may be more simply achieved by specifying a PrintQuality
