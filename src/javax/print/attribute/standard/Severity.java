 ...
 * directly. Rather, a {@link PrinterStateReasons PrinterStateReasons} attribute
 * appears in the Print Service's attribute set. The {@link PrinterStateReasons
 ...
 * PrinterStateReason} object is associated with a Severity level of REPORT
 * (least severe), WARNING, or ERROR (most severe). The printer adds a
 ...
 * <P>
 * <B>IPP Compatibility:</B> <code>Severity.toString()</code> returns either
 * "error", "warning", or "report". The string values returned by each
 * individual {@link PrinterStateReason} and associated {@link Severity}
 * object's <CODE>toString()</CODE> methods, concatenated together with a hyphen
