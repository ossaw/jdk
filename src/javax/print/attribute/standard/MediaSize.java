...
public class MediaSize extends Size2DSyntax implements Attribute {
	 ...
	 *                (Unchecked exception) Thrown if {@code x < 0} or
	 *                {@code y < 0} or {@code units < 1} or {@code x > y}.
	 */
	 ...
	 * @exception IllegalArgumentException
	 *                if {@code x <= 0}, {@code y <= 0}, or {@code units < 1}.
	 *
	 */
	...
	public final static class Engineering {
		 ...
		 */
		public static final MediaSize B = new MediaSize(11.0f, 17.0f, Size2DSyntax.INCH,
				MediaSizeName.B);
		/**
		 * Specifies the engineering C size, 17 inch by 22 inch.
		 */
		public static final MediaSize C = new MediaSize(17.0f, 22.0f, Size2DSyntax.INCH,
				MediaSizeName.C);
		/**
		 * Specifies the engineering D size, 22 inch by 34 inch.
		 */
		public static final MediaSize D = new MediaSize(22.0f, 34.0f, Size2DSyntax.INCH,
				MediaSizeName.D);
		/**
		 * Specifies the engineering E size, 34 inch by 44 inch.
		 */
		public static final MediaSize E = new MediaSize(34.0f, 44.0f, Size2DSyntax.INCH,
				MediaSizeName.E);
