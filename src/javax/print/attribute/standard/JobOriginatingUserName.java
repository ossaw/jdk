...
/**
 * Class JobOriginatingUserName is a printing attribute class, a text attribute,
 * that contains the name of the end user that submitted the print job. If
 * possible, the printer sets this attribute to the most authenticated printable
 * user name that it can obtain from the authentication service that
...
public final class JobOriginatingUserName extends TextSyntax implements
     ...
     * <LI><CODE>object</CODE> is an instance of class JobOriginatingUserName.
