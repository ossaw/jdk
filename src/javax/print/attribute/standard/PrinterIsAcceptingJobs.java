 ...
 * value is independent of the {@link PrinterState PrinterState} and
 ...
 * {@link PrinterState PrinterState} is IDLE. If value is ACCEPTING_JOBS, the
 * Printer will accept jobs even when the {@link PrinterState PrinterState} is
 * STOPPED.
 * <P>
...
public final class PrinterIsAcceptingJobs extends EnumSyntax implements PrintServiceAttribute {
	...
	private static final PrinterIsAcceptingJobs[] myEnumValueTable = { NOT_ACCEPTING_JOBS,
			ACCEPTING_JOBS };
