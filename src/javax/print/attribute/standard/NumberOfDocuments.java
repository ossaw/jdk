...
public final class NumberOfDocuments extends IntegerSyntax implements PrintJobAttribute {
	 ...
	 * <LI><CODE>object</CODE> is an instance of class NumberOfDocuments.
	 * <LI>This number of documents attribute's value and <CODE>object</CODE>'s
	 * value are equal.
	 * </OL>
	 *
	 * @param object
	 ...
	 * <P>
	 * For class NumberOfDocuments, the category is class NumberOfDocuments
	 * itself.
	 *
