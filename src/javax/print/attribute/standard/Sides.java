 ...
 * separate. Each media sheet will consist of <I>n</I> impressions from the
 ...
 * <P>
 * <LI>SEPARATE_DOCUMENTS_UNCOLLATED_COPIES -- The input docs will remain
 * separate. For input doc <I>i,</I> each media sheet will consist of <I>n
 * <SUB>i</SUB></I> impressions from the input doc. Since the input docs are
 * separate, the first impression of each input doc will always start on a new
 * media sheet; this means the last media sheet of an input doc may have only
 * one impression on it.
 * <P>
 * <LI>SEPARATE_DOCUMENTS_COLLATED_COPIES -- The input docs will remain
 * separate. For input doc <I>i,</I> each media sheet will consist of <I>n
 * <SUB>i</SUB></I> impressions from the input doc. Since the input docs are
...
public final class Sides extends EnumSyntax implements DocAttribute, PrintRequestAttribute,
        PrintJobAttribute {
