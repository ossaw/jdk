 ...
 * specifies monochrome or color printing. This is used by a print client to
 * specify how the print data should be generated or processed. It is not
 ...
 * Attribute</TH>
 * <TH>Effect on<BR>
 * Monochrome Document</TH>
 * <TH>Effect on<BR>
 * Color Document</TH>
 * </TR>
 * <TR>
 * <TD>{@link #MONOCHROME MONOCHROME}</TD>
 * <TD>Printed as is, in monochrome</TD>
 * <TD>Printed in monochrome, with colors converted to shades of gray</TD>
 * </TR>
 * <TR>
 * <TD>{@link #COLOR COLOR}</TD>
 * <TD>Printed as is, in monochrome</TD>
 * <TD>Printed as is, in color</TD>
 * </TR>
 * </TABLE>
 * <P>
 * <P>
