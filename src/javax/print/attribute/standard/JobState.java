 ...
 * current state of a print job. Class JobState defines standard job state
 * values. A Print Service implementation only needs to report those job states
 * which are appropriate for the particular implementation; it does not have to
 * report every defined job state. The {@link JobStateReasons JobStateReasons}
...
public class JobState extends EnumSyntax implements PrintJobAttribute {
	 ...
	 * stopped, the PRINTER_STOPPED value may be included in the job's
	...
	private static final String[] myStringTable = { "unknown", null, null, "pending",
	 ...
	 * instance.
	 * <P>
	 * For class JobState and any vendor-defined subclasses, the category name
	 * is <CODE>"job-state"</CODE>.
	 *
