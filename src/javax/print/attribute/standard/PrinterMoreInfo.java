 ...
 * obtain more information about this specific printer. For example, this could
 * be an HTTP type URI referencing an HTML page accessible to a web browser. The
 * information obtained from this URI is intended for end user consumption.
 * Features outside the scope of the Print Service API can be accessed from this
 * URI. The information is intended to be specific to this printer instance and
