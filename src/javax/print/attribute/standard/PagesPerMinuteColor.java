...
public final class PagesPerMinuteColor extends IntegerSyntax implements PrintServiceAttribute {
	 ...
	 * <LI><CODE>object</CODE> is an instance of class PagesPerMinuteColor.
	 * <LI>This pages per minute attribute's value and <CODE>object</CODE>'s
	 * value are equal.
	 * </OL>
	 *
	 * @param object
	 ...
	 * <P>
	 * For class PagesPerMinuteColor, the category is class PagesPerMinuteColor
	 * itself.
	 *
	 ...
	 * <CODE>"pages-per-minute-color"</CODE>.
	 *
