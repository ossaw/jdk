 ...
 * indicate an alternate destination for the spooled printer formatted data.
 * Many PrintServices will not support the notion of a destination other than
 * the printer device, and so will not support this attribute.
 * <p>
 ...
 * construction of "file:" scheme URI instances should be performed using the
 * <code>toURI()</code> method of class {@link java.io.File File}. See the
 * documentation on that class for more information.
 * <p>
 * If a destination URI is specified in a PrintRequest and it is not accessible
 * for output by the PrintService, a PrintException will be thrown. The
 * PrintException may implement URIException to provide a more specific cause.
 * <P>
