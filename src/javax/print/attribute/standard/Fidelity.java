 ...
 * whether total fidelity to client supplied print request attributes is
 * required. If FIDELITY_TRUE is specified and a service cannot print the job
 ...
 * IPP string representation of the attribute value. See
