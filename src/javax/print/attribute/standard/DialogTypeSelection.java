 ...
 * indicates the user dialog type to be used for specifying printing options. If
...
public final class DialogTypeSelection extends EnumSyntax implements
	...
	/**
	 * Construct a new dialog type selection enumeration value with the given
	 * integer value.
	 *
	 * @param value
	 *              Integer value.
	 ...
	 * <P>
	 * For class DialogTypeSelection the category is class DialogTypeSelection
	 * itself.
	 *
