 ...
 * values, that provides additional information about the printer's current
 ...
 * Print Service's status, and each {@link PrinterStateReason
 * PrinterStateReason} object is associated with a {@link Severity Severity}
 * level of REPORT (least severe), WARNING, or ERROR (most severe). The printer
 * adds a {@link PrinterStateReason PrinterStateReason} object to the Print
 * Service's PrinterStateReasons attribute when the corresponding condition
 ...
 * {@link java.util.HashMap java.util.HashMap}. Each entry in the map consists
 * of a {@link PrinterStateReason PrinterStateReason} object (key) mapping to a
 ...
 * {@link java.util.HashMap java.util.HashMap}, class PrinterStateReasons is not
 ...
 * concatenated together with a hyphen (<CODE>"-"</CODE>) in between, gives the
 * IPP keyword value. The category name returned by <CODE>getName()</CODE> gives
...
public final class PrinterStateReasons extends HashMap<PrinterStateReason, Severity>
	 ...
	 *                (unchecked exception) Thrown if <CODE>map</CODE> is null
	 *                or if any key or value in <CODE>map</CODE> is null.
	 * @throws ClassCastException
	 *             (unchecked exception) Thrown if any key in <CODE>map</CODE>
	 *             is not an instance of class {@link PrinterStateReason
	 *             PrinterStateReason} or if any value in <CODE>map</CODE> is
	 *             not an instance of class {@link Severity Severity}.
	 */
	 ...
	 * @param severity
	 *            Severity of the printer state reason. This must be an instance
	 ...
	 *             (unchecked exception) Thrown if <CODE>reason</CODE> is null
	 ...
	 *             PrinterStateReason} or if <CODE>severity</CODE> is not an
	 ...
	 *
	 * @exception NullPointerException
	 *                (unchecked exception) Thrown if <CODE>severity</CODE> is
	 *                null.
	 */
