 ...
 * <P>
 * If a PageRanges attribute is not specified for a print job, all pages of the
 * document will be printed. In other words, the default value for the
 ...
 * <P>
 * <LI>SEPARATE_DOCUMENTS_UNCOLLATED_COPIES -- For each separate input doc, the
 * specified page ranges will be printed.
 * <P>
 * <LI>SEPARATE_DOCUMENTS_COLLATED_COPIES -- For each separate input doc, the
 * specified page ranges will be printed.
 * </UL>
 * <UL>
 * <LI>SEPARATE_DOCUMENTS_UNCOLLATED_COPIES -- For each separate input doc, its
 * own specified page ranges will be printed..
 * <P>
 * <LI>SEPARATE_DOCUMENTS_COLLATED_COPIES -- For each separate input doc, its
 * own specified page ranges will be printed..
 * </UL>
 * </UL>
 * <P>
...
public final class PageRanges extends SetOfIntegerSyntax
	 ...
	 *                not obey the proper syntax. Also thrown if the constructed
	 *                set-of-integer is a zero-length array or if any member of
