...
/**
 * Class Media is a printing attribute class that specifies the medium on which
 * to print.
 * <p>
 ...
 * <p>
 * A Media object is constructed with a value which represents one of the ways
 * in which the Media attribute can be specified.
 * <p>
...
public abstract class Media extends EnumSyntax
	 ...
	 * <LI><CODE>object</CODE> is of the same subclass of Media as this object.
	 ...
	 * <P>
	 * For class Media and any vendor-defined subclasses, the category is class
	 * Media itself.
	 *
