 ...
 * finishings. <code>PrintService</code> provides the method to query the
 * supported values of an attribute in a suitable context : See
 * {@link javax.print.PrintService#getSupportedAttributeValues(Class,DocFlavor, AttributeSet)
...
public final class MediaPrintableArea implements DocAttribute, PrintRequestAttribute, PrintJobAttribute {
    ...
    /**
     * Get the x location of the origin of the printable area in the specified
     * units.
     * 
     * @param units
     *        Unit conversion factor, e.g. {@link #INCH INCH} or
    ...
    /**
     * Get the y location of the origin of the printable area in the specified
     * units.
     * 
     * @param units
     *        Unit conversion factor, e.g. {@link #INCH INCH} or
     ...
     * <LI><CODE>object</CODE> is an instance of class MediaPrintableArea.
     ...
     * <P>
     * For class MediaPrintableArea, the category is class MediaPrintableArea
     * itself.
     *
