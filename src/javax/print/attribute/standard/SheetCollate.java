 ...
 * in this case six copies of the first media sheet are printed followed by six
 * copies of the second media sheet.
 * <P>
 ...
 * following combinations of SheetCollate and {@link MultipleDocumentHandling
 ...
 * will be produced with pages in collated order, i.e. pages 1, 2, 3, . . ., 1,
 * 2, 3, . . .
 * <P>
 * <LI>SheetCollate = COLLATED, {@link MultipleDocumentHandling
 ...
 * output document will be produced with pages in collated order, i.e. pages 1,
 * 2, 3, . . ., 1, 2, 3, . . .
 * <P>
 * <LI>SheetCollate = COLLATED, {@link MultipleDocumentHandling
 ...
 * MultipleDocumentHandling} = SINGLE_DOCUMENT -- All the input docs will be
 * combined into one output document. Multiple copies of the output document
 * will be produced with pages in uncollated order, i.e. pages 1, 1, . . ., 2,
 * 2, . . ., 3, 3, . . .
 * <P>
 * <LI>SheetCollate = UNCOLLATED, {@link MultipleDocumentHandling
 * MultipleDocumentHandling} = SINGLE_DOCUMENT_NEW_SHEET -- All the input docs
