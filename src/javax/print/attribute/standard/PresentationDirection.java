 ...
 * indicate the layout of multiple print-stream pages to impose upon a single
 * side of an instance of a selected medium. This is useful to mirror the text
 * layout conventions of different scripts. For example, English is
 * "toright-tobottom", Hebrew is "toleft-tobottom" and Japanese is usually
 * "tobottom-toleft".
 * <P>
 ...
 * 1.1. The category name returned by <CODE>getName()</CODE> is the IPP
...
public final class PresentationDirection extends EnumSyntax
	...
	private static final String[] myStringTable = { "tobottom-toright", "tobottom-toleft",
			"totop-toright", "totop-toleft", "toright-tobottom", "toright-totop", "toleft-tobottom",
			"toleft-totop", };

	private static final PresentationDirection[] myEnumValueTable = { TOBOTTOM_TORIGHT,
	 ...
	 * <CODE>"presentation-direction"</CODE>.
	 *
