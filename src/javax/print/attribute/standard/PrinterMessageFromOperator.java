 ...
 * "intelligent" process to indicate to the end user information about or status
 * of the printer, such as why it is unavailable or when it is expected to be
 * available.
 * <P>
 ...
 * PrinterMessageFromOperator is not intended to be a history log. If it wishes,
 * the client can detect changes to a Print Service's PrinterMessageFromOperator
...
public final class PrinterMessageFromOperator extends TextSyntax implements PrintServiceAttribute {
     ...
     * <LI><CODE>object</CODE> is an instance of class
     * PrinterMessageFromOperator.
     * <LI>This printer message from operator attribute's underlying string and
     ...
     * <P>
     * For class PrinterMessageFromOperator, the category is class
     * PrinterMessageFromOperator itself.
     *
     ...
     * instance.
     * <P>
     * For class PrinterMessageFromOperator, the category name is
