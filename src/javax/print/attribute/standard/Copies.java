 ...
 * <UL>
 * <LI>SINGLE_DOCUMENT -- The result will be <I>n</I> copies of a single output
 * document comprising all the input docs.
 * <P>
 * <LI>SINGLE_DOCUMENT_NEW_SHEET -- The result will be <I>n</I> copies of a
 * single output document comprising all the input docs, and the first
 * impression of each input doc will always start on a new media sheet.
 * <P>
 * <LI>SEPARATE_DOCUMENTS_UNCOLLATED_COPIES -- The result will be <I>n</I>
 * copies of the first input document, followed by <I>n</I> copies of the second
 * input document, . . . followed by <I>n</I> copies of the last input document.
 * <P>
 * <LI>SEPARATE_DOCUMENTS_COLLATED_COPIES -- The result will be the first input
