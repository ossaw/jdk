 ...
 * IPP string representation of the attribute value. For a subclass, the
 * attribute value must be localized to give the IPP name and natural language
 * values.
 * <P>
 *
...
public class JobSheets extends EnumSyntax implements PrintRequestAttribute,
	 ...
	 * instance.
	 * <P>
	 * For class JobSheets and any vendor-defined subclasses, the category name
	 * is <CODE>"job-sheets"</CODE>.
	 *
