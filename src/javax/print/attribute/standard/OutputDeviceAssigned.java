 ...
 * that identifies the output device to which the service has assigned this job.
 * If an output device implements an embedded Print Service instance, the
 * printer need not set this attribute. If a print server implements a Print
 * Service instance, the value may be empty (zero- length string) or not
...
public final class OutputDeviceAssigned extends TextSyntax implements PrintJobAttribute {
	 ...
	 * <LI><CODE>object</CODE> is an instance of class OutputDeviceAssigned.
	 * <LI>This output device assigned attribute's underlying string and
	 * <CODE>object</CODE>'s underlying string are equal.
	 * <LI>This output device assigned attribute's locale and
