...
public final class PrinterMakeAndModel extends TextSyntax implements PrintServiceAttribute {
     ...
     * <LI><CODE>object</CODE> is an instance of class PrinterMakeAndModel.
     * <LI>This printer make and model attribute's underlying string and
     * <CODE>object</CODE>'s underlying string are equal.
     * <LI>This printer make and model attribute's locale and
     ...
     * <P>
     * For class PrinterMakeAndModel, the category is class PrinterMakeAndModel
     * itself.
     *
     ...
     * <CODE>"printer-make-and-model"</CODE>.
     *
