 ...
 * standard printer state values. A Print Service implementation only needs to
 * report those printer states which are appropriate for the particular
 ...
 * PrinterState attribute to give more detailed information about the printer in
 * given printer state.
 * <P>
...
public final class PrinterState extends EnumSyntax implements PrintServiceAttribute {
	...
	private static final String[] myStringTable = { "unknown", null, null, "idle", "processing",
			"stopped" };

	private static final PrinterState[] myEnumValueTable = { UNKNOWN, null, null, IDLE, PROCESSING,
			STOPPED };
