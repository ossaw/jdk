 ...
 * {@link java.util.Date Date} from the DateTimeAtCreation attribute.
 * <P>
...
public final class DateTimeAtCreation extends DateTimeSyntax implements
	 ...
	 * <LI><CODE>object</CODE> is an instance of class DateTimeAtCreation.
	 * <LI>This date-time at creation attribute's {@link java.util.Date Date}
	 ...
	 * <P>
	 * For class DateTimeAtCreation, the category is class DateTimeAtCreation
	 * itself.
	 *
