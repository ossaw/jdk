 ...
 * does not describe the orientation of the client-supplied print-stream pages.
 * <P>
 ...
 * job template attribute, since a print job can always impose constraints among
 * the values of different job template attributes. However, a special mention
 ...
 */
public final class OrientationRequested extends EnumSyntax implements DocAttribute, PrintRequestAttribute,
        PrintJobAttribute {
     ...
     * REVERSE_PORTRAIT value was added for use with the {@link Finishings
     * Finishings} attribute in cases where the opposite edge is desired for
     * finishing a portrait document on simple finishing devices that have only
     * one finishing position. Thus a <CODE>"text/plain"</CODE> portrait
