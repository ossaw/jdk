...
public final class JobName extends TextSyntax implements PrintRequestAttribute, PrintJobAttribute {
	 ...
	 *                (unchecked exception) Thrown if <CODE>jobName</CODE> is
	 *                null.
	 */
	 ...
	 * <LI><CODE>object</CODE> is an instance of class JobName.
	 * <LI>This job name attribute's underlying string and <CODE>object</CODE>'s
	 * underlying string are equal.
	 * <LI>This job name attribute's locale and <CODE>object</CODE>'s locale are
	 * equal.
	 * </OL>
	 *
	 * @param object
