 ...
 * jobs (jobs with multiple documents), the {@link MultipleDocumentHandling
 * MultipleDocumentHandling} attribute determines what constitutes a "copy" for
 ...
 * <TD STYLE="WIDTH:27%">{@link #NONE NONE}</TD>
 * <TD STYLE="WIDTH:27%">{@link #STAPLE STAPLE}</TD>
 * <TD STYLE="WIDTH:36%">{@link #EDGE_STITCH EDGE_STITCH}</TD>
 * </TR>
 * <TR>
 * <TD>&nbsp;</TD>
 * <TD>{@link #BIND BIND}</TD>
 * <TD>{@link #SADDLE_STITCH SADDLE_STITCH}</TD>
 * <TD>{@link #COVER COVER}</TD>
 * <TD>&nbsp;</TD>
 * </TR>
 * </TABLE>
 * <P>
 * The following Finishings values are more specific; they indicate a corner or
 * an edge as if the document were a portrait document:
 * <TABLE BORDER=0 CELLPADDING=0 CELLSPACING=0 WIDTH=100% SUMMARY="layout">
 * <TR>
 * <TD STYLE="WIDTH:10%">&nbsp;</TD>
 * <TD STYLE="WIDTH:27%">{@link #STAPLE_TOP_LEFT STAPLE_TOP_LEFT}</TD>
 * <TD STYLE="WIDTH:27%">{@link #EDGE_STITCH_LEFT EDGE_STITCH_LEFT}</TD>
 * <TD STYLE="WIDTH:27%">{@link #STAPLE_DUAL_LEFT STAPLE_DUAL_LEFT}</TD>
 * <TD STYLE="WIDTH:9%">&nbsp;</TD>
 * </TR>
 * <TR>
 * <TD STYLE="WIDTH:10%">&nbsp;</TD>
 * <TD STYLE="WIDTH:27%">{@link #STAPLE_BOTTOM_LEFT STAPLE_BOTTOM_LEFT}</TD>
 * <TD STYLE="WIDTH:27%">{@link #EDGE_STITCH_TOP EDGE_STITCH_TOP}</TD>
 * <TD STYLE="WIDTH:27%">{@link #STAPLE_DUAL_TOP STAPLE_DUAL_TOP}</TD>
 * <TD STYLE="WIDTH:9%">&nbsp;</TD>
 * </TR>
 * <TR>
 * <TD STYLE="WIDTH:10%">&nbsp;</TD>
 * <TD STYLE="WIDTH:27%">{@link #STAPLE_TOP_RIGHT STAPLE_TOP_RIGHT}</TD>
 * <TD STYLE="WIDTH:27%">{@link #EDGE_STITCH_RIGHT EDGE_STITCH_RIGHT}</TD>
 * <TD STYLE="WIDTH:27%">{@link #STAPLE_DUAL_RIGHT STAPLE_DUAL_RIGHT}</TD>
 * <TD STYLE="WIDTH:9%">&nbsp;</TD>
 * </TR>
 * <TR>
 * <TD STYLE="WIDTH:10%">&nbsp;</TD>
 * <TD STYLE="WIDTH:27%">{@link #STAPLE_BOTTOM_RIGHT STAPLE_BOTTOM_RIGHT}</TD>
 * <TD STYLE="WIDTH:27%">{@link #EDGE_STITCH_BOTTOM EDGE_STITCH_BOTTOM}</TD>
 * <TD STYLE="WIDTH:27%">{@link #STAPLE_DUAL_BOTTOM STAPLE_DUAL_BOTTOM}</TD>
 * <TD STYLE="WIDTH:9%">&nbsp;</TD>
 * </TR>
 * </TABLE>
 * <P>
 ...
 * supplies the STAPLE_BOTTOM_LEFT value (since landscape is defined as a +90
 * degree rotation from portrait, i.e., anti-clockwise). On the other hand, to
 * position a staple in the upper left hand corner of a reverse-landscape
 * document when held for reading, the client supplies the STAPLE_TOP_RIGHT
 * value (since reverse-landscape is defined as a -90 degree rotation from
 ...
 * the (perhaps defaulted) value of the {@link MultipleDocumentHandling
 ...
 * the printer's processing depends on the {@link MultipleDocumentHandling
 * MultipleDocumentHandling} value:
 * <UL>
 * <LI>SINGLE_DOCUMENT -- All the input docs will be bound together as one
 * output document with the specified binding.
 * <P>
 * <LI>SINGLE_DOCUMENT_NEW_SHEET -- All the input docs will be bound together as
 * one output document with the specified binding, and the first impression of
 * each input doc will always start on a new media sheet.
 * <P>
 * <LI>SEPARATE_DOCUMENTS_UNCOLLATED_COPIES -- Each input doc will be bound
 * separately with the specified binding.
 * <P>
 * <LI>SEPARATE_DOCUMENTS_COLLATED_COPIES -- Each input doc will be bound
 * separately with the specified binding.
 * </UL>
 * <P>
 * <LI>If different docs have different bindings specified, then only two values
 * of {@link MultipleDocumentHandling MultipleDocumentHandling} make sense, and
 * the printer reports an error when the job is submitted if any other value is
 * specified:
 * <UL>
 * <LI>SEPARATE_DOCUMENTS_UNCOLLATED_COPIES -- Each input doc will be bound
 ...
 * of enums. The category name returned by <CODE>getName()</CODE> is the IPP
 * attribute name. The enumeration's integer value is the IPP enum value. The
 * <code>toString()</code> method returns the IPP string representation of the
...
public class Finishings extends EnumSyntax implements DocAttribute, PrintRequestAttribute, PrintJobAttribute {
    ...
    private static final String[] myStringTable = { "none", "staple", null, "cover", "bind", "saddle-stitch",
            "edge-stitch", null, // The next ten enum values
            // are reserved.
            null, null, null, null, null, null, null, null, null, "staple-top-left", "staple-bottom-left",
            "staple-top-right", "staple-bottom-right", "edge-stitch-left", "edge-stitch-top",
            "edge-stitch-right", "edge-stitch-bottom", "staple-dual-left", "staple-dual-top",
            "staple-dual-right", "staple-dual-bottom" };

    private static final Finishings[] myEnumValueTable = { NONE, STAPLE, null, COVER, BIND, SADDLE_STITCH,
            EDGE_STITCH, null, // The next ten enum values are
            // reserved.
            null, null, null, null, null, null, null, null, null, STAPLE_TOP_LEFT, STAPLE_BOTTOM_LEFT,
            STAPLE_TOP_RIGHT, STAPLE_BOTTOM_RIGHT, EDGE_STITCH_LEFT, EDGE_STITCH_TOP, EDGE_STITCH_RIGHT,
            EDGE_STITCH_BOTTOM, STAPLE_DUAL_LEFT, STAPLE_DUAL_TOP, STAPLE_DUAL_RIGHT, STAPLE_DUAL_BOTTOM };
