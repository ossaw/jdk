...
/**
 * Class PrinterMoreInfoManufacturer is a printing attribute class, a URI, that
 * is used to obtain more information about this type of device. The information
 * obtained from this URI is intended for end user consumption. Features outside
 * the scope of the Print Service API can be accessed from this URI (e.g.,
 * latest firmware, upgrades, service proxies, optional features available,
 * details on color support). The information is intended to be germane to this
 * kind of printer without regard to site specific modifications or services.
 * <P>
...
public final class PrinterMoreInfoManufacturer extends URISyntax implements
	 ...
	 * <LI>This printer more info manufacturer attribute's URI and
