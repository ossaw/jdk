 ...
 * string defined by the client. However if a JobName is not specified, the
 * DocumentName should be used instead, which implies that supporting
 * specification of DocumentName requires reporting of JobName and vice versa.
