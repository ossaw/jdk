 ...
 * <CODE>0</CODE> through <CODE>9</CODE>). Whitespace characters cannot appear
 * within an integer but are otherwise ignored. For example: <CODE>""</CODE>,
 * <CODE>"1"</CODE>, <CODE>"5-10"</CODE>, <CODE>"1:2,
 * 4"</CODE>.
 * <P>
 ...
 * where each integer group is a length-1 or length-2 array of <CODE>int</CODE>
 * s; for example, <CODE>int[0][]</CODE>, <CODE>int[][]{{1}}</CODE>,
 * <CODE>int[][]{{5,10}}</CODE>, <CODE>int[][]{{1,2},{4}}</CODE>.
 * <P>
 ...
 * canonical array form, to test whether a given integer is a member of the set,
 * and to iterate through the members of the set.
 * <P>
 *
...
public abstract class SetOfIntegerSyntax implements Serializable, Cloneable {
	 ...
	 *                (Unchecked exception) Thrown if <CODE>members</CODE> does
	 ...
	 *                array or if any non-null range in <CODE>members</CODE> has
	 ...
	 * <LI><CODE>object</CODE> is an instance of class SetOfIntegerSyntax.
	 * <LI>This set-of-integer attribute's members and <CODE>object</CODE>'s
