...
/**
 * Class HashPrintServiceAttributeSet provides an attribute set which inherits
 ...
 */
public class HashPrintServiceAttributeSet extends HashAttributeSet implements PrintServiceAttributeSet,
        Serializable {
     ...
     * the elements of <CODE>attributes</CODE> array to the set in sequence,
     ...
     * the <code>PrintServiceAttribute</code> interface.
     *
     * @param attributes
