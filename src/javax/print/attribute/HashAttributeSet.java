...
/**
 * Class HashAttributeSet provides an <code>AttributeSet</code> implementation
 * with characteristics of a hash map.
 * <P>
 *
...
public class HashAttributeSet implements AttributeSet, Serializable {
    ...
    /*
     * A HashMap used by the implementation. The serialised form doesn't include
     ...
     * elements of <CODE>attributes</CODE> array to the set in sequence,
     ...
     *
     * @param attributes
     *        Set of attributes from which to initialise this set. If
     *        null,
     ...
     *
     * @param interfaceName
     *        The interface of which all members of this attribute
     *        set must
     *        be an instance. It is assumed to be interface
     *        {@link Attribute
     ...
     * earlier array elements if the array contains duplicate attribute values
     ...
     *            (unchecked exception) Thrown if any
     *            element of
     *            <CODE>attributes</CODE> is not an
     *            instance of
     *            <CODE>interfaceName</CODE>.
     */
    ...
    public Attribute get(Class<?> category) {
        return (Attribute) attrMap.get(AttributeSetUtilities.verifyAttributeCategory(category,
                Attribute.class));
    }
    ...
    public boolean add(Attribute attribute) {
        Object oldAttribute = attrMap.put(attribute.getCategory(), AttributeSetUtilities.verifyAttributeValue(
                attribute, myInterface));
        return (!attribute.equals(oldAttribute));
    }

    /**
     * Removes any attribute for this category from this attribute set if
     * present. If <CODE>category</CODE> is null, then <CODE>remove()</CODE>
    ...
    public boolean remove(Class<?> category) {
        return category != null && AttributeSetUtilities.verifyAttributeCategory(category,
                Attribute.class) != null && attrMap.remove(category) != null;
    }

    /**
     * Removes the specified attribute from this attribute set if present. If
     * <CODE>attribute</CODE> is null, then <CODE>remove()</CODE> does nothing
    ...
    /**
     * Returns <tt>true</tt> if this attribute set contains an attribute for the
     * specified category.
     *
     * @param category
    ...
    public boolean containsKey(Class<?> category) {
        return category != null && AttributeSetUtilities.verifyAttributeCategory(category,
                Attribute.class) != null && attrMap.get(category) != null;
    }
    ...
    public boolean containsValue(Attribute attribute) {
        return attribute != null && attribute instanceof Attribute && attribute.equals(attrMap.get(
                ((Attribute) attribute).getCategory()));
    }
     ...
     * <CODE>addAll(AttributeSet)</CODE> operation is unspecified if the
     ...
     * value mappings. This ensures that the <tt>equals()</tt> method works
     ...
     * the AttributeSet. This ensures that <tt>t1.equals(t2)</tt> implies that
