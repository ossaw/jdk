...
public class HashAttributeSet implements AttributeSet, Serializable {
	 ...
	 *
	 * @param attributes
	 *            Set of attributes from which to initialise this set. If null,
	 ...
	 *
	 * @param interfaceName
	 *            The interface of which all members of this attribute set must
	 *            be an instance. It is assumed to be interface {@link Attribute
	 ...
	 *                (unchecked exception) Thrown if <CODE>attribute</CODE> is
	 *                not an instance of <CODE>interfaceName</CODE>.
	 */
	...
	public Attribute get(Class<?> category) {
		return (Attribute) attrMap
				.get(AttributeSetUtilities.verifyAttributeCategory(category, Attribute.class));
	}
	...
	public boolean add(Attribute attribute) {
		Object oldAttribute = attrMap.put(attribute.getCategory(),
				AttributeSetUtilities.verifyAttributeValue(attribute, myInterface));
