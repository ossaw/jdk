 ...
 * looking for U.S. letter sized media in metric units, you have to search for a
 * media size of 215.9 x 279.4 mm; rounding off to an integral 216 x 279 mm will
 * not match.
 * <P>
...
public abstract class Size2DSyntax implements Serializable, Cloneable {
	 ...
	 * @param units
	 *            Unit conversion factor, e.g. {@link #INCH <CODE>INCH</CODE>}
	 *            or {@link #MM <CODE>MM</CODE>}.
	 *
	 ...
	 *
	 * @param unitsName
	 *            Units name string, e.g. {@code in} or {@code mm}. If null, no
	 ...
	 * <LI><CODE>object</CODE> is an instance of class Size2DSyntax.
	 * <LI>This attribute's X dimension is equal to <CODE>object</CODE>'s X
	 * dimension.
	 * <LI>This attribute's Y dimension is equal to <CODE>object</CODE>'s Y
	 * dimension.
	 * </OL>
	 *
	 * @param object
	 ...
	 *
	 * @return True if <CODE>object</CODE> is equivalent to this two-dimensional
	 *         size attribute, false otherwise.
	 */
	public boolean equals(Object object) {
		return (object != null && object instanceof Size2DSyntax
				&& this.x == ((Size2DSyntax) object).x && this.y == ((Size2DSyntax) object).y);
	}
	 ...
	 * is the X dimension and <I>Y</I> is the Y dimension. The values are
	 * reported in the internal units of micrometers.
	 */
