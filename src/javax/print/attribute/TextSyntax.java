...
public abstract class TextSyntax implements Serializable, Cloneable {
     ...
     *        mean the default locale for as returned by
     ...
     * <LI><CODE>object</CODE> is an instance of class TextSyntax.
     * <LI>This text attribute's underlying string and <CODE>object</CODE>'s
     * underlying string are equal.
     * <LI>This text attribute's locale and <CODE>object</CODE>'s locale are
     * equal.
     * </OL>
     *
     * @param object
     *        Object to compare to.
     * @return True if <CODE>object</CODE> is equivalent to this text attribute,
     *         false otherwise.
     */
    public boolean equals(Object object) {
        return (object != null && object instanceof TextSyntax && this.value.equals(
                ((TextSyntax) object).value) && this.locale.equals(((TextSyntax) object).locale));
    }

    /**
     * Returns a String identifying this text attribute. The String is the
