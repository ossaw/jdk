 ...
 * a DocAttributeSet to specify the characteristics of an individual doc and the
 ...
 * interface {@link DocAttribute DocAttribute}. The {@link #add(Attribute)
 * add(Attribute)}, and {@link #addAll(AttributeSet) addAll(AttributeSet)}
...
public interface DocAttributeSet extends AttributeSet {
	 ...
	 *             not an instance of interface {@link DocAttribute
	 *             DocAttribute}.
