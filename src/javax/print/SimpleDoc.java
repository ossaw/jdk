...
/**
 * This class is an implementation of interface <code>Doc</code> that can be
 * used in many common printing requests. It can handle all of the presently
 * defined "pre-defined" doc flavors defined as static variables in the
 * DocFlavor class.
 * <p>
 * In particular this class implements certain required semantics of the Doc
 ...
 * </ul>
 * Clients who want to re-use the doc object in other jobs, or need a MultiDoc
 * will not want to use this class.
 * <p>
 * If the print data is a stream, or a print job requests data as a stream, then
 * <code>SimpleDoc</code> does not monitor if the service properly closes the
 * stream after data transfer completion or job termination. Clients may prefer
 * to use provide their own implementation of doc that adds a listener to
 * monitor job completion and to validate that resources such as streams are
 * freed (ie closed).
 */
...
public final class SimpleDoc implements Doc {
	...
	/**
	 * Constructs a <code>SimpleDoc</code> with the specified print data, doc
	 ...
	 * <code>Doc</code> implementation is required to support this method if the
	 * <code>DocFlavor</code> has one of the following print data representation
	 * classes, and return <code>null</code> otherwise:
	 * <UL>
	 * <LI><code>char[]</code>
	 ...
	 * return a <code>Reader</code> for reading the print data as a stream of
	 * characters from the print data representation object. However, if the
	 * print data representation object is itself a <code>Reader</code> then the
	 * print data representation object is simply returned.
	 * <P>
	 * 
	 * @return a <code>Reader</code> for reading the print data characters from
	 ...
	 * <code>Doc</code> implementation is required to support this method if the
	 * <code>DocFlavor</code> has one of the following print data representation
	 * classes; otherwise this method returns <code>null</code>:
	 * <UL>
	 * <LI><code>byte[]</code>
	 ...
	 * <P>
	 * 
	 * @return an <code>InputStream</code> for reading the print data bytes from
