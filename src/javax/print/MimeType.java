 ...
 * <P>
 * Class MimeType is similar to the like-named class in package
 * {@link java.awt.datatransfer java.awt.datatransfer}. Class
 * java.awt.datatransfer.MimeType is not used in the Jini Print Service API for
 * two reasons:
 * <OL TYPE=1>
 * <LI>Since not all Java profiles include the AWT, the Jini Print Service
 * should not depend on an AWT class.
 * <P>
 * <LI>The implementation of class java.awt.datatransfer.MimeType does not
 * guarantee that equivalent MIME types will have the same serialized
 ...
 * involving MIME types encapsulated in class java.awt.datatransfer.MimeType may
 * incorrectly fail to match.
 * </OL>
 * <P>
...
class MimeType implements Serializable, Cloneable {
     ...
     * the MIME type has <I>n</I> parameters, <I>n</I> &gt;= 0, then the strings
     * in the array are: <BR>
     * Index 0 -- Media type. <BR>
     * Index 1 -- Media subtype. <BR>
     * Index 2<I>i</I>+2 -- Name of parameter <I>i</I>, <I>i</I>=0,1,...,
     * <I>n</I>-1. <BR>
     * Index 2<I>i</I>+3 -- Value of parameter <I>i</I>, <I>i</I>=0,1,...,
     * <I>n</I>-1. <BR>
     ...
     * String (key) mapping to a parameter value String. If this MIME type
     * object has no parameters, an empty map is returned.
     *
    ...
    private static class LexicalAnalyzer {
        ...
        public String getLexeme() {
            return (myLexemeBeginIndex >= mySourceLength ? null
     ...
     * constructed by applying Character.toLowerCase() to each character of the
     * given string, which maps characters to lowercase using the rules of
     * Unicode. This mapping is the same regardless of locale, whereas the
     * mapping of String.toLowerCase() may be different depending on the default
     * locale.
     */
