 ...
 * NamingSecurityException explicitly before attempting to catch
 * NamingException. A program might want to do this, for example, if it wants to
 * treat security-related exceptions specially from other sorts of naming
 * exception.
 * <p>
