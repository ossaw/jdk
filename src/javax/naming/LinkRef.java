 ...
 * <p>
 * The name is a URL, or a name to be resolved relative to the initial context,
 * or if the first character of the name is ".", the name is relative to the
 * context in which the link is bound.
 * <p>
 ...
 * links. This gives rise to the possibility of a cycle of links whose
 ...
 * number of links that may be involved in any single operation invoked by the
 * caller.
 * <p>
 * A LinkRef contains a single StringRefAddr, whose type is "LinkAddress", and
 * whose contents is the link name. The class name field of the Reference is
 * that of this (LinkRef) class.
 * <p>
 ...
 * <p>
 * Many naming systems support a native notion of link that may be used within
 * the naming system itself. JNDI does not specify whether there is any
 * relationship between such native links and JNDI links.
 * <p>
...
/*
 * <p> The serialized form of a LinkRef object consists of the serialized fields
 * of its Reference superclass.
 */
