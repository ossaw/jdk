 ...
 * end-point. It consists of a type that describes the communication mechanism
 * and a string contents specific to that communication mechanism. The format
 * and interpretation of the address type and the contents of the address are
