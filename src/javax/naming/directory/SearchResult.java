...
/**
 * This class represents an item in the NamingEnumeration returned as a result
 * of the DirContext.search() methods.
 * <p>
...
public class SearchResult extends Binding {
	...
	/**
	 * Constructs a search result using the result's name, its class name, its
	 ...
	 * representation consists of the string representation of the binding and
	 * the string representation of this search result's attributes, separated
	 * by ':'. The contents of this string is useful for debugging and is not
