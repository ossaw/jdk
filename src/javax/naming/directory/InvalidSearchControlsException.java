...
/**
 * This exception is thrown when the specification of the SearchControls for a
 * search operation is invalid. For example, if the scope is set to a value
 * other than OBJECT_SCOPE, ONELEVEL_SCOPE, SUBTREE_SCOPE, this exception is
 * thrown.
 * <p>
...
public class InvalidSearchControlsException extends NamingException {
	/**
	 * Constructs a new instance of InvalidSearchControlsException. All fields
	 * are set to null.
	 */
	...
	/**
	 * Constructs a new instance of InvalidSearchControlsException with an
