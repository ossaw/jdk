...
/**
 * This class represents a modification item. It consists of a modification code
 * and an attribute on which to operate.
 * <p>
 ...
 * ModificationItem instance should lock the object.
 *
 * @author Rosanna Lee
...
/*
 * <p> The serialized form of a ModificationItem object consists of the
...
public class ModificationItem implements java.io.Serializable {
    ...
    private int mod_op;
    /**
     * Contains the attribute identifying the attribute and/or its value to be
     * applied for the modification.
     * 
     * @serial
     */
     ...
     * 
     * @return The modification code. It is one of: DirContext.ADD_ATTRIBUTE
     *         DirContext.REPLACE_ATTRIBUTE DirContext.REMOVE_ATTRIBUTE
     */
    ...
    /**
     * Generates the string representation of this modification item, which
     * consists of the modification operation and its related attribute. The
     * string representation is meant for debugging and not to be interpreted
     * programmatically.
     *
