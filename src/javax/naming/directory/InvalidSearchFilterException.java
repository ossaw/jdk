...
/**
 * This exception is thrown when the specification of a search filter is
 * invalid. The expression of the filter may be invalid, or there may be a
 * problem with one of the parameters passed to the filter.
 * <p>
