 ...
 * specified at runtime. The initial context is created using an
 * <em>initial context factory</em>. An initial context factory must implement
 * the InitialContextFactory interface, which provides a method for creating
 * instances of initial context that implement the Context interface. In
