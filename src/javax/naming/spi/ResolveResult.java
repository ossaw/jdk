...
/**
 * This class represents the result of resolution of a name. It contains the
 * object to which name was resolved, and the portion of the name that has not
 * been resolved.
 * <p>
 * A ResolveResult instance is not synchronized against concurrent multithreaded
 * access. Multiple threads trying to access and modify a single ResolveResult
...
public class ResolveResult implements java.io.Serializable {
    /**
     * Field containing the Object that was resolved to successfully. It can be
     * null only when constructed using a subclass. Constructors should always
     * initialize this.
     * 
     * @serial
     */
    ...
    /**
     * Field containing the remaining name yet to be resolved. It can be null
     * only when constructed using a subclass. Constructors should always
     * initialize this.
     * 
     * @serial
     */
    ...
    /**
     * Constructs an instance of ResolveResult with the resolved object and
     * remaining name both initialized to null.
     */
    ...
    /**
     * Constructs a new instance of ResolveResult consisting of the resolved
     ...
     *
     * @return The remaining unresolved portion of the name. Cannot be null but
     *         empty OK.
    ...
    /**
     * Sets the remaining name field of this result to name. A copy of name is
     * made so that modifying the copy within this ResolveResult does not affect
     ...
     *
     * @param obj
     *            The object to use for setting the resolved obj field. Cannot
     *            be null.
     * @see #getResolvedObj
     */
