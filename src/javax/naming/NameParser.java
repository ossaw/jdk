...
/**
 * This interface is used for parsing names from a hierarchical namespace. The
 * NameParser contains knowledge of the syntactic information (like
 * left-to-right orientation, name separator, etc.) needed to parse names.
 *
...
public interface NameParser {
	 ...
	 *                If name does not conform to syntax defined for the
	 *                namespace.
