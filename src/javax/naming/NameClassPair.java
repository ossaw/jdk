...
/**
 * This class represents the object name and class name pair of a binding found
 * in a context.
 * <p>
 ...
 * <p>
 * Use subclassing for naming systems that generate contents of a name/class
 * pair dynamically.
 * <p>
...
/*
 * <p> The serialized form of a NameClassPair object consists of the name (a
 * String), class name (a String), and isRelative flag (a boolean).
 */

public class NameClassPair implements java.io.Serializable {
	/**
	 * Contains the name of this NameClassPair. It is initialized by the
	 * constructor and can be updated using <tt>setName()</tt>.
	 * 
	 * @serial
	 * @see #getName
	 * @see #setName
	...
	/**
	 * Contains the class name contained in this NameClassPair. It is
	 * initialized by the constructor and can be updated using
	 * <tt>setClassName()</tt>.
	 * 
	 * @serial
	 * @see #getClassName
	...
	/**
	 * Contains the full name of this NameClassPair within its own namespace. It
	 * is initialized using <tt>setNameInNamespace()</tt>
	 * 
	 * @serial
	...
	/**
	 * Records whether the name of this <tt>NameClassPair</tt> is relative to
	 * the target context. It is initialized by the constructor and can be
	 * updated using <tt>setRelative()</tt>.
	 * 
	 * @serial
	 * @see #isRelative
	 * @see #setRelative
	 ...
	 *            <em>target context</em> (which is named by the first parameter
	 *            of the <code>list()</code> method)
	 * @param className
	 *            The possibly null class name of the object bound to name. It
	 ...
	 *            is null if the object bound is null.
	 * @param isRelative
	 *            true if <code>name</code> is a name relative to the target
	 *            context (which is named by the first parameter of the
	 *            <code>list()</code> method); false if <code>name</code> is a
	 *            URL string.
	 * @see #getClassName
	 * @see #setClassName
	 * @see #getName
	 ...
	 * If a reference or some other indirect information is bound, retrieves the
	 * class name of the eventual object that will be returned by
	 * <tt>Binding.getObject()</tt>.
	 *
	 * @return The possibly null class name of object bound. It is null if the
	...
	/**
	 * Retrieves the name of this binding. If <tt>isRelative()</tt> is true,
	 * this name is relative to the target context (which is named by the first
	 * parameter of the <tt>list()</tt>). If <tt>isRelative()</tt> is false,
	 * this name is a URL string.
	 *
	 ...
	 *            name of the object in the binding. The class name will be null
	...
	/**
	 * Determines whether the name of this binding is relative to the target
	 * context (which is named by the first parameter of the <code>list()</code>
	 * method).
	 *
	 * @return true if the name of this binding is relative to the target
	 *         context; false if the name of this binding is a URL string.
	 * @see #setRelative
	 * @see #getName
	 */
	 ...
	 * (which is named by the first parameter of the <code>list()</code>
	 * method).
	 *
	 * @param r
	 ...
	 * introduction of the method is in use.
	 * <p>
	 ...
	 *             if the notion of full name does not apply to this binding in
	 *             the naming system.
	 * @since 1.5
	 * @see #setNameInNamespace
	 * @see #getName
	...
	/**
	 * Sets the full name of this binding. This method must be called to set the
	 * full name whenever a <tt>NameClassPair</tt> is created and a full name is
	 ...
	 * (':'). The contents of this string is useful for debugging and is not
