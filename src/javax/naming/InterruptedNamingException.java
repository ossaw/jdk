 ...
 * depends on its implementation (as provided by the service providers).
 * Different implementations have different ways of protecting their resources
 * and objects from being damaged due to unexpected interrupts.
 * <p>
