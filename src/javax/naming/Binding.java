 ...
 * <p>
 * A context consists of name-to-object bindings. The Binding class represents
 * such a binding. It consists of a name and an object. The
 * <code>Context.listBindings()</code> method returns an enumeration of Binding.
 * <p>
 * Use subclassing for naming systems that generate contents of a binding
 * dynamically.
 * <p>
...
public class Binding extends NameClassPair {
	/**
	 * Contains this binding's object. It is initialized by the constructor and
	 * can be updated using <tt>setObject</tt>.
	 * 
	 * @serial
	 * @see #getObject
	 * @see #setObject
	 ...
	 * <p>
	 * <tt>getClassName()</tt> will return the class name of <tt>obj</tt> (or
	 * null if <tt>obj</tt> is null) unless the class name has been explicitly
	...
	/**
	 * Constructs an instance of a Binding given its name, class name, and
	 * object.
	 *
	 * @param name
	 *            The non-null name of the object. It is relative to the
	...
	/**
	 * Constructs an instance of a Binding given its name, class name, object,
	 ...
	 * If the class name has been set explicitly, return it. Otherwise, if this
	 * binding contains a non-null object, that object's class name is used.
	 ...
	 *
	 * @return The object bound; null if this binding does not contain an
	 *         object.
	 * @see #setObject
	 */
	...
	/**
	 * Generates the string representation of this binding. The string
	 * representation consists of the string representation of the name/class
	 * pair and the string representation of this binding's object, separated by
	 * ':'. The contents of this string is useful for debugging and is not meant
