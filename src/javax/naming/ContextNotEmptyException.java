...
/**
 * This exception is thrown when attempting to destroy a context that is not
 * empty.
 * <p>
 * If the program wants to handle this exception in particular, it should catch
 * ContextNotEmptyException explicitly before attempting to catch
 * NamingException. For example, after catching ContextNotEmptyException, the
 * program might try to remove the contents of the context before reattempting
 * the destroy.
 * <p>
