...
/**
 * This exception is thrown when a method does not terminate within the
...
public class TimeLimitExceededException extends LimitExceededException {
	/**
	 * Constructs a new instance of TimeLimitExceededException. All fields
	 * default to null.
	 */
	...
	/**
	 * Constructs a new instance of TimeLimitExceededException using the
	 * argument supplied.
	 * 
	 * @param explanation
