 ...
 * NamingEnumerations. For example, suppose a server sends back controls with
 * the results of a search operation, the service provider would return a
 * NamingEnumeration of objects that are both SearchResult and implement
 * HasControls. <blockquote>
 * 
 * <pre>
