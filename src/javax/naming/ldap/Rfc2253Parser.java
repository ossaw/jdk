...
final class Rfc2253Parser {
	...
	List<Rdn> parseDn() throws InvalidNameException {
		...
		ArrayList<Rdn> rdns = new ArrayList<>(len / 3 + 10); // leave room for
																// growth
	...
	/*
	 * Parses the next RDN and returns it. Throws an exception if none is found.
	 * Leading and trailing whitespace is consumed.
	 */
	...
	/*
	 * Returns the attribute type that begins at the next unconsumed char. No
	 * leading whitespace is expected. This routine is more generous than RFC
	 * 2253. It accepts attribute types composed of any nonempty combination of
	 * Unicode letters, Unicode digits, '.', '-', and internal space characters.
	 */
	...
	/*
	 * Returns the attribute value that begins at the next unconsumed char. No
	 * leading whitespace is expected.
	 */
	...
	/*
	 * Returns true if next unconsumed character is one that terminates a string
	 * attribute value.
	 */
