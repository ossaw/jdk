...
/**
 * Indicates the end of a batch of search results. Contains an estimate of the
 * total number of entries in the result set and an opaque cookie. The cookie
 * must be supplied to the next search operation in order to get the next batch
 * of results.
 * <p>
 * The code sample in {@link PagedResultsControl} shows how this class may be
 * used.
 * <p>
...
final public class PagedResultsResponseControl extends BasicControl {
    ...
    /**
     * The paged-results response control's assigned object identifier is
    ...
    /**
     * Retrieves the server-generated cookie. Null is returned when there are no
     * more entries for the server to return.
     *
