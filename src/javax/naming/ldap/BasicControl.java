...
/**
 * This class provides a basic implementation of the <tt>Control</tt> interface.
 * It represents an LDAPv3 Control as defined in
...
public class BasicControl implements Control {
	...
	/**
	 * Retrieves the control's ASN.1 BER encoded value. The result includes the
	 * BER tag and length for the control's value but does not include the
	 * control's object identifier and criticality setting.
	 *
	 * @return A possibly null byte array representing the control's ASN.1 BER
	 *         encoded value. It is not cloned - any changes to the returned
	 *         value will affect the contents of the control.
	 */
