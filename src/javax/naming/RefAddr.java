...
/**
 * This class represents the address of a communications end-point. It consists
 * of a type that describes the communication mechanism and an address contents
 * determined by an RefAddr subclass.
 * <p>
 * For example, an address type could be "BSD Printer Address", which specifies
 * that it is an address to be used with the BSD printing protocol. Its contents
 * could be the machine name identifying the location of the printer server that
 * understands this protocol.
 * <p>
 * A RefAddr is contained within a Reference.
 * <p>
 * RefAddr is an abstract class. Concrete implementations of it determine its
...
/*
 * <p> The serialized form of a RefAddr object consists of only its type name
 * String.
 */
...
public abstract class RefAddr implements java.io.Serializable {
     ...
     * contents. The hash code is the sum of the hash code of the address type
     * and the hash code of the address contents.
     *
     ...
     * of the address's type and contents with labels. This representation is
     * intended for display only and not to be parsed.
     * 
