...
/**
 * Specifies the methods that a listener interested in namespace changes must
 * implement. Specifically, the listener is interested in <tt>NamingEvent</tt>s
 ...
 * should also implement the <tt>ObjectChangeListener</tt> interface.
 *
 * @author Rosanna Lee
