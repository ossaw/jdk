...
/**
 * This exception is thrown when no initial context implementation can be
 * created. The policy of how an initial context implementation is selected is
 * described in the documentation of the InitialContext class.
 * <p>
