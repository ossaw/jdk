...
public abstract class SOAPMessage {
	 ...
	 *
	 * @param description
	 *            a <code>String</code> describing the content of this message
	 ...
	 *
	 * @param headers
	 *            a <code>MimeHeaders</code> object containing the MIME headers
	 *            for which to search
	 ...
	 *
	 * @param element
	 *            The <code>SOAPElement</code> containing the reference to an
	 *            Attachment
	 ...
	 *
	 * @param dataHandler
	 *            the <code>javax.activation.DataHandler</code> object that will
	 *            generate the content for this <code>SOAPMessage</code> object
