 ...
 * likely be used by implementations of <code>AttachmentPart</code> and other
 * MIME dependent parts of the SAAJ API.
 * 
...
public class MimeHeaders {
	...
	/**
	 * Constructs a default <code>MimeHeaders</code> object initialized with an
	 * empty <code>Vector</code> object.
	 */
	public MimeHeaders() {
		headers = new Vector();
	}
	...
	public void addHeader(String name, String value) {
		...
		for (int i = pos - 1; i >= 0; i--) {
			MimeHeader hdr = (MimeHeader) headers.elementAt(i);
			if (hdr.getName().equalsIgnoreCase(name)) {
				headers.insertElementAt(new MimeHeader(name, value), i + 1);
				return;
			}
		}
	...
	/**
	 * Remove all <code>MimeHeader</code> objects whose name matches the given
	 * name.
	 *
	 * @param name
	 *            a <code>String</code> with the name of the header for which to
	...
	/**
	 * Returns all the <code>MimeHeader</code>s in this <code>MimeHeaders</code>
	 * object.
	 *
	 * @return an <code>Iterator</code> object over this
	 *         <code>MimeHeaders</code> object's list of <code>MimeHeader</code>
	 *         objects
	 */
	...
	/**
	 * Returns all the <code>MimeHeader</code> objects whose name matches a name
