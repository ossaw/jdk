 ...
 * the SAAJ API. All of the <code>newInstance</code> methods defined on
 * factories in SAAJ 1.3 defer to instances of this class to do the actual
 * object creation. The implementations of <code>newInstance()</code> methods
...
public abstract class SAAJMetaFactory {
	static private final String META_FACTORY_CLASS_PROPERTY = "javax.xml.soap.MetaFactory";
	 ...
	 * The SAAJMetaFactory is an SPI, it pulls the creation of the other
	 * factories together into a single place. Changing out the SAAJMetaFactory
	 ...
	 * classname in the file META-INF/services/javax.xml.soap.MetaFactory in
