...
/**
 * <code>SOAPElementFactory</code> is a factory for XML fragments that will
 * eventually end up in the SOAP part. These fragments can be inserted as
 * children of the <code>SOAPHeader</code> or <code>SOAPBody</code> or
 ...
 * 
 * @deprecated - Use <code>javax.xml.soap.SOAPFactory</code> for creating
 *             SOAPElements.
...
public class SOAPElementFactory {
    ...
    /**
     * Create a <code>SOAPElement</code> object initialized with the given
    ...
    /**
     * Create a <code>SOAPElement</code> object initialized with the given local
     * name.
     *
     * @param localName
     ...
     *            if there is an error in creating the
     *            <code>SOAPElement</code> object
     * @deprecated Use javax.xml.soap.SOAPFactory.createElement(String
     *             localName) instead
    ...
    /**
     * Create a new <code>SOAPElement</code> object with the given local name,
     * prefix and uri.
     *
     * @param localName
     *        a <code>String</code> giving the local name for the new
     ...
     *            <code>SOAPElement</code> object
     * @deprecated Use javax.xml.soap.SOAPFactory.createElement(String
     *             localName, String prefix, String uri) instead
     * @see javax.xml.soap.SOAPFactory#createElement(java.lang.String,
