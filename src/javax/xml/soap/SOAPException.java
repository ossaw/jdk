 ...
 * <code>SOAPException</code> object may contain a <code>String</code> that
 ...
 * not being able to get a connection with the provider. Reasons for embedding a
 * <code>Throwable</code> object include problems such as input/output errors or
 * a parsing problem, such as an error in parsing a header.
 */
public class SOAPException extends Exception {
	...
	/**
	 * Constructs a <code>SOAPException</code> object with the given
	 * <code>String</code> as the reason for the exception being thrown and the
	 * given <code>Throwable</code> object as an embedded exception.
	 *
	 * @param reason
	 *            a description of what caused the exception
	 * @param cause
	 *            a <code>Throwable</code> object that is to be embedded in this
	 ...
	 * <code>SOAPException</code> object has no detail message of its own, this
	 * method will return the detail message from the embedded
	 * <code>Throwable</code> object.
	 *
	 * @return the error or warning message for this <code>SOAPException</code>
	 *         or, if it has none, the message of the embedded
	 *         <code>Throwable</code> object, if there is one
	 */
	...
	/**
	 * Initializes the <code>cause</code> field of this
	 * <code>SOAPException</code> object with the given <code>Throwable</code>
	 * object.
	 * <P>
	 * This method can be called at most once. It is generally called from
	 * within the constructor or immediately after the constructor has returned
	 * a new <code>SOAPException</code> object. If this
	 * <code>SOAPException</code> object was created with the constructor
	 * {@link #SOAPException(Throwable)} or
	 ...
	 *             if <code>cause</code> is this <code>Throwable</code> object.
	 *             (A <code>Throwable</code> object cannot be its own cause.)
	 * @throws IllegalStateException
	 *             if the cause for this <code>SOAPException</code> object has
