 ...
 * represented only as <code>SOAPHeaderElement</code> objects.
 * <P>
...
public interface SOAPHeaderElement extends SOAPElement {
	...
	/**
	 * Sets the actor associated with this <code>SOAPHeaderElement</code> object
	 * to the specified actor. The default value of an actor is:
	 * <code>SOAPConstants.URI_SOAP_ACTOR_NEXT</code>
	 * <P>
	 * If this <code>SOAPHeaderElement</code> supports SOAP 1.2 then this call
	...
	/**
	 * Sets the <code>Role</code> associated with this
	 ...
	 * <code>SOAPHeaderElement</code> must process it correctly. This ensures,
	 * for example, that if the <code>SOAPHeaderElement</code> object modifies
	 * the message, that the message is being modified correctly.
	 *
	 * @param mustUnderstand
	 *            <code>true</code> to set the mustUnderstand attribute to true;
	 *            <code>false</code> to set it to false
	 *
	 * @exception IllegalArgumentException
	 *                if there is a problem in setting the mustUnderstand
	 *                attribute
	...
	/**
	 * Sets the <i>relay</i> attribute for this <code>SOAPHeaderElement</code>
	 ...
	 * whose mustUnderstand attribute is set to true or that are targeted at the
