...
class FactoryFinder {
     ...
     * fallback class name. The arguments supplied must be used in order. If
     * using the first argument is successful, the second one will not be used.
     * <P>
     * This method is package private so that this code can be shared.
     *
     * @return the <code>Class</code> object of the specified message factory;
     ...
     * Finds the implementation <code>Class</code> object for the given factory
     * name, or if that fails, finds the <code>Class</code> object for the given
     * default class name, but only if <code>tryFallback</code> is
     * <code>true</code>. The arguments supplied must be used in order If using
     * the first argument is successful, the second one will not be used. Note
     * the default class name may be needed even if fallback is not to be
     * attempted, so certain error conditions can be handled.
     * <P>
     * This method is package private so that this code can be shared.
     *
     * @return the <code>Class</code> object of the specified message factory;
    ...
    private static boolean isDefaultImplementation(String className) {
        return MessageFactory.DEFAULT_MESSAGE_FACTORY.equals(className) || SOAPFactory.DEFAULT_SOAP_FACTORY
                .equals(className) || SOAPConnectionFactory.DEFAULT_SOAP_CONNECTION_FACTORY.equals(className)
