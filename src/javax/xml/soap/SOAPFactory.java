...
/**
 * <code>SOAPFactory</code> is a factory for creating various objects that exist
 * in the SOAP XML tree.
 * <code>SOAPFactory</code> can be used to create XML fragments that will
 * eventually end up in the SOAP part. These fragments can be inserted as
 * children of the {@link SOAPHeaderElement} or {@link SOAPBodyElement} or
...
public abstract class SOAPFactory {
     ...
     * <code>SOAPFactory</code> implementation class.
     */
    static private final String SOAP_FACTORY_PROPERTY = "javax.xml.soap.SOAPFactory";
    ...
    /**
     * Creates a <code>SOAPElement</code> object initialized with the given
     * <code>Name</code> object. The concrete type of the return value will
     * depend on the name given to the new <code>SOAPElement</code>. For
    ...
    /**
     * Creates a <code>SOAPElement</code> object initialized with the given
     * <code>QName</code> object. The concrete type of the return value will
     * depend on the name given to the new <code>SOAPElement</code>. For
     * instance, a new <code>SOAPElement</code> with the name
     * "{http://www.w3.org/2003/05/soap-envelope}Envelope" would cause a
     * <code>SOAPEnvelope</code> that supports SOAP 1.2 behavior to be created.
     ...
     * prefix and uri. The concrete type of the return value will depend on the
     * name given to the new <code>SOAPElement</code>. For instance, a new
     * <code>SOAPElement</code> with the name
     * "{http://www.w3.org/2003/05/soap-envelope}Envelope" would cause a
     * <code>SOAPEnvelope</code> that supports SOAP 1.2 behavior to be created.
     *
     * @param localName
    ...
    /**
     * Creates a new <code>SOAPFault</code> object initialized with the given
    ...
    /**
     * Creates a new <code>SOAPFactory</code> object that is an instance of the
     * default implementation (SOAP 1.1),
     ...
     * classname in the file META-INF/services/javax.xml.soap.SOAPFactory in
     * jars available to the runtime.
     * <LI>Use the SAAJMetaFactory instance to locate the SOAPFactory
    ...
    /**
     * Creates a new <code>SOAPFactory</code> object that is an instance of the
     * specified implementation, this method uses the SAAJMetaFactory to locate
     * the implementation class and create the SOAPFactory instance.
     *
     * @return a new instance of a <code>SOAPFactory</code>
     * @param protocol
