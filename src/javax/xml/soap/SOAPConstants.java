...
public interface SOAPConstants {
	 ...
	 * <code>createMessage</code> method. If no <code>Content-Type</code> header
	 * is passed then the <code>createMessage</code> may throw an
	 * <code>IllegalArgumentException</code> or, in the case of the no argument
	 * version of <code>createMessage</code>, an
	...
	/**
	 * Used to create <code>MessageFactory</code> instances that create
	 * <code>SOAPMessages</code> whose behavior supports the SOAP 1.1
	 * specification.
	 *
	 * @since SAAJ 1.3
	 */
	 ...
	 * this namespace are defined by the SOAP 1.1 specification.
	 */
	 ...
	 * <code>encodingStyle</code> in the <code>URI_NS_SOAP_ENVELOPE</code>
	 * namespace and set to the value <code>URI_NS_SOAP_ENCODING</code> can be
	 * added to an element to indicate that it is encoded using the rules in
	 ...
	 * @since SAAJ 1.3
	 */
	public static final String URI_SOAP_1_2_ROLE_ULTIMATE_RECEIVER = URI_NS_SOAP_1_2_ENVELOPE
