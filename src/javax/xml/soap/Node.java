...
public interface Node extends org.w3c.dom.Node {
     ...
     * value of the immediate child of this node otherwise. If there is an
     * immediate child of this <code>Node</code> that it is a <code>Text</code>
     * node then it's value will be returned. If there is more than one
     * <code>Text</code> node then the value of the first <code>Text</code> Node
     ...
     * node and that node is a <code>Text</code> node, or if there are no
    ...
    /**
     * Returns the parent element of this <code>Node</code> object. This method
     * can throw an <code>UnsupportedOperationException</code> if the tree is
     * not kept in memory.
     *
    ...
    /**
     * Notifies the implementation that this <code>Node</code> object is no
     * longer being used by the application and that the implementation is free
     * to reuse this object for nodes that may be created later.
     * <P>
