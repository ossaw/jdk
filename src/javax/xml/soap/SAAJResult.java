 ...
 * using the {@link #getResult()} method. The {@link DOMResult#getNode()} method
...
public class SAAJResult extends DOMResult {
     ...
     * <p>
     * This kind of <code>SAAJResult</code> is meant for use in situations where
     * the results will be used as a parameter to a method that takes a
     * parameter whose type, such as <code>SOAPElement</code>, is drawn from the
     * SAAJ API. When used in a transformation, the results are populated into
     * the <code>SOAPPart</code> of a <code>SOAPMessage</code> that is created
     * internally. The <code>SOAPPart</code> returned by
     ...
     * cause this constructor to throw an
     ...
     * <code>SOAPPart</code> of the supplied <code>SOAPMessage</code>. In the
     * normal case these results will be written using DOM APIs and, as a
     * result, the finished <code>SOAPPart</code> will not be guaranteed to be
     * well-formed unless the data used to create it is also well formed. When
     * used in a transformation the validity of the <code>SOAPMessage</code>
    ...
    /**
     * Creates a <code>SAAJResult</code> that will write the results as a child
     * node of the <code>SOAPElement</code> specified. In the normal case these
     * results will be written using DOM APIs and as a result may invalidate the
     * structure of the SAAJ tree. This kind of <code>SAAJResult</code> should
     * only be used when the validity of the incoming data can be guaranteed by
    ...
    /**
     * @return the resulting Tree that was created under the specified root
     *         Node.
     * @since SAAJ 1.3
     */
