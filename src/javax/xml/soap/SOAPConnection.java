 ...
 * <p>
 * The SOAPConnection class is optional. Some implementations may not implement
 * this interface in which case the call to
 * <code>SOAPConnectionFactory.newInstance()</code> (see below) will throw an
 ...
 * </PRE>
 * 
 * A <code>SOAPConnection</code> object can be used to send messages directly to
 * a URL following the request/response paradigm. That is, messages are sent
 * using the method <code>call</code>, which sends the message and then waits
...
public abstract class SOAPConnection {
    ...
    public SOAPMessage get(Object to) throws SOAPException {
        throw new UnsupportedOperationException(
                "All subclasses of SOAPConnection must override get()");
    }
