 ...
 * <P>
 * A <code>SOAPBody</code> object contains <code>SOAPBodyElement</code> objects,
 * which have the content for the SOAP body. A <code>SOAPFault</code> object,
 * which carries status and/or error information, is an example of a
...
public interface SOAPBody extends SOAPElement {
	 ...
	 * <code>SOAPBody</code> object. The new <code>SOAPFault</code> will have
	 * default values set for the mandatory child elements. The type of the
	 * <code>SOAPFault</code> will be a SOAP 1.1 or a SOAP 1.2
	 * <code>SOAPFault</code> depending on the <code>protocol</code> specified
	...
	/**
	 * Creates a new <code>SOAPFault</code> object and adds it to this
	 * <code>SOAPBody</code> object. The type of the <code>SOAPFault</code> will
	 * be a SOAP 1.1 or a SOAP 1.2 <code>SOAPFault</code> depending on the
	 * <code>protocol</code> specified while creating the
	 * <code>MessageFactory</code> instance.
	 * <p>
	 * For SOAP 1.2 the <code>faultCode</code> parameter is the value of the
	 * <i>Fault/Code/Value</i> element and the <code>faultString</code>
	 * parameter is the value of the <i>Fault/Reason/Text</i> element. For SOAP
	 * 1.1 the <code>faultCode</code> parameter is the value of the
	 * <code>faultcode</code> element and the <code>faultString</code> parameter
	 * is the value of the <code>faultstring</code> element.
	 * <p>
	 * A <code>SOAPBody</code> may contain at most one <code>SOAPFault</code>
	 * child element.
	 *
	 * @param faultCode
	 *                    a <code>Name</code> object giving the fault code to be
	 *                    set;
	 *                    must be one of the fault codes defined in the Version
	 *                    of SOAP
	 ...
	 *                    fault
	 * @param locale
	 *                    a {@link java.util.Locale} object indicating the
	 *                    native
	 ...
	 *
	 * @param faultCode
	 *                    a <code>QName</code> object giving the fault code to
	 *                    be set;
	 *                    must be one of the fault codes defined in the version
	 *                    of SOAP
	 *                    specification in use.
	 ...
	 * parameter is the value of the <i>Fault/Reason/Text</i> element. For SOAP
	 * 1.1 the <code>faultCode</code> parameter is the value of the
	 * <i>faultcode</i> element and the <code>faultString</code> parameter is
	 * the value of the <i>faultstring</i> element.
	 * <p>
	 * In case of a SOAP 1.2 fault, the default value for the mandatory
	 * <code>xml:lang</code> attribute on the <i>Fault/Reason/Text</i> element
	 * will be set to <code>java.util.Locale.getDefault()</code>
	 * <p>
	 * A <code>SOAPBody</code> may contain at most one <code>SOAPFault</code>
	 * child element.
	 *
	...
	/**
	 * Creates a new <code>SOAPBodyElement</code> object with the specified name
	 * and adds it to this <code>SOAPBody</code> object.
	 *
	 * @param name
	 *             a <code>Name</code> object with the name for the new
	 *             <code>SOAPBodyElement</code> object
	...
	/**
	 * Creates a new DOM <code>{@link org.w3c.dom.Document}</code> and sets the
	 * first child of this <code>SOAPBody</code> as it's document element. The
	 * child <code>SOAPElement</code> is removed as part of the process.
	 *
	 * @return the <code>{@link org.w3c.dom.Document}</code> representation of
	 *         the <code>SOAPBody</code> content.
	 *
	 * @exception SOAPException
