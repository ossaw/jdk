 ...
 * <P>
 * A <code>SOAPEnvelope</code> object contains an empty <code>SOAPHeader</code>
 * object by default. If the <code>SOAPHeader</code> object, which is optional,
 * is not needed, it can be retrieved and deleted with the following line of
 * code. The variable <i>se</i> is a <code>SOAPEnvelope</code> object.
 * 
 * <PRE>
 * se.getHeader().detachNode();
 * </PRE>
 *
 * A <code>SOAPHeader</code> object is created with the
 * <code>SOAPEnvelope</code> method <code>addHeader</code>. This method, which
 ...
 * <code>SOAPHeader</code> object. In the following line of code, the argument
 * to the method <code>addHeaderElement</code> is a <code>Name</code> object
 * that is the name for the new <code>HeaderElement</code> object.
 * 
 * <PRE>
...
public interface SOAPHeader extends SOAPElement {
	 ...
	 * object that have the specified <i>actor</i> and that have a
	 * MustUnderstand attribute whose value is equivalent to <code>true</code>.
	 * <p>
	 * In SOAP 1.2 the <i>env:actor</i> attribute is replaced by the
	 * <i>env:role</i> attribute, but with essentially the same semantics.
	 *
	 * @param actor
	 *            a <code>String</code> giving the URI of the <code>actor</code>
	 ...
	 * <code>SOAPHeader</code> object, it is sent to the ultimate receiver along
	 ...
	 * Returns an <code>Iterator</code> over all the
	 * <code>SOAPHeaderElement</code> objects in this <code>SOAPHeader</code>
	 * object that have the specified <i>actor</i> and detaches them from this
	 * <code>SOAPHeader</code> object.
	 * <P>
	...
	/**
	 * Creates a new NotUnderstood <code>SOAPHeaderElement</code> object
	 * initialized with the specified name and adds it to this
	 * <code>SOAPHeader</code> object. This operation is supported only by SOAP
	 * 1.2.
	 *
	 * @param name
	 ...
	 * <code>SOAPHeader</code> object. This operation is supported on both SOAP
	 * 1.1 and SOAP 1.2 header.
	 *
	 * @param supportedSOAPURIs
	 *            an <code>Iterator</code> object with the URIs of SOAP versions
	 *            supported.
	 * @return the new <code>SOAPHeaderElement</code> object that was inserted
	 *         into this <code>SOAPHeader</code> object
	 * @exception SOAPException
