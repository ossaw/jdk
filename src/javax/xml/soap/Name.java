...
/**
 * A representation of an XML name. This interface provides methods for getting
 * the local and namespace-qualified names and also for getting the prefix
 * associated with the namespace for the name. It is also possible to get the
 ...
 * the <code>Name</code> interface will return.
 * <UL>
 ...
 * <code>SOAPEnvelope.createName</code>, which has two versions. One method
 * creates <code>Name</code> objects with a local name, a namespace prefix, and
 * a namespace URI. and the second creates <code>Name</code> objects with just a
 * local name. The following line of code, in which <i>se</i> is a
 * <code>SOAPEnvelope</code> object, creates a new <code>Name</code> object with
 * all three.
 * 
 * <PRE>
 ...
 * can be used. The variable <i>element</i> is a <code>SOAPElement</code>
 * object. This code creates a new <code>SOAPElement</code> object with the
 * given name and adds it to <i>element</i>.
 * 
 * <PRE>
