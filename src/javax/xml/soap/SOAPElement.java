...
public interface SOAPElement extends Node, org.w3c.dom.Element {
	 ...
	 * <code>Name</code> object and adds the new element to this
	...
	/**
	 * Creates a new <code>SOAPElement</code> object initialized with the given
	 * <code>QName</code> object and adds the new element to this
	 * <code>SOAPElement</code> object. The <i>namespace</i>, <i>localname</i>
	 * and <i>prefix</i> of the new <code>SOAPElement</code> are all taken from
	 ...
	 * <code>SOAPElement</code> object. The new <code>SOAPElement</code>
	 * inherits any in-scope default namespace.
	 *
	 * @param localName
	 *            a <code>String</code> giving the local name for the element
	 * @return the new <code>SOAPElement</code> object that was created
	 * @exception SOAPException
	 *                if there is an error in creating the
	 *                <code>SOAPElement</code> object
	 ...
	 *            element
	 * @param prefix
	 *            a <code>String</code> giving the namespace prefix for the new
	 *            element
	 *
	 * @return the new <code>SOAPElement</code> object that was created
	 * @exception SOAPException
	 *                if the <code>prefix</code> is not valid in the context of
	 *                this <code>SOAPElement</code> or if there is an error in
	 ...
	 * <code>SOAPElement</code> instance. The <code>SOAPElement</code> is
	 * expected to be created by a <code>SOAPFactory</code>. Callers should not
	 * rely on the element instance being added as is into the XML tree.
	 * Implementations could end up copying the content of the
	 * <code>SOAPElement</code> passed into an instance of a different
	 * <code>SOAPElement</code> implementation. For instance if
	 ...
	 * prefixes present in the fragment should be fully resolved using
	 ...
	 * @exception SOAPException
	 *                if there is an error in creating the new <code>Text</code>
	 *                object or if it is not legal to attach it as a child to
	 ...
	 *
	 * @exception SOAPException
	 *                if there is an error in creating the Attribute, or it is
	 *                invalid to set an attribute with <code>Name</code>
	 ...
	 * @exception SOAPException
	 *                if there is an error in creating the Attribute, or it is
	 *                invalid to set an attribute with <code>QName</code>
	 ...
	 * <code>Name</code> objects in this <code>SOAPElement</code> object. The
	 * iterator can be used to get the attribute names, which can then be passed
	 * to the method <code>getAttributeValue</code> to retrieve the value of
	 * each attribute.
	 *
	...
	/**
	 * Returns an <code>Iterator</code> over all of the attributes in this
	 * <code>SOAPElement</code> as <code>QName</code> objects. The iterator can
	 * be used to get the attribute QName, which can then be passed to the
	 * method <code>getAttributeValue</code> to retrieve the value of each
	 * attribute.
	 *
	 ...
	 *
	 * @param prefix
	 *            a <code>String</code> giving the prefix of the namespace for
	 *            which to search
	 ...
	 * this iterator can be passed to the method <code>getNamespaceURI</code> to
	 * retrieve the URI of each namespace.
	 *
	 ...
	 *         <code>SOAPElement</code>. This namespace will be the same as the
	 ...
	 * possible. SOAP Defined elements such as SOAPEnvelope, SOAPHeader,
	 ...
	 *
	 * @exception SOAPException
	 *                if changing the name of this <code>Element</code> is not
	 *                allowed.
	 ...
	 *
	 * @param name
	 *            the <code>Name</code> object with the name of the attribute to
	 *            be removed
	 ...
	 *
	 * @param qname
	 *            the <code>QName</code> object with the qname of the attribute
	 *            to be removed
	 * @return <code>true</code> if the attribute was removed successfully;
	 *         <code>false</code> if it was not
	 ...
	 * {@link Node}s of this element. This includes
	 * <code>javax.xml.soap.Text</code> objects as well as
	 * <code>SOAPElement</code> objects.
	 * <p>
	 ...
	 *
	 * @param name
	 *            a <code>Name</code> object with the name of the child elements
	 *            to be returned
	 *
	...
	/**
	 * Sets the encoding style for this <code>SOAPElement</code> object to one
	 * specified.
	 *
	 * @param encodingStyle
	 ...
	 * @exception SOAPException
	 *                if setting the encodingStyle is invalid for this
	 *                SOAPElement.
