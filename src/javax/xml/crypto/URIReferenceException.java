...
public class URIReferenceException extends Exception {
	...
	/**
	 * Constructs a new <code>URIReferenceException</code> with the specified
	 * detail message, cause and <code>URIReference</code>.
	 * <p>
	 * Note that the detail message associated with <code>cause</code> is
	 * <i>not</i> automatically incorporated in this exception's detail message.
	 *
	...
	/**
	 * Returns the <code>URIReference</code> that was being dereferenced when
	 * the exception was thrown.
	 *
	 * @return the <code>URIReference</code> that was being dereferenced when
	 ...
	 * the throwable that caused this <code>URIReferenceException</code> to get
	 * thrown.)
	 *
	...
	/**
	 * Prints this <code>URIReferenceException</code>, its backtrace and the
