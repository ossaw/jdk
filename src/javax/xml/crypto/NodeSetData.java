...
/**
 * An abstract representation of a <code>Data</code> type containing a node-set.
 * The type (class) and ordering of the nodes contained in the set are not
 * defined by this class; instead that behavior should be defined by
 * <code>NodeSetData</code> subclasses.
 *
 * @author Sean Mullan
