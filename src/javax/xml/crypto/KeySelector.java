 ...
 * {@link KeyInfo} object. An example of an implementation of this class is one
 * that searches a {@link java.security.KeyStore} for trusted keys that match
 * information contained in a <code>KeyInfo</code>.
 * <p>
 * Whether or not the returned key is trusted and the mechanisms used to
 * determine that is implementation-specific.
 *
 * @author Sean Mullan
...
public abstract class KeySelector {
    ...
    public static class Purpose {
        ...
        /**
         * Returns a string representation of this purpose ("sign", "verify",
         * "encrypt", or "decrypt").
         *
     ...
     *         this key selector
     */
    public abstract KeySelectorResult select(KeyInfo keyInfo, Purpose purpose, AlgorithmMethod method,
            XMLCryptoContext context) throws KeySelectorException;

    /**
     * Returns a <code>KeySelector</code> that always selects the specified key,
     * regardless of the <code>KeyInfo</code> passed to it.
     *
     * @param key
