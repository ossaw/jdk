...
public class NoSuchMechanismException extends RuntimeException {
	...
	/**
	 * Constructs a new <code>NoSuchMechanismException</code> with the specified
	 * detail message.
	 *
	 * @param message
	 *            the detail message
	 ...
	 * the throwable that caused this <code>NoSuchMechanismException</code> to
	 * get thrown.)
	 *
	...
	/**
	 * Prints this <code>NoSuchMechanismException</code>, its backtrace and the
