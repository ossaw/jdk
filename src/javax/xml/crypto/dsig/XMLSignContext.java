 ...
 * are unpredictable if an <code>XMLSignContext</code> is used with different
 * signature structures (for example, you should not use the same
 * <code>XMLSignContext</code> instance to sign two different
 * {@link XMLSignature} objects).
 * <p>
 * <b><a name="Supported Properties"></a>Supported Properties</b>
 * <p>
 * The following properties can be set using the {@link #setProperty
 * setProperty} method.
 * <ul>
