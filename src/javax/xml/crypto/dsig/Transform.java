...
/**
 * A representation of the XML <code>Transform</code> element as defined in the
 ...
 * {@link XMLSignatureFactory#newTransform newTransform} method of the
...
public interface Transform extends XMLStructure, AlgorithmMethod {
	...
	/**
	 * The <a href="http://www.w3.org/2002/06/xmldsig-filter2"> XPath Filter
	 * 2</a> transform algorithm URI.
	 */
	 ...
	 *            context (may be <code>null</code> if not applicable)
	 * @param os
	 *            the <code>OutputStream</code> that should be used to write the
	 *            transformed data to
	 * @return the transformed data (or <code>null</code> if the data was
	 *         written to the <code>OutputStream</code> parameter)
	 * @throws NullPointerException
	 *             if <code>data</code> or <code>os</code> is <code>null</code>
	 * @throws TransformException
	 *             if an error occurs while executing the transform
	 */
