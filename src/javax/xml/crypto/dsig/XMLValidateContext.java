 ...
 * results are unpredictable if an <code>XMLValidateContext</code> is used with
 * different signature structures (for example, you should not use the same
 * <code>XMLValidateContext</code> instance to validate two different
 ...
 * dereferenced content and pre-digested input for subsequent retrieval via the
 ...
 * methods. The default value if not specified is <code>Boolean.FALSE</code>.
 * </ul>
 *
 * @author Sean Mullan
