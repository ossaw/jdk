 ...
 * <a href="http://www.w3.org/TR/xml-exc-c14n/"> Exclusive XML Canonicalization
 * (C14N) algorithm</a>. The parameters include an optional inclusive namespace
 * prefix list. The XML Schema Definition of the Exclusive XML Canonicalization
...
public final class ExcC14NParameterSpec implements C14NMethodParameterSpec {
	...
	/**
	 * Creates a <code>ExcC14NParameterSpec</code> with an empty prefix list.
	 */
	...
	/**
	 * Creates a <code>ExcC14NParameterSpec</code> with the specified list of
