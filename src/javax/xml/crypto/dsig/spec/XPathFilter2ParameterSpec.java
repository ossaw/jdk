 ...
 * <a href="http://www.w3.org/TR/xmldsig-filter2/"> XPath Filter 2.0 Transform
 * Algorithm</a>. The parameters include a list of one or more {@link XPathType}
 * objects.
 *
 * @author Sean Mullan
...
public final class XPathFilter2ParameterSpec implements TransformParameterSpec {
	 ...
	 * unmodifiable list}.
	 *
	 * @return a <code>List</code> of <code>XPathType</code> objects (never
