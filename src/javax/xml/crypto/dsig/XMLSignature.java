...
/**
 * A representation of the XML <code>Signature</code> element as defined in the
 * <a href="http://www.w3.org/TR/xmldsig-core/"> W3C Recommendation for
 * XML-Signature Syntax and Processing</a>. This class contains methods for
 * signing and validating XML signatures with behavior as defined by the W3C
 * specification. The XML Schema Definition is defined as:
 * 
 * <pre>
 * <code>
 ...
 * @see XMLSignatureFactory#newXMLSignature(SignedInfo, KeyInfo, List, String,
 *      String)
...
public interface XMLSignature extends XMLStructure {
	...
	/**
	 * The XML Namespace URI of the W3C Recommendation for XML-Signature Syntax
	 * and Processing.
	 */
	 ...
	 * <a href="http://www.w3.org/TR/xmldsig-core/#sec-CoreValidation"> core
	 * validation processing rules</a>. This method validates the signature
	 ...
	 *
	 * @return an unmodifiable list of <code>XMLObject</code>s (may be empty but
	 ...
	 * <code>XMLSignature</code> has been signed or validated.
	 *
	 * @return the key selector result, or <code>null</code> if a key selector
	 *         has not been specified or this <code>XMLSignature</code> has not
	 *         been signed or validated
	 */
	KeySelectorResult getKeySelectorResult();

	/**
	 * A representation of the XML <code>SignatureValue</code> element as
	 * defined in the <a href="http://www.w3.org/TR/xmldsig-core/"> W3C
	 * Recommendation for XML-Signature Syntax and Processing</a>. The XML
