...
/**
 * A representation of the XML <code>RetrievalMethod</code> element as defined
 * in the <a href="http://www.w3.org/TR/xmldsig-core/"> W3C Recommendation for
 * XML-Signature Syntax and Processing</a>. A <code>RetrievalMethod</code>
 * object is used to convey a reference to <code>KeyInfo</code> information that
 * is stored at another location. The XML schema definition is defined as:
 *
 * <pre>
 ...
 * {@link KeyInfoFactory#newRetrievalMethod newRetrievalMethod} methods of the
 * {@link KeyInfoFactory} class, and passing it the URI identifying the location
 * of the KeyInfo, an optional type URI identifying the type of KeyInfo, and an
 * optional list of {@link Transform}s; for example:
 * 
 * <pre>
 * KeyInfoFactory factory = KeyInfoFactory.getInstance("DOM");
 * RetrievalMethod rm = factory.newRetrievalMethod("#KeyValue-1", KeyValue.DSA_TYPE, Collections
 *         .singletonList(Transform.BASE64));
 * </pre>
 *
 * @author Sean Mullan
...
public interface RetrievalMethod extends URIReference, XMLStructure {
     ...
     *
     * @return the URI of the referenced <code>KeyInfo</code> information in RFC
     *         2396 format (never <code>null</code>)
     */
    String getURI();
