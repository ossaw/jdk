...
/**
 * A representation of the XML <code>KeyInfo</code> element as defined in the
 * <a href="http://www.w3.org/TR/xmldsig-core/"> W3C Recommendation for
 * XML-Signature Syntax and Processing</a>. A <code>KeyInfo</code> contains a
 * list of {@link XMLStructure}s, each of which contain information that enables
 * the recipient(s) to obtain the key needed to validate an XML signature. The
 ...
 * <code>XMLStructure</code>s and an optional id parameter; for example:
 * 
 * <pre>
...
public interface KeyInfo extends XMLStructure {
     ...
     * (ex: an <code>X509Data</code> element would be returned as an instance of
     * {@link javax.xml.crypto.dsig.keyinfo.X509Data}).
     *
     * @return an unmodifiable list of one or more <code>XMLStructure</code>s in
     *         this <code>KeyInfo</code>. Never returns <code>null</code> or an
     *         empty list.
     */
    ...
    /**
     * Return the optional Id attribute of this <code>KeyInfo</code>, which may
     * be useful for referencing this <code>KeyInfo</code> from other XML
     * structures.
     *
