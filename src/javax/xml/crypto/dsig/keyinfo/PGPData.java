...
/**
 * A representation of the XML <code>PGPData</code> element as defined in the
 * <a href="http://www.w3.org/TR/xmldsig-core/"> W3C Recommendation for
 * XML-Signature Syntax and Processing</a>. A <code>PGPData</code> object is
 ...
 * {@link KeyInfoFactory#newPGPData newPGPData} methods of the
 * {@link KeyInfoFactory} class, and passing it <code>byte</code> arrays
 * representing the contents of the PGP public key identifier and/or PGP key
 * material packet, and an optional list of elements from an external namespace.
 *
 * @author Sean Mullan
