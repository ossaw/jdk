...
/**
 * Indicates an exceptional condition that occurred during the XML signature
 * generation or validation process.
 *
 * <p>
 * An <code>XMLSignatureException</code> can contain a cause: another throwable
 * that caused this <code>XMLSignatureException</code> to get thrown.
 *
 * @since 1.6
 */
public class XMLSignatureException extends Exception {
	 ...
	 * <code>null</code> if the cause is nonexistent or unknown. (The cause is
	 * the throwable that caused this <code>XMLSignatureException</code> to get
	 * thrown.)
	 *
	...
	/**
	 * Prints this <code>XMLSignatureException</code>, its backtrace and the
	 * cause's backtrace to the standard error stream.
	 */
