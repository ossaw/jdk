 ...
 * <p>
 * The result of dereferencing a <code>URIReference</code> is either an instance
 * of {@link OctetStreamData} or {@link NodeSetData}. Unless the
 * <code>URIReference</code> is a <i>same-document reference</i> as defined in
 * section 4.2 of the W3C Recommendation for XML-Signature Syntax and
 * Processing, the result of dereferencing the <code>URIReference</code> MUST be
 * an <code>OctetStreamData</code>.
 *
 * @author Sean Mullan
 * @author Joyce Leung
