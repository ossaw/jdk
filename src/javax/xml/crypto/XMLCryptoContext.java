 ...
 * results are unpredictable if an <code>XMLCryptoContext</code> is used with
 * multiple structures (for example, you should not use the same
...
public interface XMLCryptoContext {
	 ...
	 *             if <code>baseURI</code> is not RFC 2396 compliant
	 * @see #getBaseURI
	 */
	 ...
	 * {@link URIReference}s. The specified <code>URIDereferencer</code> is used
	 * in place of an implementation's default <code>URIDereferencer</code>.
	 *
	 * @param dereferencer
	 *            the <code>URIDereferencer</code>, or <code>null</code> to
	 ...
	 * namespace URI has not been bound to a prefix. To bind a namespace URI to
	 * a prefix, call the {@link #putNamespacePrefix putNamespacePrefix} method.
	 *
	 * @param namespaceURI
	 *            a namespace URI
	 * @param defaultPrefix
	 *            the prefix to be returned in the event that the the specified
	 ...
	 *            a namespace URI
	 * @param prefix
	 *            a namespace prefix (or <code>null</code> to remove any
	 *            existing mapping). Specifying the empty string (
	 *            <code>""</code>) binds no prefix to the namespace URI.
	...
	/**
	 * Returns the default namespace prefix. The default namespace prefix is the
	 * prefix for all namespace URIs not explicitly set by the
	...
	/**
	 * Sets the default namespace prefix. This sets the namespace prefix for all
	 * namespace URIs not explicitly set by the {@link #putNamespacePrefix
	 * putNamespacePrefix} method.
	 *
	 * @param defaultPrefix
	 *            the default namespace prefix, or <code>null</code> to remove
	 *            the current setting. Specify the empty string (<code>""</code>
	 *            ) to bind no prefix.
