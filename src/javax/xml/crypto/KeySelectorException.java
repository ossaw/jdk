...
public class KeySelectorException extends Exception {
	...
	/**
	 * Constructs a new <code>KeySelectorException</code> with <code>null</code>
	 ...
	 * the throwable that caused this <code>KeySelectorException</code> to get
	 * thrown.)
	 *
	...
	/**
	 * Prints this <code>KeySelectorException</code>, its backtrace and the
