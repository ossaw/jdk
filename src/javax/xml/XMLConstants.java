 ...
 * @see <a href="http://www.w3.org/TR/xml11/">Extensible Markup Language (XML)
 *      1.1</a>
 * @see <a href="http://www.w3.org/TR/REC-xml">Extensible Markup Language (XML)
 *      1.0 (Second Edition)</a>
 * @see <a href="http://www.w3.org/XML/xml-V10-2e-errata">XML 1.0 Second Edition
 *      Specification Errata</a>
...
public final class XMLConstants {
     ...
     * </p>
     *
     * @see <a href="http://www.w3.org/TR/REC-xml-names/#defaulting"> Namespaces
     *      in XML, 5.2 Namespace Defaulting</a>
     */
     ...
     *      XML Schema Part 1: Structures, 2.6 Schema-Related Markup in
     *      Documents Being Validated</a>
     */
     ...
     * </p>
     *
     * @see <a href="http://www.w3.org/TR/xpath-datamodel">XQuery 1.0 and XPath
     *      2.0 Data Model</a>
     */
     ...
     * </p>
     *
     * @see <a href="http://relaxng.org/spec-20011203.html">RELAX NG
     *      Specification</a>
     */
     ...
     * <li>{@code false} instructs the implementation to process XML in
     * accordance with the XML specifications ignoring security issues such as
     ...
     * property, a runtime exception that is specific to the context is thrown.
     ...
     * <LI>a specific protocol, such as file, to give permission to only the
     * protocol;</LI>
     ...
     * denied due to the restriction of this property, a runtime exception that
     ...
     * property is specified, its value will be used to override the default of
     * the property.
     *
     * @since 1.7
     *        </p>
     ...
     * property, a runtime exception that is specific to the context is thrown.
     * In the case of constructing new {@link javax.xml.transform.Transformer}
     * for example,
     * {@link javax.xml.transform.TransformerConfigurationException} will be
     * thrown by the {@link javax.xml.transform.TransformerFactory}.
     * </p>
     * <p>
     * <b>Value:</b> a list of protocols separated by comma. A protocol is the
     * scheme portion of a {@link java.net.URI}, or in the case of the JAR
