...
public final class DatatypeConstants {
	...
	/**
	 * Type-safe enum class that represents six fields of the {@link Duration}
	 * class.
	 * 
	 * @since 1.5
	 */
	public static final class Field {
		...
		/**
		 * Returns a field name in English. This method is intended to be used
		 * for debugging/diagnosis and not for display to end-users.
		 *
