...
final class DatatypeConverterImpl implements DatatypeConverterInterface {
     ...
     * <li>XML Schema allows leading and trailing (but not in-between)
     * whitespaces. {@link Integer#valueOf(String)} doesn't allow any.
     * </ol>
     */
    ...
    public static BigDecimal _parseDecimal(CharSequence content) {
        ...
        //
        // the code was originally using
        // com.sun.msv.datatype.xsd.NumberType.load,
    ...
    public static float _parseFloat(CharSequence _val) {
        ...
        // these screening process is necessary due to the wobble of
    ...
    public static Boolean _parseBoolean(CharSequence literal) {
        ...
        // throw new IllegalArgumentException("String \"" + literal + "\" is not
        // valid boolean value.");
    }
    ...
    public static QName _parseQName(CharSequence text, NamespaceContext nsc) {
        ...
        // search ':'
        int idx = start + 1; // no point in searching the first char. that's not
                             // valid.
        ...
        if (idx == end) {
            ...
            // but some users reported that there are implementations that
            // return null.
    ...
    public String parseAnySimpleType(String lexicalXSDAnySimpleType) {
        ...
        // return (String)SimpleURType.theInstance._createValue(
        // lexicalXSDAnySimpleType, null );
    }
    ...
    /**
     * Just return the string passed as a parameter but installs an instance of
     * this class as the DatatypeConverter implementation. Used from static
     * fixed value initializers.
     */
