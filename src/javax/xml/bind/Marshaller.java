...
/**
 * <p>
 * The <tt>Marshaller</tt> class is responsible for governing the process of
 * serializing Java content trees back into XML data. It provides the basic
 * marshalling methods:
 *
 * <p>
 ...
 *
 * <p>
 * Marshalling to a File: <blockquote>
 * 
 * <pre>
 ...
 *
 * <p>
 * Marshalling to a SAX ContentHandler: <blockquote>
 * 
 * <pre>
 ...
 *
 * <p>
 * Marshalling to a DOM Node: <blockquote>
 * 
 * <pre>
 ...
 *
 * <p>
 * Marshalling to a java.io.OutputStream: <blockquote>
 * 
 * <pre>
 ...
 *
 * <p>
 * Marshalling to a java.io.Writer: <blockquote>
 * 
 * <pre>
 ...
 *
 * <p>
 * Marshalling to a javax.xml.transform.SAXResult: <blockquote>
 * 
 * <pre>
 * // assume MyContentHandler instanceof ContentHandler
 ...
 *
 * <p>
 * Marshalling to a javax.xml.transform.DOMResult: <blockquote>
 * 
 * <pre>
 ...
 *
 * <p>
 * Marshalling to a javax.xml.transform.StreamResult: <blockquote>
 * 
 * <pre>
 ...
 *
 * <p>
 * Marshalling to a javax.xml.stream.XMLStreamWriter: <blockquote>
 * 
 * <pre>
 ...
 *
 * <p>
 * Marshalling to a javax.xml.stream.XMLEventWriter: <blockquote>
 * 
 * <pre>
 ...
 *
 * <p>
 * <a name="elementMarshalling"></a> <b>Marshalling content tree rooted by a
 * JAXB element</b><br>
 * <blockquote> The first parameter of the overloaded
 * <tt>Marshaller.marshal(java.lang.Object, ...)</tt> methods must be a JAXB
 * element as computed by {@link JAXBIntrospector#isElement(java.lang.Object)};
 * otherwise, a <tt>Marshaller.marshal</tt> method must throw a
 * {@link MarshalException}. There exist two mechanisms to enable marshalling an
 * instance that is not a JAXB element. One method is to wrap the instance as a
 * value of a {@link JAXBElement}, and pass the wrapper element as the first
 * parameter to a <tt>Marshaller.marshal</tt> method. For java to schema
 * binding, it is also possible to simply annotate the instance's class with
 * &#64;{@link XmlRootElement}. </blockquote>
 *
 * <p>
 * <b>Encoding</b><br>
 * <blockquote> By default, the Marshaller will use UTF-8 encoding when
 * generating XML data to a <tt>java.io.OutputStream</tt>, or a
 * <tt>java.io.Writer</tt>. Use the {@link #setProperty(String,Object)
 * setProperty} API to change the output encoding used during these marshal
 * operations. Client applications are expected to supply a valid character
 * encoding name as defined in the
 * <a href="http://www.w3.org/TR/2000/REC-xml-20001006#charencoding">W3C XML 1.0
 * Recommendation</a> and supported by your Java Platform</a>. </blockquote>
 *
 * <p>
 ...
 * order to marshal it back into XML data. Different JAXB Providers will support
 * marshalling invalid Java content trees at varying levels, however all JAXB
 * Providers must be able to marshal a valid content tree back to XML data. A
 * JAXB Provider must throw a <tt>MarshalException</tt> when it is unable to
 * complete the marshal operation due to invalid content. Some JAXB Providers
 * will fully allow marshalling invalid content, others will fail on the first
 * validation error.
 * <p>
 * Even when schema validation is not explictly enabled for the marshal
 ...
 * event handler prior to invoking one of the marshal API's, then events will be
 * delivered to a default event handler which will terminate the marshal
 * operation after encountering the first error or fatal error. Note that for
 * JAXB 2.0 and later versions,
 * {@link javax.xml.bind.helpers.DefaultValidationEventHandler} is no longer
 * used.
 *
 * </blockquote>
 *
 ...
 * <dd>The output encoding to use when marshalling the XML data. The Marshaller
 * will use "UTF-8" by default if this property is not specified.</dd>
 * <dt><tt>jaxb.formatted.output</tt> - value must be a java.lang.Boolean</dt>
 * <dd>This property controls whether or not the Marshaller will format the
 * resulting XML data with line breaks and indentation. A true value for this
 * property indicates human readable indented xml data, while a false value
 * indicates unformatted xml data. The Marshaller will default to false
 * (unformatted) if this property is not specified.</dd>
 ...
 * xsi:schemaLocation attribute in the generated XML data. The format of the
 * schemaLocation attribute value is discussed in an easy to understand,
 * non-normative form in
 * <a href="http://www.w3.org/TR/xmlschema-0/#schemaLocation">Section 5.6 of the
 * W3C XML Schema Part 0: Primer</a> and specified in
 ...
 * <dt><tt>jaxb.noNamespaceSchemaLocation</tt> - value must be a
 * java.lang.String</dt>
 * <dd>This property allows the client application to specify an
 * xsi:noNamespaceSchemaLocation attribute in the generated XML data. The format
 * of the schemaLocation attribute value is discussed in an easy to understand,
 * non-normative form in
 * <a href="http://www.w3.org/TR/xmlschema-0/#schemaLocation">Section 5.6 of the
 * W3C XML Schema Part 0: Primer</a> and specified in
 * <a href="http://www.w3.org/TR/xmlschema-1/#Instance_Document_Constructions">
 ...
 * generated by the Marshaller. If the property is not specified, the default is
 * <tt>false</tt>. This property has different implications depending on which
 * marshal api you are using - when this property is set to true:<br>
 * <ul>
 * <li>{@link #marshal(Object,org.xml.sax.ContentHandler)
 * marshal(Object,ContentHandler)} - the Marshaller won't invoke
 * {@link org.xml.sax.ContentHandler#startDocument()} and
 * {@link org.xml.sax.ContentHandler#endDocument()}.</li>
 * <li>{@link #marshal(Object,org.w3c.dom.Node) marshal(Object,Node)} - the
 * property has no effect on this API.</li>
 * <li>{@link #marshal(Object,java.io.OutputStream)
 * marshal(Object,OutputStream)} - the Marshaller won't generate an xml
 * declaration.</li>
 * <li>{@link #marshal(Object,java.io.Writer) marshal(Object,Writer)} - the
 * Marshaller won't generate an xml declaration.</li>
 * <li>{@link #marshal(Object,javax.xml.transform.Result)
 * marshal(Object,Result)} - depends on the kind of Result object, see semantics
 * for Node, ContentHandler, and Stream APIs</li>
 * <li>{@link #marshal(Object,javax.xml.stream.XMLEventWriter)
 * marshal(Object,XMLEventWriter)} - the Marshaller will not generate
 * {@link javax.xml.stream.events.XMLEvent#START_DOCUMENT} and
 * {@link javax.xml.stream.events.XMLEvent#END_DOCUMENT} events.</li>
 * <li>{@link #marshal(Object,javax.xml.stream.XMLStreamWriter)
 * marshal(Object,XMLStreamWriter)} - the Marshaller will not generate
 * {@link javax.xml.stream.events.XMLEvent#START_DOCUMENT} and
 * {@link javax.xml.stream.events.XMLEvent#END_DOCUMENT} events.</li>
 * </ul>
 * </dd>
 ...
 *
 * <p>
 * <a name="marshalEventCallback"></a> <b>Marshal Event Callbacks</b><br>
 * <blockquote> "The {@link Marshaller} provides two styles of callback
 ...
 * specific code placed in JAXB mapped classes is triggered during marshalling.
 * 'External listeners' allow for centralized processing of marshal events in
 ...
 * </pre>
 * 
 * </blockquote> The class defined event callback methods should be used when
 * the callback method requires access to non-public methods and/or fields of
 * the class.
 * <p>
 * The external listener callback mechanism enables the registration of a
 * {@link Listener} instance with a {@link Marshaller#setListener(Listener)}.
 * The external listener receives all callback events, allowing for more
 * centralized processing than per class defined callback methods.
 * <p>
 ...
 * {@link Listener#beforeMarshal(Object)} and
 * {@link Listener#afterMarshal(Object)}.
 * <p>
 * An event callback method throwing an exception terminates the current marshal
 * process. </blockquote>
 *
 * @author
 *         <ul>
...
public interface Marshaller {
	...
	/**
	 * Marshal the content tree rooted at <tt>jaxbElement</tt> into the
	 * specified <tt>javax.xml.transform.Result</tt>.
	 *
	 * <p>
	 * All JAXB Providers must at least support
	 * {@link javax.xml.transform.dom.DOMResult},
	 * {@link javax.xml.transform.sax.SAXResult}, and
	 * {@link javax.xml.transform.stream.StreamResult}. It can support other
	 ...
	 *
	 * If the returned DOM tree is updated, these changes are also visible in
	 * the content tree. Use {@link #marshal(Object, org.w3c.dom.Node)} to force
	 ...
	 * <tt>Marshaller</tt>. This method can only be used to set one of the
	 ...
	 * <tt>Marshaller</tt>. This method can only be used to get one of the
	 * standard JAXB defined properties above or a provider specific property.
	 ...
	 * the marshal operation after the first error or fatal error is
	 * encountered.
	 * <p>
	 ...
	 * {@link XmlAdapter}. When an instance of an adapter is not given, a
	 ...
	 * that should be used to validate subsequent marshal operations against.
	 * Passing null into this method will disable validation.
	 *
	 * <p>
	 * This method allows the caller to validate the marshalled XML as it's
	 * marshalled.
	 *
	 * <p>
	 ...
	 * used to perform marshal-time validation. If there is no Schema set on the
	 * marshaller, then this method will return null indicating that
	 ...
	 * {@link Marshaller} to externally listen for marshal events.
	 * <p/>
	 * <p/>
	 * This class enables pre and post processing of each marshalled object. The
	 * event callbacks are called when marshalling from an instance that maps to
	 * an xml element or complex type definition. The event callbacks are not
	 * called when marshalling from an instance of a Java datatype that
	 * represents a simple type definition.
	 * <p/>
	 * <p/>
	 * External listener is one of two different mechanisms for defining marshal
	 * event callbacks. See
	 * <a href="Marshaller.html#marshalEventCallback">Marshal Event
	...
	public static abstract class Listener {
		/**
		 * <p/>
		 * Callback method invoked before marshalling from <tt>source</tt> to
		 * XML.
		 * <p/>
		 * <p/>
		 * This method is invoked just before marshalling process starts to
		 * marshal <tt>source</tt>. Note that if the class of <tt>source</tt>
		 * defines its own <tt>beforeMarshal</tt> method, the class specific
		 ...
		 * <p/>
		 * <p/>
		 * This method is invoked after <tt>source</tt> and all its descendants
		 * have been marshalled. Note that if the class of <tt>source</tt>
		 * defines its own <tt>afterMarshal</tt> method, the class specific
		 * callback method is invoked just before this method is invoked.
		 *
		 * @param source
	...
	/**
	 * <p>
	 * Register marshal event callback {@link Listener} with this
	 * {@link Marshaller}.
	 *
	 * <p>
	 * There is only one Listener per Marshaller. Setting a Listener replaces
	 ...
	 *         is registered with this Marshaller.
	 * @since JAXB2.0
	 */
