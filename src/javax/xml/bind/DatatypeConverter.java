 ...
 * requires knowledge of the lexical representations (
 ...
 * custom parse and print methods. For example, the binding of xsd:dateTime to a
 * long can be customized using parse and print methods as follows: <blockquote>
 * 
 * <pre>
 ...
 * 	java.util.Calendar cal = convert_long_to_calendar(longval); // application
 * 																// specific
 ...
 * or a print method in a javaType binding declaration.
 * </p>
 * <p>
 ...
 * necessary to configure the converter that should be used to perform the print
...
final public class DatatypeConverter {
	...
	private final static JAXBPermission SET_DATATYPE_CONVERTER_PERMISSION = new JAXBPermission(
	 ...
	 * This is necessary to configure the datatype converter that should be used
	 * to perform the print and parse conversions.
	 *
	 * <p>
	 ...
	 *            DatatypeConverterInterface class - this parameter must not be
	 *            null.
	 ...
	 */
	public static String printQName(javax.xml.namespace.QName val, NamespaceContext nsc) {
		if (theConverter == null)
			initConverter();
