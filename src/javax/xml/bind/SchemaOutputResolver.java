...
public abstract class SchemaOutputResolver {
	 ...
	 * written, and return it as a {@link Result} object.
	 *
	 * <p>
	 * This method is called only once for any given namespace. IOW, all the
	 * components in one namespace is always written into the same schema
	 * document.
	 *
	 * @param namespaceUri
	 ...
	 *         absolute system ID. Those system IDs are relativized by the
	 *         caller and used for &lt;xs:import> statements.
	 *
