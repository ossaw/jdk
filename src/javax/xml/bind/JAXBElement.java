 ...
 * <li><b><tt>value</tt></b> represents the element instance's atttribute(s) and
 * content model</li>
 * <li>element declaration's <b><tt>declaredType</tt></b> (
 * <tt>xs:element @type</tt> attribute)</li>
 ...
 * representing a nil element with attribute(s). If <tt>nil</tt> is true, it is
 * possible that <tt>value</tt> is non-null so it can hold the value of the
 * attributes associated with a nil element.
 * </p>
 *
...
public class JAXBElement<T> implements Serializable {
	 ...
	 * Can be one of the following values: - {@link GlobalScope} for global xml
	 * element declaration. - local element declaration has a scope set to the
	 * Java class representation of complex type defintion containing xml
	 * element declaration.
	 */
	 ...
	 * <tt>true</tt>, {@link #getValue()} can contain a non-null value for
	 * attribute(s). It is valid for a nil xml element to have attribute(s).
	 * </p>
	 */
	...
	/*
	 * Convenience methods (Not necessary but they do unambiguously
	 * conceptualize the rationale behind this class' fields.)
	 */
