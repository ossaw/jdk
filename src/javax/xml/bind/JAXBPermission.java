 ...
 * {@link DatatypeConverter#setDatatypeConverter(DatatypeConverterInterface) the
 * setDatatypeConverter method} that all the methods on
 * {@link DatatypeConverter} uses.</td>
 * <td>Malicious code can set {@link DatatypeConverterInterface}, which has
 ...
 * not have access to, such as {@link java.awt.Frame#getFrames()} that belongs
 * to another application running in the same JVM.</td>
 * </tr>
 * </table>
 *
