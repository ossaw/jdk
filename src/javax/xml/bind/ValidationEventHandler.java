 ...
 * handlers.
 * <p>
 * If the <tt>handleEvent</tt> method throws an unchecked runtime exception, the
 * JAXB Provider must treat that as if the method returned false, effectively
 * terminating whatever operation was in progress at the time (unmarshal,
 * validate, or marshal).
 * <p>
 * Modifying the Java content tree within your event handler is undefined by the
 * specification and may result in unexpected behaviour.
 * <p>
 ...
 * <p>
 * <b>Default Event Handler</b> <blockquote> See:
 * <a href="Validator.html#defaulthandler">Validator javadocs</a> </blockquote>
 *
 * @author
 *         <ul>
...
public interface ValidationEventHandler {
     ...
     * The ValidationEvent will have a {@link ValidationEventLocator
     * ValidationEventLocator} embedded in it that indicates where the error or
     * warning occurred.
     * <p>
