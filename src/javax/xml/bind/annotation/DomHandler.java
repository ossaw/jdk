 ...
 * {@link XmlAnyElement} annotation to map an element of XML into a
 * representation of infoset such as W3C DOM.
 *
 * <p>
 * Implementations hide how a portion of XML is converted into/from such
 * DOM-like representation, allowing JAXB providers to work with arbitrary such
 * library.
 *
 * <P>
 * This interface is intended to be implemented by library writers and consumed
 * by JAXB providers. None of those methods are intended to be called from
 * applications.
 *
...
public interface DomHandler<ElementT, ResultT extends Result> {
     ...
     *
     * <p>
     * A JAXB provider will then send a portion of the XML into the given
     * result. Such a portion always form a subtree of the whole XML document
    ...
    /**
     * Once the portion is sent to the {@link Result}. This method is called by
     * a JAXB provider to obtain the unmarshalled element representation.
     *
     * <p>
     * Multiple invocations of this method may return different objects. This
     * method can be invoked only when the whole sub-tree are fed to the
     * {@link Result} object.
     *
     * @param rt
