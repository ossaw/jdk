 ...
 * </p>
 * <p>
 * The <tt>@XmlAttribute</tt> annotation can be used with the following program
 * elements:
 * <ul>
 ...
 * collection item type must be mapped to schema simple type.
 * 
 * <pre>
 * // Examples
 * &#64;XmlAttribute
 * List&lt;Integer> items; // legal
 * &#64;XmlAttribute
 * List&lt;Bar> foo; // illegal if Bar does not map to a schema simple type
 * </pre>
 * 
 * </li>
 * <li>If the type of the field or the property is a non collection type, then
 * the type of the property or field must map to a simple schema type.
 * 
 * <pre>
 * // Examples
 * &#64;XmlAttribute
 * int foo; // legal
 * &#64;XmlAttribute
 * Foo foo; // illegal if Foo does not map to a schema simple type
 * </pre>
 * 
 * </li>
 * <li>This annotation can be used with the following annotations: {@link XmlID}
 * , {@link XmlIDREF}, {@link XmlList}, {@link XmlSchemaType}, {@link XmlValue},
 * {@link XmlAttachmentRef}, {@link XmlMimeType}, {@link XmlInlineBinaryData},
