 ...
 * is generated (and annotated) from a schema into the ObjectFactory class in a
 * Java package that represents the binding of the element declaration's target
 ...
 * <p>
 * The following example illustrates the use of scope annotation parameter in
 * binding of element declaration in schema derived code.
 * <p>
 ...
 * them map to a XML schema element with the same local name "foo".
 *
 * @see XmlRegistry
 * @since JAXB 2.0
 */
...
public @interface XmlElementDecl {
     ...
     * <p>
     * If the value is "##default", then the value is the namespace name for the
     * package of the class containing this factory method.
     *
     * @see #name()
     */
     ...
     * can be derived from the factory method name.
     * 
     * @see #namespace()
     */
    String name();
     ...
     * <p>
     * This specifies the namespace name of the XML element whose local name is
     * specified by <tt>substitutionHeadName()</tt>.
     * <p>
     * If <tt>susbtitutionHeadName()</tt> is "", then this value can only be
     * "##default". But the value is ignored since since this element is not
     * part of susbtitution group when the value of
     * <tt>susbstitutionHeadName()</tt> is "".
     * <p>
     * If <tt>susbtitutionHeadName()</tt> is not "" and the value is
     * "##default", then the namespace name is the namespace name to which the
     * package of the containing class, marked with {@link XmlRegistry }, is
     * mapped.
     * <p>
     * If <tt>susbtitutionHeadName()</tt> is not "" and the value is not
     * "##default", then the value is the namespace name.
     *
     ...
     * <p>
     * If the value is "", then this element is not part of any substitution
     * group.
     *
     ...
     * poor-man's substitute for null to allow implementations to recognize the
     * 'no default value' state.
     */
