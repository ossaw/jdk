 ...
 * <b>Usage</b>
 * <p>
 * <tt>&#64;XmlElementRef</tt> annotation can be used with a JavaBean property
 * or from within {@link XmlElementRefs}
 * <p>
 * This annotation dynamically associates an XML element name with the JavaBean
 * property. When a JavaBean property is annotated with {@link XmlElement}, the
 ...
 * code provides support for substitution groups using an <i>element
 * property</i>, (section 5.5.5, "Element Property" of JAXB 2.0 specification).
 * An element property method signature is of the form:
 * 
 * <pre>
 ...
 * </pre>
 * <p>
 * An element factory method annotated with {@link XmlElementDecl} is used to
 * create a <tt>JAXBElement</tt> instance, containing an XML element name. The
 ...
 * <ul>
 * <li>If the collection item type (for collection property) or property type
 * (for single valued property) is {@link javax.xml.bind.JAXBElement}, then
 * <tt>&#64;XmlElementRef}.name()</tt> and
 * <tt>&#64;XmlElementRef.namespace()</tt> must point an element factory method
 * with an @XmlElementDecl annotation in a class annotated with @XmlRegistry
 * (usually ObjectFactory class generated by the schema compiler) :
 * <ul>
 ...
 * </li>
 * <li>If the collection item type (for collection property) or property type
 * (for single valued property) is not {@link javax.xml.bind.JAXBElement}, then
 * the type referenced by the property or field must be annotated with
 ...
 * </p>
 * The following Java class hierarchy models an Ant build script. An Ant task
 * corresponds to a class in the class hierarchy. The XML element name of an Ant
 * task is indicated by the &#64;XmlRootElement annotation on its corresponding
 * class.
 * 
 * <pre>
 ...
 * <p>
 * The following example shows the annotations for XML Schema substitution
 * groups. The annotations and the ObjectFactory are derived from the schema.
 *
 * <pre>
 *     &#64;XmlElement
 *     class Math {
