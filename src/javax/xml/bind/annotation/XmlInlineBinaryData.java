 ...
 * datatypes such as {@link java.awt.Image} or {@link Source} or <tt>byte[]</tt>
 * that are bound to base64-encoded binary from being considered for XOP
 ...
 * nor
 * {@link AttachmentMarshaller#addMtomAttachment(byte[], int, int, String, String, String)}
 * is ever called for the property. The binary data will always be inlined.
 *
