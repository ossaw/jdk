 ...
 * <b>Usage</b>
 * </p>
 * The <tt>&#64;XmlIDREF</tt> annotation can be used with the following program
 * elements:
 * <ul>
 ...
 * <tt>&#64;XmlID</tt>.</li>
 * <li>If the field or property is single valued, then the type of the property
 * or field must contain a property or field annotated with <tt>&#64;XmlID</tt>.
 * <p>
 * Note: If the collection item type or the type of the property (for non
 * collection type) is java.lang.Object, then the instance must contain a
 * property/field annotated with <tt>&#64;XmlID</tt> attribute.</li>
 ...
 * reference rather than by containment)
 * </p>
 * 
 * <pre>
 *
