 ...
 * </p>
 * <p>
 * The <tt>@XmlElementWrapper</tt> annotation can be used with the following
 * program elements:
 * <ul>
...
public @interface XmlElementWrapper {
	/**
	 * Name of the XML wrapper element. By default, the XML wrapper element name
	 * is derived from the JavaBean property name.
	 */
	 ...
	 * <tt>xsi:nil='true'</tt>. Otherwise, it is represented by the absence of
	 * the element.
	 */
	 ...
	 * let users express their application constraints better.
	 *
	 * @since JAXB 2.1
	 */
