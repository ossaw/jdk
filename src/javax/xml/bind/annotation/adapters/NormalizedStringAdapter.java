...
public final class NormalizedStringAdapter extends XmlAdapter<String, String> {
	/**
	 * Replace any tab, CR, and LF by a whitespace character ' ', as specified
	 * in <a href="http://www.w3.org/TR/xmlschema-2/#rf-whiteSpace">the
	 * whitespace facet 'replace'</a>
	 */
	...
	/**
	 * Returns true if the specified char is a white space character but not
	 * 0x20.
	 */
