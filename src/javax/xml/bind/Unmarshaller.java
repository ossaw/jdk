 ...
 * sufficient to use the unmarshalling methods described by
 * <a href="#unmarshalGlobal">Unmarshal root element that is declared
 * globally</a>. These unmarshal methods utilize {@link JAXBContext}'s mapping
 * of global XML element declarations and type definitions to JAXB mapped
 * classes to initiate the unmarshalling of the root element of XML data. When
 * the {@link JAXBContext}'s mappings are not sufficient to unmarshal the root
 ...
 * root element corresponds to a local element declaration in the
 * schema. </blockquote>
 ...
 * fatal error is reported that terminates processing by throwing
 * JAXBException. </blockquote>
 * <p>
 ...
 * the unmarshal by declaredType methods described in the next
 ...
 * unmarshal operation after encountering a fatal error.
 * </blockquote>
 * <p>
...
public interface Unmarshaller {
     ...
     * unmarshal event callbacks. See
     * <a href="Unmarshaller.html#unmarshalEventCallback">Unmarshal Event
