 ...
 * code generated by a JAXB 1.0 binding compiler.
 * <p>
 * This handler causes the unmarshal and validate operations to fail on the
 * first error or fatal error.
 * <p>
 * This handler is not the default handler for JAXB mapped classes following
 * JAXB 2.0 or later versions. Default validation event handling has changed and
 * is specified in {@link javax.xml.bind.Unmarshaller} and
...
public class DefaultValidationEventHandler implements ValidationEventHandler {
    ...
    public boolean handleEvent(ValidationEvent event) {
        ...
        System.out.println(Messages.format(Messages.SEVERITY_MESSAGE, severity, event.getMessage(),
                location));
