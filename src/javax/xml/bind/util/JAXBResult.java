...
/**
 * JAXP {@link javax.xml.transform.Result} implementation that unmarshals a JAXB
 * object.
 * <p>
 * This utility class is useful to combine JAXB with other Java/XML
 * technologies.
 * <p>
 * The following example shows how to use JAXB to unmarshal a document resulting
...
public class JAXBResult extends SAXResult {
     ...
     * an object.
     * <p>
     * This JAXBResult object will use the specified Unmarshaller instance. It
     * is the caller's responsibility not to use the same Unmarshaller for other
     * purposes while it is being used by this object.
     * <p>
     * The primary purpose of this method is to allow the client to configure
     * Unmarshaller. Unless you know what you are doing, it's easier and safer
