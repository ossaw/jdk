 ...
 * information about validation errors and warnings detected while unmarshalling
 * XML data into a Java content tree and is completely orthogonal to the other
 ...
 * tree. At any point, client applications can call the
 ...
 * constraints on Java Properties as defined in the specification. JAXB
 * Providers are not required support this type of validation. Of the JAXB
 ...
 * Unmarshal-Time Validation during the unmarshal operations. Although there is
 ...
 * handler will receive notification of any errors or warnings encountered. The
 ...
 * unmarshal, validate, and marshal operations:
 * <dl>
 ...
 * collects any <tt>ValidationEvent</tt> objects created during the unmarshal,
 * validate, and marshal operations and returns them to the client application
...
public interface Validator {
	 ...
	 * @throws JAXBException
	 *             if any unexpected problem occurs during validation
	 * @throws ValidationException
	 *             If the {@link ValidationEventHandler ValidationEventHandler}
	 *             returns false from its <tt>handleEvent</tt> method or the
	 *             <tt>Validator</tt> is unable to validate the content tree
