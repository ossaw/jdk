 ...
 * </p>
 * <ul>
 * <li>Namespace URI: Namespace name expressed as a URI to which the prefix is
 * bound</li>
 * <li>prefix: syntactically, this is the part of the attribute name following
 * the <code>XMLConstants.XMLNS_ATTRIBUTE</code> ("xmlns") in the Namespace
 * declaration</li>
 * </ul>
 * <p>
 * example:
 ...
 * <code>XMLConstants.XMLNS_ATTRIBUTE</code> ("xmlns") Namespace declarations
 * occur in the same Start-Tag and refer to the same Namespace URI. e.g.<br />
 * 
 * <pre>
 ...
 * <code>XMLConstants.XMLNS_ATTRIBUTE</code> ("xmlns") Namespace declarations in
 * the logical parent element hierarchy. e.g.<br />
 * 
 * <pre>
 ...
 * @see javax.xml.XMLConstants javax.xml.XMLConstants for declarations of common
 *      XML values
...
public interface NamespaceContext {
	 ...
	 * <thead>
	 * <tr>
	 * <td align="center" colspan="2"><code>getNamespaceURI(prefix)</code>
	 * return value for specified prefixes</td>
	 * </tr>
	 * <tr>
	 ...
	 *         </code> when there is no default Namespace URI in the current
	 * scope</td>
	 * </tr>
	 * <tr>
	 * <td>bound prefix</td>
	 ...
	 * arbitrary prefix, whose choice is implementation dependent, is returned
	 * </td>
	 * </tr>
	 * <tr>
	 ...
	 * current scope in an arbitrary, <strong>implementation dependent</strong>,
	 * order</td>
	 * </tr>
	 * <tr>
	 * <td>unbound Namespace URI</td>
