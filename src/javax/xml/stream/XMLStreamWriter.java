 ...
 * <thead>
 * <tr>
 * <th colspan="5">XML Namespaces,
 * <code>javax.xml.stream.isRepairingNamespaces</code> and write method
 * behaviour</th>
 * </tr>
 * <tr>
 * <th>Method</th> <!-- method -->
 ...
 * <td><!-- namespaceURI bound --> prefix:localName="value"&nbsp;<sup>[1]</sup>
 * </td>
 * <td><!-- namespaceURI unbound --> xmlns:{generated}="namespaceURI"
 * {generated}:localName="value"</td> <!-- isRepairingNamespaces == false -->
 * <td><!-- namespaceURI bound --> prefix:localName="value"&nbsp;<sup>[1]</sup>
 * </td>
 * <td><!-- namespaceURI unbound --> <code>XMLStreamException</code></td>
 * </tr>
 *
 * <tr>
 * <th><code>writeAttribute(prefix, namespaceURI, localName, value)</code></th>
 * <!-- isRepairingNamespaces == true -->
 * <td><!-- namespaceURI bound --> bound to same prefix:<br />
 * prefix:localName="value"&nbsp;<sup>[1]</sup><br />
 * <br />
 * bound to different prefix:<br />
 * xmlns:{generated}="namespaceURI" {generated}:localName="value"</td>
 * <td><!-- namespaceURI unbound --> xmlns:prefix="namespaceURI"
 * prefix:localName="value"&nbsp;<sup>[3]</sup></td> <!-- isRepairingNamespaces
 * == false -->
 * <td><!-- namespaceURI bound --> bound to same prefix:<br />
 * prefix:localName="value"&nbsp;<sup>[1][2]</sup><br />
 * <br />
 * bound to different prefix:<br />
 * <code>XMLStreamException</code><sup>[2]</sup></td>
 * <td><!-- namespaceURI unbound --> xmlns:prefix="namespaceURI"
 * prefix:localName="value"&nbsp;<sup>[2][5]</sup></td>
 * </tr>
 *
 * <tr>
 ...
 * isRepairingNamespaces == true -->
 * <td ><!-- namespaceURI bound --> &lt;prefix:localName&gt;&nbsp;<sup>[1]</sup>
 * </td>
 * <td><!-- namespaceURI unbound --> &lt;{generated}:localName
 * xmlns:{generated}="namespaceURI"&gt;</td> <!-- isRepairingNamespaces == false
 * -->
 * <td><!-- namespaceURI bound --> &lt;prefix:localName&gt;&nbsp;<sup>[1]</sup>
 * </td>
 * <td><!-- namespaceURI unbound --> <code>XMLStreamException</code></td>
 ...
 * <br />
 * bound to different prefix:<br />
 * &lt;{generated}:localName xmlns:{generated}="namespaceURI"&gt;</td>
 * <td><!-- namespaceURI unbound --> &lt;prefix:localName
 * xmlns:prefix="namespaceURI"&gt;&nbsp;<sup>[4]</sup></td> <!--
 * isRepairingNamespaces == false -->
 * <td><!-- namespaceURI bound --> bound to same prefix:<br />
 * &lt;prefix:localName&gt;&nbsp;<sup>[1]</sup><br />
 * <br />
 * bound to different prefix:<br />
 * <code>XMLStreamException</code></td>
 * <td><!-- namespaceURI unbound --> &lt;prefix:localName&gt;&nbsp;</td>
 * </tr>
 * </tbody> <tfoot>
 * <tr>
 * <td colspan="5">Notes:
 ...
 * </li>
 * <li>[2] if prefix == "" || null && namespaceURI == "", then no prefix or
 * Namespace declaration is generated or written</li>
 * <li>[3] if prefix == "" || null, then a prefix is randomly generated</li>
 * <li>[4] if prefix == "" || null, then it is treated as the default Namespace
 * and no prefix is generated or written, an xmlns declaration is generated and
 * written if the namespaceURI is unbound</li>
