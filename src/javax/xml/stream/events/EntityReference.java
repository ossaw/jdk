 ...
 * will be resolved transparently.
 *
 * Entities are handled in two possible ways:
 *
 * (1) If javax.xml.stream.isReplacingEntityReferences is set to true all entity
 * references are resolved and reported as markup transparently. (2) If
 * javax.xml.stream.isReplacingEntityReferences is set to false Entity
