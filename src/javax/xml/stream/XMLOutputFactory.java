 ...
 * <thead>
 * <tr>
 * <th align="center" colspan="2">Configuration parameters</th>
 * </tr>
 * </thead> <tbody>
 * <tr>
 * <th>Property Name</th>
 ...
 * namespace declaration in scope. If the StartElement has a uri but no prefix
 * specified a prefix will be assigned, if the prefix has not been declared in a
 * parent of the current StartElement it will be declared on the current
 * StartElement. If the defaultNamespace is bound and in scope and the default
 ...
 * parent context of that element, or changed to the namespace URI of the
 * element or attribute using that prefix.
 * </p>
 *
 * @version 1.2
...
public abstract class XMLOutputFactory {
     ...
     * </p>
     * <ul>
     * <li>Use the javax.xml.stream.XMLOutputFactory system property.</li>
     ...
     * <p>
     * Once an application has obtained a reference to a XMLOutputFactory it can
     ...
     * <li>If {@code factoryId} is "javax.xml.stream.XMLOutputFactory", use the
