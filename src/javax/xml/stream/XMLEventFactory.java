...
public abstract class XMLEventFactory {
	 ...
	 * </p>
	 * <ul>
	 * <li>Use the javax.xml.stream.XMLEventFactory system property.</li>
	 * <li>Use the properties file "lib/stax.properties" in the JRE directory.
	 ...
	 * </ul>
	 * <p>
	 * Once an application has obtained a reference to a XMLEventFactory it can
	 ...
	 * method. No changes in behavior are defined by this replacement method
	 ...
	 * This configuration file is in standard java.util.Properties format and
	 * contains the fully qualified name of the implementation class with the
	 * key being the given {@code factoryId}.</li>
	 * <li>If {@code factoryId} is "javax.xml.stream.XMLEventFactory", use the
	 * service-provider loading facilities, defined by the
	 * {@link java.util.ServiceLoader} class, to attempt to
	 * {@linkplain java.util.ServiceLoader#load(java.lang.Class, java.lang.ClassLoader)
	 * locate and load} an implementation of the service using the specified
	 * {@code ClassLoader}. If {@code classLoader} is null, the
	 * {@linkplain java.util.ServiceLoader#load(java.lang.Class) default loading
	 * mechanism} will apply: That is, the service-provider loading facility
	 * will use the {@linkplain java.lang.Thread#getContextClassLoader() current
	 * thread's context class loader} to attempt to load the service. If the
	 * context class loader is null, the
	 * {@linkplain ClassLoader#getSystemClassLoader() system class loader} will
	 * be used.</li>
	 * <li>Otherwise, throws a {@link FactoryConfigurationError}.</li>
	 * </ul>
	 *
	 * <p>
	 * Note that this is a new method that replaces the deprecated
	 * {@link #newInstance(java.lang.String, java.lang.ClassLoader)
	 * newInstance(String factoryId, ClassLoader classLoader)} method. No
	 * changes in behavior are defined by this replacement method relative to
	 ...
	 * by this factory. The values are copied by value into the events created
	 * by this factory. To reset the location information set the location to
	 * null.
	 * 
	 * @param location
	 ...
	 * @param localName
	 *            the local name of the XML name of the attribute, localName
	 *            cannot be null
	 * @param value
	 *            the attribute value to set, may not be null
	 * @return the Attribute with specified values
	 */
	public abstract Attribute createAttribute(String prefix, String namespaceURI, String localName,
			String value);
	 ...
	 *            the qualified name of the attribute, may not be null
	 * @param attributes
	 *            an optional unordered set of objects that implement Attribute
	 *            to add to the new StartElement, may be null
	 * @param namespaces
	 *            an optional unordered set of objects that implement Namespace
	 *            to add to the new StartElement, may be null
	 ...
	 * @return an instance of the requested StartElement
	 */
	public abstract StartElement createStartElement(String prefix, String namespaceUri,
			String localName);
	 ...
	 *            the prefix of the QName of the new StartElement
	 * @param attributes
	 *            an unordered set of objects that implement Attribute to add to
	 *            the new StartElement
	 * @param namespaces
	 *            an unordered set of objects that implement Namespace to add to
	 *            the new StartElement
	 * @return an instance of the requested StartElement
	 */
	public abstract StartElement createStartElement(String prefix, String namespaceUri,
	 ...
	 * @param attributes
	 *            an unordered set of objects that implement Attribute to add to
	 *            the new StartElement, may be null
	 * @param namespaces
	 *            an unordered set of objects that implement Namespace to add to
	 *            the new StartElement, may be null
	 * @param context
	 ...
	 */
	public abstract StartElement createStartElement(String prefix, String namespaceUri,
			String localName, Iterator attributes, Iterator namespaces, NamespaceContext context);
	 ...
	 * @param namespaces
	 *            an optional unordered set of objects that implement Namespace
	 *            that have gone out of scope, may be null
	 ...
	 * @return an instance of the requested EndElement
	 */
	public abstract EndElement createEndElement(String prefix, String namespaceUri,
			String localName);
	 ...
	 *            the prefix of the QName of the new StartElement
	 * @param namespaces
	 *            an unordered set of objects that implement Namespace that have
