 ...
 * <thead>
 * <tr>
 * <th align="center" colspan="5">Configuration parameters</th>
 * </tr>
 * </thead> <tbody>
 * <tr>
 * <th>Property Name</th>
 ...
 * <td>replace internal entity references with their replacement text and report
 * them as characters</td>
 * <td>Boolean</td>
 * <td>True</td>
 * <td>Yes</td>
 * </tr>
...
public abstract class XMLInputFactory {
	/**
	 * The property used to turn on/off namespace support, this is to support
	 * XML 1.0 documents, only the true setting must be supported
	 */
	 ...
	 * </p>
	 * <ul>
	 * <li>Use the javax.xml.stream.XMLInputFactory system property.</li>
	 ...
	 * </ul>
	 * <p>
	 * Once an application has obtained a reference to a XMLInputFactory it can
	 ...
	 * <li>If {@code factoryId} is "javax.xml.stream.XMLInputFactory", use the
	 ...
	 * {@link javax.xml.stream.XMLStreamException} will be thrown by the
	 * {@link javax.xml.stream.XMLStreamReader#next()} or
