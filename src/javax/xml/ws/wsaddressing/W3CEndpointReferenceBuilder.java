...
/**
 * This class is used to build <code>W3CEndpointReference</code> instances. The
 * intended use of this clsss is for an application component, for example a
 * factory component, to create an <code>W3CEndpointReference</code> for a web
 * service endpoint published by the same Java EE application. It can also be
 * used to create <code>W3CEndpointReferences</code> for an Java SE based
 * endpoint by providing the <code>address</code> property.
 * <p>
 * When creating a <code>W3CEndpointReference</code> for an endpoint that is not
 * published by the same Java EE application, the <code>address</code> property
 * MUST be specified.
 * <p>
 * When creating a <code>W3CEndpointReference</code> for an endpoint published
 * by the same Java EE application, the <code>address</code> property MAY be
 * <code>null</code> but then the <code>serviceName</code> and
 * <code>endpointName</code> MUST specify an endpoint published by the same Java
 * EE application.
 * <p>
 * When the <code>wsdlDocumentLocation</code> is specified it MUST refer to a
 * valid WSDL document and the <code>serviceName</code> and
 * <code>endpointName</code> (if specified) MUST match a service and port in the
 * WSDL document.
 *
 * @since JAX-WS 2.1
 */
public final class W3CEndpointReferenceBuilder {
    ...
    /**
     * Sets the <code>address</code> to the <code>W3CEndpointReference</code>
     * instance's <code>wsa:Address</code>.
     * <p>
     * The <code>address</code> MUST be set to a non-<code>null</code> value
     * when building a <code>W3CEndpointReference</code> for a web service
     * endpoint that is not published by the same Java EE application or when
     * running on Java SE.
     *
     * @param address
     ...
     * <code>wsam:InterfaceName</code> element in the <code>wsa:Metadata</code>
     * element.
     * See <a href=
    ...
    /**
     * Sets the <code>serviceName</code> as the <code>wsam:ServiceName</code>
     * element in the <code>wsa:Metadata</code> element.
     * See <a href=
     * "http://www.w3.org/TR/2007/REC-ws-addr-metadata-20070904/#refmetadatfromepr">
     * 2.1 Referencing WSDL Metadata from an EPR</a> for more details.
     *
     ...
     *         added to the <code>wsa:Metadata</code> element
     */
     ...
     * <code>wsa:Metadata</code> element. This method can only be called after
     * the {@link #serviceName} method has been called.
     * <p>
     * See <a href=
     * "http://www.w3.org/TR/2007/REC-ws-addr-metadata-20070904/#refmetadatfromepr">
     * 2.1 Referencing WSDL Metadata from an EPR</a> for more details.
    ...
    public W3CEndpointReferenceBuilder endpointName(QName endpointName) {
        if (serviceName == null) {
            throw new IllegalStateException(
                    "The W3CEndpointReferenceBuilder's serviceName must be set before setting the endpointName: "
                            + endpointName);
        }
    ...
    /**
     * Sets the <code>wsdlDocumentLocation</code> that will be referenced as
     * <code>wsa:Metadata/@wsdli:wsdlLocation</code>. The namespace name for the
     ...
     * <code>W3CEndpointReference</code> instance's <code>wsa:Metadata</code>
     * element.
     *
    ...
    /**
     * Adds an extension element to the <code>W3CEndpointReference</code>
    ...
    /**
     * Adds an extension attribute to the <code>W3CEndpointReference</code>
     * instance's <code>wsa:EndpointReference</code> element.
     *
     * @param name
     ...
     * properties set on this <code>W3CEndpointReferenceBuilder</code> instance.
     * <p>
     ...
     * the same Java EE application. This method can automatically determine the
     * <code>address</code> of an endpoint published by the same Java EE
     * application that is identified by the <code>serviceName</code> and
     * <code>endpointName</code> properties. If the <code>address</code> is
     * <code>null</code> and the <code>serviceName</code> and
     * <code>endpointName</code> do not identify an endpoint published by the
     * same Java EE application, a <code>java.lang.IllegalStateException</code>
     * MUST be thrown.
     *
     * @return <code>W3CEndpointReference</code> from the accumulated properties
     *         set on this <code>W3CEndpointReferenceBuilder</code> instance.
    ...
    public W3CEndpointReference build() {
        if (elements.isEmpty() && attributes.isEmpty() && interfaceName == null) {
            // 2.1 API
            return Provider.provider().createW3CEndpointReference(address, serviceName, endpointName,
        ...
        return Provider.provider().createW3CEndpointReference(address, interfaceName, serviceName,
                endpointName, metadata, wsdlDocumentLocation, referenceParameters, elements, attributes);
    }
