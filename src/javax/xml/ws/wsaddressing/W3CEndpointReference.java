...
/**
 * This class represents a W3C Addressing EndpointReferece which is a remote
 * reference to a web service endpoint that supports the W3C WS-Addressing 1.0 -
 * Core Recommendation.
 * <p>
 * Developers should use this class in their SEIs if they want to pass/return
 * endpoint references that represent the W3C WS-Addressing recommendation.
 * <p>
 * JAXB will use the JAXB annotations and bind this class to XML infoset that is
 * consistent with that defined by WS-Addressing. See
 * <a href="http://www.w3.org/TR/2006/REC-ws-addr-core-20060509/"> WS-Addressing
 * </a> for more information on WS-Addressing EndpointReferences.
 *
 * @since JAX-WS 2.1
 */
...
public final class W3CEndpointReference extends EndpointReference {
	...
	// should be changed to package private, keeping original modifier to keep
