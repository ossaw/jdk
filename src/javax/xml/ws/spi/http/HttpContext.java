...
/**
 * HttpContext represents a mapping between the root URI path of a web service
 * to a {@link HttpHandler} which is invoked to handle requests destined for
 * that path on the associated container.
 * <p>
...
public abstract class HttpContext {
     ...
     * {@link Endpoint#publish(HttpContext)} to handle HTTP requests for this
     * context. Container or its extensions use this handler to process the
     * requests.
     *
     * @param handler
    ...
    /**
     * Returns the path for this context. This path uniquely identifies an
    ...
    /**
     * Returns an attribute value for container's configuration and other data
    ...
    /**
     * Returns all attribute names for container's configuration and other data
     * that can be used by jax-ws runtime.
     *
