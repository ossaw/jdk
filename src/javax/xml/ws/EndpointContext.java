...
/**
 * <code>EndpointContext</code> allows multiple endpoints in an application to
 * share any information. For example, servlet application's war may contain
 * multiple endpoints and these endpoints can get addresses of each other by
