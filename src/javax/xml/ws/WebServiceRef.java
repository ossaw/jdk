...
/**
 * The <code>WebServiceRef</code> annotation is used to define a reference to a
 * web service and (optionally) an injection target for it. It can be used to
 ...
 * is specified with <code>WebServiceRef</code>, an ERROR MUST be given.
 *
...
public @interface WebServiceRef {
     ...
     * resource. (When a relative JNDI name is specified, then it's a name in
     * the JNDI <code>java:comp/env</code> namespace.) Many application servers
     * provide a way to map these local names to names of resources known to the
     * application server. This mapped name is often a <i>global</i> JNDI name,
    ...
    /**
     * A URL pointing to the WSDL document for the web service. If not
     * specified, the WSDL location specified by annotations on the resource
     * type is used instead.
     */
    String wsdlLocation() default "";

    /**
     * A portable JNDI lookup name that resolves to the target web service
     * reference.
     *
     * @since JAX-WS 2.2
     */
