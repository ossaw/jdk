 ...
 * <code>input</code>, <code>output</code>, and <code>fault</code> messages of
 * the mapped WSDL operation.
 * <p>
 * This annotation can be specified on each method of a service endpoint
 * interface. For such a method, the mapped operation in the generated WSDL's
 * <code>wsam:Action</code> attribute on the WSDL <code>input</code>,
 * <code>output</code> and <code>fault</code> messages of the WSDL
 * <code>operation</code> is based upon which attributes of the
 * <code>Action</code> annotation have been specified. For the exact computation
 * of <code>wsam:Action</code> values for the messages, refer to the algorithm
 * in the JAX-WS specification.
 * <p>
 * <b>Example 1</b>: Specify explicit values for <code>Action</code> message
 * addressing property for <code>input</code> and <code>output</code> messages.
 *
 * <pre>
 ...
 * <code>wsam:Action</code> values for the WSDL <code>output</code> message are
 ...
 * </pre>
 *
 * It is legitimate to specify an explicit value for <code>Action</code> message
