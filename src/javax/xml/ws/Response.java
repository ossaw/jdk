 ...
 * the standard set of exceptions and their cause may be a
 * <code>RemoteException</code> or a {@link WebServiceException} that represents
 * the error that occured during the asynchronous method invocation.
 * </p>
 *
 * @since JAX-WS 2.0
 **/
