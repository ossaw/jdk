 ...
 * enabled or disabled:
 * <ul>
 * <li>ENABLED: In this Mode, MTOM will be enabled. A receiver MUST accept both
 * a non-optimized and an optimized message, and a sender MAY send an optimized
 ...
 * </ul>
 * <p>
 * The {@link #threshold} property can be used to set the threshold value used
 * to determine when binary data should be XOP encoded.
 *
 * @since JAX-WS 2.1
 */
