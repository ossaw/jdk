 ...
 * 1.1/HTTP or SOAP 1.2/HTTP binding. Using this annotation with any other
 * binding is undefined.
 * <p>
 * This annotation MUST only be used in conjunction with the
 * {@link javax.jws.WebService}, {@link WebServiceProvider}, and
 * {@link WebServiceRef} annotations. When used with a
 * <code>javax.jws.WebService</code> annotation, this annotation MUST only be
 * used on the service endpoint implementation class. When used with a
 * <code>WebServiceRef</code> annotation, this annotation MUST only be used when
 * a proxy instance is created. The injected SEI proxy, and endpoint MUST honor
 * the values of the <code>Addressing</code> annotation.
 * <p>
...
public @interface Addressing {
     ...
     * Corresponding
     * <a href="http://www.w3.org/TR/ws-addr-metadata/#wspolicyaddressing"> 3.1.
     * 1 Addressing Assertion</a> must be generated in the generated WSDL.
     */
     ...
     * WS-Addressing and WS-Addressing headers MUST be present on incoming
     * messages. A corresponding
     * <a href="http://www.w3.org/TR/ws-addr-metadata/#wspolicyaddressing"> 3.1.
     * 1 Addressing Assertion</a> must be generated in the WSDL.
     */
