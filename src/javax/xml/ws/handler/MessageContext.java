...
public interface MessageContext extends Map<String, Object> {
    ...
    /**
     * Standard property: message direction, <code>true</code> for outbound
     * messages, <code>false</code> for inbound.
     * <p>
     * Type: boolean
     */
    ...
    /**
     * Standard property: WS Addressing Reference Parameters. The list MUST
     * include all SOAP headers marked with the wsa:IsReferenceParameter="true"
     * attribute.
     * <p>
     * Type: List&lt;Element>
     *
    ...
    /**
     * Property scope. Properties scoped as <code>APPLICATION</code> are visible
     * to handlers, client applications and service endpoints; properties scoped
     * as <code>HANDLER</code> are only normally visible to handlers.
     */
    public enum Scope {
        APPLICATION, HANDLER
    };
