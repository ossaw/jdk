...
/**
 * The <code>BindingProvider</code> interface provides access to the protocol
 * binding and associated context objects for request and response message
 * processing.
 *
 * @since JAX-WS 2.0
 *
...
public interface BindingProvider {
     ...
     * service endpoint. If this property is set to <code>true</code>, the
     * service client indicates that it wants the session to be maintained. If
     * set to <code>false</code>, the session is not maintained. The default
     * value for this property is <code>false</code>.
     * <p>
     ...
     * <code>javax.xml.ws.soap.http.soapaction.uri</code> property is used for
     * the value of the SOAPAction. The default value of this property is
     * <code>false</code> indicating that the
     ...
     * <code>javax.xml.ws.soap.http.soapaction.use</code> property is set to
     ...
     *
     * @return The context that resulted from processing the latest response
     *         messages.
     **/
    ...
    /**
     * Returns the <code>EndpointReference</code> associated with this
     * <code>BindingProvider</code> instance. The instance returned will be of
