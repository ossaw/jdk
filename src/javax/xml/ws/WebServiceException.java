...
/**
 * The <code>WebServiceException</code> class is the base exception class for
 * all JAX-WS API runtime exceptions.
 *
 * @since JAX-WS 2.0
 **/
...
public class WebServiceException extends java.lang.RuntimeException {
	...
	/**
	 * Constructs a new WebServiceException with the specified cause and a
