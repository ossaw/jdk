...
/**
 * <p>
 * <code>XPathExpression</code> provides access to compiled XPath expressions.
 * </p>
 ...
 * through the {@link XPathVariableResolver}. An
 ...
 * found through the {@link XPathFunctionResolver}. An
 ...
 * <tr>
 * <td>QNames</td>
 * <td>QNames in the expression are resolved against the XPath namespace
 * context.</td>
 * </tr>
 * <tr>
 * <td>result</td>
 ...
 * </table>
 * <p>
 * An XPath expression is not thread-safe and not reentrant. In other words, it
 * is the application's responsibility to make sure that one
 * {@link XPathExpression} object is not used from more than one thread at any
 * given time, and while the <code>evaluate</code> method is invoked,
 * applications may not recursively call the <code>evaluate</code> method.
 * <p>
 *
 * @author <a href="mailto:Norman.Walsh@Sun.com">Norman Walsh</a>
 * @author <a href="mailto:Jeff.Suttor@Sun.com">Jeff Suttor</a>
 * @see <a href="http://www.w3.org/TR/xpath#section-Expressions">XML Path
 *      Language (XPath) Version 1.0, Expressions</a>
 * @since 1.5
 */
public interface XPathExpression {
     ...
     * </p>
     * <p>
     * See <a href="#XPathExpression-evaluation">Evaluation of XPath
     * Expressions</a> for context item evaluation, variable, function and QName
