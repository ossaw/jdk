 ...
 * may be mutable, that is, an application may wish to evaluate the same XPath
 * expression more than once with different variable values, in the course of
 * evaluating any single XPath expression, a variable's value <strong>
 * <em>must</em></strong> not change.
 * </p>
 *
