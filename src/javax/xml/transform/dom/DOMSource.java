 ...
 * @see <a href="http://www.w3.org/TR/DOM-Level-2">Document Object Model (DOM)
...
public class DOMSource implements Source {
	 ...
	 * DOM source is set using {@link #setNode(Node node)} , then the
	 * <code>Transformer</code> will create an empty source
	 * {@link org.w3c.dom.Document} using
	 ...
	 * to the subtree rooted at this node. In XSLT, a "/" pattern still means
	 * the root of the tree (not the subtree), and the evaluation of global
	...
	/**
	 * Create a new input source with a DOM node, and with the system ID also
