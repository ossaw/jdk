...
public interface TransformerHandler extends ContentHandler, LexicalHandler,
    ...
    /**
     * Set the base ID (URI or system ID) from where relative URLs will be
     * resolved.
     * 
     * @param systemID
    ...
    /**
     * <p>
     * Get the <code>Transformer</code> associated with this handler, which is
     * needed in order to set parameters and output properties.
     * </p>
     *
