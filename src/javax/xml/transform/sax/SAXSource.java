 ...
 * {@link javax.xml.parsers.SAXParserFactory#setNamespaceAware(boolean awareness)}
 * method.
 * </p>
 *
...
public class SAXSource implements Source {
     ...
     * SAX source is set using {@link #setInputSource(InputSource inputSource)}
     * , then the <code>Transformer</code> will create an empty source
     * {@link org.xml.sax.InputSource} using
     ...
     * and a SAX InputSource. The {@link javax.xml.transform.Transformer} or
     * {@link javax.xml.transform.sax.SAXTransformerFactory} will set itself to
     * be the reader's {@link org.xml.sax.ContentHandler}, and then will call
     ...
     * {@link javax.xml.transform.sax.SAXTransformerFactory} creates a reader
     * via {@link org.xml.sax.helpers.XMLReaderFactory} (if setXMLReader is not
     * used), sets itself as the reader's {@link org.xml.sax.ContentHandler},
    ...
    /**
     * <p>
     * The SAX InputSource to be used for the source tree input. Should not be
     * <code>null</code>.
     * </p>
     */
