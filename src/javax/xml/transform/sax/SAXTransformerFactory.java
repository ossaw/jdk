 ...
 * the SAXSource which provides (with getXMLReader) a reference to the
 * XMLReader.
 * </p>
 */
public abstract class SAXTransformerFactory extends TransformerFactory {
	 ...
	 * when passed this value as an argument, the TransformerFactory returned
	 * from {@link javax.xml.transform.TransformerFactory#newInstance} may be
	 * safely cast to a SAXTransformerFactory.
	 */
	public static final String FEATURE = "http://javax.xml.transform.sax.SAXTransformerFactory/feature";

	/**
	 * If {@link javax.xml.transform.TransformerFactory#getFeature} returns true
	 * when passed this value as an argument, the
	 * {@link #newXMLFilter(Source src)} and
	 * {@link #newXMLFilter(Templates templates)} methods are supported.
	 */
	...
	/**
	 * Get a TransformerHandler object that can process SAX ContentHandler
	 * events into a Result. The transformation is defined as an identity (or
	 * copy) transformation, for example to copy a series of SAX parse events
	 * into a DOM tree.
	 *
