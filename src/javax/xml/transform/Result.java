...
/**
 * <p>
 * An object that implements this interface contains the information needed to
...
public interface Result {
     ...
     * well-formed XML. However, it is sometimes convenient to be able to
     * produce output that is almost, but not quite well-formed XML; for
     * example, the output may include ill-formed sections that will be
     ...
     * </p>
     *
     * @see <a href="http://www.w3.org/TR/xslt#disable-output-escaping">disable-
     *      output-escaping in XSLT Specification</a>
     */
    public static final String PI_DISABLE_OUTPUT_ESCAPING = "javax.xml.transform.disable-output-escaping";

    /**
     * The name of the processing instruction that is sent if the result tree
     * enables output escaping at some point after having received a
     * PI_DISABLE_OUTPUT_ESCAPING processing instruction.
     *
     * @see <a href="http://www.w3.org/TR/xslt#disable-output-escaping">disable-
     *      output-escaping in XSLT Specification</a>
     */
     ...
     * in error messages and warnings, or to resolve relative output
     * identifiers.
     * </p>
     *
     * @param systemId
