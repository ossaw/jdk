...
/**
 * <p>
 * Acts as a holder for an XML {@link Source} in the form of a StAX reader,i.e.
 * {@link XMLStreamReader} or {@link XMLEventReader}. <code>StAXSource</code>
 * can be used in all cases that accept a <code>Source</code>, e.g.
 * {@link javax.xml.transform.Transformer},
 * {@link javax.xml.validation.Validator} which accept <code>Source</code> as
 * input.
 * <p>
 * <code>StAXSource</code>s are consumed during processing and are not reusable.
 * </p>
 *
...
public class StAXSource implements Source {
     ...
     * returns true when passed this value as an argument, the Transformer
     * supports Source input of this type.
     */
    ...
    /**
     * <p>
     * Creates a new instance of a <code>StAXSource</code> by supplying an
     * {@link XMLEventReader}.
     * </p>
     * <p>
     * <code>XMLEventReader</code> must be a non-<code>null</code> reference.
     * </p>
     * <p>
     * <code>XMLEventReader</code> must be in
     ...
     * </p>
     * <p>
     * <code>XMLStreamReader</code> must be a non-<code>null</code> reference.
     * </p>
     * <p>
     * <code>XMLStreamReader</code> must be in
     * {@link XMLStreamConstants#START_DOCUMENT} or
     * {@link XMLStreamConstants#START_ELEMENT} state.
     * </p>
     *
     ...
     * </p>
     * <p>
     * <code>XMLEventReader</code> will be <code>null</code>. if this
     * <code>StAXSource</code> was created with a <code>XMLStreamReader</code>.
     * </p>
     *
     ...
     * </p>
     * <p>
     * <code>XMLStreamReader</code> will be <code>null</code> if this
     * <code>StAXSource</code> was created with a <code>XMLEventReader</code>.
     * </p>
     *
    ...
    /**
     * <p>
     * In the context of a <code>StAXSource</code>, it is not appropriate to
     * explicitly set the system identifier. The <code>XMLStreamReader</code> or
     * <code>XMLEventReader</code> used to construct this
     * <code>StAXSource</code> determines the system identifier of the XML
     * source.
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * The <code>XMLStreamReader</code> or <code>XMLEventReader</code> used to
     * construct this <code>StAXSource</code> is queried to determine the system
     * identifier of the XML source.
     * </p>
     * <p>
     * The system identifier may be <code>null</code> or an empty
