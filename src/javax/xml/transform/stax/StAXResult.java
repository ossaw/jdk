...
/**
 * <p>
 * Acts as a holder for an XML {@link Result} in the form of a StAX writer,i.e.
 * {@link XMLStreamWriter} or {@link XMLEventWriter}. <code>StAXResult</code>
 * can be used in all cases that accept a <code>Result</code>, e.g.
 * {@link javax.xml.transform.Transformer},
 * {@link javax.xml.validation.Validator} which accept <code>Result</code> as
 * input.
 *
...
public class StAXResult implements Result {
     ...
     * supports Result output of this type.
     */
    ...
    /**
     * <p>
     * In the context of a <code>StAXResult</code>, it is not appropriate to
     * explicitly set the system identifier. The <code>XMLEventWriter</code> or
     * <code>XMLStreamWriter</code> used to construct this
