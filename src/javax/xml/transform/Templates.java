...
public interface Templates {
    ...
    /**
     * Get the properties corresponding to the effective xsl:output element. The
     ...
     * specifically set by the stylesheet should be in the base Properties list,
     * while the XSLT default properties that were not specifically set should
     * be in the "default" Properties list. Thus,
     * getOutputProperties().getProperty(String key) will obtain any property in
     * that was set by the stylesheet, <em>or</em> the default properties, while
     ...
     * Value Templates</a> attribute values will be returned unexpanded (since
     * there is no context at this point). The namespace prefixes inside
     * Attribute Value Templates will be unexpanded, so that they remain valid
     * XPath values.
     * </p>
     *
