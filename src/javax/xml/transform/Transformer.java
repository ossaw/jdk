...
public abstract class Transformer {
     ...
     * {@link Templates#newTransformer()}. <code>reset()</code> is designed to
     ...
     * functionally equal <code>URIResolver</code> and
    ...
    /**
     * <p>
     * Transform the XML <code>Source</code> to a <code>Result</code>. Specific
     * transformation behavior is determined by the settings of the
     ...
     * The result of transforming an empty <code>Source</code> depends on the
     * transformation behavior; it is not always an empty <code>Result</code>.
     * </p>
     *
     * @param xmlSource
     ...
     * URL, the String only contain the local name. An application can safely
     * check for a non-null URI by testing to see if the first character of the
     * name is a '{' character.
     * </p>
     * <p>
     ...
     * desired values are non-<code>String</code> <code>Object</code>s. The
     * parameter names should conform as specified in
     * {@link #setParameter(String name, Object value)}. An
     ...
     * determined by {@link java.lang.Object#equals(Object obj)}, the existing
     ...
     * prefix is used.
     * </p>
     * An <code>IllegalArgumentException</code> is thrown if any of the argument
     ...
     * default properties specified by
     * <a href="http://www.w3.org/TR/xslt#output">section 16 of the XSL
     * Transformations (XSLT) W3C Recommendation</a>. The properties that were
     * specifically set by the user or the stylesheet should be in the base
     * Properties list, while the XSLT default properties that were not
     * specifically set should be the default Properties list. Thus,
     * getOutputProperties().getProperty(String key) will obtain any property in
     * that was set by {@link #setOutputProperty}, {@link #setOutputProperties},
     * in the stylesheet, <em>or</em> the default properties, while
     ...
     * the behaviour is not orthogonal with {@link #setOutputProperties
     * setOutputProperties}.
     * </p>
     *
     ...
     * has a null URL, the String only contain the local name. An application
     * can safely check for a non-null URI by testing to see if the first
     ...
     * stylesheet, that value will be returned. If the value of the property has
     * been defaulted, that is, if no value has been set explicitly either with
     * {@link #setOutputProperty} or in the stylesheet, the result may vary
