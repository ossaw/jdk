 ...
 * <code>setErrorListener</code> method to register an instance of the
 ...
 * which reports all warnings and errors to <code>System.err</code> and does not
 * throw any <code>Exception</code>s. Applications are <em>strongly</em>
 ...
 * decide whether to throw an <code>Exception</code> for different types of
 * errors and warnings. Note however that the <code>Transformer</code> is not
...
public interface ErrorListener {
     ...
     * will not necessarily honor this request.
     * </p>
     *
     * @param exception
