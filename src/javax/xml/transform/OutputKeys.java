 ...
 * Transformer, or to retrieve output properties from a Transformer or Templates
 * object.
 * <p>
 * All the fields in this class are read-only.
 * </p>
 *
 * @see <a href="http://www.w3.org/TR/xslt#output"> section 16 of the XSL
...
public class OutputKeys {
	 ...
	 * values may be used, such as "xhtml", but, if accepted, the handling of
	 * such values is implementation defined. If any of the method values are
	 * not accepted and are not namespace qualified, then
	 * {@link javax.xml.transform.Transformer#setOutputProperty} or
	 * {@link javax.xml.transform.Transformer#setOutputProperties} will throw a
	 ...
	 * </p>
	 * <p>
	 * When the output method is "xml", the version value specifies the version
	 * of XML to be used for outputting the result tree. The default value for
	 * the xml output method is 1.0. When the output method is "html", the
	 * version value indicates the version of the HTML. The default value for
	 * the xml output method is 4.0, which specifies that the result should be
	 * output as HTML conforming to the HTML 4.0 Recommendation [HTML]. If the
	 * output method is "text", the version property is ignored.
	 * </p>
	 * 
	 * @see <a href="http://www.w3.org/TR/xslt#output"> section 16 of the XSL
	 *      Transformations (XSLT) W3C Recommendation</a>
	 ...
	 * bytes. The value of the encoding property should be treated
	 * case-insensitively. The value must only contain characters in the range
	 ...
	 * Authority <a href="http://www.iana.org/">[IANA]</a>,
	 * <a href="http://www.ietf.org/rfc/rfc2278.txt">[RFC2278]</a> or start with
	 * <code>X-</code>.
	 * </p>
	 * 
	 * @see <a href="http://www.w3.org/TR/xslt#output"> section 16 of the XSL
	 ...
	 * <p>
	 * See the documentation for the {@link #DOCTYPE_SYSTEM} property for a
	 * description of what the value of the key should be.
	 * </p>
	 *
	 * @see <a href="http://www.w3.org/TR/xslt#output"> section 16 of the XSL
	 *      Transformations (XSLT) W3C Recommendation</a>
	 ...
	 * </p>
	 * <p>
	 * If the doctype-system property is specified, the xml output method should
	 ...
	 * If doctype-public property is also specified, then the xml output method
	 * should output PUBLIC followed by the public identifier and then the
	 * system identifier; otherwise, it should output SYSTEM followed by the
	 * system identifier. The internal subset should be empty. The value of the
	 * doctype-public property should be ignored unless the doctype-system
	 * property is specified.
	 * </p>
	 * <p>
	 * If the doctype-public or doctype-system properties are specified, then
	 ...
	 * should be HTML or html. If the doctype-public property is specified, then
	 * the output method should output PUBLIC followed by the specified public
	 * identifier; if the doctype-system property is also specified, it should
	 * also output the specified system identifier following the public
	 * identifier. If the doctype-system property is specified but the
	 ...
	 * CDATA sections. Note that these names must use the format described in
	 * the section Qualfied Name Representation in {@link javax.xml.transform}.
	 * </p>
	 *
	 * @see <a href="http://www.w3.org/TR/xslt#output"> section 16 of the XSL
	 *      Transformations (XSLT) W3C Recommendation.</a>
	 ...
	 * </p>
	 * 
	 * @see <a href="http://www.w3.org/TR/xslt#output">s ection 16 of the XSL
	 *      Transformations (XSLT) W3C Recommendation</a>
	 */
