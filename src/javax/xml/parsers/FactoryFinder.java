...
class FactoryFinder {
    ...
    static <T> T newInstance(Class<T> type, String className, ClassLoader cl, boolean doFallback,
        ...
        try {
            ...
            throw new FactoryConfigurationError(x, "Provider " + className + " could not be instantiated: "
                    + x);
        }
    }
    ...
    private static <T> T findServiceProvider(final Class<T> type) {
        try {
            ...
            final FactoryConfigurationError error = new FactoryConfigurationError(x, x.getMessage());
            throw error;
        }
    }
