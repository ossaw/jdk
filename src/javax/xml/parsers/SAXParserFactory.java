...
public abstract class SAXParserFactory {
	...
	/**
	 * Obtain a new instance of a <code>SAXParserFactory</code>. This static
	 * method creates a new factory instance This method uses the following
	 * ordered lookup procedure to determine the <code>SAXParserFactory</code>
	 * implementation class to load:
	 * <ul>
	 * <li>Use the <code>javax.xml.parsers.SAXParserFactory</code> system
	 * property.</li>
	...
	/**
	 * <p>
	 * Obtain a new instance of a <code>SAXParserFactory</code> from class name.
	...
	public static SAXParserFactory newInstance(String factoryClassName, ClassLoader classLoader) {
		...
		// exception
		return FactoryFinder.newInstance(SAXParserFactory.class, factoryClassName, classLoader,
				false);
	}
	 ...
	 * resources. If XML processing is limited for security reasons, it will be
	 * reported via a call to the registered
	 * {@link org.xml.sax.ErrorHandler#fatalError(SAXParseException exception)}.
	 * See {@link SAXParser} <code>parse</code> methods for handler
	 * specification.</li>
	 * <li>When the feature is <code>false</code>, the implementation will
	 * processing XML according to the XML specifications without regard to
	 * possible implementation limits.</li>
	 * </ul>
	 *
	 * @param name
	 ...
	 * property in conjunction with a non-null {@link Schema} object. Such
