...
/**
 * Defines the API that wraps an {@link org.xml.sax.XMLReader} implementation
 * class. In JAXP 1.0, this class wrapped the {@link org.xml.sax.Parser}
 * interface, however this interface was replaced by the
 * {@link org.xml.sax.XMLReader}. For ease of transition, this class continues
 * to support the same name and interface as well as supporting new methods.
 *
 * An instance of this class can be obtained from the
 * {@link javax.xml.parsers.SAXParserFactory#newSAXParser()} method. Once an
 * instance of this class is obtained, XML can be parsed from a variety of input
 ...
 * named <code>&quot;javax.xml.parsers.SAXParserFactory&quot;</code>. This
 * property names a class that is a concrete subclass of this abstract class. If
 * no property is defined, a platform default will be used.
 * </p>
 *
 * As the content is parsed by the underlying parser, methods of the given
 * {@link org.xml.sax.HandlerBase} or the
 ...
 * consider using the {@link org.xml.sax.helpers.ParserAdapter} class to
 * initially adapt their SAX1 implementation to work under this revised class.
 *
...
public abstract class SAXParser {
     ...
     *
     * <p>
     * <code>SAXParser</code> is reset to the same state as when it was created
     * with {@link SAXParserFactory#newSAXParser()}. <code>reset()</code> is
     * designed to allow the reuse of existing <code>SAXParser</code>s thus
     * saving resources associated with the creation of new
     * <code>SAXParser</code>s.
     * </p>
     *
     * <p>
     * The reset <code>SAXParser</code> is not guaranteed to have the same
     * {@link Schema} <code>Object</code>, e.g.
    ...
    public void reset() {
        ...
        throw new UnsupportedOperationException("This SAXParser, \"" + this
                .getClass().getName()
     ...
     * XML using the specified {@link org.xml.sax.HandlerBase}. <i> Use of the
     * DefaultHandler version of this method is recommended as the HandlerBase
     * class has been deprecated in SAX 2.0</i>.
     * </p>
     *
     * @param is
     ...
     * @throws IOException
     *                                  If an IO error occurs interacting with
     *                                  the
     *                                  <code>InputStream</code>.
     *
     * @see org.xml.sax.DocumentHandler
     */
    public void parse(InputStream is, HandlerBase hb) throws SAXException,
            IOException {
        if (is == null) {
     ...
     *
     * @throws IllegalArgumentException
     *                                  If the given <code>InputStream</code> is
     *                                  <code>null</code>.
     * @throws IOException
     *                                  If any IO error occurs interacting with
     *                                  the
     *                                  <code>InputStream</code>.
     * @throws SAXException
     *                                  If any SAX errors occur during
     *                                  processing.
     *
     ...
     * (URI) as XML using the specified {@link org.xml.sax.HandlerBase}. <i> Use
     * of the DefaultHandler version of this method is recommended as the
     ...
     * @see org.xml.sax.DocumentHandler
     */
    public void parse(String uri, HandlerBase hb) throws SAXException,
            IOException {
        if (uri == null) {
     ...
     * {@link org.xml.sax.HandlerBase}. <i> Use of the DefaultHandler version of
     * this method is recommended as the HandlerBase class has been deprecated
     * in SAX 2.0</i>
     *
     * @param f
     ...
     * specified {@link org.xml.sax.HandlerBase}. <i> Use of the DefaultHandler
     * version of this method is recommended as the HandlerBase class has been
     * deprecated in SAX 2.0</i>
     *
     * @param is
     ...
     *
     * @throws IllegalArgumentException
     *                                  If the <code>InputSource</code> object
     *                                  is <code>null</code>.
     * @throws IOException
     *                                  If any IO errors occur.
     * @throws SAXException
     ...
     * @see org.xml.sax.DocumentHandler
     */
    public void parse(InputSource is, HandlerBase hb) throws SAXException,
            IOException {
        if (is == null) {
    ...
    /**
     * Returns the SAX parser that is encapsultated by the implementation of
     * this class.
     *
     * @return The SAX parser that is encapsultated by the implementation of
     *         this class.
     *
     * @throws SAXException
     ...
     *
     * @return The XMLReader that is encapsulated by the implementation of this
     *         class.
     *
     * @throws SAXException
     *                      If any SAX errors occur during processing.
     ...
     * namespaces.
     *
     * @return true if this parser is configured to understand namespaces; false
     *         otherwise.
     */
     ...
     * documents.
     *
     * @return true if this parser is configured to validate XML documents;
     *         false otherwise.
     */
     ...
     * {@link org.xml.sax.XMLReader}. A list of the core features and properties
     * can be found at
     * <a href="http://sax.sourceforge.net/?selected=get-set"> http://sax.
     * sourceforge.net/?selected=get-set</a>.
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * Setting the {@link javax.xml.XMLConstants#ACCESS_EXTERNAL_SCHEMA}
     * property restricts the access to external Schema set by the
     * schemaLocation attribute to the protocols specified by the property. If
     * access is denied during parsing due to the restriction of this property,
     * {@link org.xml.sax.SAXException} will be thrown by the parse methods
     ...
     *                                   When the underlying XMLReader does not
    ...
    /**
     * <p>
     * Get a reference to the the {@link Schema} being used by the XML
     * processor.
     * </p>
     *
     * <p>
     ...
     *         {@link SAXParserFactory#isXIncludeAware()} when this parser was
