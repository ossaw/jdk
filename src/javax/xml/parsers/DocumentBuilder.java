 ...
 * this class, an application programmer can obtain a {@link Document} from XML.
 * <p>
 * An instance of this class can be obtained from the
 * {@link DocumentBuilderFactory#newDocumentBuilder()} method. Once an instance
 ...
 * parser to parse XML document into a <code>Document</code>. It merely requires
 * that the implementation communicate with the application using these existing
 * APIs.
 *
...
public abstract class DocumentBuilder {
     ...
     * </p>
     * <p>
     * <code>DocumentBuilder</code> is reset to the same state as when it was
     * created with {@link DocumentBuilderFactory#newDocumentBuilder()}.
     * <code>reset()</code> is designed to allow the reuse of existing
     * <code>DocumentBuilder</code>s thus saving resources associated with the
     * creation of new <code>DocumentBuilder</code>s.
     * </p>
     * <p>
     * The reset <code>DocumentBuilder</code> is not guaranteed to have the same
     * {@link EntityResolver} or {@link ErrorHandler} <code>Object</code>s, e.g.
     * {@link Object#equals(Object obj)}. It is guaranteed to have a
     * functionally equal <code>EntityResolver</code> and
    ...
    public void reset() {
        ...
        throw new UnsupportedOperationException("This DocumentBuilder, \"" + this.getClass().getName()
    ...
    /**
     * Specify the {@link EntityResolver} to be used to resolve entities present
     * in the XML document to be parsed. Setting this to <code>null</code> will
    ...
    /**
     * Specify the {@link ErrorHandler} to be used by the parser. Setting this
     * to <code>null</code> will result in the underlying implementation using
     * it's own default implementation and behavior.
     *
     * @param eh
     ...
     *         {@link DocumentBuilderFactory#isXIncludeAware()} when this parser
