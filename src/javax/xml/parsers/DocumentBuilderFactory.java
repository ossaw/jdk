...
public abstract class DocumentBuilderFactory {
	 ...
	 * static method creates a new factory instance. This method uses the
	 * following ordered lookup procedure to determine the
	 * <code>DocumentBuilderFactory</code> implementation class to load:
	 * <ul>
	 * <li>Use the <code>javax.xml.parsers.DocumentBuilderFactory</code> system
	 * property.</li>
	...
	/**
	 * <p>
	 * Obtain a new instance of a <code>DocumentBuilderFactory</code> from class
	 ...
	 * as defined in the XML recommendation. In other words, it essentially just
	 ...
	 * leaving the {@link #setValidating(boolean)} method <code>false</code>,
	 * then use the {@link #setSchema(Schema)} method to associate a schema to a
	 * parser.
	 * </p>
	 *
	 * @param validating
	 ...
	 * Due to reliance on the content model this setting requires the parser to
	 * be in validating mode. By default the value of this is set to
	 * <code>false</code>.
	 *
	 * @param whitespace
	 ...
	 *
	 * @return true if the factory is configured to produce parsers which ignore
	 *         ignorable whitespace in element content; false otherwise.
	 */
	...
	/**
	 * Indicates whether or not the factory is configured to produce parsers
	 * which expand entity reference nodes.
	 *
	 * @return true if the factory is configured to produce parsers which expand
	 *         entity reference nodes; false otherwise.
	 */
	 ...
	 *
	 * @return true if the factory is configured to produce parsers which
	 *         ignores comments; false otherwise.
	 */
	...
	/**
	 * Indicates whether or not the factory is configured to produce parsers
	 * which converts CDATA nodes to Text nodes and appends it to the adjacent
	 * (if any) Text node.
	 *
	 * @return true if the factory is configured to produce parsers which
	 *         converts CDATA nodes to Text nodes and appends it to the adjacent
	 ...
	 * thrown if this <code>DocumentBuilderFactory</code> or the
	 * <code>DocumentBuilder</code>s it creates cannot support the feature. It
	 ...
	 * thrown if this <code>DocumentBuilderFactory</code> or the
	 * <code>DocumentBuilder</code>s it creates cannot support the feature. It
	 * is possible for an <code>DocumentBuilderFactory</code> to expose a
	 ...
	 * the error handler is not set, ignore them or throw them), just like any
	 * other errors found by the parser itself. In other words, if the
	 ...
	 * property and/or the
	 * <code>http://java.sun.com/xml/jaxp/properties/schemaLanguage</code>
	 * property in conjunction with a {@link Schema} object. Such configuration
	 ...
	 * custom mechanisms as long as they yield the result described in the
	 * specification.
	 * </p>
	 *
	 * @param schema
