...
/**
 * The <code>ControllerEventListener</code> interface should be implemented by
 * classes whose instances need to be notified when a <code>Sequencer</code> has
 * processed a requested type of MIDI control-change event. To register a
 * <code>ControllerEventListener</code> object to receive such notifications,
 * invoke the
 * {@link Sequencer#addControllerEventListener(ControllerEventListener, int[])
 * addControllerEventListener} method of <code>Sequencer</code>, specifying the
 * types of MIDI controllers about which you are interested in getting
...
public interface ControllerEventListener extends EventListener {
	 ...
	 *
	 * @param event
	 *            the control-change event that the sequencer encountered in the
