 ...
 * generate sound or raw MIDI output. Common MIDI receivers include synthesizers
 * and MIDI Out ports.
 *
 * @see MidiDevice
 * @see Synthesizer
...
public interface Receiver extends AutoCloseable {
     ...
     * If the device this <code>Receiver</code> is retrieved from is closed
     * explicitly by calling {@link MidiDevice#close MidiDevice.close}, the
     * <code>Receiver</code> is closed, too. For a detailed description of
