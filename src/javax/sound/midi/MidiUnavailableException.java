 ...
 * occurs when a device is in use by another application. More generally, it can
 * occur when there is a finite number of a certain kind of resource that can be
 * used for some purpose, and all of them are already in use (perhaps all by
