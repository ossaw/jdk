...
/**
 * A <code>Transmitter</code> sends <code>{@link MidiEvent}</code> objects to
 * one or more <code>{@link Receiver Receivers}</code>. Common MIDI transmitters
...
public interface Transmitter extends AutoCloseable {
	 ...
	 * <code>Receiver</code> or <code>Transmitter</code> instances that opened
	 * the device implicitly, and unless the device has been opened explicitly.
	 * If the device this <code>Transmitter</code> is retrieved from is closed
	 * explicitly by calling {@link MidiDevice#close MidiDevice.close}, the
	 * <code>Transmitter</code> is closed, too. For a detailed description of
	 * open/close behaviour see the class description of
	 * {@link javax.sound.midi.MidiDevice MidiDevice}.
	 *
