 ...
 * queued in the data line's buffer. If the buffer does overflow, the oldest
...
public interface TargetDataLine extends DataLine {
     ...
     * line will always result in a <code>LineUnavailableException</code>.
     *
     * @param format
     ...
     * <code>DataLine</code> interface. (While it is guaranteed that this number
     * of bytes can be read without blocking, there is no guarantee that
     * attempts to read additional data will block.)
     * <p>
     * The number of bytes to be read must represent an integral number of
     * sample frames, such that: <br>
     * <center>
     * <code>[ bytes read ] % [frame size in bytes ] == 0</code></center> <br>
