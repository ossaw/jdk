...
/**
 * An instance of the <code>AudioFileFormat</code> class describes an audio
 * file, including the file type, the file's length in bytes, the length in
 * sample frames of the audio data contained in the file, and the format of the
 * audio data.
 * <p>
...
public class AudioFileFormat {
    ...
    /**
     * An instance of the <code>Type</code> class represents one of the standard
    ...
    public static class Type {
        ...
        /**
         * Provides the file type's name as the <code>String</code>
