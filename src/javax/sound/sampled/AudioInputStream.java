 ...
 * <code>AudioInputStream</code> objects. For example, the methods let you:
 * <ul>
...
public class AudioInputStream extends InputStream {
    ...
    /**
     * The <code>InputStream</code> from which this
     * <code>AudioInputStream</code> object was constructed.
     */
     ...
     * stream's frame size must be one byte, or an <code>IOException</code> will
     * be thrown.
     *
     ...
     * into the buffer array <code>b</code>. The number of bytes actually read
     ...
     * <code>b.length - (b.length % frameSize)
     ...
     *        the buffer into which the data is read
     * @param off
     *        the offset, from the beginning of array <code>b</code>, at
     ...
     * the next invocation of a <code>read</code> or <code>skip</code> method
     * for this audio input stream; the limit can vary each time these methods
     * are invoked. Depending on the underlying stream,an IOException may be
