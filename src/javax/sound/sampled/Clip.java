 ...
 * audio data can be loaded prior to playback, instead of being streamed in real
 * time.
 * <p>
 ...
 * <code>start</code> and <code>stop</code> methods. These methods do not reset
 * the media position; <code>start</code> causes playback to continue from the
 ...
 * <code>{@link DataLine#stop stop}</code> with setFramePosition(0), which
 * rewinds the media to the beginning of the clip.
 *
 * @author Kara Kytle
 * @since 1.3
 */
public interface Clip extends DataLine {
	 ...
	 * open and an <code>{@link LineEvent.Type#OPEN OPEN}</code> event is
	 * dispatched to the line's listeners.
	 * <p>
	 ...
	 * <code>{@link DataLine#getFramePosition getFramePosition}</code> method of
	 * <code>DataLine</code>.
	 *
	 * @param frames
