 ...
 * <code>Line</code> objects let you obtain a particular control object by
 * passing its class as the argument to a {@link Line#getControl(Control.Type)
 * getControl} method.
 * <p>
...
public abstract class Control {
	...
	/**
	 * An instance of the <code>Type</code> class represents the type of the
	...
	public static class Type {
		 ...
		 * This <code>String</code> is the same name that was passed to the
		 * constructor.
		 *
