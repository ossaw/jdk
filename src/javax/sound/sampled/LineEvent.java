...
/**
 * The <code>LineEvent</code> class encapsulates information that a line sends
 * its listeners whenever the line opens, closes, starts, or stops. Each of
 * these four state changes is represented by a corresponding type of event. A
 * listener receives the event as a parameter to its {@link LineListener#update
...
public class LineEvent extends java.util.EventObject {
     ...
     * lines, such as <code>START</code> and <code>STOP</code>. For events
     * generated by lines that do not count sample frames, and for any other
     * events for which this value is not known, the position value should be
     ...
     * consistent with this. which is a reasonable definition....
     */
    ...
    public static class Type {
         ...
         * input or output of audio data in response to a {@link DataLine#start
         * start} request.
         * 
         * @see #STOP
         * @see DataLine#start
