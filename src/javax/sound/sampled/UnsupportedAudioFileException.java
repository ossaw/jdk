...
/**
 * An <code>UnsupportedAudioFileException</code> is an exception indicating that
 * an operation failed because a file did not contain valid data of a recognized
