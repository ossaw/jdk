...
/**
 * The <code>ReverbType</code> class provides methods for accessing various
 ...
 * <p>
 * The reverberation parameters provided by <code>ReverbType</code> consist of
 * the delay time and intensity of early reflections, the delay time and
 * intensity of late reflections, and an overall decay time. Early reflections
 * are the initial individual low-order reflections of the direct signal off the
