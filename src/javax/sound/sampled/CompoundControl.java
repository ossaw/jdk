 ...
 * over two or more related properties, each of which is itself represented as a
 * <code>Control</code>.
 *
 * @author Kara Kytle
 * @since 1.3
...
public abstract class CompoundControl extends Control {
	...
	/**
	 * An instance of the <code>CompoundControl.Type</code> inner class
	 * identifies one kind of compound control. Static instances are provided
