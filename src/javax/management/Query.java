 ...
 * {@code QueryExp}, but it is usually best to obtain the {@code QueryExp} value
 * by calling the static methods in this class. This is particularly true when
 * querying a remote MBean Server: a custom implementation of the
...
public class Query extends Object {
	...
	/**
	 * A code representing the {@link Query#gt} query. This is chiefly of
	 * interest for the serialized form of queries.
	 */
	public static final int GT = 0;

	/**
	 * A code representing the {@link Query#lt} query. This is chiefly of
	 * interest for the serialized form of queries.
	 */
	public static final int LT = 1;

	/**
	 * A code representing the {@link Query#geq} query. This is chiefly of
	 * interest for the serialized form of queries.
	 */
	public static final int GE = 2;

	/**
	 * A code representing the {@link Query#leq} query. This is chiefly of
	 * interest for the serialized form of queries.
	 */
	public static final int LE = 3;

	/**
	 * A code representing the {@link Query#eq} query. This is chiefly of
	 * interest for the serialized form of queries.
	 */
	public static final int EQ = 4;

	/**
	 * A code representing the {@link Query#plus} expression. This is chiefly of
	 * interest for the serialized form of queries.
	 */
	public static final int PLUS = 0;

	/**
	 * A code representing the {@link Query#minus} expression. This is chiefly
	 * of interest for the serialized form of queries.
	 */
	public static final int MINUS = 1;

	/**
	 * A code representing the {@link Query#times} expression. This is chiefly
	 * of interest for the serialized form of queries.
	 */
	public static final int TIMES = 2;

	/**
	 * A code representing the {@link Query#div} expression. This is chiefly of
	 * interest for the serialized form of queries.
	 */
	 ...
	 *         <a href=
	 *         "../../serialized-form.html#javax.management.BinaryRelQueryExp">
	...
	/**
	 * Returns a query expression that represents the constraint that one value
	 ...
	 *         <a href=
	 *         "../../serialized-form.html#javax.management.BetweenQueryExp">
	...
	/**
	 * Returns a query expression that represents a matching constraint on a
	 * string argument. The matching syntax is consistent with file globbing:
	 * supports "<code>?</code>", "<code>*</code>", "<code>[</code>", each of
	 * which may be escaped with "<code>\</code>"; character classes may use
	 * "<code>!</code>" for negation and "<code>-</code>" for range. (
	 * <code>*</code> for any character sequence, <code>?</code> for a single
	 * arbitrary character, <code>[...]</code> for a character sequence). For
	 * example: <code>a*b?c</code> would match a string starting with the
	 * character <code>a</code>, followed by any number of characters, followed
	 ...
	 * MBeanServer.getObjectInstance(objectName)} and
	 * {@link MBeanServer#getAttribute MBeanServer.getAttribute(objectName,
	 * name)}.
	 * </p>
	 *
	 * @param className
	 ...
	 *         returned object will be serialized as an instance of the
	 *         non-public class <a href=
	 *         "../../serialized-form.html#javax.management.QualifiedAttributeValueExp">
	 ...
	 * </p>
	 *
	 * @return A class attribute expression. The returned object will be
	 *         serialized as an instance of the non-public class <a href=
	 *         "../../serialized-form.html#javax.management.ClassAttributeValueExp">
	 ...
	 *         will be serialized as an instance of the non-public class
	 *         <a href=
	 *         "../../serialized-form.html#javax.management.NumericValueExp">
	 ...
	 *         will be serialized as an instance of the non-public class
	 *         <a href=
	 *         "../../serialized-form.html#javax.management.BooleanValueExp">
	...
	/**
	 * Returns a binary expression representing the difference between two
	 * numeric values.
	 *
	 * @param value1
	 *            The first '-' operand.
	...
	/**
	 * Returns a query expression that represents a matching constraint on a
	 * string argument. The value must start with the given literal string
	 * value.
	 *
	 * @param a
	 *            An attribute expression.
	...
	/**
	 * Returns a query expression that represents an inheritance constraint on
	 * an MBean class.
	 * <p>
	 ...
	 *         instance of the non-public class <a href=
	 *         "../../serialized-form.html#javax.management.InstanceOfQueryExp">
