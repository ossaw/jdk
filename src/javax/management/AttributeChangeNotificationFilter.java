...
/**
 * This class implements of the {@link javax.management.NotificationFilter
 * NotificationFilter} interface for the
 * {@link javax.management.AttributeChangeNotification attribute change
 * notification}. The filtering is performed on the name of the observed
 * attribute.
 * <P>
...
public class AttributeChangeNotificationFilter implements NotificationFilter {
    ...
    /**
     * @serial {@link Vector} that contains the enabled attribute names. The
     ...
     * This filter compares the attribute name of the specified attribute change
     ...
     * which equals the specified name to be sent to the listener. <BR>
     ...
     * <BR>
     * If the specified name is not in the list of enabled attribute names, this
