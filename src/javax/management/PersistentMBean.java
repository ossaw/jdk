 ...
 * persistent. MBeans supporting this interface should call the load method
 * during construction in order to prime the MBean from the persistent store. In
 * the case of a ModelMBean, the store method should be called by the
 * MBeanServer based on the descriptors in the ModelMBean or by the MBean itself
 * during normal processing of the ModelMBean.
 *
 * @since 1.5
 */
public interface PersistentMBean {
     ...
     * operation values. If one of these methods of persistence is not supported
     * a "serviceNotFound" exception will be thrown.
     * <P>
