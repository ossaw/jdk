 ...
 * {@link MBeanServerDelegate MBeanServerDelegate} MBean that represents the
 ...
 * <ul>
 * <li>Its {@linkplain Notification#getType() notification type} is
 * {@code "JMX.mbean.registered.group"} or
 * {@code "JMX.mbean.unregistered.group"}, which can also be written
 * {@link MBeanServerNotification#REGISTRATION_NOTIFICATION}{@code + ".group"}
 * or {@link MBeanServerNotification#UNREGISTRATION_NOTIFICATION}
 * {@code + ".group"}.</li>
 * <li>Its {@linkplain #getMBeanName() MBean name} is an ObjectName pattern that
 * selects the set (or a superset) of the MBeans being registered or
 * unregistered</li>
 * <li>Its {@linkplain Notification#getUserData() user data} can optionally be
