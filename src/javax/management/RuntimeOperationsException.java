...
/**
 * Represents runtime exceptions thrown in the agent when performing operations
 * on MBeans. It wraps the actual <CODE>java.lang.RuntimeException</CODE>
 * thrown.
 *
 * @since 1.5
 */
public class RuntimeOperationsException extends JMRuntimeException {
	...
	/**
	 * Creates a <CODE>RuntimeOperationsException</CODE> that wraps the actual
