...
public class MBeanConstructorInfo extends MBeanFeatureInfo implements Cloneable {
     ...
     * contributed by any annotations on the {@code
    ...
    public MBeanConstructorInfo(String description, Constructor<?> constructor) {
        this(constructor.getName(), description, constructorSignature(constructor), Introspector
                .descriptorForElement(constructor));
    }
    ...
    public String toString() {
        return getClass().getName() + "[" + "description=" + getDescription() + ", " + "name=" + getName()
                + ", " + "signature=" + Arrays.asList(fastGetSignature()) + ", " + "descriptor="
                + getDescriptor() + "]";
    }
     ...
     *         {@link #getSignature()}, and {@link #getDescriptor()} values are
    ...
    /*
     * Unlike attributes and operations, it's quite likely we'll have more than
     * one constructor with the same name and even description, so we include
     * the parameter array in the hashcode. We don't include the description,
     * though, because it could be quite long and yet the same between
     * constructors. Likewise for the descriptor.
     */
    public int hashCode() {
