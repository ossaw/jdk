 ...
 * wrong class. This exception is used internally by JMX during the evaluation
 * of a query. User code does not usually see it.
 *
 * @since 1.5
 */
public class InvalidApplicationException extends Exception {
    ...
    /**
     * Constructs an <CODE>InvalidApplicationException</CODE> with the specified
     * <CODE>Object</CODE>.
     *
     * @param val
