...
/**
 * Represents runtime exceptions thrown by MBean methods in the agent. It
 * "wraps" the actual <CODE>java.lang.RuntimeException</CODE> exception thrown.
 * This exception will be built by the MBeanServer when a call to an MBean
...
public class RuntimeMBeanException extends JMRuntimeException {
	...
	/**
	 * Creates a <CODE>RuntimeMBeanException</CODE> that wraps the actual
