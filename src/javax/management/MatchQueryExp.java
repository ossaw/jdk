...
class MatchQueryExp extends QueryEval implements QueryExp {
	...
	/*
	 * Tests whether string s is matched by pattern p. Supports "?", "*", "[",
	 * each of which may be escaped with "\"; character classes may use "!" for
	 * negation and "-" for range. Not yet supported: internationalization; "\"
	 * inside brackets.<P> Wildcard matching routine by Karl Heuer. Public
	 * Domain.<P>
	 */
