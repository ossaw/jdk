...
public class MBeanFeatureInfo implements Serializable, DescriptorRead {
	...
	/**
	 * @serial The Descriptor for this MBeanFeatureInfo. This field can be null,
	 *         which is equivalent to an empty Descriptor.
	 */
	private transient Descriptor descriptor;

	/**
	 * Constructs an <CODE>MBeanFeatureInfo</CODE> object. This constructor is
	 * equivalent to {@code MBeanFeatureInfo(name,
	...
	/**
	 * Returns the descriptor for the feature. Changing the returned value will
	...
	/**
	 * Deserializes an {@link MBeanFeatureInfo} from an
