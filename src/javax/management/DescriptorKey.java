 ...
 * in a {@link Descriptor}. This can be the Descriptor for an MBean, or for an
 ...
 * {@code long}. The {@code @Units} annotation, given the above definition, will
 * ensure that the {@link MBeanAttributeInfo} for this attribute will have a
 ...
 * </tr>
 * <tr>
 * <td>descriptionResourceBundleBaseName</td>
 ...
 * <li>a parameter of a method in a Standard MBean or MXBean interface when that
 * method is an operation (not a getter or setter for an attribute);
 * <li>a public constructor in the class that implements a Standard MBean or
 * MXBean;
 ...
 * interfaces. Method annotations are checked only in the most specific
 ...
 * or two members of the same annotation, must not define a different value for
 * the same Descriptor field. Fields from annotations on a getter method must
 ...
 * <a href="Descriptor.html#immutableInfo">{@code
 ...
 * </tr>
 * <tr>
 * <td>Primitive value ({@code 5}, {@code false}, etc)</td>
 * <td>Wrapped value ({@code Integer.valueOf(5)}, {@code Boolean.FALSE}, etc)
 * </td>
 * </tr>
 * <tr>
 * <td>Class constant (e.g. {@code Thread.class})</td>
 * <td>Class name from {@link Class#getName()} (e.g. {@code "java.lang.Thread"})
 * </td>
 * </tr>
 * <tr>
 * <td>Enum constant (e.g. {@link ElementType#FIELD})</td>
 * <td>Constant name from {@link Enum#name()} (e.g. {@code "FIELD"})</td>
 * </tr>
 * <tr>
 * <td>Array of class constants or enum constants</td>
 * <td>String array derived by applying these rules to each element</td>
 * </tr>
 * <tr>
 * <td>Value of any other type<br>
