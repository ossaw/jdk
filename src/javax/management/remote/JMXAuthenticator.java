 ...
 * {@link JMXConnectorServer#AUTHENTICATOR}. For connector servers that use only
 * this authentication system, if this attribute is not present or its value is
 * <code>null</code> then no user authentication will be performed and full
 ...
 * Authorization checks will be then performed based on the given set of
 * principals.
 * </p>
 *
 * @since 1.5
