 ...
 * buffer have positive, monotonically increasing sequence numbers. The result
 * of a notification query contains the following elements:
 * </p>
 * <ul>
 * <li>The sequence number of the earliest notification still in the buffer.
 * <li>The sequence number of the next notification available for querying. This
 * will be the starting sequence number for the next notification query.
 * <li>An array of (Notification,listenerID) pairs corresponding to the returned
 * notifications and the listeners they correspond to.
 * </ul>
 * <p>
 * It is possible for the <code>nextSequenceNumber</code> to be less than the
 * <code>earliestSequenceNumber</code>. This signifies that notifications
 * between the two might have been lost.
 * </p>
 *
 * @since 1.5
 */
public class NotificationResult implements Serializable {
    ...
    /**
     * Returns the sequence number of the earliest notification still in the
     * buffer.
     *
     * @return the sequence number of the earliest notification still in the
     *         buffer.
     */
    ...
    /**
     * Returns the sequence number of the next notification available for
     * querying.
     *
     * @return the sequence number of the next notification available for
     *         querying.
     */
    ...
    /**
     * Returns the notifications resulting from the query, and the listeners
     * they correspond to.
     *
     * @return the notifications resulting from the query, and the listeners
    ...
    private void readObject(ObjectInputStream ois) throws IOException, ClassNotFoundException {
        ...
        try {
            ...
            this.targetedNotifications = this.targetedNotifications.length == 0 ? this.targetedNotifications
    ...
    private static void validate(TargetedNotification[] targetedNotifications, long earliestSequenceNumber,
            long nextSequenceNumber) throws IllegalArgumentException {
        ...
        /*
         * We used to check nextSequenceNumber >= earliestSequenceNumber here.
         * But in fact the opposite can legitimately be true if notifications
         * have been lost.
         */
    }
}
