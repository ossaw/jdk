 ...
 * Instances of this interface are created by {@link JMXConnectorServerFactory}
 * as part of its
 * {@link JMXConnectorServerFactory#newJMXConnectorServer(JMXServiceURL,Map,MBeanServer)
 * newJMXConnectorServer} method.
 * </p>
 *
 * @since 1.5
 */
public interface JMXConnectorServerProvider {
	/**
	 * <p>
	 * Creates a new connector server at the given address. Each successful call
	 * to this method produces a different <code>JMXConnectorServer</code>
	 * object.
	 * </p>
	 *
	 * @param serviceURL
	 ...
	 *
	 * @param environment
	 *            a read-only Map containing named attributes to control the new
	 *            connector server's behavior. Keys in this map must be Strings.
