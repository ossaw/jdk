 ...
 * additional identity. Refer to the {@link javax.security.auth.Subject} class
 * for more information on how to achieve this. Authorization decisions can then
 * be based upon the Principals associated with a <code>Subject</code>.
 *
...
public class JMXPrincipal implements Principal, Serializable {
    ...
    /**
     * @serial The JMX Remote API name for the identity represented by this
     *         <code>JMXPrincipal</code> object.
     * @see #getName()
     */
    private String name;
