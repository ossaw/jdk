...
/**
 * <p>
 * Implemented by objects that can have a {@code JMXServiceURL} address. All
 * {@link JMXConnectorServer} objects implement this interface. Depending on the
 * connector implementation, a {@link JMXConnector} object may implement this
 * interface too. {@code JMXConnector} objects for the RMI Connector are
