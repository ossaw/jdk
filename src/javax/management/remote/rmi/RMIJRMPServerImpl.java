...
/**
 * <p>
 * An {@link RMIServer} object that is exported through JRMP and that creates
 * client connections as RMI objects exported through JRMP. User code does not
 * usually reference this class directly.
 * </p>
 *
 * @see RMIServerImpl
 *
...
public class RMIJRMPServerImpl extends RMIServerImpl {
	 ...
	 *            {@link RMIConnectionImpl} objects it creates will be exported.
	 ...
	 *                if the {@link RMIServer} object cannot be created.
	 *
	 ...
	 *
	 * @exception IOException
	 *                if the stub cannot be obtained - e.g the RMIJRMPServerImpl
	 ...
	 *
	 * @exception IOException
	 *                if the new {@link RMIConnection} object cannot be created
	 *                or exported.
	 */
