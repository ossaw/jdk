...
public interface RMIServer extends Remote {
	/**
	 * <p>
	 * The version of the RMI Connector Protocol understood by this connector
	 * server. This is a string with the following format:
	 * </p>
	 *
	 * <pre>
	 ...
	 * unspecified. It is recommended that it include an implementation version
	 * number. An implementation can use an empty string as its implementation
	 * name, for example for security reasons.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Makes a new connection through this RMI connector. Each remote client
	 * calls this method to obtain a new RMI object representing its connection.
	 * </p>
	 *
	 * @param credentials
