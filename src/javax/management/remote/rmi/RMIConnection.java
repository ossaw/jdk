 ...
 * a method are wrapped in a {@link MarshalledObject}. An implementation of this
 * interface must first get the appropriate class loader for the operation and
 * its target, then deserialize the marshalled parameters with this classloader.
 * Except as noted, a parameter that is a <code>MarshalledObject</code> or
 ...
 * method is not specified here, it is the same as in the corresponding
 * <code>MBeanServerConnection</code> method.
 *
 * @since 1.5
 */
/*
 ...
 * 255. This is also why we suppress rawtypes warnings.
 */
@SuppressWarnings("rawtypes")
public interface RMIConnection extends Closeable, Remote {
	/**
	 * <p>
	 * Returns the connection ID. This string is different for every open
	 * connection to a given RMI connector server.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Closes this connection. On return from this method, the RMI object
	 * implementing this interface is unexported, so further remote calls to it
	 * will fail.
	 * </p>
	 *
	 * @throws IOException
	 *             if the connection could not be closed, or the Remote object
	 *             could not be unexported, or there was a communication failure
	 ...
	 *            The <code>Subject</code> containing the delegation principals
	 *            or <code>null</code> if the authentication principal is used
	 *            instead.
	 *
	 ...
	 *             Wraps a <code>java.lang.ClassNotFoundException</code> or a
	 *             <code>java.lang.Exception</code> that occurred when trying to
	 *             invoke the MBean's constructor.
	 * @throws InstanceAlreadyExistsException
	 *             The MBean is already under the control of the MBean server.
	 * @throws MBeanRegistrationException
	 *             The <code>preRegister</code> (<code>MBeanRegistration</code>
	 ...
	 *             Wraps a <code>java.lang.IllegalArgumentException</code>: The
	 *             className passed in parameter is null, the
	 *             <code>ObjectName</code> passed in parameter contains a
	 *             pattern or no <code>ObjectName</code> is specified for the
	 *             MBean.
	 * @throws SecurityException
	 *             if the client, or the delegated Subject if any, does not have
	...
	/**
	 * Handles the method
	 * {@link javax.management.MBeanServerConnection#createMBean(String, ObjectName, Object[], String[])}
	 * . The <code>Object[]</code> parameter is wrapped in a
	 ...
	 *            invoked, encapsulated into a <code>MarshalledObject</code>.
	 *            The encapsulated array can be null, equivalent to an empty
	 *            array.
	 * @param signature
	 *            An array containing the signature of the constructor to be
	 *            invoked. Can be null, equivalent to an empty array.
	 * @param delegationSubject
	 *            The <code>Subject</code> containing the delegation principals
	 *            or <code>null</code> if the authentication principal is used
	 *            instead.
	...
	/**
	 * Handles the method
	 * {@link javax.management.MBeanServerConnection#createMBean(String, ObjectName, ObjectName, Object[], String[])}
	 * . The <code>Object[]</code> parameter is wrapped in a
	 * <code>MarshalledObject</code>.
	 *
	 * @param className
	 ...
	 * @throws MBeanRegistrationException
	 *             The preDeregister ((<code>MBeanRegistration</code> interface)
	 *             method of the MBean has thrown an exception.
	 * @throws RuntimeOperationsException
	 *             Wraps a <code>java.lang.IllegalArgumentException</code>: The
	...
	/**
	 * Handles the method
	 * {@link javax.management.MBeanServerConnection#queryMBeans(ObjectName, QueryExp)}
	 * . The <code>QueryExp</code> is wrapped in a <code>MarshalledObject</code>
	 * .
	 *
	 * @param name
	 ...
	 *            encapsulated into a <code>MarshalledObject</code>. If the
	 *            <code>MarshalledObject</code> encapsulates a null value no
	...
	/**
	 * Handles the method
	 * {@link javax.management.MBeanServerConnection#queryNames(ObjectName, QueryExp)}
	 * . The <code>QueryExp</code> is wrapped in a <code>MarshalledObject</code>
	 * .
	 *
	 * @param name
	 ...
	 *             The MBean specified is not registered in the MBean server.
	 * @throws ReflectionException
	 *             Wraps a <code>java.lang.Exception</code> thrown when trying
	 ...
	 *             Wraps a runtime exception thrown by the MBean's getter.
	 * @throws SecurityException
	 *             if the client, or the delegated Subject if any, does not have
	 *             permission to perform this operation.
	 * @throws IOException
	 ...
	 * @throws RuntimeOperationsException
	 *             Wrap a <code>java.lang.IllegalArgumentException</code>: The
	...
	/**
	 * Handles the method
	 * {@link javax.management.MBeanServerConnection#setAttribute(ObjectName, Attribute)}
	 * . The <code>Attribute</code> parameter is wrapped in a
	 * <code>MarshalledObject</code>.
	 *
	 * @param name
	...
	/**
	 * Handles the method
	 * {@link javax.management.MBeanServerConnection#setAttributes(ObjectName, AttributeList)}
	 * . The <code>AttributeList</code> parameter is wrapped in a
	 * <code>MarshalledObject</code>.
	 *
	 * @param name
	 *            The object name of the MBean within which the attributes are
	 *            to be set.
	 * @param attributes
	 *            A list of attributes: The identification of the attributes to
	 *            be set and the values they are to be set to, encapsulated into
	...
	/**
	 * Handles the method
	 * {@link javax.management.MBeanServerConnection#invoke(ObjectName, String, Object[], String[])}
	 * . The <code>Object[]</code> parameter is wrapped in a
	 * <code>MarshalledObject</code>.
	 *
	 * @param name
	 ...
	 * @throws ReflectionException
	 *             Wraps a <code>java.lang.Exception</code> thrown while trying
	 ...
	 *             if a general communication exception occurred.
	 * @throws RuntimeOperationsException
	 *             Wraps an {@link IllegalArgumentException} when
	...
	/**
	 * Handles the method
	 * {@link javax.management.MBeanServerConnection#addNotificationListener(ObjectName, ObjectName, NotificationFilter, Object)}
	 * . The <code>NotificationFilter</code> parameter is wrapped in a
	 * <code>MarshalledObject</code>. The <code>Object</code> (handback)
	 ...
	 *            emitted, encapsulated into a <code>MarshalledObject</code>.
	 * @param delegationSubject
	 *            The <code>Subject</code> containing the delegation principals
	 *            or <code>null</code> if the authentication principal is used
	 *            instead.
	 *
	 * @throws InstanceNotFoundException
	 *             The MBean name of the notification listener or of the
	 *             notification broadcaster does not match any of the registered
	 *             MBeans.
	 * @throws RuntimeOperationsException
	 *             Wraps an {@link IllegalArgumentException}. The MBean named by
	 *             <code>listener</code> exists but does not implement the
	 *             {@link javax.management.NotificationListener} interface, or
	...
	/**
	 * Handles the method
	 * {@link javax.management.MBeanServerConnection#removeNotificationListener(ObjectName, ObjectName, NotificationFilter, Object)}
	 * . The <code>NotificationFilter</code> parameter is wrapped in a
	 * <code>MarshalledObject</code>. The <code>Object</code> parameter is also
	 ...
	 *             MBeans.
	 * @throws ListenerNotFoundException
	 *             The listener is not registered in the MBean, or it is not
	 ...
	 * client to be able to identify them, the server generates and returns a
	 ...
	 *
	 * @param names
	 *            the <code>ObjectNames</code> identifying the MBeans emitting
	 *            the Notifications.
	 * @param filters
	 ...
	 *            the <code>Subjects</code> on behalf of which the listeners are
	 *            being added. Elements of this array can be null. Also, the
	 *            <code>delegationSubjects</code> parameter itself can be null,
	 *            which is equivalent to an array of null values with the same
	 *            size as the <code>names</code> and <code>filters</code>
	 *            arrays.
	 *
	 ...
	 *             if <code>names</code> or <code>filters</code> is null, or if
	 *             <code>names</code> contains a null element, or if the three
	 *             arrays do not all have the same size.
	 * @throws ClassCastException
	 *             if one of the elements of <code>filters</code> unmarshalls as
	 *             a non-null object that is not a
	 *             <code>NotificationFilter</code>.
	 * @throws InstanceNotFoundException
	 *             if one of the <code>names</code> does not correspond to any
	 *             registered MBean.
	 * @throws SecurityException
	 *             if, for one of the MBeans, the client, or the delegated
	 *             Subject if any, does not have permission to add a listener.
	 * @throws IOException
	 *             if a general communication exception occurred.
	 */
	 ...
	 * {@link #addNotificationListeners(ObjectName[], MarshalledObject[], Subject[])}
	 * method.
	 * </p>
	 *
	 * @param name
	 *            the <code>ObjectName</code> identifying the MBean emitting the
	 *            Notifications.
	 * @param listenerIDs
	 ...
	 *
	 * @throws InstanceNotFoundException
	 *             if the given <code>name</code> does not correspond to any
	 *             registered MBean.
	 * @throws ListenerNotFoundException
	 *             if one of the listeners was not found on the server side.
	 *             This exception can happen if the MBean discarded a listener
	 ...
	 *             if a general communication exception occurred.
	 * @throws IllegalArgumentException
	 *             if <code>ObjectName</code> or <code>listenerIds</code> is
	 *             null or if <code>listenerIds</code> contains a null element.
	 */
	...
	/**
	 * <p>
	 * Retrieves notifications from the connector server. This method can block
	 * until there is at least one notification or until the specified timeout
	 ...
	 * registered at least one listener for the MBean generating the
	 * notification, with a filter that accepts the notification. Each listener
	 * that is interested in the notification is identified by an Integer ID
	 ...
	 *            the first sequence number that the client is interested in. If
	 *            negative, it is interpreted as meaning the sequence number
	 *            that the next notification will have.
	 *
	 * @param maxNotifications
	 *            the maximum number of different notifications to return. The
	 *            <code>TargetedNotification</code> array in the returned
	 *            <code>NotificationResult</code> can have more elements than
	 *            this if the same notification appears more than once. The
	 *            behavior is unspecified if this parameter is negative.
	 *
	 * @param timeout
	 *            the maximum time in milliseconds to wait for a notification to
	 *            arrive. This can be 0 to indicate that the method should not
	 *            wait if there are no notifications, but should return at once.
	 *            It can be <code>Long.MAX_VALUE</code> to indicate that there
	 *            is no timeout. The behavior is unspecified if this parameter
	 *            is negative.
	 *
