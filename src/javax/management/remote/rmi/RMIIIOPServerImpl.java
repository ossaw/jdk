...
/**
 * <p>
 * An {@link RMIServerImpl} that is exported through IIOP and that creates
 * client connections as RMI objects exported through IIOP. User code does not
...
public class RMIIIOPServerImpl extends RMIServerImpl {
     ...
     * </p>
     * The stub might not yet be connected to the ORB. The stub will be
     * serializable only if it is connected to the ORB.
     * 
     * @return an IIOP stub.
     * @exception IOException
