 ...
 * </p>
 * <p>
 * This class is used to associate an emitted notification with the listener ID
...
public class TargetedNotification implements Serializable {
    ...
    /**
     * <p>
     * Constructs a <code>TargetedNotification</code> object. The object
     * contains a pair (Notification, Listener ID). The Listener ID identifies
     * the client listener to which that notification is targeted. The client
     * listener ID is one previously returned by the connector server in
     * response to an <code>addNotificationListener</code> request.
     * </p>
     * 
     * @param notification
