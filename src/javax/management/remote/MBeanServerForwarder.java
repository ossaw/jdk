...
/**
 * <p>
 * An object of this class implements the MBeanServer interface and wraps
 * another object that also implements that interface. Typically, an
 * implementation of this interface performs some action in some or all methods
 * of the <code>MBeanServer</code> interface before and/or after forwarding the
 * method to the wrapped object. Examples include security checking and logging.
 * </p>
 *
 * @since 1.5
 */
