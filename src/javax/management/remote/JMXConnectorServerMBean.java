 ...
 * called does it start listening for connections.
 * </p>
 *
 * @since 1.5
 */
public interface JMXConnectorServerMBean {
     ...
     * been stopped will generate an {@link IOException}.
     * </p>
     *
    ...
    /**
     * <p>
     * Determines whether the connector server is active. A connector server
     * starts being active when its {@link #start start} method returns
     * successfully and remains active until either its {@link #stop stop}
     * method is called or the connector server fails.
     * </p>
     *
    ...
    /**
     * <p>
     * Inserts an object that intercepts requests for the MBean server that
     * arrive through this connector server. This object will be supplied as the
     ...
     * {@link MBeanServerForwarder#setMBeanServer mbsf.setMBeanServer}. If doing
     ...
     * <code>mbsf.setMBeanServer</code> call just mentioned succeeds, then
     * <code>mbsf</code> becomes this connector server's
     ...
     * </p>
     *
     * @return a new string array containing the list of IDs. If there are no
     *         currently-open connections, this array will be empty.
     */
     ...
     * {@link JMXConnectorServer}. This is the address that clients supply to
     * {@link JMXConnectorFactory#connect(JMXServiceURL)}.
     * </p>
     * <p>
     * Note that the address returned may be {@code null} if the
     * {@code JMXConnectorServer} is not yet {@link #isActive active}.
     * </p>
     *
     * @return the address of this connector server, or null if it does not have
     *         one.
     */
     ...
     * </p>
     *
     * @return a read-only map containing the attributes for this connector
     *         server. Attributes whose values are not serializable are omitted
     *         from this map. If there are no serializable attributes, the
