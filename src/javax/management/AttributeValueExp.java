...
/**
 * <p>
 * Represents attributes used as arguments to relational constraints. Instances
...
public class AttributeValueExp implements ValueExp {
     ...
     * 
     * @deprecated An instance created with this constructor cannot be used in a
     *             query.
     */
    @Deprecated
    ...
    /**
     * Creates a new <CODE>AttributeValueExp</CODE> representing the specified
    ...
    /**
     * <p>
     * Applies the <CODE>AttributeValueExp</CODE> on an MBean. This method calls
     * {@link #getAttribute getAttribute(name)} and wraps the result as a
     * {@code ValueExp}. The value returned by {@code getAttribute} must be a
     * {@code Number}, {@code String}, or {@code Boolean}; otherwise this method
     * throws a {@code BadAttributeValueExpException}, which will cause the
     * containing query to be false for this {@code name}.
     * </p>
     *
     * @param name
     ...
     */
    /*
     * There is no need for this method, because if a query is being evaluted an
     * AttributeValueExp can only appear inside a QueryExp, and that QueryExp
     * will itself have done setMBeanServer.
     */
    @Deprecated
    @Override
