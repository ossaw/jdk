 ...
 * <UL>
 * <LI>if the attribute value matches the string to compare value, a
 * {@link MonitorNotification#STRING_TO_COMPARE_VALUE_MATCHED match
 * notification} is sent. The notify match flag must be set to <CODE>true</CODE>
 * . <BR>
 * Subsequent matchings of the string to compare values do not cause further
 * notifications unless the attribute value differs from the string to compare
 * value.
 * <LI>if the attribute value differs from the string to compare value, a
 * {@link MonitorNotification#STRING_TO_COMPARE_VALUE_DIFFERED differ
 * notification} is sent. The notify differ flag must be set to
 * <CODE>true</CODE>. <BR>
 * Subsequent differences from the string to compare value do not cause further
...
public class StringMonitor extends Monitor implements StringMonitorMBean {
	...
	/**
	 * String to compare with the observed attribute. <BR>
	...
	public synchronized void start() {
		...
		for (ObservedObject o : observedObjects) {
			final StringMonitorObservedObject smo = (StringMonitorObservedObject) o;
	...
	/**
	 * Gets the string to compare with the observed attribute common to all
	 * observed MBeans.
	 *
	...
	/**
	 * Sets the string to compare with the observed attribute common to all
	 * observed MBeans.
	 *
	 * @param value
	 *              The string value.
	...
	/**
	 * Gets the matching notification's on/off switch value common to all
	 * observed MBeans.
	 *
	...
	/**
	 * Sets the matching notification's on/off switch value common to all
	 * observed MBeans.
	 *
	 * @param value
	...
	/**
	 * Gets the differing notification's on/off switch value common to all
	 * observed MBeans.
	 *
	...
	/**
	 * Sets the differing notification's on/off switch value common to all
	 * observed MBeans.
	 *
	 * @param value
	...
	/**
	 * Check that the type of the supplied observed attribute value is one of
