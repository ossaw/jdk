...
/**
 * This class represents the name of the Java implementation class of the MBean.
...
class ClassAttributeValueExp extends AttributeValueExp {
    ...
    public ClassAttributeValueExp() {
        /*
         * Compatibility: we have an attr field that we must hold on to for
         * serial compatibility, even though our parent has one too.
         */
        super("Class");
        attr = "Class";
    }
    ...
    /**
     * Applies the ClassAttributeValueExp on an MBean. Returns the name of the
    ...
    protected Object getValue(ObjectName name) {
        try {
            ...
            return null;
            /*
             * In principle the MBean does exist because otherwise we wouldn't
