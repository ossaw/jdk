...
/**
 * This class provides a simple implementation of an alarm clock MBean. The aim
 * of this MBean is to set up an alarm which wakes up the timer every timeout
 * (fixed-delay) or at the specified date (fixed-rate).
 */
