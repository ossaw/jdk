...
/**
 * Provides an implementation of the {@link javax.management.NotificationFilter}
 ...
 * </PRE>
 * 
 * </BLOCKQUOTE> The listener <CODE>myListener</CODE> will only receive
...
public class NotificationFilterSupport implements NotificationFilter {
	...
	/**
	 * @serial {@link Vector} that contains the enabled notification types. The
	 ...
	 * This filter compares the type of the specified notification with each
	 * enabled type. If the notification type matches one of the enabled types,
	 ...
	 * prefix to be sent to the listener. <BR>
	 * If the specified prefix is already in the list of enabled notification
	 * types, this method has no effect.
	 * <P>
	 * Example: <BLOCKQUOTE>
	 * 
	 * <PRE>
	 ...
	 * // Enables all notifications the type of which is "my_example.my_type" to be
	 * // sent.
	 * myFilter.enableType("my_example.my_type");
	 * </PRE>
	 * 
	...
	/**
	 * Removes the given prefix from the prefix list. <BR>
