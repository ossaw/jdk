 ...
 * forwarded through the MBean server, and the original source of the
 * notification was a reference to the emitting MBean object, then the MBean
 * server replaces it by the MBean's ObjectName. If the listener has registered
 * directly with the MBean, this is either the object name or a direct reference
 * to the MBean.
 * </p>
 * <p>
 ...
 * <code>-7516092053498031989L</code>.
 *
 * @since 1.5
 */
...
public class Notification extends EventObject {
    ...
    private static final ObjectStreamField[] oldSerialPersistentFields = { new ObjectStreamField("message",
            String.class), new ObjectStreamField("sequenceNumber", Long.TYPE), new ObjectStreamField("source",
                    Object.class), new ObjectStreamField("sourceObjectName", ObjectName.class),
    ...
    private static final ObjectStreamField[] newSerialPersistentFields = { new ObjectStreamField("message",
            String.class), new ObjectStreamField("sequenceNumber", Long.TYPE), new ObjectStreamField("source",
                    Object.class), new ObjectStreamField("timeStamp", Long.TYPE), new ObjectStreamField(
                            "type", String.class), new ObjectStreamField("userData", Object.class) };
    //
    ...
    /**
     * @serial The notification type. A string expressed in a dot notation
     *         similar to Java properties. An example of a notification type is
     *         network.alarm.router
     */
    private String type;

    /**
     * @serial The notification sequence number. A serial number which identify
    ...
    /**
     * @serial The notification timestamp. Indicating when the notification was
     *         generated
     */
    private long timeStamp;

    /**
     * @serial The notification user data. Used for whatever other data the
    ...
    /**
     * <p>
     * This field hides the {@link EventObject#source} field in the parent class
     * to make it non-transient and therefore part of the serialized form.
     * </p>
     *
    ...
    /**
     * Creates a Notification object. The notification timeStamp is set to the
     * current date.
     *
     * @param type
     ...
     *
     * @return The notification sequence number within the source object. It's a
     *         serial number identifying a particular instance of notification
     *         in the context of the notification source. The notification model
     *         does not assume that notifications will be received in the same
     *         order that they are sent. The sequence number helps listeners to
     *         sort received notifications.
     ...
     *         similar to Java properties. It is recommended that the
     *         notification type should follow the reverse-domain-name
     *         convention used by Java package names. An example of a
     *         notification type is com.example.alarm.router.
     */
     ...
     * Get the user data.
     *
     * @return The user data object. It is used for whatever data the
     *         notification source wishes to communicate to its consumers.
     * @see #setUserData
     */
