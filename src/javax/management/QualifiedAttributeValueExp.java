...
/**
 * <p>
 * Represents attributes used as arguments to relational constraints, where the
 * attribute must be in an MBean of a specified
 * {@linkplain MBeanInfo#getClassName() class}. A QualifiedAttributeValueExp may
...
class QualifiedAttributeValueExp extends AttributeValueExp {
	 ...
	 * object attribute, named attr with class name className.
	 */
	...
	public ValueExp apply(ObjectName name)
		...
		try {
			...
			/*
			 * Can happen if MBean disappears between the time we construct the
			 * list of MBeans to query and the time we evaluate the query on
			 * this MBean, or if getObjectInstance throws SecurityException.
			 */
		}
	}
