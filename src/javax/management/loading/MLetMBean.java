...
public interface MLetMBean {
     ...
     * The text file is read using the UTF-8 encoding. The MBeans specified in
     * the MLET file will be instantiated and registered in the MBean server.
     *
     * @param url
     ...
     * that is independent of the location of the code. The name of a resource
