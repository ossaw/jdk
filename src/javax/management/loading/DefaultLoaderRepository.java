 ...
 * MBean servers. As of JMX 1.2, that functionality is approximated by using
 * {@link MBeanServerFactory#findMBeanServer} to find all known MBean servers,
 * and consulting the {@link ClassLoaderRepository} of each one. It is strongly
 * recommended that code referencing <code>DefaultLoaderRepository</code> be
 * rewritten.
 * </p>
 *
 * @deprecated Use
...
public class DefaultLoaderRepository {
	...
	public static Class<?> loadClassWithout(ClassLoader loader, String className)
		...
		MBEANSERVER_LOGGER.logp(Level.FINEST, DefaultLoaderRepository.class.getName(),
