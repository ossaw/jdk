 ...
 * Instances of QueryExp are returned by the static methods of the {@link Query}
 * class.
 * </p>
 * <p>
 * It is possible, but not recommended, to create custom queries by implementing
 * this interface. In that case, it is better to extend the {@link QueryEval}
 * class than to implement the interface directly, so that the
 * {@link #setMBeanServer} method works correctly.
 *
