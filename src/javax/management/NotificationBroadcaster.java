 ...
 * the possibility that the list of listeners might change while a notification
 * is being dispatched, a good strategy is to use a {@link CopyOnWriteArrayList}
 * for this list.
 *
 * @since 1.5
 */
public interface NotificationBroadcaster {
     ...
     * with different handback objects or notification filters, all entries
