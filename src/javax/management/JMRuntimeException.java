...
public class JMRuntimeException extends RuntimeException {
	...
	/**
	 * Constructor with a nested exception. This constructor is package-private
	 * because it arrived too late for the JMX 1.2 specification. A later
	 * version may make it public.
	 */
