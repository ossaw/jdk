 ...
 * <CODE>StringValueExp</CODE> may be used anywhere a <CODE>ValueExp</CODE> is
 * required.
 *
 * @since 1.5
 */
public class StringValueExp implements ValueExp {
	...
	/**
	 * Returns the string represented by the <CODE>StringValueExp</CODE>
	 * instance.
	 *
	 * @return the string.
	 */
	 ...
	 * StringValueExp can only appear inside a QueryExp, and that QueryExp will
