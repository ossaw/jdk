...
public class MBeanServerDelegate implements MBeanServerDelegateMBean, NotificationEmitter {
    ...
    /**
     * Returns the full name of the JMX specification implemented by this
     * product.
     *
    ...
    /**
     * Enables the MBean server to send a notification. If the passed
     * <var>notification</var> has a sequence number lesser or equal to 0, then
     ...
     * constructor more than once in the same millisecond, or if the clock
     * always returns the same value). This means that the ids for a given JVM
     * will always be distinact, though there is no such guarantee for two
     * different JVMs.
     */
