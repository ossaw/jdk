...
public interface OpenMBeanParameterInfo {
	...
	// (these will be removed when MBeanParameterInfo is made a parent interface
	// of this interface)

	/**
	 * Returns a human readable description of the parameter described by this
	 * <tt>OpenMBeanParameterInfo</tt> instance.
	 *
	...
	/**
	 * Returns the <i>open type</i> of the values of the parameter described by
	 * this <tt>OpenMBeanParameterInfo</tt> instance.
	 *
	...
	/**
	 * Returns <tt>true</tt> if this parameter has a specified default value, or
	...
	/**
	 * Returns <tt>true</tt> if this parameter has a specified set of legal
	 * values, or <tt>false</tt> otherwise.
	 *
	...
	/**
	 * Returns <tt>true</tt> if this parameter has a specified minimal value, or
	 * <tt>false</tt> otherwise.
	 *
	...
	/**
	 * Returns <tt>true</tt> if this parameter has a specified maximal value, or
	 * <tt>false</tt> otherwise.
	 *
	...
	/**
	 * Tests whether <var>obj</var> is a valid value for the parameter described
	 ...
	 * <code>OpenMBeanParameterInfo</code> instance for equality.
	 * <p>
	 ...
	 * <code>OpenMBeanParameterInfo</code> interface,</li>
	 ...
	 * <code>OpenMBeanParameterInfo</code> interface. <br>
	 * &nbsp;
	 * 
	 * @param obj
	...
	/**
	 * Returns the hash code value for this <code>OpenMBeanParameterInfo</code>
	 * instance.
	 * <p>
	 * The hash code of an <code>OpenMBeanParameterInfo</code> instance is the
	 * sum of the hash codes of all elements of information used in
	 * <code>equals</code> comparisons (ie: its name, its <i>open type</i>, and
	 * its default, min, max and legal values).
	 * <p>
	 * This ensures that <code> t1.equals(t2) </code> implies that
	 * <code> t1.hashCode()==t2.hashCode() </code> for any two
	 * <code>OpenMBeanParameterInfo</code> instances <code>t1</code> and
	 * <code>t2</code>, as required by the general contract of the method
	 * {@link Object#hashCode() Object.hashCode()}.
	 * <p>
	 *
	 * @return the hash code value for this <code>OpenMBeanParameterInfo</code>
	 *         instance
	 */
	public int hashCode();
	 ...
	 * <code>javax.management.openmbean.OpenMBeanParameterInfo</code>), the
	 * string representation of the name and open type of the described
	 * parameter, and the string representation of its default, min, max and
	 * legal values.
	 *
