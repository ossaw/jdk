...
public interface OpenMBeanOperationInfo {
    ...
    // Re-declares fields and methods that are in class MBeanOperationInfo of
    // JMX 1.0
    // (fields and methods will be removed when MBeanOperationInfo is made a
    // parent interface of this interface)

    /**
     * Returns a human readable description of the operation described by this
     * <tt>OpenMBeanOperationInfo</tt> instance.
     *
    ...
    /**
     * Returns an array of <tt>OpenMBeanParameterInfo</tt> instances describing
     * each parameter in the signature of the operation described by this
     * <tt>OpenMBeanOperationInfo</tt> instance. Each instance in the returned
     * array should actually be a subclass of <tt>MBeanParameterInfo</tt> which
     * implements the <tt>OpenMBeanParameterInfo</tt> interface (typically
     * {@link OpenMBeanParameterInfoSupport}).
     *
     ...
     * {@link javax.management.MBeanOperationInfo#ACTION_INFO}, or
     ...
     * operation described by this <tt>OpenMBeanOperationInfo</tt> instance.
     * This method should return the same value as a call to
     ...
     * <code>OpenMBeanOperationInfo</code> instance for equality.
     * <p>
     * Returns <tt>true</tt> if and only if all of the following statements are
     * true:
     * <ul>
     * <li><var>obj</var> is non null,</li>
     * <li><var>obj</var> also implements the
     * <code>OpenMBeanOperationInfo</code> interface,</li>
     ...
     * <code>OpenMBeanOperationInfo</code> interface. <br>
     * &nbsp;
     * 
     * @param obj
    ...
    /**
     * Returns the hash code value for this <code>OpenMBeanOperationInfo</code>
     * instance.
     * <p>
     * The hash code of an <code>OpenMBeanOperationInfo</code> instance is the
     * sum of the hash codes of all elements of information used in
     * <code>equals</code> comparisons (ie: its name, return open type, impact
     ...
     * <code>OpenMBeanOperationInfo</code> instances <code>t1</code> and
     * <code>t2</code>, as required by the general contract of the method
     * {@link Object#hashCode() Object.hashCode()}.
     * <p>
     *
     * @return the hash code value for this <code>OpenMBeanOperationInfo</code>
     *         instance
     */
    public int hashCode();
     ...
     * <code>javax.management.openmbean.OpenMBeanOperationInfo</code>), and the
     * name, signature, return open type and impact of the described operation.
     *
