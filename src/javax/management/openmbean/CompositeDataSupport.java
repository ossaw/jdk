...
public class CompositeDataSupport implements CompositeData, Serializable {
     ...
     *         respective values. A {@link SortedMap} is used for faster
     *         retrieval of elements.
     */
    private final SortedMap<String, Object> contents;

    /**
     * @serial The <i>composite type </i> of this <i>composite data</i>
     *         instance.
     */
     ...
     * <tt>compositeType</tt>, whose item values are specified by
     * <tt>itemValues[]</tt>, in the same order as in <tt>itemNames[]</tt>. As a
     * <tt>CompositeType</tt> does not specify any order on its items, the
     * <tt>itemNames[]</tt> parameter is used to specify the order in which the
     * values are given in <tt>itemValues[]</tt>. The items contained in this
     * <tt>CompositeDataSupport</tt> instance are internally stored in a
     * <tt>TreeMap</tt>, thus sorted in ascending lexicographic order of their
     * names, for faster retrieval of individual item values.
     * </p>
     * <p>
     * The constructor checks that all the constraints listed below for each
     * parameter are satisfied, and throws the appropriate exception if they are
     * not.
     * </p>
     *
     * @param compositeType
     ...
     * <p>
     * Constructs a <tt>CompositeDataSupport</tt> instance with the specified
     * <tt>compositeType</tt>, whose item names and corresponding values are
     * given by the mappings in the map <tt>items</tt>. This constructor
     * converts the keys to a string array and the values to an object array and
     * calls
        ...
        for (String name : namesFromType) {
            ...
            if (value != null) {
                ...
                if (!itemType.isValue(value)) {
                    throw new OpenDataException("Argument value of wrong type for item " + name + ": value "
                            + value + ", type " + itemType);
                }
            }
        }
    ...
    /**
     * Returns the <i>composite type </i> of this <i>composite data</i>
     * instance.
     */
     ...
     * contains an item whose name is <tt>key</tt>. If <tt>key</tt> is a null or
    ...
    /**
     * Returns an unmodifiable Collection view of the item values contained in
     * this <tt>CompositeData</tt> instance. The returned collection's iterator
     * will return the values in the ascending lexicographic order of the
     ...
     * <li><var>obj</var> also implements the <code>CompositeData</code>
     * interface,</li>
     * <li>their composite types are equal</li>
     * <li>their contents, i.e. (name, value) pairs are equal. If a value
     * contained in the content is an array, the value comparison is done as if
     * by calling the {@link java.util.Arrays#deepEquals(Object[], Object[])
     * deepEquals} method for arrays of object reference types or the
     * appropriate overloading of {@code Arrays.equals(e1,e2)} for arrays of
     * primitive types</li>
     * </ul>
     * <p>
     ...
     * <code>CompositeData</code> interface, with the restrictions mentioned in
     * the {@link java.util.Collection#equals(Object) equals} method of the
    ...
    public boolean equals(Object obj) {
        ...
        for (Map.Entry<String, Object> entry : contents.entrySet()) {
            ...
            boolean eq = e1.getClass().isArray() ? Arrays.deepEquals(new Object[] { e1 }, new Object[] { e2 })
                    : e1.equals(e2);
    ...
    /**
     * Returns the hash code value for this <code>CompositeDataSupport</code>
     * instance.
     * <p>
     * The hash code of a <code>CompositeDataSupport</code> instance is the sum
     * of the hash codes of all elements of information used in
     * <code>equals</code> comparisons (ie: its <i>composite type</i> and all
     * the item values).
     * <p>
     * This ensures that <code> t1.equals(t2) </code> implies that
     * <code> t1.hashCode()==t2.hashCode() </code> for any two
     * <code>CompositeDataSupport</code> instances <code>t1</code> and
     * <code>t2</code>, as required by the general contract of the method
     * {@link Object#hashCode() Object.hashCode()}.
     * <p>
     * Each item value's hash code is added to the returned hash code. If an
     * item value is an array, its hash code is obtained as if by calling the
     * {@link java.util.Arrays#deepHashCode(Object[]) deepHashCode} method for
     * arrays of object reference types or the appropriate overloading of
     * {@code Arrays.hashCode(e)} for arrays of primitive types.
     *
     * @return the hash code value for this <code>CompositeDataSupport</code>
     *         instance
     */
    @Override
    public int hashCode() {
    ...
    /**
     * Returns a string representation of this <code>CompositeDataSupport</code>
     * instance.
     * <p>
     * The string representation consists of the name of this class (ie
     * <code>javax.management.openmbean.CompositeDataSupport</code>), the string
     * representation of the composite type of this instance, and the string
     * representation of the contents (ie list the itemName=itemValue mappings).
     *
     * @return a string representation of this <code>CompositeDataSupport</code>
     *         instance
     */
    @Override
    public String toString() {
        return new StringBuilder().append(this.getClass().getName()).append("(compositeType=").append(
                compositeType.toString()).append(",contents=").append(contentString()).append(")").toString();
    }
