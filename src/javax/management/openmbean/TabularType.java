...
/**
 * The <code>TabularType</code> class is the <i> open type</i> class whose
 * instances describe the types of {@link TabularData TabularData} values.
 *
 * @since 1.5
 */
public class TabularType extends OpenType<TabularData> {
	...
	/**
	 * @serial The items used to index each row element, kept in the order the
	 *         user gave This is an unmodifiable {@link ArrayList}
	 */
	...
	/**
	 * Constructs a <code>TabularType</code> instance, checking for the validity
	 ...
	 * (ie the class name returned by the {@link OpenType#getClassName()
	 * getClassName} method) is set to the string value returned by
	 * <code>TabularData.class.getName()</code>.
	 * <p>
	 * 
	 * @param typeName
	...
	/**
	 * Checks that Object[] arg is neither null nor empty (ie length==0) and
	 * that it does not contain any null element.
	 */
	...
	/**
	 * Checks that String[] does not contain any empty (or blank characters
	 * only) string.
	 */
	...
	/**
	 * Returns the type of the row elements of tabular data values described by
	 * this <code>TabularType</code> instance.
	 *
	...
	/**
	 * <p>
	 * Returns, in the same order as was given to this instance's constructor,
	 * an unmodifiable List of the names of the items the values of which are
	 * used to uniquely index each row element of tabular data values described
	 * by this <code>TabularType</code> instance.
	 * </p>
	 *
	 ...
	 * td.getTabularType()}, as defined in {@link CompositeType#isValue
	 ...
	 * <code>TabularType</code> instance for equality.
	 * <p>
	 * Two <code>TabularType</code> instances are equal if and only if all of
	...
	public boolean equals(Object obj) {
		...
		// Now, really test for equality between this TabularType instance and
		// the other:
		//
		...
		// their index names should be equal and in the same order (ensured by
		// List.equals())
	 ...
	 * <p>
	 * The hash code of a <code>TabularType</code> instance is the sum of the
	 * hash codes of all elements of information used in <code>equals</code>
	 * comparisons (ie: name, row type, index names). This ensures that
	 * <code> t1.equals(t2) </code> implies that
	 * <code> t1.hashCode()==t2.hashCode() </code> for any two
	 * <code>TabularType</code> instances <code>t1</code> and <code>t2</code>,
	 * as required by the general contract of the method
	 * {@link Object#hashCode() Object.hashCode()}.
	 * <p>
	 * As <code>TabularType</code> instances are immutable, the hash code for
	...
	/**
	 * Returns a string representation of this <code>TabularType</code>
	 * instance.
	 * <p>
	 * The string representation consists of the name of this class (ie
	 * <code>javax.management.openmbean.TabularType</code>), the type name for
	 * this instance, the row type string representation of this instance, and
	 * the index names of this instance.
	 * <p>
	 * As <code>TabularType</code> instances are immutable, the string
