...
public abstract class OpenType<T> implements Serializable {
	...
	public static final List<String> ALLOWED_CLASSNAMES_LIST = Collections
			.unmodifiableList(Arrays.asList("java.lang.Void", "java.lang.Boolean",
					...
					"javax.management.ObjectName", CompositeData.class.getName(), // better
																					// refer
																					// to
																					// these
																					// two
	 ...
	 * 
	 * @param className
	 *            The fully qualified Java class name of the open data values
	 *            this open type describes. The valid Java class names allowed
	 *            for open data values are listed in
	 *            {@link #ALLOWED_CLASSNAMES_LIST ALLOWED_CLASSNAMES_LIST}. A
	 *            multidimensional array of any one of these classes or their
	 *            corresponding primitive types is also an allowed class, in
	 *            which case the class name follows the rules defined by the
	 *            method {@link Class#getName() getName()} of
	 *            <code>java.lang.Class</code>. For example, a 3-dimensional
	 *            array of Strings has for class name &quot;
	 *            <code>[[[Ljava.lang.String;</code>&quot; (without the quotes).
	 *            <br>
	 *            &nbsp;
	 * @param typeName
	 *            The name given to the open type this instance represents;
	 *            cannot be a null or empty string. <br>
	 *            &nbsp;
	 * @param description
	 *            The human readable description of the open type this instance
	 *            represents; cannot be a null or empty string. <br>
	 *            &nbsp;
	 * @throws IllegalArgumentException
	 *             if <var>className</var>, <var>typeName</var> or
	 *             <var>description</var> is a null or empty string <br>
	 *             &nbsp;
	 * @throws OpenDataException
	 *             if <var>className</var> is not one of the allowed Java class
	 *             names for open data
	 */
		...
		if (overridesGetClassName(this.getClass())) {
			...
			if (AccessController.doPrivileged(getExtendOpenTypes) == null) {
				throw new SecurityException(
						"Cannot override getClassName() " + "unless -Djmx.extend.open.types");
			}
		}
	}
		...
		if (n > 0) {
			if (className.startsWith("L", n) && className.endsWith(";")) {
				...
				throw new OpenDataException(
						"Argument className=\"" + className + "\" is not a valid class name");
			}
		} else {
			// not an array
