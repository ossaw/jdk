...
/**
 * The <code>OpenType</code> class is the parent abstract class of all classes
 * which describe the actual <i>open type</i> of open data values.
 * <p>
 * An <i>open type</i> is defined by:
 * <ul>
 * <li>the fully qualified Java class name of the open data values this type
 * describes; note that only a limited set of Java classes is allowed for open
 * data values (see {@link #ALLOWED_CLASSNAMES_LIST ALLOWED_CLASSNAMES_LIST}),
 * </li>
 * <li>its name,</li>
 ...
 *
 * @param <T>
 *        the Java type that instances described by this type must have. For
 *        example, {@link SimpleType#INTEGER} is a {@code
 * SimpleType<Integer>} which is a subclass of {@code OpenType<Integer>},
 *        meaning that an attribute, parameter, or return value that is
 *        described as a {@code SimpleType.INTEGER} must have Java type
 *        {@link Integer}.
 *
 * @since 1.5
 */
public abstract class OpenType<T> implements Serializable {
     ...
     *
     */
    public static final List<String> ALLOWED_CLASSNAMES_LIST = Collections
            .unmodifiableList(Arrays.asList("java.lang.Void",
                    ...
                    "javax.management.ObjectName", CompositeData.class
                            .getName(), // better
                    // refer
                    // to
                    // these
                    ...
                    // a
                    // string,
                    TabularData.class.getName())); // in case the package of
                                                   // these classes should
                                                   // change (who knows...)

    /**
     * @deprecated Use {@link #ALLOWED_CLASSNAMES_LIST ALLOWED_CLASSNAMES_LIST}
     *             instead.
     */
    @Deprecated
    ...
    /**
     * @serial The fully qualified Java class name of open data values this type
     *         describes.
     */
    ...
    /**
     * Constructs an <code>OpenType</code> instance (actually a subclass
     * instance as <code>OpenType</code> is abstract), checking for the validity
     * of the given parameters. The validity constraints are described below for
     * each parameter. <br>
     * &nbsp;
     * 
     * @param className
     *                    The fully qualified Java class name of the open data
     *                    values
     *                    this open type describes. The valid Java class names
     *                    allowed
     *                    for open data values are listed in
     *                    {@link #ALLOWED_CLASSNAMES_LIST
     *                    ALLOWED_CLASSNAMES_LIST}. A
     *                    multidimensional array of any one of these classes or
     *                    their
     *                    corresponding primitive types is also an allowed
     *                    class, in
     *                    which case the class name follows the rules defined by
     *                    the
     *                    method {@link Class#getName() getName()} of
     *                    <code>java.lang.Class</code>. For example, a
     *                    3-dimensional
     *                    array of Strings has for class name &quot;
     *                    <code>[[[Ljava.lang.String;</code>&quot; (without the
     *                    quotes).
     *                    <br>
     *                    &nbsp;
     * @param typeName
     *                    The name given to the open type this instance
     *                    represents;
     *                    cannot be a null or empty string. <br>
     *                    &nbsp;
     * @param description
     *                    The human readable description of the open type this
     *                    instance
     *                    represents; cannot be a null or empty string. <br>
     *                    &nbsp;
     * @throws IllegalArgumentException
     *                                  if <var>className</var>,
     *                                  <var>typeName</var> or
     *                                  <var>description</var> is a null or
     *                                  empty string <br>
     *                                  &nbsp;
     * @throws OpenDataException
     *                                  if <var>className</var> is not one of
     *                                  the allowed Java class
     *                                  names for open data
     */
    ...
    private void checkClassNameOverride() throws SecurityException {
        ...
        if (overridesGetClassName(this.getClass())) {
            final GetPropertyAction getExtendOpenTypes = new GetPropertyAction(
    ...
    private static boolean overridesGetClassName(final Class<?> c) {
        return AccessController.doPrivileged(new PrivilegedAction<Boolean>() {
            public Boolean run() {
                try {
                    return (c.getMethod("getClassName")
                            .getDeclaringClass() != OpenType.class);
                } catch (Exception e) {
    ...
    private static String validClassName(String className)
            throws OpenDataException {
        className = valid("className", className);

        // Check if className describes an array class, and determines its
        // elements' class name.
        // (eg: a 3-dimensional array of Strings has for class name:
        // "[[[Ljava.lang.String;")
        //
        int n = 0;
        ...
        if (n > 0) {
            if (className.startsWith("L", n) && className.endsWith(";")) {
                ...
                eltClassName = className.substring(n + 1, className.length()
                        - 1);
        ...
        // Check that eltClassName's value is one of the allowed basic data
        // types for open data
        //
        boolean ok = false;
        if (isPrimitiveArray) {
    ...
    /**
     * Returns the fully qualified Java class name of the open data values this
     * open type describes. The only possible Java class names for open data
     * values are listed in {@link #ALLOWED_CLASSNAMES_LIST
     * ALLOWED_CLASSNAMES_LIST}. A multidimensional array of any one of these
     * classes or their corresponding primitive types is also an allowed class,
     * in which case the class name follows the rules defined by the method
     * {@link Class#getName() getName()} of <code>java.lang.Class</code>. For
     * example, a 3-dimensional array of Strings has for class name &quot;
     * <code>[[[Ljava.lang.String;</code>&quot; (without the quotes), a
     * 3-dimensional array of Integers has for class name &quot;
     * <code>[[[Ljava.lang.Integer;</code>&quot; (without the quotes), and a
     * 3-dimensional array of int has for class name &quot;<code>[[[I</code>
     * &quot; (without the quotes)
     *
     ...
     * describes are arrays, <code>false</code> otherwise.
     *
     ...
     *
     * @return <code>true</code> if <var>obj</var> is a value for this open
     ...
     * The default implementation of this method returns true only if the types
     * are equal.
     *
     * @param ot
    ...
    /**
     * Compares the specified <code>obj</code> parameter with this open type
    ...
    /**
     * Deserializes an {@link OpenType} from an
    ...
    private void readObject(ObjectInputStream in) throws IOException,
        ...
        try {
            classNameField = validClassName((String) fields.get("className",
                    null));
            descriptionField = valid("description", (String) fields.get(
                    "description", null));
            typeNameField = valid("typeName", (String) fields.get("typeName",
                    null));
        } catch (Exception e) {
