...
/**
 * The {@code OpenMBeanInfoSupport} class describes the management information
 * of an <i>open MBean</i>: it is a subclass of
 * {@link javax.management.MBeanInfo}, and it implements the
 * {@link OpenMBeanInfo} interface. Note that an <i>open MBean</i> is recognized
 * as such if its {@code getMBeanInfo()} method returns an instance of a class
 * which implements the OpenMBeanInfo interface, typically
 * {@code OpenMBeanInfoSupport}.
 *
 * @since 1.5
 */
public class OpenMBeanInfoSupport extends MBeanInfo implements OpenMBeanInfo {
    ...
    /**
     * <p>
     * Constructs an {@code OpenMBeanInfoSupport} instance, which describes a
     * class of open MBeans with the specified {@code
     ...
     * {@code openOperations} and {@code notifications} array parameters are
     * internally copied, so that subsequent changes to the arrays referenced by
     * these parameters have no effect on this instance.
     * </p>
     *
     * @param className
     ...
     */
    public OpenMBeanInfoSupport(String className, String description, OpenMBeanAttributeInfo[] openAttributes,
            OpenMBeanConstructorInfo[] openConstructors, OpenMBeanOperationInfo[] openOperations,
            MBeanNotificationInfo[] notifications) {
        this(className, description, openAttributes, openConstructors, openOperations, notifications,
                (Descriptor) null);
    }
     ...
     * openOperations} and {@code notifications} array parameters are internally
     * copied, so that subsequent changes to the arrays referenced by these
     * parameters have no effect on this instance.
     * </p>
     *
     * @param className
     *        The fully qualified Java class name of the open
    ...
    public OpenMBeanInfoSupport(String className, String description, OpenMBeanAttributeInfo[] openAttributes,
        ...
        super(className, description, attributeArray(openAttributes), constructorArray(openConstructors),
                operationArray(openOperations), (notifications == null) ? null : notifications.clone(),
                descriptor);
    }
     ...
     * <li>their infos on attributes, constructors, operations and notifications
     * are equal</li>
     * </ul>
     * This ensures that this {@code equals} method works properly for
     * {@code obj} parameters which are different implementations of the
     * {@code OpenMBeanInfo} interface.
     *
     * @param obj
     ...
     * </p>
     * <p>
     * The hash code of an {@code OpenMBeanInfoSupport} instance is the sum of
     * the hash codes of all elements of information used in {@code equals}
     * comparisons (ie: its class name, and its infos on attributes,
     * constructors, operations and notifications, where the hashCode of each of
     * these arrays is calculated by a call to {@code new
     ...
     * OpenMBeanInfoSupport} instances {@code t1} and {@code t2}, as required by
     * the general contract of the method {@link Object#hashCode()
     * Object.hashCode()}.
     * </p>
     * <p>
     * However, note that another instance of a class implementing the
     * {@code OpenMBeanInfo} interface may be equal to this {@code
     ...
     * </p>
     * <p>
     * As {@code OpenMBeanInfoSupport} instances are immutable, the hash code
     * for this instance is calculated once, on the first call to
     ...
     * {@code javax.management.openmbean.OpenMBeanInfoSupport}), the MBean class
     * name, the string representation of infos on attributes, constructors,
     * operations and notifications of the described MBean and the string
     * representation of the descriptor.
     * </p>
     * <p>
     * As {@code OpenMBeanInfoSupport} instances are immutable, the string
     * representation for this instance is calculated once, on the first call to
     * {@code toString}, and then the same value is returned for subsequent
     * calls.
     * </p>
     *
    ...
    public String toString() {
        ...
        //
        if (myToString == null) {
            myToString = new StringBuilder().append(this.getClass().getName()).append("(mbean_class_name=")
                    .append(this.getClassName()).append(",attributes=").append(Arrays.asList(this
                            .getAttributes()).toString()).append(",constructors=").append(Arrays.asList(this
                                    .getConstructors()).toString()).append(",operations=").append(Arrays
                                            .asList(this.getOperations()).toString()).append(
                                                    ",notifications=").append(Arrays.asList(this
                                                            .getNotifications()).toString()).append(
