...
public interface OpenMBeanConstructorInfo {
	...
	// (methods will be removed when MBeanConstructorInfo is made a parent
	// interface of this interface)

	/**
	 * Returns a human readable description of the constructor described by this
	 * <tt>OpenMBeanConstructorInfo</tt> instance.
	 *
	 ...
	 * each parameter in the signature of the constructor described by this
	 * <tt>OpenMBeanConstructorInfo</tt> instance.
	 *
	 ...
	 * <code>OpenMBeanConstructorInfo</code> instance for equality.
	 * <p>
	 ...
	 * <code>OpenMBeanConstructorInfo</code> interface,</li>
	 ...
	 * <code>OpenMBeanConstructorInfo</code> interface. <br>
	 * &nbsp;
	 * 
	 * @param obj
	 ...
	 * <code>OpenMBeanConstructorInfo</code> instance.
	 * <p>
	 * The hash code of an <code>OpenMBeanConstructorInfo</code> instance is the
	 * sum of the hash codes of all elements of information used in
	 * <code>equals</code> comparisons (ie: its name and signature, where the
	 * signature hashCode is calculated by a call to
	 ...
	 * <code>OpenMBeanConstructorInfo</code> instances <code>t1</code> and
	 ...
	 * <code>javax.management.openmbean.OpenMBeanConstructorInfo</code>), and
	 * the name and signature of the described constructor.
	 *
