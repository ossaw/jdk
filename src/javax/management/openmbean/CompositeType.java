...
public class CompositeType extends OpenType<CompositeData> {
	...
	/*
	 * As this instance is immutable, following three values need only be
	 * calculated once.
	 */
	...
	/**
	 * Constructs a <code>CompositeType</code> instance, checking for the
	 * validity of the given parameters. The validity constraints are described
	 * below for each parameter.
	 * <p>
	 * Note that the contents of the three array parameters <var>itemNames</var>
	 * , <var>itemDescriptions</var> and <var>itemTypes</var> are internally
	 * copied so that any subsequent modification of these arrays by the caller
	 * of this constructor has no impact on the constructed
	 * <code>CompositeType</code> instance.
	 * <p>
	 * The Java class name of composite data values this composite type
	 * represents (ie the class name returned by the
	 * {@link OpenType#getClassName() getClassName} method) is set to the string
	 * value returned by <code>CompositeData.class.getName()</code>.
	 * <p>
	 * 
	 * @param typeName
	 ...
	 *            same size as <var>itemNames</var>; no element can be null or
	 *            an empty string. <br>
	 *            &nbsp;
	 * @param itemTypes
	 ...
	 *            size as <var>itemNames</var>; no element can be null. <br>
	 *            &nbsp;
	 * @throws IllegalArgumentException
	 *             If <var>typeName</var> or <var>description</var> is a null or
	 *             empty string, or <var>itemNames</var> or
	 *             <var>itemDescriptions</var> or <var>itemTypes</var> is null,
	 *             or any element of <var>itemNames</var> or
	 *             <var>itemDescriptions</var> is a null or empty string, or any
	 *             element of <var>itemTypes</var> is null, or
	 *             <var>itemNames</var> or <var>itemDescriptions</var> or
	 *             <var>itemTypes</var> are not of the same size. <br>
	 *             &nbsp;
	 * @throws OpenDataException
	 *             If <var>itemNames</var> contains duplicate item names (case
	 *             sensitive, but leading and trailing whitespaces removed).
	 */
	public CompositeType(String typeName, String description, String[] itemNames,
		...
		// Check the 3 arrays are not null or empty (ie length==0) and that
		// there is no null element or empty string in them
		//
		...
		for (int i = 0; i < itemNames.length; i++) {
			...
			if (nameToDescription.containsKey(key)) {
				throw new OpenDataException("Argument's element itemNames[" + i + "]=\""
						+ itemNames[i] + "\" duplicates a previous item names.");
			}
	...
	/**
	 * Returns <code>true</code> if this <code>CompositeType</code> instance
	...
	/**
	 * Returns the description of the item whose name is <var>itemName</var>, or
	 * <code>null</code> if this <code>CompositeType</code> instance does not
	...
	/**
	 * Returns the <i>open type</i> of the item whose name is
	 * <var>itemName</var>, or <code>null</code> if this
	 * <code>CompositeType</code> instance does not define any item whose name
	 * is <var>itemName</var>.
	 *
	 * @param itemName
	 ...
	 * <code>CompositeType</code> instance. The set's iterator will return the
	 * item names in ascending order.
	 *
	 ...
	 * {@code ct} be its {@code CompositeType} as returned by
	 ...
	 * <li>there are no item names present in {@code this} that are not also
	 * present in {@code ct}, and
	 ...
	 * dimension}; and both are {@linkplain ArrayType#isPrimitiveArray()
	...
	public boolean isValue(Object obj) {
		...
		// test value's CompositeType is assignable to this CompositeType
		// instance
		//
	 ...
	 * The result is true if the given type is also a CompositeType with the
	 * same name ({@link #getTypeName()}), and every item in this type is also
	 * present in the given type with the same name and assignable type. There
	 ...
	 * <code>CompositeType</code> instance for equality.
	 * <p>
	 * Two <code>CompositeType</code> instances are equal if and only if all of
	...
	public boolean equals(Object obj) {
		...
		// Now, really test for equality between this CompositeType instance and
		// the other
		//
	 ...
	 * <p>
	 * The hash code of a <code>CompositeType</code> instance is the sum of the
	 * hash codes of all elements of information used in <code>equals</code>
	 * comparisons (ie: name, items names, items types). This ensures that
	 * <code> t1.equals(t2) </code> implies that
	 * <code> t1.hashCode()==t2.hashCode() </code> for any two
	 * <code>CompositeType</code> instances <code>t1</code> and <code>t2</code>,
	 * as required by the general contract of the method
	 * {@link Object#hashCode() Object.hashCode()}.
	 * <p>
	 * As <code>CompositeType</code> instances are immutable, the hash code for
	...
	/**
	 * Returns a string representation of this <code>CompositeType</code>
	 * instance.
	 * <p>
	 * The string representation consists of the name of this class (ie
	 * <code>javax.management.openmbean.CompositeType</code>), the type name for
	 * this instance, and the list of the items names and types string
	 * representation of this instance.
	 * <p>
	 * As <code>CompositeType</code> instances are immutable, the string
	 ...
	 * calls.
	 *
	 * @return a string representation of this <code>CompositeType</code>
	 *         instance
	 */
