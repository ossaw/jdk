...
/**
 * The <code>ArrayType</code> class is the <i>open type</i> class whose
 * instances describe all <i>open data</i> values which are n-dimensional arrays
 * of <i>open data</i> values.
 * <p>
 ...
 * element type, with class ArrayType<E> extends OpenType<E[]>. However, that
 * doesn't buy us all that much. We can't say public OpenType<E>
 * getElementOpenType() because this ArrayType could be a multi-dimensional
...
public class ArrayType<T> extends OpenType<T> {
    ...
    /**
     * @serial This flag indicates whether this {@link ArrayType} describes a
     *         primitive array.
     * @since 1.6
     */
    private boolean primitiveArray;

    private transient Integer myHashCode = null; // As this instance is
                                                 // immutable, these two
                                                 // values
    ...
    private static final Object[][] PRIMITIVE_ARRAY_TYPES = { { Boolean.class.getName(), boolean.class
            .getName(), "Z", SimpleType.BOOLEAN }, { Character.class.getName(), char.class.getName(), "C",
                    SimpleType.CHARACTER }, { Byte.class.getName(), byte.class.getName(), "B",
                            SimpleType.BYTE }, { Short.class.getName(), short.class.getName(), "S",
                                    SimpleType.SHORT }, { Integer.class.getName(), int.class.getName(), "I",
                                            SimpleType.INTEGER }, { Long.class.getName(), long.class
                                                    .getName(), "J", SimpleType.LONG }, { Float.class
                                                            .getName(), float.class.getName(), "F",
                                                            SimpleType.FLOAT }, { Double.class.getName(),
                                                                    double.class.getName(), "D",
                                                                    SimpleType.DOUBLE } };
    ...
    /**
     * Return the key used to identify the element type in arrays - e.g. "Z" for
     ...
     * e.g. SimpleType.BOOLEAN for "boolean", SimpleType.CHARACTER for "char",
     * etc...
     * 
    ...
    /**
     * Constructs an <tt>ArrayType</tt> instance describing <i>open data</i>
     * values which are arrays with dimension <var>dimension</var> of elements
     * whose <i>open type</i> is <var>elementType</var>.
     * <p>
     * When invoked on an <tt>ArrayType</tt> instance, the
     * {@link OpenType#getClassName() getClassName} method returns the class
     * name of the array instances it describes (following the rules defined by
     * the {@link Class#getName() getName} method of
     * <code>java.lang.Class</code>), not the class name of the array elements
     * (which is returned by a call to
     * <tt>getElementOpenType().getClassName()</tt>).
     * <p>
     * The internal field corresponding to the type name of this
     * <code>ArrayType</code> instance is also set to the class name of the
     * array instances it describes. In other words, the methods
     * <code>getClassName</code> and <code>getTypeName</code> return the same
     * string value. The internal field corresponding to the description of this
     * <code>ArrayType</code> instance is set to a string value which follows
     * the following template:
     * <ul>
     * <li>if non-primitive array:
     * <tt><i>&lt;dimension&gt;</i>-dimension array of <i>&lt;element_class_name&gt;</i></tt>
     * </li>
     * <li>if primitive array:
     * <tt><i>&lt;dimension&gt;</i>-dimension array of <i>&lt;primitive_type_of_the_element_class_name&gt;</i></tt>
     * </li>
     * </ul>
     * <p>
    ...
    public ArrayType(int dimension, OpenType<?> elementType) throws OpenDataException {
        ...
        super(buildArrayClassName(dimension, elementType), buildArrayClassName(dimension, elementType),
    ...
    /**
     * Constructs a unidimensional {@code ArrayType} instance for the supplied
     * {@code SimpleType}.
     * <p>
     * This constructor supports the creation of arrays of primitive types when
     * {@code primitiveArray} is {@code true}.
     * <p>
     * For primitive arrays the {@link #getElementOpenType()} method returns the
     * {@link SimpleType} corresponding to the wrapper type of the primitive
     * type of the array.
     * <p>
     * When invoked on an <tt>ArrayType</tt> instance, the
     * {@link OpenType#getClassName() getClassName} method returns the class
     ...
     * <ul>
     * <li>if non-primitive array:
     * <tt>1-dimension array of <i>&lt;element_class_name&gt;</i></tt></li>
     * <li>if primitive array:
     * <tt>1-dimension array of <i>&lt;primitive_type_of_the_element_class_name&gt;</i></tt>
     * </li>
     * </ul>
     * <p>
     * As an example, the following piece of code:
    ...
    public ArrayType(SimpleType<?> elementType, boolean primitiveArray) throws OpenDataException {
        ...
        super(buildArrayClassName(1, elementType, primitiveArray), buildArrayClassName(1, elementType,
                primitiveArray), buildArrayDescription(1, elementType, primitiveArray), true);
    ...
    ArrayType(String className, String typeName, String description, int dimension, OpenType<?> elementType,
    ...
    private static String buildArrayDescription(int dimension, OpenType<?> elementType,
        ...
        if (isPrimitiveArray) {
            ...
            final String primitiveType = getPrimitiveTypeName(elementClassName);
    ...
    /**
     * Returns the dimension of arrays described by this <tt>ArrayType</tt>
     * instance.
     *
    ...
    /**
     * Returns the <i>open type</i> of element values contained in the arrays
     * described by this <tt>ArrayType</tt> instance.
     *
    ...
    /**
     * Returns <code>true</code> if the open data values this open type
     * describes are primitive arrays, <code>false</code> otherwise.
     *
     ...
     * instance.
     * <p>
     * This method returns <code>true</code> if and only if <var>obj</var> is
     * not null, <var>obj</var> is an array and any one of the following is
     * <tt>true</tt>:
     * <ul>
     ...
     * for this <code>ArrayType</code> instance (i.e. the class name returned by
     * the {@link OpenType#getClassName() getClassName} method, which includes
     * the dimension information),<br>
     * &nbsp;</li>
     * <li>if this <code>ArrayType</code> instance describes an array of classes
     * implementing the {@code TabularData} interface or the
     * {@code CompositeData} interface, <var>obj</var> is assignable to such a
     * declared array, and each element contained in {<var>obj</var> is either
     * null or a valid value for the element's open type specified by this
     * <code>ArrayType</code> instance.</li>
     * </ul>
     *
     * @param obj
    ...
    public boolean isValue(Object obj) {
        ...
        // Test if obj's class name is the same as for the array values that
        // this instance describes
        // (this is fine if elements are of simple types, which are final
        // classes)
        //
        ...
        // In case this ArrayType instance describes an array of classes
        // implementing the TabularData or CompositeData interface,
        // we first check for the assignability of obj to such an array of
        // TabularData or CompositeData,
        // which ensures that:
        // . obj is of the the same dimension as this ArrayType instance,
        // . it is declared as an array of elements which are either all
        // TabularData or all CompositeData.
        //
        // If the assignment check is positive,
        // then we have to check that each element in obj is of the same
        // TabularType or CompositeType
        ...
        // ]
        //
        if ((this.elementType.getClassName().equals(TabularData.class.getName())) || (this.elementType
                .getClassName().equals(CompositeData.class.getName()))) {
            ...
            // check that all elements in obj are valid values for this
            // ArrayType
            if (!checkElementsType((Object[]) obj, this.dimension)) { // we know
                                                                      // obj's
                                                                      // dimension
                                                                      // is
                                                                      // this.dimension
        ...
        // if previous tests did not return, then obj is not a value for this
        // ArrayType instance
        return false;
    }

    /**
     * Returns true if and only if all elements contained in the array argument
     * x_dim_Array of dimension dim are valid values (ie either null or of the
     * right openType) for the element open type specified by this ArrayType
     * instance.
     * This method's implementation uses recursion to go down the dimensions of
     * the array argument.
     */
    private boolean checkElementsType(Object[] x_dim_Array, int dim) {

        // if the elements of x_dim_Array are themselves array: go down
        // recursively....
        if (dim > 1) {
        ...
        // ...else, for a non-empty array, each element must be a valid value:
    ...
    boolean isAssignableFrom(OpenType<?> ot) {
        ...
        return (at.getDimension() == getDimension() && at.isPrimitiveArray() == isPrimitiveArray() && at
                .getElementOpenType().isAssignableFrom(getElementOpenType()));
    }
     ...
     * describe array instances which have the same dimension, elements' open
     * type and primitive array flag.
     *
     * @param obj
     *        the object to be compared for equality with this
     *        <code>ArrayType</code> instance; if <var>obj</var> is
     *        <code>null</code> or is not an instance of the class
     *        <code>ArrayType</code> this method returns <code>false</code>.
     ...
     * comparisons (i.e. dimension, elements' open type and primitive array
     * flag). The hashcode for a primitive value is the hashcode of the
     * corresponding boxed object (e.g. the hashcode for <tt>true</tt> is
     * <tt>Boolean.TRUE.hashCode()</tt>). This ensures that
     * <code> t1.equals(t2) </code> implies that
     * <code> t1.hashCode()==t2.hashCode() </code> for any two
     * <code>ArrayType</code> instances <code>t1</code> and <code>t2</code>, as
     * required by the general contract of the method {@link Object#hashCode()
     * Object.hashCode()}.
     * <p>
     * As <code>ArrayType</code> instances are immutable, the hash code for this
     * instance is calculated once, on the first call to <code>hashCode</code>,
    ...
    public int hashCode() {
        ...
        // Calculate the hash code value if it has not yet been done (ie 1st
        // call to hashCode())
        //
        if (myHashCode == null) {
            int value = 0;
     ...
     * <code>javax.management.openmbean.ArrayType</code>), the type name, the
     * dimension, the elements' open type and the primitive array flag defined
     * for this instance.
     * <p>
     * As <code>ArrayType</code> instances are immutable, the string
     * representation for this instance is calculated once, on the first call to
     * <code>toString</code>, and then the same value is returned for subsequent
     * calls.
     *
    ...
    public String toString() {
        ...
        // Calculate the string representation if it has not yet been done (ie
     ...
     * @since 1.6
     */
    @SuppressWarnings("unchecked") // can't get appropriate T for primitive
                                   // array
    ...
    /**
     * Replace/resolve the object read from the stream before it is returned to
     * the caller.
     *
     * @serialData The new serial form of this class defines a new serializable
     *             {@code boolean} field {@code primitiveArray}. In order to
     *             guarantee the interoperability with previous versions of this
     *             class the new serial form must continue to refer to primitive
     *             wrapper types even when the {@code ArrayType} instance
     ...
     *             {@code elementType} field always returns the
     *             {@code SimpleType} corresponding to the primitive wrapper
     *             type of the array's primitive type.
     *             <p>
     *             Therefore the following serializable fields are deserialized
     *             as follows:
     *             <ul>
     *             <li>if {@code primitiveArray} is {@code true} the
     *             {@code className} field is deserialized by replacing the
     *             array's component primitive wrapper type by the corresponding
     *             array's component primitive type, e.g.
     *             {@code "[[Ljava.lang.Integer;"} will be deserialized as
     *             {@code "[[I"}.</li>
     *             <li>if {@code primitiveArray} is {@code true} the
     *             {@code typeName} field is deserialized by replacing the
     *             array's component primitive wrapper type by the corresponding
     *             array's component primitive type, e.g.
     *             {@code "[[Ljava.lang.Integer;"} will be deserialized as
     *             {@code "[[I"}.</li>
     *             <li>if {@code primitiveArray} is {@code true} the
     *             {@code description} field is deserialized by replacing the
     *             array's component primitive wrapper type by the corresponding
     *             array's component primitive type, e.g.
     *             {@code "2-dimension array of java.lang.Integer"} will be
    ...
    /**
     * Nominate a replacement for this object in the stream before the object is
     * written.
     *
     * @serialData The new serial form of this class defines a new serializable
     *             {@code boolean} field {@code primitiveArray}. In order to
     ...
     *             type of the array's primitive type.
     *             <p>
     *             Therefore the following serializable fields are serialized as
     *             follows:
     *             <ul>
     *             <li>if {@code primitiveArray} is {@code true} the
     *             {@code className} field is serialized by replacing the
     *             array's component primitive type by the corresponding array's
     *             component primitive wrapper type, e.g. {@code "[[I"} will be
     *             serialized as {@code "[[Ljava.lang.Integer;"}.</li>
     *             <li>if {@code primitiveArray} is {@code true} the
     *             {@code typeName} field is serialized by replacing the array's
     *             component primitive type by the corresponding array's
     *             component primitive wrapper type, e.g. {@code "[[I"} will be
     *             serialized as {@code "[[Ljava.lang.Integer;"}.</li>
     *             <li>if {@code primitiveArray} is {@code true} the
     *             {@code description} field is serialized by replacing the
     *             array's component primitive type by the corresponding array's
     *             component primitive wrapper type, e.g.
     *             {@code "2-dimension array of int"} will be serialized as
    ...
    private <T> ArrayType<T> convertFromPrimitiveToWrapperTypes() {
        ...
        for (Object[] typeDescr : PRIMITIVE_ARRAY_TYPES) {
            if (cn.indexOf((String) typeDescr[PRIMITIVE_TYPE_KEY_INDEX]) != -1) {
                cn = cn.replaceFirst((String) typeDescr[PRIMITIVE_TYPE_KEY_INDEX], "L"
                        + typeDescr[PRIMITIVE_WRAPPER_NAME_INDEX] + ";");
                tn = tn.replaceFirst((String) typeDescr[PRIMITIVE_TYPE_KEY_INDEX], "L"
                        + typeDescr[PRIMITIVE_WRAPPER_NAME_INDEX] + ";");
