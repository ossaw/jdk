...
public class Role implements Serializable {
     ...
     * @serialField name
     *              String Role name
     * @serialField objectNameList
     *              List {@link List} of {@link ObjectName}s of referenced
     *              MBeans
     */
    ...
    /**
     * <p>
     * Make a new Role object. No check is made that the ObjectNames in the role
     * value exist in an MBean server. That check will be made when the role is
     * set in a relation.
     *
     * @param roleName
     *                  role name
