...
public class MBeanOperationInfo extends MBeanFeatureInfo implements Cloneable {
    ...
    /**
     * @serial The impact of the method, one of <CODE>INFO</CODE>,
     *         <CODE>ACTION</CODE>, <CODE>ACTION_INFO</CODE>,
     *         <CODE>UNKNOWN</CODE>
     */
     ...
     * {@link Descriptor} of the constructed object will include fields
     ...
     * described by an <CODE>MBeanParameterInfo</CODE> object.
     * </p>
     * <p>
     ...
     * <CODE>MBeanParameterInfo</CODE> objects but that each referenced
     * <CODE>MBeanParameterInfo</CODE> object is not copied.
     * </p>
     *
    ...
    /**
     * Returns the impact of the method, one of <CODE>INFO</CODE>,
     * <CODE>ACTION</CODE>, <CODE>ACTION_INFO</CODE>, <CODE>UNKNOWN</CODE>.
     *
    ...
    public String toString() {
        ...
        return getClass().getName() + "[" + "description=" + getDescription() + ", " + "name=" + getName()
                + ", " + "returnType=" + getReturnType() + ", " + "signature=" + Arrays.asList(
                        fastGetSignature()) + ", " + "impact=" + impactString + ", " + "descriptor="
                + getDescriptor() + "]";
    }
     ...
     *         {@link #getDescriptor()} and {@link #getSignature()} values are
     *         equal (not necessarily identical) to those of this
     *         MBeanConstructorInfo. Two signature arrays are equal if their
    ...
    public boolean equals(Object o) {
        ...
        return (Objects.equals(p.getName(), getName()) && Objects.equals(p.getReturnType(), getReturnType())
                && Objects.equals(p.getDescription(), getDescription()) && p.getImpact() == getImpact()
                && Arrays.equals(p.fastGetSignature(), fastGetSignature()) && Objects.equals(p
