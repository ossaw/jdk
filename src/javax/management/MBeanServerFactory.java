 ...
 * {@link javax.management.MBeanServerBuilder} class. The class of the initial
 * MBeanServerBuilder to be instantiated can be specified through the
 * <b>javax.management.builder.initial</b> system property. The specified class
 * must be a public subclass of {@link javax.management.MBeanServerBuilder}, and
 ...
 * javax.management.MBeanServerBuilder} is created. Otherwise, the
 * MBeanServerFactory attempts to load the specified class using
 * {@link java.lang.Thread#getContextClassLoader()
 * Thread.currentThread().getContextClassLoader()}, or if that is null,
 * {@link java.lang.Class#forName(java.lang.String) Class.forName()}. Then it
 * creates an initial instance of that Class using
 * {@link java.lang.Class#newInstance()}. If any checked exception is raised
 * during this process (e.g. {@link java.lang.ClassNotFoundException},
 * {@link java.lang.InstantiationException}) the MBeanServerFactory will
 * propagate this exception from within a RuntimeException.
 * </p>
 *
 * <p>
 * The <b>javax.management.builder.initial</b> system property is consulted
 * every time a new MBeanServer needs to be created, and the class pointed to by
 * that property is loaded. If that class is different from that of the current
 ...
 * <b>javax.management.builder.initial</b> system property is reset to valid
 * value.
 * </p>
 *
 * <p>
...
public class MBeanServerFactory {
	...
	/*
	 * There are no instances of this class so don't generate the default public
	 * constructor.
	 */
	 ...
	 * 
	 * @param builder
	 *                The new MBeanServerBuilder that will be used to create
	 ...
	 *                                     do not include or imply <code>{@link
	 ...
	 * This allows the garbage collector to remove the MBeanServer object.
	 *
	 * @param mbeanServer
	 *                    the MBeanServer object to remove.
	 *
	 * @exception                   java.lang.IllegalArgumentException
	 *                              if <code>mbeanServer</code> was not
	 *                              generated by one of
	 *                              the <code>createMBeanServer</code> methods,
	 *                              or if
	 *                              <code>releaseMBeanServer</code> was already
	 *                              called on it.
	 *
	 * @exception SecurityException
	 *                              if there is a SecurityManager and the
	 ...
	 * domain part in the ObjectName of MBeans when the domain is specified by
	 * the user is null.
	 * </p>
	 *
	 * <p>
	 ...
	 * <CODE>findMBeanServer</CODE> to return a reference to this MBeanServer
	 * object.
	 * </p>
	 *
	 * <p>
	 * This method is equivalent to <code>createMBeanServer(null)</code>.
	 *
	 ...
	 *
	 * @exception JMRuntimeException
	 *                               if the property
	 *                               <code>javax.management.builder.initial</code>
	 *                               exists but
	 *                               the class it names cannot be instantiated
	 *                               through a public
	 *                               no-argument constructor; or if the
	 *                               instantiated builder
	 *                               returns null from its
	 *                               {@link MBeanServerBuilder#newMBeanServerDelegate
	 *                               newMBeanServerDelegate} or
	 *                               {@link MBeanServerBuilder#newMBeanServer
	 *                               newMBeanServer}
	 *                               methods.
	 *
	 ...
	 *                               <code>javax.management.builder.initial</code>
	 *                               exists and
	 *                               can be instantiated but is not assignment
	 *                               compatible with
	...
	/**
	 * <p>
	 * Return a new object implementing the {@link MBeanServer} interface with
	 * the specified default domain name. The given domain name is used as the
	 * domain part in the ObjectName of MBeans when the domain is specified by
	 * the user is null.
	 * </p>
	 *
	 ...
	 *
	 * @param domain
	 *               the default domain name for the created MBeanServer. This
	 *               is
	 *               the value that will be returned by
	 *               {@link MBeanServer#getDefaultDomain}.
	 *
	 * @return the newly created MBeanServer.
	 *
	 * @exception SecurityException
	 ...
	 * <p>
	 * Return a new object implementing the MBeanServer interface with a
	 * standard default domain name, without keeping an internal reference to
	 * this new object. The default domain name is used as the domain part in
	 * the ObjectName of MBeans when the domain is specified by the user is
	 * null.
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * No reference is kept. <CODE>findMBeanServer</CODE> will not be able to
	 * return a reference to this MBeanServer object, but the garbage collector
	 * will be able to remove the MBeanServer object when it is no longer
	 * referenced.
	 * </p>
	 *
	 * <p>
	 * This method is equivalent to <code>newMBeanServer(null)</code>.
	 * </p>
	 *
	 * @return the newly created MBeanServer.
	 *
	 ...
	 * specified default domain name, without keeping an internal reference to
	 * this new object. The given domain name is used as the domain part in the
	...
	public static MBeanServer newMBeanServer(String domain) {
		...
		synchronized (mbsBuilder) {
			final MBeanServerDelegate delegate = mbsBuilder
					.newMBeanServerDelegate();
			if (delegate == null) {
				final String msg = "MBeanServerBuilder.newMBeanServerDelegate() "
						+ "returned null";
				throw new JMRuntimeException(msg);
			}
			final MBeanServer mbeanServer = mbsBuilder.newMBeanServer(domain,
					null, delegate);
			if (mbeanServer == null) {
	 ...
	 * object is one that was created by one of the
	 * <code>createMBeanServer</code> methods and not subsequently released with
	 * <code>releaseMBeanServer</code>.
	 * </p>
	 *
	 * @param agentId
	 *                The agent identifier of the MBeanServer to retrieve. If
	 *                this
	 *                parameter is null, all registered MBeanServers in this JVM
	 *                are
	 *                returned. Otherwise, only MBeanServers whose id is equal
	 *                to
	 *                <code>agentId</code> are returned. The id of an
	 *                MBeanServer is
	 *                the <code>MBeanServerId</code> attribute of its delegate
	 *                MBean.
	 *
	 ...
	 */
	public synchronized static ArrayList<MBeanServer> findMBeanServer(
			String agentId) {
	...
	/**
	 * Return the ClassLoaderRepository used by the given MBeanServer. This
	 * method is equivalent to {@link MBeanServer#getClassLoaderRepository()
	 * server.getClassLoaderRepository()}.
	 * 
	 * @param server
	 *               The MBeanServer under examination. Since JMX 1.2, if
	 *               <code>server</code> is <code>null</code>, the result is a
	 *               {@link NullPointerException}. This behavior differs from
	 *               what
	...
	private static synchronized void removeMBeanServer(MBeanServer mbs) {
		...
		if (!removed) {
			MBEANSERVER_LOGGER.logp(Level.FINER, MBeanServerFactory.class
					.getName(), "removeMBeanServer(MBeanServer)",
	 ...
	 * javax.management.builder.initial System property - if specified. If any
	 * checked exception needs to be thrown, it is embedded in a
	 * JMRuntimeException.
	 **/
	private static MBeanServerBuilder newBuilder(Class<?> builderClass) {
		try {
			...
			final String msg = "Failed to instantiate a MBeanServerBuilder from "
					+ builderClass + ": " + x;
	...
	private static synchronized void checkMBeanServerBuilder() {
		try {
			GetPropertyAction act = new GetPropertyAction(JMX_INITIAL_BUILDER);
			...
			try {
				...
				final String msg = "Failed to load MBeanServerBuilder class "
						+ builderClassName + ": " + x;
				throw new JMRuntimeException(msg, x);
			}
		} catch (RuntimeException x) {
			if (MBEANSERVER_LOGGER.isLoggable(Level.FINEST)) {
				StringBuilder strb = new StringBuilder().append(
						"Failed to instantiate MBeanServerBuilder: ").append(x)
						.append("\n\t\tCheck the value of the ").append(
								JMX_INITIAL_BUILDER).append(" property.");
				MBEANSERVER_LOGGER.logp(Level.FINEST, MBeanServerFactory.class
						.getName(), "checkMBeanServerBuilder", strb.toString());
			}
			throw x;
		}
	}
	...
	/**
	 * Get the current {@link javax.management.MBeanServerBuilder}, as specified
	 * by the current value of the javax.management.builder.initial property.
	 *
	 * This method consults the property and instantiates a new builder if
	 * needed.
	 *
	 ...
	 *                               if there is a SecurityManager and the
	 *                               caller's permissions
	 *                               do not make it possible to instantiate a
	 *                               new builder.
	 * @exception JMRuntimeException
	 *                               if the builder instantiation fails with a
	 *                               checked
	 *                               exception -
