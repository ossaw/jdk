...
public class MBeanServerFactory {
	 ...
	 *                if there is a SecurityManager and the caller's permissions
	 ...
	 *                if <code>mbeanServer</code> was not generated by one of
	 *                the <code>createMBeanServer</code> methods, or if
	 ...
	 *                if the property
	 *                <code>javax.management.builder.initial</code> exists but
	 *                the class it names cannot be instantiated through a public
	 *                no-argument constructor; or if the instantiated builder
	 *                returns null from its
	 *                {@link MBeanServerBuilder#newMBeanServerDelegate
	 *                newMBeanServerDelegate} or
	 *                {@link MBeanServerBuilder#newMBeanServer newMBeanServer}
	 *                methods.
	 *
	 * @exception ClassCastException
	 *                if the property
	 *                <code>javax.management.builder.initial</code> exists and
	 *                can be instantiated but is not assignment compatible with
	 ...
	 *
	 * @param domain
	 *            the default domain name for the created MBeanServer. This is
	 ...
	 *            parameter is null, all registered MBeanServers in this JVM are
	 *            returned. Otherwise, only MBeanServers whose id is equal to
	 *            <code>agentId</code> are returned. The id of an MBeanServer is
	...
	private static String mBeanServerId(MBeanServer mbs) {
		try {
			...
			JmxProperties.MISC_LOGGER
					.finest("Ignoring exception while getting MBeanServerId: " + e);
			return null;
		}
	}
	...
	private static MBeanServerBuilder newBuilder(Class<?> builderClass) {
		try {
			...
			final String msg = "Failed to instantiate a MBeanServerBuilder from " + builderClass
					+ ": " + x;
	...
	private static synchronized void checkMBeanServerBuilder() {
		try {
			...
			try {
				...
				final String msg = "Failed to load MBeanServerBuilder class " + builderClassName
						+ ": " + x;
				throw new JMRuntimeException(msg, x);
			}
		} catch (RuntimeException x) {
			if (MBEANSERVER_LOGGER.isLoggable(Level.FINEST)) {
				StringBuilder strb = new StringBuilder()
						...
						.append("\n\t\tCheck the value of the ").append(JMX_INITIAL_BUILDER)
						.append(" property.");
	 ...
	 * @exception SecurityException
	 *                if there is a SecurityManager and the caller's permissions
	 *                do not make it possible to instantiate a new builder.
	 * @exception JMRuntimeException
	 *                if the builder instantiation fails with a checked
	 *                exception - {@link java.lang.ClassNotFoundException}
	 *                etc...
	 *
	 **/
