...
/**
 * Represents an MBean attribute by associating its name with its value. The
 * MBean server and other objects use this class to get and set attributes
 * values.
 *
 * @since 1.5
 */
public class Attribute implements Serializable {
	...
	/**
	 * Constructs an Attribute object which associates the given attribute name
