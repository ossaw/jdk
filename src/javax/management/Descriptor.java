...
/**
 * <p>
 * Additional metadata for a JMX element. A {@code Descriptor} is associated
 ...
 * the contents of the descriptor will throw an exception for an immutable
 * descriptor. Immutable descriptors are usually instances of
 ...
 * field may be set in descriptors returned by the JMX API. These fields appear
 * in <i>italics</i> in the table below, and each one has a corresponding
 * constant in the {@link JMX} class. For example, the field
 ...
 * consistent with the type returned by the {@code getType()} method for the
 * associated {@code MBeanAttributeInfo} or {@code
 * MBeanParameterInfo}. For MXBeans, this means that they should be of the
 ...
 * value of this field to contain a string that is the version of the model in
 * which the element was first deprecated, followed by a space, followed by an
 ...
 * item. For example, an attribute might only be meaningful after the
 ...
 * unless it has the {@code immutableInfo} set to {@code true} or it has
 ...
 * never decreases except by being reset to a starting value. Counter metrics
 * are almost always non-negative integers. An example might be the number of
 ...
 * MBeanAttributeInfo} and {@code MBeanParameterInfo}, this is the Open Type of
 * the attribute or parameter. In the case of {@code
 * MBeanOperationInfo}, it is the Open Type of the return value. This field is
 * set in the Descriptor for all instances of
 * {@link OpenMBeanAttributeInfoSupport}, {@link OpenMBeanOperationInfoSupport},
 ...
 * interface method that produced this {@code
 * MBeanAttributeInfo} (etc). For example, a method<br>
 * <code>public
 ...
 * {@code ModelMBeanOperationInfo}</a>, as well as the chapter "Model MBeans" of
 * the <a href=
 * "http://www.oracle.com/technetwork/java/javase/tech/javamanagement-140525.html">
 * JMX Specification</a>. The following table summarizes these fields. Note that
 ...
 * <td>Number</td>
 * <td>ModelMBeanInfo<br>
 * ModelMBeanAttributeInfo<br>
 ...
 * <td>Descriptor</td>
 * <td>ModelMBeanAttributeInfo</td>
 * <td>See the section "Protocol Map Support" in the JMX specification document.
 ...
 * <td>role</td>
 * <td>String</td>
 * <td>ModelMBeanConstructorInfo<br>
 * ModelMBeanOperationInfo</td>
 ...
 * <td>Number</td>
 * <td>ModelMBeanNotificationInfo</td>
 * <td>0-6 where 0: unknown; 1: non-recoverable; 2: critical, failure; 3: major,
...
public interface Descriptor extends Serializable, Cloneable {
	...
	/**
	 * Returns the value for a specific field name, or null if no value is
	 ...
	 *         <br>
	 *         If the value of a field is not a String, then the toString()
	 *         method will be called on it and the returned value, enclosed in
	 *         parentheses, used as the value for the field in the returned
	 ...
	 *
	 * @return String array of field names. If the descriptor is empty, you will
	 *         get an empty array.
	 */
	 ...
	 * The returned values are in the same order as the {@code fieldNames}
	...
	/**
	 * <p>
	 * Returns a descriptor which is equal to this descriptor. Changes to the
	 * returned descriptor will have no effect on this descriptor, and vice
	 * versa. If this descriptor is immutable, it may fulfill this condition by
	 * returning itself.
	 * </p>
	 * 
	 * @exception RuntimeOperationsException
