...
/**
 * Thrown when an invalid MBean attribute is passed to a query constructing
 * method. This exception is used internally by JMX during the evaluation of a
...
public class BadAttributeValueExpException extends Exception {
	...
	/**
	 * @serial A string representation of the attribute that originated this
	 *         exception. for example, the string value can be the return of
