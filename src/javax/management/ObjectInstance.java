...
/**
 * Used to represent the object name of an MBean and its class name. If the
 * MBean is a Dynamic MBean the class name should be retrieved from the
...
public class ObjectInstance implements Serializable {
	 ...
	 * @param className
	 *            The full class name, including the package name, of the object
	 *            instance. If the MBean is a Dynamic MBean the class name
	...
	/**
	 * Allows an object instance to be created given an object name and the full
	 ...
	 *            instance. If the MBean is a Dynamic MBean the class name
	 *            corresponds to its {@link DynamicMBean#getMBeanInfo()
	 *            getMBeanInfo()}<code>.getClassName()</code>. If the MBean is a
	 *            Dynamic MBean the class name should be retrieved from the
	 *            <CODE>MBeanInfo</CODE> it provides.
	 *
	 */
	 ...
	 *
	 * @param object
	 *            The object instance that the current object instance is to be
	 *            compared with.
	 *
	...
	/**
	 * Returns a string representing this ObjectInstance object. The format of
	 * this string is not specified, but users can expect that two
	 * ObjectInstances return the same string if and only if they are equal.
	 */
