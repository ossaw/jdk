 ...
 * associated Descriptor and an implementation of the DescriptorAccess
 * interface.
 * </p>
 * <P id="descriptor">
 ...
 * <td>role</td>
 * <td>String</td>
 * <td>Must be "operation", "getter", or "setter".</td>
 * </tr>
 * <tr>
 * <td>targetObject</td>
 * <td>Object</td>
 ...
 * <td>value</td>
 * <td>Object</td>
 * <td>Cached value for operation.</td>
 * </tr>
 * <tr>
 * <td>displayName</td>
 * <td>String</td>
 ...
 * <td>Number</td>
 * <td>How long cached value is valid.</td>
 * </tr>
 * <tr>
 * <td>lastUpdatedTimeStamp</td>
 * <td>Number</td>
 * <td>When cached value was set.</td>
 * </tr>
 * <tr>
 * <td>visibility</td>
 * <td>Number</td>
 ...
 * <td>String</td>
 * <td>XML formatted string to describe how to present operation</td>
 * </tr>
 * </table>
 * <p>
 * The default descriptor will have name, descriptorType, displayName and role
 * fields set. The default value of the name and displayName fields is the
 * operation name.
 * </p>
 * <p>
 ...
 * valid, omit the <code>currencyTimeLimit</code> field. To indicate that it is
 * always valid, use a very large number for this field.
 * </p>
 * <p>
 * The <b>serialVersionUID</b> of this class is
 * <code>6532732096650090465L</code>.
 *
 * @since 1.5
 */
...
public class ModelMBeanOperationInfo extends MBeanOperationInfo implements DescriptorAccess {
    ...
    private static final ObjectStreamField[] oldSerialPersistentFields = { new ObjectStreamField(
            "operationDescriptor", Descriptor.class), new ObjectStreamField("currClass", String.class) };
    //
    // Serializable fields in new serial form
    private static final ObjectStreamField[] newSerialPersistentFields = { new ObjectStreamField(
            "operationDescriptor", Descriptor.class) };
    //
    ...
    /**
     * @serial The descriptor containing the appropriate metadata for this
     *         instance
     */
     ...
     * The {@link Descriptor} of the constructed object will include fields
     * contributed by any annotations on the {@code Method} object that contain
    ...
    /**
     * Constructs a ModelMBeanOperationInfo object. The {@link Descriptor} of
     * the constructed object will include fields contributed by any annotations
     * on the {@code Method} object that contain the {@link DescriptorKey}
     * meta-annotation.
     *
     * @param operationMethod
     *        The java.lang.reflect.Method object describing the
    ...
    public ModelMBeanOperationInfo(ModelMBeanOperationInfo inInfo) {
        super(inInfo.getName(), inInfo.getDescription(), inInfo.getSignature(), inInfo.getReturnType(), inInfo
                .getImpact());
        if (MODELMBEAN_LOGGER.isLoggable(Level.FINER)) {
            MODELMBEAN_LOGGER.logp(Level.FINER, ModelMBeanOperationInfo.class.getName(),
    ...
    /**
     * Creates and returns a new ModelMBeanOperationInfo which is a duplicate of
     * this ModelMBeanOperationInfo.
     */
     ...
     *
     * @return Descriptor associated with the ModelMBeanOperationInfo object.
     * @see #setDescriptor
     */

    public Descriptor getDescriptor() {
        if (MODELMBEAN_LOGGER.isLoggable(Level.FINER)) {
            MODELMBEAN_LOGGER.logp(Level.FINER, ModelMBeanOperationInfo.class.getName(), "getDescriptor()",
                    "Entry");
        }
     ...
     * a default descriptor. The Descriptor is validated before it is assigned.
     * If the new Descriptor is invalid, then a RuntimeOperationsException
    ...
    public String toString() {
        if (MODELMBEAN_LOGGER.isLoggable(Level.FINER)) {
            MODELMBEAN_LOGGER.logp(Level.FINER, ModelMBeanOperationInfo.class.getName(), "toString()",
                    "Entry");
        }
        String retStr = "ModelMBeanOperationInfo: " + this.getName() + " ; Description: " + this
                .getDescription() + " ; Descriptor: " + this.getDescriptor() + " ; ReturnType: " + this
    ...
    private Descriptor validDescriptor(final Descriptor in) throws RuntimeOperationsException {
        ...
        if (!getName().equalsIgnoreCase((String) clone.getFieldValue("name"))) {
            throw new RuntimeOperationsException(new IllegalArgumentException("Invalid Descriptor argument"),
                    "The Descriptor \"name\" field does not match the object described. " + " Expected: "
                            + this.getName() + " , was: " + clone.getFieldValue("name"));
        }
        if (!"operation".equalsIgnoreCase((String) clone.getFieldValue("descriptorType"))) {
            throw new RuntimeOperationsException(new IllegalArgumentException("Invalid Descriptor argument"),
                    "The Descriptor \"descriptorType\" field does not match the object described. "
                            + " Expected: \"operation\" ," + " was: " + clone.getFieldValue(
                                    "descriptorType"));
        }
        final String role = (String) clone.getFieldValue("role");
        if (!(role.equalsIgnoreCase("operation") || role.equalsIgnoreCase("setter") || role.equalsIgnoreCase(
                "getter"))) {
            throw new RuntimeOperationsException(new IllegalArgumentException("Invalid Descriptor argument"),
                    "The Descriptor \"role\" field does not match the object described. "
                            + " Expected: \"operation\", \"setter\", or \"getter\" ," + " was: " + clone
                                    .getFieldValue("role"));
        }
            ...
            if (!(targetValue instanceof java.lang.String)) {
                throw new RuntimeOperationsException(new IllegalArgumentException(
                        ...
                        "The Descriptor field \"targetValue\" is invalid class. "
                                + " Expected: java.lang.String, " + " was: " + targetValue.getClass()
                                        .getName());
            }
        }
        return clone;
    ...
    /**
     * Serializes a {@link ModelMBeanOperationInfo} to an
