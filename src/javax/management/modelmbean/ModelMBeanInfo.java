 ...
 * cannot be registered in the MBeanServer unless it is a JMX compliant MBean.
...
public interface ModelMBeanInfo {
     ...
     * ModelMBean. The setDescriptor method of the corresponding ModelMBean*Info
     ...
     * This descriptor contains metadata about the MBean and default policies
     * for persistence and caching.
     * </p>
     * <P id="descriptor">
     * The fields in the descriptor are defined, but not limited to, the
     * following. Note that when the Type in this table is Number, a String that
     * is the decimal representation of a Long can also be used.
     * </P>
     ...
     * <td>displayName</td>
     * <td>String</td>
     * <td>Name of MBean to be used in displays.</td>
     * </tr>
     * <tr>
     * <td>persistPolicy</td>
     * <td>String</td>
     ...
     * <td>persistPeriod</td>
     * <td>Number</td>
     * <td>Frequency of persist cycle in seconds, for OnTime and NoMoreOftenThan
     * PersistPolicy</td>
     * </tr>
     * <tr>
     * <td>currencyTimeLimit</td>
     * <td>Number</td>
     * <td>How long cached value is valid: &lt;0 never, =0 always, &gt;0
     * seconds.</td>
     * </tr>
     * <tr>
     * <td>log</td>
     * <td>String</td>
     * <td>t: log all notifications, f: log no notifications.</td>
     * </tr>
     * <tr>
     * <td>logfile</td>
     * <td>String</td>
     ...
     * <td>String</td>
     * <td>XML formatted string to allow presentation of data to be associated
     * with the MBean.</td>
     * </tr>
     * </table>
     * <P>
     * The default descriptor is: name=className,descriptorType="mbean",
     * displayName=className, persistPolicy="never",log="F",visibility="1" If
     * the descriptor does not contain all these fields, they will be added with
     ...
     * wide metadata about the MBean and default policies for persistence and
     * caching. This operation does a complete replacement of the descriptor, no
     * merging is done. If the descriptor to set to is null then the default
     * descriptor will be created. The default descriptor is:
     * name=className,descriptorType="mbean", displayName=className,
     * persistPolicy="never",log="F",visibility="1" If the descriptor does not
     * contain all these fields, they will be added with these default values.
     * See {@link #getMBeanDescriptor getMBeanDescriptor} method javadoc for
     ...
     * object.
     * <P>
     * In addition to any notification specified by the application, a
     * ModelMBean may always send also two additional notifications:
     * <UL>
     * <LI>One with descriptor name "GENERIC" and displayName
     * "jmx.modelmbean.generic"
     * <LI>Second is a standard attribute change notification with descriptor
     * name "ATTRIBUTE_CHANGE" and displayName "jmx.attribute.change"
     * </UL>
