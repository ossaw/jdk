...
public interface ModelMBeanNotificationBroadcaster extends
	 ...
	 * invoked when any attributeChangeNotification is issued through or by the
	 * ModelMBean. This does not include other Notifications. They must be
	 * registered for independently. An AttributeChangeNotification will be
