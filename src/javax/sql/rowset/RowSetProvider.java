...
/**
 * A factory API that enables applications to obtain a {@code RowSetFactory}
 * implementation that can be used to create different types of {@code RowSet}
 * implementations.
 * <p>
 * Example:
 * </p>
...
public class RowSetProvider {
	...
	/**
	 * <p>
	 * Creates a new instance of a <code>RowSetFactory</code> implementation.
	 * This method uses the following look up order to determine the
	 * <code>RowSetFactory</code> implementation class to load:
	 * </p>
	 * <ul>
	 * <li>The System property {@code javax.sql.rowset.RowSetFactory}. For
	 * example:
	 * <ul>
	 * <li>-Djavax.sql.rowset.RowSetFactory=com.sun.rowset.RowSetFactoryImpl
	 * </li>
	 * </ul>
	 * <li>The {@link ServiceLoader} API. The {@code ServiceLoader} API will
	 * look for a class name in the file
	 * {@code META-INF/services/javax.sql.rowset.RowSetFactory} in jars
	 ...
	 * entry in {@code META-INF/services/javax.sql.rowset.RowSetFactory} would
	 * be:
	 * <ul>
	 ...
	 *
	 * @throws SQLException
	 *             if the default factory class cannot be loaded, instantiated.
	...
	public static RowSetFactory newFactory() throws SQLException {
		...
		try {
			...
			if (factoryClassName != null) {
				...
				factory = (RowSetFactory) ReflectUtil
						.newInstance(getFactoryClass(factoryClassName, null, true));
			}
		} catch (Exception e) {
	...
	/**
	 * <p>
	 * Creates a new instance of a <code>RowSetFactory</code> from the specified
	 * factory class name. This function is useful when there are multiple
	 ...
	 *            fully qualified factory class name that provides an
	 *            implementation of <code>javax.sql.rowset.RowSetFactory</code>.
	 *
	 * @param cl
