...
/**
 * An extension of <code>SQLException</code> that provides information about
 * database warnings set on <code>RowSet</code> objects. Warnings are silently
 * chained to the object whose method call caused it to be reported. This class
 * complements the <code>SQLWarning</code> class.
 * <P>
 * Rowset warnings may be retrieved from <code>JdbcRowSet</code>,
 * <code>CachedRowSet</code>&trade;, <code>WebRowSet</code>,
 * <code>FilteredRowSet</code>, or <code>JoinRowSet</code> implementations. To
 * retrieve the first warning reported on any <code>RowSet</code>
 * implementation, use the method <code>getRowSetWarnings</code> defined in the
 * <code>JdbcRowSet</code> interface or the <code>CachedRowSet</code> interface.
 * To retrieve a warning chained to the first warning, use the
 * <code>RowSetWarning</code> method <code>getNextWarning</code>. To retrieve
 * subsequent warnings, call <code>getNextWarning</code> on each
 * <code>RowSetWarning</code> object that is returned.
 * <P>
 * The inherited methods <code>getMessage</code>, <code>getSQLState</code>, and
 * <code>getErrorCode</code> retrieve information contained in a
...
public class RowSetWarning extends SQLException {
	...
	/**
	 * Constructs a <code>RowSetWarning</code> object with the given value for
	...
	/**
	 * Sets <i>warning</i> as the next warning, that is, the warning chained to
