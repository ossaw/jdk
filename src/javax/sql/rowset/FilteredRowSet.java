 ...
 * this is an impractical approach for lightweight components such as
 * disconnected <code>RowSet</code> objects. The <code>FilteredRowSet</code>
 ...
 * <code>RowSet</code> interfaces and extends the <code>CachedRowSet</code>
 ...
 * <a href="Predicate.html">Predicate</a> class JavaDoc), a
 * <code>FilteredRowSet</code> could then be used as described below.
 *
 * <pre>
 * {@code
 ...
 * implements the <code>Predicate</code> interface. This object expresses the
 * following constraints: All rows outputted or modified from this
 ...
 * <code>RowSet</code> object. This criterion governs the subset of rows that
 * are visible and also defines which rows can be modified, deleted or inserted.
 * <p>
 ...
 * for all views and updates to the <code>FilteredRowSet</code> object. Any
 * attempt to update the <code>FilteredRowSet</code> that violates the criterion
 * will result in a <code>SQLException</code> object being thrown.
 * <p>
 * The <code>FilteredRowSet</code> range criterion can be modified by applying a
 * new <code>Predicate</code> object to the <code>FilteredRowSet</code> instance
 * at any time. This is possible if no additional references to the
