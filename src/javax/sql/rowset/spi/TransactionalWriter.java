 ...
 * transaction control.
 * <p>
 * If one or more disconnected <code>RowSet</code> objects are participating in
 * a global transaction, they may wish to coordinate their synchronization
 * commits to preserve data integrity and reduce the number of synchronization
 * exceptions. If this is the case, an application should set the
 * <code>CachedRowSet</code> constant <code>COMMIT_ON_ACCEPT_CHANGES</code> to
 * <code>false</code> and use the <code>commit</code> and <code>rollback</code>
