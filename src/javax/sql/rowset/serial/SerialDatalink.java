 ...
 * <code>DATALINK</code> value. A <code>DATALINK</code> value references a file
 * outside of the underlying data source that the data source manages.
 * <P>
 * <code>RowSet</code> implementations can use the method
 * <code>RowSet.getURL</code> to retrieve a <code>java.net.URL</code> object,
 * which can be used to manipulate the external data.
 * 
 * <pre>
...
public class SerialDatalink implements Serializable, Cloneable {
    ...
    /**
     * The SQL type of the elements in this <code>SerialDatalink</code> object.
     * The type is expressed as one of the contants from the class
     ...
     * <code>DATALINK</code> value that this SerialDatalink object represents.
     * 
     * @serial
     */
    ...
    /**
     * Compares this {@code SerialDatalink} to the specified object. The result
     ...
     * {@code SerialDatalink} object is taken as the hash code of the
     * {@code URL} it stores
     *
    ...
    /**
     * readObject and writeObject are called to restore the state of the
     * {@code SerialDatalink} from a stream. Note: we leverage the default
     * Serialized form
     */
