...
/**
 * A serialized mapping of a <code>Ref</code> object, which is the mapping in
 * the Java programming language of an SQL <code>REF</code> value.
 * <p>
...
public class SerialRef implements Ref, Serializable, Cloneable {
	...
	/**
	 * Constructs a <code>SerialRef</code> object from the given
	 * <code>Ref</code> object.
	 *
	 * @param ref
	 *            a Ref object; cannot be <code>null</code>
	 * @throws SQLException
	 *             if a database access occurs; if <code>ref</code> is
	 *             <code>null</code>; or if the <code>Ref</code> object returns
	 *             a <code>null</code> value base type name.
	 * @throws SerialException
	 *             if an error occurs serializing the <code>Ref</code> object
	 */
	...
	/**
	 * Returns an <code>Object</code> representing the SQL structured type to
	 * which this <code>SerialRef</code> object refers. The attributes of the
	...
	/**
	 * Returns an <code>Object</code> representing the SQL structured type to
	 * which this <code>SerialRef</code> object refers.
	 *
	 ...
	 *            be referenced
	 * @throws SerialException
	 *             if an error is encountered generating the the structured type
	...
	/**
	 * Returns a clone of this {@code SerialRef}. The underlying {@code Ref}
