 ...
 * <P>
 * The <code>SerialClob</code> class provides a constructor for creating an
 * instance from a <code>Clob</code> object. Note that the <code>Clob</code>
 * object should have brought the SQL <code>CLOB</code> value's data over to the
 * client before a <code>SerialClob</code> object is constructed from it. The
 * data of an SQL <code>CLOB</code> value can be materialized on the client as a
 ...
 * SerialClob should be controlled by appropriate synchronization.
 * 
...
public class SerialClob implements Clob, Serializable, Cloneable {
	...
	/**
	 * Constructs a <code>SerialClob</code> object that is a serialized version
	 * of the given <code>char</code> array.
	 * <p>
	 * The new <code>SerialClob</code> object is initialized with the data from
	 * the <code>char</code> array, thus allowing disconnected
	 * <code>RowSet</code> objects to establish a serialized <code>Clob</code>
	...
	/**
	 * Constructs a <code>SerialClob</code> object that is a serialized version
	 * of the given <code>Clob</code> object.
	 * <P>
	 * The new <code>SerialClob</code> object is initialized with the data from
	 * the <code>Clob</code> object; therefore, the <code>Clob</code> object
	 * should have previously brought the SQL <code>CLOB</code> value's data
	 * over to the client from the database. Otherwise, the new
	 * <code>SerialClob</code> object object will contain no data.
	 * <p>
	 * Note: The <code>Clob</code> object supplied to this constructor must
	 * return non-null for both the <code>Clob.getCharacterStream()</code> and
	 * <code>Clob.getAsciiStream</code> methods. This <code>SerialClob</code>
	 ...
	 *            <code>SerialClob</code> object is to be constructed; cannot be
	 *            null
	 * @throws SerialException
	 *             if an error occurs during serialization
	 * @throws SQLException
	 *             if a SQL error occurs in capturing the CLOB; if the
	...
	public SerialClob(Clob clob) throws SerialException, SQLException {
		...
		if (clob == null) {
			throw new SQLException(
					"Cannot instantiate a SerialClob " + "object with a null Clob object");
		}
		len = clob.length();
		this.clob = clob;
		buf = new char[(int) len];
	...
	/**
	 * Returns this <code>SerialClob</code> object's data as a stream of Unicode
	 * characters. Unlike the related method, <code>getAsciiStream</code>, a
	 * stream is produced regardless of whether the <code>SerialClob</code>
	 * object was created with a <code>Clob</code> object or a <code>char</code>
	 * array.
	 *
	 ...
	 * <code>SerialClob</code> object as an ascii stream. This method forwards
	 * the <code>getAsciiStream</code> call to the underlying <code>Clob</code>
	 * object in the event that this <code>SerialClob</code> object is
	 * instantiated with a <code>Clob</code> object. If this
	 * <code>SerialClob</code> object is instantiated with a <code>char</code>
	 * array, a <code>SerialException</code> object is thrown.
	 *
	 * @return a <code>java.io.InputStream</code> object containing this
	 *         <code>SerialClob</code> object's data
	 * @throws SerialException
	 *             if this {@code SerialClob} object was not instantiated with a
	 *             <code>Clob</code> object; if {@code free} had previously been
	 *             called on this object
	 * @throws SQLException
	 *             if there is an error accessing the <code>CLOB</code> value
	 *             represented by the <code>Clob</code> object that was used to
	...
	/**
	 * Returns a copy of the substring contained in this <code>SerialClob</code>
	 * object, starting at the given position and continuing for the specified
	 ...
	 *            <code>1</code>, and the sum of the starting position and the
	 *            length of the substring must be less than the length of this
	 *            <code>SerialClob</code> object
	 * @param length
	 *            the number of characters in the substring to be returned; must
	 *            not be greater than the length of this <code>SerialClob</code>
	 *            object, and the sum of the starting position and the length of
	 ...
	 * @throws SerialException
	 *             if either of the arguments is out of bounds; if {@code free}
	...
	/**
	 * Returns the position in this <code>SerialClob</code> object where the
	 * given <code>String</code> object begins, starting the search at the
	 * specified position. This method returns <code>-1</code> if the pattern is
	 * not found.
	 *
	 * @param searchStr
	 *            the <code>String</code> object for which to search
	 * @param start
	 *            the position in this <code>SerialClob</code> object at which
	 *            to start the search; the first position is <code>1</code>;
	 *            must not be less than <code>1</code> nor greater than the
	 ...
	 *             object
	 * @throws SQLException
	 *             if there is an error accessing the Clob value from the
	 *             database.
	 */
	...
	/**
	 * Returns the position in this <code>SerialClob</code> object where the
	 * given <code>Clob</code> signature begins, starting the search at the
	 * specified position. This method returns <code>-1</code> if the pattern is
	 * not found.
	 *
	 * @param searchStr
	 ...
	 * @param start
	 *            the position in this <code>SerialClob</code> object at which
	 *            to begin the search; the first position is <code>1</code>;
	 *            must not be less than <code>1</code> nor greater than the
	 *            length of this <code>SerialClob</code> object
	 ...
	 *         starting position
	 * @throws SerialException
	 *             if an error occurs locating the Clob signature; if the
	 *             {@code free} method had been previously called on this object
	 * @throws SQLException
	 *             if there is an error accessing the Clob value from the
	 *             database
	 */
	 ...
	 * that this <code>SerialClob</code> object represents, at the position
	 * <code>pos</code>.
	 *
	 * @param pos
	 ...
	 *             <code>SerialClob</code> length; or the combined values of the
	 *             length and offset is greater than the Clob buffer; if the
	 *             {@code free} method had been previously called on this object
	 */
	 ...
	 * <code>CLOB</code> value that this <code>SerialClob</code> object
	 * represents, starting at position <code>pos</code>. This method forwards
	 * the <code>setAsciiStream()</code> call to the underlying
	 * <code>Clob</code> object in the event that this <code>SerialClob</code>
	 * object is instantiated with a <code>Clob</code> object. If this
	 * <code>SerialClob</code> object is instantiated with a <code>char</code>
	 * array, a <code>SerialException</code> object is thrown.
	 *
	 * @param pos
	 ...
	 * @throws SerialException
	 *             if SerialClob is not instantiated with a Clob object; if the
	 *             {@code free} method had been previously called on this object
	 * @throws SQLException
	 *             if there is an error accessing the <code>CLOB</code> value
	 * @see #getAsciiStream
	 ...
	 * the <code>CLOB</code> value that this <code>SerialClob</code> object
	 * represents, at position <code>pos</code>. This method forwards the
	 * <code>setCharacterStream()</code> call to the underlying
	 * <code>Clob</code> object in the event that this <code>SerialClob</code>
	 * object is instantiated with a <code>Clob</code> object. If this
	 * <code>SerialClob</code> object is instantiated with a <code>char</code>
	 ...
	 * @throws SerialException
	 *             if the SerialClob is not instantiated with a Clob object; if
	 *             the {@code free} method had been previously called on this
	 *             object
	 * @throws SQLException
	 *             if there is an error accessing the <code>CLOB</code> value
	 ...
	 * object represents so that it has a length of <code>len</code> characters.
	 * <p>
	 ...
	 * {@code SerialClob} value, starting with the character specified by pos,
	 * which is length characters in length.
	 *
	 * @param pos
	 *            the offset to the first character of the partial value to be
	 *            retrieved. The first character in the {@code SerialClob} is at
	 *            position 1.
	 * @param length
	 ...
	 *             characters in the {@code SerialClob} or if pos + length is
	 ...
	 * SerialClob} object that represents the same sequence of characters as
	 * this object.
	 *
	 * @param obj
	 ...
	 * reference to a clone of the internal character array, not a reference to
	 * the original internal character array of this {@code SerialClob} object.
