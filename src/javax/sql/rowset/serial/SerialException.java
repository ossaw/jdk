...
/**
 * Indicates and an error with the serialization or de-serialization of SQL
 * types such as <code>BLOB, CLOB, STRUCT or ARRAY</code> in addition to SQL
 * types such as <code>DATALINK and JAVAOBJECT</code>
 *
 */
