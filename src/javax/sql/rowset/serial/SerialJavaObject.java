 ...
 * <code>JAVA_OBJECT</code> value. Assuming the Java object implements the
 * <code>Serializable</code> interface, this class simply wraps the
...
public class SerialJavaObject implements Serializable, Cloneable {
    ...
    /**
     * Placeholder for all fields in the <code>JavaObject</code> being
     * serialized.
     */
    ...
    /**
     * Returns an array of <code>Field</code> objects that contains each field
     * of the object that this helper class is serializing.
     *
    ...
    public Field[] getFields() throws SerialException {
        if (fields != null) {
            ...
            if (sm != null) {
                /*
                 * Check if the caller is allowed to access the specified
                 * class's package. If access is denied, throw a
                 * SecurityException.
                 */
     ...
     * {@code SerialJavaObject} object is taken as the hash code of the
     * {@code Object} it stores
     *
