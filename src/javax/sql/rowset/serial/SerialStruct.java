...
/**
 * A serialized mapping in the Java programming language of an SQL structured
 * type. Each attribute that is not already serialized is mapped to a serialized
 * form, and if an attribute is itself a structured type, each of its attributes
 * that is not already serialized is mapped to a serialized form.
 * <P>
 * In addition, the structured type is custom mapped to a class in the Java
 * programming language if there is such a mapping, as are its attributes, if
 * appropriate.
 * <P>
...
public class SerialStruct implements Struct, Serializable, Cloneable {
     ...
     * <code>SerialStruct</code> object represents. This is the name used in the
     * SQL definition of the SQL structured type.
     *
     * @serial
     */
    ...
    /**
     * An array of <code>Object</code> instances in which each element is an
     * attribute of the SQL structured type that this <code>SerialStruct</code>
     * object represents. The attributes are ordered according to their order in
     * the definition of the SQL structured type.
     *
     * @serial
     */
    ...
    public SerialStruct(Struct in, Map<String, Class<?>> map) throws SerialException {
        ...
        try {
            ...
            /*
             * the array may contain further Structs and/or classes that have
             * been mapped, other types that we have to serialize
             */
            mapToSerial(map);
    ...
    /**
     * Constructs a <code>SerialStruct</code> object from the given
     * <code>SQLData</code> object, using the given type map to custom map it to
     * a class in the Java programming language. The type map gives the SQL type
     * and the class to which it is mapped. The <code>SQLData</code> object
     ...
     * This is the name used in the SQL definition of the structured type
     *
     * @return a <code>String</code> object representing the SQL type name for
     ...
     * attributes of the SQL structured type that this <code>SerialStruct</code>
     * object represents.
     *
     ...
     * <code>SerialStruct</code> represents as an array of <code>Object</code>
    ...
    /**
     * Maps attributes of an SQL structured type that are not serialized to a
     * serialized form, using the given type map for custom mapping when
     * appropriate. The following types in the Java programming language are
     * mapped to their serialized forms: <code>Struct</code>,
     * <code>SQLData</code>, <code>Ref</code>, <code>Blob</code>,
     * <code>Clob</code>, and <code>Array</code>.
     * <P>
     * This method is called internally and is not used by an application
     * programmer.
     *
     * @param map
     *        a <code>java.util.Map</code> object in which each entry
     ...
     * {@code SerialStruct} object is computed using the hash codes of the
     * attributes of the {@code SerialStruct} object and its {@code SQLTypeName}
     *
     ...
     * reference to a clone of the underlying attribs array, not a reference to
     * the original underlying attribs array of this {@code SerialStruct}
     * object.
     *
