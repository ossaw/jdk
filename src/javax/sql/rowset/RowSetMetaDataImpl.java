...
/**
 * Provides implementations for the methods that set and get metadata
 * information about a <code>RowSet</code> object's columns. A
 * <code>RowSetMetaDataImpl</code> object keeps track of the number of columns
 * in the rowset and maintains an internal array of column attributes for each
 * column.
 * <P>
 * A <code>RowSet</code> object creates a <code>RowSetMetaDataImpl</code> object
 * internally in order to set and retrieve information about its columns.
 * <P>
 * NOTE: All metadata in a <code>RowSetMetaDataImpl</code> object should be
 * considered as unavailable until the <code>RowSet</code> object that it
 * describes is populated. Therefore, any <code>RowSetMetaDataImpl</code> method
 * that retrieves information is defined as having unspecified behavior when it
 * is called before the <code>RowSet</code> object contains data.
 *
 * @since 1.5
 */
public class RowSetMetaDataImpl implements RowSetMetaData, Serializable {
	...
	/**
	 * The number of columns in the <code>RowSet</code> object that created this
	 * <code>RowSetMetaDataImpl</code> object.
	 * 
	 * @serial
	 */
	...
	/**
	 * An array of <code>ColInfo</code> objects used to store information about
	 * each column in the <code>RowSet</code> object for which this
	 * <code>RowSetMetaDataImpl</code> object was created. The first
	 * <code>ColInfo</code> object in this array contains information about the
	 * first column in the <code>RowSet</code> object, the second element
	...
	/**
	 * Checks to see that the designated column is a valid column number for the
	 * <code>RowSet</code> object for which this <code>RowSetMetaDataImpl</code>
	 ...
	 *             with the message "Invalid column index" if the given column
	 *             number is out of the range of valid column numbers for the
	...
	/**
	 * Checks to see that the given SQL type is a valid column type and throws
	 * an <code>SQLException</code> object if it is not. To be valid, a SQL type
	 * must be one of the constant values in the
	 ...
	 * @throws SQLException
	 *             if the given <code>int</code> is not a constant defined in
	 ...
	 *
	 * @param columnCount
	 *            an <code>int</code> giving the number of columns in the
	 *            <code>RowSet</code> object
	 * @throws SQLException
	...
	/**
	 * Sets whether the name of the designated column is case sensitive to the
	 ...
	 *            rowset, inclusive
	 * @param property
	 *            <code>true</code> to indicate that the column name is case
	 *            sensitive; <code>false</code> otherwise
	 * @throws SQLException
	 *             if a database access error occurs or the given column number
	 *             is out of bounds
	 */
	 ...
	 *            rowset, inclusive
	 * @param property
	 *            <code>true</code> to indicate that a column value can be used
	...
	/**
	 * Sets whether a value stored in the designated column is a cash value to
	 * the given <code>boolean</code>.
	 *
	 * @param columnIndex
	 *            the first column is 1, the second is 2, and so on; must be
	 *            between <code>1</code> and the number of columns, inclusive
	 *            between <code>1</code> and the number of columns, inclusive
	 * @param property
	 ...
	 * <code>NULL</code> to the given constant from the interface
	 ...
	 *            between <code>1</code> and the number of columns, inclusive
	 * @param property
	 *            one of the following <code>ResultSetMetaData</code> constants:
	 *            <code>columnNoNulls</code>, <code>columnNullable</code>, or
	 *            <code>columnNullableUnknown</code>
	 *
	 * @throws SQLException
	 *             if a database access error occurs, the given column number is
	 *             out of bounds, or the value supplied for the <i>property</i>
	...
	/**
	 * Sets whether a value stored in the designated column is a signed number
	 ...
	 *            between <code>1</code> and the number of columns, inclusive
	 * @param property
	 *            <code>true</code> to indicate that a column value is a signed
	...
	/**
	 * Sets the normal maximum number of chars in the designated column to the
	 * given number.
	 *
	 * @param columnIndex
	 *            the first column is 1, the second is 2, and so on; must be
	 ...
	 * @throws SQLException
	 *             if a database access error occurs, the given column number is
	 *             out of bounds, or <i>size</i> is less than <code>0</code>
	 */
	...
	/**
	 * Sets the suggested column label for use in printouts and displays, if
	 * any, to <i>label</i>. If <i>label</i> is <code>null</code>, the column
	 ...
	 * @throws SQLException
	 *             if a database access error occurs or the given column index
	 *             is out of bounds
	 */
	 ...
	 *            between <code>1</code> and the number of columns, inclusive
	 * @param columnName
	 *            a <code>String</code> object indicating the column name; if
	 ...
	 * <i>schemaName</i>. If <i>schemaName</i> is <code>null</code>, the schema
	 ...
	 *            between <code>1</code> and the number of columns, inclusive
	 * @param precision
	 *            the total number of decimal digits; must be <code>0</code> or
	 *            more
	 * @throws SQLException
	 *             if a database access error occurs, <i>columnIndex</i> is out
	 *             of bounds, or <i>precision</i> is less than <code>0</code>
	 */
	 ...
	 *            between <code>1</code> and the number of columns, inclusive
	 * @param scale
	 *            the number of digits to the right of the decimal point; must
	 *            be zero or greater
	 * @throws SQLException
	 *             if a database access error occurs, <i>columnIndex</i> is out
	 *             of bounds, or <i>scale</i> is less than <code>0</code>
	 */
	...
	/**
	 * Sets the name of the table from which the designated column was derived
	 ...
	 *            between <code>1</code> and the number of columns, inclusive
	 * @param tableName
	 *            the column's table name; may be <code>null</code> or an empty
	 *            string
	 * @throws SQLException
	 *             if a database access error occurs or the given column number
	 *             is out of bounds
	...
	/**
	 * Sets the catalog name of the table from which the designated column was
	 * derived to <i>catalogName</i>. If <i>catalogName</i> is <code>null</code>
	 ...
	 *            between <code>1</code> and the number of columns, inclusive
	 * @param catalogName
	 *            the column's table's catalog name; if the catalogName is
	...
	/**
	 * Sets the SQL type code for values stored in the designated column to the
	 ...
	 * @throws SQLException
	 *             if a database access error occurs, the given column number is
	 *             out of bounds, or the column type specified is not one of the
	 ...
	 *            between <code>1</code> and the number of columns, inclusive
	 * @param typeName
	 *            the data source-specific type name; if <i>typeName</i> is
	 *            <code>null</code>, an empty <code>String</code> is set
	 * @throws SQLException
	 *             if a database access error occurs or the given column number
	 *             is out of bounds
	...
	/**
	 * Retrieves the number of columns in the <code>RowSet</code> object for
	 * which this <code>RowSetMetaDataImpl</code> object was created.
	 *
	...
	/**
	 * Indicates whether a value stored in the designated column can be used in
	...
	/**
	 * Indicates whether a value stored in the designated column is a cash
	 * value.
	 *
	 * @param columnIndex
	 *            the first column is 1, the second is 2, and so on; must be
	...
	/**
	 * Indicates whether a value stored in the designated column is a signed
	 * number.
	 *
	 * @param columnIndex
	 *            the first column is 1, the second is 2, and so on; must be
	...
	/**
	 * Retrieves the suggested column title for the designated column for use in
	...
	/**
	 * Retrieves the schema name of the table from which the value in the
	...
	/**
	 * Retrieves the number of digits to the right of the decimal point for
	...
	/**
	 * Retrieves the name of the table from which the value in the designated
	 * column was derived.
	 *
	 * @param columnIndex
	 *            the first column is 1, the second is 2, and so on; must be
	...
	/**
	 * Retrieves the catalog name of the table from which the value in the
	 * designated column was derived.
	 *
	 * @param columnIndex
	 *            the first column is 1, the second is 2, and so on; must be
	...
	/**
	 * Indicates whether it is possible for a write operation on the designated
	 * column to succeed. A return value of <code>true</code> means that a write
	...
	/**
	 * Indicates whether a write operation on the designated column will
	 * definitely succeed.
	 *
	 * @param columnIndex
	 *            the first column is 1, the second is 2, and so on; must be
	 ...
	 * language to which a value in the designated column will be mapped. For
	 * example, if the value is an <code>int</code>, the class name returned by
	 * this method will be <code>java.lang.Integer</code>.
	 * <P>
	 * If the value in the designated column has a custom mapping, this method
	 * returns the name of the class that implements <code>SQLData</code>. When
	 * the method <code>ResultSet.getObject</code> is called to retrieve a value
	 * from the designated column, it will create an instance of this class or
	...
	private class ColInfo implements Serializable {
		 ...
		 * <code>true</code> means that the value in this column is
		 * automatically numbered; <code>false</code> means that it is not.
		 *
		 * @serial
		 */
		...
		/**
		 * The field that indicates whether the value in this column is case
		 * sensitive. <code>true</code> means that it is; <code>false</code>
		 * that it is not.
		 *
		 * @serial
		 */
		...
		/**
		 * The field that indicates whether the value in this column is a cash
		 * value <code>true</code> means that it is; <code>false</code> that it
		 * is not.
		 *
		 * @serial
		 */
		...
		/**
		 * The field that indicates whether the value in this column is
		 * nullable. The possible values are the <code>ResultSet</code>
		 * constants <code>columnNoNulls</code>, <code>columnNullable</code>,
		 * and <code>columnNullableUnknown</code>.
		 *
		 * @serial
		 */
		public int nullable;
		...
		/**
		 * The field that indicates whether the value in this column is a signed
		 * number. <code>true</code> means that it is; <code>false</code> that
		 * it is not.
		 *
		 * @serial
		 */
		...
		/**
		 * The field that indicates whether the value in this column can be used
		 * in a <code>WHERE</code> clause. <code>true</code> means that it can;
		 * <code>false</code> that it cannot.
		 *
		 * @serial
		 */
		...
		/**
		 * The field that holds the suggested column title for this column, to
		 * be used in printing and displays.
		 *
		 * @serial
		 */
		...
		/**
		 * The field that holds the schema name for the table from which this
		 * column was derived.
		 *
		 * @serial
		 */
		...
		/**
		 * The field that holds the precision of the value in this column. For
		 * number types, the precision is the total number of decimal digits;
		 * for character types, it is the maximum number of characters; for
		 * binary types, it is the maximum length in bytes.
		 *
		 * @serial
		 */
		...
		/**
		 * The field that holds the scale (number of digits to the right of the
		 * decimal point) of the value in this column.
		 *
		 * @serial
		 */
		public int colScale;
		...
		/**
		 * The field that holds the name of the table from which this column was
		 * derived. This value may be the empty string if there is no table
		 * name, such as when this column is produced by a join.
		 *
		 * @serial
		 */
		...
		/**
		 * The field that holds the catalog name for the table from which this
		 * column was derived. If the DBMS does not support catalogs, the value
		...
		/**
		 * The field that holds the type code from the class
		 * <code>java.sql.Types</code> indicating the type of the value in this
		 * column.
		 *
		 * @serial
		 */
		...
		/**
		 * The field that holds the type name used by this particular data
		 * source for the value stored in this column.
		 *
		 * @serial
		 */
