 ...
 * <code>RowSet</code> object. This interface is an extension of the
 * <code>ResultSetMetaData</code> interface with methods for setting the values
 * in a <code>RowSetMetaData</code> object. When a <code>RowSetReader</code>
 * object reads data into a <code>RowSet</code> object, it creates a
 * <code>RowSetMetaData</code> object and initializes it using the methods in
 * the <code>RowSetMetaData</code> interface. Then the reader passes the
 * <code>RowSetMetaData</code> object to the rowset.
 * <P>
...
public interface RowSetMetaData extends ResultSetMetaData {
	 ...
	 *
	 * @param columnCount
	 *            the number of columns in the <code>RowSet</code> object
	...
	/**
	 * Sets whether the designated column is automatically numbered, The default
	 * is for a <code>RowSet</code> object's columns not to be automatically
	 * numbered.
	 *
	 * @param columnIndex
	...
	/**
	 * Sets whether the designated column is a cash value. The default is
	 * <code>false</code>.
	 *
	 * @param columnIndex
	 *            the first column is 1, the second is 2, ...
	 ...
	 *            the first column is 1, the second is 2, ...
	 * @param size
	 *            the normal maximum number of characters for the designated
	 *            column
	 *
	 * @exception SQLException
	 *                if a database access error occurs
	...
	/**
	 * Sets the suggested column title for use in printouts and displays, if
