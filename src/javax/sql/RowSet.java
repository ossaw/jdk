...
/**
 * The interface that adds support to the JDBC API for the JavaBeans&trade;
 * component model. A rowset, which can be used as a JavaBeans component in a
 * visual Bean development environment, can be created and configured at design
 ...
 * data source and read some data from the data source. A group of setter
 * methods (<code>setInt</code>, <code>setBytes</code>, <code>setString</code>,
 * and so on) provide a way to pass input parameters to a rowset's command
 * property. This command is the SQL query the rowset uses when it gets its data
 ...
 * called a <i>connected</i> rowset. A rowset may also make a connection with a
 * data source, get data from it, and then close the connection. Such a rowset
 ...
 * and a writer (a <code>RowSetWriter</code> object) associated with it. The
 * reader may be implemented in many different ways to populate a rowset with
 * data, including getting data from a non-relational data source. The writer
 * can also be implemented in many different ways to propagate changes made to
...
public interface RowSet extends ResultSet {
	 ...
	 * create a connection if it uses the <code>DriverManager</code> instead of
	 * a <code>DataSource</code> object to establish the connection. The default
	 ...
	 * name is used to create a connection, whichever was set to non null value
	 * most recently.
	 *
	 * @param url
	 ...
	 * map for this <code>RowSet</code> object. This type map will be used
	 ...
	 * column values. This limit applies only to <code>BINARY</code>,
	 * <code>VARBINARY</code>, <code>LONGVARBINARYBINARY</code>,
	 * <code>CHAR</code>, <code>VARCHAR</code>, <code>LONGVARCHAR</code>,
	 * <code>NCHAR</code> and <code>NVARCHAR</code> columns. If the limit is
	 ...
	 * to the given number of bytes. This limit applies only to
	 * <code>BINARY</code>, <code>VARBINARY</code>,
	 * <code>LONGVARBINARYBINARY</code>, <code>CHAR</code>, <code>VARCHAR</code>
	 * , <code>LONGVARCHAR</code>, <code>NCHAR</code> and <code>NVARCHAR</code>
	 ...
	 * statement to execute. If this limit is exceeded, an
	 ...
	 * the given number of seconds. If this limit is exceeded, an
	 * <code>SQLException</code> is thrown.
	 *
	 * @param seconds
	 *            the new query timeout limit in seconds; zero means that there
	 *            is no limit
	 * @exception SQLException
	 *                if a database access error occurs
	 * @see #getQueryTimeout
	 ...
	 *
	 * @param type
	 *            one of the <code>ResultSet</code> constants specifying a type:
	...
	/**
	 * The <code>RowSet</code> setter methods are used to set any input
	 * parameters needed by the <code>RowSet</code> object's command. Parameters
	 * are set at run time, as opposed to design time.
	 */
	 ...
	 * @param sqlType
	 *            a SQL type code defined by <code>java.sql.Types</code>
	 * @exception SQLException
	 *                if a database access error occurs
	 */
	...
	/**
	 * Sets the designated parameter in this <code>RowSet</code> object's SQL
	 * command to SQL <code>NULL</code>. This version of the method
	 * <code>setNull</code> should be used for SQL user-defined types (UDTs) and
	 ...
	 * <code>REF</code> parameter. In the case of a UDT, the name is the type
	 ...
	 * @param typeName
	 *            the fully qualified name of an SQL UDT or the type name of the
	 *            SQL structured type being referenced by a <code>REF</code>
	 ...
	 * command to the given Java <code>boolean</code> value. The driver converts
	...
	/**
	 * Sets the designated parameter in this <code>RowSet</code> object's
	 * command to the given Java <code>byte</code> value. The driver converts
	 * this to an SQL <code>TINYINT</code> value before sending it to the
	 * database.
	 *
	 * @param parameterIndex
	 *            the first parameter is 1, the second is 2, ...
	...
	/**
	 * Sets the designated parameter in this <code>RowSet</code> object's
	 * command to the given Java <code>short</code> value. The driver converts
	 * this to an SQL <code>SMALLINT</code> value before sending it to the
	 * database.
	 *
	 * @param parameterIndex
	 *            the first parameter is 1, the second is 2, ...
	 ...
	 * this to an SQL <code>INTEGER</code> value before sending it to the
	 * database.
	 *
	 * @param parameterIndex
	 *            the first parameter is 1, the second is 2, ...
	 ...
	 * this to an SQL <code>BIGINT</code> value before sending it to the
	 * database.
	 *
	 * @param parameterIndex
	 *            the first parameter is 1, the second is 2, ...
	 ...
	 * this to an SQL <code>DOUBLE</code> value before sending it to the
	 * database.
	 *
	 * @param parameterIndex
	 *            the first parameter is 1, the second is 2, ...
	...
	/**
	 * Sets the designated parameter in this <code>RowSet</code> object's
	 * command to the given <code>java.math.BigDeciaml</code> value. The driver
	 * converts this to an SQL <code>NUMERIC</code> value before sending it to
	 * the database.
	 *
	 * @param parameterIndex
	 *            the first parameter is 1, the second is 2, ...
	 ...
	 * the database, the driver converts this to an SQL <code>VARCHAR</code> or
	...
	/**
	 * Sets the designated parameter in this <code>RowSet</code> object's
	 * command to the given Java array of <code>byte</code> values. Before
	 * sending it to the database, the driver converts this to an SQL
	 * <code>VARBINARY</code> or <code>LONGVARBINARY</code> value, depending on
	 ...
	 * converts this to an SQL <code>DATE</code> value before sending it to the
	 * database, using the default <code>java.util.Calendar</code> to calculate
	 * the date.
	 *
	 * @param parameterIndex
	 *            the first parameter is 1, the second is 2, ...
	 ...
	 * converts this to an SQL <code>TIME</code> value before sending it to the
	 * database, using the default <code>java.util.Calendar</code> to calculate
	 * it.
	 *
	 * @param parameterIndex
	 ...
	 * converts this to an SQL <code>TIMESTAMP</code> value before sending it to
	 * the database, using the default <code>java.util.Calendar</code> to
	 * calculate it.
	 *
	 * @param parameterIndex
	 *            the first parameter is 1, the second is 2, ...
	...
	/**
	 * Sets the designated parameter in this <code>RowSet</code> object's
	 * command to the given <code>java.io.Reader</code> value. It may be more
	 * practical to send a very large UNICODE value via a
	 ...
	 * object is of a class implementing <code>Ref</code>, <code>Blob</code>,
	 ...
	 *            sent to the database. The scale argument may further qualify
	 *            this type.
	 * @param scaleOrLength
	...
	/**
	 * Sets the designated parameter in this <code>RowSet</code> object's
	 * command with the given <code>Ref</code> value. The driver will convert
	 ...
	 * this to the <code>BLOB</code> value that the <code>Blob</code> object
	 ...
	 * this to the <code>CLOB</code> value that the <code>Clob</code> object
	 * represents before sending it to the database.
	 *
	 * @param i
	 *            the first parameter is 1, the second is 2, ...
	...
	/**
	 * Sets the designated parameter in this <code>RowSet</code> object's
	 * command with the given <code>Array</code> value. The driver will convert
	 * this to the <code>ARRAY</code> value that the <code>Array</code> object
	 * represents before sending it to the database.
	 *
	 * @param i
	 *            the first parameter is 1, the second is 2, ...
	...
	/**
	 * Sets the designated parameter in this <code>RowSet</code> object's
	 * command with the given <code>java.sql.Date</code> value. The driver will
	 * convert this to an SQL <code>DATE</code> value, using the given
	 ...
	 *            the parameter value
	 * @param cal
	 *            the <code>java.util.Calendar</code> object to use for
	...
	/**
	 * Sets the designated parameter in this <code>RowSet</code> object's
	 * command with the given <code>java.sql.Time</code> value. The driver will
	 * convert this to an SQL <code>TIME</code> value, using the given
	 * <code>java.util.Calendar</code> object to calculate it, before sending it
	 * to the database.
	 *
	 * @param parameterIndex
	 *            the first parameter is 1, the second is 2, ...
	...
	/**
	 * Sets the designated parameter in this <code>RowSet</code> object's
	 * command with the given <code>java.sql.Timestamp</code> value. The driver
	 * will convert this to an SQL <code>TIMESTAMP</code> value, using the given
	 * <code>java.util.Calendar</code> object to calculate it, before sending it
	 * to the database.
	 *
	 * @param parameterIndex
	 ...
	 * connection with its source of data, it may use a reader (a
	 ...
	 *
	 * @exception SQLException
	 *                if a database access error occurs or any of the properties
	 *                necessary for making a connection and creating a statement
	 *                have not been set
	 */
	 ...
	 *            <code>RowSetListener</code> interface and wants to be notified
