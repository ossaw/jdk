 ...
 * connection-related event. <code>ConnectionEvent</code> objects are generated
 * when an application closes a pooled connection and when an error occurs. The
 * <code>ConnectionEvent</code> object contains two kinds of information:
 * <UL>
 * <LI>The pooled connection closed by the application
 * <LI>In the case of an error event, the <code>SQLException</code> about to be
