 ...
 * {@code DriverManager} facility, a {@code DataSource} object is the preferred
 * means of getting a connection. An object that implements the
 * {@code DataSource} interface will typically be registered with a naming
 * service based on the Java&trade; Naming and Directory (JNDI) API.
 * <P>
 * The {@code DataSource} interface is implemented by a driver vendor. There are
 * three types of implementations:
 * <OL>
 * <LI>Basic implementation -- produces a standard {@code Connection} object
 * <LI>Connection pooling implementation -- produces a {@code Connection} object
 * that will automatically participate in connection pooling. This
 * implementation works with a middle-tier connection pooling manager.
 * <LI>Distributed transaction implementation -- produces a {@code Connection}
 ...
 * </OL>
 * <P>
 * A {@code DataSource} object has properties that can be modified when
 ...
 * <P>
 * A driver that is accessed via a {@code DataSource} object does not register
 * itself with the {@code DriverManager}. Rather, a {@code DataSource} object is
 * retrieved though a lookup operation and then used to create a
 * {@code Connection} object. With a basic implementation, the connection
 * obtained through a {@code DataSource} object is identical to a connection
 * obtained through the {@code DriverManager} facility.
 * <p>
