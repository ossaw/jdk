...
/**
 * A visitor of types based on their {@linkplain TypeKind kind} with default
 * behavior appropriate for the {@link SourceVersion#RELEASE_7 RELEASE_7} source
 * version. For {@linkplain TypeMirror types} <tt><i>XYZ</i></tt> that may have
 * more than one kind, the <tt>visit<i>XYZ</i></tt> methods in this class
 * delegate to the <tt>visit<i>XYZKind</i></tt> method corresponding to the
 * first argument's kind. The <tt>visit<i>XYZKind</i></tt> methods call
 ...
 * unknown, language structures added to future versions of the Java&trade;
 ...
 * type kind visitor class will also be introduced to correspond to the new
