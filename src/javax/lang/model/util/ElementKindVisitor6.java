...
/**
 * A visitor of program elements based on their {@linkplain ElementKind kind}
 * with default behavior appropriate for the {@link SourceVersion#RELEASE_6
 * RELEASE_6} source version. For {@linkplain Element elements}
 * <tt><i>XYZ</i></tt> that may have more than one kind, the
 * <tt>visit<i>XYZ</i></tt> methods in this class delegate to the
 * <tt>visit<i>XYZKind</i></tt> method corresponding to the first argument's
 ...
 * used in this case may have constants added to it in the future to accommodate
 ...
 * abstract element kind visitor class will also be introduced to correspond to
 ...
 * method</em> directly in the visitor interface since a Java SE 8 language
 * feature cannot be used to this version of the API since this version is
 * required to be runnable on Java SE 7 implementations. Future versions of the
 * API that are only required to run on Java SE 8 and later may take advantage
...
public class ElementKindVisitor6<R, P> extends SimpleElementVisitor6<R, P> {
     ...
     * {@linkplain ElementKind kind} of type, {@code
    ...
    /**
     * Visits a variable element, dispatching to the visit method for the
     * specific {@linkplain ElementKind kind} of variable, {@code
    ...
    /**
     * Visits an executable element, dispatching to the visit method for the
     * specific {@linkplain ElementKind kind} of executable, {@code CONSTRUCTOR}
