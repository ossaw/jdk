...
public interface Elements {
	 ...
	 * "{@code /**}" , ends with a separate "<code>*&#47;</code>", and
	 * immediately precedes the element, ignoring white space. Therefore, a
	 * documentation comment contains at least three"{@code *}" characters. The
	 * text returned for the documentation comment is a processed form of the
	 * comment as it appears in source code. The leading "{@code
	 * /**}" and trailing "<code>*&#47;</code>" are removed. For lines of the
	 * comment starting after the initial "{@code /**}", leading white space
	 * characters are discarded as are any consecutive "{@code *}" characters
	 * appearing after the white space or starting the line. The processed lines
	...
	/**
	 * Returns all annotations <i>present</i> on an element, whether directly
	 ...
	 * represents {@code
	 * Object.hashCode}. We can then ask whether {@code m1} overrides {@code m2}
	 * within the class {@code String} (it does):
	 *
