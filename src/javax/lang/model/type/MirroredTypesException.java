...
public class MirroredTypesException extends RuntimeException {
    ...
    /**
     * Returns the type mirrors corresponding to the types being accessed. The
     * type mirrors may be unavailable if this exception has been serialized and
     * then read back in.
     *
     * @return the type mirrors in construction order, or {@code null} if
     *         unavailable
     */
