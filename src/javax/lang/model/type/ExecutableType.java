...
/**
 * Represents the type of an executable. An <i>executable</i> is a method,
...
public interface ExecutableType extends TypeMirror {
	 ...
	 * executable.
	 *
	 * @return the type variables declared by the formal type parameters, or an
	 ...
	 *
	 * @return the types of this executable's formal parameters, or an empty
	 ...
	 * {@code throws} clause.
	 *
	 * @return the exceptions and other throwables listed in this executable's
