...
public enum SourceVersion {
	/*
	 * Summary of language evolution 1.1: nested classes 1.2: strictfp 1.3: no
	 * changes 1.4: assert 1.5: annotations, generics, autoboxing, var-args...
	 * 1.6: no changes 1.7: diamond syntax, try-with-resources, etc. 1.8: lambda
	...
	/**
	 * Returns the latest source version fully supported by the current
	 * execution environment. {@code RELEASE_5} or later must be returned.
	 *
	...
	/**
	 * Returns whether or not {@code name} is a syntactically valid identifier
	 * (simple name) or keyword in the latest source version. The method returns
	 * {@code true} if the name consists of an initial character for which
	 * {@link Character#isJavaIdentifierStart(int)} returns {@code true},
	 * followed only by characters for which
	 * {@link Character#isJavaIdentifierPart(int)} returns {@code true}. This
	 * pattern matches regular identifiers, keywords, and the literals
	 * {@code "true"}, {@code "false"}, and {@code "null"}. The method returns
	...
	/**
	 * Returns whether or not {@code name} is a syntactically valid qualified
	 * name in the latest source version. Unlike {@link #isIdentifier
	 * isIdentifier}, this method returns {@code false} for keywords and
	 * literals.
	 *
	 * @param name
	 *            the string to check
	...
	/**
	 * Returns whether or not {@code s} is a keyword or literal in the latest
	 * source version.
	 *
	 * @param s
	 *            the string to check
