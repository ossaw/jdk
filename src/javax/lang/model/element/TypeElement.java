 ...
 * interface <i>type</i>, the latter being a use (or <i>invocation</i>) of the
 * former. The distinction is most apparent with generic types, for which a
 * single element can define a whole family of types. For example, the element
 ...
 * information. For example, if the underlying source of information is Java
 * source code, then the elements will be returned in source code order.
 *
...
public interface TypeElement extends Element, Parameterizable,
     ...
     * the ordering behavior required of this interface, the list of enclosed
     * elements will be returned in the natural order for the originating source
     * of information about the type. For example, if the information about the
     * type is originating from a source file, the elements will be returned in
     * source code order. (However, in that case the the ordering of synthesized
     ...
     * {@code java.util.Set<E>} is "{@code java.util.Set}". Nested types use
     ...
     * represents an interface or the class {@code java.lang.Object}, then a
     * {@link NoType} with kind {@link TypeKind#NONE NONE} is returned.
     *
     ...
     *
     * @return the interface types directly implemented by this class or
     *         extended by this interface, or an empty list if there are none
     */
    List<? extends TypeMirror> getInterfaces();

    /**
     * Returns the formal type parameters of this type element in declaration
     * order.
     *
    ...
    /**
     * Returns the package of a top-level type and returns the immediately
     * lexically enclosing element for a {@linkplain NestingKind#isNested
     * nested} type.
     *
     * @return the package of a top-level type, the immediately lexically
     *         enclosing element for a nested type
     */
    @Override
