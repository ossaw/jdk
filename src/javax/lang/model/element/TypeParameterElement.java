 ...
 * constructor element. A type parameter declares a {@link TypeVariable}.
 *
...
public interface TypeParameterElement extends Element {
	 ...
	 * the {@code extends} clause used to declare this type parameter. If no
	 * explicit {@code extends} clause was used, then {@code java.lang.Object}
	 * is considered to be the sole bound.
	 *
	 * @return the bounds of this type parameter, or an empty list if there are
	 *         none
	 */
	List<? extends TypeMirror> getBounds();

	/**
	 * Returns the {@linkplain TypeParameterElement#getGenericElement generic
	 * element} of this type parameter.
	 *
