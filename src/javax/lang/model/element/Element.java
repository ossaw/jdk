 ...
 * result of the {@link #getKind} method. Using {@code
 * instanceof} is <em>not</em> necessarily a reliable idiom for determining the
...
public interface Element extends javax.lang.model.AnnotatedConstruct {
	 ...
	 * element's invocation on the type variables corresponding to its own
	 * formal type parameters. For example, for the generic class element
	 * {@code C<N extends Number>}, the parameterized type {@code C<N>} is
	 * returned. The {@link Types} utility interface has more general methods
	 ...
	 * of unrelated types. Element objects created by different implementations
	 * of these interfaces should <i>not</i> be expected to be equal even if
	 * &quot;the same&quot; element is being modeled; this is analogous to the
	 * inequality of {@code Class} objects for the same class file loaded
