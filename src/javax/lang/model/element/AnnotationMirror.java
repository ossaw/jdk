...
public interface AnnotationMirror {
    ...
    /**
     * Returns the values of this annotation's elements. This is returned in the
     * form of a map that associates elements with their corresponding values.
     * Only those elements with values explicitly present in the annotation are
     ...
     *
     * @return the values of this annotation's elements, or an empty map if
     *         there are none
     */
