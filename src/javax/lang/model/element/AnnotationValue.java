 ...
 * following types:
 * <ul>
 * <li>a wrapper class (such as {@link Integer}) for a primitive type
 * <li>{@code String}
 * <li>{@code TypeMirror}
 * <li>{@code VariableElement} (representing an enum constant)
 * <li>{@code AnnotationMirror}
 * <li>{@code List<? extends AnnotationValue>} (representing the elements, in
 * declared order, if the value is an array)
 * </ul>
 *
