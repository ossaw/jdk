...
public interface ExecutableElement extends Element, Parameterizable {
    /**
     * Returns the formal type parameters of this executable in declaration
     * order.
     *
    ...
    /**
     * Returns the return type of this executable. Returns a {@link NoType} with
     * kind {@link TypeKind#VOID VOID} if this executable is not a method, or is
     ...
     * constructor's {@code throws} clause in declaration order.
     *
     * @return the exceptions and other throwables listed in the {@code throws}
     *         clause, or an empty list if there are none
     */
    List<? extends TypeMirror> getThrownTypes();

    /**
     * Returns the default value if this executable is an annotation type
     * element. Returns {@code null} if this method is not an annotation type
     ...
     * constructor, the name {@code "<init>"} is returned, for a static
     * initializer, the name {@code "<clinit>"} is returned, and for an
     * anonymous class or instance initializer, an empty name is returned.
     *
