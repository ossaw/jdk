...
/**
 * Represents a field, {@code enum} constant, method or constructor parameter,
...
public interface VariableElement extends Element {
	...
	/**
	 * Returns the value of this variable if this is a {@code final} field
	 * initialized to a compile-time constant. Returns {@code
	 ...
	 * compile-time constants. To have a constant value, a field's type must be
	 * either a primitive type or {@code String}.
	 *
	 ...
	 * If the original source names are not available, an implementation may
