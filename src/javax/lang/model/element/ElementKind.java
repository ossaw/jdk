 ...
 * versions of the Java&trade; programming language.
 *
...
public enum ElementKind {
    ...
    /**
     * An implementation-reserved element. This is not the element you are
     * looking for.
     */
    OTHER,
    ...
    /**
     * Returns {@code true} if this is a kind of class: either {@code CLASS} or
     * {@code ENUM}.
     *
    ...
    /**
     * Returns {@code true} if this is a kind of interface: either
     * {@code INTERFACE} or {@code ANNOTATION_TYPE}.
     *
    ...
    /**
     * Returns {@code true} if this is a kind of field: either {@code FIELD} or
     * {@code ENUM_CONSTANT}.
     *
