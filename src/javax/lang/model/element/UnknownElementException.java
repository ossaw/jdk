 ...
 * the language evolves and new kinds of elements are added to the
 * {@code Element} hierarchy. May be thrown by an {@linkplain ElementVisitor
 * element visitor} to indicate that the visitor was created for a prior version
 * of the language.
 *
