 ...
 * objects implementing this interface must obey the general
 * {@linkplain Object#equals equals contract} when compared with each other.
 ...
 * processing}, the guarantees for "the same" implementation must include
 * contexts where the {@linkplain javax.annotation.processing API mediated} side
 * effects of {@linkplain javax.annotation.processing.Processor processors}
 * could be visible to each other, including successive annotation processing
