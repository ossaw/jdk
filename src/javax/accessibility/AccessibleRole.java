...
public class AccessibleRole extends AccessibleBundle {
	 ...
	 * accessibleDescription property of the tool tip is often displayed to the
	 * user in a small "help bubble" when the user causes the mouse to hover
	 * over the object associated with the tool tip.
	 */
	...
	/**
	 * Creates a new AccessibleRole using the given locale independent key. This
	 * should not be a public method. Instead, it is used to create the
	 * constants in this file to make it a strongly typed enumeration.
	 * Subclasses of this class should enforce similar policy.
	 * <p>
	 * The key String should be a locale independent key for the role. It is not
	 * intended to be used as the actual String to display to the user. To get
