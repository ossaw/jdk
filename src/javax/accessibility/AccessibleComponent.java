...
public interface AccessibleComponent {
	 ...
	 * have the AccessibleState.ENABLED state set in their AccessibleStateSets.
	 *
	 ...
	 * isShowing().
	 * <p>
	 * Objects that are visible will also have the AccessibleState.VISIBLE state
	 ...
	 * visibility of the object and its ancestors. Note: this will return true
	 * even if the object is obscured by another (for example, it is underneath
	 * a menu that was pulled down).
	 *
	 ...
	 *
	 * @return the location of the object on screen; null if this object is not
	 *         on the screen
	 * @see #getBounds
	 * @see #getLocation
	 */
	 ...
	 * bounds specify this object's width, height, and location relative to its
	 * parent.
	 *
	...
	/**
	 * Returns the size of this object in the form of a Dimension object. The
	 * height field of the Dimension object contains this object's height, and
	 * the width field of the Dimension object contains this object's width.
	 *
	 ...
	 * accept focus will also have the AccessibleState.FOCUSABLE state set in
	 * their AccessibleStateSets.
	 *
