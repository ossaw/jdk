...
public class AccessibleRelation extends AccessibleBundle {
     ...
     * be one-to-one or one-to-many. For example, in the case of a LABEL_FOR
     * relation, the target vector would contain a list of objects labeled by
     * the object that implements this AccessibleRelation. In the case of a
     * MEMBER_OF relation, the target vector would contain all of the components
     * that are members of the same group as the object that implements this
     * AccessibleRelation.
     */
    ...
    /**
     * Indicates the SUBWINDOW_OF relation between two or more objects has
     * changed.
     *
     * @since 1.5
     */
    ...
    /**
     * Indicates the PARENT_WINDOW_OF relation between two or more objects has
     * changed.
     *
     * @since 1.5
     */
    ...
    /**
     * Indicates the EMBEDDED_BY relation between two or more objects has
     * changed.
     *
     * @since 1.5
     */
    ...
    /**
     * Indicates the CHILD_NODE_OF relation between two or more objects has
     * changed.
     *
     * @since 1.5
     */
     ...
     * The key String should be a locale independent key for the relation. It is
     * not intended to be used as the actual String to display to the user. To
