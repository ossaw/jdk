...
public interface Accessible {
	 ...
	 * the return value should not be null if the object implements interface
	 * Accessible. If a component developer creates a subclass of an object that
	 * implements Accessible, and that subclass is not Accessible, the developer
	 * should override the getAccessibleContext method to return null.
	 * 
