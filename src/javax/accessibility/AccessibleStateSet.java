...
public class AccessibleStateSet {
     ...
     * the return value is false. Otherwise, the state is added to the state set
     ...
     * set, the state set will be unchanged and the return value will be false.
     * If the state is in the state set, it will be removed from the set and the
