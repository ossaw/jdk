...
public class AccessibleState extends AccessibleBundle {
	 ...
	 * add a PropertyChange listener to an object with transient state, as that
	 * object will never generate any events. Transient objects are typically
	 * created to answer Java Accessibility method queries, but otherwise do not
	 * remain linked to the underlying object (for example, those objects
	 * underneath lists, tables, and trees in Swing, where only one actual UI
	 * Component does shared rendering duty for all of the data objects
	 * underneath the actual list/table/tree elements).
	 *
	 * @since 1.5
	 *
	 */
	 ...
	 * This should not be a public method. Instead, it is used to create the
	 * constants in this file to make it a strongly typed enumeration.
	 * Subclasses of this class should enforce similar policy.
	 * <p>
	 * The key String should be a locale independent key for the state. It is
