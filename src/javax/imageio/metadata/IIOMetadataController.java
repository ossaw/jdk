 ...
 * an <code>IIOMetadata</code> object, either by putting up a GUI to obtain
 * values from a user, or by other means. This interface merely specifies a
 * generic <code>activate</code> method that invokes the controller, without
 ...
 * XML DOM tree or a plug-in specific interface, modifies values by whatever
 * means, then modifies the <code>IIOMetadata</code> object's settings, using
 * either the <code>setFromTree</code> or <code>mergeTree</code> methods, or a
 ...
 * call methods on <code>IIOMetadata</code> to set its state, and return
 * <code>true</code>.
 *
