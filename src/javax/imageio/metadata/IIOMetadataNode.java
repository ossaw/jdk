...
class IIOAttr extends IIOMetadataNode implements Attr {
    ...
    /**
     * This method is new in the DOM L3 for Attr interface. Could throw
     * DOMException here, but its probably OK to always return false. One reason
     * for this, is we have no good way to document this exception, since this
     * class, IIOAttr, is not a public class. The rest of the methods that throw
 ...
 * <a href="../../../../api/org/w3c/dom/Element.html">
 * <code>org.w3c.dom.Element</code></a> interface and additionally allows for
 * the storage of non-textual objects via the <code>getUserObject</code> and
 * <code>setUserObject</code> methods.
 * <p>
 * This class is not intended to be used for general XML processing. In
 * particular, <code>Element</code> nodes created within the Image I/O API are
 * not compatible with those created by Sun's standard implementation of the
 * <code>org.w3.dom</code> API. In particular, the implementation is tuned for
 * simple uses and may not perform well for intensive processing.
 * <p>
 * Namespaces are ignored in this implementation. The terms "tag name" and "node
 * name" are always considered to be synonymous.
 * <em>Note:</em> The DOM Level 3 specification added a number of new methods to
 * the {@code Node}, {@code Element} and {@code Attr} interfaces that are not of
 * value to the {@code IIOMetadataNode} implementation or specification.
...
public class IIOMetadataNode implements Element, NodeList {
    ...
    /**
     * The value of the node as a <code>String</code>. The Image I/O API
     * typically does not make use of the node value.
     */
    ...
    /**
     * The parent node of this node, or <code>null</code> if this node forms the
    ...
    /**
     * The first (leftmost) child node of this node, or <code>null</code> if
     * this node is a leaf node.
     */
    private IIOMetadataNode firstChild = null;

    /**
     * The last (rightmost) child node of this node, or <code>null</code> if
     * this node is a leaf node.
     */
    private IIOMetadataNode lastChild = null;

    /**
     * The next (right) sibling node of this node, or <code>null</code> if this
     * node is its parent's last child node.
     */
    private IIOMetadataNode nextSibling = null;

    /**
     * The previous (left) sibling node of this node, or <code>null</code> if
     * this node is its parent's first child node.
     */
    ...
    /**
     * Returns the parent of this node. A <code>null</code> value indicates that
     * the node is the root of its own tree. To add a node to an existing tree,
     * use one of the <code>insertBefore</code>, <code>replaceChild</code>, or
     ...
     * If there are no children, this is a <code>NodeList</code> containing no
     * nodes.
     *
    ...
    /**
     * Returns the first child of this node, or <code>null</code> if the node
     * has no children.
     *
     * @return the first child, as a <code>Node</code>, or <code>null</code>
     */
    ...
    /**
     * Returns the last child of this node, or <code>null</code> if the node has
     * no children.
     *
     * @return the last child, as a <code>Node</code>, or <code>null</code>.
     */
    ...
    /**
     * Returns the previous sibling of this node, or <code>null</code> if this
    ...
    /**
     * Returns the next sibling of this node, or <code>null</code> if the node
     * has no next sibling.
     *
     * @return the next sibling, as a <code>Node</code>, or <code>null</code>.
     */
    ...
    /**
     * Returns a <code>NamedNodeMap</code> containing the attributes of this
     * node.
     *
     * @return a <code>NamedNodeMap</code> containing the attributes of this
     *         node.
     */
    ...
    /**
     * Returns <code>null</code>, since <code>IIOMetadataNode</code>s do not
     * belong to any <code>Document</code>.
     *
     ...
     * <code>getParentNode</code> returns <code>null</code>). If a shallow clone
     * is being performed (<code>deep</code> is <code>false</code>), the new
     * node will not have any children or siblings. If a deep clone is being
    ...
    public Node cloneNode(boolean deep) {
        ...
        if (deep) {
            for (IIOMetadataNode child = firstChild; child != null; child = child.nextSibling) {
    ...
    public void setAttribute(String name, String value) {
        ...
        if (!valid) {
            throw new IIODOMException(DOMException.INVALID_CHARACTER_ERR, "Attribute name is illegal!");
        }
