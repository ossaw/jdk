...
/**
 * A node in a directed graph. In addition to an arbitrary <code>Object</code>
 * containing user data associated with the node, each node maintains a
...
class DigraphNode implements Cloneable, Serializable {
	...
	/**
	 * Returns an <code>Iterator</code> containing the nodes pointed to by this
	 * node.
	 */
	...
	/**
	 * Adds a directed edge to the graph. The outNodes list of this node is
	...
	/**
	 * Returns <code>true</code> if an edge exists between this node and the
	 * given node.
	 *
	 * @param node
	 *             a <code>DigraphNode</code>.
	...
	/**
	 * Removes a directed edge from the graph. The outNodes list of this node is
	 * updated and the in-degree of the other node is decremented.
	 *
	 * @return <code>true</code> if the node was previously the target of an
	 *         edge.
	 */
