...
/**
 * A superinterface for functionality common to all Image I/O service provider
 * interfaces (SPIs). For more information on service provider classes, see the
 * class comment for the <code>IIORegistry</code> class.
 *
 * @see IIORegistry
...
public abstract class IIOServiceProvider implements RegisterableService {
    ...
    /**
     * A <code>String</code> to be returned from <code>getVendorName</code>,
    ...
    /**
     * A <code>String</code> to be returned from <code>getVersion</code>,
     * initially null. Constructors should set this to a non-<code>null</code>
     * value.
     */
    protected String version;

    /**
     * Constructs an <code>IIOServiceProvider</code> with a given vendor name
    ...
    /**
     * Constructs a blank <code>IIOServiceProvider</code>. It is up to the
     * subclass to initialize instance variables and/or override method
     * implementations in order to ensure that the <code>getVendorName</code>
     ...
     * instantiated and registered in a <code>ServiceRegistry</code>. This may
     * be used to verify that the environment is suitable for this service, for
     ...
     *
     * @return a non-<code>null</code> <code>String</code> containing the name
     *         of the vendor.
     */
    ...
    /**
     * Returns a string describing the version number of this service provider
     ...
     *         version of this service provider.
     */
     ...
     * its associated implementation. The resulting string should be localized
