...
/**
 * The service provider interface (SPI) for <code>ImageTranscoder</code>s. For
 * more information on service provider classes, see the class comment for the
...
public abstract class ImageTranscoderSpi extends IIOServiceProvider {
	...
	/**
	 * Constructs a blank <code>ImageTranscoderSpi</code>. It is up to the
	...
	/**
	 * Returns the fully qualified class name of an <code>ImageReaderSpi</code>
	 * class that generates <code>IIOMetadata</code> objects that may be used as
	...
	/**
	 * Returns the fully qualified class name of an <code>ImageWriterSpi</code>
	 * class that generates <code>IIOMetadata</code> objects that may be used as
	 * input to this transcoder.
	 *
	 * @return a <code>String</code> containing the fully-qualified class name
	...
	/**
	 * Returns an instance of the <code>ImageTranscoder</code> implementation
