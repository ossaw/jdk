...
public class FileCacheImageOutputStream extends ImageOutputStreamImpl {
	...
	/**
	 * The CloseAction that closes the stream in the StreamCloser's shutdown
	 * hook
	 */
	 ...
	 * it is <code>null</code>, the system-dependent default temporary-file
	 ...
	 * legal to seek past the end of the file; an <code>EOFException</code> will
	 * be thrown only if a read is performed. The file length will not be
	...
	/**
	 * Closes this <code>FileCacheImageOutputStream</code>. All pending data is
	 * flushed to the output, and the cache file is closed and removed. The
