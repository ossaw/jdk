...
public class IIOByteBuffer {
    ...
    /**
     * Constructs an <code>IIOByteBuffer</code> that references a given byte
    ...
    /**
     * Returns a reference to the byte array. The returned value should be
     * treated as read-only, and only the portion specified by the values of
    ...
    /**
     * Updates the array reference that will be returned by subsequent calls to
    ...
    /**
     * Returns the offset within the byte array returned by <code>getData</code>
    ...
    /**
     * Returns the length of the data of interest within the byte array returned
