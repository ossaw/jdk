 ...
 * a regular <code>OutputStream</code>. A memory buffer is used to cache at
 * least the data between the discard position and the current write position.
 * The only constructor takes an <code>OutputStream</code>, so this class may
...
public class MemoryCacheImageOutputStream extends ImageOutputStreamImpl {
	...
	/**
	 * Constructs a <code>MemoryCacheImageOutputStream</code> that will write to
	...
	/**
	 * Returns <code>false</code> since this <code>ImageOutputStream</code> does
	...
	/**
	 * Closes this <code>MemoryCacheImageOutputStream</code>. All pending data
	 * is flushed to the output, and the cache is released. The destination
	 * <code>OutputStream</code> is not closed.
	 */
