...
/**
 * A class encapsulating a single JPEG Huffman table. Fields are provided for
 * the "standard" tables taken from Annex K of the JPEG specification. These are
 * the tables used as defaults.
 * <p>
...
public class JPEGHuffmanTable {
    ...
    /*
     * The data for the publically defined tables, as specified in ITU T.81 JPEG
     * specification section K3.3 and used in the IJG library.
     */
    private static final short[] StdDCLuminanceLengths = { 0x00, 0x01, 0x05, 0x01, 0x01, 0x01, 0x01, 0x01,
            0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, };

    private static final short[] StdDCLuminanceValues = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
            0x08, 0x09, 0x0a, 0x0b, };

    private static final short[] StdDCChrominanceLengths = { 0x00, 0x03, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
            0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, };

    private static final short[] StdDCChrominanceValues = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
            0x08, 0x09, 0x0a, 0x0b, };

    private static final short[] StdACLuminanceLengths = { 0x00, 0x02, 0x01, 0x03, 0x03, 0x02, 0x04, 0x03,
            0x05, 0x05, 0x04, 0x04, 0x00, 0x00, 0x01, 0x7d, };

    private static final short[] StdACLuminanceValues = { 0x01, 0x02, 0x03, 0x00, 0x04, 0x11, 0x05, 0x12,
    ...
    private static final short[] StdACChrominanceLengths = { 0x00, 0x02, 0x01, 0x02, 0x04, 0x04, 0x03, 0x04,
            0x07, 0x05, 0x04, 0x04, 0x00, 0x01, 0x02, 0x77, };

    private static final short[] StdACChrominanceValues = { 0x00, 0x01, 0x02, 0x03, 0x11, 0x04, 0x05, 0x21,
     ...
     */
    public static final JPEGHuffmanTable StdDCLuminance = new JPEGHuffmanTable(StdDCLuminanceLengths,
            StdDCLuminanceValues, false);

    /**
     * The standard DC chrominance Huffman table.
     */
    public static final JPEGHuffmanTable StdDCChrominance = new JPEGHuffmanTable(StdDCChrominanceLengths,
            StdDCChrominanceValues, false);

    /**
     * The standard AC luminance Huffman table.
     */
    public static final JPEGHuffmanTable StdACLuminance = new JPEGHuffmanTable(StdACLuminanceLengths,
            StdACLuminanceValues, false);

    /**
     * The standard AC chrominance Huffman table.
     */
    public static final JPEGHuffmanTable StdACChrominance = new JPEGHuffmanTable(StdACChrominanceLengths,
     ...
     *
     * @param lengths
     *        an array of {@code short}s where <code>lengths[k]</code>
     *        is
     ...
     *         if <code>lengths</code> or
     *         <code>values</code> are null, the
     *         length of <code>lengths</code> is
     *         greater than 16, the length
     *         of <code>values</code> is greater than
     *         256, if any value in
     *         <code>lengths</code> or
     *         <code>values</code> is less than
     *         zero, or if the arrays do not describe a
     *         valid Huffman table.
     */
    public JPEGHuffmanTable(short[] lengths, short[] values) {
        if (lengths == null || values == null || lengths.length == 0 || values.length == 0
     ...
     *
     * @return a <code>short</code> array where <code>array[k-1]</code> is equal
     *         to the number of values in the table of length <code>k</code>.
     * @see #getValues
     */
    ...
    /**
     * Returns an array of <code>short</code>s containing the values arranged by
     * increasing length of their corresponding codes. The interpretation of the
     * array is dependent on the values returned from <code>getLengths</code>.
