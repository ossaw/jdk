...
public final class ImageIO {
	 ...
	 * than re-scanning the classpath on every invocation of the API, the class
	 * path is scanned automatically only on the first invocation. Clients can
	 ...
	 * <code>META-INF/services/javax.imageio.spi.</code><i>classname</i>, where
	 * <i>classname</i> is one of <code>ImageReaderSpi</code>,
	...
	/**
	 * A class to hold information about caching. Each <code>ThreadGroup</code>
	 * will have its own copy via the <code>AppContext</code> mechanism.
	 */
	...
	/**
	 * Determines whether the caller has write access to the cache directory,
	 * stores the result in the <code>CacheInfo</code> object, and returns the
	 * decision. This method helps to prevent mysterious SecurityExceptions to
	 * be thrown when this convenience class is used in an applet, for example.
	 */
	 ...
	 * underlying stream does not allow data to be re-read. Similarly, when
	...
	/**
	 * Sets the directory where cache files are to be created. A value of
	 * <code>null</code> indicates that the system-dependent default
	 * temporary-file directory is to be used. If <code>getUseCache</code>
	...
	/**
	 * Returns the current value set by <code>setCacheDirectory</code>, or
	 * <code>null</code> if no explicit setting has been made.
	 *
	...
	/**
	 * Returns an <code>ImageInputStream</code> that will take its input from
	 * the given <code>Object</code>. The set of
	 * <code>ImageInputStreamSpi</code>s registered with the
	 * <code>IIORegistry</code> class is queried and the first one that is able
	...
	/**
	 * Returns an <code>ImageOutputStream</code> that will send its output to
	 * the given <code>Object</code>. The set of
	...
	/**
	 * Returns an array of <code>String</code>s listing all of the informal
	...
	/**
	 * Returns an array of <code>String</code>s listing all of the MIME types
	...
	/**
	 * Returns an array of <code>String</code>s listing all of the file suffixes
	 * associated with the formats understood by the current set of registered
	 * readers.
	 *
	 * @return an array of <code>String</code>s.
	 * @since 1.6
	 ...
	 *
	 * @param input
	 *            an <code>ImageInputStream</code> or other <code>Object</code>
	...
	/**
	 * Returns an <code>Iterator</code> containing all currently registered
	 * <code>ImageReader</code>s that claim to be able to decode the named
	 * format.
	 *
	 * @param formatName
	 *            a <code>String</code> containing the informal name of a format
	...
	public static Iterator<ImageReader> getImageReadersByFormatName(String formatName) {
		...
		try {
			iter = theRegistry.getServiceProviders(ImageReaderSpi.class,
					new ContainsFilter(readerFormatNamesMethod, formatName), true);
		} catch (IllegalArgumentException e) {
			return Collections.emptyIterator();
		}
		return new ImageReaderIterator(iter);
	...
	/**
	 * Returns an <code>Iterator</code> containing all currently registered
	 * <code>ImageReader</code>s that claim to be able to decode files with the
	 * given suffix.
	 *
	 * @param fileSuffix
	 *            a <code>String</code> containing a file suffix (<i>e.g.</i>,
	 *            "jpg" or "tiff").
	 *
	 * @return an <code>Iterator</code> containing <code>ImageReader</code>s.
	 *
	...
	public static Iterator<ImageReader> getImageReadersBySuffix(String fileSuffix) {
		...
		try {
			iter = theRegistry.getServiceProviders(ImageReaderSpi.class,
					new ContainsFilter(readerFileSuffixesMethod, fileSuffix), true);
		} catch (IllegalArgumentException e) {
			return Collections.emptyIterator();
		}
		return new ImageReaderIterator(iter);
	...
	/**
	 * Returns an <code>Iterator</code> containing all currently registered
	 * <code>ImageWriter</code>s that claim to be able to encode the named
	 * format.
	 *
	 * @param formatName
	 *            a <code>String</code> containing the informal name of a format
	...
	public static Iterator<ImageWriter> getImageWritersByFormatName(String formatName) {
		...
		try {
			iter = theRegistry.getServiceProviders(ImageWriterSpi.class,
					new ContainsFilter(writerFormatNamesMethod, formatName), true);
		} catch (IllegalArgumentException e) {
			return Collections.emptyIterator();
		}
	...
	/**
	 * Returns an <code>Iterator</code> containing all currently registered
	 * <code>ImageWriter</code>s that claim to be able to encode files with the
	 * given suffix.
	 *
	 * @param fileSuffix
	 *            a <code>String</code> containing a file suffix (<i>e.g.</i>,
	...
	public static Iterator<ImageWriter> getImageWritersBySuffix(String fileSuffix) {
		...
		try {
			iter = theRegistry.getServiceProviders(ImageWriterSpi.class,
					new ContainsFilter(writerFileSuffixesMethod, fileSuffix), true);
		} catch (IllegalArgumentException e) {
			return Collections.emptyIterator();
		}
		return new ImageWriterIterator(iter);
	 ...
	 * <code>ImageReader</code>, if there is one, or <code>null</code> if the
	 * plug-in for this <code>ImageReader</code> does not specify a
	 * corresponding <code>ImageWriter</code>, or if the given
	 * <code>ImageReader</code> is not registered. This mechanism may be used to
	 * obtain an <code>ImageWriter</code> that will understand the internal
	 * structure of non-pixel metadata (as encoded by <code>IIOMetadata</code>
	 * objects) generated by the <code>ImageReader</code>. By obtaining this
	 * data from the <code>ImageReader</code> and passing it on to the
	 * <code>ImageWriter</code> obtained with this method, a client program can
	 * read an image, modify it in some way, and write it back out preserving
	 * all metadata, without having to understand anything about the structure
	 * of the metadata, or even about the image format. Note that this method
	 * returns the "preferred" writer, which is the first in the list returned
	 * by <code>javax.imageio.spi.ImageReaderSpi.getImageWriterSpiNames()</code>
	 * .
	 *
	 * @param reader
	 ...
	 * <code>ImageWriter</code>, if there is one, or <code>null</code> if the
	 * plug-in for this <code>ImageWriter</code> does not specify a
	 * corresponding <code>ImageReader</code>, or if the given
	 * <code>ImageWriter</code> is not registered. This method is provided
	 * principally for symmetry with <code>getImageWriter(ImageReader)</code>.
	 * Note that this method returns the "preferred" reader, which is the first
	 * in the list returned by javax.imageio.spi.ImageWriterSpi.
	...
	/**
	 * Returns an <code>Iterator</code> containing all currently registered
	 * <code>ImageWriter</code>s that claim to be able to encode images of the
	 * given layout (specified using an <code>ImageTypeSpecifier</code>) in the
	 * given format.
	 *
	 * @param type
	 *            an <code>ImageTypeSpecifier</code> indicating the layout of
	...
	/**
	 * Returns an <code>Iterator</code> containing all currently registered
	 * <code>ImageTranscoder</code>s that claim to be able to transcode between
	 * the metadata of the given <code>ImageReader</code> and
	 ...
	 *
	 * @exception IllegalArgumentException
	 *                if <code>reader</code> or <code>writer</code> is
	 *                <code>null</code>.
	 */
	...
	/**
	 * Writes an image using the an arbitrary <code>ImageWriter</code> that
	 * supports the given format to an <code>ImageOutputStream</code>. The image
	 ...
	 * @param formatName
	 *            a <code>String</code> containing the informal name of the
	 *            format.
	 * @param output
	 ...
	 * the given format to a <code>File</code>. If there is already a
	...
	public static boolean write(RenderedImage im, String formatName, File output)
		...
		if (writer == null) {
			/*
			 * Do not make changes in the file system if we have no appropriate
			 * writer.
			 */
			return false;
		}
	...
	/**
	 * Returns <code>ImageWriter</code> instance according to given rendered
	 * image and image format or <code>null</code> if there is no appropriate
	 * writer.
	 */
