 ...
 * events indicating when an entire image has been updated (via the
 * <code>imageStarted</code>, <code>imageComplete</code>,
 * <code>thumbnailStarted</code> and <code>thumbnailComplete</code> methods).
 * Applications that wish to be informed of pixel updates as they happen (for
 * example, during progressive decoding), should provide an
...
public interface IIOReadProgressListener extends EventListener {
	 ...
	 * <code>ImageReader</code> implementations are required to call this method
	 ...
	 *            the <code>ImageReader</code> object calling this method.
	 * @param imageIndex
	 *            the index of the image being read within its containing input
	 *            file or stream.
	 */
	 ...
	 * be calculated in terms of the remaining time to completion, but it is
	 * usually more practical to use a more well-defined metric such as pixels
	 * decoded or portion of input stream consumed. In any case, a sequence of
	 * calls to this method during a given read operation should supply a
	...
	/**
	 * Reports that a read has been aborted via the reader's <code>abort</code>
