...
public interface IIOWriteProgressListener extends EventListener {
	 ...
	 * <code>ImageWriter</code> implementations are required to call this method
	 ...
	 *
	 * <p>
	 * The degree of completion is expressed as an index indicating which image
	 * is being written, and a percentage varying from <code>0.0F</code> to
	 * <code>100.0F</code> indicating how much of the current image has been
	 * output. The percentage should ideally be calculated in terms of the
	 * remaining time to completion, but it is usually more practical to use a
	 * more well-defined metric such as pixels decoded or portion of input
	 * stream consumed. In any case, a sequence of calls to this method during a
	 * given read operation should supply a monotonically increasing sequence of
	 ...
	 *
	 * <p>
	 * Each particular <code>ImageWriter</code> implementation may call this
	 ...
	 * write within the associated <code>ImageWriter</code>. The semantics are
	...
	/**
	 * Reports that a write has been aborted via the writer's <code>abort</code>
