 ...
 * with objects, such as scoped Bindings, in hosting applications. Each scope is
 * a set of named attributes whose values can be set and retrieved using the
 * <code>ScriptContext</code> methods. ScriptContexts also expose Readers and
 * Writers that can be used by the ScriptEngines for input and output.
 *
 * @author Mike Grogan
 * @since 1.6
 */
public interface ScriptContext {
    ...
    /**
     * GlobalScope attributes are visible to all engines created by same
     * ScriptEngineFactory.
     */
    public static final int GLOBAL_SCOPE = 200;

    /**
     * Associates a <code>Bindings</code> instance with a particular scope in
     * this <code>ScriptContext</code>. Calls to the <code>getAttribute</code>
     * and <code>setAttribute</code> methods must map to the <code>get</code>
     * and <code>put</code> methods of the <code>Bindings</code> for the
     * specified scope.
     *
     * @param bindings
     ...
     *
     * @return The associated <code>Bindings</code>. Returns <code>null</code>
     ...
     * occurring earliest in the search order. The order is determined by the
    ...
    /**
     * Returns immutable <code>List</code> of all the valid values for scope in
     * the ScriptContext.
     *
