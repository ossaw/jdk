...
public interface Invocable {
    /**
     * Calls a method on a script object compiled during a previous script
     * execution, which is retained in the state of the
     ...
     *        and thiz is an instance of that class returned by a previous
     *        execution or invocation, the named method is called through
     *        that instance.
     * @param args
     ...
     *         scripting variable returned by the script method to a Java Object
     *         are implementation-specific.
     * @throws ScriptException
     *         if an error occurs during invocation of
     *         the method.
     * @throws NoSuchMethodException
     *         if method with given name or matching
     *         argument types cannot
     *         be found.
     * @throws NullPointerException
     *         if the method name is null.
     * @throws IllegalArgumentException
     *         if the specified thiz is null or the
     *         specified Object is does
     ...
     * @throws ScriptException
     *         if an error occurs during invocation of the
     *         method.
     * @throws NoSuchMethodException
     *         if method with given name or matching
     *         argument types cannot
    ...
    /**
     * Returns an implementation of an interface using functions compiled in the
     ...
     *         interface is unavailable, i. e. if compiled functions in the
     *         <code>ScriptEngine</code> cannot be found matching the ones in
     *         the requested interface.
     * @throws IllegalArgumentException
     *         if the specified <code>Class</code>
     *         object is null or is not
     *         an interface.
     */
     ...
     *         if the specified <code>Class</code>
     *         object is null or is not
     *         an interface, or if the specified Object
     *         is null or does not
