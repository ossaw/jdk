...
public class SimpleScriptContext implements ScriptContext {
	...
	/**
	 * This is the engine scope bindings. By default, a
	 * <code>SimpleBindings</code> is used. Accessor methods setBindings,
	 * getBindings are used to manage this field.
	 * 
	 * @see SimpleBindings
	 */
	 ...
	 * no global scope) is used. Accessor methods setBindings, getBindings are
	 * used to manage this field.
	 */
	...
	/**
	 * Sets a <code>Bindings</code> of attributes for the given scope. If the
	 * value of scope is <code>ENGINE_SCOPE</code> the given
	 * <code>Bindings</code> replaces the <code>engineScope</code> field. If the
	 * value of scope is <code>GLOBAL_SCOPE</code> the given
	 ...
	 *             if the value of scope is <code>ENGINE_SCOPE</code> and the
	...
	/**
	 * Returns the value of the <code>engineScope</code> field if specified
	 * scope is <code>ENGINE_SCOPE</code>. Returns the value of the
	 * <code>globalScope</code> field if the specified scope is
