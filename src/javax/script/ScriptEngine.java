 ...
 * fully functional in every implementation of this specification. <br>
 * <br>
 * These methods provide basic scripting functionality. Applications written to
 * this simple interface are expected to work with minimal modifications in
 * every implementation. It includes methods that execute scripts, and ones that
 * set and get values. <br>
 * <br>
...
public interface ScriptEngine {
	 ...
	 * <code>ScriptEngine</code> implementation.
	 */
	...
	/**
	 * Reserved key for a named value that identifies the short name of the
	 * scripting language. The name is used by the
	...
	/**
	 * Reserved key for a named value that is the full name of Scripting
	 * Language supported by the implementation.
	 */
	public static final String LANGUAGE = "javax.script.language";

	/**
	 * Reserved key for the named value that identifies the version of the
	 ...
	 * <code>ENGINE_SCOPE</code> <code>Bindings</code> of the
	 * <code>ScriptEngine</code> during the script execution. The
	 * <code>Reader</code>, <code>Writer</code> and non-
	 * <code>ENGINE_SCOPE</code> <code>Bindings</code> of the default
	 * <code>ScriptContext</code> are used. The <code>ENGINE_SCOPE</code>
	 * <code>Bindings</code> of the <code>ScriptEngine</code> is not changed,
	...
	/**
	 * Same as <code>eval(String, Bindings)</code> except that the source of the
	 ...
	 * <code>Bindings</code> must be visible as the <code>GLOBAL_SCOPE</code>.
	 * </li>
	 * <li>Any other value of scope defined in the default
	 * <code>ScriptContext</code> of the <code>ScriptEngine</code>.</li>
	 * </ul>
	...
	/**
	 * Returns the default <code>ScriptContext</code> of the
	 * <code>ScriptEngine</code> whose Bindings, Reader and Writers are used for
	 * script executions when no <code>ScriptContext</code> is specified.
	 *
	 * @return The default <code>ScriptContext</code> of the
	 *         <code>ScriptEngine</code>.
	 */
	public ScriptContext getContext();

	/**
	 * Sets the default <code>ScriptContext</code> of the
	 * <code>ScriptEngine</code> whose Bindings, Reader and Writers are used for
	 * script executions when no <code>ScriptContext</code> is specified.
	 *
	 * @param context
