...
/**
 * The optional interface implemented by ScriptEngines whose methods compile
 * scripts to a form that can be executed repeatedly without recompilation.
 *
 * @author Mike Grogan
 * @since 1.6
 */
public interface Compilable {
	 ...
	 *
	 * @param script
	 *            The source of the script, represented as a <code>String</code>
	 *            .
	 *
