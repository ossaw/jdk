...
public class ScriptException extends Exception {
	...
	/**
	 * Creates a <code>ScriptException</code> with a String to be used in its
	...
	/**
	 * Creates a <code>ScriptException</code> wrapping an <code>Exception</code>
	 * thrown by an underlying interpreter. Line and column numbers and filename
	 * are unspecified.
	 *
	 * @param e
	...
	/**
	 * Creates a <code>ScriptException</code> with message, filename and
	...
	/**
	 * <code>ScriptException</code> constructor specifying message, filename,
	...
	/**
	 * Returns a message containing the String passed to a constructor as well
	 * as line and column numbers and filename if any of these are known.
	 * 
	 ...
	 * 
	 * @return The file name of the script or some other string describing the
	 *         script source. May return some implementation-defined string such
	 *         as <i>&lt;unknown&gt;</i> if a description of the source is
	 *         unavailable.
	 */
