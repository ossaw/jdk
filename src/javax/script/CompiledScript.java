 ...
 * The script may be executed repeatedly without reparsing. <br>
 * <br>
 * Each <code>CompiledScript</code> is associated with a
 * <code>ScriptEngine</code> -- A call to an <code>eval</code> method of the
 * <code>CompiledScript</code> causes the execution of the script by the
 * <code>ScriptEngine</code>. Changes in the state of the
 * <code>ScriptEngine</code> caused by execution of the
 * <code>CompiledScript</code> may visible during subsequent executions of
...
public abstract class CompiledScript {
     ...
     * using the supplied <code>Bindings</code> of attributes as the
     * <code>ENGINE_SCOPE</code> of the associated <code>ScriptEngine</code>
     * during script execution. If bindings is null, then the effect of calling
     * this method is same as that of eval(getEngine().getContext()).
     * <p>
     * . The <code>GLOBAL_SCOPE</code> <code>Bindings</code>,
     * <code>Reader</code> and <code>Writer</code> associated with the default
     * <code>ScriptContext</code> of the associated <code>ScriptEngine</code>
     * are used.
     *
     * @param bindings
    ...
    /**
     * Executes the program stored in the <code>CompiledScript</code> object.
     * The default <code>ScriptContext</code> of the associated
     * <code>ScriptEngine</code> is used. The effect of calling this method is
    ...
    /**
     * Returns the <code>ScriptEngine</code> whose <code>compile</code> method
     * created this <code>CompiledScript</code>. The <code>CompiledScript</code>
     * will execute in this engine.
     *
     * @return The <code>ScriptEngine</code> that created this
