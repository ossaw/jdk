 ...
 * <code>eval</code> method. <br>
 * <br>
 * <code><b>eval(Reader)</b></code>
 * <p>
 * <code><b>eval(String)</b></code>
 * <p>
 * <code><b>eval(String, Bindings)</b></code>
 * <p>
 * <code><b>eval(Reader, Bindings)</b></code> <br>
 * <br>
 * are implemented using the abstract methods <br>
 * <br>
 * <code><b>eval(Reader,ScriptContext)</b></code> or
 * <code><b>eval(String, ScriptContext)</b></code> <br>
 * <br>
 * with a <code>SimpleScriptContext</code>. <br>
 * <br>
 * A <code>SimpleScriptContext</code> is used as the default
 * <code>ScriptContext</code> of the <code>AbstractScriptEngine</code>..
 *
 * @author Mike Grogan
 * @since 1.6
 */
public abstract class AbstractScriptEngine implements ScriptEngine {
	...
	/**
	 * The default <code>ScriptContext</code> of this
	 ...
	 * <code>ENGINE_SCOPE</code> <code>Bindings</code> of the protected
	 * <code>context</code> field.
	 *
	 * @param key
	 *            The specified key.
	 ...
	 * <code>eval(Reader, ScriptContext)</code> method, passing it a
	 * <code>ScriptContext</code> whose Reader, Writers and Bindings for scopes
	 ...
	 * <code>eval(Reader, ScriptContext)</code> passing the value of the
	 * <code>context</code> field.
	 *
	 * @param reader
	 *            A <code>Reader</code> containing the source of the script.
	...
	/**
	 * Returns a <code>SimpleScriptContext</code>. The
	 * <code>SimpleScriptContext</code>: <br>
	 * <br>
	 * <ul>
	 * <li>Uses the specified <code>Bindings</code> for its
	 * <code>ENGINE_SCOPE</code></li>
	 * <li>Uses the <code>Bindings</code> returned by the abstract
	 * <code>getGlobalScope</code> method as its <code>GLOBAL_SCOPE</code></li>
	 * <li>Uses the Reader and Writer in the default <code>ScriptContext</code>
	 * of this <code>ScriptEngine</code></li>
	 * </ul>
	 * <br>
	 * <br>
	 * A <code>SimpleScriptContext</code> returned by this method is used to
	 * implement eval methods using the abstract
	 * <code>eval(Reader,Bindings)</code> and <code>eval(String,Bindings)</code>
	 * versions.
	 *
	 * @param nn
